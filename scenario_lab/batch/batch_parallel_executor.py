"""
Batch Parallel Executor - Async execution with rate limiting for batch runs (V2)

Features:
- Async/await parallel execution
- Rate limiting with exponential backoff
- Semaphore-based concurrency control
- 429 error handling with retry-after support
- Progress callbacks
...
class RateLimitManager:
    """
    Manages rate limiting across parallel workers (V2)
    ...
    - Automatic backoff clearing on success
    """
...
class BatchParallelExecutor:
    """
    Executes batch scenarios in parallel with rate limiting (V2)
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        Returns:
            Status dictionary with parallel execution and rate limit info
        """
        return {
...
async def run_scenarios_parallel(
    ...
    """
    Convenience function to run scenarios in parallel (V2)
