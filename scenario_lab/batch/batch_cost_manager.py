"""
Batch Cost Manager - Manages budget and cost controls for batch execution (V2)

V2 Design:
- No V1 dependencies
- Works with V2 ScenarioState cost tracking
- Pure utility class for budget management
...
class BatchCostManager:
    """
    Manages costs and budget limits for batch scenario execution (V2)

    Tracks:
    - Total spending across all runs
    - Per-run costs
