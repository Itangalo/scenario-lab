...
from scenario_lab.utils.error_handler import (
    ErrorHandler, ErrorContext, classify_error,
...
class ProgressiveFallbackExecutor:
    """
    Execute operations with progressive fallback strategies (V2)

    Execution flow:
    1. Try primary approach (with automatic retries via api_client)
