...
5. **The story tree is 168 turn pieces and 42 options** across three arms, each built from ten or more simulations. Turns 2–5 depend on the physics, which is now in better shape than it was; item 1 is small enough that it need not block this.
...
- **Seeds must be unique per run.** Blocks used so far: 5101–5330, 5401–5834, 6101–6302, 7101–7312, 7401–7604, 7701–7904, 8001–8002, 8101–8304.
