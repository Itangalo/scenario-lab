...
**Description:** Capability of the best openly released model weights, on the same scale as ai_capability. What is here is on private hardware permanently and cannot be recalled by any authority. Accumulated; it does not fall back.
...
**Start value:** 40
**Reference points:**
- 20: Two or more years behind the closed frontier. Frontier-only risks are genuinely governable through a handful of auditable organisations.
- 40: Late 2026. Under a year behind on general capability, and at the closed frontier in offensive cyber since Kimi K3. Release control now buys one model generation, not several.
- 45: Six to twelve months behind. Release controls bite for one model generation and then evaporate.
- 60: At the closed frontier of a year ago. Every offensive capability the frontier had then is now distributed and unrecallable.
- 80: At the frontier. Release control means nothing, and no restriction addressed to developers reaches the capability that matters.
...
- 35: Mid-2026. Uneven. Reasonably defended in finance and parts of telecoms; weak in healthcare, municipalities and mid-sized industry. Biological detection is slow and largely passive.
- 50: Baseline hardening across critical sectors, with incident response exercised rather than documented. Essential services degrade rather than stop.
...
- 22: Mid-2026. Around five per cent of world compute, no frontier laboratory, genuine strength in the upstream hardware supply chain, and no coordinated position from which to use it.
...
- 48: Mid-2026. Strong legal instruments, thin technical capacity, contested legitimacy and a tightening budget. Two or three measures can run at once before something slips.
...
- 42: Mid-2026. Ambivalent. Widely used, widely resented, sharply divided by age and by sector.
