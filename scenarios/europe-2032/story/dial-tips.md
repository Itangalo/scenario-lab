...
Short, reader-facing explanations of the seven dials in the panel, shown when the reader hovers one or reaches it with the keyboard. The arcs carry a reading but never say what the reading is of; this is where that is said.

Each heading must match the metric's label in `data.json` exactly, or the dial gets no explanation. One paragraph each, plain language — these are the shortest thing on the page and the most likely to be read cold. The long, internal definitions live in [`../metrics.md`](../metrics.md); these are not a summary of those, they are what a reader needs in a tooltip.
