...
<!-- liberty: the store marks the EU AI Evaluation and Safety Institute finished this half-year, while the world state keeps it pre-operational with nothing published. Told as formally opening on paper, with staff, premises and protocols still being assembled and no evaluations published. -->

# A foreign switch

At 16:40 on 8 February 2028, access to the leading American model goes dark for European users. There is no warning and no path to appeal.

Hospitals that built triage assistants on it, ministries using it for document work, and firms running customer services on top of it see error messages overnight. The helpdesks fill and contractors fly in. The evening news runs the outage as proof that Brussels let essential services rest on a foreign switch.

> **Claire:** triage assistant says service unavailable
> **Claire:** we switched to the european one. it writes like a tax form
>
> **Sofia:** It works.
>
