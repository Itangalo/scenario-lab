...
Then the clinics change the mood. Individually tailored therapies for two hard cancers, designed with AI and triaged with AI diagnostics, begin reaching ordinary hospitals in Lyon, Milan and Rotterdam. Waiting-list pilots in Denmark and Estonia cut backlogs so visibly that the decisions arrive in days.

> **Claire:** we have the new cancer therapy. real patients. real doses
> **Claire:** the doses came before the billing code exists
> **Claire:** finance is losing its mind. nobody else cares
>
> **Sofia:** Good.
>
> **Claire:** i said the same thing

Health ministers tour the wards with cameras in tow, and Sofia's note makes sure the wins are stamped European. Under it, the Union buys jointly to run the treatments and the AI triage tools on the shared supercomputers. Models that can run on hardware under Union control get preference, and every one needs a certificate from the Institute. The Institute, certifying on an interim basis since the cut-off, formally opens in March. Its first reports are procedural checklists, not deep audits.
...
By June the clinics are running degraded, but visibly better, and the voters notice. Gratitude is still thin. But for the first time since the keys died, the public story is not only dependence.
