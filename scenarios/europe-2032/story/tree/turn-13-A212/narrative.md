...
For everyone else the price is immediate. The repair ships for the cut cables stay stuck in licensing queues. Neutral satellite capacity thins again. Grid-balancing software hosted abroad times out without warning, and the restoration crews work on local fallbacks through the winter storms.

The shelter finishes on schedule. The sequencing hubs, the verification channels and the trusted-care wards hold the clinics together without a return to paper. The town registries still flicker, but the nurses talk about routine.

> **Claire:** storm knocked out the grid tool again
> **Claire:** wards didn't notice. we have our own lights now
>
> **Sofia:** And the town hall?
>
> **Claire:** the town hall noticed
...
The short version: we kept the wards off paper. Everything outside the wards, we queued for.
...
- Cables and bandwidth. Our repair ships wait in other people's licensing queues.
- The factories. The robots go everywhere except to us, unless we let the maintenance leave with the data.
- The graduates. Their bridge leads to maintenance and care, and not much else.
- Our own licensing line. We bought our way into the intelligence by mirroring Washington's.

What I would tell whoever holds this file next: we chose care first, and care held. Nothing else was chosen at all.

*In the margin, in the President's hand:* It was the right first choice. Choose a second.
