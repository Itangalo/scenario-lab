...
<!-- stance: contain | source: pool-06-A1-20260911/sample-02.md | majority, cat6, 6/10 -->

# Make the machines stoppable

**EU Embodied AI Containment and Continuity Protocol.** Preparedness and resilience. Small; running until the first half of 2030.
...
The President's own weight goes behind the Trust Pact first. Nothing else lands if mayors keep blaming Brussels for boil-water notices and uninsured downtime.

What it does not do is take up Washington's offer of access.

*Of ten simulated responses to this situation, six built containment and continuity of this kind – the majority answer. Three went for structured access instead, the direction of the other recommendation.*
