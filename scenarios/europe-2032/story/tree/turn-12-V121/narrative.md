...
> **Claire:** we saw it coming. the feed flagged it twenty minutes before it hit us
> **Claire:** twenty minutes is enough to pull the plug
>
> **Sofia:** That's the seat at the table.
>
...
The accession completes its term, and the Union is now a full member of the pooled defence. The twin shocks freeze the civic repair. Health triage keeps expanding wherever mayors signed the standard pack, and the waiting lists do fall there, and the local papers notice. But the insurers still refuse blanket cover without a statute, the unions keep welfare automation frozen, and the ransomware gives both a reason to wait.

By June the public mood is darker: grateful for visible help where it arrives, and angry at dependence everywhere else.
