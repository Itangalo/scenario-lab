...
status: written
prev: turn-04-V1
next: option-06-V11, option-06-V12
allow: 8 18
---
...
> **8 November 2028.** American voters choose the backlash: moratoriums on data centres, bans in classrooms, and taxes on the sector to fund job guarantees.
...
The short version: when it came, it got through, and the hospitals stayed open. That is what the Shield was for.

What held:

- The Shield and the swarm defences. Most grid operators and large hospitals now block by behaviour, and share what they see.
- The backstop. The insurers stayed in, and the November probes sent hospitals to backup systems, not paper.
- The allied command and the pathogen pact. We are inside both, because we could show competence.
