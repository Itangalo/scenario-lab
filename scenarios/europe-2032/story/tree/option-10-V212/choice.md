...
<!-- The draw answers a bio incident and a cut-off pinned for the next half-year. Re-grounded on the March 2030 genome paper, the sentinels in the drains, and the February 2027 cut-off. -->

# Build the fallback as people

**EU Fallback Care and Bio-Response Corps.** Preparedness and resilience. Small; running until the first half of 2032.
...
The President's own weight goes behind the corps.

What it does not do is harden the municipal systems the attacks keep jamming.

*Of ten simulated responses to this situation, two built a staffed corps of this kind – a minority. Eight built a sovereign fallback stack of tools instead, the direction of the other recommendation.*
