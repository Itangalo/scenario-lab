...
By June the grids are segmented but not secure. The compute plans have been renamed independence plans, and are still without concrete. The public mood has soured: using the tools, resenting them, and newly aware of the dependence.
