...
> **April 2028.** A group of allied states hit by the same ransomware family set up a joint cyber command with live telemetry sharing, and a binding pact on sharing pathogen samples with a standing investigation team. The Union is invited to join both.

Sofia's note becomes the Joint Threat and Bio-Surveillance Integration, and the Commission signs both. Analysts are seconded, hospital sequencing feeds are pledged, and recovery money is made conditional on interior ministries actually sharing their data.

> **Claire:** we send our sequencing data to a pact now apparently
> **Claire:** i run the sample fridge. so i'm in a pact
>
> **Sofia:** You're in a pact.
>
> **Claire:** put it on my card

The timing is uncomfortable.

> **May 2028.** A contested genome-model paper claims a non-expert could be guided to a viable design for an organism able to infect humans.
