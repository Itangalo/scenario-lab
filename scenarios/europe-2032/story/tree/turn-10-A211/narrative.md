...
> **Claire:** the cloud keeps dropping so the triage assistant lives in our basement now
> **Claire:** on a server the size of a fridge. it hums
>
> **Sofia:** Does it work?
>
> **Claire:** it works. we visit it
...
Then, in May, something falls that was never supposed to be touched. Both countries lose satellites that watch for missile launches. Each side says the other did it. Each side may be right, or neither: the analysts in Brussels cannot rule out debris, and nobody can rule out a machine choosing a target a human would not have chosen.
...
> **Sofia:** Stay inside.
>
> **Claire:** i work in a hospital sofia. where is inside

By June the war in the Pacific has almost paused. Neither side dares to move, because neither can see what the other is doing. The markets are shut more often than they are open. Europe carries on: the wards run, the lifelines hold, and the doses keep arriving, barely.

At the end of the month the alert has not been lowered. Nobody knows whether it will be. Everything Europe has built now depends on two governments, each guessing in the dark what the other is about to do.
