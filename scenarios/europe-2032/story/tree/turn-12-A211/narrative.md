...
The spring brings no pause in the war at sea and in orbit, but it brings two usable tailwinds.

> **March 2032.** Researchers in allied laboratories demonstrate defensive tooling that closes a whole class of intrusion: automated patching pushed as fast as vulnerabilities are found, and detectors that recognise swarm behaviour rather than signatures.
...
> **Claire:** nobody even went to paper
>
> **Sofia:** That's what it's for.
>
> **Claire:** i know. i'm just not used to things working

The bio-detection and trusted-care network completes its rollout. Pooled reagents, stretched licences and faster detection keep the tailored cures flowing week to week. The pharmacists still count in weeks, and hiring stays frozen.

In May, single-source reports speak of a repair flotilla under a neutral flag restoring an Atlantic landing station, and cloud and medical links ease for days at a time. Nothing is confirmed, and the jitter comes back.

Voters credit the shelter, and the remissions they see on the news. They doubt that neutrality can last without models, machines or medicines of Europe's own.
