...
status: written
prev: turn-04-P2
next: option-06-P21, option-06-P22
allow: 8 18
---
...
It is not a recovery. Doctors complain that the replacement helpers are slower and more literal, and break referral letters and discharge summaries that then have to be fixed by hand. Hospital managers quietly keep the old American workflows on standby wherever a licence still flickers.

> **Claire:** the european helper broke three discharge letters today
> **Claire:** i fixed them by hand. after my shift. again
>
> **Sofia:** Two cities have their waiting lists falling on it.
>
...
The short version: we held services together with weaker tools, and we stopped paying for factories we were never going to build.

What held:

- The grid. Nobody turned the lights off.
- The substitution. The cut-off sites are running on European models, with the new defensive tools beside them.
- Two cities. Their waiting lists fell, and they know why.
