...
<!-- liberty: the world state has the rumour of a showcase hospital finding its backup already sold on this half-year, and the next half-year confirms it as an audit finding. Told here as rumour only, and confirmed in the autumn. -->

# Refusals

At 23:40 on 9 February 2032, hospital dictation, ministry assistants and factory copilots built on the leading American model begin returning refusals for European users. There is no reason given and no channel for appeal. The metered fallback the staff had preferred for three years is simply gone.

Clinics that stretched through the autumn sweep on it revert to paper and to the routines drilled by hand. In two capitals ministers call it blackmail. The night news plays it as naivety exposed.

> **Claire:** the american helper just says no now. to everything
> **Claire:** it says no very politely
>
> **Sofia:** It isn't coming back.
>
> **Claire:** i know. i'm writing the discharge letters myself again. they're better
