...
> **Claire:** she reported it herself. then she cried in the locker room
>
> **Sofia:** Is he all right?
>
...
The short version: we pushed every defence we had to every place we could reach, and we bargained with the one bottleneck we own. The cures arrived. So did a guide to evading our own sampling.

What held:

- The defensive tools. Two dozen utilities caught swarms that would have taken them down a year earlier.
- The upstream bargain. We traded servicing of the machines that make the machines for clinical access, and got it.
- The retraining cheques. They are late and below rent, and they are real.
...
*In the margin, in the President's hand:* Carefully. Agreed.
