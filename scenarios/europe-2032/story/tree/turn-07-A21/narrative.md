...
The attack comes in October, automated and indiscriminate. Within hours municipal registries, hospital appointment systems, and a logistics software supplier used across three member states are encrypted. The ransom notes are boilerplate. The intrusion tooling is not: defenders find scripts that rewrite themselves on the fly to get past the known signatures.
...
> **December 2029.** Extended naval exercises around Taiwan push insurance rates up again, and inspection delays lengthen. A Japanese hardware lot shrinks in transit.

Officials whisper that American buyers were offered priority licences. The Paris and Warsaw halls, their power and cooling now finished, can run rationed hospital and sequencing workloads and not much else.

The cross-border aid stems the cascade. The voters remember the black screens first and the recovery second.
