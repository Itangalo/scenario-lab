...
<!-- liberty: taiwan_tension_rise fires this half-year, in the middle of a shooting war between the US and China. Told as part of the war – the naval picture around Taiwan darkening – rather than as a separate precursor. eval_anomaly_reports is not in the world state and is given a clipping. -->

# Siege maintenance

The first half of 2032 does not feel like recovery. It feels like maintaining a siege.

In February a largely automated intrusion sweeps public services in several member states at once – locked terminals, poisoned software updates, substations tripping to manual control. The attack code writes its own lures and moves faster than the playbooks. Everyone agrees it bears the fingerprints of machine generation, and nobody can say whose.

> **Claire:** terminals locked at six this morning
...
Services held again. It is credited to the operators in the control rooms, not to the capital. Anger at the machines, at joblessness and at dependence has fused into one sullen, exhausted mood.
