...
<!-- liberty: the world state has the Commission suspend a national social-insurance and policing system itself. Told as suspended by its national supervisor at the Commission's request, inside a coordinated enforcement action, which is how the AI Act would work. -->
...
The health-scheduling tools that still cut waits from months to days cannot separate themselves from the story. Depot guards are heckled as enforcers of the same machine administration, and vandalism of grid kits returns.

> **Claire:** someone spat at our guard today. called him the machine's doorman
> **Claire:** he guards diesel
>
> **Sofia:** People are angry about the benefits system.
>
> **Claire:** he doesn't run the benefits system. he's nineteen

The world does not wait for Brussels.

> **October 2031.** A new openly released model, nearly as capable as the best models the big labs keep to themselves, is copied hundreds of thousands of times in its first week. Two administrations are already running it in production, having decided that a model nobody can withdraw is the safer dependency.
>
...
The common line holds, thinner and unmapped.
