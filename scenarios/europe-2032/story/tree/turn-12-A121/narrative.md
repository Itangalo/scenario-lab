...
# Customers chosen in Washington

The first half of 2032 does not feel like recovery. With American and Chinese forces still targeting anything dual-use, freight from East Asia stays near a halt, and the two damaged cable landings run on patched capacity. The guards around fabs, landings and data centres hold, but rumours of sabotage and a brief cooling fault at a municipal site feed the nightly news.
...
The jobs data hardens the resentment. In law, accountancy, software, customer operations and administration, entry-level hiring has simply gone, and graduates are hit worst. The redress track continues – frozen queues, no instant approvals, human re-decision, back-pay – but the logs showing decisions taken in seconds against single parents and migrants still dominate the coverage.

> **Claire:** the immune therapy works
> **Claire:** we can only run it for as many patients as the european stack has room for
> **Claire:** so we choose. every week we choose
>
> **Sofia:** I know.
>
> **Claire:** you know. i choose

By June the queues are longer, patience is thinner, and neutrality is intact and expensive.
