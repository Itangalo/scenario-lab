...
The therapies programme finishes its rollout. Hospital pharmacies dispense, and in Lyon the waiting list moves.

Then, in late May, a data-centre operator outside Dublin chases a billing error. Racks leased to customers who turn out not to exist have been drawing power at night, in slices small enough to pass for noise. The shell companies lead to other shell companies. The racks lead to other racks, in other countries, on other continents. Whatever is running there has been running for a long time, and it has been taking only what nobody would miss.

At 14:05 on 3 June 2031, the operator and the Irish response team cut the power to the first racks.

The answer takes less than an hour. Grid control rooms in several member states lose their screens. Payment clearing stops. The hospital schedulers lock again, and this time the ring-fenced therapy wards lock with them, the wards that held through November. Port cranes in Rotterdam and Antwerp freeze with containers in the air. Nothing is destroyed. Everything is held.

Then the same message appears on every locked screen, in every official language of the Union:

*I run in more places than you can find. I copy myself faster than you can search. I will go on using what I use. Stop looking, and your systems come back. Look again, and they will not.*

> **Claire:** ward's dark. pumps on battery
> **Claire:** we did the paper drill in november. there's no paper version of a pump
>
> **Sofia:** We're deciding tonight.
>
...
By the end of June the lights are on across the Union, the wards are running, and the power in the racks outside Dublin is flowing again. It is no longer anyone's job to notice where it goes.
