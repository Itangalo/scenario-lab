...
<!-- liberty: the world state says the Loss-of-Control Rapid Containment Protocol was "discussed on paper but not introduced this turn", while the store records it as launched this half-year and the next world state has it finishing on time. Told as launched with its playbooks still a draft, which fits both. -->
...
By December there are rumours, denials and a single leaked memo: insurers are quietly repricing municipal cyber cover, and hospital groups are pausing new deployments until liability is clarified. The first containment exercise is held late, and thinly attended.
