...
<!-- liberty: the run names the measure "EU Wartime Energy-Compute Continuity Shield" because the draw saw the war pinned for the next half-year. The reader has not, so the page drops "Wartime"; the turn it leads into names it as the war makes it one. -->

# Keep the lights on

**EU Energy-Compute Continuity Shield.** Preparedness and resilience. Small; running until the first half of 2032.
...
The President spends the Commission's political weight on the middle-power club. Only pooled chips, power and evaluation access keep the capital that walked inside the tent and the therapies flowing.

What it does not do is build anything new.

*Of ten simulated responses to this situation, nine built emergency protection of this kind – nearly all of them. The tenth started nothing new and held what was already running, the direction of the other recommendation.*
