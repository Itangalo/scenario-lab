...
The fallback formally lands. Reserved inference on the European supercomputers stays reserved, emergency procurement of European-hosted open models continues, and the middle-power framework keeps replacement computing flowing. It does not bring back the top-tier access, and private co-financing is still hesitant. But essential entities now have a migration path that actually runs.

> **Claire:** we migrated. the european fallback
> **Claire:** it works. it's slower. it's ours
>
> **Sofia:** Ours is the part that matters.
>
