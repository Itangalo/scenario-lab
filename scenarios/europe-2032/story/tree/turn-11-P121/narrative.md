...
Procurement officers begin hoarding, and prices for backup hardware rise. The talk in Berlin and Warsaw shifts from biology papers to supply dependence.

By December the blackouts have been avoided again and the first retraining cheques have landed, and the dread has deepened. The bio sampling is still partial for lack of reagents, the containment took days rather than hours, and single-source reports claim that a popular open assistant can be coaxed into advising how to dodge wastewater detection. Officials deny it, the universities argue about disclosure, and the public mood turns darker.
