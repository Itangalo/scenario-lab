...
With only the swarm defence running, the Commission holds the Union together. Observer access to the allied telemetry continues, paid for in incident data. Nothing new is built; there is neither the money nor the majority for it.
