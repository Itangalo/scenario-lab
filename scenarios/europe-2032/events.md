...
**Probability:** 8%. Add 8 points if a finished category 8 measure coordinates other states holding pieces of the supply chain. Add 5 points if `election_alliance` fired in turn 5.
**Can repeat:** Yes
