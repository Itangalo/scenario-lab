...
**State, 2026-09-11.** (ECHO 2026-09-11) All 207 nodes written on the rerun tree in form A (Sofia Brandt, Claire, dated clippings, stage memos; see `story/README.md`). Liberties with the record are noted as HTML comments in the nodes they touch. check_tree clean. Needs a read-through by Johan before anything is published.
