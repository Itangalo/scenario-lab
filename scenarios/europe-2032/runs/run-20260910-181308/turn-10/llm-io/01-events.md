...
- characters 374-1369: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1412-3581: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3637-4575: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4638-29773: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30128-31224: `{{event_history}}` from the run's own event record
...
LEGITIMACY LENDS: capital 0, sentiment 2 -> +0 already at floor, no lend applied beyond bounds
SOVEREIGNTY: 16 last turn, no capacity event? member_state_defection t9 −2, no cat4 in flight +0, capability rose 1.0 −0 = 14

## Emerging developments (tracked)

- `emergent_grid_strain_blackouts` -- first noted turn 9, listed in 1 turn(s) so far: Prolonged heatwave plus throttled data-centre power and postponed grid maintenance trigger rolling blackouts in two member states, blamed publicly on AI electricity demand and US quota throttling.
- `emergent_power_rationing_backlash` -- first noted turn 9, listed in 1 turn(s) so far: Municipal utilities impose rolling throttling of data-centre power and public inference endpoints after autumn load spikes, triggering localized blackouts and queueing for public services.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, bio_uplift_findings, automated_decision_scandal
- Turn 2 (8 turn(s) ago): cyber_major_incident, loss_of_control_incident, bio_uplift_findings, emergent_cyber_insurance_pullback
- Turn 3 (7 turn(s) ago): cyber_major_incident, knowledge_work_augmented, taiwan_tension_rise, automated_decision_scandal
- Turn 4 (6 turn(s) ago): supply_chain_coercion
- Turn 5 (5 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied, member_state_defection, emergent_anti_ai_direct_action, emergent_anti_ai_site_blockades, election_consolidation
- Turn 6 (4 turn(s) ago): opaque_reasoning, supply_chain_coercion, member_state_defection
- Turn 7 (3 turn(s) ago): capability_jump, knowledge_work_augmented, embodied_ai_deployment, eu_frontier_access_denied, joint_threat_response
- Turn 8 (2 turn(s) ago): cyber_major_incident, openweight_frontier_release, export_control_escalation, emergent_tiered_access_selloff
- Turn 9 (1 turn(s) ago): knowledge_work_augmented, member_state_defection
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.36}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.08}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.16}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.18}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.05}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.14}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Prolonged heatwave plus throttled data-centre power and postponed grid maintenance trigger rolling blackouts in two member states, blamed publicly on AI electricity demand and US quota throttling.", "emergent": true, "id": "emergent_grid_strain_blackouts", "probability": 0.22}, {"description": "Municipal utilities impose rolling throttling of data-centre power and public inference endpoints after autumn load spikes, triggering localized blackouts and queueing for public services.", "emergent": true, "id": "emergent_power_rationing_backlash", "probability": 0.25}]
```
