...
- characters 13164-14159: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14202-16371: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16427-17365: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 66.5, "openweight_capability": 64.0, "ai_safety": 0.0, "resilience": 50.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 4.0, "public_sentiment": 1.0}
```
