...
- characters 1490-3659: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6507-6969: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9473-11033: `{{previous_actions}}` from the actor's own response from the previous turn
