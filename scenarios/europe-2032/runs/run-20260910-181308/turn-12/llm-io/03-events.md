...
- characters 374-1929: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1972-3948: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4004-4463: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4526-29661: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30016-31431: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M9 EU Essential Services Keep-Running Cells −2 = −2, no priority
PROPOSAL BONUS: EU Essential Services Keep-Running Cells (cat 6, small) +3 — February ransomware sweep plus July blackouts plus open-weight cyber wave in last 1-2 turns and this answers continuity directly
LEGITIMACY LENDS: capital 4, sentiment 1 -> none, capital higher
SOVEREIGNTY: 16 last turn, no capacity event, no category 4 in flight +0, capability rose 1.5 −0 = 16
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, bio_uplift_findings, automated_decision_scandal
- Turn 2 (10 turn(s) ago): cyber_major_incident, loss_of_control_incident, bio_uplift_findings, emergent_cyber_insurance_pullback
- Turn 3 (9 turn(s) ago): cyber_major_incident, knowledge_work_augmented, taiwan_tension_rise, automated_decision_scandal
- Turn 4 (8 turn(s) ago): supply_chain_coercion
- Turn 5 (7 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied, member_state_defection, emergent_anti_ai_direct_action, emergent_anti_ai_site_blockades, election_consolidation
- Turn 6 (6 turn(s) ago): opaque_reasoning, supply_chain_coercion, member_state_defection
- Turn 7 (5 turn(s) ago): capability_jump, knowledge_work_augmented, embodied_ai_deployment, eu_frontier_access_denied, joint_threat_response
- Turn 8 (4 turn(s) ago): cyber_major_incident, openweight_frontier_release, export_control_escalation, emergent_tiered_access_selloff
- Turn 9 (3 turn(s) ago): knowledge_work_augmented, member_state_defection
- Turn 10 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, middle_power_coalition
- Turn 11 (1 turn(s) ago): capability_jump, bio_uplift_findings, medical_breakthrough, openweight_frontier_release, emergent_grid_strain_blackouts
