...
- characters 106-12930: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12973-13162: `{{metrics_json}}` from the run's live metric values
- characters 13255-14810: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14853-16829: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16885-17947: `{{notepad}}` from the Game Master's notepad, carried across turns
