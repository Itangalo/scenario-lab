...
- characters 12963-13152: `{{metrics_json}}` from the run's live metric values
- characters 13245-14339: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14382-16735: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16791-17440: `{{notepad}}` from the Game Master's notepad, carried across turns
