...
- characters 106-13197: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13240-13429: `{{metrics_json}}` from the run's live metric values
- characters 13522-14675: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14719-16846: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16902-17931: `{{notepad}}` from the Game Master's notepad, carried across turns
