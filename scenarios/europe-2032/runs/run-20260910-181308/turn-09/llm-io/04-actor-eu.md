...
- characters 452-1605: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1649-3776: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4629-5085: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7589-9162: `{{previous_actions}}` from the actor's own response from the previous turn
