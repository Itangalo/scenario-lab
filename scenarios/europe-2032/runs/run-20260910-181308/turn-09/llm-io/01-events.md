...
- characters 374-1527: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1571-3698: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3754-4185: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4248-28530: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28885-29906: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M8 EU Joint Threat Response Accession −2, priority −1 not charged capital below 20 = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 4, sentiment 1 -> none, capital higher
SOVEREIGNTY: 17 last turn, no capacity build finishes, no cat4 in flight +0, export_control_escalation t8 −1 (largest capacity take, small end with Gigafactories finished), capability rose 1.0 −0 = 16
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, bio_uplift_findings, automated_decision_scandal
- Turn 2 (7 turn(s) ago): cyber_major_incident, loss_of_control_incident, bio_uplift_findings, emergent_cyber_insurance_pullback
- Turn 3 (6 turn(s) ago): cyber_major_incident, knowledge_work_augmented, taiwan_tension_rise, automated_decision_scandal
- Turn 4 (5 turn(s) ago): supply_chain_coercion
- Turn 5 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied, member_state_defection, emergent_anti_ai_direct_action, emergent_anti_ai_site_blockades, election_consolidation
- Turn 6 (3 turn(s) ago): opaque_reasoning, supply_chain_coercion, member_state_defection
- Turn 7 (2 turn(s) ago): capability_jump, knowledge_work_augmented, embodied_ai_deployment, eu_frontier_access_denied, joint_threat_response
- Turn 8 (1 turn(s) ago): cyber_major_incident, openweight_frontier_release, export_control_escalation, emergent_tiered_access_selloff
