...
- characters 106-13417: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13460-13652: `{{metrics_json}}` from the run's live metric values
- characters 13745-14858: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14902-17478: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17534-18085: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Incident Containment Reserve | 2 |
