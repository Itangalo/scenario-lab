...
- characters 105-13409: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13452-13644: `{{metrics_json}}` from the run's live metric values
- characters 13737-15363: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15406-17910: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17966-19070: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Trust and Transition Repair | 2 |
