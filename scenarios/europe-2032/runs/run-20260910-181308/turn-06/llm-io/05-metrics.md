...
- characters 13454-13644: `{{metrics_json}}` from the run's live metric values
- characters 13737-14938: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14981-17016: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17072-17908: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | ASML Sovereignty Shield | 2 |
| M7 | Essential Services Continuity Pact | 2 |
