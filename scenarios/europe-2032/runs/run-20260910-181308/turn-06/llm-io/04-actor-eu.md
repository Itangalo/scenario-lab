...
- characters 1696-3731: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5179-5635: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8149-10498: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | Essential Services Continuity Pact | 6 | small | 5 | 7 | own jurisdiction | resilience up materially, public_sentiment up slightly, eu_political_capital up slightly via visible delivery | 2 | running |
