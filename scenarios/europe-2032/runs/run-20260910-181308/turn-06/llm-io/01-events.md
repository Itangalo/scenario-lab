...
- characters 374-1575: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1618-3653: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3709-4197: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4260-28636: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28991-29645: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, ASML Sovereignty Shield −2, Essential Services Continuity Pact −2, priority −1 = −11
PROPOSAL BONUS: Essential Services Continuity Pact (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 4, sentiment 8 -> +1
SOVEREIGNTY: 16 last turn, no capacity event finish, Gigafactories in flight +0, eu_frontier_access_denied t5 −3, capability rose 1.0 −0 = 13
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, bio_uplift_findings, automated_decision_scandal
- Turn 2 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, bio_uplift_findings, emergent_cyber_insurance_pullback
- Turn 3 (3 turn(s) ago): cyber_major_incident, knowledge_work_augmented, taiwan_tension_rise, automated_decision_scandal
- Turn 4 (2 turn(s) ago): supply_chain_coercion
- Turn 5 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied, member_state_defection, emergent_anti_ai_direct_action, emergent_anti_ai_site_blockades, election_consolidation
