...
- characters 375-1595: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1639-3612: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3668-4513: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4576-28858: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29213-29957: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: M1 InvestAI Gigafactories −3, M6 ASML Sovereignty Shield −2, M7 Essential Services Continuity Pact −2, priority M7 −1 = −8
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 3 -> +1 capped, applied in capital total
SOVEREIGNTY: 13 last turn, Tech sovereignty package finishes t6 +4, no in-flight bonus, supply_chain_coercion t6 −3 (largest of two capacity events, member_state_defection also qualifies), capability rose 1.0 −0 = 14

## Emerging developments (tracked)

- `emergent_tiered_access_selloff` -- first noted turn 6, listed in 1 turn(s) so far: A major US lab announces tiered foreign pricing and throttled inference speeds for lower-tier allies, with contract terms leaking early and triggering pre-emptive hoarding and resale of API quotas by European intermediaries.
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, bio_uplift_findings, automated_decision_scandal
- Turn 2 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, bio_uplift_findings, emergent_cyber_insurance_pullback
- Turn 3 (4 turn(s) ago): cyber_major_incident, knowledge_work_augmented, taiwan_tension_rise, automated_decision_scandal
- Turn 4 (3 turn(s) ago): supply_chain_coercion
- Turn 5 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied, member_state_defection, emergent_anti_ai_direct_action, emergent_anti_ai_site_blockades, election_consolidation
- Turn 6 (1 turn(s) ago): opaque_reasoning, supply_chain_coercion, member_state_defection
