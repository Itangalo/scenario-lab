...
- characters 106-13662: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13705-13895: `{{metrics_json}}` from the run's live metric values
- characters 13988-15208: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15252-17225: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17281-18126: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Joint Threat Response Accession | 2 |
