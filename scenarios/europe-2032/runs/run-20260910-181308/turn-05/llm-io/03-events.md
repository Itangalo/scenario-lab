...
- characters 376-2091: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2135-4416: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4472-5587: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5650-31907: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32262-32651: `{{event_history}}` from the run's own event record
...
- `emergent_anti_ai_direct_action` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated physical protests and blockades targeting data centre construction sites and municipal AI deployments spread across several member states, fuelled by benefits scandal and low trust.
- `emergent_anti_ai_site_blockades` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated physical protests and blockades targeting data-centre construction sites and municipal AI deployments spread across several member states, turning anti-AI sentiment into sustained local disruption.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, bio_uplift_findings, automated_decision_scandal
- Turn 2 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, bio_uplift_findings, emergent_cyber_insurance_pullback
- Turn 3 (2 turn(s) ago): cyber_major_incident, knowledge_work_augmented, taiwan_tension_rise, automated_decision_scandal
- Turn 4 (1 turn(s) ago): supply_chain_coercion
