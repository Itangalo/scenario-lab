...
- characters 13764-15479: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15523-17804: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17860-18361: `{{notepad}}` from the Game Master's notepad, carried across turns
