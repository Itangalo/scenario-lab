...
- characters 375-1462: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1506-3782: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3838-4819: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4882-30017: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30372-31639: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: no measures in flight, priority none = -0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 2 -> +0 already at floor, no lend; sentiment below capital after turn, no lend applies
SOVEREIGNTY: 14 last turn, no capacity build finishes, no build in flight +0, middle_power_coalition t10 +2, capability rose 1.0 −0 = 16

## Emerging developments (tracked)

- `emergent_grid_strain_blackouts` -- first noted turn 9, listed in 2 turn(s) so far: Prolonged heatwave plus throttled data-centre power and postponed grid maintenance trigger rolling blackouts in two member states, blamed publicly on AI electricity demand and US quota throttling.
- `emergent_power_rationing_backlash` -- first noted turn 9, listed in 2 turn(s) so far: Municipal utilities impose rolling throttling of data-centre power and public inference endpoints after autumn load spikes, triggering localized blackouts and queueing for public services.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, bio_uplift_findings, automated_decision_scandal
- Turn 2 (9 turn(s) ago): cyber_major_incident, loss_of_control_incident, bio_uplift_findings, emergent_cyber_insurance_pullback
- Turn 3 (8 turn(s) ago): cyber_major_incident, knowledge_work_augmented, taiwan_tension_rise, automated_decision_scandal
- Turn 4 (7 turn(s) ago): supply_chain_coercion
- Turn 5 (6 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied, member_state_defection, emergent_anti_ai_direct_action, emergent_anti_ai_site_blockades, election_consolidation
- Turn 6 (5 turn(s) ago): opaque_reasoning, supply_chain_coercion, member_state_defection
- Turn 7 (4 turn(s) ago): capability_jump, knowledge_work_augmented, embodied_ai_deployment, eu_frontier_access_denied, joint_threat_response
- Turn 8 (3 turn(s) ago): cyber_major_incident, openweight_frontier_release, export_control_escalation, emergent_tiered_access_selloff
- Turn 9 (2 turn(s) ago): knowledge_work_augmented, member_state_defection
- Turn 10 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, middle_power_coalition
