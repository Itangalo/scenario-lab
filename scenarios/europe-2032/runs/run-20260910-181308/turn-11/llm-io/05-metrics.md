...
- characters 107-12931: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12974-13163: `{{metrics_json}}` from the run's live metric values
- characters 13256-14343: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14387-16663: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16719-17102: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Essential Services Keep-Running Cells | 2 |
