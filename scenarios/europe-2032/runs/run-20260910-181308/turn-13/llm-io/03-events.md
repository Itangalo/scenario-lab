...
- characters 375-1295: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1339-3346: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3402-4406: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4469-27245: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27600-29116: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M9 EU Essential Services Keep-Running Cells −2 = −2, priority has no effect below capital 20 and is not charged
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2.0, sentiment 2.0 -> none, capital not lower
SOVEREIGNTY: 16 last turn, no category 4 finish, no category 4 in flight +0, export_control_escalation t12 −2, capability rose 0.5 −0 = 14

## Emerging developments (tracked)

- `emergent_energy_priority_standoff` -- first noted turn 12, listed in 1 turn(s) so far: Coordinated municipal diesel-generator cooperatives in the two blackout states refuse to release backup power to data centres during peak heat, triggering localised standoffs over grid priority.
- `emergent_therapy_licence_squeeze` -- first noted turn 12, listed in 1 turn(s) so far: A foreign frontier provider abruptly tightens clinical-use licensing for its biomedical models, requiring per-patient clearance that delays tailored therapies in EU hospitals reliant on them.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, bio_uplift_findings, automated_decision_scandal
- Turn 2 (11 turn(s) ago): cyber_major_incident, loss_of_control_incident, bio_uplift_findings, emergent_cyber_insurance_pullback
- Turn 3 (10 turn(s) ago): cyber_major_incident, knowledge_work_augmented, taiwan_tension_rise, automated_decision_scandal
- Turn 4 (9 turn(s) ago): supply_chain_coercion
- Turn 5 (8 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied, member_state_defection, emergent_anti_ai_direct_action, emergent_anti_ai_site_blockades, election_consolidation
- Turn 6 (7 turn(s) ago): opaque_reasoning, supply_chain_coercion, member_state_defection
- Turn 7 (6 turn(s) ago): capability_jump, knowledge_work_augmented, embodied_ai_deployment, eu_frontier_access_denied, joint_threat_response
- Turn 8 (5 turn(s) ago): cyber_major_incident, openweight_frontier_release, export_control_escalation, emergent_tiered_access_selloff
- Turn 9 (4 turn(s) ago): knowledge_work_augmented, member_state_defection
- Turn 10 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, middle_power_coalition
- Turn 11 (2 turn(s) ago): capability_jump, bio_uplift_findings, medical_breakthrough, openweight_frontier_release, emergent_grid_strain_blackouts
- Turn 12 (1 turn(s) ago): catastrophic_bio_incident, export_control_escalation, us_china_agreement
...
IMPORTANT: For events with date-specific conditions (e.g., "September 2026 is included"), check if the current time period (July-December 2032) covers that date.
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.36}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.08}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.18}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.05}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.14}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.075}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Coordinated municipal diesel-generator cooperatives in the two blackout states refuse to release backup power to data centres during peak heat, triggering localised standoffs over grid priority.", "emergent": true, "id": "emergent_energy_priority_standoff", "probability": 0.28}, {"description": "A foreign frontier provider abruptly tightens clinical-use licensing for its biomedical models, requiring per-patient clearance that delays tailored therapies in EU hospitals reliant on them.", "emergent": true, "id": "emergent_therapy_licence_squeeze", "probability": 0.32}]
```
