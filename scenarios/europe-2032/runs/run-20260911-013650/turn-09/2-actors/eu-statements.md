...
- `two_year_commitment` (commitment): Rebuild public trust by making AI decisions accountable while keeping essential services running

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild public trust by making AI decisions accountable while keeping essential services running
