...
- characters 454-1459: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1502-3583: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4277-4741: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6198-8242: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M3 | EU Critical Infrastructure Shield | 6 | large | 1 | 3 | own jurisdiction | resilience up substantially, ai_safety up slightly | 3 | running |
