...
- characters 13385-15724: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15768-18068: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18124-18985: `{{notepad}}` from the Game Master's notepad, carried across turns
