...
- characters 377-2716: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2760-5060: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5116-6305: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6368-33916: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34271-34464: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough
- Turn 2 (3 turn(s) ago): loss_of_control_incident
- Turn 4 (1 turn(s) ago): embodied_ai_deployment, member_state_defection
