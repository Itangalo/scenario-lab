...
- characters 455-2794: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2838-5138: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7704-8168: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10359-12537: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Embodied-AI Resilience Pact | 6 | small | 4 | 6 | own jurisdiction | resilience up, eu_ai_sovereignty up slightly | 2 | running |
