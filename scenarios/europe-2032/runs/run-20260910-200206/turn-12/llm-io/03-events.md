...
- characters 375-2262: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2305-4242: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4298-4726: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4789-32591: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32946-34083: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU AI Displacement Income and Retraining Guarantee −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 17, sentiment 2 -> none, capital higher
SOVEREIGNTY: 20 last turn, no category 4 finish, no capacity in-flight bonus, eu_frontier_access_denied t11 −2 (largest of two capacity events, member_state_defection also qualifies), capability rose 3.0 −1 = 17
...
- Turn 2 (10 turn(s) ago): loss_of_control_incident
- Turn 4 (8 turn(s) ago): embodied_ai_deployment, member_state_defection
- Turn 5 (7 turn(s) ago): cyber_major_incident, loss_of_control_incident, member_state_defection, emergent_agent_insurance_freeze, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, research_breakthrough, medical_breakthrough
- Turn 7 (5 turn(s) ago): cyber_major_incident, eval_anomaly_reports, embodied_ai_deployment
- Turn 8 (4 turn(s) ago): capability_jump, eval_anomaly_reports, embodied_ai_deployment, us_labs_nationalised, eu_frontier_access_denied
- Turn 9 (3 turn(s) ago): cyber_major_incident, capability_jump, us_china_agreement, eu_frontier_access_denied
- Turn 10 (2 turn(s) ago): capability_jump, bio_uplift_findings, medical_breakthrough, openweight_frontier_release, labour_displacement, eu_frontier_access_denied, automated_decision_scandal
- Turn 11 (1 turn(s) ago): research_breakthrough, openweight_frontier_release, eu_frontier_access_denied, member_state_defection, emergent_datacentre_blockade_wave
