...
- characters 106-13348: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13391-13581: `{{metrics_json}}` from the run's live metric values
- characters 13674-15561: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15604-17541: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17597-18351: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Degraded-Mode Continuity and Local Restoration Pact | 2 |
...
## Metrics
```json
{"ai_capability": 96.0, "openweight_capability": 89.0, "ai_safety": 0.0, "resilience": 50.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 13.0, "public_sentiment": 1.0}
```
