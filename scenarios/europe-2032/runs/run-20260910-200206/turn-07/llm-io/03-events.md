...
- characters 377-1781: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1825-3834: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3890-4420: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4483-33110: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33465-33904: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough
- Turn 2 (5 turn(s) ago): loss_of_control_incident
- Turn 4 (3 turn(s) ago): embodied_ai_deployment, member_state_defection
- Turn 5 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, member_state_defection, emergent_agent_insurance_freeze, election_consolidation
- Turn 6 (1 turn(s) ago): cyber_major_incident, research_breakthrough, medical_breakthrough
