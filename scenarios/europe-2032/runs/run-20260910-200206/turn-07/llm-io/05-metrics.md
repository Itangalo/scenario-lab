...
- characters 106-13526: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13569-13761: `{{metrics_json}}` from the run's live metric values
- characters 13854-15258: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15302-17311: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17367-18188: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | EU Public-Service Cyber Failover and Restoration Corps | 2 |
...
## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M7", "fields": {"finish_turn": 8}, "grounds": "named priority"}]}
```
```
