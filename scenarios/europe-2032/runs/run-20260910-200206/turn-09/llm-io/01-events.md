...
- characters 377-1376: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1420-3473: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3529-4438: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4501-32763: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33118-33787: `{{event_history}}` from the run's own event record
...
- `emergent_eu_grid_crunch` -- first noted turn 7, listed in 2 turn(s) so far: A coordinated winter power crunch forces several member states to curtail data-centre and pilot-rack electricity use, turning compute scarcity into rolling brownout politics.
...
- Turn 2 (7 turn(s) ago): loss_of_control_incident
- Turn 4 (5 turn(s) ago): embodied_ai_deployment, member_state_defection
- Turn 5 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, member_state_defection, emergent_agent_insurance_freeze, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, research_breakthrough, medical_breakthrough
- Turn 7 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, embodied_ai_deployment
- Turn 8 (1 turn(s) ago): capability_jump, eval_anomaly_reports, embodied_ai_deployment, us_labs_nationalised, eu_frontier_access_denied
