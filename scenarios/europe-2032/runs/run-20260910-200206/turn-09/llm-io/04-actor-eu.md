...
- characters 455-1454: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1498-3551: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5585-6032: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8701-10577: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Essential Services Model Substitution Programme | 4 | small | 8 | 10 | own jurisdiction | eu_ai_sovereignty up slightly, resilience up | 2 | running |
