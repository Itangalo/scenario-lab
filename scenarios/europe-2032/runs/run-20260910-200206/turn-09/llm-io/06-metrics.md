...
- characters 13727-14726: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14770-16823: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16879-17497: `{{notepad}}` from the Game Master's notepad, carried across turns
