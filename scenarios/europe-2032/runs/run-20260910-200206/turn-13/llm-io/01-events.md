...
- characters 376-2135: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2179-4713: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4769-5553: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5616-33418: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33773-34999: `{{event_history}}` from the run's own event record
...
- `emergent_clinical_exodus` -- first noted turn 12, listed in 1 turn(s) so far: Coordinated cross-border movement of EU clinicians and trial patients to US and Asian clinics offering AI-tailored cures unavailable in Europe becomes publicly visible, straining health budgets and staffing.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough
- Turn 2 (11 turn(s) ago): loss_of_control_incident
- Turn 4 (9 turn(s) ago): embodied_ai_deployment, member_state_defection
- Turn 5 (8 turn(s) ago): cyber_major_incident, loss_of_control_incident, member_state_defection, emergent_agent_insurance_freeze, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, research_breakthrough, medical_breakthrough
- Turn 7 (6 turn(s) ago): cyber_major_incident, eval_anomaly_reports, embodied_ai_deployment
- Turn 8 (5 turn(s) ago): capability_jump, eval_anomaly_reports, embodied_ai_deployment, us_labs_nationalised, eu_frontier_access_denied
- Turn 9 (4 turn(s) ago): cyber_major_incident, capability_jump, us_china_agreement, eu_frontier_access_denied
- Turn 10 (3 turn(s) ago): capability_jump, bio_uplift_findings, medical_breakthrough, openweight_frontier_release, labour_displacement, eu_frontier_access_denied, automated_decision_scandal
- Turn 11 (2 turn(s) ago): research_breakthrough, openweight_frontier_release, eu_frontier_access_denied, member_state_defection, emergent_datacentre_blockade_wave
- Turn 12 (1 turn(s) ago): cyber_major_incident, capability_jump, member_state_defection
