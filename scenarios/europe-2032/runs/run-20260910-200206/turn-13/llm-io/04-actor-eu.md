...
- characters 454-2213: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2257-4791: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7852-8323: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11300-13246: `{{previous_actions}}` from the actor's own response from the previous turn
