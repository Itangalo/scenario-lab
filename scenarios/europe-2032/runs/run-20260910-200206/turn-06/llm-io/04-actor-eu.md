...
- characters 454-1500: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1543-3822: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6024-6471: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8663-10300: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Embodied-AI Resilience Pact | 6 | small | 4 | 7 | own jurisdiction | resilience up, eu_ai_sovereignty up slightly | 2 | running |
