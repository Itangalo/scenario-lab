...
- characters 105-13577: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13620-13812: `{{metrics_json}}` from the run's live metric values
- characters 13905-14951: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14994-17273: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17329-17744: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Sovereign Resilience Cloud Reserve | 2 |
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Transition Safety Net −2, EU Embodied-AI Resilience Pact −2, priority −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 24, sentiment 32 -> +2
SOVEREIGNTY: 16 last turn, no capacity finish, Gigafactories + Tech package in flight +0, member_state_defection t5 −2, capability rose 3.0 −1 = 13
...
## Notepad
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, EU Embodied-AI Resilience Pact −2, EU Sovereign Resilience Cloud Reserve −2, priority −1 = −8
PROPOSAL BONUS: EU Sovereign Resilience Cloud Reserve (cat 4, small) +3 — autumn ransomware sweep and port-agent containment plus US tiered-access warning and side-deal defection directly answered
LEGITIMACY LENDS: capital 17, sentiment 25 -> +2
SOVEREIGNTY: 13 last turn, Tech sovereignty package finishes t6 +5, Gigafactories in flight +1, no capacity event, capability rose 3.0 −1 = 18
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 elected consolidation platform takes office turn 6"}]}
```
```
