...
- characters 376-1796: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1840-4120: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4176-5072: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5135-32937: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33292-34264: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Major Cyber Incident Containment Cell −2, EU AI Displacement Income and Retraining Guarantee −2, priority −1 = −5
PROPOSAL BONUS: EU AI Displacement Income and Retraining Guarantee (cat 7, small) +3 — labour_displacement landed this turn and automated_decision_scandal landed this turn and this answers both directly
LEGITIMACY LENDS: capital 18, sentiment 2 -> none, capital higher
SOVEREIGNTY: 19 last turn, EU Essential Services Model Substitution Programme finishes t10 +4, no capacity in-flight bonus, eu_frontier_access_denied t10 −2, capability rose 6.0 −1 = 20

## Emerging developments (tracked)

- `emergent_datacentre_blockade_wave` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated physical protests and blockades target new datacentre and grid-upgrade sites in several member states, delaying reserve capacity expansion for substitution stacks.
...
- Turn 2 (9 turn(s) ago): loss_of_control_incident
- Turn 4 (7 turn(s) ago): embodied_ai_deployment, member_state_defection
- Turn 5 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident, member_state_defection, emergent_agent_insurance_freeze, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, research_breakthrough, medical_breakthrough
- Turn 7 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, embodied_ai_deployment
- Turn 8 (3 turn(s) ago): capability_jump, eval_anomaly_reports, embodied_ai_deployment, us_labs_nationalised, eu_frontier_access_denied
- Turn 9 (2 turn(s) ago): cyber_major_incident, capability_jump, us_china_agreement, eu_frontier_access_denied
- Turn 10 (1 turn(s) ago): capability_jump, bio_uplift_findings, medical_breakthrough, openweight_frontier_release, labour_displacement, eu_frontier_access_denied, automated_decision_scandal
