...
- characters 107-13336: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13379-13569: `{{metrics_json}}` from the run's live metric values
- characters 13662-15082: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15126-17406: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17462-18055: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU AI Displacement Income and Retraining Guarantee | 2 |
