...
- characters 376-1416: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1459-3109: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3165-3954: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4017-32644: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32999-33531: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU Sovereign Resilience Cloud Reserve −2, EU Public-Service Cyber Failover and Restoration Corps −2, priority −1 = −5
PROPOSAL BONUS: EU Public-Service Cyber Failover and Restoration Corps (cat 6, small) +3 — cyber_major_incident this turn plus spring dependency sweep directly answered
LEGITIMACY LENDS: capital 21, sentiment 18 -> none, capital higher
SOVEREIGNTY: 18 last turn, InvestAI Gigafactories finishes t7 +5, embodied_ai_deployment t7 −2, capability rose 3.0 −1 = 20

## Emerging developments (tracked)

- `emergent_eu_grid_crunch` -- first noted turn 7, listed in 1 turn(s) so far: A coordinated winter power crunch forces several member states to curtail data-centre and pilot-rack electricity use, turning compute scarcity into rolling brownout politics.
...
- Turn 2 (6 turn(s) ago): loss_of_control_incident
- Turn 4 (4 turn(s) ago): embodied_ai_deployment, member_state_defection
- Turn 5 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, member_state_defection, emergent_agent_insurance_freeze, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, research_breakthrough, medical_breakthrough
- Turn 7 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, embodied_ai_deployment
