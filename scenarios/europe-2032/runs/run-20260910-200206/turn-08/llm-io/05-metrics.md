...
- characters 105-13410: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13453-13645: `{{metrics_json}}` from the run's live metric values
- characters 13738-14778: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14821-16471: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16527-17316: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | EU Essential Services Model Substitution Programme | 2 |
