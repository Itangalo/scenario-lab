...
- characters 376-1922: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1965-3760: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3816-4349: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4412-31356: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31711-31831: `{{event_history}}` from the run's own event record
