...
- characters 13450-13640: `{{metrics_json}}` from the run's live metric values
- characters 13733-15343: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15386-17270: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17326-18104: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Major Cyber Incident Containment Cell | 2 |
