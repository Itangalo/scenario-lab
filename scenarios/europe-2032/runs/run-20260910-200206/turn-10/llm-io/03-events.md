...
- characters 375-1985: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2028-3912: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3968-4443: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4506-32308: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32663-33443: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): loss_of_control_incident
- Turn 4 (6 turn(s) ago): embodied_ai_deployment, member_state_defection
- Turn 5 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, member_state_defection, emergent_agent_insurance_freeze, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, research_breakthrough, medical_breakthrough
- Turn 7 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, embodied_ai_deployment
- Turn 8 (2 turn(s) ago): capability_jump, eval_anomaly_reports, embodied_ai_deployment, us_labs_nationalised, eu_frontier_access_denied
- Turn 9 (1 turn(s) ago): cyber_major_incident, capability_jump, us_china_agreement, eu_frontier_access_denied
