...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio-Uplift Interdiction and Care Continuity Sprint", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected"}, "grounds": "to close bio gate and hold services through jump"}
  - Grounds: to close bio gate and hold services through jump
