...
| M11 | EU Bio-Uplift Interdiction and Care Continuity Sprint | 6 | small | 12 | 14 | own jurisdiction | resilience up moderately, ai_safety protected | 2 | running |
| M12 | EU Loss-of-Control Isolation and Essential Continuity Protocol | 6 | small | 13 | 15 | own jurisdiction | resilience up moderately, ai_safety protected | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Loss-of-Control Isolation and Essential Continuity Protocol", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected"}, "grounds": "to contain rogue-agent spread after cutoff"}
  - Grounds: to contain rogue-agent spread after cutoff
