...
| M12 | EU Bio-Cyber Continuity and Care Corps | 6 | small | 11 | 12 | own jurisdiction | resilience up substantially, ai_safety up slightly via containment and detection | 2 | finished |
| M13 | EU Breakthrough Assurance Deployment | 5 | small | 12 | 13 | own jurisdiction | ai_safety up substantially, resilience up via cyber defence shift | 2 | finished |
| M14 | EU Fallback Guard and Repair Compact | 6 | small | 13 | 15 | own jurisdiction | resilience up to stop cascade, eu_political_capital protected | 2 | running |
...
- **applied** `M14` — {"op": "add", "table": "measures", "fields": {"name": "EU Fallback Guard and Repair Compact", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up to stop cascade, eu_political_capital protected"}, "grounds": "keep fallback alive through sabotage wave"}
  - Grounds: keep fallback alive through sabotage wave
