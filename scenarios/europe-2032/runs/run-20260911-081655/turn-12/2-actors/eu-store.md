...
| M13 | EU Breakthrough Assurance Deployment | 5 | small | 12 | 14 | own jurisdiction | ai_safety up substantially, resilience up via cyber defence shift | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Breakthrough Assurance Deployment", "category": 5, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "ai_safety up substantially, resilience up via cyber defence shift"}, "grounds": "deploy safety and cyber breakthroughs before window closes"}
  - Grounds: deploy safety and cyber breakthroughs before window closes
