...
| M12 | EU Bio-Cyber Continuity and Care Corps | 6 | small | 11 | 13 | own jurisdiction | resilience up substantially, ai_safety up slightly via containment and detection | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio-Cyber Continuity and Care Corps", "category": 6, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "resilience up substantially, ai_safety up slightly via containment and detection"}, "grounds": "combined bio release and major cyber incident requires immediate continuity response"}
  - Grounds: combined bio release and major cyber incident requires immediate continuity response
