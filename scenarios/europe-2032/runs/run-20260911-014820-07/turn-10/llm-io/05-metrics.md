...
- characters 106-13556: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13599-13789: `{{metrics_json}}` from the run's live metric values
- characters 13882-14875: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14918-17236: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17292-18228: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Middle-Power Supply and Evaluation Coalition | 2 |
| M11 | EU Wartime Energy-Continuity and Infrastructure Protection Regime | 2 |
...
- `emergent_robot_seizure_litigation` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated municipal lawsuits across several member states seek injunctions to seize or disconnect Chinese-built humanoids in ports after the pilot-site fires, creating a de facto impoundment crisis.
