...
- characters 375-1368: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1411-3729: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3785-4393: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4456-33236: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33591-34528: `{{event_history}}` from the run's own event record
...
- Turn 7 (3 turn(s) ago): openweight_frontier_release, labour_displacement, adoption_success, emergent_robot_backlash_bans
- Turn 8 (2 turn(s) ago): rsi_onset, labour_displacement, embodied_ai_deployment, member_state_defection
- Turn 9 (1 turn(s) ago): medical_breakthrough, member_state_defection, middle_power_coalition
