...
- characters 1984-4169: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5897-6339: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9267-11529: `{{previous_actions}}` from the actor's own response from the previous turn
