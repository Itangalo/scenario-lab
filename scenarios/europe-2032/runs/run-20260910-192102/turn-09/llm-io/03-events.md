...
- characters 377-1862: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1906-4091: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4147-5182: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5245-30363: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30718-31333: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Opaque-Model Inspection and Bio-Screening Lab −2, priority −1 = −3
PROPOSAL BONUS: EU Opaque-Model Inspection and Bio-Screening Lab (cat 5, small) +3 — opaque_reasoning and bio_uplift_findings landed this turn and this answers both directly
LEGITIMACY LENDS: capital 36, sentiment 21 -> none, capital is higher
SOVEREIGNTY: 17 last turn, no cat4 finishes, M10 cat5 in flight +0, embodied_ai_deployment t8 −2, capability rose 2.0 −1 = 14

## Emerging developments (tracked)

- `emergent_clinical_validation_strike` -- first noted turn 7, listed in 2 turn(s) so far: Hospital radiology backlogs and triage pauses after US cut-off trigger coordinated clinician refusal to validate AI outputs, forcing temporary return to manual review across several member states.
- `emergent_grid_connection_revolt` -- first noted turn 7, listed in 2 turn(s) so far: Municipal bans on new data-centre grid connections spread after the epidemic winter, with two regions imposing moratoria that stall pooled EU inference expansion.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, loss_of_control_incident, emergent_datacentre_blockade
- Turn 3 (6 turn(s) ago): bio_uplift_findings, emergent_kimi_exploit_kits
- Turn 4 (5 turn(s) ago): member_state_defection
- Turn 5 (4 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, election_retrenchment
- Turn 6 (3 turn(s) ago): bio_incident, capability_jump, rsi_onset, eu_frontier_access_denied, cyber_defence_breakthrough
- Turn 7 (2 turn(s) ago): medical_breakthrough, safety_breakthrough, us_china_agreement
- Turn 8 (1 turn(s) ago): bio_uplift_findings, opaque_reasoning, embodied_ai_deployment
