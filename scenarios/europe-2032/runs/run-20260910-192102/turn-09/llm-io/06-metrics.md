...
- characters 106-13398: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13441-13633: `{{metrics_json}}` from the run's live metric values
- characters 13726-15211: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15255-17440: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17496-17956: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Loss-of-Control Containment and Continuity Regime | 2 |
...
## Metrics
```json
{"ai_capability": 76.5, "openweight_capability": 72.0, "ai_safety": 9.0, "resilience": 47.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 38.0, "public_sentiment": 18.0}
```
## Narrative
