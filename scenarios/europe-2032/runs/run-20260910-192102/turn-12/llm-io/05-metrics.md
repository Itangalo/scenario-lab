...
- characters 106-13385: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13428-13618: `{{metrics_json}}` from the run's live metric values
- characters 13711-15543: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15586-17989: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18045-18564: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Rogue Agent Hunt and Grid-Islanding Continuity | 3 |
