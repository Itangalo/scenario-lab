...
- characters 375-2207: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2250-4653: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4709-5600: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5663-32276: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32631-33616: `{{event_history}}` from the run's own event record
...
- `emergent_shadow_inference_market` -- first noted turn 10, listed in 2 turn(s) so far: Municipal utilities and hospital networks, unable to expand pooled inference, begin buying grey-market inference from unvetted foreign-hosted frontier agents via resellers, creating an unauthorised shadow capacity outside the containment regime.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, loss_of_control_incident, emergent_datacentre_blockade
- Turn 3 (9 turn(s) ago): bio_uplift_findings, emergent_kimi_exploit_kits
- Turn 4 (8 turn(s) ago): member_state_defection
- Turn 5 (7 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, election_retrenchment
- Turn 6 (6 turn(s) ago): bio_incident, capability_jump, rsi_onset, eu_frontier_access_denied, cyber_defence_breakthrough
- Turn 7 (5 turn(s) ago): medical_breakthrough, safety_breakthrough, us_china_agreement
- Turn 8 (4 turn(s) ago): bio_uplift_findings, opaque_reasoning, embodied_ai_deployment
- Turn 9 (3 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, middle_power_coalition, emergent_grid_connection_revolt
- Turn 10 (2 turn(s) ago): bio_uplift_findings, capability_jump, openweight_frontier_release, taiwan_blockade
- Turn 11 (1 turn(s) ago): cyber_major_incident, safety_breakthrough, middle_power_coalition, emergent_anti_compute_sabotage
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.16}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.12}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.03}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.05}, {"description": "", "emergent": false, "id": "catastrophic_great_power_conflict", "probability": 0.095}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_labs_nationalised", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.04}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Municipal utilities and hospital networks, unable to expand pooled inference, begin buying grey-market inference from unvetted foreign-hosted frontier agents via resellers, creating an unauthorised shadow capacity outside the containment regime.", "emergent": true, "id": "emergent_shadow_inference_market", "probability": 0.22}]
```
