...
- characters 455-1629: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1673-3841: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5705-6164: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8503-10627: `{{previous_actions}}` from the actor's own response from the previous turn
