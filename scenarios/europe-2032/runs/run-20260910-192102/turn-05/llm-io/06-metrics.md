...
- characters 13761-14935: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14979-17147: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17203-18317: `{{notepad}}` from the Game Master's notepad, carried across turns
