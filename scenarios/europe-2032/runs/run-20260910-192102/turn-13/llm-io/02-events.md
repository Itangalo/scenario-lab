...
- characters 376-2681: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2725-4565: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4621-5066: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5129-32490: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32845-33918: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Rogue Agent Hunt and Grid-Islanding Continuity −3, priority −1 = −4
PROPOSAL BONUS: EU Rogue Agent Hunt and Grid-Islanding Continuity (cat 6, large) +6 — catastrophic loss-of-control plus leaked eval anomaly landed this turn and this answers them directly
LEGITIMACY LENDS: capital 47, sentiment 3 -> none, capital is higher
SOVEREIGNTY: 13 last turn, no capacity event, no cat4 in flight +0, capability rose 1.5 −1 = 12
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, loss_of_control_incident, emergent_datacentre_blockade
- Turn 3 (10 turn(s) ago): bio_uplift_findings, emergent_kimi_exploit_kits
- Turn 4 (9 turn(s) ago): member_state_defection
- Turn 5 (8 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, election_retrenchment
- Turn 6 (7 turn(s) ago): bio_incident, capability_jump, rsi_onset, eu_frontier_access_denied, cyber_defence_breakthrough
- Turn 7 (6 turn(s) ago): medical_breakthrough, safety_breakthrough, us_china_agreement
- Turn 8 (5 turn(s) ago): bio_uplift_findings, opaque_reasoning, embodied_ai_deployment
- Turn 9 (4 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, middle_power_coalition, emergent_grid_connection_revolt
- Turn 10 (3 turn(s) ago): bio_uplift_findings, capability_jump, openweight_frontier_release, taiwan_blockade
- Turn 11 (2 turn(s) ago): cyber_major_incident, safety_breakthrough, middle_power_coalition, emergent_anti_compute_sabotage
- Turn 12 (1 turn(s) ago): eval_anomaly_reports, catastrophic_loss_of_control_incident
