...
- characters 1384-3414: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3482-3941: `{{statement_ledger}}` from the actor's live statement ledger
- characters 5429-7533: `{{previous_actions}}` from the actor's own response from the previous turn
