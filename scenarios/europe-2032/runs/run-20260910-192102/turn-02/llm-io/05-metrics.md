...
- characters 13428-14315: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14358-16388: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16444-17440: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_kimi_exploit_kits` -- first noted turn 1, listed in 2 turn(s) so far: Underground forums circulate ready-to-run offensive toolkits derived from Kimi K3, sharply lowering the skill needed to attack industrial control systems.
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 50.5, "ai_safety": 30.0, "resilience": 37.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 28.0, "public_sentiment": 37.0}
```
