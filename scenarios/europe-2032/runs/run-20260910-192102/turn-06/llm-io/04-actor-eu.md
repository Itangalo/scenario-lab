...
- characters 1705-3983: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5682-6124: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8629-10693: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Essential Services Continuity Stack | 6 | small | 5 | 7 | own jurisdiction | resilience up, eu_ai_sovereignty up slightly via substitution | 2 | running |
