...
- characters 107-13399: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13442-13633: `{{metrics_json}}` from the run's live metric values
- characters 13726-15000: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15044-17205: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17261-18141: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Major-Incident Restoration and Assured Systems Rollout | 2 |
