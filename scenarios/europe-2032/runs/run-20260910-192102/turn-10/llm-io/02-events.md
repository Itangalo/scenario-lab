...
- characters 376-1481: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1524-3872: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3928-4377: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4440-30725: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31080-31829: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, loss_of_control_incident, emergent_datacentre_blockade
- Turn 3 (7 turn(s) ago): bio_uplift_findings, emergent_kimi_exploit_kits
- Turn 4 (6 turn(s) ago): member_state_defection
- Turn 5 (5 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, election_retrenchment
- Turn 6 (4 turn(s) ago): bio_incident, capability_jump, rsi_onset, eu_frontier_access_denied, cyber_defence_breakthrough
- Turn 7 (3 turn(s) ago): medical_breakthrough, safety_breakthrough, us_china_agreement
- Turn 8 (2 turn(s) ago): bio_uplift_findings, opaque_reasoning, embodied_ai_deployment
- Turn 9 (1 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, middle_power_coalition, emergent_grid_connection_revolt
