...
- characters 454-1559: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1602-3950: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5485-5946: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9065-11434: `{{previous_actions}}` from the actor's own response from the previous turn
