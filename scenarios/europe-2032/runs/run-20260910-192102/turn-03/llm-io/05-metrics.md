...
- characters 106-13498: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13541-13733: `{{metrics_json}}` from the run's live metric values
- characters 13826-15315: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15359-16857: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16913-17433: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU OT Intrusion Reporting and Shared Detection Network | 2 |
| M5 | EU Bio-Shield and OT Emergency Patch Surge | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Hardening and Response Pact −3, EU OT Intrusion Reporting and Shared Detection Network −2, priority −1 = −12
PROPOSAL BONUS: EU OT Intrusion Reporting and Shared Detection Network (cat 2, small) +2 — autumn rehearsal intrusion landed last turn and this answers it directly
