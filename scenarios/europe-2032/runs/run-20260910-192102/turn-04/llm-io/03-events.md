...
- characters 376-2098: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2141-4450: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4506-5030: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5093-32037: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32392-32563: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, loss_of_control_incident, emergent_datacentre_blockade
- Turn 3 (1 turn(s) ago): bio_uplift_findings, emergent_kimi_exploit_kits
