...
- characters 105-13599: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13642-13834: `{{metrics_json}}` from the run's live metric values
- characters 13927-15649: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15692-18001: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18057-19224: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Jurisdiction Lock for Foreign AI Capacity Deals | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU OT Intrusion Reporting and Shared Detection Network −2, EU Bio-Shield and OT Emergency Patch Surge −2, priority −1 = −11
PROPOSAL BONUS: EU Bio-Shield and OT Emergency Patch Surge (cat 6, small) +3 — bio uplift precursor and circulating ICS kits landed this turn and this answers them directly
