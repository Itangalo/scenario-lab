...
- characters 106-13642: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13685-13877: `{{metrics_json}}` from the run's live metric values
- characters 13970-15482: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15526-17951: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18007-19171: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Assured Cures Deployment | 2 |
...
## Metrics
```json
{"ai_capability": 72.0, "openweight_capability": 67.0, "ai_safety": 17.0, "resilience": 51.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 36.0, "public_sentiment": 21.0}
```
