...
- characters 377-1889: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1933-4358: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4414-5003: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5066-32388: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32743-33182: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, loss_of_control_incident, emergent_datacentre_blockade
- Turn 3 (4 turn(s) ago): bio_uplift_findings, emergent_kimi_exploit_kits
- Turn 4 (3 turn(s) ago): member_state_defection
- Turn 5 (2 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, election_retrenchment
- Turn 6 (1 turn(s) ago): bio_incident, capability_jump, rsi_onset, eu_frontier_access_denied, cyber_defence_breakthrough
