...
- characters 376-2197: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2240-4141: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4197-5254: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5317-31133: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31488-32015: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU Assured Cures Deployment −2, priority −1 = −3
PROPOSAL BONUS: EU Assured Cures Deployment (cat 9, small) +4 — answers winter modified-pathogen casualties and US access cut-off within last three turns, plus pairs medical and safety breakthroughs directly
LEGITIMACY LENDS: capital 25, sentiment 16 -> none, capital is higher
SOVEREIGNTY: 13 last turn, InvestAI Gigafactories finishes t7 +5, no capacity event, no cat4 in flight +0, capability rose 2.0 −1 = 17

## Emerging developments (tracked)

- `emergent_clinical_validation_strike` -- first noted turn 7, listed in 1 turn(s) so far: Hospital radiology backlogs and triage pauses after US cut-off trigger coordinated clinician refusal to validate AI outputs, forcing temporary return to manual review across several member states.
- `emergent_grid_connection_revolt` -- first noted turn 7, listed in 1 turn(s) so far: Municipal bans on new data-centre grid connections spread after the epidemic winter, with two regions imposing moratoria that stall pooled EU inference expansion.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, loss_of_control_incident, emergent_datacentre_blockade
- Turn 3 (5 turn(s) ago): bio_uplift_findings, emergent_kimi_exploit_kits
- Turn 4 (4 turn(s) ago): member_state_defection
- Turn 5 (3 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, election_retrenchment
- Turn 6 (2 turn(s) ago): bio_incident, capability_jump, rsi_onset, eu_frontier_access_denied, cyber_defence_breakthrough
- Turn 7 (1 turn(s) ago): medical_breakthrough, safety_breakthrough, us_china_agreement
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.12}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.03}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.05}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_labs_nationalised", "probability": 0.04}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.04}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Hospital radiology backlogs and triage pauses after US cut-off trigger coordinated clinician refusal to validate AI outputs, forcing temporary return to manual review across several member states.", "emergent": true, "id": "emergent_clinical_validation_strike", "probability": 0.18}, {"description": "Municipal bans on new data-centre grid connections spread after the epidemic winter, with two regions imposing moratoria that stall pooled EU inference expansion.", "emergent": true, "id": "emergent_grid_connection_revolt", "probability": 0.22}]
```
