...
- characters 105-13377: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13420-13612: `{{metrics_json}}` from the run's live metric values
- characters 13705-15526: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15569-17470: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17526-18583: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Opaque-Model Inspection and Bio-Screening Lab | 2 |
