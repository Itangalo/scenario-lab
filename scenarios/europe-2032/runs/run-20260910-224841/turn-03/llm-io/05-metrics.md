...
- characters 106-13232: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13275-13467: `{{metrics_json}}` from the run's live metric values
- characters 13560-14817: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14861-17964: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18020-19199: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Continuity and Fallback Shield | 2 |
| M5 | EU Biosecurity Screening and Assurance Uptake | 2 |
