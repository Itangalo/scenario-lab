...
- characters 7274-7714: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9168-11259: `{{previous_actions}}` from the actor's own response from the previous turn
