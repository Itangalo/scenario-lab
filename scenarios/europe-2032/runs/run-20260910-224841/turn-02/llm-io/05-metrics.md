...
- characters 105-13172: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13215-13407: `{{metrics_json}}` from the run's live metric values
- characters 13500-14667: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14710-16965: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17021-18022: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 59.0, "openweight_capability": 50.5, "ai_safety": 24.0, "resilience": 37.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 16.0, "public_sentiment": 30.0}
```
