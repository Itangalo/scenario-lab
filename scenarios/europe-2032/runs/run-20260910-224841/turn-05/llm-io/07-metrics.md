...
- characters 106-13576: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13619-13811: `{{metrics_json}}` from the run's live metric values
- characters 13904-14618: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14662-16560: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16616-17162: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Pandemic Continuity and AI-Bio Containment Surge | 2 |
