...
- characters 377-1091: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1135-3033: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3089-3635: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3698-31168: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31523-31818: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Biosecurity Screening and Assurance Uptake −2, EU Public Services Cyber Recovery and Hardening Surge −2, priority M5 −1 = −11
PROPOSAL BONUS: EU Public Services Cyber Recovery and Hardening Surge (cat 6, small) +3 — cyber_major_incident severe and current this turn and this answers it directly
LEGITIMACY LENDS: capital 21, sentiment 28 -> +2, capped by sentiment
...
- Turn 2 (3 turn(s) ago): capability_jump, us_china_agreement, eu_frontier_access_denied, supply_chain_coercion, automated_decision_scandal
- Turn 3 (2 turn(s) ago): bio_uplift_findings, safety_breakthrough
