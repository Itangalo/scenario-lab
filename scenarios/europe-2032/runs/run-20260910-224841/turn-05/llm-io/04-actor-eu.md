...
- characters 455-1169: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1213-3111: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6719-7159: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9390-11374: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Public Services Cyber Recovery and Hardening Surge | 6 | small | 4 | 6 | own jurisdiction | resilience up, eu_political_capital protection | 2 | running |
...
| M5 | EU Biosecurity Screening and Assurance Uptake | 5 | small | 3 | 5 | own jurisdiction | ai_safety up, resilience up modestly | 2 | finished |
