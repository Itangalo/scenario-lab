...
- characters 105-13714: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13757-13949: `{{metrics_json}}` from the run's live metric values
- characters 14042-15094: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15137-17213: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17269-17874: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Public Services Cyber Recovery and Hardening Surge | 2 |
...
## Metrics
```json
{"ai_capability": 65.5, "openweight_capability": 58.6, "ai_safety": 28.0, "resilience": 39.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 23.0, "public_sentiment": 22.0}
```
