...
| M8 | EU Accession Track to the US-China AI Risk Accord | 8 | small | 7 | 9 | coalition and supply-chain partners with US and China | ai_safety up modestly, eu_ai_sovereignty protected/up modestly, eu_political_capital protected | 2 | running |
...
- **applied** `M8` — {"op": "add", "table": "measures", "fields": {"name": "EU Accession Track to the US-China AI Risk Accord", "category": 8, "size": "small", "finish_turn": 9, "applies_to": "coalition and supply-chain partners with US and China", "targeted_effect": "ai_safety up modestly, eu_ai_sovereignty protected/up modestly, eu_political_capital protected"}, "grounds": "US-China agreement window that decides inc
  - Grounds: US-China agreement window that decides inclusion versus notification
