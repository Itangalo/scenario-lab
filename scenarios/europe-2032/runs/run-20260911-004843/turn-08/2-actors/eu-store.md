...
| M8 | EU Accession Track to the US-China AI Risk Accord | 8 | small | 7 | 8 | coalition and supply-chain partners with US and China | ai_safety up modestly, eu_ai_sovereignty protected/up modestly, eu_political_capital protected | 2 | finished |
| M9 | EU Assurance Upgrade and Anomaly Triage Cell | 5 | small | 8 | 9 | own jurisdiction | ai_safety up, resilience protected | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Assurance Upgrade and Anomaly Triage Cell", "category": 5, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "ai_safety up, resilience protected"}, "grounds": "deployable safety breakthrough plus eval anomaly with no in-flight capacity"}
  - Grounds: deployable safety breakthrough plus eval anomaly with no in-flight capacity
