...
- `two_year_commitment` (commitment): Rebuild societal resilience and livelihood security in a world of uncontrollable frontier AI

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild societal resilience and livelihood security in a world of uncontrollable frontier AI
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the commitment period directly ends the timeframe for the original statement, enabling a strategic shift.
