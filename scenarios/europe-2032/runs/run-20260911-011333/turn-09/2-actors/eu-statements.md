...
- `two_year_commitment` (commitment): Rebuild public trust by fixing public-sector AI and hardening essentials

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild public trust by fixing public-sector AI and hardening essentials
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the timeframe for the original statement, making its continuation obsolete.
