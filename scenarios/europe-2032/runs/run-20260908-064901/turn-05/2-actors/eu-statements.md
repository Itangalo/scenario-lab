...
- `two_year_commitment` (commitment): European AI sovereignty as a foundation for strategic autonomy and controlled capability growth

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: European AI sovereignty as a foundation for strategic autonomy and controlled capability growth
