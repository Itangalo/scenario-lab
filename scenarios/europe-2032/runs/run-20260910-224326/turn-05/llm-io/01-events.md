...
- characters 377-1377: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1421-3549: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3605-4179: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4242-31790: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32145-32440: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Displaced Worker Transition Fund −2, EU Essential Services AI Continuity Shield −2, priority −1 = −11
PROPOSAL BONUS: EU Essential Services AI Continuity Shield (cat 6, small) +4 — eu_frontier_access_denied landed this turn hitting hospitals/ministries plus grid forensics repricing, this answers both directly
LEGITIMACY LENDS: capital 15, sentiment 24 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, Gigafactories in flight +0, eu_frontier_access_denied t4 −3, capability rose 3.0 −1 = 15
...
- Turn 2 (3 turn(s) ago): automated_decision_scandal
- Turn 3 (2 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, labour_displacement
- Turn 4 (1 turn(s) ago): bio_uplift_findings, eu_frontier_access_denied, emergent_grid_forensics_fallout
