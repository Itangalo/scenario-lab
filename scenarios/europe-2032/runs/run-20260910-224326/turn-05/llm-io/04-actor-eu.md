...
- characters 455-1455: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1499-3627: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5004-5444: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7676-9551: `{{previous_actions}}` from the actor's own response from the previous turn
