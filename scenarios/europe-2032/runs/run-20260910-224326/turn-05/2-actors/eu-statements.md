...
- `two_year_commitment` (commitment): Ensure essential services survive AI disruption while rebuilding EU-controlled capacity they can run on

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Ensure essential services survive AI disruption while rebuilding EU-controlled capacity they can run on
