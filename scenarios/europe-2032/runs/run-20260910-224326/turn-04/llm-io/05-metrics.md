...
- characters 105-13715: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13758-13950: `{{metrics_json}}` from the run's live metric values
- characters 14043-15544: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15587-17667: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17723-18253: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Essential Services AI Continuity Shield | 2 |
