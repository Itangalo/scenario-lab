...
- characters 454-1621: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1664-3919: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5310-5750: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7204-9295: `{{previous_actions}}` from the actor's own response from the previous turn
