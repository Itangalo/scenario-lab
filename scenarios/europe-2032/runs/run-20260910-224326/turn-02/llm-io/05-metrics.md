...
- characters 13502-14669: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14712-16967: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17023-18049: `{{notepad}}` from the Game Master's notepad, carried across turns
