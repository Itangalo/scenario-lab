...
- `two_year_commitment` (commitment): Build independent European AI capacity to secure strategic autonomy

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Build independent European AI capacity to secure strategic autonomy
