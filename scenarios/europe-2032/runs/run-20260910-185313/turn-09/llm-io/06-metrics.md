...
- characters 13680-14949: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14993-17077: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17133-17709: `{{notepad}}` from the Game Master's notepad, carried across turns
