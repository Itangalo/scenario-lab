...
- characters 454-1723: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1767-3851: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6297-6775: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9519-11645: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Augmentation Dividend Diffusion Pact | 9 | small | 7 | 10 | own jurisdiction | public_sentiment up, resilience up slightly | 2 | running |
| M9 | EU Essential Services Continuity Switch | 6 | small | 8 | 10 | own jurisdiction | resilience up, public_sentiment up slightly | 2 | running |
