...
- characters 1689-3773: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3829-4709: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4772-30519: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30874-31761: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, member_state_defection
- Turn 2 (7 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented
- Turn 3 (6 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, emergent_research_integrity_pact
- Turn 4 (5 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, eu_frontier_access_denied, middle_power_coalition
- Turn 5 (4 turn(s) ago): embodied_ai_deployment, export_control_escalation, automated_decision_scandal, joint_threat_response, election_alliance
- Turn 6 (3 turn(s) ago): loss_of_control_incident, bio_uplift_findings, labour_displacement
- Turn 7 (2 turn(s) ago): loss_of_control_incident, knowledge_work_augmented
- Turn 8 (1 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, us_china_agreement, eu_frontier_access_denied, emergent_anti_datacentre_blockades
