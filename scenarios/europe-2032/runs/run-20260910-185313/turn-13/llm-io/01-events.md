...
- characters 378-2841: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2885-4664: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4720-5759: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5822-32422: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32777-34089: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M11 EU Bio-Uplift Screening Surge −2, priority M11 no effect below 20 −0 = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 8, sentiment 13 -> +1 (sentiment above capital, capped below sentiment)
SOVEREIGNTY: 19 last turn, no capacity event, no category 4 in flight +0, capability rose 1.0 −0 = 19

## Emerging developments (tracked)

- `emergent_unofficial_civic_fork` -- first noted turn 11, listed in 2 turn(s) so far: A coalition of European telecom operators and open-source collectives launches an unofficial verified civic-messaging fork that undercuts the Shield's wallet inbox on usability, splitting adoption and creating a parallel trust anchor outside state control.
- `emergent_substation_sabotage_escalation` -- first noted turn 11, listed in 2 turn(s) so far: A coordinated physical attack on substations or fibre interchanges linked to anti-datacentre blockades knocks out power or connectivity in one region for days, turning protest into infrastructure sabotage.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, member_state_defection
- Turn 2 (11 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented
- Turn 3 (10 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, emergent_research_integrity_pact
- Turn 4 (9 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, eu_frontier_access_denied, middle_power_coalition
- Turn 5 (8 turn(s) ago): embodied_ai_deployment, export_control_escalation, automated_decision_scandal, joint_threat_response, election_alliance
- Turn 6 (7 turn(s) ago): loss_of_control_incident, bio_uplift_findings, labour_displacement
- Turn 7 (6 turn(s) ago): loss_of_control_incident, knowledge_work_augmented
- Turn 8 (5 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, us_china_agreement, eu_frontier_access_denied, emergent_anti_datacentre_blockades
- Turn 9 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 10 (3 turn(s) ago): capability_jump, openweight_frontier_release, emergent_municipal_impersonation_fraud_wave
- Turn 11 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, knowledge_work_augmented
