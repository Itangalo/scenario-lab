...
- characters 13910-15001: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15044-18013: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18069-18623: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t5: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M5 Emergency Municipal Service Restoration Pact −2, M6 Robotics Displacement Transition Shield −2, priority −1 = −11
PROPOSAL BONUS: Robotics Displacement Transition Shield (cat 7, small) +3 — embodied_ai_deployment landed this turn displacing logistics work and this answers it directly
LEGITIMACY LENDS: capital 5, sentiment 18 -> +2
SOVEREIGNTY: 16 last turn, no capacity event finishes, M1/M2 in flight +0, export_control_escalation t5 −2, capability rose 1.0 −0 = 14
