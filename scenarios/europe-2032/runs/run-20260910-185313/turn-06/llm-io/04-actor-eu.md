...
- characters 1588-4557: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6202-6680: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8967-11851: `{{previous_actions}}` from the actor's own response from the previous turn
