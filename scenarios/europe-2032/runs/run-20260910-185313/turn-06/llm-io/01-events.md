...
- characters 376-1467: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1510-4479: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4535-5402: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5465-32115: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32470-33033: `{{event_history}}` from the run's own event record
...
- `emergent_open_toolkit_proliferation` -- first noted turn 4, listed in 2 turn(s) so far: A non-state group publishes a ready-to-run intrusion toolkit distilled from a recent open-weight model, with municipal utilities and hospitals in several countries scanned within days.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, member_state_defection
- Turn 2 (4 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented
- Turn 3 (3 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, emergent_research_integrity_pact
- Turn 4 (2 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, eu_frontier_access_denied, middle_power_coalition
- Turn 5 (1 turn(s) ago): embodied_ai_deployment, export_control_escalation, automated_decision_scandal, joint_threat_response, election_alliance
