...
- characters 106-13050: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13093-13285: `{{metrics_json}}` from the run's live metric values
- characters 13378-14947: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14991-16885: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16941-17288: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t2: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Infrastructure Cyber Shield −3, priority −1 = −10
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 19, sentiment 43 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, M1/M2 in flight +0, capability rose 2.0 −1 = 18
