...
- characters 377-1946: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1990-3884: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3940-4925: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4988-29215: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29570-29742: `{{event_history}}` from the run's own event record
...
- `emergent_provenance_mandate` -- first noted turn 1, listed in 2 turn(s) so far: Major EU scientific publishers and universities jointly mandate provenance watermarking and AI-use disclosure for submitted papers after the Millennium Prize controversy, triggering a short-lived replication panic over AI-assisted proofs.
- `emergent_research_integrity_pact` -- first noted turn 1, listed in 2 turn(s) so far: Major European scientific publishers and universities jointly mandate disclosure and audit trails for AI-assisted research after the Millennium Prize claim triggers reproducibility disputes.
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, member_state_defection
- Turn 2 (1 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented
