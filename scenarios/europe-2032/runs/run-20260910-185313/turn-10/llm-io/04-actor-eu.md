...
- characters 453-1467: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1510-3338: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4459-4906: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7500-9506: `{{previous_actions}}` from the actor's own response from the previous turn
