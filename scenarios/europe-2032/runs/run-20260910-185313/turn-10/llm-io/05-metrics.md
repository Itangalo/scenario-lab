...
- characters 106-13438: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13481-13671: `{{metrics_json}}` from the run's live metric values
- characters 13764-14778: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14821-16649: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16705-17154: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t9: M8 EU Augmentation Dividend Diffusion Pact −2, M9 EU Essential Services Continuity Switch −2, priority M9 −1 = −5
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2, sentiment 14 -> +2
SOVEREIGNTY: 21 last turn, no category 4 finish, no category 4 in flight +0, eu_frontier_access_denied t9 −2 (largest of two capacity events, member_state_defection also qualifies), capability rose 1.0 −0 = 19
...
**emergent_municipal_impersonation_fraud_wave (emergent event):** A coordinated AI-generated fraud wave impersonating municipal health and benefits offices spreads across several member states, triggering emergency telecom countermeasures and further eroding trust in digital public services.
