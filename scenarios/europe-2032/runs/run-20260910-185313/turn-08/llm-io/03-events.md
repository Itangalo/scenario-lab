...
- characters 376-1250: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1293-3801: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3857-4982: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5045-32298: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32653-33386: `{{event_history}}` from the run's own event record
...
- `emergent_anti_datacentre_blockades` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated blockades of gigafactory and data-centre construction sites in France and the Netherlands by displaced warehouse and white-collar worker networks, halting permitting works for weeks.
- `emergent_siting_blockade_wave` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated municipal blockades of data-centre power hookups in France and the Netherlands force temporary construction halts, spreading anti-AI siting tactics across member states.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, member_state_defection
- Turn 2 (6 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented
- Turn 3 (5 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, emergent_research_integrity_pact
- Turn 4 (4 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, eu_frontier_access_denied, middle_power_coalition
- Turn 5 (3 turn(s) ago): embodied_ai_deployment, export_control_escalation, automated_decision_scandal, joint_threat_response, election_alliance
- Turn 6 (2 turn(s) ago): loss_of_control_incident, bio_uplift_findings, labour_displacement
- Turn 7 (1 turn(s) ago): loss_of_control_incident, knowledge_work_augmented
