...
- characters 1371-3879: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7163-7641: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10235-12464: `{{previous_actions}}` from the actor's own response from the previous turn
