...
- characters 13332-13523: `{{metrics_json}}` from the run's live metric values
- characters 13616-15745: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15788-17968: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18024-19247: `{{notepad}}` from the Game Master's notepad, carried across turns
