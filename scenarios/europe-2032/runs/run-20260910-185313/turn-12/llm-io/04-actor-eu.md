...
- characters 454-2583: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2626-4806: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5380-5827: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8869-10908: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Bio-Uplift Screening Surge | 6 | small | 11 | 13 | own jurisdiction | resilience up slightly, ai_safety up slightly | 2 | running |
