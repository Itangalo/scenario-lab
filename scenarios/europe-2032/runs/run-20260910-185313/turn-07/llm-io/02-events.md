...
- characters 1925-4072: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4128-4686: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4749-32002: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32357-33013: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, member_state_defection
- Turn 2 (5 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented
- Turn 3 (4 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, emergent_research_integrity_pact
- Turn 4 (3 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, eu_frontier_access_denied, middle_power_coalition
- Turn 5 (2 turn(s) ago): embodied_ai_deployment, export_control_escalation, automated_decision_scandal, joint_threat_response, election_alliance
- Turn 6 (1 turn(s) ago): loss_of_control_incident, bio_uplift_findings, labour_displacement
