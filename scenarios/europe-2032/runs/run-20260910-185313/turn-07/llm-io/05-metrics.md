...
- characters 106-13407: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13450-13642: `{{metrics_json}}` from the run's live metric values
- characters 13735-15239: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15283-17430: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17486-18633: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M6 | Robotics Displacement Transition Shield | 2 |
