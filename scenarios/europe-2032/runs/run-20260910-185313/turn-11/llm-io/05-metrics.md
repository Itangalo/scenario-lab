...
- characters 107-12962: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13005-13196: `{{metrics_json}}` from the run's live metric values
- characters 13289-15120: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15164-17204: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17260-18389: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Trusted Civic Channel Shield | 2 |
| M11 | EU Bio-Uplift Screening Surge | 2 |
...
PORTFOLIO CHARGE t10: M10 EU Trusted Civic Channel Shield −2, priority M10 −1 = −3
PROPOSAL BONUS: EU Trusted Civic Channel Shield (cat 6, small) +3 — emergent_municipal_impersonation_fraud_wave landed this turn severe multi-state trust collapse and this answers it directly
LEGITIMACY LENDS: capital 12, sentiment 7 -> none — capital is higher
SOVEREIGNTY: 19 last turn, no capacity event, no category 4 in flight +0, capability rose 1.5 −0 = 19
