...
- characters 377-2208: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2252-4292: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4348-4794: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4857-31457: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31812-32980: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, member_state_defection
- Turn 2 (9 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented
- Turn 3 (8 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, emergent_research_integrity_pact
- Turn 4 (7 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, eu_frontier_access_denied, middle_power_coalition
- Turn 5 (6 turn(s) ago): embodied_ai_deployment, export_control_escalation, automated_decision_scandal, joint_threat_response, election_alliance
- Turn 6 (5 turn(s) ago): loss_of_control_incident, bio_uplift_findings, labour_displacement
- Turn 7 (4 turn(s) ago): loss_of_control_incident, knowledge_work_augmented
- Turn 8 (3 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, us_china_agreement, eu_frontier_access_denied, emergent_anti_datacentre_blockades
- Turn 9 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 10 (1 turn(s) ago): capability_jump, openweight_frontier_release, emergent_municipal_impersonation_fraud_wave
