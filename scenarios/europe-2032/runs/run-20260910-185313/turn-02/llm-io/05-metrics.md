...
- characters 105-12995: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13038-13230: `{{metrics_json}}` from the run's live metric values
- characters 13323-14550: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14593-16982: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17038-18150: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 50.0, "ai_safety": 30.0, "resilience": 37.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 21.0, "public_sentiment": 43.0}
```
