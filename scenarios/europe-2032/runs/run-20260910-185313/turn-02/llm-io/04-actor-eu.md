...
- characters 1724-4113: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5546-6024: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7506-9779: `{{previous_actions}}` from the actor's own response from the previous turn
