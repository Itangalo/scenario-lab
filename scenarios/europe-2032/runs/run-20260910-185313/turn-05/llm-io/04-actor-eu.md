...
- characters 2223-4454: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8643-9121: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11258-13537: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | Emergency Municipal Service Restoration Pact | 6 | small | 4 | 6 | own jurisdiction | resilience up materially | 2 | running |
