...
- characters 2145-4376: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4432-5281: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5344-33829: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34184-34601: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, member_state_defection
- Turn 2 (3 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented
- Turn 3 (2 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, emergent_research_integrity_pact
- Turn 4 (1 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, eu_frontier_access_denied, middle_power_coalition
