...
- characters 106-13479: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13522-13714: `{{metrics_json}}` from the run's live metric values
- characters 13807-15531: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15575-17806: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17862-18711: `{{notepad}}` from the Game Master's notepad, carried across turns
