...
- characters 106-12987: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13030-13222: `{{metrics_json}}` from the run's live metric values
- characters 13315-14946: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14989-17032: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17088-17596: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Care Continuity and Cross-Border Medical Surge | 2 |
| M11 | EU Bio Containment and Care Shield | 2 |
