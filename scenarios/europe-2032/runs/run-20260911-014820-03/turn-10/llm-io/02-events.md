...
- characters 2051-4094: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4150-4658: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4721-29037: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29392-30043: `{{event_history}}` from the run's own event record
...
- Turn 7 (3 turn(s) ago): bio_uplift_findings
- Turn 8 (2 turn(s) ago): cyber_major_incident, taiwan_blockade, adoption_success
- Turn 9 (1 turn(s) ago): cyber_major_incident, ai_investment_collapse, member_state_defection, emergent_continuity_care_crisis
