...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Distressed Compute Consolidation", "category": 4, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "eu_ai_sovereignty up moderately, resilience up slightly via secured sites"}, "grounds": "investment collapse creates buyable capacity"}
  - Grounds: investment collapse creates buyable capacity
