...
- `two_year_commitment` (commitment): Contain distributed misuse and keep essential services standing through the bio-cyber window

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Contain distributed misuse and keep essential services standing through the bio-cyber window
