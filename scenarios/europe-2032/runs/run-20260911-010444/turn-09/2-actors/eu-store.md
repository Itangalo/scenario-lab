...
| M9 | EU Distressed Compute Consolidation | 4 | small | 8 | 10 | own jurisdiction | eu_ai_sovereignty up moderately, resilience up slightly via secured sites | 2 | running |
| M10 | EU Distributed-Capability Containment Surge | 6 | small | 9 | 11 | own jurisdiction | resilience up moderately, ai_safety loss contained | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Distributed-Capability Containment Surge", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety loss contained"}, "grounds": "openweight frontier release and bio precursor demand immediate containment"}
  - Grounds: openweight frontier release and bio precursor demand immediate containment
