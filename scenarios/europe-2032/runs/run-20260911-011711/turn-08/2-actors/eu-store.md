...
- **applied** `M6` — {"op": "add", "table": "measures", "fields": {"name": "EU Public Services Cyber Recovery Pact", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, public_sentiment up modestly"}, "grounds": "major automated attack plus lapsed siting requires visible recovery first"}
  - Grounds: major automated attack plus lapsed siting requires visible recovery first
