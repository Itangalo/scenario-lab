...
| M13 | EU Bio-Uplift Detection and Hospital Shield Surge | 6 | small | 12 | 13 | own jurisdiction plus coalition partners in joint command/pact | resilience up, ai_safety up slightly via reduced bio misuse harm | 2 | finished |
| M14 | EU Trusted Municipal AI and First-Job Re-entry Pact | 9 | small | 13 | 16 | own jurisdiction | public_sentiment up, eu_political_capital up slightly via visible benefit and union cooperation | 2 | running |
...
- **applied** `M14` — {"op": "add", "table": "measures", "fields": {"name": "EU Trusted Municipal AI and First-Job Re-entry Pact", "category": 9, "size": "small", "finish_turn": 16, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, eu_political_capital up slightly via visible benefit and union cooperation"}, "grounds": "capital and sentiment collapsed while no measures in flight"}
  - Grounds: capital and sentiment collapsed while no measures in flight
