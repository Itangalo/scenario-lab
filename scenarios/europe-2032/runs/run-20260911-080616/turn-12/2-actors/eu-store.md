...
| M13 | EU Bio-Uplift Detection and Hospital Shield Surge | 6 | small | 12 | 14 | own jurisdiction plus coalition partners in joint command/pact | resilience up, ai_safety up slightly via reduced bio misuse harm | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio-Uplift Detection and Hospital Shield Surge", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction plus coalition partners in joint command/pact", "targeted_effect": "resilience up, ai_safety up slightly via reduced bio misuse harm"}, "grounds": "bio gate open for next 4 turns while safety collapsed"}
  - Grounds: bio gate open for next 4 turns while safety collapsed
