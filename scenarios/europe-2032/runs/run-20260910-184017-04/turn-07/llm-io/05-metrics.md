...
- characters 13563-14727: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14771-17361: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17417-18488: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Spares and Service Continuity Pool | 2 |
| M8 | EU Essential-Service AI Freeze Drill | 2 |
...
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, EU Spares and Service Continuity Pool −2, priority −0 (capital below 20, no effect no cost) = −5
PROPOSAL BONUS: EU Spares and Service Continuity Pool (cat 6, small) +3 — spares licensing freeze and maintenance slippage from last two turns, this answers directly
LEGITIMACY LENDS: capital 12, sentiment 21 -> +2
SOVEREIGNTY: 15 last turn, Tech sovereignty package finishes t6 +4, Gigafactories in flight +0, export_control_escalation t6 −2, capability rose 1.5 −0 = 17
