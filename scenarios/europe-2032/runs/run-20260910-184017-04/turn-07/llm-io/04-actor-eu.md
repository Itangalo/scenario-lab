...
- characters 455-1619: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1663-4253: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4880-5375: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7744-10212: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | EU Spares and Service Continuity Pool | 6 | small | 6 | 8 | own jurisdiction | resilience up, eu_ai_sovereignty up slightly | 2 | running |
