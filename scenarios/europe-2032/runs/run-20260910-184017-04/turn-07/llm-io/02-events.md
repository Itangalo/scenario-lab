...
- characters 377-1541: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1585-4175: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4231-4747: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4810-26706: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27061-27634: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, ai_investment_collapse, eval_anomaly_reports, taiwan_tension_rise
- Turn 2 (5 turn(s) ago): safety_breakthrough, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (4 turn(s) ago): supply_chain_coercion
- Turn 4 (3 turn(s) ago): loss_of_control_incident
- Turn 5 (2 turn(s) ago): openweight_frontier_release, us_china_agreement, supply_chain_coercion, emergent_beijing_materials_retaliation, election_consolidation
- Turn 6 (1 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_service_manual_leak
