...
- characters 2070-4028: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6003-6498: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8855-10069: `{{previous_actions}}` from the actor's own response from the previous turn
