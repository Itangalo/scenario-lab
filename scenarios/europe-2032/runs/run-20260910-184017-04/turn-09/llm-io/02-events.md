...
- characters 376-1948: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1992-3950: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4006-4687: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4750-27249: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27604-28400: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Essential-Service AI Freeze Drill −2, priority −0 (capital below 20, no effect no cost) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 11, sentiment 12 -> +1 (capped, sentiment above capital)
SOVEREIGNTY: 19 last turn, no cat4 finish, no cat4 in flight +0, export_control_escalation t8 −2, capability rose 0.7 −0 = 17

## Emerging developments (tracked)

- `emergent_patch_failure_scandal` -- first noted turn 7, listed in 2 turn(s) so far: Hospital technicians using leaked repair manuals with substitute parts trigger a cluster of device malfunctions, forcing an EU-wide review of essential-service repair shields.
...
- Turn 2 (7 turn(s) ago): safety_breakthrough, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (6 turn(s) ago): supply_chain_coercion
- Turn 4 (5 turn(s) ago): loss_of_control_incident
- Turn 5 (4 turn(s) ago): openweight_frontier_release, us_china_agreement, supply_chain_coercion, emergent_beijing_materials_retaliation, election_consolidation
- Turn 6 (3 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_service_manual_leak
- Turn 7 (2 turn(s) ago): capability_jump, member_state_defection
- Turn 8 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, export_control_escalation, emergent_patch_failure_cluster
