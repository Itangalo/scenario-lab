...
- characters 106-13181: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13224-13415: `{{metrics_json}}` from the run's live metric values
- characters 13508-15080: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15124-17082: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17138-17520: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 68.0, "openweight_capability": 61.5, "ai_safety": 17.0, "resilience": 46.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 18.0, "public_sentiment": 4.0}
```
