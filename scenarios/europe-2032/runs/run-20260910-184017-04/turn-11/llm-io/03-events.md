...
- characters 377-1957: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2001-3812: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3868-4720: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4783-28135: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28490-29471: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Essential Services Hardening Corps −2, EU Visible Benefit Adoption Push −2, priority −0 (capital below 20, no effect no cost) = −4
PROPOSAL BONUS: none — EU Visible Benefit Adoption Push (cat 9, small) amplifies adoption_success this turn, which is a positive window not a negative shock to answer
LEGITIMACY LENDS: capital 14, sentiment 7 -> none (capital above sentiment)
SOVEREIGNTY: 16 last turn, no cat4 finish, no cat4 in flight +0, no capacity event, capability rose 0.0 −0 = 16

## Emerging developments (tracked)

- `emergent_containment_playbook_countered` -- first noted turn 10, listed in 1 turn(s) so far: Hospital paper-fallback procedures and substitute-controller manuals leaked from the repair corps circulate widely, letting ransomware crews pre-build bypasses for islanding drills before the corps stands up.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, ai_investment_collapse, eval_anomaly_reports, taiwan_tension_rise
- Turn 2 (9 turn(s) ago): safety_breakthrough, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (8 turn(s) ago): supply_chain_coercion
- Turn 4 (7 turn(s) ago): loss_of_control_incident
- Turn 5 (6 turn(s) ago): openweight_frontier_release, us_china_agreement, supply_chain_coercion, emergent_beijing_materials_retaliation, election_consolidation
- Turn 6 (5 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_service_manual_leak
- Turn 7 (4 turn(s) ago): capability_jump, member_state_defection
- Turn 8 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, export_control_escalation, emergent_patch_failure_cluster
- Turn 9 (2 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release, safety_breakthrough, knowledge_work_augmented
- Turn 10 (1 turn(s) ago): adoption_success
