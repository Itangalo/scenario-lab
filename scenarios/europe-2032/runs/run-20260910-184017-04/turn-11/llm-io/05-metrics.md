...
- characters 107-13253: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13296-13487: `{{metrics_json}}` from the run's live metric values
- characters 13580-15160: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15204-17015: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17071-17923: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Visible Benefit Adoption Push | 2 |
| M11 | EU Bio Detection and Medical Countermeasure Surge | 2 |
...
## Metrics
```json
{"ai_capability": 68.0, "openweight_capability": 66.3, "ai_safety": 24.0, "resilience": 51.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 10.0, "public_sentiment": 3.0}
```
