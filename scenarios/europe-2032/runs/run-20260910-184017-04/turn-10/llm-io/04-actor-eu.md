...
- characters 2165-4479: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4846-5316: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7972-9868: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Essential Services Hardening Corps | 6 | small | 9 | 11 | own jurisdiction | resilience up, public_sentiment up slightly | 2 | running |
