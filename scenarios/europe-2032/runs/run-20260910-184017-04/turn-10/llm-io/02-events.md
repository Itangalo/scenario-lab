...
- characters 2087-4401: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4457-4938: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5001-28353: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28708-29644: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, ai_investment_collapse, eval_anomaly_reports, taiwan_tension_rise
- Turn 2 (8 turn(s) ago): safety_breakthrough, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (7 turn(s) ago): supply_chain_coercion
- Turn 4 (6 turn(s) ago): loss_of_control_incident
- Turn 5 (5 turn(s) ago): openweight_frontier_release, us_china_agreement, supply_chain_coercion, emergent_beijing_materials_retaliation, election_consolidation
- Turn 6 (4 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_service_manual_leak
- Turn 7 (3 turn(s) ago): capability_jump, member_state_defection
- Turn 8 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, export_control_escalation, emergent_patch_failure_cluster
- Turn 9 (1 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release, safety_breakthrough, knowledge_work_augmented
