...
- characters 106-12870: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12913-13104: `{{metrics_json}}` from the run's live metric values
- characters 13197-14865: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14908-17222: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17278-18101: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Essential Services Hardening Corps | 2 |
...
## Metrics
```json
{"ai_capability": 68.0, "openweight_capability": 64.7, "ai_safety": 17.0, "resilience": 47.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 14.0, "public_sentiment": 7.0}
```
## Narrative
### Waiting lists move
