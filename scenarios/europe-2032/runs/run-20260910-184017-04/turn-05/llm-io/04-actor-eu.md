...
- characters 455-1740: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1784-4380: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7236-7699: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9919-11859: `{{previous_actions}}` from the actor's own response from the previous turn
