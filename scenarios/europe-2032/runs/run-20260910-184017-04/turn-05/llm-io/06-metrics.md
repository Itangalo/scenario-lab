...
- characters 13381-13573: `{{metrics_json}}` from the run's live metric values
- characters 13666-14951: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14995-17591: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17647-18434: `{{notepad}}` from the Game Master's notepad, carried across turns
