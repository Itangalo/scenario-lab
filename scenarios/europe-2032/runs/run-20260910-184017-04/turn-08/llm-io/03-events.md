...
- characters 376-1692: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1735-3817: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3873-4946: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5009-27508: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27863-28502: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU Spares and Service Continuity Pool −2, EU Essential-Service AI Freeze Drill −2, priority −0 (capital below 20, no effect no cost) = −4
PROPOSAL BONUS: EU Essential-Service AI Freeze Drill (cat 6, small) +3 — capability_jump landed this turn and this answers it directly with containment drills
LEGITIMACY LENDS: capital 13, sentiment 17 -> +2
SOVEREIGNTY: 17 last turn, InvestAI Gigafactories finishes t7 +5, no in-flight cat4 bonus +0, member_state_defection t7 −2, capability rose 4.0 −1 = 19

## Emerging developments (tracked)

- `emergent_patch_failure_cluster` -- first noted turn 7, listed in 1 turn(s) so far: Patched medical and grid equipment repaired with unofficial parts and open manuals suffers a correlated failure cluster, forcing ward closures and emergency procurement.
- `emergent_patch_failure_scandal` -- first noted turn 7, listed in 1 turn(s) so far: Hospital technicians using leaked repair manuals with substitute parts trigger a cluster of device malfunctions, forcing an EU-wide review of essential-service repair shields.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, ai_investment_collapse, eval_anomaly_reports, taiwan_tension_rise
- Turn 2 (6 turn(s) ago): safety_breakthrough, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (5 turn(s) ago): supply_chain_coercion
- Turn 4 (4 turn(s) ago): loss_of_control_incident
- Turn 5 (3 turn(s) ago): openweight_frontier_release, us_china_agreement, supply_chain_coercion, emergent_beijing_materials_retaliation, election_consolidation
- Turn 6 (2 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_service_manual_leak
- Turn 7 (1 turn(s) ago): capability_jump, member_state_defection
