...
- characters 105-13187: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13230-13422: `{{metrics_json}}` from the run's live metric values
- characters 13515-14831: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14874-16956: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17012-17829: `{{notepad}}` from the Game Master's notepad, carried across turns
