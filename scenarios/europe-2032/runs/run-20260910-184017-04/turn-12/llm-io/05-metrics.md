...
- characters 106-13212: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13255-13446: `{{metrics_json}}` from the run's live metric values
- characters 13539-15145: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15188-17206: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17262-17787: `{{notepad}}` from the Game Master's notepad, carried across turns
