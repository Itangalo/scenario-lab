...
- characters 376-1982: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2025-4043: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4099-4966: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5029-28381: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28736-29829: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Visible Benefit Adoption Push −2, EU Bio Detection and Medical Countermeasure Surge −2, priority −0 (capital below 20, no effect no cost) = −4
PROPOSAL BONUS: EU Bio Detection and Medical Countermeasure Surge (cat 6, small) +2 — bio_uplift_findings opened 4-turn bio window this turn and this answers it directly
LEGITIMACY LENDS: capital 10, sentiment 3 -> none (capital above sentiment)
SOVEREIGNTY: 16 last turn, no cat4 finish, no cat4 in flight +0, no capacity event, capability rose 0.0 −0 = 16

## Emerging developments (tracked)

- `emergent_containment_playbook_countered` -- first noted turn 10, listed in 2 turn(s) so far: Hospital paper-fallback procedures and substitute-controller manuals leaked from the repair corps circulate widely, letting ransomware crews pre-build bypasses for islanding drills before the corps stands up.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, ai_investment_collapse, eval_anomaly_reports, taiwan_tension_rise
- Turn 2 (10 turn(s) ago): safety_breakthrough, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (9 turn(s) ago): supply_chain_coercion
- Turn 4 (8 turn(s) ago): loss_of_control_incident
- Turn 5 (7 turn(s) ago): openweight_frontier_release, us_china_agreement, supply_chain_coercion, emergent_beijing_materials_retaliation, election_consolidation
- Turn 6 (6 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_service_manual_leak
- Turn 7 (5 turn(s) ago): capability_jump, member_state_defection
- Turn 8 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, export_control_escalation, emergent_patch_failure_cluster
- Turn 9 (3 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release, safety_breakthrough, knowledge_work_augmented
- Turn 10 (2 turn(s) ago): adoption_success
- Turn 11 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, safety_breakthrough, labour_displacement
