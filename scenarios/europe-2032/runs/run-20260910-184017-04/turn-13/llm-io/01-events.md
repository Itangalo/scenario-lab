...
- characters 376-1704: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1748-3689: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3745-4120: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4183-26723: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27078-28253: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Bio Detection and Medical Countermeasure Surge −2, priority −0 (capital below 20, no effect no cost) = −2
...
- Turn 2 (11 turn(s) ago): safety_breakthrough, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (10 turn(s) ago): supply_chain_coercion
- Turn 4 (9 turn(s) ago): loss_of_control_incident
- Turn 5 (8 turn(s) ago): openweight_frontier_release, us_china_agreement, supply_chain_coercion, emergent_beijing_materials_retaliation, election_consolidation
- Turn 6 (7 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_service_manual_leak
- Turn 7 (6 turn(s) ago): capability_jump, member_state_defection
- Turn 8 (5 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, export_control_escalation, emergent_patch_failure_cluster
- Turn 9 (4 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release, safety_breakthrough, knowledge_work_augmented
- Turn 10 (3 turn(s) ago): adoption_success
- Turn 11 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, safety_breakthrough, labour_displacement
- Turn 12 (1 turn(s) ago): bio_incident, emergent_containment_playbook_countered
