...
- characters 454-1779: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1822-4311: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5315-5780: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8001-9463: `{{previous_actions}}` from the actor's own response from the previous turn
