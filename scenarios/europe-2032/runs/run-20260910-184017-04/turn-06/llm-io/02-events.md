...
- characters 376-1701: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1744-4233: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4289-4953: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5016-23802: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 24157-24619: `{{event_history}}` from the run's own event record
...
LEGITIMACY LENDS: capital 13, sentiment 21 -> +2
SOVEREIGNTY: 18 last turn, no category 4 finish, Gigafactories in flight +0, Tech sovereignty package in flight +0, supply_chain_coercion t5 −3, capability rose 1.0 −0 = 15

## Emerging developments (tracked)

- `emergent_service_manual_leak` -- first noted turn 4, listed in 2 turn(s) so far: ASML field-service engineers in China stage wildcat work stoppages after spare-parts freeze, leaking maintenance manuals that circulate openly and erode service controls.
...
- Turn 2 (4 turn(s) ago): safety_breakthrough, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (3 turn(s) ago): supply_chain_coercion
- Turn 4 (2 turn(s) ago): loss_of_control_incident
- Turn 5 (1 turn(s) ago): openweight_frontier_release, us_china_agreement, supply_chain_coercion, emergent_beijing_materials_retaliation, election_consolidation
