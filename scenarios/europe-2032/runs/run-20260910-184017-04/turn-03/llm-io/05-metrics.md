...
- characters 106-13301: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13344-13536: `{{metrics_json}}` from the run's live metric values
- characters 13629-15288: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15332-17535: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17591-18117: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | European Chokepoint Compact | 3 |
