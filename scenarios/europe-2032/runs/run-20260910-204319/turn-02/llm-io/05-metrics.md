...
- characters 105-13040: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13083-13275: `{{metrics_json}}` from the run's live metric values
- characters 13368-15007: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15050-17430: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17486-18599: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Controllable Core for Essential Services | 3 |
