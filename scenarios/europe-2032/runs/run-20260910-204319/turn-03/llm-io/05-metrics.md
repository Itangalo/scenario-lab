...
- characters 106-13041: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13084-13276: `{{metrics_json}}` from the run's live metric values
- characters 13369-14873: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14917-17179: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17235-17762: `{{notepad}}` from the Game Master's notepad, carried across turns
