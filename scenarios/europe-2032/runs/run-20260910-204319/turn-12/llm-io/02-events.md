...
- characters 376-3350: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3393-5872: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5928-6538: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6601-32652: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33007-34391: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
- Turn 2 (10 turn(s) ago): cyber_major_incident, openweight_frontier_release, safety_breakthrough, taiwan_tension_rise
- Turn 3 (9 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response
- Turn 4 (8 turn(s) ago): taiwan_blockade, bio_uplift_findings, taiwan_tension_rise, supply_chain_coercion
- Turn 5 (7 turn(s) ago): opaque_reasoning, openweight_frontier_release, embodied_ai_deployment, supply_chain_coercion, member_state_defection, adoption_success, emergent_care_ransomware_insurance_crunch, election_consolidation
- Turn 6 (6 turn(s) ago): knowledge_work_augmented, export_control_escalation, eu_frontier_access_denied
- Turn 7 (5 turn(s) ago): cyber_major_incident, openweight_frontier_release, export_control_escalation, emergent_care_insurance_retreat
- Turn 8 (4 turn(s) ago): research_breakthrough, export_control_escalation, adoption_success, emergent_clinical_liability_freeze
- Turn 9 (3 turn(s) ago): ai_investment_collapse, taiwan_tension_rise, eu_frontier_access_denied, member_state_defection
- Turn 10 (2 turn(s) ago): openweight_frontier_release, export_control_escalation
- Turn 11 (1 turn(s) ago): export_control_escalation, automated_decision_scandal
