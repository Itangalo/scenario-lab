...
- characters 13702-16676: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16719-19198: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 19254-19864: `{{notepad}}` from the Game Master's notepad, carried across turns
