...
- characters 13583-16150: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16194-18639: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18695-19389: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_treatment_planning_exclusion` -- first noted turn 13, listed in 1 turn(s) so far: Major EU reinsurers formally extend AI-related exclusions from diagnostic imaging to treatment-planning systems, forcing wider paper reversion and manual triage across oncology and acute care.
...
## Metrics
```json
{"ai_capability": 68.5, "openweight_capability": 66.5, "ai_safety": 7.0, "resilience": 49.5, "eu_ai_sovereignty": 7.0, "eu_political_capital": 4.0, "public_sentiment": 12.0}
```
...
SOVEREIGNTY: 7 last turn, no capacity event, no category 4 finish, no category 4 in flight +0, capability rose 1.0 −0 = 7
## Store changes
```json
{"store": []}
```
