...
- characters 107-13000: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13043-13234: `{{metrics_json}}` from the run's live metric values
- characters 13327-15917: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15961-18294: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18350-18900: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M11 | EU Social-System Algorithm Audit and Redress | 2 |
