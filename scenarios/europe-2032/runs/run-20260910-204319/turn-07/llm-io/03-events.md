...
- characters 377-1924: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1968-4038: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4094-5233: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5296-31088: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31443-32276: `{{event_history}}` from the run's own event record
...
- `emergent_clinical_liability_freeze` -- first noted turn 6, listed in 1 turn(s) so far: Coordinated withdrawal of clinical liability cover for AI-assisted diagnosis by major EU reinsurers after ransomware exclusions, forcing hospitals to switch off certified pilots and revert to manual triage.
- `emergent_care_insurance_retreat` -- first noted turn 6, listed in 1 turn(s) so far: Major EU health insurers jointly refuse to reinsure AI-dependent hospital IT, forcing temporary renationalisation of clinical cyber-risk in two member states.
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
- Turn 2 (5 turn(s) ago): cyber_major_incident, openweight_frontier_release, safety_breakthrough, taiwan_tension_rise
- Turn 3 (4 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response
- Turn 4 (3 turn(s) ago): taiwan_blockade, bio_uplift_findings, taiwan_tension_rise, supply_chain_coercion
- Turn 5 (2 turn(s) ago): opaque_reasoning, openweight_frontier_release, embodied_ai_deployment, supply_chain_coercion, member_state_defection, adoption_success, emergent_care_ransomware_insurance_crunch, election_consolidation
- Turn 6 (1 turn(s) ago): knowledge_work_augmented, export_control_escalation, eu_frontier_access_denied
