...
- characters 13446-13638: `{{metrics_json}}` from the run's live metric values
- characters 13731-15278: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15322-17392: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17448-18341: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | EU Clinical Continuity and Ransomware Response Pact | 2 |
