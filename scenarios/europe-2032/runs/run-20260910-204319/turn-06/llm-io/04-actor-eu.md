...
- characters 453-2036: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2079-4603: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6475-6949: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9297-11963: `{{previous_actions}}` from the actor's own response from the previous turn
