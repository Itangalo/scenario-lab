...
- characters 376-2533: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2576-4435: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4491-5408: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5471-31263: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31618-32587: `{{event_history}}` from the run's own event record
...
- `emergent_clinical_liability_freeze` -- first noted turn 6, listed in 2 turn(s) so far: Coordinated withdrawal of clinical liability cover for AI-assisted diagnosis by major EU reinsurers after ransomware exclusions, forcing hospitals to switch off certified pilots and revert to manual triage.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
- Turn 2 (6 turn(s) ago): cyber_major_incident, openweight_frontier_release, safety_breakthrough, taiwan_tension_rise
- Turn 3 (5 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response
- Turn 4 (4 turn(s) ago): taiwan_blockade, bio_uplift_findings, taiwan_tension_rise, supply_chain_coercion
- Turn 5 (3 turn(s) ago): opaque_reasoning, openweight_frontier_release, embodied_ai_deployment, supply_chain_coercion, member_state_defection, adoption_success, emergent_care_ransomware_insurance_crunch, election_consolidation
- Turn 6 (2 turn(s) ago): knowledge_work_augmented, export_control_escalation, eu_frontier_access_denied
- Turn 7 (1 turn(s) ago): cyber_major_incident, openweight_frontier_release, export_control_escalation, emergent_care_insurance_retreat
