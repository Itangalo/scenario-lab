...
- characters 454-2611: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2654-4513: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6622-7096: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9800-11837: `{{previous_actions}}` from the actor's own response from the previous turn
...
**emergent_clinical_liability_freeze (emergent event):** Coordinated withdrawal of clinical liability cover for AI-assisted diagnosis by major EU reinsurers after ransomware exclusions, forcing hospitals to switch off certified pilots and revert to manual triage.
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Clinical Continuity and Ransomware Response Pact | 6 | small | 7 | 9 | own jurisdiction | resilience up moderately, eu_political_capital protected | 2 | running |
