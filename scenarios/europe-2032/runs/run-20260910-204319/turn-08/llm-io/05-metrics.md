...
- characters 105-13609: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13652-13844: `{{metrics_json}}` from the run's live metric values
- characters 13937-16094: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16137-17996: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18052-18635: `{{notepad}}` from the Game Master's notepad, carried across turns
