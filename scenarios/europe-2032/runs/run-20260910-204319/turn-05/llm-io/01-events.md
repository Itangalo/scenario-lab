...
- characters 1896-4257: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4313-5196: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5259-33026: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33381-33881: `{{event_history}}` from the run's own event record
...
- `emergent_care_ransomware_insurance_crunch` -- first noted turn 4, listed in 1 turn(s) so far: Major European health insurers announce exclusions or steep premium hikes for ransomware-related care delays after the autumn clinic attacks, triggering a public fight over who pays for AI-enabled disruption.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
- Turn 2 (3 turn(s) ago): cyber_major_incident, openweight_frontier_release, safety_breakthrough, taiwan_tension_rise
- Turn 3 (2 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response
- Turn 4 (1 turn(s) ago): taiwan_blockade, bio_uplift_findings, taiwan_tension_rise, supply_chain_coercion
