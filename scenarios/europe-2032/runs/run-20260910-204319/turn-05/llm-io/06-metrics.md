...
- characters 13776-15251: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15295-17656: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17712-18252: `{{notepad}}` from the Game Master's notepad, carried across turns
