...
- characters 1974-4335: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8678-9144: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11304-13417: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU Lithography Leverage Shield | 8 | small | 4 | 6 | own jurisdiction plus middle-power coalition (NL, JP) | eu_ai_sovereignty up moderately, eu_political_capital protected | 2 | running |
