...
- characters 1814-4296: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4352-4747: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4810-29714: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30069-30462: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Controllable Core for Essential Services −3, priority −1 = −13
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 23, sentiment 31 -> +2
SOVEREIGNTY: 18 last turn, export_control_escalation t3 −2, Gigafactories in flight +0, capability rose 2.0 −1 = 15
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
- Turn 2 (2 turn(s) ago): cyber_major_incident, openweight_frontier_release, safety_breakthrough, taiwan_tension_rise
- Turn 3 (1 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response
