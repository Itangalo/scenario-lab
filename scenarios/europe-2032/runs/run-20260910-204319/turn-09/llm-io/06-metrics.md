...
- characters 106-13352: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13395-13587: `{{metrics_json}}` from the run's live metric values
- characters 13680-15953: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15997-18223: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18279-19195: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Clinical AI Liability Backstop and Waiting-List Recovery Programme | 2 |
