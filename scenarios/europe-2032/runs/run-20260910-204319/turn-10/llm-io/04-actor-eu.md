...
- characters 454-2351: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2394-4554: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5336-5815: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8582-10504: `{{previous_actions}}` from the actor's own response from the previous turn
