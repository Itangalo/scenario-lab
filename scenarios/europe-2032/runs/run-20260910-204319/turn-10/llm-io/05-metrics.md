...
- characters 106-13375: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13418-13609: `{{metrics_json}}` from the run's live metric values
- characters 13702-15599: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15642-17802: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17858-18539: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Degraded-Mode Survival and Open-Weights Triage | 2 |
...
PORTFOLIO CHARGE t9: EU Clinical AI Liability Backstop and Waiting-List Recovery Programme −2, priority M9 has no effect and no cost at capital 11 = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 3, sentiment 20 -> +2
SOVEREIGNTY: 17 last turn, no category 4 finish, no category 4 in flight +0, eu_frontier_access_denied t9 −3, capability rose 0.5 −0 = 14
