...
- characters 376-2273: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2316-4476: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4532-5213: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5276-30474: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30829-32048: `{{event_history}}` from the run's own event record
...
- `emergent_reinsurance_contagion` -- first noted turn 9, listed in 1 turn(s) so far: Major EU health reinsurers extend AI-ransomware exclusions from diagnosis to treatment planning and triage software, triggering a second wave of manual reversions.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
- Turn 2 (8 turn(s) ago): cyber_major_incident, openweight_frontier_release, safety_breakthrough, taiwan_tension_rise
- Turn 3 (7 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response
- Turn 4 (6 turn(s) ago): taiwan_blockade, bio_uplift_findings, taiwan_tension_rise, supply_chain_coercion
- Turn 5 (5 turn(s) ago): opaque_reasoning, openweight_frontier_release, embodied_ai_deployment, supply_chain_coercion, member_state_defection, adoption_success, emergent_care_ransomware_insurance_crunch, election_consolidation
- Turn 6 (4 turn(s) ago): knowledge_work_augmented, export_control_escalation, eu_frontier_access_denied
- Turn 7 (3 turn(s) ago): cyber_major_incident, openweight_frontier_release, export_control_escalation, emergent_care_insurance_retreat
- Turn 8 (2 turn(s) ago): research_breakthrough, export_control_escalation, adoption_success, emergent_clinical_liability_freeze
- Turn 9 (1 turn(s) ago): ai_investment_collapse, taiwan_tension_rise, eu_frontier_access_denied, member_state_defection
