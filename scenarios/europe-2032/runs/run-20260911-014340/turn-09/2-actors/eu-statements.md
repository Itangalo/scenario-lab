...
- `two_year_commitment` (commitment): Rebuild trusted European AI for essential services and democratic resilience

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild trusted European AI for essential services and democratic resilience
