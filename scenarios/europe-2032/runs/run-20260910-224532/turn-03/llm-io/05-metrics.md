...
- characters 106-13516: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13559-13751: `{{metrics_json}}` from the run's live metric values
- characters 13844-15220: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15264-17713: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17769-18623: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Sovereign Stack Bargain | 2 |
...
- `emergent_siting_backlash_freeze` -- first noted turn 2, listed in 2 turn(s) so far: Coordinated municipal moratoriums and grid-fee lawsuits stall two to three announced AI factory and data-centre sites, forcing renegotiation of power pledges.
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Sovereign Stack Bargain −2, priority −1 = −12
PROPOSAL BONUS: EU Sovereign Stack Bargain (cat 8, small) +3 — answers bilateral side-deal break and Dutch lithography pressure from last turn and siting injunctions this turn directly
