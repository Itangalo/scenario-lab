...
- characters 13853-15674: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15717-17697: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17753-18256: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | Joint Cyber Shield Membership | 2 |
...
## Metrics
```json
{"ai_capability": 64.0, "openweight_capability": 56.5, "ai_safety": 27.0, "resilience": 42.5, "eu_ai_sovereignty": 16.0, "eu_political_capital": 10.0, "public_sentiment": 36.0}
```
