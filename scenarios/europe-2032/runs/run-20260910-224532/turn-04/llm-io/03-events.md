...
- characters 2240-4220: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4276-5062: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5125-32069: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32424-32651: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): cyber_major_incident, supply_chain_coercion, member_state_defection, adoption_success
- Turn 3 (1 turn(s) ago): adoption_success, emergent_grid_siting_backlash
