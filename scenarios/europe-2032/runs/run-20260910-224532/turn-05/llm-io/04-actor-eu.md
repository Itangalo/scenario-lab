...
- characters 1596-3791: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5716-6156: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8354-10203: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | Joint Cyber Shield Membership | 6 | small | 4 | 6 | own jurisdiction + coalition partners | resilience up | 2 | running |
...
| M5 | EU Sovereign Stack Bargain | 8 | small | 3 | 5 | own jurisdiction + coalition partners | eu_ai_sovereignty up modestly, eu_political_capital up | 2 | finished |
