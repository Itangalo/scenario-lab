...
- characters 106-13506: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13549-13741: `{{metrics_json}}` from the run's live metric values
- characters 13834-14931: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14975-17170: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17226-18416: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_graduate_protests_siting_blockade` -- first noted turn 5, listed in 1 turn(s) so far: Coordinated graduate-led protests across several EU university cities blockade data-centre construction sites and demand hiring guarantees, turning entry-level hiring freezes into sustained street pressure through December.
- `emergent_graduate_protest_blockade` -- first noted turn 5, listed in 1 turn(s) so far: Coordinated graduate protests across several EU capitals target data-centre siting hearings and university career fairs, turning entry-level hiring freezes into sustained street opposition to new compute build-out.
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, Joint Cyber Shield Membership −2, priority −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 6, sentiment 29 -> +2
