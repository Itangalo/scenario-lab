...
- characters 1518-3713: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3769-4295: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4358-31906: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32261-32586: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Sovereign Stack Bargain −2, Joint Cyber Shield Membership −2, priority −1 = −11
PROPOSAL BONUS: Joint Cyber Shield Membership (cat 6, small) +3 — labour displacement and open frontier release landed this turn and this answers brittle municipalities directly, plus takes pooled protection on offer
...
- Turn 2 (3 turn(s) ago): cyber_major_incident, supply_chain_coercion, member_state_defection, adoption_success
- Turn 3 (2 turn(s) ago): adoption_success, emergent_grid_siting_backlash
- Turn 4 (1 turn(s) ago): openweight_frontier_release, labour_displacement, joint_threat_response
