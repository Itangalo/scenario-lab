...
- characters 105-13188: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13231-13423: `{{metrics_json}}` from the run's live metric values
- characters 13516-14683: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14726-16981: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17037-17979: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Grid and Public-Service Cyber Hardening Shield | 2 |
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 50.5, "ai_safety": 30.0, "resilience": 36.5, "eu_ai_sovereignty": 18.0, "eu_political_capital": 18.0, "public_sentiment": 39.0}
```
