...
- characters 5516-5956: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7410-9501: `{{previous_actions}}` from the actor's own response from the previous turn
