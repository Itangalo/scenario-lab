...
- characters 376-2140: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2184-4243: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4299-5289: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5352-28798: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29153-29941: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Trusted Cures Deployment −2, priority −1 = −3
PROPOSAL BONUS: EU Trusted Cures Deployment (cat 9, small) +2 — export_control_escalation landed this turn and this answers dependence directly
LEGITIMACY LENDS: capital 4, sentiment 29 -> +2
SOVEREIGNTY: 19 last turn, no capacity event? export_control_escalation t10 −2, no cat4 in flight +0, capability rose 0.7 −0 = 17

## Emerging developments (tracked)

- `emergent_grid_connection_revolt` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated municipal bans on new data-centre grid connections spread across several member states after local protests over power prices and hiring freezes, freezing EU gigafactory site works for months.
- `emergent_infrastructure_sabotage` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated physical attacks on data-centre construction sites and grid interconnects in two member states, forcing a temporary halt to gigafactory build-out and hardening works.
...
- Turn 2 (9 turn(s) ago): capability_jump, adoption_success, automated_decision_scandal
- Turn 3 (8 turn(s) ago): eval_anomaly_reports, member_state_defection
- Turn 4 (7 turn(s) ago): knowledge_work_augmented, us_china_agreement, member_state_defection
- Turn 5 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident, election_consolidation
- Turn 6 (5 turn(s) ago): member_state_defection, emergent_copyright_blackout
- Turn 7 (4 turn(s) ago): openweight_frontier_release, adoption_success
- Turn 8 (3 turn(s) ago): ai_investment_collapse, labour_displacement
- Turn 9 (2 turn(s) ago): openweight_frontier_release, adoption_success
- Turn 10 (1 turn(s) ago): cyber_defence_breakthrough, medical_breakthrough, export_control_escalation
