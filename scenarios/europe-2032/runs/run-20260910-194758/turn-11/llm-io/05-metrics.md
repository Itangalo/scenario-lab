...
- characters 107-13216: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13259-13449: `{{metrics_json}}` from the run's live metric values
- characters 13542-15306: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15350-17409: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17465-18187: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Continuity and Repair Shield | 2 |
