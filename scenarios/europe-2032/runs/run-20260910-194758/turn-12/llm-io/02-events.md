...
- characters 375-2081: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2124-4038: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4094-4795: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4858-29157: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29512-30430: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Continuity and Repair Shield −2, priority −1 = −3
PROPOSAL BONUS: none — M11 already in flight, no new measure started this turn
LEGITIMACY LENDS: capital 3, sentiment 23 -> +2 capped by events net (applied in total)
SOVEREIGNTY: 17 last turn, no cat4 finish +0, no cat4 in flight +0, eu_frontier_access_denied t11 −3, capability rose 0.7 −0 = 14

## Emerging developments (tracked)

- `emergent_grid_connection_revolt` -- first noted turn 10, listed in 2 turn(s) so far: Coordinated municipal bans on new data-centre grid connections spread across several member states after local protests over power prices and hiring freezes, freezing EU gigafactory site works for months.
...
- Turn 2 (10 turn(s) ago): capability_jump, adoption_success, automated_decision_scandal
- Turn 3 (9 turn(s) ago): eval_anomaly_reports, member_state_defection
- Turn 4 (8 turn(s) ago): knowledge_work_augmented, us_china_agreement, member_state_defection
- Turn 5 (7 turn(s) ago): cyber_major_incident, loss_of_control_incident, election_consolidation
- Turn 6 (6 turn(s) ago): member_state_defection, emergent_copyright_blackout
- Turn 7 (5 turn(s) ago): openweight_frontier_release, adoption_success
- Turn 8 (4 turn(s) ago): ai_investment_collapse, labour_displacement
- Turn 9 (3 turn(s) ago): openweight_frontier_release, adoption_success
- Turn 10 (2 turn(s) ago): cyber_defence_breakthrough, medical_breakthrough, export_control_escalation
- Turn 11 (1 turn(s) ago): bio_uplift_findings, labour_displacement, eu_frontier_access_denied, emergent_infrastructure_sabotage
