...
- characters 376-1991: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2035-3897: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3953-5336: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5399-30784: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31139-31434: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): capability_jump, adoption_success, automated_decision_scandal
- Turn 3 (2 turn(s) ago): eval_anomaly_reports, member_state_defection
- Turn 4 (1 turn(s) ago): knowledge_work_augmented, us_china_agreement, member_state_defection
