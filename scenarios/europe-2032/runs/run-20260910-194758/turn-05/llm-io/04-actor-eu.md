...
- characters 454-2069: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2113-3975: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5956-6388: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8744-10788: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Observer Bridge to the US-China Safety Accord | 8 | small | 4 | 7 | US, China, coalition | ai_safety up, eu_ai_sovereignty up slightly via leverage, eu_political_capital protected | 2 | running |
