...
- characters 13710-15325: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15369-17231: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17287-18670: `{{notepad}}` from the Game Master's notepad, carried across turns
