...
- characters 106-13202: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13245-13436: `{{metrics_json}}` from the run's live metric values
- characters 13529-14747: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14791-16778: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16834-17322: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Essentials Continuity Sprint | 2 |
...
## Metrics
```json
{"ai_capability": 63.8, "openweight_capability": 63.0, "ai_safety": 10.5, "resilience": 31.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 7.0, "public_sentiment": 24.0}
```
## Narrative
### The weights get out
