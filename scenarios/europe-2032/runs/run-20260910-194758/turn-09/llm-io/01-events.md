...
- characters 376-1594: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1638-3625: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3681-4725: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4788-28234: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28589-29201: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Displacement Transition Shield −2, priority −1 = −3
PROPOSAL BONUS: EU Displacement Transition Shield (cat 7, small) +3 — labour_displacement landed this turn and ai_investment_collapse this turn, this answers displacement directly and cohesion risk from collapse indirectly
LEGITIMACY LENDS: capital 8, sentiment 20 -> +2 capped by other losses, applied before events
SOVEREIGNTY: 19 last turn, no capacity event, no cat4 in flight +0, capability rose 0.5 −0 = 19

## Emerging developments (tracked)

- `emergent_datacentre_backlash` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated physical sabotage and blockades against data-centre construction sites in several member states, driven by anti-AI mobilisation amid outages and job anxiety, halting works for weeks.
- `emergent_us_media_retaliation` -- first noted turn 7, listed in 2 turn(s) so far: Washington imposes targeted trade retaliation over the EU publisher delisting order, such as tariffs or investigations aimed at European media-tech rules.
...
- Turn 2 (7 turn(s) ago): capability_jump, adoption_success, automated_decision_scandal
- Turn 3 (6 turn(s) ago): eval_anomaly_reports, member_state_defection
- Turn 4 (5 turn(s) ago): knowledge_work_augmented, us_china_agreement, member_state_defection
- Turn 5 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, election_consolidation
- Turn 6 (3 turn(s) ago): member_state_defection, emergent_copyright_blackout
- Turn 7 (2 turn(s) ago): openweight_frontier_release, adoption_success
- Turn 8 (1 turn(s) ago): ai_investment_collapse, labour_displacement
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.03}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.05}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.07}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.04}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.05}, {"description": "Coordinated physical sabotage and blockades against data-centre construction sites in several member states, driven by anti-AI mobilisation amid outages and job anxiety, halting works for weeks.", "emergent": true, "id": "emergent_datacentre_backlash", "probability": 0.22}, {"description": "Washington imposes targeted trade retaliation over the EU publisher delisting order, such as tariffs or investigations aimed at European media-tech rules.", "emergent": true, "id": "emergent_us_media_retaliation", "probability": 0.12}]
```
