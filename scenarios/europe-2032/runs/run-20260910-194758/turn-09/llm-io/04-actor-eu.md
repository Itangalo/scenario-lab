...
- characters 1716-3703: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4420-4925: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7477-9228: `{{previous_actions}}` from the actor's own response from the previous turn
