...
- characters 106-13008: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13051-13243: `{{metrics_json}}` from the run's live metric values
- characters 13336-14372: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14416-16216: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16272-16806: `{{notepad}}` from the Game Master's notepad, carried across turns
