...
- characters 105-13383: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13426-13618: `{{metrics_json}}` from the run's live metric values
- characters 13711-15101: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15144-17054: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17110-18456: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Incident Reporting and High-Risk Enforcement Sweep | 2 |
| M5 | EU Evaluation Access and Anomaly Triage Cell | 2 |
| M6 | EU Observer Bridge to the US-China Safety Accord | 2 |
