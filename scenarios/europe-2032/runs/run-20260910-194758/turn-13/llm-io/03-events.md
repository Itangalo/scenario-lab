...
- characters 376-3199: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3243-5232: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5288-5786: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5849-30148: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30503-31504: `{{event_history}}` from the run's own event record
...
- Turn 2 (11 turn(s) ago): capability_jump, adoption_success, automated_decision_scandal
- Turn 3 (10 turn(s) ago): eval_anomaly_reports, member_state_defection
- Turn 4 (9 turn(s) ago): knowledge_work_augmented, us_china_agreement, member_state_defection
- Turn 5 (8 turn(s) ago): cyber_major_incident, loss_of_control_incident, election_consolidation
- Turn 6 (7 turn(s) ago): member_state_defection, emergent_copyright_blackout
- Turn 7 (6 turn(s) ago): openweight_frontier_release, adoption_success
- Turn 8 (5 turn(s) ago): ai_investment_collapse, labour_displacement
- Turn 9 (4 turn(s) ago): openweight_frontier_release, adoption_success
- Turn 10 (3 turn(s) ago): cyber_defence_breakthrough, medical_breakthrough, export_control_escalation
- Turn 11 (2 turn(s) ago): bio_uplift_findings, labour_displacement, eu_frontier_access_denied, emergent_infrastructure_sabotage
- Turn 12 (1 turn(s) ago): openweight_frontier_release, export_control_escalation
