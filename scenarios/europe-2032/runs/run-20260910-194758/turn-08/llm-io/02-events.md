...
- characters 375-1658: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1701-3916: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3972-4897: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4960-29067: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29422-29964: `{{event_history}}` from the run's own event record
...
- `emergent_datacentre_backlash` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated physical sabotage and blockades against data-centre construction sites in several member states, driven by anti-AI mobilisation amid outages and job anxiety, halting works for weeks.
- `emergent_us_media_retaliation` -- first noted turn 7, listed in 1 turn(s) so far: Washington imposes targeted trade retaliation over the EU publisher delisting order, such as tariffs or investigations aimed at European media-tech rules.
...
- Turn 2 (6 turn(s) ago): capability_jump, adoption_success, automated_decision_scandal
- Turn 3 (5 turn(s) ago): eval_anomaly_reports, member_state_defection
- Turn 4 (4 turn(s) ago): knowledge_work_augmented, us_china_agreement, member_state_defection
- Turn 5 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, election_consolidation
- Turn 6 (2 turn(s) ago): member_state_defection, emergent_copyright_blackout
