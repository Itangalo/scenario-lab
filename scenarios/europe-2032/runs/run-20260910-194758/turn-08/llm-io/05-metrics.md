...
- characters 105-13215: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13258-13449: `{{metrics_json}}` from the run's live metric values
- characters 13542-14825: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14868-17083: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17139-18064: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Displacement Transition Shield | 2 |
