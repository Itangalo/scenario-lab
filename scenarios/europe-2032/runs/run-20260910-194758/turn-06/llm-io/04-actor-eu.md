...
- characters 453-2480: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2523-4789: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5478-5933: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8290-10533: `{{previous_actions}}` from the actor's own response from the previous turn
