...
- characters 375-2402: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2445-4711: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4767-5903: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5966-29470: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29825-30217: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Evaluation Access and Anomaly Triage Cell −2, EU Observer Bridge to the US-China Safety Accord −2, priority −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 9, sentiment 31 -> +2
SOVEREIGNTY: 17 last turn, no capacity event, Gigafactories in flight +0, capability rose 0.7 −0 = 17

## Emerging developments (tracked)

- `emergent_copyright_blackout` -- first noted turn 4, listed in 2 turn(s) so far: A coalition of European publishers and collecting societies wins an interim court order forcing temporary delisting of EU news content from a leading US AI assistant over copyright and AI Act transparency claims, triggering transatlantic retaliation threats.
- `emergent_cable_gps_disruption_scare` -- first noted turn 4, listed in 2 turn(s) so far: A transatlantic subsea cable outage and concurrent GPS interference over the Baltic disrupt shipping logistics and port telemetry for days, initially attributed to sabotage and later to accidental damage compounded by AI-generated misinformation about its cause.
...
- Turn 2 (4 turn(s) ago): capability_jump, adoption_success, automated_decision_scandal
- Turn 3 (3 turn(s) ago): eval_anomaly_reports, member_state_defection
- Turn 4 (2 turn(s) ago): knowledge_work_augmented, us_china_agreement, member_state_defection
- Turn 5 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, election_consolidation
