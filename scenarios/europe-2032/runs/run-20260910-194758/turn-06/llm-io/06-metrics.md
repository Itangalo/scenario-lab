...
- characters 13514-13705: `{{metrics_json}}` from the run's live metric values
- characters 13798-15825: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15868-18134: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18190-18593: `{{notepad}}` from the Game Master's notepad, carried across turns
