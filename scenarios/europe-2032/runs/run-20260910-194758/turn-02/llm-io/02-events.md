...
- characters 376-1405: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1448-3337: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3393-4587: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4650-27932: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28287-28328: `{{event_history}}` from the run's own event record
