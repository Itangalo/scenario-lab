...
- characters 1905-3703: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4816-5306: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8034-10188: `{{previous_actions}}` from the actor's own response from the previous turn
