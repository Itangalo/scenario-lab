...
- characters 1827-3625: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3681-4058: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4121-27567: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27922-28606: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): capability_jump, adoption_success, automated_decision_scandal
- Turn 3 (7 turn(s) ago): eval_anomaly_reports, member_state_defection
- Turn 4 (6 turn(s) ago): knowledge_work_augmented, us_china_agreement, member_state_defection
- Turn 5 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, election_consolidation
- Turn 6 (4 turn(s) ago): member_state_defection, emergent_copyright_blackout
- Turn 7 (3 turn(s) ago): openweight_frontier_release, adoption_success
- Turn 8 (2 turn(s) ago): ai_investment_collapse, labour_displacement
- Turn 9 (1 turn(s) ago): openweight_frontier_release, adoption_success
