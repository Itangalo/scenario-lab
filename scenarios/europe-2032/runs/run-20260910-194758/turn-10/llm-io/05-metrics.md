...
- characters 106-13211: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13254-13445: `{{metrics_json}}` from the run's live metric values
- characters 13538-14946: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14989-16787: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16843-17818: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Trusted Cures Deployment | 2 |
...
PORTFOLIO CHARGE t9: EU Essentials Continuity Sprint −2, priority −1 = −3
PROPOSAL BONUS: EU Essentials Continuity Sprint (cat 6, small) +2 — openweight_frontier_release landed this turn and this answers misuse beyond recall directly
LEGITIMACY LENDS: capital 5, sentiment 24 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, no cat4 in flight +0, capability rose 0.7 −0 = 19
