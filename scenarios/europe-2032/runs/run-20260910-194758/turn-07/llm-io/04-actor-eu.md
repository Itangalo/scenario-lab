...
- characters 1508-3620: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4337-4842: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7049-9423: `{{previous_actions}}` from the actor's own response from the previous turn
