...
- characters 1430-3542: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3598-3974: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4037-27541: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27896-28366: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): capability_jump, adoption_success, automated_decision_scandal
- Turn 3 (4 turn(s) ago): eval_anomaly_reports, member_state_defection
- Turn 4 (3 turn(s) ago): knowledge_work_augmented, us_china_agreement, member_state_defection
- Turn 5 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, election_consolidation
- Turn 6 (1 turn(s) ago): member_state_defection, emergent_copyright_blackout
