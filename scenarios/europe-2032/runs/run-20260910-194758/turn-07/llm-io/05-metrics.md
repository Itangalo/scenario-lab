...
- characters 106-13388: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13431-13622: `{{metrics_json}}` from the run's live metric values
- characters 13715-14725: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14769-16881: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16937-17869: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Visible Benefit Adoption Drive | 2 |
