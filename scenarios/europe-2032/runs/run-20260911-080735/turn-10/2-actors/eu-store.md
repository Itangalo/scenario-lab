...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Essential Services Isolation and Rogue-Agent Lockdown", "category": 6, "size": "small", "finish_turn": 12, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly via containment"}, "grounds": "to contain live cyber and loss-of-control incidents"}
  - Grounds: to contain live cyber and loss-of-control incidents
