...
| M13 | EU Hospital Continuity and Local Consent Pact | 9 | small | 11 | 13 | own jurisdiction | public_sentiment up, resilience up slightly via restored care continuity | 2 | running |
...
- **applied** `M14` — {"op": "add", "table": "measures", "fields": {"name": "EU Proven Benefit Replication Fund", "category": 9, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, resilience up slightly via restored services"}, "grounds": "to scale visible adoption success amid hospital litigation"}
  - Grounds: to scale visible adoption success amid hospital litigation
