...
| M13 | EU Hospital Continuity and Local Consent Pact | 9 | small | 11 | 13 | own jurisdiction | public_sentiment up, resilience up slightly via restored care continuity | 2 | finished |
| M14 | EU Proven Benefit Replication Fund | 9 | small | 12 | 14 | own jurisdiction | public_sentiment up, resilience up slightly via restored services | 2 | running |
| M15 | EU Emergency Municipal Restoration Corps | 6 | small | 13 | 15 | own jurisdiction | resilience up, eu_political_capital protected from cascade | 2 | running |
...
- **applied** `M15` — {"op": "add", "table": "measures", "fields": {"name": "EU Emergency Municipal Restoration Corps", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_political_capital protected from cascade"}, "grounds": "to answer major automated attack amid municipal refusal"}
  - Grounds: to answer major automated attack amid municipal refusal
