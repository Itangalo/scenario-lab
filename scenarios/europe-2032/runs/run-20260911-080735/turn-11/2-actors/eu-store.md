...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Hospital Continuity and Local Consent Pact", "category": 9, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, resilience up slightly via restored care continuity"}, "grounds": "to reverse opt-out revolt stalling fallback adoption"}
  - Grounds: to reverse opt-out revolt stalling fallback adoption
