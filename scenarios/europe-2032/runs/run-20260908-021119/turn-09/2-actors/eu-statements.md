...
- `two_year_commitment` (commitment): Secure sovereign AI capacity and operational resilience against autonomous threats

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign AI capacity and operational resilience against autonomous threats
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The commitment's duration was central to its purpose; closure of the period directly changes the actor's obligation to uphold it.
