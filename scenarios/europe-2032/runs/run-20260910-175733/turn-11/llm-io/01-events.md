...
- characters 376-1938: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1982-4498: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4554-5088: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5151-31469: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31824-32732: `{{event_history}}` from the run's own event record
...
- Turn 2 (9 turn(s) ago): eu_frontier_access_denied
- Turn 3 (8 turn(s) ago): emergent_publisher_bio_screen
- Turn 4 (7 turn(s) ago): emergent_forum_shopping_preprint
- Turn 5 (6 turn(s) ago): eval_anomaly_reports, research_breakthrough, medical_breakthrough, embodied_ai_deployment, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, taiwan_blockade, cyber_defence_breakthrough, medical_breakthrough
- Turn 7 (4 turn(s) ago): capability_jump, labour_displacement, embodied_ai_deployment, taiwan_tension_rise, us_labs_nationalised
- Turn 8 (3 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied
- Turn 9 (2 turn(s) ago): capability_jump, ai_investment_collapse, embodied_ai_deployment, emergent_municipal_robot_moratorium
- Turn 10 (1 turn(s) ago): capability_jump, medical_breakthrough, export_control_escalation
