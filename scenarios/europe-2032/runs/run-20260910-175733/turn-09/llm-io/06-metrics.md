...
- characters 13734-14843: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14887-16933: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16989-17821: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Embodied AI Safety and Continuity Audits | 2 |
...
## Metrics
```json
{"ai_capability": 83.0, "openweight_capability": 74.5, "ai_safety": 6.0, "resilience": 38.0, "eu_ai_sovereignty": 9.0, "eu_political_capital": 16.0, "public_sentiment": 14.0}
```
