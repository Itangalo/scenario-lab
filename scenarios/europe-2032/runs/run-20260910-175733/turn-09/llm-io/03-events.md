...
- characters 377-1486: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1530-3576: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3632-4775: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4838-30704: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31059-31747: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M8 EU Entry-Level Transition Guarantee −2, M9 EU Essential Services Fallback Switch −2, priority −1 = −5
PROPOSAL BONUS: EU Essential Services Fallback Switch (cat 9, small) +2 — eu_frontier_access_denied landed this turn cutting hospitals/ministries, this answers it directly
LEGITIMACY LENDS: capital 20, sentiment 16 -> none, capital higher
SOVEREIGNTY: 14 last turn, no cat4 finish, no cat4 in flight +0, eu_frontier_access_denied t8 −1, capability rose 3.0 −1 = 12

## Emerging developments (tracked)

- `emergent_municipal_robot_moratorium` -- first noted turn 8, listed in 1 turn(s) so far: Mayors in Rotterdam, Lyon and Hamburg coordinate a cross-city moratorium on new logistics-robot deployments until EU safety and labour-impact audits are completed, creating a template for municipal AI-permit resistance.
- `emergent_humanoid_yard_accident` -- first noted turn 8, listed in 1 turn(s) so far: A trial deployment of Chinese humanoid robots in a Rotterdam logistics yard causes a serious worker injury, triggering port-wide safety suspensions and calls for an EU-wide moratorium on uncontrolled embodied systems.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, eval_anomaly_reports
- Turn 2 (7 turn(s) ago): eu_frontier_access_denied
- Turn 3 (6 turn(s) ago): emergent_publisher_bio_screen
- Turn 4 (5 turn(s) ago): emergent_forum_shopping_preprint
- Turn 5 (4 turn(s) ago): eval_anomaly_reports, research_breakthrough, medical_breakthrough, embodied_ai_deployment, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, taiwan_blockade, cyber_defence_breakthrough, medical_breakthrough
- Turn 7 (2 turn(s) ago): capability_jump, labour_displacement, embodied_ai_deployment, taiwan_tension_rise, us_labs_nationalised
- Turn 8 (1 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.3}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.12}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "rsi_onset", "probability": 0.35}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.025}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_great_power_conflict", "probability": 0.09}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.21}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.26}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Mayors in Rotterdam, Lyon and Hamburg coordinate a cross-city moratorium on new logistics-robot deployments until EU safety and labour-impact audits are completed, creating a template for municipal AI-permit resistance.", "emergent": true, "id": "emergent_municipal_robot_moratorium", "probability": 0.22}, {"description": "A trial deployment of Chinese humanoid robots in a Rotterdam logistics yard causes a serious worker injury, triggering port-wide safety suspensions and calls for an EU-wide moratorium on uncontrolled embodied systems.", "emergent": true, "id": "emergent_humanoid_yard_accident", "probability": 0.14}]
```
