...
- characters 455-1564: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1608-3654: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5381-5967: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8837-10784: `{{previous_actions}}` from the actor's own response from the previous turn
