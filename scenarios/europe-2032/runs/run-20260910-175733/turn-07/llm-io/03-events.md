...
- characters 2311-4366: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4422-5201: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5264-30804: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31159-31643: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: M1 InvestAI Gigafactories −3, M7 EU Blockade Continuity and Cyber Shield −2, priority −1 = −6
PROPOSAL BONUS: EU Blockade Continuity and Cyber Shield (cat 6, small) +3 — taiwan_blockade and cyber_major_incident landed this turn and this answers both directly
LEGITIMACY LENDS: capital 19, sentiment 29 -> +2
SOVEREIGNTY: 13 last turn, Tech sovereignty package finishes t6 +4, Gigafactories in flight +0, taiwan_blockade t6 −3, capability rose 3.0 −1 = 13

## Emerging developments (tracked)

- `emergent_datacentre_protest_escalation` -- first noted turn 5, listed in 2 turn(s) so far: Coordinated physical blockades and arson attempts hit data-centre construction sites in two member states as job-loss and fraud coverage turns organised opposition violent.
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, eval_anomaly_reports
- Turn 2 (5 turn(s) ago): eu_frontier_access_denied
- Turn 3 (4 turn(s) ago): emergent_publisher_bio_screen
- Turn 4 (3 turn(s) ago): emergent_forum_shopping_preprint
- Turn 5 (2 turn(s) ago): eval_anomaly_reports, research_breakthrough, medical_breakthrough, embodied_ai_deployment, election_consolidation
- Turn 6 (1 turn(s) ago): cyber_major_incident, taiwan_blockade, cyber_defence_breakthrough, medical_breakthrough
