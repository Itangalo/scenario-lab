...
- characters 455-2345: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2389-4444: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6513-7099: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9592-12439: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | EU Blockade Continuity and Cyber Shield | 6 | small | 6 | 8 | own jurisdiction | resilience up materially, eu_ai_sovereignty stabilised via supply triage | 2 | running |
