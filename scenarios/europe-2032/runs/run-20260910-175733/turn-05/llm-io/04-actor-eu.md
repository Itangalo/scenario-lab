...
- characters 455-1792: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1836-3830: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7022-7471: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9784-11726: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU-Funded Genome Publication Standard | 3 | small | 4 | 6 | own jurisdiction | ai_safety up slightly, resilience up slightly via reduced misuse diffusion | 2 | running |
