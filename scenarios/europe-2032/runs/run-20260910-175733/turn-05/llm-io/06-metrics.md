...
- characters 13730-15067: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15111-17105: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17161-18275: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 67.0, "openweight_capability": 60.8, "ai_safety": 24.0, "resilience": 40.0, "eu_ai_sovereignty": 13.0, "eu_political_capital": 15.0, "public_sentiment": 33.0}
```
## Narrative
### Holding the line
