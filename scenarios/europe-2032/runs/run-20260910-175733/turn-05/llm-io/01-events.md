...
- characters 377-1714: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1758-3752: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3808-4655: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4718-30588: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30943-31173: `{{event_history}}` from the run's own event record
...
- `emergent_welfare_fraud_wave` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated AI-enabled fraud wave using open-weight voice and document models targets health reimbursement and welfare systems in several member states, forcing emergency payout freezes.
...
- Turn 3 (2 turn(s) ago): emergent_publisher_bio_screen
- Turn 4 (1 turn(s) ago): emergent_forum_shopping_preprint
