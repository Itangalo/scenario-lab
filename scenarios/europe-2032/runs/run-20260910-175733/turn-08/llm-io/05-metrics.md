...
- characters 105-13399: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13442-13634: `{{metrics_json}}` from the run's live metric values
- characters 13727-15572: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15615-17699: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17755-18923: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Entry-Level Transition Guarantee | 2 |
| M9 | EU Essential Services Fallback Switch | 2 |
