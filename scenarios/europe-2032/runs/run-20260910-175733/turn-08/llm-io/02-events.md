...
- characters 376-2221: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2264-4348: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4404-4919: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4982-30848: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31203-31817: `{{event_history}}` from the run's own event record
...
- Turn 2 (6 turn(s) ago): eu_frontier_access_denied
- Turn 3 (5 turn(s) ago): emergent_publisher_bio_screen
- Turn 4 (4 turn(s) ago): emergent_forum_shopping_preprint
- Turn 5 (3 turn(s) ago): eval_anomaly_reports, research_breakthrough, medical_breakthrough, embodied_ai_deployment, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, taiwan_blockade, cyber_defence_breakthrough, medical_breakthrough
- Turn 7 (1 turn(s) ago): capability_jump, labour_displacement, embodied_ai_deployment, taiwan_tension_rise, us_labs_nationalised
