...
- characters 13913-15033: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15076-17491: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17547-18234: `{{notepad}}` from the Game Master's notepad, carried across turns
