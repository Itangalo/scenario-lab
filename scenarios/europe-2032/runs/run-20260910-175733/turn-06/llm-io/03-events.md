...
- characters 376-1496: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1539-3954: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4010-4967: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5030-30447: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30802-31172: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M6 EU-Funded Genome Publication Standard −2, priority −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 13, sentiment 33 -> +2
SOVEREIGNTY: 16 last turn, no capacity finish, Gigafactories in flight +0, embodied_ai_deployment t5 −2, capability rose 3.0 −1 = 13

## Emerging developments (tracked)

- `emergent_welfare_fraud_wave` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated AI-enabled fraud wave using open-weight voice and document models targets health reimbursement and welfare systems in several member states, forcing emergency payout freezes.
- `emergent_datacentre_protest_escalation` -- first noted turn 5, listed in 1 turn(s) so far: Coordinated physical blockades and arson attempts hit data-centre construction sites in two member states as job-loss and fraud coverage turns organised opposition violent.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, eval_anomaly_reports
- Turn 2 (4 turn(s) ago): eu_frontier_access_denied
- Turn 3 (3 turn(s) ago): emergent_publisher_bio_screen
- Turn 4 (2 turn(s) ago): emergent_forum_shopping_preprint
- Turn 5 (1 turn(s) ago): eval_anomaly_reports, research_breakthrough, medical_breakthrough, embodied_ai_deployment, election_consolidation
