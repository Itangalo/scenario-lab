...
- characters 1617-4032: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5627-6119: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8434-10294: `{{previous_actions}}` from the actor's own response from the previous turn
