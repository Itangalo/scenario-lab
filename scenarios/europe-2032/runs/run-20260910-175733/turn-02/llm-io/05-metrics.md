...
- characters 13390-14857: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14900-17233: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17289-18500: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Continuity Stack for Cut-Off Users | 3 |
...
PROPOSAL BONUS: EU Critical Systems Shield (cat 6, large) +3 — autumn grid/port intrusion with undetected persistence in two EU operators landed this turn and this answers it directly
...
Emerging developments (tracked) carried forward as atmosphere only.

## Emerging developments (tracked)

- `emergent_transatlantic_trust_fallout` -- first noted turn 1, listed in 2 turn(s) so far: A coordinated investigative leak publishes internal safety memos around the June Fable/Mythos switch-off order, triggering parliamentary hearings in several member states and a short-lived consumer boycott of a US hyperscaler.
- `emergent_publisher_bio_screen` -- first noted turn 1, listed in 2 turn(s) so far: A major European scientific publisher and preprint server impose coordinated mandatory screening and delayed release for AI-assisted genome design papers after the phage results, slowing open dissemination without any state mandate.
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 50.5, "ai_safety": 30.0, "resilience": 35.5, "eu_ai_sovereignty": 18.0, "eu_political_capital": 37.0, "public_sentiment": 33.0}
```
...
## Notepad
PORTFOLIO CHARGE t2: Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Continuity Stack for Cut-Off Users −3, priority −1 = −13
PROPOSAL BONUS: EU Continuity Stack for Cut-Off Users (cat 9, large) +5 — eu_frontier_access_denied landed this turn hitting hospitals/ministries and this answers it directly
LEGITIMACY LENDS: capital 43, sentiment 40 -> none, capital higher
SOVEREIGNTY: 21 last turn, no capacity build finishing, Gigafactories in flight +0, eu_frontier_access_denied t2 −2, capability rose 3.0 −1 = 18
