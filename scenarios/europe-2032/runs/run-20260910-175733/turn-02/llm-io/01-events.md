...
- characters 376-1843: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1886-4219: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4275-5486: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5549-27679: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28034-28097: `{{event_history}}` from the run's own event record
