...
- characters 375-2226: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2269-4144: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4200-4729: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4792-31110: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31465-32491: `{{event_history}}` from the run's own event record
...
- Turn 2 (10 turn(s) ago): eu_frontier_access_denied
- Turn 3 (9 turn(s) ago): emergent_publisher_bio_screen
- Turn 4 (8 turn(s) ago): emergent_forum_shopping_preprint
- Turn 5 (7 turn(s) ago): eval_anomaly_reports, research_breakthrough, medical_breakthrough, embodied_ai_deployment, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, taiwan_blockade, cyber_defence_breakthrough, medical_breakthrough
- Turn 7 (5 turn(s) ago): capability_jump, labour_displacement, embodied_ai_deployment, taiwan_tension_rise, us_labs_nationalised
- Turn 8 (4 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied
- Turn 9 (3 turn(s) ago): capability_jump, ai_investment_collapse, embodied_ai_deployment, emergent_municipal_robot_moratorium
- Turn 10 (2 turn(s) ago): capability_jump, medical_breakthrough, export_control_escalation
- Turn 11 (1 turn(s) ago): medical_breakthrough, safety_breakthrough, taiwan_tension_rise, export_control_escalation
