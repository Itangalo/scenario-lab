...
- characters 106-13414: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13457-13647: `{{metrics_json}}` from the run's live metric values
- characters 13740-15591: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15634-17509: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17565-18427: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Assured Deployment Uptake | 2 |
| M13 | EU Degraded Continuity Containment Mesh | 2 |
...
PORTFOLIO CHARGE t11: M11 EU Trusted Medical Access Programme −2, M12 EU Assured Deployment Uptake −2, priority −1 not charged (capital below 20, no effect) = −4
PROPOSAL BONUS: EU Assured Deployment Uptake (cat 5, small) +3 — safety_breakthrough landed this turn and ai_safety at zero, this adopts it directly on deployed EU systems
LEGITIMACY LENDS: capital 15, sentiment 15 -> none (capital not lower)
SOVEREIGNTY: 6 last turn, no cat4 finish, no cat4 in flight +0, export_control_escalation t11 −2, capability rose 3.0 −1 = 3
