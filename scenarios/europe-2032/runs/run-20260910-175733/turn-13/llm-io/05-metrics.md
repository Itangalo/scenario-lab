...
- characters 13455-13644: `{{metrics_json}}` from the run's live metric values
- characters 13737-15713: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15757-18191: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18247-18754: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M14 | EU Middle-Power Supply and Access Coalition | 2 |
