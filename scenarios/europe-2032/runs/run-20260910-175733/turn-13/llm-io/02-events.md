...
- characters 375-2351: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2395-4829: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4885-5725: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5788-30833: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31188-32370: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M12 EU Assured Deployment Uptake −2, M13 EU Degraded Continuity Containment Mesh −2 = −4 + priority no effect/no cost (capital below 20)
PROPOSAL BONUS: EU Degraded Continuity Containment Mesh (cat 6, small) +4 — loss-of-control incident and frontier access cut-off fired this turn and this answers both directly
LEGITIMACY LENDS: capital 8, sentiment 17 -> +2
SOVEREIGNTY: 3 last turn, no cat4 finish, no cat4 in flight +0, eu_frontier_access_denied t12 −3, capability rose 4.0 −1 = 0

## Emerging developments (tracked)

- `emergent_certified_dosage_revolt` -- first noted turn 12, listed in 1 turn(s) so far: Hospital pharmacists in two member states publicly refuse to dispense AI-validated dosages without a human-readable certificate after a near-miss overdose, triggering a cross-border clinical walkout threat.
...
- Turn 2 (11 turn(s) ago): eu_frontier_access_denied
- Turn 3 (10 turn(s) ago): emergent_publisher_bio_screen
- Turn 4 (9 turn(s) ago): emergent_forum_shopping_preprint
- Turn 5 (8 turn(s) ago): eval_anomaly_reports, research_breakthrough, medical_breakthrough, embodied_ai_deployment, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, taiwan_blockade, cyber_defence_breakthrough, medical_breakthrough
- Turn 7 (6 turn(s) ago): capability_jump, labour_displacement, embodied_ai_deployment, taiwan_tension_rise, us_labs_nationalised
- Turn 8 (5 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied
- Turn 9 (4 turn(s) ago): capability_jump, ai_investment_collapse, embodied_ai_deployment, emergent_municipal_robot_moratorium
- Turn 10 (3 turn(s) ago): capability_jump, medical_breakthrough, export_control_escalation
- Turn 11 (2 turn(s) ago): medical_breakthrough, safety_breakthrough, taiwan_tension_rise, export_control_escalation
- Turn 12 (1 turn(s) ago): loss_of_control_incident, rsi_onset, opaque_reasoning, research_breakthrough, embodied_ai_deployment, eu_frontier_access_denied
