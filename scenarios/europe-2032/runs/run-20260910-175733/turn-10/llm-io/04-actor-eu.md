...
- characters 453-1608: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1651-3887: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4945-5435: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8340-11100: `{{previous_actions}}` from the actor's own response from the previous turn
