...
- characters 375-1530: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1573-3809: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3865-4712: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4775-31093: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31448-32263: `{{event_history}}` from the run's own event record
...
- `emergent_humanoid_yard_accident` -- first noted turn 8, listed in 2 turn(s) so far: A trial deployment of Chinese humanoid robots in a Rotterdam logistics yard causes a serious worker injury, triggering port-wide safety suspensions and calls for an EU-wide moratorium on uncontrolled embodied systems.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, eval_anomaly_reports
- Turn 2 (8 turn(s) ago): eu_frontier_access_denied
- Turn 3 (7 turn(s) ago): emergent_publisher_bio_screen
- Turn 4 (6 turn(s) ago): emergent_forum_shopping_preprint
- Turn 5 (5 turn(s) ago): eval_anomaly_reports, research_breakthrough, medical_breakthrough, embodied_ai_deployment, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, taiwan_blockade, cyber_defence_breakthrough, medical_breakthrough
- Turn 7 (3 turn(s) ago): capability_jump, labour_displacement, embodied_ai_deployment, taiwan_tension_rise, us_labs_nationalised
- Turn 8 (2 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied
- Turn 9 (1 turn(s) ago): capability_jump, ai_investment_collapse, embodied_ai_deployment, emergent_municipal_robot_moratorium
