...
- characters 106-13562: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13605-13795: `{{metrics_json}}` from the run's live metric values
- characters 13888-15043: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15086-17322: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17378-17883: `{{notepad}}` from the Game Master's notepad, carried across turns
