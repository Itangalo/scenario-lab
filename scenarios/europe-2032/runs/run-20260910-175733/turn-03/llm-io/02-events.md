...
- characters 377-1520: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1564-3429: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3485-4704: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4767-27396: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27751-27866: `{{event_history}}` from the run's own event record
...
- Turn 2 (1 turn(s) ago): eu_frontier_access_denied
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.3}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.06}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.1}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.08}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "A coordinated investigative leak publishes internal safety memos around the June Fable/Mythos switch-off order, triggering parliamentary hearings in several member states and a short-lived consumer boycott of a US hyperscaler.", "emergent": true, "id": "emergent_transatlantic_trust_fallout", "probability": 0.18}, {"description": "A major European scientific publisher and preprint server impose coordinated mandatory screening and delayed release for AI-assisted genome design papers after the phage results, slowing open dissemination without any state mandate.", "emergent": true, "id": "emergent_publisher_bio_screen", "probability": 0.14}]
```
