...
- characters 106-13443: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13486-13678: `{{metrics_json}}` from the run's live metric values
- characters 13771-14914: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14958-16823: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16879-17424: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Bio-Cyber Early Warning Mesh | 2 |
...
## Notepad
PORTFOLIO CHARGE t3: Gigafactories −3, Tech sovereignty package −3, EU Continuity Stack for Cut-Off Users −3, EU Bio-Cyber Early Warning Mesh −2, priority −1 = −12
PROPOSAL BONUS: EU Bio-Cyber Early Warning Mesh (cat 6, small) +2 — openweight advance and unverified agentic leaks plus publisher screening pause, this answers distributed misuse directly
LEGITIMACY LENDS: capital 37, sentiment 33 -> none, capital higher
