...
| M10 | EU Rogue Agent Containment and Essential Services Shield | 6 | small | 10 | 12 | own jurisdiction with coalition partners | resilience up moderately, ai_safety protected, eu_political_capital protected | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Livelihood Transition and Essential Work Continuity Fund", "category": 7, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "resilience up modestly, public_sentiment up, eu_political_capital protected"}, "grounds": "to hold livelihoods and staff manual fallback through diffusion shock"}
  - Grounds: to hold livelihoods and staff manual fallback through diffusion shock
