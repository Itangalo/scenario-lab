...
| M11 | EU Livelihood Transition and Essential Work Continuity Fund | 7 | small | 11 | 13 | own jurisdiction | resilience up modestly, public_sentiment up, eu_political_capital protected | 2 | running |
| M12 | EU Wartime Neutrality and Critical Infrastructure Survival Pact | 6 | small | 12 | 14 | own jurisdiction | resilience up moderately, eu_political_capital protected | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Wartime Neutrality and Critical Infrastructure Survival Pact", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital protected"}, "grounds": "to survive great-power war targeting EU infrastructure"}
  - Grounds: to survive great-power war targeting EU infrastructure
