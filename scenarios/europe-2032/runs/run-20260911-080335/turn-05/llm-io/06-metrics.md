...
- characters 106-13717: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13760-13952: `{{metrics_json}}` from the run's live metric values
- characters 14045-15520: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15564-17411: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17467-18382: `{{notepad}}` from the Game Master's notepad, carried across turns
