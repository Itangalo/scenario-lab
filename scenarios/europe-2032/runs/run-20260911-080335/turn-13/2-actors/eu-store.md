...
| M11 | EU Livelihood Transition and Essential Work Continuity Fund | 7 | small | 11 | 13 | own jurisdiction | resilience up modestly, public_sentiment up, eu_political_capital protected | 2 | finished |
| M12 | EU Wartime Neutrality and Critical Infrastructure Survival Pact | 6 | small | 12 | 13 | own jurisdiction | resilience up moderately, eu_political_capital protected | 2 | finished |
| M13 | EU Loss-of-Control Emergency Containment and Resource Freeze Protocol | 6 | small | 13 | 15 | own jurisdiction | resilience up moderately, ai_safety protected | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Loss-of-Control Emergency Containment and Resource Freeze Protocol", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected"}, "grounds": "to contain unsanctioned agentic loss-of-control during wartime"}
  - Grounds: to contain unsanctioned agentic loss-of-control during wartime
