...
| M9 | EU Bio Emergency Containment and Continuity Regime | 6 | small | 7 | 9 | own jurisdiction | resilience up, ai_safety protected, public_sentiment protected | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio Emergency Containment and Continuity Regime", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety protected, public_sentiment protected"}, "grounds": "to contain ongoing bio incident and keep essential services running"}
  - Grounds: to contain ongoing bio incident and keep essential services running
