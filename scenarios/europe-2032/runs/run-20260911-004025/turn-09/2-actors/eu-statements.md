...
- `two_year_commitment` (commitment): Keep essential services running and jobs survivable through superhuman and embodied AI

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Keep essential services running and jobs survivable through superhuman and embodied AI
