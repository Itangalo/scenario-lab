...
| M9 | EU Bio Emergency Containment and Continuity Regime | 6 | small | 7 | 9 | own jurisdiction | resilience up, ai_safety protected, public_sentiment protected | 2 | finished |
| M10 | EU Cyber Shield for Essential Services | 6 | small | 8 | 10 | own jurisdiction | resilience up, public_sentiment up, eu_political_capital protected | 2 | running |
| M11 | EU Embodied Displacement Buffer and Retooling Fund | 7 | small | 9 | 12 | own jurisdiction | resilience up modestly, public_sentiment up, eu_political_capital protected | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Embodied Displacement Buffer and Retooling Fund", "category": 7, "size": "small", "finish_turn": 12, "applies_to": "own jurisdiction", "targeted_effect": "resilience up modestly, public_sentiment up, eu_political_capital protected"}, "grounds": "to absorb embodied AI job shock and hold cohesion against defection"}
  - Grounds: to absorb embodied AI job shock and hold cohesion against defection
