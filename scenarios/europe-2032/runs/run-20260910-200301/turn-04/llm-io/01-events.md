...
- characters 2067-3753: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3809-4271: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4334-27616: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27971-28107: `{{event_history}}` from the run's own event record
