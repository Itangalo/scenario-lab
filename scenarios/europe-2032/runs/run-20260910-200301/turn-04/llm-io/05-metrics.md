...
- characters 105-12952: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12995-13187: `{{metrics_json}}` from the run's live metric values
- characters 13280-14928: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14971-16657: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16713-17513: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Transition Safety Net | 2 |
| M6 | Joint Chokepoint Defence | 2 |
...
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Frontier Observatory −2, M5 EU Transition Safety Net −2, priority M1 −1 = −11
PROPOSAL BONUS: none — EU Transition Safety Net (cat 7, small) answers no event from last three turns, labour weakness is reporting not an event
...
- `emergent_gigafactory_siting_backlash` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated local opposition blocks grid connection permits for one or more Gigafactory zones, with court challenges and protests over energy prices and water use delaying construction starts beyond the turn.
...
## Notepad
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Frontier Observatory −2, M5 EU Transition Safety Net −2, M6 Joint Chokepoint Defence −2, priority M1 −1 = −13
PROPOSAL BONUS: Joint Chokepoint Defence (cat 8, small) +3 — supply_chain_coercion landed this turn and this answers it directly
LEGITIMACY LENDS: capital 9, sentiment 26 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, supply_chain_coercion t4 −2, Gigafactories in flight +0, capability rose 1.5 −0 = 17
