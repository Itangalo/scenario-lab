...
- characters 13630-14908: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14952-16873: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16929-17393: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t2: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Systems Shield −3, M4 EU Frontier Observatory −2, priority M3 −1 = −12
PROPOSAL BONUS: EU Frontier Observatory (cat 5, small) +2 — eval_anomaly_reports landed this turn and this answers it directly
...
## Metrics
```json
{"ai_capability": 57.0, "openweight_capability": 52.8, "ai_safety": 28.0, "resilience": 41.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 22.0, "public_sentiment": 31.0}
```
