...
- characters 13282-13472: `{{metrics_json}}` from the run's live metric values
- characters 13565-15669: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15712-17440: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17496-17848: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Essential Services Cyber Triage and Paper-Harm Containment | 2 |
...
## Metrics
```json
{"ai_capability": 67.6, "openweight_capability": 65.9, "ai_safety": 4.0, "resilience": 46.5, "eu_ai_sovereignty": 18.0, "eu_political_capital": 9.0, "public_sentiment": 3.0}
```
