...
- characters 375-2479: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2522-4250: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4306-4996: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5059-28640: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28995-29669: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M11 Uninsured Care Continuity and Bio-Surge Shield −2, priority −0 (capital below 20, no effect, no cost) = −2
...
- `emergent_paper_care_harm_cluster` -- first noted turn 11, listed in 1 turn(s) so far: A paper-based prescription and referral transcription failure causes a cluster of avoidable patient harms in uninsured clinics, triggering national press investigations that blame EU substitute systems directly.
...
- Turn 2 (10 turn(s) ago): eval_anomaly_reports
- Turn 4 (8 turn(s) ago): openweight_frontier_release, supply_chain_coercion
- Turn 5 (7 turn(s) ago): taiwan_blockade, election_consolidation
- Turn 7 (5 turn(s) ago): loss_of_control_incident, ai_investment_collapse, openweight_frontier_release, taiwan_tension_rise, export_control_escalation, adoption_success
- Turn 8 (4 turn(s) ago): capability_jump, us_china_agreement, emergent_insurance_retreat
- Turn 9 (3 turn(s) ago): eu_frontier_access_denied
- Turn 10 (2 turn(s) ago): bio_uplift_findings, emergent_uninsured_care_shutdown
