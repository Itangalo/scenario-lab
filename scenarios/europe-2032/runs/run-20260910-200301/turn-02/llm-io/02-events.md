...
- characters 376-1618: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1661-4112: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4168-5198: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5261-28543: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28898-28987: `{{event_history}}` from the run's own event record
