...
- characters 1739-4190: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4817-5272: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6745-8800: `{{previous_actions}}` from the actor's own response from the previous turn
