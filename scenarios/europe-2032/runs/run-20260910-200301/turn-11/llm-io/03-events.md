...
- characters 2152-4134: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4190-4725: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4788-28369: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28724-29397: `{{event_history}}` from the run's own event record
...
- Turn 2 (9 turn(s) ago): eval_anomaly_reports
- Turn 4 (7 turn(s) ago): openweight_frontier_release, supply_chain_coercion
- Turn 5 (6 turn(s) ago): taiwan_blockade, election_consolidation
- Turn 7 (4 turn(s) ago): loss_of_control_incident, ai_investment_collapse, openweight_frontier_release, taiwan_tension_rise, export_control_escalation, adoption_success
- Turn 8 (3 turn(s) ago): capability_jump, us_china_agreement, emergent_insurance_retreat
- Turn 9 (2 turn(s) ago): eu_frontier_access_denied
- Turn 10 (1 turn(s) ago): bio_uplift_findings, emergent_uninsured_care_shutdown
