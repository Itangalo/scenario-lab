...
- characters 107-13206: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13249-13439: `{{metrics_json}}` from the run's live metric values
- characters 13532-15264: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15308-17290: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17346-18219: `{{notepad}}` from the Game Master's notepad, carried across turns
