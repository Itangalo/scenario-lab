...
- characters 13622-14693: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14736-16986: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17042-17536: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Essential Access Fallback | 2 |
| M11 | Uninsured Care Continuity and Bio-Surge Shield | 2 |
...
## Notepad
PORTFOLIO CHARGE t10: M10 EU Essential Access Fallback −2, M11 Uninsured Care Continuity and Bio-Surge Shield −2, priority −0 (capital below 20, no effect, no cost) = −4
PROPOSAL BONUS: Uninsured Care Continuity and Bio-Surge Shield (cat 6, small) +3 — emergent uninsured care shutdown this turn suspends networked care, this answers it directly, bio finding adds recency
