...
- characters 377-1448: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1491-3741: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3797-4614: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4677-28258: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28613-29204: `{{event_history}}` from the run's own event record
...
- `emergent_uninsured_care_shutdown` -- first noted turn 9, listed in 1 turn(s) so far: Uninsured small hospitals and municipalities, unable to renew cyber cover, suspend networked services and revert to paper after a coordinated ransomware flare, forcing emergency state intervention.
...
- Turn 4 (6 turn(s) ago): openweight_frontier_release, supply_chain_coercion
- Turn 5 (5 turn(s) ago): taiwan_blockade, election_consolidation
- Turn 7 (3 turn(s) ago): loss_of_control_incident, ai_investment_collapse, openweight_frontier_release, taiwan_tension_rise, export_control_escalation, adoption_success
- Turn 8 (2 turn(s) ago): capability_jump, us_china_agreement, emergent_insurance_retreat
