...
- characters 455-1526: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1569-3819: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4646-5078: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8067-10327: `{{previous_actions}}` from the actor's own response from the previous turn
...
**emergent_uninsured_care_shutdown (emergent event):** Uninsured small hospitals and municipalities, unable to renew cyber cover, suspend networked services and revert to paper after a coordinated ransomware flare, forcing emergency state intervention.
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Essential Access Fallback | 6 | small | 9 | 11 | own jurisdiction | resilience up moderately, public_sentiment up slightly | 2 | running |
