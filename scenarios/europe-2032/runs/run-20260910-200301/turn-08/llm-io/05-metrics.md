...
- characters 13280-14358: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14401-17094: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17150-17672: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | Open-Weight Agent Containment and Degraded-Service Protocol | 2 |
| M9 | EU Accession Track to the US-China Safety Floor | 2 |
