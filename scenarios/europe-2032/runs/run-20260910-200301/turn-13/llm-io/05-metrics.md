...
- characters 107-12849: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12892-13081: `{{metrics_json}}` from the run's live metric values
- characters 13174-14865: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14909-17321: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17377-18459: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_medical_tourism_surge` -- first noted turn 13, listed in 1 turn(s) so far: Cross-border patient flows to jurisdictions with licensed tailored therapies surge visibly, with brokers, insurers and foreign clinics openly marketing oncology packages to EU patients stuck on compassionate-use queues.
- `emergent_compassionate_corridor` -- first noted turn 13, listed in 1 turn(s) so far: A non-EU research hospital consortium offers a limited cross-border compassionate-use corridor for tailored therapies, with vetted EU clinicians allowed to refer cases abroad under foreign model supervision.
...
## Notepad
PORTFOLIO CHARGE t13: M12 EU Essential Services Cyber Triage and Paper-Harm Containment −2, priority −0 (capital below 20, no effect, no cost) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 9, sentiment 3 -> none (capital higher)
SOVEREIGNTY: 18 last turn, no capacity event finish, no cat4 in flight +0, export_control_escalation t13 −2, capability rose 0.5 −0 = 16
