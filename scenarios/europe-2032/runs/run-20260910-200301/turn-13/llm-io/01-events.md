...
- characters 375-2066: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2110-4522: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4578-5020: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5083-28664: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29019-29818: `{{event_history}}` from the run's own event record
...
- Turn 4 (9 turn(s) ago): openweight_frontier_release, supply_chain_coercion
- Turn 5 (8 turn(s) ago): taiwan_blockade, election_consolidation
- Turn 7 (6 turn(s) ago): loss_of_control_incident, ai_investment_collapse, openweight_frontier_release, taiwan_tension_rise, export_control_escalation, adoption_success
- Turn 8 (5 turn(s) ago): capability_jump, us_china_agreement, emergent_insurance_retreat
- Turn 9 (4 turn(s) ago): eu_frontier_access_denied
- Turn 10 (3 turn(s) ago): bio_uplift_findings, emergent_uninsured_care_shutdown
- Turn 12 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, medical_breakthrough, emergent_paper_care_harm_cluster
