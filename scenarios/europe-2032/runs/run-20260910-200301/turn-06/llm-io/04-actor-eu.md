...
- characters 453-1378: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1421-3246: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3314-3763: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6074-7773: `{{previous_actions}}` from the actor's own response from the previous turn
