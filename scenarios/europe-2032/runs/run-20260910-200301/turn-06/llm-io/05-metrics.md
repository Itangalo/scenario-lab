...
- characters 105-13624: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13667-13858: `{{metrics_json}}` from the run's live metric values
- characters 13951-14876: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14919-16744: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16800-17199: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | Blockade Degraded-Continuity Compact | 2 |
...
PORTFOLIO CHARGE t5: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M5 EU Transition Safety Net −2, M6 Joint Chokepoint Defence −2, priority M6 −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 11, sentiment 26 -> +2
SOVEREIGNTY: 17 last turn, no capacity finish, taiwan_blockade t5 −2, Gigafactories in flight +0, capability rose 1.5 −0 = 15
...
## Metrics
```json
{"ai_capability": 60.7, "openweight_capability": 58.0, "ai_safety": 22.5, "resilience": 36.5, "eu_ai_sovereignty": 19.0, "eu_political_capital": 16.0, "public_sentiment": 23.0}
```
## Narrative
### Holding the line
