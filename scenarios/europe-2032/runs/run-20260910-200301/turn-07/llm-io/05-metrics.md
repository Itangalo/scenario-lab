...
- characters 13585-14473: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14517-16525: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16581-17369: `{{notepad}}` from the Game Master's notepad, carried across turns
