...
- characters 377-1265: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1309-3317: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3373-3882: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3945-28237: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28592-28871: `{{event_history}}` from the run's own event record
...
- Turn 4 (3 turn(s) ago): openweight_frontier_release, supply_chain_coercion
- Turn 5 (2 turn(s) ago): taiwan_blockade, election_consolidation
