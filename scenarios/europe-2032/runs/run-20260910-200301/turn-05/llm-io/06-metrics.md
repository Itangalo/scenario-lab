...
- characters 13632-14702: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14746-17205: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17261-18105: `{{notepad}}` from the Game Master's notepad, carried across turns
