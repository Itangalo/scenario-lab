...
- characters 1569-4028: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5309-5764: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8073-10512: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | Joint Chokepoint Defence | 8 | small | 4 | 6 | own jurisdiction and middle-power coalition | eu_ai_sovereignty up slightly, eu_political_capital down then up | 2 | running |
