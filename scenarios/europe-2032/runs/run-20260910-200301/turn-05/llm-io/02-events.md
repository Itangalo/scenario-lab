...
- characters 1491-3950: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4006-4850: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4913-28694: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29049-29262: `{{event_history}}` from the run's own event record
...
- Turn 4 (1 turn(s) ago): openweight_frontier_release, supply_chain_coercion
