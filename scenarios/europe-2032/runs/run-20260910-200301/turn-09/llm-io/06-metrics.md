...
- characters 13753-14757: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14801-17048: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17104-17919: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 65.5, "openweight_capability": 62.3, "ai_safety": 10.0, "resilience": 40.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 23.0, "public_sentiment": 12.0}
```
## Narrative
### Cut off
