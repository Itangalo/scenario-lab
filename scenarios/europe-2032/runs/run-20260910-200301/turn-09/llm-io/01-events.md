...
- characters 377-1381: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1425-3672: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3728-4220: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4283-27011: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27366-27905: `{{event_history}}` from the run's own event record
...
- Turn 4 (5 turn(s) ago): openweight_frontier_release, supply_chain_coercion
- Turn 5 (4 turn(s) ago): taiwan_blockade, election_consolidation
- Turn 7 (2 turn(s) ago): loss_of_control_incident, ai_investment_collapse, openweight_frontier_release, taiwan_tension_rise, export_control_escalation, adoption_success
- Turn 8 (1 turn(s) ago): capability_jump, us_china_agreement, emergent_insurance_retreat
