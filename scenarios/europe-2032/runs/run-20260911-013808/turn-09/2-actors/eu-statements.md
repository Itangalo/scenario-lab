...
- `two_year_commitment` (commitment): Keep essential services running and rebuild public trust while containing AI-enabled harm

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Keep essential services running and rebuild public trust while containing AI-enabled harm
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the commitment period directly changes the actor's basis for maintaining the original statement.
