...
- characters 377-2489: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2533-4556: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4612-5161: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5224-33709: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34064-34348: `{{event_history}}` from the run's own event record
...
- Turn 3 (2 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation
- Turn 4 (1 turn(s) ago): bio_uplift_findings, joint_threat_response
