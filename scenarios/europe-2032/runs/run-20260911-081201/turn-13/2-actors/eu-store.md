...
| M12 | EU Trusted Benefit Expansion | 9 | small | 11 | 13 | own jurisdiction | public_sentiment up, eu_political_capital up slightly via visible benefit; resilience up slightly via EU-hosted adoption | 2 | finished |
| M13 | EU Logistics Displacement Cushion | 7 | small | 12 | 14 | own jurisdiction | public_sentiment up, eu_political_capital protected from backlash; resilience up slightly via social absorption | 2 | running |
| M14 | EU Allied Compute Access Bargain | 8 | small | 13 | 15 | coalition partners holding supply-chain chokepoints plus own jurisdiction | eu_ai_sovereignty protected/up slightly via secured supply; resilience up slightly via continuity of EU-hosted services | 2 | running |
...
- **applied** `M14` — {"op": "add", "table": "measures", "fields": {"name": "EU Allied Compute Access Bargain", "category": 8, "size": "small", "finish_turn": 15, "applies_to": "coalition partners holding supply-chain chokepoints plus own jurisdiction", "targeted_effect": "eu_ai_sovereignty protected/up slightly via secured supply; resilience up slightly via continuity of EU-hosted services"}, "grounds": "to secure all
  - Grounds: to secure allied access under tightening export controls
