...
- characters 4438-4910: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6382-8509: `{{previous_actions}}` from the actor's own response from the previous turn
