...
| M12 | EU Trusted Benefit Expansion | 9 | small | 11 | 13 | own jurisdiction | public_sentiment up, eu_political_capital up slightly via visible benefit; resilience up slightly via EU-hosted adoption | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Logistics Displacement Cushion", "category": 7, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, eu_political_capital protected from backlash; resilience up slightly via social absorption"}, "grounds": "to contain embodied-AI labour shock driving hostility"}
  - Grounds: to contain embodied-AI labour shock driving hostility
