...
- characters 106-13107: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13150-13342: `{{metrics_json}}` from the run's live metric values
- characters 13435-14925: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14969-16925: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16981-18013: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Siting Social Licence Deal | 2 |
| M5 | EU High-Risk Redress and Oversight Fix | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Siting Social Licence Deal −2, priority −1 = −12
PROPOSAL BONUS: EU Siting Social Licence Deal (cat 4, small) +2 — emergent_datacentre_siting_backlash landed this turn and this answers it directly
LEGITIMACY LENDS: capital 24, sentiment 34 -> +2
SOVEREIGNTY: 23 last turn, no capacity event, Gigafactories in flight +0, capability rose 3.0 −1 = 22

## Emerging developments (tracked)

- `emergent_compute_insurance_repr icing` -- first noted turn 3, listed in 1 turn(s) so far: A major European insurer reprices power and water risk for AI infrastructure after the siting disputes, raising premiums and requiring independent resource audits for new computing plants.
- `emergent_hyperscaler_eu_pause` -- first noted turn 3, listed in 1 turn(s) so far: A major US hyperscaler publicly pauses its planned EU datacentre expansion, citing siting delays and power uncertainty, and redirects the capacity to the US Gulf states.
