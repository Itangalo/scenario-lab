...
- characters 376-1300: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1343-3431: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3487-4580: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4643-31587: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31942-32175: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, export_control_escalation, eu_access_secured
- Turn 2 (2 turn(s) ago): emergent_datacentre_siting_backlash, emergent_eu_open_compute_pact
- Turn 3 (1 turn(s) ago): automated_decision_scandal
