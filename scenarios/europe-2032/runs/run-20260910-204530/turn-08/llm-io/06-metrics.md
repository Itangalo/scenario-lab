...
- characters 105-13270: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13313-13504: `{{metrics_json}}` from the run's live metric values
- characters 13597-15873: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15916-18053: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18109-18425: `{{notepad}}` from the Game Master's notepad, carried across turns
