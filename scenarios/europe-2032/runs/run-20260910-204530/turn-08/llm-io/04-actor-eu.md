...
- characters 453-2729: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2772-4909: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4977-5428: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7969-9307: `{{previous_actions}}` from the actor's own response from the previous turn
