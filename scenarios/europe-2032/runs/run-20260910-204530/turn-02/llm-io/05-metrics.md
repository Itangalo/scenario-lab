...
- characters 13382-14635: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14678-16802: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16858-17266: `{{notepad}}` from the Game Master's notepad, carried across turns
