...
- characters 13487-13676: `{{metrics_json}}` from the run's live metric values
- characters 13769-15113: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15157-17248: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17304-17961: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M11 | EU Bio-Containment and Essential Care Continuity Protocol | 2 |
...
## Metrics
```json
{"ai_capability": 93.0, "openweight_capability": 85.6, "ai_safety": 2.0, "resilience": 44.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 6.0, "public_sentiment": 3.0}
```
