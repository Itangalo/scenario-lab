...
- characters 375-2105: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2148-4346: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4402-5010: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5073-31516: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31871-32362: `{{event_history}}` from the run's own event record
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, export_control_escalation, eu_access_secured
- Turn 2 (4 turn(s) ago): emergent_datacentre_siting_backlash, emergent_eu_open_compute_pact
- Turn 3 (3 turn(s) ago): automated_decision_scandal
- Turn 4 (2 turn(s) ago): eval_anomaly_reports, opaque_reasoning, openweight_frontier_release, supply_chain_coercion, emergent_hyperscaler_eu_pause
- Turn 5 (1 turn(s) ago): capability_jump, eval_anomaly_reports, eu_frontier_access_denied, election_alliance
