...
- characters 453-2183: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2226-4424: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6041-6492: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8992-11203: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Essential Services Continuity Reserve | 6 | small | 5 | 7 | own jurisdiction | resilience up, eu_ai_sovereignty up slightly via fallback demand | 2 | running |
