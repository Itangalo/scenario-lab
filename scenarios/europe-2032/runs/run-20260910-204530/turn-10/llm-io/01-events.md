...
- characters 375-2486: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2529-4625: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4681-5488: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5551-32126: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32481-33269: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Essential Services Survival and Mutual Aid Surge −2, priority −1 waived (capital<20, no effect, no cost) = −2
PROPOSAL BONUS: EU Essential Services Survival and Mutual Aid Surge (cat 6, small) +3 — cyber_major_incident fired this turn hitting public services and this answers it directly
LEGITIMACY LENDS: capital 8, sentiment 10 -> +1 capped at sentiment
SOVEREIGNTY: 25 last turn, no capacity event in flight bonus, us_labs_nationalised t9 −2, capability rose 4.0 −1 = 22

## Emerging developments (tracked)

- `emergent_judicial_grid_freeze` -- first noted turn 9, listed in 1 turn(s) so far: National courts in two member states grant interim injunctions halting new data-centre grid connections pending health and water-impact review, freezing siting decisions through the turn.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, export_control_escalation, eu_access_secured
- Turn 2 (8 turn(s) ago): emergent_datacentre_siting_backlash, emergent_eu_open_compute_pact
- Turn 3 (7 turn(s) ago): automated_decision_scandal
- Turn 4 (6 turn(s) ago): eval_anomaly_reports, opaque_reasoning, openweight_frontier_release, supply_chain_coercion, emergent_hyperscaler_eu_pause
- Turn 5 (5 turn(s) ago): capability_jump, eval_anomaly_reports, eu_frontier_access_denied, election_alliance
- Turn 6 (4 turn(s) ago): loss_of_control_incident, capability_jump, rsi_onset, labour_displacement
- Turn 7 (3 turn(s) ago): safety_breakthrough, member_state_defection
- Turn 9 (1 turn(s) ago): cyber_major_incident, capability_jump, taiwan_tension_rise, us_labs_nationalised, us_china_agreement
