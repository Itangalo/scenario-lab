...
- characters 453-2564: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2607-4703: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6361-6854: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9723-12229: `{{previous_actions}}` from the actor's own response from the previous turn
...
**emergent_judicial_grid_freeze (emergent event):** National courts in two member states grant interim injunctions halting new data-centre grid connections pending health and water-impact review, freezing siting decisions through the turn.
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Essential Services Survival and Mutual Aid Surge | 6 | small | 9 | 11 | own jurisdiction | resilience up, ai_safety up slightly via incident learning | 2 | running |
