...
- characters 13081-13271: `{{metrics_json}}` from the run's live metric values
- characters 13364-15475: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15518-17614: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17670-18167: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Essential Services Survival and Mutual Aid Surge | 2 |
| M10 | EU Lithography Leverage and Essential Compute Survival Deal | 2 |
