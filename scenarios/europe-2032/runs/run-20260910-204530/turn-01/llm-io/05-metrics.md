...
- characters 16367-16937: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_datacentre_siting_backlash` -- first noted turn 1, listed in 1 turn(s) so far: Coordinated municipal opposition delays or blocks at least one major EU data-centre or supercomputer siting decision during the turn on energy-price and water-use grounds.
- `emergent_eu_open_compute_pact` -- first noted turn 1, listed in 1 turn(s) so far: Major European research universities and open-source collectives announce a coordinated compute-pooling pact to replicate Mythos-class open models domestically after the Kimi K3 release.
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 46.0, "ai_safety": 32.0, "resilience": 38.0, "eu_ai_sovereignty": 23.0, "eu_political_capital": 39.0, "public_sentiment": 38.0}
```
...
LEGITIMACY LENDS: capital 37, sentiment 38 -> +2
SOVEREIGNTY: 22 last turn, eu_access_secured t1 +2, Gigafactories in flight +0, capability rose 3.0 −1 = 23
