...
- characters 107-13657: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13700-13889: `{{metrics_json}}` from the run's live metric values
- characters 13982-16448: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16492-18449: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18505-18974: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Embodied Systems and Essential Workforce Continuity Shield | 2 |
