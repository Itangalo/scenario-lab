...
- characters 375-2841: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2885-4842: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4898-5367: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5430-30475: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30830-31971: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Lithography Leverage and Essential Compute Survival Deal −2, EU Bio-Containment and Essential Care Continuity Protocol −2, priority −1 waived (capital<20, no effect, no cost) = −4
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 3, sentiment 4 -> +1 capped check applied in totals (capital remains below sentiment)
SOVEREIGNTY: 15 last turn, no capacity event, no cat4 in flight +0, capability rose 1.5 −0 = 15
...
- Turn 2 (11 turn(s) ago): emergent_datacentre_siting_backlash, emergent_eu_open_compute_pact
- Turn 3 (10 turn(s) ago): automated_decision_scandal
- Turn 4 (9 turn(s) ago): eval_anomaly_reports, opaque_reasoning, openweight_frontier_release, supply_chain_coercion, emergent_hyperscaler_eu_pause
- Turn 5 (8 turn(s) ago): capability_jump, eval_anomaly_reports, eu_frontier_access_denied, election_alliance
- Turn 6 (7 turn(s) ago): loss_of_control_incident, capability_jump, rsi_onset, labour_displacement
- Turn 7 (6 turn(s) ago): safety_breakthrough, member_state_defection
- Turn 9 (4 turn(s) ago): cyber_major_incident, capability_jump, taiwan_tension_rise, us_labs_nationalised, us_china_agreement
- Turn 10 (3 turn(s) ago): taiwan_blockade, bio_uplift_findings, supply_chain_coercion, emergent_judicial_grid_freeze
- Turn 11 (2 turn(s) ago): bio_incident, capability_jump, bio_uplift_findings, embodied_ai_deployment, export_control_escalation, eu_frontier_access_denied
- Turn 12 (1 turn(s) ago): bio_uplift_findings, openweight_frontier_release
