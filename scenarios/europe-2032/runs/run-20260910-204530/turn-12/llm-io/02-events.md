...
- characters 374-2154: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2197-4683: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4739-5442: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5505-30550: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30905-31969: `{{event_history}}` from the run's own event record
...
- Turn 2 (10 turn(s) ago): emergent_datacentre_siting_backlash, emergent_eu_open_compute_pact
- Turn 3 (9 turn(s) ago): automated_decision_scandal
- Turn 4 (8 turn(s) ago): eval_anomaly_reports, opaque_reasoning, openweight_frontier_release, supply_chain_coercion, emergent_hyperscaler_eu_pause
- Turn 5 (7 turn(s) ago): capability_jump, eval_anomaly_reports, eu_frontier_access_denied, election_alliance
- Turn 6 (6 turn(s) ago): loss_of_control_incident, capability_jump, rsi_onset, labour_displacement
- Turn 7 (5 turn(s) ago): safety_breakthrough, member_state_defection
- Turn 9 (3 turn(s) ago): cyber_major_incident, capability_jump, taiwan_tension_rise, us_labs_nationalised, us_china_agreement
- Turn 10 (2 turn(s) ago): taiwan_blockade, bio_uplift_findings, supply_chain_coercion, emergent_judicial_grid_freeze
- Turn 11 (1 turn(s) ago): bio_incident, capability_jump, bio_uplift_findings, embodied_ai_deployment, export_control_escalation, eu_frontier_access_denied
