...
- characters 13088-13277: `{{metrics_json}}` from the run's live metric values
- characters 13370-15150: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15193-17679: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17735-18438: `{{notepad}}` from the Game Master's notepad, carried across turns
