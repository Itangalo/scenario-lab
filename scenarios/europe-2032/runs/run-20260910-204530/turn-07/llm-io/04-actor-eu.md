...
- characters 453-2568: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2612-5216: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5922-6373: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9065-11387: `{{previous_actions}}` from the actor's own response from the previous turn
