...
- characters 375-2490: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2534-5138: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5194-6406: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6469-35036: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35391-35982: `{{event_history}}` from the run's own event record
...
- `emergent_liability_insurance_retreat` -- first noted turn 6, listed in 1 turn(s) so far: Insurers extend AI-exclusion clauses from compute plants to hospitals and utilities using US frontier models, forcing emergency public reinsurance debate after the autumn cutoffs.
- `emergent_allied_access_litigation` -- first noted turn 6, listed in 1 turn(s) so far: US insurers and hospital groups sue a frontier lab after the EU cutoff disruptions, forcing first court-ordered disclosure of allocation and refusal logs for allied customers.
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, export_control_escalation, eu_access_secured
- Turn 2 (5 turn(s) ago): emergent_datacentre_siting_backlash, emergent_eu_open_compute_pact
- Turn 3 (4 turn(s) ago): automated_decision_scandal
- Turn 4 (3 turn(s) ago): eval_anomaly_reports, opaque_reasoning, openweight_frontier_release, supply_chain_coercion, emergent_hyperscaler_eu_pause
- Turn 5 (2 turn(s) ago): capability_jump, eval_anomaly_reports, eu_frontier_access_denied, election_alliance
- Turn 6 (1 turn(s) ago): loss_of_control_incident, capability_jump, rsi_onset, labour_displacement
