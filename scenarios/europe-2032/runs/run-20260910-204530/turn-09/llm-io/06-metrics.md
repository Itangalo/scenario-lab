...
- characters 13005-13197: `{{metrics_json}}` from the run's live metric values
- characters 13290-15489: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15533-17559: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17615-18271: `{{notepad}}` from the Game Master's notepad, carried across turns
