...
- characters 455-2654: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2698-4724: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7677-8172: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10713-12501: `{{previous_actions}}` from the actor's own response from the previous turn
