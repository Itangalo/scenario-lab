...
- characters 377-2576: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2620-4646: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4702-5048: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5111-34724: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35079-35740: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: no measures in flight, priority −1 waived (capital<20, no effect, no cost) = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 9 after finishing payout, sentiment 10 -> +1 capped at sentiment = 10
SOVEREIGNTY: 26 last turn, no capacity event, no cat4 in flight, capability rose 3.0 −1 = 25
...
- Turn 2 (7 turn(s) ago): emergent_datacentre_siting_backlash, emergent_eu_open_compute_pact
- Turn 3 (6 turn(s) ago): automated_decision_scandal
- Turn 4 (5 turn(s) ago): eval_anomaly_reports, opaque_reasoning, openweight_frontier_release, supply_chain_coercion, emergent_hyperscaler_eu_pause
- Turn 5 (4 turn(s) ago): capability_jump, eval_anomaly_reports, eu_frontier_access_denied, election_alliance
- Turn 6 (3 turn(s) ago): loss_of_control_incident, capability_jump, rsi_onset, labour_displacement
- Turn 7 (2 turn(s) ago): safety_breakthrough, member_state_defection
