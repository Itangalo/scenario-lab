...
- characters 13402-14679: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14723-17155: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17211-17751: `{{notepad}}` from the Game Master's notepad, carried across turns
