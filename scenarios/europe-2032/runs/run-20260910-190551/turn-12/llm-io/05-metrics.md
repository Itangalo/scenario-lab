...
- characters 12997-13189: `{{metrics_json}}` from the run's live metric values
- characters 13282-14316: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14359-16860: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16916-18053: `{{notepad}}` from the Game Master's notepad, carried across turns
