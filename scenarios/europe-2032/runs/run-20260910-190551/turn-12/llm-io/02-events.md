...
- characters 1454-3955: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4011-4541: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4604-32070: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32425-33686: `{{event_history}}` from the run's own event record
...
- Turn 2 (10 turn(s) ago): capability_jump, knowledge_work_augmented, adoption_success
- Turn 3 (9 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, member_state_defection
- Turn 4 (8 turn(s) ago): export_control_escalation
- Turn 5 (7 turn(s) ago): safety_breakthrough, labour_displacement, automated_decision_scandal, middle_power_coalition, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, labour_displacement, embodied_ai_deployment, export_control_escalation, emergent_clinical_continuity_pact
- Turn 7 (5 turn(s) ago): taiwan_tension_rise
- Turn 8 (4 turn(s) ago): eval_anomaly_reports, safety_breakthrough, embodied_ai_deployment, taiwan_tension_rise, emergent_grid_site_sabotage
- Turn 9 (3 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, eval_anomaly_reports, safety_breakthrough, emergent_humanoid_safety_scare
- Turn 10 (2 turn(s) ago): openweight_frontier_release, export_control_escalation
- Turn 11 (1 turn(s) ago): cyber_major_incident, capability_jump, knowledge_work_augmented, embodied_ai_deployment, middle_power_coalition
