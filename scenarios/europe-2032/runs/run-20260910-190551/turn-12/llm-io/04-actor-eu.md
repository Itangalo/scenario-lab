...
- characters 455-1489: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1532-4033: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5037-5514: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8973-10854: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M12 | EU Municipal Ransomware Containment and Verified Recovery Corps | 6 | small | 11 | 13 | own jurisdiction | resilience up moderately, eu_political_capital up slightly | 2 | running |
