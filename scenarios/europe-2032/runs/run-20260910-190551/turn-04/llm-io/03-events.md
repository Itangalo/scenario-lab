...
- characters 376-1762: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1805-4091: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4147-4797: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- characters 29442-29769: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): capability_jump, knowledge_work_augmented, adoption_success
- Turn 3 (1 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, member_state_defection
