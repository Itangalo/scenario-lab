...
- characters 105-13121: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13164-13356: `{{metrics_json}}` from the run's live metric values
- characters 13449-14835: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14878-17164: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17220-18454: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Loss-of-Control Containment and Service Continuity Protocol | 2 |
| M6 | Allied Volume-Licence and Supply-Chain Bargain | 2 |
