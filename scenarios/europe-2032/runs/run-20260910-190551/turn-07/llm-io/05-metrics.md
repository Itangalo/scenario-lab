...
- characters 13687-16050: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16094-18346: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18402-19301: `{{notepad}}` from the Game Master's notepad, carried across turns
