...
- characters 105-13025: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13068-13260: `{{metrics_json}}` from the run's live metric values
- characters 13353-14354: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14397-16998: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17054-18175: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Frontier Capability Watch | 2 |
