...
- characters 2440-6018: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8800-9275: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11807-14400: `{{previous_actions}}` from the actor's own response from the previous turn
