...
- characters 106-13342: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13385-13577: `{{metrics_json}}` from the run's live metric values
- characters 13670-14705: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14748-16794: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16850-17658: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Offline Fallback and Unrecallable-Capability Shield | 2 |
...
## Metrics
```json
{"ai_capability": 66.5, "openweight_capability": 64.0, "ai_safety": 19.0, "resilience": 52.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 15.0, "public_sentiment": 17.0}
```
