...
- characters 455-1490: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1533-3579: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4361-4838: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7750-10326: `{{previous_actions}}` from the actor's own response from the previous turn
