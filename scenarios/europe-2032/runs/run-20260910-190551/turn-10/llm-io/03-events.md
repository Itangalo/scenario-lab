...
- characters 377-1412: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1455-3501: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3557-4365: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4428-31894: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32249-33287: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Essential Services Continuity and Rapid Patching Drive −2, priority −1 = −3
PROPOSAL BONUS: EU Essential Services Continuity and Rapid Patching Drive (cat 6, small) +4 — cyber_major_incident this turn plus safety at 22 with anomalous evals, this answers both directly
LEGITIMACY LENDS: capital 13, sentiment 19 -> +2
SOVEREIGNTY: 18 last turn, no cat4 finish, no cat4 in flight, ai_investment_collapse t9 −2, capability rose 1.0 no penalty = 16

## Emerging developments (tracked)

- `emergent_humanoid_workplace_injury` -- first noted turn 9, listed in 1 turn(s) so far: A foreign-built logistics humanoid deployed in a European port warehouse malfunctions causing serious worker injuries, triggering product-safety investigations and calls for EU machine-certification requirements.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports
- Turn 2 (8 turn(s) ago): capability_jump, knowledge_work_augmented, adoption_success
- Turn 3 (7 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, member_state_defection
- Turn 4 (6 turn(s) ago): export_control_escalation
- Turn 5 (5 turn(s) ago): safety_breakthrough, labour_displacement, automated_decision_scandal, middle_power_coalition, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, labour_displacement, embodied_ai_deployment, export_control_escalation, emergent_clinical_continuity_pact
- Turn 7 (3 turn(s) ago): taiwan_tension_rise
- Turn 8 (2 turn(s) ago): eval_anomaly_reports, safety_breakthrough, embodied_ai_deployment, taiwan_tension_rise, emergent_grid_site_sabotage
- Turn 9 (1 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, eval_anomaly_reports, safety_breakthrough, emergent_humanoid_safety_scare
