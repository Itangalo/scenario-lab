...
- characters 378-1629: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1673-3721: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3777-4605: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4668-32134: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32489-33610: `{{event_history}}` from the run's own event record
...
- `emergent_humanoid_workplace_injury` -- first noted turn 9, listed in 2 turn(s) so far: A foreign-built logistics humanoid deployed in a European port warehouse malfunctions causing serious worker injuries, triggering product-safety investigations and calls for EU machine-certification requirements.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports
- Turn 2 (9 turn(s) ago): capability_jump, knowledge_work_augmented, adoption_success
- Turn 3 (8 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, member_state_defection
- Turn 4 (7 turn(s) ago): export_control_escalation
- Turn 5 (6 turn(s) ago): safety_breakthrough, labour_displacement, automated_decision_scandal, middle_power_coalition, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, labour_displacement, embodied_ai_deployment, export_control_escalation, emergent_clinical_continuity_pact
- Turn 7 (4 turn(s) ago): taiwan_tension_rise
- Turn 8 (3 turn(s) ago): eval_anomaly_reports, safety_breakthrough, embodied_ai_deployment, taiwan_tension_rise, emergent_grid_site_sabotage
- Turn 9 (2 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, eval_anomaly_reports, safety_breakthrough, emergent_humanoid_safety_scare
