...
- characters 13424-13616: `{{metrics_json}}` from the run's live metric values
- characters 13709-14960: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15004-17052: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17108-17596: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Municipal Ransomware Containment and Verified Recovery Corps | 2 |
