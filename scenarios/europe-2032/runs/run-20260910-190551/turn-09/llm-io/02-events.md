...
- characters 377-1402: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1446-3389: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3445-3877: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3940-31147: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31502-32366: `{{event_history}}` from the run's own event record
...
- Turn 2 (7 turn(s) ago): capability_jump, knowledge_work_augmented, adoption_success
- Turn 3 (6 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, member_state_defection
- Turn 4 (5 turn(s) ago): export_control_escalation
- Turn 5 (4 turn(s) ago): safety_breakthrough, labour_displacement, automated_decision_scandal, middle_power_coalition, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, labour_displacement, embodied_ai_deployment, export_control_escalation, emergent_clinical_continuity_pact
- Turn 7 (2 turn(s) ago): taiwan_tension_rise
- Turn 8 (1 turn(s) ago): eval_anomaly_reports, safety_breakthrough, embodied_ai_deployment, taiwan_tension_rise, emergent_grid_site_sabotage
