...
- characters 455-1480: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1524-3467: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5701-6176: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8912-10794: `{{previous_actions}}` from the actor's own response from the previous turn
