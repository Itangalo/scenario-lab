...
- characters 13394-13586: `{{metrics_json}}` from the run's live metric values
- characters 13679-14704: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14748-16691: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16747-17519: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Essential Services Continuity and Rapid Patching Drive | 2 |
