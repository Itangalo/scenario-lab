...
- characters 105-13533: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13576-13768: `{{metrics_json}}` from the run's live metric values
- characters 13861-15093: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15136-17698: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17754-18121: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Grid and Gigafactory Protection Pact | 2 |
...
## Notepad
PORTFOLIO CHARGE t8: EU Grid and Gigafactory Protection Pact −2, priority −1 = −3
PROPOSAL BONUS: EU Grid and Gigafactory Protection Pact (cat 6, small) +3 — grid sabotage freeze this turn plus safety at 17 with anomalous evals, this answers both directly
LEGITIMACY LENDS: capital 15, sentiment 26 -> +2
SOVEREIGNTY: 20 last turn, no cat4 finish, no cat4 in flight, embodied_ai_deployment t8 −2, capability rose 1.0 no penalty = 18
