...
- characters 376-1608: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1651-4213: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4269-4964: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5027-32234: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32589-33311: `{{event_history}}` from the run's own event record
...
- `emergent_grid_site_sabotage` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated physical blockades and sabotage of gigafactory grid connections escalate, forcing a prolonged construction freeze at one unlocked site and a national debate over protecting energy infrastructure.
...
- Turn 2 (6 turn(s) ago): capability_jump, knowledge_work_augmented, adoption_success
- Turn 3 (5 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, member_state_defection
- Turn 4 (4 turn(s) ago): export_control_escalation
- Turn 5 (3 turn(s) ago): safety_breakthrough, labour_displacement, automated_decision_scandal, middle_power_coalition, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, labour_displacement, embodied_ai_deployment, export_control_escalation, emergent_clinical_continuity_pact
- Turn 7 (1 turn(s) ago): taiwan_tension_rise
