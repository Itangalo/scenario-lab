...
- characters 376-1497: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1541-3613: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3669-4679: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4742-32208: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32563-33897: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Municipal Ransomware Containment and Verified Recovery Corps −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: none — capital 15, sentiment 14, capital higher
SOVEREIGNTY: 14 last turn, no cat4 finish, no cat4 in flight +0, middle_power_coalition t12 +2, capability rose 1.0 no penalty = 16

## Emerging developments (tracked)

- `emergent_logistics_robot_stoppage` -- first noted turn 12, listed in 1 turn(s) so far: A coordinated stoppage spreads across foreign-run automated warehouses and ports after a further robotics injury, blocking pallet flows for days and forcing emergency manual handling.
- `emergent_anti_datacentre_blockades` -- first noted turn 12, listed in 1 turn(s) so far: Coordinated physical protests block construction and power connections at several planned data-centre and logistics-automation sites across multiple member states, delaying builds without any EU decision.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports
- Turn 2 (11 turn(s) ago): capability_jump, knowledge_work_augmented, adoption_success
- Turn 3 (10 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, member_state_defection
- Turn 4 (9 turn(s) ago): export_control_escalation
- Turn 5 (8 turn(s) ago): safety_breakthrough, labour_displacement, automated_decision_scandal, middle_power_coalition, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, labour_displacement, embodied_ai_deployment, export_control_escalation, emergent_clinical_continuity_pact
- Turn 7 (6 turn(s) ago): taiwan_tension_rise
- Turn 8 (5 turn(s) ago): eval_anomaly_reports, safety_breakthrough, embodied_ai_deployment, taiwan_tension_rise, emergent_grid_site_sabotage
- Turn 9 (4 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, eval_anomaly_reports, safety_breakthrough, emergent_humanoid_safety_scare
- Turn 10 (3 turn(s) ago): openweight_frontier_release, export_control_escalation
- Turn 11 (2 turn(s) ago): cyber_major_incident, capability_jump, knowledge_work_augmented, embodied_ai_deployment, middle_power_coalition
- Turn 12 (1 turn(s) ago): cyber_major_incident, middle_power_coalition
