...
- characters 13768-14682: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14726-16666: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16722-17216: `{{notepad}}` from the Game Master's notepad, carried across turns
