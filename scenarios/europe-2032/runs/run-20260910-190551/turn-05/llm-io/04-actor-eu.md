...
- characters 2070-4069: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7534-8012: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10326-12081: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | Allied Volume-Licence and Supply-Chain Bargain | 8 | small | 4 | 6 | US plus middle-power coalition | eu_ai_sovereignty up slightly, eu_political_capital stable | 2 | running |
