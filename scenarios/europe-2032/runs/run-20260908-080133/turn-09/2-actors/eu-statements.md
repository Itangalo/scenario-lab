...
- `two_year_commitment` (commitment): Secure sovereign operational control over AI systems in critical public infrastructure

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign operational control over AI systems in critical public infrastructure
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the commitment period directly alters the actor's obligation to maintain the original statement, triggering a natural reassessment of its relevance and cost.
