...
- `two_year_commitment` (commitment): Defend critical infrastructure and build sovereign capacity to control AI development

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Defend critical infrastructure and build sovereign capacity to control AI development
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the two-year period directly ends the original commitment's timeframe, altering the actor's obligation and enabling a strategic update to its stated priority.
