...
- **applied** `M6` — {"op": "add", "table": "measures", "fields": {"name": "EU Loss-of-Control and Cyber Defence Protocol", "category": 6, "size": "small", "finish_turn": 7, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety up slightly"}, "grounds": "answer ransomware spillover and loss-of-control with breakthrough defence"}
  - Grounds: answer ransomware spillover and loss-of-control with breakthrough defence
