...
- characters 377-1464: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1508-3443: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3499-4609: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4672-33157: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33512-34025: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, Municipal Ransomware Triage Cells −2, priority M5 −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 10, sentiment 36 -> +2 (included in capital calc, capped below sentiment)
SOVEREIGNTY: 14 last turn, no cat4 finish, Gigafactories in flight +1, member_state_defection t4 −2 (largest capacity event, middle_power_coalition also secures but defection reaches further), capability rose 2.0 −1 = 12

## Emerging developments (tracked)

- `emergent_municipal_ransomware_spillover` -- first noted turn 4, listed in 1 turn(s) so far: A coordinated copycat wave of municipal ransomware using the same Chinese open-weight burglary kits spreads to mid-sized hospitals and utilities, forcing emergency nationalisations of local IT.
- `emergent_care_system_lockup` -- first noted turn 4, listed in 1 turn(s) so far: A coordinated hospital ransomware outage across two member states forces emergency patient diversions, turning the municipal crime-wave tooling into a visible healthcare continuity crisis.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, capability_jump, cyber_defence_breakthrough, knowledge_work_augmented, supply_chain_coercion
- Turn 2 (3 turn(s) ago): loss_of_control_incident, taiwan_tension_rise, eu_frontier_access_denied, emergent_datacentre_backlash
- Turn 3 (2 turn(s) ago): knowledge_work_augmented, emergent_kimi_crime_wave
- Turn 4 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, member_state_defection, middle_power_coalition
...
```
[{"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.46}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.22}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.18}, {"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.18}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.25}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.08}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.05}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.14}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.06}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "A coordinated copycat wave of municipal ransomware using the same Chinese open-weight burglary kits spreads to mid-sized hospitals and utilities, forcing emergency nationalisations of local IT.", "emergent": true, "id": "emergent_municipal_ransomware_spillover", "probability": 0.24}, {"description": "A coordinated hospital ransomware outage across two member states forces emergency patient diversions, turning the municipal crime-wave tooling into a visible healthcare continuity crisis.", "emergent": true, "id": "emergent_care_system_lockup", "probability": 0.2}]
```
