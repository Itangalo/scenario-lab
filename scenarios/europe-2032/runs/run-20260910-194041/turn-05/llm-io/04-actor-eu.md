...
- characters 455-1542: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1586-3521: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5950-6430: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8506-9893: `{{previous_actions}}` from the actor's own response from the previous turn
