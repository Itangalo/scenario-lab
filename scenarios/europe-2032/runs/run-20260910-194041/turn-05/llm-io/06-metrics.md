...
- characters 106-13347: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13390-13582: `{{metrics_json}}` from the run's live metric values
- characters 13675-14762: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14806-16741: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16797-17618: `{{notepad}}` from the Game Master's notepad, carried across turns
