...
- characters 16346-16912: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_datacentre_backlash` -- first noted turn 1, listed in 1 turn(s) so far: Coordinated municipal protests and permit challenges stall several planned EU data-centre expansions after power-price and water-use concerns merge with AI job anxiety in local media.
- `emergent_kimi_crime_wave` -- first noted turn 1, listed in 1 turn(s) so far: Criminal ransomware crews openly advertise tooling fine-tuned from Kimi K3, triggering a visible wave of AI-assisted intrusions against European SMEs and municipalities in late 2026.
...
## Metrics
```json
{"ai_capability": 54.0, "openweight_capability": 46.0, "ai_safety": 31.0, "resilience": 37.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 40.0, "public_sentiment": 44.0}
```
...
## Notepad
PORTFOLIO CHARGE t1: Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Shield −3, priority −1 = −10
PROPOSAL BONUS: EU Critical Infrastructure Shield (cat 6, large) +4 — autumn cross-operator intrusion test-shot landed this turn severe and this answers it directly
LEGITIMACY LENDS: none — capital 48 above sentiment 42
SOVEREIGNTY: 22 last turn, no capacity event? supply_chain_coercion t1 −2, Gigafactories in flight +0, capability rose 2.0 −1 = 19
