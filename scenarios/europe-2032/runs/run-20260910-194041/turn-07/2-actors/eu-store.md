...
| M8 | EU Bio Shield Detection Upgrade | 6 | small | 7 | 8 | own jurisdiction | resilience up moderately | 2 | running |
...
- **applied** `M8` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio Shield Detection Upgrade", "category": 6, "size": "small", "finish_turn": 8, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately"}, "grounds": "answer bio-uplift precursor while clinical trust window holds"}
  - Grounds: answer bio-uplift precursor while clinical trust window holds
