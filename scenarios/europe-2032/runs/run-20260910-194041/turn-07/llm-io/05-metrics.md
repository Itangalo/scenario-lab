...
- characters 106-13564: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13607-13797: `{{metrics_json}}` from the run's live metric values
- characters 13890-15300: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15344-17426: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17482-18389: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Bio Shield Detection Upgrade | 2 |
