...
- characters 1829-3911: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3967-4539: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4602-31809: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32164-33015: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, capability_jump, cyber_defence_breakthrough, knowledge_work_augmented, supply_chain_coercion
- Turn 2 (5 turn(s) ago): loss_of_control_incident, taiwan_tension_rise, eu_frontier_access_denied, emergent_datacentre_backlash
- Turn 3 (4 turn(s) ago): knowledge_work_augmented, emergent_kimi_crime_wave
- Turn 4 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, member_state_defection, middle_power_coalition
- Turn 5 (2 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, loss_of_control_incident, emergent_municipal_ransomware_spillover, election_consolidation
- Turn 6 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, capability_jump, eval_anomaly_reports, openweight_frontier_release, member_state_defection
