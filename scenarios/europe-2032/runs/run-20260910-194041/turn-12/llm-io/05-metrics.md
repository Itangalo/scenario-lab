...
- characters 106-12988: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13031-13219: `{{metrics_json}}` from the run's live metric values
- characters 13312-14558: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14601-16904: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16960-17457: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M13 | EU Middle-Power Patch and Supply Shield | 2 |
