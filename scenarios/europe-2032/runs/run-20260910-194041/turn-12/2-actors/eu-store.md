...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Middle-Power Patch and Supply Shield", "category": 8, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction + middle-power coalition + US", "targeted_effect": "resilience up moderately, eu_political_capital up slightly, eu_ai_sovereignty up slightly via secured supply"}, "grounds": "use defence breakthrough and coalition windo
  - Grounds: use defence breakthrough and coalition window to restore supply and trust
