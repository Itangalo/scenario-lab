...
- characters 13756-14953: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14997-17047: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17103-17647: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | Municipal Ransomware Triage Cells | 2 |
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Continuity and Agent Safety Reserve −3, Municipal Ransomware Triage Cells −2, priority −1 = −12
PROPOSAL BONUS: Municipal Ransomware Triage Cells (cat 6, small) +3 — emergent crime wave against SMEs/municipalities landed this turn severe and this answers it directly
