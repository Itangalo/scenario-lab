...
| M7 | EU Hospital Continuity Backstop | 6 | small | 6 | 7 | own jurisdiction | resilience up moderately | 2 | running |
...
- **applied** `M7` — {"op": "add", "table": "measures", "fields": {"name": "EU Hospital Continuity Backstop", "category": 6, "size": "small", "finish_turn": 7, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately"}, "grounds": "keep hospitals/utilities running through automated attack"}
  - Grounds: keep hospitals/utilities running through automated attack
