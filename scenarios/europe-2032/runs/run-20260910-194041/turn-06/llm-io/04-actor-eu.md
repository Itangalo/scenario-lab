...
- characters 452-2102: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2145-4034: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6753-7230: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9465-11830: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Loss-of-Control and Cyber Defence Protocol | 6 | small | 5 | 7 | own jurisdiction | resilience up moderately, ai_safety up slightly | 2 | running |
