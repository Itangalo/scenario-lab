...
- characters 374-2024: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2067-3956: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4012-4933: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4996-31600: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31955-32641: `{{event_history}}` from the run's own event record
...
- `emergent_care_system_lockup` -- first noted turn 4, listed in 2 turn(s) so far: A coordinated hospital ransomware outage across two member states forces emergency patient diversions, turning the municipal crime-wave tooling into a visible healthcare continuity crisis.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, capability_jump, cyber_defence_breakthrough, knowledge_work_augmented, supply_chain_coercion
- Turn 2 (4 turn(s) ago): loss_of_control_incident, taiwan_tension_rise, eu_frontier_access_denied, emergent_datacentre_backlash
- Turn 3 (3 turn(s) ago): knowledge_work_augmented, emergent_kimi_crime_wave
- Turn 4 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, member_state_defection, middle_power_coalition
- Turn 5 (1 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, loss_of_control_incident, emergent_municipal_ransomware_spillover, election_consolidation
