...
- characters 13756-15406: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15449-17338: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17394-18006: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Loss-of-Control and Cyber Defence Protocol | 2 |
| M7 | EU Hospital Continuity Backstop | 2 |
...
## Metrics
```json
{"ai_capability": 62.5, "openweight_capability": 56.0, "ai_safety": 1.0, "resilience": 39.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 6.0, "public_sentiment": 22.0}
```
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 election winner took office turn 6"}]}
```
```
