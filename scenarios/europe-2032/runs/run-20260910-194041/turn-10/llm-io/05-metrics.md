...
- characters 13315-13505: `{{metrics_json}}` from the run's live metric values
- characters 13598-15000: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15043-16968: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17024-17861: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Restore and Paper Continuity Corps | 2 |
...
## Metrics
```json
{"ai_capability": 66.3, "openweight_capability": 64.1, "ai_safety": 0.0, "resilience": 53.0, "eu_ai_sovereignty": 12.0, "eu_political_capital": 14.0, "public_sentiment": 10.0}
```
