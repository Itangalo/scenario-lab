...
- characters 375-1777: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1820-3745: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3801-4283: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4346-31812: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32167-33321: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Power-Health Islanding Pact −2, priority no cost (capital below 20) = −2
PROPOSAL BONUS: EU Power-Health Islanding Pact (cat 6, small) +2 — answers cutoff cascade and substation interference fights directly, small size and leftover funding limit it
LEGITIMACY LENDS: capital 9, sentiment 14 -> +2 (capped, counted in capital)
SOVEREIGNTY: 17 last turn, no cat4 finish, no cat4 in flight +0, export_control_escalation t9 −2, capability rose 0.8 no charge = 15
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, capability_jump, cyber_defence_breakthrough, knowledge_work_augmented, supply_chain_coercion
- Turn 2 (8 turn(s) ago): loss_of_control_incident, taiwan_tension_rise, eu_frontier_access_denied, emergent_datacentre_backlash
- Turn 3 (7 turn(s) ago): knowledge_work_augmented, emergent_kimi_crime_wave
- Turn 4 (6 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, member_state_defection, middle_power_coalition
- Turn 5 (5 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, loss_of_control_incident, emergent_municipal_ransomware_spillover, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, capability_jump, eval_anomaly_reports, openweight_frontier_release, member_state_defection
- Turn 7 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, adoption_success
- Turn 8 (2 turn(s) ago): cyber_major_incident, research_breakthrough, eu_frontier_access_denied
- Turn 9 (1 turn(s) ago): cyber_major_incident, ai_investment_collapse, medical_breakthrough, export_control_escalation
