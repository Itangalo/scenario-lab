...
- characters 453-1855: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1898-3823: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4579-5042: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7625-10109: `{{previous_actions}}` from the actor's own response from the previous turn
