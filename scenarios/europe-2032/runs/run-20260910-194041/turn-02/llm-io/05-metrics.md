...
- characters 105-13042: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13085-13277: `{{metrics_json}}` from the run's live metric values
- characters 13370-14696: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14739-17358: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17414-18188: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Continuity and Agent Safety Reserve | 3 |
...
- `emergent_kimi_crime_wave` -- first noted turn 1, listed in 2 turn(s) so far: Criminal ransomware crews openly advertise tooling fine-tuned from Kimi K3, triggering a visible wave of AI-assisted intrusions against European SMEs and municipalities in late 2026.
...
## Notepad
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Shield −3, EU Continuity and Agent Safety Reserve −3, priority −1 = −13
PROPOSAL BONUS: EU Continuity and Agent Safety Reserve (cat 5, large) +5 — eu_frontier_access_denied and loss_of_control_incident landed this turn severe and this answers both directly
LEGITIMACY LENDS: capital 15, sentiment 36 -> +2
SOVEREIGNTY: 19 last turn, no capacity event? eu_frontier_access_denied t2 −3, Gigafactories in flight +0, capability rose 2.0 −1 = 15
