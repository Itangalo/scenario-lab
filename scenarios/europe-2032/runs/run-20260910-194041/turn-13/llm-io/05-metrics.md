...
- characters 107-13354: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13397-13586: `{{metrics_json}}` from the run's live metric values
- characters 13679-15246: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15290-17114: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17170-18033: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_insurance_corridor_freeze` -- first noted turn 13, listed in 1 turn(s) so far: Insurers abruptly withdraw cover for aligned-licence spares shipments after a contested seizure in transit, freezing the middle-power supply corridor the Commission showcased.
...
## Notepad
PORTFOLIO CHARGE t13: M13 EU Middle-Power Patch and Supply Shield −2, priority no cost (capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 10, sentiment 5 -> none (capital not below sentiment)
SOVEREIGNTY: 11 last turn, no cat4 finish, no cat4 in flight +0, no capacity event, capability rose 0.5 no charge = 11
