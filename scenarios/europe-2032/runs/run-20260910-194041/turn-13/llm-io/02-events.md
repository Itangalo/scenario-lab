...
- characters 375-1942: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1986-3810: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3866-4425: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4488-31236: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31591-32994: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M12 EU Upstream Bargain and Anti-Defection Hold −2, M13 EU Middle-Power Patch and Supply Shield −2, priority no cost (capital below 20) = −4
PROPOSAL BONUS: EU Middle-Power Patch and Supply Shield (cat 8, small) +3 — answers recent blockade/rationing and defection strain directly, uses current breakthrough and coalition window
LEGITIMACY LENDS: capital 7, sentiment 4 -> none (capital not below sentiment)
SOVEREIGNTY: 9 last turn, no cat4 finish, no cat4 in flight +0, middle_power_coalition t12 +2, capability rose 0.7 no charge = 11
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, capability_jump, cyber_defence_breakthrough, knowledge_work_augmented, supply_chain_coercion
- Turn 2 (11 turn(s) ago): loss_of_control_incident, taiwan_tension_rise, eu_frontier_access_denied, emergent_datacentre_backlash
- Turn 3 (10 turn(s) ago): knowledge_work_augmented, emergent_kimi_crime_wave
- Turn 4 (9 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, member_state_defection, middle_power_coalition
- Turn 5 (8 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, loss_of_control_incident, emergent_municipal_ransomware_spillover, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, loss_of_control_incident, capability_jump, eval_anomaly_reports, openweight_frontier_release, member_state_defection
- Turn 7 (6 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, adoption_success
- Turn 8 (5 turn(s) ago): cyber_major_incident, research_breakthrough, eu_frontier_access_denied
- Turn 9 (4 turn(s) ago): cyber_major_incident, ai_investment_collapse, medical_breakthrough, export_control_escalation
- Turn 10 (3 turn(s) ago): taiwan_tension_rise, eu_frontier_access_denied
- Turn 11 (2 turn(s) ago): taiwan_blockade, export_control_escalation, member_state_defection
- Turn 12 (1 turn(s) ago): cyber_defence_breakthrough, middle_power_coalition
