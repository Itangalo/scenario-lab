...
- characters 377-1514: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1558-3611: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3667-4430: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4493-31959: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32314-33543: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Restore and Paper Continuity Corps −2, priority no cost (capital below 20) = −2
PROPOSAL BONUS: none — M11 already in flight, no new measure entered portfolio this turn
LEGITIMACY LENDS: capital 14, sentiment 14 -> none (capital not below sentiment)
SOVEREIGNTY: 15 last turn, no cat4 finish, no cat4 in flight +0, eu_frontier_access_denied t10 −3, capability rose 1.0 no charge = 12

## Emerging developments (tracked)

- `emergent_municipal_grid_seizure` -- first noted turn 10, listed in 1 turn(s) so far: With hospitals on paper fallbacks and pharmacies queuing, mayors organise a winter anti-blackout pact to seize idle compute-hall grid connections for district heating and clinics, escalating siting fights into physical blockades.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, capability_jump, cyber_defence_breakthrough, knowledge_work_augmented, supply_chain_coercion
- Turn 2 (9 turn(s) ago): loss_of_control_incident, taiwan_tension_rise, eu_frontier_access_denied, emergent_datacentre_backlash
- Turn 3 (8 turn(s) ago): knowledge_work_augmented, emergent_kimi_crime_wave
- Turn 4 (7 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, member_state_defection, middle_power_coalition
- Turn 5 (6 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, loss_of_control_incident, emergent_municipal_ransomware_spillover, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, capability_jump, eval_anomaly_reports, openweight_frontier_release, member_state_defection
- Turn 7 (4 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, adoption_success
- Turn 8 (3 turn(s) ago): cyber_major_incident, research_breakthrough, eu_frontier_access_denied
- Turn 9 (2 turn(s) ago): cyber_major_incident, ai_investment_collapse, medical_breakthrough, export_control_escalation
- Turn 10 (1 turn(s) ago): taiwan_tension_rise, eu_frontier_access_denied
