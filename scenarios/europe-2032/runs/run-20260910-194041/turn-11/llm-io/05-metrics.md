...
- characters 107-13287: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13330-13521: `{{metrics_json}}` from the run's live metric values
- characters 13614-14751: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14795-16848: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16904-17667: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Upstream Bargain and Anti-Defection Hold | 2 |
