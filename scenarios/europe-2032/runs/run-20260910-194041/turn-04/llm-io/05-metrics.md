...
- characters 13701-14659: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14702-16643: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16699-17794: `{{notepad}}` from the Game Master's notepad, carried across turns
