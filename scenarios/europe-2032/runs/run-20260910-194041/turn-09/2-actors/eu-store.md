...
| M10 | EU Power-Health Islanding Pact | 6 | small | 9 | 10 | own jurisdiction | resilience up moderately | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Power-Health Islanding Pact", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately"}, "grounds": "keep fallback hospitals and EU models powered through cutoff and attack"}
  - Grounds: keep fallback hospitals and EU models powered through cutoff and attack
