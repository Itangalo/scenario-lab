...
- characters 1672-3730: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5296-5773: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8233-10330: `{{previous_actions}}` from the actor's own response from the previous turn
