...
- characters 13314-13505: `{{metrics_json}}` from the run's live metric values
- characters 13598-14772: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14816-16874: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16930-17445: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Power-Health Islanding Pact | 2 |
