...
- characters 1594-3652: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3708-4558: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4621-31828: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32183-33217: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Essential Services Fallback Operation −2, priority no cost (capital below 20) = −2
PROPOSAL BONUS: EU Essential Services Fallback Operation (cat 6, small) +3 — cyber_major_incident and eu_frontier_access_denied fired this turn and this answers both directly with existing capacity
LEGITIMACY LENDS: capital 10, sentiment 18 -> +2 (capped, counted in capital)
SOVEREIGNTY: 19 last turn, no cat4 finish, no cat4 in flight +0, eu_frontier_access_denied t8 −2, capability rose 1.0 no charge = 17

## Emerging developments (tracked)

- `emergent_grid_sabotage_backlash` -- first noted turn 7, listed in 2 turn(s) so far: A coordinated physical sabotage campaign targets transmission substations feeding major EU data-centre clusters, forcing emergency load-shedding and a public fight over power-price relief for gigafactory sites.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, capability_jump, cyber_defence_breakthrough, knowledge_work_augmented, supply_chain_coercion
- Turn 2 (7 turn(s) ago): loss_of_control_incident, taiwan_tension_rise, eu_frontier_access_denied, emergent_datacentre_backlash
- Turn 3 (6 turn(s) ago): knowledge_work_augmented, emergent_kimi_crime_wave
- Turn 4 (5 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, member_state_defection, middle_power_coalition
- Turn 5 (4 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, loss_of_control_incident, emergent_municipal_ransomware_spillover, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, capability_jump, eval_anomaly_reports, openweight_frontier_release, member_state_defection
- Turn 7 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, adoption_success
- Turn 8 (1 turn(s) ago): cyber_major_incident, research_breakthrough, eu_frontier_access_denied
