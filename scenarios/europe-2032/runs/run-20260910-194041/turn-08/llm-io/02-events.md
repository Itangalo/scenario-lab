...
- characters 374-1492: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1535-4185: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4241-4999: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5062-32269: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32624-33561: `{{event_history}}` from the run's own event record
...
- `emergent_grid_sabotage_backlash` -- first noted turn 7, listed in 1 turn(s) so far: A coordinated physical sabotage campaign targets transmission substations feeding major EU data-centre clusters, forcing emergency load-shedding and a public fight over power-price relief for gigafactory sites.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, capability_jump, cyber_defence_breakthrough, knowledge_work_augmented, supply_chain_coercion
- Turn 2 (6 turn(s) ago): loss_of_control_incident, taiwan_tension_rise, eu_frontier_access_denied, emergent_datacentre_backlash
- Turn 3 (5 turn(s) ago): knowledge_work_augmented, emergent_kimi_crime_wave
- Turn 4 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, member_state_defection, middle_power_coalition
- Turn 5 (3 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, loss_of_control_incident, emergent_municipal_ransomware_spillover, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, capability_jump, eval_anomaly_reports, openweight_frontier_release, member_state_defection
- Turn 7 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, adoption_success
