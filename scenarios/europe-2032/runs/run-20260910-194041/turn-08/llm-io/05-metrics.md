...
- characters 13312-13502: `{{metrics_json}}` from the run's live metric values
- characters 13595-14713: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14756-17406: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17462-18220: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Essential Services Fallback Operation | 2 |
