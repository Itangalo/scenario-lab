...
| M9 | EU Essential Services Fallback Operation | 6 | small | 8 | 9 | own jurisdiction | resilience up moderately | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Essential Services Fallback Operation", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately"}, "grounds": "answer frontier cutoff and automated attack with existing capacity"}
  - Grounds: answer frontier cutoff and automated attack with existing capacity
