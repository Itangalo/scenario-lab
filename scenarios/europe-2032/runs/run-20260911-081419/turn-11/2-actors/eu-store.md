...
| M12 | EU Essential Services Defence Surge | 6 | small | 11 | 13 | own jurisdiction | resilience up substantially, ai_safety up slightly via reduced cyber harm | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Essential Services Defence Surge", "category": 6, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "resilience up substantially, ai_safety up slightly via reduced cyber harm"}, "grounds": "major automated attack while defensive breakthrough available"}
  - Grounds: major automated attack while defensive breakthrough available
