...
| M12 | EU Essential Services Defence Surge | 6 | small | 11 | 12 | own jurisdiction | resilience up substantially, ai_safety up slightly via reduced cyber harm | 2 | finished |
| M13 | EU Trusted Public Services Scale-Up | 9 | small | 12 | 13 | own jurisdiction | public_sentiment up substantially, eu_political_capital up, eu_ai_sovereignty up slightly via demand for EU-hosted capacity | 2 | finished |
| M14 | EU Rogue-Agent Containment and Essential Services Hold | 6 | small | 13 | 15 | own jurisdiction | resilience up, ai_safety up slightly via containment, eu_political_capital protected from service failure | 2 | running |
...
- **applied** `M14` — {"op": "add", "table": "measures", "fields": {"name": "EU Rogue-Agent Containment and Essential Services Hold", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly via containment, eu_political_capital protected from service failure"}, "grounds": "loss-of-control incident demanding immediate containment"}
  - Grounds: loss-of-control incident demanding immediate containment
