...
| M13 | EU Trusted Public Services Scale-Up | 9 | small | 12 | 14 | own jurisdiction | public_sentiment up substantially, eu_political_capital up, eu_ai_sovereignty up slightly via demand for EU-hosted capacity | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Trusted Public Services Scale-Up", "category": 9, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up substantially, eu_political_capital up, eu_ai_sovereignty up slightly via demand for EU-hosted capacity"}, "grounds": "adoption success to exploit amid collapsed trust"}
  - Grounds: adoption success to exploit amid collapsed trust
