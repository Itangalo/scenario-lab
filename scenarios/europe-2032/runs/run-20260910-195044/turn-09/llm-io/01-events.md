...
- characters 373-1684: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1728-3772: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3828-4251: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4314-29397: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29752-30577: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M6 EU Entry-Level Transition and Fraud Victim Fund −2, priority −0 (no effect, capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 7 -> +1 capped by internal sabotage loss, net absorbed at floor
SOVEREIGNTY: 10 last turn, no category 4 finish, no build in flight +0, emergent anti-data-centre sabotage t8 −2, capability rose 1.0 −0 = 8
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, loss_of_control_incident, eval_anomaly_reports, export_control_escalation
- Turn 2 (7 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, export_control_escalation, supply_chain_coercion
- Turn 3 (6 turn(s) ago): taiwan_blockade, ai_investment_collapse, openweight_frontier_release, member_state_defection
- Turn 4 (5 turn(s) ago): loss_of_control_incident, capability_jump, knowledge_work_augmented
- Turn 5 (4 turn(s) ago): loss_of_control_incident, export_control_escalation, election_consolidation
- Turn 6 (3 turn(s) ago): bio_incident, cyber_defence_breakthrough, labour_displacement
- Turn 7 (2 turn(s) ago): research_breakthrough, member_state_defection
- Turn 8 (1 turn(s) ago): emergent_anti_datacentre_sabotage
