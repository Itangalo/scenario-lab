...
- characters 106-13240: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13283-13471: `{{metrics_json}}` from the run's live metric values
- characters 13564-14875: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14919-16963: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17019-17742: `{{notepad}}` from the Game Master's notepad, carried across turns
