...
- characters 451-1762: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1806-3850: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4339-4793: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7008-8432: `{{previous_actions}}` from the actor's own response from the previous turn
