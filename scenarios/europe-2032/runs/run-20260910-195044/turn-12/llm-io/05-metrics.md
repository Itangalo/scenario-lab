...
- characters 13049-13237: `{{metrics_json}}` from the run's live metric values
- characters 13330-14498: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14541-16859: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16915-17649: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Middle-Power Resilience and Access Pact | 2 |
| M8 | EU Redress and Incident Ledger for Deployed Decision Systems | 2 |
...
## Metrics
```json
{"ai_capability": 68.3, "openweight_capability": 67.0, "ai_safety": 3.0, "resilience": 32.0, "eu_ai_sovereignty": 3.0, "eu_political_capital": 3.0, "public_sentiment": 0.0}
```
...
## Notepad
PORTFOLIO CHARGE t12: M7 EU Middle-Power Resilience and Access Pact −2, M8 EU Redress and Incident Ledger for Deployed Decision Systems −2, priority no effect/cost (capital below 20) = −4
PROPOSAL BONUS: EU Redress and Incident Ledger for Deployed Decision Systems (cat 2, small) +3 — automated_decision_scandal landed this turn as lawful-but-wrong coverage gap and this answers it directly with reporting/redress
LEGITIMACY LENDS: capital 3, sentiment 0 -> none (capital higher)
SOVEREIGNTY: 3.0 last turn, no capacity event, no category 4 finish or in flight, capability rose 0.8 no −1 = 3.0
