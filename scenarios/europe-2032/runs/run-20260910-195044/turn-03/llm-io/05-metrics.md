...
- characters 106-13114: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13157-13349: `{{metrics_json}}` from the run's live metric values
- characters 13442-14585: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14629-16846: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16902-17380: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Lithography Shield and Reciprocity Pact | 2 |
| M5 | EU Chip Continuity and Critical Compute Reserve | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Cyber Shield −3, EU Lithography Shield and Reciprocity Pact −2, priority −1 = −12
PROPOSAL BONUS: none — knowledge-work gains remove felt crisis, no bonus for measure addressing recent negative event applies
LEGITIMACY LENDS: capital 22, sentiment 33 -> +2
SOVEREIGNTY: 19 last turn, no capacity finish, in flight +0, supply_chain_coercion t2 −2, capability rose 2.0 −1 = 16
