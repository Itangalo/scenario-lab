...
- characters 1564-3781: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3837-4885: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4948-29175: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29530-29820: `{{event_history}}` from the run's own event record
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, loss_of_control_incident, eval_anomaly_reports, export_control_escalation
- Turn 2 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, export_control_escalation, supply_chain_coercion
