...
- characters 452-1736: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1779-4337: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5469-5923: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8107-9695: `{{previous_actions}}` from the actor's own response from the previous turn
