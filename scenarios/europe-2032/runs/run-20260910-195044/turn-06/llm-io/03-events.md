...
- characters 374-1658: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1701-4259: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4315-5049: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5112-30404: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30759-31364: `{{event_history}}` from the run's own event record
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, loss_of_control_incident, eval_anomaly_reports, export_control_escalation
- Turn 2 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, export_control_escalation, supply_chain_coercion
- Turn 3 (3 turn(s) ago): taiwan_blockade, ai_investment_collapse, openweight_frontier_release, member_state_defection
- Turn 4 (2 turn(s) ago): loss_of_control_incident, capability_jump, knowledge_work_augmented
- Turn 5 (1 turn(s) ago): loss_of_control_incident, export_control_escalation, election_consolidation
