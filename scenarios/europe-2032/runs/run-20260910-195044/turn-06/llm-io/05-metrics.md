...
- characters 13535-13725: `{{metrics_json}}` from the run's live metric values
- characters 13818-15102: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15145-17703: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17759-18131: `{{notepad}}` from the Game Master's notepad, carried across turns
