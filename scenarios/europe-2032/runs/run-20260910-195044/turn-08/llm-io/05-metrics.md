...
- characters 12976-13166: `{{metrics_json}}` from the run's live metric values
- characters 13259-14493: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14536-16163: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16219-16682: `{{notepad}}` from the Game Master's notepad, carried across turns
