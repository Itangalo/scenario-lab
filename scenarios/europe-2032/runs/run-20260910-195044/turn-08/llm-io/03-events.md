...
- characters 374-1608: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1651-3278: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3334-4104: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4167-29250: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29605-30370: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: M6 EU Entry-Level Transition and Fraud Victim Fund −2, priority −0 (no effect, capital below 20) = −2
PROPOSAL BONUS: none — M6 already in flight, no new measure started this turn
LEGITIMACY LENDS: capital 0, sentiment 7 -> +1 capped by events, net absorbed in internal defection loss
SOVEREIGNTY: 8 last turn, M1 InvestAI Gigafactories finishes t7 +4, no capacity build in flight +0, member_state_defection t7 −2, capability rose 1.0 −0 = 10

## Emerging developments (tracked)

- `emergent_anti_datacentre_sabotage` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated physical sabotage and blockades targeting data-centre construction and grid interconnects spread across several member states amid hostile sentiment and water disputes.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, loss_of_control_incident, eval_anomaly_reports, export_control_escalation
- Turn 2 (6 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, export_control_escalation, supply_chain_coercion
- Turn 3 (5 turn(s) ago): taiwan_blockade, ai_investment_collapse, openweight_frontier_release, member_state_defection
- Turn 4 (4 turn(s) ago): loss_of_control_incident, capability_jump, knowledge_work_augmented
- Turn 5 (3 turn(s) ago): loss_of_control_incident, export_control_escalation, election_consolidation
- Turn 6 (2 turn(s) ago): bio_incident, cyber_defence_breakthrough, labour_displacement
- Turn 7 (1 turn(s) ago): research_breakthrough, member_state_defection
