...
- characters 107-13462: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13505-13693: `{{metrics_json}}` from the run's live metric values
- characters 13786-15003: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15047-17181: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17237-17830: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | EU Visible Benefit Adoption Pact | 2 |
