...
- characters 374-1591: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1635-3769: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3825-4418: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4481-29720: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30075-31261: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, loss_of_control_incident, eval_anomaly_reports, export_control_escalation
- Turn 2 (11 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, export_control_escalation, supply_chain_coercion
- Turn 3 (10 turn(s) ago): taiwan_blockade, ai_investment_collapse, openweight_frontier_release, member_state_defection
- Turn 4 (9 turn(s) ago): loss_of_control_incident, capability_jump, knowledge_work_augmented
- Turn 5 (8 turn(s) ago): loss_of_control_incident, export_control_escalation, election_consolidation
- Turn 6 (7 turn(s) ago): bio_incident, cyber_defence_breakthrough, labour_displacement
- Turn 7 (6 turn(s) ago): research_breakthrough, member_state_defection
- Turn 8 (5 turn(s) ago): emergent_anti_datacentre_sabotage
- Turn 9 (4 turn(s) ago): eu_frontier_access_denied
- Turn 10 (3 turn(s) ago): opaque_reasoning, adoption_success
- Turn 11 (2 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, eu_frontier_access_denied, middle_power_coalition, emergent_siting_injunction_freeze
- Turn 12 (1 turn(s) ago): openweight_frontier_release, automated_decision_scandal
