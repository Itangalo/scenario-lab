...
- characters 377-1511: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1555-3921: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3977-4740: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4803-28395: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28750-29253: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Lithography Shield and Reciprocity Pact −2, EU Chip Continuity and Critical Compute Reserve −2, priority M5 −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 10, sentiment 27 -> +2
SOVEREIGNTY: 13 last turn, no capacity event, no finish, in flight +0, capability rose 2.0 −1 = 12

## Emerging developments (tracked)

- `emergent_foundry_outage_deepens_shortage` -- first noted turn 4, listed in 1 turn(s) so far: With advanced-chip flows halted and EU fabs on maintenance footing, a major second-source foundry outside Taiwan suffers a prolonged yield failure and fire, deepening the global shortage and forcing further EU allocation triage.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, loss_of_control_incident, eval_anomaly_reports, export_control_escalation
- Turn 2 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, export_control_escalation, supply_chain_coercion
- Turn 3 (2 turn(s) ago): taiwan_blockade, ai_investment_collapse, openweight_frontier_release, member_state_defection
- Turn 4 (1 turn(s) ago): loss_of_control_incident, capability_jump, knowledge_work_augmented
