...
- characters 106-13447: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13490-13682: `{{metrics_json}}` from the run's live metric values
- characters 13775-14909: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14953-17319: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17375-18138: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_foundry_outage_deepens_shortage` -- first noted turn 4, listed in 2 turn(s) so far: With advanced-chip flows halted and EU fabs on maintenance footing, a major second-source foundry outside Taiwan suffers a prolonged yield failure and fire, deepening the global shortage and forcing further EU allocation triage.
