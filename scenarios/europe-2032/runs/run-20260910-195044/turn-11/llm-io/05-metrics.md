...
- characters 107-12933: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12976-13164: `{{metrics_json}}` from the run's live metric values
- characters 13257-14306: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14350-16499: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16555-16842: `{{notepad}}` from the Game Master's notepad, carried across turns
