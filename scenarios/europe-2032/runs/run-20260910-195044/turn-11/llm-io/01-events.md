...
- characters 374-1423: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1467-3616: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3672-4259: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4322-29561: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29916-30856: `{{event_history}}` from the run's own event record
...
LEGITIMACY LENDS: capital 0 after opaque loss, sentiment 5.0 -> +1 capped, net at 1.0
SOVEREIGNTY: 5.0 last turn, no capacity event, no category 4 in flight, capability rose 1.0 −0 = 5.0

## Emerging developments (tracked)

- `emergent_siting_injunction_freeze` -- first noted turn 9, listed in 2 turn(s) so far: A regional court grants an interim water-use injunction halting dewatering and grid works at one gigafactory shell after anti-compute protests merge with drought litigation.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, loss_of_control_incident, eval_anomaly_reports, export_control_escalation
- Turn 2 (9 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, export_control_escalation, supply_chain_coercion
- Turn 3 (8 turn(s) ago): taiwan_blockade, ai_investment_collapse, openweight_frontier_release, member_state_defection
- Turn 4 (7 turn(s) ago): loss_of_control_incident, capability_jump, knowledge_work_augmented
- Turn 5 (6 turn(s) ago): loss_of_control_incident, export_control_escalation, election_consolidation
- Turn 6 (5 turn(s) ago): bio_incident, cyber_defence_breakthrough, labour_displacement
- Turn 7 (4 turn(s) ago): research_breakthrough, member_state_defection
- Turn 8 (3 turn(s) ago): emergent_anti_datacentre_sabotage
- Turn 9 (2 turn(s) ago): eu_frontier_access_denied
- Turn 10 (1 turn(s) ago): opaque_reasoning, adoption_success
