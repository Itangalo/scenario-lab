...
- characters 451-1964: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2007-4024: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4979-5437: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7652-9265: `{{previous_actions}}` from the actor's own response from the previous turn
