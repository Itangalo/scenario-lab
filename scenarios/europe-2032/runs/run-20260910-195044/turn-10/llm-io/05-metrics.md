...
- characters 12882-13070: `{{metrics_json}}` from the run's live metric values
- characters 13163-14676: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14719-16736: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16792-17413: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 66.5, "openweight_capability": 64.4, "ai_safety": 0.0, "resilience": 35.5, "eu_ai_sovereignty": 5.0, "eu_political_capital": 1.0, "public_sentiment": 5.0}
```
