...
- characters 373-1886: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1929-3946: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4002-4623: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4686-30622: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30977-31854: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: (none in flight) = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 2.0 -> +1 capped by access-cut loss, net at 1.0
SOVEREIGNTY: 8.0 last turn, no category 4 finish, no build in flight +0, eu_frontier_access_denied t9 −3, capability rose 1.0 −0 = 5.0

## Emerging developments (tracked)

- `emergent_siting_injunction_freeze` -- first noted turn 9, listed in 1 turn(s) so far: A regional court grants an interim water-use injunction halting dewatering and grid works at one gigafactory shell after anti-compute protests merge with drought litigation.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, loss_of_control_incident, eval_anomaly_reports, export_control_escalation
- Turn 2 (8 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, export_control_escalation, supply_chain_coercion
- Turn 3 (7 turn(s) ago): taiwan_blockade, ai_investment_collapse, openweight_frontier_release, member_state_defection
- Turn 4 (6 turn(s) ago): loss_of_control_incident, capability_jump, knowledge_work_augmented
- Turn 5 (5 turn(s) ago): loss_of_control_incident, export_control_escalation, election_consolidation
- Turn 6 (4 turn(s) ago): bio_incident, cyber_defence_breakthrough, labour_displacement
- Turn 7 (3 turn(s) ago): research_breakthrough, member_state_defection
- Turn 8 (2 turn(s) ago): emergent_anti_datacentre_sabotage
- Turn 9 (1 turn(s) ago): eu_frontier_access_denied
