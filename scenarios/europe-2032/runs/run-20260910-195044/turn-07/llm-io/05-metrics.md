...
- characters 106-13299: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13342-13531: `{{metrics_json}}` from the run's live metric values
- characters 13624-14707: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14751-17058: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17114-17759: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M6 | EU Entry-Level Transition and Fraud Victim Fund | 2 |
