...
- characters 13779-15265: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15308-17553: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17609-18572: `{{notepad}}` from the Game Master's notepad, carried across turns
