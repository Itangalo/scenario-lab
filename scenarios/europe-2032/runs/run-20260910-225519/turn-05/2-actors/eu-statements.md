...
- `two_year_commitment` (commitment): Rebuild trusted, resilient sovereignty that survives public consent

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild trusted, resilient sovereignty that survives public consent
