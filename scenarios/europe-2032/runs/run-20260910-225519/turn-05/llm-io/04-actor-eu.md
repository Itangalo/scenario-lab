...
- characters 454-2413: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2457-4626: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5554-5994: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8271-10373: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Trustworthy Deployment Audit and Redress | 2 | small | 4 | 6 | own jurisdiction | public_sentiment up, eu_political_capital up modestly via restored trust | 2 | running |
...
| M5 | EU Grid and Public-Service Cyber Shield | 6 | small | 3 | 5 | own jurisdiction | resilience up, ai_safety up modestly via incident learning | 2 | finished |
