...
- characters 376-2335: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2379-4548: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4604-5520: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5583-29893: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30248-30614: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): ai_investment_collapse, supply_chain_coercion
- Turn 3 (2 turn(s) ago): cyber_major_incident, openweight_frontier_release, safety_breakthrough, emergent_ics_toolkit_proliferation, emergent_gigafactory_siting_backlash
- Turn 4 (1 turn(s) ago): openweight_frontier_release, automated_decision_scandal
