...
- characters 13815-15774: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15818-17987: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18043-18959: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_grid_connection_moratorium` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated municipal moratoriums on new data-centre grid connections spread across three member states, citing power prices and autumn outage coverage, freezing site selection independent of sabotage.
...
## Metrics
```json
{"ai_capability": 61.3, "openweight_capability": 56.5, "ai_safety": 32.0, "resilience": 38.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 2.0, "public_sentiment": 22.0}
```
## Narrative
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Trustworthy Deployment Audit and Redress −2, priority −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 22 -> +2 (capped below sentiment)
SOVEREIGNTY: 17 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.8 −0 = 17
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "pending"}}]}
```
