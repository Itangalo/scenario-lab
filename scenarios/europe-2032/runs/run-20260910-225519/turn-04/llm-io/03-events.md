...
- characters 2281-4661: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4717-5255: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5318-28951: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29306-29590: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): ai_investment_collapse, supply_chain_coercion
- Turn 3 (1 turn(s) ago): cyber_major_incident, openweight_frontier_release, safety_breakthrough, emergent_ics_toolkit_proliferation, emergent_gigafactory_siting_backlash
