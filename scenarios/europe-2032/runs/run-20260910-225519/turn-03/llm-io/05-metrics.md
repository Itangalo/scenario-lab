...
- characters 13528-14714: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14758-17028: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17084-17614: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | European Chokepoint Leverage Shield | 2 |
| M5 | EU Grid and Public-Service Cyber Shield | 2 |
...
## Metrics
```json
{"ai_capability": 57.5, "openweight_capability": 52.0, "ai_safety": 35.0, "resilience": 35.5, "eu_ai_sovereignty": 18.0, "eu_political_capital": 13.0, "public_sentiment": 27.0}
```
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, European Chokepoint Leverage Shield −2, EU Grid and Public-Service Cyber Shield −2, priority −1 = −14
PROPOSAL BONUS: EU Grid and Public-Service Cyber Shield (cat 6, small) +3 — cyber_major_incident fired this turn and this answers it directly, small size limits value
