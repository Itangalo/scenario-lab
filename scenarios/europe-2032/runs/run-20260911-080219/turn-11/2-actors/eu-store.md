...
| M11 | EU Livelihood Bridge for Displacement Shock | 7 | small | 11 | 13 | own jurisdiction | resilience up moderately, public_sentiment up, eu_political_capital protected | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Livelihood Bridge for Displacement Shock", "category": 7, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, public_sentiment up, eu_political_capital protected"}, "grounds": "to hold livelihoods through augmentation-to-automation transition"}
  - Grounds: to hold livelihoods through augmentation-to-automation transition
