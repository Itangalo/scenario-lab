...
| M11 | EU Livelihood Bridge for Displacement Shock | 7 | small | 11 | 13 | own jurisdiction | resilience up moderately, public_sentiment up, eu_political_capital protected | 2 | finished |
| M12 | EU Islanded Continuity and Repair Compact | 6 | small | 13 | 15 | own jurisdiction | resilience up moderately, eu_political_capital protected | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Islanded Continuity and Repair Compact", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital protected"}, "grounds": "war strikes on EU infrastructure require islanded continuity"}
  - Grounds: war strikes on EU infrastructure require islanded continuity
