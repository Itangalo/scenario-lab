...
- `two_year_commitment` (commitment): Build sovereign AI capacity at speed and scale

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Build sovereign AI capacity at speed and scale
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The commitment's duration ending directly changes the actor's obligation to uphold the original statement, triggering a natural reassessment of purpose and strategy.
