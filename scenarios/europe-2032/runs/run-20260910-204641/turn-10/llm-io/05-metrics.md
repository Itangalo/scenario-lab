...
- characters 106-12835: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12878-13070: `{{metrics_json}}` from the run's live metric values
- characters 13163-14471: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14514-16547: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16603-17268: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | Essential Services Continuity and AI Control Pact | 2 |
