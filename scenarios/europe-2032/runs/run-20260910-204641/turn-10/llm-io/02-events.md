...
- characters 377-1685: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1728-3761: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3817-4167: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4230-29182: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29537-30169: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: Essential Services Continuity and AI Control Pact −2, priority −1 = −3
PROPOSAL BONUS: none — no external event in last three turns that this answers directly
LEGITIMACY LENDS: capital 21, sentiment 30 -> +2
SOVEREIGNTY: 32 last turn, Salvage Compute for Sovereignty finishes t9 +4, no capacity event, capability rose 0.7 −0 = 36
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_access_secured
- Turn 2 (8 turn(s) ago): cyber_major_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 3 (7 turn(s) ago): knowledge_work_augmented, emergent_genome_publication_freeze
- Turn 5 (5 turn(s) ago): eval_anomaly_reports, labour_displacement, taiwan_tension_rise, adoption_success, emergent_utility_staff_slowdown, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, taiwan_tension_rise
- Turn 7 (3 turn(s) ago): openweight_frontier_release
- Turn 8 (2 turn(s) ago): ai_investment_collapse
