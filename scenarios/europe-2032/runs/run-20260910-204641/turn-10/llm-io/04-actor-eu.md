...
- characters 455-1763: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1806-3839: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4431-4906: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7590-9986: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | Essential Services Continuity and AI Control Pact | 6 | small | 9 | 11 | own jurisdiction | resilience up significantly, ai_safety up moderately, public_sentiment up slightly | 2 | running |
