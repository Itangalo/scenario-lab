...
- characters 376-1748: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1791-3457: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3513-4603: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4666-29676: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30031-30614: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: Municipal Patch and Recovery Corps −2, priority −1 = −3
PROPOSAL BONUS: Municipal Patch and Recovery Corps (cat 6, small) +2 — February ransomware sweep left edges on paper last turn and this answers it directly
LEGITIMACY LENDS: capital 11, sentiment 29.0 -> +2
SOVEREIGNTY: 27 last turn, InvestAI Gigafactories finishes t7 +5, no cat4 in flight +0, no capacity event, capability rose 0.8 −0 = 32

## Emerging developments (tracked)

- `emergent_contractor_insolvency_cascade` -- first noted turn 7, listed in 1 turn(s) so far: One of the three hit energy-water contractors files for insolvency after remediation and liability costs, forcing emergency state takeover of its service area and exposing unpatched dependencies in neighbouring municipals.
- `emergent_public_sector_work_to_rule` -- first noted turn 7, listed in 1 turn(s) so far: Municipal hospital staff and city administrations refuse to return to cloud-connected triage systems after the February ransomware sweep, staging coordinated sick-outs and paper-only protests that stall emergency digitization.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_access_secured
- Turn 2 (6 turn(s) ago): cyber_major_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 3 (5 turn(s) ago): knowledge_work_augmented, emergent_genome_publication_freeze
- Turn 5 (3 turn(s) ago): eval_anomaly_reports, labour_displacement, taiwan_tension_rise, adoption_success, emergent_utility_staff_slowdown, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, taiwan_tension_rise
- Turn 7 (1 turn(s) ago): openweight_frontier_release
