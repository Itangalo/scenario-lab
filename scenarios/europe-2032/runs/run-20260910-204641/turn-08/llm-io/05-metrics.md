...
- characters 105-13204: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13247-13439: `{{metrics_json}}` from the run's live metric values
- characters 13532-14904: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14947-16613: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16669-17759: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | Salvage Compute for Sovereignty | 2 |
