...
- characters 106-13368: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13411-13603: `{{metrics_json}}` from the run's live metric values
- characters 13696-15230: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15274-17684: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17740-18764: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M6 | Municipal Patch and Recovery Corps | 2 |
...
## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M6", "fields": {"finish_turn": 8}, "grounds": "named priority"}]}
```
```
