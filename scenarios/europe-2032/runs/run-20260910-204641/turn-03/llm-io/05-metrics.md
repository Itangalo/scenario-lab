...
- characters 106-12936: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12979-13171: `{{metrics_json}}` from the run's live metric values
- characters 13264-14523: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14567-16902: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16958-17475: `{{notepad}}` from the Game Master's notepad, carried across turns
