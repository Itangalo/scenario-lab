...
- characters 105-13263: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13306-13498: `{{metrics_json}}` from the run's live metric values
- characters 13591-15006: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15049-17436: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17492-17909: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 57.9, "ai_safety": 25.5, "resilience": 36.5, "eu_ai_sovereignty": 31.0, "eu_political_capital": 7.0, "public_sentiment": 25.0}
```
