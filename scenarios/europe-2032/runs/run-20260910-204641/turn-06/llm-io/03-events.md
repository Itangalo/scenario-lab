...
- characters 376-1791: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1834-4221: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4277-5014: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5077-26977: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27332-27793: `{{event_history}}` from the run's own event record
...
- `emergent_datacentre_siting_blockade` -- first noted turn 4, listed in 2 turn(s) so far: A coordinated siting blockade by municipal councils and regional courts halts two AI gigafactory / AI-factory expansion sites over power and water use, freezing construction through mid-2028.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_access_secured
- Turn 2 (4 turn(s) ago): cyber_major_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 3 (3 turn(s) ago): knowledge_work_augmented, emergent_genome_publication_freeze
- Turn 5 (1 turn(s) ago): eval_anomaly_reports, labour_displacement, taiwan_tension_rise, adoption_success, emergent_utility_staff_slowdown, election_consolidation
