...
- characters 454-1869: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1912-4299: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5116-5573: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7734-10010: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU AI Transition Safety Net | 7 | small | 5 | 7 | own jurisdiction | resilience up moderately, public_sentiment up, eu_political_capital up slightly via cohesion | 2 | running |
