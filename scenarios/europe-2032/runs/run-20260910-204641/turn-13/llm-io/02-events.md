...
- characters 378-2012: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2056-4516: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4572-4980: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5043-30848: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31203-31989: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_access_secured
- Turn 2 (11 turn(s) ago): cyber_major_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 3 (10 turn(s) ago): knowledge_work_augmented, emergent_genome_publication_freeze
- Turn 5 (8 turn(s) ago): eval_anomaly_reports, labour_displacement, taiwan_tension_rise, adoption_success, emergent_utility_staff_slowdown, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, taiwan_tension_rise
- Turn 7 (6 turn(s) ago): openweight_frontier_release
- Turn 8 (5 turn(s) ago): ai_investment_collapse
- Turn 10 (3 turn(s) ago): knowledge_work_augmented
- Turn 11 (2 turn(s) ago): bio_uplift_findings
- Turn 12 (1 turn(s) ago): loss_of_control_incident
