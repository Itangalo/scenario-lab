...
- characters 377-1643: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1687-4008: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4064-5115: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5178-30130: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30485-31117: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: Salvage Compute for Sovereignty −2, priority −1 = −3
PROPOSAL BONUS: Salvage Compute for Sovereignty (cat 4, small) +2 — ai_investment_collapse this turn frees cancelled build-out this answers directly
LEGITIMACY LENDS: capital 19, sentiment 30.5 -> +2
SOVEREIGNTY: 32 last turn, no capacity event, Salvage Compute proposed t8 +0, capability rose 0.5 −0 = 32

## Emerging developments (tracked)

- `emergent_contractor_insolvency_cascade` -- first noted turn 7, listed in 2 turn(s) so far: One of the three hit energy-water contractors files for insolvency after remediation and liability costs, forcing emergency state takeover of its service area and exposing unpatched dependencies in neighbouring municipals.
- `emergent_public_sector_work_to_rule` -- first noted turn 7, listed in 2 turn(s) so far: Municipal hospital staff and city administrations refuse to return to cloud-connected triage systems after the February ransomware sweep, staging coordinated sick-outs and paper-only protests that stall emergency digitization.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_access_secured
- Turn 2 (7 turn(s) ago): cyber_major_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 3 (6 turn(s) ago): knowledge_work_augmented, emergent_genome_publication_freeze
- Turn 5 (4 turn(s) ago): eval_anomaly_reports, labour_displacement, taiwan_tension_rise, adoption_success, emergent_utility_staff_slowdown, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, taiwan_tension_rise
- Turn 7 (2 turn(s) ago): openweight_frontier_release
- Turn 8 (1 turn(s) ago): ai_investment_collapse
