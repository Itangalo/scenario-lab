...
- characters 13535-14801: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14845-17166: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17222-17601: `{{notepad}}` from the Game Master's notepad, carried across turns
