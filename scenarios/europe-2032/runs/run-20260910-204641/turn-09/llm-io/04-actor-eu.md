...
- characters 1765-4086: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4154-4611: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6945-8873: `{{previous_actions}}` from the actor's own response from the previous turn
