...
- characters 377-2101: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2144-3927: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3983-4676: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4739-29691: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30046-30779: `{{event_history}}` from the run's own event record
...
- `emergent_salvage_crew_backlash` -- first noted turn 10, listed in 2 turn(s) so far: Distress-hired AI engineers from the US salvage wave stage coordinated walkouts after overtime and guarantee disputes spread from hospitals to gigafactory contractors, stalling fit-out work.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_access_secured
- Turn 2 (10 turn(s) ago): cyber_major_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 3 (9 turn(s) ago): knowledge_work_augmented, emergent_genome_publication_freeze
- Turn 5 (7 turn(s) ago): eval_anomaly_reports, labour_displacement, taiwan_tension_rise, adoption_success, emergent_utility_staff_slowdown, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, taiwan_tension_rise
- Turn 7 (5 turn(s) ago): openweight_frontier_release
- Turn 8 (4 turn(s) ago): ai_investment_collapse
- Turn 10 (2 turn(s) ago): knowledge_work_augmented
- Turn 11 (1 turn(s) ago): bio_uplift_findings
