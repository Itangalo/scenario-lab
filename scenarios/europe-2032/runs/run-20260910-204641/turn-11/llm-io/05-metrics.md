...
- characters 107-13247: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13290-13482: `{{metrics_json}}` from the run's live metric values
- characters 13575-14987: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15031-17004: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17060-17669: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Clinic Shield – Bio Detection Upgrade | 2 |
