...
- characters 378-1790: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1834-3807: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3863-4472: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4535-29487: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29842-30527: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M8 Essential Services Continuity and AI Control Pact −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 20, sentiment 30 -> +2
SOVEREIGNTY: 36 last turn, no capacity event, no cat4 in flight, capability rose 0.8 −0 = 36

## Emerging developments (tracked)

- `emergent_salvage_crew_backlash` -- first noted turn 10, listed in 1 turn(s) so far: Distress-hired AI engineers from the US salvage wave stage coordinated walkouts after overtime and guarantee disputes spread from hospitals to gigafactory contractors, stalling fit-out work.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_access_secured
- Turn 2 (9 turn(s) ago): cyber_major_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 3 (8 turn(s) ago): knowledge_work_augmented, emergent_genome_publication_freeze
- Turn 5 (6 turn(s) ago): eval_anomaly_reports, labour_displacement, taiwan_tension_rise, adoption_success, emergent_utility_staff_slowdown, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, taiwan_tension_rise
- Turn 7 (4 turn(s) ago): openweight_frontier_release
- Turn 8 (3 turn(s) ago): ai_investment_collapse
- Turn 10 (1 turn(s) ago): knowledge_work_augmented
