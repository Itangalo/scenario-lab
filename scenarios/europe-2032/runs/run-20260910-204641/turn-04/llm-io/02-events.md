...
- characters 376-2012: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2055-4240: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4296-4688: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- characters 28388-28685: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_access_secured
- Turn 2 (2 turn(s) ago): cyber_major_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 3 (1 turn(s) ago): knowledge_work_augmented, emergent_genome_publication_freeze
