...
- characters 13263-14899: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14942-17127: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17183-18180: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Systems Shield −3, M4 EU Continuity Cloud for Essential Services −3, priority −1 = −13
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 25, sentiment 34 -> +2
SOVEREIGNTY: 23 last turn, no capacity event, Gigafactories in flight +1, capability rose 1.5 −0 = 24
