...
- characters 455-2189: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2233-4262: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6800-7264: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9239-10380: `{{previous_actions}}` from the actor's own response from the previous turn
