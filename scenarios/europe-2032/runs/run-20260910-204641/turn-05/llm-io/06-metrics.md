...
- characters 13779-15513: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15557-17586: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17642-18356: `{{notepad}}` from the Game Master's notepad, carried across turns
