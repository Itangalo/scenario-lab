...
- characters 377-2111: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2155-4184: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4240-5239: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5302-29083: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29438-29735: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Systems Shield −3, M4 EU Continuity Cloud for Essential Services −3, priority −1 = −13
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 14, sentiment 33.5 -> +2
SOVEREIGNTY: 24 last turn, no capacity event, Gigafactories in flight +1, capability rose 1.5 −0 = 25

## Emerging developments (tracked)

- `emergent_datacentre_siting_blockade` -- first noted turn 4, listed in 1 turn(s) so far: A coordinated siting blockade by municipal councils and regional courts halts two AI gigafactory / AI-factory expansion sites over power and water use, freezing construction through mid-2028.
- `emergent_utility_staff_slowdown` -- first noted turn 4, listed in 1 turn(s) so far: A coordinated wildcat action by grid maintenance unions and municipal utility staff slows segmentation retrofits and detection-kit installation after months of emergency overtime and frozen hiring.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_access_secured
- Turn 2 (3 turn(s) ago): cyber_major_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 3 (2 turn(s) ago): knowledge_work_augmented, emergent_genome_publication_freeze
