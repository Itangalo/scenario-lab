...
- characters 374-2802: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2845-4835: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4891-6067: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6130-35185: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35540-36438: `{{event_history}}` from the run's own event record
...
- `emergent_grid_sabotage_escalation` -- first noted turn 10, listed in 2 turn(s) so far: Coordinated sabotage of grid substations feeding data-centre clusters in two member states by graduate-protest splinter groups, forcing temporary load-shedding and a criminal-political crackdown.
- `emergent_distressed_site_selloff` -- first noted turn 10, listed in 2 turn(s) so far: With EU political capital near zero and four fenced factory lots stalled, a distressed regional government auctions a site and grid allocation to a non-EU hyperscaler for a cut-price sovereign-hosted enclave, fracturing the common procurement line.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, supply_chain_coercion
- Turn 3 (9 turn(s) ago): labour_displacement
- Turn 4 (8 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, emergent_copycat_ot_probing
- Turn 5 (7 turn(s) ago): cyber_major_incident, election_retrenchment
- Turn 6 (6 turn(s) ago): cyber_major_incident, capability_jump, embodied_ai_deployment, taiwan_tension_rise
- Turn 7 (5 turn(s) ago): ai_investment_collapse, rsi_onset, labour_displacement, taiwan_tension_rise, export_control_escalation, emergent_copycat_water_port_outage
- Turn 8 (4 turn(s) ago): emergent_graduate_protest_wave
- Turn 9 (3 turn(s) ago): opaque_reasoning, openweight_frontier_release, taiwan_tension_rise, export_control_escalation, emergent_anti_datacentre_blockade
- Turn 10 (2 turn(s) ago): medical_breakthrough
- Turn 11 (1 turn(s) ago): knowledge_work_augmented, export_control_escalation
