...
- characters 13469-13658: `{{metrics_json}}` from the run's live metric values
- characters 13751-16179: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16222-18212: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18268-18783: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 88.9, "openweight_capability": 85.0, "ai_safety": 0.0, "resilience": 38.0, "eu_ai_sovereignty": 9.0, "eu_political_capital": 6.0, "public_sentiment": 11.0}
```
