...
- characters 376-1891: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1934-3912: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3968-5088: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5151-32095: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32450-32560: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, supply_chain_coercion
- Turn 3 (1 turn(s) ago): labour_displacement
