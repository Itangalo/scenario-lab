...
- characters 105-13115: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13158-13350: `{{metrics_json}}` from the run's live metric values
- characters 13443-14958: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15001-16979: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17035-17533: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Lithography Leverage Compact | 2 |
| M5 | EU Automation Transition Fund | 2 |
| M6 | OT Rapid Patch and Swarm-Detection Rollout | 2 |
...
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Lithography Leverage Compact −2, M5 EU Automation Transition Fund −2, priority −1 = −11
PROPOSAL BONUS: EU Automation Transition Fund (cat 7, small) +2 — answers labour_displacement firing this turn directly, small size and own-jurisdiction only limits value
...
## Metrics
```json
{"ai_capability": 64.0, "openweight_capability": 57.6, "ai_safety": 26.0, "resilience": 40.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 16.0, "public_sentiment": 29.0}
```
...
## Notepad
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Lithography Leverage Compact −2, M5 EU Automation Transition Fund −2, M6 OT Rapid Patch and Swarm-Detection Rollout −2, priority −1 = −13
PROPOSAL BONUS: OT Rapid Patch (cat 6, small) +3 — answers copycat re-targeting of disclosed water/port OT this turn directly plus defensive breakthrough window, small size limits value
