...
- characters 13726-15529: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15572-17568: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17624-18643: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Clinical Benefit Access Programme | 2 |
...
PORTFOLIO CHARGE t9: M9 EU Entry-Level Transition Guarantee −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 3, sentiment 8 -> +2
SOVEREIGNTY: 13 last turn, European Embodied-AI Industrial Shield finishes t9 +4, no capacity event counted beyond export pressure treated as −1, capability rose 2.5 −1 = 15
