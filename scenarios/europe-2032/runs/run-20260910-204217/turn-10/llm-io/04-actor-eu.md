...
- characters 452-2255: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2298-4294: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4763-5231: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8050-9458: `{{previous_actions}}` from the actor's own response from the previous turn
