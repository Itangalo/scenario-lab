...
- characters 374-2177: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2220-4216: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4272-4630: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4693-33748: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34103-34873: `{{event_history}}` from the run's own event record
...
- Turn 3 (7 turn(s) ago): labour_displacement
- Turn 4 (6 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, emergent_copycat_ot_probing
- Turn 5 (5 turn(s) ago): cyber_major_incident, election_retrenchment
- Turn 6 (4 turn(s) ago): cyber_major_incident, capability_jump, embodied_ai_deployment, taiwan_tension_rise
- Turn 7 (3 turn(s) ago): ai_investment_collapse, rsi_onset, labour_displacement, taiwan_tension_rise, export_control_escalation, emergent_copycat_water_port_outage
- Turn 8 (2 turn(s) ago): emergent_graduate_protest_wave
- Turn 9 (1 turn(s) ago): opaque_reasoning, openweight_frontier_release, taiwan_tension_rise, export_control_escalation, emergent_anti_datacentre_blockade
