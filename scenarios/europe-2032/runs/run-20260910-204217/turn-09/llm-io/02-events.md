...
- characters 374-1711: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1755-3860: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3916-4580: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4643-34396: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34751-35366: `{{event_history}}` from the run's own event record
...
- `emergent_anti_datacentre_blockade` -- first noted turn 8, listed in 1 turn(s) so far: Graduate-led protests blockade a planned grid connection for a foreign hyperscale data centre, forcing a member state to suspend the project for the turn.
...
- Turn 3 (6 turn(s) ago): labour_displacement
- Turn 4 (5 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, emergent_copycat_ot_probing
- Turn 5 (4 turn(s) ago): cyber_major_incident, election_retrenchment
- Turn 6 (3 turn(s) ago): cyber_major_incident, capability_jump, embodied_ai_deployment, taiwan_tension_rise
- Turn 7 (2 turn(s) ago): ai_investment_collapse, rsi_onset, labour_displacement, taiwan_tension_rise, export_control_escalation, emergent_copycat_water_port_outage
- Turn 8 (1 turn(s) ago): emergent_graduate_protest_wave
