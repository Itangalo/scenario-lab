...
- characters 452-1789: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1833-3938: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5786-6254: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9224-10511: `{{previous_actions}}` from the actor's own response from the previous turn
