...
- characters 13704-15041: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15085-17190: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17246-17629: `{{notepad}}` from the Game Master's notepad, carried across turns
