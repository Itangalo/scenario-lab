...
- characters 376-1695: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1738-3815: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3871-4321: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4384-27461: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27816-27880: `{{event_history}}` from the run's own event record
