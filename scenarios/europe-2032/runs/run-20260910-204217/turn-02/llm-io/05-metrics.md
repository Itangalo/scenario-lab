...
- characters 13384-14703: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14746-16823: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16879-17951: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PROPOSAL BONUS: EU Critical Systems Shield (cat 6, large) +4 — cyber_test_shot severe precursor this turn and this answers it directly
LEGITIMACY LENDS: capital 48, sentiment 42 -> none, capital higher
SOVEREIGNTY: 22 last turn, no finish, Gigafactories in flight +0, supply_chain_coercion t1 −2, capability rose 3.0 −1 = 19
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 50.5, "ai_safety": 30.0, "resilience": 38.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 29.0, "public_sentiment": 38.0}
```
