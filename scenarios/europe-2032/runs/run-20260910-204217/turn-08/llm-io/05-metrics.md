...
- characters 13327-14518: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14561-16678: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16734-17556: `{{notepad}}` from the Game Master's notepad, carried across turns
