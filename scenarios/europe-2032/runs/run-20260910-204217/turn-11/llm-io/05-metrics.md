...
- characters 107-13004: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13047-13237: `{{metrics_json}}` from the run's live metric values
- characters 13330-15106: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15150-17197: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17253-18345: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M11 | EU Care-Inference Continuity Guard | 2 |
