...
- characters 376-2152: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2196-4243: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4299-5391: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5454-34509: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34864-35683: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Clinical Benefit Access Programme −2, priority −1 = −3
PROPOSAL BONUS: EU Clinical Benefit Access Programme (cat 9, small) +3 — tailored-therapy arrival this turn and this answers it directly, limited by small size and dependence
LEGITIMACY LENDS: capital 7, sentiment 6 -> none — capital is higher, no lend
SOVEREIGNTY: 15 last turn, no capacity event, no category 4 in flight, capability rose 2.5 −1 = 14

## Emerging developments (tracked)

- `emergent_grid_sabotage_escalation` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated sabotage of grid substations feeding data-centre clusters in two member states by graduate-protest splinter groups, forcing temporary load-shedding and a criminal-political crackdown.
- `emergent_distressed_site_selloff` -- first noted turn 10, listed in 1 turn(s) so far: With EU political capital near zero and four fenced factory lots stalled, a distressed regional government auctions a site and grid allocation to a non-EU hyperscaler for a cut-price sovereign-hosted enclave, fracturing the common procurement line.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, supply_chain_coercion
- Turn 3 (8 turn(s) ago): labour_displacement
- Turn 4 (7 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, emergent_copycat_ot_probing
- Turn 5 (6 turn(s) ago): cyber_major_incident, election_retrenchment
- Turn 6 (5 turn(s) ago): cyber_major_incident, capability_jump, embodied_ai_deployment, taiwan_tension_rise
- Turn 7 (4 turn(s) ago): ai_investment_collapse, rsi_onset, labour_displacement, taiwan_tension_rise, export_control_escalation, emergent_copycat_water_port_outage
- Turn 8 (3 turn(s) ago): emergent_graduate_protest_wave
- Turn 9 (2 turn(s) ago): opaque_reasoning, openweight_frontier_release, taiwan_tension_rise, export_control_escalation, emergent_anti_datacentre_blockade
- Turn 10 (1 turn(s) ago): medical_breakthrough
