...
- characters 375-1720: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1764-4007: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4063-4650: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4713-33768: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34123-35170: `{{event_history}}` from the run's own event record
...
- Turn 3 (10 turn(s) ago): labour_displacement
- Turn 4 (9 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, emergent_copycat_ot_probing
- Turn 5 (8 turn(s) ago): cyber_major_incident, election_retrenchment
- Turn 6 (7 turn(s) ago): cyber_major_incident, capability_jump, embodied_ai_deployment, taiwan_tension_rise
- Turn 7 (6 turn(s) ago): ai_investment_collapse, rsi_onset, labour_displacement, taiwan_tension_rise, export_control_escalation, emergent_copycat_water_port_outage
- Turn 8 (5 turn(s) ago): emergent_graduate_protest_wave
- Turn 9 (4 turn(s) ago): opaque_reasoning, openweight_frontier_release, taiwan_tension_rise, export_control_escalation, emergent_anti_datacentre_blockade
- Turn 10 (3 turn(s) ago): medical_breakthrough
- Turn 11 (2 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 12 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, research_breakthrough, medical_breakthrough, emergent_distressed_site_selloff
