...
- characters 377-1678: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1722-4068: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4124-5353: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5416-34125: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34480-34873: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, supply_chain_coercion
- Turn 3 (4 turn(s) ago): labour_displacement
- Turn 4 (3 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, emergent_copycat_ot_probing
- Turn 5 (2 turn(s) ago): cyber_major_incident, election_retrenchment
- Turn 6 (1 turn(s) ago): cyber_major_incident, capability_jump, embodied_ai_deployment, taiwan_tension_rise
