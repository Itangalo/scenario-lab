...
- characters 454-1626: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1669-3700: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5581-6049: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8585-11147: `{{previous_actions}}` from the actor's own response from the previous turn
