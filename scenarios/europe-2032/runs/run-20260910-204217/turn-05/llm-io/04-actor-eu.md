...
- characters 455-2144: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2188-4475: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5863-6357: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8688-10827: `{{previous_actions}}` from the actor's own response from the previous turn
