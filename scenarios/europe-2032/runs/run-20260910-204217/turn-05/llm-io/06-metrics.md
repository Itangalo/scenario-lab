...
- characters 106-13636: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13679-13871: `{{metrics_json}}` from the run's live metric values
- characters 13964-15653: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15697-17984: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18040-19248: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | Municipal Continuity and Recovery Corps | 2 |
...
## Metrics
```json
{"ai_capability": 67.0, "openweight_capability": 60.8, "ai_safety": 24.0, "resilience": 44.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 19.0, "public_sentiment": 23.0}
```
