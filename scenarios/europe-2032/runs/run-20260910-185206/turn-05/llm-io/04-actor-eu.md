...
- characters 455-1766: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1810-4112: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7496-7952: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10328-12676: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Assurance Uptake and Frontier Evaluation Cell | 5 | small | 4 | 7 | own jurisdiction | ai_safety up moderately, resilience up slightly via incident learning | 2 | running |
