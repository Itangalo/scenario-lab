...
- characters 13874-15185: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15229-17531: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17587-18185: `{{notepad}}` from the Game Master's notepad, carried across turns
