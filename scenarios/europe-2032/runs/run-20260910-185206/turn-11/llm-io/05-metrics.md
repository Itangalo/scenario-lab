...
- characters 107-13021: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13064-13254: `{{metrics_json}}` from the run's live metric values
- characters 13347-14995: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15039-17222: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17278-17999: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Civil Continuity and Recovery Corps | 2 |
| M11 | EU Pandemic Isolation and Grid-Island Survival Regime | 2 |
