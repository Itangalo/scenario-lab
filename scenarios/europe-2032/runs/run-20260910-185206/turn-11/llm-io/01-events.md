...
- characters 376-2024: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2068-4251: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4307-5276: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5339-32165: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32520-33524: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Civil Continuity and Recovery Corps −2 = −2 + priority has no effect and no cost as capital below 20
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 5, sentiment 5 -> none, capital not below sentiment
SOVEREIGNTY: 18 last turn, no category 4 finish or in flight, catastrophic great-power war targeting EU fabs/cables/compute t10 −3, capability rose 1.5 −1 = 14

## Emerging developments (tracked)

- `emergent_care_staff_walkout` -- first noted turn 10, listed in 1 turn(s) so far: A coordinated walkout by junior clinical and municipal staff across several member states refuses to operate AI-triaged queues they call unsafe, closing fallback clinics for days.
- `emergent_compute_siting_freeze` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated cross-border blockades and municipal bans halt grid-connection works for new EU compute sites through the spring, forcing contractors to demobilise.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, knowledge_work_augmented, eu_frontier_access_denied
- Turn 2 (9 turn(s) ago): cyber_major_incident, emergent_cyber_insurance_repricing
- Turn 4 (7 turn(s) ago): eval_anomaly_reports, safety_breakthrough, joint_threat_response
- Turn 5 (6 turn(s) ago): capability_jump, bio_uplift_findings, eval_anomaly_reports, export_control_escalation, us_china_agreement, election_alliance
- Turn 6 (5 turn(s) ago): capability_jump, eval_anomaly_reports, automated_decision_scandal
- Turn 7 (4 turn(s) ago): loss_of_control_incident, bio_uplift_findings, rsi_onset
- Turn 8 (3 turn(s) ago): capability_jump, eval_anomaly_reports, labour_displacement, eu_frontier_access_denied, adoption_success
- Turn 9 (2 turn(s) ago): cyber_major_incident, bio_incident, safety_breakthrough, emergent_datacentre_sabotage_wave
- Turn 10 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, catastrophic_great_power_conflict, automated_decision_scandal
