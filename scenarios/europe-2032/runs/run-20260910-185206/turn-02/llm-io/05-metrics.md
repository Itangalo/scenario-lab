...
- characters 105-13082: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13125-13317: `{{metrics_json}}` from the run's live metric values
- characters 13410-14836: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14879-17321: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17377-18248: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Grid-Port Recovery and Insurance Backstop | 2 |
...
- `emergent_kimi_cyber_toolkit_spread` -- first noted turn 1, listed in 2 turn(s) so far: Criminal forums begin circulating a ready-made intrusion toolkit fine-tuned from Kimi K3 for OT scanning and credential theft, lowering the skill barrier for grid and port intrusions beyond the initial test-shot actor.
...
## Notepad
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Cyber Shield −3, EU Grid-Port Recovery and Insurance Backstop −2, priority −1 = −12
PROPOSAL BONUS: EU Grid-Port Recovery and Insurance Backstop (cat 6, small) +3 — cyber_major_incident landed this turn and emergent repricing landed this turn and this answers them directly as recovery bridge
LEGITIMACY LENDS: capital 38, sentiment 31 -> none (capital higher)
