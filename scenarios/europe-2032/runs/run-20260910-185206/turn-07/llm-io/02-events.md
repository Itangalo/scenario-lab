...
- characters 1610-4419: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4475-4940: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5003-33337: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33692-34203: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, knowledge_work_augmented, eu_frontier_access_denied
- Turn 2 (5 turn(s) ago): cyber_major_incident, emergent_cyber_insurance_repricing
- Turn 4 (3 turn(s) ago): eval_anomaly_reports, safety_breakthrough, joint_threat_response
- Turn 5 (2 turn(s) ago): capability_jump, bio_uplift_findings, eval_anomaly_reports, export_control_escalation, us_china_agreement, election_alliance
- Turn 6 (1 turn(s) ago): capability_jump, eval_anomaly_reports, automated_decision_scandal
