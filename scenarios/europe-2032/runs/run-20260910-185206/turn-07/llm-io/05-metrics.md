...
- characters 106-13936: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13979-14170: `{{metrics_json}}` from the run's live metric values
- characters 14263-15453: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15497-18306: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18362-19148: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Loss-of-Control Containment and Bio-Detection Surge | 2 |
