...
- characters 375-1834: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1878-3867: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3923-4326: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4389-30362: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30717-31964: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M11 EU Pandemic Isolation and Grid-Island Survival Regime −2 = −2 + priority has no effect and no cost as capital below 20
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 8, sentiment 2 -> none, capital not below sentiment
SOVEREIGNTY: 13 last turn, no category 4 finish or in flight, export_control_escalation t12 −1, capability rose 1.5 −0 = 12
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, knowledge_work_augmented, eu_frontier_access_denied
- Turn 2 (11 turn(s) ago): cyber_major_incident, emergent_cyber_insurance_repricing
- Turn 4 (9 turn(s) ago): eval_anomaly_reports, safety_breakthrough, joint_threat_response
- Turn 5 (8 turn(s) ago): capability_jump, bio_uplift_findings, eval_anomaly_reports, export_control_escalation, us_china_agreement, election_alliance
- Turn 6 (7 turn(s) ago): capability_jump, eval_anomaly_reports, automated_decision_scandal
- Turn 7 (6 turn(s) ago): loss_of_control_incident, bio_uplift_findings, rsi_onset
- Turn 8 (5 turn(s) ago): capability_jump, eval_anomaly_reports, labour_displacement, eu_frontier_access_denied, adoption_success
- Turn 9 (4 turn(s) ago): cyber_major_incident, bio_incident, safety_breakthrough, emergent_datacentre_sabotage_wave
- Turn 10 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, catastrophic_great_power_conflict, automated_decision_scandal
- Turn 11 (2 turn(s) ago): catastrophic_bio_incident, catastrophic_loss_of_control_incident, emergent_compute_siting_freeze
- Turn 12 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, medical_breakthrough, export_control_escalation
