...
- characters 107-13271: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13314-13503: `{{metrics_json}}` from the run's live metric values
- characters 13596-15055: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15099-17088: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17144-17858: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_convoy_blockade_backlash` -- first noted turn 13, listed in 1 turn(s) so far: Guarded hospital convoys and islanded utilities are attacked as hoarding by municipal protest networks, triggering coordinated blockades of medical supply routes in two member states.
...
## Metrics
```json
{"ai_capability": 97.0, "openweight_capability": 93.0, "ai_safety": 1.0, "resilience": 49.0, "eu_ai_sovereignty": 9.0, "eu_political_capital": 6.0, "public_sentiment": 2.0}
```
...
## Notepad
PORTFOLIO CHARGE t13: (none in flight), priority has no effect and no cost as capital below 20 = -0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 6, sentiment 2 -> none, capital not below sentiment
SOVEREIGNTY: 12 last turn, no category 4 finish or in flight +0, us_labs_nationalised t13 −3 (largest of supply_chain_coercion / export_control_escalation / embodied_ai_deployment), capability rose 1.5 −0 = 9
