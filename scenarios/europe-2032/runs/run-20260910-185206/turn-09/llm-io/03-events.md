...
- characters 1576-3576: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3632-4476: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4539-33344: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33699-34423: `{{event_history}}` from the run's own event record
...
- `emergent_datacentre_sabotage_wave` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated physical blockades and sabotage attempts against data-centre construction sites in two member states, forcing temporary work stoppages and a national debate on infrastructure siting.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, knowledge_work_augmented, eu_frontier_access_denied
- Turn 2 (7 turn(s) ago): cyber_major_incident, emergent_cyber_insurance_repricing
- Turn 4 (5 turn(s) ago): eval_anomaly_reports, safety_breakthrough, joint_threat_response
- Turn 5 (4 turn(s) ago): capability_jump, bio_uplift_findings, eval_anomaly_reports, export_control_escalation, us_china_agreement, election_alliance
- Turn 6 (3 turn(s) ago): capability_jump, eval_anomaly_reports, automated_decision_scandal
- Turn 7 (2 turn(s) ago): loss_of_control_incident, bio_uplift_findings, rsi_onset
- Turn 8 (1 turn(s) ago): capability_jump, eval_anomaly_reports, labour_displacement, eu_frontier_access_denied, adoption_success
