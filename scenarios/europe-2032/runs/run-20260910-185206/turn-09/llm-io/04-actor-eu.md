...
- characters 1654-3654: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5054-5504: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8338-10593: `{{previous_actions}}` from the actor's own response from the previous turn
