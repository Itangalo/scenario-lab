...
- characters 106-13561: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13604-13795: `{{metrics_json}}` from the run's live metric values
- characters 13888-15044: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15088-17088: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17144-17667: `{{notepad}}` from the Game Master's notepad, carried across turns
