...
- characters 2129-3883: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7397-7844: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11020-13452: `{{previous_actions}}` from the actor's own response from the previous turn
