...
- characters 106-12952: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12995-13187: `{{metrics_json}}` from the run's live metric values
- characters 13280-14911: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14954-16708: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16764-17739: `{{notepad}}` from the Game Master's notepad, carried across turns
