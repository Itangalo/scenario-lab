...
- characters 2051-3805: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3861-4287: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4350-32343: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32698-33539: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Civil Continuity and Recovery Corps −2 = −2 + priority has no effect and no cost as capital below 20
PROPOSAL BONUS: EU Civil Continuity and Recovery Corps (cat 6, small) +3 — cyber_major_incident and bio_incident fired this turn and this answers both directly
LEGITIMACY LENDS: capital 10, sentiment 12 -> +1
SOVEREIGNTY: 19 last turn, no capacity event, no cat4 in flight, capability rose 1.5 −1 = 18
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, knowledge_work_augmented, eu_frontier_access_denied
- Turn 2 (8 turn(s) ago): cyber_major_incident, emergent_cyber_insurance_repricing
- Turn 4 (6 turn(s) ago): eval_anomaly_reports, safety_breakthrough, joint_threat_response
- Turn 5 (5 turn(s) ago): capability_jump, bio_uplift_findings, eval_anomaly_reports, export_control_escalation, us_china_agreement, election_alliance
- Turn 6 (4 turn(s) ago): capability_jump, eval_anomaly_reports, automated_decision_scandal
- Turn 7 (3 turn(s) ago): loss_of_control_incident, bio_uplift_findings, rsi_onset
- Turn 8 (2 turn(s) ago): capability_jump, eval_anomaly_reports, labour_displacement, eu_frontier_access_denied, adoption_success
- Turn 9 (1 turn(s) ago): cyber_major_incident, bio_incident, safety_breakthrough, emergent_datacentre_sabotage_wave
