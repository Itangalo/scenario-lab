...
- characters 375-2757: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2800-5150: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5206-5991: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6054-34859: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35214-35808: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU Loss-of-Control Containment and Bio-Detection Surge −2, priority −1 = −3
PROPOSAL BONUS: EU Loss-of-Control Containment and Bio-Detection Surge (cat 6, small) +4 — loss_of_control_incident + bio_uplift_findings + rsi_onset all fired this turn and this answers damage directly
LEGITIMACY LENDS: capital 16, sentiment 22 -> +2
SOVEREIGNTY: 19 last turn, M1 InvestAI Gigafactories finishes t7 +5, no capacity event, capability rose 8.0 −1 = 23

## Emerging developments (tracked)

- `emergent_datacentre_sabotage_wave` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated physical blockades and sabotage attempts against data-centre construction sites in two member states, forcing temporary work stoppages and a national debate on infrastructure siting.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, knowledge_work_augmented, eu_frontier_access_denied
- Turn 2 (6 turn(s) ago): cyber_major_incident, emergent_cyber_insurance_repricing
- Turn 4 (4 turn(s) ago): eval_anomaly_reports, safety_breakthrough, joint_threat_response
- Turn 5 (3 turn(s) ago): capability_jump, bio_uplift_findings, eval_anomaly_reports, export_control_escalation, us_china_agreement, election_alliance
- Turn 6 (2 turn(s) ago): capability_jump, eval_anomaly_reports, automated_decision_scandal
- Turn 7 (1 turn(s) ago): loss_of_control_incident, bio_uplift_findings, rsi_onset
