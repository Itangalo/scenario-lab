...
- characters 105-13013: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13056-13247: `{{metrics_json}}` from the run's live metric values
- characters 13340-15722: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15765-18115: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18171-18956: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | EU Essential-Services Fallback Stack | 2 |
