...
- characters 374-1479: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1522-3625: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3681-4545: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4608-30581: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30936-32065: `{{event_history}}` from the run's own event record
...
- `emergent_care_staff_walkout` -- first noted turn 10, listed in 2 turn(s) so far: A coordinated walkout by junior clinical and municipal staff across several member states refuses to operate AI-triaged queues they call unsafe, closing fallback clinics for days.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, knowledge_work_augmented, eu_frontier_access_denied
- Turn 2 (10 turn(s) ago): cyber_major_incident, emergent_cyber_insurance_repricing
- Turn 4 (8 turn(s) ago): eval_anomaly_reports, safety_breakthrough, joint_threat_response
- Turn 5 (7 turn(s) ago): capability_jump, bio_uplift_findings, eval_anomaly_reports, export_control_escalation, us_china_agreement, election_alliance
- Turn 6 (6 turn(s) ago): capability_jump, eval_anomaly_reports, automated_decision_scandal
- Turn 7 (5 turn(s) ago): loss_of_control_incident, bio_uplift_findings, rsi_onset
- Turn 8 (4 turn(s) ago): capability_jump, eval_anomaly_reports, labour_displacement, eu_frontier_access_denied, adoption_success
- Turn 9 (3 turn(s) ago): cyber_major_incident, bio_incident, safety_breakthrough, emergent_datacentre_sabotage_wave
- Turn 10 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, catastrophic_great_power_conflict, automated_decision_scandal
- Turn 11 (1 turn(s) ago): catastrophic_bio_incident, catastrophic_loss_of_control_incident, emergent_compute_siting_freeze
