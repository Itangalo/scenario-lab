...
- characters 13422-13611: `{{metrics_json}}` from the run's live metric values
- characters 13704-14809: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14852-16955: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17011-17574: `{{notepad}}` from the Game Master's notepad, carried across turns
