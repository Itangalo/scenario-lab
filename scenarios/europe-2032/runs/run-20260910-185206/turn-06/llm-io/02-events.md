...
- characters 1681-4244: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4300-4963: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5026-32193: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32548-32967: `{{event_history}}` from the run's own event record
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, knowledge_work_augmented, eu_frontier_access_denied
- Turn 2 (4 turn(s) ago): cyber_major_incident, emergent_cyber_insurance_repricing
- Turn 4 (2 turn(s) ago): eval_anomaly_reports, safety_breakthrough, joint_threat_response
- Turn 5 (1 turn(s) ago): capability_jump, bio_uplift_findings, eval_anomaly_reports, export_control_escalation, us_china_agreement, election_alliance
