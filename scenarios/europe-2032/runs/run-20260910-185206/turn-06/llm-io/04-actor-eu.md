...
- characters 1759-4322: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6497-6947: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9539-12569: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Seat at the Safety Floor and Allied Access Pact | 8 | small | 5 | 7 | US, China, coalition | eu_ai_sovereignty up slightly via secured access and leverage, ai_safety up via shared assurance | 2 | running |
