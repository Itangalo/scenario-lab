...
- characters 377-1332: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1376-3556: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3612-4419: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4482-28058: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28413-28578: `{{event_history}}` from the run's own event record
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, taiwan_tension_rise, automated_decision_scandal
- Turn 2 (1 turn(s) ago): adoption_success, emergent_talent_retention_pact
