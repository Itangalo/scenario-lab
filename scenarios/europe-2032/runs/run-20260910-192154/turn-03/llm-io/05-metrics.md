...
- characters 106-13437: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13480-13672: `{{metrics_json}}` from the run's live metric values
- characters 13765-14720: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14764-16944: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17000-17466: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | European Research Compute Pool | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Grid and Critical Services Shield −3, European Research Compute Pool −2, priority −1 = −12
PROPOSAL BONUS: none — new Research Compute Pool backs positive university charter and adoption wins, not a negative event from last three turns
