...
- characters 105-13511: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13554-13745: `{{metrics_json}}` from the run's live metric values
- characters 13838-14915: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14958-17075: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17131-17676: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | Allied Tier Access and Compute Swap | 2 |
