...
- characters 453-1530: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1573-3690: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4772-5235: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7630-10301: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | Allied Tier Access and Compute Swap | 8 | small | 5 | 7 | own jurisdiction | eu_ai_sovereignty up slightly, resilience up slightly | 2 | running |
