...
- characters 375-1452: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1495-3612: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3668-4539: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4602-30385: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30740-31149: `{{event_history}}` from the run's own event record
...
- `emergent_transformer_supply_crunch` -- first noted turn 4, listed in 2 turn(s) so far: Global power-transformer and grid-component shortage spikes prices and lead times, pitting EU substation rebuilds against data-centre grid connections and stalling port and Gigafactory energisation.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, taiwan_tension_rise, automated_decision_scandal
- Turn 2 (4 turn(s) ago): adoption_success, emergent_talent_retention_pact
- Turn 3 (3 turn(s) ago): eval_anomaly_reports, export_control_escalation
- Turn 4 (2 turn(s) ago): taiwan_blockade, ai_investment_collapse, openweight_frontier_release
- Turn 5 (1 turn(s) ago): knowledge_work_augmented, election_consolidation
