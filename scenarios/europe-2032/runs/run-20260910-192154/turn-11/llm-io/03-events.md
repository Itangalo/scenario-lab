...
- characters 376-1361: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1405-3260: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3316-4179: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4242-31689: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32044-32892: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M11 EU Essential Services Islanding Drive −2, M12 EU Verification Anchor to the US-China Accord −2, priority M11 −1 = −5
PROPOSAL BONUS: EU Verification Anchor to the US-China Accord (cat 8, small) +3 — us_china_agreement landed this turn and this answers it directly, trading verification for inclusion
LEGITIMACY LENDS: none — capital 12, sentiment 9, capital higher
SOVEREIGNTY: 22 last turn, no cat4 finish, no cat4 in flight +0, no capacity event, capability rose 2.5 −1 = 21

## Emerging developments (tracked)

- `emergent_copycat_extortion_wave` -- first noted turn 10, listed in 1 turn(s) so far: Copycat crews reusing leaked machine-generated ransomware toolkits launch a synchronized extortion wave against EU municipal contractors and hospital suppliers, exploiting the autumn poisoned-component blast radius before patches land.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, taiwan_tension_rise, automated_decision_scandal
- Turn 2 (9 turn(s) ago): adoption_success, emergent_talent_retention_pact
- Turn 3 (8 turn(s) ago): eval_anomaly_reports, export_control_escalation
- Turn 4 (7 turn(s) ago): taiwan_blockade, ai_investment_collapse, openweight_frontier_release
- Turn 5 (6 turn(s) ago): knowledge_work_augmented, election_consolidation
- Turn 6 (5 turn(s) ago): rsi_onset, loss_of_control_incident
- Turn 7 (4 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release
- Turn 8 (3 turn(s) ago): bio_uplift_findings, safety_breakthrough, embodied_ai_deployment
- Turn 9 (2 turn(s) ago): cyber_major_incident, capability_jump, export_control_escalation
- Turn 10 (1 turn(s) ago): cyber_major_incident, openweight_frontier_release, us_china_agreement
