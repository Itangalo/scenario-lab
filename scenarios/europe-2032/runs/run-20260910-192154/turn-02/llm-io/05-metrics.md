...
- characters 105-13065: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13108-13300: `{{metrics_json}}` from the run's live metric values
- characters 13393-14324: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14367-16495: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16551-17321: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_screening_moratorium_call` -- first noted turn 1, listed in 2 turn(s) so far: A coalition of leading virologists and AI researchers publicly calls for mandatory DNA-synthesis screening and a moratorium on open release of genome language models following the AI-designed phage demonstrations.
