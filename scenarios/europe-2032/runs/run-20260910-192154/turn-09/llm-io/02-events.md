...
- characters 377-2494: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2538-4696: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4752-5508: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5571-34524: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34879-35538: `{{event_history}}` from the run's own event record
...
- `emergent_anti_ai_infrastructure_sabotage` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated physical attacks on data-centre grid connections and fibre in multiple member states, claimed as anti-AI protest, force prolonged outages of public AI services.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, taiwan_tension_rise, automated_decision_scandal
- Turn 2 (7 turn(s) ago): adoption_success, emergent_talent_retention_pact
- Turn 3 (6 turn(s) ago): eval_anomaly_reports, export_control_escalation
- Turn 4 (5 turn(s) ago): taiwan_blockade, ai_investment_collapse, openweight_frontier_release
- Turn 5 (4 turn(s) ago): knowledge_work_augmented, election_consolidation
- Turn 6 (3 turn(s) ago): rsi_onset, loss_of_control_incident
- Turn 7 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release
- Turn 8 (1 turn(s) ago): bio_uplift_findings, safety_breakthrough, embodied_ai_deployment
