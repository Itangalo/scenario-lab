...
- characters 13691-15808: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15852-18010: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18066-18516: `{{notepad}}` from the Game Master's notepad, carried across turns
