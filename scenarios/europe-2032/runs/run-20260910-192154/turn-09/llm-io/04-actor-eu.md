...
- characters 455-2572: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2616-4774: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5913-6376: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9192-11463: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Assurance Adoption Fast-Track | 5 | small | 8 | 10 | own jurisdiction | ai_safety up, resilience up slightly | 2 | running |
