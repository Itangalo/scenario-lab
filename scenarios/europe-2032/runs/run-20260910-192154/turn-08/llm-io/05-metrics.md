...
- characters 105-13361: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13404-13596: `{{metrics_json}}` from the run's live metric values
- characters 13689-15265: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15308-17823: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17879-18183: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Bio-Cyber Distributed Defence Surge | 2 |
| M10 | EU Assurance Adoption Fast-Track | 2 |
