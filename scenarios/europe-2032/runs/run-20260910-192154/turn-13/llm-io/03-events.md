...
- characters 377-2060: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2104-4186: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4242-4709: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4772-32219: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32574-33595: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Displaced Entry-Level Continuity Fund −2, priority −1 not charged capital below 20 = −2
PROPOSAL BONUS: EU Displaced Entry-Level Continuity Fund (cat 7, small) +3 — labour_displacement landed this turn and this answers it directly with wage insurance and retraining
LEGITIMACY LENDS: none — capital 10, sentiment 3, capital higher
SOVEREIGNTY: 19 last turn, no cat4 finish, no cat4 in flight +0, no capacity event, capability rose 3.0 −1 = 18
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, taiwan_tension_rise, automated_decision_scandal
- Turn 2 (11 turn(s) ago): adoption_success, emergent_talent_retention_pact
- Turn 3 (10 turn(s) ago): eval_anomaly_reports, export_control_escalation
- Turn 4 (9 turn(s) ago): taiwan_blockade, ai_investment_collapse, openweight_frontier_release
- Turn 5 (8 turn(s) ago): knowledge_work_augmented, election_consolidation
- Turn 6 (7 turn(s) ago): rsi_onset, loss_of_control_incident
- Turn 7 (6 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release
- Turn 8 (5 turn(s) ago): bio_uplift_findings, safety_breakthrough, embodied_ai_deployment
- Turn 9 (4 turn(s) ago): cyber_major_incident, capability_jump, export_control_escalation
- Turn 10 (3 turn(s) ago): cyber_major_incident, openweight_frontier_release, us_china_agreement
- Turn 11 (2 turn(s) ago): medical_breakthrough, eu_frontier_access_denied
- Turn 12 (1 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, labour_displacement
