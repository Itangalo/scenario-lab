...
- characters 107-13005: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13048-13239: `{{metrics_json}}` from the run's live metric values
- characters 13332-15015: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15059-17141: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17197-17960: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Displaced Entry-Level Continuity Fund | 2 |
| M15 | EU Lithography Leverage Shield | 2 |
...
- `emergent_youth_datacentre_blockades` -- first noted turn 13, listed in 1 turn(s) so far: Youth-led anti-automation protests escalate into coordinated blockades of data-centre construction sites in three member states, forcing temporary construction halts.
...
## Notepad
PORTFOLIO CHARGE t13: EU Displaced Entry-Level Continuity Fund −2, EU Lithography Leverage Shield −2, priority −1 not charged capital below 20 = −4
PROPOSAL BONUS: EU Lithography Leverage Shield (cat 8, small) +3 — supply_chain_coercion landed this turn and this answers it directly with servicing pool and ACI examination
LEGITIMACY LENDS: none — capital 13, sentiment 4, capital higher
SOVEREIGNTY: 18 last turn, no cat4 finish, no cat4 in flight +0, supply_chain_coercion t13 −2, capability rose 1.5 −1 = 15
