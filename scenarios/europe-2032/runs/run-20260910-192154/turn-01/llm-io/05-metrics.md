...
- characters 106-13021: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13064-13256: `{{metrics_json}}` from the run's live metric values
- characters 13372-16321: `{{world_state}}` from background/context.md, seeded as the opening world state
- characters 16377-16954: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M3 | EU Grid and Critical Services Shield | 3 |
...
- `emergent_talent_retention_pact` -- first noted turn 1, listed in 1 turn(s) so far: Major EU research universities and public labs jointly announce a pooled compute charter to retain frontier AI talent threatening to leave for US labs.
- `emergent_screening_moratorium_call` -- first noted turn 1, listed in 1 turn(s) so far: A coalition of leading virologists and AI researchers publicly calls for mandatory DNA-synthesis screening and a moratorium on open release of genome language models following the AI-designed phage demonstrations.
...
## Notepad
PORTFOLIO CHARGE t1: Gigafactories −3, Tech sovereignty package −3, EU Grid and Critical Services Shield −3, priority −1 = −10
PROPOSAL BONUS: EU Grid and Critical Services Shield (cat 6, large) +3 — cyber_test_shot severe precursor landed this turn and this answers it directly
