...
- characters 106-13520: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13563-13753: `{{metrics_json}}` from the run's live metric values
- characters 13846-15247: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15290-17123: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17179-17689: `{{notepad}}` from the Game Master's notepad, carried across turns
