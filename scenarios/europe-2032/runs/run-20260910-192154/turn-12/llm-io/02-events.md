...
- characters 375-1776: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1819-3652: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3708-4579: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4642-32089: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32444-33368: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M12 EU Verification Anchor to the US-China Accord −2, M13 EU Clinical Continuity Fallback −2, priority M13 −1 = −5
PROPOSAL BONUS: EU Clinical Continuity Fallback (cat 9, small) +3 — eu_frontier_access_denied landed this turn and this answers it directly, keeping care running on EU-hosted models
LEGITIMACY LENDS: none — capital 10, sentiment 3, capital higher
SOVEREIGNTY: 21 last turn, no cat4 finish, no cat4 in flight +0, eu_frontier_access_denied t11 −2, capability rose 1.5 −0 = 19

## Emerging developments (tracked)

- `emergent_copycat_extortion_wave` -- first noted turn 10, listed in 2 turn(s) so far: Copycat crews reusing leaked machine-generated ransomware toolkits launch a synchronized extortion wave against EU municipal contractors and hospital suppliers, exploiting the autumn poisoned-component blast radius before patches land.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, taiwan_tension_rise, automated_decision_scandal
- Turn 2 (10 turn(s) ago): adoption_success, emergent_talent_retention_pact
- Turn 3 (9 turn(s) ago): eval_anomaly_reports, export_control_escalation
- Turn 4 (8 turn(s) ago): taiwan_blockade, ai_investment_collapse, openweight_frontier_release
- Turn 5 (7 turn(s) ago): knowledge_work_augmented, election_consolidation
- Turn 6 (6 turn(s) ago): rsi_onset, loss_of_control_incident
- Turn 7 (5 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release
- Turn 8 (4 turn(s) ago): bio_uplift_findings, safety_breakthrough, embodied_ai_deployment
- Turn 9 (3 turn(s) ago): cyber_major_incident, capability_jump, export_control_escalation
- Turn 10 (2 turn(s) ago): cyber_major_incident, openweight_frontier_release, us_china_agreement
- Turn 11 (1 turn(s) ago): medical_breakthrough, eu_frontier_access_denied
