...
- characters 1503-3459: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3515-3987: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4050-33003: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33358-34108: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, taiwan_tension_rise, automated_decision_scandal
- Turn 2 (8 turn(s) ago): adoption_success, emergent_talent_retention_pact
- Turn 3 (7 turn(s) ago): eval_anomaly_reports, export_control_escalation
- Turn 4 (6 turn(s) ago): taiwan_blockade, ai_investment_collapse, openweight_frontier_release
- Turn 5 (5 turn(s) ago): knowledge_work_augmented, election_consolidation
- Turn 6 (4 turn(s) ago): rsi_onset, loss_of_control_incident
- Turn 7 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release
- Turn 8 (2 turn(s) ago): bio_uplift_findings, safety_breakthrough, embodied_ai_deployment
- Turn 9 (1 turn(s) ago): cyber_major_incident, capability_jump, export_control_escalation
