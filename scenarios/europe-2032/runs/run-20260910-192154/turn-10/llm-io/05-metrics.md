...
- characters 106-13374: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13417-13608: `{{metrics_json}}` from the run's live metric values
- characters 13701-14785: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14828-16784: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16840-17673: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Essential Services Islanding Drive | 2 |
