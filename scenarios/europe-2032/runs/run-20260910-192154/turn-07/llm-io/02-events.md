...
- characters 1710-3978: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4034-4626: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4689-31429: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31784-32255: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, taiwan_tension_rise, automated_decision_scandal
- Turn 2 (5 turn(s) ago): adoption_success, emergent_talent_retention_pact
- Turn 3 (4 turn(s) ago): eval_anomaly_reports, export_control_escalation
- Turn 4 (3 turn(s) ago): taiwan_blockade, ai_investment_collapse, openweight_frontier_release
- Turn 5 (2 turn(s) ago): knowledge_work_augmented, election_consolidation
- Turn 6 (1 turn(s) ago): rsi_onset, loss_of_control_incident
