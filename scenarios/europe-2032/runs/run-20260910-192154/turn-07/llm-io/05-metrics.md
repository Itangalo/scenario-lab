...
- characters 106-13687: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13730-13922: `{{metrics_json}}` from the run's live metric values
- characters 14015-15304: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15348-17616: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17672-18570: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Loss-of-Control Containment Reserve | 2 |
