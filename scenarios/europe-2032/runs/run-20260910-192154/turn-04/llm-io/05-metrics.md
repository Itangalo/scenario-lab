...
- characters 105-13451: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13494-13686: `{{metrics_json}}` from the run's live metric values
- characters 13779-14779: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14822-16828: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16884-17712: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Eval Anomaly Response Protocol | 2 |
| M6 | Upstream Conservation and Leverage Compact | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, European Research Compute Pool −2, EU Eval Anomaly Response Protocol −2, priority −1 = −11
PROPOSAL BONUS: EU Eval Anomaly Response Protocol (cat 1, small) +2 — leaked unreleased-system behaviour landed this turn and this answers it directly
LEGITIMACY LENDS: capital 20, sentiment 35 -> +2
SOVEREIGNTY: 21 last turn, no capacity event, Gigafactories in flight +1, export_control_escalation t3 −1, capability rose 3.0 −1 = 20

## Emerging developments (tracked)

- `emergent_transformer_supply_crunch` -- first noted turn 4, listed in 1 turn(s) so far: Global power-transformer and grid-component shortage spikes prices and lead times, pitting EU substation rebuilds against data-centre grid connections and stalling port and Gigafactory energisation.
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Eval Anomaly Response Protocol −2, Upstream Conservation and Leverage Compact −2, priority −1 = −11
PROPOSAL BONUS: Upstream Conservation and Leverage Compact (cat 8, small) +4 — taiwan_blockade plus ai_investment_collapse landed this turn and this answers them directly
LEGITIMACY LENDS: capital 10, sentiment 29 -> +2
SOVEREIGNTY: 20 last turn, European Research Compute Pool finishes t4 +4, Gigafactories in flight +1, taiwan_blockade t4 −3, capability rose 2.5 −1 = 21
