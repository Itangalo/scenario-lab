...
- characters 455-1596: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1640-3761: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5041-5497: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7737-10192: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | Upstream Conservation and Leverage Compact | 8 | small | 4 | 7 | own jurisdiction | eu_ai_sovereignty up slightly, resilience up slightly | 2 | running |
