...
- characters 377-1518: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1562-3683: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3739-4617: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4680-30916: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31271-31605: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, taiwan_tension_rise, automated_decision_scandal
- Turn 2 (3 turn(s) ago): adoption_success, emergent_talent_retention_pact
- Turn 3 (2 turn(s) ago): eval_anomaly_reports, export_control_escalation
- Turn 4 (1 turn(s) ago): taiwan_blockade, ai_investment_collapse, openweight_frontier_release
