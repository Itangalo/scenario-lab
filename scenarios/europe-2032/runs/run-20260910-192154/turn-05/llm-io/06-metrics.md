...
- characters 13771-14912: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14956-17077: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17133-18011: `{{notepad}}` from the Game Master's notepad, carried across turns
