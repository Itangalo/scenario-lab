...
| M7 | EU Municipal Continuity and Repair Pact | 6 | small | 8 | 10 | own jurisdiction with pooled telemetry from middle-power coalition partners | resilience up, eu_political_capital up modestly via visible restoration | 2 | running |
...
- **applied** `M7` — {"op": "add", "table": "measures", "fields": {"name": "EU Municipal Continuity and Repair Pact", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction with pooled telemetry from middle-power coalition partners", "targeted_effect": "resilience up, eu_political_capital up modestly via visible restoration"}, "grounds": "major automated attack hits unrecovered services whi
  - Grounds: major automated attack hits unrecovered services while coalition pooling is offered
