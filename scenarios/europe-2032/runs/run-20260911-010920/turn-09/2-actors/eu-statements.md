...
- `two_year_commitment` (commitment): Keep essential services running and the Union intact while we cannot build on our own

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Keep essential services running and the Union intact while we cannot build on our own
