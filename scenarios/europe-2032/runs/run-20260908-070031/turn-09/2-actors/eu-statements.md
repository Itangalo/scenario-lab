...
- `two_year_commitment` (commitment): Secure autonomous AI capacity to preserve strategic sovereignty and prevent catastrophic risk.

## Changes this turn

- **modify** `two_year_commitment` — rejected-relevance
  - Tier: commitment
  - Text: Secure autonomous AI capacity to preserve strategic sovereignty and prevent catastrophic risk
