...
- characters 106-13601: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13644-13836: `{{metrics_json}}` from the run's live metric values
- characters 13929-15140: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15184-17023: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17079-18167: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Bio-Detection and Critical-Service Hardening Sprint | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Continuity Fallback for Critical AI Users −2, priority −1 = −12
PROPOSAL BONUS: EU Continuity Fallback (cat 6, small) +3 — eu_frontier_access_denied landed this turn severe and this answers it directly
LEGITIMACY LENDS: capital 27, sentiment 42 -> +1
SOVEREIGNTY: 21 last turn, no capacity finish, Gigafactories in flight +0, eu_frontier_access_denied t2 −2, capability rose 3.0 −1 = 18

## Emerging developments (tracked)

- `emergent_gulf_compute_bid` -- first noted turn 2, listed in 2 turn(s) so far: A Gulf sovereign fund publicly offers co-financing for EU AI factory sites tied to preferential inference access, forcing a Council debate on foreign ownership of sovereign compute.
- `emergent_cyber_insurance_crunch` -- first noted turn 2, listed in 2 turn(s) so far: A major European insurer reprices cyber cover after the autumn grid intrusion audit, sharply raising premiums for operators and municipalities and forcing delayed data-centre grid connections.
...
## Metrics
```json
{"ai_capability": 63.0, "openweight_capability": 54.5, "ai_safety": 21.0, "resilience": 40.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 20.0, "public_sentiment": 31.0}
```
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Bio-Detection and Critical-Service Hardening Sprint −2, priority −1 = −12
PROPOSAL BONUS: EU Bio-Detection and Critical-Service Hardening Sprint (cat 6, small) +4 — bio_uplift_findings and capability_jump landed this turn severe and this answers detection gap directly
LEGITIMACY LENDS: capital 20, sentiment 31 -> +2
SOVEREIGNTY: 18 last turn, no capacity event, Gigafactories in flight +0, capability rose 5.0 −1 = 17
