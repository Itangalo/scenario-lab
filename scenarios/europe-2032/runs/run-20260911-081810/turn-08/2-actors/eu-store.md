...
| M9 | EU Loss-of-Control Rapid Containment Protocol | 6 | small | 7 | 9 | own jurisdiction | resilience up, ai_safety loss contained via faster containment | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Chips-for-Compute and Civic Liability Pact", "category": 8, "size": "small", "finish_turn": 10, "applies_to": "coalition partners holding supply-chain chokepoints plus own jurisdiction", "targeted_effect": "eu_ai_sovereignty up slightly via secured compute, resilience up slightly via restored civic deployments"}, "grounds": "to answer block
  - Grounds: to answer blockade plus insurance freeze with low capital
