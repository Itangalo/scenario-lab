...
- characters 376-2983: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3026-4957: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5013-5787: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5850-31333: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31688-32820: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Breakthrough Care Localisation −2, EU Entry-Level Transition Shield −2, priority −0 (capital below 20, no effect, no cost) = −4
PROPOSAL BONUS: EU Entry-Level Transition Shield (cat 7, small) +3 — labour_displacement landed this turn and this answers it directly
LEGITIMACY LENDS: capital 11, sentiment 15 -> +2
SOVEREIGNTY: 11 last turn, no capacity event, no cat4 in flight +0, capability rose 4.0 −1 = 10

## Emerging developments (tracked)

- `emergent_neutral_site_struck` -- first noted turn 10, listed in 2 turn(s) so far: A US or Chinese strike disables a declared non-belligerent EU civilian node  a cable landing, ground station or islanded data centre  despite Brussels notification, forcing prolonged islanding and emergency rationing.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, safety_breakthrough, automated_decision_scandal
- Turn 2 (10 turn(s) ago): capability_jump, cyber_defence_breakthrough, automated_decision_scandal
- Turn 3 (9 turn(s) ago): cyber_defence_breakthrough, eu_frontier_access_denied
- Turn 4 (8 turn(s) ago): cyber_major_incident, opaque_reasoning, automated_decision_scandal
- Turn 5 (7 turn(s) ago): eval_anomaly_reports, ai_investment_collapse, taiwan_tension_rise, eu_frontier_access_denied, adoption_success, election_alliance
- Turn 7 (5 turn(s) ago): cyber_major_incident, medical_breakthrough, safety_breakthrough
- Turn 8 (4 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, rsi_onset, eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 9 (3 turn(s) ago): loss_of_control_incident, capability_jump, bio_uplift_findings, catastrophic_great_power_conflict, eu_frontier_access_denied, member_state_defection, middle_power_coalition
- Turn 10 (2 turn(s) ago): capability_jump, medical_breakthrough, taiwan_tension_rise
- Turn 11 (1 turn(s) ago): capability_jump, safety_breakthrough, labour_displacement
