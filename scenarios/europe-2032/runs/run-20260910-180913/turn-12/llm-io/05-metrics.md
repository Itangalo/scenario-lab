...
- characters 13728-16335: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16378-18309: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18365-18797: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Entry-Level Transition Shield | 2 |
| M13 | EU Struck Node Islanding and Emergency Rationing Reinforcement | 2 |
