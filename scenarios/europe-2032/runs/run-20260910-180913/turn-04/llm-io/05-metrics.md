...
- characters 105-13574: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13617-13809: `{{metrics_json}}` from the run's live metric values
- characters 13902-14921: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14964-17041: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17097-18214: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Municipal Recovery and Cascade Prevention | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Defensive Shield Scale-Up −3, EU Continuity Stack for Essential Services −2, priority −1 = −12
PROPOSAL BONUS: EU Continuity Stack (cat 9, small) +3 — eu_frontier_access_denied fired this turn cutting hospitals/ministries/firms, this answers it directly
LEGITIMACY LENDS: capital 10, sentiment 21 -> +2
SOVEREIGNTY: 21 last turn, no capacity event finishes, Gigafactories in flight +0, eu_frontier_access_denied t3 −3, capability rose 3.5 −1 = 17
