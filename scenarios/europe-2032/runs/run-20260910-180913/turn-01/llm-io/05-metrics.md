...
- characters 16384-16948: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M3 | EU Critical Systems Hardening and Exercises | 3 |
...
- `emergent_eu_cluster_hedge` -- first noted turn 1, listed in 1 turn(s) so far: A major non-US frontier lab announces a training cluster inside the EU under EU law to hedge against US access cutoffs, prompting a bidding contest among member states.
- `emergent_datacentre_siting_backlash` -- first noted turn 1, listed in 1 turn(s) so far: Coordinated local protests block permitting for two planned hyperscale data centre campuses in Spain and Germany over water and power use, forcing a national-level review of siting rules.
...
## Notepad
PORTFOLIO CHARGE t1: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Hardening and Exercises −3, priority −1 = −10
PROPOSAL BONUS: EU Critical Systems Hardening and Exercises (cat 6, large) +4 — intrusion across EU grids landed this turn and this answers it directly
LEGITIMACY LENDS: capital 37, sentiment 34 -> none, capital higher
SOVEREIGNTY: 22 last turn, no capacity event, Gigafactories in flight +1, capability rose 3.0 −1 = 22
