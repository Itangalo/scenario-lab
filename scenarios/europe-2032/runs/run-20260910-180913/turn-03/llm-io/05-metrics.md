...
- characters 106-13470: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13513-13705: `{{metrics_json}}` from the run's live metric values
- characters 13798-15610: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15654-17546: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17602-18095: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Continuity Stack for Essential Services | 2 |
...
## Metrics
```json
{"ai_capability": 63.5, "openweight_capability": 55.0, "ai_safety": 30.0, "resilience": 42.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 12.0, "public_sentiment": 21.0}
```
