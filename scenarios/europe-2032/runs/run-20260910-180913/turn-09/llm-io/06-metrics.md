...
- characters 13832-15092: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15136-17016: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17072-17611: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 89.0, "openweight_capability": 78.0, "ai_safety": 6.0, "resilience": 45.0, "eu_ai_sovereignty": 12.0, "eu_political_capital": 14.0, "public_sentiment": 12.0}
```
