...
- characters 377-1637: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1681-3561: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3617-4473: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4536-31186: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31541-32301: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: InvestAI Gigafactories −3, EU Essential Services Rapid Recovery Cell −2 = −5 + priority −0 (capital below 20, no effect, no cost) = −5
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 10, sentiment 19 -> +2 (included in capital total, capped below sentiment)
SOVEREIGNTY: 15 last turn, no capacity event secured, no finish, Gigafactories in flight +0, eu_frontier_access_denied t8 −3 (largest of two capacity losses, member_state_defection also qualifies), capability rose 7.0 −1 = 11

## Emerging developments (tracked)

- `emergent_care_rollout_strike` -- first noted turn 7, listed in 2 turn(s) so far: Nurses unions leading the EU reference triage deployment call a cross-border strike over AI summary re-check workloads, halting the dozen-site rollout and forcing renegotiation of staffing terms.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, safety_breakthrough, automated_decision_scandal
- Turn 2 (7 turn(s) ago): capability_jump, cyber_defence_breakthrough, automated_decision_scandal
- Turn 3 (6 turn(s) ago): cyber_defence_breakthrough, eu_frontier_access_denied
- Turn 4 (5 turn(s) ago): cyber_major_incident, opaque_reasoning, automated_decision_scandal
- Turn 5 (4 turn(s) ago): eval_anomaly_reports, ai_investment_collapse, taiwan_tension_rise, eu_frontier_access_denied, adoption_success, election_alliance
- Turn 7 (2 turn(s) ago): cyber_major_incident, medical_breakthrough, safety_breakthrough
- Turn 8 (1 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, rsi_onset, eu_frontier_access_denied, member_state_defection, adoption_success
