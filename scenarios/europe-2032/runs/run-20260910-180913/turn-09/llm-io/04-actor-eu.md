...
- characters 1759-3639: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6983-7433: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10096-11519: `{{previous_actions}}` from the actor's own response from the previous turn
