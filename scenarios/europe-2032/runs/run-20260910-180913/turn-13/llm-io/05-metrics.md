...
- characters 13139-13327: `{{metrics_json}}` from the run's live metric values
- characters 13420-14890: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14934-17384: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17440-18297: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M14 | EU Joint Threat Response Accession and Blockade Rationing | 2 |
...
- `emergent_marine_insurance_freeze` -- first noted turn 13, listed in 1 turn(s) so far: A coordinated insurance withdrawal freezes new trans-Mediterranean cable repair cover after the landing-station strike, leaving damaged capacity unrepaired for months regardless of EU repair readiness.
...
## Metrics
```json
{"ai_capability": 100.0, "openweight_capability": 95.0, "ai_safety": 0.0, "resilience": 44.0, "eu_ai_sovereignty": 3.0, "eu_political_capital": 6.0, "public_sentiment": 12.0}
```
