...
- characters 374-1844: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1888-4338: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4394-4923: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4986-30469: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30824-32120: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, safety_breakthrough, automated_decision_scandal
- Turn 2 (11 turn(s) ago): capability_jump, cyber_defence_breakthrough, automated_decision_scandal
- Turn 3 (10 turn(s) ago): cyber_defence_breakthrough, eu_frontier_access_denied
- Turn 4 (9 turn(s) ago): cyber_major_incident, opaque_reasoning, automated_decision_scandal
- Turn 5 (8 turn(s) ago): eval_anomaly_reports, ai_investment_collapse, taiwan_tension_rise, eu_frontier_access_denied, adoption_success, election_alliance
- Turn 7 (6 turn(s) ago): cyber_major_incident, medical_breakthrough, safety_breakthrough
- Turn 8 (5 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, rsi_onset, eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 9 (4 turn(s) ago): loss_of_control_incident, capability_jump, bio_uplift_findings, catastrophic_great_power_conflict, eu_frontier_access_denied, member_state_defection, middle_power_coalition
- Turn 10 (3 turn(s) ago): capability_jump, medical_breakthrough, taiwan_tension_rise
- Turn 11 (2 turn(s) ago): capability_jump, safety_breakthrough, labour_displacement
- Turn 12 (1 turn(s) ago): capability_jump, bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, supply_chain_coercion, emergent_neutral_site_struck
