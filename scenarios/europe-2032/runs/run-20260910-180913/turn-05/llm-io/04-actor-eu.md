...
- characters 455-1541: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1585-3895: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6606-7057: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9351-11579: `{{previous_actions}}` from the actor's own response from the previous turn
