...
- characters 106-13369: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13412-13604: `{{metrics_json}}` from the run's live metric values
- characters 13697-14651: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14695-16264: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16320-17078: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | EU Essential Services Rapid Recovery Cell | 2 |
...
- `emergent_care_rollout_strike` -- first noted turn 7, listed in 1 turn(s) so far: Nurses unions leading the EU reference triage deployment call a cross-border strike over AI summary re-check workloads, halting the dozen-site rollout and forcing renegotiation of staffing terms.
...
## Notepad
PORTFOLIO CHARGE t7: InvestAI Gigafactories −3, EU Essential Services Rapid Recovery Cell −2 = −5 + priority −0 (capital below 20, no effect, no cost) = −5
PROPOSAL BONUS: EU Essential Services Rapid Recovery Cell (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 14, sentiment 22 -> +2
