...
- characters 375-1676: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1719-4260: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4316-5414: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5477-30489: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30844-31361: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Cut-off Substitution and Trusted Adoption −2, priority −1 = −9
PROPOSAL BONUS: EU Cut-off Substitution and Trusted Adoption (cat 9, small) +3 — eu_frontier_access_denied landed this turn hitting hospitals/ministries and this answers it directly
LEGITIMACY LENDS: capital 7, sentiment 13 -> +2
SOVEREIGNTY: 16 last turn, no capacity event, Gigafactories in flight +0, eu_frontier_access_denied t5 −2, capability rose 3.0 −1 = 13

## Emerging developments (tracked)

- `emergent_siting_blockade_escalation` -- first noted turn 4, listed in 2 turn(s) so far: A coordinated siting blockade across Spain and Germany halts gigafactory pre-site works for weeks after local councils vote moratoriums, citing foreign-dependence and energy costs.
- `emergent_siting_sabotage_wave` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated physical sabotage and blockades hit gigafactory pre-sites and grid substations in Spain and Germany, fusing siting opposition with anti-AI hostility and halting construction for weeks.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, safety_breakthrough, automated_decision_scandal
- Turn 2 (4 turn(s) ago): capability_jump, cyber_defence_breakthrough, automated_decision_scandal
- Turn 3 (3 turn(s) ago): cyber_defence_breakthrough, eu_frontier_access_denied
- Turn 4 (2 turn(s) ago): cyber_major_incident, opaque_reasoning, automated_decision_scandal
- Turn 5 (1 turn(s) ago): eval_anomaly_reports, ai_investment_collapse, taiwan_tension_rise, eu_frontier_access_denied, adoption_success, election_alliance
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.3}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.05}, {"description": "", "emergent": false, "id": "rsi_onset", "probability": 0.35}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_labs_nationalised", "probability": 0.04}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "A coordinated siting blockade across Spain and Germany halts gigafactory pre-site works for weeks after local councils vote moratoriums, citing foreign-dependence and energy costs.", "emergent": true, "id": "emergent_siting_blockade_escalation", "probability": 0.22}, {"description": "Coordinated physical sabotage and blockades hit gigafactory pre-sites and grid substations in Spain and Germany, fusing siting opposition with anti-AI hostility and halting construction for weeks.", "emergent": true, "id": "emergent_siting_sabotage_wave", "probability": 0.14}]
```
