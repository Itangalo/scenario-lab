...
- characters 453-1754: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1797-4338: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4406-4856: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7347-9691: `{{previous_actions}}` from the actor's own response from the previous turn
