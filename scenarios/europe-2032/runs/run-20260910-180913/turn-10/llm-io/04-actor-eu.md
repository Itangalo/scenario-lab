...
- characters 454-1902: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1945-4520: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5503-5953: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9019-11427: `{{previous_actions}}` from the actor's own response from the previous turn
