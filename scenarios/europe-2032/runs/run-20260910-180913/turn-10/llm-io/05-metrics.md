...
- characters 13070-13261: `{{metrics_json}}` from the run's live metric values
- characters 13354-14802: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14845-17420: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17476-18525: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Wartime Essential Continuity and Neutral Infrastructure Shield | 2 |
