...
- characters 376-1824: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1867-4442: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4498-5205: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5268-30751: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31106-32065: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, safety_breakthrough, automated_decision_scandal
- Turn 2 (8 turn(s) ago): capability_jump, cyber_defence_breakthrough, automated_decision_scandal
- Turn 3 (7 turn(s) ago): cyber_defence_breakthrough, eu_frontier_access_denied
- Turn 4 (6 turn(s) ago): cyber_major_incident, opaque_reasoning, automated_decision_scandal
- Turn 5 (5 turn(s) ago): eval_anomaly_reports, ai_investment_collapse, taiwan_tension_rise, eu_frontier_access_denied, adoption_success, election_alliance
- Turn 7 (3 turn(s) ago): cyber_major_incident, medical_breakthrough, safety_breakthrough
- Turn 8 (2 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, rsi_onset, eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 9 (1 turn(s) ago): loss_of_control_incident, capability_jump, bio_uplift_findings, catastrophic_great_power_conflict, eu_frontier_access_denied, member_state_defection, middle_power_coalition
