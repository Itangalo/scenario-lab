...
- characters 107-13468: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13511-13702: `{{metrics_json}}` from the run's live metric values
- characters 13795-15694: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15738-17794: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17850-18713: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Breakthrough Care Localisation | 2 |
