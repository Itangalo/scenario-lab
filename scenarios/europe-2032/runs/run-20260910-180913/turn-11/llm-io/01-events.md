...
- characters 377-2276: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2320-4376: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4432-5295: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5358-30841: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31196-32242: `{{event_history}}` from the run's own event record
...
- `emergent_neutral_site_struck` -- first noted turn 10, listed in 1 turn(s) so far: A US or Chinese strike disables a declared non-belligerent EU civilian node  a cable landing, ground station or islanded data centre  despite Brussels notification, forcing prolonged islanding and emergency rationing.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, safety_breakthrough, automated_decision_scandal
- Turn 2 (9 turn(s) ago): capability_jump, cyber_defence_breakthrough, automated_decision_scandal
- Turn 3 (8 turn(s) ago): cyber_defence_breakthrough, eu_frontier_access_denied
- Turn 4 (7 turn(s) ago): cyber_major_incident, opaque_reasoning, automated_decision_scandal
- Turn 5 (6 turn(s) ago): eval_anomaly_reports, ai_investment_collapse, taiwan_tension_rise, eu_frontier_access_denied, adoption_success, election_alliance
- Turn 7 (4 turn(s) ago): cyber_major_incident, medical_breakthrough, safety_breakthrough
- Turn 8 (3 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, rsi_onset, eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 9 (2 turn(s) ago): loss_of_control_incident, capability_jump, bio_uplift_findings, catastrophic_great_power_conflict, eu_frontier_access_denied, member_state_defection, middle_power_coalition
- Turn 10 (1 turn(s) ago): capability_jump, medical_breakthrough, taiwan_tension_rise
