...
- characters 105-12986: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13029-13221: `{{metrics_json}}` from the run's live metric values
- characters 13314-14985: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15028-17120: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17176-17944: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 83.0, "openweight_capability": 73.0, "ai_safety": 14.0, "resilience": 43.0, "eu_ai_sovereignty": 11.0, "eu_political_capital": 10.0, "public_sentiment": 19.0}
```
## Narrative
### The cut-off
