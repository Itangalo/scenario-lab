...
- characters 455-1642: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1686-3678: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4058-4550: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7399-10353: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Bio Detection and Act Repair Net | 6 | small | 10 | 12 | own jurisdiction | resilience up moderately, ai_safety up slightly, public_sentiment up slightly | 2 | running |
