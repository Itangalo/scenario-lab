...
- characters 107-13321: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13364-13555: `{{metrics_json}}` from the run's live metric values
- characters 13648-14835: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14879-16871: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16927-17409: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Bio Detection and Act Repair Net | 2 |
