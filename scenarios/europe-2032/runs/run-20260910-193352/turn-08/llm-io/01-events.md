...
- characters 2467-5171: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5227-6050: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6113-31814: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32169-32795: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, cyber_major_incident, loss_of_control_incident
- Turn 3 (5 turn(s) ago): openweight_frontier_release, us_china_agreement, automated_decision_scandal, emergent_datacentre_siting_blockade, emergent_clinical_contingency_shift
- Turn 4 (4 turn(s) ago): safety_breakthrough, export_control_escalation
- Turn 5 (3 turn(s) ago): openweight_frontier_release, election_consolidation
- Turn 6 (2 turn(s) ago): openweight_frontier_release, knowledge_work_augmented, joint_threat_response
- Turn 7 (1 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, automated_decision_scandal
