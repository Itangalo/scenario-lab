...
- characters 105-13304: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13347-13538: `{{metrics_json}}` from the run's live metric values
- characters 13631-15680: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15723-18427: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18483-19306: `{{notepad}}` from the Game Master's notepad, carried across turns
