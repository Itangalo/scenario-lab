...
- characters 13345-13536: `{{metrics_json}}` from the run's live metric values
- characters 13629-14885: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14929-17109: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17165-17518: `{{notepad}}` from the Game Master's notepad, carried across turns
