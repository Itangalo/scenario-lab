...
- characters 1754-3934: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6431-6915: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9258-10638: `{{previous_actions}}` from the actor's own response from the previous turn
