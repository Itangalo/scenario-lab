...
- characters 376-1632: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1676-3856: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3912-4591: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4654-30355: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30710-31476: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Defensive Breakthrough Deployment −2, priority −0 (ineffective, capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 4, sentiment 16 -> +2
SOVEREIGNTY: 23 last turn, no category 4 finish, no in-flight category 4 bonus, embodied_ai_deployment t8 −2, capability rose 1.0 −0 = 21

## Emerging developments (tracked)

- `emergent_shadow_ai_utilities` -- first noted turn 7, listed in 2 turn(s) so far: Municipal utilities in two member states quietly switch critical control workstations to offline open-weight assistants to cope with staff shortages, creating unmonitored AI use inside essential services.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, cyber_major_incident, loss_of_control_incident
- Turn 3 (6 turn(s) ago): openweight_frontier_release, us_china_agreement, automated_decision_scandal, emergent_datacentre_siting_blockade, emergent_clinical_contingency_shift
- Turn 4 (5 turn(s) ago): safety_breakthrough, export_control_escalation
- Turn 5 (4 turn(s) ago): openweight_frontier_release, election_consolidation
- Turn 6 (3 turn(s) ago): openweight_frontier_release, knowledge_work_augmented, joint_threat_response
- Turn 7 (2 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, automated_decision_scandal
- Turn 8 (1 turn(s) ago): cyber_major_incident, medical_breakthrough, knowledge_work_augmented, embodied_ai_deployment, taiwan_tension_rise
