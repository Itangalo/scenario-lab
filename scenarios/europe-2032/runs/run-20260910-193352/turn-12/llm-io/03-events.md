...
- characters 376-1285: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1328-3163: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3219-3571: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3634-30188: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30543-31607: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Bio Detection and Act Repair Net −2, priority −0 (ineffective, capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 14 -> +2
SOVEREIGNTY: 21 last turn, no capacity event finish, no category 4 in flight, member_state_defection t11 −2, capability rose 1.0 −0 = 19
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, cyber_major_incident, loss_of_control_incident
- Turn 3 (9 turn(s) ago): openweight_frontier_release, us_china_agreement, automated_decision_scandal, emergent_datacentre_siting_blockade, emergent_clinical_contingency_shift
- Turn 4 (8 turn(s) ago): safety_breakthrough, export_control_escalation
- Turn 5 (7 turn(s) ago): openweight_frontier_release, election_consolidation
- Turn 6 (6 turn(s) ago): openweight_frontier_release, knowledge_work_augmented, joint_threat_response
- Turn 7 (5 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, automated_decision_scandal
- Turn 8 (4 turn(s) ago): cyber_major_incident, medical_breakthrough, knowledge_work_augmented, embodied_ai_deployment, taiwan_tension_rise
- Turn 9 (3 turn(s) ago): capability_jump, cyber_defence_breakthrough, openweight_frontier_release, safety_breakthrough, knowledge_work_augmented
- Turn 10 (2 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, automated_decision_scandal
- Turn 11 (1 turn(s) ago): member_state_defection
