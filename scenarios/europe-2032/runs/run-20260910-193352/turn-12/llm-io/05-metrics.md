...
- characters 106-13327: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13370-13561: `{{metrics_json}}` from the run's live metric values
- characters 13654-14563: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14606-16441: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16497-16849: `{{notepad}}` from the Game Master's notepad, carried across turns
