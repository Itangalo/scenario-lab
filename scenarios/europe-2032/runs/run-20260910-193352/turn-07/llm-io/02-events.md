...
- characters 1948-4131: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4187-4537: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4600-30301: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30656-31175: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, cyber_major_incident, loss_of_control_incident
- Turn 3 (4 turn(s) ago): openweight_frontier_release, us_china_agreement, automated_decision_scandal, emergent_datacentre_siting_blockade, emergent_clinical_contingency_shift
- Turn 4 (3 turn(s) ago): safety_breakthrough, export_control_escalation
- Turn 5 (2 turn(s) ago): openweight_frontier_release, election_consolidation
- Turn 6 (1 turn(s) ago): openweight_frontier_release, knowledge_work_augmented, joint_threat_response
