...
- characters 13378-13569: `{{metrics_json}}` from the run's live metric values
- characters 13662-15190: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15234-17417: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17473-18149: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M6 | EU Open-Diffusion Containment Net | 2 |
| M7 | EU Defensive Breakthrough Deployment | 2 |
...
- `emergent_shadow_ai_utilities` -- first noted turn 7, listed in 1 turn(s) so far: Municipal utilities in two member states quietly switch critical control workstations to offline open-weight assistants to cope with staff shortages, creating unmonitored AI use inside essential services.
