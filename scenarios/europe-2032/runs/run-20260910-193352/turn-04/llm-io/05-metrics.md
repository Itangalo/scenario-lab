...
- characters 13753-15119: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15162-17576: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17632-18695: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Trusted Sovereign Clinical Deployment | 2 |
| M5 | EU Assurance Uptake Facility | 2 |
...
## Metrics
```json
{"ai_capability": 59.3, "openweight_capability": 54.0, "ai_safety": 34.0, "resilience": 38.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 14.0, "public_sentiment": 26.0}
```
