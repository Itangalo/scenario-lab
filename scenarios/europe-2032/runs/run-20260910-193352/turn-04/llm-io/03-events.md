...
- characters 1785-4199: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4255-4664: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4727-27448: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27803-28068: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, cyber_major_incident, loss_of_control_incident
- Turn 3 (1 turn(s) ago): openweight_frontier_release, us_china_agreement, automated_decision_scandal, emergent_datacentre_siting_blockade, emergent_clinical_contingency_shift
