...
- characters 377-1284: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1328-3217: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3273-3710: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3773-30327: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30682-31824: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Embodied Work Transition Shield −2, priority −0 (ineffective, capital below 20) = −2
PROPOSAL BONUS: none — M10 already in flight, no new measure started this turn
LEGITIMACY LENDS: capital 2, sentiment 14 -> +2
SOVEREIGNTY: 19 last turn, no category 4 finish, no category 4 in flight +0, export_control_escalation t12 −2 (largest capacity event, allies rationed under CONSOLIDATION), capability rose 1.0 −0 = 17
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, cyber_major_incident, loss_of_control_incident
- Turn 3 (10 turn(s) ago): openweight_frontier_release, us_china_agreement, automated_decision_scandal, emergent_datacentre_siting_blockade, emergent_clinical_contingency_shift
- Turn 4 (9 turn(s) ago): safety_breakthrough, export_control_escalation
- Turn 5 (8 turn(s) ago): openweight_frontier_release, election_consolidation
- Turn 6 (7 turn(s) ago): openweight_frontier_release, knowledge_work_augmented, joint_threat_response
- Turn 7 (6 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, automated_decision_scandal
- Turn 8 (5 turn(s) ago): cyber_major_incident, medical_breakthrough, knowledge_work_augmented, embodied_ai_deployment, taiwan_tension_rise
- Turn 9 (4 turn(s) ago): capability_jump, cyber_defence_breakthrough, openweight_frontier_release, safety_breakthrough, knowledge_work_augmented
- Turn 10 (3 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, automated_decision_scandal
- Turn 11 (2 turn(s) ago): member_state_defection
- Turn 12 (1 turn(s) ago): embodied_ai_deployment, export_control_escalation
