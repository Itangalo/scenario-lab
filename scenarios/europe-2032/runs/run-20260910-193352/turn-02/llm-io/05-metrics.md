...
- characters 105-13050: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13093-13285: `{{metrics_json}}` from the run's live metric values
- characters 13378-14279: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14322-16536: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16592-17721: `{{notepad}}` from the Game Master's notepad, carried across turns
