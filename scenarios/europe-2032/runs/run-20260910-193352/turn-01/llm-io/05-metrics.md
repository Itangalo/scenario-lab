...
- characters 16352-16987: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M3 | EU Critical Infrastructure Cyber Shield | 2 |
...
- `emergent_datacentre_siting_blockade` -- first noted turn 1, listed in 1 turn(s) so far: Coordinated physical protests block construction at two planned EU hyperscale data-centre sites after local power-price and water-use disputes, delaying permits by months without national policy change.
- `emergent_clinical_contingency_shift` -- first noted turn 1, listed in 1 turn(s) so far: Major European research hospitals pause use of US frontier models for clinical decision support after the June switch-off scare, publishing contingency plans and accelerating evaluation of open-weight alternatives.
...
## Metrics
```json
{"ai_capability": 54.0, "openweight_capability": 45.0, "ai_safety": 32.0, "resilience": 38.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 35.0, "public_sentiment": 34.0}
```
## Narrative
...
## Notepad
PORTFOLIO CHARGE t1: Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Cyber Shield −2, priority −1 = −9
PROPOSAL BONUS: EU Critical Infrastructure Cyber Shield (cat 6, small) +2 — cyber_test_shot precursor and cyber_major_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 35, sentiment 34 -> none, capital is higher
