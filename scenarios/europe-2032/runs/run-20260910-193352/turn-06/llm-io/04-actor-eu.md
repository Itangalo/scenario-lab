...
- characters 453-1778: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1821-4095: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6018-6502: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8829-11626: `{{previous_actions}}` from the actor's own response from the previous turn
