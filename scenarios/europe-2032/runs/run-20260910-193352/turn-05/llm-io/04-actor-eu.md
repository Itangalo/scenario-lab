...
- characters 455-2373: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2417-4630: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5897-6373: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8538-10989: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU Assurance Uptake Facility | 5 | small | 4 | 6 | own jurisdiction | ai_safety up moderately, resilience up slightly, public_sentiment up slightly | 2 | running |
