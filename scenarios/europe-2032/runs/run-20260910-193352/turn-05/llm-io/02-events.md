...
- characters 377-2295: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2339-4552: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4608-5785: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5848-29246: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29601-29939: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Trusted Sovereign Clinical Deployment −2, EU Assurance Uptake Facility −2 = −10, priority has no effect and no cost below 20
PROPOSAL BONUS: none — proposed Assurance Uptake Facility duplicates M5 already in flight, no new measure to bonus
LEGITIMACY LENDS: capital 12, sentiment 26 -> +2
SOVEREIGNTY: 20 last turn, no capacity finish, Gigafactories + Tech sovereignty in flight +0, export_control_escalation t4 −2, capability rose 1.8 −0 = 18

## Emerging developments (tracked)

- `emergent_shadow_clinical_harm_cluster` -- first noted turn 4, listed in 1 turn(s) so far: Ward-level use of unvetted open-weight models for triage and prescribing causes a documented patient-harm cluster in one member state, triggering a cross-border clinical safety alert and calls for an EU-wide ban on unauthorised clinical inference.
- `emergent_openweight_clinical_harm` -- first noted turn 4, listed in 1 turn(s) so far: A ward-level open-weight clinical error causes serious patient harm in a member state hospital and is publicly attributed to unvetted model advice, triggering malpractice investigations.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, cyber_major_incident, loss_of_control_incident
- Turn 3 (2 turn(s) ago): openweight_frontier_release, us_china_agreement, automated_decision_scandal, emergent_datacentre_siting_blockade, emergent_clinical_contingency_shift
- Turn 4 (1 turn(s) ago): safety_breakthrough, export_control_escalation
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.08}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.42}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.22}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.36}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.16}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.05}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.075}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Ward-level use of unvetted open-weight models for triage and prescribing causes a documented patient-harm cluster in one member state, triggering a cross-border clinical safety alert and calls for an EU-wide ban on unauthorised clinical inference.", "emergent": true, "id": "emergent_shadow_clinical_harm_cluster", "probability": 0.19}, {"description": "A ward-level open-weight clinical error causes serious patient harm in a member state hospital and is publicly attributed to unvetted model advice, triggering malpractice investigations.", "emergent": true, "id": "emergent_openweight_clinical_harm", "probability": 0.16}]
```
