...
- characters 13786-15704: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15748-17961: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18017-19194: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.1, "openweight_capability": 55.0, "ai_safety": 32.0, "resilience": 35.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 7.0, "public_sentiment": 24.0}
```
