...
- characters 13009-13200: `{{metrics_json}}` from the run's live metric values
- characters 13293-14525: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14568-16589: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16645-17025: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Assured Systems Retrofit | 2 |
...
## Metrics
```json
{"ai_capability": 66.5, "openweight_capability": 62.8, "ai_safety": 26.0, "resilience": 43.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 2.0, "public_sentiment": 19.0}
```
