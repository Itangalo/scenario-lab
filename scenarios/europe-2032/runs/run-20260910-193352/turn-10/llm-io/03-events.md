...
- characters 1651-3672: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3728-4108: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4171-30725: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31080-31992: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, cyber_major_incident, loss_of_control_incident
- Turn 3 (7 turn(s) ago): openweight_frontier_release, us_china_agreement, automated_decision_scandal, emergent_datacentre_siting_blockade, emergent_clinical_contingency_shift
- Turn 4 (6 turn(s) ago): safety_breakthrough, export_control_escalation
- Turn 5 (5 turn(s) ago): openweight_frontier_release, election_consolidation
- Turn 6 (4 turn(s) ago): openweight_frontier_release, knowledge_work_augmented, joint_threat_response
- Turn 7 (3 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, automated_decision_scandal
- Turn 8 (2 turn(s) ago): cyber_major_incident, medical_breakthrough, knowledge_work_augmented, embodied_ai_deployment, taiwan_tension_rise
- Turn 9 (1 turn(s) ago): capability_jump, cyber_defence_breakthrough, openweight_frontier_release, safety_breakthrough, knowledge_work_augmented
