...
- characters 1729-3750: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6666-7138: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9806-12057: `{{previous_actions}}` from the actor's own response from the previous turn
