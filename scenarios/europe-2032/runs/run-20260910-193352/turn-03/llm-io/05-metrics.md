...
- characters 106-13051: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13094-13286: `{{metrics_json}}` from the run's live metric values
- characters 13379-14567: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14611-16514: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16570-17069: `{{notepad}}` from the Game Master's notepad, carried across turns
