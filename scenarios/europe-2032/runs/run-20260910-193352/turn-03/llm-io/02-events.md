...
- characters 1609-3512: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3568-4704: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4767-28994: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29349-29438: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Cyber Shield −2, EU Trusted Sovereign Clinical Deployment −2, priority −1 = −11
PROPOSAL BONUS: none — no external event in last three turns that clinical deployment directly answers; hospital pause is tracked trend not event
LEGITIMACY LENDS: capital 24, sentiment 33 -> +2
SOVEREIGNTY: 21 last turn, no capacity event, Gigafactories + Tech sovereignty in flight +0, capability rose 2.0 −1 = 20

## Emerging developments (tracked)

- `emergent_datacentre_siting_blockade` -- first noted turn 1, listed in 2 turn(s) so far: Coordinated physical protests block construction at two planned EU hyperscale data-centre sites after local power-price and water-use disputes, delaying permits by months without national policy change.
- `emergent_clinical_contingency_shift` -- first noted turn 1, listed in 2 turn(s) so far: Major European research hospitals pause use of US frontier models for clinical decision support after the June switch-off scare, publishing contingency plans and accelerating evaluation of open-weight alternatives.
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, cyber_major_incident, loss_of_control_incident
