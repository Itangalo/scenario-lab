...
| M11 | EU Containment Solidarity and Services Continuity Hold | 6 | small | 12 | 14 | own jurisdiction | resilience up modestly, eu_political_capital protected | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Containment Solidarity and Services Continuity Hold", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up modestly, eu_political_capital protected"}, "grounds": "bio leak plus defection while no measures in flight"}
  - Grounds: bio leak plus defection while no measures in flight
