...
- `two_year_commitment` (commitment): Secure autonomous European capacity and resilience that holds together under coercion and AI shocks

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure autonomous European capacity and resilience that holds together under coercion and AI shocks
