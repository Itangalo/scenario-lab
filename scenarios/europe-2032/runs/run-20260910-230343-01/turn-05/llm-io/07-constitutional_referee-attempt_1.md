...
- characters 2803-3306: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Anchor in the Frontier Risk Accord −2, priority −1 = −9
PROPOSAL BONUS: EU Anchor in the Frontier Risk Accord (cat 8, small) +2 — us_china_agreement landed this turn and this answers exclusion directly, plus member_state_defection widens need
LEGITIMACY LENDS: capital 10, sentiment 29 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, Gigafactories in flight +0, member_state_defection t5 −2, capability rose 1.0 −0 = 18
