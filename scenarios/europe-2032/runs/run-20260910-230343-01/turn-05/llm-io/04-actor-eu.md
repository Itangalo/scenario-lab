...
- characters 455-1900: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1944-4398: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6454-6926: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9034-11054: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M4 | EU Frontier Evaluation Cell | 5 | small | 2 | 5 | own jurisdiction | ai_safety up moderately, eu_ai_sovereignty up slightly via talent | 2 | finished |
| M5 | EU Agent Containment Protocol | 6 | small | 4 | 5 | own jurisdiction | resilience up moderately, ai_safety up slightly via containment | 2 | finished |
