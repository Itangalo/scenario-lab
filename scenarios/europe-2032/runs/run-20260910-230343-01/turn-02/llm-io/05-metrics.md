...
- characters 105-13024: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13067-13259: `{{metrics_json}}` from the run's live metric values
- characters 13352-14489: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14532-16561: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16617-17673: `{{notepad}}` from the Game Master's notepad, carried across turns
