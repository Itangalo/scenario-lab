...
- characters 105-13412: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13455-13647: `{{metrics_json}}` from the run's live metric values
- characters 13740-15421: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15464-17250: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17306-17672: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, EU Frontier Evaluation Cell −2, priority −1 = −12
...
## Metrics
```json
{"ai_capability": 57.5, "openweight_capability": 54.2, "ai_safety": 32.0, "resilience": 40.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 19.0, "public_sentiment": 32.0}
```
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Evaluation Cell −2, EU Agent Containment Protocol −2, priority −1 = −11
PROPOSAL BONUS: EU Agent Containment Protocol (cat 6, small) +3 — loss_of_control_incident fired this turn with days-long containment uncertainty and this answers it directly
LEGITIMACY LENDS: capital 19, sentiment 39 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.3 −0 = 20
