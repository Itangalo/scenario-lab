...
- characters 376-2057: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2100-3886: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3942-4647: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4710-27331: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27686-27870: `{{event_history}}` from the run's own event record
...
- `emergent_chinese_open_charm_offensive` -- first noted turn 2, listed in 2 turn(s) so far: A Chinese laboratory releases a near-frontier open-weight model with permissive licensing and EU-hosted mirrors, explicitly courting European developers and research sites frustrated by US access uncertainty.
...
- Turn 2 (2 turn(s) ago): ai_investment_collapse, eval_anomaly_reports
- Turn 3 (1 turn(s) ago): safety_breakthrough, emergent_siting_backlash
