...
- characters 13353-14646: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14690-16609: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16665-17511: `{{notepad}}` from the Game Master's notepad, carried across turns
