...
| M9 | EU Cascading-Failure Containment Regime | 6 | small | 7 | 8 | own jurisdiction | resilience up substantially, ai_safety up slightly via containment | 2 | finished |
| M10 | EU Chokepoint Leverage Compact | 8 | small | 8 | 11 | coalition partners holding supply-chain chokepoints plus US plus own jurisdiction | eu_ai_sovereignty up, eu_political_capital protected, resilience up slightly via secured supply | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Chokepoint Leverage Compact", "category": 8, "size": "small", "finish_turn": 11, "applies_to": "coalition partners holding supply-chain chokepoints plus US plus own jurisdiction", "targeted_effect": "eu_ai_sovereignty up, eu_political_capital protected, resilience up slightly via secured supply"}, "grounds": "to convert blockade leverage in
  - Grounds: to convert blockade leverage into compute access and cohesion
