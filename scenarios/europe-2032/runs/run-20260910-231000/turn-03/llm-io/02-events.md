...
- characters 1532-3671: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3727-4845: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4908-28190: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28545-28638: `{{event_history}}` from the run's own event record
...
- Turn 2 (1 turn(s) ago): export_control_escalation
