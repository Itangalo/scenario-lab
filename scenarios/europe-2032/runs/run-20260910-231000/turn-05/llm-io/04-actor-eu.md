...
- characters 2245-4372: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5833-6273: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8320-10328: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU Rapid Containment Surge | 6 | small | 4 | 6 | own jurisdiction | resilience up, ai_safety up modestly | 2 | running |
