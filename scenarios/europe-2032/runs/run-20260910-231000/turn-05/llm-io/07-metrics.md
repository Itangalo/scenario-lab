...
- characters 13678-15424: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15468-17595: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17651-18738: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|---|---|---|---|---|---|---|
| M4 | Grid Shield Hardening and Exercises | 6 | large | 2 | 5 | own jurisdiction | resilience up strongly, ai_safety up modestly | 3 | finished |
...
- `emergent_grid_blockade_spillover` -- first noted turn 5, listed in 1 turn(s) so far: Coordinated physical blockades of grid upgrade works spread from factory sites to two cross-border interconnectors, delaying substation delivery through winter.
- `emergent_grid_connection_freeze` -- first noted turn 5, listed in 1 turn(s) so far: Coordinated municipal moratoriums on new data-centre grid connections spread to two more member states after outage anger and price protests, freezing factory site power pledges through the turn.
...
## Metrics
```json
{"ai_capability": 59.5, "openweight_capability": 55.8, "ai_safety": 25.0, "resilience": 39.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 17.0, "public_sentiment": 29.0}
```
## Narrative
### Holding the line
...
## Notepad
PORTFOLIO CHARGE t5: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M5 EU Rapid Containment Surge −2, priority −1 = −9
