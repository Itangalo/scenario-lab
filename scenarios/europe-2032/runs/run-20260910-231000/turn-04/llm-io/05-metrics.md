...
- characters 13727-15229: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15272-18108: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18164-18560: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Rapid Containment Surge | 2 |
...
## Notepad
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 Grid Shield Hardening and Exercises −3, M5 EU Rapid Containment Surge −2, priority −1 = −12
PROPOSAL BONUS: EU Rapid Containment Surge (cat 6, small) +3 — cyber_major_incident landed this turn and bio precursor opened, this answers both directly
LEGITIMACY LENDS: capital 16, sentiment 32 -> +2
SOVEREIGNTY: 18 last turn, no category 4 finish, Gigafactories in flight +0, export_control_escalation t4 −2, capability rose 1.5 −0 = 16
