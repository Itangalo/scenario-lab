...
- characters 4750-5190: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6644-8735: `{{previous_actions}}` from the actor's own response from the previous turn
