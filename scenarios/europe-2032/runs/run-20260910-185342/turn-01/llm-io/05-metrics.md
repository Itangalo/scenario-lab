...
- characters 16367-16734: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_bio_publishing_split` -- first noted turn 1, listed in 1 turn(s) so far: A major European scientific publisher and university consortium announce a joint moratorium on publishing detailed methods for AI-designed pathogen work after the phage results, triggering a split with US and Chinese labs over open science norms.
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 46.0, "ai_safety": 32.0, "resilience": 37.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 42.0, "public_sentiment": 38.0}
```
...
LEGITIMACY LENDS: capital 38, sentiment 42 -> +2 — wait recomputed after bonus: capital 42, sentiment 38, capital higher so none [corrected: LEGITIMACY LENDS: capital 42, sentiment 38 -> none]
SOVEREIGNTY: 22 last turn, no capacity event, Gigafactories in flight +0, capability rose 3.0 −1 = 21
Emerging developments (tracked): `emergent_bio_publishing_split` -- faint single-source chatter of a European publisher moratorium on AI-designed pathogen methods amid open-science split.
