...
- characters 453-1898: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1941-4104: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6625-7085: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9226-11050: `{{previous_actions}}` from the actor's own response from the previous turn
