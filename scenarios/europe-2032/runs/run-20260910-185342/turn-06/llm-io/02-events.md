...
- characters 375-1820: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1863-4026: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4082-4413: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4476-31571: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31926-32328: `{{event_history}}` from the run's own event record
...
- Turn 2 (4 turn(s) ago): cyber_defence_breakthrough, emergent_bio_publishing_split
- Turn 3 (3 turn(s) ago): eval_anomaly_reports, automated_decision_scandal
- Turn 4 (2 turn(s) ago): bio_uplift_findings, research_breakthrough
- Turn 5 (1 turn(s) ago): eval_anomaly_reports, capability_jump, taiwan_tension_rise, member_state_defection, election_consolidation
