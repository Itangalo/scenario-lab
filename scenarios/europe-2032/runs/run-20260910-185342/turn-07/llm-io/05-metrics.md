...
- characters 106-13025: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13068-13259: `{{metrics_json}}` from the run's live metric values
- characters 13352-14684: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14728-17256: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17312-18106: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Middle-Power Supply-Chain Pact | 2 |
