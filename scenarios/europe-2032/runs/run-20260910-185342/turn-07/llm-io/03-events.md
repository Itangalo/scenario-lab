...
- characters 376-1708: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1752-4280: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4336-5408: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5471-34690: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35045-35580: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): cyber_defence_breakthrough, emergent_bio_publishing_split
- Turn 3 (4 turn(s) ago): eval_anomaly_reports, automated_decision_scandal
- Turn 4 (3 turn(s) ago): bio_uplift_findings, research_breakthrough
- Turn 5 (2 turn(s) ago): eval_anomaly_reports, capability_jump, taiwan_tension_rise, member_state_defection, election_consolidation
- Turn 6 (1 turn(s) ago): eval_anomaly_reports, rsi_onset, embodied_ai_deployment, eu_frontier_access_denied, member_state_defection
