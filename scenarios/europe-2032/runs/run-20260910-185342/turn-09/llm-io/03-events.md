...
- characters 375-2483: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2527-4671: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4727-5423: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5486-35751: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 36106-36786: `{{event_history}}` from the run's own event record
...
- `emergent_robot_fleet_lockin` -- first noted turn 7, listed in 2 turn(s) so far: Several EU logistics operators standardise on Chinese humanoid chassis with US control software after the 2029 warehouse orders, creating a de facto fleet dependence that neither export-control alignment nor gigafactory funding addresses.
...
- Turn 2 (7 turn(s) ago): cyber_defence_breakthrough, emergent_bio_publishing_split
- Turn 3 (6 turn(s) ago): eval_anomaly_reports, automated_decision_scandal
- Turn 4 (5 turn(s) ago): bio_uplift_findings, research_breakthrough
- Turn 5 (4 turn(s) ago): eval_anomaly_reports, capability_jump, taiwan_tension_rise, member_state_defection, election_consolidation
- Turn 6 (3 turn(s) ago): eval_anomaly_reports, rsi_onset, embodied_ai_deployment, eu_frontier_access_denied, member_state_defection
- Turn 7 (2 turn(s) ago): middle_power_coalition
- Turn 8 (1 turn(s) ago): research_breakthrough, embodied_ai_deployment, middle_power_coalition
