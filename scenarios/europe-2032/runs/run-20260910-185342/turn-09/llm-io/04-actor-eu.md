...
- characters 453-2561: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2605-4749: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6205-6665: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9003-10409: `{{previous_actions}}` from the actor's own response from the previous turn
