...
- characters 13448-13638: `{{metrics_json}}` from the run's live metric values
- characters 13731-15839: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15883-18027: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18083-18420: `{{notepad}}` from the Game Master's notepad, carried across turns
