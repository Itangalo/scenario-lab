...
- characters 374-2105: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2148-4040: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4096-4923: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4986-34205: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34560-35144: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: M1 InvestAI Gigafactories −3, M6 EU Cutoff Continuity Switch −2, M7 EU Middle-Power Supply-Chain Pact −2, priority M1 −1 = −8
PROPOSAL BONUS: EU Middle-Power Supply-Chain Pact (cat 8, small) +2 — tiered throttling and access denial from t6 still biting and this answers it directly
LEGITIMACY LENDS: capital 3, sentiment 30 -> +2
SOVEREIGNTY: 19 last turn, no cat4 finish, M1 in flight +1, middle_power_coalition t7 +2, capability rose 3.0 −1 = 21

## Emerging developments (tracked)

- `emergent_robot_fleet_lockin` -- first noted turn 7, listed in 1 turn(s) so far: Several EU logistics operators standardise on Chinese humanoid chassis with US control software after the 2029 warehouse orders, creating a de facto fleet dependence that neither export-control alignment nor gigafactory funding addresses.
...
- Turn 2 (6 turn(s) ago): cyber_defence_breakthrough, emergent_bio_publishing_split
- Turn 3 (5 turn(s) ago): eval_anomaly_reports, automated_decision_scandal
- Turn 4 (4 turn(s) ago): bio_uplift_findings, research_breakthrough
- Turn 5 (3 turn(s) ago): eval_anomaly_reports, capability_jump, taiwan_tension_rise, member_state_defection, election_consolidation
- Turn 6 (2 turn(s) ago): eval_anomaly_reports, rsi_onset, embodied_ai_deployment, eu_frontier_access_denied, member_state_defection
- Turn 7 (1 turn(s) ago): middle_power_coalition
