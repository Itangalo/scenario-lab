...
- characters 13420-13610: `{{metrics_json}}` from the run's live metric values
- characters 13703-15434: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15477-17369: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17425-18252: `{{notepad}}` from the Game Master's notepad, carried across turns
