...
- characters 105-13085: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13128-13320: `{{metrics_json}}` from the run's live metric values
- characters 13413-14913: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14956-17017: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17073-17974: `{{notepad}}` from the Game Master's notepad, carried across turns
