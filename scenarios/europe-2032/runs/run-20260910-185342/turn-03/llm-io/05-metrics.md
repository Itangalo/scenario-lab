...
- characters 13797-15510: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15554-17535: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17591-18432: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Bio Screening and Response Net | 2 |
| M5 | EU Anomaly Investigation and Evaluation Access Regime | 2 |
...
PORTFOLIO CHARGE t2: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Systems Shield −3, M4 EU Bio Screening and Response Net −2 = −11 + priority −1 = −12
PROPOSAL BONUS: EU Bio Screening and Response Net (cat 6, small) +2 — emergent publishing split over AI-designed pathogen methods landed this turn and this answers it directly
LEGITIMACY LENDS: capital 32, sentiment 41 -> +2
SOVEREIGNTY: 21 last turn, no capacity event, Gigafactories in flight +0, capability rose 3.0 −1 = 20

## Emerging developments (tracked)

- `emergent_municipal_grid_backlash` -- first noted turn 3, listed in 1 turn(s) so far: A coordinated municipal utility revolt stalls grid segmentation retrofits, with several cities seeking injunctions over cost-share and permitting delays that leave mapped substations exposed through winter.
...
## Notepad
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Bio Screening and Response Net −2, M5 EU Anomaly Investigation and Evaluation Access Regime −2 = −10 + priority −1 = −11
PROPOSAL BONUS: EU Anomaly Investigation and Evaluation Access Regime (cat 1, small) +2 — automated decision scandal + leaked eval anomaly landed this turn and this answers both directly
LEGITIMACY LENDS: capital 21, sentiment 38 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, Gigafactories + sovereignty package in flight +1, capability rose 3.0 −1 = 20
