...
- characters 1346-3884: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3940-4413: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4476-34043: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34398-35170: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): cyber_defence_breakthrough, emergent_bio_publishing_split
- Turn 3 (7 turn(s) ago): eval_anomaly_reports, automated_decision_scandal
- Turn 4 (6 turn(s) ago): bio_uplift_findings, research_breakthrough
- Turn 5 (5 turn(s) ago): eval_anomaly_reports, capability_jump, taiwan_tension_rise, member_state_defection, election_consolidation
- Turn 6 (4 turn(s) ago): eval_anomaly_reports, rsi_onset, embodied_ai_deployment, eu_frontier_access_denied, member_state_defection
- Turn 7 (3 turn(s) ago): middle_power_coalition
- Turn 8 (2 turn(s) ago): research_breakthrough, embodied_ai_deployment, middle_power_coalition
- Turn 9 (1 turn(s) ago): opaque_reasoning, medical_breakthrough, eu_frontier_access_denied
