...
- characters 1424-3962: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4030-4483: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6821-8339: `{{previous_actions}}` from the actor's own response from the previous turn
