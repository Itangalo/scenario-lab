...
- characters 106-12958: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13001-13191: `{{metrics_json}}` from the run's live metric values
- characters 13284-14212: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14255-16793: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16849-17666: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 86.5, "openweight_capability": 81.2, "ai_safety": 3.0, "resilience": 41.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 5.0, "public_sentiment": 21.0}
```
