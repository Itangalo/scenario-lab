...
- characters 454-1404: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1448-3096: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6265-6757: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9436-11573: `{{previous_actions}}` from the actor's own response from the previous turn
...
**emergent_islanded_fallback_failure (emergent event):** Islanded EU hospitals and administrations running on open models suffer a cascading outage after a faulty auto-update, forcing emergency rationing and triggering street protests blaming both Brussels and Washington.
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | Islanded Public Service Continuity Corps | 6 | small | 10 | 12 | own jurisdiction | resilience up moderately, eu_political_capital up slightly via visible continuity | 2 | running |
