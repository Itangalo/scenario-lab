...
- characters 376-1326: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1370-3018: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3074-3898: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3961-33528: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33883-34656: `{{event_history}}` from the run's own event record
...
- `emergent_islanded_fallback_failure` -- first noted turn 10, listed in 1 turn(s) so far: Islanded EU hospitals and administrations running on open models suffer a cascading outage after a faulty auto-update, forcing emergency rationing and triggering street protests blaming both Brussels and Washington.
...
- Turn 2 (9 turn(s) ago): cyber_defence_breakthrough, emergent_bio_publishing_split
- Turn 3 (8 turn(s) ago): eval_anomaly_reports, automated_decision_scandal
- Turn 4 (7 turn(s) ago): bio_uplift_findings, research_breakthrough
- Turn 5 (6 turn(s) ago): eval_anomaly_reports, capability_jump, taiwan_tension_rise, member_state_defection, election_consolidation
- Turn 6 (5 turn(s) ago): eval_anomaly_reports, rsi_onset, embodied_ai_deployment, eu_frontier_access_denied, member_state_defection
- Turn 7 (4 turn(s) ago): middle_power_coalition
- Turn 8 (3 turn(s) ago): research_breakthrough, embodied_ai_deployment, middle_power_coalition
- Turn 9 (2 turn(s) ago): opaque_reasoning, medical_breakthrough, eu_frontier_access_denied
