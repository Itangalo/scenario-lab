...
- characters 107-13022: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13065-13255: `{{metrics_json}}` from the run's live metric values
- characters 13348-14298: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14342-15990: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16046-16526: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | Islanded Public Service Continuity Corps | 2 |
