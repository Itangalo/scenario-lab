...
- characters 13421-13611: `{{metrics_json}}` from the run's live metric values
- characters 13704-14909: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14952-16854: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16910-18269: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU–US State-Level AI Access and Restraint Channel | 2 |
...
## Metrics
```json
{"ai_capability": 89.2, "openweight_capability": 85.8, "ai_safety": 0.0, "resilience": 44.0, "eu_ai_sovereignty": 12.0, "eu_political_capital": 0.0, "public_sentiment": 10.0}
```
## Narrative
