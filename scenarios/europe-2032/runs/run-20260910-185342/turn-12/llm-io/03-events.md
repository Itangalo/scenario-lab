...
- characters 375-1580: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1623-3525: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3581-4283: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4346-32381: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32736-33646: `{{event_history}}` from the run's own event record
...
- Turn 2 (10 turn(s) ago): cyber_defence_breakthrough, emergent_bio_publishing_split
- Turn 3 (9 turn(s) ago): eval_anomaly_reports, automated_decision_scandal
- Turn 4 (8 turn(s) ago): bio_uplift_findings, research_breakthrough
- Turn 5 (7 turn(s) ago): eval_anomaly_reports, capability_jump, taiwan_tension_rise, member_state_defection, election_consolidation
- Turn 6 (6 turn(s) ago): eval_anomaly_reports, rsi_onset, embodied_ai_deployment, eu_frontier_access_denied, member_state_defection
- Turn 7 (5 turn(s) ago): middle_power_coalition
- Turn 8 (4 turn(s) ago): research_breakthrough, embodied_ai_deployment, middle_power_coalition
- Turn 9 (3 turn(s) ago): opaque_reasoning, medical_breakthrough, eu_frontier_access_denied
- Turn 11 (1 turn(s) ago): us_labs_nationalised, automated_decision_scandal, middle_power_coalition, emergent_islanded_fallback_failure
