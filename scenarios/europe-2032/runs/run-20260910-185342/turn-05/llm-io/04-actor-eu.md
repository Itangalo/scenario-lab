...
- characters 455-1583: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1627-3583: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5841-6310: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8450-9860: `{{previous_actions}}` from the actor's own response from the previous turn
