...
- characters 13873-15001: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15045-17001: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17057-17499: `{{notepad}}` from the Game Master's notepad, carried across turns
