...
- characters 377-1505: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1549-3505: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3561-4335: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4398-31946: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32301-32570: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Bio Screening and Response Net −2, M5 EU Anomaly Investigation and Evaluation Access Regime −2 = −10 + priority M4 −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 23, sentiment 38 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, Gigafactories + sovereignty package in flight +1, capability rose 3.0 −1 = 20

## Emerging developments (tracked)

- `emergent_municipal_grid_backlash` -- first noted turn 3, listed in 2 turn(s) so far: A coordinated municipal utility revolt stalls grid segmentation retrofits, with several cities seeking injunctions over cost-share and permitting delays that leave mapped substations exposed through winter.
...
- Turn 2 (3 turn(s) ago): cyber_defence_breakthrough, emergent_bio_publishing_split
- Turn 3 (2 turn(s) ago): eval_anomaly_reports, automated_decision_scandal
- Turn 4 (1 turn(s) ago): bio_uplift_findings, research_breakthrough
