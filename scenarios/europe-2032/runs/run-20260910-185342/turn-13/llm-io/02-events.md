...
- characters 1615-3736: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3792-4876: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4939-32380: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32735-33769: `{{event_history}}` from the run's own event record
...
- `emergent_infrastructure_sabotage_wave` -- first noted turn 12, listed in 1 turn(s) so far: Coordinated physical sabotage and blockades against power substations and fenced gigafactory sites spread across several member states, forcing extended outages and construction halts beyond the islanded software failures.
- `emergent_gigafactory_site_sabotage` -- first noted turn 12, listed in 1 turn(s) so far: Coordinated physical sabotage and blockades hit fenced gigafactory sites and grid connections across two member states, fusing anti-AI, anti-rationing and anti-Washington protest into sustained site occupations.
...
- Turn 2 (11 turn(s) ago): cyber_defence_breakthrough, emergent_bio_publishing_split
- Turn 3 (10 turn(s) ago): eval_anomaly_reports, automated_decision_scandal
- Turn 4 (9 turn(s) ago): bio_uplift_findings, research_breakthrough
- Turn 5 (8 turn(s) ago): eval_anomaly_reports, capability_jump, taiwan_tension_rise, member_state_defection, election_consolidation
- Turn 6 (7 turn(s) ago): eval_anomaly_reports, rsi_onset, embodied_ai_deployment, eu_frontier_access_denied, member_state_defection
- Turn 7 (6 turn(s) ago): middle_power_coalition
- Turn 8 (5 turn(s) ago): research_breakthrough, embodied_ai_deployment, middle_power_coalition
- Turn 9 (4 turn(s) ago): opaque_reasoning, medical_breakthrough, eu_frontier_access_denied
- Turn 11 (2 turn(s) ago): us_labs_nationalised, automated_decision_scandal, middle_power_coalition, emergent_islanded_fallback_failure
- Turn 12 (1 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, eval_anomaly_reports, research_breakthrough
