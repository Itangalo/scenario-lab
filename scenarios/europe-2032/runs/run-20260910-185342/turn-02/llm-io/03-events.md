...
- characters 376-1455: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1498-3299: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3355-4458: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4521-27598: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27953-27994: `{{event_history}}` from the run's own event record
