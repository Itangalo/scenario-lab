...
- characters 105-13058: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13101-13293: `{{metrics_json}}` from the run's live metric values
- characters 13386-14465: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14508-16309: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16365-17099: `{{notepad}}` from the Game Master's notepad, carried across turns
