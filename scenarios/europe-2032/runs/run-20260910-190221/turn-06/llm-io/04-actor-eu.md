...
- characters 453-1799: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1842-4163: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5010-5444: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7817-10070: `{{previous_actions}}` from the actor's own response from the previous turn
