...
- characters 375-1721: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1764-4085: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4141-4645: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4708-28212: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28567-29009: `{{event_history}}` from the run's own event record
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, capability_jump, knowledge_work_augmented, member_state_defection
- Turn 2 (4 turn(s) ago): taiwan_tension_rise, export_control_escalation, emergent_lab_leak_hearings
- Turn 3 (3 turn(s) ago): safety_breakthrough
- Turn 4 (2 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise, us_china_agreement
- Turn 5 (1 turn(s) ago): export_control_escalation, supply_chain_coercion, election_consolidation
