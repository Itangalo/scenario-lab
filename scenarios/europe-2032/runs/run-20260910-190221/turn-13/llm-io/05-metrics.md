...
- characters 13441-13631: `{{metrics_json}}` from the run's live metric values
- characters 13724-14719: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14763-16957: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17013-17467: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Municipal Offline Restoration Corps | 2 |
...
## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M12", "fields": {"finish_turn": 14}, "grounds": "named priority"}]}
```
```
