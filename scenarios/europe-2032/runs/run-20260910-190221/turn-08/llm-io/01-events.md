...
- characters 376-1270: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1313-3002: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3058-3731: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3794-27901: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28256-28821: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU Chokepoint Defence Pact −2, priority M6 −0 (no effect, capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 9, sentiment 33 -> +2
SOVEREIGNTY: 17 last turn, InvestAI Gigafactories finishes t7 +5, emergent_us_tiered_access_rule t7 −2, capability rose 0.6 −0 = 20

## Emerging developments (tracked)

- `emergent_allied_hoarding_squeeze` -- first noted turn 6, listed in 2 turn(s) so far: Incoming US administration publishes draft tiered-access licensing rule with no named EU volume guarantees, triggering pre-emptive bulk chip and inference-capacity hoarding by European distributors in H1 2029.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, capability_jump, knowledge_work_augmented, member_state_defection
- Turn 2 (6 turn(s) ago): taiwan_tension_rise, export_control_escalation, emergent_lab_leak_hearings
- Turn 3 (5 turn(s) ago): safety_breakthrough
- Turn 4 (4 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise, us_china_agreement
- Turn 5 (3 turn(s) ago): export_control_escalation, supply_chain_coercion, election_consolidation
- Turn 6 (2 turn(s) ago): supply_chain_coercion, adoption_success
- Turn 7 (1 turn(s) ago): emergent_us_tiered_access_rule
