...
- characters 105-13246: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13289-13481: `{{metrics_json}}` from the run's live metric values
- characters 13574-14468: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14511-16200: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16256-16913: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Cutoff Continuity and Graduate Transition Shield | 2 |
