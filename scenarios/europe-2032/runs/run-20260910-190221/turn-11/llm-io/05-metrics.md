...
- characters 107-13338: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13381-13572: `{{metrics_json}}` from the run's live metric values
- characters 13665-14484: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14528-16482: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16538-17018: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Bio-Uplift Detection and Essential Service Shield | 2 |
...
## Notepad
PORTFOLIO CHARGE t11: EU Supply-Chain Bargain for Compute Continuity −2, EU Bio-Uplift Detection and Essential Service Shield −2, priority −1 = −5
PROPOSAL BONUS: EU Bio-Uplift Detection and Essential Service Shield (cat 6, small) +2 — bio_uplift_findings fired this turn and this answers it directly
LEGITIMACY LENDS: capital 19, sentiment 20 -> +1
SOVEREIGNTY: 15 last turn, no capacity event, no cat4 in flight, capability rose 0.8 −0 = 15
