...
- characters 2073-3956: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4410-4857: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7656-10084: `{{previous_actions}}` from the actor's own response from the previous turn
