...
- characters 377-1952: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1995-3878: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3934-5046: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5109-28519: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28874-29584: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Cutoff Continuity and Graduate Transition Shield −2, EU Black-Box Continuity and Open Misuse Shield −2, priority −0 (no effect, capital below 20) = −4
PROPOSAL BONUS: EU Black-Box Continuity and Open Misuse Shield (cat 6, small) +4 — opaque_reasoning and openweight_frontier_release both fired this turn and this answers both directly
LEGITIMACY LENDS: capital 13, sentiment 29 -> +2
SOVEREIGNTY: 17 last turn, no capacity event, no cat4 finish, no cat4 in flight, capability rose 0.7 −0 = 17

## Emerging developments (tracked)

- `emergent_licence_tranche_freeze` -- first noted turn 8, listed in 2 turn(s) so far: US licence administrators impose an abrupt tranche pause for EU buyers in Q1 2030 after a vetting backlog, forcing capped distributors to ration inference and pushing spot prices sharply higher.
- `emergent_datacentre_blockade` -- first noted turn 9, listed in 1 turn(s) so far: Coordinated physical blockades halt construction at two InvestAI hyperscale sites after local councils revoke permits over water and power use, delaying EU-hosted capacity expansion by months.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, capability_jump, knowledge_work_augmented, member_state_defection
- Turn 2 (8 turn(s) ago): taiwan_tension_rise, export_control_escalation, emergent_lab_leak_hearings
- Turn 3 (7 turn(s) ago): safety_breakthrough
- Turn 4 (6 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise, us_china_agreement
- Turn 5 (5 turn(s) ago): export_control_escalation, supply_chain_coercion, election_consolidation
- Turn 6 (4 turn(s) ago): supply_chain_coercion, adoption_success
- Turn 7 (3 turn(s) ago): emergent_us_tiered_access_rule
- Turn 8 (2 turn(s) ago): labour_displacement, eu_frontier_access_denied
- Turn 9 (1 turn(s) ago): opaque_reasoning, openweight_frontier_release
