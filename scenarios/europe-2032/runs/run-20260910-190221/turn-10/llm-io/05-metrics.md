...
- characters 106-13320: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13363-13555: `{{metrics_json}}` from the run's live metric values
- characters 13648-15223: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15266-17149: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17205-18035: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Black-Box Continuity and Open Misuse Shield | 2 |
| M9 | EU Supply-Chain Bargain for Compute Continuity | 2 |
...
- `emergent_datacentre_blockade` -- first noted turn 9, listed in 2 turn(s) so far: Coordinated physical blockades halt construction at two InvestAI hyperscale sites after local councils revoke permits over water and power use, delaying EU-hosted capacity expansion by months.
...
## Notepad
PORTFOLIO CHARGE t10: EU Black-Box Continuity and Open Misuse Shield −2, EU Supply-Chain Bargain for Compute Continuity −2, priority −0 (no effect, capital below 20) = −4
PROPOSAL BONUS: EU Supply-Chain Bargain for Compute Continuity (cat 8, small) +4 — taiwan_blockade fired this turn and this answers it directly
LEGITIMACY LENDS: capital 20, sentiment 27 -> +2
SOVEREIGNTY: 17 last turn, no capacity event, no cat4 in flight, taiwan_blockade t10 −2, capability rose 0.7 −0 = 15
