...
- characters 105-13341: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13384-13576: `{{metrics_json}}` from the run's live metric values
- characters 13669-14883: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14926-17022: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17078-17460: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Foreign Frontier Audit Claim | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Cyber Shield −3, EU Foreign Frontier Audit Claim −2, priority −1 = −12
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Foreign Frontier Audit Claim −2, EU Verification Bridge to the US-China Safety Accord −2, priority −1 = −11
PROPOSAL BONUS: none — new Bridge answers US-China agreement (positive precursor) and eval reports, not a negative event from last three turns
LEGITIMACY LENDS: capital 8, sentiment 40 -> +2
