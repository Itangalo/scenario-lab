...
- characters 376-1590: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1633-3729: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3785-4167: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4230-31121: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31476-31731: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, capability_jump, knowledge_work_augmented, member_state_defection
- Turn 2 (2 turn(s) ago): taiwan_tension_rise, export_control_escalation, emergent_lab_leak_hearings
