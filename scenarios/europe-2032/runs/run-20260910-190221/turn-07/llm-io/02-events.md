...
- characters 1610-3602: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3658-4677: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4740-28847: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29202-29710: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, EU Verification Bridge to the US-China Safety Accord −2, EU Chokepoint Defence Pact −2, priority M1 −1 = −8
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 35 -> +2
SOVEREIGNTY: 15 last turn, Tech sovereignty package finishes t6 +4, no capacity in-flight bonus +0, supply_chain_coercion t6 −2, capability rose 0.7 −0 = 17

## Emerging developments (tracked)

- `emergent_allied_hoarding_squeeze` -- first noted turn 6, listed in 1 turn(s) so far: Incoming US administration publishes draft tiered-access licensing rule with no named EU volume guarantees, triggering pre-emptive bulk chip and inference-capacity hoarding by European distributors in H1 2029.
- `emergent_us_tiered_access_rule` -- first noted turn 6, listed in 1 turn(s) so far: The new US administration publishes its tiered foreign-access rule, placing EU buyers on capped volume licences with security-vetting and re-export conditions rather than a cutoff.
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, capability_jump, knowledge_work_augmented, member_state_defection
- Turn 2 (5 turn(s) ago): taiwan_tension_rise, export_control_escalation, emergent_lab_leak_hearings
- Turn 3 (4 turn(s) ago): safety_breakthrough
- Turn 4 (3 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise, us_china_agreement
- Turn 5 (2 turn(s) ago): export_control_escalation, supply_chain_coercion, election_consolidation
- Turn 6 (1 turn(s) ago): supply_chain_coercion, adoption_success
