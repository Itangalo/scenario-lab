...
- characters 1688-3680: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4003-4437: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6812-8086: `{{previous_actions}}` from the actor's own response from the previous turn
...
**emergent_us_tiered_access_rule (emergent event):** The new US administration publishes its tiered foreign-access rule placing EU buyers on capped volume licences with security-vetting and re-export conditions rather than a cutoff.
...
|---|---|---|---|---|---|---|---|---|---|
| M6 | EU Chokepoint Defence Pact | 8 | small | 5 | 8 | US and Netherlands via coalition, EU jurisdiction | eu_ai_sovereignty up moderately, eu_political_capital down then up | 2 | running |
