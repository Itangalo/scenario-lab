...
- characters 13723-14913: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14957-16949: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17005-17757: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 63.1, "openweight_capability": 61.4, "ai_safety": 21.0, "resilience": 37.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 11.0, "public_sentiment": 33.0}
```
