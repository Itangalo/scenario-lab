...
- characters 13274-14355: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14399-16576: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16632-17112: `{{notepad}}` from the Game Master's notepad, carried across turns
