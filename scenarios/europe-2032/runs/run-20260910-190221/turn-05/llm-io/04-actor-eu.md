...
- characters 1580-3757: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5496-5926: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8107-10409: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU Verification Bridge to the US-China Safety Accord | 8 | small | 4 | 7 | US, China and frontier developers via coalition | ai_safety up moderately, eu_ai_sovereignty up slightly via seat at table | 2 | running |
