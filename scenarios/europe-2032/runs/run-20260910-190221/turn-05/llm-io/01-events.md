...
- characters 1502-3679: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3735-4215: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4278-29663: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30018-30361: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, capability_jump, knowledge_work_augmented, member_state_defection
- Turn 2 (3 turn(s) ago): taiwan_tension_rise, export_control_escalation, emergent_lab_leak_hearings
- Turn 3 (2 turn(s) ago): safety_breakthrough
- Turn 4 (1 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise, us_china_agreement
