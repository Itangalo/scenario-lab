...
- characters 106-12938: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12981-13173: `{{metrics_json}}` from the run's live metric values
- characters 13266-14335: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14379-16438: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16494-17028: `{{notepad}}` from the Game Master's notepad, carried across turns
