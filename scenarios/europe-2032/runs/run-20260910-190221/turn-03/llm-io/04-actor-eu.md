...
- characters 455-1524: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1568-3627: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4043-4473: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6115-7987: `{{previous_actions}}` from the actor's own response from the previous turn
