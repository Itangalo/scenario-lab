...
- characters 377-1446: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1490-3549: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3605-4452: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4515-28296: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28651-28860: `{{event_history}}` from the run's own event record
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, capability_jump, knowledge_work_augmented, member_state_defection
- Turn 2 (1 turn(s) ago): taiwan_tension_rise, export_control_escalation, emergent_lab_leak_hearings
