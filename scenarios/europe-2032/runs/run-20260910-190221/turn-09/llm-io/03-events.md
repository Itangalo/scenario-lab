...
- characters 377-1244: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1288-3160: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3216-4020: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4083-28190: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28545-29183: `{{event_history}}` from the run's own event record
...
- `emergent_licence_tranche_freeze` -- first noted turn 8, listed in 1 turn(s) so far: US licence administrators impose an abrupt tranche pause for EU buyers in Q1 2030 after a vetting backlog, forcing capped distributors to ration inference and pushing spot prices sharply higher.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, capability_jump, knowledge_work_augmented, member_state_defection
- Turn 2 (7 turn(s) ago): taiwan_tension_rise, export_control_escalation, emergent_lab_leak_hearings
- Turn 3 (6 turn(s) ago): safety_breakthrough
- Turn 4 (5 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise, us_china_agreement
- Turn 5 (4 turn(s) ago): export_control_escalation, supply_chain_coercion, election_consolidation
- Turn 6 (3 turn(s) ago): supply_chain_coercion, adoption_success
- Turn 7 (2 turn(s) ago): emergent_us_tiered_access_rule
- Turn 8 (1 turn(s) ago): labour_displacement, eu_frontier_access_denied
