...
- characters 455-1322: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1366-3238: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4266-4700: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7282-9329: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | EU Cutoff Continuity and Graduate Transition Shield | 6 | small | 8 | 10 | own jurisdiction | resilience up moderately, eu_political_capital up slightly, public_sentiment up slightly | 2 | running |
