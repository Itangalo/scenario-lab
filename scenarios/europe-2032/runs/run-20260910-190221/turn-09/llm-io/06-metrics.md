...
- characters 106-12895: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12938-13130: `{{metrics_json}}` from the run's live metric values
- characters 13223-14090: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14134-16006: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16062-17143: `{{notepad}}` from the Game Master's notepad, carried across turns
