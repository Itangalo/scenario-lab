...
- characters 13659-15193: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15236-17101: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17157-17599: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M11 | EU Major Cyber Recovery and Continuity Surge | 2 |
...
## Metrics
```json
{"ai_capability": 66.7, "openweight_capability": 65.2, "ai_safety": 4.0, "resilience": 42.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 16.0, "public_sentiment": 7.0}
```
