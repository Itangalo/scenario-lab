...
- characters 376-1910: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1953-3818: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3874-4316: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4379-27263: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27618-28466: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, capability_jump, knowledge_work_augmented, member_state_defection
- Turn 2 (10 turn(s) ago): taiwan_tension_rise, export_control_escalation, emergent_lab_leak_hearings
- Turn 3 (9 turn(s) ago): safety_breakthrough
- Turn 4 (8 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise, us_china_agreement
- Turn 5 (7 turn(s) ago): export_control_escalation, supply_chain_coercion, election_consolidation
- Turn 6 (6 turn(s) ago): supply_chain_coercion, adoption_success
- Turn 7 (5 turn(s) ago): emergent_us_tiered_access_rule
- Turn 8 (4 turn(s) ago): labour_displacement, eu_frontier_access_denied
- Turn 9 (3 turn(s) ago): opaque_reasoning, openweight_frontier_release
- Turn 10 (2 turn(s) ago): taiwan_blockade
- Turn 11 (1 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports
