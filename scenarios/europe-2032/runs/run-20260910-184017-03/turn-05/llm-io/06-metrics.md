...
- characters 13842-15285: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15329-17390: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17446-17982: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 67.0, "openweight_capability": 60.8, "ai_safety": 17.0, "resilience": 37.0, "eu_ai_sovereignty": 13.0, "eu_political_capital": 16.0, "public_sentiment": 29.0}
```
## Narrative
