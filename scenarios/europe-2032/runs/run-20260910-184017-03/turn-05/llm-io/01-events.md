...
- characters 1864-3925: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3981-4877: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4940-30843: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31198-31443: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, bio_uplift_findings, emergent_screening_expose
- Turn 2 (3 turn(s) ago): bio_uplift_findings
- Turn 3 (2 turn(s) ago): member_state_defection, adoption_success
- Turn 4 (1 turn(s) ago): opaque_reasoning
