...
- characters 1942-4003: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6240-6709: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9044-11013: `{{previous_actions}}` from the actor's own response from the previous turn
