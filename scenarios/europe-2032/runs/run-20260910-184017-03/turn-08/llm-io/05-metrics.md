...
- characters 13685-15321: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15364-17595: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17651-18415: `{{notepad}}` from the Game Master's notepad, carried across turns
