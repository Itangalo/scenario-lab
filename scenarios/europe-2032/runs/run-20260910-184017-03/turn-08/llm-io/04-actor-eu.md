...
- characters 2132-4363: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4895-5376: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8079-9713: `{{previous_actions}}` from the actor's own response from the previous turn
