...
- characters 2054-4285: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4341-5081: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5144-29714: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30069-30677: `{{event_history}}` from the run's own event record
...
- `emergent_humanoid_safety_scare` -- first noted turn 6, listed in 2 turn(s) so far: A deployed Chinese-built humanoid fleet in EU logistics suffers a coordinated control-stack failure causing injuries and a temporary warehouse shutdown, fuelling calls for EU robotics certification.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, bio_uplift_findings, emergent_screening_expose
- Turn 2 (6 turn(s) ago): bio_uplift_findings
- Turn 3 (5 turn(s) ago): member_state_defection, adoption_success
- Turn 4 (4 turn(s) ago): opaque_reasoning
- Turn 5 (3 turn(s) ago): bio_uplift_findings, embodied_ai_deployment, election_alliance
- Turn 6 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, rsi_onset, medical_breakthrough, embodied_ai_deployment, us_china_agreement
- Turn 7 (1 turn(s) ago): catastrophic_bio_incident, member_state_defection, joint_threat_response, emergent_humanoid_safety_ban
