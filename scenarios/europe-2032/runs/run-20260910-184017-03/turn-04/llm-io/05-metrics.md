...
- characters 105-13111: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13154-13346: `{{metrics_json}}` from the run's live metric values
- characters 13439-14717: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14760-16823: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16879-17818: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 64.0, "openweight_capability": 57.6, "ai_safety": 18.0, "resilience": 39.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 18.0, "public_sentiment": 32.0}
```
