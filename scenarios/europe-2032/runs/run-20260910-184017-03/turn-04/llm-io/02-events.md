...
- characters 376-1654: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1697-3760: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3816-4755: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4818-30815: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31170-31372: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, bio_uplift_findings, emergent_screening_expose
- Turn 2 (2 turn(s) ago): bio_uplift_findings
- Turn 3 (1 turn(s) ago): member_state_defection, adoption_success
