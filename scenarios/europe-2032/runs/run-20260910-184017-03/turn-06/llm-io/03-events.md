...
- characters 1941-4134: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4190-4794: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4857-30353: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30708-31042: `{{event_history}}` from the run's own event record
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, bio_uplift_findings, emergent_screening_expose
- Turn 2 (4 turn(s) ago): bio_uplift_findings
- Turn 3 (3 turn(s) ago): member_state_defection, adoption_success
- Turn 4 (2 turn(s) ago): opaque_reasoning
- Turn 5 (1 turn(s) ago): bio_uplift_findings, embodied_ai_deployment, election_alliance
