...
- characters 2019-4212: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7668-8149: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10671-12980: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | Opaque Reasoning Assurance Programme | 5 | small | 4 | 7 | own jurisdiction | ai_safety up, resilience up modestly via working oversight without CoT | 2 | running |
