...
- characters 376-2519: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2563-4680: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4736-5393: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5456-30026: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30381-31037: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M8 EU Accord Seat and Sovereign Access Terms −2, priority M8 −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 10, sentiment 13 -> +1
SOVEREIGNTY: 17 last turn, no category 4 finish, no capacity event, no in-flight bonus, capability rose 3.0 −1 = 16

## Emerging developments (tracked)

- `emergent_counterfeit_countermeasure_surge` -- first noted turn 8, listed in 1 turn(s) so far: Counterfeit triage and countermeasure lots circulate during the pandemic surge, with forged cold-chain certificates and AI-generated lab reports, forcing recalls and checkpoint seizures in several member states.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, bio_uplift_findings, emergent_screening_expose
- Turn 2 (7 turn(s) ago): bio_uplift_findings
- Turn 3 (6 turn(s) ago): member_state_defection, adoption_success
- Turn 4 (5 turn(s) ago): opaque_reasoning
- Turn 5 (4 turn(s) ago): bio_uplift_findings, embodied_ai_deployment, election_alliance
- Turn 6 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, rsi_onset, medical_breakthrough, embodied_ai_deployment, us_china_agreement
- Turn 7 (2 turn(s) ago): catastrophic_bio_incident, member_state_defection, joint_threat_response, emergent_humanoid_safety_ban
- Turn 8 (1 turn(s) ago): joint_threat_response
