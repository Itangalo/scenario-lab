...
- characters 454-2223: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2267-4343: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6346-6834: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9912-11863: `{{previous_actions}}` from the actor's own response from the previous turn
