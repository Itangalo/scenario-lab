...
- characters 376-2145: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2189-4265: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4321-5212: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5275-30079: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30434-31319: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, bio_uplift_findings, emergent_screening_expose
- Turn 2 (9 turn(s) ago): bio_uplift_findings
- Turn 3 (8 turn(s) ago): member_state_defection, adoption_success
- Turn 4 (7 turn(s) ago): opaque_reasoning
- Turn 5 (6 turn(s) ago): bio_uplift_findings, embodied_ai_deployment, election_alliance
- Turn 6 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings, rsi_onset, medical_breakthrough, embodied_ai_deployment, us_china_agreement
- Turn 7 (4 turn(s) ago): catastrophic_bio_incident, member_state_defection, joint_threat_response, emergent_humanoid_safety_ban
- Turn 8 (3 turn(s) ago): joint_threat_response
- Turn 9 (2 turn(s) ago): cyber_major_incident, openweight_frontier_release, taiwan_tension_rise, emergent_counterfeit_countermeasure_surge
- Turn 10 (1 turn(s) ago): cyber_major_incident, bio_incident, knowledge_work_augmented
