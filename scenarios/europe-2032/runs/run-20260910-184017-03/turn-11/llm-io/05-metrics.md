...
- characters 107-13023: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13066-13256: `{{metrics_json}}` from the run's live metric values
- characters 13349-15118: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15162-17238: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17294-18185: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Local Recovery and Care Trust Network | 2 |
