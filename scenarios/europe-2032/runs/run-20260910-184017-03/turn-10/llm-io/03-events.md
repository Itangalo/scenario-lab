...
- characters 375-2173: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2216-4686: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4742-5169: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5232-30848: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31203-31999: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, bio_uplift_findings, emergent_screening_expose
- Turn 2 (8 turn(s) ago): bio_uplift_findings
- Turn 3 (7 turn(s) ago): member_state_defection, adoption_success
- Turn 4 (6 turn(s) ago): opaque_reasoning
- Turn 5 (5 turn(s) ago): bio_uplift_findings, embodied_ai_deployment, election_alliance
- Turn 6 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, rsi_onset, medical_breakthrough, embodied_ai_deployment, us_china_agreement
- Turn 7 (3 turn(s) ago): catastrophic_bio_incident, member_state_defection, joint_threat_response, emergent_humanoid_safety_ban
- Turn 8 (2 turn(s) ago): joint_threat_response
- Turn 9 (1 turn(s) ago): cyber_major_incident, openweight_frontier_release, taiwan_tension_rise, emergent_counterfeit_countermeasure_surge
