...
- characters 13412-13602: `{{metrics_json}}` from the run's live metric values
- characters 13695-15493: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15536-18006: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18062-18872: `{{notepad}}` from the Game Master's notepad, carried across turns
