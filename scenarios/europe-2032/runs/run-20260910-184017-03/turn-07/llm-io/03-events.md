...
- characters 376-2108: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2152-4603: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4659-5826: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5889-30145: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30500-30979: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, bio_uplift_findings, emergent_screening_expose
- Turn 2 (5 turn(s) ago): bio_uplift_findings
- Turn 3 (4 turn(s) ago): member_state_defection, adoption_success
- Turn 4 (3 turn(s) ago): opaque_reasoning
- Turn 5 (2 turn(s) ago): bio_uplift_findings, embodied_ai_deployment, election_alliance
- Turn 6 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, rsi_onset, medical_breakthrough, embodied_ai_deployment, us_china_agreement
