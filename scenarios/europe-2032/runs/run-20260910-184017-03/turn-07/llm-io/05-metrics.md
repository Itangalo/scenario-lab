...
- characters 13595-13786: `{{metrics_json}}` from the run's live metric values
- characters 13879-15611: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15655-18106: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18162-19064: `{{notepad}}` from the Game Master's notepad, carried across turns
