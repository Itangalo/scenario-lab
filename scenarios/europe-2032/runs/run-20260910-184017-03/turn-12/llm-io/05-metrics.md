...
- characters 106-13432: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13475-13664: `{{metrics_json}}` from the run's live metric values
- characters 13757-15881: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15924-18140: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18196-18785: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Municipal Isolation and Agent Containment Protocol | 2 |
| M12 | EU Wartime Shelter and Minimum Continuity Regime | 2 |
...
## Metrics
```json
{"ai_capability": 90.0, "openweight_capability": 83.5, "ai_safety": 2.0, "resilience": 49.0, "eu_ai_sovereignty": 13.0, "eu_political_capital": 2.0, "public_sentiment": 1.0}
```
