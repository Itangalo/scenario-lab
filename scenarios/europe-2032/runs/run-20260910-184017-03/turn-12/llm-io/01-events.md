...
- characters 374-2498: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2541-4757: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4813-5785: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5848-30652: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31007-32009: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Local Recovery and Care Trust Network −2, EU Municipal Isolation and Agent Containment Protocol −2, priority −1 not charged (capital below 20, no effect) = −4
PROPOSAL BONUS: EU Municipal Isolation and Agent Containment Protocol (cat 6, small) +4 — loss-of-control with days-long containment plus bio-uplift signal and eval anomaly this turn, answers continuity/containment directly
LEGITIMACY LENDS: capital 11, sentiment 5 -> none, capital higher
SOVEREIGNTY: 14 last turn, no capacity event, no category 4 finish, no in-flight bonus, capability rose 1.5 −0 = 14

## Emerging developments (tracked)

- `emergent_grey_inference_bazaar` -- first noted turn 10, listed in 2 turn(s) so far: Grey-market brokers openly rent out partitioned slices of compromised municipal and hospital-adjacent compute for running near-frontier open models, creating a persistent illicit inference layer that police cannot seize without shutting down public services.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, bio_uplift_findings, emergent_screening_expose
- Turn 2 (10 turn(s) ago): bio_uplift_findings
- Turn 3 (9 turn(s) ago): member_state_defection, adoption_success
- Turn 4 (8 turn(s) ago): opaque_reasoning
- Turn 5 (7 turn(s) ago): bio_uplift_findings, embodied_ai_deployment, election_alliance
- Turn 6 (6 turn(s) ago): cyber_major_incident, bio_uplift_findings, rsi_onset, medical_breakthrough, embodied_ai_deployment, us_china_agreement
- Turn 7 (5 turn(s) ago): catastrophic_bio_incident, member_state_defection, joint_threat_response, emergent_humanoid_safety_ban
- Turn 8 (4 turn(s) ago): joint_threat_response
- Turn 9 (3 turn(s) ago): cyber_major_incident, openweight_frontier_release, taiwan_tension_rise, emergent_counterfeit_countermeasure_surge
- Turn 10 (2 turn(s) ago): cyber_major_incident, bio_incident, knowledge_work_augmented
- Turn 11 (1 turn(s) ago): loss_of_control_incident, bio_uplift_findings, eval_anomaly_reports, labour_displacement
