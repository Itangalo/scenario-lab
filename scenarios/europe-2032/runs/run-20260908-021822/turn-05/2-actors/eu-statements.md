...
- `two_year_commitment` (commitment): Secure sovereign AI control and resilience for critical systems

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign AI control and resilience for critical systems
