...
- characters 377-1401: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1445-3406: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3462-3940: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4003-27285: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27640-27681: `{{event_history}}` from the run's own event record
