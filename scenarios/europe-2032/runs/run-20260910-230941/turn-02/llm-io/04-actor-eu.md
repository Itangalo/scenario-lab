...
- characters 4386-4826: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6280-8371: `{{previous_actions}}` from the actor's own response from the previous turn
