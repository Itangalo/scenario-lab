...
- `two_year_commitment` (commitment): Rebuild public trust through resilient services and protection from AI displacement

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild public trust through resilient services and protection from AI displacement
