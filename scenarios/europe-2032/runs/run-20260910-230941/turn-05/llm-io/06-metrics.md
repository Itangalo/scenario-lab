...
- characters 106-13406: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13449-13641: `{{metrics_json}}` from the run's live metric values
- characters 13734-15415: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15459-17435: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17491-17976: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|---|---|---|---|---|---|---|
| M5 | EU Rapid Cyber Defence Deployment | 6 | small | 3 | 5 | own jurisdiction | resilience up | 2 | finished |
| M6 | EU Continuity Stack | 4 | small | 4 | 5 | own jurisdiction | eu_ai_sovereignty up, resilience up modestly | 2 | finished |
...
LEGITIMACY LENDS: capital 15, sentiment 20 -> +2
SOVEREIGNTY: 18 last turn, M6 EU Continuity Stack finishes t5 +4, M1 Gigafactories in flight +1, member_state_defection t5 −2, capability rose 1.5 −0 = 21
