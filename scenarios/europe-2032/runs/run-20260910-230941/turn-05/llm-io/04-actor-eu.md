...
- characters 455-2136: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2180-4156: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5374-5814: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7943-9652: `{{previous_actions}}` from the actor's own response from the previous turn
