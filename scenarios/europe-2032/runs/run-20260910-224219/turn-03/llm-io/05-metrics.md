...
- characters 106-13198: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13241-13433: `{{metrics_json}}` from the run's live metric values
- characters 13526-14789: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14833-16824: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16880-17999: `{{notepad}}` from the Game Master's notepad, carried across turns
