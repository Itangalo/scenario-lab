...
- characters 13882-16134: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16178-18748: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18804-19863: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Bio-Cyber Resilience Backstop | 2 |
...
- `emergent_uninsured_care_diversion` -- first noted turn 5, listed in 1 turn(s) so far: Municipal hospital ransomware cascade forces uninsured utilities to divert care and triggers emergency nationalizations of local grids in one or more member states.
- `emergent_uninsured_hospital_cascade` -- first noted turn 5, listed in 1 turn(s) so far: Municipal hospital ransomware cascade forces emergency patient diversions across two member states after cyber cover withdrawal leaves unhardened sites exposed.
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Transition Safety Net −2, EU Bio-Cyber Resilience Backstop −2, priority −1 = −11
