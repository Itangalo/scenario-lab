...
- characters 377-2629: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2673-5243: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5299-5815: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5878-34260: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34615-34917: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Evaluation Cell −2, EU AI Transition Safety Net −2, EU Bio-Cyber Resilience Backstop −2, priority −1 = −13
PROPOSAL BONUS: EU Bio-Cyber Resilience Backstop (cat 6, small) +3 — insurance crunch landed this turn and bio precursor opened 4-turn window, this answers both directly
LEGITIMACY LENDS: capital 21, sentiment 31 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, Gigafactories in flight +0, capability rose 2.5 −1 = 18
...
- Turn 2 (3 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented
- Turn 3 (2 turn(s) ago): capability_jump, eval_anomaly_reports, labour_displacement
- Turn 4 (1 turn(s) ago): ai_investment_collapse, bio_uplift_findings, emergent_cyber_insurance_crunch
