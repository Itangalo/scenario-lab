...
- characters 455-2707: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2751-5321: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6733-7205: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9483-11552: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Bio-Cyber Resilience Backstop | 6 | small | 4 | 7 | own jurisdiction | resilience up, ai_safety indirectly via biosecurity detection | 2 | running |
...
| M4 | EU Frontier Evaluation Cell | 5 | small | 2 | 5 | own jurisdiction | ai_safety up modestly, eu_ai_sovereignty up indirectly via technical capacity | 2 | finished |
