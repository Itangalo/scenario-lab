...
- characters 13916-15535: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15578-18096: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18152-18637: `{{notepad}}` from the Game Master's notepad, carried across turns
