...
- characters 105-13156: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13199-13391: `{{metrics_json}}` from the run's live metric values
- characters 13484-14813: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14856-17333: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17389-18487: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 50.5, "ai_safety": 30.0, "resilience": 36.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 32.0, "public_sentiment": 42.0}
```
