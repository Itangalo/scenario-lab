...
- characters 5293-5765: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7237-9364: `{{previous_actions}}` from the actor's own response from the previous turn
