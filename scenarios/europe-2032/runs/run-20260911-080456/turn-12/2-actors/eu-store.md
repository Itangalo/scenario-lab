...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU-US State-Level Assurance and Continuity Accord", "category": 8, "size": "small", "finish_turn": 14, "applies_to": "US state counterpart with coalition partners", "targeted_effect": "eu_ai_sovereignty protected/up modestly, resilience up, ai_safety up modestly"}, "grounds": "US nationalisation enables state-to-state bargain to sustain servic
  - Grounds: US nationalisation enables state-to-state bargain to sustain services
