...
| M11 | EU-US State-Level Assurance and Continuity Accord | 8 | small | 12 | 14 | US state counterpart with coalition partners | eu_ai_sovereignty protected/up modestly, resilience up, ai_safety up modestly | 2 | running |
| M12 | EU Middle-Power Supply and Access Coalition | 8 | small | 13 | 15 | own jurisdiction with middle-power coalition partners | eu_ai_sovereignty protected/up, eu_political_capital up, resilience up modestly | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Middle-Power Supply and Access Coalition", "category": 8, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction with middle-power coalition partners", "targeted_effect": "eu_ai_sovereignty protected/up, eu_political_capital up, resilience up modestly"}, "grounds": "coalition window after US nationalisation and defection risk"}
  - Grounds: coalition window after US nationalisation and defection risk
