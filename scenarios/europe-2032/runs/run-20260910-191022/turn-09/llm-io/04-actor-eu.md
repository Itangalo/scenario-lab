...
- characters 454-2072: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2116-4476: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6013-6471: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9355-11279: `{{previous_actions}}` from the actor's own response from the previous turn
