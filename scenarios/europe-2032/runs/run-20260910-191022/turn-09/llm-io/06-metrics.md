...
- characters 13670-15288: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15332-17692: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17748-18545: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Essential Services Offline Continuity Corps | 2 |
...
## Metrics
```json
{"ai_capability": 65.0, "openweight_capability": 63.0, "ai_safety": 17.0, "resilience": 44.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 24.0, "public_sentiment": 5.0}
```
...
## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M11", "fields": {"finish_turn": 10}, "grounds": "named priority"}]}
```
```
