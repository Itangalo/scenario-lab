...
- characters 376-1994: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2038-4398: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4454-5251: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5314-31209: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31564-32309: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Supply-Chain Bargain for Continuity −2, priority −1 = −3
PROPOSAL BONUS: EU Supply-Chain Bargain for Continuity (cat 8, small) +4 — taiwan_blockade landed this turn and this answers it directly, cyber_major_incident adds weight, small size limits gain
LEGITIMACY LENDS: capital 28, sentiment 9 -> none, capital higher
SOVEREIGNTY: 23 last turn, no cat4 finishes, no cat4 in flight +0, taiwan_blockade t8 −3, capability rose 1.0 no penalty = 20

## Emerging developments (tracked)

- `emergent_construction_blockade` -- first noted turn 8, listed in 1 turn(s) so far: Coordinated physical protests and blockades target the two gigafactory construction sites and local grid upgrades, fusing anti-AI, labour-displacement and energy-cost grievances and halting works for weeks.
...
- Turn 3 (6 turn(s) ago): cyber_major_incident, ai_investment_collapse, taiwan_tension_rise, emergent_sovereign_hosting_offer, emergent_eu_hosting_guarantee
- Turn 4 (5 turn(s) ago): bio_uplift_findings, safety_breakthrough, knowledge_work_augmented
- Turn 5 (4 turn(s) ago): cyber_major_incident, automated_decision_scandal, election_consolidation
- Turn 6 (3 turn(s) ago): labour_displacement, eu_frontier_access_denied
- Turn 7 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings
- Turn 8 (1 turn(s) ago): cyber_major_incident, taiwan_blockade, bio_uplift_findings, medical_breakthrough, openweight_frontier_release
