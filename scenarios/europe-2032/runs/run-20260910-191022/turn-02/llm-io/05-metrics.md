...
- characters 13374-14600: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14643-17098: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17154-18183: `{{notepad}}` from the Game Master's notepad, carried across turns
