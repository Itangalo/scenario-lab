...
- characters 13410-13602: `{{metrics_json}}` from the run's live metric values
- characters 13695-15039: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15083-17317: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17373-17883: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Hosted Clinical Inference Sprint | 2 |
