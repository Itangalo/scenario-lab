...
- characters 378-1722: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1766-4000: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4056-4566: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4629-30680: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31035-31921: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M12 EU Sovereign Clinical AI Access Pact −2, priority −1 = −3
PROPOSAL BONUS: EU Sovereign Clinical AI Access Pact (cat 9, small) +2 — answers eu_frontier_access_denied and opaque_reasoning dependence from last three turns by securing breakthrough on EU-hosted terms, small size and just-proposed limits gain
...
- Turn 3 (8 turn(s) ago): cyber_major_incident, ai_investment_collapse, taiwan_tension_rise, emergent_sovereign_hosting_offer, emergent_eu_hosting_guarantee
- Turn 4 (7 turn(s) ago): bio_uplift_findings, safety_breakthrough, knowledge_work_augmented
- Turn 5 (6 turn(s) ago): cyber_major_incident, automated_decision_scandal, election_consolidation
- Turn 6 (5 turn(s) ago): labour_displacement, eu_frontier_access_denied
- Turn 7 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings
- Turn 8 (3 turn(s) ago): cyber_major_incident, taiwan_blockade, bio_uplift_findings, medical_breakthrough, openweight_frontier_release
- Turn 9 (2 turn(s) ago): cyber_major_incident, opaque_reasoning, eu_frontier_access_denied
