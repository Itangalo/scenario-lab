...
- characters 456-1800: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1844-4078: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6345-6845: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10151-12745: `{{previous_actions}}` from the actor's own response from the previous turn
