...
- characters 106-13334: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13377-13569: `{{metrics_json}}` from the run's live metric values
- characters 13662-15233: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15276-17146: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17202-18062: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Cutoff-Proof Operations Stack | 2 |
