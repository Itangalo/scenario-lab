...
- characters 1991-3861: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3917-4443: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4506-30557: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30912-31874: `{{event_history}}` from the run's own event record
...
- Turn 3 (9 turn(s) ago): cyber_major_incident, ai_investment_collapse, taiwan_tension_rise, emergent_sovereign_hosting_offer, emergent_eu_hosting_guarantee
- Turn 4 (8 turn(s) ago): bio_uplift_findings, safety_breakthrough, knowledge_work_augmented
- Turn 5 (7 turn(s) ago): cyber_major_incident, automated_decision_scandal, election_consolidation
- Turn 6 (6 turn(s) ago): labour_displacement, eu_frontier_access_denied
- Turn 7 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings
- Turn 8 (4 turn(s) ago): cyber_major_incident, taiwan_blockade, bio_uplift_findings, medical_breakthrough, openweight_frontier_release
- Turn 9 (3 turn(s) ago): cyber_major_incident, opaque_reasoning, eu_frontier_access_denied
- Turn 10 (2 turn(s) ago): medical_breakthrough
- Turn 11 (1 turn(s) ago): research_breakthrough, knowledge_work_augmented
