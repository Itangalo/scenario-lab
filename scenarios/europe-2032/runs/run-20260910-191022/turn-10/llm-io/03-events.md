...
- characters 376-1733: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1776-4193: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4249-5127: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5190-31241: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31596-32433: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M10 finished not charged, M11 EU Essential Services Offline Continuity Corps −2, priority −1 = −3
PROPOSAL BONUS: EU Essential Services Offline Continuity Corps (cat 6, small) +4 — eu_frontier_access_denied, cyber_major_incident and opaque_reasoning all landed this turn and this answers them directly, small size limits gain
LEGITIMACY LENDS: capital 24, sentiment 5 -> none, capital higher
SOVEREIGNTY: 20 last turn, no cat4 finishes, no cat4 in flight +0, eu_frontier_access_denied t9 −3, capability rose 1.0 no penalty = 17

## Emerging developments (tracked)

- `emergent_construction_blockade` -- first noted turn 8, listed in 2 turn(s) so far: Coordinated physical protests and blockades target the two gigafactory construction sites and local grid upgrades, fusing anti-AI, labour-displacement and energy-cost grievances and halting works for weeks.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, loss_of_control_incident
- Turn 2 (8 turn(s) ago): eu_frontier_access_denied
- Turn 3 (7 turn(s) ago): cyber_major_incident, ai_investment_collapse, taiwan_tension_rise, emergent_sovereign_hosting_offer, emergent_eu_hosting_guarantee
- Turn 4 (6 turn(s) ago): bio_uplift_findings, safety_breakthrough, knowledge_work_augmented
- Turn 5 (5 turn(s) ago): cyber_major_incident, automated_decision_scandal, election_consolidation
- Turn 6 (4 turn(s) ago): labour_displacement, eu_frontier_access_denied
- Turn 7 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings
- Turn 8 (2 turn(s) ago): cyber_major_incident, taiwan_blockade, bio_uplift_findings, medical_breakthrough, openweight_frontier_release
- Turn 9 (1 turn(s) ago): cyber_major_incident, opaque_reasoning, eu_frontier_access_denied
