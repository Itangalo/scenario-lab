...
- characters 1854-4271: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4740-5201: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8288-10597: `{{previous_actions}}` from the actor's own response from the previous turn
