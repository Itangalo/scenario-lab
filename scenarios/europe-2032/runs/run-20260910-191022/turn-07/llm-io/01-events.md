...
- characters 377-1782: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1826-3713: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3769-4341: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4404-31017: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31372-31913: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, loss_of_control_incident
- Turn 2 (5 turn(s) ago): eu_frontier_access_denied
- Turn 3 (4 turn(s) ago): cyber_major_incident, ai_investment_collapse, taiwan_tension_rise, emergent_sovereign_hosting_offer, emergent_eu_hosting_guarantee
- Turn 4 (3 turn(s) ago): bio_uplift_findings, safety_breakthrough, knowledge_work_augmented
- Turn 5 (2 turn(s) ago): cyber_major_incident, automated_decision_scandal, election_consolidation
- Turn 6 (1 turn(s) ago): labour_displacement, eu_frontier_access_denied
