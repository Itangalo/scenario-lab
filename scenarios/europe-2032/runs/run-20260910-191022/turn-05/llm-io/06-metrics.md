...
- characters 13376-15654: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15698-17829: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17885-18920: `{{notepad}}` from the Game Master's notepad, carried across turns
