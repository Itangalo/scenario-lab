...
- characters 455-2733: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2777-4908: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7586-8088: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10380-12378: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Bio Detection and Screening Shield | 6 | small | 4 | 6 | own jurisdiction | resilience up moderately, ai_safety up slightly | 2 | running |
