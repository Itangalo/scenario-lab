...
- characters 378-1791: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1835-3713: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3769-4544: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4607-30658: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31013-32076: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M14 EU Cutoff-Proof Operations Stack −2, priority −1 = −3
PROPOSAL BONUS: none — new cat 9 stack answers this-turn cutoff and robot wave, not an event from the last three rounds
LEGITIMACY LENDS: capital 26, sentiment 20 -> none, capital higher
SOVEREIGNTY: 18 last turn, M13 EU Hosted Clinical Inference Sprint finishes t12 +3, no capacity in-flight bonus, eu_frontier_access_denied t12 −2, capability rose 1.0 −0 = 19

## Emerging developments (tracked)

- `emergent_care_queue_backlash` -- first noted turn 12, listed in 1 turn(s) so far: Hospital waiting lists for EU-hosted dose-planning leak to foreign press, triggering cross-border medical tourism brokers offering tailored-therapy slots abroad and a parliamentary inquiry into queue allocation.
...
- Turn 3 (10 turn(s) ago): cyber_major_incident, ai_investment_collapse, taiwan_tension_rise, emergent_sovereign_hosting_offer, emergent_eu_hosting_guarantee
- Turn 4 (9 turn(s) ago): bio_uplift_findings, safety_breakthrough, knowledge_work_augmented
- Turn 5 (8 turn(s) ago): cyber_major_incident, automated_decision_scandal, election_consolidation
- Turn 6 (7 turn(s) ago): labour_displacement, eu_frontier_access_denied
- Turn 7 (6 turn(s) ago): cyber_major_incident, bio_uplift_findings
- Turn 8 (5 turn(s) ago): cyber_major_incident, taiwan_blockade, bio_uplift_findings, medical_breakthrough, openweight_frontier_release
- Turn 9 (4 turn(s) ago): cyber_major_incident, opaque_reasoning, eu_frontier_access_denied
- Turn 10 (3 turn(s) ago): medical_breakthrough
- Turn 11 (2 turn(s) ago): research_breakthrough, knowledge_work_augmented
- Turn 12 (1 turn(s) ago): research_breakthrough, embodied_ai_deployment, eu_frontier_access_denied
