...
- characters 105-13313: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13356-13548: `{{metrics_json}}` from the run's live metric values
- characters 13641-15047: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15090-17119: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17175-17977: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Supply-Chain Bargain for Continuity | 2 |
