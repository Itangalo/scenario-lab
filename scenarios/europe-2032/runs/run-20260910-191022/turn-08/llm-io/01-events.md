...
- characters 1825-3854: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3910-4382: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4445-31058: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31413-32022: `{{event_history}}` from the run's own event record
...
- Turn 3 (5 turn(s) ago): cyber_major_incident, ai_investment_collapse, taiwan_tension_rise, emergent_sovereign_hosting_offer, emergent_eu_hosting_guarantee
- Turn 4 (4 turn(s) ago): bio_uplift_findings, safety_breakthrough, knowledge_work_augmented
- Turn 5 (3 turn(s) ago): cyber_major_incident, automated_decision_scandal, election_consolidation
- Turn 6 (2 turn(s) ago): labour_displacement, eu_frontier_access_denied
- Turn 7 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings
