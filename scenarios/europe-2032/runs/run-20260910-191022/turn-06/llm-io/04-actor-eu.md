...
- characters 454-1548: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1591-3371: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4327-4785: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7260-9711: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU High-Risk AI Redress and Audit Reset | 1 | small | 5 | 7 | own jurisdiction | public_sentiment up, eu_political_capital up slightly, ai_safety up slightly | 2 | running |
