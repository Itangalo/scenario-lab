...
- characters 376-1470: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1513-3293: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3349-4464: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4527-30537: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30892-31360: `{{event_history}}` from the run's own event record
...
- `emergent_hosting_trust_freeze` -- first noted turn 4, listed in 2 turn(s) so far: Municipal hospital federations publish a joint audit questioning whether the non-American ring-fenced hosting guarantees would survive an export order from its home government, freezing further migrations pending legal clarification.
- `emergent_ringfenced_host_failure` -- first noted turn 4, listed in 2 turn(s) so far: The non-American cloud group offering ring-fenced EU hosting suffers a major outage or security failure, undermining trust in the migration path hospitals and cities just chose.
...
- Turn 3 (3 turn(s) ago): cyber_major_incident, ai_investment_collapse, taiwan_tension_rise, emergent_sovereign_hosting_offer, emergent_eu_hosting_guarantee
- Turn 4 (2 turn(s) ago): bio_uplift_findings, safety_breakthrough, knowledge_work_augmented
- Turn 5 (1 turn(s) ago): cyber_major_incident, automated_decision_scandal, election_consolidation
