...
| M11 | EU Sovereign Fallback Stack | 4 | small | 9 | 11 | own jurisdiction | eu_ai_sovereignty up, resilience up slightly via continuity | 2 | finished |
| M12 | EU Essential Services Isolation and Rogue-Agent Lockdown | 6 | small | 10 | 12 | own jurisdiction | resilience up, ai_safety up slightly via containment | 2 | finished |
| M13 | EU Municipal Restoration and Bio-Screening Surge | 6 | small | 11 | 12 | own jurisdiction plus coalition partners in joint command/pact | resilience up, ai_safety up slightly via reduced cyber/bio harm | 2 | finished |
| M14 | EU Certified Safeguards and Agent Containment Deployment | 5 | small | 12 | 14 | own jurisdiction | ai_safety up, resilience up via reduced cyber/agent harm | 2 | running |
| M15 | EU Welfare-Policing AI Redress and Oversight Repair | 1 | small | 13 | 15 | own jurisdiction | eu_political_capital protected, public_sentiment up slightly, ai_safety up slightly via oversight | 2 | running |
...
- **applied** `M15` — {"op": "add", "table": "measures", "fields": {"name": "EU Welfare-Policing AI Redress and Oversight Repair", "category": 1, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "eu_political_capital protected, public_sentiment up slightly, ai_safety up slightly via oversight"}, "grounds": "to answer automated-decision scandal and repair AI Act credibility"}
  - Grounds: to answer automated-decision scandal and repair AI Act credibility
