...
- characters 106-13288: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13331-13523: `{{metrics_json}}` from the run's live metric values
- characters 13616-16490: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16533-18521: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18577-19808: `{{notepad}}` from the Game Master's notepad, carried across turns
