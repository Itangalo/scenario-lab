...
- characters 455-3329: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3372-5360: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6183-6653: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9329-12016: `{{previous_actions}}` from the actor's own response from the previous turn
