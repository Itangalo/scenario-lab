...
- characters 377-3251: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3294-5282: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5338-5944: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6007-30241: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30596-31289: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, ai_investment_collapse, export_control_escalation
- Turn 2 (8 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, openweight_frontier_release
- Turn 3 (7 turn(s) ago): knowledge_work_augmented
- Turn 4 (6 turn(s) ago): labour_displacement, member_state_defection
- Turn 5 (5 turn(s) ago): adoption_success, emergent_insurance_repricing, election_consolidation
- Turn 6 (4 turn(s) ago): eu_frontier_access_denied
- Turn 7 (3 turn(s) ago): export_control_escalation
- Turn 8 (2 turn(s) ago): bio_uplift_findings, openweight_frontier_release, taiwan_tension_rise, eu_frontier_access_denied
- Turn 9 (1 turn(s) ago): taiwan_blockade
