...
- characters 376-1642: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1685-3576: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3632-4831: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4894-29169: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29524-30435: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M8 Upstream Leverage and Allied Chip Lifeline −2, M9 EU Incident Containment and Continuity Reinforcement −2, M10 EU Trusted Restoration and Visible Relief Delivery −2, priority −1 = −7
PROPOSAL BONUS: none — EU Trusted Restoration (cat 9, small) answers low sentiment and uses adoption gains, but does not directly answer a negative event from last three rounds
LEGITIMACY LENDS: capital 23, sentiment 10 -> none (capital higher)
SOVEREIGNTY: 19 last turn, no cat4 finish, no in-flight bonus, embodied_ai_deployment t11 −1, capability rose 0.7 −0 = 18

## Emerging developments (tracked)

- `emergent_allied_spares_pool` -- first noted turn 10, listed in 2 turn(s) so far: Allied foundries and Tokyo offer the EU a pooled life-extension pool for accelerators and grid spares in exchange for pooled lithography servicing, formalized as a standing rationing clearinghouse outside US volume licences.
- `emergent_allied_pool_freeze` -- first noted turn 10, listed in 2 turn(s) so far: Allied accelerator pool fractures over rationing shares, with Tokyo and The Hague withholding batches after EU re-exports to non-priority hospitals, freezing the joint licensing table for weeks.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, ai_investment_collapse, export_control_escalation
- Turn 2 (10 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, openweight_frontier_release
- Turn 3 (9 turn(s) ago): knowledge_work_augmented
- Turn 4 (8 turn(s) ago): labour_displacement, member_state_defection
- Turn 5 (7 turn(s) ago): adoption_success, emergent_insurance_repricing, election_consolidation
- Turn 6 (6 turn(s) ago): eu_frontier_access_denied
- Turn 7 (5 turn(s) ago): export_control_escalation
- Turn 8 (4 turn(s) ago): bio_uplift_findings, openweight_frontier_release, taiwan_tension_rise, eu_frontier_access_denied
- Turn 9 (3 turn(s) ago): taiwan_blockade
- Turn 10 (2 turn(s) ago): cyber_major_incident, bio_incident
- Turn 11 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, safety_breakthrough, embodied_ai_deployment, adoption_success
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.12}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.03}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.04}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.19}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.03}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.1}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.05}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.14}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.04}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.16}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Allied foundries and Tokyo offer the EU a pooled life-extension pool for accelerators and grid spares in exchange for pooled lithography servicing, formalized as a standing rationing clearinghouse outside US volume licences.", "emergent": true, "id": "emergent_allied_spares_pool", "probability": 0.18}, {"description": "Allied accelerator pool fractures over rationing shares, with Tokyo and The Hague withholding batches after EU re-exports to non-priority hospitals, freezing the joint licensing table for weeks.", "emergent": true, "id": "emergent_allied_pool_freeze", "probability": 0.22}]
```
