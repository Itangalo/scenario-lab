...
- characters 106-13483: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13526-13717: `{{metrics_json}}` from the run's live metric values
- characters 13810-15076: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15119-17010: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17066-17640: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Trusted Restoration and Visible Relief Delivery | 2 |
| M11 | EU Pandemic Continuity and Biodefence Lockdown | 2 |
...
## Metrics
```json
{"ai_capability": 65.9, "openweight_capability": 64.7, "ai_safety": 11.0, "resilience": 46.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 21.0, "public_sentiment": 1.0}
```
## Narrative
### Pandemic mode
...
## Notepad
PORTFOLIO CHARGE t12: M10 EU Trusted Restoration and Visible Relief Delivery −2, M11 EU Pandemic Continuity and Biodefence Lockdown −2 = −4 (priority named but capital below 20 so priority −1 not charged, no pull-in)
PROPOSAL BONUS: EU Pandemic Continuity (cat 6, small) +3 — catastrophic bio outbreak landed this turn and this answers it directly
LEGITIMACY LENDS: capital 15, sentiment 6 -> none (capital higher)
SOVEREIGNTY: 18 last turn, no cat4 finish, no cat4 in flight +0, export_control_escalation t12 −2, capability rose 0.5 −0 = 16
## Store changes
```json
{"store": []}
```
