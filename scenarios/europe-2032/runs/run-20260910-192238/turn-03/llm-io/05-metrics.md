...
- characters 106-13275: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13318-13510: `{{metrics_json}}` from the run's live metric values
- characters 13603-14973: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15017-17206: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17262-17774: `{{notepad}}` from the Game Master's notepad, carried across turns
