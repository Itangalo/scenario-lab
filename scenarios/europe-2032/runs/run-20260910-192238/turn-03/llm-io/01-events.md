...
- characters 1791-3980: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4036-5153: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5216-28336: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28691-28897: `{{event_history}}` from the run's own event record
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, ai_investment_collapse, export_control_escalation
- Turn 2 (1 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, openweight_frontier_release
