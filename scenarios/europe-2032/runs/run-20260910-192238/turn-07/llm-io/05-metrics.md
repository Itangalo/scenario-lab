...
- characters 13507-15895: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15939-17970: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18026-19095: `{{notepad}}` from the Game Master's notepad, carried across turns
