...
- characters 377-2765: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2809-4840: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4896-5303: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5366-29715: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30070-30546: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: M1 InvestAI Gigafactories −3, M6 European Public Benefit Rollout −2, priority M1 −1 = −6
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 11, sentiment 23 -> +2 (capped, applied in capital total)
SOVEREIGNTY: 19 last turn, Tech sovereignty package finishes t6 +4, Gigafactories in flight +1, eu_frontier_access_denied t6 −2, capability rose 0.7 −0 = 22
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, ai_investment_collapse, export_control_escalation
- Turn 2 (5 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, openweight_frontier_release
- Turn 3 (4 turn(s) ago): knowledge_work_augmented
- Turn 4 (3 turn(s) ago): labour_displacement, member_state_defection
- Turn 5 (2 turn(s) ago): adoption_success, emergent_insurance_repricing, election_consolidation
