...
- characters 376-2953: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2996-4928: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4984-6015: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6078-31030: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31385-31913: `{{event_history}}` from the run's own event record
...
- `emergent_eu_power_crunch_curtailment` -- first noted turn 7, listed in 1 turn(s) so far: A prolonged heatwave-driven power crunch forces rolling curtailments of data-centre load in France and Germany, publicly pitting inference for hospitals and public services against commercial compute and stalling re-anchoring timelines.
- `emergent_sovereign_cloud_split` -- first noted turn 7, listed in 1 turn(s) so far: Breakaway member state signs a public co-location deal inviting a US hyperscaler to build EU-jurisdiction inference capacity, presented domestically as re-anchoring but diverging from common procurement terms.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, ai_investment_collapse, export_control_escalation
- Turn 2 (6 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, openweight_frontier_release
- Turn 3 (5 turn(s) ago): knowledge_work_augmented
- Turn 4 (4 turn(s) ago): labour_displacement, member_state_defection
- Turn 5 (3 turn(s) ago): adoption_success, emergent_insurance_repricing, election_consolidation
- Turn 6 (2 turn(s) ago): eu_frontier_access_denied
- Turn 7 (1 turn(s) ago): export_control_escalation
