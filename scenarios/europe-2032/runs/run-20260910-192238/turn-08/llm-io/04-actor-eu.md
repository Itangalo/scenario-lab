...
- characters 454-3031: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3074-5006: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6596-7046: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9218-10883: `{{previous_actions}}` from the actor's own response from the previous turn
