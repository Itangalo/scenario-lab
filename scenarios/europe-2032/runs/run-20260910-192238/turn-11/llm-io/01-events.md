...
- characters 377-1188: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1232-3150: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3206-4357: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4420-27842: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28197-28953: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M8 Upstream Leverage and Allied Chip Lifeline −2, M9 EU Incident Containment and Continuity Reinforcement −2, priority −1 not charged (capital below 20, no effect) = −4
PROPOSAL BONUS: EU Incident Containment and Continuity Reinforcement (cat 6, small) +3 — cyber_major_incident and bio_incident fired this turn, this answers containment directly
LEGITIMACY LENDS: capital 23, sentiment 10 -> none (capital higher)
SOVEREIGNTY: 19 last turn, no cat4 finish, no capacity event, capability rose 0.7 −0 = 19

## Emerging developments (tracked)

- `emergent_allied_spares_pool` -- first noted turn 10, listed in 1 turn(s) so far: Allied foundries and Tokyo offer the EU a pooled life-extension pool for accelerators and grid spares in exchange for pooled lithography servicing, formalized as a standing rationing clearinghouse outside US volume licences.
- `emergent_allied_pool_freeze` -- first noted turn 10, listed in 1 turn(s) so far: Allied accelerator pool fractures over rationing shares, with Tokyo and The Hague withholding batches after EU re-exports to non-priority hospitals, freezing the joint licensing table for weeks.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, ai_investment_collapse, export_control_escalation
- Turn 2 (9 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, openweight_frontier_release
- Turn 3 (8 turn(s) ago): knowledge_work_augmented
- Turn 4 (7 turn(s) ago): labour_displacement, member_state_defection
- Turn 5 (6 turn(s) ago): adoption_success, emergent_insurance_repricing, election_consolidation
- Turn 6 (5 turn(s) ago): eu_frontier_access_denied
- Turn 7 (4 turn(s) ago): export_control_escalation
- Turn 8 (3 turn(s) ago): bio_uplift_findings, openweight_frontier_release, taiwan_tension_rise, eu_frontier_access_denied
- Turn 9 (2 turn(s) ago): taiwan_blockade
- Turn 10 (1 turn(s) ago): cyber_major_incident, bio_incident
