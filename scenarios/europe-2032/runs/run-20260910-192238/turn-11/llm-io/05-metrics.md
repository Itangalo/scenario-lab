...
- characters 107-12960: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13003-13194: `{{metrics_json}}` from the run's live metric values
- characters 13287-14098: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14142-16060: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16116-17267: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | Upstream Leverage and Allied Chip Lifeline | 2 |
| M9 | EU Incident Containment and Continuity Reinforcement | 2 |
