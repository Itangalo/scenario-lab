...
- characters 377-1993: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2037-4025: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4081-4622: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4685-26601: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26956-27997: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, ai_investment_collapse, export_control_escalation
- Turn 2 (11 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, openweight_frontier_release
- Turn 3 (10 turn(s) ago): knowledge_work_augmented
- Turn 4 (9 turn(s) ago): labour_displacement, member_state_defection
- Turn 5 (8 turn(s) ago): adoption_success, emergent_insurance_repricing, election_consolidation
- Turn 6 (7 turn(s) ago): eu_frontier_access_denied
- Turn 7 (6 turn(s) ago): export_control_escalation
- Turn 8 (5 turn(s) ago): bio_uplift_findings, openweight_frontier_release, taiwan_tension_rise, eu_frontier_access_denied
- Turn 9 (4 turn(s) ago): taiwan_blockade
- Turn 10 (3 turn(s) ago): cyber_major_incident, bio_incident
- Turn 11 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, safety_breakthrough, embodied_ai_deployment, adoption_success
- Turn 12 (1 turn(s) ago): catastrophic_bio_incident, export_control_escalation, us_china_agreement, emergent_allied_pool_freeze
