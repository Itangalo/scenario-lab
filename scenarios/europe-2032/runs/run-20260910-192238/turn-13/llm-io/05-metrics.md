...
- characters 13311-13502: `{{metrics_json}}` from the run's live metric values
- characters 13595-15211: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15255-17243: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17299-18186: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_attenuation_signal` -- first noted turn 13, listed in 1 turn(s) so far: Independent labs in three countries publish convergent field evidence that the pandemic agent is losing lethality through a stable attenuating mutation, shifting public-health planning from containment to managed transition.
...
## Notepad
PORTFOLIO CHARGE t13: M11 EU Pandemic Continuity and Biodefence Lockdown −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 21, sentiment 1.0 -> none (capital higher)
SOVEREIGNTY: 16 last turn, no cat4 finish, no cat4 in flight +0, no capacity event, capability rose 0.8 −0 = 16
