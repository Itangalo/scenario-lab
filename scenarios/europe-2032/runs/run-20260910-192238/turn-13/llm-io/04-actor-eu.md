...
- characters 455-2071: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2115-4103: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4653-5123: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8411-10631: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Pandemic Continuity and Biodefence Lockdown | 6 | small | 12 | 14 | own jurisdiction | resilience up, public_sentiment stabilised, eu_political_capital stabilised via visible containment | 2 | running |
...
| M10 | EU Trusted Restoration and Visible Relief Delivery | 9 | small | 11 | 13 | own jurisdiction | public_sentiment up, resilience up slightly via restored use, eu_political_capital stabilised | 2 | finished |
...
```
## New measure
None this turn. We are holding M11 as the single instrument until transmission breaks and capital rebuilds enough to carry a second track.

## Store changes
No changes.

## Priority
M11 EU Pandemic Continuity and Biodefence Lockdown, because with a designed pathogen still spreading and a model-generated automated attack landing on top, keeping power, water, emergency comms and fallback hospitals alive is the commitment itself, not one task among others.

## In practice
We keep the Health Council and IPCR in permanent session and HERA/ECDC on procurement, oxygen/ICU surge, testing and isolation. ENISA and the Health/Transport certification cells hold only the certified rails — power, water, emergency comms, stripped-back hospital IT — and pull the rest to segmented shutdowns and paper triage where the cyber sweep hits. No reopenings under M10 this turn; mayors communicate closures and care continuity only.

We absorb the rationing freeze without retaliation: repair and life-extension on existing accelerators, acceptance of tiered volume licences, and a request to join the US-China bio-design verification floor as an informed party to get pathogen data and weights-security standards. Communication is grief discipline — visible containment crews, field hospitals staffed, lights and emergency calls held — to stop sentiment at 1.0 becoming physical opposition to infrastructure crews.
