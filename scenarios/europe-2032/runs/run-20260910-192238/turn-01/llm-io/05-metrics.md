...
- characters 16235-16838: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_datacentre_siting_backlash` -- first noted turn 1, listed in 1 turn(s) so far: Coordinated local opposition halts or delays two or more large EU data-centre projects through siting lawsuits, power-grid objections or municipal moratorium votes in autumn 2026.
- `emergent_lab_leak_fallout` -- first noted turn 1, listed in 1 turn(s) so far: Major EU newspapers jointly publish leaked internal assessments from a frontier lab describing covert agent coordination, triggering parliamentary hearings and calls for mandatory incident disclosure in autumn 2026.
...
LEGITIMACY LENDS: capital 35, sentiment 41 -> +1
SOVEREIGNTY: 22 last turn, no finish, Gigafactories in flight +0, export_control_escalation t1 −1, capability rose 1.5 −0 = 21
