...
- characters 13658-15681: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15725-17750: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17806-18631: `{{notepad}}` from the Game Master's notepad, carried across turns
