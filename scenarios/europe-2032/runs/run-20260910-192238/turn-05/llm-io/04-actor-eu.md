...
- characters 455-2478: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2522-4547: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6027-6493: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8641-10532: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU Entry-Level Transition Guarantee | 7 | small | 4 | 6 | own jurisdiction | resilience up via absorption, public_sentiment up, eu_political_capital stabilised | 2 | running |
