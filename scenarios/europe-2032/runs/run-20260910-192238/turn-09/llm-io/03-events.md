...
- characters 377-3533: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3577-5578: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5634-6835: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6898-31850: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32205-32856: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, ai_investment_collapse, export_control_escalation
- Turn 2 (7 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, openweight_frontier_release
- Turn 3 (6 turn(s) ago): knowledge_work_augmented
- Turn 4 (5 turn(s) ago): labour_displacement, member_state_defection
- Turn 5 (4 turn(s) ago): adoption_success, emergent_insurance_repricing, election_consolidation
- Turn 6 (3 turn(s) ago): eu_frontier_access_denied
- Turn 7 (2 turn(s) ago): export_control_escalation
- Turn 8 (1 turn(s) ago): bio_uplift_findings, openweight_frontier_release, taiwan_tension_rise, eu_frontier_access_denied
