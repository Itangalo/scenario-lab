...
- characters 106-12887: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12930-13122: `{{metrics_json}}` from the run's live metric values
- characters 13215-16371: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16415-18416: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18472-19011: `{{notepad}}` from the Game Master's notepad, carried across turns
