...
- characters 13494-13685: `{{metrics_json}}` from the run's live metric values
- characters 13778-15346: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15389-17877: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17933-18427: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | European Public Benefit Rollout | 2 |
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 elected consolidation president, takes office turn 6"}, {"op": "update", "table": "measures", "id": "M1", "fields": {"finish_turn": 7}, "grounds": "named priority"}]}
```
```
