...
- characters 453-2021: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2064-4552: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5041-5491: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7813-10286: `{{previous_actions}}` from the actor's own response from the previous turn
