...
| M8 | EU Hospital-Only Continuity and Opaque-Model Supervision Regime | 6 | small | 7 | 9 | own jurisdiction | resilience up modestly, ai_safety protected from further fall, eu_political_capital protected | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU State-to-State Assurance and Continuity Accord", "category": 8, "size": "small", "finish_turn": 10, "applies_to": "US and coalition and supply-chain partners", "targeted_effect": "eu_ai_sovereignty protected, ai_safety up modestly, resilience protected"}, "grounds": "US labs nationalised opens state negotiation and safety breakthrough adopt
  - Grounds: US labs nationalised opens state negotiation and safety breakthrough adoptable
