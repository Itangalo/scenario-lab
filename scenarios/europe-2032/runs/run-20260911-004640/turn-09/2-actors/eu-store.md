...
| M8 | EU Hospital-Only Continuity and Opaque-Model Supervision Regime | 6 | small | 7 | 9 | own jurisdiction | resilience up modestly, ai_safety protected from further fall, eu_political_capital protected | 2 | finished |
| M9 | EU State-to-State Assurance and Continuity Accord | 8 | small | 8 | 10 | US and coalition and supply-chain partners | eu_ai_sovereignty protected, ai_safety up modestly, resilience protected | 2 | running |
| M10 | EU Displacement Absorption and Essential-Service Hardening Pact | 6 | small | 9 | 11 | own jurisdiction | resilience up moderately, public_sentiment protected/up modestly, eu_political_capital protected | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Displacement Absorption and Essential-Service Hardening Pact", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, public_sentiment protected/up modestly, eu_political_capital protected"}, "grounds": "RSI onset plus labour displacement and eval anomaly demand abs
  - Grounds: RSI onset plus labour displacement and eval anomaly demand absorption over build-out
