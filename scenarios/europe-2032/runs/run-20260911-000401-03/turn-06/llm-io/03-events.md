...
- characters 1713-3849: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3905-4726: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4789-31248: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31603-31978: `{{event_history}}` from the run's own event record
...
- `emergent_grid_connection_freeze` -- first noted turn 5, listed in 1 turn(s) so far: Grid operators in France and Poland publicly refuse new AI-facility connections until EU-wide backup-power and islanding standards are agreed, freezing EuroHPC-linked clinic and factory rollouts through the winter.
...
- Turn 3 (3 turn(s) ago): capability_jump, bio_uplift_findings, labour_displacement
- Turn 4 (2 turn(s) ago): eval_anomaly_reports, medical_breakthrough, adoption_success
- Turn 5 (1 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, taiwan_blockade, election_retrenchment
