...
- characters 1791-3927: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4554-5008: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7568-10158: `{{previous_actions}}` from the actor's own response from the previous turn
...
- `two_year_commitment` (commitment): Hold European autonomy and essential services through the semiconductor rupture
...
| M7 | EU Supply Leverage and Continuity Compact | 8 | small | 5 | 8 | own jurisdiction with coalition and supply-chain partners | eu_ai_sovereignty protected/up modestly, resilience up, eu_political_capital protected | 2 | running |
