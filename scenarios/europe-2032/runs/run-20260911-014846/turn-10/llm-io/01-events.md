...
- characters 377-1910: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1953-4143: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4199-4654: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4717-28209: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28564-29294: `{{event_history}}` from the run's own event record
...
- Turn 3 (7 turn(s) ago): adoption_success, emergent_gigafactory_siting_backlash
- Turn 4 (6 turn(s) ago): openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise
- Turn 5 (5 turn(s) ago): eval_anomaly_reports, member_state_defection, election_retrenchment
- Turn 6 (4 turn(s) ago): loss_of_control_incident, eu_frontier_access_denied
- Turn 7 (3 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented, taiwan_tension_rise, export_control_escalation
- Turn 8 (2 turn(s) ago): loss_of_control_incident, opaque_reasoning, export_control_escalation, us_china_agreement
- Turn 9 (1 turn(s) ago): eval_anomaly_reports, labour_displacement, middle_power_coalition
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.15}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.08}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.1}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.07}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.04}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.075}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}]
```
