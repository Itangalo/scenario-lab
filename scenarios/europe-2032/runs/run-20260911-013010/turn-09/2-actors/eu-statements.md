...
- `two_year_commitment` (commitment): Rebuild trusted essential services and anchored allied capacity to survive open diffusion

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild trusted essential services and anchored allied capacity to survive open diffusion
