...
- `two_year_commitment` (commitment): Prevent open-weight capability from reaching dangerous thresholds while maintaining EU strategic autonomy

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Prevent open-weight capability from reaching dangerous thresholds while maintaining EU strategic autonomy
