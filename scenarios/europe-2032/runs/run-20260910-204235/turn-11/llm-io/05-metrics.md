...
- characters 107-13214: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13257-13446: `{{metrics_json}}` from the run's live metric values
- characters 13539-14979: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15023-16748: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16804-17533: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Agent Loss-of-Control Containment Net | 2 |
