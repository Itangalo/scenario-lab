...
- characters 376-2113: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2156-4311: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4367-5205: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5268-28169: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28524-29190: `{{event_history}}` from the run's own event record
...
- `emergent_compute_grey_market_crackdown` -- first noted turn 6, listed in 2 turn(s) so far: Accelerator grey market centred on EU lithography servicing and spare parts is exposed, forcing emergency export enforcement and criminal probes.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, knowledge_work_augmented, supply_chain_coercion, emergent_lab_training_halt_disclosure
- Turn 2 (6 turn(s) ago): bio_incident, taiwan_tension_rise
- Turn 3 (5 turn(s) ago): openweight_frontier_release
- Turn 4 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, knowledge_work_augmented
- Turn 5 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, taiwan_blockade, openweight_frontier_release, emergent_screening_evasion_market, election_retrenchment
- Turn 6 (2 turn(s) ago): knowledge_work_augmented
- Turn 7 (1 turn(s) ago): member_state_defection, joint_threat_response
