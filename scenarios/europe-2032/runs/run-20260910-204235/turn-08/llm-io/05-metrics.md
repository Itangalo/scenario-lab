...
- characters 105-13254: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13297-13489: `{{metrics_json}}` from the run's live metric values
- characters 13582-15319: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15362-17517: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17573-18134: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | European Public Results Sprint | 2 |
