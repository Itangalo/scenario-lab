...
- characters 1537-3360: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3416-3906: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3969-26870: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27225-28047: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Denial Continuity and Recovery Shield −2, priority −1 = −2 + 1 more for the priority = −3
PROPOSAL BONUS: EU Denial Continuity and Recovery Shield (cat 6, small) +4 — cyber_major_incident and eu_frontier_access_denied both fired this turn and this answers both directly
LEGITIMACY LENDS: capital 12, sentiment 10 -> none, capital higher
SOVEREIGNTY: 23 last turn, no cat 4 finishes, no cat 4 in flight +0, eu_frontier_access_denied t9 −2, capability rose 0.5 −0 = 21
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, knowledge_work_augmented, supply_chain_coercion, emergent_lab_training_halt_disclosure
- Turn 2 (8 turn(s) ago): bio_incident, taiwan_tension_rise
- Turn 3 (7 turn(s) ago): openweight_frontier_release
- Turn 4 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, knowledge_work_augmented
- Turn 5 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, taiwan_blockade, openweight_frontier_release, emergent_screening_evasion_market, election_retrenchment
- Turn 6 (4 turn(s) ago): knowledge_work_augmented
- Turn 7 (3 turn(s) ago): member_state_defection, joint_threat_response
- Turn 8 (2 turn(s) ago): adoption_success
- Turn 9 (1 turn(s) ago): cyber_major_incident, labour_displacement, eu_frontier_access_denied, adoption_success
