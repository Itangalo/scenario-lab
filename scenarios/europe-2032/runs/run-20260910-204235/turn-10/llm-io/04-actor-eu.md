...
- characters 1615-3438: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4515-5091: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7969-11007: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Denial Continuity and Recovery Shield | 6 | small | 9 | 11 | own jurisdiction | resilience up substantially, public_sentiment up slightly | 2 | running |
