...
- characters 12869-13060: `{{metrics_json}}` from the run's live metric values
- characters 13153-14271: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14314-16137: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16193-16683: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Denial Continuity and Recovery Shield | 2 |
