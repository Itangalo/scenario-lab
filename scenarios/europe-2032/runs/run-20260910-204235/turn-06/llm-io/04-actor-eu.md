...
- characters 1815-4689: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5281-5842: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8268-11522: `{{previous_actions}}` from the actor's own response from the previous turn
