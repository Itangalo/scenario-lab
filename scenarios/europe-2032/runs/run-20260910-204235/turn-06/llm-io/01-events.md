...
- characters 1737-4611: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4667-5218: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5281-25072: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 25427-25970: `{{event_history}}` from the run's own event record
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, knowledge_work_augmented, supply_chain_coercion, emergent_lab_training_halt_disclosure
- Turn 2 (4 turn(s) ago): bio_incident, taiwan_tension_rise
- Turn 3 (3 turn(s) ago): openweight_frontier_release
- Turn 4 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, knowledge_work_augmented
- Turn 5 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, taiwan_blockade, openweight_frontier_release, emergent_screening_evasion_market, election_retrenchment
