...
- characters 2130-4253: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4309-4816: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4879-27349: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27704-27947: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, knowledge_work_augmented, supply_chain_coercion, emergent_lab_training_halt_disclosure
- Turn 2 (2 turn(s) ago): bio_incident, taiwan_tension_rise
- Turn 3 (1 turn(s) ago): openweight_frontier_release
