...
- characters 105-13268: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13311-13503: `{{metrics_json}}` from the run's live metric values
- characters 13596-15307: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15350-17473: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17529-18357: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M5 EU Distributed Misuse Shield −2, priority −1 = −9
PROPOSAL BONUS: EU Distributed Misuse Shield (cat 6, small) +3 — openweight_frontier_release landed this turn distributing bio/cyber uplift plus prior bio_incident casualties, this answers both directly
LEGITIMACY LENDS: capital 35, sentiment 33 -> none, capital higher
SOVEREIGNTY: 20 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 20

## Emerging developments (tracked)

- `emergent_screening_evasion_market` -- first noted turn 4, listed in 1 turn(s) so far: Small foreign DNA synthesis brokers openly advertise no-screen orders to EU addresses after large providers comply, triggering seizures of mail-order reagents and a public enforcement test case.
...
## Notepad
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M6 EU Agent Containment and Continuity Protocol −2, priority −1 = −9
PROPOSAL BONUS: EU Agent Containment and Continuity Protocol (cat 6, small) +4 — cyber_major_incident and loss_of_control_incident both landed this turn with public-service disruption and days-long containment uncertainty, this answers both directly
LEGITIMACY LENDS: capital 27, sentiment 28 -> +2
SOVEREIGNTY: 20 last turn, no category 4 finish, ai_investment_collapse t4 −2, capability rose 1.0 −0 = 18
