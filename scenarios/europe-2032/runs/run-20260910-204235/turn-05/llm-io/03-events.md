...
- characters 377-1543: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1587-3708: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3764-4642: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4705-26514: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26869-27235: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, knowledge_work_augmented, supply_chain_coercion, emergent_lab_training_halt_disclosure
- Turn 2 (3 turn(s) ago): bio_incident, taiwan_tension_rise
- Turn 3 (2 turn(s) ago): openweight_frontier_release
- Turn 4 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, knowledge_work_augmented
