...
- characters 1665-3786: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6743-7228: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9479-11498: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Agent Containment and Continuity Protocol | 6 | small | 4 | 6 | own jurisdiction | resilience up substantially, ai_safety up slightly via containment | 2 | running |
