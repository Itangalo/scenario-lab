...
- characters 13278-14444: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14488-16609: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16665-17222: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 59.0, "openweight_capability": 54.0, "ai_safety": 17.0, "resilience": 48.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 19.0, "public_sentiment": 16.0}
```
