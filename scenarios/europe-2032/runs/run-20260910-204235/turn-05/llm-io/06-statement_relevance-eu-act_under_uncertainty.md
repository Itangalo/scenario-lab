...
- characters 3562-5683: `{{world_state}}` from background/context.md, seeded as the opening world state
- characters 5716-8970: `{{previous_actions}}` from the actor's own response from the previous turn
...
Rewrite it to read: We will commit before the picture is clear, and sequence scarce capital behind containment first and sovereign leverage second, accepting being wrong sometimes as the price of not being late

## The development the actor names as its trigger

political capital at 29 with sentiment at 28 and Taiwan blockade plus open-weight frontier release arriving together
...
```json
{
  "quote": "political capital at 29 with sentiment at 28 and Taiwan blockade plus open-weight frontier release arriving together",
  "found": true,
  "verdict": "BEARS",
  "reason": "The blockade and open-weight release directly impact EU's capital allocation priorities, altering the cost and strategic context of acting under uncertainty."
}
```
```
