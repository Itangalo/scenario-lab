...
- characters 106-12826: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12869-13058: `{{metrics_json}}` from the run's live metric values
- characters 13151-14262: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14305-16621: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16677-17197: `{{notepad}}` from the Game Master's notepad, carried across turns
