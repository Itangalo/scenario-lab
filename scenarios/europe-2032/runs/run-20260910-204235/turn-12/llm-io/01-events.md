...
- characters 374-1485: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1528-3844: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3900-4705: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4768-27575: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27930-28899: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Agent Loss-of-Control Containment Net −2, priority −1 = −2 + 1 more for the priority = −3, but capital 7 below 20 so priority has no effect and no cost, charged −2
PROPOSAL BONUS: EU Agent Loss-of-Control Containment Net (cat 6, small) +2 — loss_of_control_incident landed this turn and this answers it directly
...
- `emergent_opaque_system_work_stoppage` -- first noted turn 11, listed in 1 turn(s) so far: Municipal unions coordinate refusal to operate opaque triage and permit assistants without legible reasons, forcing service suspensions in several cities.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, knowledge_work_augmented, supply_chain_coercion, emergent_lab_training_halt_disclosure
- Turn 2 (10 turn(s) ago): bio_incident, taiwan_tension_rise
- Turn 3 (9 turn(s) ago): openweight_frontier_release
- Turn 4 (8 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, knowledge_work_augmented
- Turn 5 (7 turn(s) ago): cyber_major_incident, loss_of_control_incident, taiwan_blockade, openweight_frontier_release, emergent_screening_evasion_market, election_retrenchment
- Turn 6 (6 turn(s) ago): knowledge_work_augmented
- Turn 7 (5 turn(s) ago): member_state_defection, joint_threat_response
- Turn 8 (4 turn(s) ago): adoption_success
- Turn 9 (3 turn(s) ago): cyber_major_incident, labour_displacement, eu_frontier_access_denied, adoption_success
- Turn 10 (2 turn(s) ago): opaque_reasoning, eu_frontier_access_denied
- Turn 11 (1 turn(s) ago): loss_of_control_incident, eval_anomaly_reports
