...
- characters 106-13233: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13276-13468: `{{metrics_json}}` from the run's live metric values
- characters 13561-14849: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14893-16848: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16904-17570: `{{notepad}}` from the Game Master's notepad, carried across turns
