...
- characters 377-1665: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1709-3664: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3720-4386: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4449-27350: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27705-28299: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: M1 InvestAI Gigafactories −3, M7 EU Lithography and Secure Compute Pact −2, priority −1 = −6
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 19, sentiment 16 -> none, sentiment below capital
SOVEREIGNTY: 16 last turn, Tech sovereignty package finishes t6 +4, Gigafactories in flight +0, no capacity event, capability rose 1.0 −0 = 20

## Emerging developments (tracked)

- `emergent_compute_grey_market_crackdown` -- first noted turn 6, listed in 1 turn(s) so far: Accelerator grey market centred on EU lithography servicing and spare parts is exposed, forcing emergency export enforcement and criminal probes.
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, knowledge_work_augmented, supply_chain_coercion, emergent_lab_training_halt_disclosure
- Turn 2 (5 turn(s) ago): bio_incident, taiwan_tension_rise
- Turn 3 (4 turn(s) ago): openweight_frontier_release
- Turn 4 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, knowledge_work_augmented
- Turn 5 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, taiwan_blockade, openweight_frontier_release, emergent_screening_evasion_market, election_retrenchment
- Turn 6 (1 turn(s) ago): knowledge_work_augmented
