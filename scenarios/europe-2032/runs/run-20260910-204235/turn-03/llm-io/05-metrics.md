...
- characters 13729-15130: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15174-17427: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17483-18038: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Distributed Misuse Shield | 2 |
...
## Metrics
```json
{"ai_capability": 56.5, "openweight_capability": 51.0, "ai_safety": 28.0, "resilience": 46.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 35.0, "public_sentiment": 33.0}
```
