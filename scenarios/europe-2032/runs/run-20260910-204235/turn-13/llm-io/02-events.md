...
- characters 375-1890: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1934-3624: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3680-4123: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4186-26993: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27348-28404: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, knowledge_work_augmented, supply_chain_coercion, emergent_lab_training_halt_disclosure
- Turn 2 (11 turn(s) ago): bio_incident, taiwan_tension_rise
- Turn 3 (10 turn(s) ago): openweight_frontier_release
- Turn 4 (9 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, knowledge_work_augmented
- Turn 5 (8 turn(s) ago): cyber_major_incident, loss_of_control_incident, taiwan_blockade, openweight_frontier_release, emergent_screening_evasion_market, election_retrenchment
- Turn 6 (7 turn(s) ago): knowledge_work_augmented
- Turn 7 (6 turn(s) ago): member_state_defection, joint_threat_response
- Turn 8 (5 turn(s) ago): adoption_success
- Turn 9 (4 turn(s) ago): cyber_major_incident, labour_displacement, eu_frontier_access_denied, adoption_success
- Turn 10 (3 turn(s) ago): opaque_reasoning, eu_frontier_access_denied
- Turn 11 (2 turn(s) ago): loss_of_control_incident, eval_anomaly_reports
- Turn 12 (1 turn(s) ago): eval_anomaly_reports, emergent_opaque_system_work_stoppage
