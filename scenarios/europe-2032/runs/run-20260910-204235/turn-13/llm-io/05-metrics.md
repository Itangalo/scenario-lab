...
- characters 107-13224: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13267-13456: `{{metrics_json}}` from the run's live metric values
- characters 13549-15064: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15108-16798: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16854-17633: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Essential Services Restoration Shield | 2 |
...
PORTFOLIO CHARGE t12: M11 EU Agent Loss-of-Control Containment Net −2, priority −1 = −2 + 1 more for the priority = −2, but capital 8 below 20 so priority has no effect and no cost, charged −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 6 after charge, sentiment 2 -> none, capital higher
SOVEREIGNTY: 19 last turn, no cat 4 finishes, no cat 4 in flight +0, no capacity event, capability rose 0.5 −0 = 19

## Emerging developments (tracked)

- `emergent_municipal_legibility_moratorium` -- first noted turn 13, listed in 1 turn(s) so far: A cross-city municipal coalition votes to suspend all opaque triage and permit AI pending independent legibility certification, formalising the wildcat refusals into a political standoff with Brussels.
...
## Notepad
PORTFOLIO CHARGE t13: M12 EU Essential Services Restoration Shield −2, priority has no effect and no cost (capital 2 below 20) = −2
PROPOSAL BONUS: EU Essential Services Restoration Shield (cat 6, small) +3 — cyber_major_incident + sabotage outages landed this turn and this answers restoration directly
LEGITIMACY LENDS: capital 3 after charge/finish/bonus/events, sentiment 0.5 -> none, capital higher
SOVEREIGNTY: 19 last turn, no cat 4 finishes, no cat 4 in flight +0, no capacity event, capability rose 0.5 −0 = 19
## Store changes
```json
{"store": []}
