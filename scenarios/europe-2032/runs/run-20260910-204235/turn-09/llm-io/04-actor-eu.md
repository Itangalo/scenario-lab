...
- characters 455-2326: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2370-4132: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5646-6207: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8768-10590: `{{previous_actions}}` from the actor's own response from the previous turn
