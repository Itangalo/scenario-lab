...
- characters 377-2248: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2292-4054: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4110-4518: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4581-27482: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27837-28546: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M8 EU Joint Threat Response Accession −2, M9 European Public Results Sprint −2, priority −1 = −5
PROPOSAL BONUS: none — new cat 9 measure captures positive adoption window, not a negative event from last three rounds
LEGITIMACY LENDS: capital 12, sentiment 17 -> +2
SOVEREIGNTY: 23 last turn, M7 finishes t8 cat 8 +0, no capacity event, no cat 4 in flight +0, capability rose 0.5 −0 = 23
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, knowledge_work_augmented, supply_chain_coercion, emergent_lab_training_halt_disclosure
- Turn 2 (7 turn(s) ago): bio_incident, taiwan_tension_rise
- Turn 3 (6 turn(s) ago): openweight_frontier_release
- Turn 4 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, knowledge_work_augmented
- Turn 5 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, taiwan_blockade, openweight_frontier_release, emergent_screening_evasion_market, election_retrenchment
- Turn 6 (3 turn(s) ago): knowledge_work_augmented
- Turn 7 (2 turn(s) ago): member_state_defection, joint_threat_response
