...
- characters 106-13330: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13373-13565: `{{metrics_json}}` from the run's live metric values
- characters 13658-15529: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15573-17335: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17391-17799: `{{notepad}}` from the Game Master's notepad, carried across turns
