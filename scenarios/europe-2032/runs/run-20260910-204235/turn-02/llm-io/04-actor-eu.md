...
- characters 454-1713: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1756-3900: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4530-5015: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6492-8600: `{{previous_actions}}` from the actor's own response from the previous turn
