...
- characters 13269-14528: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14571-16715: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16771-17599: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Bio Detection and Response Surge | 2 |
