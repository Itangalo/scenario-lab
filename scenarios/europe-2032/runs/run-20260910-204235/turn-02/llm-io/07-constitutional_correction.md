...
- Metric change violates Constitutional Constraint 9: `eu_political_capital` decreases by 14 points (from 44.0 to 30.0), which exceeds the hard bound of 25-point maximum movement in one turn. While downward movements are allowed, no metric — including political capital — may move more than 25 points in absolute value in a single turn.
