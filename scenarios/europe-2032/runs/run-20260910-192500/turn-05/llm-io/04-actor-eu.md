...
- characters 455-1488: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1532-3391: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5570-6046: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8132-9682: `{{previous_actions}}` from the actor's own response from the previous turn
