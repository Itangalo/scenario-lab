...
- characters 377-1410: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1454-3313: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3369-4077: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4140-32625: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32980-33284: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Evaluation Access Cell −2, M5 EU Municipal Recovery and Isolation Fund −2, priority −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 34, sentiment 38 -> +2
SOVEREIGNTY: 21 last turn, no capacity event, Gigafactories/Tech package in flight +1, capability rose 2.0 −1 = 21

## Emerging developments (tracked)

- `emergent_cyber_insurance_repricing` -- first noted turn 4, listed in 1 turn(s) so far: Major European health insurers quietly reprice municipal cyber risk after the autumn sweep, making EU-conditional restoration funding a de facto requirement for coverage renewal.
...
- Turn 2 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, knowledge_work_augmented
- Turn 3 (2 turn(s) ago): cyber_major_incident, export_control_escalation
