...
- characters 13837-14870: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14914-16773: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16829-17537: `{{notepad}}` from the Game Master's notepad, carried across turns
