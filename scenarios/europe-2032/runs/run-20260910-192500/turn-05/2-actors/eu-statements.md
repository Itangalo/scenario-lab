...
- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold an independent European AI footing through supply rupture by wielding upstream leverage and hardening what open weights have already exposed
