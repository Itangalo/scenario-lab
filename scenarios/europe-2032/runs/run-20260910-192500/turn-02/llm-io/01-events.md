...
- characters 376-1839: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1882-4088: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4144-5258: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5321-29548: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29903-29963: `{{event_history}}` from the run's own event record
