...
- characters 105-13022: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13065-13257: `{{metrics_json}}` from the run's live metric values
- characters 13350-14813: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14856-17062: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17118-18232: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 50.0, "ai_safety": 30.0, "resilience": 37.0, "eu_ai_sovereignty": 23.0, "eu_political_capital": 35.0, "public_sentiment": 44.0}
```
