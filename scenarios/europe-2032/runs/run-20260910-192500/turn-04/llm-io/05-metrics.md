...
- characters 13364-14461: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14504-16385: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16441-17284: `{{notepad}}` from the Game Master's notepad, carried across turns
