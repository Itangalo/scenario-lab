...
- characters 376-1473: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1516-3397: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3453-3990: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4053-28957: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29312-29541: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, knowledge_work_augmented
- Turn 3 (1 turn(s) ago): cyber_major_incident, export_control_escalation
