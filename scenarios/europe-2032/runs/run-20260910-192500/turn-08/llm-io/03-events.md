...
- characters 375-1718: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1761-4581: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4637-5122: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5185-31756: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32111-32759: `{{event_history}}` from the run's own event record
...
- Turn 2 (6 turn(s) ago): cyber_major_incident, eval_anomaly_reports, knowledge_work_augmented
- Turn 3 (5 turn(s) ago): cyber_major_incident, export_control_escalation
- Turn 4 (4 turn(s) ago): openweight_frontier_release, taiwan_tension_rise
- Turn 5 (3 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, election_retrenchment
- Turn 6 (2 turn(s) ago): supply_chain_coercion, member_state_defection, emergent_cyber_insurance_repricing
- Turn 7 (1 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release, export_control_escalation
