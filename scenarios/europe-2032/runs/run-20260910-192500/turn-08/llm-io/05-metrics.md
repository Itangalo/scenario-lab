...
- characters 105-13488: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13531-13722: `{{metrics_json}}` from the run's live metric values
- characters 13815-15158: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15201-18021: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18077-18562: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Shopfloor Transition Pact | 2 |
...
## Metrics
```json
{"ai_capability": 63.8, "openweight_capability": 61.4, "ai_safety": 18.0, "resilience": 46.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 13.0, "public_sentiment": 14.0}
```
