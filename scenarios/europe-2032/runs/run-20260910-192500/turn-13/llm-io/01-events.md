...
- characters 377-2098: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2142-3563: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3619-4028: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4091-30224: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30579-31567: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Trusted Recovery Assistants −2, EU Trusted Therapies Access −2, priority −1 = −5
PROPOSAL BONUS: none — medical breakthrough is positive window, not negative event from last three rounds, and rule 6 bonus only for negative events
LEGITIMACY LENDS: capital 14, sentiment 18.5 -> +1
...
- Turn 2 (11 turn(s) ago): cyber_major_incident, eval_anomaly_reports, knowledge_work_augmented
- Turn 3 (10 turn(s) ago): cyber_major_incident, export_control_escalation
- Turn 4 (9 turn(s) ago): openweight_frontier_release, taiwan_tension_rise
- Turn 5 (8 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, election_retrenchment
- Turn 6 (7 turn(s) ago): supply_chain_coercion, member_state_defection, emergent_cyber_insurance_repricing
- Turn 7 (6 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release, export_control_escalation
- Turn 8 (5 turn(s) ago): cyber_major_incident, embodied_ai_deployment, export_control_escalation
- Turn 9 (4 turn(s) ago): ai_investment_collapse, middle_power_coalition
- Turn 10 (3 turn(s) ago): cyber_major_incident
- Turn 11 (2 turn(s) ago): opaque_reasoning, knowledge_work_augmented
