...
- characters 13461-13653: `{{metrics_json}}` from the run's live metric values
- characters 13746-15143: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15187-17296: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17352-17825: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Evaluation Access Cell | 2 |
| M5 | EU Municipal Recovery and Isolation Fund | 2 |
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Evaluation Access Cell −2, EU Municipal Recovery and Isolation Fund −2, priority −1 = −11
PROPOSAL BONUS: EU Municipal Recovery and Isolation Fund (cat 6, small) +3 — cyber_major_incident landed this turn and this answers municipal/health gap directly
LEGITIMACY LENDS: capital 32, sentiment 38 -> +2
SOVEREIGNTY: 23 last turn, no capacity event finishes, Gigafactories/Tech package in flight +1, export_control_escalation t3 −2, capability rose 2.0 −1 = 21
