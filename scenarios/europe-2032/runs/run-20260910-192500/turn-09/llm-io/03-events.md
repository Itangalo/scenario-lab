...
- characters 377-1722: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1766-4011: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4067-4517: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4580-31151: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31506-32252: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Shopfloor Transition Pact −2, priority −1 = −3
PROPOSAL BONUS: EU Shopfloor Transition Pact (cat 7, small) +2 — embodied deployment dividing labour market this turn severe and sentiment at 19, this answers it directly
LEGITIMACY LENDS: capital 11, sentiment 14 -> +2
SOVEREIGNTY: 20 last turn, no capacity measure finishes, no capacity measure in flight +0, export_control_escalation t8 −2, capability rose 0.8 no penalty = 18
...
- Turn 2 (7 turn(s) ago): cyber_major_incident, eval_anomaly_reports, knowledge_work_augmented
- Turn 3 (6 turn(s) ago): cyber_major_incident, export_control_escalation
- Turn 4 (5 turn(s) ago): openweight_frontier_release, taiwan_tension_rise
- Turn 5 (4 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, election_retrenchment
- Turn 6 (3 turn(s) ago): supply_chain_coercion, member_state_defection, emergent_cyber_insurance_repricing
- Turn 7 (2 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release, export_control_escalation
- Turn 8 (1 turn(s) ago): cyber_major_incident, embodied_ai_deployment, export_control_escalation
