...
- characters 13670-15015: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15059-17304: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17360-18122: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Middle-Power Supply Pact | 2 |
...
## Metrics
```json
{"ai_capability": 64.5, "openweight_capability": 62.6, "ai_safety": 16.0, "resilience": 45.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 17.0, "public_sentiment": 17.0}
```
