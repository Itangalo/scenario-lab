...
- characters 1844-4089: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4928-5448: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7945-9945: `{{previous_actions}}` from the actor's own response from the previous turn
