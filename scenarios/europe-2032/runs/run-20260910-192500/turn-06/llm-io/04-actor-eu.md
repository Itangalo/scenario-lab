...
- characters 1648-3819: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4915-5435: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7689-10192: `{{previous_actions}}` from the actor's own response from the previous turn
