...
- characters 1570-3741: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3797-4561: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4624-30592: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30947-31367: `{{event_history}}` from the run's own event record
...
- `emergent_cyber_insurance_repricing` -- first noted turn 4, listed in 2 turn(s) so far: Major European health insurers quietly reprice municipal cyber risk after the autumn sweep, making EU-conditional restoration funding a de facto requirement for coverage renewal.
...
- Turn 2 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, knowledge_work_augmented
- Turn 3 (3 turn(s) ago): cyber_major_incident, export_control_escalation
- Turn 4 (2 turn(s) ago): openweight_frontier_release, taiwan_tension_rise
- Turn 5 (1 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, election_retrenchment
