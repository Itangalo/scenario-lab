...
- characters 377-1942: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1985-4025: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4081-4856: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4919-30896: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31251-32070: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Middle-Power Supply Pact −2, priority −1 = −3
PROPOSAL BONUS: EU Middle-Power Supply Pact (cat 8, small) +2 — ai_investment_collapse strands build-outs this turn and this answers it directly via joint bargaining
LEGITIMACY LENDS: capital 17, sentiment 17 -> none, capital not below sentiment
SOVEREIGNTY: 18 last turn, no capacity measure finishes +0, no cat4 in flight +0, middle_power_coalition t9 +2, capability rose 0.7 no penalty = 20

## Emerging developments (tracked)

- `emergent_port_robot_blockade` -- first noted turn 9, listed in 1 turn(s) so far: Coordinated dockworker and works-council blockades halt humanoid deployments at Rotterdam and Antwerp for weeks after a workplace accident blamed on pacing algorithms, spreading to Duisburg.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, eu_access_secured
- Turn 2 (8 turn(s) ago): cyber_major_incident, eval_anomaly_reports, knowledge_work_augmented
- Turn 3 (7 turn(s) ago): cyber_major_incident, export_control_escalation
- Turn 4 (6 turn(s) ago): openweight_frontier_release, taiwan_tension_rise
- Turn 5 (5 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, election_retrenchment
- Turn 6 (4 turn(s) ago): supply_chain_coercion, member_state_defection, emergent_cyber_insurance_repricing
- Turn 7 (3 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release, export_control_escalation
- Turn 8 (2 turn(s) ago): cyber_major_incident, embodied_ai_deployment, export_control_escalation
- Turn 9 (1 turn(s) ago): ai_investment_collapse, middle_power_coalition
