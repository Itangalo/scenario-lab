...
- characters 455-2020: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2063-4103: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4653-5134: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7797-10038: `{{previous_actions}}` from the actor's own response from the previous turn
