...
- characters 378-1652: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1696-3745: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3801-4537: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4600-31430: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31785-32653: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Critical Services Restoration Surge −2, priority −1 = −3
PROPOSAL BONUS: EU Critical Services Restoration Surge (cat 6, small) +3 — cyber_major_incident lands this turn and this answers it directly via restoration teams
LEGITIMACY LENDS: capital 21, sentiment 12 -> none, capital above sentiment
SOVEREIGNTY: 20 last turn, no capacity event, no cat4 in flight +0, capability rose 0.8 no penalty = 20

## Emerging developments (tracked)

- `emergent_port_robot_blockade` -- first noted turn 9, listed in 2 turn(s) so far: Coordinated dockworker and works-council blockades halt humanoid deployments at Rotterdam and Antwerp for weeks after a workplace accident blamed on pacing algorithms, spreading to Duisburg.
...
- Turn 2 (9 turn(s) ago): cyber_major_incident, eval_anomaly_reports, knowledge_work_augmented
- Turn 3 (8 turn(s) ago): cyber_major_incident, export_control_escalation
- Turn 4 (7 turn(s) ago): openweight_frontier_release, taiwan_tension_rise
- Turn 5 (6 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, election_retrenchment
- Turn 6 (5 turn(s) ago): supply_chain_coercion, member_state_defection, emergent_cyber_insurance_repricing
- Turn 7 (4 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release, export_control_escalation
- Turn 8 (3 turn(s) ago): cyber_major_incident, embodied_ai_deployment, export_control_escalation
- Turn 9 (2 turn(s) ago): ai_investment_collapse, middle_power_coalition
- Turn 10 (1 turn(s) ago): cyber_major_incident
