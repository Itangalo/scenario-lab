...
- characters 107-13359: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13402-13594: `{{metrics_json}}` from the run's live metric values
- characters 13687-14961: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15005-17054: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17110-17534: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Trusted Recovery Assistants | 2 |
...
## Notepad
PORTFOLIO CHARGE t11: EU Trusted Recovery Assistants −2, priority −1 = −3
PROPOSAL BONUS: none — knowledge_work_augmented blocks rule 6 bonus for addressing recent negative event, and small cat 9 gestures at old stoppages earns nothing this turn
LEGITIMACY LENDS: capital 19, sentiment 16 -> none, capital above sentiment
