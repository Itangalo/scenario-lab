...
- characters 376-1601: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1644-3787: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3843-4268: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4331-30464: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30819-31758: `{{event_history}}` from the run's own event record
...
- Turn 2 (10 turn(s) ago): cyber_major_incident, eval_anomaly_reports, knowledge_work_augmented
- Turn 3 (9 turn(s) ago): cyber_major_incident, export_control_escalation
- Turn 4 (8 turn(s) ago): openweight_frontier_release, taiwan_tension_rise
- Turn 5 (7 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, election_retrenchment
- Turn 6 (6 turn(s) ago): supply_chain_coercion, member_state_defection, emergent_cyber_insurance_repricing
- Turn 7 (5 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release, export_control_escalation
- Turn 8 (4 turn(s) ago): cyber_major_incident, embodied_ai_deployment, export_control_escalation
- Turn 9 (3 turn(s) ago): ai_investment_collapse, middle_power_coalition
- Turn 10 (2 turn(s) ago): cyber_major_incident
- Turn 11 (1 turn(s) ago): opaque_reasoning, knowledge_work_augmented
