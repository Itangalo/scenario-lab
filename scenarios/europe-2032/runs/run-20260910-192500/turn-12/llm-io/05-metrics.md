...
- characters 106-12962: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13005-13196: `{{metrics_json}}` from the run's live metric values
- characters 13289-14514: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14557-16700: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16756-17181: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M12 | EU Trusted Therapies Access | 2 |
