...
- `two_year_commitment` (commitment): Rebuild societal resilience and public consent so essential services hold through AI disruption

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild societal resilience and public consent so essential services hold through AI disruption
