...
| M9 | EU Automated Decisions Redress and Audit | 2 | small | 7 | 9 | own jurisdiction | public_sentiment up, eu_political_capital protected via restored trust | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Automated Decisions Redress and Audit", "category": 2, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, eu_political_capital protected via restored trust"}, "grounds": "to answer internal-origin scandal while capital is critically low"}
  - Grounds: to answer internal-origin scandal while capital is critically low
