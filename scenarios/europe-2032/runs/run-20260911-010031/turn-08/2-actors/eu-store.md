...
| M9 | EU Automated Decisions Redress and Audit | 2 | small | 7 | 8 | own jurisdiction | public_sentiment up, eu_political_capital protected via restored trust | 2 | finished |
| M10 | EU Bio Emergency Shield and Medical Access | 6 | small | 8 | 10 | own jurisdiction | resilience up, public_sentiment up if therapies secured, ai_safety loss contained | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio Emergency Shield and Medical Access", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, public_sentiment up if therapies secured, ai_safety loss contained"}, "grounds": "to answer bio incident and bio-uplift findings while capturing medical breakthrough"}
  - Grounds: to answer bio incident and bio-uplift findings while capturing medical breakthrough
