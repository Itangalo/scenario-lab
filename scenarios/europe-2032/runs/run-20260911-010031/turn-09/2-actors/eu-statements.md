...
- `two_year_commitment` (commitment): Rebuild trust and resilience so European AI delivers visible public benefit without cascading harm

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild trust and resilience so European AI delivers visible public benefit without cascading harm
