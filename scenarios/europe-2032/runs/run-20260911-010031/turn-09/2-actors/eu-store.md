...
| M11 | EU Trusted Public AI Dividend | 9 | small | 9 | 11 | own jurisdiction | public_sentiment up, eu_political_capital up via visible benefit, resilience up slightly | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Trusted Public AI Dividend", "category": 9, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, eu_political_capital up via visible benefit, resilience up slightly"}, "grounds": "to capture adoption success window and rebuild trust"}
  - Grounds: to capture adoption success window and rebuild trust
