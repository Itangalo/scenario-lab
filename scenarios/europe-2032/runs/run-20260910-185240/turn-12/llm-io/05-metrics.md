...
- characters 13191-14288: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14331-16299: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16355-16727: `{{notepad}}` from the Game Master's notepad, carried across turns
