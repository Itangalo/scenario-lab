...
- characters 373-1470: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1513-3481: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3537-3909: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3972-29748: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30103-31228: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: no measures in flight, no priority = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0.0, sentiment 5.0 -> +0, capital held at floor, no lend applied while capital at zero with no delivery
SOVEREIGNTY: 7 last turn, no cat4 finish, no capacity in flight +0, us_labs_nationalised t11 −3, capability rose 1.5 −0 = 4
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, loss_of_control_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 2 (10 turn(s) ago): capability_jump, ai_investment_collapse, emergent_cyber_insurance_repricing
- Turn 3 (9 turn(s) ago): cyber_major_incident, capability_jump
- Turn 4 (8 turn(s) ago): emergent_permit_blockade_freeze
- Turn 5 (7 turn(s) ago): election_consolidation
- Turn 6 (6 turn(s) ago): export_control_escalation, eu_frontier_access_denied
- Turn 7 (5 turn(s) ago): bio_uplift_findings, opaque_reasoning, research_breakthrough, export_control_escalation, eu_frontier_access_denied
- Turn 8 (4 turn(s) ago): bio_incident, research_breakthrough, eu_frontier_access_denied
- Turn 9 (3 turn(s) ago): cyber_major_incident, catastrophic_bio_incident, rsi_onset, labour_displacement, export_control_escalation, emergent_anti_compute_litigation_wave
- Turn 10 (2 turn(s) ago): eval_anomaly_reports, medical_breakthrough, eu_frontier_access_denied
- Turn 11 (1 turn(s) ago): bio_uplift_findings, research_breakthrough, taiwan_tension_rise, us_labs_nationalised, adoption_success
