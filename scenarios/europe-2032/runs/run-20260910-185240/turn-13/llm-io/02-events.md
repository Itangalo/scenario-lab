...
- characters 374-1864: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1908-3971: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4027-4389: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4452-30228: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30583-31817: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: no measures in flight, no priority = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0.0, sentiment 3.0 -> +0, capital held at floor, no lend applied while capital at zero with no delivery
SOVEREIGNTY: 4 last turn, no capacity event, no cat4 finish, no capacity in flight +0, capability rose 1.5 −0 = 4
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, loss_of_control_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 2 (11 turn(s) ago): capability_jump, ai_investment_collapse, emergent_cyber_insurance_repricing
- Turn 3 (10 turn(s) ago): cyber_major_incident, capability_jump
- Turn 4 (9 turn(s) ago): emergent_permit_blockade_freeze
- Turn 5 (8 turn(s) ago): election_consolidation
- Turn 6 (7 turn(s) ago): export_control_escalation, eu_frontier_access_denied
- Turn 7 (6 turn(s) ago): bio_uplift_findings, opaque_reasoning, research_breakthrough, export_control_escalation, eu_frontier_access_denied
- Turn 8 (5 turn(s) ago): bio_incident, research_breakthrough, eu_frontier_access_denied
- Turn 9 (4 turn(s) ago): cyber_major_incident, catastrophic_bio_incident, rsi_onset, labour_displacement, export_control_escalation, emergent_anti_compute_litigation_wave
- Turn 10 (3 turn(s) ago): eval_anomaly_reports, medical_breakthrough, eu_frontier_access_denied
- Turn 11 (2 turn(s) ago): bio_uplift_findings, research_breakthrough, taiwan_tension_rise, us_labs_nationalised, adoption_success
- Turn 12 (1 turn(s) ago): medical_breakthrough, catastrophic_loss_of_control_incident, labour_displacement
