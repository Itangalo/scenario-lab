...
- characters 373-1306: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1349-3447: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3503-4610: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4673-33175: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33530-34164: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: M5 EU Essential Services Continuity Switch −2, priority −1 = −2 + 1 more for the priority = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0.0, sentiment 2.0 -> +2 capped by sentiment dynamics, net capital remains at floor 0.0
SOVEREIGNTY: 15 last turn, M1 InvestAI Gigafactories finishes t7 +4, no capacity in-flight bonus +0, eu_frontier_access_denied t7 −2, capability rose 3.5 −1 = 16

## Emerging developments (tracked)

- `emergent_anti_compute_litigation_wave` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated municipal lawsuits across several member states seek injunctions blocking grid connections for any new large-scale compute sites, citing the empty gigafactory fields and rationed foreign models as proof of wasted burden.
- `emergent_care_safety_backlash` -- first noted turn 7, listed in 1 turn(s) so far: Hospital staff and municipal workers stage coordinated walkouts after dosage hallucinations and retyping backlogs cause patient harm, forcing emergency suspension of open-model triage pilots in several regions.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, loss_of_control_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 2 (6 turn(s) ago): capability_jump, ai_investment_collapse, emergent_cyber_insurance_repricing
- Turn 3 (5 turn(s) ago): cyber_major_incident, capability_jump
- Turn 4 (4 turn(s) ago): emergent_permit_blockade_freeze
- Turn 5 (3 turn(s) ago): election_consolidation
- Turn 6 (2 turn(s) ago): export_control_escalation, eu_frontier_access_denied
- Turn 7 (1 turn(s) ago): bio_uplift_findings, opaque_reasoning, research_breakthrough, export_control_escalation, eu_frontier_access_denied
