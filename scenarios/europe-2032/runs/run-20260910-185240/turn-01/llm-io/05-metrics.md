...
- characters 16367-16998: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_screening_norm_push` -- first noted turn 1, listed in 1 turn(s) so far: A major EU scientific publisher and a national research funder jointly announce mandatory AI-model-assistance disclosure and phage-design screening for grants, triggering a short-lived researcher boycott debate across European labs.
- `emergent_cyber_insurance_repricing` -- first noted turn 1, listed in 1 turn(s) so far: A major insurer reprices cyber cover for energy and port operators after the summer lab revelations, briefly threatening to withdraw cover unless minimum AI-assisted monitoring is adopted.
