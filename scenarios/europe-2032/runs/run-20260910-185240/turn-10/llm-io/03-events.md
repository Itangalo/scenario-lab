...
- characters 374-2243: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2286-4296: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4352-4708: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4771-32079: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32434-33329: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: no measures in flight, no priority = −0 + 0 for no priority = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 4.0, sentiment 0.0 -> none, capital higher than sentiment
SOVEREIGNTY: 14 last turn, no cat4 finish, no capacity in flight +0, export_control_escalation t9 −3, capability rose 7.5 −1 = 10
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, loss_of_control_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 2 (8 turn(s) ago): capability_jump, ai_investment_collapse, emergent_cyber_insurance_repricing
- Turn 3 (7 turn(s) ago): cyber_major_incident, capability_jump
- Turn 4 (6 turn(s) ago): emergent_permit_blockade_freeze
- Turn 5 (5 turn(s) ago): election_consolidation
- Turn 6 (4 turn(s) ago): export_control_escalation, eu_frontier_access_denied
- Turn 7 (3 turn(s) ago): bio_uplift_findings, opaque_reasoning, research_breakthrough, export_control_escalation, eu_frontier_access_denied
- Turn 8 (2 turn(s) ago): bio_incident, research_breakthrough, eu_frontier_access_denied
- Turn 9 (1 turn(s) ago): cyber_major_incident, catastrophic_bio_incident, rsi_onset, labour_displacement, export_control_escalation, emergent_anti_compute_litigation_wave
