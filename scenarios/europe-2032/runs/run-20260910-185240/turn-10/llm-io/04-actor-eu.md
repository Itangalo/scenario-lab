...
- characters 452-2321: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2364-4374: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5779-6254: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8215-10357: `{{previous_actions}}` from the actor's own response from the previous turn
