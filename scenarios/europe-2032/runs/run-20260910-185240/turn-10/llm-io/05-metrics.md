...
- characters 13192-15061: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15104-17114: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17170-17526: `{{notepad}}` from the Game Master's notepad, carried across turns
