...
- characters 13389-15203: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15247-17803: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17859-18402: `{{notepad}}` from the Game Master's notepad, carried across turns
