...
- characters 377-2191: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2235-4791: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4847-5744: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5807-28789: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29144-29387: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t2: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Systems Shield −3, M4 Insurer-Aligned Monitoring Baseline −2, priority −1 = −11 + 1 more for the priority = −12
PROPOSAL BONUS: Insurer-Aligned Monitoring Baseline (cat 6, small) +2 — emergent cyber insurance repricing landed this turn threatening energy/port cover and this answers it directly
LEGITIMACY LENDS: capital 17, sentiment 28 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, Gigafactories in flight +0, capability rose 7.0 −1 = 18

## Emerging developments (tracked)

- `emergent_screening_norm_push` -- first noted turn 1, listed in 2 turn(s) so far: A major EU scientific publisher and a national research funder jointly announce mandatory AI-model-assistance disclosure and phage-design screening for grants, triggering a short-lived researcher boycott debate across European labs.
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, loss_of_control_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 2 (1 turn(s) ago): capability_jump, ai_investment_collapse, emergent_cyber_insurance_repricing
