...
- characters 106-12865: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12908-13097: `{{metrics_json}}` from the run's live metric values
- characters 13190-14148: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14192-16070: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16126-16491: `{{notepad}}` from the Game Master's notepad, carried across turns
