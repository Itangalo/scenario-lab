...
- characters 452-1410: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1454-3332: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5521-5995: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7956-9672: `{{previous_actions}}` from the actor's own response from the previous turn
