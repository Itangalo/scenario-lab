...
- characters 375-1144: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1188-3553: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3609-4125: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4188-32221: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32576-33069: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: M1 InvestAI Gigafactories −3, M5 EU Essential Services Continuity Switch −2, priority −1 = −5 + 1 more for the priority = −6
PROPOSAL BONUS: EU Essential Services Continuity Switch (cat 6, small) +2 — eu_frontier_access_denied and export tightening fired this turn and this answers them directly
LEGITIMACY LENDS: capital -1, sentiment 4 -> +2
SOVEREIGNTY: 15 last turn, Tech sovereignty package finishes t6 +4, no in-flight bonus +0, eu_frontier_access_denied t6 −3, capability rose 3.0 −1 = 15
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, loss_of_control_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 2 (5 turn(s) ago): capability_jump, ai_investment_collapse, emergent_cyber_insurance_repricing
- Turn 3 (4 turn(s) ago): cyber_major_incident, capability_jump
- Turn 4 (3 turn(s) ago): emergent_permit_blockade_freeze
- Turn 5 (2 turn(s) ago): election_consolidation
- Turn 6 (1 turn(s) ago): export_control_escalation, eu_frontier_access_denied
