...
- characters 13645-14414: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14458-16823: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16879-18054: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 76.0, "openweight_capability": 69.2, "ai_safety": 3.0, "resilience": 35.5, "eu_ai_sovereignty": 16.0, "eu_political_capital": 0.0, "public_sentiment": 2.0}
```
## Narrative
### Holding the line
