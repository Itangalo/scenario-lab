...
- characters 1459-3584: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3640-4082: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4145-31099: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31454-31761: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Systems Shield −3, M4 Insurer-Aligned Monitoring Baseline −2, priority −1 = −11 + 1 more for the priority = −12
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 13, sentiment 28 -> +2 (capped below sentiment)
SOVEREIGNTY: 18 last turn, no capacity event, Gigafactories in flight +0, capability rose 5.5 −1 = 17
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, loss_of_control_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 2 (2 turn(s) ago): capability_jump, ai_investment_collapse, emergent_cyber_insurance_repricing
- Turn 3 (1 turn(s) ago): cyber_major_incident, capability_jump
