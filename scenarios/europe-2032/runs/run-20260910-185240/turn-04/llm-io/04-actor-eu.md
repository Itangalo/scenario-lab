...
- characters 1537-3662: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3967-4426: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6363-7531: `{{previous_actions}}` from the actor's own response from the previous turn
