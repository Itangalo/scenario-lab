...
- characters 105-13060: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13103-13295: `{{metrics_json}}` from the run's live metric values
- characters 13388-14659: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14702-17286: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17342-18251: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | Insurer-Aligned Monitoring Baseline | 2 |
