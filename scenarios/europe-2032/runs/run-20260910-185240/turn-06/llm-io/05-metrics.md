...
- characters 105-13407: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13450-13641: `{{metrics_json}}` from the run's live metric values
- characters 13734-14979: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15022-17092: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17148-17485: `{{notepad}}` from the Game Master's notepad, carried across turns
