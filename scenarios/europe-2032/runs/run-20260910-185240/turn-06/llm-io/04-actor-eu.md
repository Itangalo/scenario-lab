...
- characters 453-1698: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1741-3811: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4642-5116: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7054-8498: `{{previous_actions}}` from the actor's own response from the previous turn
