...
- characters 13299-14222: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14266-16015: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16071-16740: `{{notepad}}` from the Game Master's notepad, carried across turns
