...
- characters 377-1300: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1344-3093: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3149-3818: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3881-32263: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32618-32983: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, priority −1 = −6 + 1 more for the priority = −7
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 13, sentiment 16 -> +2 (capped below sentiment)
SOVEREIGNTY: 17 last turn, no capacity event, Gigafactories in flight +0, capability rose 3.0 −1 = 16

## Emerging developments (tracked)

- `emergent_datacentre_moratorium_wave` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated local council moratoriums freeze grid connections for new data centres in three member states after blackout-linked protests, delaying EU compute buildout by months.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, loss_of_control_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 2 (3 turn(s) ago): capability_jump, ai_investment_collapse, emergent_cyber_insurance_repricing
- Turn 3 (2 turn(s) ago): cyber_major_incident, capability_jump
- Turn 4 (1 turn(s) ago): emergent_permit_blockade_freeze
