...
- characters 455-1378: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1422-3171: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4088-4547: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6484-7793: `{{previous_actions}}` from the actor's own response from the previous turn
