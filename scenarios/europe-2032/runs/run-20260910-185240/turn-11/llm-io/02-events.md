...
- characters 374-1894: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1938-3734: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3790-4168: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4231-31539: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31894-32887: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: no measures in flight, no priority = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0.0, sentiment 2.0 -> +0, capital held at floor, no lend applied while capital at zero with no delivery
SOVEREIGNTY: 10 last turn, no cat4 finish, no capacity in flight +0, eu_frontier_access_denied t10 −2, capability rose 2.0 −1 = 7
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, loss_of_control_incident, safety_breakthrough, knowledge_work_augmented, eu_frontier_access_denied
- Turn 2 (9 turn(s) ago): capability_jump, ai_investment_collapse, emergent_cyber_insurance_repricing
- Turn 3 (8 turn(s) ago): cyber_major_incident, capability_jump
- Turn 4 (7 turn(s) ago): emergent_permit_blockade_freeze
- Turn 5 (6 turn(s) ago): election_consolidation
- Turn 6 (5 turn(s) ago): export_control_escalation, eu_frontier_access_denied
- Turn 7 (4 turn(s) ago): bio_uplift_findings, opaque_reasoning, research_breakthrough, export_control_escalation, eu_frontier_access_denied
- Turn 8 (3 turn(s) ago): bio_incident, research_breakthrough, eu_frontier_access_denied
- Turn 9 (2 turn(s) ago): cyber_major_incident, catastrophic_bio_incident, rsi_onset, labour_displacement, export_control_escalation, emergent_anti_compute_litigation_wave
- Turn 10 (1 turn(s) ago): eval_anomaly_reports, medical_breakthrough, eu_frontier_access_denied
