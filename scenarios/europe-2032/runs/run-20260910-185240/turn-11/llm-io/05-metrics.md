...
- characters 13192-14712: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14756-16552: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16608-16986: `{{notepad}}` from the Game Master's notepad, carried across turns
