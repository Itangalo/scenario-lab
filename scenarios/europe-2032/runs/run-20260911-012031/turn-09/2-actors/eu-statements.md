...
- `two_year_commitment` (commitment): Rebuild trust through resilience and controlled adoption before frontier build

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild trust through resilience and controlled adoption before frontier build
