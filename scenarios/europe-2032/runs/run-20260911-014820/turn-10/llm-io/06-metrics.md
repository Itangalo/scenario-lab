...
- characters 13677-15053: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15096-16930: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16986-18024: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Bio-Detection and Care Continuity Surge | 2 |
...
- `emergent_care_energy_strike_wave` -- first noted turn 10, listed in 1 turn(s) so far: A coordinated cross-border hospital and municipal workers' action explicitly ties AI factory water-power use to care rationing, forcing extended triage-helper shutdowns in showcase regions.
- `emergent_permit_precedent_spread` -- first noted turn 10, listed in 1 turn(s) so far: National courts in the two freeze states extend water-power suspensions into a coordinated precedent cited by councils elsewhere, turning local injunctions into a de facto EU-wide moratorium on new large-scale compute builds.
