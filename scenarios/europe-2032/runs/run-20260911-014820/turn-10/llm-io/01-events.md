...
- characters 375-1751: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1794-3628: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3684-4091: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4154-29767: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30122-30857: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU United Access and No-Undercut Pact −2, priority no cost (capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 21 -> +0 applied in capital total (capped, capital remains below sentiment)
SOVEREIGNTY: 16 last turn, no capacity finish, no in-flight build, emergent_build_moratoria_wave t9 −2, capability rose 0.7 −0 = 14
...
- Turn 2 (8 turn(s) ago): export_control_escalation
- Turn 3 (7 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, export_control_escalation
- Turn 4 (6 turn(s) ago): cyber_defence_breakthrough, eu_frontier_access_denied, emergent_siting_backlash_freeze
- Turn 5 (5 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, taiwan_tension_rise, adoption_success, election_consolidation
- Turn 6 (4 turn(s) ago): loss_of_control_incident, emergent_care_substitution_strike
- Turn 8 (2 turn(s) ago): embodied_ai_deployment, eu_frontier_access_denied, member_state_defection
- Turn 9 (1 turn(s) ago): adoption_success, emergent_build_moratoria_wave
