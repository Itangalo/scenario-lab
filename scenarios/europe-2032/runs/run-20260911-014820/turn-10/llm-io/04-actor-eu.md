...
- characters 453-1829: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1872-3706: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4630-5101: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7392-8911: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Hospital Helper Fix and Triage Continuity Fund | 9 | small | 7 | 9 | own jurisdiction | public_sentiment up, resilience up modestly | 2 | finished |
| M8 | EU United Access and No-Undercut Pact | 8 | small | 8 | 10 | own jurisdiction | eu_ai_sovereignty up modestly, eu_political_capital down then up, public_sentiment up modestly | 2 | finished |
...
## Two-year commitment
Rebuild trusted European AI that delivers visible public benefit and unblocks sovereign capacity

## Statement changes
modify `two_year_commitment` (commitment): Rebuild trusted European AI that delivers visible public benefit and unblocks sovereign capacity
- Trigger: the two-year commitment period closes this turn

## New measure
None this turn, while political capital is at 2 and court injunctions freeze builds pending a negotiated siting settlement.

## Store changes
No changes.

## Priority
M8 EU United Access and No-Undercut Pact, because holding the common access line and stopping further side-deals outranks new builds until cohesion and continuity are secured.

## In practice
We finish under the old containment commitment: DG CNECT and ENISA keep rerouting cut-off workloads to the continuity stack, HERA money stays on locums and triage fixes under M7 through December, and the Commission uses its Council mandate to press Washington for restoration on a timetable while offering pooled volumes and future factory shares to hold the side-deal capital to a standstill.

We use the adoption_success window to attribute falling waits where helpers work to the European decision, not to foreign models, via joint Commission-regional communications, while imposing no new factory siting this semester. Legal Services and DG ENER prepare water-and-power compacts with the two moratoria municipalities for January, so the next commitment starts from negotiation rather than coercion.
