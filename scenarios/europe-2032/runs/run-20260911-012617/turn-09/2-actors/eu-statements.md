...
- `two_year_commitment` (commitment): Harden essentials and contain harm from unrecallable frontier AI

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Harden essentials and contain harm from unrecallable frontier AI
