...
- characters 106-13559: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13602-13794: `{{metrics_json}}` from the run's live metric values
- characters 13887-14966: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15010-17002: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17058-18190: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Bio-Detection and Medical Countermeasure Surge | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Essential Services Continuity Shield −2, priority −1 = −12
PROPOSAL BONUS: EU Essential Services Continuity Shield (cat 6, small) +3 — answers autumn grid intrusion (last turn) and this turn's cutoff directly, hospitals/ministries failing
LEGITIMACY LENDS: capital 27, sentiment 34 -> +1
SOVEREIGNTY: 21 last turn, no capacity event, Gigafactories in flight +0, eu_frontier_access_denied t2 −3, capability rose 3.0 −1 = 17

## Emerging developments (tracked)

- `emergent_siting_backlash` -- first noted turn 2, listed in 2 turn(s) so far: A coordinated municipal campaign across several shortlisted AI-factory host regions blocks grid-connection permits over power prices and water use, forcing a renegotiation of state-aid pledges.
- `emergent_attribution_diplomatic_row` -- first noted turn 2, listed in 2 turn(s) so far: Competing leaks over grid-intrusion attribution trigger an open diplomatic row between EU capitals and a named foreign power, with expulsions threatened and joint investigation stalled.
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Bio-Detection and Medical Countermeasure Surge −2, priority −1 = −12
PROPOSAL BONUS: EU Bio-Detection and Medical Countermeasure Surge (cat 6, small) +3 — answers bio_uplift_findings this turn directly, severe precursor opening 4-turn gate with openweights near 50
