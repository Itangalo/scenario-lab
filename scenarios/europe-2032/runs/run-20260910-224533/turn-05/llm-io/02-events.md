...
- characters 377-2713: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2757-4980: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5036-5594: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5657-33205: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33560-33774: `{{event_history}}` from the run's own event record
...
- Turn 4 (1 turn(s) ago): embodied_ai_deployment, emergent_siting_backlash
