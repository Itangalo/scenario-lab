...
- characters 455-2791: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2835-5058: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7297-7737: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10012-12028: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Embodied-AI Transition and Shopfloor Trust Pact | 7 | small | 4 | 7 | own jurisdiction | public_sentiment up, resilience up modestly via labour absorption | 2 | running |
