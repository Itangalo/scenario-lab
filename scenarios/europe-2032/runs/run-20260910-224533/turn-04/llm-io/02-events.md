...
- characters 376-2046: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2089-4357: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4413-5538: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5601-32545: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32900-33039: `{{event_history}}` from the run's own event record
...
- Turn 3 (1 turn(s) ago): bio_uplift_findings
