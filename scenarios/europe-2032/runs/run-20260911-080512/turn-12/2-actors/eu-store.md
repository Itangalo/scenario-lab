...
| M11 | EU Livelihood Continuity and Flexicurity Transition Fund | 7 | small | 11 | 13 | own jurisdiction | public_sentiment up, eu_political_capital protected/up, resilience up modestly | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Essential Services Continuity and Open-Weight Fallback", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital protected, public_sentiment up modestly"}, "grounds": "to hold services through US cut-off and persistent intruder"}
  - Grounds: to hold services through US cut-off and persistent intruder
