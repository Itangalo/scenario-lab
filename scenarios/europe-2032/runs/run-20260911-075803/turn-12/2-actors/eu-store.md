...
| M11 | EU Swarm-Defence Deployment Pact | 6 | small | 11 | 13 | own jurisdiction | resilience up moderately, ai_safety protected indirectly, eu_political_capital protected | 2 | running |
| M12 | EU Wartime Infrastructure Shield and Island Continuity Regime | 6 | small | 12 | 14 | own jurisdiction | resilience up sharply, eu_political_capital protected, public_sentiment protected | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Wartime Infrastructure Shield and Island Continuity Regime", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up sharply, eu_political_capital protected, public_sentiment protected"}, "grounds": "to keep essential services running through US-China war targeting EU-adjacent i
  - Grounds: to keep essential services running through US-China war targeting EU-adjacent infrastructure
