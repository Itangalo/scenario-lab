...
| M9 | EU Critical Services Cyber Recovery and Hardening Pact | 6 | small | 9 | 11 | own jurisdiction | resilience up moderately, eu_political_capital protected | 2 | finished |
| M10 | EU Displaced Graduates Transition and Retraining Guarantee | 7 | small | 10 | 12 | own jurisdiction | resilience up modestly via social absorption, public_sentiment up, eu_political_capital protected | 2 | finished |
| M11 | EU Swarm-Defence Deployment Pact | 6 | small | 11 | 13 | own jurisdiction | resilience up moderately, ai_safety protected indirectly, eu_political_capital protected | 2 | finished |
| M12 | EU Wartime Infrastructure Shield and Island Continuity Regime | 6 | small | 12 | 13 | own jurisdiction | resilience up sharply, eu_political_capital protected, public_sentiment protected | 2 | finished |
| M13 | EU Defensive Breakthrough Scale-Up for Island Services | 6 | small | 13 | 15 | own jurisdiction | resilience up sharply, ai_safety protected, eu_political_capital protected | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Defensive Breakthrough Scale-Up for Island Services", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up sharply, ai_safety protected, eu_political_capital protected"}, "grounds": "to scale automated patching and swarm detection against wartime automated attack"}
  - Grounds: to scale automated patching and swarm detection against wartime automated attack
