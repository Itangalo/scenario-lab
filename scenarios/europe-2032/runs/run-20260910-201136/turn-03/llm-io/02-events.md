...
- characters 377-2235: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2279-4275: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4331-5483: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5546-28016: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28371-28527: `{{event_history}}` from the run's own event record
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, bio_incident, eu_frontier_access_denied
- Turn 2 (1 turn(s) ago): loss_of_control_incident, joint_threat_response
