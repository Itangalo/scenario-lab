...
- characters 106-13291: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13334-13526: `{{metrics_json}}` from the run's live metric values
- characters 13619-15477: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15521-17517: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17573-18138: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 56.5, "openweight_capability": 52.3, "ai_safety": 28.0, "resilience": 42.5, "eu_ai_sovereignty": 18.0, "eu_political_capital": 21.0, "public_sentiment": 29.0}
```
