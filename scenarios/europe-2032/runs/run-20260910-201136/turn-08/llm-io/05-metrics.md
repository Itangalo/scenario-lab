...
- characters 105-13251: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13294-13486: `{{metrics_json}}` from the run's live metric values
- characters 13579-14932: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14975-17077: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17133-17635: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Swarm-Defence Rollout | 2 |
| M8 | EU Middle-Power Supply Chain Pact | 2 |
...
## Metrics
```json
{"ai_capability": 65.2, "openweight_capability": 61.8, "ai_safety": 6.0, "resilience": 44.0, "eu_ai_sovereignty": 25.0, "eu_political_capital": 12.0, "public_sentiment": 18.0}
```
