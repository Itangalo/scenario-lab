...
- characters 13315-13506: `{{metrics_json}}` from the run's live metric values
- characters 13599-15539: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15582-17679: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17735-18248: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Essential Continuity Switch | 2 |
...
PORTFOLIO CHARGE t9: EU Middle-Power Supply Chain Pact −2, EU Essential Continuity Switch −2, priority −0 (capital below 20, no effect no cost) = −4
PROPOSAL BONUS: EU Essential Continuity Switch (cat 6, small) +5 — cyber_major_incident severe this turn plus access cutoff this turn, this answers both directly
LEGITIMACY LENDS: capital 13, sentiment 18 -> +2
SOVEREIGNTY: 25 last turn, no capacity event? no — eu_frontier_access_denied t9 −2, no cat4 finish +0, no build in flight +0, capability rose 0.8 −0 = 23
