...
- characters 376-2316: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2359-4456: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4512-5025: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5088-29384: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29739-30422: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, bio_incident, eu_frontier_access_denied
- Turn 2 (8 turn(s) ago): loss_of_control_incident, joint_threat_response
- Turn 3 (7 turn(s) ago): emergent_compute_buildout_pause
- Turn 4 (6 turn(s) ago): cyber_major_incident, ai_investment_collapse
- Turn 5 (5 turn(s) ago): emergent_hyperscaler_retreat_widens, election_consolidation
- Turn 6 (4 turn(s) ago): knowledge_work_augmented
- Turn 7 (3 turn(s) ago): capability_jump, cyber_defence_breakthrough, knowledge_work_augmented, member_state_defection
- Turn 8 (2 turn(s) ago): opaque_reasoning, middle_power_coalition
- Turn 9 (1 turn(s) ago): cyber_major_incident, eu_frontier_access_denied
