...
- characters 107-13302: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13345-13535: `{{metrics_json}}` from the run's live metric values
- characters 13628-15078: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15122-16793: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16849-17367: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Displaced Entry-Work Transition Guarantee | 2 |
| M11 | EU Bio-Uplift Containment and Certified Control Deployment | 2 |
...
PORTFOLIO CHARGE t10: EU Essential Continuity Switch −2, EU Displaced Entry-Work Transition Guarantee −2, priority −0 (capital below 20, no effect no cost) = −4
PROPOSAL BONUS: EU Displaced Entry-Work Transition Guarantee (cat 7, small) +3 — labour_displacement landed this turn with entry hiring stopped, this answers it directly
LEGITIMACY LENDS: capital 14, sentiment 7 -> none (capital higher)
SOVEREIGNTY: 23 last turn, M8 finishes t10 cat8 +0, no capacity event, no cat4 in flight +0, capability rose 0.8 −0 = 22
...
## Metrics
```json
{"ai_capability": 67.4, "openweight_capability": 65.8, "ai_safety": 7.0, "resilience": 49.5, "eu_ai_sovereignty": 22.0, "eu_political_capital": 13.0, "public_sentiment": 5.0}
```
...
## Notepad
PORTFOLIO CHARGE t11: EU Displaced Entry-Work Transition Guarantee −2, EU Bio-Uplift Containment and Certified Control Deployment −2, priority −0 (capital below 20, no effect no cost) = −4
PROPOSAL BONUS: EU Bio-Uplift Containment and Certified Control Deployment (cat 6, small) +3 — bio uplift precursor signal landed this turn with contested viable design, this answers it directly plus adopts usable control gain
LEGITIMACY LENDS: capital 13, sentiment 5 -> none (capital higher)
SOVEREIGNTY: 22 last turn, no capacity event, no cat4 in flight +0, capability rose 0.6 −0 = 22
