...
- characters 1870-3541: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3597-4115: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4178-28474: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28829-29581: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, bio_incident, eu_frontier_access_denied
- Turn 2 (9 turn(s) ago): loss_of_control_incident, joint_threat_response
- Turn 3 (8 turn(s) ago): emergent_compute_buildout_pause
- Turn 4 (7 turn(s) ago): cyber_major_incident, ai_investment_collapse
- Turn 5 (6 turn(s) ago): emergent_hyperscaler_retreat_widens, election_consolidation
- Turn 6 (5 turn(s) ago): knowledge_work_augmented
- Turn 7 (4 turn(s) ago): capability_jump, cyber_defence_breakthrough, knowledge_work_augmented, member_state_defection
- Turn 8 (3 turn(s) ago): opaque_reasoning, middle_power_coalition
- Turn 9 (2 turn(s) ago): cyber_major_incident, eu_frontier_access_denied
- Turn 10 (1 turn(s) ago): labour_displacement, taiwan_tension_rise
