...
- characters 106-13278: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13321-13511: `{{metrics_json}}` from the run's live metric values
- characters 13604-15050: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15093-16996: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17052-17630: `{{notepad}}` from the Game Master's notepad, carried across turns
