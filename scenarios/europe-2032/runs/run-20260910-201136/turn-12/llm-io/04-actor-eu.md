...
- characters 453-1899: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1942-3845: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4261-4978: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8253-10305: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Bio-Uplift Containment and Certified Control Deployment | 6 | small | 11 | 13 | own jurisdiction | ai_safety up moderately via deployed controls, resilience up slightly via bio detection | 2 | running |
