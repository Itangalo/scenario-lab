...
- characters 377-1168: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1212-3128: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3184-3642: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3705-27242: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27597-28019: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, bio_incident, eu_frontier_access_denied
- Turn 2 (5 turn(s) ago): loss_of_control_incident, joint_threat_response
- Turn 3 (4 turn(s) ago): emergent_compute_buildout_pause
- Turn 4 (3 turn(s) ago): cyber_major_incident, ai_investment_collapse
- Turn 5 (2 turn(s) ago): emergent_hyperscaler_retreat_widens, election_consolidation
