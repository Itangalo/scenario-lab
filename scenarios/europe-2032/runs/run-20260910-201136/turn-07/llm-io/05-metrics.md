...
- characters 106-13228: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13271-13463: `{{metrics_json}}` from the run's live metric values
- characters 13556-14347: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14391-16307: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16363-16821: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M6 | EU Assured Access and Fallback Negotiation | 2 |
