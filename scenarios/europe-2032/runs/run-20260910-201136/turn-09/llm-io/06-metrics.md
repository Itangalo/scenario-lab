...
- characters 13573-15057: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15101-17140: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17196-17707: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 66.0, "openweight_capability": 63.5, "ai_safety": 4.0, "resilience": 48.0, "eu_ai_sovereignty": 23.0, "eu_political_capital": 15.0, "public_sentiment": 11.0}
```
