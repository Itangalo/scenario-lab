...
- characters 1904-3943: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3999-4510: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4573-28869: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29224-29833: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, bio_incident, eu_frontier_access_denied
- Turn 2 (7 turn(s) ago): loss_of_control_incident, joint_threat_response
- Turn 3 (6 turn(s) ago): emergent_compute_buildout_pause
- Turn 4 (5 turn(s) ago): cyber_major_incident, ai_investment_collapse
- Turn 5 (4 turn(s) ago): emergent_hyperscaler_retreat_widens, election_consolidation
- Turn 6 (3 turn(s) ago): knowledge_work_augmented
- Turn 7 (2 turn(s) ago): capability_jump, cyber_defence_breakthrough, knowledge_work_augmented, member_state_defection
- Turn 8 (1 turn(s) ago): opaque_reasoning, middle_power_coalition
