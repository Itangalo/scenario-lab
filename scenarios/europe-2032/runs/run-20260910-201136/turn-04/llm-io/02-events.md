...
- characters 1627-3635: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3691-4083: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4146-26616: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26971-27185: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, bio_incident, eu_frontier_access_denied
- Turn 2 (2 turn(s) ago): loss_of_control_incident, joint_threat_response
- Turn 3 (1 turn(s) ago): emergent_compute_buildout_pause
