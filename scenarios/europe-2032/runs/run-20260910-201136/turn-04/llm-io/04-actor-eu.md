...
- characters 1705-3713: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4558-5023: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6990-8237: `{{previous_actions}}` from the actor's own response from the previous turn
