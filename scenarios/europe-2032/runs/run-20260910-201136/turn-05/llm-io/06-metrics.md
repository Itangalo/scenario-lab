...
- characters 13575-14760: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14804-16831: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16887-17643: `{{notepad}}` from the Game Master's notepad, carried across turns
