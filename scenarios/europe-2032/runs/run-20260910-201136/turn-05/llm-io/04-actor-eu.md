...
- characters 455-1640: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1684-3711: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4883-5348: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7502-9233: `{{previous_actions}}` from the actor's own response from the previous turn
