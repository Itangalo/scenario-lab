...
- characters 377-1562: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1606-3633: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3689-4733: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4796-26605: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26960-27245: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Emergency Cyber Restoration and Mutual Aid Surge −2, priority −1 = −9
PROPOSAL BONUS: EU Emergency Cyber Restoration and Mutual Aid Surge (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 15, sentiment 22 -> +2
SOVEREIGNTY: 18 last turn, no capacity event, Gigafactories/Tech package in flight +0, capability rose 1.0 −0 = 18

## Emerging developments (tracked)

- `emergent_grid_auction_freeze` -- first noted turn 4, listed in 1 turn(s) so far: Regional grid operators jointly postpone gigafactory connection auctions to late 2028 citing transformer and turbine shortages, freezing EU co-financing disbursement.
- `emergent_hyperscaler_retreat_widens` -- first noted turn 4, listed in 1 turn(s) so far: A second US hyperscaler quietly shelves two further EU data-centre expansions and diverts transformer orders to US sites, leaking to press and hardening municipal opposition to gigafactory siting.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, bio_incident, eu_frontier_access_denied
- Turn 2 (3 turn(s) ago): loss_of_control_incident, joint_threat_response
- Turn 3 (2 turn(s) ago): emergent_compute_buildout_pause
- Turn 4 (1 turn(s) ago): cyber_major_incident, ai_investment_collapse
...
```
[{"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.25}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.13}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.42}, {"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.03}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.07}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.05}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.14}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Regional grid operators jointly postpone gigafactory connection auctions to late 2028 citing transformer and turbine shortages, freezing EU co-financing disbursement.", "emergent": true, "id": "emergent_grid_auction_freeze", "probability": 0.22}, {"description": "A second US hyperscaler quietly shelves two further EU data-centre expansions and diverts transformer orders to US sites, leaking to press and hardening municipal opposition to gigafactory siting.", "emergent": true, "id": "emergent_hyperscaler_retreat_widens", "probability": 0.27}]
```
