...
- characters 376-1979: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2022-3965: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4021-4654: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4717-25144: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 25499-25870: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, priority −1 not charged (capital below 20) = −6
...
- `emergent_grid_auction_freeze` -- first noted turn 4, listed in 2 turn(s) so far: Regional grid operators jointly postpone gigafactory connection auctions to late 2028 citing transformer and turbine shortages, freezing EU co-financing disbursement.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, bio_incident, eu_frontier_access_denied
- Turn 2 (4 turn(s) ago): loss_of_control_incident, joint_threat_response
- Turn 3 (3 turn(s) ago): emergent_compute_buildout_pause
- Turn 4 (2 turn(s) ago): cyber_major_incident, ai_investment_collapse
- Turn 5 (1 turn(s) ago): emergent_hyperscaler_retreat_widens, election_consolidation
