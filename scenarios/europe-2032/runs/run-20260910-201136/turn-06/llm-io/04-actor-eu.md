...
- characters 454-2057: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2100-4043: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4635-5082: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7237-8619: `{{previous_actions}}` from the actor's own response from the previous turn
