...
- characters 1754-3463: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3519-3878: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3941-28237: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28592-29461: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, bio_incident, eu_frontier_access_denied
- Turn 2 (11 turn(s) ago): loss_of_control_incident, joint_threat_response
- Turn 3 (10 turn(s) ago): emergent_compute_buildout_pause
- Turn 4 (9 turn(s) ago): cyber_major_incident, ai_investment_collapse
- Turn 5 (8 turn(s) ago): emergent_hyperscaler_retreat_widens, election_consolidation
- Turn 6 (7 turn(s) ago): knowledge_work_augmented
- Turn 7 (6 turn(s) ago): capability_jump, cyber_defence_breakthrough, knowledge_work_augmented, member_state_defection
- Turn 8 (5 turn(s) ago): opaque_reasoning, middle_power_coalition
- Turn 9 (4 turn(s) ago): cyber_major_incident, eu_frontier_access_denied
- Turn 10 (3 turn(s) ago): labour_displacement, taiwan_tension_rise
- Turn 11 (2 turn(s) ago): bio_uplift_findings, safety_breakthrough
