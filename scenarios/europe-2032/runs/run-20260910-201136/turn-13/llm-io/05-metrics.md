...
- characters 107-13275: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13318-13509: `{{metrics_json}}` from the run's live metric values
- characters 13602-14935: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14979-16688: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16744-17103: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Blockade Continuity and Trusted Care Sustainment | 2 |
...
PORTFOLIO CHARGE t12: EU Bio-Uplift Containment and Certified Control Deployment −2, priority −0 (capital below 20, no effect no cost) = −2
...
## Notepad
PORTFOLIO CHARGE t13: M12 EU Blockade Continuity and Trusted Care Sustainment −2, priority −0 (capital below 20, no effect no cost) = −2
PROPOSAL BONUS: EU Blockade Continuity (cat 6, small) +4 — taiwan_blockade plus bio-precursor plus clinic blockades landed this turn and this answers them directly
LEGITIMACY LENDS: capital 16, sentiment 7 -> none (capital higher)
SOVEREIGNTY: 22 last turn, no capacity event finish, no cat4 in flight +0, taiwan_blockade t13 −2, capability rose 0.0 −0 = 20
