...
- `two_year_commitment` (commitment): Secure sovereign AI capability to anchor autonomy and resilience

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign AI capability to anchor autonomy and resilience
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The commitment's time-bound nature ends, changing the cost of maintaining the original statement and triggering a natural review of its terms.
