...
- characters 105-12932: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12975-13167: `{{metrics_json}}` from the run's live metric values
- characters 13260-14502: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14545-16782: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16838-17888: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Loss-of-Control Containment Protocol | 2 |
