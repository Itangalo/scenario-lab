...
- characters 13597-15132: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15175-17529: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17585-18366: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Common AI Supply Compact | 2 |
...
## Metrics
```json
{"ai_capability": 57.5, "openweight_capability": 54.1, "ai_safety": 26.0, "resilience": 38.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 3.0, "public_sentiment": 17.5}
```
## Narrative
