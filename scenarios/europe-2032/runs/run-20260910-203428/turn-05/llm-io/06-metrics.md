...
- characters 106-13351: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13394-13585: `{{metrics_json}}` from the run's live metric values
- characters 13678-15448: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15492-17585: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17641-18323: `{{notepad}}` from the Game Master's notepad, carried across turns
