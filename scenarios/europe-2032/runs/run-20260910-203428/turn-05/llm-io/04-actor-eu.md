...
- characters 454-2224: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2268-4361: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5289-5743: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7662-9092: `{{previous_actions}}` from the actor's own response from the previous turn
