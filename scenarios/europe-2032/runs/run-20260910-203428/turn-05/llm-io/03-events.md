...
- characters 376-2146: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2190-4283: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4339-5021: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5084-27705: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28060-28366: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M3 EU Critical Systems Shield −3, M5 EU Common AI Supply Compact −2, priority M5 −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 12, sentiment 23.5 -> +2
SOVEREIGNTY: 16 last turn, no cat4 finish, Gigafactories in flight +0, member_state_defection t4 −2, capability rose 1.4 −0 = 14

## Emerging developments (tracked)

- `emergent_siting_backlash_freeze` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated protests block permitting and power hookups for paused gigafactory sites and two planned data centres, turning local opposition into a national siting moratorium debate.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, cyber_major_incident, eval_anomaly_reports, member_state_defection
- Turn 2 (3 turn(s) ago): loss_of_control_incident, ai_investment_collapse, member_state_defection
