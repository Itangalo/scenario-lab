...
- characters 1618-3436: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3492-3806: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3869-26679: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27034-27941: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: no measures in flight −0, priority −0 = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 0 -> none, sentiment not above capital before update
SOVEREIGNTY: 8 last turn, no capacity event, no cat4 finish or in-flight, capability rose 0.5 −0 = 8
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, cyber_major_incident, eval_anomaly_reports, member_state_defection
- Turn 2 (10 turn(s) ago): loss_of_control_incident, ai_investment_collapse, member_state_defection
...
- Turn 6 (6 turn(s) ago): taiwan_tension_rise
- Turn 7 (5 turn(s) ago): taiwan_blockade, us_china_agreement, member_state_defection, automated_decision_scandal, middle_power_coalition
- Turn 8 (4 turn(s) ago): bio_uplift_findings, safety_breakthrough, labour_displacement, member_state_defection
- Turn 9 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, labour_displacement, emergent_siting_freeze_contagion
- Turn 10 (2 turn(s) ago): loss_of_control_incident, eu_frontier_access_denied
- Turn 11 (1 turn(s) ago): knowledge_work_augmented
