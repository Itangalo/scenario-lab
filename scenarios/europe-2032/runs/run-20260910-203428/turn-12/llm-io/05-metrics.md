...
- characters 13059-14260: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14303-16121: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16177-16491: `{{notepad}}` from the Game Master's notepad, carried across turns
