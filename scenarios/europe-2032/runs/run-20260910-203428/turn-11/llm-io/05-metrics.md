...
- characters 13060-14392: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14436-16540: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16596-16969: `{{notepad}}` from the Game Master's notepad, carried across turns
