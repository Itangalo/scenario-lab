...
- characters 453-1785: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1829-3933: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4525-5011: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6969-8786: `{{previous_actions}}` from the actor's own response from the previous turn
