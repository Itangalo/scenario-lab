...
- characters 375-1707: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1751-3855: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3911-4284: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4347-27157: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27512-28366: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: no measures in flight −0, priority −0 = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 3 -> +1 capped, applied after other terms but overwhelmed by negative events, floor at 0
SOVEREIGNTY: 11 last turn, no cat4 finish, no in-flight bonus, eu_frontier_access_denied t10 −3, capability rose 0.5 −0 = 8
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, cyber_major_incident, eval_anomaly_reports, member_state_defection
- Turn 2 (9 turn(s) ago): loss_of_control_incident, ai_investment_collapse, member_state_defection
...
- Turn 6 (5 turn(s) ago): taiwan_tension_rise
- Turn 7 (4 turn(s) ago): taiwan_blockade, us_china_agreement, member_state_defection, automated_decision_scandal, middle_power_coalition
- Turn 8 (3 turn(s) ago): bio_uplift_findings, safety_breakthrough, labour_displacement, member_state_defection
- Turn 9 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, labour_displacement, emergent_siting_freeze_contagion
- Turn 10 (1 turn(s) ago): loss_of_control_incident, eu_frontier_access_denied
