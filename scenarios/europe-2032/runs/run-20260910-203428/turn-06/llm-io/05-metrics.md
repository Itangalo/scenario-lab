...
- characters 105-12798: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12841-13032: `{{metrics_json}}` from the run's live metric values
- characters 13125-14032: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14075-16006: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16062-16339: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t5: M1 InvestAI Gigafactories −3, priority M1 −1 = −4
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 5, sentiment 19 -> +2
SOVEREIGNTY: 14 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 14
...
## Notepad
PORTFOLIO CHARGE t6: M1 InvestAI Gigafactories −3, priority −0 (no effect, capital below 20) = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 19 -> +2
SOVEREIGNTY: 14 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.0 −0 = 14

## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "RETRENCHMENT"}}]}
```
```
