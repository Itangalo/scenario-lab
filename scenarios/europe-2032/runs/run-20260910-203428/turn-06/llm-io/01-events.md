...
- characters 1325-3256: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3312-3895: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3958-25279: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 25634-25988: `{{event_history}}` from the run's own event record
...
- `emergent_siting_backlash_freeze` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated protests block permitting and power hookups for paused gigafactory sites and two planned data centres, turning local opposition into a national siting moratorium debate.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, cyber_major_incident, eval_anomaly_reports, member_state_defection
- Turn 2 (4 turn(s) ago): loss_of_control_incident, ai_investment_collapse, member_state_defection
