...
- characters 1403-3334: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3691-4148: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6067-7553: `{{previous_actions}}` from the actor's own response from the previous turn
