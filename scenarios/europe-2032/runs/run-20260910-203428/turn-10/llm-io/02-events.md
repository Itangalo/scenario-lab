...
- characters 375-1590: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1633-3820: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3876-4221: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4284-26491: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26846-27620: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: no measures in flight −0, priority −0 = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 5 -> +1 capped, applied after other terms (floor at 0)
SOVEREIGNTY: 13 last turn, no cat4 finish, no in-flight bonus, emergent siting freeze contagion t9 −2, capability rose 0.5 −0 = 11
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, cyber_major_incident, eval_anomaly_reports, member_state_defection
- Turn 2 (8 turn(s) ago): loss_of_control_incident, ai_investment_collapse, member_state_defection
...
- Turn 6 (4 turn(s) ago): taiwan_tension_rise
- Turn 7 (3 turn(s) ago): taiwan_blockade, us_china_agreement, member_state_defection, automated_decision_scandal, middle_power_coalition
- Turn 8 (2 turn(s) ago): bio_uplift_findings, safety_breakthrough, labour_displacement, member_state_defection
- Turn 9 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, labour_displacement, emergent_siting_freeze_contagion
