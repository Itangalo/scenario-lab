...
- characters 12777-12967: `{{metrics_json}}` from the run's live metric values
- characters 13060-14275: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14318-16505: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16561-16906: `{{notepad}}` from the Game Master's notepad, carried across turns
