...
- characters 453-1668: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1711-3898: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4991-5433: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7391-9380: `{{previous_actions}}` from the actor's own response from the previous turn
