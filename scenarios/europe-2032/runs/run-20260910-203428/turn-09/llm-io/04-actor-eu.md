...
- characters 453-1482: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1526-3614: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5242-5699: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7657-8944: `{{previous_actions}}` from the actor's own response from the previous turn
