...
- characters 106-13143: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13186-13376: `{{metrics_json}}` from the run's live metric values
- characters 13469-14498: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14542-16630: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16686-17091: `{{notepad}}` from the Game Master's notepad, carried across turns
