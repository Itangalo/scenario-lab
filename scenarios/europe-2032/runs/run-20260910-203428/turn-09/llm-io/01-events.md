...
- characters 375-1404: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1448-3536: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3592-4320: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4383-26590: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26945-27595: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M6 EU Supply-Chain Coalition for Compute Access −2, priority −0 (no effect, capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 5 -> +1 capped, applied after other terms (floor at 0)
SOVEREIGNTY: 15 last turn, no measure finishes, no capacity in-flight bonus, member_state_defection t8 −2, capability rose 0.5 −0 = 13

## Emerging developments (tracked)

- `emergent_siting_freeze_contagion` -- first noted turn 7, listed in 2 turn(s) so far: US data-centre moratorium rhetoric spills over: coordinated municipal votes to freeze grid reservations for EU gigafactory sites, forcing Brussels to pay retention fees or lose hookups permanently.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, cyber_major_incident, eval_anomaly_reports, member_state_defection
- Turn 2 (7 turn(s) ago): loss_of_control_incident, ai_investment_collapse, member_state_defection
- Turn 3 (6 turn(s) ago): member_state_defection
- Turn 4 (5 turn(s) ago): member_state_defection
- Turn 5 (4 turn(s) ago): election_retrenchment
- Turn 6 (3 turn(s) ago): taiwan_tension_rise
- Turn 7 (2 turn(s) ago): taiwan_blockade, us_china_agreement, member_state_defection, automated_decision_scandal, middle_power_coalition
- Turn 8 (1 turn(s) ago): bio_uplift_findings, safety_breakthrough, labour_displacement, member_state_defection
