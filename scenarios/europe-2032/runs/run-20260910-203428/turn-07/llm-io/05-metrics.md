...
- characters 13234-13425: `{{metrics_json}}` from the run's live metric values
- characters 13518-14306: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14350-16129: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16185-16812: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M6 | EU Supply-Chain Coalition for Compute Access | 2 |
