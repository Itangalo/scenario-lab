...
- characters 376-1164: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1208-2987: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3043-3347: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3410-27841: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28196-28596: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, cyber_major_incident, eval_anomaly_reports, member_state_defection
- Turn 2 (5 turn(s) ago): loss_of_control_incident, ai_investment_collapse, member_state_defection
- Turn 3 (4 turn(s) ago): member_state_defection
- Turn 4 (3 turn(s) ago): member_state_defection
- Turn 5 (2 turn(s) ago): election_retrenchment
- Turn 6 (1 turn(s) ago): taiwan_tension_rise
