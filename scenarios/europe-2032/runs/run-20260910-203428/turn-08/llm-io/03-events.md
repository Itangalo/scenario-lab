...
- characters 1599-3627: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3683-4623: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4686-26893: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27248-27786: `{{event_history}}` from the run's own event record
...
- `emergent_siting_freeze_contagion` -- first noted turn 7, listed in 1 turn(s) so far: US data-centre moratorium rhetoric spills over: coordinated municipal votes to freeze grid reservations for EU gigafactory sites, forcing Brussels to pay retention fees or lose hookups permanently.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, cyber_major_incident, eval_anomaly_reports, member_state_defection
- Turn 2 (6 turn(s) ago): loss_of_control_incident, ai_investment_collapse, member_state_defection
...
- Turn 6 (2 turn(s) ago): taiwan_tension_rise
- Turn 7 (1 turn(s) ago): taiwan_blockade, us_china_agreement, member_state_defection, automated_decision_scandal, middle_power_coalition
