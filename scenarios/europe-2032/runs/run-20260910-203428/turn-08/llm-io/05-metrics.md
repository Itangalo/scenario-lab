...
- characters 105-12825: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12868-13059: `{{metrics_json}}` from the run's live metric values
- characters 13152-14333: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14376-16404: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16460-17400: `{{notepad}}` from the Game Master's notepad, carried across turns
