...
- characters 376-1960: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2004-4065: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4121-4419: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4482-27292: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27647-28737: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, cyber_major_incident, eval_anomaly_reports, member_state_defection
- Turn 2 (11 turn(s) ago): loss_of_control_incident, ai_investment_collapse, member_state_defection
...
- Turn 6 (7 turn(s) ago): taiwan_tension_rise
- Turn 7 (6 turn(s) ago): taiwan_blockade, us_china_agreement, member_state_defection, automated_decision_scandal, middle_power_coalition
- Turn 8 (5 turn(s) ago): bio_uplift_findings, safety_breakthrough, labour_displacement, member_state_defection
- Turn 9 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, labour_displacement, emergent_siting_freeze_contagion
- Turn 10 (3 turn(s) ago): loss_of_control_incident, eu_frontier_access_denied
- Turn 11 (2 turn(s) ago): knowledge_work_augmented
- Turn 12 (1 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, bio_uplift_findings, medical_breakthrough, labour_displacement, adoption_success, middle_power_coalition
