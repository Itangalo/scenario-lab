...
- characters 13264-14616: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14660-16677: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16733-17220: `{{notepad}}` from the Game Master's notepad, carried across turns
