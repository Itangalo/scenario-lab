...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio-Uplift Shield and Care Continuity Sprint", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected"}, "grounds": "to answer contested bio-uplift finding before diffusion"}
  - Grounds: to answer contested bio-uplift finding before diffusion
