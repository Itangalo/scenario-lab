...
| M8 | EU Trusted Therapies Continuity Programme | 9 | small | 7 | 9 | own jurisdiction | public_sentiment up, resilience up modestly, eu_political_capital protected | 2 | running |
...
- **applied** `M8` — {"op": "add", "table": "measures", "fields": {"name": "EU Trusted Therapies Continuity Programme", "category": 9, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, resilience up modestly, eu_political_capital protected"}, "grounds": "to convert medical breakthrough into trust under rationing"}
  - Grounds: to convert medical breakthrough into trust under rationing
