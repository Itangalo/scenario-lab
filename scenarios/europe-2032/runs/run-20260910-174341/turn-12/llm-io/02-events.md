...
- characters 375-1313: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1356-3528: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3584-4208: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4271-30034: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30389-31403: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, capability_jump, ai_investment_collapse, eu_access_secured, adoption_success
- Turn 3 (9 turn(s) ago): opaque_reasoning, openweight_frontier_release, emergent_datacentre_siting_backlash
- Turn 4 (8 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, adoption_success
- Turn 5 (7 turn(s) ago): eval_anomaly_reports, rsi_onset, election_consolidation
- Turn 6 (6 turn(s) ago): bio_uplift_findings, medical_breakthrough
- Turn 7 (5 turn(s) ago): cyber_major_incident, safety_breakthrough, labour_displacement, export_control_escalation
- Turn 8 (4 turn(s) ago): loss_of_control_incident, bio_uplift_findings, medical_breakthrough, export_control_escalation, eu_frontier_access_denied
- Turn 9 (3 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, supply_chain_coercion
- Turn 10 (2 turn(s) ago): medical_breakthrough, embodied_ai_deployment, us_labs_nationalised, automated_decision_scandal
- Turn 11 (1 turn(s) ago): capability_jump, loss_of_control_incident
