...
- characters 106-13430: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13473-13663: `{{metrics_json}}` from the run's live metric values
- characters 13756-14694: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14737-16909: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16965-17589: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Containment and Continuity Protocol for Rogue Agents | 2 |
