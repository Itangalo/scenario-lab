...
- characters 1506-3498: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3554-4451: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4514-31118: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31473-32201: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, capability_jump, ai_investment_collapse, eu_access_secured, adoption_success
- Turn 3 (6 turn(s) ago): opaque_reasoning, openweight_frontier_release, emergent_datacentre_siting_backlash
- Turn 4 (5 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, adoption_success
- Turn 5 (4 turn(s) ago): eval_anomaly_reports, rsi_onset, election_consolidation
- Turn 6 (3 turn(s) ago): bio_uplift_findings, medical_breakthrough
- Turn 7 (2 turn(s) ago): cyber_major_incident, safety_breakthrough, labour_displacement, export_control_escalation
- Turn 8 (1 turn(s) ago): loss_of_control_incident, bio_uplift_findings, medical_breakthrough, export_control_escalation, eu_frontier_access_denied
