...
- characters 1584-3576: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5500-5986: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8850-10793: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Care Continuity Switch | 6 | small | 8 | 10 | own jurisdiction | resilience up materially, public_sentiment up slightly | 2 | running |
