...
- characters 106-13476: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13519-13711: `{{metrics_json}}` from the run's live metric values
- characters 13804-15544: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15588-17821: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17877-18436: `{{notepad}}` from the Game Master's notepad, carried across turns
...
**emergent_datacentre_siting_backlash (emergent event):** Coordinated local protests and municipal permit challenges delay at least one major EU data-centre expansion planned for late 2026, turning energy use and siting into a national political issue.
