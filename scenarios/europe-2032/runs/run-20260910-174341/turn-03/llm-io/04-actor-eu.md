...
- characters 455-2195: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2239-4472: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5753-6235: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8191-10314: `{{previous_actions}}` from the actor's own response from the previous turn
