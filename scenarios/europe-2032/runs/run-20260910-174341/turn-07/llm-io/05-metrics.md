...
- characters 106-13361: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13404-13595: `{{metrics_json}}` from the run's live metric values
- characters 13688-14944: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14988-17921: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17977-18813: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 80.0, "openweight_capability": 73.0, "ai_safety": 8.0, "resilience": 37.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 14.0, "public_sentiment": 34.0}
```
