...
- characters 1676-4609: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4665-5191: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5254-30812: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31167-31631: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, capability_jump, ai_investment_collapse, eu_access_secured, adoption_success
- Turn 3 (4 turn(s) ago): opaque_reasoning, openweight_frontier_release, emergent_datacentre_siting_backlash
- Turn 4 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, adoption_success
- Turn 5 (2 turn(s) ago): eval_anomaly_reports, rsi_onset, election_consolidation
- Turn 6 (1 turn(s) ago): bio_uplift_findings, medical_breakthrough
