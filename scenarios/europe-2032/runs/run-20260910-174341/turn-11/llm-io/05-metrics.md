...
- characters 107-13420: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13463-13653: `{{metrics_json}}` from the run's live metric values
- characters 13746-14857: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14901-17046: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17102-17762: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Humanoid Shock Absorber and Care Continuity Pact | 2 |
...
## Metrics
```json
{"ai_capability": 91.5, "openweight_capability": 86.0, "ai_safety": 0.0, "resilience": 48.0, "eu_ai_sovereignty": 10.0, "eu_political_capital": 13.0, "public_sentiment": 9.0}
```
