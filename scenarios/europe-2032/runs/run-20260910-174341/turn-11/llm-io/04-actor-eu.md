...
- characters 1609-3754: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4695-5200: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8395-11290: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Humanoid Shock Absorber and Care Continuity Pact | 7 | small | 10 | 12 | own jurisdiction | resilience up slightly, public_sentiment up slightly | 2 | running |
