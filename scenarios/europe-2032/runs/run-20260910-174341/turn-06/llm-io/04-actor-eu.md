...
- characters 2686-5087: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6040-6526: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8888-10716: `{{previous_actions}}` from the actor's own response from the previous turn
