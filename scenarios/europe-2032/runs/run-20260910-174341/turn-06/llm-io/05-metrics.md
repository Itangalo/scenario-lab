...
- characters 105-13611: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13654-13845: `{{metrics_json}}` from the run's live metric values
- characters 13938-16128: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16171-18572: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18628-19028: `{{notepad}}` from the Game Master's notepad, carried across turns
