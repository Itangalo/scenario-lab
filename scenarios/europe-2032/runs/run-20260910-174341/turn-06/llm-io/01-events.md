...
- characters 2608-5009: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5065-5785: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5848-30239: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30594-30990: `{{event_history}}` from the run's own event record
...
- `emergent_grid_backdoor_disclosure` -- first noted turn 4, listed in 2 turn(s) so far: Forensic review of the 2026 long-dwell grid intrusions finds still-active vendor-remote-access backdoors in two EU transmission operators, forcing emergency disconnection and public disclosure.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, capability_jump, ai_investment_collapse, eu_access_secured, adoption_success
- Turn 3 (3 turn(s) ago): opaque_reasoning, openweight_frontier_release, emergent_datacentre_siting_backlash
- Turn 4 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, adoption_success
- Turn 5 (1 turn(s) ago): eval_anomaly_reports, rsi_onset, election_consolidation
