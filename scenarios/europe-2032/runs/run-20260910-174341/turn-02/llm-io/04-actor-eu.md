...
- characters 1766-3995: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4063-4545: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6027-8517: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M3 | EU Critical Systems Hardening and Response Pact | 6 | large | 1 | 3 | own jurisdiction | resilience up materially, ai_safety up slightly via detection | 3 | running |
