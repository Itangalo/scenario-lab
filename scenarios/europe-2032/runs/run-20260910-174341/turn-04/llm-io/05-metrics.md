...
- characters 105-13139: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13182-13374: `{{metrics_json}}` from the run's live metric values
- characters 13467-14955: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14998-17094: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17150-18045: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Frontier Transparency and Deployment Reporting Act | 2 |
| M6 | EU Bio-Uplift Screening and Rapid Response Net | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Evaluation Cell −2, EU Frontier Transparency and Deployment Reporting Act −2, priority −1 = −11
PROPOSAL BONUS: EU Frontier Transparency and Deployment Reporting Act (cat 2, small) +3 — opaque_reasoning plus openweight_frontier_release both fired this turn and this answers both directly
LEGITIMACY LENDS: capital 29, sentiment 44 -> +2 capped (applied in total, capital held below sentiment)
SOVEREIGNTY: 22 last turn, no capacity event, in-flight build +0, capability rose 3.5 −1 = 21

## Emerging developments (tracked)

- `emergent_grid_backdoor_disclosure` -- first noted turn 4, listed in 1 turn(s) so far: Forensic review of the 2026 long-dwell grid intrusions finds still-active vendor-remote-access backdoors in two EU transmission operators, forcing emergency disconnection and public disclosure.
...
## Metrics
```json
{"ai_capability": 67.0, "openweight_capability": 60.0, "ai_safety": 11.0, "resilience": 40.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 23.0, "public_sentiment": 46.0}
```
## Narrative
