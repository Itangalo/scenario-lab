...
- characters 376-1864: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1907-4003: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4059-4634: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4697-29275: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29630-29858: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, capability_jump, ai_investment_collapse, eu_access_secured, adoption_success
- Turn 3 (1 turn(s) ago): opaque_reasoning, openweight_frontier_release, emergent_datacentre_siting_backlash
