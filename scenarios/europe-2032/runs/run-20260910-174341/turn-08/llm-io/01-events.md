...
- characters 375-1566: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1609-3739: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3795-4649: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4712-31316: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31671-32251: `{{event_history}}` from the run's own event record
...
- `emergent_care_rationing_lawsuit` -- first noted turn 7, listed in 1 turn(s) so far: US tiering delays trigger public attribution fight when two EU hospital networks report postponed oncology triage upgrades, sparking lawsuits against vendors and calls for compensation.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, capability_jump, ai_investment_collapse, eu_access_secured, adoption_success
- Turn 3 (5 turn(s) ago): opaque_reasoning, openweight_frontier_release, emergent_datacentre_siting_backlash
- Turn 4 (4 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, adoption_success
- Turn 5 (3 turn(s) ago): eval_anomaly_reports, rsi_onset, election_consolidation
- Turn 6 (2 turn(s) ago): bio_uplift_findings, medical_breakthrough
- Turn 7 (1 turn(s) ago): cyber_major_incident, safety_breakthrough, labour_displacement, export_control_escalation
