...
- characters 106-13610: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13653-13845: `{{metrics_json}}` from the run's live metric values
- characters 13938-16066: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16110-18385: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18441-19367: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 74.0, "openweight_capability": 64.0, "ai_safety": 5.0, "resilience": 38.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 16.0, "public_sentiment": 43.0}
```
