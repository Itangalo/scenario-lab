...
- characters 2549-4824: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4880-5806: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5869-31875: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32230-32544: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, capability_jump, ai_investment_collapse, eu_access_secured, adoption_success
- Turn 3 (2 turn(s) ago): opaque_reasoning, openweight_frontier_release, emergent_datacentre_siting_backlash
- Turn 4 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, adoption_success
