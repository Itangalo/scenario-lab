...
- characters 455-2583: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2627-4902: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6744-7226: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9586-11658: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Bio-Uplift Screening and Rapid Response Net | 6 | small | 4 | 6 | own jurisdiction | resilience up materially against bio incidents, ai_safety up slightly via misuse detection | 2 | running |
