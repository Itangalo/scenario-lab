...
- characters 1402-3101: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5101-5563: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8585-10859: `{{previous_actions}}` from the actor's own response from the previous turn
