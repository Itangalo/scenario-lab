...
- characters 13712-14617: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14660-16359: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16415-17036: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 88.5, "openweight_capability": 83.5, "ai_safety": 2.0, "resilience": 49.0, "eu_ai_sovereignty": 11.0, "eu_political_capital": 8.0, "public_sentiment": 13.0}
```
