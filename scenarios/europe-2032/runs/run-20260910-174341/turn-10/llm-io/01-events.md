...
- characters 1324-3023: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3079-3700: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3763-30367: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30722-31544: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, capability_jump, ai_investment_collapse, eu_access_secured, adoption_success
- Turn 3 (7 turn(s) ago): opaque_reasoning, openweight_frontier_release, emergent_datacentre_siting_backlash
- Turn 4 (6 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, adoption_success
- Turn 5 (5 turn(s) ago): eval_anomaly_reports, rsi_onset, election_consolidation
- Turn 6 (4 turn(s) ago): bio_uplift_findings, medical_breakthrough
- Turn 7 (3 turn(s) ago): cyber_major_incident, safety_breakthrough, labour_displacement, export_control_escalation
- Turn 8 (2 turn(s) ago): loss_of_control_incident, bio_uplift_findings, medical_breakthrough, export_control_escalation, eu_frontier_access_denied
- Turn 9 (1 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, supply_chain_coercion
