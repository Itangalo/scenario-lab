...
- characters 107-13439: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13482-13672: `{{metrics_json}}` from the run's live metric values
- characters 13765-15031: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15075-17116: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17172-17729: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Bio Containment Surge and Care Isolation Net | 2 |
| M14 | EU Entry-Level Work and Humanoid Transition Bridge | 2 |
...
PORTFOLIO CHARGE t12: M12 EU Containment and Continuity Protocol for Rogue Agents −2, M13 EU Bio Containment Surge and Care Isolation Net −2, priority no effect below 20 −0 = −4
PROPOSAL BONUS: EU Bio Containment Surge and Care Isolation Net (cat 6, small) +4 — bio_incident landed this turn with real casualties and weeks-long containment and this answers it directly
LEGITIMACY LENDS: none — capital 21, sentiment 7, capital higher
SOVEREIGNTY: 10 last turn, no cat4 finish, no cat4 in flight +0, middle_power_coalition t12 +2, capability rose 1.5 −1 = 11
...
## Metrics
```json
{"ai_capability": 94.5, "openweight_capability": 90.8, "ai_safety": 0.0, "resilience": 51.0, "eu_ai_sovereignty": 9.0, "eu_political_capital": 15.0, "public_sentiment": 3.0}
```
...
## Notepad
PORTFOLIO CHARGE t13: M13 EU Bio Containment Surge and Care Isolation Net −2, M14 EU Entry-Level Work and Humanoid Transition Bridge −2, priority M13 −1 = −5
PROPOSAL BONUS: EU Entry-Level Work and Humanoid Transition Bridge (cat 7, small) +2 — labour_displacement and embodied_ai_deployment landed this turn with hiring freeze and humanoid imports and this answers them directly
LEGITIMACY LENDS: none — capital 21, sentiment 7, capital higher
SOVEREIGNTY: 11 last turn, no cat4 finish, no cat4 in flight +0, export_control_escalation t13 −2, capability rose 1.5 −0 = 9
