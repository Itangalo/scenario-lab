...
- characters 375-1732: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1775-3960: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4016-4310: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4373-29521: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29876-30877: `{{event_history}}` from the run's own event record
...
LEGITIMACY LENDS: capital 6, sentiment 13 -> +2 (capped by sentiment)
SOVEREIGNTY: 12 last turn, no cat4 finish, no cat4 in flight +0, middle_power_coalition t11 +2, capability rose 1.5 −0 = 14
...
- Turn 2 (10 turn(s) ago): bio_incident
- Turn 3 (9 turn(s) ago): emergent_lab_coverup_revelation
- Turn 5 (7 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response
- Turn 7 (5 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, automated_decision_scandal
- Turn 8 (4 turn(s) ago): export_control_escalation, us_china_agreement
- Turn 9 (3 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, embodied_ai_deployment, export_control_escalation, member_state_defection
- Turn 10 (2 turn(s) ago): capability_jump, ai_investment_collapse, safety_breakthrough, knowledge_work_augmented, export_control_escalation
- Turn 11 (1 turn(s) ago): cyber_major_incident, capability_jump, research_breakthrough, knowledge_work_augmented, adoption_success, middle_power_coalition
