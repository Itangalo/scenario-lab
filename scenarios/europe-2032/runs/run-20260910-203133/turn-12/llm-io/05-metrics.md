...
- characters 106-12923: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12966-13156: `{{metrics_json}}` from the run's live metric values
- characters 13249-14606: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14649-16834: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16890-17184: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 68.5, "openweight_capability": 66.0, "ai_safety": 12.0, "resilience": 37.0, "eu_ai_sovereignty": 12.0, "eu_political_capital": 5.0, "public_sentiment": 18.0}
```
## Narrative
