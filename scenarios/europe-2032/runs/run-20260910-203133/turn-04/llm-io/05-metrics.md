...
- characters 105-13444: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13487-13679: `{{metrics_json}}` from the run's live metric values
- characters 13772-16002: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16045-18123: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18179-19320: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Independent Incident Audit Authority | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Bio Detection and Medical Countermeasure Surge −3, EU Independent Incident Audit Authority −2, priority −1 = −12
PROPOSAL BONUS: EU Independent Incident Audit Authority (cat 1, small) +3 — lab cover-up revelation landed this turn with parliamentary inquiries on both sides and this answers it directly
LEGITIMACY LENDS: capital 24, sentiment 31 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, Gigafactories in flight +0, capability rose 2.0 −1 = 19

## Emerging developments (tracked)

- `emergent_infrastructure_sabotage_wave` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated physical sabotage and blockades halt several data-centre and grid-upgrade construction sites in Spain and the Netherlands, fusing municipal power-price protests with anti-AI activism.
- `emergent_grid_power_backlash` -- first noted turn 4, listed in 1 turn(s) so far: A coordinated municipal moratorium movement links data-centre power connections to grid reliability fears, delaying several gigafactory grid hookups and forcing emergency power-price renegotiations.
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Independent Incident Audit Authority −2, EU AI Displacement Buffer −2, priority M5 −1 = −11
PROPOSAL BONUS: none — no external event in last three turns listed; Buffer answers atmosphere of job-loss hostility but no priced event to answer
LEGITIMACY LENDS: capital 18, sentiment 31 -> +2
