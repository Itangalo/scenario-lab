...
- characters 1821-4036: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6518-6969: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9548-11127: `{{previous_actions}}` from the actor's own response from the previous turn
