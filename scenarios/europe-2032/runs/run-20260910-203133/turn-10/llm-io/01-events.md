...
- characters 376-1700: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1743-3958: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4014-4804: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4867-29756: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30111-30813: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M9 EU Third-Party Accession to US-China Risk Reduction Accord −2, priority M9 −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 10 -> +1 (capped by negative events and floor)
SOVEREIGNTY: 16 last turn, no cat4 finish, no cat4 in flight +0, export_control_escalation t9 −2 (largest of embodied_ai_deployment t9, export_control_escalation t9, member_state_defection t9), capability rose 1.0 −0 = 14

## Emerging developments (tracked)

- `emergent_permit_referendum_revolt` -- first noted turn 8, listed in 2 turn(s) so far: Municipal councils in Spain and the Netherlands vote to put gigafactory power hookups to local referendums, turning grid connection into a direct anti-AI ballot amid benefits-scandal protests.
...
- Turn 2 (8 turn(s) ago): bio_incident
- Turn 3 (7 turn(s) ago): emergent_lab_coverup_revelation
- Turn 5 (5 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response
- Turn 7 (3 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, automated_decision_scandal
- Turn 8 (2 turn(s) ago): export_control_escalation, us_china_agreement
- Turn 9 (1 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, embodied_ai_deployment, export_control_escalation, member_state_defection
