...
- characters 13580-14904: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14947-17162: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17218-17689: `{{notepad}}` from the Game Master's notepad, carried across turns
