...
- characters 105-13300: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13343-13534: `{{metrics_json}}` from the run's live metric values
- characters 13627-14936: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14979-17100: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17156-17777: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Third-Party Accession to US-China Risk Reduction Accord | 2 |
...
- `emergent_permit_referendum_revolt` -- first noted turn 8, listed in 1 turn(s) so far: Municipal councils in Spain and the Netherlands vote to put gigafactory power hookups to local referendums, turning grid connection into a direct anti-AI ballot amid benefits-scandal protests.
...
## Notepad
PORTFOLIO CHARGE t8: M9 Accession −2, priority M9 −1 = −3
PROPOSAL BONUS: Accession (cat 8, small) +2 — export_control_escalation and us_china_agreement landed this turn and this answers exclusion directly, but small size and no prior coordination limit leverage
LEGITIMACY LENDS: capital 2, sentiment 10 -> +1
SOVEREIGNTY: 18 last turn, no cat4 finish, no cat4 in flight, export_control_escalation t8 −2, capability rose 0.5 −0 = 16
