...
- characters 375-1684: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1727-3848: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3904-4206: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4269-30664: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31019-31501: `{{event_history}}` from the run's own event record
...
- Turn 2 (6 turn(s) ago): bio_incident
- Turn 3 (5 turn(s) ago): emergent_lab_coverup_revelation
- Turn 5 (3 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response
- Turn 7 (1 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, automated_decision_scandal
