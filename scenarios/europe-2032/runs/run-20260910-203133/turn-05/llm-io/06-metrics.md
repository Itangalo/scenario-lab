...
- characters 106-13413: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13456-13648: `{{metrics_json}}` from the run's live metric values
- characters 13741-14958: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15002-16648: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16704-17782: `{{notepad}}` from the Game Master's notepad, carried across turns
