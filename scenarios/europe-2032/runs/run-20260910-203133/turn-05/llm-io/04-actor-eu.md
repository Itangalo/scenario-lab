...
- characters 455-1672: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1716-3362: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5065-5512: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7772-9822: `{{previous_actions}}` from the actor's own response from the previous turn
