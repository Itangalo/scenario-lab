...
- characters 107-12978: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13021-13212: `{{metrics_json}}` from the run's live metric values
- characters 13305-14548: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14592-16627: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16683-17391: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Degraded Operations Hardening | 2 |
| M11 | EU Incident Triage and Continuity Cells | 2 |
...
- `emergent_operator_patch_fatigue` -- first noted turn 13, listed in 1 turn(s) so far: Municipal utilities and grid operators stage coordinated go-slow on automated patching after degraded-mode overload, leaving a window of unpatched edge systems through the autumn.
...
## Notepad
PORTFOLIO CHARGE t13: M10 EU Degraded Operations Hardening −2, M11 EU Incident Triage and Continuity Cells −2, priority M10 −1 = −5
PROPOSAL BONUS: EU Incident Triage and Continuity Cells (cat 6, small) +3 — cyber_major_incident lands this turn on already-degraded services and this answers it directly
LEGITIMACY LENDS: capital 5, sentiment 18 -> +2
SOVEREIGNTY: 12 last turn, no capacity event, no cat4 finish, no cat4 in flight +0, capability rose 1.0 −0 = 12
