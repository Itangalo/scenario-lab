...
- characters 377-1620: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1664-3699: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3755-4158: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4221-29369: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29724-30873: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Degraded Operations Hardening −2 = −2 + priority none = −2
PROPOSAL BONUS: none — new hardening answers autumn assault but offices show rehiring and no felt crisis, so no spend-against-problem bonus applies
LEGITIMACY LENDS: capital 3, sentiment 18 -> +2
SOVEREIGNTY: 14 last turn, no cat4 finish, no cat4 in flight +0, embodied_ai_deployment t12 −2, capability rose 1.0 −0 = 12
...
- Turn 2 (11 turn(s) ago): bio_incident
- Turn 3 (10 turn(s) ago): emergent_lab_coverup_revelation
- Turn 5 (8 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response
- Turn 7 (6 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, automated_decision_scandal
- Turn 8 (5 turn(s) ago): export_control_escalation, us_china_agreement
- Turn 9 (4 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, embodied_ai_deployment, export_control_escalation, member_state_defection
- Turn 10 (3 turn(s) ago): capability_jump, ai_investment_collapse, safety_breakthrough, knowledge_work_augmented, export_control_escalation
- Turn 11 (2 turn(s) ago): cyber_major_incident, capability_jump, research_breakthrough, knowledge_work_augmented, adoption_success, middle_power_coalition
- Turn 12 (1 turn(s) ago): openweight_frontier_release, safety_breakthrough, knowledge_work_augmented, embodied_ai_deployment, taiwan_tension_rise
