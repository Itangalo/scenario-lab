...
- characters 455-1999: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2043-4345: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8191-8662: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11241-12936: `{{previous_actions}}` from the actor's own response from the previous turn
