...
- characters 377-1921: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1965-4267: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4323-4651: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4714-29862: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30217-31061: `{{event_history}}` from the run's own event record
...
- Turn 2 (9 turn(s) ago): bio_incident
- Turn 3 (8 turn(s) ago): emergent_lab_coverup_revelation
- Turn 5 (6 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response
- Turn 7 (4 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, automated_decision_scandal
- Turn 8 (3 turn(s) ago): export_control_escalation, us_china_agreement
- Turn 9 (2 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, embodied_ai_deployment, export_control_escalation, member_state_defection
- Turn 10 (1 turn(s) ago): capability_jump, ai_investment_collapse, safety_breakthrough, knowledge_work_augmented, export_control_escalation
