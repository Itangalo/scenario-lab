...
- characters 13167-14711: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14755-17057: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17113-17441: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 67.5, "openweight_capability": 64.8, "ai_safety": 7.0, "resilience": 38.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 8.0, "public_sentiment": 13.0}
```
