...
- characters 1615-3852: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6227-6690: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9107-11756: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Biosynthesis Screening and Model Uplift Containment | 3 | small | 5 | 7 | own jurisdiction | resilience up, ai_safety up slightly | 2 | running |
