...
- characters 1537-3774: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3830-4915: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4978-30770: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31125-31382: `{{event_history}}` from the run's own event record
...
- `emergent_infrastructure_sabotage_wave` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated physical sabotage and blockades halt several data-centre and grid-upgrade construction sites in Spain and the Netherlands, fusing municipal power-price protests with anti-AI activism.
- `emergent_grid_power_backlash` -- first noted turn 4, listed in 2 turn(s) so far: A coordinated municipal moratorium movement links data-centre power connections to grid reliability fears, delaying several gigafactory grid hookups and forcing emergency power-price renegotiations.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, bio_uplift_findings
- Turn 2 (4 turn(s) ago): bio_incident
- Turn 3 (3 turn(s) ago): emergent_lab_coverup_revelation
- Turn 5 (1 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, election_consolidation
