...
- characters 105-13481: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13524-13716: `{{metrics_json}}` from the run's live metric values
- characters 13809-14927: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14970-17207: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17263-17739: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU AI Displacement Buffer | 2 |
| M7 | EU Biosynthesis Screening and Model Uplift Containment | 2 |
| M8 | EU Joint Cyber Telemetry Accession | 2 |
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Displacement Buffer −2, EU Biosynthesis Screening and Model Uplift Containment −2, priority M7 −1 = −11
PROPOSAL BONUS: EU Biosynthesis Screening (cat 3, small) +2 — bio_uplift_findings fired this turn and this answers broker evasion directly
...
## Metrics
```json
{"ai_capability": 62.0, "openweight_capability": 59.3, "ai_safety": 25.0, "resilience": 45.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 10.0, "public_sentiment": 21.0}
```
## Narrative
...
## Notepad
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, EU AI Displacement Buffer −2, EU Biosynthesis Screening and Model Uplift Containment −2, EU Joint Cyber Telemetry Accession −2, priority M8 −1 = −10
PROPOSAL BONUS: none — knowledge_work_augmented suppresses bonus and public cannot feel displacement problem this turn
LEGITIMACY LENDS: capital 8, sentiment 27 -> +2
SOVEREIGNTY: 18 last turn, Tech sovereignty package finishes t6 +4, Gigafactories in flight +0, export_control_escalation t6 −2, capability rose 1.0 −0 = 20
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}}, {"op": "update", "table": "measures", "id": "M8", "fields": {"finish_turn": 7}, "grounds": "named priority"}]}
```
```
