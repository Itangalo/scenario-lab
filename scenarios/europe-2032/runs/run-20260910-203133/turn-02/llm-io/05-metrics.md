...
- characters 105-13053: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13096-13288: `{{metrics_json}}` from the run's live metric values
- characters 13381-14908: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14951-17234: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17290-18451: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Bio Detection and Medical Countermeasure Surge | 3 |
...
## Notepad
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Shield −3, EU Bio Detection and Medical Countermeasure Surge −3, priority −1 = −13
PROPOSAL BONUS: EU Bio Detection and Medical Countermeasure Surge (cat 6, large) +6 — bio_incident landed this turn with real casualties and weeks-long containment and this answers it directly
LEGITIMACY LENDS: capital 31, sentiment 42 -> +2
