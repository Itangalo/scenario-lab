...
- characters 376-1903: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1946-4229: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4285-5446: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5509-29736: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30091-30153: `{{event_history}}` from the run's own event record
