...
- characters 106-13453: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13496-13688: `{{metrics_json}}` from the run's live metric values
- characters 13781-15560: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15604-17497: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17553-18083: `{{notepad}}` from the Game Master's notepad, carried across turns
