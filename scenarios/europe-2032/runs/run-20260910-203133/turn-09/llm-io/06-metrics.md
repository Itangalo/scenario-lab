...
- characters 12989-13180: `{{metrics_json}}` from the run's live metric values
- characters 13273-14946: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14990-17084: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17140-17892: `{{notepad}}` from the Game Master's notepad, carried across turns
