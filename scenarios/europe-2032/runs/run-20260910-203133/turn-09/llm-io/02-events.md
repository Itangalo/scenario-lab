...
- characters 376-2049: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2093-4187: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4243-4995: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5058-29947: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30302-30856: `{{event_history}}` from the run's own event record
...
- Turn 2 (7 turn(s) ago): bio_incident
- Turn 3 (6 turn(s) ago): emergent_lab_coverup_revelation
- Turn 5 (4 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response
- Turn 7 (2 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, automated_decision_scandal
- Turn 8 (1 turn(s) ago): export_control_escalation, us_china_agreement
