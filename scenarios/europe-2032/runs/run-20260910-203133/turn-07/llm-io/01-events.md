...
- characters 377-1480: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1524-3510: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3566-4086: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4149-30544: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30899-31279: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, bio_uplift_findings
- Turn 2 (5 turn(s) ago): bio_incident
- Turn 3 (4 turn(s) ago): emergent_lab_coverup_revelation
- Turn 5 (2 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, election_consolidation
- Turn 6 (1 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response
