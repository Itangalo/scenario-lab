...
- characters 13880-14983: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15027-17013: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17069-17589: `{{notepad}}` from the Game Master's notepad, carried across turns
