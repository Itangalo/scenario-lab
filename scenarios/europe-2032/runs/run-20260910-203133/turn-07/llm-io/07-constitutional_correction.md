...
- characters 2648-3168: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 63.0, "openweight_capability": 60.7, "ai_safety": 23.0, "resilience": 43.5, "eu_ai_sovereignty": 18.0, "eu_political_capital": 3.0, "public_sentiment": 12.0}
```
