...
- characters 1604-3738: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3794-4398: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4461-29365: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29720-29889: `{{event_history}}` from the run's own event record
...
- Turn 3 (1 turn(s) ago): openweight_frontier_release, emergent_grid_toolkit_leak
