...
- characters 105-13724: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13767-13959: `{{metrics_json}}` from the run's live metric values
- characters 14052-15237: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15280-17414: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17470-18689: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Municipal Restoration and Dependency Triage | 2 |
