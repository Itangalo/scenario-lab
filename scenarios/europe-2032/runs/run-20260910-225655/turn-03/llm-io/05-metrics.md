...
- characters 13554-14982: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15026-16894: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16950-17483: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Critical Systems Hardening and Bio-Detection Surge | 2 |
| M5 | EU Open-Weight Misuse Shield and Hosting Duties | 2 |
...
PORTFOLIO CHARGE t2: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU AI Evaluation and Safety Institute −3, M4 EU Critical Systems Hardening and Bio-Detection Surge −2, priority −1 = −12
PROPOSAL BONUS: EU Critical Systems Hardening and Bio-Detection Surge (cat 6, small) +3 — answers autumn grid walk-through last turn and bio_uplift_findings this turn directly
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 51.0, "ai_safety": 28.0, "resilience": 36.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 18.0, "public_sentiment": 36.0}
```
