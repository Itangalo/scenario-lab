...
- `two_year_commitment` (commitment): Absorb shocks and contain distributed AI harm without dependable foreign supply

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Absorb shocks and contain distributed AI harm without dependable foreign supply
