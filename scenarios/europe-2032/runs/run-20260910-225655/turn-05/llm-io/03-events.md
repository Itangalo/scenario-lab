...
- characters 377-1773: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1817-4182: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4238-5405: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5468-33953: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34308-34551: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M5 EU Open-Weight Misuse Shield and Hosting Duties −2, M6 EU Municipal Restoration and Dependency Triage −2, priority −1 = −11
PROPOSAL BONUS: EU Municipal Restoration and Dependency Triage (cat 6, small) +4 — cyber_major_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 14, sentiment 30 -> +2
SOVEREIGNTY: 19 last turn, no capacity event finishes, Gigafactories in flight +0, export_control_escalation t4 −2, capability rose 2.0 −1 = 16

## Emerging developments (tracked)

- `emergent_municipal_blackout` -- first noted turn 4, listed in 1 turn(s) so far: A coordinated relay-mapping intrusion using the public grid toolkit causes a multi-hour distribution outage in a mid-size EU city, forcing emergency load-shedding and public attribution to open-model-enabled sabotage.
- `emergent_anti_datacentre_sabotage` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated protest and sabotage actions physically target data-centre sites and grid-connection works in two or more member states, delaying construction and forcing a policing response.
...
- Turn 2 (3 turn(s) ago): bio_uplift_findings
- Turn 3 (2 turn(s) ago): openweight_frontier_release, emergent_grid_toolkit_leak
- Turn 4 (1 turn(s) ago): cyber_major_incident, export_control_escalation
...
```
[{"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.5}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.18}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.27}, {"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.16}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.18}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.08}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.08}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.05}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.14}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.06}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.15}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "A coordinated relay-mapping intrusion using the public grid toolkit causes a multi-hour distribution outage in a mid-size EU city, forcing emergency load-shedding and public attribution to open-model-enabled sabotage.", "emergent": true, "id": "emergent_municipal_blackout", "probability": 0.22}, {"description": "Coordinated protest and sabotage actions physically target data-centre sites and grid-connection works in two or more member states, delaying construction and forcing a policing response.", "emergent": true, "id": "emergent_anti_datacentre_sabotage", "probability": 0.18}]
```
