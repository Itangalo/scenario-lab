...
- characters 455-1851: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1895-4260: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5450-5890: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8226-10289: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Municipal Restoration and Dependency Triage | 6 | small | 4 | 6 | own jurisdiction | resilience up materially, ai_safety up slightly via incident learning | 2 | running |
