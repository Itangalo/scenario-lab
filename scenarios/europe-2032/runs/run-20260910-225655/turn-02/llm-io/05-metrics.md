...
- characters 105-13164: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13207-13399: `{{metrics_json}}` from the run's live metric values
- characters 13492-14705: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14748-16943: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16999-17715: `{{notepad}}` from the Game Master's notepad, carried across turns
