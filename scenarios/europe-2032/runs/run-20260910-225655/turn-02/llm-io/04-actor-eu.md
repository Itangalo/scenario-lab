...
- characters 4479-4919: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6373-8464: `{{previous_actions}}` from the actor's own response from the previous turn
