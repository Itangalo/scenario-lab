...
- characters 13357-14715: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14759-16741: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16797-17476: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Public Benefit AI Deployment | 2 |
...
- `emergent_cyber_insurance_crunch` -- first noted turn 2, listed in 2 turn(s) so far: A major European insurer reprices cyber cover after the autumn pre-positioning audits, sharply raising premiums or withdrawing cover for municipal utilities and hospitals that cannot prove hardening.
