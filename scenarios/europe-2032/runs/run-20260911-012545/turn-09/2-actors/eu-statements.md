...
- `two_year_commitment` (commitment): Hold essential services open and carry displaced workers through AI-driven disruption

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold essential services open and carry displaced workers through AI-driven disruption
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the commitment period directly ends the timeframe for the original pledge, changing the cost of maintaining it and enabling a strategic update.
