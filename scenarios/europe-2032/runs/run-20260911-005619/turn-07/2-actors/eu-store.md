...
| M9 | EU Trusted Adoption Accelerator | 9 | small | 7 | 9 | own jurisdiction | public_sentiment up, eu_political_capital up, ai_safety up slightly via certified deployment | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Trusted Adoption Accelerator", "category": 9, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, eu_political_capital up, ai_safety up slightly via certified deployment"}, "grounds": "to lock in adoption win with new assurance method"}
  - Grounds: to lock in adoption win with new assurance method
