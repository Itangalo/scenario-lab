...
| M9 | EU Trusted Adoption Accelerator | 9 | small | 7 | 8 | own jurisdiction | public_sentiment up, eu_political_capital up, ai_safety up slightly via certified deployment | 2 | finished |
| M10 | EU Continuity and Screening Emergency Regime | 6 | small | 8 | 9 | own jurisdiction | resilience up, ai_safety up via reduced cyber/bio harm, eu_political_capital protected | 2 | finished |
| M11 | EU Municipal-Hospital Continuity Compact | 6 | small | 9 | 11 | own jurisdiction | resilience up, ai_safety up slightly via reduced cyber/bio harm, eu_political_capital protected | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Municipal-Hospital Continuity Compact", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly via reduced cyber/bio harm, eu_political_capital protected"}, "grounds": "to finish under old safety-capacity commitment while pivoting to governability"}
  - Grounds: to finish under old safety-capacity commitment while pivoting to governability
