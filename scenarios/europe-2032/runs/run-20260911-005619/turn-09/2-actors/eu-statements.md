...
- `two_year_commitment` (commitment): Hold the Union together by keeping essential services running through AI-enabled disruption

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold the Union together by keeping essential services running through AI-enabled disruption
