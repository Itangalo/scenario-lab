...
| M10 | EU Continuity and Screening Emergency Regime | 6 | small | 8 | 10 | own jurisdiction | resilience up, ai_safety up via reduced cyber/bio harm, eu_political_capital protected | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Continuity and Screening Emergency Regime", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up via reduced cyber/bio harm, eu_political_capital protected"}, "grounds": "to answer major incident, cutoff and synthesis crisis together"}
  - Grounds: to answer major incident, cutoff and synthesis crisis together
