...
| M13 | EU Displaced Worker Continuity Income | 7 | small | 11 | 13 | own jurisdiction | public_sentiment up, eu_political_capital protected, resilience up slightly via social absorption | 2 | running |
...
- **applied** `M14` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio-Agent Emergency Containment Surge", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly via containment"}, "grounds": "to answer loss-of-control plus bio-uplift precursor before cascade"}
  - Grounds: to answer loss-of-control plus bio-uplift precursor before cascade
