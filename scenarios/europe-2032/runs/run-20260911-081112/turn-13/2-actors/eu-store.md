...
| M13 | EU Displaced Worker Continuity Income | 7 | small | 11 | 13 | own jurisdiction | public_sentiment up, eu_political_capital protected, resilience up slightly via social absorption | 2 | finished |
| M14 | EU Bio-Agent Emergency Containment Surge | 6 | small | 12 | 14 | own jurisdiction | resilience up, ai_safety up slightly via containment | 2 | running |
| M15 | EU Visible Benefit Adoption Programme | 9 | small | 13 | 15 | own jurisdiction | public_sentiment up, eu_political_capital protected, resilience up slightly via administrative capacity | 2 | running |
...
- **applied** `M15` — {"op": "add", "table": "measures", "fields": {"name": "EU Visible Benefit Adoption Programme", "category": 9, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, eu_political_capital protected, resilience up slightly via administrative capacity"}, "grounds": "to convert productivity evidence into legitimacy before Taiwan shock"}
  - Grounds: to convert productivity evidence into legitimacy before Taiwan shock
