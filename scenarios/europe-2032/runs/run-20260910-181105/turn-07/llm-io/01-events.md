...
- characters 377-3322: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3366-5626: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5682-6515: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6578-29249: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29604-29913: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, ai_investment_collapse, eu_frontier_access_denied
- Turn 3 (4 turn(s) ago): adoption_success
- Turn 5 (2 turn(s) ago): loss_of_control_incident, election_consolidation
- Turn 6 (1 turn(s) ago): bio_uplift_findings, openweight_frontier_release, member_state_defection
