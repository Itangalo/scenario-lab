...
- characters 106-12946: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12989-13181: `{{metrics_json}}` from the run's live metric values
- characters 13274-14561: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14605-16697: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16753-17235: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Public Benefit AI Deployment Sprint | 2 |
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Essential Services Continuity Reserve −2, EU Public Benefit AI Deployment Sprint −2, priority −1 = −11
PROPOSAL BONUS: none — adoption_success is a visible benefit, not a negative shock this sprint answers; no qualifying harm in last three turns
