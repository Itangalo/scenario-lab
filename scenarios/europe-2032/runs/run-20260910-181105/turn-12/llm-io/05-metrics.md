...
- characters 106-13300: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13343-13535: `{{metrics_json}}` from the run's live metric values
- characters 13628-15040: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15083-17064: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17120-17589: `{{notepad}}` from the Game Master's notepad, carried across turns
