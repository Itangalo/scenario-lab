...
- characters 377-1789: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1832-3813: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3869-4658: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4721-27995: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28350-28895: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, ai_investment_collapse, eu_frontier_access_denied
- Turn 3 (9 turn(s) ago): adoption_success
- Turn 5 (7 turn(s) ago): loss_of_control_incident, election_consolidation
- Turn 6 (6 turn(s) ago): bio_uplift_findings, openweight_frontier_release, member_state_defection
- Turn 8 (4 turn(s) ago): cyber_major_incident
- Turn 9 (3 turn(s) ago): taiwan_tension_rise, emergent_insurer_triage_pullback
- Turn 10 (2 turn(s) ago): openweight_frontier_release
- Turn 11 (1 turn(s) ago): export_control_escalation
