...
- characters 377-1807: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1851-4390: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4446-4963: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5026-29153: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29508-30140: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, ai_investment_collapse, eu_frontier_access_denied
- Turn 3 (10 turn(s) ago): adoption_success
- Turn 5 (8 turn(s) ago): loss_of_control_incident, election_consolidation
- Turn 6 (7 turn(s) ago): bio_uplift_findings, openweight_frontier_release, member_state_defection
- Turn 8 (5 turn(s) ago): cyber_major_incident
- Turn 9 (4 turn(s) ago): taiwan_tension_rise, emergent_insurer_triage_pullback
- Turn 10 (3 turn(s) ago): openweight_frontier_release
- Turn 11 (2 turn(s) ago): export_control_escalation
- Turn 12 (1 turn(s) ago): capability_jump, medical_breakthrough, taiwan_tension_rise
