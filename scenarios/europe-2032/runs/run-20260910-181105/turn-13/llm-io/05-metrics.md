...
- characters 107-13347: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13390-13581: `{{metrics_json}}` from the run's live metric values
- characters 13674-15104: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15148-17687: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17743-18599: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Audited Breakthrough Therapies Access Programme | 2 |
| M13 | EU Municipal and Health Systems Cyber Restoration Facility | 2 |
...
PORTFOLIO CHARGE t12: M11 EU Allied Compute Access and Supply Leverage Pact −2, M12 EU Audited Breakthrough Therapies Access Programme −2, priority M11 −1 = −5
PROPOSAL BONUS: none — M12 answers medical_breakthrough firing this turn (positive, not negative) and capability_jump, no qualifying negative event from last three rounds
LEGITIMACY LENDS: capital 20, sentiment 23 -> +1 (included in capital total)
SOVEREIGNTY: 19.5 last turn, no capacity event, no cat4 finish or in flight +0, capability rose 3.2 −1 = 18.5

## Emerging developments (tracked)

- `emergent_strait_freight_suspension` -- first noted turn 13, listed in 1 turn(s) so far: Strait insurance spike forces allied suppliers to suspend volume-licence chip shipments to Europe for weeks, leaving labelled hospital sites and the audited therapies programme without assured compute resupply.
...
## Notepad
PORTFOLIO CHARGE t13: M12 EU Audited Breakthrough Therapies Access Programme −2, M13 EU Municipal and Health Systems Cyber Restoration Facility −2, priority M12 −1 = −5
PROPOSAL BONUS: M13 (cat 6, small) +3 — cyber_major_incident landed this turn severe/public-services-wide and this answers it directly
LEGITIMACY LENDS: capital 23, sentiment 18 -> none (capital higher)
SOVEREIGNTY: 18.5 last turn, no capacity cat4 finish, no cat4 in flight +0, embodied_ai_deployment t13 −1, capability rose 0.0 −0 = 17.5
