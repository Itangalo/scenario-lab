...
- characters 13611-15163: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15206-17217: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17273-17754: `{{notepad}}` from the Game Master's notepad, carried across turns
