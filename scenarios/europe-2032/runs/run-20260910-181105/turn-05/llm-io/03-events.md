...
- characters 377-2145: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2189-4031: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4087-4436: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4499-26173: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26528-26663: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Public Benefit AI Deployment Sprint −2, priority −1 = −9
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, ai_investment_collapse, eu_frontier_access_denied
