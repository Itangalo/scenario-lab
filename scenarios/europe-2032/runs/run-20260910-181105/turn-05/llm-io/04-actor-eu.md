...
- characters 455-2223: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2267-4109: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5630-6103: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8227-9335: `{{previous_actions}}` from the actor's own response from the previous turn
