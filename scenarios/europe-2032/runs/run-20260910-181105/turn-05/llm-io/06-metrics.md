...
- characters 106-13279: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13322-13514: `{{metrics_json}}` from the run's live metric values
- characters 13607-15375: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15419-17261: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17317-17982: `{{notepad}}` from the Game Master's notepad, carried across turns
