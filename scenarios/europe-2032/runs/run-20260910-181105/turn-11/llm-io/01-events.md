...
- characters 1491-3352: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3408-4266: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4329-27603: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27958-28450: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M9 EU Labelled Clinical Triage Continuity Mandate −2, M10 EU Unrecallable Model Containment Protocol −2, priority ineffective (capital below 20) −0 = −4
PROPOSAL BONUS: EU Unrecallable Model Containment Protocol (cat 6, small) +2 — openweight frontier release landed this turn and this answers it directly
LEGITIMACY LENDS: capital 21, sentiment 23 -> +1 [applied after charge, finish, bonus and dampening]
SOVEREIGNTY: 21.5 last turn, no capacity event, no cat4 finish or in flight +0, capability rose 0.8 −0 = 21.5

## Emerging developments (tracked)

- `emergent_strait_medical_supply_crunch` -- first noted turn 10, listed in 1 turn(s) so far: Strait-driven chip-freight and shipping insurance spike triggers spot shortages of imaging consumables and generics in several member states, forcing rationing on the labelled triage path.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, ai_investment_collapse, eu_frontier_access_denied
- Turn 3 (8 turn(s) ago): adoption_success
- Turn 5 (6 turn(s) ago): loss_of_control_incident, election_consolidation
- Turn 6 (5 turn(s) ago): bio_uplift_findings, openweight_frontier_release, member_state_defection
- Turn 8 (3 turn(s) ago): cyber_major_incident
- Turn 9 (2 turn(s) ago): taiwan_tension_rise, emergent_insurer_triage_pullback
- Turn 10 (1 turn(s) ago): openweight_frontier_release
