...
- characters 377-2232: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2276-4370: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4426-5152: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5215-28489: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28844-29200: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M7 EU Bio-Shield Detection Net −2, M8 EU Insurable Continuity Standard −2, priority ineffective (capital below 20) −0 = −4
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 13, sentiment 27 -> +2 (capped below sentiment)
SOVEREIGNTY: 21.5 last turn, no capacity event, no cat4 finish or in flight +0, capability rose 0.7 −0 = 21.5

## Emerging developments (tracked)

- `emergent_insurer_triage_pullback` -- first noted turn 8, listed in 1 turn(s) so far: Major European insurers jointly withdraw cover for AI-assisted clinical triage using unaudited open weights after an adverse audit leak, forcing hospitals to choose between the labelled reserve path and side servers.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, ai_investment_collapse, eu_frontier_access_denied
- Turn 3 (6 turn(s) ago): adoption_success
- Turn 5 (4 turn(s) ago): loss_of_control_incident, election_consolidation
- Turn 6 (3 turn(s) ago): bio_uplift_findings, openweight_frontier_release, member_state_defection
