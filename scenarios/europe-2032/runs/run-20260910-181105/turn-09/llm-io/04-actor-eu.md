...
- characters 455-2310: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2354-4448: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5077-5540: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8140-9423: `{{previous_actions}}` from the actor's own response from the previous turn
