...
- characters 13574-15429: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15473-17567: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17623-18007: `{{notepad}}` from the Game Master's notepad, carried across turns
