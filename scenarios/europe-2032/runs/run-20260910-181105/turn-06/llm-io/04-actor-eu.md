...
- characters 454-2783: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2826-4984: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6198-6661: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8949-11172: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Loss-of-Control Containment Reserve | 6 | small | 5 | 7 | own jurisdiction | resilience up, ai_safety spillover via containment learning | 2 | running |
