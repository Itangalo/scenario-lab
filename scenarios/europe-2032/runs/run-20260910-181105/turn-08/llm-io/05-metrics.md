...
- characters 105-12855: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12898-13090: `{{metrics_json}}` from the run's live metric values
- characters 13183-16983: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 17026-19751: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 19807-20534: `{{notepad}}` from the Game Master's notepad, carried across turns
