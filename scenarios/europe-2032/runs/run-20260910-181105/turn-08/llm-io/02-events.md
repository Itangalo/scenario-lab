...
- characters 376-4176: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 4219-6944: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7000-7385: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 7448-30119: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30474-30783: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, ai_investment_collapse, eu_frontier_access_denied
- Turn 3 (5 turn(s) ago): adoption_success
- Turn 5 (3 turn(s) ago): loss_of_control_incident, election_consolidation
- Turn 6 (2 turn(s) ago): bio_uplift_findings, openweight_frontier_release, member_state_defection
