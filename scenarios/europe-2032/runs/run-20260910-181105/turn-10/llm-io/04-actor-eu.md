...
- characters 2045-3807: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4247-4710: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7486-9726: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Labelled Clinical Triage Continuity Mandate | 6 | small | 9 | 11 | own jurisdiction | resilience up modestly, public_sentiment up via restored trust | 2 | running |
