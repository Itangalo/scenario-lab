...
- characters 1967-3729: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3785-4268: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4331-27605: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27960-28396: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, ai_investment_collapse, eu_frontier_access_denied
- Turn 3 (7 turn(s) ago): adoption_success
- Turn 5 (5 turn(s) ago): loss_of_control_incident, election_consolidation
- Turn 6 (4 turn(s) ago): bio_uplift_findings, openweight_frontier_release, member_state_defection
- Turn 8 (2 turn(s) ago): cyber_major_incident
- Turn 9 (1 turn(s) ago): taiwan_tension_rise, emergent_insurer_triage_pullback
