...
- characters 13600-15147: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15190-16952: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17008-17811: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Labelled Clinical Triage Continuity Mandate | 2 |
| M10 | EU Unrecallable Model Containment Protocol | 2 |
...
PORTFOLIO CHARGE t9: M8 EU Insurable Continuity Standard −2, M9 EU Labelled Clinical Triage Continuity Mandate −2, priority ineffective (capital below 20) −0 = −4
PROPOSAL BONUS: EU Labelled Clinical Triage Continuity Mandate (cat 6, small) +2 — emergent_insurer_triage_pullback landed this turn and this answers it directly
