...
| M11 | EU Sovereign Fallback Stack | 4 | small | 9 | 12 | own jurisdiction | eu_ai_sovereignty up, resilience up slightly via continuity | 2 | finished |
...
| M13 | EU Municipal Restoration and Hardening Cells | 6 | small | 13 | 15 | own jurisdiction | resilience up, eu_political_capital and public_sentiment up slightly via restored services and visible benefit | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Municipal Restoration and Hardening Cells", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_political_capital and public_sentiment up slightly via restored services and visible benefit"}, "grounds": "to answer major cyber incident while capital is near zero"}
  - Grounds: to answer major cyber incident while capital is near zero
