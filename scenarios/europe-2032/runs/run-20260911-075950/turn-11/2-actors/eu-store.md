...
| M10 | EU Displaced Graduates Transition and Retraining Guarantee | 7 | small | 10 | 12 | own jurisdiction | resilience up modestly via social absorption, public_sentiment up, eu_political_capital protected | 2 | running |
| M11 | EU Wartime Neutral Infrastructure Protection Regime | 6 | small | 11 | 13 | own jurisdiction | resilience up modestly, eu_ai_sovereignty protected, eu_political_capital protected | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Wartime Neutral Infrastructure Protection Regime", "category": 6, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "resilience up modestly, eu_ai_sovereignty protected, eu_political_capital protected"}, "grounds": "to shield EU infrastructure from great-power war targeting"}
  - Grounds: to shield EU infrastructure from great-power war targeting
