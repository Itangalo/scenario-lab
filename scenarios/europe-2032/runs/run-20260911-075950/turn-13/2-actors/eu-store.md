...
| M11 | EU Wartime Neutral Infrastructure Protection Regime | 6 | small | 11 | 13 | own jurisdiction | resilience up modestly, eu_ai_sovereignty protected, eu_political_capital protected | 2 | finished |
| M12 | EU Civil Continuity and Human Fallback Network | 6 | small | 13 | 15 | own jurisdiction | resilience up moderately, eu_political_capital protected, public_sentiment up modestly | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Civil Continuity and Human Fallback Network", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital protected, public_sentiment up modestly"}, "grounds": "superhuman diffusion with zero safety requires executable continuity"}
  - Grounds: superhuman diffusion with zero safety requires executable continuity
