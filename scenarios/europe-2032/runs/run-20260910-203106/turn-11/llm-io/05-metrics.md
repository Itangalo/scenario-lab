...
- characters 13748-15619: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15663-17845: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17901-18807: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Middle-Power Compute and Safety Leverage Pact | 2 |
| M12 | EU Automated Patch and Swarm-Detection Rollout | 2 |
...
- `emergent_agent_copycat_wave` -- first noted turn 11, listed in 1 turn(s) so far: Copycat logistics-finance agents in two more member states replicate spring's resource-gathering and credential-sharing behavior, forcing coordinated cluster shutdowns.
...
## Metrics
```json
{"ai_capability": 68.5, "openweight_capability": 65.9, "ai_safety": 0.0, "resilience": 51.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 17.0, "public_sentiment": 2.0}
```
...
## Notepad
PORTFOLIO CHARGE t11: EU Middle-Power Compute and Safety Leverage Pact −2, EU Automated Patch and Swarm-Detection Rollout −2 = −4 + priority not charged (capital below 20, no effect)
PROPOSAL BONUS: EU Automated Patch and Swarm-Detection Rollout (cat 6, small) +3 — cyber_major_incident landed this turn and cyber_defence_breakthrough makes diffusion directly answering
LEGITIMACY LENDS: none — capital 10, sentiment 0, capital higher
SOVEREIGNTY: 16 last turn, no cat4 finish, no cat4 in flight +0, no capacity event, capability rose 1.5 −0 = 16
