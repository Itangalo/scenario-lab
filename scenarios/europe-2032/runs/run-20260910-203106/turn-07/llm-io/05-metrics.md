...
- characters 106-13551: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13594-13785: `{{metrics_json}}` from the run's live metric values
- characters 13878-15738: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15782-18009: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18065-19192: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Black-Box Assurance and Activation Inspection Programme | 2 |
| M9 | EU Critical Continuity and Bio-Sentinel Surge | 2 |
