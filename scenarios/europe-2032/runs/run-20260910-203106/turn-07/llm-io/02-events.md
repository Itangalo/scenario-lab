...
- characters 376-2236: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2280-4507: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4563-5075: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5138-31054: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31409-31943: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, taiwan_tension_rise, eu_access_secured
- Turn 2 (5 turn(s) ago): openweight_frontier_release
- Turn 3 (4 turn(s) ago): cyber_major_incident, openweight_frontier_release
- Turn 4 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, joint_threat_response
- Turn 5 (2 turn(s) ago): capability_jump, ai_investment_collapse, knowledge_work_augmented, election_consolidation
- Turn 6 (1 turn(s) ago): opaque_reasoning, embodied_ai_deployment, taiwan_tension_rise, export_control_escalation
