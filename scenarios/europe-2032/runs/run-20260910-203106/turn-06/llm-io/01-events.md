...
- characters 2165-4396: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4452-5248: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5311-31321: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31676-32095: `{{event_history}}` from the run's own event record
...
- `emergent_municipal_copycat_wave` -- first noted turn 4, listed in 2 turn(s) so far: Copycat municipal extortion wave using the openly available intrusion tooling forces several mid-size cities to suspend e-services for weeks, triggering street protests over data-centre siting and recovery spending.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, taiwan_tension_rise, eu_access_secured
- Turn 2 (4 turn(s) ago): openweight_frontier_release
- Turn 3 (3 turn(s) ago): cyber_major_incident, openweight_frontier_release
- Turn 4 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, joint_threat_response
- Turn 5 (1 turn(s) ago): capability_jump, ai_investment_collapse, knowledge_work_augmented, election_consolidation
