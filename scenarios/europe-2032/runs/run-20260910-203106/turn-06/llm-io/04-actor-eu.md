...
- characters 2243-4474: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6929-7416: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9864-12522: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | Transatlantic Tier-1 Access Bargain | 8 | small | 5 | 7 | coalition | eu_ai_sovereignty up slightly via secured access, resilience up slightly via continuity | 2 | running |
