...
- characters 375-1710: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1753-3999: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4055-4582: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4645-30696: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31051-32012: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, taiwan_tension_rise, eu_access_secured
- Turn 2 (8 turn(s) ago): openweight_frontier_release
- Turn 3 (7 turn(s) ago): cyber_major_incident, openweight_frontier_release
- Turn 4 (6 turn(s) ago): cyber_major_incident, eval_anomaly_reports, joint_threat_response
- Turn 5 (5 turn(s) ago): capability_jump, ai_investment_collapse, knowledge_work_augmented, election_consolidation
- Turn 6 (4 turn(s) ago): opaque_reasoning, embodied_ai_deployment, taiwan_tension_rise, export_control_escalation
- Turn 7 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release
- Turn 8 (2 turn(s) ago): loss_of_control_incident, taiwan_blockade, eval_anomaly_reports, research_breakthrough, taiwan_tension_rise, eu_frontier_access_denied, joint_threat_response
- Turn 9 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, export_control_escalation, emergent_tier_pricing_shock
