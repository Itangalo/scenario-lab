...
- characters 106-13016: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13059-13249: `{{metrics_json}}` from the run's live metric values
- characters 13342-14677: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14720-16966: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17022-17549: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Essential Services Degrade-Gracefully and Bio-Response Pact | 2 |
...
PORTFOLIO CHARGE t9: EU Essential Services Degrade-Gracefully and Bio-Response Pact −2 = −2 + priority not charged (capital below 20, no effect)
PROPOSAL BONUS: EU Essential Services Degrade-Gracefully Pact (cat 6, small) +3 — cyber_major_incident landed this turn and bio_uplift_findings precursor this turn, this answers both directly
LEGITIMACY LENDS: none — capital 10, sentiment 8, capital higher
SOVEREIGNTY: 17 last turn, no cat4 finish, no cat4 in flight +0, export_control_escalation t9 −3, capability rose 1.0 −0 = 14
