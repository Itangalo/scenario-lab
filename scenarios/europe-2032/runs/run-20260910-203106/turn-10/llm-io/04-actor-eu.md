...
- characters 453-1788: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1831-4077: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5225-5712: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8733-11136: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Essential Services Degrade-Gracefully and Bio-Response Pact | 6 | small | 9 | 11 | own jurisdiction | resilience up materially, ai_safety up slightly via incident learning | 2 | running |
