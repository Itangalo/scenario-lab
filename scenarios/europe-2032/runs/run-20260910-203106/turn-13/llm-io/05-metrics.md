...
- characters 13700-14659: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14703-16440: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16496-16855: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Essential Services Islanding and Recovery Corps | 2 |
...
## Notepad
PORTFOLIO CHARGE t13: EU Essential Services Islanding and Recovery Corps −2, priority −1 = −3
...
LEGITIMACY LENDS: none — capital 20, sentiment 1, capital higher
SOVEREIGNTY: 16 last turn, no cat4 finish, no cat4 in flight +0, no capacity event, capability rose 1.0 −0 = 16
