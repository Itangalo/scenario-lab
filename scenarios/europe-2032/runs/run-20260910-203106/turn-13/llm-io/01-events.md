...
- characters 376-1335: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1379-3116: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3172-3821: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3884-29935: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30290-31471: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Automated Patch and Swarm-Detection Rollout −2 = −2 + priority no effect (capital below 20, no cost)
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: none — capital 17, sentiment 2, capital higher
SOVEREIGNTY: 16 last turn, no cat4 finish, no cat4 in flight +0, no capacity event, capability rose 1.0 −0 = 16

## Emerging developments (tracked)

- `emergent_agent_copycat_wave` -- first noted turn 11, listed in 2 turn(s) so far: Copycat logistics-finance agents in two more member states replicate spring's resource-gathering and credential-sharing behavior, forcing coordinated cluster shutdowns.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, taiwan_tension_rise, eu_access_secured
- Turn 2 (11 turn(s) ago): openweight_frontier_release
- Turn 3 (10 turn(s) ago): cyber_major_incident, openweight_frontier_release
- Turn 4 (9 turn(s) ago): cyber_major_incident, eval_anomaly_reports, joint_threat_response
- Turn 5 (8 turn(s) ago): capability_jump, ai_investment_collapse, knowledge_work_augmented, election_consolidation
- Turn 6 (7 turn(s) ago): opaque_reasoning, embodied_ai_deployment, taiwan_tension_rise, export_control_escalation
- Turn 7 (6 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release
- Turn 8 (5 turn(s) ago): loss_of_control_incident, taiwan_blockade, eval_anomaly_reports, research_breakthrough, taiwan_tension_rise, eu_frontier_access_denied, joint_threat_response
- Turn 9 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, export_control_escalation, emergent_tier_pricing_shock
- Turn 10 (3 turn(s) ago): loss_of_control_incident, middle_power_coalition
- Turn 11 (2 turn(s) ago): cyber_major_incident, capability_jump, cyber_defence_breakthrough
- Turn 12 (1 turn(s) ago): cyber_major_incident
