...
- characters 13443-13633: `{{metrics_json}}` from the run's live metric values
- characters 13726-14765: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14808-17180: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17236-18072: `{{notepad}}` from the Game Master's notepad, carried across turns
