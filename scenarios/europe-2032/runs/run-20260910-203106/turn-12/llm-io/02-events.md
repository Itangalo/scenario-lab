...
- characters 1457-3829: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3885-4721: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4784-30835: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31190-32322: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, taiwan_tension_rise, eu_access_secured
- Turn 2 (10 turn(s) ago): openweight_frontier_release
- Turn 3 (9 turn(s) ago): cyber_major_incident, openweight_frontier_release
- Turn 4 (8 turn(s) ago): cyber_major_incident, eval_anomaly_reports, joint_threat_response
- Turn 5 (7 turn(s) ago): capability_jump, ai_investment_collapse, knowledge_work_augmented, election_consolidation
- Turn 6 (6 turn(s) ago): opaque_reasoning, embodied_ai_deployment, taiwan_tension_rise, export_control_escalation
- Turn 7 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release
- Turn 8 (4 turn(s) ago): loss_of_control_incident, taiwan_blockade, eval_anomaly_reports, research_breakthrough, taiwan_tension_rise, eu_frontier_access_denied, joint_threat_response
- Turn 9 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, export_control_escalation, emergent_tier_pricing_shock
- Turn 10 (2 turn(s) ago): loss_of_control_incident, middle_power_coalition
- Turn 11 (1 turn(s) ago): cyber_major_incident, capability_jump, cyber_defence_breakthrough
