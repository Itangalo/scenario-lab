...
- characters 105-13003: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13046-13237: `{{metrics_json}}` from the run's live metric values
- characters 13330-14686: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14729-17326: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17382-18536: `{{notepad}}` from the Game Master's notepad, carried across turns
