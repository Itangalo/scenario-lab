...
- characters 375-1731: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1774-4371: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4427-5581: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5644-31560: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31915-32546: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU Black-Box Assurance and Activation Inspection Programme −2, EU Critical Continuity and Bio-Sentinel Surge −2, priority −1 = −5
PROPOSAL BONUS: EU Critical Continuity and Bio-Sentinel Surge (cat 6, small) +3 — cyber_major_incident landed this turn and bio_uplift_findings opened bio gate and this answers both directly
LEGITIMACY LENDS: none — capital 22, sentiment 13, capital higher
SOVEREIGNTY: 21 last turn, InvestAI Gigafactories finishes t7 +4, no capacity event, no cat4 in flight, capability rose 1.0 −0 = 25

## Emerging developments (tracked)

- `emergent_tier_pricing_shock` -- first noted turn 7, listed in 1 turn(s) so far: A major transatlantic cloud provider announces per-seat frontier-agent pricing and regional throughput caps for European enterprise customers, citing US tier-review compliance costs, triggering contract renegotiations and press coverage of a two-tier AI market.
- `emergent_logistics_strike_escalation` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated dockworker and warehouse strike wave spreads from major ports to inland logistics hubs, blocking automation retrofits for weeks.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, taiwan_tension_rise, eu_access_secured
- Turn 2 (6 turn(s) ago): openweight_frontier_release
- Turn 3 (5 turn(s) ago): cyber_major_incident, openweight_frontier_release
- Turn 4 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, joint_threat_response
- Turn 5 (3 turn(s) ago): capability_jump, ai_investment_collapse, knowledge_work_augmented, election_consolidation
- Turn 6 (2 turn(s) ago): opaque_reasoning, embodied_ai_deployment, taiwan_tension_rise, export_control_escalation
- Turn 7 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release
