...
- characters 2150-4424: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5324-5814: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7781-9718: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M4 | EU Incident Reporting and Misuse Telemetry Network | 2 | small | 2 | 4 | own jurisdiction | resilience up, ai_safety up slightly via incident learning | 2 | running |
