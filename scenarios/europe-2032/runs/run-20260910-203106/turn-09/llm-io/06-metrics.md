...
- characters 13587-13777: `{{metrics_json}}` from the run's live metric values
- characters 13870-14863: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14907-17071: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17127-17526: `{{notepad}}` from the Game Master's notepad, carried across turns
