...
- characters 1490-3654: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5879-6366: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9036-10225: `{{previous_actions}}` from the actor's own response from the previous turn
