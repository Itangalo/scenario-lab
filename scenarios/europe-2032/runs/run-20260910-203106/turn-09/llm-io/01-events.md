...
- characters 1412-3576: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3632-4646: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4709-30760: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31115-31930: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Black-Box Assurance and Activation Inspection Programme −2, EU Critical Continuity and Bio-Sentinel Surge −2, priority −1 = −5
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: none — capital 17, sentiment 13, capital higher
SOVEREIGNTY: 19 last turn, no cat4 finish, no cat4 in flight +0, eu_frontier_access_denied t8 −2, capability rose 1.0 −0 = 17

## Emerging developments (tracked)

- `emergent_tier_pricing_shock` -- first noted turn 7, listed in 2 turn(s) so far: A major transatlantic cloud provider announces per-seat frontier-agent pricing and regional throughput caps for European enterprise customers, citing US tier-review compliance costs, triggering contract renegotiations and press coverage of a two-tier AI market.
- `emergent_logistics_strike_escalation` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated dockworker and warehouse strike wave spreads from major ports to inland logistics hubs, blocking automation retrofits for weeks.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, taiwan_tension_rise, eu_access_secured
- Turn 2 (7 turn(s) ago): openweight_frontier_release
- Turn 3 (6 turn(s) ago): cyber_major_incident, openweight_frontier_release
- Turn 4 (5 turn(s) ago): cyber_major_incident, eval_anomaly_reports, joint_threat_response
- Turn 5 (4 turn(s) ago): capability_jump, ai_investment_collapse, knowledge_work_augmented, election_consolidation
- Turn 6 (3 turn(s) ago): opaque_reasoning, embodied_ai_deployment, taiwan_tension_rise, export_control_escalation
- Turn 7 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release
- Turn 8 (1 turn(s) ago): loss_of_control_incident, taiwan_blockade, eval_anomaly_reports, research_breakthrough, taiwan_tension_rise, eu_frontier_access_denied, joint_threat_response
