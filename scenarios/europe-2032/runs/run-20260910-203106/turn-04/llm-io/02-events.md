...
- characters 376-1870: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1913-4205: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4261-4734: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4797-29701: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30056-30267: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, taiwan_tension_rise, eu_access_secured
- Turn 2 (2 turn(s) ago): openweight_frontier_release
- Turn 3 (1 turn(s) ago): cyber_major_incident, openweight_frontier_release
