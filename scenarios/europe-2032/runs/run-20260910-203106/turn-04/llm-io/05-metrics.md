...
- characters 105-13532: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13575-13767: `{{metrics_json}}` from the run's live metric values
- characters 13860-15354: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15397-17689: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17745-18558: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | Joint Threat Response Accession | 2 |
