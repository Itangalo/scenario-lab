...
- characters 455-2679: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2723-4875: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7516-8006: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10272-12300: `{{previous_actions}}` from the actor's own response from the previous turn
