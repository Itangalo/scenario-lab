...
- characters 13690-15914: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15958-18110: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18166-18959: `{{notepad}}` from the Game Master's notepad, carried across turns
