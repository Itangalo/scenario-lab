...
- `two_year_commitment` (commitment): Hold essential services and livelihoods standing through dependence and disruption

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold essential services and livelihoods standing through dependence and disruption
