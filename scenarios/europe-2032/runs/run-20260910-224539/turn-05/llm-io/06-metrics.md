...
- characters 106-13679: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13722-13913: `{{metrics_json}}` from the run's live metric values
- characters 14006-15041: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15085-17060: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17116-18013: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_cyber_insurance_retreat` -- first noted turn 5, listed in 1 turn(s) so far: Major European insurers begin excluding AI-model-assisted cyber losses from standard municipal and utility policies, citing the grid cascade attribution, triggering emergency state backstop demands.
...
## Metrics
```json
{"ai_capability": 67.0, "openweight_capability": 60.0, "ai_safety": 25.0, "resilience": 43.0, "eu_ai_sovereignty": 13.0, "eu_political_capital": 4.0, "public_sentiment": 26.0}
```
## Narrative
