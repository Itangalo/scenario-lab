...
- characters 376-1411: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1455-3430: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3486-4059: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4122-30378: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30733-30988: `{{event_history}}` from the run's own event record
...
- Turn 3 (2 turn(s) ago): cyber_major_incident, ai_investment_collapse, safety_breakthrough, knowledge_work_augmented
- Turn 4 (1 turn(s) ago): opaque_reasoning, joint_threat_response, emergent_open_model_backlash
