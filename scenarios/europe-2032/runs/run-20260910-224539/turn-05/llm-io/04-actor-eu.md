...
- characters 1533-3508: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5117-5557: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7792-9825: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Joint Cyber Defence Accession | 8 | small | 4 | 6 | own jurisdiction | resilience up substantially | 2 | running |
...
| M4 | EU Critical Infrastructure Cyber Shield | 6 | large | 2 | 5 | own jurisdiction | resilience up substantially, ai_safety up modestly via detection | 3 | finished |
| M5 | EU Displaced Workers Transition Fund | 7 | small | 3 | 5 | own jurisdiction | resilience up via social absorption, public_sentiment up modestly | 2 | finished |
