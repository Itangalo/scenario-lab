...
- characters 13506-14673: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14716-16971: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17027-18046: `{{notepad}}` from the Game Master's notepad, carried across turns
