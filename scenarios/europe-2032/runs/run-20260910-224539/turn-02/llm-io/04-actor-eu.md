...
- characters 3987-4427: `{{statement_ledger}}` from the actor's live statement ledger
- characters 5881-7972: `{{previous_actions}}` from the actor's own response from the previous turn
