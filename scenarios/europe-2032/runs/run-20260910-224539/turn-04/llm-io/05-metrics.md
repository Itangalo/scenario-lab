...
- characters 105-13591: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13634-13826: `{{metrics_json}}` from the run's live metric values
- characters 13919-15439: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15482-17872: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17928-18500: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Joint Cyber Defence Accession | 2 |
...
## Notepad
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Critical Infrastructure Cyber Shield −3, M5 EU Displaced Workers Transition Fund −2, M6 EU Joint Cyber Defence Accession −2, priority −1 = −14
PROPOSAL BONUS: EU Joint Cyber Defence Accession (cat 8, small) +3 — answers autumn automated cascade and attribution to open-model tooling from last turn directly, small but timely pooled protection
