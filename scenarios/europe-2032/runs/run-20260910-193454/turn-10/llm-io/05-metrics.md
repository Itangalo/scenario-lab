...
- characters 13062-14061: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14104-15991: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16047-16688: `{{notepad}}` from the Game Master's notepad, carried across turns
