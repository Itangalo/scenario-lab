...
- characters 376-1375: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1418-3305: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3361-4002: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4065-28205: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28560-29279: `{{event_history}}` from the run's own event record
...
LEGITIMACY LENDS: capital 0, sentiment 12 -> +0, capital already below sentiment but at floor, no lend applied
SOVEREIGNTY: 19 last turn, no capacity build finishing, supply_chain_coercion t9 −2, capability rose 0.7 −0 = 17

## Emerging developments (tracked)

- `emergent_permit_freeze_backlash` -- first noted turn 9, listed in 1 turn(s) so far: Municipal-led data-centre blockades spread across southern member states, with courts granting interim injunctions that freeze two gigafactory-site permits through the turn.
...
- Turn 2 (8 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, adoption_success
- Turn 3 (7 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 5 (5 turn(s) ago): emergent_procurement_auction, election_consolidation
- Turn 6 (4 turn(s) ago): bio_incident, openweight_frontier_release, export_control_escalation, member_state_defection
- Turn 7 (3 turn(s) ago): openweight_frontier_release, export_control_escalation
- Turn 8 (2 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, taiwan_tension_rise, automated_decision_scandal
- Turn 9 (1 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, supply_chain_coercion
