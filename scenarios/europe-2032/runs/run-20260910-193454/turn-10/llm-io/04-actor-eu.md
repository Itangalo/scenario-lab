...
- characters 454-1453: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1496-3383: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3799-4228: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6135-7384: `{{previous_actions}}` from the actor's own response from the previous turn
