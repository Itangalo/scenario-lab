...
- characters 375-1569: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1612-3258: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3314-3614: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3677-27214: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27569-28062: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: no measures in flight, priority none = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 26 -> +2
SOVEREIGNTY: 22 last turn, no category 4 finish, no build in flight +0, export_control_escalation t7 −3, capability rose 0.8 −0 = 19
...
- Turn 2 (6 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, adoption_success
- Turn 3 (5 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 5 (3 turn(s) ago): emergent_procurement_auction, election_consolidation
- Turn 6 (2 turn(s) ago): bio_incident, openweight_frontier_release, export_control_escalation, member_state_defection
- Turn 7 (1 turn(s) ago): openweight_frontier_release, export_control_escalation
