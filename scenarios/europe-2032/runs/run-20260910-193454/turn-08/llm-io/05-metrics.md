...
- characters 105-12731: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12774-12965: `{{metrics_json}}` from the run's live metric values
- characters 13058-14252: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14295-15941: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 15997-16297: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 62.0, "openweight_capability": 58.6, "ai_safety": 18.0, "resilience": 44.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 1.0, "public_sentiment": 18.0}
```
