...
- characters 2443-4510: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4566-5098: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5161-27782: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28137-28351: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, adoption_success
- Turn 3 (1 turn(s) ago): openweight_frontier_release, member_state_defection
