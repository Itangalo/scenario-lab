...
- characters 376-1561: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1605-3974: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4030-5096: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5159-27780: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28135-28349: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, Grid and Port Cyber Shield −3, Trusted Public AI Rollout −2, Distributed Capability Containment Net −2, priority −1 = −14, priority cost waived as capital below 20, charged −13
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 14, sentiment 42 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, Gigafactories/tech package in flight +0, capability rose 1.5 −0 = 20

## Emerging developments (tracked)

- `emergent_procurement_auction` -- first noted turn 4, listed in 1 turn(s) so far: A second EU capital publicly shops a separate hyperscaler cloud deal after the first defection, triggering competitive tender freezes and press coverage of a sovereignty auction.
- `emergent_gulf_gigafactory_bid` -- first noted turn 4, listed in 1 turn(s) so far: A Gulf sovereign fund offers bridge financing for one stalled EU gigafactory site on condition of dedicated capacity and looser data terms, forcing a public choice on foreign ownership of sovereign compute.
...
- Turn 2 (3 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, adoption_success
- Turn 3 (2 turn(s) ago): openweight_frontier_release, member_state_defection
