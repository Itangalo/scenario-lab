...
- characters 13458-13649: `{{metrics_json}}` from the run's live metric values
- characters 13742-14927: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14971-17340: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17396-18199: `{{notepad}}` from the Game Master's notepad, carried across turns
