...
- characters 1683-4052: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5199-5648: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7716-8846: `{{previous_actions}}` from the actor's own response from the previous turn
