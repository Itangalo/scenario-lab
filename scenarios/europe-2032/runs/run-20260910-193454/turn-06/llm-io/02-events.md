...
- characters 375-1677: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1720-3857: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3913-4652: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4715-25954: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26309-26602: `{{event_history}}` from the run's own event record
...
- `emergent_gulf_gigafactory_bid` -- first noted turn 4, listed in 2 turn(s) so far: A Gulf sovereign fund offers bridge financing for one stalled EU gigafactory site on condition of dedicated capacity and looser data terms, forcing a public choice on foreign ownership of sovereign compute.
...
- Turn 2 (4 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, adoption_success
- Turn 3 (3 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 5 (1 turn(s) ago): emergent_procurement_auction, election_consolidation
