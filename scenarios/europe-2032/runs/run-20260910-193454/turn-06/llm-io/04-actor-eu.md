...
- characters 453-1755: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1798-3935: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5280-5712: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7782-9470: `{{previous_actions}}` from the actor's own response from the previous turn
