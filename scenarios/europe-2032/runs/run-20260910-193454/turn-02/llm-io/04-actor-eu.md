...
- characters 1866-4115: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5079-5528: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6978-9088: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M3 | Grid and Port Cyber Shield | 6 | large | 1 | 3 | own jurisdiction | resilience up, ai_safety up slightly via detection | 3 | running |
