...
- characters 1788-4037: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4093-5169: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5232-28514: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28869-28910: `{{event_history}}` from the run's own event record
