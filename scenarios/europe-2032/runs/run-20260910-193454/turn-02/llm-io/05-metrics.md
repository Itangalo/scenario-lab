...
- characters 105-12918: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12961-13153: `{{metrics_json}}` from the run's live metric values
- characters 13246-14615: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14658-16907: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16963-18039: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | Trusted Public AI Rollout | 2 |
...
- `emergent_datacentre_backlash` -- first noted turn 1, listed in 2 turn(s) so far: Coordinated municipal protests and legal challenges block or delay at least one major data-centre build in the EU over power prices and water use, turning siting into a national political issue.
- `emergent_research_integrity_crackdown` -- first noted turn 1, listed in 2 turn(s) so far: Major European scientific publishers and universities jointly mandate disclosure and watermarking of AI-generated research after the Millennium Prize controversy triggers fraud investigations.
...
## Metrics
```json
{"ai_capability": 54.5, "openweight_capability": 49.8, "ai_safety": 30.0, "resilience": 38.0, "eu_ai_sovereignty": 22.0, "eu_political_capital": 35.0, "public_sentiment": 45.0}
```
...
## Notepad
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, Grid and Port Cyber Shield −3, Trusted Public AI Rollout −2, priority −1 = −12
PROPOSAL BONUS: none — Trusted Public AI Rollout (cat 9, small) answers adoption_success positive window, not a negative event from last three rounds
LEGITIMACY LENDS: capital 33, sentiment 45 -> +2
