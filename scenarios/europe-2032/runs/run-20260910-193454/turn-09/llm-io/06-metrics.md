...
- characters 106-12733: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12776-12967: `{{metrics_json}}` from the run's live metric values
- characters 13060-14104: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14148-16244: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16300-16862: `{{notepad}}` from the Game Master's notepad, carried across turns
