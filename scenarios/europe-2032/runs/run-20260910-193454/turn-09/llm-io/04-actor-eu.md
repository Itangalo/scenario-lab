...
- characters 1542-3638: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4825-5257: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7164-8368: `{{previous_actions}}` from the actor's own response from the previous turn
