...
- characters 376-1420: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1464-3560: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3616-3880: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3943-28083: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28438-29059: `{{event_history}}` from the run's own event record
...
LEGITIMACY LENDS: capital 0, sentiment 18 -> +1
SOVEREIGNTY: 19 last turn, no capacity event, no build in flight +0, capability rose 0.7 −0 = 19
...
- Turn 2 (7 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, adoption_success
- Turn 3 (6 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 5 (4 turn(s) ago): emergent_procurement_auction, election_consolidation
- Turn 6 (3 turn(s) ago): bio_incident, openweight_frontier_release, export_control_escalation, member_state_defection
- Turn 7 (2 turn(s) ago): openweight_frontier_release, export_control_escalation
- Turn 8 (1 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, taiwan_tension_rise, automated_decision_scandal
