...
- characters 1683-3626: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3682-4269: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4332-28472: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28827-29594: `{{event_history}}` from the run's own event record
...
LEGITIMACY LENDS: capital 0.0, sentiment 12.0 -> +1, capped below sentiment
SOVEREIGNTY: 17 last turn, no capacity event, no cat4 in flight, capability rose 0.7 −0 = 17

## Emerging developments (tracked)

- `emergent_permit_freeze_backlash` -- first noted turn 9, listed in 2 turn(s) so far: Municipal-led data-centre blockades spread across southern member states, with courts granting interim injunctions that freeze two gigafactory-site permits through the turn.
...
- Turn 2 (9 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, adoption_success
- Turn 3 (8 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 5 (6 turn(s) ago): emergent_procurement_auction, election_consolidation
- Turn 6 (5 turn(s) ago): bio_incident, openweight_frontier_release, export_control_escalation, member_state_defection
- Turn 7 (4 turn(s) ago): openweight_frontier_release, export_control_escalation
- Turn 8 (3 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, taiwan_tension_rise, automated_decision_scandal
- Turn 9 (2 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, supply_chain_coercion
- Turn 10 (1 turn(s) ago): safety_breakthrough
