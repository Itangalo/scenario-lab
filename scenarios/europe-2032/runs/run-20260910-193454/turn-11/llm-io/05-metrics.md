...
- characters 107-12736: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12779-12970: `{{metrics_json}}` from the run's live metric values
- characters 13063-14325: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14369-16312: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16368-16657: `{{notepad}}` from the Game Master's notepad, carried across turns
