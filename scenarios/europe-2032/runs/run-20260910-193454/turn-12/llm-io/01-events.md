...
- characters 1614-3736: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3792-4081: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4144-28284: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28639-29578: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: no measures in flight, priority none = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0.0, sentiment 11.0 -> +1, capped below sentiment
...
- Turn 2 (10 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, adoption_success
- Turn 3 (9 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 5 (7 turn(s) ago): emergent_procurement_auction, election_consolidation
- Turn 6 (6 turn(s) ago): bio_incident, openweight_frontier_release, export_control_escalation, member_state_defection
- Turn 7 (5 turn(s) ago): openweight_frontier_release, export_control_escalation
- Turn 8 (4 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, taiwan_tension_rise, automated_decision_scandal
- Turn 9 (3 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, supply_chain_coercion
- Turn 10 (2 turn(s) ago): safety_breakthrough
- Turn 11 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, safety_breakthrough, knowledge_work_augmented, emergent_permit_freeze_backlash
