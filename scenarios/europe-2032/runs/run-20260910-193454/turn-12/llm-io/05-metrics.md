...
- characters 13062-14257: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14300-16422: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16478-16767: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 64.8, "openweight_capability": 64.0, "ai_safety": 24.0, "resilience": 41.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 0.0, "public_sentiment": 12.0}
```
## Narrative
