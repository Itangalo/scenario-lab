...
- characters 106-12971: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13014-13206: `{{metrics_json}}` from the run's live metric values
- characters 13299-15231: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15275-17453: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17509-17978: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | Distributed Capability Containment Net | 2 |
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, Grid and Port Cyber Shield −3, Trusted Public AI Rollout −2, Distributed Capability Containment Net −2, priority −1 = −14
PROPOSAL BONUS: none — Containment Net answers this turn's open release and defection, not a negative event from last three rounds
LEGITIMACY LENDS: capital 12, sentiment 42 -> +2
SOVEREIGNTY: 22 last turn, no capacity event finishes, Gigafactories/tech package in flight +0, member_state_defection t3 −2, capability rose 1.5 −0 = 20
