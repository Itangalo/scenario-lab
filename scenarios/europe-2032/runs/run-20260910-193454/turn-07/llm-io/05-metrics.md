...
- characters 106-13085: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13128-13319: `{{metrics_json}}` from the run's live metric values
- characters 13412-14928: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14972-17261: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17317-17790: `{{notepad}}` from the Game Master's notepad, carried across turns
