...
- characters 376-1892: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1936-4225: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4281-4754: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4817-28354: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28709-29121: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, adoption_success
- Turn 3 (4 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 5 (2 turn(s) ago): emergent_procurement_auction, election_consolidation
- Turn 6 (1 turn(s) ago): bio_incident, openweight_frontier_release, export_control_escalation, member_state_defection
