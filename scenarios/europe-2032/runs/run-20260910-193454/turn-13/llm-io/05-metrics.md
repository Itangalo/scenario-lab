...
- characters 13063-14065: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14109-16168: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16224-16564: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0.0, sentiment 10.0 -> +0, capital remains at floor 0, capped below sentiment
SOVEREIGNTY: 17 last turn, no capacity build finishing or in flight, export_control_escalation t13 −1, capability rose 0.7 −0 = 16
