...
- characters 377-1379: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1423-3482: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3538-3878: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3941-28081: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28436-29497: `{{event_history}}` from the run's own event record
...
LEGITIMACY LENDS: capital 1.0, sentiment 11.0 -> +1, capped below sentiment; net with openweight shock leaves capital at floor
SOVEREIGNTY: 17 last turn, no capacity event, no cat4 in flight, capability rose 0.7 −0 = 17
...
- Turn 2 (11 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, adoption_success
- Turn 3 (10 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 5 (8 turn(s) ago): emergent_procurement_auction, election_consolidation
- Turn 6 (7 turn(s) ago): bio_incident, openweight_frontier_release, export_control_escalation, member_state_defection
- Turn 7 (6 turn(s) ago): openweight_frontier_release, export_control_escalation
- Turn 8 (5 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, taiwan_tension_rise, automated_decision_scandal
- Turn 9 (4 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, supply_chain_coercion
- Turn 10 (3 turn(s) ago): safety_breakthrough
- Turn 11 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, safety_breakthrough, knowledge_work_augmented, emergent_permit_freeze_backlash
- Turn 12 (1 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, safety_breakthrough, joint_threat_response
