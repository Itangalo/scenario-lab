...
| M8 | EU Essential Services Cyber-Bio Shield | 6 | small | 7 | 9 | own jurisdiction | resilience up moderately, ai_safety protected, eu_political_capital protected | 2 | running |
...
- **applied** `M8` — {"op": "add", "table": "measures", "fields": {"name": "EU Essential Services Cyber-Bio Shield", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected, eu_political_capital protected"}, "grounds": "automated cyber incident plus bio-uplift precursor plus displacement demand absorb-first response"}
  - Grounds: automated cyber incident plus bio-uplift precursor plus displacement demand absorb-first response
