...
| M9 | EU Accession to the Safety Floor and Joint Threat Pact | 8 | small | 8 | 10 | coalition and supply-chain partners | resilience up moderately, ai_safety up, eu_political_capital protected | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Accession to the Safety Floor and Joint Threat Pact", "category": 8, "size": "small", "finish_turn": 10, "applies_to": "coalition and supply-chain partners", "targeted_effect": "resilience up moderately, ai_safety up, eu_political_capital protected"}, "grounds": "US-China agreement plus joint threat invitation window"}
  - Grounds: US-China agreement plus joint threat invitation window
