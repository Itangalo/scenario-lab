...
- `two_year_commitment` (commitment): Protect livelihoods and democratic control through runaway capability

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Protect livelihoods and democratic control through runaway capability
