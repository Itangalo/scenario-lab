...
- characters 454-1701: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1744-3929: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5635-6109: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8694-11025: `{{previous_actions}}` from the actor's own response from the previous turn
...
- `two_year_commitment` (commitment): Secure verifiable safety and independent capacity so Europe is not defenceless as capabilities jump
...
| M7 | EU–Middle-Power Trusted Compute Compact | 8 | small | 5 | 8 | coalition partners holding supply-chain chokepoints plus own jurisdiction | eu_ai_sovereignty up, resilience up slightly via secured supply | 2 | running |
