...
| M8 | EU Open-Weight Consequence Containment | 6 | small | 6 | 9 | own jurisdiction | resilience up to absorb open-weight cyber/bio uplift, ai_safety loss contained | 2 | running |
...
- **applied** `M8` — {"op": "add", "table": "measures", "fields": {"name": "EU Open-Weight Consequence Containment", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up to absorb open-weight cyber/bio uplift, ai_safety loss contained"}, "grounds": "to absorb unrecallable open-weight jump under opaque reasoning"}
  - Grounds: to absorb unrecallable open-weight jump under opaque reasoning
