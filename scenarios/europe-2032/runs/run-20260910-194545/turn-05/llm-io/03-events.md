...
- characters 1996-4412: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4468-5579: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5642-32596: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32951-33261: `{{event_history}}` from the run's own event record
...
- `emergent_graduate_protest_blockade` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated graduate-led protests against AI hiring freezes block university partnerships and a data-centre site in one member state, forcing a permitting pause.
- `emergent_graduate_protests_disrupt_compute` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated graduate-led protests against AI hiring collapse block several university-industry AI labs and data-centre permitting hearings across France, Germany and Spain in spring 2028.
...
- Turn 2 (3 turn(s) ago): ai_investment_collapse, supply_chain_coercion, emergent_eu_talent_retention_pact
- Turn 3 (2 turn(s) ago): bio_uplift_findings, labour_displacement
