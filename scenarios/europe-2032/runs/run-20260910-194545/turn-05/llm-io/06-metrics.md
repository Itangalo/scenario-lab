...
- characters 106-13461: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13504-13696: `{{metrics_json}}` from the run's live metric values
- characters 13789-15364: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15408-17824: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17880-18739: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 67.0, "openweight_capability": 60.8, "ai_safety": 31.0, "resilience": 38.0, "eu_ai_sovereignty": 13.0, "eu_political_capital": 14.0, "public_sentiment": 22.0}
```
