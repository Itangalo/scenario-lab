...
- characters 2074-4490: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6833-7287: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9501-11467: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Assurance Adoption Cell | 5 | small | 4 | 6 | own jurisdiction | ai_safety up, eu_political_capital up slightly | 2 | running |
