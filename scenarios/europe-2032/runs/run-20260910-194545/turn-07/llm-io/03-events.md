...
- characters 377-1428: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1472-3942: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3998-4821: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4884-31467: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31822-32378: `{{event_history}}` from the run's own event record
...
- `emergent_robot_supply_pause` -- first noted turn 6, listed in 1 turn(s) so far: Chinese robotics suppliers pause new EU logistics deliveries for a quarter amid export-licence review and US control-model licensing dispute, freezing Rotterdam/Hamburg rollout expansion.
...
- Turn 2 (5 turn(s) ago): ai_investment_collapse, supply_chain_coercion, emergent_eu_talent_retention_pact
- Turn 3 (4 turn(s) ago): bio_uplift_findings, labour_displacement
- Turn 4 (3 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 5 (2 turn(s) ago): medical_breakthrough, embodied_ai_deployment, emergent_graduate_protest_blockade, election_retrenchment
- Turn 6 (1 turn(s) ago): medical_breakthrough, embodied_ai_deployment, eu_frontier_access_denied, adoption_success
