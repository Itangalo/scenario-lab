...
- characters 455-1506: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1550-4020: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5577-6047: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8568-10963: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Continuity Adoption for Hospitals and Public Services | 9 | small | 6 | 8 | own jurisdiction | public_sentiment up, resilience up slightly | 2 | running |
