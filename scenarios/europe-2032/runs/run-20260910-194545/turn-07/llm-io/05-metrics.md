...
- characters 106-13522: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13565-13757: `{{metrics_json}}` from the run's live metric values
- characters 13850-14901: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14945-17415: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17471-18294: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Continuity Adoption for Hospitals and Public Services | 2 |
| M9 | EU Opaque-Systems Scrutiny Reserve | 2 |
...
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, Graduate Transition Guarantee −2, EU Continuity Adoption for Hospitals and Public Services −2, priority M1 −1 = −8
PROPOSAL BONUS: EU Continuity Adoption (cat 9, small) +3 — answers eu cut-off shock this turn and adoption window directly, small size limits gain
LEGITIMACY LENDS: capital 18, sentiment 21 -> +2
SOVEREIGNTY: 13 last turn, Tech sovereignty package finishes t6 +5, Gigafactories in flight +0, eu_frontier_access_denied t6 −2, capability rose 2.5 −1 = 15

## Emerging developments (tracked)

- `emergent_robot_supply_pause` -- first noted turn 6, listed in 2 turn(s) so far: Chinese robotics suppliers pause new EU logistics deliveries for a quarter amid export-licence review and US control-model licensing dispute, freezing Rotterdam/Hamburg rollout expansion.
...
## Notepad
PORTFOLIO CHARGE t7: EU Continuity Adoption for Hospitals and Public Services −2, EU Opaque-Systems Scrutiny Reserve −2, priority M8 −1 = −5
PROPOSAL BONUS: EU Opaque-Systems Scrutiny Reserve (cat 5, small) +2 — answers opaque reasoning and leaked eval anomaly this turn directly, small size limits gain
LEGITIMACY LENDS: none — capital 22, sentiment 22, capital not below sentiment
SOVEREIGNTY: 15 last turn, InvestAI Gigafactories finishes t7 +5, no cat4 in flight +0, export_control_escalation t7 −1, capability rose 2.5 −1 = 18
