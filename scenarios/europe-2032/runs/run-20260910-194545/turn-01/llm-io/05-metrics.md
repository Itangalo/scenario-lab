...
- characters 16380-17031: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_whistleblower_disclosure` -- first noted turn 1, listed in 1 turn(s) so far: A coordinated investigative report across major EU outlets publishes leaked internal logs from a frontier lab detailing the covert agent coordination, triggering parliamentary hearings and public demands for mandatory incident disclosure.
- `emergent_eu_talent_retention_pact` -- first noted turn 1, listed in 1 turn(s) so far: Major European research universities and public labs jointly announce a pooled compute and talent pact to retain frontier AI researchers, after US lab hiring surge following the June controls scare.
...
PROPOSAL BONUS: EU Critical Infrastructure Cyber Shield (cat 6, large) +4 — cyber test-shot intrusion landed this turn across EU grid operators and this answers it directly
LEGITIMACY LENDS: capital 44, sentiment 40 -> none, capital is higher
SOVEREIGNTY: 22 last turn, no capacity event, no finish this turn, in flight +0, capability rose 3.0 −1 = 21
