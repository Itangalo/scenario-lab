...
- characters 377-2251: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2295-4126: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4182-4672: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4735-32152: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32507-33155: `{{event_history}}` from the run's own event record
...
- Turn 2 (7 turn(s) ago): ai_investment_collapse, supply_chain_coercion, emergent_eu_talent_retention_pact
- Turn 3 (6 turn(s) ago): bio_uplift_findings, labour_displacement
- Turn 4 (5 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 5 (4 turn(s) ago): medical_breakthrough, embodied_ai_deployment, emergent_graduate_protest_blockade, election_retrenchment
- Turn 6 (3 turn(s) ago): medical_breakthrough, embodied_ai_deployment, eu_frontier_access_denied, adoption_success
- Turn 7 (2 turn(s) ago): eval_anomaly_reports, opaque_reasoning, export_control_escalation
