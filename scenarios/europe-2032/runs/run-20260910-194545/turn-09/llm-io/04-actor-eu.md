...
- characters 2373-4204: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7151-7621: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10430-12495: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Hospital Continuity Reserve | 6 | small | 8 | 10 | own jurisdiction | resilience up, public_sentiment up slightly | 2 | running |
