...
- characters 377-1626: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1670-3801: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3857-4274: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4337-33392: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33747-34851: `{{event_history}}` from the run's own event record
...
- Turn 2 (11 turn(s) ago): ai_investment_collapse, supply_chain_coercion, emergent_eu_talent_retention_pact
- Turn 3 (10 turn(s) ago): bio_uplift_findings, labour_displacement
- Turn 4 (9 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 5 (8 turn(s) ago): medical_breakthrough, embodied_ai_deployment, emergent_graduate_protest_blockade, election_retrenchment
- Turn 6 (7 turn(s) ago): medical_breakthrough, embodied_ai_deployment, eu_frontier_access_denied, adoption_success
- Turn 7 (6 turn(s) ago): eval_anomaly_reports, opaque_reasoning, export_control_escalation
- Turn 9 (4 turn(s) ago): rsi_onset, research_breakthrough, medical_breakthrough, embodied_ai_deployment
- Turn 10 (3 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, embodied_ai_deployment, adoption_success
- Turn 11 (2 turn(s) ago): capability_jump, eval_anomaly_reports, research_breakthrough, medical_breakthrough, joint_threat_response
- Turn 12 (1 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise, adoption_success
