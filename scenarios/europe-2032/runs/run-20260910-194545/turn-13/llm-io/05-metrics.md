...
- characters 13667-14916: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14960-17091: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17147-17564: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M15 | EU Blackout-Bio Containment Continuity | 2 |
...
## Metrics
```json
{"ai_capability": 93.5, "openweight_capability": 87.0, "ai_safety": 0.0, "resilience": 51.5, "eu_ai_sovereignty": 7.0, "eu_political_capital": 14.0, "public_sentiment": 16.0}
```
