...
- characters 1839-4059: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4115-4640: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4703-31053: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31408-31651: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): ai_investment_collapse, supply_chain_coercion, emergent_eu_talent_retention_pact
- Turn 3 (1 turn(s) ago): bio_uplift_findings, labour_displacement
