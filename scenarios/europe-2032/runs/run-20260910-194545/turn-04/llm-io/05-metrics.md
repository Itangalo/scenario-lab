...
- characters 105-13101: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13144-13336: `{{metrics_json}}` from the run's live metric values
- characters 13429-14849: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14892-17112: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17168-18268: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Bio Shield and Workforce Buffer | 2 |
| M6 | EU Assurance Adoption Cell | 2 |
