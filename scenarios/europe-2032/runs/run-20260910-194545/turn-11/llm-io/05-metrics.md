...
- characters 107-13380: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13423-13614: `{{metrics_json}}` from the run's live metric values
- characters 13707-14791: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14835-16839: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16895-18018: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M13 | EU Joint Cyber-Bio Response Tie-In | 2 |
