...
- characters 13394-14497: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14540-16474: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16530-17376: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | European Chokepoint Response | 3 |
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 50.5, "ai_safety": 30.0, "resilience": 37.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 32.0, "public_sentiment": 35.0}
```
