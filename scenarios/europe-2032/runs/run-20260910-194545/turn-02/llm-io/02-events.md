...
- characters 376-1479: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1522-3456: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3512-4646: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4709-27786: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28141-28210: `{{event_history}}` from the run's own event record
