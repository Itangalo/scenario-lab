...
- characters 377-2882: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2925-4837: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4893-5370: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5433-34488: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34843-35596: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough
- Turn 2 (8 turn(s) ago): ai_investment_collapse, supply_chain_coercion, emergent_eu_talent_retention_pact
- Turn 3 (7 turn(s) ago): bio_uplift_findings, labour_displacement
- Turn 4 (6 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 5 (5 turn(s) ago): medical_breakthrough, embodied_ai_deployment, emergent_graduate_protest_blockade, election_retrenchment
- Turn 6 (4 turn(s) ago): medical_breakthrough, embodied_ai_deployment, eu_frontier_access_denied, adoption_success
- Turn 7 (3 turn(s) ago): eval_anomaly_reports, opaque_reasoning, export_control_escalation
- Turn 9 (1 turn(s) ago): rsi_onset, research_breakthrough, medical_breakthrough, embodied_ai_deployment
