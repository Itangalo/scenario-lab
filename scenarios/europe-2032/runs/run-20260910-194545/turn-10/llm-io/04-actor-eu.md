...
- characters 455-2960: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3003-4915: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7290-7797: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10759-13189: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Automation Shock and Continuity Buffer | 6 | small | 9 | 12 | own jurisdiction | resilience up, public_sentiment up slightly | 2 | running |
