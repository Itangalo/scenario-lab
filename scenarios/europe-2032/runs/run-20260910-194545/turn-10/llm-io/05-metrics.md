...
- characters 13418-13610: `{{metrics_json}}` from the run's live metric values
- characters 13703-16208: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16251-18163: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18219-19310: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Automation Shock and Continuity Buffer | 2 |
| M12 | EU Cyber-Bio Emergency Hardening Surge | 2 |
...
PORTFOLIO CHARGE t9: EU Hospital Continuity Reserve −2, EU Automation Shock and Continuity Buffer −2, priority M10 −1 = −5
PROPOSAL BONUS: EU Automation Shock and Continuity Buffer (cat 6, small) +3 — answers embodied deployment and RSI-onset disruption pressure this turn directly, small size limits gain
LEGITIMACY LENDS: capital 22, sentiment 25 -> +1
SOVEREIGNTY: 17 last turn, no cat4 finish, no cat4 in flight +0, embodied_ai_deployment t9 −2, capability rose 6.0 −1 = 14
