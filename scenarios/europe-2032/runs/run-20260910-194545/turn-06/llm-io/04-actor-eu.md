...
- characters 1847-4077: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6039-6509: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8863-10918: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | Graduate Transition Guarantee | 7 | small | 5 | 7 | own jurisdiction | public_sentiment up, resilience up slightly | 2 | running |
