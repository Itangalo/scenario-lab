...
- characters 1769-3999: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4055-4918: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4981-31564: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31919-32359: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Bio Shield and Workforce Buffer −2, EU Assurance Adoption Cell −2, Graduate Transition Guarantee −2, priority M5 −1 = −13
PROPOSAL BONUS: Graduate Transition Guarantee (cat 7, small) +3 — answers graduate blockade this turn and embodied-AI job shock directly, small size limits gain
LEGITIMACY LENDS: capital 14, sentiment 22 -> +2
SOVEREIGNTY: 16 last turn, no cat4 finish, Gigafactories in flight +0, embodied_ai_deployment t5 −2, capability rose 3.0 −1 = 13

## Emerging developments (tracked)

- `emergent_graduate_protests_disrupt_compute` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated graduate-led protests against AI hiring collapse block several university-industry AI labs and data-centre permitting hearings across France, Germany and Spain in spring 2028.
...
- Turn 2 (4 turn(s) ago): ai_investment_collapse, supply_chain_coercion, emergent_eu_talent_retention_pact
- Turn 3 (3 turn(s) ago): bio_uplift_findings, labour_displacement
- Turn 4 (2 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 5 (1 turn(s) ago): medical_breakthrough, embodied_ai_deployment, emergent_graduate_protest_blockade, election_retrenchment
