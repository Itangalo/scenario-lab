...
- characters 376-1451: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1494-3587: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3643-4757: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4820-33875: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34230-35246: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Cyber-Bio Emergency Hardening Surge −2, EU Joint Cyber-Bio Response Tie-In −2, priority M12 −1 = −5
PROPOSAL BONUS: EU Joint Cyber-Bio Response Tie-In (cat 6, small) +3 — joint_threat_response landed this turn plus February cyber cascade and bio signal from last turns, this answers them directly
LEGITIMACY LENDS: capital 19, sentiment 16 -> none, capital higher
SOVEREIGNTY: 11 last turn, no capacity event, no cat4 finish, no cat4 in flight +0, capability rose 3.0 −1 = 10

## Emerging developments (tracked)

- `emergent_liability_repricing_shock` -- first noted turn 10, listed in 2 turn(s) so far: A major non-EU insurer reprices hospital and port automation coverage after opaque-model failures, abruptly raising premiums for operators using foreign closed models and forcing contract renegotiations.
- `emergent_port_strike_backlash` -- first noted turn 10, listed in 2 turn(s) so far: Port unions in Rotterdam and Hamburg coordinate a cross-border slowdown against foreign robot fleets, blocking automated terminals for days and forcing a political confrontation over embodied AI.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough
- Turn 2 (10 turn(s) ago): ai_investment_collapse, supply_chain_coercion, emergent_eu_talent_retention_pact
- Turn 3 (9 turn(s) ago): bio_uplift_findings, labour_displacement
- Turn 4 (8 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 5 (7 turn(s) ago): medical_breakthrough, embodied_ai_deployment, emergent_graduate_protest_blockade, election_retrenchment
- Turn 6 (6 turn(s) ago): medical_breakthrough, embodied_ai_deployment, eu_frontier_access_denied, adoption_success
- Turn 7 (5 turn(s) ago): eval_anomaly_reports, opaque_reasoning, export_control_escalation
- Turn 9 (3 turn(s) ago): rsi_onset, research_breakthrough, medical_breakthrough, embodied_ai_deployment
- Turn 10 (2 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, embodied_ai_deployment, adoption_success
- Turn 11 (1 turn(s) ago): capability_jump, eval_anomaly_reports, research_breakthrough, medical_breakthrough, joint_threat_response
