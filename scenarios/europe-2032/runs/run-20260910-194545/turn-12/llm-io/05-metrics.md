...
- characters 106-13355: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13398-13589: `{{metrics_json}}` from the run's live metric values
- characters 13682-14757: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14800-16893: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16949-17449: `{{notepad}}` from the Game Master's notepad, carried across turns
