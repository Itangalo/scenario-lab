...
- characters 455-1810: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1854-4064: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4926-5380: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7311-9235: `{{previous_actions}}` from the actor's own response from the previous turn
