...
- `two_year_commitment` (commitment): Keep essential services and livelihoods standing through ungovernable AI

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Keep essential services and livelihoods standing through ungovernable AI
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the timeframe for the original statement, necessitating a new formulation of the commitment.
