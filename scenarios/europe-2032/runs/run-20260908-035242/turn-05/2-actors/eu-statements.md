...
- `two_year_commitment` (commitment): Secure sovereign AI capacity to act with autonomy in a world where control lags behind capability

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign AI capacity to act with autonomy in a world where control lags behind capability
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The commitment's time-bound nature directly ties its relevance to the closure of the two-year period, changing the cost of maintaining the original wording.
