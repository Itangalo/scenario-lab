...
- `two_year_commitment` (commitment): Secure sovereign AI capacity that is safe, controllable, and resilient to coercion

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign AI capacity that is safe, controllable, and resilient to coercion
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the two-year period directly ends the original commitment's timeframe, changing the cost of maintaining the old statement and enabling a strategic update.
