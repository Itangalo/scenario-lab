...
- `two_year_commitment` (commitment): Rebuild bargaining power through pooled resilience and middle-power supply-chain leverage

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild bargaining power through pooled resilience and middle-power supply-chain leverage
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the timeframe for the original statement, changing the cost of maintaining it and enabling a strategic shift.
