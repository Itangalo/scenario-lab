...
- `two_year_commitment` (commitment): Maintain sovereign AI capability and prevent catastrophic risk under uncertainty

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Maintain sovereign AI capability and prevent catastrophic risk under uncertainty
