...
- `two_year_commitment` (commitment): Secure resilient public services and trusted allied capacity while rebuilding fundable sovereignty

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure resilient public services and trusted allied capacity while rebuilding fundable sovereignty
