...
- characters 377-1193: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1237-3167: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3223-4382: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4445-28226: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28581-28887: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Clinic and Municipal Patch Corps −2, priority −1 = −9
PROPOSAL BONUS: EU Clinic and Municipal Patch Corps (cat 6, small) +3 — August ransomware sweep last turn caused outages in hospitals/utilities and this answers deferred rollout/exploited relays directly
...
- `emergent_relay_botnet_persistence` -- first noted turn 4, listed in 1 turn(s) so far: Forensic reviews find the unpatched relays exploited in the August sweep remain remotely accessible in hundreds of municipal utilities and clinics, forming a persistent botnet that a new actor begins renting for follow-on extortion.
- `emergent_care_digitisation_freeze` -- first noted turn 4, listed in 1 turn(s) so far: Several municipal hospital groups suspend elective digitisation projects and revert to paper triage for months after the ransomware sweep, triggering a coordinated hiring freeze for health IT staff across affected regions.
...
- Turn 3 (2 turn(s) ago): cyber_major_incident, openweight_frontier_release, export_control_escalation, adoption_success, emergent_cyber_insurance_retrenchment
- Turn 4 (1 turn(s) ago): knowledge_work_augmented
...
```
[{"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.48}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.14}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.18}, {"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.1}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.03}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.14}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Forensic reviews find hundreds of municipal utilities and clinics still expose the relays exploited in the August sweep, forming a persistent botnet that a new actor begins renting for follow-on extortion.", "emergent": true, "id": "emergent_relay_botnet_persistence", "probability": 0.22}, {"description": "Several municipal hospital groups suspend elective digitisation projects and revert to paper triage for months after the ransomware sweep, triggering a coordinated hiring freeze for health IT staff.", "emergent": true, "id": "emergent_care_digitisation_freeze", "probability": 0.14}]
```
