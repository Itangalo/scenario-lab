...
- characters 455-1271: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1315-3245: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5515-5987: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8081-9950: `{{previous_actions}}` from the actor's own response from the previous turn
