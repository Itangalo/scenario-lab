...
- characters 4103-4575: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6047-8174: `{{previous_actions}}` from the actor's own response from the previous turn
