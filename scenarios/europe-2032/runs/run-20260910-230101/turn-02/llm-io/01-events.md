...
- characters 1556-3585: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3641-4079: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4142-27424: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27779-27820: `{{event_history}}` from the run's own event record
