...
- characters 1755-4331: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4923-5395: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7363-8869: `{{previous_actions}}` from the actor's own response from the previous turn
