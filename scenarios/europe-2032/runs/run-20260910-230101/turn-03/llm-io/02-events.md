...
- characters 377-1817: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1861-3817: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3873-4993: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5056-28338: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28693-28788: `{{event_history}}` from the run's own event record
