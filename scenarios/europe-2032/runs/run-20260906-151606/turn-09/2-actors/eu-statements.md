...
- `two_year_commitment` (commitment): Sovereign control of AI to resist coercion and prevent catastrophic misuse

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Sovereign control of AI to resist coercion and prevent catastrophic misuse
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the two-year period directly ends the original commitment's timeframe, altering the actor's obligation and enabling a revised statement.
