...
- characters 13252-13443: `{{metrics_json}}` from the run's live metric values
- characters 13536-14906: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14949-16919: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16975-17650: `{{notepad}}` from the Game Master's notepad, carried across turns
