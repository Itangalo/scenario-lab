...
- characters 376-1746: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1789-3759: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3815-4196: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4259-28448: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28803-29561: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M9 EU Cyber Defence Breakthrough Deployment −2, priority ineffective (capital below 20, no cost, no pull-in) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 6, sentiment 23 -> +2 (capped below sentiment)
SOVEREIGNTY: 19 last turn, no capacity event, no category 4 finish or in flight, capability rose 0.5 no penalty = 19
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, eval_anomaly_reports, eu_frontier_access_denied
- Turn 2 (8 turn(s) ago): emergent_lab_coverup_hearings
- Turn 3 (7 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, member_state_defection
- Turn 4 (6 turn(s) ago): loss_of_control_incident, openweight_frontier_release
- Turn 5 (5 turn(s) ago): taiwan_tension_rise, election_retrenchment
- Turn 6 (4 turn(s) ago): emergent_insurance_retreat
- Turn 7 (3 turn(s) ago): openweight_frontier_release, safety_breakthrough, taiwan_tension_rise, export_control_escalation, us_china_agreement
- Turn 8 (2 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release
- Turn 9 (1 turn(s) ago): eval_anomaly_reports, emergent_municipal_uninsurable_cascade
