...
- characters 1867-3837: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4852-5318: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8027-9703: `{{previous_actions}}` from the actor's own response from the previous turn
