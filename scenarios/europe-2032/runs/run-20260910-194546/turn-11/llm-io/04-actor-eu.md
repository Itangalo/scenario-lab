...
- characters 456-1806: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1850-4005: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6341-6841: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9980-12618: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Chokepoint Bargain | 8 | small | 10 | 12 | US, China, coalition partners and frontier developers via supply-chain leverage | eu_ai_sovereignty up moderately, eu_political_capital up slightly if bargain lands, resilience up slightly via secured spares | 2 | running |
