...
- characters 107-12808: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12851-13043: `{{metrics_json}}` from the run's live metric values
- characters 13136-14486: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14530-16685: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16741-17504: `{{notepad}}` from the Game Master's notepad, carried across turns
