...
- characters 375-1605: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1648-3598: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3654-4441: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4504-26486: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26841-27234: `{{event_history}}` from the run's own event record
...
- `emergent_insurance_retreat` -- first noted turn 4, listed in 2 turn(s) so far: Major EU reinsurers jointly suspend new cyber coverage for municipalities lacking 24-hour monitoring, triggering a wave of local service cutbacks and lawsuits over the Commission's uneven hardening rollout.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, eval_anomaly_reports, eu_frontier_access_denied
- Turn 2 (4 turn(s) ago): emergent_lab_coverup_hearings
- Turn 3 (3 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, member_state_defection
- Turn 4 (2 turn(s) ago): loss_of_control_incident, openweight_frontier_release
- Turn 5 (1 turn(s) ago): taiwan_tension_rise, election_retrenchment
