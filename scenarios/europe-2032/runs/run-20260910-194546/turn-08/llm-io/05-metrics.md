...
- characters 105-12876: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12919-13111: `{{metrics_json}}` from the run's live metric values
- characters 13204-15632: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15675-18274: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18330-19404: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Accession to the US-China Safety Floor | 2 |
| M9 | EU Cyber Defence Breakthrough Deployment | 2 |
