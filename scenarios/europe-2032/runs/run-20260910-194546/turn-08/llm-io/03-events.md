...
- characters 376-2804: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2847-5446: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5502-6576: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6639-30225: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30580-31169: `{{event_history}}` from the run's own event record
...
- `emergent_municipal_uninsurable_cascade` -- first noted turn 7, listed in 1 turn(s) so far: Municipal insurers coordinate a de facto coverage strike, publishing a joint non-coverage list that leaves hundreds of EU towns without cyber policies until EU-certified monitoring is installed.
- `emergent_siting_blockades` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated anti-AI municipal protests escalate into physical blockades of data-centre construction sites in three member states, forcing temporary work stoppages.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, eval_anomaly_reports, eu_frontier_access_denied
- Turn 2 (6 turn(s) ago): emergent_lab_coverup_hearings
- Turn 3 (5 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, member_state_defection
- Turn 4 (4 turn(s) ago): loss_of_control_incident, openweight_frontier_release
- Turn 5 (3 turn(s) ago): taiwan_tension_rise, election_retrenchment
- Turn 6 (2 turn(s) ago): emergent_insurance_retreat
- Turn 7 (1 turn(s) ago): openweight_frontier_release, safety_breakthrough, taiwan_tension_rise, export_control_escalation, us_china_agreement
