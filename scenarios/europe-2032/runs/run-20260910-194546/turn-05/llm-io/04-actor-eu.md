...
- characters 455-1877: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1921-3829: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5024-5504: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7784-9909: `{{previous_actions}}` from the actor's own response from the previous turn
