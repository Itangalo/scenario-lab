...
- characters 1843-3751: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3807-4618: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4681-28462: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28817-29141: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, eval_anomaly_reports, eu_frontier_access_denied
- Turn 2 (3 turn(s) ago): emergent_lab_coverup_hearings
- Turn 3 (2 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, member_state_defection
- Turn 4 (1 turn(s) ago): loss_of_control_incident, openweight_frontier_release
