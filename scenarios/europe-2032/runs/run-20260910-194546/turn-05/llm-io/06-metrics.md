...
- characters 13773-15195: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15239-17147: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17203-18014: `{{notepad}}` from the Game Master's notepad, carried across turns
