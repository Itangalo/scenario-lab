...
- characters 106-13333: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13376-13568: `{{metrics_json}}` from the run's live metric values
- characters 13661-15032: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15076-17079: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17135-17619: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Breakthrough Shield Deployment | 2 |
...
PORTFOLIO CHARGE t2: Gigafactories −3, Tech sovereignty package −3, Grid and Critical Systems Hardening Shield −3, EU Frontier Evaluation Taskforce −2, priority −1 = −12
PROPOSAL BONUS: Evaluation Taskforce (cat 5, small) +2 — covert lab coordination hearings landed this turn and this answers assurance failure directly
...
## Metrics
```json
{"ai_capability": 56.5, "openweight_capability": 52.2, "ai_safety": 35.0, "resilience": 42.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 19.0, "public_sentiment": 31.0}
```
...
## Notepad
PORTFOLIO CHARGE t3: Gigafactories −3, Tech sovereignty package −3, EU Frontier Evaluation Taskforce −2, EU Breakthrough Shield Deployment −2, priority −1 = −11
PROPOSAL BONUS: none — new shield answers breakthrough opportunities, not a negative event from last three turns
LEGITIMACY LENDS: capital 17, sentiment 34 -> +2
SOVEREIGNTY: 20 last turn, no capacity event finishes, Gigafactories/Tech package in flight +0, member_state_defection t3 −2, capability rose 1.5 −0 = 18
