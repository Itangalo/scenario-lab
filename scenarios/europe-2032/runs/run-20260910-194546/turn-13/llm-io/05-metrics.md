...
- characters 107-12877: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12920-13112: `{{metrics_json}}` from the run's live metric values
- characters 13205-14334: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14378-16325: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16381-16890: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M12 | EU Middle-Power Compute and Spares Pact | 2 |
