...
- characters 378-1507: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1551-3498: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3554-4063: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4126-27597: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27952-29039: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, eval_anomaly_reports, eu_frontier_access_denied
- Turn 2 (11 turn(s) ago): emergent_lab_coverup_hearings
- Turn 3 (10 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, member_state_defection
- Turn 4 (9 turn(s) ago): loss_of_control_incident, openweight_frontier_release
- Turn 5 (8 turn(s) ago): taiwan_tension_rise, election_retrenchment
- Turn 6 (7 turn(s) ago): emergent_insurance_retreat
- Turn 7 (6 turn(s) ago): openweight_frontier_release, safety_breakthrough, taiwan_tension_rise, export_control_escalation, us_china_agreement
- Turn 8 (5 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release
- Turn 9 (4 turn(s) ago): eval_anomaly_reports, emergent_municipal_uninsurable_cascade
- Turn 10 (3 turn(s) ago): taiwan_blockade, embodied_ai_deployment
- Turn 11 (2 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, medical_breakthrough, safety_breakthrough, knowledge_work_augmented, adoption_success
- Turn 12 (1 turn(s) ago): medical_breakthrough, safety_breakthrough, eu_frontier_access_denied
