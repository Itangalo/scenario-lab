...
- characters 377-2016: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2059-3774: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3830-4464: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4527-27998: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28353-29343: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M10 EU Chokepoint Bargain −2, priority ineffective (capital below 20, no cost, no pull-in) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 14, sentiment 22 -> +2
SOVEREIGNTY: 16 last turn, no capacity event, no category 4 finish or in flight, capability rose 0.5 no penalty = 16

## Emerging developments (tracked)

- `emergent_care_diversion_cascade` -- first noted turn 10, listed in 2 turn(s) so far: Several uninsurable municipalities suspend non-emergency clinical IT systems after auditors refuse cover, forcing temporary service transfers to neighbouring districts.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, eval_anomaly_reports, eu_frontier_access_denied
- Turn 2 (10 turn(s) ago): emergent_lab_coverup_hearings
- Turn 3 (9 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, member_state_defection
- Turn 4 (8 turn(s) ago): loss_of_control_incident, openweight_frontier_release
- Turn 5 (7 turn(s) ago): taiwan_tension_rise, election_retrenchment
- Turn 6 (6 turn(s) ago): emergent_insurance_retreat
- Turn 7 (5 turn(s) ago): openweight_frontier_release, safety_breakthrough, taiwan_tension_rise, export_control_escalation, us_china_agreement
- Turn 8 (4 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release
- Turn 9 (3 turn(s) ago): eval_anomaly_reports, emergent_municipal_uninsurable_cascade
- Turn 10 (2 turn(s) ago): taiwan_blockade, embodied_ai_deployment
- Turn 11 (1 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, medical_breakthrough, safety_breakthrough, knowledge_work_augmented, adoption_success
