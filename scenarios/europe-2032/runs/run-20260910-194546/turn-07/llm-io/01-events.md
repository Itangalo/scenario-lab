...
- characters 2064-4161: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4217-4662: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4725-29817: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30172-30618: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, eval_anomaly_reports, eu_frontier_access_denied
- Turn 2 (5 turn(s) ago): emergent_lab_coverup_hearings
- Turn 3 (4 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, member_state_defection
- Turn 4 (3 turn(s) ago): loss_of_control_incident, openweight_frontier_release
- Turn 5 (2 turn(s) ago): taiwan_tension_rise, election_retrenchment
- Turn 6 (1 turn(s) ago): emergent_insurance_retreat
