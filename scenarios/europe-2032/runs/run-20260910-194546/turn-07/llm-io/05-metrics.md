...
- characters 13408-13599: `{{metrics_json}}` from the run's live metric values
- characters 13692-15336: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15380-17477: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17533-18549: `{{notepad}}` from the Game Master's notepad, carried across turns
