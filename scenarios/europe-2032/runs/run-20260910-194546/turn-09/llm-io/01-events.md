...
- characters 377-1703: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1747-3802: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3858-4936: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4999-28585: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28940-29611: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M8 EU Accession to US-China Safety Floor −2, M9 EU Cyber Defence Breakthrough Deployment −2, priority ineffective (capital below 20, no cost, no pull-in) = −4
PROPOSAL BONUS: none — new deployment measure answers this turn's defensive advance and open release, not a negative event from last three turns
LEGITIMACY LENDS: capital 10, sentiment 26 -> +2 (capped below sentiment)
SOVEREIGNTY: 19 last turn, no capacity event, no category 4 finish or in flight, capability rose 0.5 −0 = 19

## Emerging developments (tracked)

- `emergent_municipal_uninsurable_cascade` -- first noted turn 7, listed in 2 turn(s) so far: Municipal insurers coordinate a de facto coverage strike, publishing a joint non-coverage list that leaves hundreds of EU towns without cyber policies until EU-certified monitoring is installed.
- `emergent_siting_blockades` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated anti-AI municipal protests escalate into physical blockades of data-centre construction sites in three member states, forcing temporary work stoppages.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, eval_anomaly_reports, eu_frontier_access_denied
- Turn 2 (7 turn(s) ago): emergent_lab_coverup_hearings
- Turn 3 (6 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, member_state_defection
- Turn 4 (5 turn(s) ago): loss_of_control_incident, openweight_frontier_release
- Turn 5 (4 turn(s) ago): taiwan_tension_rise, election_retrenchment
- Turn 6 (3 turn(s) ago): emergent_insurance_retreat
- Turn 7 (2 turn(s) ago): openweight_frontier_release, safety_breakthrough, taiwan_tension_rise, export_control_escalation, us_china_agreement
- Turn 8 (1 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release
