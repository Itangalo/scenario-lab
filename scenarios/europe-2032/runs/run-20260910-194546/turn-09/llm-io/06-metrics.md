...
- characters 13593-14919: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14963-17018: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17074-17581: `{{notepad}}` from the Game Master's notepad, carried across turns
