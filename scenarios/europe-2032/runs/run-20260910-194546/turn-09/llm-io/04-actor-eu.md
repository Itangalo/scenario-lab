...
- characters 455-1781: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1825-3880: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4763-5218: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8078-9936: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Cyber Defence Breakthrough Deployment | 6 | small | 8 | 10 | own jurisdiction | resilience up strongly, ai_safety up slightly via reduced incident impact | 2 | running |
