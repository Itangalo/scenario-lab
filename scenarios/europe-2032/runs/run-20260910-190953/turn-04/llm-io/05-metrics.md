...
- characters 105-13360: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13403-13595: `{{metrics_json}}` from the run's live metric values
- characters 13688-15035: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15078-16872: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16928-17466: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Transition Safety Net Pilot | 2 |
| M5 | EU Trusted Public Services Scale-Up | 2 |
| M6 | EU Automated Defence Rollout | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Grid and Essential Services Shield −3, EU Transition Safety Net Pilot −2, EU Trusted Public Services Scale-Up −2, priority M3 −1 = −14
PROPOSAL BONUS: EU Trusted Public Services Scale-Up (cat 9, small) +2 — adoption_success landed this turn with visible hospital/permit/tutoring wins, this banks it directly
LEGITIMACY LENDS: capital 20, sentiment 43 -> +2
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Transition Safety Net Pilot −2, EU Trusted Public Services Scale-Up −2, EU Automated Defence Rollout −2, priority −1 = −13
PROPOSAL BONUS: EU Automated Defence Rollout (cat 6, small) +3 — cyber_major_incident landed this turn severe and public and this answers it directly with breakthrough tooling
