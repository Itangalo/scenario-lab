...
- characters 1974-3933: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3989-4465: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4528-29697: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30052-30792: `{{event_history}}` from the run's own event record
...
- Turn 2 (9 turn(s) ago): ai_investment_collapse
- Turn 3 (8 turn(s) ago): adoption_success
- Turn 4 (7 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough
- Turn 5 (6 turn(s) ago): election_retrenchment
- Turn 6 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, adoption_success
- Turn 7 (4 turn(s) ago): cyber_major_incident, capability_jump, taiwan_tension_rise
- Turn 8 (3 turn(s) ago): automated_decision_scandal
- Turn 9 (2 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, labour_displacement, knowledge_work_augmented, taiwan_tension_rise
- Turn 10 (1 turn(s) ago): taiwan_blockade, labour_displacement, emergent_insurance_retreat
