...
- characters 107-13267: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13310-13501: `{{metrics_json}}` from the run's live metric values
- characters 13594-15147: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15191-17150: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17206-17682: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Jump Response Safety Brake | 2 |
