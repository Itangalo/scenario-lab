...
- characters 1698-3787: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3843-4372: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4435-27056: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27411-27637: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): ai_investment_collapse
- Turn 3 (2 turn(s) ago): adoption_success
- Turn 4 (1 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough
