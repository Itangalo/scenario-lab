...
- characters 13688-14965: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15009-17098: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17154-18013: `{{notepad}}` from the Game Master's notepad, carried across turns
