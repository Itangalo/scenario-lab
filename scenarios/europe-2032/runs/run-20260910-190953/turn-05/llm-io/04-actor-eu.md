...
- characters 1776-3865: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4793-5258: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7506-9521: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Automated Defence Rollout | 6 | small | 4 | 6 | own jurisdiction | resilience up materially, ai_safety up slightly | 2 | running |
