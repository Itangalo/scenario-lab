...
- characters 2578-4658: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5618-6096: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8780-11252: `{{previous_actions}}` from the actor's own response from the previous turn
