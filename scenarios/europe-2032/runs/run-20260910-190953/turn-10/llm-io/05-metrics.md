...
- characters 106-13306: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13349-13540: `{{metrics_json}}` from the run's live metric values
- characters 13633-15714: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15757-17837: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17893-18332: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Essential Services Insurance Backstop and Supply-Chain Leverage Hold | 2 |
...
**emergent_insurance_retreat (emergent event):** Major EU insurers announce AI-cyber exclusions for hospitals and municipalities after the autumn outages, freezing cover renewals and forcing emergency state backstops.
...
## Notepad
PORTFOLIO CHARGE t10: M10 EU Essential Services Insurance Backstop and Supply-Chain Leverage Hold −2, priority −1 = −3
PROPOSAL BONUS: EU Essential Services Insurance Backstop and Supply-Chain Leverage Hold (cat 6, small) +4 — insurance freeze fired this turn and blockade fired this turn and this answers both directly
LEGITIMACY LENDS: capital 16, sentiment 19 -> +2
SOVEREIGNTY: 33 last turn, taiwan_blockade t10 −2, no cat4 finish or in flight, capability rose 0.5 −0 = 31
## Store changes
```json
