...
- characters 376-2457: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2500-4580: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4636-5363: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5426-31313: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31668-32315: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M9 EU Displaced Workers Transition and Essential Services Continuity Fund −2, priority −1 = −3
PROPOSAL BONUS: EU Displaced Workers Transition and Essential Services Continuity Fund (cat 7, small) +3 — labour_displacement fired this turn and this answers it directly
LEGITIMACY LENDS: capital 14, sentiment 22 -> +2
SOVEREIGNTY: 33 last turn, no capacity event, no cat4 finish or in flight, capability rose 0.5 −0 = 33

## Emerging developments (tracked)

- `emergent_insurance_retreat` -- first noted turn 8, listed in 2 turn(s) so far: Major EU insurers announce AI-cyber exclusions for hospitals and municipalities after the autumn outages, freezing cover renewals and forcing emergency state backstops.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, adoption_success
- Turn 2 (8 turn(s) ago): ai_investment_collapse
- Turn 3 (7 turn(s) ago): adoption_success
- Turn 4 (6 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough
- Turn 5 (5 turn(s) ago): election_retrenchment
- Turn 6 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, adoption_success
- Turn 7 (3 turn(s) ago): cyber_major_incident, capability_jump, taiwan_tension_rise
- Turn 8 (2 turn(s) ago): automated_decision_scandal
- Turn 9 (1 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, labour_displacement, knowledge_work_augmented, taiwan_tension_rise
