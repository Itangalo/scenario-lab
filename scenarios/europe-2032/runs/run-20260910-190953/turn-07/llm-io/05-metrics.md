...
- characters 13233-13425: `{{metrics_json}}` from the run's live metric values
- characters 13518-15340: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15384-18182: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18238-18608: `{{notepad}}` from the Game Master's notepad, carried across turns
