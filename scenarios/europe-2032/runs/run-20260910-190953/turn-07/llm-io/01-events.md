...
- characters 377-2199: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2243-5041: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5097-5797: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5860-30291: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30646-31011: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): ai_investment_collapse
- Turn 3 (4 turn(s) ago): adoption_success
- Turn 4 (3 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough
- Turn 5 (2 turn(s) ago): election_retrenchment
- Turn 6 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, adoption_success
