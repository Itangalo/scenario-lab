...
- characters 107-13252: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13295-13486: `{{metrics_json}}` from the run's live metric values
- characters 13579-15171: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15215-17249: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17305-17977: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Bio-Shield Detection and Continuity Surge | 2 |
...
- `emergent_infrastructure_sabotage_wave` -- first noted turn 12, listed in 2 turn(s) so far: Coordinated physical attacks and arson against two to three data-centre construction sites and grid interconnects force a temporary construction moratorium in a member state.
