...
- characters 106-12984: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13027-13219: `{{metrics_json}}` from the run's live metric values
- characters 13312-14604: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14648-17122: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17178-17695: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Grid and Essential Services Shield −3, EU Transition Safety Net Pilot −2, priority −1 = −12
PROPOSAL BONUS: EU Transition Safety Net Pilot (cat 7, small) +2 — investment collapse landed this turn freezing private build-out and heightening displacement anxiety, this answers it partially
LEGITIMACY LENDS: capital 37, sentiment 41 -> +1
