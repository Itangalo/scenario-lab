...
- characters 377-2177: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2221-4446: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4502-5225: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5288-30322: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30677-31180: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M8 EU Welfare-Policing AI Redress and Logging Audit −2, priority −1 = −3
PROPOSAL BONUS: EU Welfare-Policing AI Redress and Logging Audit (cat 2, small) +3 — automated_decision_scandal fired this turn and this answers it directly
LEGITIMACY LENDS: capital 8, sentiment 26 -> +2
SOVEREIGNTY: 29 last turn, M7 EU Talent Homecoming and Chip Leverage Pact finishes t8 +4, no capacity event, capability rose 0.5 −0 = 33

## Emerging developments (tracked)

- `emergent_insurance_retreat` -- first noted turn 8, listed in 1 turn(s) so far: Major EU insurers announce AI-cyber exclusions for hospitals and municipalities after the autumn outages, freezing cover renewals and forcing emergency state backstops.
...
- Turn 2 (7 turn(s) ago): ai_investment_collapse
- Turn 3 (6 turn(s) ago): adoption_success
- Turn 4 (5 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough
- Turn 5 (4 turn(s) ago): election_retrenchment
- Turn 6 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, adoption_success
- Turn 7 (2 turn(s) ago): cyber_major_incident, capability_jump, taiwan_tension_rise
- Turn 8 (1 turn(s) ago): automated_decision_scandal
