...
- characters 455-2255: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2299-4524: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6558-7009: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9465-11409: `{{previous_actions}}` from the actor's own response from the previous turn
