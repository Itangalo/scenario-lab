...
- characters 106-13290: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13333-13525: `{{metrics_json}}` from the run's live metric values
- characters 13618-15418: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15462-17687: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17743-18466: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Displaced Workers Transition and Essential Services Continuity Fund | 2 |
