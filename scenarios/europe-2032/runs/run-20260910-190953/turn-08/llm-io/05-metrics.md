...
- characters 105-13191: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13234-13426: `{{metrics_json}}` from the run's live metric values
- characters 13519-15176: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15219-17499: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17555-18182: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Welfare-Policing AI Redress and Logging Audit | 2 |
