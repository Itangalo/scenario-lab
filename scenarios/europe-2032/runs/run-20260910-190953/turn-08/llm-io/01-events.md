...
- characters 376-2033: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2076-4356: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4412-4751: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4814-29848: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30203-30653: `{{event_history}}` from the run's own event record
...
- Turn 2 (6 turn(s) ago): ai_investment_collapse
- Turn 3 (5 turn(s) ago): adoption_success
- Turn 4 (4 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough
- Turn 5 (3 turn(s) ago): election_retrenchment
- Turn 6 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, adoption_success
- Turn 7 (1 turn(s) ago): cyber_major_incident, capability_jump, taiwan_tension_rise
