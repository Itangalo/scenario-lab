...
- characters 376-1288: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1331-3088: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3144-4252: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4315-27597: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27952-28011: `{{event_history}}` from the run's own event record
