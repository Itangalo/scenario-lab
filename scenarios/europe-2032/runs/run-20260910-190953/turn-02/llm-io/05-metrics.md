...
- characters 105-12934: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12977-13169: `{{metrics_json}}` from the run's live metric values
- characters 13262-14174: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14217-15974: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16030-17138: `{{notepad}}` from the Game Master's notepad, carried across turns
