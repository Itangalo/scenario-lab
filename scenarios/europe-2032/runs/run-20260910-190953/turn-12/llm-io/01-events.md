...
- characters 376-1880: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1923-3932: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3988-4387: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4450-29619: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29974-30758: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M11 EU Jump Response Safety Brake −2, priority −1 = −3
PROPOSAL BONUS: EU Jump Response Safety Brake (cat 1, small) +3 — capability_jump fired this turn and this answers it directly with time-limited hold
LEGITIMACY LENDS: capital 23, sentiment 16 -> none, capital is higher
SOVEREIGNTY: 31 last turn, no capacity event, no cat4 finish or in flight, capability rose 3.0 −1 = 30
...
- Turn 2 (10 turn(s) ago): ai_investment_collapse
- Turn 3 (9 turn(s) ago): adoption_success
- Turn 4 (8 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough
- Turn 5 (7 turn(s) ago): election_retrenchment
- Turn 6 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident, adoption_success
- Turn 7 (5 turn(s) ago): cyber_major_incident, capability_jump, taiwan_tension_rise
- Turn 8 (4 turn(s) ago): automated_decision_scandal
- Turn 9 (3 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, labour_displacement, knowledge_work_augmented, taiwan_tension_rise
- Turn 10 (2 turn(s) ago): taiwan_blockade, labour_displacement, emergent_insurance_retreat
- Turn 11 (1 turn(s) ago): capability_jump
