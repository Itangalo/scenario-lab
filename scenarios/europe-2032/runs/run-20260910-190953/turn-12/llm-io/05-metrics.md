...
- characters 106-13189: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13232-13423: `{{metrics_json}}` from the run's live metric values
- characters 13516-15020: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15063-17072: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17128-17833: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Bridge to the US-China Safety Floor | 2 |
...
- `emergent_infrastructure_sabotage_wave` -- first noted turn 12, listed in 1 turn(s) so far: Coordinated physical attacks and arson against two to three data-centre construction sites and grid interconnects force a temporary construction moratorium in a member state.
...
## Notepad
PORTFOLIO CHARGE t12: M12 EU Bridge to the US-China Safety Floor −2, priority −1 = −3
PROPOSAL BONUS: none — us_china_agreement is a cooperative floor, not a negative shock this measure repairs
LEGITIMACY LENDS: capital 23, sentiment 16 -> none, capital is higher
