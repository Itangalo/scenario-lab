...
- characters 376-2474: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2517-4616: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4672-5501: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5564-26885: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27240-27514: `{{event_history}}` from the run's own event record
...
- `emergent_local_ai_moratorium_wave` -- first noted turn 5, listed in 1 turn(s) so far: Coordinated municipal moratoriums on new data-centre siting and hospital AI expansion spread across several member states after the February outage, delaying patch rollout and gigafactory site approvals.
...
- Turn 2 (4 turn(s) ago): ai_investment_collapse
- Turn 3 (3 turn(s) ago): adoption_success
- Turn 4 (2 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough
