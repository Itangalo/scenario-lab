...
- characters 454-2552: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2595-4694: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6125-6576: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8966-11387: `{{previous_actions}}` from the actor's own response from the previous turn
