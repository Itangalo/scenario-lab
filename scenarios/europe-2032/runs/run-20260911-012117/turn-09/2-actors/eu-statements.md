...
- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild absorption and leverage to survive ungovernable capability
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: Two-year commitment
Rebuild absorption and leverage to survive ungovernable capability
  - Reason: The commitment's expiration directly changes the actor's obligation to uphold the prior statement, triggering reassessment.
