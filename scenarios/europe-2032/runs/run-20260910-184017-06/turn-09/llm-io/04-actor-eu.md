...
- characters 451-2000: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2044-4118: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6036-6482: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8883-10038: `{{previous_actions}}` from the actor's own response from the previous turn
