...
- characters 13273-13461: `{{metrics_json}}` from the run's live metric values
- characters 13554-15103: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15147-17221: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17277-17667: `{{notepad}}` from the Game Master's notepad, carried across turns
