...
- characters 373-1922: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1966-4040: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4096-4796: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4859-31148: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31503-32362: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, emergent_kimi_exploit_kit
- Turn 2 (7 turn(s) ago): safety_breakthrough, automated_decision_scandal
- Turn 3 (6 turn(s) ago): cyber_major_incident, capability_jump, labour_displacement, adoption_success
- Turn 4 (5 turn(s) ago): cyber_major_incident, labour_displacement, emergent_graduate_protest_wave
- Turn 5 (4 turn(s) ago): supply_chain_coercion, election_consolidation
- Turn 6 (3 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, rsi_onset, openweight_frontier_release, embodied_ai_deployment, export_control_escalation, adoption_success, automated_decision_scandal
- Turn 7 (2 turn(s) ago): cyber_major_incident, research_breakthrough, medical_breakthrough, joint_threat_response
- Turn 8 (1 turn(s) ago): opaque_reasoning, supply_chain_coercion, emergent_municipal_grid_revolt
