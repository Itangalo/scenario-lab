...
- characters 16367-16669: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_datacentre_siting_backlash` -- first noted turn 1, listed in 1 turn(s) so far: Coordinated municipal opposition blocks or delays at least one major EU AI data-centre project over power and water use, forcing a national-level siting review in autumn 2026.
...
**emergent_kimi_exploit_kit (emergent event):** Criminal groups package Kimi K3's leaked offensive cyber capability into a plug-and-play intrusion kit traded on underground forums, sharply lowering the skill needed for grid and port intrusions.
...
PROPOSAL BONUS: EU Critical Systems Shield (cat 6, large) +3 — autumn grid/port intrusions landed this turn and this answers it directly
