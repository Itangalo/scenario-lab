...
- characters 2024-4331: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5728-6191: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8566-10979: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Compute Communities Dividend | 9 | small | 4 | 6 | own jurisdiction | public_sentiment up materially, eu_political_capital up slightly, eu_ai_sovereignty up slightly via unblocked permits | 2 | running |
