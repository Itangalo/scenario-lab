...
- characters 106-13503: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13546-13738: `{{metrics_json}}` from the run's live metric values
- characters 13831-15356: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15400-17707: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17763-18622: `{{notepad}}` from the Game Master's notepad, carried across turns
