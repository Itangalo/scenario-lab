...
- characters 105-13493: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13536-13728: `{{metrics_json}}` from the run's live metric values
- characters 13821-15632: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15675-18132: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18188-19031: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Assurance Adoption Facility | 2 |
| M5 | EU Displaced Workers Transition Fund | 2 |
| M6 | EU Compute Communities Dividend | 2 |
...
- `emergent_permit_protest_blockade` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated graduate-led protests across several member states physically block two planned compute-zone sites, forcing a national moratorium debate on data-centre power permits.
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Assurance Adoption Facility −2, EU Displaced Workers Transition Fund −2, EU Compute Communities Dividend −2 + priority −1 = −13
PROPOSAL BONUS: EU Compute Communities Dividend (cat 9, small) +2 — labour_displacement and graduate protest wave landed this turn and this answers permit-jobs fusion directly
LEGITIMACY LENDS: capital 13, sentiment 18 -> +2, capped by sentiment
