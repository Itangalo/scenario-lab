...
- characters 375-1767: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1811-3880: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3936-4319: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4382-30202: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30557-31203: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, emergent_kimi_exploit_kit
- Turn 2 (5 turn(s) ago): safety_breakthrough, automated_decision_scandal
- Turn 3 (4 turn(s) ago): cyber_major_incident, capability_jump, labour_displacement, adoption_success
- Turn 4 (3 turn(s) ago): cyber_major_incident, labour_displacement, emergent_graduate_protest_wave
- Turn 5 (2 turn(s) ago): supply_chain_coercion, election_consolidation
- Turn 6 (1 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, rsi_onset, openweight_frontier_release, embodied_ai_deployment, export_control_escalation, adoption_success, automated_decision_scandal
