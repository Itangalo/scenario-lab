...
- characters 106-12982: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13025-13215: `{{metrics_json}}` from the run's live metric values
- characters 13308-14700: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14744-16813: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16869-17849: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Supply-Chain Bargaining Bloc | 2 |
