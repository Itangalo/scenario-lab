...
- characters 12998-13186: `{{metrics_json}}` from the run's live metric values
- characters 13279-14739: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14783-16904: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16960-17526: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t13: M8 EU Middle-Power Supply-Chain Compact −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 4, sentiment 0 -> +0, capital not above sentiment, no lend
SOVEREIGNTY: 6 last turn, no category 4 finish, no in-flight bonus, embodied_ai_deployment t13 −2, capability rose 2.0 −1 = 3
