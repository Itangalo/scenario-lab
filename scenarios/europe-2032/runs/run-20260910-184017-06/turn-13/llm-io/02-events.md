...
- characters 374-1834: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1878-3999: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4055-4621: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4684-31178: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31533-32886: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Middle-Power Supply-Chain Compact −2 = −2 + no priority = −2
PROPOSAL BONUS: EU Middle-Power Supply-Chain Compact (cat 8, small) +3 — access denial last turn plus defection window, answers directly but small and coalition-dependent
LEGITIMACY LENDS: capital 0, sentiment 0 -> +0, capital not above sentiment, no lend
SOVEREIGNTY: 5 last turn, no category 4 finish, no in-flight bonus, middle_power_coalition t12 +2 (largest of eu_frontier_access_denied t12, member_state_defection t12, middle_power_coalition t12), capability rose 3.5 −1 = 6
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, emergent_kimi_exploit_kit
- Turn 2 (11 turn(s) ago): safety_breakthrough, automated_decision_scandal
- Turn 3 (10 turn(s) ago): cyber_major_incident, capability_jump, labour_displacement, adoption_success
- Turn 4 (9 turn(s) ago): cyber_major_incident, labour_displacement, emergent_graduate_protest_wave
- Turn 5 (8 turn(s) ago): supply_chain_coercion, election_consolidation
- Turn 6 (7 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, rsi_onset, openweight_frontier_release, embodied_ai_deployment, export_control_escalation, adoption_success, automated_decision_scandal
- Turn 7 (6 turn(s) ago): cyber_major_incident, research_breakthrough, medical_breakthrough, joint_threat_response
- Turn 8 (5 turn(s) ago): opaque_reasoning, supply_chain_coercion, emergent_municipal_grid_revolt
- Turn 9 (4 turn(s) ago): research_breakthrough, labour_displacement, taiwan_tension_rise
- Turn 10 (3 turn(s) ago): eval_anomaly_reports, labour_displacement, embodied_ai_deployment, taiwan_tension_rise, automated_decision_scandal
- Turn 11 (2 turn(s) ago): capability_jump, safety_breakthrough, labour_displacement, us_labs_nationalised, eu_frontier_access_denied, member_state_defection
- Turn 12 (1 turn(s) ago): eu_frontier_access_denied, member_state_defection, middle_power_coalition
