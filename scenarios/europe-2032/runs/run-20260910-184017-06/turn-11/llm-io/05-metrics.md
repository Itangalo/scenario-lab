...
- characters 13192-15451: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15495-17771: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17827-18455: `{{notepad}}` from the Game Master's notepad, carried across turns
