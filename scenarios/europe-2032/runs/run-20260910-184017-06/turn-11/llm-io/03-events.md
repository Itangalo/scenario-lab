...
- characters 374-2633: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2677-4953: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5009-5637: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5700-33035: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33390-34482: `{{event_history}}` from the run's own event record
...
- `emergent_anti_datacentre_pact` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated siting bans spread across major EU metro regions, with councils jointly refusing grid connections for new AI compute and forcing a de facto moratorium on domestic buildout.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, emergent_kimi_exploit_kit
- Turn 2 (9 turn(s) ago): safety_breakthrough, automated_decision_scandal
- Turn 3 (8 turn(s) ago): cyber_major_incident, capability_jump, labour_displacement, adoption_success
- Turn 4 (7 turn(s) ago): cyber_major_incident, labour_displacement, emergent_graduate_protest_wave
- Turn 5 (6 turn(s) ago): supply_chain_coercion, election_consolidation
- Turn 6 (5 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, rsi_onset, openweight_frontier_release, embodied_ai_deployment, export_control_escalation, adoption_success, automated_decision_scandal
- Turn 7 (4 turn(s) ago): cyber_major_incident, research_breakthrough, medical_breakthrough, joint_threat_response
- Turn 8 (3 turn(s) ago): opaque_reasoning, supply_chain_coercion, emergent_municipal_grid_revolt
- Turn 9 (2 turn(s) ago): research_breakthrough, labour_displacement, taiwan_tension_rise
- Turn 10 (1 turn(s) ago): eval_anomaly_reports, labour_displacement, embodied_ai_deployment, taiwan_tension_rise, automated_decision_scandal
