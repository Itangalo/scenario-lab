...
- characters 13383-14494: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14537-16730: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16786-17521: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_datacentre_siting_backlash` -- first noted turn 1, listed in 2 turn(s) so far: Coordinated municipal opposition blocks or delays at least one major EU AI data-centre project over power and water use, forcing a national-level siting review in autumn 2026.
