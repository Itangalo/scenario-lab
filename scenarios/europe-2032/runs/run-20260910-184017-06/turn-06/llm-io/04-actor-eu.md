...
- characters 1675-4228: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8162-8608: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11159-13729: `{{previous_actions}}` from the actor's own response from the previous turn
