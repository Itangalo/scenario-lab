...
- characters 1597-4150: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4206-5087: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5150-31298: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31653-32070: `{{event_history}}` from the run's own event record
...
- `emergent_permit_protest_blockade` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated graduate-led protests across several member states physically block two planned compute-zone sites, forcing a national moratorium debate on data-centre power permits.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, emergent_kimi_exploit_kit
- Turn 2 (4 turn(s) ago): safety_breakthrough, automated_decision_scandal
- Turn 3 (3 turn(s) ago): cyber_major_incident, capability_jump, labour_displacement, adoption_success
- Turn 4 (2 turn(s) ago): cyber_major_incident, labour_displacement, emergent_graduate_protest_wave
- Turn 5 (1 turn(s) ago): supply_chain_coercion, election_consolidation
