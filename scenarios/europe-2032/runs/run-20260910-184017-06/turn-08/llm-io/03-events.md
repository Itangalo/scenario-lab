...
- characters 91-281: `{{metrics_json}}` from the run's live metric values
- characters 374-2013: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2056-4073: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4129-5077: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5140-30960: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31315-32076: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: InvestAI Gigafactories −3, EU Supply-Chain Bargaining Bloc −2, priority −1 = −6
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 6 -> +0, capped by floor after charge and event gain
SOVEREIGNTY: 14 last turn, no capacity event, Gigafactories in flight +0, capability rose 3.0 −1 = 13

## Emerging developments (tracked)

- `emergent_embodied_lockin_offer` -- first noted turn 7, listed in 1 turn(s) so far: Chinese humanoid vendors offer EU logistics firms cut-price fleets with on-device models derived from the leaked open frontier, locking in maintenance dependence outside EU jurisdiction.
- `emergent_municipal_grid_revolt` -- first noted turn 7, listed in 1 turn(s) so far: Municipal utilities in two member states suspend AI-vended grid-balancing software after cascading blackout scares, triggering a coordinated mayoral revolt against further EU AI infrastructure siting.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, emergent_kimi_exploit_kit
- Turn 2 (6 turn(s) ago): safety_breakthrough, automated_decision_scandal
- Turn 3 (5 turn(s) ago): cyber_major_incident, capability_jump, labour_displacement, adoption_success
- Turn 4 (4 turn(s) ago): cyber_major_incident, labour_displacement, emergent_graduate_protest_wave
- Turn 5 (3 turn(s) ago): supply_chain_coercion, election_consolidation
- Turn 6 (2 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, rsi_onset, openweight_frontier_release, embodied_ai_deployment, export_control_escalation, adoption_success, automated_decision_scandal
- Turn 7 (1 turn(s) ago): cyber_major_incident, research_breakthrough, medical_breakthrough, joint_threat_response
...
IMPORTANT: For events with date-specific conditions (e.g., "September 2026 is included"), check if the current time period (January-June 2030) covers that date.
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.3}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.03}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.15}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "us_labs_nationalised", "probability": 0.22}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Chinese humanoid vendors offer EU logistics firms cut-price fleets with on-device models derived from the leaked open frontier, locking in maintenance dependence outside EU jurisdiction.", "emergent": true, "id": "emergent_embodied_lockin_offer", "probability": 0.22}, {"description": "Municipal utilities in two member states suspend AI-vended grid-balancing software after cascading blackout scares, triggering a coordinated mayoral revolt against further EU AI infrastructure siting.", "emergent": true, "id": "emergent_municipal_grid_revolt", "probability": 0.18}]
```
