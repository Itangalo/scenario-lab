...
- characters 106-12954: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12997-13185: `{{metrics_json}}` from the run's live metric values
- characters 13278-14626: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14669-16769: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16825-17244: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Middle-Power Supply-Chain Compact | 2 |
