...
- characters 451-1799: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1842-3942: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5175-5660: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8061-10011: `{{previous_actions}}` from the actor's own response from the previous turn
