...
- characters 13434-14843: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14887-16980: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17036-17515: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 62.0, "openweight_capability": 54.0, "ai_safety": 29.0, "resilience": 34.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 12.0, "public_sentiment": 24.0}
```
