...
- characters 106-12867: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12910-13099: `{{metrics_json}}` from the run's live metric values
- characters 13192-15019: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15062-17191: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17247-17859: `{{notepad}}` from the Game Master's notepad, carried across turns
