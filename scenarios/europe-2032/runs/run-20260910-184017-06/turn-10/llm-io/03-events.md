...
- characters 374-2201: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2244-4373: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4429-4733: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4796-31085: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31440-32389: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: no measures in flight −0 = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 0 -> +0, capital not below sentiment, no lend
SOVEREIGNTY: 9 last turn, InvestAI Gigafactories finishes t9 +4, no capacity event, capability rose 3.0 −1 = 12
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, emergent_kimi_exploit_kit
- Turn 2 (8 turn(s) ago): safety_breakthrough, automated_decision_scandal
- Turn 3 (7 turn(s) ago): cyber_major_incident, capability_jump, labour_displacement, adoption_success
- Turn 4 (6 turn(s) ago): cyber_major_incident, labour_displacement, emergent_graduate_protest_wave
- Turn 5 (5 turn(s) ago): supply_chain_coercion, election_consolidation
- Turn 6 (4 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, rsi_onset, openweight_frontier_release, embodied_ai_deployment, export_control_escalation, adoption_success, automated_decision_scandal
- Turn 7 (3 turn(s) ago): cyber_major_incident, research_breakthrough, medical_breakthrough, joint_threat_response
- Turn 8 (2 turn(s) ago): opaque_reasoning, supply_chain_coercion, emergent_municipal_grid_revolt
- Turn 9 (1 turn(s) ago): research_breakthrough, labour_displacement, taiwan_tension_rise
