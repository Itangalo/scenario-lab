...
- characters 452-2279: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2322-4451: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6804-7289: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9690-11900: `{{previous_actions}}` from the actor's own response from the previous turn
