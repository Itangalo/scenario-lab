...
| M8 | EU Autonomous Systems Watch and Continuity Protocol | 6 | small | 7 | 9 | own jurisdiction | resilience up modestly, ai_safety protected from further fall | 2 | finished |
| M9 | EU Transition Buffer for Automated Logistics and Care | 7 | small | 8 | 10 | own jurisdiction | public_sentiment up modestly, eu_political_capital protected, resilience up modestly | 2 | running |
| M10 | EU Wartime Continuity and Neutral Infrastructure Shield | 6 | small | 9 | 12 | own jurisdiction | resilience up moderately, eu_political_capital protected, public_sentiment protected | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Wartime Continuity and Neutral Infrastructure Shield", "category": 6, "size": "small", "finish_turn": 12, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital protected, public_sentiment protected"}, "grounds": "US-China war targeting infrastructure in/near Europe plus loss-of-control and bio 
  - Grounds: US-China war targeting infrastructure in/near Europe plus loss-of-control and bio precursor
