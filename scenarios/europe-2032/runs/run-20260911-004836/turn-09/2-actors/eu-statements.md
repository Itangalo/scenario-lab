...
- `two_year_commitment` (commitment): Keep Europe alive, neutral and governable through great-power war and uncontrollable AI

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Keep Europe alive, neutral and governable through great-power war and uncontrollable AI
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the commitment period directly ends the original mandate, enabling a strategic shift in focus and justification for the actor's new statement.
