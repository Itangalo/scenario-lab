...
- **applied** `M8` — {"op": "add", "table": "measures", "fields": {"name": "EU Autonomous Systems Watch and Continuity Protocol", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up modestly, ai_safety protected from further fall"}, "grounds": "RSI onset thins assurance on deployed substitutes"}
  - Grounds: RSI onset thins assurance on deployed substitutes
