...
- `two_year_commitment` (commitment): Secure European agency in an age of uncontrollable capability

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure European agency in an age of uncontrollable capability
