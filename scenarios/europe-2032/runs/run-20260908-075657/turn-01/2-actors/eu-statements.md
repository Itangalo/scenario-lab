...
- `two_year_commitment` (commitment): Secure independent AI capacity to anchor European strategic autonomy

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure independent AI capacity to anchor European strategic autonomy
