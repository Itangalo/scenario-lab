...
- characters 105-13402: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13445-13636: `{{metrics_json}}` from the run's live metric values
- characters 13729-14821: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14864-16892: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16948-17795: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Automation Transition Shield | 2 |
| M10 | EU Essential Services Continuity and Agent Containment Protocol | 2 |
