...
- characters 1510-3538: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3594-4441: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4504-26468: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26823-27585: `{{event_history}}` from the run's own event record
...
- `emergent_gridlink_blockade_escalation` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated local protests and municipal legal challenges physically block power and water works at the two stalled gigafactory grid-link sites, forcing a months-long halt and national debate over AI infrastructure siting.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, loss_of_control_incident, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (6 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 3 (5 turn(s) ago): cyber_major_incident, capability_jump
- Turn 4 (4 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, eval_anomaly_reports
- Turn 5 (3 turn(s) ago): bio_incident, emergent_datacentre_backlash, election_consolidation
- Turn 6 (2 turn(s) ago): eval_anomaly_reports, opaque_reasoning, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, export_control_escalation, us_china_agreement
- Turn 7 (1 turn(s) ago): knowledge_work_augmented, embodied_ai_deployment
