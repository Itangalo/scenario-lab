...
- characters 376-1603: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1647-3862: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3918-4474: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4537-27354: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27709-29114: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Trusted Wards and Sites Pact −2, EU Continuity Restoration and Assurance Adoption −2, priority −1 = −4 priority void capital below 20, charged −4 only
PROPOSAL BONUS: EU Continuity Restoration and Assurance Adoption (cat 6, small) +4 — cyber_major_incident this turn with dark wards and grids plus zero assurance, this answers directly
LEGITIMACY LENDS: capital 14, sentiment 2 -> none, capital higher
SOVEREIGNTY: 15 last turn, no cat4 finish, no cat4 in flight +0, export_control_escalation t12 −2, capability rose 1.0 no −1 = 13
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, loss_of_control_incident, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (11 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 3 (10 turn(s) ago): cyber_major_incident, capability_jump
- Turn 4 (9 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, eval_anomaly_reports
- Turn 5 (8 turn(s) ago): bio_incident, emergent_datacentre_backlash, election_consolidation
- Turn 6 (7 turn(s) ago): eval_anomaly_reports, opaque_reasoning, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, export_control_escalation, us_china_agreement
- Turn 7 (6 turn(s) ago): knowledge_work_augmented, embodied_ai_deployment
- Turn 8 (5 turn(s) ago): loss_of_control_incident, capability_jump, eu_frontier_access_denied, automated_decision_scandal
- Turn 9 (4 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, labour_displacement, emergent_gridlink_blockade_escalation
- Turn 10 (3 turn(s) ago): cyber_major_incident, openweight_frontier_release, export_control_escalation, automated_decision_scandal
- Turn 11 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, research_breakthrough, emergent_siting_injunction_spread
- Turn 12 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, safety_breakthrough, export_control_escalation
