...
- characters 13706-14727: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14771-16746: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16802-17327: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | Municipal Hospital Continuity Fund | 2 |
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 53.0, "ai_safety": 22.0, "resilience": 40.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 26.0, "public_sentiment": 30.0}
```
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, Municipal Hospital Continuity Fund −2, priority −1 = −12
PROPOSAL BONUS: Municipal Hospital Continuity Fund (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly with continuity for hit municipalities/hospitals
LEGITIMACY LENDS: capital 25, sentiment 30 -> +1 [capped below sentiment]
