...
- characters 377-1398: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1442-3417: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3473-4608: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4671-27383: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27738-27973: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Automated Defence Deployment −2, priority −1 = −12
PROPOSAL BONUS: EU Automated Defence Deployment (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly with breakthrough tooling
LEGITIMACY LENDS: capital 35, sentiment 40 -> +1 [included in capital total; capped below sentiment]
SOVEREIGNTY: 23 last turn, no capacity event, Gigafactories in flight +0, capability rose 2.0 −1 = 22

## Emerging developments (tracked)

- `emergent_clinical_ai_pause` -- first noted turn 1, listed in 2 turn(s) so far: Major European research hospitals pause elective AI-assisted diagnostics after a peer-reviewed study links a widely used clinical model to missed sepsis cases, triggering EU-wide media debate on medical AI reliance.
- `emergent_openweight Misuse_attribution` -- first noted turn 1, listed in 2 turn(s) so far: Major European press investigation traces Kimi K3-derived cyber tools to a foiled intrusion at a French hospital group, triggering calls for open-weight liability in the EU debate.
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, loss_of_control_incident, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (1 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, taiwan_tension_rise
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.28}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.08}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.06}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.1}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.15}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.15}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.11}, {"description": "Major European research hospitals pause elective AI-assisted diagnostics after a peer-reviewed study links a widely used clinical model to missed sepsis cases, triggering EU-wide media debate on medical AI reliance.", "emergent": true, "id": "emergent_clinical_ai_pause", "probability": 0.12}, {"description": "Major European press investigation traces Kimi K3-derived cyber tools to a foiled intrusion at a French hospital group, triggering calls for open-weight liability in the EU debate.", "emergent": true, "id": "emergent_openweight Misuse_attribution", "probability": 0.14}]
```
