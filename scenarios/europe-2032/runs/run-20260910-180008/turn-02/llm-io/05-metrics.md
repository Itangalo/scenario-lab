...
- characters 105-13028: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13071-13263: `{{metrics_json}}` from the run's live metric values
- characters 13356-14724: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14767-16743: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16799-18186: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Automated Defence Deployment | 2 |
