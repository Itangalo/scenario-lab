...
- characters 454-1822: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1865-3841: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4960-5432: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6904-8894: `{{previous_actions}}` from the actor's own response from the previous turn
