...
- characters 1584-3921: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5667-6158: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9090-11676: `{{previous_actions}}` from the actor's own response from the previous turn
