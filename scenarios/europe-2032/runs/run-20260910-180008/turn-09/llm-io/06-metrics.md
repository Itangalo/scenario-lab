...
- characters 106-13452: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13495-13686: `{{metrics_json}}` from the run's live metric values
- characters 13779-14865: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14909-17246: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17302-17850: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M11 | EU Swarm-Defence Rollout to Hospitals and Grids | 2 |
