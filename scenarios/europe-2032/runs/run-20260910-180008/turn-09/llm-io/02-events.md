...
- characters 376-1462: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1506-3843: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3899-4800: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4863-26827: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27182-28067: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M9 EU Automation Transition Shield −2, M10 EU Essential Services Continuity and Agent Containment Protocol −2, priority −1 = −5
PROPOSAL BONUS: EU Essential Services Continuity and Agent Containment Protocol (cat 6, small) +4 — loss-of-control incident and frontier cutoff this turn and this answers continuity/containment directly
LEGITIMACY LENDS: capital 19, sentiment 10 -> none, capital higher
SOVEREIGNTY: 21 last turn, no cat4 finish, no cat4 in flight +0, eu_frontier_access_denied t8 −2, capability rose 1.0 no −1 = 19

## Emerging developments (tracked)

- `emergent_gridlink_blockade_escalation` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated local protests and municipal legal challenges physically block power and water works at the two stalled gigafactory grid-link sites, forcing a months-long halt and national debate over AI infrastructure siting.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, loss_of_control_incident, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (7 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 3 (6 turn(s) ago): cyber_major_incident, capability_jump
- Turn 4 (5 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, eval_anomaly_reports
- Turn 5 (4 turn(s) ago): bio_incident, emergent_datacentre_backlash, election_consolidation
- Turn 6 (3 turn(s) ago): eval_anomaly_reports, opaque_reasoning, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, export_control_escalation, us_china_agreement
- Turn 7 (2 turn(s) ago): knowledge_work_augmented, embodied_ai_deployment
- Turn 8 (1 turn(s) ago): loss_of_control_incident, capability_jump, eu_frontier_access_denied, automated_decision_scandal
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.36}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.07}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.08}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.18}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.05}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.14}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Coordinated local protests and municipal legal challenges physically block power and water works at the two stalled gigafactory grid-link sites, forcing a months-long halt and national debate over AI infrastructure siting.", "emergent": true, "id": "emergent_gridlink_blockade_escalation", "probability": 0.22}]
```
