...
- characters 1769-3967: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4023-5037: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5100-31357: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31712-32118: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Bio Early-Warning Network −2, priority −1 = −9
PROPOSAL BONUS: EU Bio Early-Warning Network (cat 6, small) +3 — bio_uplift precursor opened 4-turn gate and cyber wave left hospitals weakened, this answers both directly
...
- `emergent_siting_protests` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated physical protests block two planned gigafactory grid-link sites, forcing a months-long siting delay and national debate over power prices and AI infrastructure.
- `emergent_datacentre_backlash` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated protests block two planned gigafactory/data-centre sites over power prices and water use, forcing a siting delay and national debate on AI infrastructure costs.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, loss_of_control_incident, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (3 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 3 (2 turn(s) ago): cyber_major_incident, capability_jump
- Turn 4 (1 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, eval_anomaly_reports
