...
- characters 13352-14700: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14744-16942: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16998-17755: `{{notepad}}` from the Game Master's notepad, carried across turns
