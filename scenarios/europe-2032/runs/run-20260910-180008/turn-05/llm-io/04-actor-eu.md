...
- characters 455-1803: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1847-4045: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5459-5931: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8095-9907: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Bio Early-Warning Network | 6 | small | 4 | 6 | own jurisdiction | resilience up substantially | 2 | running |
