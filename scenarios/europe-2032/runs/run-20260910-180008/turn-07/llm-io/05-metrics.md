...
- characters 13782-15169: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15213-18308: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18364-19253: `{{notepad}}` from the Game Master's notepad, carried across turns
