...
- characters 13698-15056: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15100-17469: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17525-18345: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Trusted Wards and Sites Pact | 2 |
...
## Metrics
```json
{"ai_capability": 66.5, "openweight_capability": 64.5, "ai_safety": 0.0, "resilience": 63.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 17.0, "public_sentiment": 4.0}
```
## Narrative
### Wards that held
