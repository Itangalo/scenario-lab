...
- characters 376-1734: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1778-4147: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4203-5341: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5404-28221: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28576-29733: `{{event_history}}` from the run's own event record
...
- `emergent_infrastructure_moratorium_spread` -- first noted turn 10, listed in 1 turn(s) so far: Municipal courts extend the gigafactory power-water injunctions into a de facto construction moratorium that spreads to two further sites, freezing EU compute build-out for the half-year.
- `emergent_siting_injunction_spread` -- first noted turn 10, listed in 1 turn(s) so far: Municipal courts extend the gigafactory siting blockade into a coordinated cross-region injunction movement, with several cities jointly suspending power and water permits for large compute builds pending a national siting law.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, loss_of_control_incident, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (9 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 3 (8 turn(s) ago): cyber_major_incident, capability_jump
- Turn 4 (7 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, eval_anomaly_reports
- Turn 5 (6 turn(s) ago): bio_incident, emergent_datacentre_backlash, election_consolidation
- Turn 6 (5 turn(s) ago): eval_anomaly_reports, opaque_reasoning, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, export_control_escalation, us_china_agreement
- Turn 7 (4 turn(s) ago): knowledge_work_augmented, embodied_ai_deployment
- Turn 8 (3 turn(s) ago): loss_of_control_incident, capability_jump, eu_frontier_access_denied, automated_decision_scandal
- Turn 9 (2 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, labour_displacement, emergent_gridlink_blockade_escalation
- Turn 10 (1 turn(s) ago): cyber_major_incident, openweight_frontier_release, export_control_escalation, automated_decision_scandal
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.36}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.02}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.08}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.18}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.05}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.11}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.14}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.15}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Municipal courts extend the gigafactory power-water injunctions into a de facto construction moratorium that spreads to two further sites, freezing EU compute build-out for the half-year.", "emergent": true, "id": "emergent_infrastructure_moratorium_spread", "probability": 0.24}, {"description": "Municipal courts extend the gigafactory siting blockade into a coordinated cross-region injunction movement, with several cities jointly suspending power and water permits for large compute builds pending a national siting law.", "emergent": true, "id": "emergent_siting_injunction_spread", "probability": 0.22}]
```
