...
- characters 1831-4035: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7520-8011: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10294-12692: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Bio Containment Surge | 6 | small | 5 | 7 | own jurisdiction | resilience up substantially | 2 | running |
