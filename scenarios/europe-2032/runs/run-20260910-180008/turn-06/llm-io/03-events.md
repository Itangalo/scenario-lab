...
- characters 1753-3957: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4013-4815: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4878-28442: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28797-29296: `{{event_history}}` from the run's own event record
...
- `emergent_siting_protests` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated physical protests block two planned gigafactory grid-link sites, forcing a months-long siting delay and national debate over power prices and AI infrastructure.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, loss_of_control_incident, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (4 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 3 (3 turn(s) ago): cyber_major_incident, capability_jump
- Turn 4 (2 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, eval_anomaly_reports
- Turn 5 (1 turn(s) ago): bio_incident, emergent_datacentre_backlash, election_consolidation
