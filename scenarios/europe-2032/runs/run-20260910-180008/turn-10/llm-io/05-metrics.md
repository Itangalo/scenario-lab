...
- characters 106-13554: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13597-13787: `{{metrics_json}}` from the run's live metric values
- characters 13880-15300: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15343-17600: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17656-18808: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Critical Services Cyber Recovery Surge | 2 |
...
## Metrics
```json
{"ai_capability": 65.5, "openweight_capability": 63.5, "ai_safety": 0.0, "resilience": 59.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 15.0, "public_sentiment": 3.0}
```
