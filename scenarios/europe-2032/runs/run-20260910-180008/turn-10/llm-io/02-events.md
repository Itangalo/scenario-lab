...
- characters 375-1795: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1838-4095: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4151-4662: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4725-26689: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27044-28068: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, loss_of_control_incident, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (8 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 3 (7 turn(s) ago): cyber_major_incident, capability_jump
- Turn 4 (6 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, eval_anomaly_reports
- Turn 5 (5 turn(s) ago): bio_incident, emergent_datacentre_backlash, election_consolidation
- Turn 6 (4 turn(s) ago): eval_anomaly_reports, opaque_reasoning, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, export_control_escalation, us_china_agreement
- Turn 7 (3 turn(s) ago): knowledge_work_augmented, embodied_ai_deployment
- Turn 8 (2 turn(s) ago): loss_of_control_incident, capability_jump, eu_frontier_access_denied, automated_decision_scandal
- Turn 9 (1 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, labour_displacement, emergent_gridlink_blockade_escalation
