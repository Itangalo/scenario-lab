...
- characters 453-1873: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1916-4173: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5769-6253: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9223-11780: `{{previous_actions}}` from the actor's own response from the previous turn
