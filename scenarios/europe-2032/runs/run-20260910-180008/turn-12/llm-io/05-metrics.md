...
- characters 106-12985: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13028-13218: `{{metrics_json}}` from the run's live metric values
- characters 13311-14467: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14510-16368: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16424-16875: `{{notepad}}` from the Game Master's notepad, carried across turns
