...
- characters 375-1531: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1574-3432: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3488-4262: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4325-27142: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27497-28783: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Trusted Wards and Sites Pact −2, priority −1 = −3
PROPOSAL BONUS: EU Trusted Wards and Sites Pact (cat 6, small) +4 — cyber_major_incident this turn with paper wards plus cross-region siting blockade, this answers directly
LEGITIMACY LENDS: capital 15, sentiment 3 -> none, capital higher
SOVEREIGNTY: 17 last turn, no cat4 finish, no cat4 in flight +0, emergent_siting_injunction_spread t11 −2, capability rose 1.0 no −1 = 15

## Emerging developments (tracked)

- `emergent_infrastructure_moratorium_spread` -- first noted turn 10, listed in 2 turn(s) so far: Municipal courts extend the gigafactory power-water injunctions into a de facto construction moratorium that spreads to two further sites, freezing EU compute build-out for the half-year.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, loss_of_control_incident, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (10 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 3 (9 turn(s) ago): cyber_major_incident, capability_jump
- Turn 4 (8 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, eval_anomaly_reports
- Turn 5 (7 turn(s) ago): bio_incident, emergent_datacentre_backlash, election_consolidation
- Turn 6 (6 turn(s) ago): eval_anomaly_reports, opaque_reasoning, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, export_control_escalation, us_china_agreement
- Turn 7 (5 turn(s) ago): knowledge_work_augmented, embodied_ai_deployment
- Turn 8 (4 turn(s) ago): loss_of_control_incident, capability_jump, eu_frontier_access_denied, automated_decision_scandal
- Turn 9 (3 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, labour_displacement, emergent_gridlink_blockade_escalation
- Turn 10 (2 turn(s) ago): cyber_major_incident, openweight_frontier_release, export_control_escalation, automated_decision_scandal
- Turn 11 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, research_breakthrough, emergent_siting_injunction_spread
