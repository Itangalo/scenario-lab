...
- characters 105-13498: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13541-13733: `{{metrics_json}}` from the run's live metric values
- characters 13826-15338: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15381-17202: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17258-18332: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Bio Early-Warning Network | 2 |
