...
- characters 376-1888: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1931-3752: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3808-4335: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4398-27787: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28142-28441: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, loss_of_control_incident, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (2 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, taiwan_tension_rise
