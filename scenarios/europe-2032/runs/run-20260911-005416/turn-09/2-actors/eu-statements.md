...
- `two_year_commitment` (commitment): Rebuild trusted AI through enforced oversight, restorable public services and independent capacity Europe controls

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild trusted AI through enforced oversight, restorable public services and independent capacity Europe controls
