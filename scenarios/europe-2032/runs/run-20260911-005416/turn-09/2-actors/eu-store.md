...
| M9 | EU Checkable-Work Transition Guarantee | 7 | small | 7 | 9 | own jurisdiction | resilience up, public_sentiment up, eu_political_capital protected | 2 | finished |
| M10 | EU Automated-Attack Restoration Surge | 6 | small | 8 | 9 | own jurisdiction | resilience up to contain cascade, eu_political_capital protected from service failure | 2 | finished |
| M11 | EU Automated Decisions Redress and Oversight Enforcement | 1 | small | 9 | 11 | own jurisdiction | public_sentiment up, eu_political_capital protected, ai_safety up slightly via enforced oversight | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Automated Decisions Redress and Oversight Enforcement", "category": 1, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, eu_political_capital protected, ai_safety up slightly via enforced oversight"}, "grounds": "to answer the automated-decision scandal and AI Act enforcement fail
  - Grounds: to answer the automated-decision scandal and AI Act enforcement failure
