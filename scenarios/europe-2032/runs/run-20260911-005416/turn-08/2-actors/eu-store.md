...
| M10 | EU Automated-Attack Restoration Surge | 6 | small | 8 | 10 | own jurisdiction | resilience up to contain cascade, eu_political_capital protected from service failure | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Automated-Attack Restoration Surge", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up to contain cascade, eu_political_capital protected from service failure"}, "grounds": "to answer the ongoing major automated attack"}
  - Grounds: to answer the ongoing major automated attack
