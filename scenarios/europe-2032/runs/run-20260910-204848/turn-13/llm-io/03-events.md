...
- characters 1554-3296: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3352-3712: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3775-29657: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30012-31131: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, loss_of_control_incident, taiwan_tension_rise
- Turn 2 (11 turn(s) ago): bio_uplift_findings, export_control_escalation, member_state_defection, adoption_success, emergent_research_provenance_mandate
- Turn 3 (10 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, knowledge_work_augmented, export_control_escalation
- Turn 4 (9 turn(s) ago): cyber_major_incident
- Turn 5 (8 turn(s) ago): openweight_frontier_release, export_control_escalation, automated_decision_scandal, election_alliance
- Turn 6 (7 turn(s) ago): emergent_stopgap_lithography_pool
- Turn 7 (6 turn(s) ago): research_breakthrough, taiwan_tension_rise
- Turn 8 (5 turn(s) ago): loss_of_control_incident, openweight_frontier_release
- Turn 9 (4 turn(s) ago): bio_uplift_findings, us_china_agreement, member_state_defection, emergent_siting_freeze_revolt
- Turn 10 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports, embodied_ai_deployment, middle_power_coalition
- Turn 11 (2 turn(s) ago): cyber_major_incident, middle_power_coalition, emergent_siting_blockade_pact
