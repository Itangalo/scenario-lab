...
- characters 2000-4426: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4770-5211: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7374-9200: `{{previous_actions}}` from the actor's own response from the previous turn
