...
- characters 105-13541: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13584-13775: `{{metrics_json}}` from the run's live metric values
- characters 13868-15372: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15415-17841: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17897-18394: `{{notepad}}` from the Game Master's notepad, carried across turns
