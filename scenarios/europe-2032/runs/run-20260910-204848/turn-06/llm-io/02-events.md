...
- characters 375-1879: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1922-4348: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4404-5458: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5521-31453: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31808-32347: `{{event_history}}` from the run's own event record
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, loss_of_control_incident, taiwan_tension_rise
- Turn 2 (4 turn(s) ago): bio_uplift_findings, export_control_escalation, member_state_defection, adoption_success, emergent_research_provenance_mandate
- Turn 3 (3 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, knowledge_work_augmented, export_control_escalation
- Turn 4 (2 turn(s) ago): cyber_major_incident
- Turn 5 (1 turn(s) ago): openweight_frontier_release, export_control_escalation, automated_decision_scandal, election_alliance
