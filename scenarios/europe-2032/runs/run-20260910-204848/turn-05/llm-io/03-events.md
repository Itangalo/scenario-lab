...
- characters 376-1638: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1682-3533: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3589-4629: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4692-32459: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32814-33225: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Grid and Lifeline Hardening Shield −3, EU Bio Shield Watch −2, EU Lithography and Supply-Chain Leverage Compact −2, priority −1 = −13 (priority cost waived as capital below 20, charge applied −13)
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 32 -> +2
SOVEREIGNTY: 14 last turn, no capacity event, Gigafactories in flight +0, capability rose 2.0 −1 = 13

## Emerging developments (tracked)

- `emergent_stopgap_lithography_pool` -- first noted turn 4, listed in 1 turn(s) so far: South Korean and Japanese chip-equipment suppliers offer the EU pooled second-hand lithography tools and field-service crews diverted from delayed expansions, contingent on the lithography compact.
- `emergent_stopgap_tool_pool` -- first noted turn 4, listed in 1 turn(s) so far: South Korean and Japanese chip-tool suppliers quietly offer Europe pooled second-hand lithography capacity as a stopgap for stalled gigafactory lines.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, loss_of_control_incident, taiwan_tension_rise
- Turn 2 (3 turn(s) ago): bio_uplift_findings, export_control_escalation, member_state_defection, adoption_success, emergent_research_provenance_mandate
- Turn 3 (2 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, knowledge_work_augmented, export_control_escalation
- Turn 4 (1 turn(s) ago): cyber_major_incident
