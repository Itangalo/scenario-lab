...
- characters 1760-3611: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6540-6981: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9142-10347: `{{previous_actions}}` from the actor's own response from the previous turn
