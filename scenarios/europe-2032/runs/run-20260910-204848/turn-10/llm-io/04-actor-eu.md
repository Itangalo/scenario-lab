...
- characters 1664-3461: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6774-7278: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9621-11387: `{{previous_actions}}` from the actor's own response from the previous turn
