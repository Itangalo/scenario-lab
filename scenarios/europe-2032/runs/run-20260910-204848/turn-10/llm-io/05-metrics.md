...
- characters 106-13241: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13284-13475: `{{metrics_json}}` from the run's live metric values
- characters 13568-14735: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14778-16575: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16631-17380: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t9: M7 EU Agent Loss-of-Control Response Network −2, priority −0 (capital below 20, no effect no cost) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1.0, sentiment 17.5 -> +2 capped by prior terms, already accounted in capital total
SOVEREIGNTY: 17 last turn, no cat4 finish, no cat4 in flight +0, member_state_defection t9 −2, capability rose 0.5 −0 = 15
