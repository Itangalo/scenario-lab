...
- characters 375-1798: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1841-5093: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5149-6107: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6170-32705: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33060-33728: `{{event_history}}` from the run's own event record
...
- `emergent_siting_freeze_revolt` -- first noted turn 7, listed in 1 turn(s) so far: Municipal bans on new data-centre grid connections spread across several member states amid fraud-scandal anger and power-price protests, freezing pledged builds despite EU permitting zones.
- `emergent_lithography_transfer_freeze` -- first noted turn 7, listed in 1 turn(s) so far: Second-hand lithography suppliers delay or suspend Grenoble/Magdeburg tool installs after a US re-export warning, leaving crews on site but tools in customs hold.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, loss_of_control_incident, taiwan_tension_rise
- Turn 2 (6 turn(s) ago): bio_uplift_findings, export_control_escalation, member_state_defection, adoption_success, emergent_research_provenance_mandate
- Turn 3 (5 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, knowledge_work_augmented, export_control_escalation
- Turn 4 (4 turn(s) ago): cyber_major_incident
- Turn 5 (3 turn(s) ago): openweight_frontier_release, export_control_escalation, automated_decision_scandal, election_alliance
- Turn 6 (2 turn(s) ago): emergent_stopgap_lithography_pool
- Turn 7 (1 turn(s) ago): research_breakthrough, taiwan_tension_rise
