...
- characters 105-12958: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13001-13192: `{{metrics_json}}` from the run's live metric values
- characters 13285-14708: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14751-18003: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18059-19017: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M6 | EU Taiwan Shock Buffer | 2 |
| M7 | EU Agent Loss-of-Control Response Network | 2 |
