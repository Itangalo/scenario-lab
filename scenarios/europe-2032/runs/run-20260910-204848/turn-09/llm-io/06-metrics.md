...
- characters 13333-13524: `{{metrics_json}}` from the run's live metric values
- characters 13617-14787: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14831-17268: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17324-17766: `{{notepad}}` from the Game Master's notepad, carried across turns
