...
- characters 1668-4105: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6050-6554: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9048-11091: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | EU Agent Loss-of-Control Response Network | 6 | small | 8 | 10 | own jurisdiction | resilience up moderately, ai_safety up slightly via containment and reporting | 2 | running |
