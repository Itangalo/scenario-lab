...
- characters 106-12928: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12971-13161: `{{metrics_json}}` from the run's live metric values
- characters 13254-14591: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14634-16612: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16668-17279: `{{notepad}}` from the Game Master's notepad, carried across turns
