...
- characters 106-13269: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13312-13503: `{{metrics_json}}` from the run's live metric values
- characters 13596-14704: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14748-16620: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16676-17618: `{{notepad}}` from the Game Master's notepad, carried across turns
