...
- characters 376-1484: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1528-3400: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3456-3830: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3893-30428: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30783-31382: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, loss_of_control_incident, taiwan_tension_rise
- Turn 2 (5 turn(s) ago): bio_uplift_findings, export_control_escalation, member_state_defection, adoption_success, emergent_research_provenance_mandate
- Turn 3 (4 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, knowledge_work_augmented, export_control_escalation
- Turn 4 (3 turn(s) ago): cyber_major_incident
- Turn 5 (2 turn(s) ago): openweight_frontier_release, export_control_escalation, automated_decision_scandal, election_alliance
- Turn 6 (1 turn(s) ago): emergent_stopgap_lithography_pool
