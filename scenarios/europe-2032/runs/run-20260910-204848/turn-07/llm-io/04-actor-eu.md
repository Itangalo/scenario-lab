...
- characters 454-1562: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1606-3478: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4971-5475: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7487-9458: `{{previous_actions}}` from the actor's own response from the previous turn
