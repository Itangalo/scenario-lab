...
- characters 13132-13323: `{{metrics_json}}` from the run's live metric values
- characters 13416-14491: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14534-16602: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16658-17769: `{{notepad}}` from the Game Master's notepad, carried across turns
