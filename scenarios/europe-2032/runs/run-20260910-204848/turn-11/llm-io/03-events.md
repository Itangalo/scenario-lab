...
- characters 1527-3761: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3817-4614: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4677-30559: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30914-31928: `{{event_history}}` from the run's own event record
...
- `emergent_siting_blockade_pact` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated municipal bans on new data-centre grid connections spread into a cross-border mayors' pact that physically blocks construction traffic and forces a national government to suspend EU-permitted builds.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, loss_of_control_incident, taiwan_tension_rise
- Turn 2 (9 turn(s) ago): bio_uplift_findings, export_control_escalation, member_state_defection, adoption_success, emergent_research_provenance_mandate
- Turn 3 (8 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, knowledge_work_augmented, export_control_escalation
- Turn 4 (7 turn(s) ago): cyber_major_incident
- Turn 5 (6 turn(s) ago): openweight_frontier_release, export_control_escalation, automated_decision_scandal, election_alliance
- Turn 6 (5 turn(s) ago): emergent_stopgap_lithography_pool
- Turn 7 (4 turn(s) ago): research_breakthrough, taiwan_tension_rise
- Turn 8 (3 turn(s) ago): loss_of_control_incident, openweight_frontier_release
- Turn 9 (2 turn(s) ago): bio_uplift_findings, us_china_agreement, member_state_defection, emergent_siting_freeze_revolt
- Turn 10 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports, embodied_ai_deployment, middle_power_coalition
