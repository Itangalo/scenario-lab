...
- characters 107-12929: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12972-13163: `{{metrics_json}}` from the run's live metric values
- characters 13256-14362: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14406-16640: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16696-17158: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Municipal Repair and Displacement Bridge | 2 |
