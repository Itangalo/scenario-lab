...
- characters 377-1795: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1839-3846: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3902-4698: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4761-28988: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29343-29584: `{{event_history}}` from the run's own event record
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, loss_of_control_incident, taiwan_tension_rise
- Turn 2 (1 turn(s) ago): bio_uplift_findings, export_control_escalation, member_state_defection, adoption_success, emergent_research_provenance_mandate
