...
- characters 13390-14343: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14386-16099: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16155-17235: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Entry-Level Transition Fund | 2 |
...
## Metrics
```json
{"ai_capability": 62.0, "openweight_capability": 52.5, "ai_safety": 23.0, "resilience": 36.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 28.0, "public_sentiment": 29.0}
```
