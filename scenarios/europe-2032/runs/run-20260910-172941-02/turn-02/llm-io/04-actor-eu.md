...
- characters 454-1407: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1450-3163: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3904-4389: `{{statement_ledger}}` from the actor's live statement ledger
- characters 5868-7990: `{{previous_actions}}` from the actor's own response from the previous turn
