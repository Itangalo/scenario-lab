...
- characters 13008-13197: `{{metrics_json}}` from the run's live metric values
- characters 13290-14847: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14890-17130: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17186-17610: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Middle-Power Alignment and Verification Cell | 2 |
