...
- characters 374-1931: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1974-4214: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4270-5002: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5065-29402: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29757-30581: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: no measures in flight, no priority = -0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 4, sentiment 10 -> +2 (capped, included in capital calc)
SOVEREIGNTY: 12 last turn, no capacity event finish, no category 4 in flight +0, us_labs_nationalised t9 −2 (largest capacity event, middle_power_coalition securing not counted per one-term rule), capability rose 1.5 −1 = 9

## Emerging developments (tracked)

- `emergent_wartime_cloud_ration_riot` -- first noted turn 8, listed in 2 turn(s) so far: Rationed cloud quotas and rolling grid islanding trigger coordinated protests and sabotage attempts at data-centre and substation sites in two or more member states during H1 2030.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, capability_jump, eu_frontier_access_denied
- Turn 2 (8 turn(s) ago): labour_displacement, knowledge_work_augmented
- Turn 3 (7 turn(s) ago): eval_anomaly_reports
- Turn 4 (6 turn(s) ago): rsi_onset, eval_anomaly_reports
- Turn 5 (5 turn(s) ago): cyber_major_incident, embodied_ai_deployment, adoption_success, election_consolidation
- Turn 6 (4 turn(s) ago): capability_jump, knowledge_work_augmented, member_state_defection
- Turn 7 (3 turn(s) ago): catastrophic_great_power_conflict, member_state_defection, joint_threat_response
- Turn 8 (2 turn(s) ago): opaque_reasoning, adoption_success
- Turn 9 (1 turn(s) ago): loss_of_control_incident, catastrophic_bio_incident, catastrophic_loss_of_control_incident, knowledge_work_augmented, us_labs_nationalised, middle_power_coalition
