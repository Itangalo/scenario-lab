...
- characters 452-2009: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2052-4292: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6211-6530: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8778-11166: `{{previous_actions}}` from the actor's own response from the previous turn
