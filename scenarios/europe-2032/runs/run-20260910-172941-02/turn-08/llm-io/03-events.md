...
- characters 374-1763: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1806-3985: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4041-4643: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4706-31435: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31790-32364: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, capability_jump, eu_frontier_access_denied
- Turn 2 (6 turn(s) ago): labour_displacement, knowledge_work_augmented
- Turn 3 (5 turn(s) ago): eval_anomaly_reports
- Turn 4 (4 turn(s) ago): rsi_onset, eval_anomaly_reports
- Turn 5 (3 turn(s) ago): cyber_major_incident, embodied_ai_deployment, adoption_success, election_consolidation
- Turn 6 (2 turn(s) ago): capability_jump, knowledge_work_augmented, member_state_defection
- Turn 7 (1 turn(s) ago): catastrophic_great_power_conflict, member_state_defection, joint_threat_response
...
```
[{"id": "cyber_major_incident", "probability": 0.19, "emergent": false, "description": ""}, {"id": "cyber_defence_breakthrough", "probability": 0.08, "emergent": false, "description": ""}, {"id": "bio_uplift_findings", "probability": 0.21, "emergent": false, "description": ""}, {"id": "bio_incident", "probability": 0.01, "emergent": false, "description": ""}, {"id": "catastrophic_bio_incident", "probability": 0.01, "emergent": false, "description": ""}, {"id": "eval_anomaly_reports", "probability": 0.25, "emergent": false, "description": ""}, {"id": "capability_jump", "probability": 0.1, "emergent": false, "description": ""}, {"id": "opaque_reasoning", "probability": 0.15, "emergent": false, "description": ""}, {"id": "research_breakthrough", "probability": 0.1, "emergent": false, "description": ""}, {"id": "medical_breakthrough", "probability": 0.18, "emergent": false, "description": ""}, {"id": "openweight_frontier_release", "probability": 0.1, "emergent": false, "description": ""}, {"id": "loss_of_control_incident", "probability": 0.08, "emergent": false, "description": ""}, {"id": "catastrophic_loss_of_control_incident", "probability": 0.02, "emergent": false, "description": ""}, {"id": "safety_breakthrough", "probability": 0.1, "emergent": false, "description": ""}, {"id": "labour_displacement", "probability": 0.16, "emergent": false, "description": ""}, {"id": "knowledge_work_augmented", "probability": 0.05, "emergent": false, "description": ""}, {"id": "embodied_ai_deployment", "probability": 0.16, "emergent": false, "description": ""}, {"id": "ai_investment_collapse", "probability": 0.11, "emergent": false, "description": ""}, {"id": "taiwan_tension_rise", "probability": 0.1, "emergent": false, "description": ""}, {"id": "taiwan_blockade", "probability": 0.02, "emergent": false, "description": ""}, {"id": "export_control_escalation", "probability": 0.16, "emergent": false, "description": ""}, {"id": "us_labs_nationalised", "probability": 0.3, "emergent": false, "description": ""}, {"id": "us_china_agreement", "probability": 0.06, "emergent": false, "description": ""}, {"id": "eu_frontier_access_denied", "probability": 0.16, "emergent": false, "description": ""}, {"id": "supply_chain_coercion", "probability": 0.04, "emergent": false, "description": ""}, {"id": "member_state_defection", "probability": 0.09, "emergent": false, "description": ""}, {"id": "adoption_success", "probability": 0.1, "emergent": false, "description": ""}, {"id": "automated_decision_scandal", "probability": 0.06, "emergent": false, "description": ""}, {"id": "joint_threat_response", "probability": 0.12, "emergent": false, "description": ""}, {"id": "middle_power_coalition", "probability": 0.1, "emergent": false, "description": ""}, {"id": "emergent_wartime_cloud_ration_riot", "probability": 0.12, "emergent": true, "description": "Rationed cloud quotas and rolling grid islanding trigger coordinated protests and sabotage attempts at data-centre and substation sites in two or more member states during H1 2030."}]
```
