...
- characters 13001-13191: `{{metrics_json}}` from the run's live metric values
- characters 13284-14673: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14716-16895: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16951-17861: `{{notepad}}` from the Game Master's notepad, carried across turns
