...
- characters 1951-3694: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3750-4789: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4852-30722: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31077-31234: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Shield −3, EU Entry-Level Transition Fund −2, priority −1 = −12
PROPOSAL BONUS: EU Entry-Level Transition Fund (cat 7, small) +3 — labour_displacement fired this turn with graduate hiring freeze and this answers it directly
LEGITIMACY LENDS: capital 26, sentiment 29 -> +2
SOVEREIGNTY: 18 last turn, no capacity event, in flight +0, capability rose 3.0 −1 = 17

## Emerging developments (tracked)

- `emergent_compute_siting_backlash` -- first noted turn 1, listed in 2 turn(s) so far: Coordinated local protests and legal challenges delay at least one major EU data-centre or supercomputer expansion, turning compute siting into a national political issue in late 2026.
- `emergent_datacentre_backlash` -- first noted turn 1, listed in 2 turn(s) so far: Coordinated local opposition blocks or delays permitting for one or more hyperscale AI data centre projects in the EU after power-price and water-use disputes become national news.
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, capability_jump, eu_frontier_access_denied
- Turn 2 (1 turn(s) ago): labour_displacement, knowledge_work_augmented
