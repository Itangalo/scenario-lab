...
- characters 106-13109: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13152-13344: `{{metrics_json}}` from the run's live metric values
- characters 13437-14967: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15011-16754: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16810-17274: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Model Scrutiny Access Mandate | 2 |
...
## Metrics
```json
{"ai_capability": 65.0, "openweight_capability": 57.0, "ai_safety": 21.0, "resilience": 35.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 20.0, "public_sentiment": 31.0}
```
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Shield −3, EU Entry-Level Transition Fund −2, EU Model Scrutiny Access Mandate −2, priority −1 = −14
PROPOSAL BONUS: EU Model Scrutiny Access Mandate (cat 1, small) +2 — eval anomaly reports this turn and assurance gap from Oct intrusions, this answers it directly
LEGITIMACY LENDS: capital 18, sentiment 31 -> +2
SOVEREIGNTY: 17 last turn, no capacity event, in flight +0, capability rose 3.0 −1 = 16
