...
- characters 374-2812: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2855-4950: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5006-5615: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5678-28509: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28864-29946: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, capability_jump, eu_frontier_access_denied
- Turn 2 (10 turn(s) ago): labour_displacement, knowledge_work_augmented
- Turn 3 (9 turn(s) ago): eval_anomaly_reports
- Turn 4 (8 turn(s) ago): rsi_onset, eval_anomaly_reports
- Turn 5 (7 turn(s) ago): cyber_major_incident, embodied_ai_deployment, adoption_success, election_consolidation
- Turn 6 (6 turn(s) ago): capability_jump, knowledge_work_augmented, member_state_defection
- Turn 7 (5 turn(s) ago): catastrophic_great_power_conflict, member_state_defection, joint_threat_response
- Turn 8 (4 turn(s) ago): opaque_reasoning, adoption_success
- Turn 9 (3 turn(s) ago): loss_of_control_incident, catastrophic_bio_incident, catastrophic_loss_of_control_incident, knowledge_work_augmented, us_labs_nationalised, middle_power_coalition
- Turn 10 (2 turn(s) ago): eval_anomaly_reports, us_china_agreement, middle_power_coalition
- Turn 11 (1 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, catastrophic_loss_of_control_incident, member_state_defection, middle_power_coalition
