...
- characters 13450-13639: `{{metrics_json}}` from the run's live metric values
- characters 13732-16170: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16213-18308: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18364-18973: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Essential-Service Survival and Cutoff Substitution Protocol | 2 |
...
## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M10", "fields": {"finish_turn": 13}, "grounds": "named priority"}]}
```
```
