...
- characters 13482-15595: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15638-17807: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17863-18368: `{{notepad}}` from the Game Master's notepad, carried across turns
