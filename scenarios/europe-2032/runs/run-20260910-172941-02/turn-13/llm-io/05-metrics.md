...
- characters 13434-13622: `{{metrics_json}}` from the run's live metric values
- characters 13715-15863: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15907-17782: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17838-18377: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Islanded Survival and Joint Threat Shelters | 2 |
...
## Notepad
PORTFOLIO CHARGE t13: EU Islanded Survival and Joint Threat Shelters −2, priority −1 = −3
PROPOSAL BONUS: EU Islanded Survival and Joint Threat Shelters (cat 6, small) +4 — cyber_major_incident, bio uplift signal and labour shock across last three turns, severe and immediate, this answers survival directly
LEGITIMACY LENDS: capital 9, sentiment 2 -> none (capital higher, no term)
SOVEREIGNTY: 8 last turn, no category 4 finish, no category 4 in flight +0, embodied_ai_deployment t13 −2, capability rose 2.5 −1 = 5
