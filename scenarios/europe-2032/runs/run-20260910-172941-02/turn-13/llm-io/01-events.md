...
- characters 374-2522: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2566-4441: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4497-5036: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5099-27930: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28285-29443: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, capability_jump, eu_frontier_access_denied
- Turn 2 (11 turn(s) ago): labour_displacement, knowledge_work_augmented
- Turn 3 (10 turn(s) ago): eval_anomaly_reports
- Turn 4 (9 turn(s) ago): rsi_onset, eval_anomaly_reports
- Turn 5 (8 turn(s) ago): cyber_major_incident, embodied_ai_deployment, adoption_success, election_consolidation
- Turn 6 (7 turn(s) ago): capability_jump, knowledge_work_augmented, member_state_defection
- Turn 7 (6 turn(s) ago): catastrophic_great_power_conflict, member_state_defection, joint_threat_response
- Turn 8 (5 turn(s) ago): opaque_reasoning, adoption_success
- Turn 9 (4 turn(s) ago): loss_of_control_incident, catastrophic_bio_incident, catastrophic_loss_of_control_incident, knowledge_work_augmented, us_labs_nationalised, middle_power_coalition
- Turn 10 (3 turn(s) ago): eval_anomaly_reports, us_china_agreement, middle_power_coalition
- Turn 11 (2 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, catastrophic_loss_of_control_incident, member_state_defection, middle_power_coalition
