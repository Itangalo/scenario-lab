...
- characters 13488-13677: `{{metrics_json}}` from the run's live metric values
- characters 13770-15923: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15967-18166: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18222-18724: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Rogue-Agent Containment and Essential-Service Islanding Protocol | 2 |
...
## Metrics
```json
{"ai_capability": 92.0, "openweight_capability": 87.0, "ai_safety": 0.0, "resilience": 38.0, "eu_ai_sovereignty": 12.0, "eu_political_capital": 8.0, "public_sentiment": 3.0}
```
