...
- characters 375-2528: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2572-4771: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4827-5329: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5392-28223: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28578-29495: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Middle-Power Alignment and Verification Cell −2, priority −1 = −3
PROPOSAL BONUS: EU Middle-Power Alignment and Verification Cell (cat 8, small) +2 — answers middle-power coordination opening and US-China floor from this turn directly
LEGITIMACY LENDS: capital 6, sentiment 10 -> +1 (capped, included in capital calc)
SOVEREIGNTY: 9 last turn, no category 4 finish, no category 4 in flight +0, middle_power_coalition t10 +2 (largest capacity event), capability rose 1.5 −0 = 11
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, capability_jump, eu_frontier_access_denied
- Turn 2 (9 turn(s) ago): labour_displacement, knowledge_work_augmented
- Turn 3 (8 turn(s) ago): eval_anomaly_reports
- Turn 4 (7 turn(s) ago): rsi_onset, eval_anomaly_reports
- Turn 5 (6 turn(s) ago): cyber_major_incident, embodied_ai_deployment, adoption_success, election_consolidation
- Turn 6 (5 turn(s) ago): capability_jump, knowledge_work_augmented, member_state_defection
- Turn 7 (4 turn(s) ago): catastrophic_great_power_conflict, member_state_defection, joint_threat_response
- Turn 8 (3 turn(s) ago): opaque_reasoning, adoption_success
- Turn 9 (2 turn(s) ago): loss_of_control_incident, catastrophic_bio_incident, catastrophic_loss_of_control_incident, knowledge_work_augmented, us_labs_nationalised, middle_power_coalition
- Turn 10 (1 turn(s) ago): eval_anomaly_reports, us_china_agreement, middle_power_coalition
