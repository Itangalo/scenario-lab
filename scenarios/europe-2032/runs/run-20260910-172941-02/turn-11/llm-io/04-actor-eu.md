...
- characters 453-2606: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2650-4849: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7103-7457: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9943-12403: `{{previous_actions}}` from the actor's own response from the previous turn
