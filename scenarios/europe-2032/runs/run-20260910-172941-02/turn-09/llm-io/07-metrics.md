...
- characters 13550-15251: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15295-17250: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17306-18009: `{{notepad}}` from the Game Master's notepad, carried across turns
