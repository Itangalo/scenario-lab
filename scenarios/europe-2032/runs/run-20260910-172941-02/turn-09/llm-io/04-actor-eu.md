...
- characters 453-2154: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2198-4153: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6885-7356: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9604-10956: `{{previous_actions}}` from the actor's own response from the previous turn
