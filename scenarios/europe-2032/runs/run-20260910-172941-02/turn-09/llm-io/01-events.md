...
- characters 375-2076: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2120-4075: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4131-4834: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4897-30928: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31283-31918: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M7 EU Wartime Continuity and Joint Cyber Shield −2 = −2 (priority named but capital below 20 so priority −1 not charged, no pull-in)
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 15 -> +2 (capped, included in capital calc)
SOVEREIGNTY: 13 last turn, no capacity event, no category 4 in flight +0, capability rose 3.0 −1 = 12

## Emerging developments (tracked)

- `emergent_wartime_cloud_ration_riot` -- first noted turn 8, listed in 1 turn(s) so far: Rationed cloud quotas and rolling grid islanding trigger coordinated protests and sabotage attempts at data-centre and substation sites in two or more member states during H1 2030.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, capability_jump, eu_frontier_access_denied
- Turn 2 (7 turn(s) ago): labour_displacement, knowledge_work_augmented
- Turn 3 (6 turn(s) ago): eval_anomaly_reports
- Turn 4 (5 turn(s) ago): rsi_onset, eval_anomaly_reports
- Turn 5 (4 turn(s) ago): cyber_major_incident, embodied_ai_deployment, adoption_success, election_consolidation
- Turn 6 (3 turn(s) ago): capability_jump, knowledge_work_augmented, member_state_defection
- Turn 7 (2 turn(s) ago): catastrophic_great_power_conflict, member_state_defection, joint_threat_response
- Turn 8 (1 turn(s) ago): opaque_reasoning, adoption_success
