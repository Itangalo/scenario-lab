...
- characters 106-13630: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13673-13865: `{{metrics_json}}` from the run's live metric values
- characters 13958-15265: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15309-17487: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17543-18649: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 75.0, "openweight_capability": 66.0, "ai_safety": 10.0, "resilience": 38.0, "eu_ai_sovereignty": 12.0, "eu_political_capital": 8.0, "public_sentiment": 23.0}
```
