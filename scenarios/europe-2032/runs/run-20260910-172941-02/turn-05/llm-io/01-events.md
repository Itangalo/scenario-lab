...
- characters 377-1684: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1728-3906: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3962-4483: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4546-32110: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32465-32727: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, capability_jump, eu_frontier_access_denied
- Turn 2 (3 turn(s) ago): labour_displacement, knowledge_work_augmented
- Turn 3 (2 turn(s) ago): eval_anomaly_reports
- Turn 4 (1 turn(s) ago): rsi_onset, eval_anomaly_reports
