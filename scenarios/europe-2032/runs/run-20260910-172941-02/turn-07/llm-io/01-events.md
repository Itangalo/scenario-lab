...
- characters 375-1410: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1454-3374: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3430-4437: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4500-32396: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32751-33218: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, EU Frontier Evaluation Taskforce −2 = −5 (priority named M1 but capital below 20 so priority −1 not charged, no pull-in)
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 8, sentiment 23 -> +2
SOVEREIGNTY: 12 last turn, Tech sovereignty package finishes t6 +4, no in-flight bonus +0, member_state_defection t6 −2, capability rose 6.0 −1 = 13

## Emerging developments (tracked)

- `emergent_datacentre_blockade` -- first noted turn 5, listed in 2 turn(s) so far: Coordinated physical protests and blockades target two hyperscale data-centre construction sites over power and water use, forcing a temporary halt and national police deployment.
- `emergent_compute_backlash_escalation` -- first noted turn 5, listed in 2 turn(s) so far: Coordinated physical protests blockade power and water connections at multiple EU gigafactory and data-centre construction sites, halting works for weeks and forcing emergency policing costs.
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, capability_jump, eu_frontier_access_denied
- Turn 2 (5 turn(s) ago): labour_displacement, knowledge_work_augmented
- Turn 3 (4 turn(s) ago): eval_anomaly_reports
- Turn 4 (3 turn(s) ago): rsi_onset, eval_anomaly_reports
- Turn 5 (2 turn(s) ago): cyber_major_incident, embodied_ai_deployment, adoption_success, election_consolidation
- Turn 6 (1 turn(s) ago): capability_jump, knowledge_work_augmented, member_state_defection
...
IMPORTANT: For events with date-specific conditions (e.g., "September 2026 is included"), check if the current time period (July-December 2029) covers that date.
...
```
[{"id": "cyber_major_incident", "probability": 0.19, "emergent": false, "description": ""}, {"id": "bio_incident", "probability": 0.01, "emergent": false, "description": ""}, {"id": "loss_of_control_incident", "probability": 0.14, "emergent": false, "description": ""}, {"id": "capability_jump", "probability": 0.1, "emergent": false, "description": ""}, {"id": "taiwan_blockade", "probability": 0.02, "emergent": false, "description": ""}, {"id": "ai_investment_collapse", "probability": 0.11, "emergent": false, "description": ""}, {"id": "cyber_defence_breakthrough", "probability": 0.08, "emergent": false, "description": ""}, {"id": "bio_uplift_findings", "probability": 0.21, "emergent": false, "description": ""}, {"id": "catastrophic_bio_incident", "probability": 0.01, "emergent": false, "description": ""}, {"id": "eval_anomaly_reports", "probability": 0.25, "emergent": false, "description": ""}, {"id": "opaque_reasoning", "probability": 0.15, "emergent": false, "description": ""}, {"id": "research_breakthrough", "probability": 0.1, "emergent": false, "description": ""}, {"id": "medical_breakthrough", "probability": 0.18, "emergent": false, "description": ""}, {"id": "openweight_frontier_release", "probability": 0.1, "emergent": false, "description": ""}, {"id": "catastrophic_loss_of_control_incident", "probability": 0.08, "emergent": false, "description": ""}, {"id": "safety_breakthrough", "probability": 0.1, "emergent": false, "description": ""}, {"id": "labour_displacement", "probability": 0.16, "emergent": false, "description": ""}, {"id": "knowledge_work_augmented", "probability": 0.05, "emergent": false, "description": ""}, {"id": "embodied_ai_deployment", "probability": 0.16, "emergent": false, "description": ""}, {"id": "taiwan_tension_rise", "probability": 0.1, "emergent": false, "description": ""}, {"id": "catastrophic_great_power_conflict", "probability": 0.11, "emergent": false, "description": ""}, {"id": "export_control_escalation", "probability": 0.16, "emergent": false, "description": ""}, {"id": "us_labs_nationalised", "probability": 0.22, "emergent": false, "description": ""}, {"id": "us_china_agreement", "probability": 0.06, "emergent": false, "description": ""}, {"id": "eu_frontier_access_denied", "probability": 0.16, "emergent": false, "description": ""}, {"id": "supply_chain_coercion", "probability": 0.04, "emergent": false, "description": ""}, {"id": "member_state_defection", "probability": 0.13, "emergent": false, "description": ""}, {"id": "adoption_success", "probability": 0.1, "emergent": false, "description": ""}, {"id": "automated_decision_scandal", "probability": 0.06, "emergent": false, "description": ""}, {"id": "joint_threat_response", "probability": 0.12, "emergent": false, "description": ""}, {"id": "middle_power_coalition", "probability": 0.1, "emergent": false, "description": ""}, {"id": "emergent_datacentre_blockade", "probability": 0.27, "emergent": true, "description": "Coordinated physical protests and blockades target two hyperscale data-centre construction sites over power and water use, forcing a temporary halt and national police deployment."}, {"id": "emergent_compute_backlash_escalation", "probability": 0.3, "emergent": true, "description": "Coordinated physical protests blockade power and water connections at multiple EU gigafactory and data-centre construction sites, halting works for weeks and forcing emergency policing costs."}]
```
