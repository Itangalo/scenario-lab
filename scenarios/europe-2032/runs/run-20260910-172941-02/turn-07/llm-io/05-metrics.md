...
- characters 106-13446: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13489-13679: `{{metrics_json}}` from the run's live metric values
- characters 13772-14807: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14851-16771: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16827-17249: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Wartime Continuity and Joint Cyber Shield | 2 |
...
## Metrics
```json
{"ai_capability": 84.0, "openweight_capability": 76.0, "ai_safety": 3.0, "resilience": 38.0, "eu_ai_sovereignty": 13.0, "eu_political_capital": 3.0, "public_sentiment": 15.0}
```
## Narrative
### War arrives
