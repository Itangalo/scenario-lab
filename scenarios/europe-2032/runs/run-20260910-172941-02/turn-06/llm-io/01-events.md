...
- characters 375-1479: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1522-3695: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3751-4725: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4788-31638: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31993-32368: `{{event_history}}` from the run's own event record
...
- `emergent_datacentre_blockade` -- first noted turn 5, listed in 1 turn(s) so far: Coordinated physical protests and blockades target two hyperscale data-centre construction sites over power and water use, forcing a temporary halt and national police deployment.
- `emergent_compute_backlash_escalation` -- first noted turn 5, listed in 1 turn(s) so far: Coordinated physical protests blockade power and water connections at multiple EU gigafactory and data-centre construction sites, halting works for weeks and forcing emergency policing costs.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, capability_jump, eu_frontier_access_denied
- Turn 2 (4 turn(s) ago): labour_displacement, knowledge_work_augmented
- Turn 3 (3 turn(s) ago): eval_anomaly_reports
- Turn 4 (2 turn(s) ago): rsi_onset, eval_anomaly_reports
- Turn 5 (1 turn(s) ago): cyber_major_incident, embodied_ai_deployment, adoption_success, election_consolidation
