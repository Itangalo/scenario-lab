...
- characters 453-1557: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1600-3773: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4763-5234: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7494-9090: `{{previous_actions}}` from the actor's own response from the previous turn
