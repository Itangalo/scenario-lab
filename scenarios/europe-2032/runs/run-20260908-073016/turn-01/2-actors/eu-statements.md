...
- `two_year_commitment` (commitment): Secure sovereign AI capacity while containing catastrophic risk in an era of open proliferation.

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign AI capacity while containing catastrophic risk in an era of open proliferation.
