...
- `two_year_commitment` (commitment): Prevent strategic dependence on foreign AI powers while maintaining societal resilience to AI-enabled threats

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Prevent strategic dependence on foreign AI powers while maintaining societal resilience to AI-enabled threats
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the commitment period directly ends the original pledge's timeframe, altering the cost of maintaining the old statement and enabling a strategic reframing.
