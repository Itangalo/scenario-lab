...
- characters 105-13417: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13460-13652: `{{metrics_json}}` from the run's live metric values
- characters 13745-14889: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14932-16908: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16964-17676: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Bridge to the US-China Safety Accord | 2 |
...
PORTFOLIO CHARGE t7: M6 EU Supply-Chain Leverage Coalition −2, M7 EU Essential-Service AI Continuity Reserve −2, priority M6 −1 = −5
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 20.0 after charges and finishing bonus, sentiment 27.0 -> +2
SOVEREIGNTY: 21.5 last turn, M1 InvestAI Gigafactories finishes t7 +4, no capacity event, capability rose 0.7 −0 = 25.5

## Emerging developments (tracked)

- `emergent_care_fallback_litigation` -- first noted turn 8, listed in 1 turn(s) so far: A major European hospital group publicly attributes a weeks-long diagnostic outage to degraded fallback models after US cutoff, triggering lawsuits against the state for continuity failure.
...
## Notepad
PORTFOLIO CHARGE t8: M8 EU Bridge to the US-China Safety Accord −2, priority −1 = −3
PROPOSAL BONUS: none — us_china_agreement this turn is a joinable floor, not a negative shock from last three rounds
LEGITIMACY LENDS: capital 25.0 after charges and finishing bonus, sentiment 27.0 -> +2
SOVEREIGNTY: 25.5 last turn, no cat4 finish, no cat4 in flight, no capacity event, capability rose 0.5 −0 = 25.5
