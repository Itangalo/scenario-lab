...
- characters 378-2824: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2868-4684: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4740-5253: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5316-28762: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29117-29849: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, export_control_escalation, eu_access_secured
- Turn 2 (11 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough
- Turn 5 (8 turn(s) ago): supply_chain_coercion, election_consolidation
- Turn 6 (7 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, eu_frontier_access_denied
- Turn 8 (5 turn(s) ago): us_china_agreement
- Turn 9 (4 turn(s) ago): labour_displacement, knowledge_work_augmented, export_control_escalation, supply_chain_coercion, emergent_care_fallback_litigation
- Turn 11 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, supply_chain_coercion
- Turn 12 (1 turn(s) ago): labour_displacement, emergent_gulf_compute_financing_offer
