...
- characters 107-13316: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13359-13551: `{{metrics_json}}` from the run's live metric values
- characters 13644-16090: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16134-17950: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18006-19163: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Graduate Entry Re-hiring Bridge | 2 |
| M13 | EU Cut-Off Continuity Switch | 2 |
...
PORTFOLIO CHARGE t12: EU Cyber-Bio Containment and Essential Service Recovery Surge −2, EU Graduate Entry Re-hiring Bridge −2, priority −1 = −5

PROPOSAL BONUS: EU Graduate Entry Re-hiring Bridge (cat 7, small) +3 — labour_displacement fired this turn and this answers it directly after M10 finished without restoring hiring

LEGITIMACY LENDS: capital 20.0, sentiment 18.0 -> none, capital higher

SOVEREIGNTY: 20.5 last turn, no capacity event, no cat4 finish, no cat4 in flight +0, capability rose 0.7 −0 = 20.5

## Emerging developments (tracked)

- `emergent_graduate_occupation_wave` -- first noted turn 13, listed in 1 turn(s) so far: Coordinated occupations of faculties and graduate town-halls spill into a sustained blockade of administrative buildings in several university cities, forcing closures and a national political response on entry hiring.
- `emergent_graduate_strike_wave` -- first noted turn 13, listed in 1 turn(s) so far: Graduate occupations and faculty sit-ins across several member states coalesce into a coordinated EU-wide student strike demanding paid entry posts, briefly shutting campuses and forcing a parliamentary hearing.
...
## Notepad
PORTFOLIO CHARGE t13: EU Graduate Entry Re-hiring Bridge −2, EU Cut-Off Continuity Switch −2, priority −1 = −5

PROPOSAL BONUS: EU Cut-Off Continuity Switch (cat 6, small) +4 — cyber_major_incident and eu_frontier_access_denied both fired this turn and this answers them directly

LEGITIMACY LENDS: capital 16.0, sentiment 10.0 -> none, capital higher

SOVEREIGNTY: 20.5 last turn, no capacity event? no — eu_frontier_access_denied t13 −2, no cat4 finish, no cat4 in flight +0, capability rose 0.6 −0 = 18.5

## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M13", "fields": {"finish_turn": 14}, "grounds": "named priority"}]}
```
```
