...
- characters 16248-16820: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_research_integrity_pact` -- first noted turn 1, listed in 1 turn(s) so far: Major EU scientific publishers and universities jointly mandate disclosure and limits on AI-generated research after the Millennium Prize claim triggers integrity disputes.
- `emergent_openweight_crime_wave` -- first noted turn 1, listed in 1 turn(s) so far: Major EU press investigation links Kimi K3-derived tooling to a wave of ransomware against mid-sized industrial firms, triggering calls for open-weight liability in the European Parliament.
