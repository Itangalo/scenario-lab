...
- characters 13621-15414: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15457-17362: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17418-18270: `{{notepad}}` from the Game Master's notepad, carried across turns
