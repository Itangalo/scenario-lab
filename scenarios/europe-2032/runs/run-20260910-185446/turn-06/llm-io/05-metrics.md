...
- characters 13794-16146: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16189-18788: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18844-19426: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Supply-Chain Leverage Coalition | 2 |
| M7 | EU Essential-Service AI Continuity Reserve | 2 |
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 election winner campaigned on federal review and tiered foreign access"}]}
```
```
