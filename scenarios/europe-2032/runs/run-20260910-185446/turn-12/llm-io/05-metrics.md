...
- characters 106-13350: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13393-13585: `{{metrics_json}}` from the run's live metric values
- characters 13678-15866: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15909-17888: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17944-18489: `{{notepad}}` from the Game Master's notepad, carried across turns
