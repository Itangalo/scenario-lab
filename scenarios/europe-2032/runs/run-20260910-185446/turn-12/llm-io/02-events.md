...
- characters 377-2565: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2608-4587: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4643-5819: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5882-29328: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29683-30329: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Youth Entry and Care Transition Guarantee −2, EU Cyber-Bio Containment and Essential Service Recovery Surge −2, priority −1 = −5

PROPOSAL BONUS: EU Cyber-Bio Containment and Essential Service Recovery Surge (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly plus bio precursor

LEGITIMACY LENDS: capital 18, sentiment 24 -> +2 (capped below sentiment)

SOVEREIGNTY: 22.5 last turn, no capacity finish, no cat4 in flight +0, supply_chain_coercion t11 −2, capability rose 0.7 −0 = 20.5

## Emerging developments (tracked)

- `emergent_gulf_compute_financing_offer` -- first noted turn 10, listed in 2 turn(s) so far: A Gulf sovereign fund publicly offers to finance EU gigafactory build-out and secure inference capacity in exchange for hosted capacity and energy partnerships, forcing a sovereignty-versus-dependence debate.
- `emergent_graduate_protest_wave` -- first noted turn 10, listed in 2 turn(s) so far: A coordinated graduate-led protest movement blocks university career fairs and occupies public employment offices across several member states, demanding guaranteed entry posts as hiring freezes persist.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, export_control_escalation, eu_access_secured
- Turn 2 (10 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough
- Turn 5 (7 turn(s) ago): supply_chain_coercion, election_consolidation
- Turn 6 (6 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, eu_frontier_access_denied
- Turn 8 (4 turn(s) ago): us_china_agreement
- Turn 9 (3 turn(s) ago): labour_displacement, knowledge_work_augmented, export_control_escalation, supply_chain_coercion, emergent_care_fallback_litigation
- Turn 11 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, supply_chain_coercion
