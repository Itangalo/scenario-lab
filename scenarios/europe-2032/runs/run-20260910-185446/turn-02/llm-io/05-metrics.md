...
- characters 12983-13175: `{{metrics_json}}` from the run's live metric values
- characters 13268-14680: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14723-17063: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17119-18203: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Assurance and Eval Rapid Uptake | 2 |
...
## Metrics
```json
{"ai_capability": 54.5, "openweight_capability": 49.7, "ai_safety": 37.0, "resilience": 37.0, "eu_ai_sovereignty": 24.0, "eu_political_capital": 31.0, "public_sentiment": 39.0}
```
