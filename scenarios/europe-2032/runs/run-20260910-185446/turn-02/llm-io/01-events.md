...
- characters 1831-4171: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4227-5311: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5374-28656: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29011-29098: `{{event_history}}` from the run's own event record
