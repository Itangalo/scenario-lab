...
- characters 377-2288: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2332-4295: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4351-5035: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5098-27719: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28074-28253: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M5 EU Hardening Standards Enforcement and Continuity −2, priority M5 −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 29, sentiment 37 -> +2
SOVEREIGNTY: 24 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 24

## Emerging developments (tracked)

- `emergent_hardening_decay_backlash` -- first noted turn 4, listed in 1 turn(s) so far: Municipal utilities quietly defer credential rotation and detection staffing over winter, and a local press investigation frames EU hardening funds as paying for audits while defences decay.
...
- Turn 2 (3 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough
