...
- characters 106-12951: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12994-13186: `{{metrics_json}}` from the run's live metric values
- characters 13279-15190: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15234-17197: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17253-17937: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 59.0, "openweight_capability": 55.8, "ai_safety": 28.5, "resilience": 39.0, "eu_ai_sovereignty": 22.0, "eu_political_capital": 21.0, "public_sentiment": 31.0}
```
## Narrative
