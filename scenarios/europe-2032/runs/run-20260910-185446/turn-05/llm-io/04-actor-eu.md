...
- characters 455-2366: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2410-4373: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5770-6246: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8359-9663: `{{previous_actions}}` from the actor's own response from the previous turn
