...
- characters 13603-14739: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14782-16932: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16988-18080: `{{notepad}}` from the Game Master's notepad, carried across turns
