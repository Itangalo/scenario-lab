...
- characters 1634-3784: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3852-4309: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7112-9662: `{{previous_actions}}` from the actor's own response from the previous turn
