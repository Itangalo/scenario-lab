...
- characters 377-1513: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1556-3706: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3762-4223: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4286-27732: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28087-28639: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M9 EU Essential-Service Fallback Repair and Care Liability Pact −2, priority −1 = −3
PROPOSAL BONUS: M9 (cat 6, small) +2 — diagnostic outage litigation and entry-level hiring freeze directly answered, recent and severe
LEGITIMACY LENDS: capital 22.0, sentiment 22.0 -> +1 capped at sentiment [adjusted to 23.0 total]
SOVEREIGNTY: 25.5 last turn, no cat4 finish, no cat4 in flight, supply_chain_coercion t9 −3, capability rose 0.8 −0 = 22.5
...
- Turn 2 (8 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough
- Turn 5 (5 turn(s) ago): supply_chain_coercion, election_consolidation
- Turn 6 (4 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, eu_frontier_access_denied
- Turn 8 (2 turn(s) ago): us_china_agreement
- Turn 9 (1 turn(s) ago): labour_displacement, knowledge_work_augmented, export_control_escalation, supply_chain_coercion, emergent_care_fallback_litigation
