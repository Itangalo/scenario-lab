...
- characters 1471-3631: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3687-4404: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4467-27310: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27665-28060: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, export_control_escalation, eu_access_secured
- Turn 2 (7 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough
- Turn 5 (4 turn(s) ago): supply_chain_coercion, election_consolidation
- Turn 6 (3 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, eu_frontier_access_denied
- Turn 8 (1 turn(s) ago): us_china_agreement
