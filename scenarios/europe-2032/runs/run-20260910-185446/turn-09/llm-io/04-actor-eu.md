...
- characters 455-1505: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1549-3709: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5657-6114: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8694-10922: `{{previous_actions}}` from the actor's own response from the previous turn
