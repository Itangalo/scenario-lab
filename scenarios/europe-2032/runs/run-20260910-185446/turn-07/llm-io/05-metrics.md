...
- characters 13281-13473: `{{metrics_json}}` from the run's live metric values
- characters 13566-14630: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14674-17188: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17244-17801: `{{notepad}}` from the Game Master's notepad, carried across turns
