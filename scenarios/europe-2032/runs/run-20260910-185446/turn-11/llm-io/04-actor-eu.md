...
- characters 456-1750: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1794-3487: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5001-5461: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8647-11040: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Youth Entry and Care Transition Guarantee | 7 | small | 10 | 12 | own jurisdiction | public_sentiment up materially, eu_political_capital up if hiring resumes, resilience up slightly via staffed fallback | 2 | running |
