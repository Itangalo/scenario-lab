...
- characters 378-1672: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1716-3409: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3465-4523: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4586-28032: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28387-28940: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Youth Entry and Care Transition Guarantee −2, priority −1 = −3

PROPOSAL BONUS: none — no external events in last three turns to answer, hiring freeze and outage litigation are standing conditions not priced events

LEGITIMACY LENDS: none — capital 23.0, sentiment 22.0, capital higher

SOVEREIGNTY: 22.5 last turn, no capacity event, no cat4 finish, no cat4 in flight +0, capability rose 0.7 −0 = 22.5

## Emerging developments (tracked)

- `emergent_gulf_compute_financing_offer` -- first noted turn 10, listed in 1 turn(s) so far: A Gulf sovereign fund publicly offers to finance EU gigafactory build-out and secure inference capacity in exchange for hosted capacity and energy partnerships, forcing a sovereignty-versus-dependence debate.
- `emergent_graduate_protest_wave` -- first noted turn 10, listed in 1 turn(s) so far: A coordinated graduate-led protest movement blocks university career fairs and occupies public employment offices across several member states, demanding guaranteed entry posts as hiring freezes persist.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, export_control_escalation, eu_access_secured
- Turn 2 (9 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough
- Turn 5 (6 turn(s) ago): supply_chain_coercion, election_consolidation
- Turn 6 (5 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, eu_frontier_access_denied
- Turn 8 (3 turn(s) ago): us_china_agreement
- Turn 9 (2 turn(s) ago): labour_displacement, knowledge_work_augmented, export_control_escalation, supply_chain_coercion, emergent_care_fallback_litigation
