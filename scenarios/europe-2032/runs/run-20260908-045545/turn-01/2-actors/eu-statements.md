...
- `two_year_commitment` (commitment): Secure sovereign control over AI capability while containing catastrophic risk under uncertainty

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign control over AI capability while containing catastrophic risk under uncertainty
