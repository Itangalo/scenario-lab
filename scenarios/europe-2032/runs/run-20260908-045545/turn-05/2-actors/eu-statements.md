...
- `two_year_commitment` (commitment): Prevent irreversible dependence on non-EU AI capability while maintaining sovereign capacity to act

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Prevent irreversible dependence on non-EU AI capability while maintaining sovereign capacity to act
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the commitment period directly changes the actor's obligation to maintain the original statement, enabling a strategic reorientation.
