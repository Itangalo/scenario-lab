...
- characters 13744-14926: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14970-17051: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17107-18184: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Allied Access and Leverage Compact | 2 |
...
- `emergent_voluntary_disclosure_protocol` -- first noted turn 5, listed in 1 turn(s) so far: A major non-EU standards body publishes an emergency evaluation disclosure protocol that major labs voluntarily adopt, creating de facto cross-border triage norms outside the EU Evaluation Institute.
- `emergent_siting_freeze_escalation` -- first noted turn 5, listed in 1 turn(s) so far: Coordinated physical protests and municipal permit injunctions halt site preparation at two AI factory host towns after open-model probing reports, freezing build-out through winter.
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Anomaly Triage −2, EU Allied Access and Leverage Compact −2, priority −1 = −11
PROPOSAL BONUS: EU Allied Access and Leverage Compact (cat 8, small) +3 — election_consolidation landed this turn and this answers it directly
