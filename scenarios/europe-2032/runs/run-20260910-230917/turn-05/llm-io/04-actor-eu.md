...
- characters 455-1637: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1681-3762: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5181-5621: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7844-9674: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Frontier Anomaly Triage | 1 | small | 4 | 6 | own jurisdiction | ai_safety up modestly, resilience up slightly via early warning | 2 | running |
...
| M5 | EU Open-Weight Incident Shield | 2 | small | 3 | 5 | own jurisdiction | resilience up, ai_safety up modestly via reporting and hardening | 2 | finished |
