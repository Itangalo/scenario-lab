...
- characters 105-13529: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13572-13764: `{{metrics_json}}` from the run's live metric values
- characters 13857-15361: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15404-17218: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17274-17807: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Frontier Anomaly Triage | 2 |
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Open-Weight Incident Shield −2, EU Frontier Anomaly Triage −2, priority −1 = −11
PROPOSAL BONUS: EU Frontier Anomaly Triage (cat 1, small) +3 — eval anomaly reports landed this turn and this answers it directly plus open-weight probing context
