...
- characters 1923-3737: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3793-4618: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4681-27963: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28318-28447: `{{event_history}}` from the run's own event record
...
- Turn 3 (1 turn(s) ago): openweight_frontier_release, emergent_factory_siting_backlash
