...
- characters 106-13096: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13139-13331: `{{metrics_json}}` from the run's live metric values
- characters 13424-14867: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14911-16719: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16775-17559: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Critical Infrastructure AI-Hardening Pact | 2 |
| M5 | EU Open-Weight Incident Shield | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Critical Infrastructure AI-Hardening Pact −2, priority −1 = −12
PROPOSAL BONUS: none — no priced event in last three turns that hardening pact directly answers; autumn intrusions are background history, not event record
LEGITIMACY LENDS: capital 32, sentiment 37 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 20

## Emerging developments (tracked)

- `emergent_siting_backlash` -- first noted turn 2, listed in 2 turn(s) so far: Coordinated local protests and municipal permit challenges stall data-centre and grid-upgrade sites in two or more candidate host states, delaying site selection beyond June.
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Critical Infrastructure AI-Hardening Pact −2, EU Open-Weight Incident Shield −2, priority −1 = −14
PROPOSAL BONUS: EU Open-Weight Incident Shield (cat 2, small) +3 — openweight_frontier_release landed this turn and this answers it directly plus siting backlash
LEGITIMACY LENDS: capital 20, sentiment 34 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 20
