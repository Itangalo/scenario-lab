...
- characters 17299-18356: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 47.5, "ai_safety": 30.0, "resilience": 36.5, "eu_ai_sovereignty": 20.0, "eu_political_capital": 34.0, "public_sentiment": 37.0}
```
