...
- `two_year_commitment` (commitment): Sovereignty through cohesion, not coercion

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Sovereignty through cohesion, not coercion
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly changes the actor's temporal mandate and redefines the necessity of the original statement, triggering a shift in strategic framing.
