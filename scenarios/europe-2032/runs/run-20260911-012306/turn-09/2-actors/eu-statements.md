...
- `two_year_commitment` (commitment): Hold essential services and democratic control through superhuman diffusion

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold essential services and democratic control through superhuman diffusion
