...
- characters 2210-4530: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7487-7959: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10056-11483: `{{previous_actions}}` from the actor's own response from the previous turn
