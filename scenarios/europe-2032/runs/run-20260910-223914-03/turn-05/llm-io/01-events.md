...
- characters 2132-4452: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4508-5114: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5177-35685: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 36040-36437: `{{event_history}}` from the run's own event record
...
- Turn 3 (2 turn(s) ago): capability_jump, eval_anomaly_reports, openweight_frontier_release, safety_breakthrough, labour_displacement, eu_frontier_access_denied
- Turn 4 (1 turn(s) ago): capability_jump, embodied_ai_deployment, eu_frontier_access_denied, automated_decision_scandal, middle_power_coalition
