...
- `two_year_commitment` (commitment): Rebuild public trust and resilient services while securing conditional allied access without abandoning independent capacity

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild public trust and resilient services while securing conditional allied access without abandoning independent capacity
