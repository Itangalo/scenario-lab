...
- characters 4683-5155: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6627-8754: `{{previous_actions}}` from the actor's own response from the previous turn
