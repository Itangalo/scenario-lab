...
- characters 106-13223: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13266-13458: `{{metrics_json}}` from the run's live metric values
- characters 13551-15183: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15227-17247: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17303-18138: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | Common Terms for Foreign AI Partnerships | 2 |
| M5 | EU Essential Services Continuity Switch | 2 |
...
PORTFOLIO CHARGE t2: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Services Shield −3, M4 Common Terms for Foreign AI Partnerships −2, priority M1 −1 = −12
PROPOSAL BONUS: Common Terms (cat 8, small) +2 — member_state_defection fired this turn and this answers it directly, small size limits gain
LEGITIMACY LENDS: capital 23, sentiment 35 -> +2 (capped below sentiment)
SOVEREIGNTY: 21 last turn, no finish, Gigafactories in flight +0, member_state_defection t2 −2, capability rose 3.0 −1 = 18

## Emerging developments (tracked)

- `emergent_factory_siting_backlash` -- first noted turn 2, listed in 2 turn(s) so far: Coordinated local protests and municipal permit challenges stall one or more EU AI factory sites over power prices and water use, forcing a siting delay without a formal policy change.
...
## Metrics
```json
{"ai_capability": 65.0, "openweight_capability": 57.0, "ai_safety": 27.0, "resilience": 35.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 13.0, "public_sentiment": 27.0}
```
## Narrative
### Cut off
...
## Notepad
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Services Shield −3, M4 Common Terms for Foreign AI Partnerships −2, M5 EU Essential Services Continuity Switch −2, priority M3 −1 = −14
PROPOSAL BONUS: Continuity Switch (cat 6, small) +4 — eu_frontier_access_denied fired this turn and this answers it directly, small size limits gain
LEGITIMACY LENDS: capital 11, sentiment 27 -> +2
SOVEREIGNTY: 18 last turn, no finish, no capacity build in flight +0, eu_frontier_access_denied t3 −2, capability rose 7.0 −1 = 15
## Store changes
```json
