...
- characters 376-2114: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2157-3900: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3956-4828: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4891-33867: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34222-34474: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): member_state_defection
- Turn 3 (1 turn(s) ago): capability_jump, eval_anomaly_reports, openweight_frontier_release, safety_breakthrough, labour_displacement, eu_frontier_access_denied
