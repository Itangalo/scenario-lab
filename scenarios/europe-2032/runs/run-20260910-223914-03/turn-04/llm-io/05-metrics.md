...
- characters 105-13548: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13591-13783: `{{metrics_json}}` from the run's live metric values
- characters 13876-15614: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15657-17400: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17456-18018: `{{notepad}}` from the Game Master's notepad, carried across turns
