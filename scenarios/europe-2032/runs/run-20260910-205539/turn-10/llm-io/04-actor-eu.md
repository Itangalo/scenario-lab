...
- characters 453-2536: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2579-5295: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7522-8050: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11262-14050: `{{previous_actions}}` from the actor's own response from the previous turn
...
**emergent_care_staff_boycott (emergent event):** Regional nursing unions coordinate cross-border refusal to operate AI triage tools without EU-wide liability cover, forcing ward closures beyond the reinsurance window.
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Middle-Power Joint Defence and Supply-Chain Pact | 8 | small | 9 | 11 | coalition | resilience up substantially, eu_political_capital up modestly, eu_ai_sovereignty up slightly | 2 | running |
