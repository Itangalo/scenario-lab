...
- characters 375-2458: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2501-5217: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5273-6349: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6412-31301: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31656-32596: `{{event_history}}` from the run's own event record
...
- `emergent_care_staff_boycott` -- first noted turn 9, listed in 1 turn(s) so far: Regional nursing unions coordinate cross-border refusal to operate AI triage tools without EU-wide liability cover, forcing ward closures beyond the reinsurance window.
- `emergent_care_data_extortion_freeze` -- first noted turn 9, listed in 1 turn(s) so far: A coordinated ransomware crew using open-weight cyber agents publishes stolen triage and sequencing data from several northwest clinic networks, triggering patient lawsuits and a temporary halt to cross-border data sharing for care.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, bio_uplift_findings, eu_frontier_access_denied
- Turn 2 (8 turn(s) ago): eu_frontier_access_denied, emergent_lab_disclosure_scandal
- Turn 3 (7 turn(s) ago): cyber_major_incident, bio_uplift_findings, adoption_success, emergent_lab_whistleblower_exodus
- Turn 4 (6 turn(s) ago): bio_uplift_findings, automated_decision_scandal
- Turn 5 (5 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, election_consolidation
- Turn 6 (4 turn(s) ago): bio_incident, bio_uplift_findings, member_state_defection, emergent_cyber_bio_insurance_retreat
- Turn 7 (3 turn(s) ago): taiwan_tension_rise, us_china_agreement, emergent_care_rationing_strikes
- Turn 8 (2 turn(s) ago): capability_jump, taiwan_tension_rise, member_state_defection, emergent_insurer_coverage_freeze
- Turn 9 (1 turn(s) ago): cyber_major_incident, openweight_frontier_release, joint_threat_response, middle_power_coalition
