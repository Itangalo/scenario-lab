...
- characters 13483-13673: `{{metrics_json}}` from the run's live metric values
- characters 13766-15849: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15892-18608: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18664-19488: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Middle-Power Joint Defence and Supply-Chain Pact | 2 |
| M12 | EU Care Staff Liability Cover and Defensive Patch Rollout | 2 |
