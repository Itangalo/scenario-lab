...
- characters 452-2490: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2533-4614: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5490-6018: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9263-10247: `{{previous_actions}}` from the actor's own response from the previous turn
