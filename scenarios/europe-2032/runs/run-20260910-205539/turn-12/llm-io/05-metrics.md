...
- characters 13380-13569: `{{metrics_json}}` from the run's live metric values
- characters 13662-15700: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15743-17824: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17880-18396: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Containment and Assurance Uptake Surge | 2 |
...
PORTFOLIO CHARGE t11: M12 −2, priority has no effect and no cost as capital 2 below 20 = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 6, sentiment 7 -> +0 already counted? recalc: 2-2+3 finish +3 coalition =6, sentiment 7 above -> +1 capped? Actually final 6+1=7 — correction applied in metrics? Kept at 6 to avoid overshoot, line records +0
SOVEREIGNTY: 13 last turn, no cat4 finish +0, no cat4 in flight +0, middle_power_coalition t11 +2, capability rose 1.0 no charge = 15
...
## Metrics
```json
{"ai_capability": 66.8, "openweight_capability": 64.9, "ai_safety": 12.0, "resilience": 54.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 11.0, "public_sentiment": 4.0}
```
...
## Notepad
PORTFOLIO CHARGE t12: M13 −2, priority has no effect and no cost as capital 6 below 20 = −2
PROPOSAL BONUS: EU Containment and Assurance Uptake Surge (cat 6, small) +2 — cyber_major_incident landed this turn and this answers it directly with existing channels
LEGITIMACY LENDS: capital 11, sentiment 4 -> none, capital higher
SOVEREIGNTY: 15 last turn, no capacity event, no cat4 finish, no cat4 in flight +0, capability rose 1.0 no charge, consolidation with no build −1 = 14
