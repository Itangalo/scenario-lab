...
- characters 106-13499: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13542-13734: `{{metrics_json}}` from the run's live metric values
- characters 13827-15041: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15085-17257: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17313-18163: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Bio-Cyber Containment and Care Surge | 2 |
| M9 | EU Accession Bridge to the US-China Risk Accord | 2 |
...
- `emergent_insurer_coverage_freeze` -- first noted turn 7, listed in 1 turn(s) so far: Hospital groups and municipal utilities sue insurers over model-assisted sabotage and pathogen exclusions, triggering a court-ordered coverage freeze and emergency reinsurance intervention.
...
By December, the defensive shield was declared deployed and the first gigafactory phase complete on paper. Auditors again noted permits lagging capacity, and polls showed resentment outweighing relief.
