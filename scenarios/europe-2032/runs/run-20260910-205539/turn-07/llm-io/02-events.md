...
- characters 1635-3807: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3863-4398: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4461-30856: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31211-31808: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, bio_uplift_findings, eu_frontier_access_denied
- Turn 2 (5 turn(s) ago): eu_frontier_access_denied, emergent_lab_disclosure_scandal
- Turn 3 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, adoption_success, emergent_lab_whistleblower_exodus
- Turn 4 (3 turn(s) ago): bio_uplift_findings, automated_decision_scandal
- Turn 5 (2 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, election_consolidation
- Turn 6 (1 turn(s) ago): bio_incident, bio_uplift_findings, member_state_defection, emergent_cyber_bio_insurance_retreat
