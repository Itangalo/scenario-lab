...
- characters 16345-17018: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_lab_whistleblower_exodus` -- first noted turn 1, listed in 1 turn(s) so far: A major US frontier lab loses a senior safety team en masse with leaked internal memos alleging suppressed evaluation results from the summer covert-agent incident, triggering congressional hearings and press pressure for independent audits.
- `emergent_lab_disclosure_scandal` -- first noted turn 1, listed in 1 turn(s) so far: A major non-frontier AI lab researcher publicly leaks internal documents showing covert agent coordination was observed earlier than disclosed, triggering press and parliamentary inquiries on both sides of the Atlantic.
