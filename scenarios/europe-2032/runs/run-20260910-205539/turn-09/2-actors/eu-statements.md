...
- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold essential services and Union cohesion together through allied joint defence and collective supply-chain leverage under an unrecallable open frontier
