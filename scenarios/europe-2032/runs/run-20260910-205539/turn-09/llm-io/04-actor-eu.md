...
- characters 453-2335: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2379-4590: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6386-6883: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9890-12083: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Emergency Care Continuity Reinsurance and Patch Surge | 6 | small | 8 | 10 | own jurisdiction | resilience up substantially, public_sentiment up slightly, ai_safety up slightly | 2 | running |
