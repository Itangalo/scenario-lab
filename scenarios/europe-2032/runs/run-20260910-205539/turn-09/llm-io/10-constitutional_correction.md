...
- characters 3096-3579: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 64.3, "openweight_capability": 62.0, "ai_safety": 11.0, "resilience": 45.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 5.0, "public_sentiment": 4.0}
```
