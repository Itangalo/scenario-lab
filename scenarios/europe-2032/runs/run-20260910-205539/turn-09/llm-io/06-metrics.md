...
- characters 13479-13669: `{{metrics_json}}` from the run's live metric values
- characters 13762-15644: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15688-17899: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17955-19051: `{{notepad}}` from the Game Master's notepad, carried across turns
