...
- characters 375-2257: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2301-4512: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4568-5051: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5114-30003: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30358-31175: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, bio_uplift_findings, eu_frontier_access_denied
- Turn 2 (7 turn(s) ago): eu_frontier_access_denied, emergent_lab_disclosure_scandal
- Turn 3 (6 turn(s) ago): cyber_major_incident, bio_uplift_findings, adoption_success, emergent_lab_whistleblower_exodus
- Turn 4 (5 turn(s) ago): bio_uplift_findings, automated_decision_scandal
- Turn 5 (4 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, election_consolidation
- Turn 6 (3 turn(s) ago): bio_incident, bio_uplift_findings, member_state_defection, emergent_cyber_bio_insurance_retreat
- Turn 7 (2 turn(s) ago): taiwan_tension_rise, us_china_agreement, emergent_care_rationing_strikes
- Turn 8 (1 turn(s) ago): capability_jump, taiwan_tension_rise, member_state_defection, emergent_insurer_coverage_freeze
