...
- characters 455-2468: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2512-4844: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6003-6531: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10118-12170: `{{previous_actions}}` from the actor's own response from the previous turn
...
- `two_year_commitment` (commitment): Hold essential services and Union cohesion together through allied joint defence and collective supply-chain leverage under an unrecallable open frontier
...
|---|---|---|---|---|---|---|---|---|---|
| M13 | EU Containment and Assurance Uptake Surge | 6 | small | 12 | 14 | own jurisdiction | resilience up substantially, ai_safety up modestly, public_sentiment up slightly | 2 | running |
...
| M9 | EU Accession Bridge to the US-China Risk Accord | 8 | small | 7 | 9 | US, China, coalition | ai_safety up modestly, eu_ai_sovereignty up slightly, eu_political_capital up slightly | 2 | finished |
| M10 | EU Emergency Care Continuity Reinsurance and Patch Surge | 6 | small | 8 | 10 | own jurisdiction | resilience up substantially, public_sentiment up slightly, ai_safety up slightly | 2 | finished |
| M11 | EU Middle-Power Joint Defence and Supply-Chain Pact | 8 | small | 9 | 11 | coalition | resilience up substantially, eu_political_capital up modestly, eu_ai_sovereignty up slightly | 2 | finished |
| M12 | EU Care Staff Liability Cover and Defensive Patch Rollout | 6 | small | 10 | 12 | own jurisdiction | resilience up substantially, public_sentiment up modestly | 2 | finished |
...
## New measure
**EU Containment and Assurance Uptake Surge**
It pushes ENISA-led containment, patching and care continuity to the sites hit by the automated attack while fast-tracking the new interpretability/control fix into deployed triage and cyber-defence tools via the joint cyber command and biosurveillance pact.
Category 6 Preparedness and resilience is why now: the major incident demands immediate absorption with capital at 6 and sentiment at 7, and the safety breakthrough gives us a deployable assurance gain without a new build we cannot fund.

## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Containment and Assurance Uptake Surge", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up substantially, ai_safety up modestly, public_sentiment up slightly"}, "grounds": "answer major cyber incident and adopt safety breakthrough with existing channels"}]}
```

## Priority
M13 EU Containment and Assurance Uptake Surge, because it is the only live instrument and holding wards and connected services through the attack outranks all other direction while capital is near zero.

## In practice
We run this through the Health Council and Justice and Home Affairs Council on the existing M10/M12 reinsurance and liability lines, with ENISA and the joint cyber command pushing automated patches, swarm-detection feeds and the new assurance fix to municipalities, clinic networks and the hit utilities. No new money voted: redeployed Digital Europe and civil-protection funds plus the Tokyo-Seoul-London pooled evaluation channel for validation.

We condition continued EU liability cover on sharing telemetry and accepting the certified fix in approved triage tools, offering unions a time-limited no-fault extension in exchange for reopening picketed wards. Trade ministers hold the bloc export-licence line to keep US volume licences and supplier cooperation flowing while containment is visibly behind and attribution is pending.
...
```
## New measure
None this turn. We are waiting for political capital and public trust to recover enough to carry anything new without collapse.

## Store changes
No changes.

## Priority
M13 EU Containment and Assurance Uptake Surge, because with capital at 11 and sentiment at 4 holding shared-telemetry sites, wards and municipal services through the automated sweep and Taiwan-shipping shock outranks any new build we cannot fund or enforce.

## In practice
We keep ENISA and the joint cyber command pushing the validated interpretability/control fix, patches and swarm-detection feeds through the existing Digital Europe and civil-protection redeployment, with Health and JHA Councils administering the conditional liability cover and time-limited no-fault offer to reopen wards. No new money is voted and no parallel compute line is opened.

Trade ministers hold the bloc licence line for rationed US volume licences under tightening export controls, accepting allied-rationing rather than breaking cohesion, while the Tokyo-Seoul-London pooled evaluation channel sustains validation. Suppliers get patch cooperation for licence volume, not new capacity promises we cannot keep.
