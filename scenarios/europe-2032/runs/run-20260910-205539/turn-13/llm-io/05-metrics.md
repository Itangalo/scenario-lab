...
- characters 13260-15273: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15317-17649: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17705-18181: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 67.8, "openweight_capability": 65.9, "ai_safety": 10.0, "resilience": 53.0, "eu_ai_sovereignty": 12.0, "eu_political_capital": 5.0, "public_sentiment": 0.0}
```
...
## Notepad
PORTFOLIO CHARGE t13: M13 −2, priority has no effect and no cost as capital 11 below 20 = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 11, sentiment 4 -> none, capital higher
SOVEREIGNTY: 14 last turn, no cat4 finish, no cat4 in flight +0, export_control_escalation t13 −2, capability rose 1.0 no charge = 12
