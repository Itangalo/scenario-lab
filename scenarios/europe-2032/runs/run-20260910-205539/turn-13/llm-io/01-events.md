...
- characters 377-2390: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2434-4766: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4822-5298: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5361-30509: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30864-32105: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, bio_uplift_findings, eu_frontier_access_denied
- Turn 2 (11 turn(s) ago): eu_frontier_access_denied, emergent_lab_disclosure_scandal
- Turn 3 (10 turn(s) ago): cyber_major_incident, bio_uplift_findings, adoption_success, emergent_lab_whistleblower_exodus
- Turn 4 (9 turn(s) ago): bio_uplift_findings, automated_decision_scandal
- Turn 5 (8 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, election_consolidation
- Turn 6 (7 turn(s) ago): bio_incident, bio_uplift_findings, member_state_defection, emergent_cyber_bio_insurance_retreat
- Turn 7 (6 turn(s) ago): taiwan_tension_rise, us_china_agreement, emergent_care_rationing_strikes
- Turn 8 (5 turn(s) ago): capability_jump, taiwan_tension_rise, member_state_defection, emergent_insurer_coverage_freeze
- Turn 9 (4 turn(s) ago): cyber_major_incident, openweight_frontier_release, joint_threat_response, middle_power_coalition
- Turn 10 (3 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, eval_anomaly_reports, export_control_escalation, joint_threat_response, emergent_care_staff_boycott
- Turn 11 (2 turn(s) ago): middle_power_coalition
- Turn 12 (1 turn(s) ago): cyber_major_incident, safety_breakthrough
