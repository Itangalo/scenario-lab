...
- characters 2220-4868: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6743-7246: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9350-11425: `{{previous_actions}}` from the actor's own response from the previous turn
