...
- characters 454-2061: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2104-4427: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5847-6344: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8778-11313: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Defensive Shield Deployment | 6 | small | 5 | 7 | own jurisdiction | resilience up substantially, ai_safety up slightly | 2 | running |
