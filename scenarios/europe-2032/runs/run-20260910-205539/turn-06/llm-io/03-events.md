...
- characters 376-1983: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2026-4349: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4405-5555: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5618-32222: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32577-33052: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Defensive Shield Deployment −2, priority −1 = −9
PROPOSAL BONUS: EU Defensive Shield Deployment (cat 6, small) +4 — open-weight frontier jump lands this turn putting offence on private hardware and this answers it directly with defensive breakthrough rollout
LEGITIMACY LENDS: capital 17, sentiment 18 -> +1
SOVEREIGNTY: 14 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.0 −0 = 14

## Emerging developments (tracked)

- `emergent_cyber_bio_insurance_retreat` -- first noted turn 4, listed in 2 turn(s) so far: Major European insurers quietly exclude model-assisted cyber sabotage and engineered-pathogen business interruption from municipal and hospital policies, citing unmodellable systemic risk, forcing emergency state backstops.
- `emergent_public_cyber_insurance_retreat` -- first noted turn 4, listed in 2 turn(s) so far: Municipal insurers across several member states abruptly reprice or suspend cyber coverage for public hospitals and water utilities after the autumn machine-paced sabotage wave, forcing emergency state backstops.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, bio_uplift_findings, eu_frontier_access_denied
- Turn 2 (4 turn(s) ago): eu_frontier_access_denied, emergent_lab_disclosure_scandal
- Turn 3 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, adoption_success, emergent_lab_whistleblower_exodus
- Turn 4 (2 turn(s) ago): bio_uplift_findings, automated_decision_scandal
- Turn 5 (1 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, election_consolidation
