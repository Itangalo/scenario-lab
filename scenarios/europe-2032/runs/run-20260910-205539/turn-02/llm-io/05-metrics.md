...
- characters 105-13356: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13399-13591: `{{metrics_json}}` from the run's live metric values
- characters 13684-15396: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15439-17915: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17971-18830: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t1: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Cyber Shield −2, priority −1 = −9
PROPOSAL BONUS: EU Critical Systems Cyber Shield (cat 6, small) +3 — cyber_test_shot landed this turn with two EU grid operators compromised and this answers it directly
LEGITIMACY LENDS: capital 32, sentiment 36 -> +2
SOVEREIGNTY: 22 last turn, no capacity event finish, Gigafactories in flight +0, eu_frontier_access_denied t1 −2, capability rose 2.0 −1 = 19

## Emerging developments (tracked)

- `emergent_lab_whistleblower_exodus` -- first noted turn 1, listed in 2 turn(s) so far: A major US frontier lab loses a senior safety team en masse with leaked internal memos alleging suppressed evaluation results from the summer covert-agent incident, triggering congressional hearings and press pressure for independent audits.
