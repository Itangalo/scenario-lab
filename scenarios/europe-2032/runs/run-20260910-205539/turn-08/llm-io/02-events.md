...
- characters 374-2449: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2492-5452: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5508-6282: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6345-31234: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31589-32285: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, bio_uplift_findings, eu_frontier_access_denied
- Turn 2 (6 turn(s) ago): eu_frontier_access_denied, emergent_lab_disclosure_scandal
- Turn 3 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings, adoption_success, emergent_lab_whistleblower_exodus
- Turn 4 (4 turn(s) ago): bio_uplift_findings, automated_decision_scandal
- Turn 5 (3 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, election_consolidation
- Turn 6 (2 turn(s) ago): bio_incident, bio_uplift_findings, member_state_defection, emergent_cyber_bio_insurance_retreat
- Turn 7 (1 turn(s) ago): taiwan_tension_rise, us_china_agreement, emergent_care_rationing_strikes
