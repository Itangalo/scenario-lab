...
- characters 13431-13621: `{{metrics_json}}` from the run's live metric values
- characters 13714-15789: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15832-18792: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18848-19307: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Emergency Care Continuity Reinsurance and Patch Surge | 2 |
...
## Metrics
```json
{"ai_capability": 63.5, "openweight_capability": 61.3, "ai_safety": 13.0, "resilience": 45.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 7.0, "public_sentiment": 5.0}
```
## Narrative
