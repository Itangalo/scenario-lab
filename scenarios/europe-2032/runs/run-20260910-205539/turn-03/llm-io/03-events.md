...
- characters 377-1766: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1810-3783: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3839-4745: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4808-29035: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29390-29564: `{{event_history}}` from the run's own event record
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, bio_uplift_findings, eu_frontier_access_denied
- Turn 2 (1 turn(s) ago): eu_frontier_access_denied, emergent_lab_disclosure_scandal
