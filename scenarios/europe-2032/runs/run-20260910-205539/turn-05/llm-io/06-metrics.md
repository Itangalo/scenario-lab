...
- characters 106-13731: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13774-13966: `{{metrics_json}}` from the run's live metric values
- characters 14059-15642: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15686-18275: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18331-19565: `{{notepad}}` from the Game Master's notepad, carried across turns
