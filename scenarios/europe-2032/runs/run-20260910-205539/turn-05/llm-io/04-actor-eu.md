...
- characters 2082-4671: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6240-6743: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9030-10956: `{{previous_actions}}` from the actor's own response from the previous turn
