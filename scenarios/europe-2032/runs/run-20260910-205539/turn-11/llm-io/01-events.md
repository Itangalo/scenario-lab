...
- characters 375-2669: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2713-5060: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5116-5970: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6033-30328: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30683-31803: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M11 −2, M12 −2 = −4, priority has no effect and no cost as capital 5 below 20
PROPOSAL BONUS: EU Care Staff Liability Cover and Defensive Patch Rollout (cat 6, small) +3 — emergent boycott closing wards this turn severe and this answers directly plus defensive breakthrough window
LEGITIMACY LENDS: capital 0, sentiment 4 -> +2
SOVEREIGNTY: 15 last turn, no capacity event finish, no cat4 in flight +0, export_control_escalation t10 −2, capability rose 0.5 no charge = 13

## Emerging developments (tracked)

- `emergent_care_data_extortion_freeze` -- first noted turn 9, listed in 2 turn(s) so far: A coordinated ransomware crew using open-weight cyber agents publishes stolen triage and sequencing data from several northwest clinic networks, triggering patient lawsuits and a temporary halt to cross-border data sharing for care.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, bio_uplift_findings, eu_frontier_access_denied
- Turn 2 (9 turn(s) ago): eu_frontier_access_denied, emergent_lab_disclosure_scandal
- Turn 3 (8 turn(s) ago): cyber_major_incident, bio_uplift_findings, adoption_success, emergent_lab_whistleblower_exodus
- Turn 4 (7 turn(s) ago): bio_uplift_findings, automated_decision_scandal
- Turn 5 (6 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, election_consolidation
- Turn 6 (5 turn(s) ago): bio_incident, bio_uplift_findings, member_state_defection, emergent_cyber_bio_insurance_retreat
- Turn 7 (4 turn(s) ago): taiwan_tension_rise, us_china_agreement, emergent_care_rationing_strikes
- Turn 8 (3 turn(s) ago): capability_jump, taiwan_tension_rise, member_state_defection, emergent_insurer_coverage_freeze
- Turn 9 (2 turn(s) ago): cyber_major_incident, openweight_frontier_release, joint_threat_response, middle_power_coalition
- Turn 10 (1 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, eval_anomaly_reports, export_control_escalation, joint_threat_response, emergent_care_staff_boycott
