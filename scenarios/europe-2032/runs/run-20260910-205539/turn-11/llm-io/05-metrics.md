...
- characters 107-13375: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13418-13607: `{{metrics_json}}` from the run's live metric values
- characters 13700-15994: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16038-18385: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18441-18934: `{{notepad}}` from the Game Master's notepad, carried across turns
