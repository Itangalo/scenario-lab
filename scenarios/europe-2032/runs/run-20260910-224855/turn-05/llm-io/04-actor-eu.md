...
- characters 455-1401: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1445-3822: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6910-7382: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9693-12164: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Assured Control Adoption | 5 | small | 4 | 7 | own jurisdiction | ai_safety up, resilience up slightly via certified controls and containment | 2 | running |
...
| M5 | EU Breakthrough Defence Surge | 6 | small | 3 | 5 | own jurisdiction | resilience up, ai_safety up slightly via reduced blast radius | 2 | finished |
