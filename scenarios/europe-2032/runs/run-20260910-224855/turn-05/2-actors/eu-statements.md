...
- `two_year_commitment` (commitment): Ensure essential services run on EU-controlled capacity and survive frontier shocks

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Ensure essential services run on EU-controlled capacity and survive frontier shocks
