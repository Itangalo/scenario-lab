...
- characters 105-13712: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13755-13947: `{{metrics_json}}` from the run's live metric values
- characters 14040-15193: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15236-18317: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18373-18927: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Breakthrough Defence Surge | 2 |
| M6 | EU Assured Control Adoption | 2 |
...
## Notepad
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M5 EU Breakthrough Defence Surge −2, M6 EU Assured Control Adoption −2, priority −1 = −11
PROPOSAL BONUS: none — knowledge_work_augmented removes felt displacement crisis, no bonus for spending against problem public cannot feel despite loss-of-control and breakthrough window
LEGITIMACY LENDS: capital 30, sentiment 28 -> none, capital higher
