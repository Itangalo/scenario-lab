...
- characters 4728-5200: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6672-8799: `{{previous_actions}}` from the actor's own response from the previous turn
