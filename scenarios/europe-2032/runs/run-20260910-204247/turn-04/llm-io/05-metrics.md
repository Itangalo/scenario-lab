...
- characters 13339-14629: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14672-16791: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16847-17505: `{{notepad}}` from the Game Master's notepad, carried across turns
