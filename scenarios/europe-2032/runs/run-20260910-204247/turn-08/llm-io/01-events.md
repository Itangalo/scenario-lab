...
- characters 376-1728: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1771-3694: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3750-4821: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4884-31579: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31934-32418: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: Eastern Resilience Repair Cell −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: Eastern Resilience Repair Cell (cat 6, small) +2 — cyber_major_incident this turn and repeated sweep last turn, answers directly but small
LEGITIMACY LENDS: capital 13, sentiment 38 -> +2
SOVEREIGNTY: 20 last turn, InvestAI Gigafactories finishes t7 +5, no cat4 in flight, member_state_defection t7 −2, capability rose 0.9 −0 = 23

## Emerging developments (tracked)

- `emergent_brussels_standard_opening` -- first noted turn 6, listed in 2 turn(s) so far: US retrenchment administration publishes draft AI moratorium rules creating temporary regulatory vacuum that EU standards bodies are invited to fill in international forums.
- `emergent_gulf_capacity_offer` -- first noted turn 7, listed in 1 turn(s) so far: With US frontier training paused and EU access tightened informally, a Gulf-funded compute provider offers discounted dedicated frontier capacity to EU ministries and hospitals, forcing a procurement-versus-dependence fight.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, eu_access_secured, adoption_success
- Turn 2 (6 turn(s) ago): ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented
- Turn 5 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, labour_displacement, adoption_success, emergent_cyber_insurance_crunch, election_retrenchment
- Turn 6 (2 turn(s) ago): cyber_major_incident
- Turn 7 (1 turn(s) ago): cyber_major_incident, member_state_defection
