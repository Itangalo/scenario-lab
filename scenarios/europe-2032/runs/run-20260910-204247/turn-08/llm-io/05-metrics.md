...
- characters 13278-14630: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14673-16596: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16652-17459: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_gulf_capacity_offer` -- first noted turn 7, listed in 2 turn(s) so far: With US frontier training paused and EU access tightened informally, a Gulf-funded compute provider offers discounted dedicated frontier capacity to EU ministries and hospitals, forcing a procurement-versus-dependence fight.
