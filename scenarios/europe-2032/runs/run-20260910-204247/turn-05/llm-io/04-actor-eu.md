...
- characters 1691-3579: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6773-7233: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9155-10737: `{{previous_actions}}` from the actor's own response from the previous turn
