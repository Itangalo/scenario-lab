...
- characters 1613-3501: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3557-4215: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4278-28588: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28943-29117: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Shield −3, EU Bio-Sentinel Uplift −2, priority −1 = −12
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 10, sentiment 53 -> +2
SOVEREIGNTY: 23 last turn, no capacity event, no finishing measure, in-flight +0, capability rose 2.0 −1 = 22

## Emerging developments (tracked)

- `emergent_cyber_insurance_crunch` -- first noted turn 4, listed in 1 turn(s) so far: A major European insurer reprices commercial cyber cover after 2027 probing, forcing grid operators and mid-size industrials to disclose unpatched exposure to keep policies.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, eu_access_secured, adoption_success
- Turn 2 (3 turn(s) ago): ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented
