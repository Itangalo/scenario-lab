...
- characters 106-13340: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13383-13575: `{{metrics_json}}` from the run's live metric values
- characters 13668-14860: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14904-16792: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16848-17208: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.5, "openweight_capability": 56.0, "ai_safety": 24.0, "resilience": 40.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 8.0, "public_sentiment": 44.0}
```
## Narrative
### Autumn of shocks
