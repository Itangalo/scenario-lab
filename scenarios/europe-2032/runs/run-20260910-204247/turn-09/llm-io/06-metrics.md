...
- characters 13665-15645: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15689-17741: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17797-18268: `{{notepad}}` from the Game Master's notepad, carried across turns
