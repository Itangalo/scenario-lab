...
- characters 454-2434: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2478-4530: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8457-8946: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11203-13104: `{{previous_actions}}` from the actor's own response from the previous turn
