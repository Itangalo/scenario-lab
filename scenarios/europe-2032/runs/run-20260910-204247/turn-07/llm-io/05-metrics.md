...
- characters 106-13435: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13478-13669: `{{metrics_json}}` from the run's live metric values
- characters 13762-15400: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15444-18115: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18171-19125: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M5 | Eastern Resilience Repair Cell | 2 |
