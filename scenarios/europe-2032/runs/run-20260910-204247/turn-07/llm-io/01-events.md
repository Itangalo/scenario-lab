...
- characters 376-2014: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2058-4729: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4785-5737: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5800-32495: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32850-33263: `{{event_history}}` from the run's own event record
...
- `emergent_us_frontier_pause` -- first noted turn 6, listed in 1 turn(s) so far: The new US backlash administration issues an executive pause on large training runs and restricts frontier API access for foreign users pending safety review, slowing US frontier releases and tightening EU access informally.
- `emergent_brussels_standard_opening` -- first noted turn 6, listed in 1 turn(s) so far: US retrenchment administration publishes draft AI moratorium rules creating temporary regulatory vacuum that EU standards bodies are invited to fill in international forums.
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, eu_access_secured, adoption_success
- Turn 2 (5 turn(s) ago): ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented
- Turn 5 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, labour_displacement, adoption_success, emergent_cyber_insurance_crunch, election_retrenchment
- Turn 6 (1 turn(s) ago): cyber_major_incident
