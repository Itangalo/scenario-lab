...
- characters 454-3071: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3114-5410: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6588-7081: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9573-12308: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | Joint Patch and Leverage Pact | 8 | small | 9 | 11 | own jurisdiction and middle-power coalition | resilience up moderately, eu_ai_sovereignty up slightly via joint access, eu_political_capital up via coalition | 2 | running |
