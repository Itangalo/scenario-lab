...
- characters 13677-16294: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16337-18633: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18689-19266: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | Joint Patch and Leverage Pact | 2 |
| M8 | EU Bio-Agent Containment Surge | 2 |
...
## Notepad
PORTFOLIO CHARGE t10: Joint Patch and Leverage Pact −2, EU Bio-Agent Containment Surge −2, priority −0 (capital below 20, no effect) = −4
PROPOSAL BONUS: EU Bio-Agent Containment Surge (cat 6, small) +3 — bio-viable-design precursor plus days-long unsanctioned agent action last turn, answers directly via screening and kill-switch drills, but small and no new budget
LEGITIMACY LENDS: capital 5, sentiment 22 -> +2 (capped below sentiment, applied in total)
