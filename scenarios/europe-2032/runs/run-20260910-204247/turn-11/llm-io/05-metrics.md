...
- characters 107-13376: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13419-13610: `{{metrics_json}}` from the run's live metric values
- characters 13703-16964: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 17008-19129: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 19185-19739: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 67.1, "openweight_capability": 65.3, "ai_safety": 22.0, "resilience": 40.0, "eu_ai_sovereignty": 23.0, "eu_political_capital": 12.0, "public_sentiment": 15.0}
```
