...
- characters 377-3638: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3682-5803: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5859-6413: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6476-33327: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33682-34502: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, eu_access_secured, adoption_success
- Turn 2 (9 turn(s) ago): ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented
- Turn 5 (6 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, labour_displacement, adoption_success, emergent_cyber_insurance_crunch, election_retrenchment
- Turn 6 (5 turn(s) ago): cyber_major_incident
- Turn 7 (4 turn(s) ago): cyber_major_incident, member_state_defection
- Turn 8 (3 turn(s) ago): eval_anomaly_reports, openweight_frontier_release
- Turn 9 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, capability_jump, cyber_defence_breakthrough, opaque_reasoning, knowledge_work_augmented, middle_power_coalition
- Turn 10 (1 turn(s) ago): loss_of_control_incident, bio_uplift_findings
