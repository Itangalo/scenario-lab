...
- characters 106-13012: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13055-13247: `{{metrics_json}}` from the run's live metric values
- characters 13340-14394: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14438-16745: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16801-17261: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Narrative
### Holding the line
July to December 2027 was a half-year of maintenance, not momentum. Brussels chose to start nothing new, and the choice showed.
...
The new biosurveillance network began quietly. A dozen sentinel hospitals began reporting, wastewater sampling started at major border hubs, and sequencing contracts were signed. Health officials stressed it was detection only — no new powers, no new money line. Researchers tracking the March genome-model claim remained divided, and public attention never engaged.
...
By December, the Union had avoided irreversible loss on cyber hardening, but at the cost of political exhaustion and a sovereignty position that drifted backward as the frontier advanced without it.

## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Shield −3, EU Bio-Sentinel Uplift −2, priority −1 = −12
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 22, sentiment 51 -> +2
