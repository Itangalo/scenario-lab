...
- characters 375-1974: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2017-4152: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4208-4540: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4603-30695: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31050-31416: `{{event_history}}` from the run's own event record
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, eu_access_secured, adoption_success
- Turn 2 (4 turn(s) ago): ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented
- Turn 5 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, labour_displacement, adoption_success, emergent_cyber_insurance_crunch, election_retrenchment
