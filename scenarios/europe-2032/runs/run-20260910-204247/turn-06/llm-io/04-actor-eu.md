...
- characters 453-2052: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2095-4230: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4780-5269: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7192-9123: `{{previous_actions}}` from the actor's own response from the previous turn
