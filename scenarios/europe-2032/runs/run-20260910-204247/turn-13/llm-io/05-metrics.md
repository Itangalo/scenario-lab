...
- characters 107-12971: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13014-13205: `{{metrics_json}}` from the run's live metric values
- characters 13298-16591: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16635-18716: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18772-19189: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | Defection Containment and Eastern Backfill | 2 |
| M10 | European Relief Dividend | 2 |
...
PORTFOLIO CHARGE t12: Defection Containment and Eastern Backfill −2, priority −0 (capital below 20, no effect) = −2
PROPOSAL BONUS: Defection Containment (cat 8, small) +2 — member-state side-deal landed this turn and this answers it directly
LEGITIMACY LENDS: capital 7, sentiment 12 -> +2
SOVEREIGNTY: 23 last turn, no capacity event? member_state_defection t12 −2, no cat4 in flight +0, capability rose 0.8 −0 = 21
...
## Metrics
```json
{"ai_capability": 68.7, "openweight_capability": 67.0, "ai_safety": 18.0, "resilience": 43.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 7.0, "public_sentiment": 6.0}
```
...
## Notepad
PORTFOLIO CHARGE t13: Defection Containment and Eastern Backfill −2, European Relief Dividend −2, priority −0 (capital below 20, no effect) = −4
PROPOSAL BONUS: European Relief Dividend (cat 9, small) +2 — automated sweep landed this turn and this answers visible harm directly, adoption win supports it
LEGITIMACY LENDS: capital 5, sentiment 6 -> +2
SOVEREIGNTY: 21 last turn, no capacity event? embodied_ai_deployment t13 −2, no cat4 in flight +0, capability rose 0.8 −0 = 19
