...
- characters 106-13451: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13494-13686: `{{metrics_json}}` from the run's live metric values
- characters 13779-15611: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15655-17587: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17643-18164: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Defensive AI Shield Deployment | 2 |
