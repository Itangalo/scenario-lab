...
- characters 374-1397: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1440-4202: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4258-5259: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5322-32017: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32372-33097: `{{event_history}}` from the run's own event record
...
- `emergent_energy_rationing_litigation` -- first noted turn 7, listed in 1 turn(s) so far: Municipal utilities in two member states impose rolling brownouts explicitly blamed on backup-grid strain, triggering coordinated lawsuits against conversion-site grid reservations.
- `emergent_winter_backup_grid_failure` -- first noted turn 7, listed in 1 turn(s) so far: A severe winter cold snap combined with deferred maintenance forces rolling outages across the slower backup grid that held through the autumn, turning frozen data-centre conversion sites and paper-fallback hospitals into a continent-wide energy-resilience crisis.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, ai_investment_collapse, safety_breakthrough, taiwan_tension_rise
- Turn 2 (6 turn(s) ago): emergent_synthetic_fraud_wave
- Turn 3 (5 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release
- Turn 4 (4 turn(s) ago): eu_frontier_access_denied, member_state_defection
- Turn 5 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, export_control_escalation, automated_decision_scandal, election_retrenchment
- Turn 6 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, export_control_escalation, emergent_factory_site_backlash
- Turn 7 (1 turn(s) ago): capability_jump, bio_uplift_findings, taiwan_tension_rise, supply_chain_coercion
