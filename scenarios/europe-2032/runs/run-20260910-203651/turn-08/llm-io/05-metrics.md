...
- characters 105-13226: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13269-13459: `{{metrics_json}}` from the run's live metric values
- characters 13552-14575: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14618-17380: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17436-18437: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 63.8, "openweight_capability": 61.8, "ai_safety": 20.0, "resilience": 47.0, "eu_ai_sovereignty": 13.0, "eu_political_capital": 6.0, "public_sentiment": 10.0}
```
