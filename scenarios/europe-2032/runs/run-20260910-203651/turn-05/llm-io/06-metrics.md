...
- characters 13728-15552: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15596-17736: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17792-18713: `{{notepad}}` from the Game Master's notepad, carried across turns
