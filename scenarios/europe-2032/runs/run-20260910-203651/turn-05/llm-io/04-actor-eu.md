...
- characters 455-2279: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2323-4463: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 9223-9695: `{{statement_ledger}}` from the actor's live statement ledger
- characters 12004-13975: `{{previous_actions}}` from the actor's own response from the previous turn
