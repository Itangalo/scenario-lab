...
| M6 | EU Essential Services Model Continuity Bridge | 6 | small | 4 | 6 | own jurisdiction | resilience up moderately, eu_political_capital up slightly if holds | 2 | running |
...
- **applied** `M6` — {"op": "add", "table": "measures", "fields": {"name": "EU Essential Services Model Continuity Bridge", "category": 6, "size": "small", "finish_turn": 6, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital up slightly if holds"}, "grounds": "frontier access denied plus member-state defection in same turn"}
  - Grounds: frontier access denied plus member-state defection in same turn
