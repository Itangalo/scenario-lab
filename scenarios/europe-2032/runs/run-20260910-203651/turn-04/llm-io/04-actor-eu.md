...
- characters 2479-4323: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5102-5574: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7704-9747: `{{previous_actions}}` from the actor's own response from the previous turn
