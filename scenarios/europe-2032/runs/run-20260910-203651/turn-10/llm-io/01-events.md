...
- characters 376-1161: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1204-3392: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3448-4060: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4123-31671: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32026-33001: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, ai_investment_collapse, safety_breakthrough, taiwan_tension_rise
- Turn 2 (8 turn(s) ago): emergent_synthetic_fraud_wave
- Turn 3 (7 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release
- Turn 4 (6 turn(s) ago): eu_frontier_access_denied, member_state_defection
- Turn 5 (5 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, export_control_escalation, automated_decision_scandal, election_retrenchment
- Turn 6 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, export_control_escalation, emergent_factory_site_backlash
- Turn 7 (3 turn(s) ago): capability_jump, bio_uplift_findings, taiwan_tension_rise, supply_chain_coercion
- Turn 8 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, medical_breakthrough, knowledge_work_augmented, export_control_escalation
- Turn 9 (1 turn(s) ago): capability_jump, research_breakthrough, adoption_success, middle_power_coalition
