...
- characters 107-13377: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13420-13609: `{{metrics_json}}` from the run's live metric values
- characters 13702-14691: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14735-16898: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16954-17616: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Accession to the US-China AI Risk Accord | 2 |
...
- `emergent_paper_care_federation` -- first noted turn 13, listed in 1 turn(s) so far: Municipal clinician boycott networks formalize into a permanent paper-care federation that refuses reconnection and trains staff in non-AI practice, entrenching dual-system healthcare.
...
## Notepad
PORTFOLIO CHARGE t13: M11 EU Accession to the US-China AI Risk Accord −2, priority has no effect below 20 −0 = −2
PROPOSAL BONUS: EU Accession (cat 8, small) +2 — us_china_agreement landed this turn and this answers it directly, observer status only so low end
LEGITIMACY LENDS: capital 3, sentiment 0 -> none, capital higher
SOVEREIGNTY: 13 last turn, no cat4 finish, no cat4 in flight +0, no capacity event, capability rose 0.5 −0 = 13
