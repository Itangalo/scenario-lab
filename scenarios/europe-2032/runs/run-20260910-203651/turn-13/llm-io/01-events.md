...
- characters 375-1364: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1408-3571: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3627-3980: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4043-30176: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30531-31711: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M10 EU Clinic Backlog Clearing and Procurement Review −2, priority has no effect below 20 −0 = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 3, sentiment 0 -> none, capital higher
SOVEREIGNTY: 13 last turn, no cat4 finish, no cat4 in flight +0, no capacity event, capability rose 0.7 −0 = 13
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, ai_investment_collapse, safety_breakthrough, taiwan_tension_rise
- Turn 2 (11 turn(s) ago): emergent_synthetic_fraud_wave
- Turn 3 (10 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release
- Turn 4 (9 turn(s) ago): eu_frontier_access_denied, member_state_defection
- Turn 5 (8 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, export_control_escalation, automated_decision_scandal, election_retrenchment
- Turn 6 (7 turn(s) ago): cyber_major_incident, bio_uplift_findings, export_control_escalation, emergent_factory_site_backlash
- Turn 7 (6 turn(s) ago): capability_jump, bio_uplift_findings, taiwan_tension_rise, supply_chain_coercion
- Turn 8 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings, medical_breakthrough, knowledge_work_augmented, export_control_escalation
- Turn 9 (4 turn(s) ago): capability_jump, research_breakthrough, adoption_success, middle_power_coalition
- Turn 10 (3 turn(s) ago): taiwan_blockade
- Turn 11 (2 turn(s) ago): emergent_care_backlog_litigation_freeze
- Turn 12 (1 turn(s) ago): cyber_major_incident, opaque_reasoning, emergent_care_ai_boycott
