...
- characters 374-1183: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1226-3171: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3227-4161: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4224-31054: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31409-32496: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, ai_investment_collapse, safety_breakthrough, taiwan_tension_rise
- Turn 2 (10 turn(s) ago): emergent_synthetic_fraud_wave
- Turn 3 (9 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release
- Turn 4 (8 turn(s) ago): eu_frontier_access_denied, member_state_defection
- Turn 5 (7 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, export_control_escalation, automated_decision_scandal, election_retrenchment
- Turn 6 (6 turn(s) ago): cyber_major_incident, bio_uplift_findings, export_control_escalation, emergent_factory_site_backlash
- Turn 7 (5 turn(s) ago): capability_jump, bio_uplift_findings, taiwan_tension_rise, supply_chain_coercion
- Turn 8 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, medical_breakthrough, knowledge_work_augmented, export_control_escalation
- Turn 9 (3 turn(s) ago): capability_jump, research_breakthrough, adoption_success, middle_power_coalition
- Turn 10 (2 turn(s) ago): taiwan_blockade
- Turn 11 (1 turn(s) ago): emergent_care_backlog_litigation_freeze
