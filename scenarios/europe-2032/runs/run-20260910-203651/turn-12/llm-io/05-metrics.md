...
- characters 13409-13598: `{{metrics_json}}` from the run's live metric values
- characters 13691-14500: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14543-16488: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16544-17121: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 67.5, "openweight_capability": 65.9, "ai_safety": 0.0, "resilience": 47.0, "eu_ai_sovereignty": 13.0, "eu_political_capital": 3.0, "public_sentiment": 0.0}
```
