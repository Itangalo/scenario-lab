...
- characters 13337-13528: `{{metrics_json}}` from the run's live metric values
- characters 13621-14833: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14877-17011: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17067-18108: `{{notepad}}` from the Game Master's notepad, carried across turns
