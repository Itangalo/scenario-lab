...
- characters 1632-3766: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3822-4196: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4259-30351: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30706-31324: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, ai_investment_collapse, safety_breakthrough, taiwan_tension_rise
- Turn 2 (5 turn(s) ago): emergent_synthetic_fraud_wave
- Turn 3 (4 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release
- Turn 4 (3 turn(s) ago): eu_frontier_access_denied, member_state_defection
- Turn 5 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, export_control_escalation, automated_decision_scandal, election_retrenchment
- Turn 6 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, export_control_escalation, emergent_factory_site_backlash
