...
- characters 106-12934: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12977-13168: `{{metrics_json}}` from the run's live metric values
- characters 13261-14184: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14228-16102: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16158-16475: `{{notepad}}` from the Game Master's notepad, carried across turns
