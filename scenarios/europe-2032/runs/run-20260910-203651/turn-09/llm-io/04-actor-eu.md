...
- characters 454-1377: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1421-3295: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5640-6128: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8458-9702: `{{previous_actions}}` from the actor's own response from the previous turn
