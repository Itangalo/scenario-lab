...
- characters 376-1299: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1343-3217: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3273-4257: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4320-31015: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31370-32238: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: no measures in flight −0, priority has no effect below 20 −0 = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 4, sentiment 10 -> +2
SOVEREIGNTY: 15 last turn, no cat4 finish, no in-flight cat4 +0, export_control_escalation t8 −2, capability rose 0.8 −0 = 13

## Emerging developments (tracked)

- `emergent_energy_rationing_litigation` -- first noted turn 7, listed in 2 turn(s) so far: Municipal utilities in two member states impose rolling brownouts explicitly blamed on backup-grid strain, triggering coordinated lawsuits against conversion-site grid reservations.
- `emergent_winter_backup_grid_failure` -- first noted turn 7, listed in 2 turn(s) so far: A severe winter cold snap combined with deferred maintenance forces rolling outages across the slower backup grid that held through the autumn, turning frozen data-centre conversion sites and paper-fallback hospitals into a continent-wide energy-resilience crisis.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, ai_investment_collapse, safety_breakthrough, taiwan_tension_rise
- Turn 2 (7 turn(s) ago): emergent_synthetic_fraud_wave
- Turn 3 (6 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release
- Turn 4 (5 turn(s) ago): eu_frontier_access_denied, member_state_defection
- Turn 5 (4 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, export_control_escalation, automated_decision_scandal, election_retrenchment
- Turn 6 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, export_control_escalation, emergent_factory_site_backlash
- Turn 7 (2 turn(s) ago): capability_jump, bio_uplift_findings, taiwan_tension_rise, supply_chain_coercion
- Turn 8 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, medical_breakthrough, knowledge_work_augmented, export_control_escalation
