...
- characters 376-1055: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1099-3153: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3209-4477: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4540-31370: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31725-32744: `{{event_history}}` from the run's own event record
...
- `emergent_care_backlog_litigation_freeze` -- first noted turn 10, listed in 1 turn(s) so far: Municipal clinics and registries hit by the managed-service intrusions publish paper-record backlogs and delayed-care figures, triggering coordinated patient-advocacy lawsuits that freeze further health-administration AI procurement pending court review.
- `emergent_care_ai_boycott` -- first noted turn 10, listed in 1 turn(s) so far: Municipal clinic staff and local press publish coordinated refusals to reconnect EU-procured diagnostic assistants after the managed-service intrusions, turning a cyber-hygiene measure into a sustained non-use movement in several regions.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, ai_investment_collapse, safety_breakthrough, taiwan_tension_rise
- Turn 2 (9 turn(s) ago): emergent_synthetic_fraud_wave
- Turn 3 (8 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release
- Turn 4 (7 turn(s) ago): eu_frontier_access_denied, member_state_defection
- Turn 5 (6 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, export_control_escalation, automated_decision_scandal, election_retrenchment
- Turn 6 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings, export_control_escalation, emergent_factory_site_backlash
- Turn 7 (4 turn(s) ago): capability_jump, bio_uplift_findings, taiwan_tension_rise, supply_chain_coercion
- Turn 8 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, medical_breakthrough, knowledge_work_augmented, export_control_escalation
- Turn 9 (2 turn(s) ago): capability_jump, research_breakthrough, adoption_success, middle_power_coalition
- Turn 10 (1 turn(s) ago): taiwan_blockade
