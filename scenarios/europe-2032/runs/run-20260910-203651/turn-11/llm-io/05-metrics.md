...
- characters 107-13496: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13539-13729: `{{metrics_json}}` from the run's live metric values
- characters 13822-14501: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14545-16599: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16655-17572: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Essential Compute Continuity and Rationing Regime | 2 |
| M10 | EU Clinic Backlog Clearing and Procurement Review | 2 |
...
PORTFOLIO CHARGE t10: M8 EU–Middle Power Supply Chain Bargaining Compact −2, M9 EU Essential Compute Continuity and Rationing Regime −2, priority has no effect below 20 −0 = −4
PROPOSAL BONUS: EU Essential Compute Continuity and Rationing Regime (cat 6, small) +2 — taiwan_blockade landed this turn halting advanced exports for years and this rations remaining compute directly
LEGITIMACY LENDS: capital 11, sentiment 5 -> none, capital higher
SOVEREIGNTY: 15 last turn, no cat4 finish, no in-flight cat4 +0, taiwan_blockade t10 −2, capability rose 0.8 −0 = 13

## Emerging developments (tracked)

- `emergent_care_ai_boycott` -- first noted turn 10, listed in 2 turn(s) so far: Municipal clinic staff and local press publish coordinated refusals to reconnect EU-procured diagnostic assistants after the managed-service intrusions, turning a cyber-hygiene measure into a sustained non-use movement in several regions.
...
## Notepad
PORTFOLIO CHARGE t11: M9 EU Essential Compute Continuity and Rationing Regime −2, M10 EU Clinic Backlog Clearing and Procurement Review −2, priority has no effect below 20 −0 = −4
PROPOSAL BONUS: EU Clinic Backlog Clearing and Procurement Review (cat 6, small) +2 — emergent litigation freeze landed this turn freezing health-administration procurement and this answers backlogs plus review directly
LEGITIMACY LENDS: capital 11, sentiment 5 -> none, capital higher
SOVEREIGNTY: 13 last turn, no cat4 finish, no in-flight cat4 +0, no capacity event, capability rose 0.8 −0 = 13
