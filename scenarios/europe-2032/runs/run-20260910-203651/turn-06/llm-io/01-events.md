...
- characters 375-1433: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1476-3730: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3786-4715: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4778-30870: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31225-31716: `{{event_history}}` from the run's own event record
...
- `emergent_factory_site_backlash` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated physical protests and blockades target frozen AI factory conversion sites and new substation sensor rollouts, fusing anti-data-centre, energy-price and anti-fraud grievances into a single movement.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, ai_investment_collapse, safety_breakthrough, taiwan_tension_rise
- Turn 2 (4 turn(s) ago): emergent_synthetic_fraud_wave
- Turn 3 (3 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release
- Turn 4 (2 turn(s) ago): eu_frontier_access_denied, member_state_defection
- Turn 5 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, export_control_escalation, automated_decision_scandal, election_retrenchment
