...
- characters 453-1511: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1554-3808: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5447-5935: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8415-10765: `{{previous_actions}}` from the actor's own response from the previous turn
