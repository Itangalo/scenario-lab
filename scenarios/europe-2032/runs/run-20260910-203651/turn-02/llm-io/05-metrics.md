...
- characters 13398-14669: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14712-17037: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17093-17975: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Trusted Authentication and Fraud Containment Shield | 2 |
...
## Notepad
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Grid and Essential Services Hardening Pact −3, EU Trusted Authentication and Fraud Containment Shield −2, priority −1 = −12
PROPOSAL BONUS: EU Trusted Authentication and Fraud Containment Shield (cat 9, small) +2 — emergent_synthetic_fraud_wave landed this turn and this answers it directly
LEGITIMACY LENDS: capital 21, sentiment 32 -> +1
