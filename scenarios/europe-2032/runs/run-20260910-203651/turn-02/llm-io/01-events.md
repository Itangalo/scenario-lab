...
- characters 376-1647: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1690-4015: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4071-5259: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5322-28955: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29310-29417: `{{event_history}}` from the run's own event record
...
- Turn 1 (1 turn(s) ago): cyber_test_shot, ai_investment_collapse, safety_breakthrough, taiwan_tension_rise
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.28}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.1}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.15}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.05}, {"description": "A major European scientific publisher and a DNA synthesis industry consortium jointly announce a voluntary moratorium on publishing detailed genome-design methods above phage-level complexity, prompting a split among researchers and an immediate test of whether voluntary screening holds.", "emergent": true, "id": "emergent_synthesis_screening_pact", "probability": 0.12}, {"description": "A wave of AI-generated voice and video fraud using Mythos-class open models hits banks and public administrations across several EU states, causing tens of millions in losses and forcing emergency authentication changes.", "emergent": true, "id": "emergent_synthetic_fraud_wave", "probability": 0.2}]
```
