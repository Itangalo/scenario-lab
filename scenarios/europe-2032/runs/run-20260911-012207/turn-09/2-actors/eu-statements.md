...
- `two_year_commitment` (commitment): Hold absorption and trusted services first, keep banked sovereignty alive for re-entry

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold absorption and trusted services first, keep banked sovereignty alive for re-entry
