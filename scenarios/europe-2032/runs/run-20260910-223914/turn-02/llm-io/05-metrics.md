...
- characters 105-13166: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13209-13401: `{{metrics_json}}` from the run's live metric values
- characters 13494-14823: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14866-17343: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17399-18440: `{{notepad}}` from the Game Master's notepad, carried across turns
