...
- characters 5602-6074: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7546-9673: `{{previous_actions}}` from the actor's own response from the previous turn
