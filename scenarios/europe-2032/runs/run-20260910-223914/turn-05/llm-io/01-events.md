...
- characters 377-2079: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2123-4088: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4144-4655: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4718-31548: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31903-32089: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): cyber_major_incident, openweight_frontier_release, eu_frontier_access_denied
- Turn 4 (1 turn(s) ago): taiwan_blockade
