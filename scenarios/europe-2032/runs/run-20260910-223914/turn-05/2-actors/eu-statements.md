...
- `two_year_commitment` (commitment): Hold essential services running through blockade and opaque AI by hardening fallback and absorption

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold essential services running through blockade and opaque AI by hardening fallback and absorption
