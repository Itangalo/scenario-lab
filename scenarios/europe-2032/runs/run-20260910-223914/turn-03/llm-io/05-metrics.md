...
- characters 106-13214: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13257-13449: `{{metrics_json}}` from the run's live metric values
- characters 13542-15072: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15116-17148: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17204-18332: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Essential Services Continuity Pool | 2 |
| M5 | EU-US-Asia Supply and Access Pact | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, EU Essential Services Continuity Pool −2, priority −1 = −12
PROPOSAL BONUS: EU Essential Services Continuity Pool (cat 6, small) +2 — cyber_major_incident and frontier access denial landed this turn and this answers continuity directly
LEGITIMACY LENDS: capital 26, sentiment 28 -> +2
SOVEREIGNTY: 21 last turn, no capacity event finish, Gigafactories in flight +0, eu_frontier_access_denied t2 −2, capability rose 3.0 −1 = 18

## Emerging developments (tracked)

- `emergent_copycat_intrusion_wave` -- first noted turn 2, listed in 2 turn(s) so far: Independent grid-vendor audit publicly links the autumn pre-positioning tooling to a specific downloadable frontier model lineage, triggering copycat probing attempts by non-state groups.
- `emergent_attribution_leak` -- first noted turn 2, listed in 2 turn(s) so far: Forensic reports attributing the autumn grid pre-positioning campaign to a specific state sponsor leak from multiple intelligence services, forcing public attribution debate and retaliation pressure.
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, EU Essential Services Continuity Pool −2, EU-US-Asia Supply and Access Pact −2, priority −1 = −14
PROPOSAL BONUS: EU-US-Asia Supply and Access Pact (cat 8, small) +3 — unilateral frontier access cut last turn and this answers leverage/fallback directly
