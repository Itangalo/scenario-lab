...
- characters 105-13566: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13609-13801: `{{metrics_json}}` from the run's live metric values
- characters 13894-16081: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16124-18270: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18326-18838: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | Lithography-for-Assurance Bargain | 2 |
...
## Metrics
```json
{"ai_capability": 64.0, "openweight_capability": 57.8, "ai_safety": 26.0, "resilience": 41.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 14.0, "public_sentiment": 24.0}
```
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, EU Critical Services Shield −3, EU-US-Asia Supply and Access Pact −2, Lithography-for-Assurance Bargain −2, priority −1 = −11
PROPOSAL BONUS: Lithography-for-Assurance Bargain (cat 8, small) +3 — taiwan blockade halts semiconductor exports this turn and this trades lithography leverage for access directly
LEGITIMACY LENDS: capital 19, sentiment 27 -> +2
SOVEREIGNTY: 17 last turn, no cat4 finish, in-flight +0, taiwan_blockade t4 −2, capability rose 3.0 −1 = 14
## Store changes
```json
{"store": []}
```
