...
- `two_year_commitment` (commitment): Keep hospitals, power and payments running and earn back public consent through useful AI

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Keep hospitals, power and payments running and earn back public consent through useful AI
