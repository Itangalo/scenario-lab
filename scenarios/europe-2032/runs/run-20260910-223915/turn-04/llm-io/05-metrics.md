...
- characters 105-13586: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13629-13821: `{{metrics_json}}` from the run's live metric values
- characters 13914-15462: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15505-17732: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17788-18876: `{{notepad}}` from the Game Master's notepad, carried across turns
