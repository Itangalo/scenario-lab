...
- characters 5023-5495: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6967-9094: `{{previous_actions}}` from the actor's own response from the previous turn
