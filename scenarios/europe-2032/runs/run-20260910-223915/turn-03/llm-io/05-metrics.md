...
- characters 106-13206: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13249-13441: `{{metrics_json}}` from the run's live metric values
- characters 13534-15001: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15045-16932: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16988-18058: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | Joint Supply-Chain Leverage Pact | 2 |
| M5 | EU Frontier Evaluation Mandate | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, Joint Supply-Chain Leverage Pact −2, priority −1 = −12
PROPOSAL BONUS: Joint Supply-Chain Leverage Pact (cat 8, small) +2 — Taiwan tension rise this turn opens three-turn coercion window and this answers it directly
...
- `emergent_datacentre_siting_backlash` -- first noted turn 3, listed in 1 turn(s) so far: A coordinated physical protest and grid-connection blockade stalls one of the two advancing AI factory sites, forcing a months-long permitting freeze and a national debate over data-centre power prices.
- `emergent_municipal_insurance_crunch` -- first noted turn 3, listed in 1 turn(s) so far: A major European insurer reprices cyber cover for municipal utilities after the autumn intrusion disclosures, forcing councils to publish backup-test results or lose cover.
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, Joint Supply-Chain Leverage Pact −2, EU Frontier Evaluation Mandate −2, priority −1 = −14
PROPOSAL BONUS: none — no external event in last three turns that Evaluation Mandate directly answers; capability-safety gap is trend not event
