...
- characters 13865-15213: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15257-17460: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17516-17981: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Evaluation Mandate −2, European Care Dividend −2, priority −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 9, sentiment 45 -> +2
SOVEREIGNTY: 18 last turn, no cat4 finish, no in-flight bonus, export_control_escalation t5 −2, capability rose 3.0 −1 = 15
