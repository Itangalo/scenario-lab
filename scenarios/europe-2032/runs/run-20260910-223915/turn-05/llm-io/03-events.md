...
- characters 377-1725: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1769-3972: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4028-5088: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5151-32699: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33054-33231: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, Joint Supply-Chain Leverage Pact −2, EU Frontier Evaluation Mandate −2, European Care Dividend −2, priority −1 = −13
PROPOSAL BONUS: European Care Dividend (cat 9, small) +2 — adoption_success landed this turn and this scales it directly
LEGITIMACY LENDS: capital 20, sentiment 40 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, Gigafactories in flight +0, capability rose 3.0 −1 = 18

## Emerging developments (tracked)

- `emergent_datacentre_siting_backlash` -- first noted turn 3, listed in 2 turn(s) so far: A coordinated physical protest and grid-connection blockade stalls one of the two advancing AI factory sites, forcing a months-long permitting freeze and a national debate over data-centre power prices.
- `emergent_municipal_insurance_crunch` -- first noted turn 3, listed in 2 turn(s) so far: A major European insurer reprices cyber cover for municipal utilities after the autumn intrusion disclosures, forcing councils to publish backup-test results or lose cover.
...
- Turn 2 (3 turn(s) ago): knowledge_work_augmented, taiwan_tension_rise
- Turn 4 (1 turn(s) ago): taiwan_tension_rise, adoption_success
