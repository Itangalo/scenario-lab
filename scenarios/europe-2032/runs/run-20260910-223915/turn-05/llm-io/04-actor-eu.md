...
- characters 1847-4050: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6434-6906: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9153-10869: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | European Care Dividend | 9 | small | 4 | 7 | own jurisdiction | public_sentiment up, eu_political_capital up indirectly | 2 | running |
...
| M4 | Joint Supply-Chain Leverage Pact | 8 | small | 2 | 5 | coalition | eu_ai_sovereignty up, eu_political_capital protected against coercion | 2 | finished |
