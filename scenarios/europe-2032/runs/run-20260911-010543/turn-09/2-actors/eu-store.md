...
| M9 | EU Synthesis Screening and Medical Countermeasure Sprint | 6 | small | 7 | 9 | own jurisdiction | resilience up to blunt bio uplift, ai_safety loss contained | 2 | finished |
| M10 | EU Loss-of-Control Agent Containment Regime | 6 | small | 8 | 10 | own jurisdiction | resilience up to stop cascade from agentic loss-of-control, ai_safety loss contained | 2 | running |
| M11 | EU Critical Services Cyber Restoration Surge | 6 | small | 9 | 11 | own jurisdiction | resilience up to restore services and stop cascade, eu_political_capital protected | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Critical Services Cyber Restoration Surge", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up to restore services and stop cascade, eu_political_capital protected"}, "grounds": "to answer the major automated attack while containment holds"}
  - Grounds: to answer the major automated attack while containment holds
