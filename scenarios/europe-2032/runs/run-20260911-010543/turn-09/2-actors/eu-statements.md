...
- `two_year_commitment` (commitment): Keep essential services running through AI shocks while rebuilding the Union's capacity to act on its own terms

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Keep essential services running through AI shocks while rebuilding the Union's capacity to act on its own terms
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the commitment period directly changes the actor's obligation to uphold the prior statement, triggering a natural review and rewrite.
