...
| M9 | EU Synthesis Screening and Medical Countermeasure Sprint | 6 | small | 7 | 9 | own jurisdiction | resilience up to blunt bio uplift, ai_safety loss contained | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Synthesis Screening and Medical Countermeasure Sprint", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up to blunt bio uplift, ai_safety loss contained"}, "grounds": "to answer bio precursor before gate widens with minimal capital"}
  - Grounds: to answer bio precursor before gate widens with minimal capital
