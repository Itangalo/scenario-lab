...
- characters 1933-3596: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3652-4566: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4629-27911: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28266-28359: `{{event_history}}` from the run's own event record
