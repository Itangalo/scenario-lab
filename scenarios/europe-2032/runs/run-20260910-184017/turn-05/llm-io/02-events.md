...
- characters 377-1747: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1791-4041: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4097-5206: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5269-31870: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32225-32436: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Displacement Transition Fund −2, EU Evaluation and Assurance Cell −2, priority −1 = −11
PROPOSAL BONUS: EU Evaluation and Assurance Cell (cat 5, small) +2 — eval anomaly leak this turn shows assurance gap and this answers it directly but small and access not yet secured
...
- `emergent_anti_datacentre_blockades` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated physical protests block two planned gigafactory / data-centre sites in France and Germany over power prices and jobs, forcing permitting delays and national debate.
- `emergent_anti_ai_siting_protests` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated protests by freelance journalists and junior white-collar workers in France and Germany block a data-centre permitting hearing, turning displacement anxiety into physical opposition to AI infrastructure.
...
- Turn 2 (3 turn(s) ago): emergent_kimi_crime_wave
- Turn 3 (2 turn(s) ago): knowledge_work_augmented
- Turn 4 (1 turn(s) ago): eval_anomaly_reports
