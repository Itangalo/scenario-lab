...
- characters 106-13484: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13527-13719: `{{metrics_json}}` from the run's live metric values
- characters 13812-15182: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15226-17476: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17532-18641: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Critical Dependency Patching and Recovery Reserve | 2 |
