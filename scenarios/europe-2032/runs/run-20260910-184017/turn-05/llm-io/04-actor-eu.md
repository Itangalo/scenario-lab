...
- characters 1869-4119: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6781-7232: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9558-11467: `{{previous_actions}}` from the actor's own response from the previous turn
