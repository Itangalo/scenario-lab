...
- characters 106-13448: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13491-13683: `{{metrics_json}}` from the run's live metric values
- characters 13776-14990: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15034-17069: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17125-17616: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 54.0, "ai_safety": 28.0, "resilience": 42.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 29.0, "public_sentiment": 33.0}
```
