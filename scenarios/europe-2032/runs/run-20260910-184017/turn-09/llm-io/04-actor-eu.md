...
- characters 454-2493: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2537-4919: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5972-6489: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9463-11752: `{{previous_actions}}` from the actor's own response from the previous turn
