...
- characters 106-13766: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13809-14000: `{{metrics_json}}` from the run's live metric values
- characters 14093-16132: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16176-18558: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18614-19201: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Certified Containment Retrofit | 2 |
