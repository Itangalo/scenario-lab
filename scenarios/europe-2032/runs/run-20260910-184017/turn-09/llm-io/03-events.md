...
- characters 376-2415: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2459-4841: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4897-5782: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5845-31596: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31951-32615: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Upstream Leverage and Secure Compute Compact −2, EU Joint Threat Shield Accession −2, EU Containment and Lights-On Protocol −2, priority −1 = −7
PROPOSAL BONUS: EU Containment and Lights-On Protocol (cat 6, small) +4 — loss-of-control incident with days-long containment uncertainty plus rolling blackouts landed this turn and this answers both directly
LEGITIMACY LENDS: capital 16, sentiment 24 -> +2 (capped below sentiment, after charge/bonus/losses)
SOVEREIGNTY: 19 last turn, no capacity event, EU Upstream Leverage in flight +0, capability rose 7.0 −1 = 18

## Emerging developments (tracked)

- `emergent_buildout_moratorium` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated strikes and sabotage halt construction at the remaining French/German gigafactory site and force a temporary EU-wide moratorium on new data-centre grid connections.
...
- Turn 2 (7 turn(s) ago): emergent_kimi_crime_wave
- Turn 3 (6 turn(s) ago): knowledge_work_augmented
- Turn 4 (5 turn(s) ago): eval_anomaly_reports
- Turn 5 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, medical_breakthrough, openweight_frontier_release, election_alliance
- Turn 6 (3 turn(s) ago): capability_jump, taiwan_blockade, opaque_reasoning, emergent_anti_datacentre_blockades
- Turn 7 (2 turn(s) ago): capability_jump, us_china_agreement, joint_threat_response
- Turn 8 (1 turn(s) ago): rsi_onset, medical_breakthrough, loss_of_control_incident, emergent_grid_stress_blackouts
