...
- characters 107-13500: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13543-13733: `{{metrics_json}}` from the run's live metric values
- characters 13826-15008: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15052-17019: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17075-17846: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M15 | EU Automated Attack Containment and Essential Service Restoration | 2 |
...
PORTFOLIO CHARGE t12: EU Certified Benefit Scale-Up and Anti-Carve-Out Enforcement −2, priority −1 = −3
PROPOSAL BONUS: none — M14 already in flight, no new measure started this turn to earn one-off
LEGITIMACY LENDS: capital 30, sentiment 30 -> none — capital not below sentiment, no lend
SOVEREIGNTY: 8 last turn, no capacity finish +0, no cat4 in flight +0, member_state_defection t12 −2, capability rose 1.5 (below 2, no −1) = 6

## Emerging developments (tracked)

- `emergent_war_risk_transit_freeze` -- first noted turn 13, listed in 1 turn(s) so far: Wartime insurers and neutral cloud operators begin refusing EU inference transit, citing targeting risk to data centres, forcing emergency rerouting of medical and energy workloads onto congested isolated systems.
...
## Notepad
PORTFOLIO CHARGE t13: EU Automated Attack Containment and Essential Service Restoration −2, priority −1 = −3
PROPOSAL BONUS: EU Automated Attack Containment and Essential Service Restoration (cat 6, small) +3 — cyber_major_incident landed this turn severe and this answers it directly
LEGITIMACY LENDS: capital 23, sentiment 31 -> +2
SOVEREIGNTY: 6 last turn, no capacity event, no cat4 finish or in flight +0, capability rose 2.0 −1 = 5
