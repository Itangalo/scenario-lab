...
- characters 376-1558: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1602-3569: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3625-4056: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4119-27268: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27623-28806: `{{event_history}}` from the run's own event record
...
- Turn 2 (11 turn(s) ago): emergent_kimi_crime_wave
- Turn 3 (10 turn(s) ago): knowledge_work_augmented
- Turn 4 (9 turn(s) ago): eval_anomaly_reports
- Turn 5 (8 turn(s) ago): cyber_major_incident, eval_anomaly_reports, medical_breakthrough, openweight_frontier_release, election_alliance
- Turn 6 (7 turn(s) ago): capability_jump, taiwan_blockade, opaque_reasoning, emergent_anti_datacentre_blockades
- Turn 7 (6 turn(s) ago): capability_jump, us_china_agreement, joint_threat_response
- Turn 8 (5 turn(s) ago): rsi_onset, medical_breakthrough, loss_of_control_incident, emergent_grid_stress_blackouts
- Turn 9 (4 turn(s) ago): ai_investment_collapse, safety_breakthrough, export_control_escalation
- Turn 10 (3 turn(s) ago): bio_uplift_findings, research_breakthrough, safety_breakthrough, catastrophic_great_power_conflict, eu_frontier_access_denied, supply_chain_coercion
- Turn 11 (2 turn(s) ago): capability_jump, bio_uplift_findings, research_breakthrough, medical_breakthrough, safety_breakthrough, us_labs_nationalised
- Turn 12 (1 turn(s) ago): research_breakthrough, member_state_defection, adoption_success
