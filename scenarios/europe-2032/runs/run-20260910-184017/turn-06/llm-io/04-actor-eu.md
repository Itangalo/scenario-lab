...
- characters 454-1797: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1840-4017: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5540-6005: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8530-11059: `{{previous_actions}}` from the actor's own response from the previous turn
