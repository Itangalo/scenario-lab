...
- characters 376-1719: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1762-3939: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3995-5142: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5205-31399: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31754-32104: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Displacement Transition Fund −2, EU Critical Dependency Patching and Recovery Reserve −2, priority −1 = −11
PROPOSAL BONUS: EU Critical Dependency Patching and Recovery Reserve (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly, plus openweight release raises blast radius
...
- `emergent_anti_datacentre_blockades` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated physical protests block two planned gigafactory / data-centre sites in France and Germany over power prices and jobs, forcing permitting delays and national debate.
- `emergent_anti_ai_siting_protests` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated protests by freelance journalists and junior white-collar workers in France and Germany block a data-centre permitting hearing, turning displacement anxiety into physical opposition to AI infrastructure.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, taiwan_tension_rise
- Turn 2 (4 turn(s) ago): emergent_kimi_crime_wave
- Turn 3 (3 turn(s) ago): knowledge_work_augmented
- Turn 4 (2 turn(s) ago): eval_anomaly_reports
- Turn 5 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, medical_breakthrough, openweight_frontier_release, election_alliance
