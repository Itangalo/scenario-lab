...
- characters 105-13056: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13099-13291: `{{metrics_json}}` from the run's live metric values
- characters 13384-14606: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14649-16767: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16823-17901: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | SME Fraud and Ransomware Triage | 2 |
...
- `emergent_medical_fraud_wave` -- first noted turn 1, listed in 2 turn(s) so far: Major European research hospitals publicly report a wave of AI-generated insurance fraud and forged referrals exploiting clinical workflows built on US frontier models, triggering a cross-border health-data integrity review.
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 50.5, "ai_safety": 30.0, "resilience": 37.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 32.0, "public_sentiment": 35.0}
```
...
## Notepad
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, SME Fraud and Ransomware Triage −2, priority −1 = −12
PROPOSAL BONUS: SME Fraud and Ransomware Triage (cat 6, small) +3 — emergent_kimi_crime_wave landed this turn with sharp attributable fraud/extortion and this answers it directly
LEGITIMACY LENDS: capital 30, sentiment 35 -> +2
