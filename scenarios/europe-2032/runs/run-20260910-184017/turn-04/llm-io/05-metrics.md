...
- characters 105-13456: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13499-13691: `{{metrics_json}}` from the run's live metric values
- characters 13784-14949: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14992-16673: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16729-17855: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Displacement Transition Fund | 2 |
| M6 | EU Evaluation and Assurance Cell | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, SME Fraud and Ransomware Triage −2, EU Displacement Transition Fund −2, priority −1 = −11
PROPOSAL BONUS: EU Displacement Transition Fund (cat 7, small) +2 — knowledge_work_augmented shows augmentation tipping to displacement and fraud distrust, this answers it directly but small and early
LEGITIMACY LENDS: capital 27, sentiment 33 -> +2
