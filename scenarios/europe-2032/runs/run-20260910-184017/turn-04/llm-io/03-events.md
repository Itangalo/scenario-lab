...
- characters 1584-3265: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3321-3839: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3902-29899: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30254-30418: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, taiwan_tension_rise
- Turn 2 (2 turn(s) ago): emergent_kimi_crime_wave
- Turn 3 (1 turn(s) ago): knowledge_work_augmented
