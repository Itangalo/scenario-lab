...
- characters 107-13408: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13451-13642: `{{metrics_json}}` from the run's live metric values
- characters 13735-14891: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14935-18010: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18066-18926: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Shielded Continuity and Certified Medical Uptake | 2 |
