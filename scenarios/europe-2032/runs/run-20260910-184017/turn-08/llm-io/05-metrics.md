...
- characters 13097-13288: `{{metrics_json}}` from the run's live metric values
- characters 13381-15017: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15060-17149: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17205-18055: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Upstream Leverage and Secure Compute Compact | 2 |
| M9 | EU Joint Threat Shield Accession | 2 |
| M10 | EU Containment and Lights-On Protocol | 2 |
