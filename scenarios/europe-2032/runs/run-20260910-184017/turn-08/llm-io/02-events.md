...
- characters 375-2011: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2054-4143: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4199-5334: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5397-30677: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31032-31580: `{{event_history}}` from the run's own event record
...
- `emergent_buildout_moratorium` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated strikes and sabotage halt construction at the remaining French/German gigafactory site and force a temporary EU-wide moratorium on new data-centre grid connections.
- `emergent_grid_stress_blackouts` -- first noted turn 7, listed in 1 turn(s) so far: A winter cold snap combined with datacentre load and constrained gas storage forces rolling power cuts in two member states, publicly blamed on AI power demand and hardening opposition to new sites.
...
- Turn 2 (6 turn(s) ago): emergent_kimi_crime_wave
- Turn 3 (5 turn(s) ago): knowledge_work_augmented
- Turn 4 (4 turn(s) ago): eval_anomaly_reports
- Turn 5 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, medical_breakthrough, openweight_frontier_release, election_alliance
- Turn 6 (2 turn(s) ago): capability_jump, taiwan_blockade, opaque_reasoning, emergent_anti_datacentre_blockades
- Turn 7 (1 turn(s) ago): capability_jump, us_china_agreement, joint_threat_response
