...
- characters 375-1735: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1778-4086: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4142-4976: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5039-28188: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28543-29634: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Shielded Continuity and Certified Medical Uptake −2, priority −1 = −3
PROPOSAL BONUS: EU Shielded Continuity and Certified Medical Uptake (cat 6, small) +3 — answers cutoff/nationalisation shock from last turn and bio uplift precursor this turn directly
LEGITIMACY LENDS: capital 30, sentiment 30 -> none — capital not below sentiment, no lend
SOVEREIGNTY: 11 last turn, no capacity finish +0, no cat4 in flight +0, us_labs_nationalised t11 −2, capability rose 2.5 −1 = 8

## Emerging developments (tracked)

- `emergent_distressed_compute_captured` -- first noted turn 10, listed in 2 turn(s) so far: Distressed AI power and cloud assets are bought at scale by non-European cash buyers who strip telemetry and safety retrofit obligations, permanently removing flexible load the EU counted on for curtailment.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, taiwan_tension_rise
- Turn 2 (10 turn(s) ago): emergent_kimi_crime_wave
- Turn 3 (9 turn(s) ago): knowledge_work_augmented
- Turn 4 (8 turn(s) ago): eval_anomaly_reports
- Turn 5 (7 turn(s) ago): cyber_major_incident, eval_anomaly_reports, medical_breakthrough, openweight_frontier_release, election_alliance
- Turn 6 (6 turn(s) ago): capability_jump, taiwan_blockade, opaque_reasoning, emergent_anti_datacentre_blockades
- Turn 7 (5 turn(s) ago): capability_jump, us_china_agreement, joint_threat_response
- Turn 8 (4 turn(s) ago): rsi_onset, medical_breakthrough, loss_of_control_incident, emergent_grid_stress_blackouts
- Turn 9 (3 turn(s) ago): ai_investment_collapse, safety_breakthrough, export_control_escalation
- Turn 10 (2 turn(s) ago): bio_uplift_findings, research_breakthrough, safety_breakthrough, catastrophic_great_power_conflict, eu_frontier_access_denied, supply_chain_coercion
- Turn 11 (1 turn(s) ago): capability_jump, bio_uplift_findings, research_breakthrough, medical_breakthrough, safety_breakthrough, us_labs_nationalised
