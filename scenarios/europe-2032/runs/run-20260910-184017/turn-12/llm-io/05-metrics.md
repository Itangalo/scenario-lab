...
- characters 13496-13686: `{{metrics_json}}` from the run's live metric values
- characters 13779-15139: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15182-17490: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17546-18042: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Certified Benefit Scale-Up and Anti-Carve-Out Enforcement | 2 |
...
## Metrics
```json
{"ai_capability": 92.0, "openweight_capability": 87.0, "ai_safety": 6.0, "resilience": 61.0, "eu_ai_sovereignty": 6.0, "eu_political_capital": 23.0, "public_sentiment": 31.0}
```
