...
- characters 376-2112: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2155-4539: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4595-5131: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5194-30351: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30706-31467: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): emergent_kimi_crime_wave
- Turn 3 (7 turn(s) ago): knowledge_work_augmented
- Turn 4 (6 turn(s) ago): eval_anomaly_reports
- Turn 5 (5 turn(s) ago): cyber_major_incident, eval_anomaly_reports, medical_breakthrough, openweight_frontier_release, election_alliance
- Turn 6 (4 turn(s) ago): capability_jump, taiwan_blockade, opaque_reasoning, emergent_anti_datacentre_blockades
- Turn 7 (3 turn(s) ago): capability_jump, us_china_agreement, joint_threat_response
- Turn 8 (2 turn(s) ago): rsi_onset, medical_breakthrough, loss_of_control_incident, emergent_grid_stress_blackouts
- Turn 9 (1 turn(s) ago): ai_investment_collapse, safety_breakthrough, export_control_escalation
