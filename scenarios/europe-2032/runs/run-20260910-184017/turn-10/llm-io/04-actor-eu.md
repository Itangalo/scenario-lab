...
- characters 454-2190: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2233-4617: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8445-8933: `{{statement_ledger}}` from the actor's live statement ledger
- characters 12111-14943: `{{previous_actions}}` from the actor's own response from the previous turn
