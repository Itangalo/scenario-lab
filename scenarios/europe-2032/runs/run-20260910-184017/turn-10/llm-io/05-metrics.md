...
- characters 106-13383: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13426-13617: `{{metrics_json}}` from the run's live metric values
- characters 13710-15446: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15489-17873: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17929-18803: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Wartime Continuity and Sovereign Fallback | 2 |
...
## Metrics
```json
{"ai_capability": 89.5, "openweight_capability": 83.6, "ai_safety": 15.0, "resilience": 52.0, "eu_ai_sovereignty": 11.0, "eu_political_capital": 24.0, "public_sentiment": 20.0}
```
