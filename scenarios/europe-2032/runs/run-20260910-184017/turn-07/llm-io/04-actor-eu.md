...
- characters 1602-3780: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5397-5914: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8655-11588: `{{previous_actions}}` from the actor's own response from the previous turn
