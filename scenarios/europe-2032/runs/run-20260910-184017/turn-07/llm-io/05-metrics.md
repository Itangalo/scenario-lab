...
- characters 13696-14799: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14843-17021: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17077-18193: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 78.0, "openweight_capability": 68.5, "ai_safety": 4.0, "resilience": 48.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 28.0, "public_sentiment": 30.0}
```
