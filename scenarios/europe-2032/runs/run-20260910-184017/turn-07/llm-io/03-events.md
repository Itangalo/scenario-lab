...
- characters 1524-3702: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3758-4291: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4354-29973: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30328-30791: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): emergent_kimi_crime_wave
- Turn 3 (4 turn(s) ago): knowledge_work_augmented
- Turn 4 (3 turn(s) ago): eval_anomaly_reports
- Turn 5 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, medical_breakthrough, openweight_frontier_release, election_alliance
- Turn 6 (1 turn(s) ago): capability_jump, taiwan_blockade, opaque_reasoning, emergent_anti_datacentre_blockades
