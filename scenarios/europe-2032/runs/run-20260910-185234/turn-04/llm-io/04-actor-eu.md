...
- characters 454-1321: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1364-3526: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5818-6271: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8381-10526: `{{previous_actions}}` from the actor's own response from the previous turn
