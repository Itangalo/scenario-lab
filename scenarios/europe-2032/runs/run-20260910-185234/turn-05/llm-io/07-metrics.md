...
- characters 106-13373: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13416-13608: `{{metrics_json}}` from the run's live metric values
- characters 13701-14741: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14785-16482: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16538-17601: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 57.0, "ai_safety": 19.0, "resilience": 46.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 9.0, "public_sentiment": 12.0}
```
