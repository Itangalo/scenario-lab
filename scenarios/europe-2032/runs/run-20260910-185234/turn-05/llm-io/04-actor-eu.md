...
- characters 455-1495: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1539-3236: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5909-6362: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8645-10604: `{{previous_actions}}` from the actor's own response from the previous turn
