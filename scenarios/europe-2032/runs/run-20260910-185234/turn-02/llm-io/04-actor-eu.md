...
- characters 454-1422: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1465-3260: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4941-5394: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6866-8975: `{{previous_actions}}` from the actor's own response from the previous turn
