...
- characters 105-13016: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13059-13251: `{{metrics_json}}` from the run's live metric values
- characters 13344-14312: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14355-16150: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16206-17205: `{{notepad}}` from the Game Master's notepad, carried across turns
