...
- characters 1387-3182: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3238-4237: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4300-28527: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28882-28942: `{{event_history}}` from the run's own event record
