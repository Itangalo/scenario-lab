...
- characters 1671-4078: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5232-5600: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8262-10334: `{{previous_actions}}` from the actor's own response from the previous turn
