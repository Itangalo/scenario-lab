...
- characters 1593-4000: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4056-4905: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4968-30075: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30430-31030: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): capability_jump, eval_anomaly_reports, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (4 turn(s) ago): loss_of_control_incident
- Turn 4 (3 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, openweight_frontier_release, labour_displacement
- Turn 5 (2 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, us_china_agreement, member_state_defection, election_consolidation
- Turn 6 (1 turn(s) ago): loss_of_control_incident, ai_investment_collapse, middle_power_coalition
