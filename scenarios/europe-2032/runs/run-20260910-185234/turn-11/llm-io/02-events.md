...
- characters 376-2945: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2989-5248: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5304-5666: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5729-31689: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32044-33062: `{{event_history}}` from the run's own event record
...
- Turn 2 (9 turn(s) ago): capability_jump, eval_anomaly_reports, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (8 turn(s) ago): loss_of_control_incident
- Turn 4 (7 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, openweight_frontier_release, labour_displacement
- Turn 5 (6 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, us_china_agreement, member_state_defection, election_consolidation
- Turn 6 (5 turn(s) ago): loss_of_control_incident, ai_investment_collapse, middle_power_coalition
- Turn 7 (4 turn(s) ago): capability_jump, openweight_frontier_release, safety_breakthrough
- Turn 8 (3 turn(s) ago): research_breakthrough, knowledge_work_augmented, embodied_ai_deployment, member_state_defection
- Turn 9 (2 turn(s) ago): safety_breakthrough, export_control_escalation
- Turn 10 (1 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, adoption_success, emergent_municipal_insurance_retreat
