...
- characters 107-13241: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13284-13474: `{{metrics_json}}` from the run's live metric values
- characters 13567-16136: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16180-18439: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18495-19494: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t10: EU Assured Systems Adoption Patch −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 9 -> +0, capped below sentiment but no rule term applied after charge/finish/events = 1 final
SOVEREIGNTY: 13 last turn, no capacity event, no cat4 in flight +0, capability rose 1.0 −0 = 13
...
## Metrics
```json
{"ai_capability": 67.0, "openweight_capability": 64.5, "ai_safety": 19.5, "resilience": 42.5, "eu_ai_sovereignty": 11.0, "eu_political_capital": 2.0, "public_sentiment": 7.0}
```
## Narrative
### Holding the islands
