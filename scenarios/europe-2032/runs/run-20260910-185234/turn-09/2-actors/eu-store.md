...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Assured Systems Adoption Patch", "category": 5, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "ai_safety up materially, resilience up slightly via certified deployed systems"}, "grounds": "deployable safety breakthrough adopted with labs wanting it"}
  - Grounds: deployable safety breakthrough adopted with labs wanting it
