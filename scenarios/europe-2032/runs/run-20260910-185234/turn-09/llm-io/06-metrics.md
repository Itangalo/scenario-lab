...
- characters 106-12977: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13020-13210: `{{metrics_json}}` from the run's live metric values
- characters 13303-15236: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15280-17510: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17566-18575: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 65.0, "openweight_capability": 62.2, "ai_safety": 23.0, "resilience": 45.0, "eu_ai_sovereignty": 13.0, "eu_political_capital": 3.0, "public_sentiment": 10.0}
```
