...
- characters 375-2308: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2352-4582: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4638-5647: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5710-30817: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31172-31986: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Shop-Floor and Office Transition Fund −2, priority −1 = −2
PROPOSAL BONUS: none — knowledge-work augmentation removes displacement crisis to point at, Union asked to spend against problem public cannot feel
LEGITIMACY LENDS: capital 8, sentiment 8 -> none, capital not lower
SOVEREIGNTY: 17 last turn, no cat4 finish, no build in flight +0, member_state_defection t8 −2, capability rose 1.0 −0 = 15

## Emerging developments (tracked)

- `emergent_local_siting_freeze` -- first noted turn 8, listed in 1 turn(s) so far: Coordinated municipal bans on data-centre expansion spread across several member states after DIY intrusion-kit coverage, freezing permitted sites regardless of EU planning status.
- `emergent_municipal_insurance_retreat` -- first noted turn 8, listed in 1 turn(s) so far: Municipal insurers across several member states jointly refuse to underwrite AI-operated grid and port control systems after the January logistics incident, forcing emergency state guarantees.
...
- Turn 2 (7 turn(s) ago): capability_jump, eval_anomaly_reports, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (6 turn(s) ago): loss_of_control_incident
- Turn 4 (5 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, openweight_frontier_release, labour_displacement
- Turn 5 (4 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, us_china_agreement, member_state_defection, election_consolidation
- Turn 6 (3 turn(s) ago): loss_of_control_incident, ai_investment_collapse, middle_power_coalition
- Turn 7 (2 turn(s) ago): capability_jump, openweight_frontier_release, safety_breakthrough
- Turn 8 (1 turn(s) ago): research_breakthrough, knowledge_work_augmented, embodied_ai_deployment, member_state_defection
