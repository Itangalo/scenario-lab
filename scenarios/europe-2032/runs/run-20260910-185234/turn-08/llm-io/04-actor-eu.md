...
- characters 452-1801: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1844-3742: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7467-7835: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10523-12677: `{{previous_actions}}` from the actor's own response from the previous turn
