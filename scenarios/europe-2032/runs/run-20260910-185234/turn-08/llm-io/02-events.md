...
- characters 374-1723: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1766-3664: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3720-4224: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4287-29394: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29749-30441: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: Middle-Power Compute and Verification Pact −2, EU Assured Deployment Retrofit −2, priority −1 = −5
PROPOSAL BONUS: EU Assured Deployment Retrofit (cat 6, small) +3 — January rogue-agent crisis plus verifiable-domains jump and near-frontier open release landed last two turns and this answers them directly
LEGITIMACY LENDS: capital 9, sentiment 6 -> none, capital higher
SOVEREIGNTY: 14 last turn, InvestAI Gigafactories finishes t7 +3, no capacity event, capability rose 1.0 −0 = 17
...
- Turn 2 (6 turn(s) ago): capability_jump, eval_anomaly_reports, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (5 turn(s) ago): loss_of_control_incident
- Turn 4 (4 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, openweight_frontier_release, labour_displacement
- Turn 5 (3 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, us_china_agreement, member_state_defection, election_consolidation
- Turn 6 (2 turn(s) ago): loss_of_control_incident, ai_investment_collapse, middle_power_coalition
- Turn 7 (1 turn(s) ago): capability_jump, openweight_frontier_release, safety_breakthrough
