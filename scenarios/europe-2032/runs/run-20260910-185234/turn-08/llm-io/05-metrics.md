...
- characters 13560-13750: `{{metrics_json}}` from the run's live metric values
- characters 13843-15192: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15235-17133: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17189-18280: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Shop-Floor and Office Transition Fund | 2 |
...
## Metrics
```json
{"ai_capability": 64.0, "openweight_capability": 60.5, "ai_safety": 17.0, "resilience": 46.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 8.0, "public_sentiment": 8.0}
```
