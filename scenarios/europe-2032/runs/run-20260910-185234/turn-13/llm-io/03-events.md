...
- characters 375-1388: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1432-3893: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3949-4851: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4914-30874: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31229-32509: `{{event_history}}` from the run's own event record
...
- `emergent_buildout_blockade` -- first noted turn 11, listed in 2 turn(s) so far: Coordinated physical blockades of data-centre extension sites in three member states force contractors to suspend works for weeks, turning local opposition into a cross-border anti-build movement.
...
- Turn 2 (11 turn(s) ago): capability_jump, eval_anomaly_reports, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (10 turn(s) ago): loss_of_control_incident
- Turn 4 (9 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, openweight_frontier_release, labour_displacement
- Turn 5 (8 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, us_china_agreement, member_state_defection, election_consolidation
- Turn 6 (7 turn(s) ago): loss_of_control_incident, ai_investment_collapse, middle_power_coalition
- Turn 7 (6 turn(s) ago): capability_jump, openweight_frontier_release, safety_breakthrough
- Turn 8 (5 turn(s) ago): research_breakthrough, knowledge_work_augmented, embodied_ai_deployment, member_state_defection
- Turn 9 (4 turn(s) ago): safety_breakthrough, export_control_escalation
- Turn 10 (3 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, adoption_success, emergent_municipal_insurance_retreat
- Turn 11 (2 turn(s) ago): openweight_frontier_release, labour_displacement, embodied_ai_deployment
- Turn 12 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, eu_frontier_access_denied, emergent_certified_liability_pool
