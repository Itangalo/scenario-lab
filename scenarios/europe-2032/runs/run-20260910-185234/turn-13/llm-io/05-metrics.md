...
- characters 13248-14261: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14305-16766: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16822-17407: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t13: Certified Liability Pool Anchor −2, priority −0 (capital below 20, no effect/no cost) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 2.0 -> +1, capped below sentiment = 1 final
SOVEREIGNTY: 8 last turn, no capacity event, no cat4 in flight +0, capability rose 1.0 −0 = 8
## Store changes
```json
{"store": []}
```
