...
- characters 454-2672: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2715-4985: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6745-7121: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10349-12820: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Assured Systems Adoption Patch | 5 | small | 9 | 11 | own jurisdiction | ai_safety up materially, resilience up slightly via certified deployed systems | 2 | running |
