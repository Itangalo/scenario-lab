...
- characters 376-2594: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2637-4907: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4963-6090: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6153-32113: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32468-33355: `{{event_history}}` from the run's own event record
...
- `emergent_local_siting_freeze` -- first noted turn 8, listed in 2 turn(s) so far: Coordinated municipal bans on data-centre expansion spread across several member states after DIY intrusion-kit coverage, freezing permitted sites regardless of EU planning status.
- `emergent_municipal_insurance_retreat` -- first noted turn 8, listed in 2 turn(s) so far: Municipal insurers across several member states jointly refuse to underwrite AI-operated grid and port control systems after the January logistics incident, forcing emergency state guarantees.
...
- Turn 2 (8 turn(s) ago): capability_jump, eval_anomaly_reports, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (7 turn(s) ago): loss_of_control_incident
- Turn 4 (6 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, openweight_frontier_release, labour_displacement
- Turn 5 (5 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, us_china_agreement, member_state_defection, election_consolidation
- Turn 6 (4 turn(s) ago): loss_of_control_incident, ai_investment_collapse, middle_power_coalition
- Turn 7 (3 turn(s) ago): capability_jump, openweight_frontier_release, safety_breakthrough
- Turn 8 (2 turn(s) ago): research_breakthrough, knowledge_work_augmented, embodied_ai_deployment, member_state_defection
- Turn 9 (1 turn(s) ago): safety_breakthrough, export_control_escalation
