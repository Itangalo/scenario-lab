...
- characters 377-1653: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1697-3971: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4027-5110: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5173-29400: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29755-29927: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, Grid and Port Cyber Shield −3, EU Continuity Stack −2, priority −1 = −12
PROPOSAL BONUS: EU Continuity Stack (cat 9, small) +3 — frontier access denial landed this turn on hospitals/ministries and this answers it directly
LEGITIMACY LENDS: capital 23, sentiment 27 -> +2
SOVEREIGNTY: 23 last turn, no capacity event? actually eu_frontier_access_denied t2 −2, Gigafactories in flight +0, capability rose 2.0 −1 = 20

## Emerging developments (tracked)

- `emergent_china_open_industrial_release` -- first noted turn 1, listed in 2 turn(s) so far: A Chinese laboratory releases an open-weight model near the Mythos class with tool-use scaffolding optimized for industrial control protocols, accelerating proliferation of offensive cyber tooling beyond the Kimi K3 baseline.
- `emergent_open_model_hosting_backlash` -- first noted turn 1, listed in 2 turn(s) so far: European press investigation traces Kimi K3-derived cyber tooling to EU-hosted compute, triggering calls for domestic hosting liability rules.
...
- Turn 2 (1 turn(s) ago): capability_jump, eval_anomaly_reports, taiwan_tension_rise, eu_frontier_access_denied
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.28}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.25}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.15}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.15}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "A Chinese laboratory releases an open-weight model near the Mythos class with tool-use scaffolding optimized for industrial control protocols, accelerating proliferation of offensive cyber tooling beyond the Kimi K3 baseline.", "emergent": true, "id": "emergent_china_open_industrial_release", "probability": 0.19}, {"description": "European press investigation traces Kimi K3-derived cyber tooling to EU-hosted compute, triggering calls for domestic hosting liability rules.", "emergent": true, "id": "emergent_open_model_hosting_backlash", "probability": 0.14}]
```
