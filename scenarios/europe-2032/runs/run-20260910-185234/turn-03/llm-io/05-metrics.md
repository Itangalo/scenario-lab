...
- characters 106-13416: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13459-13651: `{{metrics_json}}` from the run's live metric values
- characters 13744-15020: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15064-17338: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17394-17885: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Loss-of-Control Containment Protocol | 2 |
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 53.0, "ai_safety": 21.0, "resilience": 40.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 18.0, "public_sentiment": 21.0}
```
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Continuity Stack −2, EU Loss-of-Control Containment Protocol −2, priority −1 = −11
PROPOSAL BONUS: EU Loss-of-Control Containment Protocol (cat 6, small) +3 — loss-of-control incident with days-long containment uncertainty landed this turn and this answers it directly
