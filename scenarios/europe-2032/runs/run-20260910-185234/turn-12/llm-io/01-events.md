...
- characters 375-1348: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1391-3543: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3599-4601: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4664-30624: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30979-32098: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: no measures in flight −0 = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2, sentiment 7 -> +0, capped below sentiment but no rule term applied after charge/finish/events = 2 final
SOVEREIGNTY: 13 last turn, no cat4 finish, no cat4 in flight +0, embodied_ai_deployment t11 −2, capability rose 1.0 −0 = 11

## Emerging developments (tracked)

- `emergent_certified_liability_pool` -- first noted turn 11, listed in 1 turn(s) so far: Several large EU insurers jointly launch a certified-AI liability pool offering discounted cover only where Seville-kit telemetry and incident reporting are in place, creating a de-facto private standard for insurable automation.
- `emergent_buildout_blockade` -- first noted turn 11, listed in 1 turn(s) so far: Coordinated physical blockades of data-centre extension sites in three member states force contractors to suspend works for weeks, turning local opposition into a cross-border anti-build movement.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, eu_access_secured
- Turn 2 (10 turn(s) ago): capability_jump, eval_anomaly_reports, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (9 turn(s) ago): loss_of_control_incident
- Turn 4 (8 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, openweight_frontier_release, labour_displacement
- Turn 5 (7 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, us_china_agreement, member_state_defection, election_consolidation
- Turn 6 (6 turn(s) ago): loss_of_control_incident, ai_investment_collapse, middle_power_coalition
- Turn 7 (5 turn(s) ago): capability_jump, openweight_frontier_release, safety_breakthrough
- Turn 8 (4 turn(s) ago): research_breakthrough, knowledge_work_augmented, embodied_ai_deployment, member_state_defection
- Turn 9 (3 turn(s) ago): safety_breakthrough, export_control_escalation
- Turn 10 (2 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, adoption_success, emergent_municipal_insurance_retreat
- Turn 11 (1 turn(s) ago): openweight_frontier_release, labour_displacement, embodied_ai_deployment
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.36}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.25}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.05}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.16}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.18}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.08}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.05}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.11}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.14}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.05}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "Several large EU insurers jointly launch a certified-AI liability pool offering discounted cover only where Seville-kit telemetry and incident reporting are in place, creating a de-facto private standard for insurable automation.", "emergent": true, "id": "emergent_certified_liability_pool", "probability": 0.18}, {"description": "Coordinated physical blockades of data-centre extension sites in three member states force contractors to suspend works for weeks, turning local opposition into a cross-border anti-build movement.", "emergent": true, "id": "emergent_buildout_blockade", "probability": 0.22}]
```
