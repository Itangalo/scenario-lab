...
- characters 106-12922: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12965-13155: `{{metrics_json}}` from the run's live metric values
- characters 13248-14221: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14264-16416: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16472-17154: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | Certified Liability Pool Anchor | 2 |
