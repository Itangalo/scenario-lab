...
- characters 453-1406: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1449-3335: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4778-5146: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7615-10732: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Verification Bridge | 8 | small | 5 | 7 | own jurisdiction | ai_safety up materially, resilience up, eu_political_capital up slightly via inside-deal leverage | 2 | running |
