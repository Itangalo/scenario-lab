...
- characters 375-1328: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1371-3257: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3313-4414: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4477-29575: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29930-30431: `{{event_history}}` from the run's own event record
...
- `emergent_datacentre_backlash_blockade` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated protests block permitting and construction at two planned EU compute sites, citing power costs and distrust after the logistics-agent scandal, delaying domestic capacity expansion by months.
- `emergent_municipal_provider_collapse` -- first noted turn 5, listed in 1 turn(s) so far: Several small municipal IT providers hit by the winter ransomware wave face insolvency or contract withdrawal, forcing emergency state takeover of local registries and backups.
...
- Turn 2 (4 turn(s) ago): capability_jump, eval_anomaly_reports, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (3 turn(s) ago): loss_of_control_incident
- Turn 4 (2 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, openweight_frontier_release, labour_displacement
- Turn 5 (1 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, us_china_agreement, member_state_defection, election_consolidation
