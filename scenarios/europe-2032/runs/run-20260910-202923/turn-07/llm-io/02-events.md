...
- characters 377-2956: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3000-5388: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5444-5849: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5912-30192: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30547-31035: `{{event_history}}` from the run's own event record
...
- Turn 3 (4 turn(s) ago): bio_incident, loss_of_control_incident
- Turn 4 (3 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 5 (2 turn(s) ago): eval_anomaly_reports, loss_of_control_incident, election_retrenchment
- Turn 6 (1 turn(s) ago): loss_of_control_incident, adoption_success
