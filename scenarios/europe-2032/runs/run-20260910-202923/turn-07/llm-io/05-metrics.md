...
- characters 106-13244: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13287-13479: `{{metrics_json}}` from the run's live metric values
- characters 13572-16151: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16195-18583: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18639-19044: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | EU Displaced-Worker Guarantee and Retraining Pact | 2 |
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 59.1, "ai_safety": 31.0, "resilience": 42.0, "eu_ai_sovereignty": 25.0, "eu_political_capital": 16.0, "public_sentiment": 17.0}
```
