...
- characters 455-2101: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2145-4622: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6691-7151: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9403-11574: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Certified Assurance Deployment | 5 | small | 4 | 6 | own jurisdiction | ai_safety up substantially, public_sentiment stabilised | 2 | running |
