...
- characters 13676-15322: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15366-17843: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17899-19116: `{{notepad}}` from the Game Master's notepad, carried across turns
