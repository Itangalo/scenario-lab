...
- characters 376-1267: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1310-3507: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3563-4078: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4141-28421: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28776-29313: `{{event_history}}` from the run's own event record
...
- Turn 3 (5 turn(s) ago): bio_incident, loss_of_control_incident
- Turn 4 (4 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 5 (3 turn(s) ago): eval_anomaly_reports, loss_of_control_incident, election_retrenchment
- Turn 6 (2 turn(s) ago): loss_of_control_incident, adoption_success
- Turn 7 (1 turn(s) ago): embodied_ai_deployment
