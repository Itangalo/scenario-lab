...
- characters 105-13209: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13252-13444: `{{metrics_json}}` from the run's live metric values
- characters 13537-14428: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14471-16668: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16724-17239: `{{notepad}}` from the Game Master's notepad, carried across turns
