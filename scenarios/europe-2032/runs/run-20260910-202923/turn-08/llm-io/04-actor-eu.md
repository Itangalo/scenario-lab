...
- characters 454-1345: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1388-3585: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3653-4103: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6688-8659: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Displaced-Worker Guarantee and Retraining Pact | 7 | small | 7 | 10 | own jurisdiction | public_sentiment up moderately, resilience up moderately | 2 | running |
...
```
## New measure
None this turn, while we let political capital recover and the gigafactory capacity reach operational use before staking a new instrument.

## Store changes
No changes.

## Priority
M8 EU Displaced-Worker Guarantee and Retraining Pact, because with sentiment at 17 and capital at 16 only funded livelihood security can keep the trust-rebuilding commitment alive now that certified clinics alone have plateaued.

## In practice
We keep health and interior ministers fronting the finished Trusted Public Services Rollout as proof: DG DIGIT and the AI Office replicate passing hospital and municipal audits with EU4Health and Digital Europe money, publishing district queue figures to blunt blockades and moratorium parties.

We push M8 via DG EMPL and EPSCO Council under ESF+ with a SURE-type backstop: qualifying automating employers co-fund wage insurance, public employment services fast-track retraining tied to certified sectors on Articles 153/175. The joint cell freeze and 24h reporting in power, transport, hospitals and finance stay enforced under NIS2/CER and AI Act Art.73 while grid clearance and staffing for the fitted gigafactory halls are shepherded to operational use.
