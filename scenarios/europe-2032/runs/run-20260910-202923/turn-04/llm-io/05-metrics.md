...
- characters 105-12999: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13042-13234: `{{metrics_json}}` from the run's live metric values
- characters 13327-14701: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14744-16829: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16885-18062: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Incident Registry and Deployment Audit | 2 |
| M5 | EU Bio-Detection and Agent Containment Surge | 2 |
| M6 | EU Certified Assurance Deployment | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Incident Registry and Deployment Audit −2, EU Bio-Detection and Agent Containment Surge −2, priority −1 = −11
PROPOSAL BONUS: EU Bio-Detection and Agent Containment Surge (cat 6, small) +4 — bio_incident and loss_of_control_incident both fired this turn with casualties and days-long containment, this answers both directly
...
- `emergent_anti_infrastructure_sabotage` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated physical blockades and sabotage attempts against data-centre construction sites and grid interconnects across several member states, forcing temporary site closures.
- `emergent_datacentre_sabotage_wave` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated physical sabotage campaign hits multiple EU data-centre construction sites and grid interconnects, with arson and equipment damage claimed by anti-AI groups, forcing temporary construction halts.
