...
- characters 12875-13067: `{{metrics_json}}` from the run's live metric values
- characters 13160-14141: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14185-16348: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16404-16694: `{{notepad}}` from the Game Master's notepad, carried across turns
