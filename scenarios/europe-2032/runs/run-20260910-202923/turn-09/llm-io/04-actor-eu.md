...
- characters 455-1436: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1480-3643: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4621-5071: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7656-8857: `{{previous_actions}}` from the actor's own response from the previous turn
