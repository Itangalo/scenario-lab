...
- characters 377-1358: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1402-3565: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3621-3911: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3974-28254: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28609-29146: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Displaced-Worker Guarantee and Retraining Pact −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 16, sentiment 21 -> +2
SOVEREIGNTY: 23 last turn, no capacity event, no cat4 in flight, capability rose 0.5 −0 = 23
...
- Turn 3 (6 turn(s) ago): bio_incident, loss_of_control_incident
- Turn 4 (5 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 5 (4 turn(s) ago): eval_anomaly_reports, loss_of_control_incident, election_retrenchment
- Turn 6 (3 turn(s) ago): loss_of_control_incident, adoption_success
- Turn 7 (2 turn(s) ago): embodied_ai_deployment
