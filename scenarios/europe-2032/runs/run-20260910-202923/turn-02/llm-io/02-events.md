...
- characters 1378-3904: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3960-5076: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- characters 28776-28866: `{{event_history}}` from the run's own event record
