...
- characters 378-3088: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3132-5213: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5269-5921: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5984-30206: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30561-31485: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M10 EU Loss-of-Control Containment and Joint Cyber Defence Accession −2, priority −1 void (capital below 20, priority has no effect) = −2
...
- `emergent_anti_ai_direct_action` -- first noted turn 11, listed in 2 turn(s) so far: Coordinated physical blockades of data-centre construction and municipal AI deployments across several member states force temporary site closures.
...
- Turn 3 (10 turn(s) ago): bio_incident, loss_of_control_incident
- Turn 4 (9 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 5 (8 turn(s) ago): eval_anomaly_reports, loss_of_control_incident, election_retrenchment
- Turn 6 (7 turn(s) ago): loss_of_control_incident, adoption_success
- Turn 7 (6 turn(s) ago): embodied_ai_deployment
- Turn 9 (4 turn(s) ago): ai_investment_collapse, export_control_escalation, emergent_clinic_audit_copycat
- Turn 10 (3 turn(s) ago): cyber_major_incident, knowledge_work_augmented
- Turn 11 (2 turn(s) ago): loss_of_control_incident, safety_breakthrough, knowledge_work_augmented, joint_threat_response
