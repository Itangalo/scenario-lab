...
- characters 107-13237: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13280-13472: `{{metrics_json}}` from the run's live metric values
- characters 13565-16275: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16319-18400: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18456-18836: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Site Truce and Community Benefit Compact | 2 |
...
## Metrics
```json
{"ai_capability": 64.0, "openweight_capability": 63.0, "ai_safety": 26.0, "resilience": 46.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 17.0, "public_sentiment": 16.0}
```
## Narrative
...
## Notepad
PORTFOLIO CHARGE t13: M11 EU Site Truce and Community Benefit Compact −2, priority −1 void (capital below 20, priority has no effect) = −2
PROPOSAL BONUS: EU Site Truce and Community Benefit Compact (cat 9, small) +2 — emergent_anti_ai_direct_action fired this turn closing sites and this answers it directly
LEGITIMACY LENDS: capital 16, sentiment 16 -> none — capital not lower
SOVEREIGNTY: 21 last turn, no capacity event, no cat4 in flight +0, capability rose 0.5 −0 = 21
## Store changes
```json
{"store": []}
