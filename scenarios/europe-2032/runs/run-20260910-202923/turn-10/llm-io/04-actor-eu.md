...
- characters 1480-3505: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4557-5017: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7451-8978: `{{previous_actions}}` from the actor's own response from the previous turn
