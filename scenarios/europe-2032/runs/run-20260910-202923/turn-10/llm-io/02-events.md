...
- characters 1402-3427: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3483-3891: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3954-28176: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28531-29175: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M8 EU Displaced-Worker Guarantee and Retraining Pact −2, priority −1 = −2 — capital below 20 so priority has no effect and no cost, measures only
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 11, sentiment 20 -> +2
SOVEREIGNTY: 23 last turn, no capacity event finish, no cat4 in flight +0, export_control_escalation t9 −2, capability rose 0.5 −0 = 21
...
- Turn 2 (8 turn(s) ago): cyber_major_incident, knowledge_work_augmented, automated_decision_scandal
- Turn 3 (7 turn(s) ago): bio_incident, loss_of_control_incident
- Turn 4 (6 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 5 (5 turn(s) ago): eval_anomaly_reports, loss_of_control_incident, election_retrenchment
- Turn 6 (4 turn(s) ago): loss_of_control_incident, adoption_success
- Turn 7 (3 turn(s) ago): embodied_ai_deployment
- Turn 9 (1 turn(s) ago): ai_investment_collapse, export_control_escalation, emergent_clinic_audit_copycat
