...
- characters 13563-14545: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14588-16613: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16669-17077: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 62.5, "openweight_capability": 61.3, "ai_safety": 25.0, "resilience": 36.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 17.0, "public_sentiment": 18.0}
```
