...
- characters 378-1306: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1350-3319: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3375-3844: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3907-28129: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28484-29203: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M9 EU Essential Services Continuity and Rapid Recovery Pact -2, priority -1 = -3 — capital below 20 so priority has no effect and no cost, measures only = -2
PROPOSAL BONUS: none — continuity pact already in flight as M9, no distinct new measure answering last-three-turn shock
LEGITIMACY LENDS: capital 17, sentiment 18 -> +1 — capped below sentiment
...
- Turn 2 (9 turn(s) ago): cyber_major_incident, knowledge_work_augmented, automated_decision_scandal
- Turn 3 (8 turn(s) ago): bio_incident, loss_of_control_incident
- Turn 4 (7 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 5 (6 turn(s) ago): eval_anomaly_reports, loss_of_control_incident, election_retrenchment
- Turn 6 (5 turn(s) ago): loss_of_control_incident, adoption_success
- Turn 7 (4 turn(s) ago): embodied_ai_deployment
- Turn 9 (2 turn(s) ago): ai_investment_collapse, export_control_escalation, emergent_clinic_audit_copycat
- Turn 10 (1 turn(s) ago): cyber_major_incident, knowledge_work_augmented
