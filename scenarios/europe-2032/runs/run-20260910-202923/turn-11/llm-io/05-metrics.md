...
- characters 107-12921: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12964-13156: `{{metrics_json}}` from the run's live metric values
- characters 13249-14177: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14221-16190: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16246-16987: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Essential Services Continuity and Rapid Recovery Pact | 2 |
| M10 | EU Loss-of-Control Containment and Joint Cyber Defence Accession | 2 |
...
- `emergent_anti_ai_direct_action` -- first noted turn 11, listed in 1 turn(s) so far: Coordinated physical blockades of data-centre construction and municipal AI deployments across several member states force temporary site closures.
