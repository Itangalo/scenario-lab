...
- characters 376-2576: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2619-4857: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4913-5906: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5969-27139: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27494-27913: `{{event_history}}` from the run's own event record
...
- `emergent_anti_infrastructure_sabotage` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated physical blockades and sabotage attempts against data-centre construction sites and grid interconnects across several member states, forcing temporary site closures.
- `emergent_datacentre_sabotage_wave` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated physical sabotage campaign hits multiple EU data-centre construction sites and grid interconnects, with arson and equipment damage claimed by anti-AI groups, forcing temporary construction halts.
...
- Turn 2 (4 turn(s) ago): cyber_major_incident, knowledge_work_augmented, automated_decision_scandal
- Turn 3 (3 turn(s) ago): bio_incident, loss_of_control_incident
- Turn 4 (2 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 5 (1 turn(s) ago): eval_anomaly_reports, loss_of_control_incident, election_retrenchment
