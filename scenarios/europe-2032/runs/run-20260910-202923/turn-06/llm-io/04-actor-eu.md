...
- characters 454-2654: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2697-4935: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5906-6356: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8610-10493: `{{previous_actions}}` from the actor's own response from the previous turn
