...
- characters 13914-16114: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16157-18395: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18451-18839: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Trusted Public Services Rollout | 2 |
...
## Metrics
```json
{"ai_capability": 60.5, "openweight_capability": 57.8, "ai_safety": 33.0, "resilience": 43.0, "eu_ai_sovereignty": 28.0, "eu_political_capital": 17.0, "public_sentiment": 15.0}
```
## Narrative
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "RETRENCHMENT"}, "grounds": "turn 5 elected retrenchment administration takes office turn 6"}]}
```
```
