...
- characters 106-13252: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13295-13487: `{{metrics_json}}` from the run's live metric values
- characters 13580-15263: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15306-17513: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17569-18459: `{{notepad}}` from the Game Master's notepad, carried across turns
