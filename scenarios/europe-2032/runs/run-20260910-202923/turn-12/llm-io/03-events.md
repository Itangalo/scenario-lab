...
- characters 2103-4310: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4366-5256: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5319-29541: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29896-30738: `{{event_history}}` from the run's own event record
...
- Turn 3 (9 turn(s) ago): bio_incident, loss_of_control_incident
- Turn 4 (8 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 5 (7 turn(s) ago): eval_anomaly_reports, loss_of_control_incident, election_retrenchment
- Turn 6 (6 turn(s) ago): loss_of_control_incident, adoption_success
- Turn 7 (5 turn(s) ago): embodied_ai_deployment
- Turn 9 (3 turn(s) ago): ai_investment_collapse, export_control_escalation, emergent_clinic_audit_copycat
- Turn 10 (2 turn(s) ago): cyber_major_incident, knowledge_work_augmented
- Turn 11 (1 turn(s) ago): loss_of_control_incident, safety_breakthrough, knowledge_work_augmented, joint_threat_response
