...
- `two_year_commitment` (commitment): Hold insurable continuity while deploying EU-controlled cyber defence to restore essential services

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold insurable continuity while deploying EU-controlled cyber defence to restore essential services
