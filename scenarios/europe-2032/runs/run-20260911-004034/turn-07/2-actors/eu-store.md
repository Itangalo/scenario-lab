...
| M9 | EU Bio-Emergency Containment and Continuity Regime | 6 | large | 7 | 9 | own jurisdiction | resilience up strongly, ai_safety protected, public_sentiment protected | 3 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio-Emergency Containment and Continuity Regime", "category": 6, "size": "large", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up strongly, ai_safety protected, public_sentiment protected"}, "grounds": "to contain AI-enabled pandemic and keep essential services running"}
  - Grounds: to contain AI-enabled pandemic and keep essential services running
