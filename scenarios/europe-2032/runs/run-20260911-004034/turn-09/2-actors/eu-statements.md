...
- `two_year_commitment` (commitment): Rebuild European resilience and bargaining power for living with superhuman AI

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild European resilience and bargaining power for living with superhuman AI
