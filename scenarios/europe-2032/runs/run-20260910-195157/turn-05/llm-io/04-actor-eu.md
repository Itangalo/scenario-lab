...
- characters 1785-3928: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5141-5600: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7877-9894: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Anomaly Triage and Hold Protocol | 1 | small | 4 | 6 | own jurisdiction | ai_safety up moderately, resilience up slightly | 2 | running |
