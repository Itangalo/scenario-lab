...
- characters 106-13591: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13634-13826: `{{metrics_json}}` from the run's live metric values
- characters 13919-15205: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15249-17392: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17448-18297: `{{notepad}}` from the Game Master's notepad, carried across turns
