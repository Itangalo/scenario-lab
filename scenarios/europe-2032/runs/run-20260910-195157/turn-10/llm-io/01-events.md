...
- characters 377-1430: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1473-3771: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3827-4238: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4301-29589: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29944-30796: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Defence Breakthrough Surge −2, priority −1 = −3
PROPOSAL BONUS: EU Defence Breakthrough Surge (cat 6, small) +2 — winter ransomware sweep and January automated wave in last three turns, this answers it directly with breakthrough tooling
LEGITIMACY LENDS: capital 17, sentiment 27 -> +2
SOVEREIGNTY: 30 last turn, no capacity event, no category 4 in flight +0, capability rose 0.7 −0 = 30
...
- Turn 3 (7 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, knowledge_work_augmented, emergent_sovereign_hosting_offer
- Turn 4 (6 turn(s) ago): eval_anomaly_reports
- Turn 5 (5 turn(s) ago): adoption_success, election_alliance
- Turn 6 (4 turn(s) ago): loss_of_control_incident, capability_jump, eval_anomaly_reports, emergent_triage_bypass_exposure
- Turn 7 (3 turn(s) ago): cyber_major_incident, taiwan_blockade, cyber_defence_breakthrough, embodied_ai_deployment, taiwan_tension_rise
- Turn 8 (2 turn(s) ago): cyber_major_incident, capability_jump, member_state_defection, adoption_success
- Turn 9 (1 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, safety_breakthrough, us_china_agreement
