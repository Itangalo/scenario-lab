...
- characters 455-1508: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1551-3849: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4719-5364: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8184-10393: `{{previous_actions}}` from the actor's own response from the previous turn
