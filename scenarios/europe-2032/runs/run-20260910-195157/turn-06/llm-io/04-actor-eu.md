...
- characters 454-1789: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1832-3860: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5732-6383: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8845-11779: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Public Benefit AI Scale-Up | 9 | small | 5 | 7 | own jurisdiction | public_sentiment up moderately, eu_political_capital up slightly, resilience up slightly | 2 | running |
