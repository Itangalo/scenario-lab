...
- characters 13846-15181: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15224-17252: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17308-17807: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Public Benefit AI Scale-Up | 2 |
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Anomaly Triage and Hold Protocol −2, EU Public Benefit AI Scale-Up −2, priority −1 = −11
PROPOSAL BONUS: none — new EU Public Benefit AI Scale-Up (cat 9, small) scales adoption_success, a positive event, not a negative shock from last three turns
LEGITIMACY LENDS: capital 15, sentiment 42 -> +2
SOVEREIGNTY: 20 last turn, EU Ring-Fenced Continuity Hosting finishes t5 +4, no capacity event, capability rose 1.0 −0 = 24
...
**emergent_triage_bypass_exposure (emergent event):** Independent grid audit finds the EU triage desk's frozen agent rollouts were bypassed via vendor remote-update channels, leaving municipal utilities exposed without triggering reporting obligations.
...
## Notepad
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, EU Public Benefit AI Scale-Up −2, priority −1 = −6
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 12, sentiment 38 -> +2
SOVEREIGNTY: 24 last turn, Tech sovereignty package finishes t6 +4, Gigafactories in flight +0, no capacity event, capability rose 1.0 −0 = 28
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "ALLIANCE"}, "grounds": "turn 5 election won on structured allied access; posture takes effect turn 6"}]}
```
```
