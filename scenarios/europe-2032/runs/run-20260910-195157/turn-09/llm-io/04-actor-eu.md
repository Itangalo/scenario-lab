...
- characters 455-1366: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1410-3476: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5787-6438: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9096-11093: `{{previous_actions}}` from the actor's own response from the previous turn
