...
- characters 1609-3661: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3717-4864: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4927-29154: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29509-29550: `{{event_history}}` from the run's own event record
