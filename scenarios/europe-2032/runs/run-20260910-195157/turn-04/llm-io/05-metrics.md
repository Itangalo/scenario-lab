...
- characters 105-13097: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13140-13332: `{{metrics_json}}` from the run's live metric values
- characters 13425-14583: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14626-16608: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16664-17185: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Anomaly Triage and Hold Protocol | 2 |
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Evaluation and Deployment Review Capacity −2, EU Ring-Fenced Continuity Hosting −2, EU Anomaly Triage and Hold Protocol −2, priority −1 = −13
PROPOSAL BONUS: EU Anomaly Triage and Hold Protocol (cat 1, small) +2 — leaked eval anomaly this turn suggests assurance gap and this answers it directly
LEGITIMACY LENDS: capital 18, sentiment 38 -> +2
