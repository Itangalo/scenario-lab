...
- characters 378-2086: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2130-4564: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4620-5085: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5148-29739: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30094-31264: `{{event_history}}` from the run's own event record
...
- Turn 3 (10 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, knowledge_work_augmented, emergent_sovereign_hosting_offer
- Turn 4 (9 turn(s) ago): eval_anomaly_reports
- Turn 5 (8 turn(s) ago): adoption_success, election_alliance
- Turn 6 (7 turn(s) ago): loss_of_control_incident, capability_jump, eval_anomaly_reports, emergent_triage_bypass_exposure
- Turn 7 (6 turn(s) ago): cyber_major_incident, taiwan_blockade, cyber_defence_breakthrough, embodied_ai_deployment, taiwan_tension_rise
- Turn 8 (5 turn(s) ago): cyber_major_incident, capability_jump, member_state_defection, adoption_success
- Turn 9 (4 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, safety_breakthrough, us_china_agreement
- Turn 10 (3 turn(s) ago): safety_breakthrough, middle_power_coalition
- Turn 11 (2 turn(s) ago): cyber_major_incident, automated_decision_scandal, middle_power_coalition
- Turn 12 (1 turn(s) ago): opaque_reasoning, openweight_frontier_release, taiwan_tension_rise, eu_frontier_access_denied, joint_threat_response
