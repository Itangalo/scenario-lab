...
- characters 13684-15197: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15240-17574: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17630-18101: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Cutoff Continuity and Joint Telemetry Accession | 2 |
...
## Notepad
PORTFOLIO CHARGE t12: EU Cutoff Continuity and Joint Telemetry Accession −2, priority −1 = −3
PROPOSAL BONUS: EU Cutoff Continuity and Joint Telemetry Accession (cat 6, small) +4 — answers eu_frontier_access_denied and openweight sweep landing this turn directly
LEGITIMACY LENDS: capital 23, sentiment 18 -> none, capital higher
SOVEREIGNTY: 34 last turn, no category 4 finish, no category 4 in flight, eu_frontier_access_denied t12 −2, capability rose 1.2 −0 = 32
