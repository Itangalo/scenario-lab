...
- characters 1933-4267: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4323-4794: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4857-30145: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30500-31525: `{{event_history}}` from the run's own event record
...
- Turn 3 (9 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, knowledge_work_augmented, emergent_sovereign_hosting_offer
- Turn 4 (8 turn(s) ago): eval_anomaly_reports
- Turn 5 (7 turn(s) ago): adoption_success, election_alliance
- Turn 6 (6 turn(s) ago): loss_of_control_incident, capability_jump, eval_anomaly_reports, emergent_triage_bypass_exposure
- Turn 7 (5 turn(s) ago): cyber_major_incident, taiwan_blockade, cyber_defence_breakthrough, embodied_ai_deployment, taiwan_tension_rise
- Turn 8 (4 turn(s) ago): cyber_major_incident, capability_jump, member_state_defection, adoption_success
- Turn 9 (3 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, safety_breakthrough, us_china_agreement
- Turn 10 (2 turn(s) ago): safety_breakthrough, middle_power_coalition
- Turn 11 (1 turn(s) ago): cyber_major_incident, automated_decision_scandal, middle_power_coalition
