...
- characters 106-13468: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13511-13703: `{{metrics_json}}` from the run's live metric values
- characters 13796-14823: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14867-17376: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17432-17779: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Critical Services Continuity Surge | 2 |
...
## Notepad
PORTFOLIO CHARGE t7: EU Critical Services Continuity Surge −2, priority −1 = −3
PROPOSAL BONUS: EU Critical Services Continuity Surge (cat 6, small) +3 — cyber_major_incident and taiwan_blockade both severe and this turn, this answers hardening directly
LEGITIMACY LENDS: capital 14, sentiment 38 -> +2
SOVEREIGNTY: 28 last turn, InvestAI Gigafactories finishes t7 +5, no capacity measure in flight, embodied_ai_deployment t7 −1, capability rose 1.0 −0 = 32
## Store changes
```json
