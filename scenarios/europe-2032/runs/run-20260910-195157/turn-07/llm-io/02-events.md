...
- characters 377-1404: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1448-3957: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4013-4360: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4423-31676: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32031-32500: `{{event_history}}` from the run's own event record
...
- Turn 3 (4 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, knowledge_work_augmented, emergent_sovereign_hosting_offer
- Turn 4 (3 turn(s) ago): eval_anomaly_reports
- Turn 5 (2 turn(s) ago): adoption_success, election_alliance
- Turn 6 (1 turn(s) ago): loss_of_control_incident, capability_jump, eval_anomaly_reports, emergent_triage_bypass_exposure
