...
- characters 378-1803: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1847-3933: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3989-4395: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4458-29746: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30101-31025: `{{event_history}}` from the run's own event record
...
- Turn 3 (8 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, knowledge_work_augmented, emergent_sovereign_hosting_offer
- Turn 4 (7 turn(s) ago): eval_anomaly_reports
- Turn 5 (6 turn(s) ago): adoption_success, election_alliance
- Turn 6 (5 turn(s) ago): loss_of_control_incident, capability_jump, eval_anomaly_reports, emergent_triage_bypass_exposure
- Turn 7 (4 turn(s) ago): cyber_major_incident, taiwan_blockade, cyber_defence_breakthrough, embodied_ai_deployment, taiwan_tension_rise
- Turn 8 (3 turn(s) ago): cyber_major_incident, capability_jump, member_state_defection, adoption_success
- Turn 9 (2 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, safety_breakthrough, us_china_agreement
- Turn 10 (1 turn(s) ago): safety_breakthrough, middle_power_coalition
