...
- characters 456-1881: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1925-4011: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6316-7160: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10165-13206: `{{previous_actions}}` from the actor's own response from the previous turn
