...
- characters 107-13345: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13388-13580: `{{metrics_json}}` from the run's live metric values
- characters 13673-15098: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15142-17228: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17284-17690: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Certified Recovery and Accountability Enforcement | 2 |
...
PORTFOLIO CHARGE t10: EU Coalition Control Adoption Pact −2, priority −1 = −3
PROPOSAL BONUS: none — new pact answers coalition window and control advance, no negative event in last three turns it directly remedies
LEGITIMACY LENDS: capital 22, sentiment 30 -> +2
SOVEREIGNTY: 30 last turn, no category 4 finish, no capacity event in flight terms, middle_power_coalition t10 +2, capability rose 1.0 −0 = 32
...
## Metrics
```json
{"ai_capability": 67.2, "openweight_capability": 65.2, "ai_safety": 22.0, "resilience": 40.5, "eu_ai_sovereignty": 34.0, "eu_political_capital": 23.0, "public_sentiment": 18.0}
```
...
## Notepad
PORTFOLIO CHARGE t11: EU Certified Recovery and Accountability Enforcement −2, priority −1 = −3
PROPOSAL BONUS: EU Certified Recovery and Accountability Enforcement (cat 6, small) +4 — answers cyber_major_incident and automated_decision_scandal landing this turn directly
LEGITIMACY LENDS: capital 23, sentiment 18 -> none, capital higher
SOVEREIGNTY: 32 last turn, no category 4 finish, no category 4 in flight, middle_power_coalition t11 +2, capability rose 1.0 −0 = 34
