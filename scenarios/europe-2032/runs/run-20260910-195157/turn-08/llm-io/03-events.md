...
- characters 376-2045: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2088-4132: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4188-4645: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4708-31243: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31598-32204: `{{event_history}}` from the run's own event record
...
- Turn 3 (5 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, knowledge_work_augmented, emergent_sovereign_hosting_offer
- Turn 4 (4 turn(s) ago): eval_anomaly_reports
- Turn 5 (3 turn(s) ago): adoption_success, election_alliance
- Turn 6 (2 turn(s) ago): loss_of_control_incident, capability_jump, eval_anomaly_reports, emergent_triage_bypass_exposure
- Turn 7 (1 turn(s) ago): cyber_major_incident, taiwan_blockade, cyber_defence_breakthrough, embodied_ai_deployment, taiwan_tension_rise
