...
- characters 105-13293: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13336-13528: `{{metrics_json}}` from the run's live metric values
- characters 13621-15290: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15333-17377: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17433-17890: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Visible Benefit Rollout | 2 |
...
## Notepad
PORTFOLIO CHARGE t8: EU Visible Benefit Rollout −2, priority −1 = −3
PROPOSAL BONUS: none — new EU Visible Benefit Rollout (cat 9, small) banks a positive adoption success, not a negative event from last three rounds
LEGITIMACY LENDS: capital 14, sentiment 32 -> +2
SOVEREIGNTY: 32 last turn, no capacity measure finishes, no capacity measure in flight +0, member_state_defection t8 −2, capability rose 1.5 −0 = 30
