...
- characters 1954-3968: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4024-5130: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5193-29420: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29775-29870: `{{event_history}}` from the run's own event record
...
- `emergent_sovereign_hosting_offer` -- first noted turn 1, listed in 2 turn(s) so far: A major non-US cloud provider announces EU-only model hosting with data and weights legally ring-fenced in the Union, marketed as continuity insurance after the June switch-off scare.
- `emergent_bio_publication_moratorium` -- first noted turn 1, listed in 2 turn(s) so far: Major scientific journals and preprint servers impose coordinated mandatory screening and delayed-release review for AI-assisted pathogen design work after the phage demonstrations.
