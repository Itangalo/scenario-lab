...
- characters 13768-15301: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15345-17359: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17415-17939: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Evaluation and Deployment Review Capacity | 2 |
| M5 | EU Ring-Fenced Continuity Hosting | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Cyber Shield −3, EU Evaluation and Deployment Review Capacity −2, priority −1 = −12
PROPOSAL BONUS: EU Evaluation and Deployment Review Capacity (cat 5, small) +3 — openweight_frontier_release landed this turn and this answers it directly, plus autumn intrusion context
LEGITIMACY LENDS: capital 31, sentiment 36 -> +1
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Evaluation and Deployment Review Capacity −2, EU Ring-Fenced Continuity Hosting −2, priority −1 = −11
PROPOSAL BONUS: none — knowledge-work gains without displacement remove felt problem, hosting answers access worry not a recent negative shock directly
LEGITIMACY LENDS: capital 27, sentiment 39 -> +2
SOVEREIGNTY: 20 last turn, no cat4 finish, Gigafactories in flight +0, emergent_sovereign_hosting_offer t3 +2, capability rose 2.0 −1 = 21
## Store changes
```json
