...
- characters 1891-4339: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4395-4870: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4933-30931: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31286-31988: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, emergent_eu_open_compute_pact
- Turn 3 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (3 turn(s) ago): ai_investment_collapse, knowledge_work_augmented
- Turn 5 (2 turn(s) ago): opaque_reasoning, research_breakthrough, openweight_frontier_release, eu_frontier_access_denied, automated_decision_scandal, emergent_us_talent_exodus, election_retrenchment
- Turn 6 (1 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, joint_threat_response
