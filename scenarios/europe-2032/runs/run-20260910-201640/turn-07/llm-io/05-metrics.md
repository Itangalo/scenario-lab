...
- characters 106-13514: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13557-13748: `{{metrics_json}}` from the run's live metric values
- characters 13841-15312: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15356-17804: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17860-18963: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 62.8, "openweight_capability": 59.0, "ai_safety": 12.0, "resilience": 46.0, "eu_ai_sovereignty": 22.0, "eu_political_capital": 2.0, "public_sentiment": 12.0}
```
