...
- characters 106-13084: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13127-13319: `{{metrics_json}}` from the run's live metric values
- characters 13412-15337: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15381-17809: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17865-18343: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Sovereign Inference Backbone | 3 |
| M5 | EU Incident Containment and Recovery Cell | 2 |
...
PORTFOLIO CHARGE t2: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Systems Shield −3, M4 EU Sovereign Inference Backbone −3, priority −1 = −13
PROPOSAL BONUS: none — knowledge_work_augmented blunts urgency, no displacement crisis to point at despite eu_frontier_access_denied this turn
LEGITIMACY LENDS: capital 17, sentiment 37 -> +2
SOVEREIGNTY: 21 last turn, no finish, in flight +0, eu_frontier_access_denied t2 −3, capability rose 2.0 −1 = 17
...
## Notepad
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Systems Shield −3, M4 EU Sovereign Inference Backbone −3, M5 EU Incident Containment and Recovery Cell −2, priority M3 −1 = −15
PROPOSAL BONUS: EU Incident Containment and Recovery Cell (cat 6, small) +3 — cyber_major_incident severe and live this turn and this answers it directly
LEGITIMACY LENDS: capital 10, sentiment 26 -> +2
SOVEREIGNTY: 17 last turn, no capacity event finish, no finish, in flight +0, eu_frontier_access_denied t3 −2, capability rose 2.0 −1 = 14
