...
- characters 375-2315: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2358-4695: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4751-5868: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5931-31929: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32284-33086: `{{event_history}}` from the run's own event record
...
- `emergent_care_failure_protests` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated street protests and hospital staff walkouts in states hit by US model revocations after on-camera oncology failures, turning health-care dependence into a national political crisis.
- `emergent_clinical_audit_backlash` -- first noted turn 7, listed in 1 turn(s) so far: Municipal hospital federations publish an open clinical safety audit showing the EU hardened open-model triage stack failing at scale, triggering coordinated procurement freezes and street protests against further rollout.
...
- Turn 2 (6 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, emergent_eu_open_compute_pact
- Turn 3 (5 turn(s) ago): cyber_major_incident, eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (4 turn(s) ago): ai_investment_collapse, knowledge_work_augmented
- Turn 5 (3 turn(s) ago): opaque_reasoning, research_breakthrough, openweight_frontier_release, eu_frontier_access_denied, automated_decision_scandal, emergent_us_talent_exodus, election_retrenchment
- Turn 6 (2 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, joint_threat_response
- Turn 7 (1 turn(s) ago): openweight_frontier_release, supply_chain_coercion, joint_threat_response
