...
- characters 105-12933: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12976-13167: `{{metrics_json}}` from the run's live metric values
- characters 13260-15200: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15243-17580: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17636-18753: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | Middle-Power Supply-Chain Coordination Framework | 2 |
