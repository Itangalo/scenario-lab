...
- characters 374-1703: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1746-4053: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4109-4982: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5045-30440: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30795-31400: `{{event_history}}` from the run's own event record
...
- `emergent_care_triage_freeze` -- first noted turn 4, listed in 2 turn(s) so far: Municipal backlash forces emergency pause of hospital triage AI in two member states after ransomware-linked misdiagnosis claims, freezing EU inference backbone rollout for months.
...
- Turn 2 (4 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, emergent_eu_open_compute_pact
- Turn 3 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (2 turn(s) ago): ai_investment_collapse, knowledge_work_augmented
- Turn 5 (1 turn(s) ago): opaque_reasoning, research_breakthrough, openweight_frontier_release, eu_frontier_access_denied, automated_decision_scandal, emergent_us_talent_exodus, election_retrenchment
