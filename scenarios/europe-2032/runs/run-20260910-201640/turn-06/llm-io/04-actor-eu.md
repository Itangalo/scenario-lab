...
- characters 452-1781: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1824-4131: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5522-6004: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8230-10717: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M4 | EU Sovereign Inference Backbone | 4 | large | 2 | 7 | own jurisdiction | eu_ai_sovereignty up materially, resilience up | 3 | running |
| M6 | European Talent Reception and Open-Stack Hardening | 4 | small | 5 | 7 | own jurisdiction | eu_ai_sovereignty up modestly, resilience up slightly | 2 | running |
