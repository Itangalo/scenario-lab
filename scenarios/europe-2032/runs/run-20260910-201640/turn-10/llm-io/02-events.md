...
- characters 1469-3389: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3445-3775: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3838-29836: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30191-31176: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: Middle-Power Supply-Chain Coordination Framework −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital -1, sentiment 15 -> +1 capped, included in capital total
SOVEREIGNTY: 13 last turn, no capacity event, M7 cat 8 in flight +0, capability rose 0.8 no −1 = 13
...
- Turn 2 (8 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, emergent_eu_open_compute_pact
- Turn 3 (7 turn(s) ago): cyber_major_incident, eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (6 turn(s) ago): ai_investment_collapse, knowledge_work_augmented
- Turn 5 (5 turn(s) ago): opaque_reasoning, research_breakthrough, openweight_frontier_release, eu_frontier_access_denied, automated_decision_scandal, emergent_us_talent_exodus, election_retrenchment
- Turn 6 (4 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, joint_threat_response
- Turn 7 (3 turn(s) ago): openweight_frontier_release, supply_chain_coercion, joint_threat_response
- Turn 8 (2 turn(s) ago): labour_displacement, adoption_success, middle_power_coalition
- Turn 9 (1 turn(s) ago): bio_uplift_findings, research_breakthrough, knowledge_work_augmented
