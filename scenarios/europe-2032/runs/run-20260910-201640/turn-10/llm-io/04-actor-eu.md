...
- characters 1547-3467: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4287-4770: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7081-8836: `{{previous_actions}}` from the actor's own response from the previous turn
