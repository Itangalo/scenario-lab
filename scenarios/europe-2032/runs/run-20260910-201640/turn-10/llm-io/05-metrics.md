...
- characters 106-13293: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13336-13527: `{{metrics_json}}` from the run's live metric values
- characters 13620-14670: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14713-16633: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16689-17341: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 66.5, "openweight_capability": 63.3, "ai_safety": 1.0, "resilience": 42.5, "eu_ai_sovereignty": 10.0, "eu_political_capital": 3.0, "public_sentiment": 12.0}
```
