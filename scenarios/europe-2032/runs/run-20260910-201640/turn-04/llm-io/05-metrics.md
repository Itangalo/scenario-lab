...
- characters 13739-14845: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14888-16796: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16852-17985: `{{notepad}}` from the Game Master's notepad, carried across turns
