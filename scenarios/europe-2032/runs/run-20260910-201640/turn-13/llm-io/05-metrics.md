...
- characters 13257-14895: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14939-16766: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16822-17315: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t13: EU Bio-Containment and Care Continuity Cell −2, priority −1 not charged capital below 20 = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 1 -> +1 capped by floor dynamics but overwhelmed by internal loss-of-control failure, net 0
SOVEREIGNTY: 8 last turn, no capacity event, no category 4 in flight +0, capability rose 0.7 −0 = 8
