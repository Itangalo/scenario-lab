...
- characters 374-2012: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2056-3883: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3939-4432: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4495-30534: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30889-32231: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Bio-Containment and Care Continuity Cell −2, priority −1 not charged capital below 20 = −2
PROPOSAL BONUS: EU Bio-Containment and Care Continuity Cell (cat 6, small) +4 — real bio incident with casualties this turn and this answers it directly on existing budgets
LEGITIMACY LENDS: capital 3, sentiment 1 -> none, capital higher
SOVEREIGNTY: 10 last turn, no category 4 finishes, no category 4 in flight +0, eu_frontier_access_denied t12 −2, capability rose 0.9 −0 = 8
...
- Turn 2 (11 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, emergent_eu_open_compute_pact
- Turn 3 (10 turn(s) ago): cyber_major_incident, eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (9 turn(s) ago): ai_investment_collapse, knowledge_work_augmented
- Turn 5 (8 turn(s) ago): opaque_reasoning, research_breakthrough, openweight_frontier_release, eu_frontier_access_denied, automated_decision_scandal, emergent_us_talent_exodus, election_retrenchment
- Turn 6 (7 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, joint_threat_response
- Turn 7 (6 turn(s) ago): openweight_frontier_release, supply_chain_coercion, joint_threat_response
- Turn 8 (5 turn(s) ago): labour_displacement, adoption_success, middle_power_coalition
- Turn 9 (4 turn(s) ago): bio_uplift_findings, research_breakthrough, knowledge_work_augmented
- Turn 10 (3 turn(s) ago): capability_jump, export_control_escalation
- Turn 11 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, taiwan_tension_rise
- Turn 12 (1 turn(s) ago): bio_incident, bio_uplift_findings, openweight_frontier_release, embodied_ai_deployment, eu_frontier_access_denied, member_state_defection
