...
- characters 1506-3582: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3638-4299: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4362-31213: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31568-32624: `{{event_history}}` from the run's own event record
...
LEGITIMACY LENDS: capital 2, sentiment 12 -> +1 capped, included in capital total
SOVEREIGNTY: 13 last turn, no category 4 finish, no capacity in flight +0, export_control_escalation t10 −2, capability rose 2.2 −1 = 10

## Emerging developments (tracked)

- `emergent_eu_clinical_commons` -- first noted turn 10, listed in 1 turn(s) so far: Municipal hospital federations publish an open audit showing sustained triage performance on the European stack, prompting several regions to pool procurement for a jointly maintained clinical model.
...
- Turn 2 (9 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, emergent_eu_open_compute_pact
- Turn 3 (8 turn(s) ago): cyber_major_incident, eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (7 turn(s) ago): ai_investment_collapse, knowledge_work_augmented
- Turn 5 (6 turn(s) ago): opaque_reasoning, research_breakthrough, openweight_frontier_release, eu_frontier_access_denied, automated_decision_scandal, emergent_us_talent_exodus, election_retrenchment
- Turn 6 (5 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, joint_threat_response
- Turn 7 (4 turn(s) ago): openweight_frontier_release, supply_chain_coercion, joint_threat_response
- Turn 8 (3 turn(s) ago): labour_displacement, adoption_success, middle_power_coalition
- Turn 9 (2 turn(s) ago): bio_uplift_findings, research_breakthrough, knowledge_work_augmented
- Turn 10 (1 turn(s) ago): capability_jump, export_control_escalation
