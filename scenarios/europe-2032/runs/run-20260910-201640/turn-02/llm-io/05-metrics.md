...
- characters 13356-14878: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14921-16960: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17016-17775: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_clinical_sovereignty_pause` -- first noted turn 1, listed in 2 turn(s) so far: Major European research hospitals pause use of US frontier models for clinical triage after the June switch-off scare, publishing contingency procurement notices for sovereign alternatives.
