...
- characters 376-1898: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1941-3980: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4036-5111: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5174-29401: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29756-29826: `{{event_history}}` from the run's own event record
