...
- characters 374-1507: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1550-3465: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3521-4274: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4337-31188: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31543-32719: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Essential Services Keep-Alive Cell −2, priority −1 = −3
PROPOSAL BONUS: EU Essential Services Keep-Alive Cell (cat 6, small) +2 — cyber_major_incident landed this turn severe and this answers it directly on existing budgets
LEGITIMACY LENDS: capital 2, sentiment 8 -> +2 capped, included in capital total
SOVEREIGNTY: 10 last turn, no capacity event, no category 4 in flight +0, capability rose 0.9 −0 = 10

## Emerging developments (tracked)

- `emergent_eu_clinical_commons` -- first noted turn 10, listed in 2 turn(s) so far: Municipal hospital federations publish an open audit showing sustained triage performance on the European stack, prompting several regions to pool procurement for a jointly maintained clinical model.
...
- Turn 2 (10 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, emergent_eu_open_compute_pact
- Turn 3 (9 turn(s) ago): cyber_major_incident, eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (8 turn(s) ago): ai_investment_collapse, knowledge_work_augmented
- Turn 5 (7 turn(s) ago): opaque_reasoning, research_breakthrough, openweight_frontier_release, eu_frontier_access_denied, automated_decision_scandal, emergent_us_talent_exodus, election_retrenchment
- Turn 6 (6 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, joint_threat_response
- Turn 7 (5 turn(s) ago): openweight_frontier_release, supply_chain_coercion, joint_threat_response
- Turn 8 (4 turn(s) ago): labour_displacement, adoption_success, middle_power_coalition
- Turn 9 (3 turn(s) ago): bio_uplift_findings, research_breakthrough, knowledge_work_augmented
- Turn 10 (2 turn(s) ago): capability_jump, export_control_escalation
- Turn 11 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, taiwan_tension_rise
