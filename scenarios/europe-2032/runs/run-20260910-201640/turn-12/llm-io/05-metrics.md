...
- characters 13344-13533: `{{metrics_json}}` from the run's live metric values
- characters 13626-14759: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14802-16717: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16773-17204: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Bio-Containment and Care Continuity Cell | 2 |
...
## Metrics
```json
{"ai_capability": 68.3, "openweight_capability": 64.0, "ai_safety": 0.0, "resilience": 44.0, "eu_ai_sovereignty": 8.0, "eu_political_capital": 0.0, "public_sentiment": 1.0}
```
## Narrative
### Containment
