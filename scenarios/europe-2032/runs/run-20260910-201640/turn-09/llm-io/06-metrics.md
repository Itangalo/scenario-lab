...
- characters 106-12935: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12978-13169: `{{metrics_json}}` from the run's live metric values
- characters 13262-15017: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15061-17016: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17072-17552: `{{notepad}}` from the Game Master's notepad, carried across turns
