...
- characters 13742-15648: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15692-17622: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17678-18396: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "pending"}}, {"op": "update", "table": "measures", "id": "M4", "fields": {"finish_turn": 7}, "grounds": "named priority"}]}
```
```
