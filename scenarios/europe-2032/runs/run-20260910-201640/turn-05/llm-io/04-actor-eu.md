...
- characters 454-2360: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2404-4334: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 9268-9734: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11790-13065: `{{previous_actions}}` from the actor's own response from the previous turn
