...
- characters 376-2282: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2326-4256: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4312-5295: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5358-33249: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33604-34009: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Sovereign Inference Backbone −3, M5 EU Incident Containment and Recovery Cell −2, priority M5 −1 = −12
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 30 -> +2
SOVEREIGNTY: 14 last turn, no category 4 finish, in flight +0, ai_investment_collapse t4 −2, capability rose 2.0 −1 = 11

## Emerging developments (tracked)

- `emergent_care_triage_freeze` -- first noted turn 4, listed in 1 turn(s) so far: Municipal backlash forces emergency pause of hospital triage AI in two member states after ransomware-linked misdiagnosis claims, freezing EU inference backbone rollout for months.
- `emergent_us_talent_exodus` -- first noted turn 4, listed in 1 turn(s) so far: A major US frontier lab suffers a high-profile researcher exodus after safety and access disputes, with several teams openly seeking European public-compute offers for continued work.
...
- Turn 2 (3 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, emergent_eu_open_compute_pact
- Turn 3 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (1 turn(s) ago): ai_investment_collapse, knowledge_work_augmented
