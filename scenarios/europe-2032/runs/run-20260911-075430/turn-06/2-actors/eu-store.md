...
| M8 | EU Frontier Anomaly Triage and Conditional Hold | 1 | small | 6 | 8 | own jurisdiction | ai_safety up, resilience protected | 2 | running |
...
- **applied** `M8` — {"op": "add", "table": "measures", "fields": {"name": "EU Frontier Anomaly Triage and Conditional Hold", "category": 1, "size": "small", "finish_turn": 8, "applies_to": "own jurisdiction", "targeted_effect": "ai_safety up, resilience protected"}, "grounds": "to create a hold and triage capacity before anomalous capability deploys"}
  - Grounds: to create a hold and triage capacity before anomalous capability deploys
