...
- characters 1687-3779: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4596-5068: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6540-8667: `{{previous_actions}}` from the actor's own response from the previous turn
