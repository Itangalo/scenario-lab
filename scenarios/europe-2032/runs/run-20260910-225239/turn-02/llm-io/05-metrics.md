...
- characters 105-13140: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13183-13375: `{{metrics_json}}` from the run's live metric values
- characters 13468-14658: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14701-16793: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16849-17896: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PROPOSAL BONUS: EU Critical Services Shield (cat 6, large) +3 — intrusion across grids/ports discovered this turn and this answers it directly
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 50.0, "ai_safety": 30.0, "resilience": 37.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 36.0, "public_sentiment": 32.0}
```
