...
- characters 105-13582: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13625-13817: `{{metrics_json}}` from the run's live metric values
- characters 13910-14978: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15021-16884: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16940-17512: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | Municipal Cyber Containment Surge | 2 |
...
## Metrics
```json
{"ai_capability": 60.0, "openweight_capability": 54.0, "ai_safety": 24.0, "resilience": 42.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 17.0, "public_sentiment": 31.0}
```
## Narrative
...
## Notepad
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU-Taiwan Strait Supply Continuity Pact −2, M5 EU Assurance and Anomaly Triage Cell −2, M6 Municipal Cyber Containment Surge −2, priority −1 = −13
PROPOSAL BONUS: Municipal Cyber Containment Surge (cat 6, small) +2 — answers split-attribution winter sweep and lagging small-council last mile from t3, now acute
LEGITIMACY LENDS: capital 15, sentiment 31 -> +2
