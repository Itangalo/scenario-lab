...
- characters 377-1608: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1652-3593: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3649-4196: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4259-32744: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33099-33403: `{{event_history}}` from the run's own event record
...
- Turn 3 (2 turn(s) ago): eval_anomaly_reports, safety_breakthrough, adoption_success, emergent_gigafactory_siting_backlash
- Turn 4 (1 turn(s) ago): capability_jump, openweight_frontier_release
