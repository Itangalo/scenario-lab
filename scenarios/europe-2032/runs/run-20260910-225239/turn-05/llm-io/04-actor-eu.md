...
- characters 455-1686: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1730-3671: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7457-7929: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10224-12368: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M4 | EU-Taiwan Strait Supply Continuity Pact | 8 | small | 2 | 5 | coalition (JP, KR, NL, TW) | eu_ai_sovereignty up slightly, resilience up against supply shock | 2 | finished |
| M6 | Municipal Cyber Containment Surge | 6 | small | 4 | 5 | own jurisdiction | resilience up, ai_safety up slightly via reduced misuse impact | 2 | finished |
