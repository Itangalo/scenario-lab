...
- `two_year_commitment` (commitment): Restore public trust and hardened resilience so AI remains governable in Europe

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Restore public trust and hardened resilience so AI remains governable in Europe
