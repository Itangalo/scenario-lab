...
- characters 375-1762: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1805-3425: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3481-3994: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4057-27688: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28043-28712: `{{event_history}}` from the run's own event record
...
- Turn 2 (6 turn(s) ago): emergent_research_provenance_pact
- Turn 3 (5 turn(s) ago): knowledge_work_augmented, supply_chain_coercion, member_state_defection
- Turn 4 (4 turn(s) ago): cyber_major_incident, taiwan_blockade, ai_investment_collapse, automated_decision_scandal
- Turn 5 (3 turn(s) ago): bio_uplift_findings, openweight_frontier_release, election_consolidation
- Turn 6 (2 turn(s) ago): labour_displacement, export_control_escalation, member_state_defection
- Turn 7 (1 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, joint_threat_response, emergent_municipal_ai_moratorium
