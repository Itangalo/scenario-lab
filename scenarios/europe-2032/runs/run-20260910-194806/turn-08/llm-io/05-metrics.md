...
- characters 13143-13334: `{{metrics_json}}` from the run's live metric values
- characters 13427-14814: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14857-16477: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16533-17046: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 62.5, "openweight_capability": 59.8, "ai_safety": 18.5, "resilience": 40.5, "eu_ai_sovereignty": 17.0, "eu_political_capital": 7.0, "public_sentiment": 13.0}
```
