...
- characters 453-2231: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2274-4613: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5623-6072: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8152-10058: `{{previous_actions}}` from the actor's own response from the previous turn
