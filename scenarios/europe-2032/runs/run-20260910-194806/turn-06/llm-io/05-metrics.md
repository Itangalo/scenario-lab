...
- characters 105-13374: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13417-13608: `{{metrics_json}}` from the run's live metric values
- characters 13701-15479: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15522-17861: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17917-18691: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t5: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M5 EU Chokepoint Coordination Pact −2, priority M5 −0 (no effect, capital below 20) = −8
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0 after charges, sentiment 22 -> +2 (capped below sentiment)
SOVEREIGNTY: 15 last turn, no capacity event, M1/M2 in flight +0, capability rose 1.9 −0 = 15

## Emerging developments (tracked)

- `emergent_municipal_ai_moratorium` -- first noted turn 5, listed in 2 turn(s) so far: Municipal utilities and hospital networks in two member states suspend new AI procurement and disconnect automated triage tools after the welfare and ransomware scandals, creating a de facto local moratorium that spreads via city networks.
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 57.1, "ai_safety": 22.5, "resilience": 37.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 2.0, "public_sentiment": 15.0}
```
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 election settled consolidation winner, takes effect turn 6"}]}
```
```
