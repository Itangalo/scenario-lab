...
- characters 107-13096: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13139-13329: `{{metrics_json}}` from the run's live metric values
- characters 13422-16022: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16066-18179: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18235-18542: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 64.5, "openweight_capability": 62.7, "ai_safety": 12.0, "resilience": 42.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 4.0, "public_sentiment": 3.0}
```
...
## Notepad
PORTFOLIO CHARGE t11: (none in flight) = -0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 4.0, sentiment 3.0 -> none, capital higher
