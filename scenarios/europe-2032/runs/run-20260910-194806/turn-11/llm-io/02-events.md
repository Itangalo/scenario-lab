...
- characters 376-2976: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3020-5133: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5189-6127: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6190-30424: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30779-31632: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M7 EU Blockade Continuity Reserve −2, priority no effect as capital below 20 = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1.0, sentiment 7.0 -> +1
SOVEREIGNTY: 15 last turn, no capacity event, no cat4 in flight +0, capability rose 0.7 −0 = 15

## Emerging developments (tracked)

- `emergent_fallback_staff_burnout` -- first noted turn 9, listed in 2 turn(s) so far: A coordinated sick-out by hospital and utility staff running manual-fallback systems forces several cities to suspend human-checked triage and reconnect uncertified AI tools to keep services running.
- `emergent_anti_datacentre_blockades` -- first noted turn 9, listed in 2 turn(s) so far: Coordinated physical blockades of gigafactory and data-centre construction sites spread across several member states, delaying fallback capacity expansion and forcing extended police protection of energy connections.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, eu_frontier_access_denied
- Turn 2 (9 turn(s) ago): emergent_research_provenance_pact
- Turn 3 (8 turn(s) ago): knowledge_work_augmented, supply_chain_coercion, member_state_defection
- Turn 4 (7 turn(s) ago): cyber_major_incident, taiwan_blockade, ai_investment_collapse, automated_decision_scandal
- Turn 5 (6 turn(s) ago): bio_uplift_findings, openweight_frontier_release, election_consolidation
- Turn 6 (5 turn(s) ago): labour_displacement, export_control_escalation, member_state_defection
- Turn 7 (4 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, joint_threat_response, emergent_municipal_ai_moratorium
- Turn 9 (2 turn(s) ago): loss_of_control_incident, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
- Turn 10 (1 turn(s) ago): research_breakthrough
