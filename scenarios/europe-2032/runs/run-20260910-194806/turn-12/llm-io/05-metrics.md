...
- characters 106-12821: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12864-13054: `{{metrics_json}}` from the run's live metric values
- characters 13147-14145: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14188-16114: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16170-16435: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Joint Threat Telemetry Accession | 2 |
