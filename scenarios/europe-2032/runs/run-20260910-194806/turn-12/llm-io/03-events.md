...
- characters 375-1373: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1416-3342: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3398-3663: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3726-27960: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28315-29252: `{{event_history}}` from the run's own event record
...
- Turn 2 (10 turn(s) ago): emergent_research_provenance_pact
- Turn 3 (9 turn(s) ago): knowledge_work_augmented, supply_chain_coercion, member_state_defection
- Turn 4 (8 turn(s) ago): cyber_major_incident, taiwan_blockade, ai_investment_collapse, automated_decision_scandal
- Turn 5 (7 turn(s) ago): bio_uplift_findings, openweight_frontier_release, election_consolidation
- Turn 6 (6 turn(s) ago): labour_displacement, export_control_escalation, member_state_defection
- Turn 7 (5 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, joint_threat_response, emergent_municipal_ai_moratorium
- Turn 9 (3 turn(s) ago): loss_of_control_incident, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
- Turn 10 (2 turn(s) ago): research_breakthrough
- Turn 11 (1 turn(s) ago): labour_displacement, emergent_anti_datacentre_blockades
