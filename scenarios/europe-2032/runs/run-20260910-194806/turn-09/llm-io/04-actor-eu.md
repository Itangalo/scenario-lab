...
- characters 454-1692: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1736-3418: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5203-5652: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7729-9354: `{{previous_actions}}` from the actor's own response from the previous turn
