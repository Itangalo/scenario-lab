...
- characters 106-12814: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12857-13048: `{{metrics_json}}` from the run's live metric values
- characters 13141-14379: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14423-16105: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16161-17043: `{{notepad}}` from the Game Master's notepad, carried across turns
