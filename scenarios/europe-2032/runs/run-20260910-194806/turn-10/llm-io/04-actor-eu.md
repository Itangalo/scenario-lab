...
- characters 453-2322: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2365-4780: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6143-6573: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8940-10925: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | EU Blockade Continuity Reserve | 6 | small | 9 | 11 | own jurisdiction | resilience up, public_sentiment stabilize | 2 | running |
