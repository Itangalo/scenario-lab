...
- characters 106-12816: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12859-13049: `{{metrics_json}}` from the run's live metric values
- characters 13142-15011: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15054-17469: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17525-18745: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Blockade Continuity Reserve | 2 |
