...
- characters 375-2244: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2287-4702: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4758-5978: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6041-30275: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30630-31433: `{{event_history}}` from the run's own event record
...
- `emergent_fallback_staff_burnout` -- first noted turn 9, listed in 1 turn(s) so far: A coordinated sick-out by hospital and utility staff running manual-fallback systems forces several cities to suspend human-checked triage and reconnect uncertified AI tools to keep services running.
- `emergent_anti_datacentre_blockades` -- first noted turn 9, listed in 1 turn(s) so far: Coordinated physical blockades of gigafactory and data-centre construction sites spread across several member states, delaying fallback capacity expansion and forcing extended police protection of energy connections.
...
- Turn 2 (8 turn(s) ago): emergent_research_provenance_pact
- Turn 3 (7 turn(s) ago): knowledge_work_augmented, supply_chain_coercion, member_state_defection
- Turn 4 (6 turn(s) ago): cyber_major_incident, taiwan_blockade, ai_investment_collapse, automated_decision_scandal
- Turn 5 (5 turn(s) ago): bio_uplift_findings, openweight_frontier_release, election_consolidation
- Turn 6 (4 turn(s) ago): labour_displacement, export_control_escalation, member_state_defection
- Turn 7 (3 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, joint_threat_response, emergent_municipal_ai_moratorium
- Turn 9 (1 turn(s) ago): loss_of_control_incident, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
