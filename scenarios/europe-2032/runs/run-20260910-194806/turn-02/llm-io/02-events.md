...
- characters 376-1602: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1645-3527: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3583-4902: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4965-28247: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28602-28670: `{{event_history}}` from the run's own event record
