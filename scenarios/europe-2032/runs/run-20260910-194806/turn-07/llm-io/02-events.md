...
- characters 376-1675: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1719-3502: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3558-4395: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4458-28089: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28444-28982: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): emergent_research_provenance_pact
- Turn 3 (4 turn(s) ago): knowledge_work_augmented, supply_chain_coercion, member_state_defection
- Turn 4 (3 turn(s) ago): cyber_major_incident, taiwan_blockade, ai_investment_collapse, automated_decision_scandal
- Turn 5 (2 turn(s) ago): bio_uplift_findings, openweight_frontier_release, election_consolidation
- Turn 6 (1 turn(s) ago): labour_displacement, export_control_escalation, member_state_defection
