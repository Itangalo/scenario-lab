...
- characters 106-13186: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13229-13420: `{{metrics_json}}` from the run's live metric values
- characters 13513-14812: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14856-16639: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16695-17167: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M6 | EU Municipal Continuity and Trust Pact | 2 |
...
## Metrics
```json
{"ai_capability": 61.8, "openweight_capability": 59.0, "ai_safety": 20.5, "resilience": 37.5, "eu_ai_sovereignty": 21.0, "eu_political_capital": 2.0, "public_sentiment": 11.0}
```
## Narrative
### The cutoff
