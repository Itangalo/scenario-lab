...
- characters 1646-3708: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3764-4154: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4217-26120: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26475-26817: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): emergent_research_provenance_pact
- Turn 3 (2 turn(s) ago): knowledge_work_augmented, supply_chain_coercion, member_state_defection
- Turn 4 (1 turn(s) ago): cyber_major_incident, taiwan_blockade, ai_investment_collapse, automated_decision_scandal
