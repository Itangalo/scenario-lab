...
- characters 1724-3786: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5537-6008: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8086-9867: `{{previous_actions}}` from the actor's own response from the previous turn
