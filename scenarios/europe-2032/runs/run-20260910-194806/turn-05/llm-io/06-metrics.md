...
- characters 12927-13118: `{{metrics_json}}` from the run's live metric values
- characters 13211-14437: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14481-16543: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16599-17354: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 59.6, "openweight_capability": 54.6, "ai_safety": 24.5, "resilience": 38.5, "eu_ai_sovereignty": 15.0, "eu_political_capital": 3.0, "public_sentiment": 22.0}
```
