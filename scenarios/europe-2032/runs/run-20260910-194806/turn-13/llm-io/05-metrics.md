...
- characters 107-12822: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12865-13055: `{{metrics_json}}` from the run's live metric values
- characters 13148-14304: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14348-16025: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16081-16568: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t13: M8 EU Joint Threat Telemetry Accession −2 = −2, priority has no effect and no cost below 20
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2.0, sentiment 5.0 -> +1, capped by subsequent external and internal shocks
SOVEREIGNTY: 15 last turn, no capacity build finishes, no in-flight build +0, export_control_escalation t13 −3, capability rose 0.5 −0 = 12
## Store changes
```json
{"store": []}
```
