...
- characters 376-1532: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1576-3253: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3309-3796: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3859-28946: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29301-30338: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Joint Threat Telemetry Accession −2 = −2, no priority
PROPOSAL BONUS: none — joint invitation and defensive advance are protective opportunities, not negative shocks from last three turns
LEGITIMACY LENDS: capital 2.0, sentiment 5.0 -> none, capital calculation done after charge; sentiment above but rule gives no lend term below threshold / capital higher at start
SOVEREIGNTY: 15 last turn, no capacity event, no cat4 in flight +0, capability rose 0.6 −0 = 15
...
- Turn 2 (11 turn(s) ago): emergent_research_provenance_pact
- Turn 3 (10 turn(s) ago): knowledge_work_augmented, supply_chain_coercion, member_state_defection
- Turn 4 (9 turn(s) ago): cyber_major_incident, taiwan_blockade, ai_investment_collapse, automated_decision_scandal
- Turn 5 (8 turn(s) ago): bio_uplift_findings, openweight_frontier_release, election_consolidation
- Turn 6 (7 turn(s) ago): labour_displacement, export_control_escalation, member_state_defection
- Turn 7 (6 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied, joint_threat_response, emergent_municipal_ai_moratorium
- Turn 9 (4 turn(s) ago): loss_of_control_incident, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
- Turn 10 (3 turn(s) ago): research_breakthrough
- Turn 11 (2 turn(s) ago): labour_displacement, emergent_anti_datacentre_blockades
- Turn 12 (1 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, joint_threat_response
