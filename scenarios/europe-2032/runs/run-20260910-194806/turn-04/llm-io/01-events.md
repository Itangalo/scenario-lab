...
- characters 1788-4329: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4385-4972: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5035-28317: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28672-28898: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): emergent_research_provenance_pact
- Turn 3 (1 turn(s) ago): knowledge_work_augmented, supply_chain_coercion, member_state_defection
