...
- characters 13449-13641: `{{metrics_json}}` from the run's live metric values
- characters 13734-15103: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15146-17687: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17743-18330: `{{notepad}}` from the Game Master's notepad, carried across turns
