...
- characters 13294-14282: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14326-16188: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16244-16755: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Chokepoint Coordination Pact | 2 |
...
## Notepad
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Systems Shield −3, M4 EU Provenance Clearinghouse −2, M5 EU Chokepoint Coordination Pact −2, priority M3 −1 = −14
PROPOSAL BONUS: EU Chokepoint Coordination Pact (cat 8, small) +3 — supply_chain_coercion and member_state_defection landed this turn and this answers them directly
LEGITIMACY LENDS: capital 10, sentiment 34 -> +2 capped by other negative terms, included in total
SOVEREIGNTY: 20 last turn, supply_chain_coercion t3 −2, Gigafactories in flight +0, capability rose 1.5 −0 = 18
## Store changes
```json
{"store": []}
```
