...
- `two_year_commitment` (commitment): Secure open-weight resilience and sovereign evaluation capacity

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure open-weight resilience and sovereign evaluation capacity
