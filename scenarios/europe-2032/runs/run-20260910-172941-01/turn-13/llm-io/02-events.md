...
- characters 378-1068: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1112-2825: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 2881-3301: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3364-24460: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 24815-25879: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, loss_of_control_incident, cyber_defence_breakthrough, openweight_frontier_release
- Turn 2 (11 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal
- Turn 3 (10 turn(s) ago): bio_uplift_findings, safety_breakthrough, export_control_escalation, adoption_success
- Turn 4 (9 turn(s) ago): knowledge_work_augmented, emergent_siting_backlash_freeze
- Turn 5 (8 turn(s) ago): bio_uplift_findings, emergent_datacenter_resource_blockade, election_alliance
- Turn 6 (7 turn(s) ago): emergent_siting_zoning_lockin
- Turn 7 (6 turn(s) ago): loss_of_control_incident, eval_anomaly_reports
- Turn 8 (5 turn(s) ago): taiwan_blockade, export_control_escalation
- Turn 9 (4 turn(s) ago): openweight_frontier_release, safety_breakthrough, us_china_agreement
- Turn 10 (3 turn(s) ago): loss_of_control_incident, medical_breakthrough, adoption_success, emergent_china_materials_retaliation
- Turn 11 (2 turn(s) ago): cyber_defence_breakthrough
