...
- characters 13587-14277: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14321-16034: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16090-16510: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M15 | EU Eval-Anomaly Triage Cell | 2 |
...
## Metrics
```json
{"ai_capability": 65.1, "openweight_capability": 63.7, "ai_safety": 28.5, "resilience": 41.5, "eu_ai_sovereignty": 22.0, "eu_political_capital": 22.0, "public_sentiment": 33.0}
```
...
## Notepad
PORTFOLIO CHARGE t13: M14 EU Short-Time to Retraining Guarantee −2, M15 EU Eval-Anomaly Triage Cell −2, priority M14 −1 = −5
PROPOSAL BONUS: EU Eval-Anomaly Triage Cell (cat 5, small) +3 — eval_anomaly_reports fired this turn and this answers it directly
