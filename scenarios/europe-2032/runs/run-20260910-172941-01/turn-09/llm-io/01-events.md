...
- characters 1824-3635: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3691-4214: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4277-26276: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26631-27413: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M8 EU-US Coalition Access and Evaluation Pact −2, M9 EU Loss-of-Control Containment Protocol −2, M10 EU Lithography-for-Compute Guarantee −2, priority −1 = −7
PROPOSAL BONUS: EU Lithography-for-Compute Guarantee (cat 8, small) +3 — taiwan_blockade and export_control_escalation landed this turn and this answers them directly
LEGITIMACY LENDS: capital 15, sentiment 32 -> +2
SOVEREIGNTY: 27 last turn, no capacity event finishes, no cat4 in flight +0, taiwan_blockade t8 −3, capability rose 0.7 −0 = 24
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, loss_of_control_incident, cyber_defence_breakthrough, openweight_frontier_release
- Turn 2 (7 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal
- Turn 3 (6 turn(s) ago): bio_uplift_findings, safety_breakthrough, export_control_escalation, adoption_success
- Turn 4 (5 turn(s) ago): knowledge_work_augmented, emergent_siting_backlash_freeze
- Turn 5 (4 turn(s) ago): bio_uplift_findings, emergent_datacenter_resource_blockade, election_alliance
- Turn 6 (3 turn(s) ago): emergent_siting_zoning_lockin
- Turn 7 (2 turn(s) ago): loss_of_control_incident, eval_anomaly_reports
- Turn 8 (1 turn(s) ago): taiwan_blockade, export_control_escalation
