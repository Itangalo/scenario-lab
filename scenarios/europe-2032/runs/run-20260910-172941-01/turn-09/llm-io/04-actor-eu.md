...
- characters 1902-3713: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5317-5833: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8907-10807: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Lithography-for-Compute Guarantee | 8 | small | 8 | 10 | own jurisdiction + US + coalition | eu_ai_sovereignty up slightly, eu_political_capital up slightly via leverage | 2 | running |
