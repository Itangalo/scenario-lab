...
- characters 13778-15181: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15225-17036: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17092-17932: `{{notepad}}` from the Game Master's notepad, carried across turns
