...
- characters 105-12940: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12983-13176: `{{metrics_json}}` from the run's live metric values
- characters 13269-14506: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14549-16928: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16984-18165: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Incident Reporting and Redress Clearinghouse | 2 |
