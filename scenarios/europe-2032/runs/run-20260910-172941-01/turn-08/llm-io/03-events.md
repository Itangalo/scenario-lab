...
- characters 376-2058: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2101-4336: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4392-5193: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5256-27973: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28328-29041: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: M8 EU-US Coalition Access and Evaluation Pact −2, M9 EU Loss-of-Control Containment Protocol −2, priority −1 = −5
PROPOSAL BONUS: EU Loss-of-Control Containment Protocol (cat 6, small) +3 — loss_of_control_incident landed this turn and this answers it directly under eval-anomaly precursor
LEGITIMACY LENDS: capital 17, sentiment 32 -> +2
SOVEREIGNTY: 22 last turn, M1 InvestAI Gigafactories finishes t7 +5, no capacity event, capability rose 0.7 −0 = 27

## Emerging developments (tracked)

- `emergent_biosecurity_study_leak` -- first noted turn 6, listed in 2 turn(s) so far: The contested autumn 2028 genome-model biosecurity study leaks from expert channels to front-page press, forcing public debate on non-expert uplift and on the adequacy of the finished screening refits.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, loss_of_control_incident, cyber_defence_breakthrough, openweight_frontier_release
- Turn 2 (6 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal
- Turn 3 (5 turn(s) ago): bio_uplift_findings, safety_breakthrough, export_control_escalation, adoption_success
- Turn 4 (4 turn(s) ago): knowledge_work_augmented, emergent_siting_backlash_freeze
- Turn 5 (3 turn(s) ago): bio_uplift_findings, emergent_datacenter_resource_blockade, election_alliance
- Turn 6 (2 turn(s) ago): emergent_siting_zoning_lockin
- Turn 7 (1 turn(s) ago): loss_of_control_incident, eval_anomaly_reports
