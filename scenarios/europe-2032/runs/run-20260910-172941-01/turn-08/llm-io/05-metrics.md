...
- characters 13251-14933: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14976-17211: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17267-17742: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU-US Coalition Access and Evaluation Pact | 2 |
| M9 | EU Loss-of-Control Containment Protocol | 2 |
| M10 | EU Lithography-for-Compute Guarantee | 2 |
