...
- characters 13728-14953: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14997-17355: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17411-18348: `{{notepad}}` from the Game Master's notepad, carried across turns
