...
- characters 1646-4004: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4060-4997: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5060-27777: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28132-28772: `{{event_history}}` from the run's own event record
...
- `emergent_biosecurity_study_leak` -- first noted turn 6, listed in 1 turn(s) so far: The contested autumn 2028 genome-model biosecurity study leaks from expert channels to front-page press, forcing public debate on non-expert uplift and on the adequacy of the finished screening refits.
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, loss_of_control_incident, cyber_defence_breakthrough, openweight_frontier_release
- Turn 2 (5 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal
- Turn 3 (4 turn(s) ago): bio_uplift_findings, safety_breakthrough, export_control_escalation, adoption_success
- Turn 4 (3 turn(s) ago): knowledge_work_augmented, emergent_siting_backlash_freeze
- Turn 5 (2 turn(s) ago): bio_uplift_findings, emergent_datacenter_resource_blockade, election_alliance
- Turn 6 (1 turn(s) ago): emergent_siting_zoning_lockin
