...
- characters 1724-4082: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5313-5829: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8547-11055: `{{previous_actions}}` from the actor's own response from the previous turn
