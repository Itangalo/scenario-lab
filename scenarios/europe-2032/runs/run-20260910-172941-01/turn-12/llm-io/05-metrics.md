...
- characters 13643-15135: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15178-17252: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17308-17753: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Swarm-Defence Patching Rollout | 2 |
| M14 | EU Short-Time to Retraining Guarantee | 2 |
...
PORTFOLIO CHARGE t11: M12 EU Trusted Care and Public Service AI Scale-up −2, M13 EU Swarm-Defence Patching Rollout −2, priority M12 −1 = −5
PROPOSAL BONUS: none — M13 (cat 6, small) answers defensive breakthrough which is a positive gain, not a negative shock from last three turns
LEGITIMACY LENDS: capital 17, sentiment 25 -> +2
SOVEREIGNTY: 22 last turn, no capacity event, no cat4 finish, no in-flight cat4 bonus, capability rose 0.7 −0 = 22
...
## Notepad
PORTFOLIO CHARGE t12: M13 EU Swarm-Defence Patching Rollout −2, M14 EU Short-Time to Retraining Guarantee −2, priority M13 −1 = −5
PROPOSAL BONUS: none — M14 (cat 7, small) answers long-running displacement, not a negative event shock from last three turns
