...
- characters 455-1947: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1990-4064: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4132-4594: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8266-10207: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M13 | EU Swarm-Defence Patching Rollout | 6 | small | 11 | 13 | own jurisdiction | resilience up substantially, ai_safety up slightly via reduced cyber harm | 2 | running |
