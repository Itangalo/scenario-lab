...
- characters 13674-14940: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14984-17350: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17406-18007: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 59.0, "openweight_capability": 55.7, "ai_safety": 31.5, "resilience": 38.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 18.0, "public_sentiment": 40.0}
```
