...
- characters 377-2184: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2228-4765: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4821-5972: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6035-27709: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28064-28348: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Incident Reporting and Redress Clearinghouse −2, priority −1 = −12
PROPOSAL BONUS: EU Incident Reporting and Redress Clearinghouse (cat 2, small) +2 — automated-decision scandal landed this turn and this answers it directly
LEGITIMACY LENDS: capital 22, sentiment 33 -> +2
SOVEREIGNTY: 22 last turn, no capacity event, Gigafactories + Tech package in flight +0, capability rose 1.0 −0 = 22

## Emerging developments (tracked)

- `emergent_datacentre_siting_backlash` -- first noted turn 1, listed in 2 turn(s) so far: Coordinated municipal opposition blocks or delays at least one major EU data-centre / supercomputer siting on energy-price and water-use grounds during H2 2026, forcing a public EU-level siting and energy compact debate.
- `emergent_clinical_model_pause` -- first noted turn 1, listed in 2 turn(s) so far: Major European research hospitals pause use of US frontier models for clinical decision support after the June switch-off scare, publishing contingency guidance that leaks and amplifies public debate over dependence.
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, loss_of_control_incident, cyber_defence_breakthrough, openweight_frontier_release
- Turn 2 (1 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal
