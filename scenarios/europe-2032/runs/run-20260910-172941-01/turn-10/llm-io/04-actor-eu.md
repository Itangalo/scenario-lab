...
- characters 455-1660: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1703-4169: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5766-6228: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9497-11700: `{{previous_actions}}` from the actor's own response from the previous turn
...
**emergent_china_materials_retaliation (emergent event):** Beijing imposes retaliatory export licensing on gallium, germanium and legacy-chip components, squeezing European industrial and defence supply chains already stressed by the Taiwan stop.
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Accession to the US-China Safety Floor | 8 | small | 9 | 11 | own jurisdiction + US + China + coalition | ai_safety up, eu_political_capital up slightly via inclusion | 2 | running |
