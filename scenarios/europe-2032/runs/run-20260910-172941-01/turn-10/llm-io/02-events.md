...
- characters 377-1582: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1625-4091: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4147-4917: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4980-26076: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26431-27308: `{{event_history}}` from the run's own event record
...
- `emergent_china_materials_retaliation` -- first noted turn 9, listed in 1 turn(s) so far: Beijing imposes retaliatory export licensing on gallium, germanium and legacy-chip components, squeezing European industrial and defence supply chains already stressed by the Taiwan stop.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, loss_of_control_incident, cyber_defence_breakthrough, openweight_frontier_release
- Turn 2 (8 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal
- Turn 3 (7 turn(s) ago): bio_uplift_findings, safety_breakthrough, export_control_escalation, adoption_success
- Turn 4 (6 turn(s) ago): knowledge_work_augmented, emergent_siting_backlash_freeze
- Turn 5 (5 turn(s) ago): bio_uplift_findings, emergent_datacenter_resource_blockade, election_alliance
- Turn 6 (4 turn(s) ago): emergent_siting_zoning_lockin
- Turn 7 (3 turn(s) ago): loss_of_control_incident, eval_anomaly_reports
- Turn 8 (2 turn(s) ago): taiwan_blockade, export_control_escalation
- Turn 9 (1 turn(s) ago): openweight_frontier_release, safety_breakthrough, us_china_agreement
