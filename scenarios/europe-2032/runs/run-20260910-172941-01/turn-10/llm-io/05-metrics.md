...
- characters 106-13303: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13346-13538: `{{metrics_json}}` from the run's live metric values
- characters 13631-14836: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14879-17345: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17401-17854: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Accession to the US-China Safety Floor | 2 |
| M12 | EU Trusted Care and Public Service AI Scale-up | 2 |
