...
- characters 107-13293: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13336-13528: `{{metrics_json}}` from the run's live metric values
- characters 13621-15464: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15508-18002: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18058-18664: `{{notepad}}` from the Game Master's notepad, carried across turns
