...
- characters 376-2203: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2246-4563: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4619-5200: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5263-26937: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27292-27688: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, loss_of_control_incident, cyber_defence_breakthrough, openweight_frontier_release
- Turn 2 (2 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal
- Turn 3 (1 turn(s) ago): bio_uplift_findings, safety_breakthrough, export_control_escalation, adoption_success
