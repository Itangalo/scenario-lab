...
- characters 13417-13609: `{{metrics_json}}` from the run's live metric values
- characters 13702-15529: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15572-17889: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17945-18850: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU-US-Allied Compute Assurance and Siting Compact | 2 |
...
- `emergent_datacenter_resource_blockade` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated municipal protests and court injunctions over power and water use temporarily halt work on one or more salvaged InvestAI hyperscale sites, delaying equipment installation by months.
