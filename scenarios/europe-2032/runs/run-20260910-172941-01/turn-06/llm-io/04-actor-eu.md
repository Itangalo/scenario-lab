...
- characters 454-1852: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1895-3951: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4288-4760: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7278-9424: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Bio Detection and Care Continuity Surge | 6 | small | 5 | 7 | own jurisdiction | resilience up, ai_safety up slightly via bio-response | 2 | running |
