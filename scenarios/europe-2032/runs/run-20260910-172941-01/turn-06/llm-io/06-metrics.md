...
- characters 105-13542: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13585-13777: `{{metrics_json}}` from the run's live metric values
- characters 13870-15268: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15311-17367: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17423-18335: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Bio Detection and Care Continuity Surge | 2 |
