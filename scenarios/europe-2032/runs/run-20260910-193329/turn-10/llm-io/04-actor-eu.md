...
- characters 455-3267: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3310-5321: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6354-6778: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9857-11857: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Sovereign Cutover for Essential Dependencies | 9 | small | 9 | 11 | own jurisdiction | eu_ai_sovereignty up, resilience up, public_sentiment up slightly | 2 | running |
