...
- characters 377-3189: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3232-5243: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5299-5695: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5758-30710: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31065-31821: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, eu_access_secured
- Turn 2 (8 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, eu_frontier_access_denied, emergent_bio_data_closure
- Turn 3 (7 turn(s) ago): export_control_escalation
- Turn 4 (6 turn(s) ago): cyber_major_incident, adoption_success
- Turn 5 (5 turn(s) ago): adoption_success, emergent_fallback_safety_scare, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, safety_breakthrough
- Turn 7 (3 turn(s) ago): safety_breakthrough
- Turn 8 (2 turn(s) ago): cyber_defence_breakthrough
- Turn 9 (1 turn(s) ago): knowledge_work_augmented, eu_frontier_access_denied
