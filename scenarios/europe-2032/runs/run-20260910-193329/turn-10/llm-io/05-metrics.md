...
- characters 106-12893: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12936-13128: `{{metrics_json}}` from the run's live metric values
- characters 13221-16033: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16076-18087: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18143-19192: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Sovereign Cutover for Essential Dependencies | 2 |
| M12 | EU Validated Assurance for the Open Frontier | 2 |
...
PORTFOLIO CHARGE t9: EU Sovereign Cutover for Essential Dependencies −2, priority −1 = −3
PROPOSAL BONUS: EU Sovereign Cutover (cat 9, small) +4 — eu_frontier_access_denied fired this turn, severe and directly answered
LEGITIMACY LENDS: capital 38, sentiment 40.5 -> +2
SOVEREIGNTY: 33.5 last turn, no cat4 finish, no cat4 in flight, eu_frontier_access_denied t9 −2, capability rose 0.7 −0 = 31.5
