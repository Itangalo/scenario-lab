...
- characters 106-13511: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13554-13746: `{{metrics_json}}` from the run's live metric values
- characters 13839-15567: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15611-17784: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17840-18676: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Municipal Hygiene Endowment | 2 |
