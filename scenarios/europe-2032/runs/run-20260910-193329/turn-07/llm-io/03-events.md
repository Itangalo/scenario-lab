...
- characters 377-2105: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2149-4322: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4378-4913: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4976-29325: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29680-30259: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, eu_access_secured
- Turn 2 (5 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, eu_frontier_access_denied, emergent_bio_data_closure
- Turn 3 (4 turn(s) ago): export_control_escalation
- Turn 4 (3 turn(s) ago): cyber_major_incident, adoption_success
- Turn 5 (2 turn(s) ago): adoption_success, emergent_fallback_safety_scare, election_consolidation
- Turn 6 (1 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, safety_breakthrough
