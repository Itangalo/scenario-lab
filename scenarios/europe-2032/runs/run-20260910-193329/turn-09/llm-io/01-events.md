...
- characters 377-2459: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2503-4337: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4393-5043: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5106-29455: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29810-30488: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Breakthrough Patching Scale-Up −2, priority −1 = −3
PROPOSAL BONUS: none — cyber_defence_breakthrough is positive technical tailwind, not a negative event this measure answers
LEGITIMACY LENDS: capital 30.5, sentiment 40.5 -> +2
SOVEREIGNTY: 33.5 last turn, no capacity event, no cat4 in flight, capability rose 0.7 −0 = 33.5

## Emerging developments (tracked)

- `emergent_validation_pull` -- first noted turn 7, listed in 2 turn(s) so far: A major European standards body certifies the new interpretability guardrail technique as audit-grade, prompting non-EU vendors to seek EU validation licences to retain market access.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, eu_access_secured
- Turn 2 (7 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, eu_frontier_access_denied, emergent_bio_data_closure
- Turn 3 (6 turn(s) ago): export_control_escalation
- Turn 4 (5 turn(s) ago): cyber_major_incident, adoption_success
- Turn 5 (4 turn(s) ago): adoption_success, emergent_fallback_safety_scare, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, safety_breakthrough
- Turn 7 (2 turn(s) ago): safety_breakthrough
- Turn 8 (1 turn(s) ago): cyber_defence_breakthrough
