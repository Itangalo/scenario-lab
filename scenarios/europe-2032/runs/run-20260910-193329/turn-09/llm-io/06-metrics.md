...
- characters 13244-13436: `{{metrics_json}}` from the run's live metric values
- characters 13529-15611: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15655-17489: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17545-17894: `{{notepad}}` from the Game Master's notepad, carried across turns
