...
- characters 455-2537: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2581-4415: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5406-5858: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8605-10397: `{{previous_actions}}` from the actor's own response from the previous turn
