...
- characters 1397-3535: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3591-4724: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4787-29021: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29376-30317: `{{event_history}}` from the run's own event record
...
- `emergent_clinical_cutover_backlash` -- first noted turn 10, listed in 2 turn(s) so far: A major European hospital group publicly attributes a weekend of degraded triage summaries and translation errors to the forced cutover to domestic open models, triggering lawsuits and press calls for a pause on sovereign inference in clinical use.
- `emergent_sovereign_fork_compromise` -- first noted turn 10, listed in 2 turn(s) so far: A major European-hosted open model fork used for the sovereign cutover is found to contain a backdoored data curation pipeline, forcing hospitals and ministries to roll back migration.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, eu_access_secured
- Turn 2 (10 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, eu_frontier_access_denied, emergent_bio_data_closure
- Turn 3 (9 turn(s) ago): export_control_escalation
- Turn 4 (8 turn(s) ago): cyber_major_incident, adoption_success
- Turn 5 (7 turn(s) ago): adoption_success, emergent_fallback_safety_scare, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, safety_breakthrough
- Turn 7 (5 turn(s) ago): safety_breakthrough
- Turn 8 (4 turn(s) ago): cyber_defence_breakthrough
- Turn 9 (3 turn(s) ago): knowledge_work_augmented, eu_frontier_access_denied
- Turn 10 (2 turn(s) ago): openweight_frontier_release, safety_breakthrough, taiwan_tension_rise
- Turn 11 (1 turn(s) ago): cyber_major_incident, taiwan_blockade, bio_uplift_findings
