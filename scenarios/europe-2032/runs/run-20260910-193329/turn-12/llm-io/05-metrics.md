...
- characters 106-13321: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13364-13556: `{{metrics_json}}` from the run's live metric values
- characters 13649-14626: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14669-16807: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16863-17343: `{{notepad}}` from the Game Master's notepad, carried across turns
