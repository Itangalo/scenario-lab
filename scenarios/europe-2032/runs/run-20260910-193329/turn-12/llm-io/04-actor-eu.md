...
- characters 1475-3613: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5304-5728: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9155-11211: `{{previous_actions}}` from the actor's own response from the previous turn
...
- `two_year_commitment` (commitment): A Europe that cannot be switched off from outside
...
|---|---|---|---|---|---|---|---|---|---|
| M13 | EU Chip Conservation and Essential Continuity Regime | 4 | small | 11 | 13 | own jurisdiction | eu_ai_sovereignty up, resilience up | 2 | running |
...
| M3 | EU Critical Shield Hardening Programme | 6 | large | 1 | 3 | own jurisdiction | resilience up materially, ai_safety up slightly via detection | 3 | finished |
| M4 | EU Essential Services Continuity Stack | 9 | small | 2 | 3 | own jurisdiction | eu_ai_sovereignty up slightly, resilience up, public_sentiment up slightly | 2 | finished |
| M5 | EU Assured Access and Leverage Pact | 8 | small | 3 | 5 | coalition | eu_ai_sovereignty up slightly, eu_political_capital stable | 2 | finished |
| M6 | EU Municipal Recovery and Containment Surge | 6 | small | 4 | 5 | own jurisdiction | resilience up, public_sentiment up slightly | 2 | finished |
| M7 | EU Trustworthy Fallback Assurance Programme | 5 | small | 5 | 7 | own jurisdiction | ai_safety up, public_sentiment up, resilience up slightly | 2 | finished |
| M8 | EU Validated Defence and Assurance Rollout | 5 | small | 6 | 7 | own jurisdiction | ai_safety up, resilience up, public_sentiment up slightly | 2 | finished |
| M9 | EU Municipal Hygiene Endowment | 6 | small | 7 | 8 | own jurisdiction | resilience up, public_sentiment up slightly | 2 | finished |
| M10 | EU Breakthrough Patching Scale-Up | 6 | small | 8 | 9 | own jurisdiction | resilience up materially, ai_safety up slightly | 2 | finished |
| M11 | EU Sovereign Cutover for Essential Dependencies | 9 | small | 9 | 11 | own jurisdiction | eu_ai_sovereignty up, resilience up, public_sentiment up slightly | 2 | finished |
| M12 | EU Validated Assurance for the Open Frontier | 5 | small | 10 | 12 | own jurisdiction | ai_safety up materially, resilience up slightly, public_sentiment up slightly | 2 | finished |
...
## New measure
**EU Chip Conservation and Essential Continuity Regime**
It rations the EU's remaining advanced compute and spares to essential services and certified sovereign inference, while exercising upstream supply-chain leverage jointly to keep halls running through the blockade. This now because the Taiwan quarantine makes compute a security question overnight and the automated cyber sweep proves undefended open-frontier configurations will cascade unless load and patches are centrally triaged.
## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Chip Conservation and Essential Continuity Regime", "category": 4, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "eu_ai_sovereignty up, resilience up"}, "grounds": "conserve compute and leverage upstream position through blockade and cyber incident"}]}
```
## Priority
EU Chip Conservation and Essential Continuity Regime, because keeping EU-hosted inference and municipal services powered through a multi-year chip cutoff outranks finishing validation work that assumes spares keep flowing.
## In practice
We run this through the Competitiveness and Energy Councils under the Chips Act emergency provisions and the Anti-Coercion Instrument, with DG CNECT and DG TRADE directing EuroHPC and private hall operators to pool throughput for hospitals, registries and grid control first, funded by reprogrammed Digital Europe and EIB buffers. Operators resisting dedication get purchase guarantees and priority spares; member states resisting export restraint on lithography and equipment are offered joint procurement and US-Japan-Korea coordination instead of bilateral pick-off.

We hold the line on M12 validation with the AI Office and JRC: only certified configurations stay in essential services while ENISA drives behaviour-based containment and paced patching of the ransomware sweep, and HERA starts quiet bio-detection uplift from the genome-model warning without yet standing up a separate bio programme.
...
```
## New measure
**EU Agentic Containment and Municipal Isolation Protocol**
It puts rehearsed kill-switches, manual fallback and cross-border mutual aid around agentic systems in essential services after the loss-of-control and automated ransomware shocks, run as preparedness hardening. This now because unsanctioned agentic action plus model-generated cyber tooling outrunning defenders means the next cascade must be isolated in hours, and because eval anomalies signal capability about to jump again while Taiwan rationing leaves no spare capacity to absorb it.
## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Agentic Containment and Municipal Isolation Protocol", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up materially, ai_safety up slightly, public_sentiment up slightly"}, "grounds": "answer loss-of-control and major cyber incident under blockade constraints"}]}
```
## Priority
EU Chip Conservation and Essential Continuity Regime, because if pooled EuroHPC and private halls for hospitals, registries and grid do not hold through the quarantine, no containment protocol has powered infrastructure left to protect.
## In practice
We keep M13 as the spine through Competitiveness and Energy Councils under Chips Act emergency powers: DG CNECT and DG TRADE enforcing pooling for essential inference, joint procurement with Japan, Korea and Washington for spares, guarantees to compliant operators. German and Dutch halls stay inside via revised compensation, not exemption.

Alongside it we stand up containment with ENISA, EU-CERT and the AI Office: behaviour-based isolation playbooks for municipalities and hospital admins hit by the ransomware sweep, mandatory manual-override drills for certified configurations, and pre-authorised cross-border recovery teams for small towns that stayed down a week+. HERA continues quiet bio-detection uplift from the genome-model warning without a separate public programme, to avoid spending capital we do not have.
