...
- characters 13663-15907: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15950-17660: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17716-18165: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Trustworthy Fallback Assurance Programme | 2 |
| M8 | EU Validated Defence and Assurance Rollout | 2 |
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Trustworthy Fallback Assurance Programme −2, priority −1 = −9
PROPOSAL BONUS: EU Trustworthy Fallback Assurance Programme (cat 5, small) +3 — emergent fallback safety scare landed this turn and this answers it directly
LEGITIMACY LENDS: capital 28, sentiment 36 -> +2
SOVEREIGNTY: 26 last turn, no capacity event, Gigafactories in flight +1, capability rose 1.5 −0 = 27
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 election winner campaigned on strategic asset with tiered access"}, {"op": "update", "table": "measures", "id": "M8", "fields": {"finish_turn": 7}, "grounds": "named priority"}]}
```
```
