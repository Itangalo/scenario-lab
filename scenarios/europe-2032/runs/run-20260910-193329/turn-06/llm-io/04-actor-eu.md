...
- characters 454-2698: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2741-4451: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5706-6158: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8601-11012: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Trustworthy Fallback Assurance Programme | 5 | small | 5 | 7 | own jurisdiction | ai_safety up, public_sentiment up, resilience up slightly | 2 | running |
