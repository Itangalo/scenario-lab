...
- characters 376-2620: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2663-4373: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4429-5206: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5269-26508: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26863-27346: `{{event_history}}` from the run's own event record
...
- `emergent_fallback_medical_failure` -- first noted turn 4, listed in 2 turn(s) so far: A major European hospital group publicly reports serious clinical errors traced to degraded EuroHPC open-model triage summaries, triggering lawsuits and a parliamentary inquiry into the fallback stack.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, eu_access_secured
- Turn 2 (4 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, eu_frontier_access_denied, emergent_bio_data_closure
- Turn 3 (3 turn(s) ago): export_control_escalation
- Turn 4 (2 turn(s) ago): cyber_major_incident, adoption_success
- Turn 5 (1 turn(s) ago): adoption_success, emergent_fallback_safety_scare, election_consolidation
