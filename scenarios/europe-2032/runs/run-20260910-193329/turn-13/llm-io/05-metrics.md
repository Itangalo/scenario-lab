...
- characters 13330-13522: `{{metrics_json}}` from the run's live metric values
- characters 13615-14900: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14944-17013: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17069-17592: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Agentic Containment and Municipal Isolation Protocol | 2 |
| M15 | EU Essential Services Sovereign Fallback Activation | 2 |
...
## Notepad
PORTFOLIO CHARGE t13: EU Agentic Containment and Municipal Isolation Protocol −2, EU Essential Services Sovereign Fallback Activation −2, priority −1 = −5
PROPOSAL BONUS: EU Essential Services Sovereign Fallback Activation (cat 9, small) +4 — eu_frontier_access_denied fired this turn and this answers it directly for essential services
LEGITIMACY LENDS: capital 31, sentiment 23.5 -> none, capital higher
SOVEREIGNTY: 30.5 last turn, EU Chip Conservation and Essential Continuity Regime finishes t13 +4, no capacity in-flight bonus, eu_frontier_access_denied t13 −2, capability rose 0.7 −0 = 32.5
