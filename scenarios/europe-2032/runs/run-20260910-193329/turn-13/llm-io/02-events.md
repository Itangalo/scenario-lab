...
- characters 378-1663: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1707-3776: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3832-4355: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4418-28652: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29007-30045: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Chip Conservation and Essential Continuity Regime −2, EU Agentic Containment and Municipal Isolation Protocol −2, priority −1 = −5
PROPOSAL BONUS: EU Agentic Containment and Municipal Isolation Protocol (cat 6, small) +3 — cyber_major_incident and loss-of-control both landed this turn and this answers both directly
LEGITIMACY LENDS: capital 31, sentiment 27.5 -> none, capital higher
SOVEREIGNTY: 29.5 last turn, no capacity event, EU Chip Conservation in flight +1, capability rose 0.7 −0 = 30.5
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, eu_access_secured
- Turn 2 (11 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, eu_frontier_access_denied, emergent_bio_data_closure
- Turn 3 (10 turn(s) ago): export_control_escalation
- Turn 4 (9 turn(s) ago): cyber_major_incident, adoption_success
- Turn 5 (8 turn(s) ago): adoption_success, emergent_fallback_safety_scare, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, safety_breakthrough
- Turn 7 (6 turn(s) ago): safety_breakthrough
- Turn 8 (5 turn(s) ago): cyber_defence_breakthrough
- Turn 9 (4 turn(s) ago): knowledge_work_augmented, eu_frontier_access_denied
- Turn 10 (3 turn(s) ago): openweight_frontier_release, safety_breakthrough, taiwan_tension_rise
- Turn 11 (2 turn(s) ago): cyber_major_incident, taiwan_blockade, bio_uplift_findings
- Turn 12 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
