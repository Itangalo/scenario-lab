...
- characters 2309-4257: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5734-6181: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8457-10261: `{{previous_actions}}` from the actor's own response from the previous turn
