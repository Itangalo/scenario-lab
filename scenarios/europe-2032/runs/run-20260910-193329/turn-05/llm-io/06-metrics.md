...
- characters 13751-15561: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15605-17553: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17609-18425: `{{notepad}}` from the Game Master's notepad, carried across turns
