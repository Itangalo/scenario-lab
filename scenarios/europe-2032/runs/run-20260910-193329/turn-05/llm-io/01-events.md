...
- characters 377-2187: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2231-4179: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4235-5367: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5430-28051: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28406-28790: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Assured Access and Leverage Pact −2, EU Municipal Recovery and Containment Surge −2, priority −1 = −11
PROPOSAL BONUS: EU Municipal Recovery and Containment Surge (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 32, sentiment 38 -> +2
SOVEREIGNTY: 25 last turn, no capacity event, Gigafactories in flight +1, capability rose 1.5 no penalty = 26

## Emerging developments (tracked)

- `emergent_fallback_safety_scare` -- first noted turn 4, listed in 1 turn(s) so far: A major European hospital group publicly attributes a near-miss medication triage error to degraded performance of the EuroHPC open-model fallback, triggering a patient-safety inquiry and calls to restore foreign frontier access.
- `emergent_fallback_medical_failure` -- first noted turn 4, listed in 1 turn(s) so far: A major European hospital group publicly reports serious clinical errors traced to degraded EuroHPC open-model triage summaries, triggering lawsuits and a parliamentary inquiry into the fallback stack.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, eu_access_secured
- Turn 2 (3 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, eu_frontier_access_denied, emergent_bio_data_closure
- Turn 3 (2 turn(s) ago): export_control_escalation
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.03}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.05}, {"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.42}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.33}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.12}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.08}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.1}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.14}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.15}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "A major European hospital group publicly attributes a near-miss medication triage error to degraded performance of the EuroHPC open-model fallback, triggering a patient-safety inquiry and calls to restore foreign frontier access.", "emergent": true, "id": "emergent_fallback_safety_scare", "probability": 0.22}, {"description": "A major European hospital group publicly reports serious clinical errors traced to degraded EuroHPC open-model triage summaries, triggering lawsuits and a parliamentary inquiry into the fallback stack.", "emergent": true, "id": "emergent_fallback_medical_failure", "probability": 0.12}]
```
