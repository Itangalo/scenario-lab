...
- characters 376-2719: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2762-5689: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5745-6393: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6456-30805: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31160-31785: `{{event_history}}` from the run's own event record
...
- `emergent_validation_pull` -- first noted turn 7, listed in 1 turn(s) so far: A major European standards body certifies the new interpretability guardrail technique as audit-grade, prompting non-EU vendors to seek EU validation licences to retain market access.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, eu_access_secured
- Turn 2 (6 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, eu_frontier_access_denied, emergent_bio_data_closure
- Turn 3 (5 turn(s) ago): export_control_escalation
- Turn 4 (4 turn(s) ago): cyber_major_incident, adoption_success
- Turn 5 (3 turn(s) ago): adoption_success, emergent_fallback_safety_scare, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, safety_breakthrough
- Turn 7 (1 turn(s) ago): safety_breakthrough
