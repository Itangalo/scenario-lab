...
- characters 105-13177: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13220-13412: `{{metrics_json}}` from the run's live metric values
- characters 13505-15848: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15891-18818: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18874-19522: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.9, "openweight_capability": 60.0, "ai_safety": 28.5, "resilience": 44.0, "eu_ai_sovereignty": 33.5, "eu_political_capital": 32.0, "public_sentiment": 40.5}
```
