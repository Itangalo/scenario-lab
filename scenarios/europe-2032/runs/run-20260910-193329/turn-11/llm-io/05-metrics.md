...
- characters 107-13301: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13344-13536: `{{metrics_json}}` from the run's live metric values
- characters 13629-17010: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 17054-19109: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 19165-20317: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M13 | EU Chip Conservation and Essential Continuity Regime | 2 |
