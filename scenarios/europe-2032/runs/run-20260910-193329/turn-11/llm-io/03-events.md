...
- characters 378-3759: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3803-5858: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5914-7066: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 7129-32081: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32436-33290: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Sovereign Cutover for Essential Dependencies −2, EU Validated Assurance for the Open Frontier −2, priority −1 = −5
PROPOSAL BONUS: EU Validated Assurance (cat 5, small) +4 — openweight_frontier_release landed this turn and this answers it directly, plus safety_breakthrough makes certification credible
LEGITIMACY LENDS: none — capital 40.0 above sentiment 36.5
SOVEREIGNTY: 31.5 last turn, no capacity event, no cat4 finish, no cat4 in flight, capability rose 0.8 −0 = 31.5

## Emerging developments (tracked)

- `emergent_clinical_cutover_backlash` -- first noted turn 10, listed in 1 turn(s) so far: A major European hospital group publicly attributes a weekend of degraded triage summaries and translation errors to the forced cutover to domestic open models, triggering lawsuits and press calls for a pause on sovereign inference in clinical use.
- `emergent_sovereign_fork_compromise` -- first noted turn 10, listed in 1 turn(s) so far: A major European-hosted open model fork used for the sovereign cutover is found to contain a backdoored data curation pipeline, forcing hospitals and ministries to roll back migration.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, eu_access_secured
- Turn 2 (9 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, eu_frontier_access_denied, emergent_bio_data_closure
- Turn 3 (8 turn(s) ago): export_control_escalation
- Turn 4 (7 turn(s) ago): cyber_major_incident, adoption_success
- Turn 5 (6 turn(s) ago): adoption_success, emergent_fallback_safety_scare, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, safety_breakthrough
- Turn 7 (4 turn(s) ago): safety_breakthrough
- Turn 8 (3 turn(s) ago): cyber_defence_breakthrough
- Turn 9 (2 turn(s) ago): knowledge_work_augmented, eu_frontier_access_denied
- Turn 10 (1 turn(s) ago): openweight_frontier_release, safety_breakthrough, taiwan_tension_rise
