...
- characters 106-13454: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13497-13689: `{{metrics_json}}` from the run's live metric values
- characters 13782-15410: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15454-17297: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17353-17978: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Assured Access and Leverage Pact | 2 |
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 51.7, "ai_safety": 28.0, "resilience": 40.0, "eu_ai_sovereignty": 25.0, "eu_political_capital": 38.0, "public_sentiment": 42.0}
```
