...
- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold essential services and social order together through cut-off, open-model exposure and hostile AI
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The commitment's duration was its core condition; expiry changes the actor's obligation to uphold it.
