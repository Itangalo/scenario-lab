...
- **applied** `M5` — {"op": "add", "table": "measures", "fields": {"name": "Middle-Power Supply-Chain Compact", "category": 8, "size": "small", "finish_turn": 7, "applies_to": "coalition of EU and middle powers holding supply-chain chokepoints", "targeted_effect": "eu_political_capital up, eu_ai_sovereignty up modestly via secured access"}, "grounds": "US tiered rationing makes joint bargaining the only viable access 
  - Grounds: US tiered rationing makes joint bargaining the only viable access strategy
