...
- characters 455-1749: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1793-3661: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5278-5750: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7222-8476: `{{previous_actions}}` from the actor's own response from the previous turn
