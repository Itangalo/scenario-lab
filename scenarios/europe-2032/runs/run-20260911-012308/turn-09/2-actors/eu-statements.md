...
- `two_year_commitment` (commitment): Contain bio-enabled harm and keep essential services staffed and insured through open diffusion

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Contain bio-enabled harm and keep essential services staffed and insured through open diffusion
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the timeframe for the original statement, necessitating a new formulation of the EU's ongoing obligations.
