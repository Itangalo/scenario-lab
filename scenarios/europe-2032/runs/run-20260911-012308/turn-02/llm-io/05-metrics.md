...
- characters 105-12982: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13025-13217: `{{metrics_json}}` from the run's live metric values
- characters 13310-14447: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14490-16519: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16575-17589: `{{notepad}}` from the Game Master's notepad, carried across turns
