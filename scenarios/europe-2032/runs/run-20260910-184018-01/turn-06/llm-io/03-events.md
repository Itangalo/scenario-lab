...
- characters 376-3306: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3349-5484: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5540-5979: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6042-29647: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30002-30451: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M5 EU Supply-Chain Bargaining Bloc −2, M6 EU Blockade Rationing and Continuity Protocol −2, priority M6 −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 16, sentiment 21 -> +2
SOVEREIGNTY: 14 last turn, no category 4 finish, Gigafactories in flight +0, export_control_escalation t5 −2, capability rose 1.0 −0 = 12
...
- Turn 2 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, emergent_biosecurity_publishing_freeze
- Turn 3 (3 turn(s) ago): openweight_frontier_release, supply_chain_coercion
- Turn 4 (2 turn(s) ago): taiwan_blockade, eval_anomaly_reports
- Turn 5 (1 turn(s) ago): bio_incident, eval_anomaly_reports, research_breakthrough, export_control_escalation, election_alliance
