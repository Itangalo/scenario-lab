...
- characters 377-2156: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2200-4436: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4492-5312: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5375-27474: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27829-28419: `{{event_history}}` from the run's own event record
...
- `emergent_care_rationing_backlash` -- first noted turn 6, listed in 1 turn(s) so far: Municipal hospital federations publish an open triage-rationing protocol after stalled EU rollout, triggering coordinated strikes and court challenges that freeze further health AI deployment.
...
- Turn 2 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, emergent_biosecurity_publishing_freeze
- Turn 3 (4 turn(s) ago): openweight_frontier_release, supply_chain_coercion
- Turn 4 (3 turn(s) ago): taiwan_blockade, eval_anomaly_reports
- Turn 5 (2 turn(s) ago): bio_incident, eval_anomaly_reports, research_breakthrough, export_control_escalation, election_alliance
- Turn 6 (1 turn(s) ago): loss_of_control_incident, embodied_ai_deployment, us_china_agreement, adoption_success, automated_decision_scandal
