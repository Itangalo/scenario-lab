...
- characters 2278-4514: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5962-6447: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8977-10975: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | EU Agentic Loss-of-Control Protocol | 6 | small | 6 | 8 | own jurisdiction | resilience up moderately, ai_safety up slightly, eu_political_capital preserved | 2 | running |
