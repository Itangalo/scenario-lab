...
- characters 106-13331: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13374-13566: `{{metrics_json}}` from the run's live metric values
- characters 13659-15438: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15482-17718: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17774-18594: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Agentic Loss-of-Control Protocol | 2 |
| M8 | European Public Benefit AI Scale-Up | 2 |
...
PORTFOLIO CHARGE t6: M1 InvestAI Gigafactories −3, M7 EU Agentic Loss-of-Control Protocol −2, priority M1 −1 = −6
PROPOSAL BONUS: EU Agentic Loss-of-Control Protocol (cat 6, small) +3 — loss_of_control_incident landed this turn and this answers it directly, with scandal pressure alongside
LEGITIMACY LENDS: capital 18, sentiment 10 -> none, capital higher
SOVEREIGNTY: 12 last turn, M2 Tech sovereignty package finishes t6 +4, M1 in flight +1, embodied_ai_deployment t6 −2, capability rose 0.5 −0 = 15
...
## Metrics
```json
{"ai_capability": 62.0, "openweight_capability": 60.0, "ai_safety": 23.0, "resilience": 48.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 15.0, "public_sentiment": 15.0}
```
