...
- characters 2500-4393: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4449-5214: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5277-27385: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27740-28446: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: M7 EU Agentic Loss-of-Control Protocol −2, M8 European Public Benefit AI Scale-Up −2, priority M8 −1 = −5
PROPOSAL BONUS: none — M8 (cat 9, small) scales adoption_success which is a positive outcome, not a negative event from last three rounds
LEGITIMACY LENDS: capital 18, sentiment 10 -> none, capital higher
SOVEREIGNTY: 15 last turn, M1 InvestAI Gigafactories finishes t7 +4, no capacity event, capability rose 0.5 −0 = 19

## Emerging developments (tracked)

- `emergent_care_rationing_backlash` -- first noted turn 6, listed in 2 turn(s) so far: Municipal hospital federations publish an open triage-rationing protocol after stalled EU rollout, triggering coordinated strikes and court challenges that freeze further health AI deployment.
...
- Turn 2 (6 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, emergent_biosecurity_publishing_freeze
- Turn 3 (5 turn(s) ago): openweight_frontier_release, supply_chain_coercion
- Turn 4 (4 turn(s) ago): taiwan_blockade, eval_anomaly_reports
- Turn 5 (3 turn(s) ago): bio_incident, eval_anomaly_reports, research_breakthrough, export_control_escalation, election_alliance
- Turn 6 (2 turn(s) ago): loss_of_control_incident, embodied_ai_deployment, us_china_agreement, adoption_success, automated_decision_scandal
- Turn 7 (1 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, bio_uplift_findings, adoption_success
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.36}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.2}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.08}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.1}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.16}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.08}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.05}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.14}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.05}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Municipal hospital federations publish an open triage-rationing protocol after stalled EU rollout, triggering coordinated strikes and court challenges that freeze further health AI deployment.", "emergent": true, "id": "emergent_care_rationing_backlash", "probability": 0.18}]
```
