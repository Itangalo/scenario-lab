...
- characters 376-1426: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1469-3414: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3470-4356: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4419-26527: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26882-27732: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M9 Targeted Entry-Level and Redress Transition Fund −2, M10 Municipal Cyber Recovery and Continuity Repair −2, priority −1 not charged (capital below 20, no effect) = −4
PROPOSAL BONUS: Municipal Cyber Recovery and Continuity Repair (cat 6, small) +3 — cyber_major_incident landed this turn severe and this answers it directly with visible restoration
LEGITIMACY LENDS: capital 14, sentiment 4 -> none, capital not lower
SOVEREIGNTY: 19 last turn, no capacity event, no cat 4 finish or in flight, capability rose 1.0 −0 = 19

## Emerging developments (tracked)

- `emergent_anti_ai_infrastructure_blockades` -- first noted turn 9, listed in 1 turn(s) so far: Coordinated wildcat strikes and blockades target foreign-run warehouses and data-centre construction sites in France, Germany and the Netherlands, framed as resistance to AI-driven rationing and job losses.
...
- Turn 2 (8 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, emergent_biosecurity_publishing_freeze
- Turn 3 (7 turn(s) ago): openweight_frontier_release, supply_chain_coercion
- Turn 4 (6 turn(s) ago): taiwan_blockade, eval_anomaly_reports
- Turn 5 (5 turn(s) ago): bio_incident, eval_anomaly_reports, research_breakthrough, export_control_escalation, election_alliance
- Turn 6 (4 turn(s) ago): loss_of_control_incident, embodied_ai_deployment, us_china_agreement, adoption_success, automated_decision_scandal
- Turn 7 (3 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, bio_uplift_findings, adoption_success
- Turn 8 (2 turn(s) ago): labour_displacement, automated_decision_scandal
- Turn 9 (1 turn(s) ago): cyber_major_incident, research_breakthrough
