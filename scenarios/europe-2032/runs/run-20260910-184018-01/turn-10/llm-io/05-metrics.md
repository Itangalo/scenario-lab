...
- characters 106-13357: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13400-13591: `{{metrics_json}}` from the run's live metric values
- characters 13684-14734: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14777-16722: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16778-17323: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | Municipal Cyber Recovery and Continuity Repair | 2 |
...
**emergent_anti_ai_infrastructure_blockades (emergent event):** Coordinated wildcat strikes and blockades target foreign-run warehouses and data-centre construction sites in France, Germany and the Netherlands, framed as resistance to AI-driven rationing and job losses.
...
## Notepad
PORTFOLIO CHARGE t10: M10 Municipal Cyber Recovery and Continuity Repair −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 9, sentiment 7 -> none, capital not lower
SOVEREIGNTY: 19 last turn, no capacity event, no cat 4 finish or in flight, capability rose 1.0 −0 = 19
