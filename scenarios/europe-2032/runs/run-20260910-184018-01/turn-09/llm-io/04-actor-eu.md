...
- characters 454-1410: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1454-3525: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5211-5696: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8625-10532: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | Targeted Entry-Level and Redress Transition Fund | 7 | small | 8 | 10 | own jurisdiction | public_sentiment up moderately, eu_political_capital up slightly, resilience up slightly | 2 | running |
