...
- characters 376-1332: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1376-3447: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3503-3988: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4051-26159: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26514-27294: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M9 Targeted Entry-Level and Redress Transition Fund −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: Targeted Entry-Level and Redress Transition Fund (cat 7, small) +4 — answers automated decision scandal and narrow entry-level freeze firing this turn directly
...
- Turn 2 (7 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, emergent_biosecurity_publishing_freeze
- Turn 3 (6 turn(s) ago): openweight_frontier_release, supply_chain_coercion
- Turn 4 (5 turn(s) ago): taiwan_blockade, eval_anomaly_reports
- Turn 5 (4 turn(s) ago): bio_incident, eval_anomaly_reports, research_breakthrough, export_control_escalation, election_alliance
- Turn 6 (3 turn(s) ago): loss_of_control_incident, embodied_ai_deployment, us_china_agreement, adoption_success, automated_decision_scandal
- Turn 7 (2 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, bio_uplift_findings, adoption_success
- Turn 8 (1 turn(s) ago): labour_displacement, automated_decision_scandal
