...
- characters 13035-13226: `{{metrics_json}}` from the run's live metric values
- characters 13319-14275: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14319-16390: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16446-17272: `{{notepad}}` from the Game Master's notepad, carried across turns
