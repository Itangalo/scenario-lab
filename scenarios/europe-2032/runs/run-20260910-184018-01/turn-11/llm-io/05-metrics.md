...
- characters 107-13363: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13406-13596: `{{metrics_json}}` from the run's live metric values
- characters 13689-14576: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14620-16483: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16539-17208: `{{notepad}}` from the Game Master's notepad, carried across turns
