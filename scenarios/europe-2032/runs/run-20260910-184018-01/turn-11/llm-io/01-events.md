...
- characters 1307-3170: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3226-3590: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3653-26614: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26969-27911: `{{event_history}}` from the run's own event record
...
- Turn 2 (9 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, emergent_biosecurity_publishing_freeze
- Turn 3 (8 turn(s) ago): openweight_frontier_release, supply_chain_coercion
- Turn 4 (7 turn(s) ago): taiwan_blockade, eval_anomaly_reports
- Turn 5 (6 turn(s) ago): bio_incident, eval_anomaly_reports, research_breakthrough, export_control_escalation, election_alliance
- Turn 6 (5 turn(s) ago): loss_of_control_incident, embodied_ai_deployment, us_china_agreement, adoption_success, automated_decision_scandal
- Turn 7 (4 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, bio_uplift_findings, adoption_success
- Turn 8 (3 turn(s) ago): labour_displacement, automated_decision_scandal
- Turn 9 (2 turn(s) ago): cyber_major_incident, research_breakthrough
- Turn 10 (1 turn(s) ago): medical_breakthrough, emergent_anti_ai_infrastructure_blockades
