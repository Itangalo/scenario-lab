...
- characters 105-13120: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13163-13355: `{{metrics_json}}` from the run's live metric values
- characters 13448-15285: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15328-17311: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17367-18259: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Pathogen Early-Warning and Medical Countermeasure Shield | 3 |
| M5 | EU Supply-Chain Bargaining Bloc | 2 |
| M6 | EU Blockade Rationing and Continuity Protocol | 2 |
...
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Pathogen Early-Warning and Medical Countermeasure Shield −3, M5 EU Supply-Chain Bargaining Bloc −2, priority −1 = −12
PROPOSAL BONUS: EU Supply-Chain Bargaining Bloc (cat 8, small) +2 — supply_chain_coercion landed this turn and this answers it directly
LEGITIMACY LENDS: capital 22, sentiment 26 -> +1
SOVEREIGNTY: 20 last turn, no capacity build finishes, Gigafactories in flight +0, supply_chain_coercion t3 −2, capability rose 2.0 −1 = 17

## Emerging developments (tracked)

- `emergent_offshore_mirror_repository` -- first noted turn 3, listed in 2 turn(s) so far: An offshore repository outside US-EU jurisdiction begins systematically mirroring blocked pathogen-related preprints and model weights refused by mainstream publishers, becoming a go-to source for unvetted biological design methods.
...
## Metrics
```json
{"ai_capability": 60.0, "openweight_capability": 55.0, "ai_safety": 26.0, "resilience": 40.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 16.0, "public_sentiment": 21.0}
```
...
## Notepad
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Pathogen Early-Warning and Medical Countermeasure Shield −3, M5 EU Supply-Chain Bargaining Bloc −2, M6 EU Blockade Rationing and Continuity Protocol −2, priority −1 = −14
PROPOSAL BONUS: EU Blockade Rationing and Continuity Protocol (cat 6, small) +3 — taiwan_blockade landed this turn and this answers it directly
LEGITIMACY LENDS: capital 14, sentiment 21 -> +2
SOVEREIGNTY: 17 last turn, no category 4 finish, Gigafactories in flight +0, taiwan_blockade t4 −2, capability rose 2.0 −1 = 14
