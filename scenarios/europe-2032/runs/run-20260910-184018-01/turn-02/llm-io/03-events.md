...
- characters 376-1600: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1643-3689: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3745-4916: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4979-27691: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28046-28087: `{{event_history}}` from the run's own event record
