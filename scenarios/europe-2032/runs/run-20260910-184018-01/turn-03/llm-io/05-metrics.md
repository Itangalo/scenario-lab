...
- characters 13790-15216: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15260-17382: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17438-18378: `{{notepad}}` from the Game Master's notepad, carried across turns
