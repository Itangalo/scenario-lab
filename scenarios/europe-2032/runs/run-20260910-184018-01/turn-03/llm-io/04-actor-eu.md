...
- characters 1925-4047: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4967-5454: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7453-9507: `{{previous_actions}}` from the actor's own response from the previous turn
