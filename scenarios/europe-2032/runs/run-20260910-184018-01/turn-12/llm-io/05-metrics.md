...
- characters 13054-13245: `{{metrics_json}}` from the run's live metric values
- characters 13338-14226: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14269-15974: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16030-16550: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Loss-of-Control Containment and Robot Labour Shield | 2 |
