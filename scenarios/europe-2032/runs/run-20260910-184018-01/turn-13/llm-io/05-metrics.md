...
- characters 107-13365: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13408-13598: `{{metrics_json}}` from the run's live metric values
- characters 13691-15033: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15077-16898: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16954-17905: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Wronged-By-AI Redress and Manual Continuity Guarantee | 2 |
...
- `emergent_manual_system_health_crisis` -- first noted turn 13, listed in 1 turn(s) so far: Paper-based water billing and clinic appointment systems adopted under supervised manual operation suffer large-scale record loss and treatment delays during winter demand, triggering a public-health scare blamed on the manual fallback itself.
...
## Metrics
```json
{"ai_capability": 68.0, "openweight_capability": 66.0, "ai_safety": 17.0, "resilience": 57.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 0.0, "public_sentiment": 4.0}
```
...
## Notepad
PORTFOLIO CHARGE t13: M12 EU Wronged-By-AI Redress and Manual Continuity Guarantee −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 0 -> none, capital higher
SOVEREIGNTY: 17 last turn, no cat 4 finish or in flight, embodied_ai_deployment t13 −2, capability rose 1.0 −0 = 15
