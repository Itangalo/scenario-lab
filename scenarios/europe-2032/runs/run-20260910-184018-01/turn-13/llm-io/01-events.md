...
- characters 376-1718: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1762-3583: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3639-4216: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4279-27240: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27595-28754: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M11 EU Loss-of-Control Containment and Robot Labour Shield −2, M12 EU Wronged-By-AI Redress and Manual Continuity Guarantee −2, priority −1 not charged (capital below 20, no effect) = −4
PROPOSAL BONUS: EU Wronged-By-AI Redress and Manual Continuity Guarantee (cat 2, small) +2 — automated_decision_scandal and vendor lockout backlash landed this turn and this answers both directly
LEGITIMACY LENDS: capital 10, sentiment 3 -> none, capital not lower
SOVEREIGNTY: 17 last turn, no capacity event, no cat 4 finish or in flight, capability rose 1.0 −0 = 17
...
- Turn 2 (11 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, emergent_biosecurity_publishing_freeze
- Turn 3 (10 turn(s) ago): openweight_frontier_release, supply_chain_coercion
- Turn 4 (9 turn(s) ago): taiwan_blockade, eval_anomaly_reports
- Turn 5 (8 turn(s) ago): bio_incident, eval_anomaly_reports, research_breakthrough, export_control_escalation, election_alliance
- Turn 6 (7 turn(s) ago): loss_of_control_incident, embodied_ai_deployment, us_china_agreement, adoption_success, automated_decision_scandal
- Turn 7 (6 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, bio_uplift_findings, adoption_success
- Turn 8 (5 turn(s) ago): labour_displacement, automated_decision_scandal
- Turn 9 (4 turn(s) ago): cyber_major_incident, research_breakthrough
- Turn 10 (3 turn(s) ago): medical_breakthrough, emergent_anti_ai_infrastructure_blockades
- Turn 11 (2 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release, embodied_ai_deployment
- Turn 12 (1 turn(s) ago): automated_decision_scandal, emergent_vendor_lockout_backlash
