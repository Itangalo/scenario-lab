...
- characters 13793-16610: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16654-18357: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18413-18993: `{{notepad}}` from the Game Master's notepad, carried across turns
