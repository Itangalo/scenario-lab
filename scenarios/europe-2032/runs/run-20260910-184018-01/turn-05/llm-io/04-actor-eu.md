...
- characters 455-3272: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3316-5019: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8243-8730: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11077-12973: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Blockade Rationing and Continuity Protocol | 6 | small | 4 | 6 | own jurisdiction | resilience up moderately, eu_ai_sovereignty preserved from falling | 2 | running |
