...
- characters 1713-4005: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4061-4895: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4958-32424: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32779-33520: `{{event_history}}` from the run's own event record
...
- `emergent_robot_update_disruption` -- first noted turn 8, listed in 2 turn(s) so far: A Chinese vendor pushes a mandatory firmware update to warehouse robotics fleets in Rotterdam and Hamburg that briefly degrades throughput and triggers an EU-wide debate over remote kill-switch dependence on foreign embodied-AI stacks.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, cyber_major_incident
- Turn 2 (8 turn(s) ago): eval_anomaly_reports
- Turn 4 (6 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release
- Turn 5 (5 turn(s) ago): safety_breakthrough, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, taiwan_tension_rise, export_control_escalation
- Turn 7 (3 turn(s) ago): knowledge_work_augmented, embodied_ai_deployment
- Turn 8 (2 turn(s) ago): cyber_major_incident, openweight_frontier_release, embodied_ai_deployment, export_control_escalation, emergent_robot_update_halt
- Turn 9 (1 turn(s) ago): cyber_major_incident, taiwan_tension_rise, member_state_defection, joint_threat_response
