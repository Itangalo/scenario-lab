...
- characters 1791-4083: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6881-7317: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10173-12587: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Entry into Joint Cyber Response Pact | 8 | small | 9 | 11 | coalition | resilience up moderately, ai_safety up slightly via shared warning | 2 | running |
