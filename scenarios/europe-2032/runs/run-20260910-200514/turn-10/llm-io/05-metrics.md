...
- characters 106-12979: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13022-13214: `{{metrics_json}}` from the run's live metric values
- characters 13307-14600: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14643-16935: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16991-17464: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Entry into Joint Cyber Response Pact | 2 |
