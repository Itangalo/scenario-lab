...
- characters 13678-14695: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14739-16839: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16895-17387: `{{notepad}}` from the Game Master's notepad, carried across turns
