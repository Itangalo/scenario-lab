...
- characters 1438-3538: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3594-4086: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4149-30762: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31117-31513: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, cyber_major_incident
- Turn 2 (5 turn(s) ago): eval_anomaly_reports
- Turn 4 (3 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release
- Turn 5 (2 turn(s) ago): safety_breakthrough, election_consolidation
- Turn 6 (1 turn(s) ago): cyber_major_incident, taiwan_tension_rise, export_control_escalation
