...
- characters 105-13363: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13406-13598: `{{metrics_json}}` from the run's live metric values
- characters 13691-15099: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15142-17084: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17140-18109: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Distributed Risk Shield | 2 |
...
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Frontier Eval Triage Cell −2, priority −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 21, sentiment 33 -> +2
...
## Metrics
```json
{"ai_capability": 59.5, "openweight_capability": 54.0, "ai_safety": 27.0, "resilience": 41.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 16.0, "public_sentiment": 32.0}
```
## Narrative
### A lean half-year
