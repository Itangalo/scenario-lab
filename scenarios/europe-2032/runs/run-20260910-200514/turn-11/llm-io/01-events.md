...
- characters 378-1808: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1852-3714: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3770-4395: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4458-31924: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32279-33166: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, cyber_major_incident
- Turn 2 (9 turn(s) ago): eval_anomaly_reports
- Turn 4 (7 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release
- Turn 5 (6 turn(s) ago): safety_breakthrough, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, taiwan_tension_rise, export_control_escalation
- Turn 7 (4 turn(s) ago): knowledge_work_augmented, embodied_ai_deployment
- Turn 8 (3 turn(s) ago): cyber_major_incident, openweight_frontier_release, embodied_ai_deployment, export_control_escalation, emergent_robot_update_halt
- Turn 9 (2 turn(s) ago): cyber_major_incident, taiwan_tension_rise, member_state_defection, joint_threat_response
- Turn 10 (1 turn(s) ago): cyber_major_incident, research_breakthrough, export_control_escalation, supply_chain_coercion, member_state_defection
