...
- characters 107-13357: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13400-13590: `{{metrics_json}}` from the run's live metric values
- characters 13683-14767: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14811-16676: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16732-17095: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Municipal Continuity Backstop and Agent Containment Protocol | 2 |
...
## Metrics
```json
{"ai_capability": 70.0, "openweight_capability": 67.8, "ai_safety": 3.0, "resilience": 53.5, "eu_ai_sovereignty": 13.0, "eu_political_capital": 8.0, "public_sentiment": 3.0}
```
