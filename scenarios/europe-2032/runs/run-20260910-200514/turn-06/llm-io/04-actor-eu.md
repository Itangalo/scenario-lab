...
- characters 453-3047: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3090-5323: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6482-6942: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9077-10780: `{{previous_actions}}` from the actor's own response from the previous turn
