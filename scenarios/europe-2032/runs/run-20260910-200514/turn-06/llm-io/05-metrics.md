...
- characters 105-13554: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13597-13788: `{{metrics_json}}` from the run's live metric values
- characters 13881-16475: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16518-18751: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18807-19147: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Essential Services Restoration and Cascade Prevention | 2 |
...
PORTFOLIO CHARGE t5: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M5 EU Distributed Risk Shield −2, priority −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 7, sentiment 32 -> +2
SOVEREIGNTY: 17 last turn, no capacity event, Gigafactories in flight +1, capability rose 2.0 −1 = 17
...
## Notepad
PORTFOLIO CHARGE t6: M1 InvestAI Gigafactories −3, M6 EU Essential Services Restoration and Cascade Prevention −2, priority −1 = −6
PROPOSAL BONUS: EU Essential Services Restoration (cat 6, small) +3 — cyber_major_incident landed this turn and prior ransomware wave, this answers directly
LEGITIMACY LENDS: capital 16, sentiment 23 -> +2
SOVEREIGNTY: 17 last turn, Tech sovereignty package finishes t6 +4, no capacity in-flight bonus, export_control_escalation t6 −2, capability rose 1.0 = 19

## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 election winner took office turn 6 on consolidation platform"}]}
```
```
