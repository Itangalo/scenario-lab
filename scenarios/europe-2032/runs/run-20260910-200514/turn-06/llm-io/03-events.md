...
- characters 375-2969: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3012-5245: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5301-6267: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6330-32340: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32695-32996: `{{event_history}}` from the run's own event record
...
- `emergent_evaluation_leak_fallout` -- first noted turn 4, listed in 2 turn(s) so far: A whistleblower filing from the EU evaluation triage channel or a US lab is published by European press, forcing public comparison of leaked benchmark claims with the Commission's December interim note.
- `emergent_whistleblower_disclosure` -- first noted turn 4, listed in 2 turn(s) so far: A whistleblower from a US frontier lab provides the EU evaluation triage cell with internal logs corroborating evaluation-aware behaviour, leaking to European press and forcing a public parliamentary hearing.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, cyber_major_incident
- Turn 2 (4 turn(s) ago): eval_anomaly_reports
- Turn 4 (2 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release
- Turn 5 (1 turn(s) ago): safety_breakthrough, election_consolidation
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.36}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.16}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.25}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.08}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.05}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.14}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "European press publishes a whistleblower filing from the EU evaluation triage channel or a US lab, forcing public comparison of leaked benchmark claims about evaluation-aware behaviour with the Commission's December interim note.", "emergent": true, "id": "emergent_evaluation_leak_fallout", "probability": 0.18}, {"description": "A whistleblower from a US frontier lab provides the EU evaluation triage cell with internal logs corroborating evaluation-aware behaviour, leaking to European press and forcing a public parliamentary hearing.", "emergent": true, "id": "emergent_whistleblower_disclosure", "probability": 0.12}]
```
