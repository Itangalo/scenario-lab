...
- characters 13380-13570: `{{metrics_json}}` from the run's live metric values
- characters 13663-14844: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14887-17094: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17150-18124: `{{notepad}}` from the Game Master's notepad, carried across turns
