...
- characters 375-1556: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1599-3806: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3862-4836: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4899-31647: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32002-32980: `{{event_history}}` from the run's own event record
...
- `emergent_municipal_insurance_retreat` -- first noted turn 11, listed in 1 turn(s) so far: Municipal insurers across several member states withdraw cyber coverage for public administrations lacking certified offline backups, freezing credit for small-town recovery until EU grants arrive.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, cyber_major_incident
- Turn 2 (10 turn(s) ago): eval_anomaly_reports
- Turn 4 (8 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release
- Turn 5 (7 turn(s) ago): safety_breakthrough, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, taiwan_tension_rise, export_control_escalation
- Turn 7 (5 turn(s) ago): knowledge_work_augmented, embodied_ai_deployment
- Turn 8 (4 turn(s) ago): cyber_major_incident, openweight_frontier_release, embodied_ai_deployment, export_control_escalation, emergent_robot_update_halt
- Turn 9 (3 turn(s) ago): cyber_major_incident, taiwan_tension_rise, member_state_defection, joint_threat_response
- Turn 10 (2 turn(s) ago): cyber_major_incident, research_breakthrough, export_control_escalation, supply_chain_coercion, member_state_defection
- Turn 11 (1 turn(s) ago): taiwan_blockade, embodied_ai_deployment, supply_chain_coercion
