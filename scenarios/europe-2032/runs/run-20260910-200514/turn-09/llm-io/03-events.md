...
- characters 377-2178: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2222-4475: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4531-5456: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5519-32132: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32487-33113: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, cyber_major_incident
- Turn 2 (7 turn(s) ago): eval_anomaly_reports
- Turn 4 (5 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release
- Turn 5 (4 turn(s) ago): safety_breakthrough, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, taiwan_tension_rise, export_control_escalation
- Turn 7 (2 turn(s) ago): knowledge_work_augmented, embodied_ai_deployment
- Turn 8 (1 turn(s) ago): cyber_major_incident, openweight_frontier_release, embodied_ai_deployment, export_control_escalation, emergent_robot_update_halt
