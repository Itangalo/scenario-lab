...
- characters 13839-15640: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15684-17937: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17993-18918: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 65.5, "openweight_capability": 63.5, "ai_safety": 24.0, "resilience": 53.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 19.0, "public_sentiment": 14.0}
```
## Narrative
