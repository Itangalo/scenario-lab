...
- characters 455-2256: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2300-4553: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6102-6562: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9101-11217: `{{previous_actions}}` from the actor's own response from the previous turn
