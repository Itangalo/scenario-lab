...
- characters 455-2422: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2466-4843: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6086-6534: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8667-10630: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU Distributed Risk Shield | 6 | small | 4 | 6 | own jurisdiction | resilience up moderately, ai_safety up slightly via early warning | 2 | running |
