...
- characters 13311-15278: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15322-17699: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17755-18863: `{{notepad}}` from the Game Master's notepad, carried across turns
