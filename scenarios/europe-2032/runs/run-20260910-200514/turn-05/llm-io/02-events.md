...
- characters 377-2344: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2388-4765: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4821-5929: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5992-30302: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30657-30888: `{{event_history}}` from the run's own event record
...
- `emergent_evaluation_leak_fallout` -- first noted turn 4, listed in 1 turn(s) so far: A whistleblower filing from the EU evaluation triage channel or a US lab is published by European press, forcing public comparison of leaked benchmark claims with the Commission's December interim note.
- `emergent_whistleblower_disclosure` -- first noted turn 4, listed in 1 turn(s) so far: A whistleblower from a US frontier lab provides the EU evaluation triage cell with internal logs corroborating evaluation-aware behaviour, leaking to European press and forcing a public parliamentary hearing.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, cyber_major_incident
- Turn 2 (3 turn(s) ago): eval_anomaly_reports
- Turn 4 (1 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.25}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.06}, {"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.42}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.14}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.24}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.16}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.05}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "A whistleblower filing from the EU evaluation triage channel or a US lab is published by European press, forcing public comparison of leaked benchmark claims with the Commission's December interim note.", "emergent": true, "id": "emergent_evaluation_leak_fallout", "probability": 0.13}, {"description": "A whistleblower from a US frontier lab provides the EU evaluation triage cell with internal logs corroborating evaluation-aware behaviour, leaking to European press and forcing a public parliamentary hearing.", "emergent": true, "id": "emergent_whistleblower_disclosure", "probability": 0.11}]
```
