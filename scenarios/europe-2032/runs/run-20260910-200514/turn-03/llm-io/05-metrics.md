...
- characters 13725-14967: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15011-17013: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17069-17548: `{{notepad}}` from the Game Master's notepad, carried across turns
