...
- characters 376-2233: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2276-4445: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4501-5018: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5081-31694: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32049-32520: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, cyber_major_incident
- Turn 2 (6 turn(s) ago): eval_anomaly_reports
- Turn 4 (4 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release
- Turn 5 (3 turn(s) ago): safety_breakthrough, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, taiwan_tension_rise, export_control_escalation
