...
- characters 105-13392: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13435-13627: `{{metrics_json}}` from the run's live metric values
- characters 13720-15577: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15620-17789: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17845-18723: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Sovereign Automation Core | 2 |
| M8 | EU Municipal and Port Systems Emergency Restoration | 2 |
...
PORTFOLIO CHARGE t7: M6 EU Essential Services Restoration and Cascade Prevention −2, M7 EU Sovereign Automation Core −2, priority −1 = −5
PROPOSAL BONUS: none — knowledge_work_augmented removes displacement crisis and states rule 6 bonus does not apply; embodied deployment answered only by pilot with no dampening yet
LEGITIMACY LENDS: capital 12, sentiment 27 -> +2
SOVEREIGNTY: 19 last turn, InvestAI Gigafactories finishes t7 +4, no capacity in-flight bonus, embodied_ai_deployment t7 −2, capability rose 1.0 = 21

## Emerging developments (tracked)

- `emergent_robot_update_disruption` -- first noted turn 8, listed in 1 turn(s) so far: A Chinese vendor pushes a mandatory firmware update to warehouse robotics fleets in Rotterdam and Hamburg that briefly degrades throughput and triggers an EU-wide debate over remote kill-switch dependence on foreign embodied-AI stacks.
...
## Notepad
PORTFOLIO CHARGE t8: M7 EU Sovereign Automation Core −2, M8 EU Municipal and Port Systems Emergency Restoration −2, priority −1 = −5
PROPOSAL BONUS: EU Municipal and Port Systems Emergency Restoration (cat 6, small) +3 — cyber_major_incident plus port halt fired this turn and this answers both directly
LEGITIMACY LENDS: capital 14, sentiment 27 -> +2
SOVEREIGNTY: 21 last turn, no capacity measure finishes, M7 in flight +0, export_control_escalation t8 −2 (largest of embodied_ai_deployment t8 / export_control_escalation t8), capability rose 1.0 no charge = 19
