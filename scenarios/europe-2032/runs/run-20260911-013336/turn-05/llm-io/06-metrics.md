...
- characters 106-13048: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13091-13282: `{{metrics_json}}` from the run's live metric values
- characters 13375-15177: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15221-17831: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17887-19041: `{{notepad}}` from the Game Master's notepad, carried across turns
