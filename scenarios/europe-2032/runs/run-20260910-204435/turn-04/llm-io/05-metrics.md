...
- characters 105-13440: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13483-13675: `{{metrics_json}}` from the run's live metric values
- characters 13768-15365: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15408-17928: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17984-19137: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Trusted Hosting and Shield Continuity Pact | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Grid and Critical Systems Hardening Shield −3, Municipal Equal Protection Deployment −2, priority −1 = −12
PROPOSAL BONUS: Municipal Equal Protection Deployment (cat 6, small) +2 — answers recent intrusion-probe surge and municipal hosting backlash directly
LEGITIMACY LENDS: capital 23, sentiment 34 -> +1
SOVEREIGNTY: 21 last turn, no capacity event, no finishing measure, in flight +0, capability rose 1.5 no charge = 21

## Emerging developments (tracked)

- `emergent_municipal_build_freeze` -- first noted turn 4, listed in 1 turn(s) so far: Several municipal councils extend open-model hosting bans into broader temporary moratoriums on new data-centre construction and expansion, freezing hardening-related builds through H1 2028.
- `emergent_datacentre_sabotage_wave` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated physical sabotage hits data-centre power feeds or construction sites in two or more member states, linked to the anti-data-centre protest movement, forcing temporary shutdowns and a national debate on protection of AI infrastructure.
