...
- characters 376-1389: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1432-3498: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3554-4649: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4712-30325: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30680-31393: `{{event_history}}` from the run's own event record
...
- `emergent_grid_connection_freeze` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated physical attacks and blockades force a temporary EU-wide pause on new data-centre grid connections after sabotage spreads from three stalled gigafactory sites to subcontractors.
- `emergent_interlink_sabotage_escalation` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated physical attacks on cross-border fibre interlinks and power feeds to data-centre zones in two member states, claimed by anti-AI groups, force temporary rerouting and insurance repricing.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, openweight_frontier_release, export_control_escalation
- Turn 2 (6 turn(s) ago): cyber_defence_breakthrough, emergent_swarm_tooling_diffusion
- Turn 3 (5 turn(s) ago): cyber_defence_breakthrough, emergent_open_model_backlash
- Turn 4 (4 turn(s) ago): openweight_frontier_release, knowledge_work_augmented
- Turn 5 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, taiwan_tension_rise, emergent_datacentre_sabotage_wave, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, capability_jump, cyber_defence_breakthrough, export_control_escalation
- Turn 7 (1 turn(s) ago): labour_displacement, eu_frontier_access_denied
