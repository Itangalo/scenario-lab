...
- characters 377-1601: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1644-3906: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3962-4492: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4555-30303: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30658-31561: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Graduate Transition and Continuity Employment Pact −2, priority −1 = −3
PROPOSAL BONUS: EU Graduate Transition and Continuity Employment Pact (cat 7, small) +2 — labour_displacement landed this turn and this answers it directly
LEGITIMACY LENDS: capital 31, sentiment 19 -> none, capital is higher
SOVEREIGNTY: 27 last turn, M10 finishes t9 is cat 8 not cat 4 +0, no cat 4 in flight +0, eu_frontier_access_denied t9 −2 (largest of export_control_escalation and frontier denial), capability rose 0.7 −0 = 25
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, openweight_frontier_release, export_control_escalation
- Turn 2 (8 turn(s) ago): cyber_defence_breakthrough, emergent_swarm_tooling_diffusion
- Turn 3 (7 turn(s) ago): cyber_defence_breakthrough, emergent_open_model_backlash
- Turn 4 (6 turn(s) ago): openweight_frontier_release, knowledge_work_augmented
- Turn 5 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, taiwan_tension_rise, emergent_datacentre_sabotage_wave, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, capability_jump, cyber_defence_breakthrough, export_control_escalation
- Turn 7 (3 turn(s) ago): labour_displacement, eu_frontier_access_denied
- Turn 8 (2 turn(s) ago): taiwan_blockade, eval_anomaly_reports, knowledge_work_augmented
- Turn 9 (1 turn(s) ago): labour_displacement, export_control_escalation, eu_frontier_access_denied
