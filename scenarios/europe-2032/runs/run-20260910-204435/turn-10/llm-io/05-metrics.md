...
- characters 106-13249: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13292-13484: `{{metrics_json}}` from the run's live metric values
- characters 13577-14801: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14844-17106: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17162-18000: `{{notepad}}` from the Game Master's notepad, carried across turns
