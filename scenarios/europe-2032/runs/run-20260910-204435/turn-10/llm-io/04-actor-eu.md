...
- characters 455-1679: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1722-3984: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4341-4840: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7873-10384: `{{previous_actions}}` from the actor's own response from the previous turn
