...
- characters 106-13237: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13280-13472: `{{metrics_json}}` from the run's live metric values
- characters 13565-15121: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15165-17258: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17314-17767: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Graduate Transition and Continuity Employment Pact | 2 |
