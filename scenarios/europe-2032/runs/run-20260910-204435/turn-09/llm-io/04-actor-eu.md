...
- characters 455-2011: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2055-4148: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5267-5771: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8613-10832: `{{previous_actions}}` from the actor's own response from the previous turn
