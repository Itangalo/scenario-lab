...
- characters 377-1933: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1977-4070: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4126-5186: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5249-30997: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31352-32155: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Upstream Bargain for Compute Continuity −2, priority −1 = −3
PROPOSAL BONUS: EU Upstream Bargain for Compute Continuity (cat 8, small) +3 — taiwan_blockade landed this turn and this answers it directly
LEGITIMACY LENDS: capital 31, sentiment 21 -> none, capital is higher
SOVEREIGNTY: 25 last turn, EU Essential Continuity Stack finishes t8 +4, no capacity measure in flight +0, taiwan_blockade t8 −2, capability rose 0.7 −0 = 27

## Emerging developments (tracked)

- `emergent_grid_connection_freeze` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated physical attacks and blockades force a temporary EU-wide pause on new data-centre grid connections after sabotage spreads from three stalled gigafactory sites to subcontractors.
- `emergent_interlink_sabotage_escalation` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated physical attacks on cross-border fibre interlinks and power feeds to data-centre zones in two member states, claimed by anti-AI groups, force temporary rerouting and insurance repricing.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, openweight_frontier_release, export_control_escalation
- Turn 2 (7 turn(s) ago): cyber_defence_breakthrough, emergent_swarm_tooling_diffusion
- Turn 3 (6 turn(s) ago): cyber_defence_breakthrough, emergent_open_model_backlash
- Turn 4 (5 turn(s) ago): openweight_frontier_release, knowledge_work_augmented
- Turn 5 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, taiwan_tension_rise, emergent_datacentre_sabotage_wave, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, capability_jump, cyber_defence_breakthrough, export_control_escalation
- Turn 7 (2 turn(s) ago): labour_displacement, eu_frontier_access_denied
- Turn 8 (1 turn(s) ago): taiwan_blockade, eval_anomaly_reports, knowledge_work_augmented
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.08}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.15}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.14}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.1}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.05}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.07}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.04}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Coordinated physical attacks and blockades force a temporary EU-wide pause on new data-centre grid connections after sabotage spreads from three stalled gigafactory sites to subcontractors.", "emergent": true, "id": "emergent_grid_connection_freeze", "probability": 0.18}, {"description": "Coordinated physical attacks on cross-border fibre interlinks and power feeds to data-centre zones in two member states, claimed by anti-AI groups, force temporary rerouting and insurance repricing.", "emergent": true, "id": "emergent_interlink_sabotage_escalation", "probability": 0.14}]
```
