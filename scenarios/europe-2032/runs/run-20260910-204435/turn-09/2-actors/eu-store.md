...
| M11 | EU Graduate Transition and Continuity Employment Pact | 7 | small | 9 | 11 | own jurisdiction | resilience up slightly, public_sentiment up materially via employment | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Graduate Transition and Continuity Employment Pact", "category": 7, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up slightly, public_sentiment up materially via employment"}, "grounds": "convert displacement shock into staffed continuity capacity"}
  - Grounds: convert displacement shock into staffed continuity capacity
