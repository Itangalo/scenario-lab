...
- characters 377-2116: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2159-3862: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3918-4423: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4486-29573: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29928-30973: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, openweight_frontier_release, export_control_escalation
- Turn 2 (10 turn(s) ago): cyber_defence_breakthrough, emergent_swarm_tooling_diffusion
- Turn 3 (9 turn(s) ago): cyber_defence_breakthrough, emergent_open_model_backlash
- Turn 4 (8 turn(s) ago): openweight_frontier_release, knowledge_work_augmented
- Turn 5 (7 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, taiwan_tension_rise, emergent_datacentre_sabotage_wave, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, capability_jump, cyber_defence_breakthrough, export_control_escalation
- Turn 7 (5 turn(s) ago): labour_displacement, eu_frontier_access_denied
- Turn 8 (4 turn(s) ago): taiwan_blockade, eval_anomaly_reports, knowledge_work_augmented
- Turn 9 (3 turn(s) ago): labour_displacement, export_control_escalation, eu_frontier_access_denied
- Turn 10 (2 turn(s) ago): taiwan_tension_rise
- Turn 11 (1 turn(s) ago): ai_investment_collapse, emergent_reception_site_permitting_freeze
