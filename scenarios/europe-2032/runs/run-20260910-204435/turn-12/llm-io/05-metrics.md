...
- characters 106-13316: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13359-13551: `{{metrics_json}}` from the run's live metric values
- characters 13644-15383: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15426-17129: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17185-18280: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Stranded Compute Salvage and Maintenance Corps | 2 |
| M14 | European Results Showcase for Continuity AI | 2 |
...
PORTFOLIO CHARGE t11: EU Taiwan Strait Continuity and Rationing Protocol −2, EU Stranded Compute Salvage and Maintenance Corps −2, priority −1 = −5
PROPOSAL BONUS: EU Stranded Compute Salvage and Maintenance Corps (cat 6, small) +3 — ai_investment_collapse landed this turn and this answers it directly, plus freeze makes salvage timely
...
## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M14", "fields": {"finish_turn": 13}, "grounds": "named priority"}]}
```
```
