...
- characters 107-12902: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12945-13137: `{{metrics_json}}` from the run's live metric values
- characters 13230-15101: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15145-16862: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16918-17333: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Taiwan Strait Continuity and Rationing Protocol | 2 |
