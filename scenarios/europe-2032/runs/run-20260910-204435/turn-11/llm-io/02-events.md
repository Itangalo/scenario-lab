...
- characters 378-2249: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2293-4010: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4066-4789: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4852-30600: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30955-31906: `{{event_history}}` from the run's own event record
...
- `emergent_reception_site_permitting_freeze` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated municipal blockades halt new EuroHPC reception-site grid connections across several member states, turning siting opposition into a sustained permitting freeze.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, openweight_frontier_release, export_control_escalation
- Turn 2 (9 turn(s) ago): cyber_defence_breakthrough, emergent_swarm_tooling_diffusion
- Turn 3 (8 turn(s) ago): cyber_defence_breakthrough, emergent_open_model_backlash
- Turn 4 (7 turn(s) ago): openweight_frontier_release, knowledge_work_augmented
- Turn 5 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, taiwan_tension_rise, emergent_datacentre_sabotage_wave, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, capability_jump, cyber_defence_breakthrough, export_control_escalation
- Turn 7 (4 turn(s) ago): labour_displacement, eu_frontier_access_denied
- Turn 8 (3 turn(s) ago): taiwan_blockade, eval_anomaly_reports, knowledge_work_augmented
- Turn 9 (2 turn(s) ago): labour_displacement, export_control_escalation, eu_frontier_access_denied
- Turn 10 (1 turn(s) ago): taiwan_tension_rise
