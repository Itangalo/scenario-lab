...
- characters 106-13317: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13360-13552: `{{metrics_json}}` from the run's live metric values
- characters 13645-15217: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15261-17478: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17534-18033: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | Municipal Equal Protection Deployment | 2 |
