...
- characters 107-13457: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13500-13692: `{{metrics_json}}` from the run's live metric values
- characters 13785-15506: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15550-17332: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17388-18407: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M15 | EU Loss-of-Control Incident Containment Activation | 2 |
...
- `emergent_salvage_site_occupation` -- first noted turn 12, listed in 2 turn(s) so far: Laid-off private data-centre contractors stage coordinated occupations of mothballed Zaragoza and Lyon shells, demanding conversion to public compute and halting salvage surveys for weeks.
- `emergent_salvage_site_stripping` -- first noted turn 12, listed in 2 turn(s) so far: Mothballed Zaragoza and Lyon shells are stripped for copper and cooling equipment by organised theft rings, halting salvage surveys and triggering a dispute over site security liability.
...
## Notepad
PORTFOLIO CHARGE t13: EU Loss-of-Control Incident Containment Activation −2, priority −1 = −3
PROPOSAL BONUS: EU Loss-of-Control Incident Containment Activation (cat 6, small) +3 — loss_of_control_incident fired this turn and this answers it directly
LEGITIMACY LENDS: capital 17, sentiment 15 -> none, capital is higher
SOVEREIGNTY: 25 last turn, no capacity event finish, no cat 4 in flight +0, export_control_escalation t13 −3, capability rose 0.5 −0 = 22.0
