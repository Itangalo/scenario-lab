...
- characters 378-2099: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2143-3925: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3981-5000: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5063-30150: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30505-31595: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Stranded Compute Salvage and Maintenance Corps −2, European Results Showcase for Continuity AI −2, priority −1 = −5
PROPOSAL BONUS: none — adoption_success is a positive attributable benefit, not a negative event from last three rounds
LEGITIMACY LENDS: capital 23, sentiment 15 -> none, capital is higher
SOVEREIGNTY: 25 last turn, no capacity event, no cat 4 in flight +0, capability rose 0.6 −0 = 25.0

## Emerging developments (tracked)

- `emergent_salvage_site_occupation` -- first noted turn 12, listed in 1 turn(s) so far: Laid-off private data-centre contractors stage coordinated occupations of mothballed Zaragoza and Lyon shells, demanding conversion to public compute and halting salvage surveys for weeks.
- `emergent_salvage_site_stripping` -- first noted turn 12, listed in 1 turn(s) so far: Mothballed Zaragoza and Lyon shells are stripped for copper and cooling equipment by organised theft rings, halting salvage surveys and triggering a dispute over site security liability.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, openweight_frontier_release, export_control_escalation
- Turn 2 (11 turn(s) ago): cyber_defence_breakthrough, emergent_swarm_tooling_diffusion
- Turn 3 (10 turn(s) ago): cyber_defence_breakthrough, emergent_open_model_backlash
- Turn 4 (9 turn(s) ago): openweight_frontier_release, knowledge_work_augmented
- Turn 5 (8 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, taiwan_tension_rise, emergent_datacentre_sabotage_wave, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, capability_jump, cyber_defence_breakthrough, export_control_escalation
- Turn 7 (6 turn(s) ago): labour_displacement, eu_frontier_access_denied
- Turn 8 (5 turn(s) ago): taiwan_blockade, eval_anomaly_reports, knowledge_work_augmented
- Turn 9 (4 turn(s) ago): labour_displacement, export_control_escalation, eu_frontier_access_denied
- Turn 10 (3 turn(s) ago): taiwan_tension_rise
- Turn 11 (2 turn(s) ago): ai_investment_collapse, emergent_reception_site_permitting_freeze
- Turn 12 (1 turn(s) ago): adoption_success
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.03}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.19}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.05}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.14}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.04}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "Laid-off private data-centre contractors stage coordinated occupations of mothballed Zaragoza and Lyon shells, demanding conversion to public compute and halting salvage surveys for weeks.", "emergent": true, "id": "emergent_salvage_site_occupation", "probability": 0.16}, {"description": "Mothballed Zaragoza and Lyon shells are stripped for copper and cooling equipment by organised theft rings, halting salvage surveys and triggering a dispute over site security liability.", "emergent": true, "id": "emergent_salvage_site_stripping", "probability": 0.13}]
```
