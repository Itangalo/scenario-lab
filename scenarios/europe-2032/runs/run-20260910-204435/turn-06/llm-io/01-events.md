...
- characters 376-2665: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2708-4786: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4842-5713: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5776-27676: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28031-28552: `{{event_history}}` from the run's own event record
...
- `emergent_municipal_build_freeze` -- first noted turn 4, listed in 2 turn(s) so far: Several municipal councils extend open-model hosting bans into broader temporary moratoriums on new data-centre construction and expansion, freezing hardening-related builds through H1 2028.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, openweight_frontier_release, export_control_escalation
- Turn 2 (4 turn(s) ago): cyber_defence_breakthrough, emergent_swarm_tooling_diffusion
- Turn 3 (3 turn(s) ago): cyber_defence_breakthrough, emergent_open_model_backlash
- Turn 4 (2 turn(s) ago): openweight_frontier_release, knowledge_work_augmented
- Turn 5 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, taiwan_tension_rise, emergent_datacentre_sabotage_wave, election_consolidation
