...
- characters 455-2806: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2850-4759: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5536-6040: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8689-10725: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Breakthrough Defence Rollout to Municipal Shield | 6 | small | 6 | 8 | own jurisdiction | resilience up materially, ai_safety up slightly via detection | 2 | running |
