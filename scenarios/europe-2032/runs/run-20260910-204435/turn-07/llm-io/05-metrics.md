...
- characters 106-13242: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13285-13477: `{{metrics_json}}` from the run's live metric values
- characters 13570-15921: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15965-17874: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17930-19081: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Breakthrough Defence Rollout to Municipal Shield | 2 |
| M9 | EU Essential Continuity Stack | 2 |
...
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, EU Breakthrough Defence Rollout to Municipal Shield −2, priority −1 = −6
PROPOSAL BONUS: EU Breakthrough Defence Rollout to Municipal Shield (cat 6, small) +3 — cyber_major_incident landed this turn and cyber_defence_breakthrough gives it something proven to deploy
LEGITIMACY LENDS: capital 28, sentiment 26 -> none, capital is higher
SOVEREIGNTY: 19 last turn, Tech sovereignty package finishes t6 +5, no capacity event in flight +0, export_control_escalation t6 −2, capability rose 4.0 −1 = 21
