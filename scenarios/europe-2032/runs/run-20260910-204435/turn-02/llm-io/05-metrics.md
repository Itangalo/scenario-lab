...
- characters 13269-14151: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14194-16315: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16371-17188: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Swarm Detection Fast-Track | 2 |
...
- `emergent_open_model_backlash` -- first noted turn 1, listed in 2 turn(s) so far: Major European press investigation traces Kimi K3-derived cyber tooling to an EU-hosted botnet rental service, triggering municipal bans on open-model hosting and first physical protests at data centre sites.
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 50.0, "ai_safety": 30.0, "resilience": 36.5, "eu_ai_sovereignty": 21.0, "eu_political_capital": 35.0, "public_sentiment": 38.0}
```
## Narrative
