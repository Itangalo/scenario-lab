...
- characters 2245-4477: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7296-7771: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10036-12209: `{{previous_actions}}` from the actor's own response from the previous turn
