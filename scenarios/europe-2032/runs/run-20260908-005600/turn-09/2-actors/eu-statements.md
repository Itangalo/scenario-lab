...
- `two_year_commitment` (commitment): Secure autonomous AI capacity through resilient public infrastructure and enforceable allocation of strategic resources

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure autonomous AI capacity through resilient public infrastructure and enforceable allocation of strategic resources
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the timeframe for the original pledge, altering the cost and relevance of maintaining it.
