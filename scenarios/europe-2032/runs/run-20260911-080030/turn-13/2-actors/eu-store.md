...
| M11 | EU Agentic Containment and Essential Services Isolation Protocol | 6 | small | 11 | 13 | own jurisdiction | resilience up moderately, ai_safety protected | 2 | finished |
| M12 | EU Joint Telemetry and Mutual Aid Accession | 6 | small | 12 | 14 | own jurisdiction with coalition partners | resilience up moderately | 2 | running |
| M13 | EU Lost Cohort Jobs and Cures Bridge | 7 | small | 13 | 15 | own jurisdiction | resilience up via social absorption, public_sentiment up | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Lost Cohort Jobs and Cures Bridge", "category": 7, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up via social absorption, public_sentiment up"}, "grounds": "to hold livelihoods and deliver cures under services commitment"}
  - Grounds: to hold livelihoods and deliver cures under services commitment
