...
| M11 | EU Agentic Containment and Essential Services Isolation Protocol | 6 | small | 11 | 13 | own jurisdiction | resilience up moderately, ai_safety protected | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Joint Telemetry and Mutual Aid Accession", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction with coalition partners", "targeted_effect": "resilience up moderately"}, "grounds": "to take up joint threat response protection under services commitment"}
  - Grounds: to take up joint threat response protection under services commitment
