...
- characters 107-13693: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13736-13928: `{{metrics_json}}` from the run's live metric values
- characters 14021-15501: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15545-17600: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17656-18986: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M13 | EU Automation Shock Absorber for Displaced Entrants and Embodied-AI Exposed Workers | 2 |
