...
- characters 1816-3981: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6662-7119: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10116-12192: `{{previous_actions}}` from the actor's own response from the previous turn
