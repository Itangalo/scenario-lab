...
- characters 377-1694: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1738-3903: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3959-5029: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5092-34705: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35060-35605: `{{event_history}}` from the run's own event record
...
- Turn 3 (6 turn(s) ago): safety_breakthrough, automated_decision_scandal
- Turn 4 (5 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise
- Turn 5 (4 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, embodied_ai_deployment, taiwan_tension_rise, election_alliance
- Turn 6 (3 turn(s) ago): capability_jump, eval_anomaly_reports, rsi_onset, adoption_success
- Turn 7 (2 turn(s) ago): loss_of_control_incident, capability_jump, taiwan_tension_rise
- Turn 8 (1 turn(s) ago): opaque_reasoning
