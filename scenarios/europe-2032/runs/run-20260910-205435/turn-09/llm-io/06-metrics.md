...
- characters 106-13040: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13083-13275: `{{metrics_json}}` from the run's live metric values
- characters 13368-14685: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14729-16894: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16950-17420: `{{notepad}}` from the Game Master's notepad, carried across turns
