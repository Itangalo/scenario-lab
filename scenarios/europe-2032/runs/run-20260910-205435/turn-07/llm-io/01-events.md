...
- characters 377-2704: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2748-5225: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5281-5728: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5791-35056: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35411-35824: `{{event_history}}` from the run's own event record
...
- Turn 3 (4 turn(s) ago): safety_breakthrough, automated_decision_scandal
- Turn 4 (3 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise
- Turn 5 (2 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, embodied_ai_deployment, taiwan_tension_rise, election_alliance
- Turn 6 (1 turn(s) ago): capability_jump, eval_anomaly_reports, rsi_onset, adoption_success
