...
- characters 106-13360: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13403-13595: `{{metrics_json}}` from the run's live metric values
- characters 13688-16015: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16059-18536: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18592-19639: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | EU Loss-of-Control Rapid Containment Surge | 2 |
