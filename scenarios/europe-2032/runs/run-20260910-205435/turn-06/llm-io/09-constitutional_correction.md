...
- characters 2575-3205: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 75.0, "openweight_capability": 64.0, "ai_safety": 24.0, "resilience": 47.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 22.0, "public_sentiment": 26.0}
```
