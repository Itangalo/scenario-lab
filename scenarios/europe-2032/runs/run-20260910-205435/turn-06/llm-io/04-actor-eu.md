...
- characters 2437-4527: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6066-6523: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8958-11456: `{{previous_actions}}` from the actor's own response from the previous turn
