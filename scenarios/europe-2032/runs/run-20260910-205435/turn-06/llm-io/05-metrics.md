...
- characters 105-13888: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13931-14123: `{{metrics_json}}` from the run's live metric values
- characters 14216-16156: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16199-18289: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18345-18975: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | EU Trusted Public AI Dividend | 2 |
