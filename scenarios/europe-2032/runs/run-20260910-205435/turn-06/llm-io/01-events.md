...
- characters 2359-4449: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4505-5452: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5515-32656: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33011-33331: `{{event_history}}` from the run's own event record
...
- `emergent_fraud_wave` -- first noted turn 4, listed in 2 turn(s) so far: A coordinated wave of AI-generated voice and document fraud hits welfare offices and regional banks in several member states, using openly available models to impersonate claimants and officials at scale.
...
- Turn 3 (3 turn(s) ago): safety_breakthrough, automated_decision_scandal
- Turn 4 (2 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise
- Turn 5 (1 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, embodied_ai_deployment, taiwan_tension_rise, election_alliance
