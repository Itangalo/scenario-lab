...
- characters 376-1355: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1398-3548: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3604-4676: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4739-35050: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35405-35907: `{{event_history}}` from the run's own event record
...
- `emergent_anti_datacentre_blockades` -- first noted turn 7, listed in 1 turn(s) so far: A coordinated physical protest campaign blocks construction and grid hook-up for gigafactory and data-centre sites in several member states, delaying buildout independent of EU funding decisions.
- `emergent_municipal_shield_revolt` -- first noted turn 7, listed in 1 turn(s) so far: Municipal water operators across several member states publicly refuse to connect Shield sensors, citing staffing and cost, leaving a documented gap in EU critical-infrastructure coverage.
...
- Turn 3 (5 turn(s) ago): safety_breakthrough, automated_decision_scandal
- Turn 4 (4 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise
- Turn 5 (3 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, embodied_ai_deployment, taiwan_tension_rise, election_alliance
- Turn 6 (2 turn(s) ago): capability_jump, eval_anomaly_reports, rsi_onset, adoption_success
- Turn 7 (1 turn(s) ago): loss_of_control_incident, capability_jump, taiwan_tension_rise
