...
- characters 1476-3626: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4304-4761: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7419-9466: `{{previous_actions}}` from the actor's own response from the previous turn
