...
- characters 377-1317: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1361-3378: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3434-4002: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4065-33678: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34033-35040: `{{event_history}}` from the run's own event record
...
- Turn 3 (10 turn(s) ago): safety_breakthrough, automated_decision_scandal
- Turn 4 (9 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise
- Turn 5 (8 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, embodied_ai_deployment, taiwan_tension_rise, election_alliance
- Turn 6 (7 turn(s) ago): capability_jump, eval_anomaly_reports, rsi_onset, adoption_success
- Turn 7 (6 turn(s) ago): loss_of_control_incident, capability_jump, taiwan_tension_rise
- Turn 8 (5 turn(s) ago): opaque_reasoning
- Turn 9 (4 turn(s) ago): cyber_major_incident, research_breakthrough, safety_breakthrough, labour_displacement, emergent_municipal_shield_revolt
- Turn 10 (3 turn(s) ago): labour_displacement, taiwan_tension_rise, eu_frontier_access_denied
- Turn 11 (2 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment
- Turn 12 (1 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, safety_breakthrough, adoption_success, emergent_graduate_protest_wave
