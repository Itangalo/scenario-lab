...
- characters 376-1947: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1990-4365: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4421-5467: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5530-28607: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28962-29003: `{{event_history}}` from the run's own event record
