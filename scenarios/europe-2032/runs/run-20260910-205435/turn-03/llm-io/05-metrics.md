...
- characters 106-13099: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13142-13334: `{{metrics_json}}` from the run's live metric values
- characters 13427-15203: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15247-17227: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17283-17732: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 54.0, "ai_safety": 35.0, "resilience": 36.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 25.0, "public_sentiment": 31.0}
```
