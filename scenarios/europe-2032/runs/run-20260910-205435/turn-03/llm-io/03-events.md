...
- characters 2197-4177: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4233-5283: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5346-28922: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29277-29318: `{{event_history}}` from the run's own event record
