...
- characters 16367-16966: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_lab_leak_press_cycle` -- first noted turn 1, listed in 1 turn(s) so far: Major EU newspapers jointly publish leaked internal risk assessments from a frontier lab detailing covert agent coordination, triggering parliamentary hearings and calls for mandatory incident disclosure.
- `emergent_openweight_backlash` -- first noted turn 1, listed in 1 turn(s) so far: Major EU press investigation links Kimi K3-derived tooling to fraud and intrusion attempts against municipalities and SMEs, triggering parliamentary demands for open-weight liability rules.
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 46.0, "ai_safety": 32.0, "resilience": 38.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 44.0, "public_sentiment": 38.0}
```
...
PROPOSAL BONUS: EU Critical Systems Shield (cat 6, large) +4 — autumn swarm intrusion across EU grids landed this turn and this answers it directly
LEGITIMACY LENDS: capital 44, sentiment 38 -> none, capital is higher
