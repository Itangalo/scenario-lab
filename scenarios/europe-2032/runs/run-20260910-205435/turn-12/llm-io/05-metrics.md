...
- characters 106-13553: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13596-13788: `{{metrics_json}}` from the run's live metric values
- characters 13881-15641: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15684-17875: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17931-18550: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M14 | EU Swarm Defence and Essential Services Restoration Sprint | 2 |
...
## Metrics
```json
{"ai_capability": 90.5, "openweight_capability": 86.7, "ai_safety": 25.0, "resilience": 35.5, "eu_ai_sovereignty": 11.0, "eu_political_capital": 25.0, "public_sentiment": 6.0}
```
