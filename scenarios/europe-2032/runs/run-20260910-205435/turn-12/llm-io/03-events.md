...
- characters 377-2137: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2180-4371: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4427-5679: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5742-35355: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35710-36569: `{{event_history}}` from the run's own event record
...
- `emergent_graduate_protest_wave` -- first noted turn 10, listed in 2 turn(s) so far: Coordinated graduate-led protests across several EU capitals fuse hiring collapse with data-centre opposition, occupying university buildings and disrupting council meetings to demand hiring quotas and a moratorium on public-sector automation.
- `emergent_datacentre_sabotage_wave` -- first noted turn 10, listed in 2 turn(s) so far: Coordinated physical sabotage and blockades force temporary shutdown of one or more EU data-centre construction sites amid spreading protests and graduate unemployment anger.
...
- Turn 3 (9 turn(s) ago): safety_breakthrough, automated_decision_scandal
- Turn 4 (8 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise
- Turn 5 (7 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, embodied_ai_deployment, taiwan_tension_rise, election_alliance
- Turn 6 (6 turn(s) ago): capability_jump, eval_anomaly_reports, rsi_onset, adoption_success
- Turn 7 (5 turn(s) ago): loss_of_control_incident, capability_jump, taiwan_tension_rise
- Turn 8 (4 turn(s) ago): opaque_reasoning
- Turn 9 (3 turn(s) ago): cyber_major_incident, research_breakthrough, safety_breakthrough, labour_displacement, emergent_municipal_shield_revolt
- Turn 10 (2 turn(s) ago): labour_displacement, taiwan_tension_rise, eu_frontier_access_denied
- Turn 11 (1 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment
