...
- characters 106-13124: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13167-13359: `{{metrics_json}}` from the run's live metric values
- characters 13452-14533: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14576-16669: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16725-17900: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M11 | EU Essential Services Continuity and Shield Repair Fund | 2 |
| M12 | EU Denied-Model Substitution and Essential-User Continuity Facility | 2 |
...
PORTFOLIO CHARGE t9: EU Black-Box Assurance and Activation Inspection Programme −2, EU Essential Services Continuity and Shield Repair Fund −2, priority −1 = −5
PROPOSAL BONUS: EU Essential Services Continuity and Shield Repair Fund (cat 6, small) +3 — cyber_major_incident landed this turn severe plus municipal refusal and labour displacement, this answers them directly
LEGITIMACY LENDS: capital 27, sentiment 20 -> none, capital higher
SOVEREIGNTY: 17 last turn, no capacity event, no cat4 finish or in flight, capability rose 3.0 −1 = 16
