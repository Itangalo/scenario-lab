...
- characters 455-1536: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1579-3672: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4716-5188: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8388-10982: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Black-Box Assurance and Activation Inspection Programme | 5 | small | 8 | 11 | own jurisdiction | ai_safety up moderately, resilience up slightly via detection | 2 | running |
| M11 | EU Essential Services Continuity and Shield Repair Fund | 6 | small | 9 | 11 | own jurisdiction | resilience up substantially, public_sentiment up slightly via service continuity | 2 | running |
