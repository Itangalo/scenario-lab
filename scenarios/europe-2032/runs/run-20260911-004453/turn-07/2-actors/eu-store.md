...
| M9 | EU Degraded-Mode Continuity Regime for Hospitals, Grid and Municipal Services | 6 | small | 7 | 9 | own jurisdiction | resilience up moderately, eu_political_capital protected | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Degraded-Mode Continuity Regime for Hospitals, Grid and Municipal Services", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital protected"}, "grounds": "to hold essential services through the rupture on capacity we already have"}
  - Grounds: to hold essential services through the rupture on capacity we already have
