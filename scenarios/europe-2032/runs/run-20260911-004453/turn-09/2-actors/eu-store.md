...
| M9 | EU Degraded-Mode Continuity Regime for Hospitals, Grid and Municipal Services | 6 | small | 7 | 8 | own jurisdiction | resilience up moderately, eu_political_capital protected | 2 | finished |
| M10 | EU Jump-Triggered Review and Conditional Deployment Hold | 1 | small | 8 | 9 | own jurisdiction | ai_safety up, resilience protected | 2 | finished |
| M11 | EU Essential Services Survival and Cyber-Bio Mutual Aid Regime | 6 | small | 9 | 11 | own jurisdiction | resilience up moderately, eu_political_capital protected | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Essential Services Survival and Cyber-Bio Mutual Aid Regime", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital protected"}, "grounds": "to absorb major cyber incident and bio uplift under RSI with safety collapsed"}
  - Grounds: to absorb major cyber incident and bio uplift under RSI with safety collapsed
