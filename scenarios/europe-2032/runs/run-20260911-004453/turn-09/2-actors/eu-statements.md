...
- `two_year_commitment` (commitment): Keep essential services, livelihoods and democratic continuity running through ungovernable frontier capability

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Keep essential services, livelihoods and democratic continuity running through ungovernable frontier capability
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly changes the actor's obligation to uphold the original statement, triggering a necessary reassessment.
