...
| M7 | Municipal Lifeline Repair and Harden | 6 | small | 8 | 10 | own jurisdiction | resilience up, eu_political_capital up modestly via visible restoration | 2 | running |
...
- **applied** `M7` — {"op": "add", "table": "measures", "fields": {"name": "Municipal Lifeline Repair and Harden", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_political_capital up modestly via visible restoration"}, "grounds": "second automated sweep left wards on paper and ports dark with capital near zero"}
  - Grounds: second automated sweep left wards on paper and ports dark with capital near zero
