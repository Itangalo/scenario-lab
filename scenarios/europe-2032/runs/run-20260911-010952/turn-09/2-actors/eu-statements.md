...
- `two_year_commitment` (commitment): Restore functioning public services and democratic consent for AI under EU control

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Restore functioning public services and democratic consent for AI under EU control
