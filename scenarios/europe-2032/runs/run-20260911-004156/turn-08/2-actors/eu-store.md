...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio-Cyber-Physical Shield for Care and Ports", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety protected"}, "grounds": "to contain bio-uplift and fleet failure while holding care continuity"}
  - Grounds: to contain bio-uplift and fleet failure while holding care continuity
