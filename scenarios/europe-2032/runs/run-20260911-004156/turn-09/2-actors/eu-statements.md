...
- `two_year_commitment` (commitment): Survive untrusted frontier capability by hardening health and essential services

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Survive untrusted frontier capability by hardening health and essential services
