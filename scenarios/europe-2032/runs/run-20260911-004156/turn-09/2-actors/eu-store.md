...
| M9 | EU Denied-Access Continuity Switch for Hospitals and Public Services | 6 | small | 7 | 9 | own jurisdiction | resilience up, eu_political_capital protected | 2 | finished |
| M10 | EU Bio-Cyber-Physical Shield for Care and Ports | 6 | small | 8 | 10 | own jurisdiction | resilience up, ai_safety protected | 2 | running |
| M11 | EU Sentinel Bio-Response and Care Continuity Network | 6 | small | 9 | 12 | own jurisdiction | resilience up moderately, ai_safety protected | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Sentinel Bio-Response and Care Continuity Network", "category": 6, "size": "small", "finish_turn": 12, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected"}, "grounds": "to make bio-detection surge permanent under untrusted capability"}
  - Grounds: to make bio-detection surge permanent under untrusted capability
