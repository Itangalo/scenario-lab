...
- characters 106-13070: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13113-13303: `{{metrics_json}}` from the run's live metric values
- characters 13396-14436: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14479-16787: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16843-17357: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Entry-Level Transition and Essential Service Corps | 2 |
...
## Metrics
```json
{"ai_capability": 90.5, "openweight_capability": 84.5, "ai_safety": 1.0, "resilience": 46.5, "eu_ai_sovereignty": 16.0, "eu_political_capital": 3.0, "public_sentiment": 14.0}
```
...
## Notepad
PORTFOLIO CHARGE t10: M10 EU Entry-Level Transition and Essential Service Corps −2, priority no effect under capital below 20 = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 3, sentiment 14 -> +2 (capped below sentiment, included in capital)
