...
- characters 92-282: `{{metrics_json}}` from the run's live metric values
- characters 375-1415: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1458-3766: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3822-4336: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4399-33179: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33534-34435: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M10 EU Entry-Level Transition and Essential Service Corps −2, priority no effect under capital below 20 = −2
PROPOSAL BONUS: EU Entry-Level Transition and Essential Service Corps (cat 7, small) +4 — labour_displacement landed this turn severe graduate hiring collapse and this answers it directly
LEGITIMACY LENDS: capital 7, sentiment 20 -> +2 (capped below sentiment, included in capital)
SOVEREIGNTY: 18 last turn, no capacity event, no cat4 finish or in-flight, capability rose 3.5 −1 = 17
...
- Turn 1 (9 turn(s) ago): cyber_test_shot
- Turn 2 (8 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, emergent_intrusion_tooling_copycats
- Turn 3 (7 turn(s) ago): loss_of_control_incident, capability_jump, eu_frontier_access_denied, adoption_success
- Turn 4 (6 turn(s) ago): bio_incident, taiwan_blockade, bio_uplift_findings, knowledge_work_augmented, embodied_ai_deployment
- Turn 5 (5 turn(s) ago): eval_anomaly_reports, adoption_success, emergent_utility_isolation_backfire, emergent_cyber_insurance_retreat, election_alliance
- Turn 6 (4 turn(s) ago): capability_jump, embodied_ai_deployment
- Turn 7 (3 turn(s) ago): cyber_major_incident, capability_jump, medical_breakthrough, safety_breakthrough, taiwan_tension_rise
- Turn 8 (2 turn(s) ago): rsi_onset, member_state_defection, adoption_success
- Turn 9 (1 turn(s) ago): capability_jump, labour_displacement, adoption_success
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.12}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.08}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_loss_of_control_incident", "probability": 0.02}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.025}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_great_power_conflict", "probability": 0.11}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_labs_nationalised", "probability": 0.12}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}]
```
