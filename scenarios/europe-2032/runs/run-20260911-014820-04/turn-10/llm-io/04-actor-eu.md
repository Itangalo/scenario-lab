...
- characters 453-1493: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1536-3844: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7154-7617: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10634-13308: `{{previous_actions}}` from the actor's own response from the previous turn
...
### The jump
Autumn began with a release that made spring look incremental. Two American labs within weeks demonstrated systems that planned multi-day work, used tools without prompting, and improved parts of their own training pipelines. European deployment teams said their evaluation checklists were obsolete on arrival. Human review of frontier behaviour became a formality.

In Brussels the shift was felt in concrete and queues. Fenced compute sites faced another season of cut cables and halted works, now guarded as routine. At the same time law firms, accountancies, software houses and customer-operations centres simply stopped hiring juniors. Graduate unemployment maps turned dark in university cities; the absence of offers was not disputed, only its cause.

### Dividend pays, partially
The Trusted Adoption Dividend closed as scheduled. One-stop permit modules and therapy-scheduling assistants cut waiting times sharply where they were installed on EU-anchored capacity — clinics in Lyon, Porto and Gdansk posted falling queues. But chips reserved on paper were still arriving late, installations stalled in half the member states, and the side-deal for hyperscale capacity remained outside common terms. Conditionality on funds contained the split without healing it.

Washington's allied-access track stayed in drafting. No European firm was onboarded; insurers kept their surcharges.

### The Corps that could not move fast enough
To answer the hiring collapse, the Union launched wage-insurance and paid placements — retraining juniors alongside AI, and 12-month posts in hospitals, municipalities and guarded build sites. Councils welcomed it, mayors asked for slots immediately.

Delivery lagged the announcement. ESF+ top-ups and underspend took months to clear, placements numbered in thousands against tens of thousands missing jobs, and firms kept juniors only where subsidies covered most of the wage. Voters saw EU-paid work in some wards and empty job boards in others. Gratitude for visible help mixed with anger at dependence, and opposition parties ran openly against data-centre expansion.

Hospitals and ports held — degraded, not stopped — but the Union entered winter with thinner assurances, tighter budgets and a public that used AI daily and resented it just as daily.
...
- `two_year_commitment` (commitment): Hold essential services, livelihoods and democratic agency through broadly superhuman AI
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Entry-Level Transition and Essential Service Corps | 7 | small | 9 | 11 | own jurisdiction | public_sentiment up, resilience up modestly, eu_political_capital up modestly | 2 | running |
...
| M7 | EU Embodied AI Containment and Continuity Protocol | 6 | small | 6 | 8 | own jurisdiction | resilience up modestly, ai_safety up modestly | 2 | finished |
| M8 | EU Cyber Recovery and Service Continuity Surge | 6 | small | 7 | 8 | own jurisdiction | resilience up, ai_safety up modestly, public_sentiment up modestly | 2 | finished |
| M9 | EU Trusted Adoption Dividend | 9 | small | 8 | 9 | own jurisdiction | public_sentiment up, eu_political_capital up modestly, resilience up modestly | 2 | finished |
...
## Two-year commitment
Hold essential services, livelihoods and democratic agency through broadly superhuman AI

## Statement changes
modify `two_year_commitment` (commitment): Hold essential services, livelihoods and democratic agency through broadly superhuman AI
- Trigger: the two-year commitment period closes this turn

## New measure
**EU Entry-Level Transition and Essential Service Corps**
Creates EU-funded wage-insurance, rapid retraining and paid essential-service placements for displaced graduates and admin/customer-operations workers, tied to municipalities and hospitals already under the Continuity Shield. Category 7 labour and social protection measure — why this and why now: with capability at 85.5, open weights at 74.5, safety at 4, capital at 12 and sentiment at 21, labour displacement in law, accountancy, software and admin is the shock that will break cohesion and guarding of build sites, while the Dividend's adoption success gives us placement sites where help is visibly needed.

## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Entry-Level Transition and Essential Service Corps", "category": 7, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, resilience up modestly, eu_political_capital up modestly"}, "grounds": "labour displacement must be answered now to hold consent for sovereignty build"}]}
```

## Priority
M10 EU Entry-Level Transition and Essential Service Corps — because without stemming graduate and white-collar hiring collapse no compute, resilience or adoption measure survives public hostility and site sabotage this turn.

## In practice
We run the Corps through DG EMPL and the ESF+ with top-up from the Dividend underspend, via EPSCO and the Competitiveness Council: wage-insurance for firms that retain-retrain juniors alongside AI, plus 12-month paid placements in hospitals, municipalities and civil-protection-guarded build sites doing offline-backup, port-check and permit-module work. Conditionality answers the side-deal split — Dividend and Corps funds flow only on common procurement terms.

We finish under the old commitment by holding what we built: NIS2 joint teams keep hospital/port continuity without new cost, ENISA hardens Dividend deployments on EU-anchored compute only, and DG GROW uses permitting/grid-reservation law to push reserved chips into racks with civil-protection guarding, while TTC allied-access is kept warm but not waited for. No new frontier restriction we cannot enforce; survival is keeping services degraded-not-stopped and voters seeing EU-paid work where AI took jobs.
...
```
## New measure
None this turn — waiting for the Entry-Level Corps to finish landing and for capital to recover before staking another instrument.

## Store changes
No changes.

## Priority
M10 EU Entry-Level Transition and Essential Service Corps — because with graduate hiring collapsed, sabotage routine, and an automated-decision scandal breaking, visible EU-paid work in hospitals and municipalities is the only thing holding consent for everything else.

## In practice
We run what we have. DG EMPL pushes ESF+ clearances through EPSCO to get Corps placements from thousands toward tens of thousands, prioritising Lyon, Porto, Gdansk Dividend sites and guarded build sites where sabotage threatens chips still arriving late. NIS2 joint teams and ENISA keep hospitals and ports degraded-not-stopped, and harden permit and therapy assistants on EU-anchored capacity only.

On the scandal — a benefits-scoring system in two member states found to have systematically cut entitlements, with caseworker oversight at seconds-per-case and logs never read — we do not open a new instrument. The Commission frames it as breach of Annex III high-risk obligations, not a gap in the Act itself, orders conformity-body review and suspends the deployments pending human-review remediation, to avoid making restriction cheap and adoption impossible for years. On Taiwan surcharges and the US medical and research breakthroughs arriving on terms we cannot access, we keep TTC allied-access warm, invoke Anti-Coercion monitoring without escalation, and direct procurement to EU-anchored capacity where it exists.
