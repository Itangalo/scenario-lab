...
- characters 106-13168: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13211-13403: `{{metrics_json}}` from the run's live metric values
- characters 13496-14790: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14834-16702: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16758-17765: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t2: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Services Shield −3, priority −1 = −10
