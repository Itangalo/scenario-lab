...
- characters 376-1221: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1265-3124: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3180-3491: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3554-28095: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28450-29482: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M9 EU Strait-Proof Continuity Reserve −2, priority −0 (no effect, capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 7, sentiment 24 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, no cat4 in flight +0, capability rose 0.8 −0 = 19
...
- Turn 2 (11 turn(s) ago): capability_jump
- Turn 3 (10 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, adoption_success
- Turn 5 (8 turn(s) ago): openweight_frontier_release, member_state_defection, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, openweight_frontier_release, member_state_defection, adoption_success, emergent_clinical_hallucination_backlash
- Turn 7 (6 turn(s) ago): bio_uplift_findings, capability_jump, opaque_reasoning, knowledge_work_augmented, member_state_defection
- Turn 8 (5 turn(s) ago): eval_anomaly_reports, medical_breakthrough, adoption_success, joint_threat_response
- Turn 9 (4 turn(s) ago): emergent_clinical_ai_suspension
- Turn 10 (3 turn(s) ago): openweight_frontier_release, middle_power_coalition
- Turn 11 (2 turn(s) ago): research_breakthrough, taiwan_tension_rise
- Turn 12 (1 turn(s) ago): knowledge_work_augmented, emergent_clinical_staff_walkout
