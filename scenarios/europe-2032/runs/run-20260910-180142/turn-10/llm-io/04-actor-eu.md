...
- characters 1535-3467: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4361-4812: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7515-9575: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Clinical AI Safety Review and Supervised Re-entry | 1 | small | 9 | 11 | own jurisdiction | ai_safety up slightly, public_sentiment up, resilience up slightly | 2 | running |
