...
- characters 375-1414: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1457-3389: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3445-3873: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3936-28477: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28832-29627: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Clinical AI Safety Review and Supervised Re-entry −2, priority −0 (no effect, capital below 20) = −2
PROPOSAL BONUS: EU Clinical AI Safety Review and Supervised Re-entry (cat 1, small) +3 — emergent joint clinical suspension this turn and this answers it directly
LEGITIMACY LENDS: capital 0, sentiment 27 -> +2
...
- Turn 2 (8 turn(s) ago): capability_jump
- Turn 3 (7 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, adoption_success
- Turn 5 (5 turn(s) ago): openweight_frontier_release, member_state_defection, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, openweight_frontier_release, member_state_defection, adoption_success, emergent_clinical_hallucination_backlash
- Turn 7 (3 turn(s) ago): bio_uplift_findings, capability_jump, opaque_reasoning, knowledge_work_augmented, member_state_defection
- Turn 8 (2 turn(s) ago): eval_anomaly_reports, medical_breakthrough, adoption_success, joint_threat_response
- Turn 9 (1 turn(s) ago): emergent_clinical_ai_suspension
