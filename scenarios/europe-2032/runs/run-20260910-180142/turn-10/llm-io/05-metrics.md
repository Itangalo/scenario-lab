...
- characters 106-12942: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12985-13175: `{{metrics_json}}` from the run's live metric values
- characters 13268-14307: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14350-16282: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16338-17396: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Clinical AI Safety Review and Supervised Re-entry | 2 |
