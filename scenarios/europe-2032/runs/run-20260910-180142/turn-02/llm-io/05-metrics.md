...
- characters 105-13031: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13074-13266: `{{metrics_json}}` from the run's live metric values
- characters 13359-14324: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14367-16760: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16816-17902: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 50.0, "ai_safety": 23.0, "resilience": 37.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 35.0, "public_sentiment": 39.0}
```
