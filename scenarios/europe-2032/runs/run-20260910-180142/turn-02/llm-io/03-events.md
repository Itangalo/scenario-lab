...
- characters 376-1341: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1384-3777: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3833-4919: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4982-27694: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28049-28119: `{{event_history}}` from the run's own event record
