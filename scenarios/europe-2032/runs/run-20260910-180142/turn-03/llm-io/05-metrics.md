...
- characters 13760-14814: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14858-16637: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16693-17160: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M1", "fields": {"finish_turn": 7}, "grounds": "event ai_investment_collapse cancelled dependent build-out"}]}
```
```
