...
- characters 376-1272: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1316-3054: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3110-4097: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4160-28701: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29056-29931: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Clinical AI Safety Review and Supervised Re-entry −2, priority −0 (no effect, capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 3, sentiment 27 -> +2
SOVEREIGNTY: 17 last turn, no capacity event, no cat4 in flight +0, middle_power_coalition t10 +2, capability rose 1.0 −0 = 19

## Emerging developments (tracked)

- `emergent_clinical_tourism_spillover` -- first noted turn 10, listed in 1 turn(s) so far: Cross-border patient movement to jurisdictions still running AI-assisted triage and dosing, creating unmonitored treatment records that re-enter EU hospitals and undermine the supervised re-entry evaluation.
- `emergent_clinical_staff_walkout` -- first noted turn 10, listed in 1 turn(s) so far: A coordinated walkout by junior doctors and nurses in two large member states over manual overload after the AI suspension forces emergency staffing measures and further delays supervised re-entry pilots.
...
- Turn 2 (9 turn(s) ago): capability_jump
- Turn 3 (8 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, adoption_success
- Turn 5 (6 turn(s) ago): openweight_frontier_release, member_state_defection, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, openweight_frontier_release, member_state_defection, adoption_success, emergent_clinical_hallucination_backlash
- Turn 7 (4 turn(s) ago): bio_uplift_findings, capability_jump, opaque_reasoning, knowledge_work_augmented, member_state_defection
- Turn 8 (3 turn(s) ago): eval_anomaly_reports, medical_breakthrough, adoption_success, joint_threat_response
- Turn 9 (2 turn(s) ago): emergent_clinical_ai_suspension
- Turn 10 (1 turn(s) ago): openweight_frontier_release, middle_power_coalition
