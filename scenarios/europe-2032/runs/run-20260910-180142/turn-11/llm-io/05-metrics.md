...
- characters 107-13332: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13375-13565: `{{metrics_json}}` from the run's live metric values
- characters 13658-14554: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14598-16336: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16392-17379: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Strait-Proof Continuity Reserve | 2 |
