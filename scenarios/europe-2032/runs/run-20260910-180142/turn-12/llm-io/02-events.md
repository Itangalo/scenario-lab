...
- characters 375-1451: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1494-3548: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3604-4670: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4733-29274: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29629-30575: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Strait-Proof Continuity Reserve −2, priority −0 (no effect, capital below 20) = −2
PROPOSAL BONUS: EU Strait-Proof Continuity Reserve (cat 6, small) +1 — taiwan_tension_rise precursor this turn and brittle manual services, answers directly but small and just proposed
...
- `emergent_clinical_tourism_spillover` -- first noted turn 10, listed in 2 turn(s) so far: Cross-border patient movement to jurisdictions still running AI-assisted triage and dosing, creating unmonitored treatment records that re-enter EU hospitals and undermine the supervised re-entry evaluation.
- `emergent_clinical_staff_walkout` -- first noted turn 10, listed in 2 turn(s) so far: A coordinated walkout by junior doctors and nurses in two large member states over manual overload after the AI suspension forces emergency staffing measures and further delays supervised re-entry pilots.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, openweight_frontier_release
- Turn 2 (10 turn(s) ago): capability_jump
- Turn 3 (9 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, adoption_success
- Turn 5 (7 turn(s) ago): openweight_frontier_release, member_state_defection, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, openweight_frontier_release, member_state_defection, adoption_success, emergent_clinical_hallucination_backlash
- Turn 7 (5 turn(s) ago): bio_uplift_findings, capability_jump, opaque_reasoning, knowledge_work_augmented, member_state_defection
- Turn 8 (4 turn(s) ago): eval_anomaly_reports, medical_breakthrough, adoption_success, joint_threat_response
- Turn 9 (3 turn(s) ago): emergent_clinical_ai_suspension
- Turn 10 (2 turn(s) ago): openweight_frontier_release, middle_power_coalition
- Turn 11 (1 turn(s) ago): research_breakthrough, taiwan_tension_rise
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.36}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.08}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.05}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.16}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.18}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.05}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.14}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.21}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "Cross-border patient movement to jurisdictions still running AI-assisted triage and dosing, creating unmonitored treatment records that re-enter EU hospitals and undermine the supervised re-entry evaluation.", "emergent": true, "id": "emergent_clinical_tourism_spillover", "probability": 0.22}, {"description": "A coordinated walkout by junior doctors and nurses in two large member states over manual overload after the AI suspension forces emergency staffing measures and further delays supervised re-entry pilots.", "emergent": true, "id": "emergent_clinical_staff_walkout", "probability": 0.18}]
```
