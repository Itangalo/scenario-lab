...
- characters 106-12924: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12967-13157: `{{metrics_json}}` from the run's live metric values
- characters 13250-14326: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14369-16423: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16479-16915: `{{notepad}}` from the Game Master's notepad, carried across turns
