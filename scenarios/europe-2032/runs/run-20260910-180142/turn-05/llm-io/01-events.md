...
- characters 377-2008: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2052-4123: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4179-5421: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5484-31147: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31502-31708: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Evaluation Cell −2, EU Continuity Stack for Public Services −2, EU Municipal Resilience Hardening Fund −2, priority −1 = −13
PROPOSAL BONUS: EU Municipal Resilience Hardening Fund (cat 6, small) +2 — autumn grid/port intrusions contained by Shield and cut-off cascade risk last two turns, this extends hardening directly
...
- `emergent_clinical_fallback_liability` -- first noted turn 4, listed in 1 turn(s) so far: European hospital audit finds open-weights clinical fallback hallucinating dosage guidance in edge cases, triggering a cross-border medical liability dispute over provisional AI Office certification.
- `emergent_clinical_hallucination_backlash` -- first noted turn 4, listed in 1 turn(s) so far: European hospital clinicians publish a case series showing open-weight replacement models produced plausible but wrong triage and dosing guidance in edge cases, triggering national press coverage and a formal review of provisional AI Office certifications.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, openweight_frontier_release
- Turn 2 (3 turn(s) ago): capability_jump
- Turn 3 (2 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, adoption_success
...
```
[{"description": "","emergent": false,"id": "election_consolidation","probability": 0.45},{"description": "","emergent": false,"id": "election_alliance","probability": 0.22},{"description": "","emergent": false,"id": "election_retrenchment","probability": 0.28},{"description": "","emergent": false,"id": "cyber_major_incident","probability": 0.18},{"description": "","emergent": false,"id": "bio_incident","probability": 0.01},{"description": "","emergent": false,"id": "loss_of_control_incident","probability": 0.08},{"description": "","emergent": false,"id": "capability_jump","probability": 0.08},{"description": "","emergent": false,"id": "taiwan_blockade","probability": 0.02},{"description": "","emergent": false,"id": "cyber_defence_breakthrough","probability": 0.13},{"description": "","emergent": false,"id": "bio_uplift_findings","probability": 0.21},{"description": "","emergent": false,"id": "opaque_reasoning","probability": 0.08},{"description": "","emergent": false,"id": "research_breakthrough","probability": 0.05},{"description": "","emergent": false,"id": "openweight_frontier_release","probability": 0.18},{"description": "","emergent": false,"id": "safety_breakthrough","probability": 0.1},{"description": "","emergent": false,"id": "labour_displacement","probability": 0.05},{"description": "","emergent": false,"id": "knowledge_work_augmented","probability": 0.22},{"description": "","emergent": false,"id": "embodied_ai_deployment","probability": 0.14},{"description": "","emergent": false,"id": "taiwan_tension_rise","probability": 0.1},{"description": "","emergent": false,"id": "export_control_escalation","probability": 0.1},{"description": "","emergent": false,"id": "us_china_agreement","probability": 0.06},{"description": "","emergent": false,"id": "eu_frontier_access_denied","probability": 0.1},{"description": "","emergent": false,"id": "supply_chain_coercion","probability": 0.04},{"description": "","emergent": false,"id": "member_state_defection","probability": 0.13},{"description": "","emergent": false,"id": "adoption_success","probability": 0.1},{"description": "","emergent": false,"id": "automated_decision_scandal","probability": 0.06},{"description": "European hospital audit finds open-weights clinical fallback hallucinating dosage guidance in edge cases, triggering a cross-border medical liability dispute over provisional AI Office certification.","emergent": true,"id": "emergent_clinical_fallback_liability","probability": 0.22},{"description": "European hospital clinicians publish a case series showing open-weight replacement models produced plausible but wrong triage and dosing guidance in edge cases, triggering national press coverage and a formal review of provisional AI Office certifications.","emergent": true,"id": "emergent_clinical_hallucination_backlash","probability": 0.27}]
```
