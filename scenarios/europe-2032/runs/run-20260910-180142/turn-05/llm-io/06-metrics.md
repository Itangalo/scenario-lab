...
- characters 106-13624: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13667-13859: `{{metrics_json}}` from the run's live metric values
- characters 13952-15583: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15627-17698: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17754-18996: `{{notepad}}` from the Game Master's notepad, carried across turns
