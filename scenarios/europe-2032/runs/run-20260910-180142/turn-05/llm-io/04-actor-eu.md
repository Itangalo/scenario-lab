...
- characters 2130-4201: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5758-6223: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8565-10720: `{{previous_actions}}` from the actor's own response from the previous turn
