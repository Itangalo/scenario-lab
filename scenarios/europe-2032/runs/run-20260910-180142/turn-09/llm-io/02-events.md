...
- characters 375-1427: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1471-3481: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3537-4398: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4461-28149: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28504-29241: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: (none) = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 4, sentiment 26 -> +2
SOVEREIGNTY: 17 last turn, no capacity event, no cat4 in flight, capability rose 1.0 −0 = 17

## Emerging developments (tracked)

- `emergent_clinical_insurance_withdrawal` -- first noted turn 7, listed in 2 turn(s) so far: A major European insurers' consortium abruptly excludes AI-generated dosage and triage errors from clinical liability cover, forcing hospitals off provisional chat systems within weeks.
- `emergent_clinical_ai_suspension` -- first noted turn 7, listed in 2 turn(s) so far: Hospital federations and physician associations across several member states jointly suspend use of provisionally approved triage and dosage assistants after published error cases, forcing emergency reversion to manual triage.
...
- Turn 2 (7 turn(s) ago): capability_jump
- Turn 3 (6 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, adoption_success
- Turn 5 (4 turn(s) ago): openweight_frontier_release, member_state_defection, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, openweight_frontier_release, member_state_defection, adoption_success, emergent_clinical_hallucination_backlash
- Turn 7 (2 turn(s) ago): bio_uplift_findings, capability_jump, opaque_reasoning, knowledge_work_augmented, member_state_defection
- Turn 8 (1 turn(s) ago): eval_anomaly_reports, medical_breakthrough, adoption_success, joint_threat_response
