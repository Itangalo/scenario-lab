...
- characters 106-12940: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12983-13173: `{{metrics_json}}` from the run's live metric values
- characters 13266-14318: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14362-16372: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16428-16658: `{{notepad}}` from the Game Master's notepad, carried across turns
