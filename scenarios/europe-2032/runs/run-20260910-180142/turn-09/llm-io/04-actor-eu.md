...
- characters 453-1505: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1549-3559: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3930-4393: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6759-7967: `{{previous_actions}}` from the actor's own response from the previous turn
