...
- characters 105-13089: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13132-13324: `{{metrics_json}}` from the run's live metric values
- characters 13417-14665: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14708-17212: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17268-18517: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Continuity Stack for Public Services | 2 |
| M6 | EU Municipal Resilience Hardening Fund | 2 |
...
## Metrics
```json
{"ai_capability": 60.0, "openweight_capability": 55.5, "ai_safety": 19.0, "resilience": 41.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 21.0, "public_sentiment": 35.0}
```
