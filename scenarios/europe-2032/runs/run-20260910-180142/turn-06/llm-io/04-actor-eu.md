...
- characters 454-2436: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2479-4569: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6658-7121: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9636-12072: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Municipal Resilience Hardening Fund | 6 | small | 4 | 7 | own jurisdiction | resilience up substantially, public_sentiment up slightly via kept services | 2 | running |
