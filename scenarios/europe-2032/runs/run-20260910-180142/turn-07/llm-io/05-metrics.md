...
- characters 13503-13694: `{{metrics_json}}` from the run's live metric values
- characters 13787-15825: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15869-18423: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18479-19509: `{{notepad}}` from the Game Master's notepad, carried across turns
