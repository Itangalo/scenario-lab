...
- characters 376-2414: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2458-5012: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5068-5467: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5530-29915: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30270-30766: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, EU Municipal Resilience Hardening Fund −2, EU AI Access Bargaining Bloc −2, priority −1 = −8
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 28 -> +2
SOVEREIGNTY: 14 last turn, Tech sovereignty package finishes t6 +3, Gigafactories in flight +0, member_state_defection t6 −2, capability rose 1.0 −0 = 15
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, openweight_frontier_release
- Turn 2 (5 turn(s) ago): capability_jump
- Turn 3 (4 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, adoption_success
- Turn 5 (2 turn(s) ago): openweight_frontier_release, member_state_defection, election_consolidation
- Turn 6 (1 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, openweight_frontier_release, member_state_defection, adoption_success, emergent_clinical_hallucination_backlash
