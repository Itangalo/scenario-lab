...
- characters 454-2492: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2536-5090: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7403-7866: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10383-11447: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | EU AI Access Bargaining Bloc | 8 | small | 5 | 8 | own jurisdiction | eu_ai_sovereignty up slightly, eu_political_capital down then up via held line | 2 | running |
