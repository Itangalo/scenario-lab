...
- characters 13272-13462: `{{metrics_json}}` from the run's live metric values
- characters 13555-16117: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16160-18580: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18636-19605: `{{notepad}}` from the Game Master's notepad, carried across turns
