...
- characters 374-2936: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2979-5399: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5455-6424: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6487-30175: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30530-31157: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU AI Access Bargaining Bloc −2, priority −0 (capital below 20, no effect, no cost) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 3, sentiment 28 -> +2
SOVEREIGNTY: 15 last turn, InvestAI Gigafactories finishes t7 +4, member_state_defection t7 −2, capability rose 1.5 −0 = 17

## Emerging developments (tracked)

- `emergent_clinical_insurance_withdrawal` -- first noted turn 7, listed in 1 turn(s) so far: A major European insurers' consortium abruptly excludes AI-generated dosage and triage errors from clinical liability cover, forcing hospitals off provisional chat systems within weeks.
- `emergent_clinical_ai_suspension` -- first noted turn 7, listed in 1 turn(s) so far: Hospital federations and physician associations across several member states jointly suspend use of provisionally approved triage and dosage assistants after published error cases, forcing emergency reversion to manual triage.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, openweight_frontier_release
- Turn 2 (6 turn(s) ago): capability_jump
- Turn 3 (5 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, adoption_success
- Turn 5 (3 turn(s) ago): openweight_frontier_release, member_state_defection, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, openweight_frontier_release, member_state_defection, adoption_success, emergent_clinical_hallucination_backlash
- Turn 7 (1 turn(s) ago): bio_uplift_findings, capability_jump, opaque_reasoning, knowledge_work_augmented, member_state_defection
