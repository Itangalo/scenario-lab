...
- `two_year_commitment` (commitment): To anchor European agency in sovereign AI capacity while containing the risk of uncontrolled escalation

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: To anchor European agency in sovereign AI capacity while containing the risk of uncontrolled escalation
