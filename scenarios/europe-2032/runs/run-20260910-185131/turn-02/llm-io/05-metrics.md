...
- characters 105-12930: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12973-13165: `{{metrics_json}}` from the run's live metric values
- characters 13258-14637: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14680-16920: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16976-17963: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | Essential Services Continuity Reserve | 3 |
...
- `emergent_provenance_mandate` -- first noted turn 1, listed in 2 turn(s) so far: Major EU scientific publishers and universities jointly mandate watermarking and provenance disclosure for AI-assisted manuscripts after Millennium Prize proof controversy.
- `emergent_kimi_exploit_kits` -- first noted turn 1, listed in 2 turn(s) so far: Criminal groups package Kimi K3-derived offensive cyber tooling into ready-to-use ransomware kits traded openly, sharply lowering the skill needed for grid-adjacent intrusions.
...
## Notepad
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, Grid and Port Cyber Shield −3, Essential Services Continuity Reserve −3, priority −1 = −13
PROPOSAL BONUS: Essential Services Continuity Reserve (cat 6, large) +4 — autumn grid/port/water intrusion severe last turn plus unrecallable open release this turn, answers both directly
LEGITIMACY LENDS: capital 26, sentiment 38 -> +2
SOVEREIGNTY: 22 last turn, no capacity measure finishes, in flight +0, member_state_defection t2 −2, capability rose 1.5 −0 = 20
