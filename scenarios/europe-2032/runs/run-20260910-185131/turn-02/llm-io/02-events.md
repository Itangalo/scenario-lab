...
- characters 376-1755: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1798-4038: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4094-5081: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5144-28426: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28781-28843: `{{event_history}}` from the run's own event record
