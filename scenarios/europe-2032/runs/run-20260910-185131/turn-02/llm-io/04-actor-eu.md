...
- characters 454-1833: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1876-4116: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5348-5793: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7262-9405: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M3 | Grid and Port Cyber Shield | 6 | large | 1 | 3 | own jurisdiction | resilience up materially; ai_safety up slightly via incident learning | 3 | running |
