...
- characters 1426-3304: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3360-3702: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3765-29378: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29733-30257: `{{event_history}}` from the run's own event record
...
LEGITIMACY LENDS: capital 2, sentiment 29 -> +2 (capped, sentiment above capital, applied after finish and event terms)
SOVEREIGNTY: 29 last turn, no capacity event, no cat4 finish or in flight, capability rose 0.6 −0 = 29
...
- Turn 2 (8 turn(s) ago): openweight_frontier_release, knowledge_work_augmented, member_state_defection
- Turn 3 (7 turn(s) ago): safety_breakthrough
- Turn 5 (5 turn(s) ago): election_consolidation
- Turn 6 (4 turn(s) ago): labour_displacement, taiwan_tension_rise
- Turn 7 (3 turn(s) ago): cyber_defence_breakthrough
- Turn 8 (2 turn(s) ago): knowledge_work_augmented, member_state_defection
- Turn 9 (1 turn(s) ago): eval_anomaly_reports, safety_breakthrough
