...
- characters 106-12829: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12872-13063: `{{metrics_json}}` from the run's live metric values
- characters 13156-14163: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14206-16084: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16140-16482: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Continuity and Incident Learning Compact | 2 |
