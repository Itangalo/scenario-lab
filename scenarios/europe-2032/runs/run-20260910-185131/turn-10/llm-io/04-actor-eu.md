...
- characters 1504-3382: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4915-5331: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7489-8791: `{{previous_actions}}` from the actor's own response from the previous turn
