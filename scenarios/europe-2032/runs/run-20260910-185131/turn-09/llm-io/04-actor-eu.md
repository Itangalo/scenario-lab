...
- characters 454-1450: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1494-3523: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4476-4902: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7060-8965: `{{previous_actions}}` from the actor's own response from the previous turn
