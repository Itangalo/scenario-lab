...
- characters 13168-13359: `{{metrics_json}}` from the run's live metric values
- characters 13452-14448: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14492-16521: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16577-17017: `{{notepad}}` from the Game Master's notepad, carried across turns
