...
- characters 376-1372: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1416-3445: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3501-3941: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4004-29617: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29972-30428: `{{event_history}}` from the run's own event record
...
- Turn 2 (7 turn(s) ago): openweight_frontier_release, knowledge_work_augmented, member_state_defection
- Turn 3 (6 turn(s) ago): safety_breakthrough
- Turn 5 (4 turn(s) ago): election_consolidation
- Turn 6 (3 turn(s) ago): labour_displacement, taiwan_tension_rise
- Turn 7 (2 turn(s) ago): cyber_defence_breakthrough
- Turn 8 (1 turn(s) ago): knowledge_work_augmented, member_state_defection
