...
- characters 13298-14812: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14855-17156: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17212-17706: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, Grid and Port Cyber Shield −3, Essential Services Continuity Reserve −3, EU Assurance Adoption Cell −2 = −14 (priority named M3 has no effect and no cost as capital 15 <20 per rule 10)
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 40 -> +2 (capped below sentiment)
SOVEREIGNTY: 20 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 20
