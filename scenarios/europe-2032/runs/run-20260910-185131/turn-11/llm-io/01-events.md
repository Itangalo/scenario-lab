...
- characters 377-1394: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1438-3301: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3357-3859: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3922-29535: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29890-30511: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Continuity and Incident Learning Compact −2, priority −1 = −3
PROPOSAL BONUS: EU Continuity and Incident Learning Compact (cat 6, small) +3 — answers cyber_major_incident and loss-of-control case firing this turn directly
LEGITIMACY LENDS: capital 1, sentiment 28 -> +0 (capped, sentiment above capital, applied after finish and event terms, no lift - capital floor binding)
SOVEREIGNTY: 29 last turn, no capacity event, no cat4 finish or in flight, capability rose 0.7 −0 = 29
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, safety_breakthrough
- Turn 2 (9 turn(s) ago): openweight_frontier_release, knowledge_work_augmented, member_state_defection
- Turn 3 (8 turn(s) ago): safety_breakthrough
- Turn 5 (6 turn(s) ago): election_consolidation
- Turn 6 (5 turn(s) ago): labour_displacement, taiwan_tension_rise
- Turn 7 (4 turn(s) ago): cyber_defence_breakthrough
- Turn 8 (3 turn(s) ago): knowledge_work_augmented, member_state_defection
- Turn 9 (2 turn(s) ago): eval_anomaly_reports, safety_breakthrough
- Turn 10 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, medical_breakthrough
