...
- characters 107-13138: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13181-13372: `{{metrics_json}}` from the run's live metric values
- characters 13465-14482: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14526-16389: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16445-16947: `{{notepad}}` from the Game Master's notepad, carried across turns
