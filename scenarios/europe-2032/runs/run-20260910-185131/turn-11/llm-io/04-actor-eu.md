...
- characters 1516-3379: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4871-5329: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7668-10622: `{{previous_actions}}` from the actor's own response from the previous turn
