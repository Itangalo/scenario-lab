...
- characters 106-13163: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13206-13397: `{{metrics_json}}` from the run's live metric values
- characters 13490-14591: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14635-16559: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16615-17611: `{{notepad}}` from the Game Master's notepad, carried across turns
