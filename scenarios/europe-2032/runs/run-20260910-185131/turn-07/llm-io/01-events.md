...
- characters 376-1477: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1521-3445: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3501-4497: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4560-29570: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29925-30253: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, priority M1 −1 = −4
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2, sentiment 28 -> +2 (capped, brings capital to 2, sentiment above capital)
SOVEREIGNTY: 20 last turn, Tech sovereignty package finishes t6 +5, Gigafactories in flight +1, no capacity event, capability rose 1.5 −0 = 26

## Emerging developments (tracked)

- `emergent_us_tiering_draft_shock` -- first noted turn 6, listed in 1 turn(s) so far: Incoming US administration publishes draft tiering rules placing most EU members in a capped second tier with per-order security review, triggering contract repricing and queueing for EU firms before inauguration.
- `emergent_us_tier_rationing` -- first noted turn 6, listed in 1 turn(s) so far: Incoming US administration publishes tiered foreign access rules for frontier models and compute in H1 2029, placing most EU buyers in a conditional middle tier with security-review quotas and volume caps.
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, safety_breakthrough
- Turn 2 (5 turn(s) ago): openweight_frontier_release, knowledge_work_augmented, member_state_defection
- Turn 3 (4 turn(s) ago): safety_breakthrough
- Turn 5 (2 turn(s) ago): election_consolidation
- Turn 6 (1 turn(s) ago): labour_displacement, taiwan_tension_rise
