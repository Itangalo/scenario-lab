...
- characters 13299-14846: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14890-17199: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17255-17788: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Assurance Adoption Cell | 2 |
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, Grid and Port Cyber Shield −3, Essential Services Continuity Reserve −3, EU Assurance Adoption Cell −2, priority −1 = −15
PROPOSAL BONUS: none — EU Assurance Adoption Cell answers safety_breakthrough (positive breakthrough, not negative event from last three rounds)
