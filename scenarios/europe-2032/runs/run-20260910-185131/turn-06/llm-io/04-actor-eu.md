...
- characters 453-1577: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1620-3653: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4298-4724: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6756-8082: `{{previous_actions}}` from the actor's own response from the previous turn
