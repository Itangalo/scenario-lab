...
- characters 105-13350: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13393-13584: `{{metrics_json}}` from the run's live metric values
- characters 13677-14801: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14844-16877: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16933-17936: `{{notepad}}` from the Game Master's notepad, carried across turns
