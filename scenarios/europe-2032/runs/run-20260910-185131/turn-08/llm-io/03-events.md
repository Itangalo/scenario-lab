...
- characters 375-1395: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1438-3165: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3221-4213: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4276-29286: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29641-30022: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU Patch Sprint −2, priority −1 = −3
PROPOSAL BONUS: none — cyber defence breakthrough is positive opportunity, not negative shock in last three turns
LEGITIMACY LENDS: capital 2, sentiment 28 -> +2 (capped, sentiment above capital)
SOVEREIGNTY: 26 last turn, InvestAI Gigafactories finishes t7 +5, no capacity event, capability rose 0.7 −0 = 31

## Emerging developments (tracked)

- `emergent_us_tiering_draft_shock` -- first noted turn 6, listed in 2 turn(s) so far: Incoming US administration publishes draft tiering rules placing most EU members in a capped second tier with per-order security review, triggering contract repricing and queueing for EU firms before inauguration.
- `emergent_us_tier_rationing` -- first noted turn 6, listed in 2 turn(s) so far: Incoming US administration publishes tiered foreign access rules for frontier models and compute in H1 2029, placing most EU buyers in a conditional middle tier with security-review quotas and volume caps.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, safety_breakthrough
- Turn 2 (6 turn(s) ago): openweight_frontier_release, knowledge_work_augmented, member_state_defection
- Turn 3 (5 turn(s) ago): safety_breakthrough
- Turn 5 (3 turn(s) ago): election_consolidation
- Turn 6 (2 turn(s) ago): labour_displacement, taiwan_tension_rise
