...
- characters 105-13137: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13180-13371: `{{metrics_json}}` from the run's live metric values
- characters 13464-14484: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14527-16254: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16310-16676: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | Graduate Junior Posts Bridge | 2 |
...
## Notepad
PORTFOLIO CHARGE t8: Graduate Junior Posts Bridge −2, priority −1 = −3
PROPOSAL BONUS: none — placements answer chronic graduate unemployment, not a negative event from last three turns; defection this turn is not answered by this measure
LEGITIMACY LENDS: capital 0, sentiment 29 -> +2 (capped, sentiment above capital)
SOVEREIGNTY: 31 last turn, no cat4 finish, no cat4 in flight, member_state_defection t8 −2, capability rose 0.7 −0 = 29
