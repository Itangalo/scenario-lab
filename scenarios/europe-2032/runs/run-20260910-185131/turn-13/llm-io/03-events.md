...
- characters 377-1652: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1696-3998: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4054-4743: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4806-28216: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28571-29345: `{{event_history}}` from the run's own event record
...
LEGITIMACY LENDS: capital 1.0, sentiment 31.0 -> +2 (sentiment above capital, applied after finish and event terms, capped below sentiment)
SOVEREIGNTY: 29 last turn, no capacity event, no cat4 finish or in flight, capability rose 0.5 −0 = 29

## Emerging developments (tracked)

- `emergent_research_exit_signal` -- first noted turn 12, listed in 1 turn(s) so far: Major European clinical research consortium announces it will move frontier model training and evaluation outside the EU, citing unreadable model reasoning and lack of enforceable EU evaluation access.
...
- Turn 2 (11 turn(s) ago): openweight_frontier_release, knowledge_work_augmented, member_state_defection
- Turn 3 (10 turn(s) ago): safety_breakthrough
- Turn 5 (8 turn(s) ago): election_consolidation
- Turn 6 (7 turn(s) ago): labour_displacement, taiwan_tension_rise
- Turn 7 (6 turn(s) ago): cyber_defence_breakthrough
- Turn 8 (5 turn(s) ago): knowledge_work_augmented, member_state_defection
- Turn 9 (4 turn(s) ago): eval_anomaly_reports, safety_breakthrough
- Turn 10 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, medical_breakthrough
- Turn 11 (2 turn(s) ago): eval_anomaly_reports, opaque_reasoning, adoption_success
- Turn 12 (1 turn(s) ago): safety_breakthrough, us_china_agreement
