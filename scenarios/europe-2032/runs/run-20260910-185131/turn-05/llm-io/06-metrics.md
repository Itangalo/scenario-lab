...
- characters 13432-13623: `{{metrics_json}}` from the run's live metric values
- characters 13716-14663: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14707-16744: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16800-17293: `{{notepad}}` from the Game Master's notepad, carried across turns
