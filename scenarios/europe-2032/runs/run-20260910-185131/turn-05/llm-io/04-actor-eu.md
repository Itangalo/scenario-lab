...
- characters 454-1401: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1445-3482: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4399-4844: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6874-8172: `{{previous_actions}}` from the actor's own response from the previous turn
