...
- characters 1905-3725: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3781-4162: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4225-29141: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29496-30202: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: (none in flight) = -0 + priority none = -0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1.0, sentiment 31.0 -> +0 (capped, sentiment above capital, applied after finish and event terms, no lift - capital floor binding)
...
- Turn 2 (10 turn(s) ago): openweight_frontier_release, knowledge_work_augmented, member_state_defection
- Turn 3 (9 turn(s) ago): safety_breakthrough
- Turn 5 (7 turn(s) ago): election_consolidation
- Turn 6 (6 turn(s) ago): labour_displacement, taiwan_tension_rise
- Turn 7 (5 turn(s) ago): cyber_defence_breakthrough
- Turn 8 (4 turn(s) ago): knowledge_work_augmented, member_state_defection
- Turn 9 (3 turn(s) ago): eval_anomaly_reports, safety_breakthrough
- Turn 10 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, medical_breakthrough
- Turn 11 (1 turn(s) ago): eval_anomaly_reports, opaque_reasoning, adoption_success
