...
- characters 106-12735: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12778-12969: `{{metrics_json}}` from the run's live metric values
- characters 13062-14548: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14591-16411: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16467-17173: `{{notepad}}` from the Game Master's notepad, carried across turns
