...
- characters 16385-16952: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_synthetic_fraud_wave` -- first noted turn 1, listed in 1 turn(s) so far: A coordinated wave of AI-generated fraud using Kimi K3-derived voice and document forgeries hits several EU banks and public administrations, causing material losses but no infrastructure damage.
- `emergent_provenance_mandate` -- first noted turn 1, listed in 1 turn(s) so far: Major EU scientific publishers and universities jointly mandate watermarking and provenance disclosure for AI-assisted papers after Millennium Prize proof controversy.
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 46.0, "ai_safety": 32.0, "resilience": 38.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 41.0, "public_sentiment": 40.0}
```
