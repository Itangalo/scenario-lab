...
- characters 105-13589: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13632-13824: `{{metrics_json}}` from the run's live metric values
- characters 13917-15124: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15167-17190: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17246-18446: `{{notepad}}` from the Game Master's notepad, carried across turns
