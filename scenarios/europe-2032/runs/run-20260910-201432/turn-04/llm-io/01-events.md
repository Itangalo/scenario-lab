...
- characters 376-1583: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1626-3649: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3705-4327: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4390-31938: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32293-32523: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, export_control_escalation, eu_frontier_access_denied, adoption_success
- Turn 2 (2 turn(s) ago): loss_of_control_incident, capability_jump
- Turn 3 (1 turn(s) ago): member_state_defection
