...
- **applied** `M6` — {"op": "add", "table": "measures", "fields": {"name": "EU Automation Displacement Cushion", "category": 7, "size": "small", "finish_turn": 8, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, public_sentiment up, eu_political_capital up slightly over time"}, "grounds": "robots in purchase orders leave no retraining interval"}
  - Grounds: robots in purchase orders leave no retraining interval
