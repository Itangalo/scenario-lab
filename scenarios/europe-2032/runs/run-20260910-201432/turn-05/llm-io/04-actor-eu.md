...
- characters 1692-4064: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6197-6664: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8822-10119: `{{previous_actions}}` from the actor's own response from the previous turn
