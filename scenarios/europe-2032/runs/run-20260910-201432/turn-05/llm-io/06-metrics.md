...
- characters 13753-14946: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14990-17362: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17418-18501: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 78.0, "openweight_capability": 65.0, "ai_safety": 3.0, "resilience": 39.0, "eu_ai_sovereignty": 9.0, "eu_political_capital": 7.0, "public_sentiment": 16.0}
```
