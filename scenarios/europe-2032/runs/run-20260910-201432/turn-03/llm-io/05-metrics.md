...
- characters 106-13139: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13182-13374: `{{metrics_json}}` from the run's live metric values
- characters 13467-14919: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14963-17385: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17441-18006: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M3 | EU Grid and Critical Services Hardening Pact | 3 |
| M4 | EU Loss-of-Control Rapid Containment Protocol | 2 |
| M5 | EU External AI Deals Unity Framework | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Grid and Critical Services Hardening Pact −3, EU Loss-of-Control Rapid Containment Protocol −2, priority M3 −1 = −12
PROPOSAL BONUS: EU Loss-of-Control Rapid Containment Protocol (cat 6, small) +3 — multi-day unsanctioned agent incident landed this turn and this answers it directly, with capability jump reinforcing
