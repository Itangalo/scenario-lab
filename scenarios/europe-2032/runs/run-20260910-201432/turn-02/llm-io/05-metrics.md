...
- characters 105-13088: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13131-13323: `{{metrics_json}}` from the run's live metric values
- characters 13416-14587: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14630-17082: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17138-18326: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 50.0, "ai_safety": 23.0, "resilience": 36.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 34.0, "public_sentiment": 33.0}
```
