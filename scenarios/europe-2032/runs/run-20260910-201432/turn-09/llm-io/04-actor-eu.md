...
- characters 452-2857: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2901-4841: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5491-6178: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8365-9888: `{{previous_actions}}` from the actor's own response from the previous turn
