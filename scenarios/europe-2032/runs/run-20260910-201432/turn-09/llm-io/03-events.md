...
- characters 374-2779: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2823-4763: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4819-5439: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5502-35849: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 36204-36862: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: no measures in flight, priority none = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1.0, sentiment 4.0 -> +1 capped by sentiment cap at 4.0 (applied in total)
SOVEREIGNTY: 13 last turn, no capacity event, no cat4 in flight +0, capability rose 2.0 −1 = 12

## Emerging developments (tracked)

- `emergent_robot_siting_backlash` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated municipal bans on new foreign logistics-robot depots spread across warehouse regions, forcing operators to pause rollout and pushing Brussels to arbitrate siting rules.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, export_control_escalation, eu_frontier_access_denied, adoption_success
- Turn 2 (7 turn(s) ago): loss_of_control_incident, capability_jump
- Turn 3 (6 turn(s) ago): member_state_defection
- Turn 4 (5 turn(s) ago): capability_jump, embodied_ai_deployment, export_control_escalation
- Turn 5 (4 turn(s) ago): rsi_onset, embodied_ai_deployment, election_retrenchment
- Turn 6 (3 turn(s) ago): cyber_defence_breakthrough, embodied_ai_deployment, eu_frontier_access_denied, automated_decision_scandal
- Turn 7 (2 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, embodied_ai_deployment, member_state_defection
