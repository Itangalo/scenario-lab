...
| M7 | EU Depot Siting Arbitration and Continuity Pact | 6 | small | 9 | 11 | own jurisdiction | resilience up, public_sentiment up slightly, eu_political_capital up slightly | 2 | running |
...
- **applied** `M7` — {"op": "add", "table": "measures", "fields": {"name": "EU Depot Siting Arbitration and Continuity Pact", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, public_sentiment up slightly, eu_political_capital up slightly"}, "grounds": "to arbitrate siting backlash while holding continuity"}
  - Grounds: to arbitrate siting backlash while holding continuity
