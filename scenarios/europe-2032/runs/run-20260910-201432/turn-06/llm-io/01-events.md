...
- characters 373-1601: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1644-4185: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4241-5355: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5418-34719: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35074-35480: `{{event_history}}` from the run's own event record
...
- `emergent_fraud_payment_freeze` -- first noted turn 4, listed in 2 turn(s) so far: A coordinated cloned-voice fraud wave forces several EU banks to suspend instant payments and triggers emergency liability rules, turning AI fraud from nuisance crime into a financial-stability incident.
- `emergent_factory_siting_blockade` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated physical protests block construction access at two Gigafactory grid-connection sites, delaying works for weeks and forcing national police deployments.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, export_control_escalation, eu_frontier_access_denied, adoption_success
- Turn 2 (4 turn(s) ago): loss_of_control_incident, capability_jump
- Turn 3 (3 turn(s) ago): member_state_defection
- Turn 4 (2 turn(s) ago): capability_jump, embodied_ai_deployment, export_control_escalation
- Turn 5 (1 turn(s) ago): rsi_onset, embodied_ai_deployment, election_retrenchment
