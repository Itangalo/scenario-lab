...
- characters 451-1679: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1722-4263: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7172-7859: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10196-13117: `{{previous_actions}}` from the actor's own response from the previous turn
