...
- characters 106-13313: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13356-13545: `{{metrics_json}}` from the run's live metric values
- characters 13638-14928: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14972-17647: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17703-18507: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 83.0, "openweight_capability": 75.5, "ai_safety": 0.0, "resilience": 36.5, "eu_ai_sovereignty": 13.0, "eu_political_capital": 1.0, "public_sentiment": 4.0}
```
