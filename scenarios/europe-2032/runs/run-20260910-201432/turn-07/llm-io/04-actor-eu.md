...
- characters 452-1742: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1786-4461: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6505-7192: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9530-11162: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M6 | EU Automation Displacement Cushion | 7 | small | 5 | 8 | own jurisdiction | resilience up, public_sentiment up, eu_political_capital up slightly over time | 2 | running |
...
## New measure
None this turn, while we let the Gigafactories line reach its decision point and rebuild enough capital to fund anything new without collapse.

## Store changes
No changes.

## Priority
M6 EU Automation Displacement Cushion, because with access cut off, robots in deployment and a benefits scandal destroying trust, income continuity and continued service are the only things that keep the Union governable.

## In practice
We triage what is already on the books. DG EMPL and the Employment Council accelerate the Cushion payouts through ESF+ to logistics, warehouse and auto-supplier regions hit by embodied deployment, pairing wage insurance with mayoral siting funds to hold factory perimeters. ENISA and the TSO cell take the defensive breakthrough — automated patching and swarm-behaviour detection — and push it through the M3/M4 playbooks already exercised: hospitals, grids and payment systems first, since cloned-voice freezes and probing attacks showed where cascade starts.

On access denied we do not promise a replacement we cannot fund: DG CNECT/TRADE holds the M5 unity line, no bilateral breakaway, pooled fallback procurement and conditioned top-ups to the joint pipeline, while Health and ministerial users are migrated to degraded-mode continuity. On the scandal we concede the harder reading — the system sat in a gap the Act's Annex III categories do not reach, so what was done was lawful — and task the AI Office with a narrow patch proposal rather than defending enforcement that cannot answer it. M1 stays in triage only until turn 7: permitting and grid-connection taskforces, no new money.
...
```
## New measure
None this turn, while we hold the unity line and keep the Cushion paying out until capital rebuilds enough to fund anything new without collapse.

## Store changes
No changes.

## Priority
M6 EU Automation Displacement Cushion, because with subscriptions cut off, robots displacing warehouse and supplier towns, and trust at 6, income continuity is the only thing keeping the Union governable.

## In practice
We triage what is already on the books. DG EMPL via ESF+ accelerates M6 wage-insurance and retraining payouts to logistics and auto-supplier regions, paired with mayoral siting funds to hold factory perimeters in France, Germany, Spain and Poland-Sweden. ENISA and the TSO cell push the M3/M4 defensive tooling — machine-speed patching and coordinated-probe detectors — to hospitals on degraded continuity, grids and payment systems first.

On the cut-off and the defection we hold the M5 common line: no bilateral breakaway, pooled fallback procurement, Council trade conclusions condemning separate deals as undercutting joint leverage, while DG CNECT migrates health and finance-ministry users to older-model/manual continuity. On the benefits ruling we concede the gap — lawful but wrong — and task the AI Office with a narrow Annex III patch proposal. On the bio uplift signal we task ECDC/HERA with detection stocktake under existing preparedness playbooks, without opening a new instrument this turn.
