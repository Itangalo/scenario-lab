...
- characters 374-1664: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1708-4383: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4439-4939: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5002-35349: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35704-36242: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, export_control_escalation, eu_frontier_access_denied, adoption_success
- Turn 2 (5 turn(s) ago): loss_of_control_incident, capability_jump
- Turn 3 (4 turn(s) ago): member_state_defection
- Turn 4 (3 turn(s) ago): capability_jump, embodied_ai_deployment, export_control_escalation
- Turn 5 (2 turn(s) ago): rsi_onset, embodied_ai_deployment, election_retrenchment
- Turn 6 (1 turn(s) ago): cyber_defence_breakthrough, embodied_ai_deployment, eu_frontier_access_denied, automated_decision_scandal
