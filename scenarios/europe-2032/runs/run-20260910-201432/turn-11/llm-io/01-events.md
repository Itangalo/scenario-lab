...
- characters 375-2309: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2353-4576: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4632-5767: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5830-35479: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35834-36615: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Opaque-Systems Continuity and Black-Box Triage Pact −2, priority −1 = −3
PROPOSAL BONUS: EU Opaque-Systems Continuity and Black-Box Triage Pact (cat 6, small) +3 — opaque reasoning landed this turn killing interpretability holding triage/grid/depot together and this answers it directly
LEGITIMACY LENDS: capital 4, sentiment 9 -> +1 capped by sentiment cap at 9 (applied in total)
SOVEREIGNTY: 12 last turn, no capacity event, no cat4 in flight +0, capability rose 2.0 −1 = 11

## Emerging developments (tracked)

- `emergent_yard_infrastructure_sabotage` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated physical sabotage of power and fibre feeds to foreign-run automated logistics yards in several member states, claimed by a decentralized anti-automation network, forcing temporary manual operation.
- `emergent_shadow_yard_automation` -- first noted turn 10, listed in 1 turn(s) so far: A second-tier frontier lab outside the US releases a fully autonomous logistics-planning agent that is rapidly copied into European port and yard operators, bypassing the depot pact inspections entirely.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, export_control_escalation, eu_frontier_access_denied, adoption_success
- Turn 2 (9 turn(s) ago): loss_of_control_incident, capability_jump
- Turn 3 (8 turn(s) ago): member_state_defection
- Turn 4 (7 turn(s) ago): capability_jump, embodied_ai_deployment, export_control_escalation
- Turn 5 (6 turn(s) ago): rsi_onset, embodied_ai_deployment, election_retrenchment
- Turn 6 (5 turn(s) ago): cyber_defence_breakthrough, embodied_ai_deployment, eu_frontier_access_denied, automated_decision_scandal
- Turn 7 (4 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, embodied_ai_deployment, member_state_defection
- Turn 9 (2 turn(s) ago): safety_breakthrough, emergent_robot_siting_backlash
- Turn 10 (1 turn(s) ago): opaque_reasoning
