...
- characters 13707-15641: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15685-17908: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17964-19099: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 92.0, "openweight_capability": 86.4, "ai_safety": 0.0, "resilience": 41.0, "eu_ai_sovereignty": 10.0, "eu_political_capital": 14.0, "public_sentiment": 5.0}
```
