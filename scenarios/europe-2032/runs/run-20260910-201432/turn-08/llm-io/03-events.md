...
- characters 373-2317: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2360-4344: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4400-5145: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5208-35555: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35910-36568: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU Automation Displacement Cushion −2, priority M6 −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2, sentiment 6 -> +1 capped by event drag (applied in total)
SOVEREIGNTY: 11 last turn, InvestAI Gigafactories finishes t7 +5, no cat4 in flight +0, member_state_defection t7 −2 (largest of two capacity events, embodied_ai_deployment also qualifies), capability rose 2.5 −1 = 13

## Emerging developments (tracked)

- `emergent_robot_siting_backlash` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated municipal bans on new foreign logistics-robot depots spread across warehouse regions, forcing operators to pause rollout and pushing Brussels to arbitrate siting rules.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, export_control_escalation, eu_frontier_access_denied, adoption_success
- Turn 2 (6 turn(s) ago): loss_of_control_incident, capability_jump
- Turn 3 (5 turn(s) ago): member_state_defection
- Turn 4 (4 turn(s) ago): capability_jump, embodied_ai_deployment, export_control_escalation
- Turn 5 (3 turn(s) ago): rsi_onset, embodied_ai_deployment, election_retrenchment
- Turn 6 (2 turn(s) ago): cyber_defence_breakthrough, embodied_ai_deployment, eu_frontier_access_denied, automated_decision_scandal
- Turn 7 (1 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, embodied_ai_deployment, member_state_defection
