...
- characters 105-13262: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13305-13494: `{{metrics_json}}` from the run's live metric values
- characters 13587-15531: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15574-17558: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17614-18359: `{{notepad}}` from the Game Master's notepad, carried across turns
