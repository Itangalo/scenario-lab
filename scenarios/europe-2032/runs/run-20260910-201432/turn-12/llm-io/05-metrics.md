...
- characters 13074-13264: `{{metrics_json}}` from the run's live metric values
- characters 13357-14565: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14608-16698: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16754-17275: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Wartime Neutrality and Essential Continuity Shelter | 2 |
...
## Metrics
```json
{"ai_capability": 94.5, "openweight_capability": 89.2, "ai_safety": 0.0, "resilience": 40.0, "eu_ai_sovereignty": 7.0, "eu_political_capital": 15.0, "public_sentiment": 2.0}
```
