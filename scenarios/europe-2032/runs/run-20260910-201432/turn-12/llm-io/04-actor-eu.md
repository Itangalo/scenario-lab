...
- characters 453-1661: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1704-3794: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5003-5686: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8603-10870: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Wartime Neutrality and Essential Continuity Shelter | 6 | small | 11 | 13 | own jurisdiction | resilience up slightly, eu_political_capital down initially then stabilised | 2 | running |
