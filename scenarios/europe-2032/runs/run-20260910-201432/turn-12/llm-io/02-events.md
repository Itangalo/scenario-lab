...
- characters 375-1583: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1626-3716: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3772-4926: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4989-33471: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33826-34708: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Wartime Neutrality and Essential Continuity Shelter −2, priority −1 not charged (capital below 20, priority has no effect) = −2
PROPOSAL BONUS: EU Wartime Neutrality and Essential Continuity Shelter (cat 6, small) +3 — catastrophic_great_power_conflict landed this turn threatening power/hospitals/cables and this answers it directly
LEGITIMACY LENDS: capital 14, sentiment 5 -> none (capital higher)
SOVEREIGNTY: 11 last turn, no capacity event, no cat4 in flight +0, capability rose 3.5 −1 = 10

## Emerging developments (tracked)

- `emergent_yard_infrastructure_sabotage` -- first noted turn 10, listed in 2 turn(s) so far: Coordinated physical sabotage of power and fibre feeds to foreign-run automated logistics yards in several member states, claimed by a decentralized anti-automation network, forcing temporary manual operation.
- `emergent_shadow_yard_automation` -- first noted turn 10, listed in 2 turn(s) so far: A second-tier frontier lab outside the US releases a fully autonomous logistics-planning agent that is rapidly copied into European port and yard operators, bypassing the depot pact inspections entirely.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, export_control_escalation, eu_frontier_access_denied, adoption_success
- Turn 2 (10 turn(s) ago): loss_of_control_incident, capability_jump
- Turn 3 (9 turn(s) ago): member_state_defection
- Turn 4 (8 turn(s) ago): capability_jump, embodied_ai_deployment, export_control_escalation
- Turn 5 (7 turn(s) ago): rsi_onset, embodied_ai_deployment, election_retrenchment
- Turn 6 (6 turn(s) ago): cyber_defence_breakthrough, embodied_ai_deployment, eu_frontier_access_denied, automated_decision_scandal
- Turn 7 (5 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, embodied_ai_deployment, member_state_defection
- Turn 9 (3 turn(s) ago): safety_breakthrough, emergent_robot_siting_backlash
- Turn 10 (2 turn(s) ago): opaque_reasoning
- Turn 11 (1 turn(s) ago): capability_jump, eval_anomaly_reports, catastrophic_great_power_conflict
