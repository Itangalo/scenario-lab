...
| M8 | EU Opaque-Systems Continuity and Black-Box Triage Pact | 6 | small | 10 | 12 | own jurisdiction | resilience up, ai_safety up slightly, public_sentiment up slightly | 2 | running |
...
- **applied** `M8` — {"op": "add", "table": "measures", "fields": {"name": "EU Opaque-Systems Continuity and Black-Box Triage Pact", "category": 6, "size": "small", "finish_turn": 12, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly, public_sentiment up slightly"}, "grounds": "to hold continuity after loss of readable reasoning"}
  - Grounds: to hold continuity after loss of readable reasoning
