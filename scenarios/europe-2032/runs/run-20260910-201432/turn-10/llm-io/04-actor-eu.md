...
- characters 452-1992: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2035-4111: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4789-5472: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7851-10150: `{{previous_actions}}` from the actor's own response from the previous turn
