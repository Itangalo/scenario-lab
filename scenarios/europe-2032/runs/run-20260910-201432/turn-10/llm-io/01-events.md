...
- characters 374-1914: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1957-4033: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4089-4541: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4604-34951: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35306-36042: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Depot Siting Arbitration and Continuity Pact −2, priority −1 = −3
PROPOSAL BONUS: EU Depot Siting Arbitration and Continuity Pact (cat 6, small) +2 — coordinated municipal bans pausing rollout fired this turn and this answers it directly
LEGITIMACY LENDS: capital 3, sentiment 7 -> +1 capped by sentiment cap at 7 (applied in total)
SOVEREIGNTY: 12 last turn, no capacity event, no cat4 in flight +0, capability rose 1.5 −0 = 12
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, export_control_escalation, eu_frontier_access_denied, adoption_success
- Turn 2 (8 turn(s) ago): loss_of_control_incident, capability_jump
- Turn 3 (7 turn(s) ago): member_state_defection
- Turn 4 (6 turn(s) ago): capability_jump, embodied_ai_deployment, export_control_escalation
- Turn 5 (5 turn(s) ago): rsi_onset, embodied_ai_deployment, election_retrenchment
- Turn 6 (4 turn(s) ago): cyber_defence_breakthrough, embodied_ai_deployment, eu_frontier_access_denied, automated_decision_scandal
- Turn 7 (3 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, embodied_ai_deployment, member_state_defection
- Turn 9 (1 turn(s) ago): safety_breakthrough, emergent_robot_siting_backlash
