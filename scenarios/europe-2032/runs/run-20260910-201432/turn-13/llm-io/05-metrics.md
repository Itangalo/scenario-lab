...
- characters 107-13383: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13426-13615: `{{metrics_json}}` from the run's live metric values
- characters 13708-15161: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15205-17148: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17204-18422: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Defensive Surge and Human-Hands Continuity | 2 |
...
- `emergent_humanoid_spares_freeze` -- first noted turn 13, listed in 1 turn(s) so far: A belligerent remotely bricks or withholds control updates for Chinese-built humanoids running US software in EU logistics and care sites, forcing emergency manual reversion during wartime rosters.
- `emergent_robot_fleet_bricking` -- first noted turn 13, listed in 1 turn(s) so far: A belligerent remotely withholds spares or control updates for the Chinese-built, US-software humanoid fleet operating EU yards, depots and care auxiliaries, forcing widespread manual reversion.
...
## Notepad
PORTFOLIO CHARGE t13: M10 EU Defensive Surge and Human-Hands Continuity −2, priority −1 not charged (capital below 20, priority has no effect) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 10, sentiment 0 -> none (capital higher)
SOVEREIGNTY: 7 last turn, no cat4 finish, no cat4 in flight +0, member_state_defection t13 −2 (largest capacity event, embodied_ai_deployment also qualifies), capability rose 2.0 −1 = 4
