...
- characters 375-1828: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1872-3815: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3871-4485: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4548-33030: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33385-34346: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, export_control_escalation, eu_frontier_access_denied, adoption_success
- Turn 2 (11 turn(s) ago): loss_of_control_incident, capability_jump
- Turn 3 (10 turn(s) ago): member_state_defection
- Turn 4 (9 turn(s) ago): capability_jump, embodied_ai_deployment, export_control_escalation
- Turn 5 (8 turn(s) ago): rsi_onset, embodied_ai_deployment, election_retrenchment
- Turn 6 (7 turn(s) ago): cyber_defence_breakthrough, embodied_ai_deployment, eu_frontier_access_denied, automated_decision_scandal
- Turn 7 (6 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, embodied_ai_deployment, member_state_defection
- Turn 9 (4 turn(s) ago): safety_breakthrough, emergent_robot_siting_backlash
- Turn 10 (3 turn(s) ago): opaque_reasoning
- Turn 11 (2 turn(s) ago): capability_jump, eval_anomaly_reports, catastrophic_great_power_conflict
- Turn 12 (1 turn(s) ago): cyber_defence_breakthrough, embodied_ai_deployment
