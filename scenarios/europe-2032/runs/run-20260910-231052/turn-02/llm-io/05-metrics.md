...
- characters 17299-18370: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_grid_insurance_crunch` -- first noted turn 2, listed in 1 turn(s) so far: European insurers and reinsurers sharply raise premiums and exclusions for grid and port operational-technology cover after the autumn intrusions, forcing unplanned public backstopping debates.
- `emergent_cyber_insurance_repricing` -- first noted turn 2, listed in 1 turn(s) so far: European insurers and reinsurers sharply reprice industrial cyber cover after the autumn grid intrusions, requiring mandatory segmentation audits for energy and port operators as a condition of coverage.
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 47.0, "ai_safety": 30.0, "resilience": 37.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 22.0, "public_sentiment": 32.0}
```
