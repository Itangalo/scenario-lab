...
- characters 6051-6491: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7945-10036: `{{previous_actions}}` from the actor's own response from the previous turn
