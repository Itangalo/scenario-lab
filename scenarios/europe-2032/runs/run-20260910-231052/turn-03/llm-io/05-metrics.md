...
- characters 13430-15216: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15260-18065: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18121-19281: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Grid and Critical Services Hardening Pact | 3 |
| M5 | EU-US Allied Volume Licence Corridor | 2 |
...
- `emergent_grid_insurance_crunch` -- first noted turn 2, listed in 2 turn(s) so far: European insurers and reinsurers sharply raise premiums and exclusions for grid and port operational-technology cover after the autumn intrusions, forcing unplanned public backstopping debates.
- `emergent_cyber_insurance_repricing` -- first noted turn 2, listed in 2 turn(s) so far: European insurers and reinsurers sharply reprice industrial cyber cover after the autumn grid intrusions, requiring mandatory segmentation audits for energy and port operators as a condition of coverage.
