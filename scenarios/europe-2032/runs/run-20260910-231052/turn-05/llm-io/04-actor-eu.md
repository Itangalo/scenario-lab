...
- characters 455-1648: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1692-3581: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5114-5554: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7631-8893: `{{previous_actions}}` from the actor's own response from the previous turn
