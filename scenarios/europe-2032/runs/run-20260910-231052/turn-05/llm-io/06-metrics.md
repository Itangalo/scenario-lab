...
- characters 106-13371: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13414-13606: `{{metrics_json}}` from the run's live metric values
- characters 13699-14892: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14936-16825: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16881-17554: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|---|---|---|---|---|---|---|
| M5 | EU-US Allied Volume Licence Corridor | 8 | small | 3 | 5 | US | eu_ai_sovereignty up modestly, eu_political_capital protected | 2 | finished |
...
- `emergent_reinsurance_data_leverage` -- first noted turn 5, listed in 1 turn(s) so far: Grid insurers pool OT cyber-risk data into a de facto EU-wide incident repository that US reinsurers demand access to as a condition for continued cover.
...
## Metrics
```json
{"ai_capability": 59.0, "openweight_capability": 55.5, "ai_safety": 32.0, "resilience": 33.5, "eu_ai_sovereignty": 14.0, "eu_political_capital": 6.0, "public_sentiment": 25.0}
```
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Grid and Critical Services Hardening Pact −3, priority −1 = −10
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 4, sentiment 29 -> +2
SOVEREIGNTY: 16 last turn, no cat4 finish, Gigafactories in flight +0, member_state_defection t5 −2, capability rose 1.2 −0 = 14
