...
- characters 376-1771: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1814-4380: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4436-5659: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5722-29004: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29359-29561: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): export_control_escalation, automated_decision_scandal
- Turn 3 (1 turn(s) ago): openweight_frontier_release, export_control_escalation
