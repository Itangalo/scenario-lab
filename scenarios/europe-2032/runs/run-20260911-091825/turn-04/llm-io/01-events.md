...
- characters 2063-4506: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4562-5486: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5549-28831: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29186-29403: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): export_control_escalation
- Turn 3 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, export_control_escalation
