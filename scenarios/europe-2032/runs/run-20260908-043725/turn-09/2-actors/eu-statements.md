...
- `two_year_commitment` (commitment): Secure sovereign AI capacity for crisis resilience and autonomous decision-making

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign AI capacity for crisis resilience and autonomous decision-making
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the two-year period directly ends the original commitment's timeframe, altering the actor's obligation and justifying a reframing of its purpose.
