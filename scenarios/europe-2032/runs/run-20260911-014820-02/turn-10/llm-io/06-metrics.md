...
- characters 13470-13660: `{{metrics_json}}` from the run's live metric values
- characters 13753-14733: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14776-16636: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16692-17073: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Clinical and Administrative Sovereign Fallback | 2 |
...
## Notepad
PORTFOLIO CHARGE t10: M8 EU Clinical and Administrative Sovereign Fallback −2, priority −0 (capital below 20, no effect no cost) = −2
PROPOSAL BONUS: EU Clinical and Administrative Sovereign Fallback (cat 6, small) +3 — bio_incident and frontier cutoff fired this turn and this answers both directly, small size caps it
LEGITIMACY LENDS: capital 1, sentiment 0 -> none (capital higher)
SOVEREIGNTY: 19 last turn, no capacity event, no cat4 in flight bonus, eu_frontier_access_denied t10 −3, capability rose 1.5 −0 = 16
