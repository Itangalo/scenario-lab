...
- characters 375-1355: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1398-3258: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3314-3695: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3758-31224: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31579-32302: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M7 EU Municipal Continuity and Bio-Sentinel Surge −2, priority −0 (capital below 20, no effect no cost) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2, sentiment 6 -> +1 (capped by sentiment, applied after other terms)
SOVEREIGNTY: 19 last turn, no capacity event, no cat4 in flight bonus, capability rose 1.0 −0 = 19
...
- Turn 7 (3 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 8 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, supply_chain_coercion, member_state_defection
- Turn 9 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports
