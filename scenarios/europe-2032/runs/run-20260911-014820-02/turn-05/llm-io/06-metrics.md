...
- characters 13787-15090: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15134-17202: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17258-17664: `{{notepad}}` from the Game Master's notepad, carried across turns
