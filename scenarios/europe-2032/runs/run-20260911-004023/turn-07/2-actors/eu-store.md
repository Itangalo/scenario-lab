...
| M9 | EU Bio Containment and Clinical Sequencing Surge | 6 | small | 7 | 9 | own jurisdiction | resilience up moderately, ai_safety protected | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio Containment and Clinical Sequencing Surge", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected"}, "grounds": "to meet the bio-uplift precursor before diffusion"}
  - Grounds: to meet the bio-uplift precursor before diffusion
