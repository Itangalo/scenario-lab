...
- `two_year_commitment` (commitment): Survive superhuman and bio-risk while keeping essential services running

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Survive superhuman and bio-risk while keeping essential services running
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the timeframe for the original statement, changing the cost of maintaining it.
