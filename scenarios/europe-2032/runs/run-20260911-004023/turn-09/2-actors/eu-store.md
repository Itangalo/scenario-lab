...
| M9 | EU Bio Containment and Clinical Sequencing Surge | 6 | small | 7 | 8 | own jurisdiction | resilience up moderately, ai_safety protected | 2 | finished |
| M10 | EU Autonomous Systems Containment and Continuity Protocol | 6 | small | 8 | 9 | own jurisdiction | resilience up moderately, ai_safety protected | 2 | finished |
| M11 | EU Convoy Seizure and Islanded Continuity Sprint | 6 | small | 9 | 11 | own jurisdiction | resilience up moderately, eu_ai_sovereignty protected | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Convoy Seizure and Islanded Continuity Sprint", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_ai_sovereignty protected"}, "grounds": "to exploit temporary convoy window and survive jump plus bio precursor"}
  - Grounds: to exploit temporary convoy window and survive jump plus bio precursor
