...
| M10 | EU Autonomous Systems Containment and Continuity Protocol | 6 | small | 8 | 10 | own jurisdiction | resilience up moderately, ai_safety protected | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Autonomous Systems Containment and Continuity Protocol", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected"}, "grounds": "to meet RSI onset and eval-anomaly control gate with exercisable containment"}
  - Grounds: to meet RSI onset and eval-anomaly control gate with exercisable containment
