...
- characters 376-1759: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1803-3926: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3982-4639: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4702-28010: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28365-29194: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M8 EU Municipal Bio-Detection and Care Continuity Net −2, priority −0 (capital below 20, no effect, no cost) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 9, sentiment 33 -> +2
SOVEREIGNTY: 30 last turn, no category 4 finish, no capacity event, capability rose 0.7 −0 = 30

## Emerging developments (tracked)

- `emergent_municipal_walkout_spread` -- first noted turn 7, listed in 2 turn(s) so far: Municipal staff unions coordinate a cross-border sick-out and permit-system boycott that spreads beyond integrator-covered cities, forcing extended paper-based administration through autumn 2029.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, eu_access_secured, adoption_success, emergent_datacentre_permit_backlash
- Turn 2 (7 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 3 (6 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 4 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings, eu_frontier_access_denied, member_state_defection
- Turn 5 (4 turn(s) ago): ai_investment_collapse, supply_chain_coercion, emergent_municipal_it_backlash, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, export_control_escalation, emergent_substation_blockade
- Turn 7 (2 turn(s) ago): bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented
- Turn 8 (1 turn(s) ago): bio_uplift_findings, opaque_reasoning, labour_displacement, emergent_public_sector_walkout_spread
