...
- characters 106-13225: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13268-13459: `{{metrics_json}}` from the run's live metric values
- characters 13552-14935: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14979-17102: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17158-17493: `{{notepad}}` from the Game Master's notepad, carried across turns
