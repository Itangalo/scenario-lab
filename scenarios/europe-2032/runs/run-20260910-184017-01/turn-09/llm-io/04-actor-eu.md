...
- characters 454-1837: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1881-4004: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5514-6014: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8428-9779: `{{previous_actions}}` from the actor's own response from the previous turn
