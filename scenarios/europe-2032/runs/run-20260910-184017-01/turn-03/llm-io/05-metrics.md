...
- characters 106-12933: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12976-13168: `{{metrics_json}}` from the run's live metric values
- characters 13261-14605: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14649-16643: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16699-17137: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | Municipal Shield Relief Corps | 2 |
