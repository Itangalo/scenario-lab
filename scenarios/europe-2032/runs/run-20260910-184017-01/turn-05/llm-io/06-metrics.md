...
- characters 13219-15574: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15618-17700: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17756-18536: `{{notepad}}` from the Game Master's notepad, carried across turns
