...
- characters 377-2732: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2776-4858: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4914-5988: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6051-28885: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29240-29612: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M6 EU Essential Services Continuity Stack −3, priority −1 = −10
PROPOSAL BONUS: none — M6 (cat 4, large) answers this turn's cutoff and attack, not an event from the last three rounds
LEGITIMACY LENDS: capital 21, sentiment 42 -> +2
SOVEREIGNTY: 24 last turn, no capacity event finishes, Gigafactories in flight +0, eu_frontier_access_denied t4 −2, capability rose 1.5 −0 = 22

## Emerging developments (tracked)

- `emergent_substation_blockade` -- first noted turn 4, listed in 1 turn(s) so far: A coordinated physical protest campaign blocks grid-connection works at the two unblocked gigafactory shortlist sites, delaying substation upgrades by months and forcing a national permitting review.
- `emergent_municipal_it_backlash` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated sick-outs and resignations by overstretched municipal IT staff in several member states delay both segmentation retrofits and triage/permit hosting, forcing temporary rollback to paper processes.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, eu_access_secured, adoption_success, emergent_datacentre_permit_backlash
- Turn 2 (3 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 3 (2 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 4 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, eu_frontier_access_denied, member_state_defection
