...
- characters 13600-14955: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14998-17186: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17242-17974: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | European Public Services AI Scale-Up | 2 |
...
- `emergent_eu_joint_training_bid` -- first noted turn 1, listed in 2 turn(s) so far: Major EU research universities and Mistral announce a joint pooled-training run on EuroHPC capacity to produce an openly licensed frontier-adjacent model before year-end.
...
## Notepad
PORTFOLIO CHARGE t2: M1 Gigafactories −3, M2 Tech sovereignty package −3, M4 European Public Services AI Scale-Up −2, priority −1 = −9
PROPOSAL BONUS: none — M4 (cat 9, small) rides adoption_success window and permit backlash, no negative event from last three rounds it directly answers
LEGITIMACY LENDS: capital 34, sentiment 43 -> +2
