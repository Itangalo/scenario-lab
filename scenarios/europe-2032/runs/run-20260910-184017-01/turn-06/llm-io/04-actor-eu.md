...
- characters 454-2431: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2474-4685: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5828-6328: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8534-10228: `{{previous_actions}}` from the actor's own response from the previous turn
