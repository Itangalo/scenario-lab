...
- characters 105-13415: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13458-13650: `{{metrics_json}}` from the run's live metric values
- characters 13743-15720: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15763-17974: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18030-18422: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Essential Services Restoration Surge | 2 |
...
PORTFOLIO CHARGE t5: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M6 EU Essential Services Continuity Stack −3, priority −1 = −10
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 13, sentiment 42 -> +2
SOVEREIGNTY: 22 last turn, no capacity event finishes, Gigafactories in flight +0, supply_chain_coercion t5 −2, capability rose 1.0 −0 = 20
...
**emergent_substation_blockade (emergent event):** A coordinated physical protest campaign blocks grid-connection works at the two unblocked gigafactory shortlist sites, delaying substation upgrades by months and forcing a national permitting review.
...
## Metrics
```json
{"ai_capability": 60.5, "openweight_capability": 57.6, "ai_safety": 22.0, "resilience": 42.0, "eu_ai_sovereignty": 26.0, "eu_political_capital": 6.0, "public_sentiment": 31.0}
```
## Narrative
### The sweep
...
## Notepad
PORTFOLIO CHARGE t6: M1 InvestAI Gigafactories −3, M7 EU Essential Services Restoration Surge −2, priority −1 = −6
PROPOSAL BONUS: EU Essential Services Restoration Surge (cat 6, small) +2 — cyber_major_incident landed this turn and this answers it directly, small size limits gain
LEGITIMACY LENDS: capital 4, sentiment 31 -> +2
SOVEREIGNTY: 20 last turn, M2 Tech sovereignty package finishes t6 +4, M6 Continuity Stack finishes t6 +4, M1 in flight +0, export_control_escalation t6 −2, capability rose 1.5 −0 = 26
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 election winner takes office in turn 6"}]}
```
```
