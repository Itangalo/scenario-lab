...
- characters 376-2353: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2396-4607: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4663-5376: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5439-25731: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26086-26586: `{{event_history}}` from the run's own event record
...
- `emergent_substation_blockade` -- first noted turn 4, listed in 2 turn(s) so far: A coordinated physical protest campaign blocks grid-connection works at the two unblocked gigafactory shortlist sites, delaying substation upgrades by months and forcing a national permitting review.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, eu_access_secured, adoption_success, emergent_datacentre_permit_backlash
- Turn 2 (4 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 3 (3 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 4 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, eu_frontier_access_denied, member_state_defection
- Turn 5 (1 turn(s) ago): ai_investment_collapse, supply_chain_coercion, emergent_municipal_it_backlash, election_consolidation
