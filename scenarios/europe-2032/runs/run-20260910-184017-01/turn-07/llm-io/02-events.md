...
- characters 376-2394: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2438-4416: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4472-4986: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5049-28451: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28806-29410: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, eu_access_secured, adoption_success, emergent_datacentre_permit_backlash
- Turn 2 (5 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 3 (4 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 4 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, eu_frontier_access_denied, member_state_defection
- Turn 5 (2 turn(s) ago): ai_investment_collapse, supply_chain_coercion, emergent_municipal_it_backlash, election_consolidation
- Turn 6 (1 turn(s) ago): cyber_major_incident, export_control_escalation, emergent_substation_blockade
