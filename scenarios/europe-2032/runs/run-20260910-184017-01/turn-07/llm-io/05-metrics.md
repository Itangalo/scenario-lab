...
- characters 106-13251: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13294-13485: `{{metrics_json}}` from the run's live metric values
- characters 13578-15596: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15640-17618: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17674-18778: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | EU Municipal Bio-Detection and Care Continuity Net | 2 |
