...
- characters 375-1584: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1627-3682: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3738-4217: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4280-27588: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27943-28867: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M9 EU Sovereign Fallback Operations Pact −2, priority −0 (capital below 20, no effect, no cost) = −2
PROPOSAL BONUS: EU Sovereign Fallback Operations Pact (cat 6, small) +2 — frontier cutoff landed this turn and bio-design claim opened gate, this answers both directly
LEGITIMACY LENDS: capital 8, sentiment 23 -> +2
SOVEREIGNTY: 30 last turn, no category 4 finish, no capacity build in flight +0, eu_frontier_access_denied t9 −3, capability rose 0.7 −0 = 27
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, eu_access_secured, adoption_success, emergent_datacentre_permit_backlash
- Turn 2 (8 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 3 (7 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 4 (6 turn(s) ago): cyber_major_incident, bio_uplift_findings, eu_frontier_access_denied, member_state_defection
- Turn 5 (5 turn(s) ago): ai_investment_collapse, supply_chain_coercion, emergent_municipal_it_backlash, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, export_control_escalation, emergent_substation_blockade
- Turn 7 (3 turn(s) ago): bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented
- Turn 8 (2 turn(s) ago): bio_uplift_findings, opaque_reasoning, labour_displacement, emergent_public_sector_walkout_spread
- Turn 9 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied
