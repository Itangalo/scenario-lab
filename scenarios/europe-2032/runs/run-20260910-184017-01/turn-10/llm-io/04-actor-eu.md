...
- characters 453-1662: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1705-3760: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4292-4761: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7509-9662: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Sovereign Fallback Operations Pact | 6 | small | 9 | 11 | own jurisdiction | resilience up moderately, eu_ai_sovereignty up slightly via EU-hosted fallback | 2 | running |
