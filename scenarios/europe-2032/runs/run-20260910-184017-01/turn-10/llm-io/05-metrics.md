...
- characters 12915-13105: `{{metrics_json}}` from the run's live metric values
- characters 13198-14407: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14450-16505: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16561-17664: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Sovereign Fallback Operations Pact | 2 |
| M10 | EU Joint Threat Response Accession | 2 |
