...
- characters 105-13388: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13431-13623: `{{metrics_json}}` from the run's live metric values
- characters 13716-15312: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15355-17545: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17601-18672: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Essential Services Continuity Stack | 3 |
...
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 European Public Services AI Scale-Up −2, M5 Municipal Shield Relief Corps −2, priority −1 = −11
PROPOSAL BONUS: none — M5 (cat 6, small) answers municipal overload bottleneck, not a negative event from last three rounds
LEGITIMACY LENDS: capital 25, sentiment 47 -> +2
