...
- characters 107-13226: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13269-13459: `{{metrics_json}}` from the run's live metric values
- characters 13552-14291: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14335-16299: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16355-17518: `{{notepad}}` from the Game Master's notepad, carried across turns
