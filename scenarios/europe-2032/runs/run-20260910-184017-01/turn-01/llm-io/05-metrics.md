...
- characters 16235-16527: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M3 | Grid and Port Cyber Shield | 2 |
...
- `emergent_eu_joint_training_bid` -- first noted turn 1, listed in 1 turn(s) so far: Major EU research universities and Mistral announce a joint pooled-training run on EuroHPC capacity to produce an openly licensed frontier-adjacent model before year-end.
...
**emergent_datacentre_permit_backlash (emergent event):** A coordinated campaign across several member states blocks permitting for new AI data centres over power prices and water use, forcing at least one hyperscale project to pause in autumn 2026.
...
## Notepad
PORTFOLIO CHARGE t1: Gigafactories −3, Tech sovereignty package −3, Grid and Port Cyber Shield −2, priority −1 = −9
PROPOSAL BONUS: Grid and Port Cyber Shield (cat 6, small) +2 — autumn cross-continent grid intrusion landed this turn and this answers it directly
LEGITIMACY LENDS: capital 39, sentiment 43 -> +1
SOVEREIGNTY: 22 last turn, no capacity event, Gigafactories in flight +0, eu_access_secured t1 +2, capability rose 1.5 −0 = 24
