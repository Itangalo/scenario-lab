...
- characters 453-1288: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1331-3232: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3589-4058: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6798-7934: `{{previous_actions}}` from the actor's own response from the previous turn
