...
- characters 13142-13332: `{{metrics_json}}` from the run's live metric values
- characters 13425-14260: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14303-16204: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16260-16613: `{{notepad}}` from the Game Master's notepad, carried across turns
