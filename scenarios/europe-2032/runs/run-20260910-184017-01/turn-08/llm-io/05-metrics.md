...
- characters 105-13229: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13272-13463: `{{metrics_json}}` from the run's live metric values
- characters 13556-14652: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14695-16799: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16855-17719: `{{notepad}}` from the Game Master's notepad, carried across turns
