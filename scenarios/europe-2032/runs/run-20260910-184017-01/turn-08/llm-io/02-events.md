...
- characters 375-1471: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1514-3618: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3674-4806: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4869-28271: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28626-29331: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: M7 EU Essential Services Restoration Surge −2, M8 EU Municipal Bio-Detection and Care Continuity Net −2, priority −0 (capital below 20, no effect, no cost) = −4
PROPOSAL BONUS: EU Municipal Bio-Detection and Care Continuity Net (cat 6, small) +2 — bio precursor fired this turn and ransomware-degraded hospitals argue for it directly, small size limits gain
LEGITIMACY LENDS: capital 7, sentiment 31 -> +2
SOVEREIGNTY: 26 last turn, M1 InvestAI Gigafactories finishes t7 +4, no capacity event, capability rose 0.8 −0 = 30

## Emerging developments (tracked)

- `emergent_municipal_walkout_spread` -- first noted turn 7, listed in 1 turn(s) so far: Municipal staff unions coordinate a cross-border sick-out and permit-system boycott that spreads beyond integrator-covered cities, forcing extended paper-based administration through autumn 2029.
- `emergent_public_sector_walkout_spread` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated walkouts by municipal IT staff spread to hospital admin unions, prolonging paper-based fallback in major cities through the autumn despite Brussels surge funding.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, eu_access_secured, adoption_success, emergent_datacentre_permit_backlash
- Turn 2 (6 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 3 (5 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 4 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, eu_frontier_access_denied, member_state_defection
- Turn 5 (3 turn(s) ago): ai_investment_collapse, supply_chain_coercion, emergent_municipal_it_backlash, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, export_control_escalation, emergent_substation_blockade
- Turn 7 (1 turn(s) ago): bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented
