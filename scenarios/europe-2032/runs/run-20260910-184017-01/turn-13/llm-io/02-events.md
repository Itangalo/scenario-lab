...
- characters 376-1271: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1315-2901: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 2957-3273: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3336-26644: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26999-28100: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: (none in flight), priority −0 (capital below 20, no effect, no cost) = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 6, sentiment 20 -> +2
SOVEREIGNTY: 25 last turn, no capacity event, no capacity build finish or in flight +0, capability rose 0.7 −0 = 25
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, eu_access_secured, adoption_success, emergent_datacentre_permit_backlash
- Turn 2 (11 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 3 (10 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 4 (9 turn(s) ago): cyber_major_incident, bio_uplift_findings, eu_frontier_access_denied, member_state_defection
- Turn 5 (8 turn(s) ago): ai_investment_collapse, supply_chain_coercion, emergent_municipal_it_backlash, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, export_control_escalation, emergent_substation_blockade
- Turn 7 (6 turn(s) ago): bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented
- Turn 8 (5 turn(s) ago): bio_uplift_findings, opaque_reasoning, labour_displacement, emergent_public_sector_walkout_spread
- Turn 9 (4 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied
- Turn 10 (3 turn(s) ago): joint_threat_response
- Turn 11 (2 turn(s) ago): cyber_defence_breakthrough, member_state_defection
- Turn 12 (1 turn(s) ago): taiwan_tension_rise
