...
- characters 377-1522: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1566-3765: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3821-5014: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5077-32523: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32878-33271: `{{event_history}}` from the run's own event record

Everything outside those spans is the template's own text.

```
It is now turn 5 which covers July-December 2028.
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M5 EU Bio-Shield and Blockade Continuity Regime −3, priority −1 = −10
PROPOSAL BONUS: EU Bio-Shield and Blockade Continuity Regime (cat 6, large) +6 — bio_incident with real casualties plus taiwan_blockade halting chips fired this turn and this answers both directly
LEGITIMACY LENDS: capital 28, sentiment 22 -> none (capital higher)
SOVEREIGNTY: 17 last turn, M4 EU Essential Services Continuity Stack finishes t4 +4, embodied_ai_deployment t4 −2, capability rose 3.5 −1 = 18

## Emerging developments (tracked)

- `emergent_utility_isolation_backfire` -- first noted turn 3, listed in 2 turn(s) so far: A defensive isolation by a small municipal utility goes wrong, cutting chlorination monitoring for days and causing a brief public-health scare that is blamed on the EU-mandated playbook rather than the intruders.
- `emergent_cyber_insurance_retreat` -- first noted turn 3, listed in 2 turn(s) so far: Major cyber-reinsurers temporarily withdraw or reprice coverage for small municipal utilities after the copycat probe wave, leaving towns unable to insure operational downtime from defensive isolations.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot
- Turn 2 (3 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, emergent_intrusion_tooling_copycats
- Turn 3 (2 turn(s) ago): loss_of_control_incident, capability_jump, eu_frontier_access_denied, adoption_success
- Turn 4 (1 turn(s) ago): bio_incident, taiwan_blockade, bio_uplift_findings, knowledge_work_augmented, embodied_ai_deployment
...
IMPORTANT: For events with date-specific conditions (e.g., "September 2026 is included"), check if the current time period (July-December 2028) covers that date.
...
```
[{"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.48}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.18}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.34}, {"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.03}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "rsi_onset", "probability": 0.35}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.16}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.12}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.12}, {"description": "A defensive isolation by a small municipal utility goes wrong, cutting chlorination monitoring for days and causing a brief public-health scare that is blamed on the EU-mandated playbook rather than the intruders.", "emergent": true, "id": "emergent_utility_isolation_backfire", "probability": 0.14}, {"description": "Major cyber-reinsurers temporarily withdraw or reprice coverage for small municipal utilities after the copycat probe wave, leaving towns unable to insure operational downtime from defensive isolations.", "emergent": true, "id": "emergent_cyber_insurance_retreat", "probability": 0.12}]
```
