...
- characters 13513-14658: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14702-16901: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16957-17517: `{{notepad}}` from the Game Master's notepad, carried across turns
