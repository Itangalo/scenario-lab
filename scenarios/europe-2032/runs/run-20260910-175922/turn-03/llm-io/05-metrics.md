...
- characters 13665-14740: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14784-16639: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16695-17210: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | Municipal Utilities Rapid Shield | 2 |
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, Common Front on External AI Deals −2, Municipal Utilities Rapid Shield −2, priority −1 = −11
PROPOSAL BONUS: Municipal Utilities Rapid Shield (cat 6, small) +3 — openweight frontier release this turn plus wave of municipal probing answers it directly
LEGITIMACY LENDS: capital 17, sentiment 32 -> +2
SOVEREIGNTY: 20 last turn, no capacity build finishes, Gigafactories in flight +0, member_state_defection t3 −2, capability rose 1.5 −0 = 18
