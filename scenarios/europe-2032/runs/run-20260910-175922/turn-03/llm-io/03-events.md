...
- characters 377-1452: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1496-3351: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3407-4228: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4291-26626: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26981-27100: `{{event_history}}` from the run's own event record
