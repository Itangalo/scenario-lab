...
- characters 107-13153: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13196-13387: `{{metrics_json}}` from the run's live metric values
- characters 13480-15275: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15319-17427: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17483-17900: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t10: EU Swarm Defence and Loss-of-Control Containment Rollout −2, priority −0 (ineffective, capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 23 -> +1 (capped, after charges, finishes and events)
SOVEREIGNTY: 16 last turn, no category 4 finish, no category 4 in flight +0, member_state_defection t10 −2, capability rose 0.7 −0 = 14
...
## Metrics
```json
{"ai_capability": 64.6, "openweight_capability": 63.8, "ai_safety": 15.0, "resilience": 43.5, "eu_ai_sovereignty": 11.0, "eu_political_capital": 2.0, "public_sentiment": 20.0}
```
