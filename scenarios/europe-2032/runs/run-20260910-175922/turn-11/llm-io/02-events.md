...
- characters 377-2172: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2216-4324: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4380-4797: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4860-28134: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28489-29318: `{{event_history}}` from the run's own event record
...
- Turn 2 (9 turn(s) ago): member_state_defection
- Turn 3 (8 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 4 (7 turn(s) ago): knowledge_work_augmented
- Turn 5 (6 turn(s) ago): eval_anomaly_reports, safety_breakthrough, election_consolidation
- Turn 6 (5 turn(s) ago): safety_breakthrough, emergent_siting_moratorium_wave
- Turn 7 (4 turn(s) ago): member_state_defection, adoption_success
- Turn 8 (3 turn(s) ago): cyber_major_incident, emergent_permit_litigation_freeze, emergent_us_tier_schedule_release
- Turn 9 (2 turn(s) ago): loss_of_control_incident, ai_investment_collapse, cyber_defence_breakthrough, member_state_defection
- Turn 10 (1 turn(s) ago): medical_breakthrough, knowledge_work_augmented, member_state_defection
