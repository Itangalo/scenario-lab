...
- characters 105-12879: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12922-13114: `{{metrics_json}}` from the run's live metric values
- characters 13207-14557: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14600-16719: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16775-17241: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | Municipal Service Continuity and Recovery Pact | 2 |
