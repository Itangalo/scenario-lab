...
- characters 376-1314: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1357-3429: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3485-4561: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4624-26959: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27314-27384: `{{event_history}}` from the run's own event record
