...
- characters 13765-15214: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15258-16867: `{{world_state}}` from the Game Master's narrative from the previous turn
