...
- characters 1870-3479: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3535-4543: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4606-27440: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27795-28043: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, Common Front on External AI Deals −2, Municipal Utilities Rapid Shield −2, priority −0 (ineffective, capital below 20) = −10
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 9, sentiment 35 -> +2
SOVEREIGNTY: 18 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 18

## Emerging developments (tracked)

- `emergent_siting_moratorium_wave` -- first noted turn 4, listed in 1 turn(s) so far: A coordinated regional moratorium movement blocks or delays two or more planned data-centre and backup-control sites over power and water, forcing siting renegotiation.
- `emergent_datacentre_permit_moratorium` -- first noted turn 4, listed in 1 turn(s) so far: One or more EU regions impose a temporary moratorium on new data centre power and water permits until national grid and environmental reviews conclude, freezing several hyperscaler and gigafactory-adjacent builds.
...
- Turn 2 (3 turn(s) ago): member_state_defection
