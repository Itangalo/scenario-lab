...
- characters 1948-3557: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5337-5796: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7981-9190: `{{previous_actions}}` from the actor's own response from the previous turn
