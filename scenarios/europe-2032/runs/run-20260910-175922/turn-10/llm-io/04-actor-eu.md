...
- characters 454-2081: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2124-4174: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5435-5874: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8620-11178: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Swarm Defence and Loss-of-Control Containment Rollout | 6 | small | 9 | 11 | own jurisdiction | resilience up materially, ai_safety up slightly via containment learning | 2 | running |
