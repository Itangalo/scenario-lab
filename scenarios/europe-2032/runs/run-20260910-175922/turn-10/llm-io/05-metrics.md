...
- characters 106-13256: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13299-13490: `{{metrics_json}}` from the run's live metric values
- characters 13583-15210: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15253-17303: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17359-18018: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Swarm Defence and Loss-of-Control Containment Rollout | 2 |
