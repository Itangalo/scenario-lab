...
- characters 105-13222: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13265-13457: `{{metrics_json}}` from the run's live metric values
- characters 13550-14872: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14915-17369: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17425-17758: `{{notepad}}` from the Game Master's notepad, carried across turns
...
**emergent_siting_moratorium_wave (emergent event):** A coordinated regional moratorium movement blocks or delays two or more planned data-centre and backup-control sites over power and water, forcing siting renegotiation.
