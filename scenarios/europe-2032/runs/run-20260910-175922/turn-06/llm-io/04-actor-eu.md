...
- characters 1819-4273: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4912-5359: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7545-8844: `{{previous_actions}}` from the actor's own response from the previous turn
