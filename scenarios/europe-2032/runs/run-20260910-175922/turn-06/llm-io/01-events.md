...
- characters 1741-4195: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4251-5184: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5247-26200: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26555-26895: `{{event_history}}` from the run's own event record
...
- `emergent_siting_moratorium_wave` -- first noted turn 4, listed in 2 turn(s) so far: A coordinated regional moratorium movement blocks or delays two or more planned data-centre and backup-control sites over power and water, forcing siting renegotiation.
- `emergent_datacentre_permit_moratorium` -- first noted turn 4, listed in 2 turn(s) so far: One or more EU regions impose a temporary moratorium on new data centre power and water permits until national grid and environmental reviews conclude, freezing several hyperscaler and gigafactory-adjacent builds.
...
- Turn 2 (4 turn(s) ago): member_state_defection
- Turn 3 (3 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 4 (2 turn(s) ago): knowledge_work_augmented
- Turn 5 (1 turn(s) ago): eval_anomaly_reports, safety_breakthrough, election_consolidation
