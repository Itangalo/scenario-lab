...
- characters 106-12820: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12863-13054: `{{metrics_json}}` from the run's live metric values
- characters 13147-14504: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14547-16732: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16788-17476: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | Municipal Automated Patching Surge | 2 |
...
## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M9", "fields": {"finish_turn": 13}, "grounds": "named priority"}]}
```
```
