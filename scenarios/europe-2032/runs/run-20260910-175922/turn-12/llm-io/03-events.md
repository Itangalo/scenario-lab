...
- characters 1776-3961: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4017-4364: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4427-27701: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28056-28964: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: (none in flight) = −0 + priority −0 = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 20 -> +2 (capped, after charges, finishes and events)
SOVEREIGNTY: 14 last turn, no category 4 finish, no category 4 in flight +0, supply_chain_coercion t11 −3, capability rose 0.7 −0 = 11
...
- Turn 2 (10 turn(s) ago): member_state_defection
- Turn 3 (9 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 4 (8 turn(s) ago): knowledge_work_augmented
- Turn 5 (7 turn(s) ago): eval_anomaly_reports, safety_breakthrough, election_consolidation
- Turn 6 (6 turn(s) ago): safety_breakthrough, emergent_siting_moratorium_wave
- Turn 7 (5 turn(s) ago): member_state_defection, adoption_success
- Turn 8 (4 turn(s) ago): cyber_major_incident, emergent_permit_litigation_freeze, emergent_us_tier_schedule_release
- Turn 9 (3 turn(s) ago): loss_of_control_incident, ai_investment_collapse, cyber_defence_breakthrough, member_state_defection
- Turn 10 (2 turn(s) ago): medical_breakthrough, knowledge_work_augmented, member_state_defection
- Turn 11 (1 turn(s) ago): openweight_frontier_release, supply_chain_coercion
