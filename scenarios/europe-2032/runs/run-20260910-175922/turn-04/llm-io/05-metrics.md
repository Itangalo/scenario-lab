...
- characters 13260-14224: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14267-16176: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16232-17349: `{{notepad}}` from the Game Master's notepad, carried across turns
