...
- characters 376-1340: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1383-3292: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3348-3865: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3928-26263: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26618-26815: `{{event_history}}` from the run's own event record
