...
- characters 1670-4193: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4249-4593: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4656-27988: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28343-28762: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): member_state_defection
- Turn 3 (4 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 4 (3 turn(s) ago): knowledge_work_augmented
- Turn 5 (2 turn(s) ago): eval_anomaly_reports, safety_breakthrough, election_consolidation
- Turn 6 (1 turn(s) ago): safety_breakthrough, emergent_siting_moratorium_wave
