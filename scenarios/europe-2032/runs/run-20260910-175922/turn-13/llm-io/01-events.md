...
- characters 377-2263: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2307-4124: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4180-4989: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5052-29179: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29534-30497: `{{event_history}}` from the run's own event record
...
- `emergent_grassroots_triage_kit` -- first noted turn 12, listed in 1 turn(s) so far: Municipal IT staff circulate a stripped-down offline triage toolkit built from the ENISA playbooks that spreads peer-to-peer among small towns, partially offsetting dependence on foreign models for incident response.
...
- Turn 2 (11 turn(s) ago): member_state_defection
- Turn 3 (10 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 4 (9 turn(s) ago): knowledge_work_augmented
- Turn 5 (8 turn(s) ago): eval_anomaly_reports, safety_breakthrough, election_consolidation
- Turn 6 (7 turn(s) ago): safety_breakthrough, emergent_siting_moratorium_wave
- Turn 7 (6 turn(s) ago): member_state_defection, adoption_success
- Turn 8 (5 turn(s) ago): cyber_major_incident, emergent_permit_litigation_freeze, emergent_us_tier_schedule_release
- Turn 9 (4 turn(s) ago): loss_of_control_incident, ai_investment_collapse, cyber_defence_breakthrough, member_state_defection
- Turn 10 (3 turn(s) ago): medical_breakthrough, knowledge_work_augmented, member_state_defection
- Turn 11 (2 turn(s) ago): openweight_frontier_release, supply_chain_coercion
- Turn 12 (1 turn(s) ago): cyber_defence_breakthrough
