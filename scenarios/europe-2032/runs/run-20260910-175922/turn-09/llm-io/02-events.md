...
- characters 376-1658: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1702-3669: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3725-4251: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4314-28249: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28604-29207: `{{event_history}}` from the run's own event record
...
- Turn 2 (7 turn(s) ago): member_state_defection
- Turn 3 (6 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 4 (5 turn(s) ago): knowledge_work_augmented
- Turn 5 (4 turn(s) ago): eval_anomaly_reports, safety_breakthrough, election_consolidation
- Turn 6 (3 turn(s) ago): safety_breakthrough, emergent_siting_moratorium_wave
- Turn 7 (2 turn(s) ago): member_state_defection, adoption_success
- Turn 8 (1 turn(s) ago): cyber_major_incident, emergent_permit_litigation_freeze, emergent_us_tier_schedule_release
