...
- characters 13335-13526: `{{metrics_json}}` from the run's live metric values
- characters 13619-14901: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14945-16912: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16968-17494: `{{notepad}}` from the Game Master's notepad, carried across turns
