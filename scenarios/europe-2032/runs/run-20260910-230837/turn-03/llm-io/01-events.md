...
- characters 1934-3695: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3751-4586: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4649-27931: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28286-28406: `{{event_history}}` from the run's own event record
...
- Turn 2 (1 turn(s) ago): member_state_defection, emergent_permitting_backlash
