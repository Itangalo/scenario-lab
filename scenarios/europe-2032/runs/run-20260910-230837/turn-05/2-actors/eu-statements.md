...
- `two_year_commitment` (commitment): Hold leverage and harden society through the chip and bio shocks

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold leverage and harden society through the chip and bio shocks
