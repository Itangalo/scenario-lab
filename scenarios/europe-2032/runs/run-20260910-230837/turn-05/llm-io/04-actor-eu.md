...
- characters 455-3133: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3177-5039: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6815-7255: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9311-11195: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU Displaced-Worker Bridge | 7 | small | 4 | 7 | own jurisdiction | public_sentiment up, eu_political_capital up, resilience up modestly | 2 | running |
...
| M4 | EU Grid Hardening and Incident Response Pact | 6 | small | 2 | 5 | own jurisdiction | resilience up | 2 | finished |
