...
- characters 377-3055: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3099-4961: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5017-5456: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5519-29300: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29655-29821: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): member_state_defection, emergent_permitting_backlash
- Turn 3 (2 turn(s) ago): taiwan_tension_rise
