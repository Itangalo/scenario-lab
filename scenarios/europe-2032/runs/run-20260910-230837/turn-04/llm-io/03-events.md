...
- characters 376-2293: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2336-4127: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4183-4880: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4943-28225: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28580-28746: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): member_state_defection, emergent_permitting_backlash
- Turn 3 (1 turn(s) ago): taiwan_tension_rise
