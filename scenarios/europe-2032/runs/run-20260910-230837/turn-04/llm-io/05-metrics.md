...
- characters 13736-15653: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15696-17487: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17543-17936: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Displaced-Worker Bridge | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Grid Hardening and Incident Response Pact −2, priority −1 = −12
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Grid Hardening and Incident Response Pact −2, EU Displaced-Worker Bridge −2, priority −1 = −11
PROPOSAL BONUS: none — no qualifying event in last three turns, new Bridge answers chronic scepticism not a shock
LEGITIMACY LENDS: capital 11, sentiment 31 -> +2
SOVEREIGNTY: 18 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 18
