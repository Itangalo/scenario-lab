...
- characters 377-1416: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1460-3532: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3588-4792: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4855-29807: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30162-31011: `{{event_history}}` from the run's own event record
...
- `emergent_siting_permit_freeze` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated student-union blockades shut down two planned data-centre sites for weeks, forcing a national permitting freeze that spreads to neighbouring member states.
- `emergent_siting_moratorium_push` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated student-union blockades halt construction at two planned data-centre sites and force a member-state government to announce a local moratorium vote, turning siting opposition from protest into permitting risk.
...
- Turn 2 (9 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, emergent_model_access_freeze
- Turn 3 (8 turn(s) ago): emergent_sovereign_hosting_offer
- Turn 4 (7 turn(s) ago): cyber_major_incident, ai_investment_collapse
- Turn 5 (6 turn(s) ago): knowledge_work_augmented, supply_chain_coercion, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings, export_control_escalation, emergent_hosting_pilot_suspension
- Turn 7 (4 turn(s) ago): cyber_defence_breakthrough, emergent_shadow_fallback_stack
- Turn 8 (3 turn(s) ago): knowledge_work_augmented, export_control_escalation, adoption_success
- Turn 9 (2 turn(s) ago): labour_displacement
- Turn 10 (1 turn(s) ago): cyber_major_incident, export_control_escalation, joint_threat_response
