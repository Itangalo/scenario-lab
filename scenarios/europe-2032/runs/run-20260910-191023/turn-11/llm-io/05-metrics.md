...
- characters 107-13352: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13395-13586: `{{metrics_json}}` from the run's live metric values
- characters 13679-14718: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14762-16834: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16890-18094: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Entry-Level Guarantee Top-Up | 2 |
