...
- characters 13057-13249: `{{metrics_json}}` from the run's live metric values
- characters 13342-14404: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14448-16511: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16567-17154: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Sovereign Hosting Accreditation Pact | 2 |
