...
- characters 107-13235: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13278-13469: `{{metrics_json}}` from the run's live metric values
- characters 13562-15050: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15094-17485: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17541-18029: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Cure Access Deployment | 2 |
| M13 | EU Offline Care Continuity Shield | 2 |
...
## Notepad
PORTFOLIO CHARGE t13: EU Cure Access Deployment −2, EU Offline Care Continuity Shield −2, priority −0 (capital 8 below 20, priority has no effect and no cost) = −4
PROPOSAL BONUS: EU Offline Care Continuity Shield (cat 6, small) +3 — answers frontier cutoff this turn directly and bio/openweight shock in part
LEGITIMACY LENDS: capital 5, sentiment 8 -> +1 (capped below sentiment, after other terms)
SOVEREIGNTY: 15 last turn, no capacity event none, no cat4 in flight +0, eu_frontier_access_denied t13 −3, capability rose 0.6 −0 = 12
