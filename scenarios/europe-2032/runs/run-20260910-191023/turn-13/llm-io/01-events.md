...
- characters 377-1865: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1909-4300: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4356-4844: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4907-29859: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30214-31160: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Entry-Level Guarantee Top-Up −2, EU Cure Access Deployment −2, priority −0 (capital 12 below 20, priority has no effect and no cost) = −4
PROPOSAL BONUS: none — EU Cure Access Deployment (cat 9, small) answers medical_breakthrough which is a positive shock, not a negative event from last three rounds
LEGITIMACY LENDS: capital 8, sentiment 7 -> none (capital higher)
SOVEREIGNTY: 15 last turn, no capacity event, no cat4 in flight +0, capability rose 0.8 −0 = 15
...
- Turn 2 (11 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, emergent_model_access_freeze
- Turn 3 (10 turn(s) ago): emergent_sovereign_hosting_offer
- Turn 4 (9 turn(s) ago): cyber_major_incident, ai_investment_collapse
- Turn 5 (8 turn(s) ago): knowledge_work_augmented, supply_chain_coercion, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, bio_uplift_findings, export_control_escalation, emergent_hosting_pilot_suspension
- Turn 7 (6 turn(s) ago): cyber_defence_breakthrough, emergent_shadow_fallback_stack
- Turn 8 (5 turn(s) ago): knowledge_work_augmented, export_control_escalation, adoption_success
- Turn 9 (4 turn(s) ago): labour_displacement
- Turn 10 (3 turn(s) ago): cyber_major_incident, export_control_escalation, joint_threat_response
- Turn 11 (2 turn(s) ago): labour_displacement
- Turn 12 (1 turn(s) ago): medical_breakthrough
