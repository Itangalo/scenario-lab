...
- characters 106-13380: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13423-13614: `{{metrics_json}}` from the run's live metric values
- characters 13707-14841: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14885-17188: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17244-18326: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 59.0, "openweight_capability": 56.0, "ai_safety": 31.0, "resilience": 43.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 10.0, "public_sentiment": 17.0}
```
## Narrative
### Holding the line
