...
- characters 1632-3935: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5834-6270: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8223-9775: `{{previous_actions}}` from the actor's own response from the previous turn
