...
- characters 106-12858: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12901-13092: `{{metrics_json}}` from the run's live metric values
- characters 13185-14682: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14725-16572: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16628-17116: `{{notepad}}` from the Game Master's notepad, carried across turns
