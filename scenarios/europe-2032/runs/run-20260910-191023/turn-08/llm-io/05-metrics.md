...
- characters 105-13242: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13285-13476: `{{metrics_json}}` from the run's live metric values
- characters 13569-14695: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14738-16840: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16896-17757: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | European Visible Benefit Deployment | 2 |
