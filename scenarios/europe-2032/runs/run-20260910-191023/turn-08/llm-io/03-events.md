...
- characters 375-1501: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1544-3646: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3702-4563: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4626-28975: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29330-29938: `{{event_history}}` from the run's own event record
...
- Turn 2 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, emergent_model_access_freeze
- Turn 3 (5 turn(s) ago): emergent_sovereign_hosting_offer
- Turn 4 (4 turn(s) ago): cyber_major_incident, ai_investment_collapse
- Turn 5 (3 turn(s) ago): knowledge_work_augmented, supply_chain_coercion, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, export_control_escalation, emergent_hosting_pilot_suspension
- Turn 7 (1 turn(s) ago): cyber_defence_breakthrough, emergent_shadow_fallback_stack
