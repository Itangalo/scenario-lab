...
- characters 455-1609: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1652-3534: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4868-5334: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7958-10895: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Entry-Level Transition Shield | 7 | small | 9 | 11 | own jurisdiction | public_sentiment up slightly, eu_political_capital up slightly, resilience up slightly | 2 | running |
