...
- characters 1964-4028: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4084-4702: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4765-28047: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28402-28626: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, emergent_model_access_freeze
- Turn 3 (1 turn(s) ago): emergent_sovereign_hosting_offer
