...
- characters 13635-15180: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15223-17287: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17343-18567: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 57.5, "openweight_capability": 54.4, "ai_safety": 33.0, "resilience": 40.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 9.0, "public_sentiment": 21.0}
```
