...
- characters 106-13245: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13288-13479: `{{metrics_json}}` from the run's live metric values
- characters 13572-14725: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14769-16536: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16592-17449: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Swarm-Defence Rollout and Offline Stack Adoption | 2 |
...
- `emergent_care_staff_walkout` -- first noted turn 7, listed in 1 turn(s) so far: Municipal hospital staff stage coordinated walkouts blaming AI-driven rostering and paper-slow systems for unsafe shifts, spreading to two more member states.
