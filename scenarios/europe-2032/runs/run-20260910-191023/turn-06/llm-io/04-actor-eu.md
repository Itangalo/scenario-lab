...
- characters 1544-3786: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5430-5757: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7710-10233: `{{previous_actions}}` from the actor's own response from the previous turn
