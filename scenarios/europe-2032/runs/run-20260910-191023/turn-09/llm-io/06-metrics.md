...
- characters 13592-14791: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14835-16934: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16990-17493: `{{notepad}}` from the Game Master's notepad, carried across turns
