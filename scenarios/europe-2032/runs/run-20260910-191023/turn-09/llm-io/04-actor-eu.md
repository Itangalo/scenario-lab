...
- characters 1697-3796: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4174-4501: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6939-8752: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | European Visible Benefit Deployment | 9 | small | 8 | 10 | own jurisdiction | public_sentiment up moderately, eu_political_capital up slightly | 2 | running |
