...
- characters 376-1575: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1619-3718: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3774-4556: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4619-28968: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29323-30027: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Swarm-Defence Rollout and Offline Stack Adoption −2, European Visible Benefit Deployment −2, priority −0 (capital 7 below 20, priority has no effect and no cost) = −4
PROPOSAL BONUS: none — M8 (cat 9, small) converts positive adoption_success and office gains, not a negative event from last three turns
LEGITIMACY LENDS: capital 2, sentiment 14 -> +2
SOVEREIGNTY: 20 last turn, no cat4 finishes, no cat4 in flight +0, export_control_escalation t8 −2, capability rose 0.5 −0 = 18

## Emerging developments (tracked)

- `emergent_care_staff_walkout` -- first noted turn 7, listed in 2 turn(s) so far: Municipal hospital staff stage coordinated walkouts blaming AI-driven rostering and paper-slow systems for unsafe shifts, spreading to two more member states.
...
- Turn 2 (7 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, emergent_model_access_freeze
- Turn 3 (6 turn(s) ago): emergent_sovereign_hosting_offer
- Turn 4 (5 turn(s) ago): cyber_major_incident, ai_investment_collapse
- Turn 5 (4 turn(s) ago): knowledge_work_augmented, supply_chain_coercion, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, export_control_escalation, emergent_hosting_pilot_suspension
- Turn 7 (2 turn(s) ago): cyber_defence_breakthrough, emergent_shadow_fallback_stack
- Turn 8 (1 turn(s) ago): knowledge_work_augmented, export_control_escalation, adoption_success
