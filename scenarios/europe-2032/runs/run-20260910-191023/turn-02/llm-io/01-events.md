...
- characters 376-1283: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1326-3074: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3130-4236: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4299-27581: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27936-27977: `{{event_history}}` from the run's own event record
