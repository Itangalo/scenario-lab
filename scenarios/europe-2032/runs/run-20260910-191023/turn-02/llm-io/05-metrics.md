...
- characters 105-12960: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13003-13195: `{{metrics_json}}` from the run's live metric values
- characters 13288-14195: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14238-15986: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16042-16847: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M3 | EU Grid and Critical Services Hardening Shield | 3 |
| M4 | EU AI Incident Containment and Continuity Corps | 3 |
...
PORTFOLIO CHARGE t1: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Grid and Critical Services Hardening Shield −3, priority −1 = −10
PROPOSAL BONUS: EU Grid and Critical Services Hardening Shield (cat 6, large) +4 — cyber_test_shot precursor intrusion this turn and this answers it directly
LEGITIMACY LENDS: none — capital 48, sentiment 42, capital higher
SOVEREIGNTY: 22 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 22

## Emerging developments (tracked)

- `emergent_sovereign_hosting_offer` -- first noted turn 1, listed in 2 turn(s) so far: A major non-EU cloud provider announces EU-local model hosting with data residency guarantees after the June switch-off scare, easing near-term continuity fears without changing legal control from Washington.
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 49.8, "ai_safety": 37.0, "resilience": 37.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 31.0, "public_sentiment": 28.0}
```
...
## Notepad
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Grid and Critical Services Hardening Shield −3, EU AI Incident Containment and Continuity Corps −3, priority −1 = −13
PROPOSAL BONUS: EU AI Incident Containment and Continuity Corps (cat 6, large) +6 — cyber_major_incident and loss_of_control_incident both landed this turn and this answers them directly
LEGITIMACY LENDS: none — capital 31, sentiment 28, capital higher
SOVEREIGNTY: 22 last turn, no finished cat4, Gigafactories in flight +0, emergent_model_access_freeze t2 −1, capability rose 1.5 −0 = 21

## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M3", "fields": {"finish_turn": 4}, "grounds": "named priority"}]}
```
```
