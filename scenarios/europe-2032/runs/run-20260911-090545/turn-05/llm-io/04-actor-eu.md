...
- characters 1566-3814: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5569-6041: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8186-10140: `{{previous_actions}}` from the actor's own response from the previous turn
