...
- characters 1723-3791: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3847-4253: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4316-28626: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28981-29275: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Grid and Public Services Shield −3, priority −0 (capital below 20, no effect no cost) = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 22 -> +2
SOVEREIGNTY: 18 last turn, no capacity event, Gigafactories in flight +0, supply_chain_coercion t4 −3, capability rose 2.0 −1 = 14
...
- Turn 2 (3 turn(s) ago): cyber_major_incident, safety_breakthrough, eu_frontier_access_denied, adoption_success
- Turn 3 (2 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, taiwan_tension_rise
