...
- `two_year_commitment` (commitment): Secure independent AI capability to act with sovereignty in a world where access can be withdrawn at will.

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure independent AI capability to act with sovereignty in a world where access can be withdrawn at will.
