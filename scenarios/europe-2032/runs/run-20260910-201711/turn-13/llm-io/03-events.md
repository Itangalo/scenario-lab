...
- characters 376-1448: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1492-3697: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3753-4311: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4374-29461: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29816-30986: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Anomaly Triage and Essential-Systems Hold −2, priority −1 = −2 (capital below 20, priority has no effect and no cost)
PROPOSAL BONUS: EU Anomaly Triage and Essential-Systems Hold (cat 5, small) +2 — leaked eval anomaly fired this turn and this answers it directly; export rationing also recent but answered only indirectly
LEGITIMACY LENDS: none — capital 16.0 above sentiment 3.0
SOVEREIGNTY: 25.5 last turn, no capacity event? export_control_escalation t12 −2, no cat4 finish +0, no cat4 in flight +0, capability rose 0.5 −0 = 23.5
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, eval_anomaly_reports, emergent_fraud_wave_eu
- Turn 2 (11 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports, member_state_defection
- Turn 3 (10 turn(s) ago): joint_threat_response
- Turn 4 (9 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, joint_threat_response
- Turn 5 (8 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, middle_power_coalition, election_consolidation
- Turn 6 (7 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, export_control_escalation, eu_frontier_access_denied
- Turn 7 (6 turn(s) ago): taiwan_blockade, research_breakthrough, eu_frontier_access_denied, automated_decision_scandal
- Turn 8 (5 turn(s) ago): research_breakthrough, emergent_datacentre_siting_freeze
- Turn 9 (4 turn(s) ago): member_state_defection
- Turn 10 (3 turn(s) ago): loss_of_control_incident, taiwan_tension_rise, export_control_escalation, eu_frontier_access_denied
- Turn 11 (2 turn(s) ago): capability_jump, automated_decision_scandal, emergent_energy_rationing_moratorium
- Turn 12 (1 turn(s) ago): eval_anomaly_reports, export_control_escalation
