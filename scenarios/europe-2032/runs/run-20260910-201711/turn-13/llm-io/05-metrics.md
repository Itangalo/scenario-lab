...
- characters 107-12888: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12931-13121: `{{metrics_json}}` from the run's live metric values
- characters 13214-14286: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14330-16535: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16591-17149: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M15 | EU Middle-Power Reciprocal Access Compact | 2 |
