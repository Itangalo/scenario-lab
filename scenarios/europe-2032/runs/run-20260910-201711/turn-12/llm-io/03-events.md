...
- characters 375-2227: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2270-4220: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4276-5091: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5154-30241: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30596-31690: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Hospital-First Power and Wronged-Citizen Redress Pact −2, priority −1 = −3
PROPOSAL BONUS: EU Hospital-First Power and Wronged-Citizen Redress Pact (cat 9, small) +3 — automated-decision scandal and rationing moratorium votes fired this turn and this answers both directly
LEGITIMACY LENDS: none — capital 21.0 above sentiment 7.0
SOVEREIGNTY: 26.5 last turn, no capacity event, no cat4 finish +0, no cat4 in flight +0, capability rose 3.8 −1 = 25.5

## Emerging developments (tracked)

- `emergent_grid_connection_injunctions` -- first noted turn 10, listed in 2 turn(s) so far: Coordinated municipal lawsuits against data-centre operators over water use and unpaid revenue shares consolidate into a national court injunction wave, freezing new grid connections until escrow payments land.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, eval_anomaly_reports, emergent_fraud_wave_eu
- Turn 2 (10 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports, member_state_defection
- Turn 3 (9 turn(s) ago): joint_threat_response
- Turn 4 (8 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, joint_threat_response
- Turn 5 (7 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, middle_power_coalition, election_consolidation
- Turn 6 (6 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, export_control_escalation, eu_frontier_access_denied
- Turn 7 (5 turn(s) ago): taiwan_blockade, research_breakthrough, eu_frontier_access_denied, automated_decision_scandal
- Turn 8 (4 turn(s) ago): research_breakthrough, emergent_datacentre_siting_freeze
- Turn 9 (3 turn(s) ago): member_state_defection
- Turn 10 (2 turn(s) ago): loss_of_control_incident, taiwan_tension_rise, export_control_escalation, eu_frontier_access_denied
- Turn 11 (1 turn(s) ago): capability_jump, automated_decision_scandal, emergent_energy_rationing_moratorium
