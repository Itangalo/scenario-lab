...
- characters 106-13271: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13314-13504: `{{metrics_json}}` from the run's live metric values
- characters 13597-15449: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15492-17442: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17498-17972: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Anomaly Triage and Essential-Systems Hold | 2 |
