...
- characters 453-2305: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2348-4298: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5267-5727: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9277-11411: `{{previous_actions}}` from the actor's own response from the previous turn
