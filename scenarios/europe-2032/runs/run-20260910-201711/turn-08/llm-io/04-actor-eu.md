...
- characters 454-2392: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2435-4714: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6363-6825: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9527-12129: `{{previous_actions}}` from the actor's own response from the previous turn
