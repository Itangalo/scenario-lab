...
- characters 1700-3597: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3653-4248: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4311-28660: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29015-29619: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, eval_anomaly_reports, emergent_fraud_wave_eu
- Turn 2 (5 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports, member_state_defection
- Turn 3 (4 turn(s) ago): joint_threat_response
- Turn 4 (3 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, joint_threat_response
- Turn 5 (2 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, middle_power_coalition, election_consolidation
- Turn 6 (1 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, export_control_escalation, eu_frontier_access_denied
