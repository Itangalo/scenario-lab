...
- characters 1778-3675: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7102-7564: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10076-12020: `{{previous_actions}}` from the actor's own response from the previous turn
