...
- characters 13262-14676: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14719-16862: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16918-18158: `{{notepad}}` from the Game Master's notepad, carried across turns
