...
- characters 107-13286: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13329-13520: `{{metrics_json}}` from the run's live metric values
- characters 13613-15049: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15093-17374: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17430-18270: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Hospital-First Power and Wronged-Citizen Redress Pact | 2 |
