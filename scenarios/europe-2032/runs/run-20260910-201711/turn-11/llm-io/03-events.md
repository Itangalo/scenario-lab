...
- characters 377-1813: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1857-4138: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4194-5329: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5392-29626: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29981-30965: `{{event_history}}` from the run's own event record
...
- `emergent_grid_connection_injunctions` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated municipal lawsuits against data-centre operators over water use and unpaid revenue shares consolidate into a national court injunction wave, freezing new grid connections until escrow payments land.
- `emergent_energy_rationing_moratorium` -- first noted turn 10, listed in 1 turn(s) so far: A second dry winter forces extended power rationing across two grids, triggering coordinated municipal moratorium votes on new data-centre connections until hospital and household supply is guaranteed.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, eval_anomaly_reports, emergent_fraud_wave_eu
- Turn 2 (9 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports, member_state_defection
- Turn 3 (8 turn(s) ago): joint_threat_response
- Turn 4 (7 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, joint_threat_response
- Turn 5 (6 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, middle_power_coalition, election_consolidation
- Turn 6 (5 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, export_control_escalation, eu_frontier_access_denied
- Turn 7 (4 turn(s) ago): taiwan_blockade, research_breakthrough, eu_frontier_access_denied, automated_decision_scandal
- Turn 8 (3 turn(s) ago): research_breakthrough, emergent_datacentre_siting_freeze
- Turn 9 (2 turn(s) ago): member_state_defection
- Turn 10 (1 turn(s) ago): loss_of_control_incident, taiwan_tension_rise, export_control_escalation, eu_frontier_access_denied
