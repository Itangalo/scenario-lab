...
- characters 377-1710: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1754-3701: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3757-5036: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5099-27720: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28075-28427: `{{event_history}}` from the run's own event record
...
- `emergent_municipal_insurance_pullback` -- first noted turn 4, listed in 1 turn(s) so far: Major EU cyber-insurers suspend new municipal cyber coverage or sharply raise deductibles after the 2027 poisoned-update losses, leaving smaller cities uninsured through the first half of 2028.
- `emergent_insurance_retreat_utilities` -- first noted turn 4, listed in 1 turn(s) so far: Municipal insurers across several member states jointly refuse to renew cyber coverage for utilities still running unpatched legacy stacks, forcing emergency state backstops and a public fight over who pays for the domestic shield rollout.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, eval_anomaly_reports, emergent_fraud_wave_eu
- Turn 2 (3 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports, member_state_defection
- Turn 3 (2 turn(s) ago): joint_threat_response
- Turn 4 (1 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, joint_threat_response
