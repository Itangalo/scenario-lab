...
- characters 1857-3906: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5608-6068: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9178-11469: `{{previous_actions}}` from the actor's own response from the previous turn
