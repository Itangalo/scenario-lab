...
- characters 106-13276: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13319-13511: `{{metrics_json}}` from the run's live metric values
- characters 13604-14963: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15006-17055: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17111-18240: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Sovereign Continuity Reserve for Essential Services | 2 |
...
PORTFOLIO CHARGE t9: EU Displaced Worker Income and Retraining Guarantee −2, priority −1 = −3
PROPOSAL BONUS: EU Displaced Worker Income and Retraining Guarantee (cat 7, small) +3 — welfare scandal and siting blockade last turns and member defection pressure this turn and this answers both directly
LEGITIMACY LENDS: none — capital 24.0 above sentiment 13.0
SOVEREIGNTY: 30.5 last turn, no capacity event? no — member_state_defection t9 −2, no cat4 in flight +0, capability rose 0.7 −0 = 28.5
