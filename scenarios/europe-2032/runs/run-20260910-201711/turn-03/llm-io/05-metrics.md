...
- characters 13327-14299: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14343-15920: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 15976-16496: `{{notepad}}` from the Game Master's notepad, carried across turns
