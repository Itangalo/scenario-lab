...
| M11 | EU Displaced Worker Income and Retraining Guarantee | 7 | small | 9 | 11 | own jurisdiction | public_sentiment up, eu_political_capital stabilise, resilience up small via social absorption | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Displaced Worker Income and Retraining Guarantee", "category": 7, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, eu_political_capital stabilise, resilience up small via social absorption"}, "grounds": "answering welfare scandal, siting blockade and defection pressure"}
  - Grounds: answering welfare scandal, siting blockade and defection pressure
