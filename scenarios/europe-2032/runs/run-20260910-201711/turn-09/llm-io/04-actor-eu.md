...
- characters 1701-4031: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4411-4873: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7769-10029: `{{previous_actions}}` from the actor's own response from the previous turn
