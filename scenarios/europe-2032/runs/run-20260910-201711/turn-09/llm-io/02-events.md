...
- characters 1623-3953: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4009-4793: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4856-28487: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28842-29649: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, eval_anomaly_reports, emergent_fraud_wave_eu
- Turn 2 (7 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports, member_state_defection
- Turn 3 (6 turn(s) ago): joint_threat_response
- Turn 4 (5 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, joint_threat_response
- Turn 5 (4 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, middle_power_coalition, election_consolidation
- Turn 6 (3 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, export_control_escalation, eu_frontier_access_denied
- Turn 7 (2 turn(s) ago): taiwan_blockade, research_breakthrough, eu_frontier_access_denied, automated_decision_scandal
- Turn 8 (1 turn(s) ago): research_breakthrough, emergent_datacentre_siting_freeze
