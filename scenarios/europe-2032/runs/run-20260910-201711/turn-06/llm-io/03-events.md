...
- characters 376-2286: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2329-4473: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4529-5789: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5852-27091: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27446-27921: `{{event_history}}` from the run's own event record
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, eval_anomaly_reports, emergent_fraud_wave_eu
- Turn 2 (4 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports, member_state_defection
- Turn 3 (3 turn(s) ago): joint_threat_response
- Turn 4 (2 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, joint_threat_response
- Turn 5 (1 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, middle_power_coalition, election_consolidation
