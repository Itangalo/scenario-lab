...
- characters 13719-15629: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15672-17816: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17872-18476: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | EU Essential Services Frontier Fallback | 2 |
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 election settled tiered strategic-asset administration, takes office turn 6"}, {"op": "update", "table": "measures", "id": "M8", "fields": {"finish_turn": 7}, "grounds": "named priority"}]}
```
```
