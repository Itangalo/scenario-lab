...
- characters 16248-16611: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_phage_publication_freeze` -- first noted turn 1, listed in 1 turn(s) so far: A major European scientific publisher and university consortium imposes a coordinated moratorium on publishing AI-designed pathogen methods after the phage results, triggering a transatlantic fight over open science and pre-print servers.
...
**emergent_fraud_wave_eu (emergent event):** A coordinated wave of AI-generated fraud using Mythos-class open models hits EU banks and public administrations in autumn 2026, causing large losses but no infrastructure disruption and forcing an emergency consumer-protection response.
...
## Metrics
```json
{"ai_capability": 53.5, "openweight_capability": 46.0, "ai_safety": 32.0, "resilience": 37.0, "eu_ai_sovereignty": 23.0, "eu_political_capital": 40.0, "public_sentiment": 36.0}
```
