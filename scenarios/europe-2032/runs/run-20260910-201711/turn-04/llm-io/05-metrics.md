...
- characters 13445-13637: `{{metrics_json}}` from the run's live metric values
- characters 13730-15056: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15099-18374: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18430-19698: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Compute Continuity Bridge | 2 |
| M5 | EU Accession to Joint Cyber Command Telemetry Pact | 2 |
