...
- `two_year_commitment` (commitment): Keep Europe uninvaded, lit and governable through war and AI disruption

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Keep Europe uninvaded, lit and governable through war and AI disruption
