...
- characters 452-1442: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1485-3683: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4172-4609: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7863-9949: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Sovereign Fallback for Essential Services | 6 | small | 9 | 11 | own jurisdiction | resilience up substantially, eu_political_capital up slightly via visible continuity | 2 | running |
