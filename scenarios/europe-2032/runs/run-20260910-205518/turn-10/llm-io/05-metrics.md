...
- characters 106-13038: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13081-13270: `{{metrics_json}}` from the run's live metric values
- characters 13363-14353: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14396-16594: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16650-17475: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Sovereign Fallback for Essential Services | 2 |
| M12 | EU Offline Continuity Corps for Hospitals and Municipalities | 2 |
...
PORTFOLIO CHARGE t9: EU Sovereign Fallback for Essential Services −2, priority −1 = −3
PROPOSAL BONUS: EU Sovereign Fallback for Essential Services (cat 6, small) +5 — eu_frontier_access_denied plus cyber_major_incident and loss_of_control landed this turn with service cut-off and visible damage and this answers them directly
LEGITIMACY LENDS: none — capital 10 above sentiment 5
SOVEREIGNTY: 14 last turn, no category 4 finish, no category 4 in flight, eu_frontier_access_denied t9 −3, capability rose 1.5 −1 = 10
...
## Metrics
```json
{"ai_capability": 88.5, "openweight_capability": 84.2, "ai_safety": 0.0, "resilience": 49.5, "eu_ai_sovereignty": 7.0, "eu_political_capital": 6.0, "public_sentiment": 0.0}
```
