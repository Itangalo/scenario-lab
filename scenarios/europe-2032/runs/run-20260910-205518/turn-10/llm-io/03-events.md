...
- characters 374-1364: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1407-3605: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3661-4177: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4240-33099: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33454-34356: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, capability_jump, eval_anomaly_reports
- Turn 2 (8 turn(s) ago): export_control_escalation, emergent_lab_coverup_revelation
- Turn 3 (7 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough
- Turn 4 (6 turn(s) ago): joint_threat_response
- Turn 5 (5 turn(s) ago): bio_uplift_findings, rsi_onset, eu_frontier_access_denied, election_consolidation
- Turn 6 (4 turn(s) ago): capability_jump, cyber_defence_breakthrough, bio_uplift_findings, research_breakthrough, labour_displacement, embodied_ai_deployment, taiwan_tension_rise, member_state_defection
- Turn 7 (3 turn(s) ago): cyber_major_incident, medical_breakthrough, taiwan_tension_rise
- Turn 8 (2 turn(s) ago): bio_incident, member_state_defection, emergent_youth_blockade
- Turn 9 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, eu_frontier_access_denied
