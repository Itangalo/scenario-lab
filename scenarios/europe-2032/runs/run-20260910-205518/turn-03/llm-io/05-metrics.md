...
- characters 13802-15172: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15216-17640: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17696-18203: `{{notepad}}` from the Game Master's notepad, carried across turns
