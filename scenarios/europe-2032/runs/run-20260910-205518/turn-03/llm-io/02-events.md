...
- characters 1791-4215: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4271-5042: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5105-32049: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32404-32569: `{{event_history}}` from the run's own event record
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, capability_jump, eval_anomaly_reports
- Turn 2 (1 turn(s) ago): export_control_escalation, emergent_lab_coverup_revelation
