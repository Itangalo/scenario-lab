...
- characters 105-13123: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13166-13358: `{{metrics_json}}` from the run's live metric values
- characters 13451-14476: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14519-16809: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16865-18062: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Cyber Defence Breakthrough Deployment | 2 |
| M6 | EU Accession to Joint Cyber Command | 2 |
...
## Metrics
```json
{"ai_capability": 67.5, "openweight_capability": 60.5, "ai_safety": 20.0, "resilience": 41.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 19.0, "public_sentiment": 29.0}
```
