...
- characters 376-1670: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1714-3937: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3993-4577: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4640-33265: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33620-34244: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, EU Essential Services Continuity and Bio-Detection Backstop −2, EU Displaced Worker Transition Fund −2, priority −0 (capital below 20, no effect, no cost) = −7
PROPOSAL BONUS: EU Displaced Worker Transition Fund (cat 7, small) +3 — labour_displacement fired this turn and this answers it directly, with embodied fear amplifying
LEGITIMACY LENDS: none — capital 19 above sentiment 17
SOVEREIGNTY: 13 last turn, Tech sovereignty package finishes t6 +4, Gigafactories in flight +0, member_state_defection t6 −2, capability rose 4.5 −1 = 14
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, capability_jump, eval_anomaly_reports
- Turn 2 (5 turn(s) ago): export_control_escalation, emergent_lab_coverup_revelation
- Turn 3 (4 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough
- Turn 4 (3 turn(s) ago): joint_threat_response
- Turn 5 (2 turn(s) ago): bio_uplift_findings, rsi_onset, eu_frontier_access_denied, election_consolidation
- Turn 6 (1 turn(s) ago): capability_jump, cyber_defence_breakthrough, bio_uplift_findings, research_breakthrough, labour_displacement, embodied_ai_deployment, taiwan_tension_rise, member_state_defection
