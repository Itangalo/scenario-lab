...
- characters 13599-13790: `{{metrics_json}}` from the run's live metric values
- characters 13883-15177: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15221-17444: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17500-18647: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | EU Major Incident Containment and Restoration Surge | 2 |
