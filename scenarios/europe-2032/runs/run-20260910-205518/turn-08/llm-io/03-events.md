...
- characters 375-1906: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1949-4217: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4273-5331: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5394-35065: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35420-36134: `{{event_history}}` from the run's own event record
...
- `emergent_youth_blockade` -- first noted turn 7, listed in 1 turn(s) so far: Graduate-led anti-AI protests coalesce into coordinated blockades of logistics hubs using humanoid robots, forcing temporary shutdowns in two member states.
- `emergent_infrastructure_backlash_freeze` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated sabotage and blockades halt several planned EU gigafactory and data-centre sites after youth and union protests merge with local opposition, freezing construction through the winter.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, capability_jump, eval_anomaly_reports
- Turn 2 (6 turn(s) ago): export_control_escalation, emergent_lab_coverup_revelation
- Turn 3 (5 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough
- Turn 4 (4 turn(s) ago): joint_threat_response
- Turn 5 (3 turn(s) ago): bio_uplift_findings, rsi_onset, eu_frontier_access_denied, election_consolidation
- Turn 6 (2 turn(s) ago): capability_jump, cyber_defence_breakthrough, bio_uplift_findings, research_breakthrough, labour_displacement, embodied_ai_deployment, taiwan_tension_rise, member_state_defection
- Turn 7 (1 turn(s) ago): cyber_major_incident, medical_breakthrough, taiwan_tension_rise
