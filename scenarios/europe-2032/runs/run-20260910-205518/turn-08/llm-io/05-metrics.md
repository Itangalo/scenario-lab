...
- characters 105-13433: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13476-13667: `{{metrics_json}}` from the run's live metric values
- characters 13760-15291: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15334-17602: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17658-18480: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Bio-Incident Containment and Continuity Lockdown | 2 |
