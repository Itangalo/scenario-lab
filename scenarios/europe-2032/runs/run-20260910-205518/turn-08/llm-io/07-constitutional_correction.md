...
- characters 2695-3190: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 85.0, "openweight_capability": 78.5, "ai_safety": 1.0, "resilience": 48.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 10.0, "public_sentiment": 5.0}
```
