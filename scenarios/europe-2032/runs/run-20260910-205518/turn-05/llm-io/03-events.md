...
- characters 377-1230: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1274-3313: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3369-4500: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4563-32945: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33300-33612: `{{event_history}}` from the run's own event record
...
- `emergent_distress_compute_buyout` -- first noted turn 4, listed in 1 turn(s) so far: Distressed AI infrastructure sell-off: a cancelled hyperscaler build or lab compute cluster in Europe is offered for cut-price state-anchored acquisition, creating a one-off sovereignty buying opportunity.
- `emergent_compute_fire_sale` -- first noted turn 4, listed in 1 turn(s) so far: Distressed hyperscalers and cancelled EU compute deals trigger fire-sale of ordered accelerators and power reservations to non-EU buyers, permanently removing contracted capacity Europe counted on.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, capability_jump, eval_anomaly_reports
- Turn 2 (3 turn(s) ago): export_control_escalation, emergent_lab_coverup_revelation
- Turn 3 (2 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough
- Turn 4 (1 turn(s) ago): joint_threat_response
