...
- characters 106-13628: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13671-13863: `{{metrics_json}}` from the run's live metric values
- characters 13956-14809: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14853-16892: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16948-18079: `{{notepad}}` from the Game Master's notepad, carried across turns
