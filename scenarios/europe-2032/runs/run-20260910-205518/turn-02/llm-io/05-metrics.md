...
- characters 13401-14689: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14732-17058: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17114-17810: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Independent Model Audit Facility | 2 |
...
- `emergent_clinical_ai_pause` -- first noted turn 1, listed in 2 turn(s) so far: Major European research hospitals pause elective AI-assisted diagnostics after a faulty open-model update causes widespread false triage alerts.
...
## Metrics
```json
{"ai_capability": 61.5, "openweight_capability": 52.0, "ai_safety": 24.0, "resilience": 36.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 32.0, "public_sentiment": 32.0}
```
...
## Notepad
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Cyber Shield −3, EU Independent Model Audit Facility −2, priority −1 = −12
PROPOSAL BONUS: Audit Facility (cat 5, small) +4 — lab coverup revelation landed this turn and this answers it directly, export control escalation adds relevance
LEGITIMACY LENDS: capital 31, sentiment 32 -> +1
SOVEREIGNTY: 21 last turn, no cat4 finish, in flight +0, export_control_escalation t2 −2, capability rose 3.5 −1 = 18
