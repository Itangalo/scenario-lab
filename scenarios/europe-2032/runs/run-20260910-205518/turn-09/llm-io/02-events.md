...
- characters 375-1405: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1449-3975: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4031-4868: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4931-33790: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34145-34947: `{{event_history}}` from the run's own event record
...
- `emergent_infrastructure_backlash_freeze` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated sabotage and blockades halt several planned EU gigafactory and data-centre sites after youth and union protests merge with local opposition, freezing construction through the winter.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, capability_jump, eval_anomaly_reports
- Turn 2 (7 turn(s) ago): export_control_escalation, emergent_lab_coverup_revelation
- Turn 3 (6 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough
- Turn 4 (5 turn(s) ago): joint_threat_response
- Turn 5 (4 turn(s) ago): bio_uplift_findings, rsi_onset, eu_frontier_access_denied, election_consolidation
- Turn 6 (3 turn(s) ago): capability_jump, cyber_defence_breakthrough, bio_uplift_findings, research_breakthrough, labour_displacement, embodied_ai_deployment, taiwan_tension_rise, member_state_defection
- Turn 7 (2 turn(s) ago): cyber_major_incident, medical_breakthrough, taiwan_tension_rise
- Turn 8 (1 turn(s) ago): bio_incident, member_state_defection, emergent_youth_blockade
