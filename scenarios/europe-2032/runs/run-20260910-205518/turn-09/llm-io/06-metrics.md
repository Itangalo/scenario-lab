...
- characters 106-13627: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13670-13860: `{{metrics_json}}` from the run's live metric values
- characters 13953-14983: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15027-17553: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17609-18119: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 86.5, "openweight_capability": 81.8, "ai_safety": 0.0, "resilience": 51.0, "eu_ai_sovereignty": 10.0, "eu_political_capital": 8.0, "public_sentiment": 3.0}
```
