...
- characters 453-1483: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1527-4053: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5606-6049: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8955-11184: `{{previous_actions}}` from the actor's own response from the previous turn
