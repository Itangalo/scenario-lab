...
- characters 107-13471: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13514-13702: `{{metrics_json}}` from the run's live metric values
- characters 13795-14654: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14698-16758: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16814-17707: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M13 | EU Bio-Detection and Essential Medicines Continuity Shield | 2 |
...
## Metrics
```json
{"ai_capability": 90.0, "openweight_capability": 86.3, "ai_safety": 6.0, "resilience": 53.5, "eu_ai_sovereignty": 4.0, "eu_political_capital": 6.0, "public_sentiment": 2.0}
```
