...
- characters 374-1233: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1277-3337: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3393-4286: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4349-33208: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33563-34519: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Sovereign Fallback for Essential Services −2, EU Offline Continuity Corps for Hospitals and Municipalities −2, priority −1 = −5
PROPOSAL BONUS: EU Offline Continuity Corps for Hospitals and Municipalities (cat 6, small) +4 — eu_frontier_access_denied plus ransomware sweep landed this turn and last with cut-off hospitals and paper fallback and this answers them directly
LEGITIMACY LENDS: none — capital 8 above sentiment 3
SOVEREIGNTY: 10 last turn, no category 4 finish, no category 4 in flight, eu_frontier_access_denied t10 −2, capability rose 2.0 −1 = 7

## Emerging developments (tracked)

- `emergent_analog_holdout` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated municipal refusal to reconnect restored health and customs systems to any US-controlled model, leaving paper procedures in place for months and creating a de facto analog enclave.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, capability_jump, eval_anomaly_reports
- Turn 2 (9 turn(s) ago): export_control_escalation, emergent_lab_coverup_revelation
- Turn 3 (8 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough
- Turn 4 (7 turn(s) ago): joint_threat_response
- Turn 5 (6 turn(s) ago): bio_uplift_findings, rsi_onset, eu_frontier_access_denied, election_consolidation
- Turn 6 (5 turn(s) ago): capability_jump, cyber_defence_breakthrough, bio_uplift_findings, research_breakthrough, labour_displacement, embodied_ai_deployment, taiwan_tension_rise, member_state_defection
- Turn 7 (4 turn(s) ago): cyber_major_incident, medical_breakthrough, taiwan_tension_rise
- Turn 8 (3 turn(s) ago): bio_incident, member_state_defection, emergent_youth_blockade
- Turn 9 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, eu_frontier_access_denied
- Turn 10 (1 turn(s) ago): eu_frontier_access_denied
