...
- characters 454-1380: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1423-3519: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7577-8020: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10434-12670: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Essential Services Continuity and Bio-Detection Backstop | 6 | small | 5 | 7 | own jurisdiction | resilience up substantially, ai_safety up slightly | 2 | running |
