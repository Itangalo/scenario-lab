...
- characters 374-1278: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1322-3233: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3289-3702: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3765-32624: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32979-34078: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Bio-Detection and Essential Medicines Continuity Shield −2, priority −1 = −2 (priority has no effect and no cost as capital below 20, charged measures only)
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: none — capital 6 above sentiment 2
SOVEREIGNTY: 4 last turn, no category 4 finish, no category 4 in flight +0, no capacity event, capability rose 3.0 −1 = 3
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, capability_jump, eval_anomaly_reports
- Turn 2 (11 turn(s) ago): export_control_escalation, emergent_lab_coverup_revelation
- Turn 3 (10 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough
- Turn 4 (9 turn(s) ago): joint_threat_response
- Turn 5 (8 turn(s) ago): bio_uplift_findings, rsi_onset, eu_frontier_access_denied, election_consolidation
- Turn 6 (7 turn(s) ago): capability_jump, cyber_defence_breakthrough, bio_uplift_findings, research_breakthrough, labour_displacement, embodied_ai_deployment, taiwan_tension_rise, member_state_defection
- Turn 7 (6 turn(s) ago): cyber_major_incident, medical_breakthrough, taiwan_tension_rise
- Turn 8 (5 turn(s) ago): bio_incident, member_state_defection, emergent_youth_blockade
- Turn 9 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, eu_frontier_access_denied
- Turn 10 (3 turn(s) ago): eu_frontier_access_denied
- Turn 11 (2 turn(s) ago): bio_uplift_findings, medical_breakthrough, safety_breakthrough, eu_frontier_access_denied, member_state_defection
