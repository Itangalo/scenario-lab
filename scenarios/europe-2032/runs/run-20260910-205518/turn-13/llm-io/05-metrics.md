...
- characters 13456-13644: `{{metrics_json}}` from the run's live metric values
- characters 13737-14641: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14685-16596: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16652-17065: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Containment-Anchored Bio Shield and Offline Essentials Hold | 2 |
