...
- characters 13733-14855: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14898-16709: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16765-17453: `{{notepad}}` from the Game Master's notepad, carried across turns
