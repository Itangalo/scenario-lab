...
- characters 373-1495: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1538-3349: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3405-4402: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4465-33324: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33679-34777: `{{event_history}}` from the run's own event record
...
- `emergent_analog_holdout` -- first noted turn 10, listed in 2 turn(s) so far: Coordinated municipal refusal to reconnect restored health and customs systems to any US-controlled model, leaving paper procedures in place for months and creating a de facto analog enclave.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, capability_jump, eval_anomaly_reports
- Turn 2 (10 turn(s) ago): export_control_escalation, emergent_lab_coverup_revelation
- Turn 3 (9 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough
- Turn 4 (8 turn(s) ago): joint_threat_response
- Turn 5 (7 turn(s) ago): bio_uplift_findings, rsi_onset, eu_frontier_access_denied, election_consolidation
- Turn 6 (6 turn(s) ago): capability_jump, cyber_defence_breakthrough, bio_uplift_findings, research_breakthrough, labour_displacement, embodied_ai_deployment, taiwan_tension_rise, member_state_defection
- Turn 7 (5 turn(s) ago): cyber_major_incident, medical_breakthrough, taiwan_tension_rise
- Turn 8 (4 turn(s) ago): bio_incident, member_state_defection, emergent_youth_blockade
- Turn 9 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, eu_frontier_access_denied
- Turn 10 (2 turn(s) ago): eu_frontier_access_denied
- Turn 11 (1 turn(s) ago): bio_uplift_findings, medical_breakthrough, safety_breakthrough, eu_frontier_access_denied, member_state_defection
