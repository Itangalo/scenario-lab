...
- characters 451-1573: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1616-3427: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3495-3932: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7607-9626: `{{previous_actions}}` from the actor's own response from the previous turn
...
{
  "ai_capability": 90.0,
  "openweight_capability": 86.3,
  "ai_safety": 6.0,
  "resilience": 53.5,
  "eu_ai_sovereignty": 4.0,
...
|---|---|---|---|---|---|---|---|---|---|
| M13 | EU Bio-Detection and Essential Medicines Continuity Shield | 6 | small | 11 | 13 | own jurisdiction | resilience up substantially, public_sentiment up slightly via visible cures access | 2 | running |
