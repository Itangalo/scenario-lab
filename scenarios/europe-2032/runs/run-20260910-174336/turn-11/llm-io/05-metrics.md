...
- characters 13284-13475: `{{metrics_json}}` from the run's live metric values
- characters 13568-14807: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14851-17202: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17258-17834: `{{notepad}}` from the Game Master's notepad, carried across turns
