...
- characters 377-1616: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1660-4011: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4067-4963: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5026-26794: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27149-27814: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Municipal Continuity and Graduate Retention Hold −2, EU Visible Benefit Adoption Scale-Up −2, priority −1 not charged (capital below 20, no effect) = −4
PROPOSAL BONUS: none — no negative event in last three turns that scale-up answers; cyber incident is this turn and adoption success is positive
LEGITIMACY LENDS: capital 2.0 after charges and cyber loss, sentiment 21.0 -> +2 (capped by sentiment)
SOVEREIGNTY: 20.5 last turn, no capacity event, no cat4 finish or in-flight build, capability rose 0.6 −0, consolidation decay with no build −1 = 19.5

## Emerging developments (tracked)

- `emergent_anti_datacentre_blockades` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated physical blockades of data-centre construction sites and grid connections spread across three or more member states, halting builds for weeks and forcing emergency policing costs.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, bio_uplift_findings, openweight_frontier_release, adoption_success
- Turn 2 (9 turn(s) ago): cyber_major_incident, automated_decision_scandal
- Turn 3 (8 turn(s) ago): cyber_major_incident, emergent_synthesis_screening_pact
- Turn 4 (7 turn(s) ago): ai_investment_collapse, openweight_frontier_release
- Turn 5 (6 turn(s) ago): election_consolidation
- Turn 6 (5 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 7 (4 turn(s) ago): us_china_agreement
- Turn 8 (3 turn(s) ago): safety_breakthrough, labour_displacement
- Turn 10 (1 turn(s) ago): cyber_major_incident, safety_breakthrough, adoption_success
