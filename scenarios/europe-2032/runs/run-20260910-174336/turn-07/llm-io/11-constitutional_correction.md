...
- characters 3245-3585: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 58.7, "ai_safety": 21.5, "resilience": 38.5, "eu_ai_sovereignty": 22.5, "eu_political_capital": 10.0, "public_sentiment": 25.0}
```
