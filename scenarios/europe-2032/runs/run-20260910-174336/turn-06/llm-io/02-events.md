...
- characters 375-1629: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1672-3353: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3409-4459: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4522-24814: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 25169-25562: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Model Evaluation and Assurance Office −2, EU AI Incident and Dependency Registry −2, priority −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 6, sentiment 25 -> +2 [capped in total: 14 -11 +3 +2 = 8]
SOVEREIGNTY: 20 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 20

## Emerging developments (tracked)

- `emergent_local_permit_freeze` -- first noted turn 4, listed in 2 turn(s) so far: Several municipal councils in stalled gigafactory regions impose temporary moratoria on new data-centre grid connections after protests over outages and energy costs, freezing site permitting through the spring.
- `emergent_heatwave_grid_crunch` -- first noted turn 4, listed in 2 turn(s) so far: A severe early-summer heatwave forces grid curtailments in southern Europe, pitting stalled gigafactory grid reservations and data-centre power demand against hospital cooling and public anger over outages.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, bio_uplift_findings, openweight_frontier_release, adoption_success
- Turn 2 (4 turn(s) ago): cyber_major_incident, automated_decision_scandal
- Turn 3 (3 turn(s) ago): cyber_major_incident, emergent_synthesis_screening_pact
- Turn 4 (2 turn(s) ago): ai_investment_collapse, openweight_frontier_release
