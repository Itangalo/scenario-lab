...
- characters 453-1707: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1750-3431: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4507-4978: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7347-8835: `{{previous_actions}}` from the actor's own response from the previous turn
