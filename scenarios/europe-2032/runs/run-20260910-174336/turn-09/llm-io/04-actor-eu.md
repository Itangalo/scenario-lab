...
- characters 454-1572: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1616-3724: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3792-4263: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6879-8858: `{{previous_actions}}` from the actor's own response from the previous turn
