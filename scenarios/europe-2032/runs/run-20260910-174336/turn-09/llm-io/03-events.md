...
- characters 376-1494: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1538-3646: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3702-4517: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4580-25745: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26100-26677: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Graduate Transition and Wage Insurance Bridge −2, priority −1 = −3
PROPOSAL BONUS: EU Graduate Transition and Wage Insurance Bridge (cat 7, small) +3 — labour_displacement landed this turn naming graduates in five sectors and this answers it directly
LEGITIMACY LENDS: capital 7, sentiment 18 -> +2
SOVEREIGNTY: 22.5 last turn, no capacity event, no cat4 finish or in-flight build, capability rose 0.7 −0, consolidation decay with no build −1 = 21.5

## Emerging developments (tracked)

- `emergent_municipal_resilience_compact` -- first noted turn 7, listed in 2 turn(s) so far: Municipal utilities in Spain and France quietly pool backup-power and manual-failover procedures into a cross-border mutual-aid compact after hookup freezes, creating a citable resilience model outside Brussels.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, bio_uplift_findings, openweight_frontier_release, adoption_success
- Turn 2 (7 turn(s) ago): cyber_major_incident, automated_decision_scandal
- Turn 3 (6 turn(s) ago): cyber_major_incident, emergent_synthesis_screening_pact
- Turn 4 (5 turn(s) ago): ai_investment_collapse, openweight_frontier_release
- Turn 5 (4 turn(s) ago): election_consolidation
- Turn 6 (3 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 7 (2 turn(s) ago): us_china_agreement
- Turn 8 (1 turn(s) ago): safety_breakthrough, labour_displacement
