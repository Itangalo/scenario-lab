...
- characters 106-13250: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13293-13484: `{{metrics_json}}` from the run's live metric values
- characters 13577-14695: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14739-16847: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16903-17376: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 62.4, "openweight_capability": 60.8, "ai_safety": 24.5, "resilience": 35.5, "eu_ai_sovereignty": 20.5, "eu_political_capital": 12.0, "public_sentiment": 21.0}
```
## Narrative
