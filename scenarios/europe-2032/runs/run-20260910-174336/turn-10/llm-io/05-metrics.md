...
- characters 13216-14213: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14256-16384: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16440-17227: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Municipal Continuity and Graduate Retention Hold | 2 |
| M10 | EU Visible Benefit Adoption Scale-Up | 2 |
...
PORTFOLIO CHARGE t9: EU Municipal Continuity and Graduate Retention Hold −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: none — no event in last three turns that this hold answers; labour freeze is standing condition, not a priced event
LEGITIMACY LENDS: capital 10, sentiment 18 -> +2
SOVEREIGNTY: 21.5 last turn, no capacity event, no cat4 finish or in-flight build, capability rose 0.7 −0, consolidation decay with no build −1 = 20.5
