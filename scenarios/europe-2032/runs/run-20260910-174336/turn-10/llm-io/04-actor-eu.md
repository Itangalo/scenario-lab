...
- characters 455-1452: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1495-3623: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4776-5269: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8232-10519: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Municipal Continuity and Graduate Retention Hold | 6 | small | 9 | 11 | own jurisdiction | resilience up slightly, public_sentiment and eu_political_capital up slightly | 2 | running |
