...
- characters 377-1374: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1417-3545: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3601-4068: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4131-25899: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26254-26831: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, bio_uplift_findings, openweight_frontier_release, adoption_success
- Turn 2 (8 turn(s) ago): cyber_major_incident, automated_decision_scandal
- Turn 3 (7 turn(s) ago): cyber_major_incident, emergent_synthesis_screening_pact
- Turn 4 (6 turn(s) ago): ai_investment_collapse, openweight_frontier_release
- Turn 5 (5 turn(s) ago): election_consolidation
- Turn 6 (4 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 7 (3 turn(s) ago): us_china_agreement
- Turn 8 (2 turn(s) ago): safety_breakthrough, labour_displacement
