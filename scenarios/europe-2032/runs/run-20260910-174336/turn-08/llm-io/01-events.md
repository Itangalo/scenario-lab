...
- characters 376-1384: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1427-4338: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4394-5114: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5177-26342: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26697-27207: `{{event_history}}` from the run's own event record
...
- `emergent_municipal_resilience_compact` -- first noted turn 7, listed in 1 turn(s) so far: Municipal utilities in Spain and France quietly pool backup-power and manual-failover procedures into a cross-border mutual-aid compact after hookup freezes, creating a citable resilience model outside Brussels.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, bio_uplift_findings, openweight_frontier_release, adoption_success
- Turn 2 (6 turn(s) ago): cyber_major_incident, automated_decision_scandal
- Turn 3 (5 turn(s) ago): cyber_major_incident, emergent_synthesis_screening_pact
- Turn 4 (4 turn(s) ago): ai_investment_collapse, openweight_frontier_release
- Turn 5 (3 turn(s) ago): election_consolidation
- Turn 6 (2 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 7 (1 turn(s) ago): us_china_agreement
