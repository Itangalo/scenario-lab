...
- characters 105-13255: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13298-13490: `{{metrics_json}}` from the run's live metric values
- characters 13583-14591: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14634-17545: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17601-18321: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Graduate Transition and Wage Insurance Bridge | 2 |
...
## Metrics
```json
{"ai_capability": 61.7, "openweight_capability": 59.9, "ai_safety": 26.5, "resilience": 37.0, "eu_ai_sovereignty": 21.5, "eu_political_capital": 9.0, "public_sentiment": 18.0}
```
