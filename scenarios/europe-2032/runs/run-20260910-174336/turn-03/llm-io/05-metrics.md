...
- characters 106-12970: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13013-13205: `{{metrics_json}}` from the run's live metric values
- characters 13298-14652: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14696-16854: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16910-17384: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 56.5, "openweight_capability": 52.2, "ai_safety": 28.0, "resilience": 39.5, "eu_ai_sovereignty": 22.0, "eu_political_capital": 28.0, "public_sentiment": 28.0}
```
