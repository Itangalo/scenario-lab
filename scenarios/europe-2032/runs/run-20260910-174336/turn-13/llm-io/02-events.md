...
- characters 377-2310: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2354-4431: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4487-5435: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5498-27266: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27621-28489: `{{event_history}}` from the run's own event record
...
LEGITIMACY LENDS: capital 7.0 after finishes, sentiment 19.0 -> +2 (capped by sentiment) = 9.0
SOVEREIGNTY: 18.5 last turn, no capacity event, no cat4 finish or in-flight build, capability rose 0.7 -0, consolidation decay with no build -1 = 17.5

## Emerging developments (tracked)

- `emergent_utility_walkout` -- first noted turn 12, listed in 1 turn(s) so far: Coordinated municipal utility operators in two member states stage wildcat walkouts after automated cyberattack overtime and data-centre police escort duties, briefly halting grid maintenance crews.
- `emergent_substation_sabotage_blackouts` -- first noted turn 12, listed in 1 turn(s) so far: Anti data-centre blockades escalate into coordinated sabotage of grid substations feeding construction sites, causing localized blackouts blamed on the protest movement.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, bio_uplift_findings, openweight_frontier_release, adoption_success
- Turn 2 (11 turn(s) ago): cyber_major_incident, automated_decision_scandal
- Turn 3 (10 turn(s) ago): cyber_major_incident, emergent_synthesis_screening_pact
- Turn 4 (9 turn(s) ago): ai_investment_collapse, openweight_frontier_release
- Turn 5 (8 turn(s) ago): election_consolidation
- Turn 6 (7 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 7 (6 turn(s) ago): us_china_agreement
- Turn 8 (5 turn(s) ago): safety_breakthrough, labour_displacement
- Turn 10 (3 turn(s) ago): cyber_major_incident, safety_breakthrough, adoption_success
- Turn 11 (2 turn(s) ago): cyber_major_incident, taiwan_tension_rise, emergent_anti_datacentre_blockades
- Turn 12 (1 turn(s) ago): research_breakthrough, safety_breakthrough, knowledge_work_augmented
