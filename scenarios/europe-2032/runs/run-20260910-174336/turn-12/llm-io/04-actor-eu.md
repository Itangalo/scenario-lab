...
- characters 454-2029: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2072-4247: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5707-6200: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9206-10687: `{{previous_actions}}` from the actor's own response from the previous turn
