...
- characters 106-13150: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13193-13384: `{{metrics_json}}` from the run's live metric values
- characters 13477-15052: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15095-17270: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17326-18387: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t11: M10 EU Visible Benefit Adoption Scale-Up −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 4.0 after charges, finishes and events, sentiment 13.0 -> +2 (capped by sentiment, net held at floor by further strain)
SOVEREIGNTY: 19.5 last turn, no capacity event, no cat4 finish or in-flight build, capability rose 0.7 −0, consolidation decay with no build −1 = 18.5
