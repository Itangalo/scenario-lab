...
- characters 376-1951: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1994-4169: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4225-4704: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4767-26535: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26890-27661: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, bio_uplift_findings, openweight_frontier_release, adoption_success
- Turn 2 (10 turn(s) ago): cyber_major_incident, automated_decision_scandal
- Turn 3 (9 turn(s) ago): cyber_major_incident, emergent_synthesis_screening_pact
- Turn 4 (8 turn(s) ago): ai_investment_collapse, openweight_frontier_release
- Turn 5 (7 turn(s) ago): election_consolidation
- Turn 6 (6 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 7 (5 turn(s) ago): us_china_agreement
- Turn 8 (4 turn(s) ago): safety_breakthrough, labour_displacement
- Turn 10 (2 turn(s) ago): cyber_major_incident, safety_breakthrough, adoption_success
- Turn 11 (1 turn(s) ago): cyber_major_incident, taiwan_tension_rise, emergent_anti_datacentre_blockades
