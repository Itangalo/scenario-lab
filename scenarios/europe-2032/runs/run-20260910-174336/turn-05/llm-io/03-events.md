...
- characters 377-1303: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1347-3416: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3472-4864: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4927-26601: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26956-27300: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, bio_uplift_findings, openweight_frontier_release, adoption_success
- Turn 2 (3 turn(s) ago): cyber_major_incident, automated_decision_scandal
- Turn 3 (2 turn(s) ago): cyber_major_incident, emergent_synthesis_screening_pact
- Turn 4 (1 turn(s) ago): ai_investment_collapse, openweight_frontier_release
...
```
[{"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.35}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.12}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.38}, {"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.03}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.14}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.05}, {"description": "Several municipal councils in stalled gigafactory regions impose temporary moratoria on new data-centre grid connections after protests over outages and energy costs, freezing site permitting through the spring.", "emergent": true, "id": "emergent_local_permit_freeze", "probability": 0.22}, {"description": "A severe early-summer heatwave forces grid curtailments in southern Europe, pitting stalled gigafactory grid reservations and data-centre power demand against hospital cooling and public anger over outages.", "emergent": true, "id": "emergent_heatwave_grid_crunch", "probability": 0.18}]
```
