...
- characters 1425-3494: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4411-4887: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7254-9498: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU AI Incident and Dependency Registry | 2 | small | 4 | 6 | own jurisdiction | resilience up moderately, ai_safety up slightly via shared detection | 2 | running |
