...
- characters 13408-13600: `{{metrics_json}}` from the run's live metric values
- characters 13693-14619: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14663-16732: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16788-18180: `{{notepad}}` from the Game Master's notepad, carried across turns
