...
- `two_year_commitment` (commitment): Sustain and defend European autonomy in an uncontrollable world

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Sustain and defend European autonomy in an uncontrollable world
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the two-year period directly alters the temporal basis of the original commitment, justifying its rewording.
