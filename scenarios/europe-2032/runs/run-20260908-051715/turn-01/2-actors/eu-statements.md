...
- `two_year_commitment` (commitment): Build sovereign capacity to act with autonomy in an era of uncontrollable diffusion

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Build sovereign capacity to act with autonomy in an era of uncontrollable diffusion
