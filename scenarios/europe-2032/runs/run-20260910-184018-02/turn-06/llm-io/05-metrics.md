...
- characters 105-13728: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13771-13963: `{{metrics_json}}` from the run's live metric values
- characters 14056-15803: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15846-18034: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18090-18615: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Agentic Containment and Essential-Service Kill-Switch | 2 |
...
## Metrics
```json
{"ai_capability": 76.0, "openweight_capability": 67.0, "ai_safety": 7.0, "resilience": 40.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 20.0, "public_sentiment": 18.0}
```
## Narrative
