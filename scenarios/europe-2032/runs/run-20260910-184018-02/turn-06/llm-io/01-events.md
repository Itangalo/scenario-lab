...
- characters 376-2123: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2166-4354: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4410-5560: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5623-31188: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31543-32003: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Clean Sovereign Stack for Essential Services −2, EU Agentic Containment and Essential-Service Kill-Switch −2, priority −1 = −11
PROPOSAL BONUS: EU Agentic Containment and Essential-Service Kill-Switch (cat 6, small) +3 — loss-of-control incident severe and direct this turn, answered directly
LEGITIMACY LENDS: capital 23, sentiment 24 -> +1
SOVEREIGNTY: 14 last turn, no capacity event, no cat4 finish, in flight +0, capability rose 2.0 −1 = 13

## Emerging developments (tracked)

- `emergent_municipal_insolvency_wave` -- first noted turn 4, listed in 2 turn(s) so far: Small communes hit by the spring ransomware wave face cascading service insolvencies as recovery contractors and backup costs overwhelm budgets, forcing emergency municipal mergers and state receiverships.
- `emergent_grid_permit_freeze` -- first noted turn 4, listed in 2 turn(s) so far: Municipal utilities in France and Germany suspend approved hyperscale grid connections after court challenges, freezing several AI-ready sites mid-build and pushing developers toward locations outside the EU.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, safety_breakthrough, adoption_success
- Turn 2 (4 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release
- Turn 3 (3 turn(s) ago): eu_frontier_access_denied, joint_threat_response, emergent_datacentre_siting_backlash
- Turn 4 (2 turn(s) ago): openweight_frontier_release, eu_frontier_access_denied
- Turn 5 (1 turn(s) ago): loss_of_control_incident, us_china_agreement, election_retrenchment
