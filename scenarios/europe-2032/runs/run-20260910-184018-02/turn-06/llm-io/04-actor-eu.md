...
- characters 454-2201: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2244-4432: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7333-7780: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10412-12868: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Agentic Containment and Essential-Service Kill-Switch | 6 | small | 5 | 7 | own jurisdiction | resilience up moderately, ai_safety up slightly via containment learning | 2 | running |
