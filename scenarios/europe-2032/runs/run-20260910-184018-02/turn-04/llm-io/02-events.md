...
- characters 376-1753: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1796-3535: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3591-4161: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4224-32253: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32608-32893: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, safety_breakthrough, adoption_success
- Turn 2 (2 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release
- Turn 3 (1 turn(s) ago): eu_frontier_access_denied, joint_threat_response, emergent_datacentre_siting_backlash
