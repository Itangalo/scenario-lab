...
- characters 107-13459: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13502-13693: `{{metrics_json}}` from the run's live metric values
- characters 13786-15387: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15431-17890: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17946-18737: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Cold-Chain Corridor Protection and Medical Resupply Escort | 2 |
