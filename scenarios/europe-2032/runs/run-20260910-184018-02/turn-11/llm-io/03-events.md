...
- characters 377-1978: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2022-4481: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4537-5633: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5696-31389: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31744-32825: `{{event_history}}` from the run's own event record
...
- `emergent_containment_corridor_blockade` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated funerals-protest networks fuse with anti-data-centre groups to mount a sustained blockade of pharmaceutical cold-chain corridors, disrupting bio-containment resupply independent of any EU decision.
- `emergent_permit_freeze_cascade` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated municipal bans on new grid connections for data-centres spread across three member states after sabotage trials, freezing guarded rebuilds in permitting courts.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, safety_breakthrough, adoption_success
- Turn 2 (9 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release
- Turn 3 (8 turn(s) ago): eu_frontier_access_denied, joint_threat_response, emergent_datacentre_siting_backlash
- Turn 4 (7 turn(s) ago): openweight_frontier_release, eu_frontier_access_denied
- Turn 5 (6 turn(s) ago): loss_of_control_incident, us_china_agreement, election_retrenchment
- Turn 6 (5 turn(s) ago): rsi_onset, opaque_reasoning, embodied_ai_deployment, export_control_escalation, eu_frontier_access_denied, adoption_success
- Turn 7 (4 turn(s) ago): medical_breakthrough, safety_breakthrough, embodied_ai_deployment, export_control_escalation
- Turn 8 (3 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, bio_uplift_findings
- Turn 9 (2 turn(s) ago): bio_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, emergent_infrastructure_sabotage_wave
- Turn 10 (1 turn(s) ago): research_breakthrough, adoption_success, middle_power_coalition
