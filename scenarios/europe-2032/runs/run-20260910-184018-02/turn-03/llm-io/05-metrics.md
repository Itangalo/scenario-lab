...
- characters 106-13125: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13168-13360: `{{metrics_json}}` from the run's live metric values
- characters 13453-14436: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14480-16320: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16376-16855: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Rapid Containment and Recovery Corps | 2 |
| M5 | EU Trusted Access and Joint Response Accession | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Rapid Containment and Recovery Corps −2, priority −1 = −12
PROPOSAL BONUS: EU Rapid Containment and Recovery Corps (cat 6, small) +2 — cyber_major_incident severe this turn and open frontier release, answered directly
LEGITIMACY LENDS: capital 36, sentiment 43 -> +2
SOVEREIGNTY: 21 last turn, no capacity event, Gigafactories in flight +0, capability rose 7.0 −1 = 20
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Rapid Containment and Recovery Corps −2, EU Trusted Access and Joint Response Accession −2, priority −1 = −14
PROPOSAL BONUS: EU Trusted Access and Joint Response Accession (cat 8, small) +4 — eu_frontier_access_denied severe this turn plus joint pooling offer, answered directly
LEGITIMACY LENDS: capital 27, sentiment 30 -> +1
SOVEREIGNTY: 20 last turn, no capacity build finishing, in flight +0, eu_frontier_access_denied t3 −2, capability rose 3.0 −1 = 17
