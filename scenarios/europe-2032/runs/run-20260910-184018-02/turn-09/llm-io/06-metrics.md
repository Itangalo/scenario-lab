...
- characters 13870-15190: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15234-17470: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17526-18089: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M11 | EU Bio-Containment and Essential-Service Continuity Surge | 2 |
...
## Metrics
```json
{"ai_capability": 83.5, "openweight_capability": 77.0, "ai_safety": 8.0, "resilience": 41.0, "eu_ai_sovereignty": 12.0, "eu_political_capital": 13.0, "public_sentiment": 10.0}
```
## Narrative
