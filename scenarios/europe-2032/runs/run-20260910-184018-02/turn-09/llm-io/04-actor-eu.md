...
- characters 455-1775: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1819-4055: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5827-6274: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9557-11820: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M10 | EU Loss-of-Control Lockdown and Bio Early-Warning Protocol | 6 | small | 8 | 10 | own jurisdiction | resilience up moderately, ai_safety up slightly via incident learning and containment | 2 | running |
