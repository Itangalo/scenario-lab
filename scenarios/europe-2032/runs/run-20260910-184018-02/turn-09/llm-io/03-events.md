...
- characters 377-1697: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1741-3977: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4033-5260: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5323-31828: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32183-33012: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M8 EU Visible Benefit Rollout on the Sovereign Stack −2, M9 EU Logistics Humanoid Transition Compact −2, M10 EU Loss-of-Control Lockdown and Bio Early-Warning Protocol −2, priority −1 = −7
PROPOSAL BONUS: EU Loss-of-Control Lockdown and Bio Early-Warning Protocol (cat 6, small) +4 — loss-of-control multi-day escape and bio-uplift design signal both this turn, answered directly
LEGITIMACY LENDS: capital 16, sentiment 12 -> none, capital higher
SOVEREIGNTY: 17 last turn, no capacity event, no cat4 in flight +0, capability rose 2.5 −1 = 16

## Emerging developments (tracked)

- `emergent_sensor_rollout_freeze` -- first noted turn 7, listed in 2 turn(s) so far: Municipal utilities in two member states suspend installation of EU-offered shutdown sensors after union-led legal challenges over liability, freezing the conditional rollout of sovereign-stack inference slots.
- `emergent_infrastructure_sabotage_wave` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated sabotage campaign against hyperscale grid connections and data-centre construction sites in Spain and Germany, fusing local permit protests with anti-AI activism and foreign-amplified disinformation, halting works for weeks.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, safety_breakthrough, adoption_success
- Turn 2 (7 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release
- Turn 3 (6 turn(s) ago): eu_frontier_access_denied, joint_threat_response, emergent_datacentre_siting_backlash
- Turn 4 (5 turn(s) ago): openweight_frontier_release, eu_frontier_access_denied
- Turn 5 (4 turn(s) ago): loss_of_control_incident, us_china_agreement, election_retrenchment
- Turn 6 (3 turn(s) ago): rsi_onset, opaque_reasoning, embodied_ai_deployment, export_control_escalation, eu_frontier_access_denied, adoption_success
- Turn 7 (2 turn(s) ago): medical_breakthrough, safety_breakthrough, embodied_ai_deployment, export_control_escalation
- Turn 8 (1 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, bio_uplift_findings
