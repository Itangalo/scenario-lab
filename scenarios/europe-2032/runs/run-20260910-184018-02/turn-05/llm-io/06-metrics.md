...
- characters 106-13720: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13763-13955: `{{metrics_json}}` from the run's live metric values
- characters 14048-15522: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15566-17574: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17630-18898: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 70.0, "openweight_capability": 64.0, "ai_safety": 19.0, "resilience": 44.0, "eu_ai_sovereignty": 13.0, "eu_political_capital": 24.0, "public_sentiment": 24.0}
```
