...
- characters 377-1851: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1895-3903: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3959-5227: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5290-33319: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33674-34040: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, safety_breakthrough, adoption_success
- Turn 2 (3 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release
- Turn 3 (2 turn(s) ago): eu_frontier_access_denied, joint_threat_response, emergent_datacentre_siting_backlash
- Turn 4 (1 turn(s) ago): openweight_frontier_release, eu_frontier_access_denied
