...
- characters 376-1562: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1605-3887: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3943-4660: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4723-30416: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30771-31954: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M13 EU Cold-Chain Corridor Protection and Medical Resupply Escort −2, priority −1 = −3
PROPOSAL BONUS: none — M13 already in flight, no new measure answering last-three-turn shock beyond ongoing blockade response
LEGITIMACY LENDS: capital 15, sentiment 17 -> +1 but capped, already accounted in capital total
SOVEREIGNTY: 13 last turn, no capacity event, no cat4 finish, capability rose 4.0 −1 = 12

## Emerging developments (tracked)

- `emergent_permit_freeze_cascade` -- first noted turn 10, listed in 2 turn(s) so far: Coordinated municipal bans on new grid connections for data-centres spread across three member states after sabotage trials, freezing guarded rebuilds in permitting courts.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, safety_breakthrough, adoption_success
- Turn 2 (10 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release
- Turn 3 (9 turn(s) ago): eu_frontier_access_denied, joint_threat_response, emergent_datacentre_siting_backlash
- Turn 4 (8 turn(s) ago): openweight_frontier_release, eu_frontier_access_denied
- Turn 5 (7 turn(s) ago): loss_of_control_incident, us_china_agreement, election_retrenchment
- Turn 6 (6 turn(s) ago): rsi_onset, opaque_reasoning, embodied_ai_deployment, export_control_escalation, eu_frontier_access_denied, adoption_success
- Turn 7 (5 turn(s) ago): medical_breakthrough, safety_breakthrough, embodied_ai_deployment, export_control_escalation
- Turn 8 (4 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, bio_uplift_findings
- Turn 9 (3 turn(s) ago): bio_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, emergent_infrastructure_sabotage_wave
- Turn 10 (2 turn(s) ago): research_breakthrough, adoption_success, middle_power_coalition
- Turn 11 (1 turn(s) ago): capability_jump, adoption_success, emergent_containment_corridor_blockade
