...
- characters 106-13402: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13445-13636: `{{metrics_json}}` from the run's live metric values
- characters 13729-14915: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14958-17240: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17296-17716: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Open-Weights Fallback for Cut-Off Essential Services | 2 |
