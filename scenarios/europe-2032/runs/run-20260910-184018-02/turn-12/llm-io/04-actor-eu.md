...
- characters 454-1640: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1683-3965: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5279-5751: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9553-11851: `{{previous_actions}}` from the actor's own response from the previous turn
