...
- characters 106-13577: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13620-13811: `{{metrics_json}}` from the run's live metric values
- characters 13904-14861: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14905-17041: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17097-18336: `{{notepad}}` from the Game Master's notepad, carried across turns
