...
- characters 376-1333: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1377-3513: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3569-4144: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4207-29666: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30021-30631: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, safety_breakthrough, adoption_success
- Turn 2 (5 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release
- Turn 3 (4 turn(s) ago): eu_frontier_access_denied, joint_threat_response, emergent_datacentre_siting_backlash
- Turn 4 (3 turn(s) ago): openweight_frontier_release, eu_frontier_access_denied
- Turn 5 (2 turn(s) ago): loss_of_control_incident, us_china_agreement, election_retrenchment
- Turn 6 (1 turn(s) ago): rsi_onset, opaque_reasoning, embodied_ai_deployment, export_control_escalation, eu_frontier_access_denied, adoption_success
