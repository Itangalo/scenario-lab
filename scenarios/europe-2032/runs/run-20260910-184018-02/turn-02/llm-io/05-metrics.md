...
- characters 105-13064: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13107-13299: `{{metrics_json}}` from the run's live metric values
- characters 13392-14643: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14686-16576: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16632-17728: `{{notepad}}` from the Game Master's notepad, carried across turns
