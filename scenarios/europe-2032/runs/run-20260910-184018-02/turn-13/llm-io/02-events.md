...
- characters 377-1444: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1488-3531: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3587-4010: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4073-29766: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30121-31401: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, safety_breakthrough, adoption_success
- Turn 2 (11 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release
- Turn 3 (10 turn(s) ago): eu_frontier_access_denied, joint_threat_response, emergent_datacentre_siting_backlash
- Turn 4 (9 turn(s) ago): openweight_frontier_release, eu_frontier_access_denied
- Turn 5 (8 turn(s) ago): loss_of_control_incident, us_china_agreement, election_retrenchment
- Turn 6 (7 turn(s) ago): rsi_onset, opaque_reasoning, embodied_ai_deployment, export_control_escalation, eu_frontier_access_denied, adoption_success
- Turn 7 (6 turn(s) ago): medical_breakthrough, safety_breakthrough, embodied_ai_deployment, export_control_escalation
- Turn 8 (5 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, bio_uplift_findings
- Turn 9 (4 turn(s) ago): bio_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, emergent_infrastructure_sabotage_wave
- Turn 10 (3 turn(s) ago): research_breakthrough, adoption_success, middle_power_coalition
- Turn 11 (2 turn(s) ago): capability_jump, adoption_success, emergent_containment_corridor_blockade
- Turn 12 (1 turn(s) ago): eval_anomaly_reports, labour_displacement, eu_frontier_access_denied
