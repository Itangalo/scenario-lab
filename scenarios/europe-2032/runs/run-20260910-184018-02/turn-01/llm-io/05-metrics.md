...
- characters 16367-16987: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_grid_connection_crunch` -- first noted turn 1, listed in 1 turn(s) so far: A major non-EU cloud provider announces emergency power-price surcharges and pauses new EU data-centre hookups after grid-connection queues blow out, triggering municipal opposition to siting.
- `emergent_datacentre_siting_backlash` -- first noted turn 1, listed in 1 turn(s) so far: Coordinated municipal moratoriums and grid-connection lawsuits stall several hyperscale data-centre projects in Spain and Germany over power prices and water use, delaying EU compute expansion without stopping it.
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 46.0, "ai_safety": 39.0, "resilience": 37.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 44.0, "public_sentiment": 43.0}
```
## Narrative
### The autumn audit
...
PROPOSAL BONUS: EU Critical Systems Shield (cat 6, large) +4 — autumn grid/port intrusion this turn and unrecallable open cyber capability, answered directly
LEGITIMACY LENDS: none — capital 42 after charge+bonus, sentiment 42, capital not below sentiment
