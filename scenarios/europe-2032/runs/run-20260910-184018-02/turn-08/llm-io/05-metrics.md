...
- characters 13417-14637: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14680-17117: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17173-18358: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Visible Benefit Rollout on the Sovereign Stack | 2 |
| M9 | EU Logistics Humanoid Transition Compact | 2 |
| M10 | EU Loss-of-Control Lockdown and Bio Early-Warning Protocol | 2 |
...
## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M10", "fields": {"finish_turn": 10}, "grounds": "named priority"}]}
```
```
