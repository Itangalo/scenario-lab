...
- characters 454-1653: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1696-3842: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5936-6408: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9744-12003: `{{previous_actions}}` from the actor's own response from the previous turn
