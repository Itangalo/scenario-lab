...
- characters 106-13820: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13863-14054: `{{metrics_json}}` from the run's live metric values
- characters 14147-15346: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15389-17535: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17591-18807: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Middle-Power Supply-Chain and Compute Compact | 2 |
