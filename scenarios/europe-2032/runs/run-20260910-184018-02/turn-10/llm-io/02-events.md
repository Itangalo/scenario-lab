...
- characters 1618-3764: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3820-4434: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4497-30190: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30545-31534: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, safety_breakthrough, adoption_success
- Turn 2 (8 turn(s) ago): cyber_major_incident, capability_jump, openweight_frontier_release
- Turn 3 (7 turn(s) ago): eu_frontier_access_denied, joint_threat_response, emergent_datacentre_siting_backlash
- Turn 4 (6 turn(s) ago): openweight_frontier_release, eu_frontier_access_denied
- Turn 5 (5 turn(s) ago): loss_of_control_incident, us_china_agreement, election_retrenchment
- Turn 6 (4 turn(s) ago): rsi_onset, opaque_reasoning, embodied_ai_deployment, export_control_escalation, eu_frontier_access_denied, adoption_success
- Turn 7 (3 turn(s) ago): medical_breakthrough, safety_breakthrough, embodied_ai_deployment, export_control_escalation
- Turn 8 (2 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, bio_uplift_findings
- Turn 9 (1 turn(s) ago): bio_incident, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied, emergent_infrastructure_sabotage_wave
