...
- `two_year_commitment` (commitment): Rebuild trustworthy services, jobs and enforcement before any AI expansion

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild trustworthy services, jobs and enforcement before any AI expansion
