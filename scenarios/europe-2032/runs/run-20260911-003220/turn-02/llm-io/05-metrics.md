...
- characters 105-13114: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13157-13349: `{{metrics_json}}` from the run's live metric values
- characters 13442-14771: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14814-17291: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17347-17795: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 50.0, "ai_safety": 30.0, "resilience": 37.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 32.0, "public_sentiment": 38.0}
```
## Narrative
