...
- `two_year_commitment` (commitment): Survive superhuman capability through the allied safety floor and hardened domestic resilience

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Survive superhuman capability through the allied safety floor and hardened domestic resilience
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The commitment's duration was central to its purpose; closure of the period directly ends the original pledge's timeframe and enables redefinition.
