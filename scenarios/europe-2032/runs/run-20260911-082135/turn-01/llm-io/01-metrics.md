...
- characters 106-13087: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13130-13322: `{{metrics_json}}` from the run's live metric values
- characters 13438-16387: `{{world_state}}` from background/context.md, seeded as the opening world state
