...
- `two_year_commitment` (commitment): Rebuild legitimacy by making European AI visibly work in public services while hardening against harm

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild legitimacy by making European AI visibly work in public services while hardening against harm
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the timeframe for the original statement, necessitating a new direction.
