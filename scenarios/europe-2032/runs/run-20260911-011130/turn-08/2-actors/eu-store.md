...
| M7 | EU Swarm-Defence Patch Shield | 6 | small | 8 | 10 | own jurisdiction | resilience up strongly, ai_safety up modestly | 2 | running |
...
- **applied** `M7` — {"op": "add", "table": "measures", "fields": {"name": "EU Swarm-Defence Patch Shield", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up strongly, ai_safety up modestly"}, "grounds": "defensive breakthrough makes patch-at-speed deployable now"}
  - Grounds: defensive breakthrough makes patch-at-speed deployable now
