...
- characters 13465-14678: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14721-16916: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16972-17748: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_grid_tooling_leak` -- first noted turn 2, listed in 1 turn(s) so far: Stolen grid reconnaissance tooling derived from the autumn intrusion is repackaged and offered on criminal forums, putting industrial-system swarm capability in the hands of non-state actors beyond the original operators.
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 49.0, "ai_safety": 30.0, "resilience": 37.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 19.0, "public_sentiment": 37.0}
```
