...
- characters 5421-5861: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7315-9406: `{{previous_actions}}` from the actor's own response from the previous turn
