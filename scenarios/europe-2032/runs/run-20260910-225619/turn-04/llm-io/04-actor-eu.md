...
- characters 1664-4598: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5014-5454: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7578-9664: `{{previous_actions}}` from the actor's own response from the previous turn
