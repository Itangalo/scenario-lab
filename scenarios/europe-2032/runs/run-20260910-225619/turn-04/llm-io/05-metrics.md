...
- characters 105-13809: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13852-14044: `{{metrics_json}}` from the run's live metric values
- characters 14137-15304: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15347-18281: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18337-19316: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Certified Assurance Rollout | 2 |
