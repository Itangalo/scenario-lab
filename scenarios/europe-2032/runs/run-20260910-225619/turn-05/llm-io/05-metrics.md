...
- characters 106-13488: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13531-13723: `{{metrics_json}}` from the run's live metric values
- characters 13816-15268: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15312-17558: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17614-18046: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Bio-Response and Containment Surge | 2 |
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Certified Assurance Rollout −2, priority −1 = −9
PROPOSAL BONUS: none — new assurance rollout answers positive breakthrough and welfare enforcement failure, not a negative shock it would have mitigated
LEGITIMACY LENDS: capital 17, sentiment 36 -> +2
