...
- characters 107-12828: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12871-13060: `{{metrics_json}}` from the run's live metric values
- characters 13153-15628: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15672-17651: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17707-18360: `{{notepad}}` from the Game Master's notepad, carried across turns
