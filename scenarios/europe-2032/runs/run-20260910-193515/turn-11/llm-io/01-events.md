...
- characters 375-2850: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2894-4873: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4929-5582: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5645-31450: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31805-32742: `{{event_history}}` from the run's own event record
...
SOVEREIGNTY: 19 last turn, no capacity event, no category 4 in flight or finishing, capability rose 0.0 no -1 = 19

## Emerging developments (tracked)

- `emergent_municipal_agent_cascade` -- first noted turn 10, listed in 1 turn(s) so far: Municipalities running months-old open-weight assistants suffer a coordinated credential-swapping cascade that locks payroll and hospital scheduling systems for days, forcing emergency reversion to paper across several cities.
...
- Turn 2 (9 turn(s) ago): cyber_major_incident, ai_investment_collapse, knowledge_work_augmented, eu_frontier_access_denied, member_state_defection
- Turn 3 (8 turn(s) ago): knowledge_work_augmented, export_control_escalation, automated_decision_scandal, joint_threat_response
- Turn 4 (7 turn(s) ago): knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied
- Turn 5 (6 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_datacentre_moratorium_ruling, election_consolidation
- Turn 6 (5 turn(s) ago): capability_jump, supply_chain_coercion, middle_power_coalition
- Turn 8 (3 turn(s) ago): loss_of_control_incident, capability_jump, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal, emergent_care_provider_breakaway
- Turn 9 (2 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, member_state_defection
