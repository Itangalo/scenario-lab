...
- characters 375-1712: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1756-3818: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3874-4410: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4473-30278: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30633-31755: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M10 EU Essential Services Emergency Failover −2, M11 Municipal Open-Agent Quarantine and Continuity −2, priority −1 not charged capital below 20 = −4
PROPOSAL BONUS: Municipal Open-Agent Quarantine and Continuity (cat 6, small) +3 — emergent municipal credential cascade this turn locking payroll/scheduling and this answers directly
LEGITIMACY LENDS: capital 12, sentiment 5 -> none, capital higher
SOVEREIGNTY: 17 last turn, no capacity event, no category 4 in flight or finishing, capability rose 0.0 no −1 = 17
...
- Turn 2 (11 turn(s) ago): cyber_major_incident, ai_investment_collapse, knowledge_work_augmented, eu_frontier_access_denied, member_state_defection
- Turn 3 (10 turn(s) ago): knowledge_work_augmented, export_control_escalation, automated_decision_scandal, joint_threat_response
- Turn 4 (9 turn(s) ago): knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied
- Turn 5 (8 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_datacentre_moratorium_ruling, election_consolidation
- Turn 6 (7 turn(s) ago): capability_jump, supply_chain_coercion, middle_power_coalition
- Turn 8 (5 turn(s) ago): loss_of_control_incident, capability_jump, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal, emergent_care_provider_breakaway
- Turn 9 (4 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, member_state_defection
- Turn 11 (2 turn(s) ago): export_control_escalation, eu_frontier_access_denied
- Turn 12 (1 turn(s) ago): medical_breakthrough, taiwan_tension_rise, emergent_municipal_agent_cascade
