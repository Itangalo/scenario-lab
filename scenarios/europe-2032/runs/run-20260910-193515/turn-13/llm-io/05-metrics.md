...
- characters 107-13230: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13273-13462: `{{metrics_json}}` from the run's live metric values
- characters 13555-14892: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14936-16998: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17054-18188: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_therapy_licence_freeze` -- first noted turn 13, listed in 1 turn(s) so far: Licensed clinical channels for US-model-delivered tailored therapies break down over liability and data-transfer disputes, leaving EU patients with approvals on paper but no treatments in practice.
- `emergent_clinical_staff_walkout` -- first noted turn 13, listed in 1 turn(s) so far: A coordinated walkout by locum and agency clinical staff refusing paper-only rostering and liability exposure forces emergency ward closures in two member states during the winter surge.
...
## Notepad
PORTFOLIO CHARGE t13: M11 Municipal Open-Agent Quarantine and Continuity −2, priority −1 not charged capital below 20 = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 2 -> +1 but capped, applied in capital calc
SOVEREIGNTY: 17 last turn, no category 4 finishing or in flight, export_control_escalation t13 −3, capability rose 3.0 −1 = 13
