...
- characters 105-12985: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13028-13220: `{{metrics_json}}` from the run's live metric values
- characters 13313-15268: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15311-17626: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17682-18807: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Essential Services Continuity Mandate | 3 |
| M5 | EU Joint Cyber Telemetry Pool | 2 |
| M6 | EU Hospital-Ministry Failover Stack | 2 |
