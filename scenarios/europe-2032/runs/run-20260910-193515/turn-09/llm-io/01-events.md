...
- characters 374-1398: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1442-3903: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3959-4856: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4919-30724: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31079-31914: `{{event_history}}` from the run's own event record
...
- `emergent_pacific_compute_bargain` -- first noted turn 7, listed in 2 turn(s) so far: Tokyo and Seoul offer joint compute procurement pooled with EU gigafactory reservations in exchange for EU co-funding of a non-US lithography servicing workaround.
...
- Turn 2 (7 turn(s) ago): cyber_major_incident, ai_investment_collapse, knowledge_work_augmented, eu_frontier_access_denied, member_state_defection
- Turn 3 (6 turn(s) ago): knowledge_work_augmented, export_control_escalation, automated_decision_scandal, joint_threat_response
- Turn 4 (5 turn(s) ago): knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied
- Turn 5 (4 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_datacentre_moratorium_ruling, election_consolidation
- Turn 6 (3 turn(s) ago): capability_jump, supply_chain_coercion, middle_power_coalition
- Turn 8 (1 turn(s) ago): loss_of_control_incident, capability_jump, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal, emergent_care_provider_breakaway
