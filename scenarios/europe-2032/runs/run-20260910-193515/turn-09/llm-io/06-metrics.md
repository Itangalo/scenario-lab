...
- characters 13379-13568: `{{metrics_json}}` from the run's live metric values
- characters 13661-14685: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14729-17190: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17246-17854: `{{notepad}}` from the Game Master's notepad, carried across turns
