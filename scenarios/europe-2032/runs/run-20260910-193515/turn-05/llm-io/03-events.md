...
- characters 377-2604: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2648-4583: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4639-5784: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5847-28468: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28823-29240: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Essential Services Continuity Mandate −3, EU Joint Cyber Telemetry Pool −2, EU Hospital-Ministry Failover Stack −2, priority −1 = −14
PROPOSAL BONUS: EU Hospital-Ministry Failover Stack (cat 6, small) +3 — eu_frontier_access_denied landed this turn on hospitals/ministries and this answers it directly
LEGITIMACY LENDS: capital 17, sentiment 22 -> +2
SOVEREIGNTY: 20 last turn, no capacity finish, Gigafactories in flight +0, eu_frontier_access_denied t4 −2, capability rose 1.5 −0 = 18

## Emerging developments (tracked)

- `emergent_datacentre_moratorium_ruling` -- first noted turn 4, listed in 1 turn(s) so far: Municipal backlash forces a court-ordered pause on a planned gigafactory grid connection after the benefits scandal, freezing permits that had survived as reservations.
- `emergent_datacentre_siting_freeze` -- first noted turn 4, listed in 1 turn(s) so far: Municipal backlash forces a court-ordered pause on new data centre grid connections in two member states pending health and cost review, freezing sovereignty build-out without cancelling it.
...
- Turn 2 (3 turn(s) ago): cyber_major_incident, ai_investment_collapse, knowledge_work_augmented, eu_frontier_access_denied, member_state_defection
- Turn 3 (2 turn(s) ago): knowledge_work_augmented, export_control_escalation, automated_decision_scandal, joint_threat_response
- Turn 4 (1 turn(s) ago): knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied
