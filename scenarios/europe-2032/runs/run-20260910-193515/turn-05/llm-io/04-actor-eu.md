...
- characters 455-2682: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2726-4661: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6499-6945: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9232-11461: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Hospital-Ministry Failover Stack | 6 | small | 4 | 6 | own jurisdiction | resilience up, eu_ai_sovereignty up slightly via demand pull away from US model | 2 | running |
