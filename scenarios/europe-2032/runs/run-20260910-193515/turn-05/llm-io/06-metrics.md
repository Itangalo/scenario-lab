...
- characters 13744-15971: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16015-17950: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18006-18889: `{{notepad}}` from the Game Master's notepad, carried across turns
