...
- characters 12931-13121: `{{metrics_json}}` from the run's live metric values
- characters 13214-14367: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14410-16631: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16687-17240: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Essential Services Emergency Failover | 2 |
| M11 | Municipal Open-Agent Quarantine and Continuity | 2 |
