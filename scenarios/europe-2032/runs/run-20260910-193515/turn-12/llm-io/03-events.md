...
- characters 375-1528: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1571-3792: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3848-4754: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4817-30622: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30977-31995: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M10 EU Essential Services Emergency Failover −2 = −2, no named priority
PROPOSAL BONUS: EU Essential Services Emergency Failover (cat 6, small) +3 — frontier cutoff and export tightening hit hospitals/ministries this turn and this answers directly
LEGITIMACY LENDS: capital 9, sentiment 8 -> none, capital higher
SOVEREIGNTY: 19 last turn, no capacity event? no — eu_frontier_access_denied t11 −2 (largest of two takeaways, cushioned by paper/kill-switch rails), no category 4 in flight or finishing, capability rose 0.0 no −1 = 17

## Emerging developments (tracked)

- `emergent_municipal_agent_cascade` -- first noted turn 10, listed in 2 turn(s) so far: Municipalities running months-old open-weight assistants suffer a coordinated credential-swapping cascade that locks payroll and hospital scheduling systems for days, forcing emergency reversion to paper across several cities.
...
- Turn 2 (10 turn(s) ago): cyber_major_incident, ai_investment_collapse, knowledge_work_augmented, eu_frontier_access_denied, member_state_defection
- Turn 3 (9 turn(s) ago): knowledge_work_augmented, export_control_escalation, automated_decision_scandal, joint_threat_response
- Turn 4 (8 turn(s) ago): knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied
- Turn 5 (7 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_datacentre_moratorium_ruling, election_consolidation
- Turn 6 (6 turn(s) ago): capability_jump, supply_chain_coercion, middle_power_coalition
- Turn 8 (4 turn(s) ago): loss_of_control_incident, capability_jump, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal, emergent_care_provider_breakaway
- Turn 9 (3 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, member_state_defection
- Turn 11 (1 turn(s) ago): export_control_escalation, eu_frontier_access_denied
