...
- characters 452-2242: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2285-4323: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4391-4866: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7606-9109: `{{previous_actions}}` from the actor's own response from the previous turn
