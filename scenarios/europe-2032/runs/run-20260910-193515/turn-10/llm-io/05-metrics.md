...
- characters 13375-13564: `{{metrics_json}}` from the run's live metric values
- characters 13657-15447: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15490-17528: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17584-18327: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t9: M8 EU Automation Transition Safety Net −2, M9 EU Agentic Containment and Essential Continuity Protocol −2, priority M9 −1 = −5
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 3, sentiment 5 -> +1 but capped, applied in total
SOVEREIGNTY: 21 last turn, no category 4 finish, member_state_defection t9 −2, capability rose 0.5 no −1 = 19
