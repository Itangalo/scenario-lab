...
- characters 105-12939: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12982-13174: `{{metrics_json}}` from the run's live metric values
- characters 13267-14198: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14241-15911: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 15967-16658: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | EU Agentic Containment and Essential Continuity Protocol | 2 |
...
## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M8", "fields": {"finish_turn": 10}, "grounds": "named priority"}]}
```
```
