...
- characters 105-13455: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13498-13690: `{{metrics_json}}` from the run's live metric values
- characters 13783-16661: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16704-18450: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18506-18881: `{{notepad}}` from the Game Master's notepad, carried across turns
