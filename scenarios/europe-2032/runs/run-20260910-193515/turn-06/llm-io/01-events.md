...
- characters 376-3254: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3297-5043: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5099-5791: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5854-27093: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27448-28009: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Hospital-Ministry Failover Stack −2, priority −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 15, sentiment 19 -> +2
SOVEREIGNTY: 18 last turn, no capacity finish, Gigafactories in flight +0, export_control_escalation t5 −2, capability rose 1.5 −0 = 16

## Emerging developments (tracked)

- `emergent_datacentre_siting_freeze` -- first noted turn 4, listed in 2 turn(s) so far: Municipal backlash forces a court-ordered pause on new data centre grid connections in two member states pending health and cost review, freezing sovereignty build-out without cancelling it.
...
- Turn 2 (4 turn(s) ago): cyber_major_incident, ai_investment_collapse, knowledge_work_augmented, eu_frontier_access_denied, member_state_defection
- Turn 3 (3 turn(s) ago): knowledge_work_augmented, export_control_escalation, automated_decision_scandal, joint_threat_response
- Turn 4 (2 turn(s) ago): knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied
- Turn 5 (1 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_datacentre_moratorium_ruling, election_consolidation
