...
- characters 454-3332: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3375-5121: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6392-6866: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9155-10839: `{{previous_actions}}` from the actor's own response from the previous turn
