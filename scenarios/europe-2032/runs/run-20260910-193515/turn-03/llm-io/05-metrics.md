...
- characters 13661-15160: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15204-17744: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17800-18324: `{{notepad}}` from the Game Master's notepad, carried across turns
