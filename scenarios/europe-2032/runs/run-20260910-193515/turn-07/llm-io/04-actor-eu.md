...
- characters 455-1323: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1367-3498: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3566-4084: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6599-9273: `{{previous_actions}}` from the actor's own response from the previous turn
