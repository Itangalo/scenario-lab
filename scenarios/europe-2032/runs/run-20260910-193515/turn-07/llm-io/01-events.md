...
- characters 377-1245: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1289-3420: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3476-3978: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4041-28993: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29348-29998: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): cyber_major_incident, ai_investment_collapse, knowledge_work_augmented, eu_frontier_access_denied, member_state_defection
- Turn 3 (4 turn(s) ago): knowledge_work_augmented, export_control_escalation, automated_decision_scandal, joint_threat_response
- Turn 4 (3 turn(s) ago): knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied
- Turn 5 (2 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_datacentre_moratorium_ruling, election_consolidation
- Turn 6 (1 turn(s) ago): capability_jump, supply_chain_coercion, middle_power_coalition
