...
- characters 13563-14431: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14475-16606: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16662-17739: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Middle-Power Supply-Chain Coalition | 2 |
| M8 | EU Automation Transition Safety Net | 2 |
...
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, EU Middle-Power Supply-Chain Coalition −2, priority −1 = −6
PROPOSAL BONUS: EU Middle-Power Supply-Chain Coalition (cat 8, small) +3 — supply_chain_coercion t5-t6 and rationed access directly answered, capability jump makes it urgent
LEGITIMACY LENDS: capital 20, sentiment 16 -> none — capital higher
SOVEREIGNTY: 16 last turn, Tech sovereignty package finishes t6 +4, Gigafactories in flight +0, supply_chain_coercion t6 −2, capability rose 4.0 −1 = 17
