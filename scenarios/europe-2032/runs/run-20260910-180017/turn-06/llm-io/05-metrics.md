...
- characters 105-13323: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13366-13556: `{{metrics_json}}` from the run's live metric values
- characters 13649-15238: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15281-17551: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17607-18035: `{{notepad}}` from the Game Master's notepad, carried across turns
...
**emergent_reinsurance_retreat_widens (emergent event):** Major global reinsurers extend model-enabled exclusions from cyber to technology-errors and contingent business-interruption policies, leaving EU ports and hospitals unable to renew cover at any price and forcing temporary service curtailments.
