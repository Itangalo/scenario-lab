...
- characters 374-1963: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2006-4276: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4332-5133: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5196-30860: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31215-31777: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, EU Critical-Sector Cyber Insurance Backstop −2, EU Bio Shield Surge −2, priority −1 = −8
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 4, sentiment 33 -> +2 (included in capital total, capped below sentiment)
SOVEREIGNTY: 12 last turn, no capacity build finishes, no in-flight bonus, export_control_escalation t5 −2, capability rose 5.0 −1 = 9

## Emerging developments (tracked)

- `emergent_reinsurance_retreat_widens` -- first noted turn 4, listed in 2 turn(s) so far: Major global reinsurers extend model-enabled exclusions from cyber to technology-errors and contingent business-interruption policies, leaving EU ports and hospitals unable to renew cover at any price and forcing temporary service curtailments.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, capability_jump, taiwan_tension_rise, supply_chain_coercion
- Turn 2 (4 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough, taiwan_tension_rise, export_control_escalation
- Turn 3 (3 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise, member_state_defection, emergent_cyber_insurance_crunch
- Turn 4 (2 turn(s) ago): bio_uplift_findings, medical_breakthrough
- Turn 5 (1 turn(s) ago): capability_jump, export_control_escalation, emergent_cover_gap_cascade, election_consolidation
