...
- characters 452-2041: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2084-4354: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6395-6850: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8863-10573: `{{previous_actions}}` from the actor's own response from the previous turn
