...
- characters 105-13466: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13509-13701: `{{metrics_json}}` from the run's live metric values
- characters 13794-15468: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15511-17830: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17886-19108: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Critical-Sector Cyber Insurance Backstop | 2 |
| M6 | EU Bio Shield Surge | 2 |
...
## Metrics
```json
{"ai_capability": 66.0, "openweight_capability": 59.3, "ai_safety": 26.0, "resilience": 33.0, "eu_ai_sovereignty": 12.0, "eu_political_capital": 8.0, "public_sentiment": 37.0}
```
