...
- characters 375-1487: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1531-3344: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3400-4159: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4222-28017: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28372-29352: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Bio Incident Containment and Care Continuity −2, priority −1 = −3
PROPOSAL BONUS: EU Bio Incident Containment and Care Continuity (cat 6, small) +4 — bio_incident landed this turn and this answers containment directly
LEGITIMACY LENDS: capital 4, sentiment 18 -> +2 (included in capital total, capped below sentiment)
SOVEREIGNTY: 2 last turn, no capacity event, no cat4 finish, capability rose 3.0 −1 = 1

## Emerging developments (tracked)

- `emergent_sovereign_compute_bid` -- first noted turn 7, listed in 2 turn(s) so far: Gulf and Asian sovereign funds offer to finance the shelved EU gigafactory sites in exchange for dedicated capacity and governance rights, forcing a public fight over foreign ownership of sovereign compute.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, capability_jump, taiwan_tension_rise, supply_chain_coercion
- Turn 2 (7 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough, taiwan_tension_rise, export_control_escalation
- Turn 3 (6 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise, member_state_defection, emergent_cyber_insurance_crunch
- Turn 4 (5 turn(s) ago): bio_uplift_findings, medical_breakthrough
- Turn 5 (4 turn(s) ago): capability_jump, export_control_escalation, emergent_cover_gap_cascade, election_consolidation
- Turn 6 (3 turn(s) ago): knowledge_work_augmented, taiwan_tension_rise, export_control_escalation, eu_frontier_access_denied, adoption_success, emergent_reinsurance_retreat_widens
- Turn 7 (2 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, taiwan_blockade, export_control_escalation, us_china_agreement
- Turn 8 (1 turn(s) ago): bio_uplift_findings, bio_incident, safety_breakthrough, labour_displacement
