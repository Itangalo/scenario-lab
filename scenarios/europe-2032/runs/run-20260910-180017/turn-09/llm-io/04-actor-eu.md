...
- characters 453-1565: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1609-3422: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5725-6180: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8234-10262: `{{previous_actions}}` from the actor's own response from the previous turn
