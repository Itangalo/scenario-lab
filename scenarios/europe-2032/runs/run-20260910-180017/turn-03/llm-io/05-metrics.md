...
- characters 13437-15077: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15121-17298: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17354-17905: `{{notepad}}` from the Game Master's notepad, carried across turns
