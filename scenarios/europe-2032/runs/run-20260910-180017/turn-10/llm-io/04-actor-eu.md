...
- characters 452-1818: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1861-3784: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5499-5974: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8171-10668: `{{previous_actions}}` from the actor's own response from the previous turn
