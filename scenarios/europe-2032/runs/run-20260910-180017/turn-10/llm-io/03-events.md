...
- characters 374-1740: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1783-3706: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3762-4223: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4286-28429: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28784-29896: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, capability_jump, taiwan_tension_rise, supply_chain_coercion
- Turn 2 (8 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough, taiwan_tension_rise, export_control_escalation
- Turn 3 (7 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise, member_state_defection, emergent_cyber_insurance_crunch
- Turn 4 (6 turn(s) ago): bio_uplift_findings, medical_breakthrough
- Turn 5 (5 turn(s) ago): capability_jump, export_control_escalation, emergent_cover_gap_cascade, election_consolidation
- Turn 6 (4 turn(s) ago): knowledge_work_augmented, taiwan_tension_rise, export_control_escalation, eu_frontier_access_denied, adoption_success, emergent_reinsurance_retreat_widens
- Turn 7 (3 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, taiwan_blockade, export_control_escalation, us_china_agreement
- Turn 8 (2 turn(s) ago): bio_uplift_findings, bio_incident, safety_breakthrough, labour_displacement
- Turn 9 (1 turn(s) ago): capability_jump, eval_anomaly_reports, opaque_reasoning, eu_frontier_access_denied, joint_threat_response
