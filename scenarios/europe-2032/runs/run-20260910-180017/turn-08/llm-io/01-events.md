...
- characters 374-1713: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1756-4008: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4064-4916: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4979-29586: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29941-30819: `{{event_history}}` from the run's own event record
...
- `emergent_sovereign_compute_bid` -- first noted turn 7, listed in 1 turn(s) so far: Gulf and Asian sovereign funds offer to finance the shelved EU gigafactory sites in exchange for dedicated capacity and governance rights, forcing a public fight over foreign ownership of sovereign compute.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, capability_jump, taiwan_tension_rise, supply_chain_coercion
- Turn 2 (6 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough, taiwan_tension_rise, export_control_escalation
- Turn 3 (5 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise, member_state_defection, emergent_cyber_insurance_crunch
- Turn 4 (4 turn(s) ago): bio_uplift_findings, medical_breakthrough
- Turn 5 (3 turn(s) ago): capability_jump, export_control_escalation, emergent_cover_gap_cascade, election_consolidation
- Turn 6 (2 turn(s) ago): knowledge_work_augmented, taiwan_tension_rise, export_control_escalation, eu_frontier_access_denied, adoption_success, emergent_reinsurance_retreat_widens
- Turn 7 (1 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, taiwan_blockade, export_control_escalation, us_china_agreement
