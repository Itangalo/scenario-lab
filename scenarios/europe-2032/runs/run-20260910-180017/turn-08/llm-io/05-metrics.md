...
- characters 105-13351: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13394-13584: `{{metrics_json}}` from the run's live metric values
- characters 13677-15016: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15059-17311: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17367-18219: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Bio Incident Containment and Care Continuity | 2 |
...
## Metrics
```json
{"ai_capability": 79.5, "openweight_capability": 73.5, "ai_safety": 19.0, "resilience": 47.0, "eu_ai_sovereignty": 1.0, "eu_political_capital": 6.0, "public_sentiment": 18.0}
```
