...
- characters 13359-13549: `{{metrics_json}}` from the run's live metric values
- characters 13642-15095: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15139-17573: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17629-18311: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Essential Services Continuity Rationing | 2 |
