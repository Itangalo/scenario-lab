...
- characters 1872-4306: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4362-4714: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4777-30441: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30796-31539: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, capability_jump, taiwan_tension_rise, supply_chain_coercion
- Turn 2 (5 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough, taiwan_tension_rise, export_control_escalation
- Turn 3 (4 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise, member_state_defection, emergent_cyber_insurance_crunch
- Turn 4 (3 turn(s) ago): bio_uplift_findings, medical_breakthrough
- Turn 5 (2 turn(s) ago): capability_jump, export_control_escalation, emergent_cover_gap_cascade, election_consolidation
- Turn 6 (1 turn(s) ago): knowledge_work_augmented, taiwan_tension_rise, export_control_escalation, eu_frontier_access_denied, adoption_success, emergent_reinsurance_retreat_widens
