...
- characters 374-2073: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2117-4141: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4197-4595: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4658-27948: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28303-29733: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Pandemic Care and Essential Functions Keep-Alive −2, priority −1 = −3
PROPOSAL BONUS: none — new Keep-Alive entry duplicates M11 already in flight, no fresh proposal bonus
LEGITIMACY LENDS: capital 3, sentiment 0 -> none, capital higher
SOVEREIGNTY: 0 last turn, no cat4 finish, no cat4 in flight, eu_frontier_access_denied t12 −2, capability rose 1.5 −1 = 0 (floored at 0)
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, capability_jump, taiwan_tension_rise, supply_chain_coercion
- Turn 2 (11 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough, taiwan_tension_rise, export_control_escalation
- Turn 3 (10 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise, member_state_defection, emergent_cyber_insurance_crunch
- Turn 4 (9 turn(s) ago): bio_uplift_findings, medical_breakthrough
- Turn 5 (8 turn(s) ago): capability_jump, export_control_escalation, emergent_cover_gap_cascade, election_consolidation
- Turn 6 (7 turn(s) ago): knowledge_work_augmented, taiwan_tension_rise, export_control_escalation, eu_frontier_access_denied, adoption_success, emergent_reinsurance_retreat_widens
- Turn 7 (6 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, taiwan_blockade, export_control_escalation, us_china_agreement
- Turn 8 (5 turn(s) ago): bio_uplift_findings, bio_incident, safety_breakthrough, labour_displacement
- Turn 9 (4 turn(s) ago): capability_jump, eval_anomaly_reports, opaque_reasoning, eu_frontier_access_denied, joint_threat_response
- Turn 10 (3 turn(s) ago): loss_of_control_incident, capability_jump, bio_uplift_findings, member_state_defection
- Turn 11 (2 turn(s) ago): cyber_major_incident, capability_jump
- Turn 12 (1 turn(s) ago): catastrophic_bio_incident, safety_breakthrough, eu_frontier_access_denied, emergent_anti_datacentre_sabotage
