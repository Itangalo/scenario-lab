...
- characters 13014-13202: `{{metrics_json}}` from the run's live metric values
- characters 13295-14994: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15038-17062: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17118-17516: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t13: M11 EU Pandemic Care and Essential Functions Keep-Alive −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 3, sentiment 0 -> none, capital higher
SOVEREIGNTY: 0 last turn, no capacity event, no cat4 finish, no cat4 in flight +0, capability rose 3.5 −1 = 0 (floored at 0)
## Store changes
```json
{"store": []}
```
