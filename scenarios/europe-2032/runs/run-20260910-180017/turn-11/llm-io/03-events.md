...
- characters 93-281: `{{metrics_json}}` from the run's live metric values
- characters 374-1509: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1553-3949: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4005-5069: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5132-29275: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29630-30857: `{{event_history}}` from the run's own event record
...
- `emergent_fallback_protocol_diffusion` -- first noted turn 10, listed in 1 turn(s) so far: Hospital fallback networks publish an open triage and logistics protocol built on older EU models during the access cutoff, and several non-EU public health systems adopt it as a low-dependence backup standard.
- `emergent_anti_datacentre_sabotage` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated sabotage and blockades of data-centre construction sites across several member states force a temporary halt to new builds after clashes with security.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, capability_jump, taiwan_tension_rise, supply_chain_coercion
- Turn 2 (9 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough, taiwan_tension_rise, export_control_escalation
- Turn 3 (8 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise, member_state_defection, emergent_cyber_insurance_crunch
- Turn 4 (7 turn(s) ago): bio_uplift_findings, medical_breakthrough
- Turn 5 (6 turn(s) ago): capability_jump, export_control_escalation, emergent_cover_gap_cascade, election_consolidation
- Turn 6 (5 turn(s) ago): knowledge_work_augmented, taiwan_tension_rise, export_control_escalation, eu_frontier_access_denied, adoption_success, emergent_reinsurance_retreat_widens
- Turn 7 (4 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, taiwan_blockade, export_control_escalation, us_china_agreement
- Turn 8 (3 turn(s) ago): bio_uplift_findings, bio_incident, safety_breakthrough, labour_displacement
- Turn 9 (2 turn(s) ago): capability_jump, eval_anomaly_reports, opaque_reasoning, eu_frontier_access_denied, joint_threat_response
- Turn 10 (1 turn(s) ago): loss_of_control_incident, capability_jump, bio_uplift_findings, member_state_defection
