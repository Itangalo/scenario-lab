...
- characters 107-12964: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13007-13195: `{{metrics_json}}` from the run's live metric values
- characters 13288-14423: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14467-16863: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16919-17983: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Emergency Restoration and Mutual Aid Cell | 2 |
...
## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M10", "fields": {"finish_turn": 12}, "grounds": "named priority"}]}
```
```
