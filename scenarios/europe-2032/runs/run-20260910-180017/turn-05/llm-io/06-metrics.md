...
- characters 13705-15125: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15169-17431: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17487-18353: `{{notepad}}` from the Game Master's notepad, carried across turns
