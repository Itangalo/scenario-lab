...
- characters 1840-4102: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4158-5293: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5356-32060: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32415-32856: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Critical-Sector Cyber Insurance Backstop −2, EU Bio Shield Surge −2, priority −1 = −14
PROPOSAL BONUS: EU Bio Shield Surge (cat 6, small) +3 — bio_uplift_findings precursor opened 4-turn window last turn and this answers it directly
LEGITIMACY LENDS: capital 6, sentiment 37 -> +2
SOVEREIGNTY: 13 last turn, no capacity event, Gigafactories in flight +0, capability rose 3.0 −1 = 12

## Emerging developments (tracked)

- `emergent_reinsurance_retreat_widens` -- first noted turn 4, listed in 1 turn(s) so far: Major global reinsurers extend model-enabled exclusions from cyber to technology-errors and contingent business-interruption policies, leaving EU ports and hospitals unable to renew cover at any price and forcing temporary service curtailments.
- `emergent_cover_gap_cascade` -- first noted turn 4, listed in 1 turn(s) so far: Municipal utilities and regional hospitals in several member states face temporary loss of cyber cover at renewal, forcing emergency self-insurance pools and deferred equipment upgrades.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, capability_jump, taiwan_tension_rise, supply_chain_coercion
- Turn 2 (3 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough, taiwan_tension_rise, export_control_escalation
- Turn 3 (2 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise, member_state_defection, emergent_cyber_insurance_crunch
- Turn 4 (1 turn(s) ago): bio_uplift_findings, medical_breakthrough
