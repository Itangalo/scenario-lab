...
- characters 1918-4180: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5922-6382: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8597-10764: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Bio Shield Surge | 6 | small | 4 | 7 | own jurisdiction | resilience up, ai_safety up via bio misuse detection | 2 | running |
