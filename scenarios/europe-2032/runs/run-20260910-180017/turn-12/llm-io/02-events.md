...
- characters 92-280: `{{metrics_json}}` from the run's live metric values
- characters 373-1214: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1257-3399: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3455-4509: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4572-28715: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29070-30363: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Emergency Restoration and Mutual Aid Cell −2, priority −1 = −3
PROPOSAL BONUS: EU Emergency Restoration and Mutual Aid Cell (cat 6, small) +3 — cyber_major_incident landed this turn severe and public with services down and this answers it directly
LEGITIMACY LENDS: capital 7, sentiment 2 -> none, capital higher
SOVEREIGNTY: 0 last turn, no capacity event, no cat4 finish, no cat4 in flight, capability rose 3.8 −1 = 0 (floored at 0)

## Emerging developments (tracked)

- `emergent_fallback_protocol_diffusion` -- first noted turn 10, listed in 2 turn(s) so far: Hospital fallback networks publish an open triage and logistics protocol built on older EU models during the access cutoff, and several non-EU public health systems adopt it as a low-dependence backup standard.
- `emergent_anti_datacentre_sabotage` -- first noted turn 10, listed in 2 turn(s) so far: Coordinated sabotage and blockades of data-centre construction sites across several member states force a temporary halt to new builds after clashes with security.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, capability_jump, taiwan_tension_rise, supply_chain_coercion
- Turn 2 (10 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough, taiwan_tension_rise, export_control_escalation
- Turn 3 (9 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise, member_state_defection, emergent_cyber_insurance_crunch
- Turn 4 (8 turn(s) ago): bio_uplift_findings, medical_breakthrough
- Turn 5 (7 turn(s) ago): capability_jump, export_control_escalation, emergent_cover_gap_cascade, election_consolidation
- Turn 6 (6 turn(s) ago): knowledge_work_augmented, taiwan_tension_rise, export_control_escalation, eu_frontier_access_denied, adoption_success, emergent_reinsurance_retreat_widens
- Turn 7 (5 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, taiwan_blockade, export_control_escalation, us_china_agreement
- Turn 8 (4 turn(s) ago): bio_uplift_findings, bio_incident, safety_breakthrough, labour_displacement
- Turn 9 (3 turn(s) ago): capability_jump, eval_anomaly_reports, opaque_reasoning, eu_frontier_access_denied, joint_threat_response
- Turn 10 (2 turn(s) ago): loss_of_control_incident, capability_jump, bio_uplift_findings, member_state_defection
- Turn 11 (1 turn(s) ago): cyber_major_incident, capability_jump
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.12}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.03}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.05}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.03}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "rsi_onset", "probability": 0.35}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.05}, {"description": "", "emergent": false, "id": "catastrophic_great_power_conflict", "probability": 0.045}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "us_labs_nationalised", "probability": 0.19}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Hospital fallback networks publish an open triage and logistics protocol built on older EU models during the access cutoff, and several non-EU public health systems adopt it as a low-dependence backup standard.", "emergent": true, "id": "emergent_fallback_protocol_diffusion", "probability": 0.18}, {"description": "Coordinated sabotage and blockades of data-centre construction sites across several member states force a temporary halt to new builds after clashes with security.", "emergent": true, "id": "emergent_anti_datacentre_sabotage", "probability": 0.28}]
```
