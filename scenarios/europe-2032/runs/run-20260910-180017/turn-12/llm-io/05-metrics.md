...
- characters 106-13365: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13408-13596: `{{metrics_json}}` from the run's live metric values
- characters 13689-14530: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14573-16715: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16771-17230: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Pandemic Care and Essential Functions Keep-Alive | 2 |
