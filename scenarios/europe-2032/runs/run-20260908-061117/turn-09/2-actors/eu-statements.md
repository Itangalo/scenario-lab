...
- `two_year_commitment` (commitment): Maintain sovereign AI capacity to preserve strategic autonomy and prevent irreversible dependency

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Maintain sovereign AI capacity to preserve strategic autonomy and prevent irreversible dependency
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The commitment's duration ending directly changes the actor's obligation to uphold the original statement, triggering a natural reassessment of its terms.
