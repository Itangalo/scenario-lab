...
- characters 376-1868: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1911-3842: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3898-4452: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4515-30126: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30481-31029: `{{event_history}}` from the run's own event record
...
- Turn 2 (4 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, emergent_intrusion_tooling_copycats
- Turn 3 (3 turn(s) ago): loss_of_control_incident, capability_jump, eu_frontier_access_denied, adoption_success
- Turn 4 (2 turn(s) ago): bio_incident, taiwan_blockade, bio_uplift_findings, knowledge_work_augmented, embodied_ai_deployment
- Turn 5 (1 turn(s) ago): eval_anomaly_reports, adoption_success, emergent_utility_isolation_backfire, emergent_cyber_insurance_retreat, election_alliance
