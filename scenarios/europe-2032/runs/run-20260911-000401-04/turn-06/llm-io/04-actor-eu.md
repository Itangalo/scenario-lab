...
- characters 454-1946: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1989-3920: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5074-5528: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7832-10168: `{{previous_actions}}` from the actor's own response from the previous turn
...
- `two_year_commitment` (commitment): Regain trusted sovereign capacity and societal resilience for autonomous action
...
| M6 | EU Municipal Trust and Transition Pact | 7 | small | 5 | 7 | own jurisdiction | public_sentiment up, resilience up modestly, eu_political_capital up modestly | 2 | running |
