...
- characters 2554-4482: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4538-4985: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5048-31405: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31760-32661: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M10 EU Essential Services Continuity Patch −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: EU Essential Services Continuity Patch (cat 6, small) +2 — capability_jump landed this turn and this answers cascade risk directly, small size limits value
LEGITIMACY LENDS: capital 12, sentiment 22 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, no category 4 in flight, capability rose 3.0 −1 = 18
...
- Turn 2 (9 turn(s) ago): cyber_major_incident, loss_of_control_incident, emergent_datacentre_backlash
- Turn 3 (8 turn(s) ago): capability_jump, adoption_success
- Turn 4 (7 turn(s) ago): eval_anomaly_reports
- Turn 5 (6 turn(s) ago): capability_jump, rsi_onset, opaque_reasoning, openweight_frontier_release, joint_threat_response, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, embodied_ai_deployment, us_labs_nationalised, joint_threat_response, emergent_power_crunch
- Turn 7 (4 turn(s) ago): safety_breakthrough, joint_threat_response
- Turn 8 (3 turn(s) ago): bio_uplift_findings, research_breakthrough, medical_breakthrough, export_control_escalation, joint_threat_response
- Turn 9 (2 turn(s) ago): medical_breakthrough, adoption_success
- Turn 10 (1 turn(s) ago): capability_jump, research_breakthrough
