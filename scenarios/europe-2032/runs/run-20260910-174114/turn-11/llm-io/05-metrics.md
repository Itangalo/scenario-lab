...
- characters 107-12958: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13001-13192: `{{metrics_json}}` from the run's live metric values
- characters 13285-15418: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15462-17390: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17446-18552: `{{notepad}}` from the Game Master's notepad, carried across turns
