...
- characters 13776-14854: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14898-17034: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17090-17635: `{{notepad}}` from the Game Master's notepad, carried across turns
