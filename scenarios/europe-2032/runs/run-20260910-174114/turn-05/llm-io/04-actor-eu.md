...
- characters 455-1533: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1577-3713: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6645-7096: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9402-11486: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Evaluation Surge Taskforce | 5 | small | 4 | 6 | own jurisdiction | ai_safety up materially, eu_ai_sovereignty up slightly | 2 | running |
