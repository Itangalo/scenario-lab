...
- characters 3015-3560: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 73.5, "openweight_capability": 65.5, "ai_safety": 5.0, "resilience": 40.5, "eu_ai_sovereignty": 17.0, "eu_political_capital": 6.0, "public_sentiment": 24.0}
```
