...
- characters 1499-3635: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3691-4619: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4682-31980: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32335-32608: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, European Public Results AI Programme −2, EU Evaluation Surge Taskforce −2, priority −1 = −14
PROPOSAL BONUS: EU Evaluation Surge Taskforce (cat 5, small) +3 — answers eval anomaly this turn directly and admitted harness gap from US leap, but small and own-jurisdiction only
...
- `emergent_municipal_cyber_insurance_freeze` -- first noted turn 3, listed in 2 turn(s) so far: Several major EU insurers suspend or sharply reprice cyber and technology-errors coverage for municipalities and hospitals after the spring ransomware sweep, leaving local services unable to insure continued digitised operations through the winter.
...
- Turn 2 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, emergent_datacentre_backlash
- Turn 3 (2 turn(s) ago): capability_jump, adoption_success
