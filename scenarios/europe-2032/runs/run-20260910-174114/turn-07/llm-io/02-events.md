...
- characters 375-1763: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1807-3794: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3850-4628: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4691-30002: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30357-30916: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, emergent_datacentre_backlash
- Turn 3 (4 turn(s) ago): capability_jump, adoption_success
- Turn 4 (3 turn(s) ago): eval_anomaly_reports
- Turn 5 (2 turn(s) ago): capability_jump, rsi_onset, opaque_reasoning, openweight_frontier_release, joint_threat_response, election_consolidation
- Turn 6 (1 turn(s) ago): cyber_major_incident, embodied_ai_deployment, us_labs_nationalised, joint_threat_response, emergent_power_crunch
