...
- characters 106-13379: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13422-13612: `{{metrics_json}}` from the run's live metric values
- characters 13705-15093: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15137-17124: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17180-18024: `{{notepad}}` from the Game Master's notepad, carried across turns
