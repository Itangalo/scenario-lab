...
- characters 13112-13302: `{{metrics_json}}` from the run's live metric values
- characters 13395-14939: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14982-17008: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17064-17831: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | EU Joint Shield Integration and Assured Deployment | 2 |
| M9 | EU Bio Detection and Treatment Access Pact | 2 |
...
PORTFOLIO CHARGE t7: M7 EU Cohesion and Retraining Backstop −2, M8 EU Joint Shield Integration and Assured Deployment −2, priority M7 −1 = −5
PROPOSAL BONUS: none — new cat 6 small answers positive invitation and breakthrough, not a negative event from last three rounds
LEGITIMACY LENDS: capital 6, sentiment 19 -> +2
SOVEREIGNTY: 19 last turn, M1 InvestAI Gigafactories finishes t7 +5, no capacity event, capability rose 3.0 −1 = 23
