...
- characters 374-1918: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1961-3987: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4043-4810: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4873-30184: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30539-31167: `{{event_history}}` from the run's own event record
...
- `emergent_grid_compute_curtailment` -- first noted turn 7, listed in 1 turn(s) so far: Municipal utilities and hospital networks impose rolling compute curtailments and data-centre connection moratoria after winter heating-vs-compute clashes, sparking local siting fights and court challenges.
...
- Turn 2 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident, emergent_datacentre_backlash
- Turn 3 (5 turn(s) ago): capability_jump, adoption_success
- Turn 4 (4 turn(s) ago): eval_anomaly_reports
- Turn 5 (3 turn(s) ago): capability_jump, rsi_onset, opaque_reasoning, openweight_frontier_release, joint_threat_response, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, embodied_ai_deployment, us_labs_nationalised, joint_threat_response, emergent_power_crunch
- Turn 7 (1 turn(s) ago): safety_breakthrough, joint_threat_response
