...
- characters 106-13345: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13388-13578: `{{metrics_json}}` from the run's live metric values
- characters 13671-15304: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15347-17229: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17285-17579: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Essential Services Continuity Patch | 2 |
...
PORTFOLIO CHARGE t9: M9 EU Bio Detection and Treatment Access Pact −2, priority M9 −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 7, sentiment 23 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, no category 4 in flight, capability rose 3.0 −1 = 19
