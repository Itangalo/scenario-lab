...
- characters 453-2086: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2129-4011: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4890-5366: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8015-9628: `{{previous_actions}}` from the actor's own response from the previous turn
