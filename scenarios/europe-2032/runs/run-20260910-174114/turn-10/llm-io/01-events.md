...
- characters 375-2008: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2051-3933: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3989-4283: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4346-30703: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31058-31892: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): cyber_major_incident, loss_of_control_incident, emergent_datacentre_backlash
- Turn 3 (7 turn(s) ago): capability_jump, adoption_success
- Turn 4 (6 turn(s) ago): eval_anomaly_reports
- Turn 5 (5 turn(s) ago): capability_jump, rsi_onset, opaque_reasoning, openweight_frontier_release, joint_threat_response, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, embodied_ai_deployment, us_labs_nationalised, joint_threat_response, emergent_power_crunch
- Turn 7 (3 turn(s) ago): safety_breakthrough, joint_threat_response
- Turn 8 (2 turn(s) ago): bio_uplift_findings, research_breakthrough, medical_breakthrough, export_control_escalation, joint_threat_response
- Turn 9 (1 turn(s) ago): medical_breakthrough, adoption_success
