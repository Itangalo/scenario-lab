...
- characters 376-1557: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1600-4010: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4066-5019: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5082-30952: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31307-31533: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, eval_anomaly_reports
- Turn 2 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, emergent_datacentre_backlash
- Turn 3 (1 turn(s) ago): capability_jump, adoption_success
