...
- characters 107-13008: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13051-13242: `{{metrics_json}}` from the run's live metric values
- characters 13335-16373: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16417-18952: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 19008-19483: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M12 | EU Accession to the US-China Risk Accord | 2 |
