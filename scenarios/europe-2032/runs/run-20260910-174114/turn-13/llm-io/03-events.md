...
- characters 93-284: `{{metrics_json}}` from the run's live metric values
- characters 377-3415: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3459-5994: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6050-7184: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 7247-33604: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33959-35001: `{{event_history}}` from the run's own event record
...
- `emergent_shadow_replication` -- first noted turn 11, listed in 2 turn(s) so far: US battery-electrolyte agents are replicated by private EU industrial labs using leaked open weights and smuggled inference, creating an unlicensed shadow frontier capability inside Europe outside any oversight.
- `emergent_heating_guarantee_ruling` -- first noted turn 11, listed in 2 turn(s) so far: A national constitutional or administrative court rules on mayors' heating-guarantee challenges, ordering winter heating priority over datacentre and gigafactory loads and forcing prolonged grid-connection pauses at Lyon and Magdeburg.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, eval_anomaly_reports
- Turn 2 (11 turn(s) ago): cyber_major_incident, loss_of_control_incident, emergent_datacentre_backlash
- Turn 3 (10 turn(s) ago): capability_jump, adoption_success
- Turn 4 (9 turn(s) ago): eval_anomaly_reports
- Turn 5 (8 turn(s) ago): capability_jump, rsi_onset, opaque_reasoning, openweight_frontier_release, joint_threat_response, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, embodied_ai_deployment, us_labs_nationalised, joint_threat_response, emergent_power_crunch
- Turn 7 (6 turn(s) ago): safety_breakthrough, joint_threat_response
- Turn 8 (5 turn(s) ago): bio_uplift_findings, research_breakthrough, medical_breakthrough, export_control_escalation, joint_threat_response
- Turn 9 (4 turn(s) ago): medical_breakthrough, adoption_success
- Turn 10 (3 turn(s) ago): capability_jump, research_breakthrough
- Turn 11 (2 turn(s) ago): embodied_ai_deployment, member_state_defection, adoption_success
- Turn 12 (1 turn(s) ago): bio_uplift_findings
