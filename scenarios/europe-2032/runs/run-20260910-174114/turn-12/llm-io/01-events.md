...
- characters 375-3253: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3296-5476: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5532-6622: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6685-33042: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33397-34391: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M10 EU Essential Services Continuity Patch −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 5, sentiment 18 -> +2
SOVEREIGNTY: 18 last turn, no category 4 finish or in-flight, embodied_ai_deployment t11 −2 (largest capacity event, member_state_defection also qualifies), capability rose 1.5 (below 2, no −1) = 16

## Emerging developments (tracked)

- `emergent_shadow_replication` -- first noted turn 11, listed in 1 turn(s) so far: US battery-electrolyte agents are replicated by private EU industrial labs using leaked open weights and smuggled inference, creating an unlicensed shadow frontier capability inside Europe outside any oversight.
- `emergent_heating_guarantee_ruling` -- first noted turn 11, listed in 1 turn(s) so far: A national constitutional or administrative court rules on mayors' heating-guarantee challenges, ordering winter heating priority over datacentre and gigafactory loads and forcing prolonged grid-connection pauses at Lyon and Magdeburg.
...
- Turn 2 (10 turn(s) ago): cyber_major_incident, loss_of_control_incident, emergent_datacentre_backlash
- Turn 3 (9 turn(s) ago): capability_jump, adoption_success
- Turn 4 (8 turn(s) ago): eval_anomaly_reports
- Turn 5 (7 turn(s) ago): capability_jump, rsi_onset, opaque_reasoning, openweight_frontier_release, joint_threat_response, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, embodied_ai_deployment, us_labs_nationalised, joint_threat_response, emergent_power_crunch
- Turn 7 (5 turn(s) ago): safety_breakthrough, joint_threat_response
- Turn 8 (4 turn(s) ago): bio_uplift_findings, research_breakthrough, medical_breakthrough, export_control_escalation, joint_threat_response
- Turn 9 (3 turn(s) ago): medical_breakthrough, adoption_success
- Turn 10 (2 turn(s) ago): capability_jump, research_breakthrough
- Turn 11 (1 turn(s) ago): embodied_ai_deployment, member_state_defection, adoption_success
...
```
[{"id": "cyber_major_incident", "probability": 0.19, "emergent": false, "description": ""}, {"id": "bio_incident", "probability": 0.09, "emergent": false, "description": ""}, {"id": "loss_of_control_incident", "probability": 0.08, "emergent": false, "description": ""}, {"id": "capability_jump", "probability": 0.1, "emergent": false, "description": ""}, {"id": "taiwan_blockade", "probability": 0.02, "emergent": false, "description": ""}, {"id": "ai_investment_collapse", "probability": 0.11, "emergent": false, "description": ""}, {"id": "cyber_defence_breakthrough", "probability": 0.08, "emergent": false, "description": ""}, {"id": "bio_uplift_findings", "probability": 0.21, "emergent": false, "description": ""}, {"id": "catastrophic_bio_incident", "probability": 0.03, "emergent": false, "description": ""}, {"id": "eval_anomaly_reports", "probability": 0.25, "emergent": false, "description": ""}, {"id": "research_breakthrough", "probability": 0.1, "emergent": false, "description": ""}, {"id": "medical_breakthrough", "probability": 0.18, "emergent": false, "description": ""}, {"id": "openweight_frontier_release", "probability": 0.1, "emergent": false, "description": ""}, {"id": "catastrophic_loss_of_control_incident", "probability": 0.02, "emergent": false, "description": ""}, {"id": "safety_breakthrough", "probability": 0.1, "emergent": false, "description": ""}, {"id": "labour_displacement", "probability": 0.16, "emergent": false, "description": ""}, {"id": "knowledge_work_augmented", "probability": 0.05, "emergent": false, "description": ""}, {"id": "embodied_ai_deployment", "probability": 0.16, "emergent": false, "description": ""}, {"id": "taiwan_tension_rise", "probability": 0.1, "emergent": false, "description": ""}, {"id": "catastrophic_great_power_conflict", "probability": 0.11, "emergent": false, "description": ""}, {"id": "export_control_escalation", "probability": 0.16, "emergent": false, "description": ""}, {"id": "us_china_agreement", "probability": 0.12, "emergent": false, "description": ""}, {"id": "eu_frontier_access_denied", "probability": 0.26, "emergent": false, "description": ""}, {"id": "supply_chain_coercion", "probability": 0.04, "emergent": false, "description": ""}, {"id": "member_state_defection", "probability": 0.09, "emergent": false, "description": ""}, {"id": "adoption_success", "probability": 0.1, "emergent": false, "description": ""}, {"id": "automated_decision_scandal", "probability": 0.06, "emergent": false, "description": ""}, {"id": "middle_power_coalition", "probability": 0.1, "emergent": false, "description": ""}, {"id": "emergent_shadow_replication", "probability": 0.22, "emergent": true, "description": "US battery-electrolyte agents are replicated by private EU industrial labs using leaked open weights and smuggled inference, creating an unlicensed shadow frontier capability inside Europe outside any oversight."}, {"id": "emergent_heating_guarantee_ruling", "probability": 0.25, "emergent": true, "description": "A national constitutional or administrative court rules on mayors' heating-guarantee challenges, ordering winter heating priority over datacentre and gigafactory loads and forcing prolonged grid-connection pauses at Lyon and Magdeburg."}]
```
