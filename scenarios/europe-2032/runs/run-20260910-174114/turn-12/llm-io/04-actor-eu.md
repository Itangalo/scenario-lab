...
- characters 453-3331: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3374-5554: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6128-6604: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9430-10700: `{{previous_actions}}` from the actor's own response from the previous turn
