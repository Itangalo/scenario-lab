...
- characters 13393-13583: `{{metrics_json}}` from the run's live metric values
- characters 13676-16554: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16597-18777: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18833-19923: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Bio Shield and Treatment Surge | 2 |
...
## Metrics
```json
{"ai_capability": 91.5, "openweight_capability": 87.8, "ai_safety": 0.0, "resilience": 52.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 12.0, "public_sentiment": 17.0}
```
