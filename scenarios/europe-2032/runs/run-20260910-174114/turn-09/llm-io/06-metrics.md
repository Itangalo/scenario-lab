...
- characters 13547-13737: `{{metrics_json}}` from the run's live metric values
- characters 13830-15585: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15629-17543: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17599-18141: `{{notepad}}` from the Game Master's notepad, carried across turns
