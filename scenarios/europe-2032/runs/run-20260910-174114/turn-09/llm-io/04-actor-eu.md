...
- characters 453-2208: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2252-4166: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4912-5362: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8162-10255: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Bio Detection and Treatment Access Pact | 6 | small | 8 | 10 | own jurisdiction | resilience up, public_sentiment up, ai_safety up slightly | 2 | running |
