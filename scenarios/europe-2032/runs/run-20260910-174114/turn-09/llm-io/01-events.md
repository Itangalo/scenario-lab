...
- characters 375-2130: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2174-4088: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4144-5019: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5082-31439: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31794-32563: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M7 EU Cohesion and Retraining Backstop −2, M8 EU Joint Shield Integration and Assured Deployment −2, M9 EU Bio Detection and Treatment Access Pact −2, priority M7 −1 = −7
PROPOSAL BONUS: EU Bio Detection and Treatment Access Pact (cat 6, small) +2 — bio uplift precursor fired this turn and this answers it directly with joint procurement
LEGITIMACY LENDS: capital 8, sentiment 19 -> +2
SOVEREIGNTY: 23 last turn, no category 4 finish, no category 4 in flight, export_control_escalation t8 −2, capability rose 3.0 −1 = 20

## Emerging developments (tracked)

- `emergent_grid_compute_curtailment` -- first noted turn 7, listed in 2 turn(s) so far: Municipal utilities and hospital networks impose rolling compute curtailments and data-centre connection moratoria after winter heating-vs-compute clashes, sparking local siting fights and court challenges.
...
- Turn 2 (7 turn(s) ago): cyber_major_incident, loss_of_control_incident, emergent_datacentre_backlash
- Turn 3 (6 turn(s) ago): capability_jump, adoption_success
- Turn 4 (5 turn(s) ago): eval_anomaly_reports
- Turn 5 (4 turn(s) ago): capability_jump, rsi_onset, opaque_reasoning, openweight_frontier_release, joint_threat_response, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, embodied_ai_deployment, us_labs_nationalised, joint_threat_response, emergent_power_crunch
- Turn 7 (2 turn(s) ago): safety_breakthrough, joint_threat_response
- Turn 8 (1 turn(s) ago): bio_uplift_findings, research_breakthrough, medical_breakthrough, export_control_escalation, joint_threat_response
