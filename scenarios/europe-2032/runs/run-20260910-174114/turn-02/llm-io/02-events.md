...
- characters 376-1610: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1653-3768: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3824-5587: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5650-27780: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28135-28198: `{{event_history}}` from the run's own event record
