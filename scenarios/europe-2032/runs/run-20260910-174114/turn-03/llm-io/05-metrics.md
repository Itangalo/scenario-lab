...
- characters 106-13118: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13161-13353: `{{metrics_json}}` from the run's live metric values
- characters 13446-14883: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14927-17103: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17159-18082: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | European Public Results AI Programme | 2 |
...
- `emergent_municipal_cyber_insurance_freeze` -- first noted turn 3, listed in 1 turn(s) so far: Several major EU insurers suspend or sharply reprice cyber and technology-errors coverage for municipalities and hospitals after the spring ransomware sweep, leaving local services unable to insure continued digitised operations through the winter.
