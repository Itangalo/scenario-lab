...
- characters 452-1832: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1875-4386: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6798-7248: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9556-12066: `{{previous_actions}}` from the actor's own response from the previous turn
