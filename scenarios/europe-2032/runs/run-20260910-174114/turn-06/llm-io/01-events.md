...
- characters 374-1754: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1797-4308: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4364-4825: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4888-29873: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30228-30648: `{{event_history}}` from the run's own event record
...
- Turn 2 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, emergent_datacentre_backlash
- Turn 3 (3 turn(s) ago): capability_jump, adoption_success
- Turn 4 (2 turn(s) ago): eval_anomaly_reports
- Turn 5 (1 turn(s) ago): capability_jump, rsi_onset, opaque_reasoning, openweight_frontier_release, joint_threat_response, election_consolidation
