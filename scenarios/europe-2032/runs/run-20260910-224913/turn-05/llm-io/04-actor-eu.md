...
- characters 1630-4087: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7175-7647: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9809-11879: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | European Chokepoint Compact | 8 | small | 4 | 6 | coalition (EU + Netherlands, with US as counterpart) | eu_ai_sovereignty up, eu_political_capital defended via bargained access | 2 | running |
