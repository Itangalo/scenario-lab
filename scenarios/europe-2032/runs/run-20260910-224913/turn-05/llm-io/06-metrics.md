...
- characters 13464-14595: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14639-17096: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17152-18316: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_dutch_bilateral_deal` -- first noted turn 5, listed in 1 turn(s) so far: The Hague signs a bilateral servicing-for-access understanding directly with Washington, pre-empting the Commission's single European offer and publicly demonstrating that the chokepoint bargain was struck without Brussels.
- `emergent_gigafactory_referendum_rejection` -- first noted turn 5, listed in 1 turn(s) so far: The spring referendum on the fourth gigafactory site rejects water and power concessions, forcing the Commission to restart site selection and delaying any final investment decision into 2029.
