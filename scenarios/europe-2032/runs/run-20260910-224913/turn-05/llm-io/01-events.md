...
- characters 1552-4009: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4065-4593: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4656-33141: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33496-33706: `{{event_history}}` from the run's own event record
...
- Turn 3 (2 turn(s) ago): eval_anomaly_reports, safety_breakthrough, knowledge_work_augmented
- Turn 4 (1 turn(s) ago): export_control_escalation, supply_chain_coercion
