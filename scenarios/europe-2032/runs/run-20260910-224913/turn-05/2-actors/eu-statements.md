...
- `two_year_commitment` (commitment): Hold sovereign capacity and societal resilience through AI disruption without depending on any single foreign power

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold sovereign capacity and societal resilience through AI disruption without depending on any single foreign power
