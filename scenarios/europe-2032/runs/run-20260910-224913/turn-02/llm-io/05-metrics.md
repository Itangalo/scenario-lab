...
- characters 105-13086: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13129-13321: `{{metrics_json}}` from the run's live metric values
- characters 13414-14604: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14647-16739: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16795-17856: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 50.0, "ai_safety": 30.0, "resilience": 38.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 31.0, "public_sentiment": 39.0}
```
