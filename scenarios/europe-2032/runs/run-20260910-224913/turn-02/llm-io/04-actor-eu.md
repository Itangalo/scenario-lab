...
- characters 3847-4319: `{{statement_ledger}}` from the actor's live statement ledger
- characters 5791-7918: `{{previous_actions}}` from the actor's own response from the previous turn
