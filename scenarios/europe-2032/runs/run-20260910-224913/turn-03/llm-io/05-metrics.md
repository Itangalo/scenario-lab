...
- characters 106-13136: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13179-13371: `{{metrics_json}}` from the run's live metric values
- characters 13464-14735: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14779-16483: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16539-17514: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Deployed-Systems Assurance Cell | 2 |
