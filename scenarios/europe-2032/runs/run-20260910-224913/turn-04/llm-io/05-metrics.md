...
- characters 13849-15132: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15175-17820: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17876-18390: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | European Chokepoint Compact | 2 |
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Deployed-Systems Assurance Cell −2, European Chokepoint Compact −2, priority −1 = −11
PROPOSAL BONUS: European Chokepoint Compact (cat 8, small) +2 — supply-chain coercion over ASML servicing fired this turn and this answers it directly, small size limits value
LEGITIMACY LENDS: capital 19, sentiment 40 -> +2
