...
| M11 | EU Degraded Operations Continuity Corps | 6 | small | 11 | 13 | own jurisdiction | resilience up moderately, eu_political_capital protected | 2 | finished |
| M12 | EU Loss-of-Control Containment and Certified Oversight Protocol | 6 | small | 12 | 14 | own jurisdiction | resilience up, ai_safety up modestly from breakthrough adoption | 2 | running |
| M13 | EU Major Cyber Incident Restoration and Degraded Services Hold | 6 | small | 13 | 15 | own jurisdiction | resilience up moderately, eu_political_capital protected | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Major Cyber Incident Restoration and Degraded Services Hold", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital protected"}, "grounds": "to answer major automated cyber incident on essential services"}
  - Grounds: to answer major automated cyber incident on essential services
