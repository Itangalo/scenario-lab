...
| M11 | EU Degraded Operations Continuity Corps | 6 | small | 11 | 13 | own jurisdiction | resilience up moderately, eu_political_capital protected | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Loss-of-Control Containment and Certified Oversight Protocol", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up modestly from breakthrough adoption"}, "grounds": "to answer loss-of-control incident with deployable assurance"}
  - Grounds: to answer loss-of-control incident with deployable assurance
