...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Degraded Operations Continuity Corps", "category": 6, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital protected"}, "grounds": "to succeed M9 and hold services under livelihoods commitment"}
  - Grounds: to succeed M9 and hold services under livelihoods commitment
