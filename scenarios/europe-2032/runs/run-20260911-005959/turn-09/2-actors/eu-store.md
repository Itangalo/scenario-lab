...
| M10 | EU Chips-for-Compute and Civic Liability Pact | 8 | small | 8 | 10 | coalition partners holding supply-chain chokepoints plus own jurisdiction | eu_ai_sovereignty up slightly via secured compute, resilience up slightly via restored civic deployments | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Civic AI Trust and Adoption Repair", "category": 9, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, resilience up slightly via restored civic deployments, eu_political_capital protected"}, "grounds": "to answer scandal plus insurer freeze with low capital"}
  - Grounds: to answer scandal plus insurer freeze with low capital
