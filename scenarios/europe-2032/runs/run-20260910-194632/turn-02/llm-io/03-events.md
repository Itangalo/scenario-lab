...
- characters 376-1681: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1724-4319: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4375-5787: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5850-28471: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28826-28891: `{{event_history}}` from the run's own event record
