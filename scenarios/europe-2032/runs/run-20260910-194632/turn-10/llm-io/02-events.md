...
- characters 1456-3324: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3380-3776: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3839-28837: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29192-29855: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): cyber_major_incident, adoption_success
- Turn 3 (7 turn(s) ago): openweight_frontier_release, joint_threat_response, emergent_lab_leak_fallout
- Turn 4 (6 turn(s) ago): joint_threat_response
- Turn 5 (5 turn(s) ago): supply_chain_coercion, member_state_defection, adoption_success, election_alliance
- Turn 6 (4 turn(s) ago): member_state_defection
- Turn 7 (3 turn(s) ago): taiwan_tension_rise, member_state_defection, automated_decision_scandal
- Turn 9 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, knowledge_work_augmented, emergent_grid_backlash_freeze
