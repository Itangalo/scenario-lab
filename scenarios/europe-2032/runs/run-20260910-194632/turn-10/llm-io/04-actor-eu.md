...
- characters 454-1491: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1534-3402: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4640-5084: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7914-10149: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Bio Detection and Health Shield Upgrade | 6 | small | 9 | 11 | own jurisdiction | resilience up, ai_safety up slightly via detection | 2 | running |
