...
- characters 106-12872: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12915-13106: `{{metrics_json}}` from the run's live metric values
- characters 13199-14236: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14279-16147: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16203-16933: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Bio Detection and Health Shield Upgrade | 2 |
| M10 | EU Anti-Coercion Supply-Chain Pact | 2 |
...
PORTFOLIO CHARGE t9: EU Bio Detection and Health Shield Upgrade −2, priority −1 = −3
PROPOSAL BONUS: EU Bio Detection and Health Shield Upgrade (cat 6, small) +2 — bio_uplift_findings fired this turn and this answers it directly, eval anomaly adds urgency
LEGITIMACY LENDS: capital 5, sentiment 29 -> +2
SOVEREIGNTY: 25 last turn, no capacity event, no cat4 in flight, capability rose 0.7 −0 = 25
