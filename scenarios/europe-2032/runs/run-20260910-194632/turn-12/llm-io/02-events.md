...
- characters 376-1764: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1807-3925: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3981-4316: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4379-30230: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30585-31492: `{{event_history}}` from the run's own event record
...
- Turn 2 (10 turn(s) ago): cyber_major_incident, adoption_success
- Turn 3 (9 turn(s) ago): openweight_frontier_release, joint_threat_response, emergent_lab_leak_fallout
- Turn 4 (8 turn(s) ago): joint_threat_response
- Turn 5 (7 turn(s) ago): supply_chain_coercion, member_state_defection, adoption_success, election_alliance
- Turn 6 (6 turn(s) ago): member_state_defection
- Turn 7 (5 turn(s) ago): taiwan_tension_rise, member_state_defection, automated_decision_scandal
- Turn 9 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, knowledge_work_augmented, emergent_grid_backlash_freeze
- Turn 10 (2 turn(s) ago): safety_breakthrough, export_control_escalation, supply_chain_coercion
- Turn 11 (1 turn(s) ago): capability_jump, eval_anomaly_reports, research_breakthrough, export_control_escalation, emergent_energy_price_revolt
