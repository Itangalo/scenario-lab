...
- characters 454-1842: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1885-4003: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5806-6250: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9110-10401: `{{previous_actions}}` from the actor's own response from the previous turn
