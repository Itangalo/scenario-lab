...
- characters 106-13238: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13281-13472: `{{metrics_json}}` from the run's live metric values
- characters 13565-14953: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14996-17114: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17170-17887: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Community Resilience and Bio-Cyber Continuity Corps | 2 |
