...
- characters 107-12905: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12948-13139: `{{metrics_json}}` from the run's live metric values
- characters 13232-14681: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14725-16811: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16867-17751: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M12 | EU Verification Bridge to the US-China AI Risk Accord | 2 |
