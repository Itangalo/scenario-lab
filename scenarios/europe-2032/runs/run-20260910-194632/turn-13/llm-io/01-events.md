...
- characters 377-1826: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1870-3956: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4012-4896: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4959-30810: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31165-32198: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Community Resilience and Bio-Cyber Continuity Corps −2, priority ineffective (capital below 20) = −2
PROPOSAL BONUS: EU Community Resilience and Bio-Cyber Continuity Corps (cat 6, small) +3 — bio uplift precursor this turn plus municipal power revolt ongoing, answers directly
LEGITIMACY LENDS: capital 9, sentiment 22.0 -> +2, capped below sentiment
SOVEREIGNTY: 19 last turn, no cat4 finish, no cat4 in flight, export_control_escalation t12 −2, capability rose 0.8 no −1 = 17

## Emerging developments (tracked)

- `emergent_court_strikes_mayor_freeze` -- first noted turn 12, listed in 1 turn(s) so far: A national court or the CJEU suspends municipal data-centre surcharges and building moratoria as disproportionate restrictions on the internal market, turning the revolt of mayors into a direct legal confrontation over EU energy and digital competence.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, ai_investment_collapse
- Turn 2 (11 turn(s) ago): cyber_major_incident, adoption_success
- Turn 3 (10 turn(s) ago): openweight_frontier_release, joint_threat_response, emergent_lab_leak_fallout
- Turn 4 (9 turn(s) ago): joint_threat_response
- Turn 5 (8 turn(s) ago): supply_chain_coercion, member_state_defection, adoption_success, election_alliance
- Turn 6 (7 turn(s) ago): member_state_defection
- Turn 7 (6 turn(s) ago): taiwan_tension_rise, member_state_defection, automated_decision_scandal
- Turn 9 (4 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, knowledge_work_augmented, emergent_grid_backlash_freeze
- Turn 10 (3 turn(s) ago): safety_breakthrough, export_control_escalation, supply_chain_coercion
- Turn 11 (2 turn(s) ago): capability_jump, eval_anomaly_reports, research_breakthrough, export_control_escalation, emergent_energy_price_revolt
- Turn 12 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, export_control_escalation
