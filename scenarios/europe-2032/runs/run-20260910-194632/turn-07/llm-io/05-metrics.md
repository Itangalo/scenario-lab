...
- characters 13562-14471: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14515-16456: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16512-17134: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M6 | EU Care and City Shield Extension | 2 |
| M7 | EU Automated Decisions Redress and Moratorium | 2 |
...
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, EU Care and City Shield Extension −2, priority −1 = −6
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 14, sentiment 33 -> +2
SOVEREIGNTY: 20 last turn, Tech sovereignty package finishes t6 +5, Gigafactories in flight +0, member_state_defection t6 −2, capability rose 1.5 −0 = 23

## Emerging developments (tracked)

- `emergent_grid_backlash_freeze` -- first noted turn 7, listed in 1 turn(s) so far: Municipal power-price protests force a temporary moratorium on two EU data-centre zones, delaying gigafactory grid connections by months.
