...
- characters 1329-3270: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3326-3688: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3751-28146: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28501-28941: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): cyber_major_incident, adoption_success
- Turn 3 (4 turn(s) ago): openweight_frontier_release, joint_threat_response, emergent_lab_leak_fallout
- Turn 4 (3 turn(s) ago): joint_threat_response
- Turn 5 (2 turn(s) ago): supply_chain_coercion, member_state_defection, adoption_success, election_alliance
