...
- characters 454-1518: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1562-3309: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5112-5575: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8094-10064: `{{previous_actions}}` from the actor's own response from the previous turn
