...
- characters 106-13262: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13305-13496: `{{metrics_json}}` from the run's live metric values
- characters 13589-14653: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14697-16444: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16500-16825: `{{notepad}}` from the Game Master's notepad, carried across turns
