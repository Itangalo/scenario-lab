...
- characters 376-1440: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1484-3231: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3287-3872: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3935-28330: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28685-29223: `{{event_history}}` from the run's own event record
...
- Turn 2 (7 turn(s) ago): cyber_major_incident, adoption_success
- Turn 3 (6 turn(s) ago): openweight_frontier_release, joint_threat_response, emergent_lab_leak_fallout
- Turn 4 (5 turn(s) ago): joint_threat_response
- Turn 5 (4 turn(s) ago): supply_chain_coercion, member_state_defection, adoption_success, election_alliance
- Turn 6 (3 turn(s) ago): member_state_defection
- Turn 7 (2 turn(s) ago): taiwan_tension_rise, member_state_defection, automated_decision_scandal
