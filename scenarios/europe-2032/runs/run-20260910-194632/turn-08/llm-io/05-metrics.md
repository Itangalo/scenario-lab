...
- characters 13448-13639: `{{metrics_json}}` from the run's live metric values
- characters 13732-14551: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14594-16422: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16478-17227: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Transition Safety Net for AI-Displaced Workers | 2 |
...
PORTFOLIO CHARGE t7: EU Care and City Shield Extension −2, EU Automated Decisions Redress and Moratorium −2, priority −1 = −5
PROPOSAL BONUS: EU Automated Decisions Redress and Moratorium (cat 3, small) +3 — automated_decision_scandal fired this turn and this answers it directly, plus member_state_defection pressure
LEGITIMACY LENDS: capital 1, sentiment 28 -> +2
SOVEREIGNTY: 23 last turn, InvestAI Gigafactories finishes t7 +4, member_state_defection t7 −2, capability rose 0.7 −0 = 25

## Emerging developments (tracked)

- `emergent_grid_backlash_freeze` -- first noted turn 7, listed in 2 turn(s) so far: Municipal power-price protests force a temporary moratorium on two EU data-centre zones, delaying gigafactory grid connections by months.
...
## Notepad
PORTFOLIO CHARGE t8: EU Transition Safety Net for AI-Displaced Workers −2, priority −1 = −3
PROPOSAL BONUS: none — no event in last three turns that this cat 7 measure directly answers
LEGITIMACY LENDS: capital 6, sentiment 22 -> +2
SOVEREIGNTY: 25 last turn, no capacity event, no cat4 in flight, capability rose 0.6 −0 = 25
