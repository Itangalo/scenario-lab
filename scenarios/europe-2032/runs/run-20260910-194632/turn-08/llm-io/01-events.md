...
- characters 375-1194: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1237-3065: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3121-3870: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3933-28328: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28683-29221: `{{event_history}}` from the run's own event record
...
- Turn 2 (6 turn(s) ago): cyber_major_incident, adoption_success
- Turn 3 (5 turn(s) ago): openweight_frontier_release, joint_threat_response, emergent_lab_leak_fallout
- Turn 4 (4 turn(s) ago): joint_threat_response
- Turn 5 (3 turn(s) ago): supply_chain_coercion, member_state_defection, adoption_success, election_alliance
- Turn 6 (2 turn(s) ago): member_state_defection
- Turn 7 (1 turn(s) ago): taiwan_tension_rise, member_state_defection, automated_decision_scandal
