...
- characters 1996-4169: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4225-5412: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5475-28096: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28451-28581: `{{event_history}}` from the run's own event record
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, ai_investment_collapse
- Turn 2 (1 turn(s) ago): cyber_major_incident, adoption_success
