...
- characters 106-13298: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13341-13533: `{{metrics_json}}` from the run's live metric values
- characters 13626-15201: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15245-17418: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17474-18012: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | Trusted Public Services AI Scale-up | 2 |
| M5 | EU Model Incident Disclosure and Joint Telemetry Membership | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, Trusted Public Services AI Scale-up −2, priority −1 = −12
PROPOSAL BONUS: Trusted Public Services AI Scale-up (cat 9, small) +3 — adoption_success landed this turn with visible waiting-list benefit attributable to European decision and this locks it in directly
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 50.5, "ai_safety": 28.0, "resilience": 43.0, "eu_ai_sovereignty": 22.0, "eu_political_capital": 29.0, "public_sentiment": 32.0}
```
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, Trusted Public Services AI Scale-up −2, EU Model Incident Disclosure and Joint Telemetry Membership −2, priority −1 = −11
PROPOSAL BONUS: EU Model Incident Disclosure and Joint Telemetry Membership (cat 2, small) +4 — leaked covert-coordination memos landed this turn triggering hearings plus open-weight jump, this answers both directly
LEGITIMACY LENDS: capital 28, sentiment 32 -> +1
SOVEREIGNTY: 22 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 22
