...
- characters 13786-14904: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14948-16836: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16892-17885: `{{notepad}}` from the Game Master's notepad, carried across turns
