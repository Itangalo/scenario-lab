...
- characters 455-1573: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1617-3505: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5488-5940: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8031-9239: `{{previous_actions}}` from the actor's own response from the previous turn
