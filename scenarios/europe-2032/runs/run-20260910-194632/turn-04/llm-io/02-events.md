...
- characters 1424-3307: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3363-3928: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3991-26612: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26967-27201: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): cyber_major_incident, adoption_success
- Turn 3 (1 turn(s) ago): openweight_frontier_release, joint_threat_response, emergent_lab_leak_fallout
