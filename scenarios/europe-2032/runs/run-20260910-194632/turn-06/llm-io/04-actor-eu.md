...
- characters 454-1729: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1772-4297: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4677-5140: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7384-9893: `{{previous_actions}}` from the actor's own response from the previous turn
