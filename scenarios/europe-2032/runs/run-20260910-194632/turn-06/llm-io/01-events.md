...
- characters 376-1651: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1694-4219: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4275-5390: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5453-26738: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27093-27484: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Care and City Shield Extension −2, priority −1 = −9
PROPOSAL BONUS: none — new cat-6 extension answers tracked municipal-health pressure and permit backlash, not a fired event in last three turns
LEGITIMACY LENDS: capital 12, sentiment 33 -> +2
SOVEREIGNTY: 22 last turn, no capacity measure finishes, Gigafactories in flight +0, supply_chain_coercion t5 −2 (largest of two takeaways, member_state_defection also fires), capability rose 1.5 −0 = 20

## Emerging developments (tracked)

- `emergent_municipal_health_ransomware` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated municipal ransomware wave using the autumn open model hits hospitals and city halls left outside the Shield, forcing emergency EU-level triage funding.
- `emergent_datacentre_permit_backlash` -- first noted turn 4, listed in 2 turn(s) so far: A coordinated wave of physical protests and permit challenges blocks several EU data-centre and grid-connection approvals, citing power prices and AI fraud fears, delaying capacity expansion for months.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, ai_investment_collapse
- Turn 2 (4 turn(s) ago): cyber_major_incident, adoption_success
- Turn 3 (3 turn(s) ago): openweight_frontier_release, joint_threat_response, emergent_lab_leak_fallout
- Turn 4 (2 turn(s) ago): joint_threat_response
- Turn 5 (1 turn(s) ago): supply_chain_coercion, member_state_defection, adoption_success, election_alliance
