...
- characters 377-1435: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1479-3576: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3632-4494: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4557-29555: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29910-30671: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Bio Detection and Health Shield Upgrade −2, EU Anti-Coercion Supply-Chain Pact −2, priority ineffective (capital below 20) = −4
PROPOSAL BONUS: EU Anti-Coercion Supply-Chain Pact (cat 8, small) +3 — supply_chain_coercion and export_control_escalation fired this turn and this answers coercion directly
LEGITIMACY LENDS: capital 5, sentiment 23.5 -> +2 (capped below sentiment)
SOVEREIGNTY: 25 last turn, no capacity build finishing or in flight, supply_chain_coercion t10 −3, capability rose 0.7 −0 = 22

## Emerging developments (tracked)

- `emergent_energy_price_revolt` -- first noted turn 10, listed in 1 turn(s) so far: A coordinated municipal utility revolt spreads beyond the two frozen data-centre zones, with several city councils imposing punitive power surcharges and moratoria that stall private grid upgrades across the EU.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, ai_investment_collapse
- Turn 2 (9 turn(s) ago): cyber_major_incident, adoption_success
- Turn 3 (8 turn(s) ago): openweight_frontier_release, joint_threat_response, emergent_lab_leak_fallout
- Turn 4 (7 turn(s) ago): joint_threat_response
- Turn 5 (6 turn(s) ago): supply_chain_coercion, member_state_defection, adoption_success, election_alliance
- Turn 6 (5 turn(s) ago): member_state_defection
- Turn 7 (4 turn(s) ago): taiwan_tension_rise, member_state_defection, automated_decision_scandal
- Turn 9 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, knowledge_work_augmented, emergent_grid_backlash_freeze
- Turn 10 (1 turn(s) ago): safety_breakthrough, export_control_escalation, supply_chain_coercion
