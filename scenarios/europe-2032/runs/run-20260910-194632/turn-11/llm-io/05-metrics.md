...
- characters 107-13198: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13241-13432: `{{metrics_json}}` from the run's live metric values
- characters 13525-14583: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14627-16724: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16780-17308: `{{notepad}}` from the Game Master's notepad, carried across turns
