...
- characters 454-2631: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2675-4860: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7415-7887: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10199-12214: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | European Public Sector AI Scale-Up | 9 | small | 4 | 7 | own jurisdiction | public_sentiment up, eu_political_capital up, resilience up modestly via service capacity | 2 | running |
...
| M4 | EU Assurance Adoption Hub | 5 | small | 2 | 5 | own jurisdiction | ai_safety up, eu_ai_sovereignty up indirectly via evaluation leverage | 2 | finished |
