...
- characters 13454-13645: `{{metrics_json}}` from the run's live metric values
- characters 13738-15915: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15959-18144: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18200-19050: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_grid_siting_backlash` -- first noted turn 5, listed in 1 turn(s) so far: A regional grid operator publicly blames EU priority-connection rules for delayed industrial connections, triggering coordinated municipal lawsuits over power pricing and siting.
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Transition Cushion −2, European Public Sector AI Scale-Up −2 = −10 plus priority −1 not charged (capital below 20, priority has no effect)
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 9, sentiment 41 -> +2
