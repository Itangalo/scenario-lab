...
- characters 376-2553: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2597-4782: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4838-5387: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5450-28071: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28426-28696: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough
- Turn 3 (2 turn(s) ago): ai_investment_collapse, emergent_hyperscaler_pause_eu_build
- Turn 4 (1 turn(s) ago): knowledge_work_augmented, adoption_success
