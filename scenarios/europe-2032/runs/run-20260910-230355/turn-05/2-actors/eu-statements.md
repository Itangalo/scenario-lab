...
- `two_year_commitment` (commitment): Harden society and retain bargaining leverage while the frontier is foreign-controlled

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Harden society and retain bargaining leverage while the frontier is foreign-controlled
