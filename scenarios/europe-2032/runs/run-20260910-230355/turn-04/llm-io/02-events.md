...
- characters 2221-4239: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4295-5372: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5435-28056: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28411-28612: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough
- Turn 3 (1 turn(s) ago): ai_investment_collapse, emergent_hyperscaler_pause_eu_build
