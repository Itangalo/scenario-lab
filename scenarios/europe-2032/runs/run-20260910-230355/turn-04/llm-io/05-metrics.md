...
- characters 13781-15583: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15626-17644: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17700-18454: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | European Public Sector AI Scale-Up | 2 |
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Assurance Adoption Hub −2, EU AI Transition Cushion −2, European Public Sector AI Scale-Up −2 = −12 plus priority −1 not charged (capital below 20, priority has no effect)
PROPOSAL BONUS: none — new Scale-Up (cat 9, small) answers positive adoption/productivity developments, not a negative event from last three rounds
LEGITIMACY LENDS: capital 7, sentiment 41 -> +2
