...
- characters 106-13061: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13104-13296: `{{metrics_json}}` from the run's live metric values
- characters 13389-14705: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14749-16626: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16682-17491: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Assurance Adoption Hub | 2 |
| M5 | EU AI Transition Cushion | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, EU Assurance Adoption Hub −2, priority −1 = −12
PROPOSAL BONUS: EU Assurance Adoption Hub (cat 5, small) +2 — safety_breakthrough landed this turn and this answers it directly by institutionalising adoption
LEGITIMACY LENDS: none — capital 41, sentiment 39, capital is higher
SOVEREIGNTY: 22 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 22

## Emerging developments (tracked)

- `emergent_gigafactory_siting_backlash` -- first noted turn 2, listed in 2 turn(s) so far: Coordinated local opposition and municipal permitting challenges stall at least one gigafactory shortlisted site over grid priority and power prices, forcing site renegotiation within the turn.
