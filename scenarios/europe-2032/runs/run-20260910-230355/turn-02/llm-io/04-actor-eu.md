...
- characters 4381-4853: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6325-8452: `{{previous_actions}}` from the actor's own response from the previous turn
