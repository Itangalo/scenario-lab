...
- characters 376-2214: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2257-4121: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4177-4951: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5014-28150: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28505-29357: `{{event_history}}` from the run's own event record
...
- `emergent_grid_backlash_sabotage` -- first noted turn 10, listed in 2 turn(s) so far: Coordinated physical sabotage and grid-connection blockades halt several EU data-centre and gigafactory-shell sites, with councils suspending permits pending safety reviews.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, member_state_defection
- Turn 2 (10 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 3 (9 turn(s) ago): export_control_escalation
- Turn 4 (8 turn(s) ago): eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 5 (7 turn(s) ago): bio_incident, labour_displacement, election_consolidation
- Turn 6 (6 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, supply_chain_coercion
- Turn 7 (5 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough
- Turn 8 (4 turn(s) ago): bio_uplift_findings, taiwan_tension_rise
- Turn 9 (3 turn(s) ago): labour_displacement
- Turn 10 (2 turn(s) ago): eu_frontier_access_denied, supply_chain_coercion
- Turn 11 (1 turn(s) ago): loss_of_control_incident, export_control_escalation, adoption_success
