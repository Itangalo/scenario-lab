...
- characters 106-13141: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13184-13375: `{{metrics_json}}` from the run's live metric values
- characters 13468-15306: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15349-17213: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17269-17744: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t11: EU Cutoff Survival and Chokepoint Defence −2, priority −0 (suspended, capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2, sentiment 10 -> +1 (capped, included in capital arithmetic: 3-2+3+2-5+1=2)
SOVEREIGNTY: 17 last turn, no capacity build finishes, no capacity build in flight +0, export_control_escalation t11 −3 (capacity access taken away, largest qualifier), capability rose 0.7 no −1 = 14
...
## Metrics
```json
{"ai_capability": 64.8, "openweight_capability": 64.0, "ai_safety": 9.0, "resilience": 44.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 9.0, "public_sentiment": 10.0}
```
## Narrative
