...
- characters 455-2118: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2162-4307: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5785-6256: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8473-10654: `{{previous_actions}}` from the actor's own response from the previous turn
