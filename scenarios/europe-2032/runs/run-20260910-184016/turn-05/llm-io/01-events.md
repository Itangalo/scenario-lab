...
- characters 377-2040: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2084-4229: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4285-5180: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5243-28077: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28432-28721: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, member_state_defection
- Turn 2 (3 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 3 (2 turn(s) ago): export_control_escalation
- Turn 4 (1 turn(s) ago): eu_frontier_access_denied, member_state_defection, adoption_success
