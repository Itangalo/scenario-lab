...
- characters 376-1316: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1360-3418: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3474-3803: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3866-26341: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26696-27651: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, member_state_defection
- Turn 2 (11 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 3 (10 turn(s) ago): export_control_escalation
- Turn 4 (9 turn(s) ago): eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 5 (8 turn(s) ago): bio_incident, labour_displacement, election_consolidation
- Turn 6 (7 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, supply_chain_coercion
- Turn 7 (6 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough
- Turn 8 (5 turn(s) ago): bio_uplift_findings, taiwan_tension_rise
- Turn 9 (4 turn(s) ago): labour_displacement
- Turn 10 (3 turn(s) ago): eu_frontier_access_denied, supply_chain_coercion
- Turn 11 (2 turn(s) ago): loss_of_control_incident, export_control_escalation, adoption_success
- Turn 12 (1 turn(s) ago): ai_investment_collapse, research_breakthrough, openweight_frontier_release
