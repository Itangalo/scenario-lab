...
- characters 454-1574: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1617-3512: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4481-4992: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8050-10453: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Entry-Level Transition Guarantee | 7 | small | 9 | 11 | own jurisdiction | resilience up, eu_political_capital stabilise, public_sentiment up slightly | 2 | running |
