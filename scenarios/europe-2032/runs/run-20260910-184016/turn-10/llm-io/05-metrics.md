...
- characters 106-13246: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13289-13480: `{{metrics_json}}` from the run's live metric values
- characters 13573-14693: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14736-16631: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16687-17442: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Entry-Level Transition Guarantee | 2 |
| M12 | EU Cutoff Survival and Chokepoint Defence | 2 |
