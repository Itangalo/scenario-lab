...
- characters 1539-3434: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3490-3946: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4009-27145: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27500-28177: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Bio Synthesis Screening Lockdown −2, EU Entry-Level Transition Guarantee −2, priority −0 (suspended, capital below 20) = −4
PROPOSAL BONUS: EU Entry-Level Transition Guarantee (cat 7, small) +3 — labour_displacement fired this turn and this answers it directly, small size limits value
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, member_state_defection
- Turn 2 (8 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 3 (7 turn(s) ago): export_control_escalation
- Turn 4 (6 turn(s) ago): eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 5 (5 turn(s) ago): bio_incident, labour_displacement, election_consolidation
- Turn 6 (4 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, supply_chain_coercion
- Turn 7 (3 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough
- Turn 8 (2 turn(s) ago): bio_uplift_findings, taiwan_tension_rise
