...
- characters 13555-15111: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15155-17331: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17387-18352: `{{notepad}}` from the Game Master's notepad, carried across turns
