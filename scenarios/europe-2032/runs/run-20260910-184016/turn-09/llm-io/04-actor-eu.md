...
- characters 454-2103: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2147-4156: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4534-5035: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7914-10021: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Bio Synthesis Screening Lockdown | 3 | small | 8 | 10 | own jurisdiction | ai_safety up slightly, resilience stabilise | 2 | running |
