...
- characters 13480-13671: `{{metrics_json}}` from the run's live metric values
- characters 13764-15413: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15457-17466: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17522-18019: `{{notepad}}` from the Game Master's notepad, carried across turns
