...
- characters 376-2025: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2069-4078: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4134-4930: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4993-28129: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28484-29115: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, member_state_defection
- Turn 2 (7 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 3 (6 turn(s) ago): export_control_escalation
- Turn 4 (5 turn(s) ago): eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 5 (4 turn(s) ago): bio_incident, labour_displacement, election_consolidation
- Turn 6 (3 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, supply_chain_coercion
- Turn 7 (2 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough
- Turn 8 (1 turn(s) ago): bio_uplift_findings, taiwan_tension_rise
