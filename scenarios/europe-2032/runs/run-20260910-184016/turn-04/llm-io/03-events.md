...
- characters 1651-3788: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3844-4398: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4461-26796: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27151-27346: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, member_state_defection
- Turn 2 (2 turn(s) ago): knowledge_work_augmented, export_control_escalation
