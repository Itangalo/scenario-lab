...
- characters 105-13321: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13364-13556: `{{metrics_json}}` from the run's live metric values
- characters 13649-14881: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14924-17061: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17117-18008: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Supply-Chain Compact | 2 |
| M5 | EU Frontier Evaluation Cell | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Shield −2, EU Supply-Chain Compact −2, EU Frontier Evaluation Cell −2, priority −1 = −13
PROPOSAL BONUS: EU Frontier Evaluation Cell (cat 5, small) +1 — open parity and undetected agent coordination from prior turns, this answers it indirectly
LEGITIMACY LENDS: capital 22, sentiment 37 -> +2
SOVEREIGNTY: 20 last turn, no capacity event finish, Gigafactories/tech package in flight +1, export_control_escalation t3 −2, capability rose 1.5 no −1 = 19

## Emerging developments (tracked)

- `emergent_inference_price_squeeze` -- first noted turn 4, listed in 1 turn(s) so far: Major US hyperscalers impose steep inference price and quota changes on European enterprise customers citing export-compliance costs and capacity constraints, forcing hospitals and ministries to throttle AI use.
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 54.5, "ai_safety": 26.0, "resilience": 40.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 16.0, "public_sentiment": 35.0}
```
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Supply-Chain Compact −2, EU Frontier Evaluation Cell −2, EU Continuity Stack −2, priority −1 = −13
PROPOSAL BONUS: EU Continuity Stack (cat 9, small) +3 — frontier denial this turn turns dependence into service failure and this answers it directly, adoption win as demonstrator
LEGITIMACY LENDS: capital 24, sentiment 37 -> +2
SOVEREIGNTY: 19 last turn, no capacity finish, Gigafactories/tech package in flight +1, eu_frontier_access_denied t4 −2, capability rose 1.5 no −1 = 18
