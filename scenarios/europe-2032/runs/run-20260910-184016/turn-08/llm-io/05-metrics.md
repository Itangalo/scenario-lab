...
- characters 105-12916: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12959-13151: `{{metrics_json}}` from the run's live metric values
- characters 13244-14948: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14991-17617: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17673-18444: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Chokepoint Bargain and Scarcity Pact | 2 |
| M9 | EU Cyber Absorb and Patch Surge | 2 |
| M10 | EU Bio Synthesis Screening Lockdown | 2 |
...
- `emergent_grid_connection_revolt` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated municipal bans on new data-centre grid connections spread across several member states amid scarcity and job-loss protests, freezing EU-hosted capacity expansion.
...
## Metrics
```json
{"ai_capability": 62.0, "openweight_capability": 60.5, "ai_safety": 17.0, "resilience": 44.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 7.0, "public_sentiment": 21.0}
```
...
## Notepad
PORTFOLIO CHARGE t8: EU Chokepoint Bargain and Scarcity Pact −2, EU Cyber Absorb and Patch Surge −2, EU Bio Synthesis Screening Lockdown −2, priority −0 (suspended, capital below 20) = −6
PROPOSAL BONUS: EU Bio Synthesis Screening Lockdown (cat 3, small) +2 — bio_uplift_findings fired this turn and this answers it directly, small size limits value
LEGITIMACY LENDS: capital 13, sentiment 22 -> +1
SOVEREIGNTY: 20 last turn, no capacity event, no cat4 in flight +0, capability rose 0.7 no −1 = 20
