...
- characters 376-2080: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2123-4749: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4805-5576: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5639-28172: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28527-29091: `{{event_history}}` from the run's own event record
...
- `emergent_grid_connection_revolt` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated municipal bans on new data-centre grid connections spread across several member states amid scarcity and job-loss protests, freezing EU-hosted capacity expansion.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, member_state_defection
- Turn 2 (6 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 3 (5 turn(s) ago): export_control_escalation
- Turn 4 (4 turn(s) ago): eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 5 (3 turn(s) ago): bio_incident, labour_displacement, election_consolidation
- Turn 6 (2 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, supply_chain_coercion
- Turn 7 (1 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough
