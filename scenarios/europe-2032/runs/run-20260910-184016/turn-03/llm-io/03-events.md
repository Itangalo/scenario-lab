...
- characters 377-1587: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1631-3636: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3692-4736: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4799-27134: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27489-27632: `{{event_history}}` from the run's own event record
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, member_state_defection
- Turn 2 (1 turn(s) ago): knowledge_work_augmented, export_control_escalation
