...
- characters 106-12965: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13008-13200: `{{metrics_json}}` from the run's live metric values
- characters 13293-14503: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14547-16552: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16608-17093: `{{notepad}}` from the Game Master's notepad, carried across turns
