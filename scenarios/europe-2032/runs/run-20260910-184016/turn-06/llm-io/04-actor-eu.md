...
- characters 1727-3751: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5572-6035: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8420-10850: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Bio Detection and Care Shield | 6 | small | 5 | 7 | own jurisdiction | resilience up, ai_safety up slightly, eu_political_capital stabilise | 2 | running |
