...
- characters 105-13458: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13501-13693: `{{metrics_json}}` from the run's live metric values
- characters 13786-15016: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15059-17083: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17139-17642: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 winner was consolidation, takes effect turn 6"}]}
```
```
