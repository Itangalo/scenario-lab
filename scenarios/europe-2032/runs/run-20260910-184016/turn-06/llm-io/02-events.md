...
- characters 1649-3673: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3729-4569: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4632-24773: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 25128-25501: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Evaluation Cell −2, EU Bio Detection and Care Shield −2, priority −1 = −11
PROPOSAL BONUS: EU Bio Detection and Care Shield (cat 6, small) +5 — bio_incident with real casualties this turn and this answers it directly, containment and care response
LEGITIMACY LENDS: capital 13, sentiment 28 -> +2
SOVEREIGNTY: 18 last turn, no capacity event, Gigafactories/tech package in flight +1, capability rose 1.5 no −1 = 19

## Emerging developments (tracked)

- `emergent_inference_price_squeeze` -- first noted turn 4, listed in 2 turn(s) so far: Major US hyperscalers impose steep inference price and quota changes on European enterprise customers citing export-compliance costs and capacity constraints, forcing hospitals and ministries to throttle AI use.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, member_state_defection
- Turn 2 (4 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 3 (3 turn(s) ago): export_control_escalation
- Turn 4 (2 turn(s) ago): eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 5 (1 turn(s) ago): bio_incident, labour_displacement, election_consolidation
