...
- characters 377-1388: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1432-3470: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3526-4068: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4131-26664: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27019-27508: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, member_state_defection
- Turn 2 (5 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 3 (4 turn(s) ago): export_control_escalation
- Turn 4 (3 turn(s) ago): eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 5 (2 turn(s) ago): bio_incident, labour_displacement, election_consolidation
- Turn 6 (1 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, supply_chain_coercion
