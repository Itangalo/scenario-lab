...
- characters 455-1466: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1510-3548: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4400-4901: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7467-10420: `{{previous_actions}}` from the actor's own response from the previous turn
