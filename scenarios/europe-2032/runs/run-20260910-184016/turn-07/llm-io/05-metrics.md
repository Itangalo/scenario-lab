...
- characters 106-13399: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13442-13634: `{{metrics_json}}` from the run's live metric values
- characters 13727-14738: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14782-16820: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16876-17717: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.3, "openweight_capability": 59.7, "ai_safety": 19.0, "resilience": 45.0, "eu_ai_sovereignty": 26.0, "eu_political_capital": 20.0, "public_sentiment": 22.0}
```
