...
- characters 105-13620: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13663-13855: `{{metrics_json}}` from the run's live metric values
- characters 13948-15189: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15232-17557: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17613-17989: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Agent Containment and Essential-Service Continuity Order | 2 |
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, European Trusted Deployment Scale-up −2, priority −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 15, sentiment 41 -> +2
SOVEREIGNTY: 18 last turn, no capacity event finishes, M1/M2 in flight +0, export_control_escalation t5 −2, capability rose 3.0 −1 = 15
...
**emergent_datacentre_siting_backlash (emergent event):** A coordinated protest and legal blockade against new data-centre grid connections in two member states delays contracted compute expansion for six months, cited by opponents as proof of foreign-model energy costs.
...
## Notepad
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, EU Agent Containment and Essential-Service Continuity Order −2, priority −1 = −6
PROPOSAL BONUS: Containment Order (cat 6, small) +3 — loss-of-control with days-long containment plus RSI onset last turn and this answers it directly
LEGITIMACY LENDS: capital 12, sentiment 33.5 -> +2
SOVEREIGNTY: 15 last turn, Tech sovereignty package finishes t6 +4, M1 in flight +0, emergent_datacentre_siting_backlash t6 −2, capability rose 8.0 −1 = 16
## Store changes
```json
