...
- characters 1738-4063: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6267-6698: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9031-10503: `{{previous_actions}}` from the actor's own response from the previous turn
