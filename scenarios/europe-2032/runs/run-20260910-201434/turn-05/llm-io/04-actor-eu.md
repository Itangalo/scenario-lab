...
- characters 455-1474: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1518-3318: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5056-5514: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7845-9757: `{{previous_actions}}` from the actor's own response from the previous turn
