...
- characters 13914-14933: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14977-16777: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16833-17978: `{{notepad}}` from the Game Master's notepad, carried across turns
