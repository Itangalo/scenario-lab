...
- characters 377-1544: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1588-3704: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3760-4922: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4985-28561: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28916-29021: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Cyber Shield −3, EU Assurance Adoption Cell −2, priority −1 = −12
PROPOSAL BONUS: EU Assurance Adoption Cell (cat 5, small) +2 — autumn intrusion across grids/port/water in last 3 turns and this answers assurance gap directly, small size limits gain
LEGITIMACY LENDS: capital 33, sentiment 41 -> +2
SOVEREIGNTY: 21 last turn, no capacity event, Gigafactories/tech package in flight +0, capability rose 3.0 −1 = 20

## Emerging developments (tracked)

- `emergent_eu_eval_consortium` -- first noted turn 1, listed in 2 turn(s) so far: Major European research universities and CNRS/Max Planck institutes announce a joint open evaluation consortium publishing independent red-team results on Kimi K3 and Mythos-class models, forcing public debate on open-weight risk.
- `emergent_open_science_compute_call` -- first noted turn 1, listed in 2 turn(s) so far: Major European research universities and open-science institutes publish a joint call for a compute-sharing pool for safety and evaluation research, attracting press coverage and parliamentary questions.
...
- Turn 2 (1 turn(s) ago): safety_breakthrough, adoption_success
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.06}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.1}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.04}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "Major European research universities and CNRS/Max Planck institutes announce a joint open evaluation consortium publishing independent red-team results on Kimi K3 and Mythos-class models, forcing public debate on open-weight risk.", "emergent": true, "id": "emergent_eu_eval_consortium", "probability": 0.18}, {"description": "Major European research universities and open-science institutes publish a joint call for a compute-sharing pool for safety and evaluation research, attracting press coverage and parliamentary questions.", "emergent": true, "id": "emergent_open_science_compute_call", "probability": 0.2}]
```
