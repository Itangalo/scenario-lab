...
- characters 106-13115: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13158-13350: `{{metrics_json}}` from the run's live metric values
- characters 13443-14610: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14654-16770: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16826-17343: `{{notepad}}` from the Game Master's notepad, carried across turns
