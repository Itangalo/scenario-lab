...
- characters 107-13415: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13458-13648: `{{metrics_json}}` from the run's live metric values
- characters 13741-15043: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15087-17367: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17423-18027: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M13 | EU Cyber Restoration and Bio Early-Warning Surge | 2 |
...
## Notepad
PORTFOLIO CHARGE t13: M12 EU Degraded Operations and Loss-of-Control Fallback −2, M13 EU Cyber Restoration and Bio Early-Warning Surge −2, priority −0 (no effect, no cost below capital 20) = −4
PROPOSAL BONUS: EU Cyber Restoration and Bio Early-Warning Surge (cat 6, small) +4 — cyber_major_incident landed this turn and bio_uplift precursor opened 4-turn gate and this answers both directly via restoration and early-warning
LEGITIMACY LENDS: none — capital 15 above sentiment 4, no lend
SOVEREIGNTY: 8 last turn, no capacity event, no cat4 in flight +0, capability rose 1.5 (below 2, no −1) = 8
