...
- characters 376-1678: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1722-4002: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4058-5289: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5352-29448: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29803-30972: `{{event_history}}` from the run's own event record
...
- `emergent_infrastructure_sabotage` -- first noted turn 11, listed in 2 turn(s) so far: Coordinated physical sabotage of grid islanding stations and cable filtering sites by anti-AI groups, forcing prolonged local outages during containment operations.
- `emergent_containment_crew_refusal` -- first noted turn 11, listed in 2 turn(s) so far: Coordinated municipal utility operators in several member states publicly refuse further emergency islanding and rack-pull orders, citing staff exhaustion and equipment damage, leaving degraded-mode grid procedures without crews to execute them.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot
- Turn 2 (11 turn(s) ago): safety_breakthrough, adoption_success
- Turn 3 (10 turn(s) ago): adoption_success
- Turn 4 (9 turn(s) ago): cyber_defence_breakthrough
- Turn 5 (8 turn(s) ago): cyber_major_incident, export_control_escalation, election_alliance
- Turn 6 (7 turn(s) ago): loss_of_control_incident, ai_investment_collapse, rsi_onset, labour_displacement, taiwan_tension_rise, emergent_datacentre_siting_backlash
- Turn 7 (6 turn(s) ago): taiwan_blockade, catastrophic_great_power_conflict, labour_displacement, us_labs_nationalised, emergent_energy_siting_revolt
- Turn 8 (5 turn(s) ago): cyber_defence_breakthrough, labour_displacement, us_china_agreement, supply_chain_coercion
- Turn 9 (4 turn(s) ago): eval_anomaly_reports, catastrophic_loss_of_control_incident, joint_threat_response
- Turn 10 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release
- Turn 11 (2 turn(s) ago): capability_jump, safety_breakthrough
- Turn 12 (1 turn(s) ago): loss_of_control_incident, opaque_reasoning, safety_breakthrough, knowledge_work_augmented, embodied_ai_deployment
