...
- characters 376-1660: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1704-3745: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3801-4740: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4803-29597: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29952-30679: `{{event_history}}` from the run's own event record
...
- `emergent_distress_compute_buyout` -- first noted turn 7, listed in 2 turn(s) so far: Gulf and Asian sovereign funds step in to finance the two stalled EU compute parks on distressed terms, offering capital for equity and off-take priority.
...
- Turn 2 (7 turn(s) ago): safety_breakthrough, adoption_success
- Turn 3 (6 turn(s) ago): adoption_success
- Turn 4 (5 turn(s) ago): cyber_defence_breakthrough
- Turn 5 (4 turn(s) ago): cyber_major_incident, export_control_escalation, election_alliance
- Turn 6 (3 turn(s) ago): loss_of_control_incident, ai_investment_collapse, rsi_onset, labour_displacement, taiwan_tension_rise, emergent_datacentre_siting_backlash
- Turn 7 (2 turn(s) ago): taiwan_blockade, catastrophic_great_power_conflict, labour_displacement, us_labs_nationalised, emergent_energy_siting_revolt
- Turn 8 (1 turn(s) ago): cyber_defence_breakthrough, labour_displacement, us_china_agreement, supply_chain_coercion
