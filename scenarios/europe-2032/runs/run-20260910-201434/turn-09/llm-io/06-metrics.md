...
- characters 13500-13691: `{{metrics_json}}` from the run's live metric values
- characters 13784-15068: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15112-17153: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17209-17868: `{{notepad}}` from the Game Master's notepad, carried across turns
