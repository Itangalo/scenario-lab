...
- characters 1782-3823: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5425-5856: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8827-11158: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Accession to the US-China AI Risk Accord with ASML Shield | 8 | small | 8 | 10 | US, China and own jurisdiction | ai_safety up moderately, resilience up slightly, eu_ai_sovereignty up slightly via leverage defence | 2 | running |
