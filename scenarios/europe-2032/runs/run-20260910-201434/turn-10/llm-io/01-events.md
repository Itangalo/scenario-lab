...
- characters 377-1282: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1325-3107: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3163-3779: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3842-28636: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28991-29827: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): safety_breakthrough, adoption_success
- Turn 3 (7 turn(s) ago): adoption_success
- Turn 4 (6 turn(s) ago): cyber_defence_breakthrough
- Turn 5 (5 turn(s) ago): cyber_major_incident, export_control_escalation, election_alliance
- Turn 6 (4 turn(s) ago): loss_of_control_incident, ai_investment_collapse, rsi_onset, labour_displacement, taiwan_tension_rise, emergent_datacentre_siting_backlash
- Turn 7 (3 turn(s) ago): taiwan_blockade, catastrophic_great_power_conflict, labour_displacement, us_labs_nationalised, emergent_energy_siting_revolt
- Turn 8 (2 turn(s) ago): cyber_defence_breakthrough, labour_displacement, us_china_agreement, supply_chain_coercion
- Turn 9 (1 turn(s) ago): eval_anomaly_reports, catastrophic_loss_of_control_incident, joint_threat_response
