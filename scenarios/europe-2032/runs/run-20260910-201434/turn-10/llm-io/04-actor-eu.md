...
- characters 455-1360: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1403-3185: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5226-5688: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8893-11212: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Loss-of-Control Containment and Joint Threat Response | 6 | small | 9 | 11 | own jurisdiction and joint response coalition | resilience up substantially, ai_safety up slightly via containment and telemetry | 2 | running |
