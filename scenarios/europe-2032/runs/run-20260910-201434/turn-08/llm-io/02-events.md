...
- characters 375-1782: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1825-3765: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3821-4770: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4833-30087: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30442-31052: `{{event_history}}` from the run's own event record
...
- Turn 2 (6 turn(s) ago): safety_breakthrough, adoption_success
- Turn 3 (5 turn(s) ago): adoption_success
- Turn 4 (4 turn(s) ago): cyber_defence_breakthrough
- Turn 5 (3 turn(s) ago): cyber_major_incident, export_control_escalation, election_alliance
- Turn 6 (2 turn(s) ago): loss_of_control_incident, ai_investment_collapse, rsi_onset, labour_displacement, taiwan_tension_rise, emergent_datacentre_siting_backlash
- Turn 7 (1 turn(s) ago): taiwan_blockade, catastrophic_great_power_conflict, labour_displacement, us_labs_nationalised, emergent_energy_siting_revolt
