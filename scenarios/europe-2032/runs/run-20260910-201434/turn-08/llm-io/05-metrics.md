...
- characters 13779-15186: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15229-17169: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17225-18174: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | EU Accession to the US-China AI Risk Accord with ASML Shield | 2 |
...
## Metrics
```json
{"ai_capability": 80.0, "openweight_capability": 73.0, "ai_safety": 23.0, "resilience": 45.5, "eu_ai_sovereignty": 13.0, "eu_political_capital": 8.0, "public_sentiment": 18.0}
```
