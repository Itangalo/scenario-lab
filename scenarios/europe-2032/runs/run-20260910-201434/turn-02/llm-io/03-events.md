...
- characters 376-1096: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1139-3327: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3383-4504: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4567-27644: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27999-28040: `{{event_history}}` from the run's own event record
