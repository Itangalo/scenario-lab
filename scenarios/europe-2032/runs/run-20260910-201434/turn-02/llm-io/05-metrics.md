...
- characters 13392-14112: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14155-16343: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16399-17520: `{{notepad}}` from the Game Master's notepad, carried across turns
