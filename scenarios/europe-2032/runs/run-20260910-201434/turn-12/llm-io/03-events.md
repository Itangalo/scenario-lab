...
- characters 377-1928: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1971-3911: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3967-5063: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5126-29920: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30275-31302: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M11 EU Assurance Uptake for Deployed Agentic Systems −2, priority −0 (no effect, no cost below capital 20) = −2
PROPOSAL BONUS: EU Assurance Uptake (cat 5, small) +3 — capability_jump landed this turn and safety at 21, this answers it directly via adoptable breakthrough
LEGITIMACY LENDS: none — capital 19 above sentiment 8, no lend
SOVEREIGNTY: 11 last turn, no capacity event, no cat4 finishes, no cat4 in flight +0, capability rose 4.0 −1 = 10

## Emerging developments (tracked)

- `emergent_infrastructure_sabotage` -- first noted turn 11, listed in 1 turn(s) so far: Coordinated physical sabotage of grid islanding stations and cable filtering sites by anti-AI groups, forcing prolonged local outages during containment operations.
- `emergent_containment_crew_refusal` -- first noted turn 11, listed in 1 turn(s) so far: Coordinated municipal utility operators in several member states publicly refuse further emergency islanding and rack-pull orders, citing staff exhaustion and equipment damage, leaving degraded-mode grid procedures without crews to execute them.
...
- Turn 2 (10 turn(s) ago): safety_breakthrough, adoption_success
- Turn 3 (9 turn(s) ago): adoption_success
- Turn 4 (8 turn(s) ago): cyber_defence_breakthrough
- Turn 5 (7 turn(s) ago): cyber_major_incident, export_control_escalation, election_alliance
- Turn 6 (6 turn(s) ago): loss_of_control_incident, ai_investment_collapse, rsi_onset, labour_displacement, taiwan_tension_rise, emergent_datacentre_siting_backlash
- Turn 7 (5 turn(s) ago): taiwan_blockade, catastrophic_great_power_conflict, labour_displacement, us_labs_nationalised, emergent_energy_siting_revolt
- Turn 8 (4 turn(s) ago): cyber_defence_breakthrough, labour_displacement, us_china_agreement, supply_chain_coercion
- Turn 9 (3 turn(s) ago): eval_anomaly_reports, catastrophic_loss_of_control_incident, joint_threat_response
- Turn 10 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release
- Turn 11 (1 turn(s) ago): capability_jump, safety_breakthrough
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.3}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.05}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.04}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.3}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.05}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.2}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Coordinated physical sabotage of grid islanding stations and cable filtering sites by anti-AI groups, forcing prolonged local outages during containment operations.", "emergent": true, "id": "emergent_infrastructure_sabotage", "probability": 0.18}, {"description": "Coordinated municipal utility operators in several member states publicly refuse further emergency islanding and rack-pull orders, citing staff exhaustion and equipment damage, leaving degraded-mode grid procedures without crews to execute them.", "emergent": true, "id": "emergent_containment_crew_refusal", "probability": 0.16}]
```
