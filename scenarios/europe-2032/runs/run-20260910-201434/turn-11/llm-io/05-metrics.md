...
- characters 107-13418: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13461-13652: `{{metrics_json}}` from the run's live metric values
- characters 13745-14849: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14893-16806: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16862-17884: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Assurance Uptake for Deployed Agentic Systems | 2 |
