...
- characters 377-1481: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1525-3438: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3494-3889: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3952-28746: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29101-30063: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M10 EU Loss-of-Control Containment and Joint Threat Response −2, priority −0 (no effect, no cost below capital 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: none — capital 19 above sentiment 8 after incident drop, no lend
SOVEREIGNTY: 12 last turn, no capacity event, no cat4 finishes, no cat4 in flight +0, capability rose 3.0 −1 = 11
...
- Turn 2 (9 turn(s) ago): safety_breakthrough, adoption_success
- Turn 3 (8 turn(s) ago): adoption_success
- Turn 4 (7 turn(s) ago): cyber_defence_breakthrough
- Turn 5 (6 turn(s) ago): cyber_major_incident, export_control_escalation, election_alliance
- Turn 6 (5 turn(s) ago): loss_of_control_incident, ai_investment_collapse, rsi_onset, labour_displacement, taiwan_tension_rise, emergent_datacentre_siting_backlash
- Turn 7 (4 turn(s) ago): taiwan_blockade, catastrophic_great_power_conflict, labour_displacement, us_labs_nationalised, emergent_energy_siting_revolt
- Turn 8 (3 turn(s) ago): cyber_defence_breakthrough, labour_displacement, us_china_agreement, supply_chain_coercion
- Turn 9 (2 turn(s) ago): eval_anomaly_reports, catastrophic_loss_of_control_incident, joint_threat_response
- Turn 10 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release
