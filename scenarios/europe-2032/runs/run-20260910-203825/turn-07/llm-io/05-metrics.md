...
- characters 106-13370: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13413-13605: `{{metrics_json}}` from the run's live metric values
- characters 13698-15114: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15158-17101: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17157-18271: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | EU Blockade Resilience and Repair Compact | 2 |
