...
- characters 1915-3858: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7249-7682: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10273-12144: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | EU Transition Guarantee for Displaced Workers | 7 | small | 5 | 8 | own jurisdiction | resilience up, eu_political_capital protected, public_sentiment up modestly | 2 | running |
