...
- characters 1837-3780: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3836-4351: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4414-29506: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29861-30329: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, bio_uplift_findings, taiwan_tension_rise, export_control_escalation
- Turn 2 (5 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, supply_chain_coercion
- Turn 3 (4 turn(s) ago): taiwan_tension_rise, adoption_success
- Turn 4 (3 turn(s) ago): export_control_escalation
- Turn 5 (2 turn(s) ago): cyber_major_incident, labour_displacement, election_retrenchment
- Turn 6 (1 turn(s) ago): cyber_defence_breakthrough
