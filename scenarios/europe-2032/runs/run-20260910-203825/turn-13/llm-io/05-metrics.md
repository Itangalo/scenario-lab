...
- characters 107-12910: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12953-13144: `{{metrics_json}}` from the run's live metric values
- characters 13237-16215: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16259-18056: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18112-18588: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Hospital-Water Continuity and Bio-Cyber Absorption Compact | 2 |
| M14 | EU Verification and Cyber-Shield Accession Pact | 2 |
...
## Notepad
PORTFOLIO CHARGE t13: M13 EU Hospital-Water Continuity and Bio-Cyber Absorption Compact −2, M14 EU Verification and Cyber-Shield Accession Pact −2, priority no cost below 20 = −4
PROPOSAL BONUS: none — M14 (cat 8, small) answers US-China accord and defensive tooling opening, both positive developments not negative shocks from last three rounds
LEGITIMACY LENDS: capital 15, sentiment 9 -> none, capital already above sentiment
SOVEREIGNTY: 18 last turn, no capacity event, no cat 4 in flight +0, capability rose 0.4 −0 = 18
