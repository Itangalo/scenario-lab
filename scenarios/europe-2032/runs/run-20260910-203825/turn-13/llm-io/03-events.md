...
- characters 377-3355: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3399-5196: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5252-5728: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5791-30148: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30503-31748: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M13 EU Hospital-Water Continuity and Bio-Cyber Absorption Compact −2 = −2 + priority no cost below 20
PROPOSAL BONUS: M13 (cat 6, small) +3 — cyber sweep landed this turn and bio-precursor plus cutoff from last rounds, this answers directly
LEGITIMACY LENDS: capital 19, sentiment 7 -> none, capital already above sentiment
SOVEREIGNTY: 20 last turn, no cat 4 finishes, no cat 4 in flight +0, eu_frontier_access_denied t12 −2, capability rose 0.6 −0 = 18
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, bio_uplift_findings, taiwan_tension_rise, export_control_escalation
- Turn 2 (11 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, supply_chain_coercion
- Turn 3 (10 turn(s) ago): taiwan_tension_rise, adoption_success
- Turn 4 (9 turn(s) ago): export_control_escalation
- Turn 5 (8 turn(s) ago): cyber_major_incident, labour_displacement, election_retrenchment
- Turn 6 (7 turn(s) ago): cyber_defence_breakthrough
- Turn 7 (6 turn(s) ago): cyber_major_incident, taiwan_blockade, bio_uplift_findings, safety_breakthrough, labour_displacement, taiwan_tension_rise, export_control_escalation, supply_chain_coercion, member_state_defection
- Turn 8 (5 turn(s) ago): capability_jump, ai_investment_collapse, eu_frontier_access_denied
- Turn 9 (4 turn(s) ago): safety_breakthrough, supply_chain_coercion
- Turn 10 (3 turn(s) ago): bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied, joint_threat_response, middle_power_coalition
- Turn 11 (2 turn(s) ago): bio_incident, cyber_defence_breakthrough
- Turn 12 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, eu_frontier_access_denied
