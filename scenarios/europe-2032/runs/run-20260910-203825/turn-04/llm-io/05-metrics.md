...
- characters 13648-15057: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15100-17192: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17248-18126: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | Joint Lithography Stewardship Pact | 2 |
| M6 | EU Volume Licence Assurance | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Swarm Defence Deployment −3, Joint Lithography Stewardship Pact −2, priority −1 = −12
PROPOSAL BONUS: Joint Lithography Stewardship Pact (cat 8, small) +2 — US servicing/export cut last turn plus Taiwan tension precursor, answers loss of supply-chain leverage directly but small and external
LEGITIMACY LENDS: capital 32, sentiment 34 -> +1
SOVEREIGNTY: 18 last turn, no capacity event, no cat4 finish, in flight +0, capability rose 1.5 −0 = 18

## Emerging developments (tracked)

- `emergent_shipping_insurance_squeeze` -- first noted turn 4, listed in 1 turn(s) so far: Extended exercises around Taiwan prompt marine insurers to sharply raise premiums and exclude semiconductor shipments on certain routes, delaying spares and tooling deliveries to Europe for months without any formal blockade.
