...
- characters 378-2395: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2439-5095: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5151-5687: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5750-30919: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31274-32324: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, bio_uplift_findings, taiwan_tension_rise, export_control_escalation
- Turn 2 (9 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, supply_chain_coercion
- Turn 3 (8 turn(s) ago): taiwan_tension_rise, adoption_success
- Turn 4 (7 turn(s) ago): export_control_escalation
- Turn 5 (6 turn(s) ago): cyber_major_incident, labour_displacement, election_retrenchment
- Turn 6 (5 turn(s) ago): cyber_defence_breakthrough
- Turn 7 (4 turn(s) ago): cyber_major_incident, taiwan_blockade, bio_uplift_findings, safety_breakthrough, labour_displacement, taiwan_tension_rise, export_control_escalation, supply_chain_coercion, member_state_defection
- Turn 8 (3 turn(s) ago): capability_jump, ai_investment_collapse, eu_frontier_access_denied
- Turn 9 (2 turn(s) ago): safety_breakthrough, supply_chain_coercion
- Turn 10 (1 turn(s) ago): bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied, joint_threat_response, middle_power_coalition
