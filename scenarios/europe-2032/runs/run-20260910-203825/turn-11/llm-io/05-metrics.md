...
- characters 13534-15551: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15595-18251: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18307-18843: `{{notepad}}` from the Game Master's notepad, carried across turns
