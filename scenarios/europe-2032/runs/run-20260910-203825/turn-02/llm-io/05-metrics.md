...
- characters 13250-14458: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14501-16481: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16537-17526: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Swarm Defence Deployment | 3 |
...
- `emergent_eu_open_frontier_push` -- first noted turn 1, listed in 2 turn(s) so far: Major EU research universities and Mistral announce a joint pooled-training run on EuroHPC capacity to produce an openly licensed frontier-class model by early 2027.
- `emergent_biopublish_backlash` -- first noted turn 1, listed in 2 turn(s) so far: Major European research hospitals and journals impose a temporary moratorium on publishing AI-designed pathogen methods after the phage results, prompting a preprint leak fight outside EU jurisdiction.
