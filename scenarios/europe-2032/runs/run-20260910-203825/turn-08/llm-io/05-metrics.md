...
- characters 105-13393: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13436-13628: `{{metrics_json}}` from the run's live metric values
- characters 13721-15722: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15765-17865: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17921-19019: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Sovereign Continuity Cloud | 2 |
