...
- characters 376-2377: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2420-4520: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4576-5674: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5737-30111: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30466-31156: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU Transition Guarantee for Displaced Workers −2, EU Blockade Resilience and Repair Compact −2, priority −1 = −5
PROPOSAL BONUS: EU Blockade Resilience and Repair Compact (cat 6, small) +5 — cyber_major_incident plus taiwan_blockade both landed this turn and this answers both directly
LEGITIMACY LENDS: capital 19, sentiment 22 -> +2
SOVEREIGNTY: 21 last turn, InvestAI Gigafactories finishes t7 +5, no in-flight cat4, taiwan_blockade t7 −3, capability rose 0.6 no penalty = 23

## Emerging developments (tracked)

- `emergent_cyber_insurance_freeze` -- first noted turn 7, listed in 1 turn(s) so far: Major European reinsurers jointly suspend new cyber-business-interruption cover for municipalities and hospitals after patch-integration failures, freezing local IT upgrades until public backstop terms are clarified.
- `emergent_us_moratorium_price_shock` -- first noted turn 7, listed in 1 turn(s) so far: US state-level data-centre moratoriums coalesce into a de facto permitting freeze, spiking EU cloud inference prices and renewal terms for pooled US supply in H2 2029.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, bio_uplift_findings, taiwan_tension_rise, export_control_escalation
- Turn 2 (6 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, supply_chain_coercion
- Turn 3 (5 turn(s) ago): taiwan_tension_rise, adoption_success
- Turn 4 (4 turn(s) ago): export_control_escalation
- Turn 5 (3 turn(s) ago): cyber_major_incident, labour_displacement, election_retrenchment
- Turn 6 (2 turn(s) ago): cyber_defence_breakthrough
- Turn 7 (1 turn(s) ago): cyber_major_incident, taiwan_blockade, bio_uplift_findings, safety_breakthrough, labour_displacement, taiwan_tension_rise, export_control_escalation, supply_chain_coercion, member_state_defection
