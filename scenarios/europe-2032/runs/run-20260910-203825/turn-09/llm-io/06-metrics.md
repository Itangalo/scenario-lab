...
- characters 106-12868: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12911-13103: `{{metrics_json}}` from the run's live metric values
- characters 13196-15537: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15581-17423: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17479-17943: `{{notepad}}` from the Game Master's notepad, carried across turns
