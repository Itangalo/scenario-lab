...
- characters 455-2796: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2840-4682: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5578-6011: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8926-10944: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Sovereign Continuity Cloud | 4 | small | 8 | 10 | own jurisdiction | eu_ai_sovereignty up, resilience protected from fall | 2 | running |
