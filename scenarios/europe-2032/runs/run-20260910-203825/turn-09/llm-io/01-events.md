...
- characters 377-2718: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2762-4604: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4660-5723: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5786-30955: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31310-32093: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Sovereign Continuity Cloud −2, priority −1 = −3
PROPOSAL BONUS: EU Sovereign Continuity Cloud (cat 4, small) +4 — eu_frontier_access_denied plus taiwan quarantine tightening and ai_investment_collapse landed this turn and this answers access loss directly
LEGITIMACY LENDS: capital 16, sentiment 18 -> +2
SOVEREIGNTY: 23 last turn, no capacity event finishes, M10 proposed t8 +0, eu_frontier_access_denied t8 −2, capability rose 3.6 −1 = 20

## Emerging developments (tracked)

- `emergent_cyber_insurance_freeze` -- first noted turn 7, listed in 2 turn(s) so far: Major European reinsurers jointly suspend new cyber-business-interruption cover for municipalities and hospitals after patch-integration failures, freezing local IT upgrades until public backstop terms are clarified.
- `emergent_us_moratorium_price_shock` -- first noted turn 7, listed in 2 turn(s) so far: US state-level data-centre moratoriums coalesce into a de facto permitting freeze, spiking EU cloud inference prices and renewal terms for pooled US supply in H2 2029.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, bio_uplift_findings, taiwan_tension_rise, export_control_escalation
- Turn 2 (7 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, supply_chain_coercion
- Turn 3 (6 turn(s) ago): taiwan_tension_rise, adoption_success
- Turn 4 (5 turn(s) ago): export_control_escalation
- Turn 5 (4 turn(s) ago): cyber_major_incident, labour_displacement, election_retrenchment
- Turn 6 (3 turn(s) ago): cyber_defence_breakthrough
- Turn 7 (2 turn(s) ago): cyber_major_incident, taiwan_blockade, bio_uplift_findings, safety_breakthrough, labour_displacement, taiwan_tension_rise, export_control_escalation, supply_chain_coercion, member_state_defection
- Turn 8 (1 turn(s) ago): capability_jump, ai_investment_collapse, eu_frontier_access_denied
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.03}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.06}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.03}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.08}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.03}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.05}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.07}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.04}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.15}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.15}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Major European reinsurers jointly suspend new cyber-business-interruption cover for municipalities and hospitals after patch-integration failures, freezing local IT upgrades until public backstop terms are clarified.", "emergent": true, "id": "emergent_cyber_insurance_freeze", "probability": 0.22}, {"description": "US state-level data-centre moratoriums coalesce into a de facto permitting freeze, spiking EU cloud inference prices and renewal terms for pooled US supply in H2 2029.", "emergent": true, "id": "emergent_us_moratorium_price_shock", "probability": 0.18}]
```
