...
- characters 13642-14734: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14778-17189: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17245-17766: `{{notepad}}` from the Game Master's notepad, carried across turns
