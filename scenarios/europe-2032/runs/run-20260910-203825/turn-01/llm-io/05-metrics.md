...
- characters 16237-16810: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_eu_open_frontier_push` -- first noted turn 1, listed in 1 turn(s) so far: Major EU research universities and Mistral announce a joint pooled-training run on EuroHPC capacity to produce an openly licensed frontier-class model by early 2027.
- `emergent_biopublish_backlash` -- first noted turn 1, listed in 1 turn(s) so far: Major European research hospitals and journals impose a temporary moratorium on publishing AI-designed pathogen methods after the phage results, prompting a preprint leak fight outside EU jurisdiction.
...
## Notepad
PORTFOLIO CHARGE t1: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Shield Hardening −3, priority −1 = −10
PROPOSAL BONUS: EU Critical Shield Hardening (cat 6, large) +4 — cyber_test_shot landed this turn and this answers it directly
LEGITIMACY LENDS: capital 39, sentiment 40 -> +1
SOVEREIGNTY: 22 last turn, no in-flight bonus +0, export_control_escalation t1 −2, capability rose 1.8 −0 = 20
