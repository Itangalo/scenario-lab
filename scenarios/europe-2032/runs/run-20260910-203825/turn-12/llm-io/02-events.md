...
- characters 377-3117: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3160-5086: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5142-5540: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5603-29960: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30315-31434: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Middle-Power Continuity and Bioshield Pact −2, priority no cost below 20 = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 16, sentiment 12 -> none, capital already above sentiment after other terms
SOVEREIGNTY: 20 last turn, M11 finishes t11 is cat 5 not cat 4 +0, no cat 4 in flight +0, no capacity event, capability rose 0.6 −0 = 20
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, bio_uplift_findings, taiwan_tension_rise, export_control_escalation
- Turn 2 (10 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, supply_chain_coercion
- Turn 3 (9 turn(s) ago): taiwan_tension_rise, adoption_success
- Turn 4 (8 turn(s) ago): export_control_escalation
- Turn 5 (7 turn(s) ago): cyber_major_incident, labour_displacement, election_retrenchment
- Turn 6 (6 turn(s) ago): cyber_defence_breakthrough
- Turn 7 (5 turn(s) ago): cyber_major_incident, taiwan_blockade, bio_uplift_findings, safety_breakthrough, labour_displacement, taiwan_tension_rise, export_control_escalation, supply_chain_coercion, member_state_defection
- Turn 8 (4 turn(s) ago): capability_jump, ai_investment_collapse, eu_frontier_access_denied
- Turn 9 (3 turn(s) ago): safety_breakthrough, supply_chain_coercion
- Turn 10 (2 turn(s) ago): bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied, joint_threat_response, middle_power_coalition
- Turn 11 (1 turn(s) ago): bio_incident, cyber_defence_breakthrough
