...
- characters 455-3195: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3238-5164: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6947-7412: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10521-11837: `{{previous_actions}}` from the actor's own response from the previous turn
