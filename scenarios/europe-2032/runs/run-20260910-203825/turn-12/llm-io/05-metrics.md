...
- characters 13588-16328: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16371-18297: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18353-18751: `{{notepad}}` from the Game Master's notepad, carried across turns
