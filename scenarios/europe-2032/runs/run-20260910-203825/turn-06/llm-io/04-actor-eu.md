...
- characters 454-1515: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1558-4202: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4594-5027: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7494-9774: `{{previous_actions}}` from the actor's own response from the previous turn
