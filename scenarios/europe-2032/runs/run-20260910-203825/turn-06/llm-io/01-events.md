...
- characters 376-1437: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1480-4124: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4180-5033: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5096-27078: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27433-27848: `{{event_history}}` from the run's own event record
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, bio_uplift_findings, taiwan_tension_rise, export_control_escalation
- Turn 2 (4 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, supply_chain_coercion
- Turn 3 (3 turn(s) ago): taiwan_tension_rise, adoption_success
- Turn 4 (2 turn(s) ago): export_control_escalation
- Turn 5 (1 turn(s) ago): cyber_major_incident, labour_displacement, election_retrenchment
