...
- characters 1920-3764: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6752-7217: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10285-12772: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Assured Sovereign Stack Certification | 5 | small | 9 | 11 | own jurisdiction | ai_safety up, resilience protected from fall | 2 | running |
