...
- characters 377-1799: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1842-3686: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3742-4228: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4291-29460: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29815-30667: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Sovereign Continuity Cloud −2, EU Assured Sovereign Stack Certification −2, priority −1 = −5
PROPOSAL BONUS: EU Assured Sovereign Stack Certification (cat 5, small) +1 — safety at 15 and cutoff fallback living on open weights, answers frontier leap and access loss from t8 indirectly
LEGITIMACY LENDS: capital 10, sentiment 18 -> +2
SOVEREIGNTY: 20 last turn, no capacity event finishes, M10 in flight +0, supply_chain_coercion t9 −2, capability rose 0.6 −0 = 18
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, bio_uplift_findings, taiwan_tension_rise, export_control_escalation
- Turn 2 (8 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, supply_chain_coercion
- Turn 3 (7 turn(s) ago): taiwan_tension_rise, adoption_success
- Turn 4 (6 turn(s) ago): export_control_escalation
- Turn 5 (5 turn(s) ago): cyber_major_incident, labour_displacement, election_retrenchment
- Turn 6 (4 turn(s) ago): cyber_defence_breakthrough
- Turn 7 (3 turn(s) ago): cyber_major_incident, taiwan_blockade, bio_uplift_findings, safety_breakthrough, labour_displacement, taiwan_tension_rise, export_control_escalation, supply_chain_coercion, member_state_defection
- Turn 8 (2 turn(s) ago): capability_jump, ai_investment_collapse, eu_frontier_access_denied
- Turn 9 (1 turn(s) ago): safety_breakthrough, supply_chain_coercion
