...
- characters 106-13257: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13300-13492: `{{metrics_json}}` from the run's live metric values
- characters 13585-15007: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15050-16894: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16950-17436: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Assured Sovereign Stack Certification | 2 |
| M12 | EU Middle-Power Continuity and Bioshield Pact | 2 |
...
## Metrics
```json
{"ai_capability": 66.1, "openweight_capability": 64.0, "ai_safety": 18.0, "resilience": 50.0, "eu_ai_sovereignty": 24.0, "eu_political_capital": 15.0, "public_sentiment": 16.0}
```
