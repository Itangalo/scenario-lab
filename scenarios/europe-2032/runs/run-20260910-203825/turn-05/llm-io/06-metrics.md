...
- characters 13644-14633: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14677-17024: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17080-17986: `{{notepad}}` from the Game Master's notepad, carried across turns
