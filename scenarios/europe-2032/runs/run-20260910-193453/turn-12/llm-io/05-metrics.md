...
- characters 13266-13457: `{{metrics_json}}` from the run's live metric values
- characters 13550-14582: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14625-16619: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16675-17085: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Care Liability Payout Facility | 2 |
