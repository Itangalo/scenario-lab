...
- characters 106-13341: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13384-13576: `{{metrics_json}}` from the run's live metric values
- characters 13669-14773: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14817-17111: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17167-17982: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Municipal Services Continuity Pact | 2 |
| M5 | EU Trusted Components and Supply-Chain Leverage Pact | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Grid and Essential Services Shield −3, EU Municipal Services Continuity Pact −2, priority −1 = −12
PROPOSAL BONUS: EU Municipal Services Continuity Pact (cat 6, small) +2 — cyber_major_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 28, sentiment 36 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, no finishing measure, in flight +0, capability rose 1.5 no −1 = 20

## Emerging developments (tracked)

- `emergent_relay_procurement_fight` -- first noted turn 3, listed in 1 turn(s) so far: US volume-licence controls on grid relays and compute spark an EU-level procurement lawsuit and emergency stockpile order, temporarily easing relay supply but deepening transatlantic tech-sovereignty dispute.
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 52.0, "ai_safety": 28.0, "resilience": 41.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 24.0, "public_sentiment": 26.0}
```
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Municipal Services Continuity Pact −2, EU Trusted Components and Supply-Chain Leverage Pact −2, priority −1 = −11
PROPOSAL BONUS: EU Trusted Components and Supply-Chain Leverage Pact (cat 8, small) +4 — taiwan_blockade and counterfeit relay crisis landed this turn and this answers both directly
LEGITIMACY LENDS: capital 22, sentiment 26 -> +2
SOVEREIGNTY: 20 last turn, no capacity event finishing, no finishing measure, in flight +0, taiwan_blockade t3 −2, capability rose 1.5 no −1 = 18
