...
- characters 454-1146: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1189-3378: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4638-5115: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7894-10311: `{{previous_actions}}` from the actor's own response from the previous turn
...
**emergent_municipal_siting_freeze (emergent event):** Anti-AI parties coordinate cross-border municipal bans on new data-centre and AI-infrastructure siting, forcing permit freezes in several member states.
