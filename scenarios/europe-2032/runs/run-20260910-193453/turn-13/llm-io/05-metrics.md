...
- characters 107-13188: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13231-13422: `{{metrics_json}}` from the run's live metric values
- characters 13515-14801: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14845-17015: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17071-17467: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Swarm Defence Scale-Up | 2 |
...
## Notepad
PORTFOLIO CHARGE t13: EU Swarm Defence Scale-Up −2, priority −1 = −3

PROPOSAL BONUS: none — new cat 6 answers defensive breakthrough (positive) not a negative event from last three turns
