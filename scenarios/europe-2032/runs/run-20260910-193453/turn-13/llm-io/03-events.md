...
- characters 1707-3877: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3933-4329: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4392-28864: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29219-30469: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Care Liability Payout Facility −2, priority −1 = −3

PROPOSAL BONUS: EU Care Liability Payout Facility (cat 6, small) +2 — answers hospital rollback standoff and formal non-compliance threat building since t11

LEGITIMACY LENDS: capital 22, sentiment 20 -> none, capital higher

SOVEREIGNTY: 25 last turn, no capacity event, no cat4 in flight, capability rose 0.5 −0 = 25
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, cyber_major_incident, ai_investment_collapse, taiwan_tension_rise, export_control_escalation
- Turn 2 (11 turn(s) ago): cyber_major_incident, emergent_datacentre_backlash, emergent_screening_norm_shift
- Turn 3 (10 turn(s) ago): taiwan_blockade, taiwan_tension_rise, emergent_grid_component_fraud
- Turn 4 (9 turn(s) ago): emergent_relay_procurement_fight
- Turn 5 (8 turn(s) ago): eval_anomaly_reports, safety_breakthrough, joint_threat_response, election_retrenchment
- Turn 6 (7 turn(s) ago): cyber_major_incident, capability_jump
- Turn 7 (6 turn(s) ago): cyber_defence_breakthrough, opaque_reasoning, knowledge_work_augmented
- Turn 8 (5 turn(s) ago): cyber_defence_breakthrough
- Turn 9 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, cyber_defence_breakthrough, research_breakthrough, medical_breakthrough, member_state_defection
- Turn 10 (3 turn(s) ago): cyber_major_incident, knowledge_work_augmented, emergent_municipal_siting_freeze
- Turn 11 (2 turn(s) ago): bio_uplift_findings, export_control_escalation, joint_threat_response, emergent_care_rollback_standoff
- Turn 12 (1 turn(s) ago): openweight_frontier_release, knowledge_work_augmented, emergent_care_bloc_formalisation
