...
- characters 1581-4023: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4820-5267: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7571-10004: `{{previous_actions}}` from the actor's own response from the previous turn
