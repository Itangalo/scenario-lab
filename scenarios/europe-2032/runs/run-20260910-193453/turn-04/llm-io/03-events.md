...
- characters 1450-3571: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3627-4531: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4594-26497: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26852-27189: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, cyber_major_incident, ai_investment_collapse, taiwan_tension_rise, export_control_escalation
- Turn 2 (2 turn(s) ago): cyber_major_incident, emergent_datacentre_backlash, emergent_screening_norm_shift
- Turn 3 (1 turn(s) ago): taiwan_blockade, taiwan_tension_rise, emergent_grid_component_fraud
