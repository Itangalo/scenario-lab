...
- characters 105-13279: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13322-13514: `{{metrics_json}}` from the run's live metric values
- characters 13607-14638: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14681-16802: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16858-17428: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Trusted Components and Supply-Chain Leverage Pact −2, priority −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 18, sentiment 26 -> +2
SOVEREIGNTY: 18 last turn, no capacity event, Gigafactories in flight +1, capability rose 1.5 no −1 = 19
