...
- characters 377-1254: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1298-3057: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3113-3474: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3537-25440: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 25795-26191: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, cyber_major_incident, ai_investment_collapse, taiwan_tension_rise, export_control_escalation
- Turn 2 (3 turn(s) ago): cyber_major_incident, emergent_datacentre_backlash, emergent_screening_norm_shift
- Turn 3 (2 turn(s) ago): taiwan_blockade, taiwan_tension_rise, emergent_grid_component_fraud
- Turn 4 (1 turn(s) ago): emergent_relay_procurement_fight
