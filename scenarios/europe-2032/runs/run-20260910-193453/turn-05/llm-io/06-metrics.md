...
- characters 13282-14159: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14203-15962: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16018-16379: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Joint Threat Response Accession | 2 |
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "pending"}}, {"op": "update", "table": "measures", "id": "M6", "fields": {"finish_turn": 6}, "grounds": "named priority"}]}
```
```
