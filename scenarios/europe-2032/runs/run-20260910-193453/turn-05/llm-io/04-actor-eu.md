...
- characters 455-1332: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1376-3135: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5368-5831: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7960-9393: `{{previous_actions}}` from the actor's own response from the previous turn
