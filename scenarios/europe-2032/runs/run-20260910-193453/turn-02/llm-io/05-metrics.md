...
- characters 105-12941: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12984-13176: `{{metrics_json}}` from the run's live metric values
- characters 13269-14063: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14106-16174: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16230-16876: `{{notepad}}` from the Game Master's notepad, carried across turns
