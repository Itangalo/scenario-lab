...
- characters 105-13186: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13229-13421: `{{metrics_json}}` from the run's live metric values
- characters 13514-14760: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14803-16957: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17013-17436: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Essential Services Hardening Mandate | 2 |
...
## Metrics
```json
{"ai_capability": 65.0, "openweight_capability": 62.6, "ai_safety": 9.0, "resilience": 51.0, "eu_ai_sovereignty": 25.0, "eu_political_capital": 21.0, "public_sentiment": 29.0}
```
## Narrative
