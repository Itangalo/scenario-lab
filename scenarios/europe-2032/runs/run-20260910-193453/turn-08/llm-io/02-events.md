...
- characters 376-1622: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1665-3819: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3875-4627: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4690-28309: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28664-29335: `{{event_history}}` from the run's own event record
...
- `emergent_nonus_frontier_claim` -- first noted turn 6, listed in 2 turn(s) so far: With the incoming US administration signalling data-centre moratoriums and AI curbs, a non-US frontier lab publicly demonstrates a system trained largely outside US compute, narrowing the perceived US lead.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, cyber_major_incident, ai_investment_collapse, taiwan_tension_rise, export_control_escalation
- Turn 2 (6 turn(s) ago): cyber_major_incident, emergent_datacentre_backlash, emergent_screening_norm_shift
- Turn 3 (5 turn(s) ago): taiwan_blockade, taiwan_tension_rise, emergent_grid_component_fraud
- Turn 4 (4 turn(s) ago): emergent_relay_procurement_fight
- Turn 5 (3 turn(s) ago): eval_anomaly_reports, safety_breakthrough, joint_threat_response, election_retrenchment
- Turn 6 (2 turn(s) ago): cyber_major_incident, capability_jump
- Turn 7 (1 turn(s) ago): cyber_defence_breakthrough, opaque_reasoning, knowledge_work_augmented
