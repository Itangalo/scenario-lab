...
- characters 106-13199: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13242-13433: `{{metrics_json}}` from the run's live metric values
- characters 13526-14775: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14819-16377: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16433-16830: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Frontier Failure Containment Pact | 2 |
