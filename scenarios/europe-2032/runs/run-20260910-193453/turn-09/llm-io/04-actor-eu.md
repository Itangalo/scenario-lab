...
- characters 454-1703: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1747-3305: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6703-7150: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9763-11595: `{{previous_actions}}` from the actor's own response from the previous turn
