...
- characters 376-1625: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1669-3227: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3283-3680: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3743-28215: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28570-29294: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Essential Services Hardening Mandate −2, priority −1 = −3

PROPOSAL BONUS: EU Essential Services Hardening Mandate (cat 6, small) +2 — February ransomware sweep in t6 severe and this locks in the breakthrough that contained it

LEGITIMACY LENDS: capital 19, sentiment 29 -> +2

SOVEREIGNTY: 25 last turn, no capacity event, no cat4 in flight +0, capability rose 0.5 −0 = 25
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, cyber_major_incident, ai_investment_collapse, taiwan_tension_rise, export_control_escalation
- Turn 2 (7 turn(s) ago): cyber_major_incident, emergent_datacentre_backlash, emergent_screening_norm_shift
- Turn 3 (6 turn(s) ago): taiwan_blockade, taiwan_tension_rise, emergent_grid_component_fraud
- Turn 4 (5 turn(s) ago): emergent_relay_procurement_fight
- Turn 5 (4 turn(s) ago): eval_anomaly_reports, safety_breakthrough, joint_threat_response, election_retrenchment
- Turn 6 (3 turn(s) ago): cyber_major_incident, capability_jump
- Turn 7 (2 turn(s) ago): cyber_defence_breakthrough, opaque_reasoning, knowledge_work_augmented
