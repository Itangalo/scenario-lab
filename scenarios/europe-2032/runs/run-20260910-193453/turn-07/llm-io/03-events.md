...
- characters 377-1475: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1519-3687: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3743-4520: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4583-28899: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29254-29828: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, cyber_major_incident, ai_investment_collapse, taiwan_tension_rise, export_control_escalation
- Turn 2 (5 turn(s) ago): cyber_major_incident, emergent_datacentre_backlash, emergent_screening_norm_shift
- Turn 3 (4 turn(s) ago): taiwan_blockade, taiwan_tension_rise, emergent_grid_component_fraud
- Turn 4 (3 turn(s) ago): emergent_relay_procurement_fight
- Turn 5 (2 turn(s) ago): eval_anomaly_reports, safety_breakthrough, joint_threat_response, election_retrenchment
- Turn 6 (1 turn(s) ago): cyber_major_incident, capability_jump
