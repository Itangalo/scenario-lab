...
- characters 377-1295: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1339-3425: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3481-4318: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4381-28853: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29208-30211: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, cyber_major_incident, ai_investment_collapse, taiwan_tension_rise, export_control_escalation
- Turn 2 (9 turn(s) ago): cyber_major_incident, emergent_datacentre_backlash, emergent_screening_norm_shift
- Turn 3 (8 turn(s) ago): taiwan_blockade, taiwan_tension_rise, emergent_grid_component_fraud
- Turn 4 (7 turn(s) ago): emergent_relay_procurement_fight
- Turn 5 (6 turn(s) ago): eval_anomaly_reports, safety_breakthrough, joint_threat_response, election_retrenchment
- Turn 6 (5 turn(s) ago): cyber_major_incident, capability_jump
- Turn 7 (4 turn(s) ago): cyber_defence_breakthrough, opaque_reasoning, knowledge_work_augmented
- Turn 8 (3 turn(s) ago): cyber_defence_breakthrough
- Turn 9 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, cyber_defence_breakthrough, research_breakthrough, medical_breakthrough, member_state_defection
- Turn 10 (1 turn(s) ago): cyber_major_incident, knowledge_work_augmented, emergent_municipal_siting_freeze
