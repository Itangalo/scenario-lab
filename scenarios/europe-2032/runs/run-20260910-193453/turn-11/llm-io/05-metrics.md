...
- characters 107-13199: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13242-13433: `{{metrics_json}}` from the run's live metric values
- characters 13526-14444: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14488-16574: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16630-17122: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Bio-Care Continuity Pact | 2 |
...
## Notepad
PORTFOLIO CHARGE t11: EU Bio-Care Continuity Pact −2, priority −1 = −3

PROPOSAL BONUS: none — M12 already in flight, this turn names it as priority rather than adding a new answer to bio_uplift_findings

LEGITIMACY LENDS: capital 29, sentiment 19 -> none, capital higher

SOVEREIGNTY: 22 last turn, EU Clean Compute Siting Compact finishes t11 +4, export_control_escalation t11 −1, capability rose 0.5 −0 = 25
