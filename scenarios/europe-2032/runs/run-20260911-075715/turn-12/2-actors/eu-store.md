...
| M11 | EU Rogue Agent Quarantine and Essential Services Islanding Operation | 6 | small | 11 | 13 | own jurisdiction | resilience up moderately, ai_safety protected | 2 | running |
| M12 | EU Cutoff Continuity Bridge for Hospitals and Public Services | 6 | small | 12 | 14 | own jurisdiction | resilience up modestly, eu_political_capital protected, public_sentiment up modestly | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Cutoff Continuity Bridge for Hospitals and Public Services", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up modestly, eu_political_capital protected, public_sentiment up modestly"}, "grounds": "to hold essential services through frontier cutoff under livelihoods commitm
  - Grounds: to hold essential services through frontier cutoff under livelihoods commitment
