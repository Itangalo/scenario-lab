...
| M7 | Municipal Fallback Corps | 6 | small | 8 | 10 | own jurisdiction | resilience up, eu_political_capital up modestly via visible continuity | 2 | running |
...
- **applied** `M7` — {"op": "add", "table": "measures", "fields": {"name": "Municipal Fallback Corps", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_political_capital up modestly via visible continuity"}, "grounds": "major automated incident requires continuity response within zero capital room"}
  - Grounds: major automated incident requires continuity response within zero capital room
