...
| M13 | EU Trust and Siting Repair Compact | 9 | small | 12 | 14 | own jurisdiction | public_sentiment up, eu_political_capital protected, resilience up slightly via siting unblock | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Trust and Siting Repair Compact", "category": 9, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, eu_political_capital protected, resilience up slightly via siting unblock"}, "grounds": "scandal plus datacentre blockades paralyse further build"}
  - Grounds: scandal plus datacentre blockades paralyse further build
