...
- characters 106-13324: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13367-13559: `{{metrics_json}}` from the run's live metric values
- characters 13652-14442: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14486-16428: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16484-17600: `{{notepad}}` from the Game Master's notepad, carried across turns
