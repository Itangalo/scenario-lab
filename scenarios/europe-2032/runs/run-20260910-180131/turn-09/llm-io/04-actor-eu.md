...
- characters 455-1245: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1289-3231: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4491-4975: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7412-9547: `{{previous_actions}}` from the actor's own response from the previous turn
