...
- characters 377-1276: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1319-3125: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3181-4245: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4308-27664: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28019-29104: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M11 EU Municipal Patch and Certified Recovery Network −2, priority −1 = −3
PROPOSAL BONUS: EU Municipal Patch Network (cat 6, small) +3 — eu_frontier_access_denied and ransomware wave in last 3 turns, answers directly with breakthrough tooling
LEGITIMACY LENDS: capital 21, sentiment 23 -> +1
SOVEREIGNTY: 24 last turn, no cat4 finish, no cat4 in flight +0, eu_frontier_access_denied t11 −2, capability rose 0.5 −0 = 22

## Emerging developments (tracked)

- `emergent_siting_moratoria_wave` -- first noted turn 11, listed in 1 turn(s) so far: Coordinated municipal moratoria on new compute siting spread after the February cut-off, with several councils pausing permits pending health-continuity guarantees.
- `emergent_dutch_lithography_standoff` -- first noted turn 11, listed in 1 turn(s) so far: The Dutch government publicly refuses a US demand to suspend servicing of older lithography tools already installed abroad, triggering an open transatlantic dispute over extraterritorial export controls and a retaliatory US licensing threat.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, safety_breakthrough, knowledge_work_augmented
- Turn 2 (10 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 3 (9 turn(s) ago): eu_frontier_access_denied
- Turn 4 (8 turn(s) ago): openweight_frontier_release
- Turn 5 (7 turn(s) ago): openweight_frontier_release, emergent_datacentre_siting_backlash, election_retrenchment
- Turn 6 (6 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, emergent_datacentre_power_backlash
- Turn 7 (5 turn(s) ago): loss_of_control_incident, emergent_agent_liability_freeze
- Turn 8 (4 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, openweight_frontier_release
- Turn 9 (3 turn(s) ago): safety_breakthrough, knowledge_work_augmented, export_control_escalation
- Turn 10 (2 turn(s) ago): openweight_frontier_release, safety_breakthrough, export_control_escalation, eu_frontier_access_denied, supply_chain_coercion
- Turn 11 (1 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, openweight_frontier_release, safety_breakthrough, eu_frontier_access_denied
