...
- characters 106-13230: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13273-13465: `{{metrics_json}}` from the run's live metric values
- characters 13558-14457: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14500-16306: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16362-17092: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Joint Threat Response and Treatment Continuity Cell | 2 |
