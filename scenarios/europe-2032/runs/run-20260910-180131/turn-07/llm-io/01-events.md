...
- characters 377-1509: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1553-4377: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4433-4956: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5019-28433: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28788-29276: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, safety_breakthrough, knowledge_work_augmented
- Turn 2 (5 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 3 (4 turn(s) ago): eu_frontier_access_denied
- Turn 4 (3 turn(s) ago): openweight_frontier_release
- Turn 5 (2 turn(s) ago): openweight_frontier_release, emergent_datacentre_siting_backlash, election_retrenchment
- Turn 6 (1 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, emergent_datacentre_power_backlash
