...
- characters 13261-14393: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14437-17261: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17317-18171: `{{notepad}}` from the Game Master's notepad, carried across turns
