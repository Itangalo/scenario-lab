...
- characters 13280-14420: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14464-16375: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16431-16780: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Continuity Fallback for Critical AI Dependencies | 2 |
