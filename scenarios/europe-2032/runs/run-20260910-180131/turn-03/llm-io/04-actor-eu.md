...
- characters 455-1595: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1639-3550: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4039-4515: `{{statement_ledger}}` from the actor's live statement ledger
- characters 5995-7194: `{{previous_actions}}` from the actor's own response from the previous turn
