...
- characters 455-1779: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1822-3552: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5539-5998: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8730-10859: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Deployed Assurance Adoption Programme | 5 | small | 9 | 11 | own jurisdiction | ai_safety up, resilience up slightly | 2 | running |
