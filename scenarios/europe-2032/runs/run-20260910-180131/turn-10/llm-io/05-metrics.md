...
- characters 13213-14537: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14580-16310: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16366-16827: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Deployed Assurance Adoption Programme | 2 |
| M10 | EU Cut-Off Continuity and Substitution Shield | 2 |
...
## Metrics
```json
{"ai_capability": 62.5, "openweight_capability": 61.0, "ai_safety": 43.0, "resilience": 44.0, "eu_ai_sovereignty": 24.0, "eu_political_capital": 16.0, "public_sentiment": 27.0}
```
## Narrative
### Cut off
