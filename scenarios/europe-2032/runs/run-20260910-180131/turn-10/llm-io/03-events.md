...
- characters 377-1701: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1744-3474: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3530-4674: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4737-28754: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29109-29884: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M9 EU Deployed Assurance Adoption Programme −2, priority −1 = −3
PROPOSAL BONUS: none — safety_breakthrough is a positive exogenous gain, not a negative event from last three rounds; export tightening not answered by this cat 5 measure
LEGITIMACY LENDS: capital 20, sentiment 32 -> +2
SOVEREIGNTY: 23 last turn, M1 InvestAI Gigafactories finishes t9 +4, no capacity in flight +0, export_control_escalation t9 −1, capability rose 0.5 −0 = 26

## Emerging developments (tracked)

- `emergent_insurer_certification_standard` -- first noted turn 8, listed in 2 turn(s) so far: Major EU reinsurers jointly publish a binding certification standard for autonomous financial and logistics agents, making external kill-switches and tamper-evident logging a de facto market requirement across member states.
- `emergent_insurer_certified_standard` -- first noted turn 8, listed in 2 turn(s) so far: European liability insurers jointly publish a temporary certified-agent standard with external stop and logging requirements, briefly unfreezing insurable deployments in ports and factoring while uncertified operators remain excluded.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, safety_breakthrough, knowledge_work_augmented
- Turn 2 (8 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 3 (7 turn(s) ago): eu_frontier_access_denied
- Turn 4 (6 turn(s) ago): openweight_frontier_release
- Turn 5 (5 turn(s) ago): openweight_frontier_release, emergent_datacentre_siting_backlash, election_retrenchment
- Turn 6 (4 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, emergent_datacentre_power_backlash
- Turn 7 (3 turn(s) ago): loss_of_control_incident, emergent_agent_liability_freeze
- Turn 8 (2 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, openweight_frontier_release
- Turn 9 (1 turn(s) ago): safety_breakthrough, knowledge_work_augmented, export_control_escalation
