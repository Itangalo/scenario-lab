...
- characters 455-2151: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2195-3992: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5517-5993: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8135-10103: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU Open-Weight Surge Shield Extension | 6 | small | 4 | 6 | own jurisdiction | resilience up, ai_safety up slightly via misuse detection | 2 | running |
