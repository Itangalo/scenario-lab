...
- characters 13684-15380: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15424-17221: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17277-18074: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 59.5, "openweight_capability": 53.5, "ai_safety": 38.0, "resilience": 37.5, "eu_ai_sovereignty": 20.0, "eu_political_capital": 24.0, "public_sentiment": 41.0}
```
