...
- characters 107-13360: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13403-13595: `{{metrics_json}}` from the run's live metric values
- characters 13688-15634: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15678-17793: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17849-18964: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Municipal Patch and Certified Recovery Network | 2 |
...
PORTFOLIO CHARGE t10: M9 EU Deployed Assurance Adoption Programme −2, M10 EU Cut-Off Continuity and Substitution Shield −2, priority −1 = −5
PROPOSAL BONUS: EU Cut-Off Continuity Shield (cat 6, small) +4 — eu_frontier_access_denied this turn, answers directly
LEGITIMACY LENDS: capital 16, sentiment 27 -> +2 (included in capital accounting, capped below sentiment)
SOVEREIGNTY: 26 last turn, no cat4 finish, no cat4 in flight +0, eu_frontier_access_denied t10 −2, capability rose 0.5 −0 = 24
...
## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M11", "fields": {"finish_turn": 12}, "grounds": "named priority"}]}
```
```
