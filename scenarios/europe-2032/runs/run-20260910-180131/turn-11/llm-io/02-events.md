...
- characters 378-2324: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2368-4483: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4539-5031: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5094-29111: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29466-30395: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, safety_breakthrough, knowledge_work_augmented
- Turn 2 (9 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 3 (8 turn(s) ago): eu_frontier_access_denied
- Turn 4 (7 turn(s) ago): openweight_frontier_release
- Turn 5 (6 turn(s) ago): openweight_frontier_release, emergent_datacentre_siting_backlash, election_retrenchment
- Turn 6 (5 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, emergent_datacentre_power_backlash
- Turn 7 (4 turn(s) ago): loss_of_control_incident, emergent_agent_liability_freeze
- Turn 8 (3 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, openweight_frontier_release
- Turn 9 (2 turn(s) ago): safety_breakthrough, knowledge_work_augmented, export_control_escalation
- Turn 10 (1 turn(s) ago): openweight_frontier_release, safety_breakthrough, export_control_escalation, eu_frontier_access_denied, supply_chain_coercion
