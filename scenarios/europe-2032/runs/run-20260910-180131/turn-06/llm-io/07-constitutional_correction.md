...
- characters 2729-3279: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 60.5, "openweight_capability": 56.5, "ai_safety": 31.0, "resilience": 40.5, "eu_ai_sovereignty": 20.0, "eu_political_capital": 22.0, "public_sentiment": 38.0}
```
