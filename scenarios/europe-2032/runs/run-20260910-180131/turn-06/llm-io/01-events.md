...
- characters 1809-4136: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4192-5054: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5117-26152: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26507-26882: `{{event_history}}` from the run's own event record
...
- `emergent_datacentre_power_backlash` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated local protests and grid-operator curtailments force a temporary moratorium on new data-centre connections in two EU member states, delaying EuroHPC and gigafactory ramp-up.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, safety_breakthrough, knowledge_work_augmented
- Turn 2 (4 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 3 (3 turn(s) ago): eu_frontier_access_denied
- Turn 4 (2 turn(s) ago): openweight_frontier_release
- Turn 5 (1 turn(s) ago): openweight_frontier_release, emergent_datacentre_siting_backlash, election_retrenchment
