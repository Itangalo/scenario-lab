...
- characters 1887-4214: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5652-6136: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8440-11038: `{{previous_actions}}` from the actor's own response from the previous turn
