...
- characters 1721-3756: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3812-4538: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4601-28015: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28370-28942: `{{event_history}}` from the run's own event record
...
- `emergent_agent_insurance_freeze` -- first noted turn 7, listed in 1 turn(s) so far: Insurers and banks impose an agent-liability surcharge after the invoice-agent incident, sharply raising premiums for firms deploying autonomous financial agents without certified kill-switches and logging.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, safety_breakthrough, knowledge_work_augmented
- Turn 2 (6 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 3 (5 turn(s) ago): eu_frontier_access_denied
- Turn 4 (4 turn(s) ago): openweight_frontier_release
- Turn 5 (3 turn(s) ago): openweight_frontier_release, emergent_datacentre_siting_backlash, election_retrenchment
- Turn 6 (2 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, emergent_datacentre_power_backlash
- Turn 7 (1 turn(s) ago): loss_of_control_incident, emergent_agent_liability_freeze
