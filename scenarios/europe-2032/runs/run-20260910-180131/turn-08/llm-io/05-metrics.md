...
- characters 105-13379: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13422-13614: `{{metrics_json}}` from the run's live metric values
- characters 13707-15009: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15052-17087: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17143-18221: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | EU Cyber Patch and Recovery Surge | 2 |
...
PORTFOLIO CHARGE t7: M1 InvestAI Gigafactories −3, M6 EU Trusted Supply and Partnership Diversification Compact −2, M7 EU Agent Containment and Escalation Protocol −2, priority −1 = −8
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 14, sentiment 38 -> +2
SOVEREIGNTY: 22 last turn, no capacity event, M1 Gigafactories in flight +1, capability rose 0.5 −0 = 23

## Emerging developments (tracked)

- `emergent_insurer_certification_standard` -- first noted turn 8, listed in 1 turn(s) so far: Major EU reinsurers jointly publish a binding certification standard for autonomous financial and logistics agents, making external kill-switches and tamper-evident logging a de facto market requirement across member states.
- `emergent_insurer_certified_standard` -- first noted turn 8, listed in 1 turn(s) so far: European liability insurers jointly publish a temporary certified-agent standard with external stop and logging requirements, briefly unfreezing insurable deployments in ports and factoring while uncertified operators remain excluded.
...
## Notepad
PORTFOLIO CHARGE t8: M1 InvestAI Gigafactories −3, M8 EU Cyber Patch and Recovery Surge −2, priority −1 = −6
PROPOSAL BONUS: EU Cyber Patch and Recovery Surge (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly, with breakthrough tooling window
LEGITIMACY LENDS: capital 20, sentiment 28 -> +2
SOVEREIGNTY: 23 last turn, no capacity event, M1 Gigafactories in flight +0, capability rose 0.5 −0 = 23

## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M8", "fields": {"finish_turn": 9}, "grounds": "named priority"}]}
```
```
