...
- characters 378-1365: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1409-3126: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3182-4029: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4092-27448: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27803-29068: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M12 EU Joint Threat Response and Treatment Continuity Cell −2, priority −1 = −3
PROPOSAL BONUS: EU Joint Threat Response and Treatment Continuity Cell (cat 6, small) +2 — eu_frontier_access_denied and ransomware pressure in last 3 turns, answers directly with borrowed protection
LEGITIMACY LENDS: capital 20, sentiment 18 -> none, capital higher
SOVEREIGNTY: 22 last turn, no cat4 finish, no cat4 in flight +0, eu_frontier_access_denied t12 −2 (largest capacity event; supply_chain_coercion also qualifies), capability rose 0.5 −0 = 20

## Emerging developments (tracked)

- `emergent_siting_moratoria_wave` -- first noted turn 11, listed in 2 turn(s) so far: Coordinated municipal moratoria on new compute siting spread after the February cut-off, with several councils pausing permits pending health-continuity guarantees.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, safety_breakthrough, knowledge_work_augmented
- Turn 2 (11 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 3 (10 turn(s) ago): eu_frontier_access_denied
- Turn 4 (9 turn(s) ago): openweight_frontier_release
- Turn 5 (8 turn(s) ago): openweight_frontier_release, emergent_datacentre_siting_backlash, election_retrenchment
- Turn 6 (7 turn(s) ago): loss_of_control_incident, knowledge_work_augmented, emergent_datacentre_power_backlash
- Turn 7 (6 turn(s) ago): loss_of_control_incident, emergent_agent_liability_freeze
- Turn 8 (5 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, openweight_frontier_release
- Turn 9 (4 turn(s) ago): safety_breakthrough, knowledge_work_augmented, export_control_escalation
- Turn 10 (3 turn(s) ago): openweight_frontier_release, safety_breakthrough, export_control_escalation, eu_frontier_access_denied, supply_chain_coercion
- Turn 11 (2 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, openweight_frontier_release, safety_breakthrough, eu_frontier_access_denied
- Turn 12 (1 turn(s) ago): medical_breakthrough, labour_displacement, eu_frontier_access_denied, supply_chain_coercion, joint_threat_response, emergent_dutch_lithography_standoff
