...
- characters 12940-13132: `{{metrics_json}}` from the run's live metric values
- characters 13225-14212: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14256-15973: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16029-16587: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M13 | EU Certified Substitute Assurance Rollout | 2 |
