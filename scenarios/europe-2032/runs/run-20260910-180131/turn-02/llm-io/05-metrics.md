...
- characters 105-12885: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12928-13120: `{{metrics_json}}` from the run's live metric values
- characters 13213-14099: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14142-16132: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16188-17230: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_datacentre_permit_freeze` -- first noted turn 1, listed in 2 turn(s) so far: Coordinated municipal moratoriums and grid-connection refusals stall several hyperscale data-centre projects in the EU after power-price protests, without any EU-level decision.
...
## Notepad
PORTFOLIO CHARGE t2: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Infrastructure Shield −3, priority −1 = −10
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 34, sentiment 47 -> +1
SOVEREIGNTY: 22 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 22
