...
- characters 1665-3691: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3747-4262: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4325-26660: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27015-27222: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, safety_breakthrough, knowledge_work_augmented
- Turn 2 (2 turn(s) ago): safety_breakthrough, taiwan_tension_rise
- Turn 3 (1 turn(s) ago): eu_frontier_access_denied
