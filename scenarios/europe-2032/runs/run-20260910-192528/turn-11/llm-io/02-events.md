...
- characters 378-1472: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1516-3690: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3746-4769: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4832-30835: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31190-32209: `{{event_history}}` from the run's own event record
...
- `emergent_backstop_town_revolt` -- first noted turn 10, listed in 1 turn(s) so far: Several backstop towns jointly refuse further clean-rebuild conditions, arguing premiums and drill requirements are fiscally unsustainable, threatening fragmentation of the EU municipal continuity scheme.
- `emergent_care_standard_revolt` -- first noted turn 10, listed in 1 turn(s) so far: Backstop towns that drilled isolation publish triage survival data, prompting a patient-led movement demanding the same offline-care standards nationally and shaming undrilled hospital boards.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, capability_jump, taiwan_tension_rise
- Turn 2 (9 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, adoption_success
- Turn 3 (8 turn(s) ago): cyber_major_incident, loss_of_control_incident, emergent_datacentre_siting_backlash
- Turn 4 (7 turn(s) ago): cyber_major_incident, eval_anomaly_reports, joint_threat_response
- Turn 5 (6 turn(s) ago): bio_uplift_findings, openweight_frontier_release, labour_displacement, knowledge_work_augmented, emergent_municipal_cyber_insurance_retreat, emergent_ransomware_access_resale, election_alliance
- Turn 6 (5 turn(s) ago): loss_of_control_incident, safety_breakthrough
- Turn 7 (4 turn(s) ago): ai_investment_collapse, opaque_reasoning, member_state_defection
- Turn 8 (3 turn(s) ago): bio_incident, emergent_allied_evaluation_backlash
- Turn 9 (2 turn(s) ago): openweight_frontier_release, emergent_insurance_pool_hardening
- Turn 10 (1 turn(s) ago): cyber_major_incident, capability_jump
