...
- characters 377-2087: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2131-4532: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4588-5324: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5387-30537: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30892-31756: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, capability_jump, taiwan_tension_rise
- Turn 2 (7 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, adoption_success
- Turn 3 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident, emergent_datacentre_siting_backlash
- Turn 4 (5 turn(s) ago): cyber_major_incident, eval_anomaly_reports, joint_threat_response
- Turn 5 (4 turn(s) ago): bio_uplift_findings, openweight_frontier_release, labour_displacement, knowledge_work_augmented, emergent_municipal_cyber_insurance_retreat, emergent_ransomware_access_resale, election_alliance
- Turn 6 (3 turn(s) ago): loss_of_control_incident, safety_breakthrough
- Turn 7 (2 turn(s) ago): ai_investment_collapse, opaque_reasoning, member_state_defection
- Turn 8 (1 turn(s) ago): bio_incident, emergent_allied_evaluation_backlash
