...
- characters 455-2165: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2209-4610: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5266-5766: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8487-10347: `{{previous_actions}}` from the actor's own response from the previous turn
