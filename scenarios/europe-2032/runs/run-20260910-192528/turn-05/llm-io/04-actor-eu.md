...
- characters 455-1507: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1551-3498: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7309-7777: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10020-11756: `{{previous_actions}}` from the actor's own response from the previous turn
