...
- characters 13688-14740: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14784-16731: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16787-17202: `{{notepad}}` from the Game Master's notepad, carried across turns
