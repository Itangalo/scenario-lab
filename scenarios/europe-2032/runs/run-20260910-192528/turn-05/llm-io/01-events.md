...
- characters 377-1429: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1473-3420: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3476-4527: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4590-33075: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33430-33835: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Joint Cyber Shield Accession −2, priority −1 = −9
PROPOSAL BONUS: EU Joint Cyber Shield Accession (cat 8, small) +3 — cyber_major_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 22, sentiment 35 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, Gigafactories in flight +0, capability rose 2.0 −1 = 18

## Emerging developments (tracked)

- `emergent_municipal_cyber_insurance_retreat` -- first noted turn 4, listed in 1 turn(s) so far: Major cyber-insurers suspend or cap municipal and hospital ransomware cover across several member states after the wave, citing unmodelled AI-assisted loss, forcing emergency state backstops.
- `emergent_ransomware_access_resale` -- first noted turn 4, listed in 1 turn(s) so far: Criminal brokers begin openly auctioning persistent access to unrecovered municipal and hospital networks hit in the winter ransomware wave, creating a standing secondary extortion market outside the original attackers.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, capability_jump, taiwan_tension_rise
- Turn 2 (3 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, adoption_success
- Turn 3 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, emergent_datacentre_siting_backlash
- Turn 4 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, joint_threat_response
