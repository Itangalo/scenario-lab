...
- characters 105-13526: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13569-13761: `{{metrics_json}}` from the run's live metric values
- characters 13854-15174: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15217-17363: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17419-18580: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Joint Cyber Shield Accession | 2 |
...
## Metrics
```json
{"ai_capability": 60.0, "openweight_capability": 55.4, "ai_safety": 20.0, "resilience": 48.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 24.0, "public_sentiment": 35.0}
```
## Narrative
