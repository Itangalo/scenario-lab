...
- characters 455-2230: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2273-4144: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5082-5559: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8428-10755: `{{previous_actions}}` from the actor's own response from the previous turn
