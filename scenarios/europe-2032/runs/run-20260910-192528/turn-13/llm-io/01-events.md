...
- characters 1574-3481: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3537-3974: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4037-28534: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28889-30107: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, capability_jump, taiwan_tension_rise
- Turn 2 (11 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, adoption_success
- Turn 3 (10 turn(s) ago): cyber_major_incident, loss_of_control_incident, emergent_datacentre_siting_backlash
- Turn 4 (9 turn(s) ago): cyber_major_incident, eval_anomaly_reports, joint_threat_response
- Turn 5 (8 turn(s) ago): bio_uplift_findings, openweight_frontier_release, labour_displacement, knowledge_work_augmented, emergent_municipal_cyber_insurance_retreat, emergent_ransomware_access_resale, election_alliance
- Turn 6 (7 turn(s) ago): loss_of_control_incident, safety_breakthrough
- Turn 7 (6 turn(s) ago): ai_investment_collapse, opaque_reasoning, member_state_defection
- Turn 8 (5 turn(s) ago): bio_incident, emergent_allied_evaluation_backlash
- Turn 9 (4 turn(s) ago): openweight_frontier_release, emergent_insurance_pool_hardening
- Turn 10 (3 turn(s) ago): cyber_major_incident, capability_jump
- Turn 11 (2 turn(s) ago): capability_jump, us_china_agreement, eu_frontier_access_denied, emergent_care_standard_revolt
