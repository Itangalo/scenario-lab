...
- characters 455-1608: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1652-3559: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3939-4416: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7788-9869: `{{previous_actions}}` from the actor's own response from the previous turn
...
- `two_year_commitment` (commitment): Hold biological containment and essential-service continuity through unrecallable open-model diffusion
...
| M3 | EU Grid and Port Cyber Hardening Shield | 6 | large | 1 | 3 | own jurisdiction | resilience up substantially, ai_safety up slightly via incident learning | 3 | finished |
| M4 | EU Agentic Systems Evaluation and Containment Regime | 1 | large | 2 | 4 | own jurisdiction | ai_safety up substantially, resilience up slightly via containment | 3 | finished |
| M5 | EU Essential Services Continuity Shield | 6 | small | 3 | 4 | own jurisdiction | resilience up substantially | 2 | finished |
| M6 | EU Joint Cyber Shield Accession | 8 | small | 4 | 5 | own jurisdiction | resilience up moderately | 2 | finished |
| M7 | Municipal Hospital Cyber Backstop and Clean Rebuild Facility | 6 | small | 5 | 7 | own jurisdiction | resilience up moderately | 2 | finished |
| M8 | EU Deployed Assurance Uptake and Loss-of-Control Containment Protocol | 5 | small | 6 | 8 | own jurisdiction | ai_safety up moderately, resilience up slightly | 2 | finished |
| M9 | EU Essential Services Manual Fallback and Offline Continuity Corps | 6 | small | 7 | 9 | own jurisdiction | resilience up moderately | 2 | finished |
| M10 | EU Biological Detection and Containment Surge | 6 | small | 8 | 9 | own jurisdiction | resilience up moderately | 2 | finished |
| M11 | EU Bio-Detection and Municipal Continuity Consolidation | 6 | small | 9 | 10 | own jurisdiction | resilience up moderately | 2 | finished |
| M12 | EU Automated Attack Containment and Service Isolation Drive | 6 | small | 10 | 11 | own jurisdiction | resilience up moderately | 2 | finished |
| M13 | EU Offline-Care Guarantee and Cutoff Substitution Facility | 6 | small | 11 | 12 | own jurisdiction | resilience up moderately | 2 | finished |
| M14 | EU Swarm Defence Deployment and Municipal Recovery Surge | 6 | small | 12 | 13 | own jurisdiction | resilience up substantially, ai_safety up slightly via incident learning | 2 | finished |
...
## New measure
**EU Swarm Defence Deployment and Municipal Recovery Surge**
Rolls the patch-at-speed and swarm-detection breakthrough into drilled municipal health, grids and ports via ENISA-coordinated deployment while surging recovery to services hit by the automated attack.
This is Preparedness and resilience work, and it must come now because the large automated incident proves offence still lands first while the defensive breakthrough gives drilled isolation something it lacked — a way to close the gap for a whole attack class before the next sweep.

## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Swarm Defence Deployment and Municipal Recovery Surge", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up substantially, ai_safety up slightly via incident learning"}, "grounds": "automated attack damage plus first real defensive breakthrough"}]}
```

## Priority
EU Swarm Defence Deployment and Municipal Recovery Surge, because containing the ongoing automated incident and making the breakthrough land in drilled towns outranks all else this turn and without it the two-year commitment to hold essential-service continuity fails.

## In practice
We act under NIS2 and civil-protection crisis powers with ENISA and the Health Emergency Preparedness and Response Authority: EU Cybersecurity Reserve and EU4Health co-funding pays for automated patching and swarm-detection rollout to drilled hospitals, municipal administration, grids and ports, tied to the existing drilled-isolation proof and continuity-team funding so degraded-not-stopped becomes patched-and-recovering.

We do not reopen the US frontier-internals fight or promise universal offline-care overnight; DigitalEurope re-routes cut-off clinical workloads to EU-anchored inference where hardened, finance ministers hold the backstop for uninsurable recovery costs, and mayors get recovery crews and stocks now in exchange for accepting the new detection telemetry and resource-buying limits.
...
```
## New measure
**EU Drilled Continuity Mutual-Aid and Anti-Defection Hold**
Binds drilled continuity funding, recovery crews and EU-anchored inference access to common procurement and no-side-deal discipline to stop the defection from hollowing out essential-service continuity and biological detection.
This is Preparedness and resilience work with an International coordination and leverage edge, and it must come now because a single member-state side arrangement on hyperscaler / Washington / Beijing terms would re-fragment telemetry, patching and isolation proof just as the swarm-defence gains need universal hold to meet the two-year commitment.

## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Drilled Continuity Mutual-Aid and Anti-Defection Hold", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately"}, "grounds": "member-state defection threatening common continuity and containment hold"}]}
```

## Priority
EU Drilled Continuity Mutual-Aid and Anti-Defection Hold, because without holding the common line the two-year commitment to hold biological containment and essential-service continuity through open-model diffusion fails first politically, not technically.

## In practice
We act in the General Affairs and ECOFIN formations with ENISA, HERA and DG CNECT: continuity-team funding, Cybersecurity Reserve deployments and the cutoff-substitution inference quota are renewed only for common-procurement compliance, acceptance of swarm-detection telemetry and isolation proof, with finance-ministers' backstop for uninsurable costs channelled through the facility, not bilateral deals.

We offer the defecting capital pragmatism inside the Union — accelerated recovery crews, stocks and degraded EU inference capacity — in exchange for withdrawing terms that undercut EU supply-chain leverage and sensor coverage, making clear that side access bought by splitting telemetry and buying limits re-invites the February sweep pattern. No new fight on US model internals, no promise of universal offline care; just drilled-not-stopped held as a Union standard that cannot be opted out of deal by deal.
