...
- characters 107-13362: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13405-13596: `{{metrics_json}}` from the run's live metric values
- characters 13689-14842: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14886-16793: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16849-17286: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M15 | EU Drilled Continuity Mutual-Aid and Anti-Defection Hold | 2 |
...
## Notepad
PORTFOLIO CHARGE t13: EU Drilled Continuity Mutual-Aid and Anti-Defection Hold −2, priority −1 = −3
PROPOSAL BONUS: EU Drilled Continuity Mutual-Aid and Anti-Defection Hold (cat 6, small) +2 — member_state_defection this turn answered directly
LEGITIMACY LENDS: capital 25, sentiment 8 -> none
SOVEREIGNTY: 18 last turn, no capacity event? member_state_defection t13 −2, no cat 4 in flight +0, capability rose 0.8 −0 = 16
