...
- characters 454-1531: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1574-3604: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4456-4933: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8107-10041: `{{previous_actions}}` from the actor's own response from the previous turn
