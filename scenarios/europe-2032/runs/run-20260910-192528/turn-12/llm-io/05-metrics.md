...
- characters 106-13315: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13358-13549: `{{metrics_json}}` from the run's live metric values
- characters 13642-14719: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14762-16792: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16848-17346: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Swarm Defence Deployment and Municipal Recovery Surge | 2 |
...
## Metrics
```json
{"ai_capability": 68.0, "openweight_capability": 66.1, "ai_safety": 6.0, "resilience": 63.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 30.0, "public_sentiment": 10.0}
```
...
## Notepad
PORTFOLIO CHARGE t12: EU Swarm Defence Deployment and Municipal Recovery Surge −2, priority −1 = −3
PROPOSAL BONUS: EU Swarm Defence Deployment and Municipal Recovery Surge (cat 6, small) +4 — cyber_major_incident this turn answered directly plus defensive breakthrough makes it actionable
LEGITIMACY LENDS: capital 26, sentiment 12 -> none
SOVEREIGNTY: 18 last turn, no capacity event, no cat 4 in flight +0, capability rose 0.8 −0 = 18
