...
- characters 376-1453: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1496-3526: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3582-4408: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4471-28968: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29323-30464: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Offline-Care Guarantee and Cutoff Substitution Facility −2, priority −1 = −3
PROPOSAL BONUS: EU Offline-Care Guarantee and Cutoff Substitution Facility (cat 6, small) +4 — eu_frontier_access_denied this turn plus care-standard revolt and automated sweep in last three turns answered directly
LEGITIMACY LENDS: capital 25, sentiment 16 -> none
SOVEREIGNTY: 21 last turn, no capacity event, no cat 4 in flight +0, eu_frontier_access_denied t11 −3, capability rose 1.0 −0 = 18

## Emerging developments (tracked)

- `emergent_backstop_town_revolt` -- first noted turn 10, listed in 2 turn(s) so far: Several backstop towns jointly refuse further clean-rebuild conditions, arguing premiums and drill requirements are fiscally unsustainable, threatening fragmentation of the EU municipal continuity scheme.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, capability_jump, taiwan_tension_rise
- Turn 2 (10 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, adoption_success
- Turn 3 (9 turn(s) ago): cyber_major_incident, loss_of_control_incident, emergent_datacentre_siting_backlash
- Turn 4 (8 turn(s) ago): cyber_major_incident, eval_anomaly_reports, joint_threat_response
- Turn 5 (7 turn(s) ago): bio_uplift_findings, openweight_frontier_release, labour_displacement, knowledge_work_augmented, emergent_municipal_cyber_insurance_retreat, emergent_ransomware_access_resale, election_alliance
- Turn 6 (6 turn(s) ago): loss_of_control_incident, safety_breakthrough
- Turn 7 (5 turn(s) ago): ai_investment_collapse, opaque_reasoning, member_state_defection
- Turn 8 (4 turn(s) ago): bio_incident, emergent_allied_evaluation_backlash
- Turn 9 (3 turn(s) ago): openweight_frontier_release, emergent_insurance_pool_hardening
- Turn 10 (2 turn(s) ago): cyber_major_incident, capability_jump
- Turn 11 (1 turn(s) ago): capability_jump, us_china_agreement, eu_frontier_access_denied, emergent_care_standard_revolt
