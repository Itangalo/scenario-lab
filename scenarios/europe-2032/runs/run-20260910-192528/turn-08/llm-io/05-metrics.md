...
- characters 13739-15647: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15690-18749: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18805-19642: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Biological Detection and Containment Surge | 2 |
...
- `emergent_insurance_pool_hardening` -- first noted turn 7, listed in 2 turn(s) so far: Municipal insurers form a pooled exclusion facility that permanently prices AI-assisted intrusion as uninsurable, forcing extended reliance on the EU backstop.
...
## Notepad
PORTFOLIO CHARGE t8: EU Essential Services Manual Fallback and Offline Continuity Corps −2, EU Biological Detection and Containment Surge −2, priority −1 = −5
PROPOSAL BONUS: EU Biological Detection and Containment Surge (cat 6, small) +4 — real bio incident with casualties this turn answered directly
LEGITIMACY LENDS: capital 21, sentiment 19 -> none
SOVEREIGNTY: 21 last turn, no capacity event, no cat 4 in flight +0, capability rose 1.0 −0 = 21
