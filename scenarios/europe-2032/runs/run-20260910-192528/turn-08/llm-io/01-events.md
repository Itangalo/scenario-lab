...
- characters 376-2284: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2327-5386: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5442-6623: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6686-32648: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33003-33791: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, capability_jump, taiwan_tension_rise
- Turn 2 (6 turn(s) ago): loss_of_control_incident, openweight_frontier_release, knowledge_work_augmented, adoption_success
- Turn 3 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, emergent_datacentre_siting_backlash
- Turn 4 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, joint_threat_response
- Turn 5 (3 turn(s) ago): bio_uplift_findings, openweight_frontier_release, labour_displacement, knowledge_work_augmented, emergent_municipal_cyber_insurance_retreat, emergent_ransomware_access_resale, election_alliance
- Turn 6 (2 turn(s) ago): loss_of_control_incident, safety_breakthrough
- Turn 7 (1 turn(s) ago): ai_investment_collapse, opaque_reasoning, member_state_defection
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.36}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.16}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.08}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.05}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.14}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.16}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.05}, {"description": "Municipal insurers form a pooled exclusion facility that permanently prices AI-assisted intrusion as uninsurable, forcing extended reliance on the EU backstop.", "emergent": true, "id": "emergent_insurance_pool_hardening", "probability": 0.18}, {"description": "US frontier vendors publicly dispute the joint-evaluation and incident-reporting terms offered by Washington, warning that full internals access for allies would compromise trade secrets and slow releases, putting cheap allied access renewals in doubt.", "emergent": true, "id": "emergent_allied_evaluation_backlash", "probability": 0.22}]
```
