...
- characters 13790-15566: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15610-18360: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18416-18991: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Essential Services Continuity Shield | 2 |
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 52.8, "ai_safety": 21.0, "resilience": 42.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 18.0, "public_sentiment": 39.0}
```
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Agentic Systems Evaluation and Containment Regime −3, EU Essential Services Continuity Shield −2, priority −1 = −12
PROPOSAL BONUS: EU Essential Services Continuity Shield (cat 6, small) +2 — cyber_major_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 18, sentiment 39 -> +2 (capped, applied after other terms)
