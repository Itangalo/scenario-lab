...
- characters 455-2394: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2438-4973: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6236-6736: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9314-11601: `{{previous_actions}}` from the actor's own response from the previous turn
