...
- characters 106-13130: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13173-13365: `{{metrics_json}}` from the run's live metric values
- characters 13458-14872: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14916-16880: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16936-17369: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 53.0, "ai_safety": 35.0, "resilience": 36.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 15.0, "public_sentiment": 40.0}
```
