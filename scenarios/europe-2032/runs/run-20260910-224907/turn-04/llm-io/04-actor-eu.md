...
- characters 2141-3657: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4146-4618: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6577-7862: `{{previous_actions}}` from the actor's own response from the previous turn
