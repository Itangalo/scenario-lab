...
- characters 376-1178: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1222-3175: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3231-4358: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4421-32906: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33261-33484: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Deployed Assurance Uptake −2, EU Fallback Stack −2, priority −1 = −11
PROPOSAL BONUS: EU Fallback Stack (cat 4, small) +4 — eu_frontier_access_denied landed this turn and this answers it directly as emergency substitution
LEGITIMACY LENDS: capital 5, sentiment 34 -> +2
SOVEREIGNTY: 19 last turn, no capacity build finishes, Gigafactories in flight +0, eu_frontier_access_denied t4 −3, capability rose 2.0 −1 = 15

## Emerging developments (tracked)

- `emergent_permit_injunction_freeze` -- first noted turn 4, listed in 1 turn(s) so far: A national administrative court grants an interim injunction freezing grid-connection permits for two contested gigafactory sites after farmer and municipal challenges, pushing final investment decisions past mid-2028.
- `emergent_drought_power_squeeze` -- first noted turn 4, listed in 1 turn(s) so far: A dry winter and spring cut hydro output and constrain cooling water for thermal and nuclear plants in southern Europe, spiking power prices and hardening local opposition to new large grid connections.
...
- Turn 2 (3 turn(s) ago): safety_breakthrough
- Turn 3 (2 turn(s) ago): taiwan_tension_rise, emergent_gigafactory_siting_backlash
