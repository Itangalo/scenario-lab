...
- characters 2901-3302: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3 = −6 (named priority M1 has no effect and no cost as capital below 20)
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 9, sentiment 37 -> +2
SOVEREIGNTY: 15 last turn, EU Fallback Stack finishes t5 +4, Gigafactories in flight +0, export_control_escalation t5 −2, capability rose 1.0 −0 = 17
