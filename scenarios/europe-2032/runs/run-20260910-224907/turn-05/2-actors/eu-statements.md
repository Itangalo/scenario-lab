...
- `two_year_commitment` (commitment): Secure independent AI capacity and resilient essential services against coercion and disruption

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure independent AI capacity and resilient essential services against coercion and disruption
