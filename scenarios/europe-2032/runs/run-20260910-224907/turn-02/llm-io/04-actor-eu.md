...
- characters 4195-4667: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6139-8266: `{{previous_actions}}` from the actor's own response from the previous turn
