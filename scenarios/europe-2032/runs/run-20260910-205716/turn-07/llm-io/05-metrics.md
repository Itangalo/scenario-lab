...
- characters 106-13502: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13545-13736: `{{metrics_json}}` from the run's live metric values
- characters 13829-14986: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15030-17997: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18053-18602: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Middle-Power AI Access Coalition | 2 |
| M9 | EU Logistics Worker Transition Shield | 2 |
