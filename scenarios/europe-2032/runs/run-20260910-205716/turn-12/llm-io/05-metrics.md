...
- characters 106-13442: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13485-13676: `{{metrics_json}}` from the run's live metric values
- characters 13769-14996: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15039-17153: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17209-17633: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Screening Enforcement Closure | 2 |
