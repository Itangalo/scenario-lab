...
- characters 1646-3760: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3816-4541: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- characters 32425-33193: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, capability_jump, bio_uplift_findings, eval_anomaly_reports
- Turn 2 (10 turn(s) ago): capability_jump
- Turn 3 (9 turn(s) ago): emergent_synthetic_fraud_wave, emergent_open_toolkit_takedown
- Turn 4 (8 turn(s) ago): ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented, member_state_defection
- Turn 5 (7 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, election_consolidation
- Turn 6 (6 turn(s) ago): embodied_ai_deployment, middle_power_coalition, emergent_fraud_auth_mandate
- Turn 8 (4 turn(s) ago): bio_uplift_findings
- Turn 10 (2 turn(s) ago): eval_anomaly_reports
- Turn 11 (1 turn(s) ago): loss_of_control_incident, labour_displacement, knowledge_work_augmented, taiwan_tension_rise
