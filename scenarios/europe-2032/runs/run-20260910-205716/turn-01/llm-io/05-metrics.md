...
- characters 16352-16681: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_synthetic_fraud_wave` -- first noted turn 1, listed in 1 turn(s) so far: A coordinated wave of AI-generated voice and video fraud hits banks and public administrations in several member states in autumn 2026, causing nine-figure losses and forcing emergency authentication changes.
...
PROPOSAL BONUS: EU Critical Infrastructure Cyber Shield (cat 6, large) +4 — cyber_test_shot severe cross-sector intrusion this turn and this answers it directly
LEGITIMACY LENDS: capital 36, sentiment 40 -> +1
SOVEREIGNTY: 22 last turn, no capacity event, no in-flight bonus yet, capability rose 2.0 −1 = 21
## Store changes
```json
