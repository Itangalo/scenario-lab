...
- characters 106-13441: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13484-13676: `{{metrics_json}}` from the run's live metric values
- characters 13769-15398: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15442-17535: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17591-18065: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU OT Rapid Reaction Reserve | 2 |
| M5 | EU Bank-and-State Authentication Hardening | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Cyber Shield −3, EU OT Rapid Reaction Reserve −2, priority −1 = −12
PROPOSAL BONUS: EU OT Rapid Reaction Reserve (cat 6, small) +2 — answers severe autumn cross-sector intrusion plus this turn's sharp cyber advance directly
LEGITIMACY LENDS: capital 27, sentiment 39 -> +2
SOVEREIGNTY: 21 last turn, no capacity event, no in-flight bonus yet, capability rose 1.5 −0 = 21
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU OT Rapid Reaction Reserve −2, EU Bank-and-State Authentication Hardening −2, priority −1 = −11
PROPOSAL BONUS: EU Bank-and-State Authentication Hardening (cat 9, small) +3 — answers severe autumn nine-figure fraud wave directly this turn
LEGITIMACY LENDS: capital 27, sentiment 35 -> +2
SOVEREIGNTY: 21 last turn, no capacity event, no cat4 finish, in-flight +0, capability rose 2.0 −1 = 20
