...
- characters 376-1836: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1879-3775: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3831-4485: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4548-32014: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32369-32967: `{{event_history}}` from the run's own event record
...
- `emergent_logistics_blockade_escalation` -- first noted turn 8, listed in 2 turn(s) so far: A coordinated wildcat blockade of parcel hubs by logistics workers spreads to two ports after a humanoid-related injury, halting freight for days.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, capability_jump, bio_uplift_findings, eval_anomaly_reports
- Turn 2 (8 turn(s) ago): capability_jump
- Turn 3 (7 turn(s) ago): emergent_synthetic_fraud_wave, emergent_open_toolkit_takedown
- Turn 4 (6 turn(s) ago): ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented, member_state_defection
- Turn 5 (5 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, election_consolidation
- Turn 6 (4 turn(s) ago): embodied_ai_deployment, middle_power_coalition, emergent_fraud_auth_mandate
- Turn 8 (2 turn(s) ago): bio_uplift_findings
