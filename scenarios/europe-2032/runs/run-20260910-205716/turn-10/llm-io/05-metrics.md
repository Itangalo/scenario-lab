...
- characters 13013-13204: `{{metrics_json}}` from the run's live metric values
- characters 13297-14757: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14800-16696: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16752-17128: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Essential Services Continuity Pact | 2 |
...
PORTFOLIO CHARGE t9: EU Essential Services Continuity Pact −2, priority −1 = −3
PROPOSAL BONUS: none — no external event in last three turns that Continuity Pact answers; portfolio completions are not bonus events
LEGITIMACY LENDS: capital 19, sentiment 26 -> +2
...
## Metrics
```json
{"ai_capability": 66.0, "openweight_capability": 64.0, "ai_safety": 1.0, "resilience": 51.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 21.0, "public_sentiment": 28.0}
```
