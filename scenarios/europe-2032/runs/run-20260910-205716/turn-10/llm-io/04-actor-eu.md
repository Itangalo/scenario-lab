...
- characters 1957-3853: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4480-4962: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8032-10240: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Essential Services Continuity Pact | 6 | small | 9 | 11 | own jurisdiction | resilience up substantially, eu_political_capital up slightly, public_sentiment up slightly | 2 | running |
