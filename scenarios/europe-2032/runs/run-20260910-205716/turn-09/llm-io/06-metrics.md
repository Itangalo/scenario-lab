...
- characters 106-13497: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13540-13731: `{{metrics_json}}` from the run's live metric values
- characters 13824-15063: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15107-18412: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18468-19226: `{{notepad}}` from the Game Master's notepad, carried across turns
