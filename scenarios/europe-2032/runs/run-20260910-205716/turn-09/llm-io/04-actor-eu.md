...
- characters 454-1693: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1737-5042: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5110-5605: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8327-9983: `{{previous_actions}}` from the actor's own response from the previous turn
