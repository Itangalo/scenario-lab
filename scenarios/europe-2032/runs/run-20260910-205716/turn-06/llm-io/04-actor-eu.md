...
- characters 454-1523: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1566-3662: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5632-6093: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8464-10551: `{{previous_actions}}` from the actor's own response from the previous turn
