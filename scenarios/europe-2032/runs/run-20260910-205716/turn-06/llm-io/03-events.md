...
- characters 376-1445: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1488-3584: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3640-4774: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4837-30847: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31202-31652: `{{event_history}}` from the run's own event record
...
- `emergent_fraud_auth_mandate` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated EU telecom regulators impose emergency real-time voice-video authentication mandates on banks and public call centres after the autumn fraud wave, briefly restoring trust before fraud kits adapt.
- `emergent_telecom_voice_freeze` -- first noted turn 4, listed in 2 turn(s) so far: Major European telecom operators unilaterally throttle or suspend cross-border voice and video interconnection after repeated AI-cloned fraud waves, disrupting legitimate call centres, banks and emergency helplines for weeks.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, capability_jump, bio_uplift_findings, eval_anomaly_reports
- Turn 2 (4 turn(s) ago): capability_jump
- Turn 3 (3 turn(s) ago): emergent_synthetic_fraud_wave, emergent_open_toolkit_takedown
- Turn 4 (2 turn(s) ago): ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented, member_state_defection
