...
- characters 105-13382: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13425-13617: `{{metrics_json}}` from the run's live metric values
- characters 13710-14864: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14907-16873: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16929-18038: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Bio Shield Detection Surge | 2 |
