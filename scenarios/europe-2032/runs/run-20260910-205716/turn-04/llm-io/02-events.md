...
- characters 376-1530: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1573-3539: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3595-4065: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4128-28355: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28710-28941: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, capability_jump, bio_uplift_findings, eval_anomaly_reports
- Turn 2 (2 turn(s) ago): capability_jump
- Turn 3 (1 turn(s) ago): emergent_synthetic_fraud_wave, emergent_open_toolkit_takedown
