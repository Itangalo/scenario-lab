...
- characters 13384-13575: `{{metrics_json}}` from the run's live metric values
- characters 13668-14845: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14888-17223: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17279-18043: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Bio-Uplift Containment Surge | 2 |
