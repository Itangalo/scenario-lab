...
- characters 375-1552: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1595-3930: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3986-4472: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4535-31148: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31503-32055: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, capability_jump, bio_uplift_findings, eval_anomaly_reports
- Turn 2 (6 turn(s) ago): capability_jump
- Turn 3 (5 turn(s) ago): emergent_synthetic_fraud_wave, emergent_open_toolkit_takedown
- Turn 4 (4 turn(s) ago): ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented, member_state_defection
- Turn 5 (3 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, election_consolidation
- Turn 6 (2 turn(s) ago): embodied_ai_deployment, middle_power_coalition, emergent_fraud_auth_mandate
