...
- characters 377-1554: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1598-3742: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3798-4923: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4986-29296: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29651-30002: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Bank-and-State Authentication Hardening −2, EU Bio Shield Detection Surge −2, priority −1 = −11
PROPOSAL BONUS: none — new Bio Surge answers precursor this turn, and productivity evidence removes bonus case for spending against unfelt problem
LEGITIMACY LENDS: capital 17, sentiment 37 -> +2
SOVEREIGNTY: 20 last turn, no cat4 finish, in-flight +0, member_state_defection t4 −2, capability rose 1.5 −0 = 18

## Emerging developments (tracked)

- `emergent_fraud_auth_mandate` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated EU telecom regulators impose emergency real-time voice-video authentication mandates on banks and public call centres after the autumn fraud wave, briefly restoring trust before fraud kits adapt.
- `emergent_telecom_voice_freeze` -- first noted turn 4, listed in 1 turn(s) so far: Major European telecom operators unilaterally throttle or suspend cross-border voice and video interconnection after repeated AI-cloned fraud waves, disrupting legitimate call centres, banks and emergency helplines for weeks.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, capability_jump, bio_uplift_findings, eval_anomaly_reports
- Turn 2 (3 turn(s) ago): capability_jump
- Turn 3 (2 turn(s) ago): emergent_synthetic_fraud_wave, emergent_open_toolkit_takedown
- Turn 4 (1 turn(s) ago): ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented, member_state_defection
