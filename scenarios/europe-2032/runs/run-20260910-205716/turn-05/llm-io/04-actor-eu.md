...
- characters 1676-3820: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5499-5965: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8202-10177: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Bio Shield Detection Surge | 6 | small | 4 | 7 | own jurisdiction | resilience up moderately, ai_safety up slightly via misuse detection | 2 | running |
