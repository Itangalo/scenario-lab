...
- characters 107-13309: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13352-13543: `{{metrics_json}}` from the run's live metric values
- characters 13636-15062: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15106-17124: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17180-18090: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M15 | EU Assured Systems Upgrade | 2 |
...
PORTFOLIO CHARGE t12: EU Screening Enforcement Closure −2, priority −1 = −3
PROPOSAL BONUS: EU Screening Enforcement Closure (cat 6, small) +3 — Swiss affiliate rerouting landed this turn and this answers it directly
LEGITIMACY LENDS: capital 21, sentiment 17 -> none, capital higher
SOVEREIGNTY: 17 last turn, no cat4 finishes, no cat4 in flight +0, no capacity event, capability rose 1.0 −0 = 17

## Emerging developments (tracked)

- `emergent_swiss_screening_closure` -- first noted turn 13, listed in 1 turn(s) so far: Bern and Europol close the Swiss affiliate loophole with a fee-funded screening pact, ending rerouted EU DNA orders within the turn.
- `emergent_swiss_audit_freeze` -- first noted turn 13, listed in 1 turn(s) so far: Swiss cantonal court suspends Europol joint audit access to affiliate order data on jurisdictional grounds, freezing the HERA screening enforcement track pending appeal.
...
## Notepad
PORTFOLIO CHARGE t13: EU Assured Systems Upgrade −2, priority −1 = −3
PROPOSAL BONUS: none — EU Assured Systems Upgrade (cat 5, small) adopts a positive breakthrough, answers no negative event from last three turns
LEGITIMACY LENDS: capital 15, sentiment 14 -> none, capital higher
SOVEREIGNTY: 17 last turn, no cat4 finishes, no cat4 in flight +0, supply_chain_coercion t13 −3, capability rose 0.5 −0 = 14
