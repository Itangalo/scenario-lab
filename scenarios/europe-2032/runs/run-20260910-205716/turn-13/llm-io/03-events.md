...
- characters 377-1803: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1847-3865: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3921-4318: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4381-31847: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32202-33027: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, capability_jump, bio_uplift_findings, eval_anomaly_reports
- Turn 2 (11 turn(s) ago): capability_jump
- Turn 3 (10 turn(s) ago): emergent_synthetic_fraud_wave, emergent_open_toolkit_takedown
- Turn 4 (9 turn(s) ago): ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented, member_state_defection
- Turn 5 (8 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, election_consolidation
- Turn 6 (7 turn(s) ago): embodied_ai_deployment, middle_power_coalition, emergent_fraud_auth_mandate
- Turn 8 (5 turn(s) ago): bio_uplift_findings
- Turn 10 (3 turn(s) ago): eval_anomaly_reports
- Turn 11 (2 turn(s) ago): loss_of_control_incident, labour_displacement, knowledge_work_augmented, taiwan_tension_rise
- Turn 12 (1 turn(s) ago): emergent_screening_arbitrage
