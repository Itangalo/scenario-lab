...
- characters 106-12993: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13036-13228: `{{metrics_json}}` from the run's live metric values
- characters 13344-16293: `{{world_state}}` from background/context.md, seeded as the opening world state
