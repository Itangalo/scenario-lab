...
- `two_year_commitment` (commitment): Survive great-power war and keep essential EU functions running through it

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Survive great-power war and keep essential EU functions running through it
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the prior obligation, triggering a necessary shift in focus to new survival priorities under changed conditions.
