...
| M8 | EU Clinical Queue Relief and Displaced-Worker Bridge | 7 | small | 7 | 9 | own jurisdiction | public_sentiment up, eu_political_capital protected, resilience up modestly | 2 | finished |
| M9 | EU Wartime Continuity Shield | 6 | small | 9 | 11 | own jurisdiction | resilience up, eu_political_capital protected | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Wartime Continuity Shield", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_political_capital protected"}, "grounds": "war makes infrastructure targeting imminent and prior measures finished"}
  - Grounds: war makes infrastructure targeting imminent and prior measures finished
