...
| M8 | EU Clinical Queue Relief and Displaced-Worker Bridge | 7 | small | 7 | 9 | own jurisdiction | public_sentiment up, eu_political_capital protected, resilience up modestly | 2 | running |
...
- **applied** `M8` — {"op": "add", "table": "measures", "fields": {"name": "EU Clinical Queue Relief and Displaced-Worker Bridge", "category": 7, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, eu_political_capital protected, resilience up modestly"}, "grounds": "queues and union backlash eroding mandate to hold rationing"}
  - Grounds: queues and union backlash eroding mandate to hold rationing
