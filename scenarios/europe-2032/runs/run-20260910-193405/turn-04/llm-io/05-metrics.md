...
- characters 105-13122: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13165-13357: `{{metrics_json}}` from the run's live metric values
- characters 13450-14991: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15034-17097: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17153-18251: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Frontier Evaluation and Bio-Uplift Observatory | 2 |
| M5 | EU Chip Continuity Coalition | 2 |
| M6 | EU Black-Box Assurance Programme | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Evaluation and Bio-Uplift Observatory −2, EU Chip Continuity Coalition −2, priority −1 = −11
PROPOSAL BONUS: EU Chip Continuity Coalition (cat 8, small) +3 — taiwan_tension_rise precursor landed this turn threatening compute/grid hardware and this answers it directly
LEGITIMACY LENDS: capital 22, sentiment 33 -> +2
SOVEREIGNTY: 18 last turn, no capacity event, Gigafactories + Tech package in flight +0, capability rose 5.0 −1 = 17

## Emerging developments (tracked)

- `emergent_siting_blockade` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated local protests block construction access at two gigafactory and grid-transformer sites, delaying works for weeks and forcing a national policing response.
- `emergent_datacentre_blockade_protest` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated physical protests block or damage a gigafactory construction site or grid-transformer delivery, turning local opposition over power, siting and jobs into a national anti-AI confrontation.
