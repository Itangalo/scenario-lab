...
- characters 106-13450: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13493-13685: `{{metrics_json}}` from the run's live metric values
- characters 13778-16355: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16399-18407: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18463-19012: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 63.0, "openweight_capability": 54.0, "ai_safety": 21.0, "resilience": 40.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 24.0, "public_sentiment": 33.0}
```
