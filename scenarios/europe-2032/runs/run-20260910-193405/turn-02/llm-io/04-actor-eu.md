...
- characters 454-1977: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2020-4420: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5531-6008: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7467-9381: `{{previous_actions}}` from the actor's own response from the previous turn
