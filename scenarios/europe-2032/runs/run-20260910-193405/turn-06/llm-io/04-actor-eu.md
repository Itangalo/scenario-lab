...
- characters 453-1574: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1617-3448: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5322-5817: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8205-10632: `{{previous_actions}}` from the actor's own response from the previous turn
