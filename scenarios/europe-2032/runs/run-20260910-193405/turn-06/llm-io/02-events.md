...
- characters 375-1496: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1539-3370: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3426-4357: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4420-30817: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31172-31533: `{{event_history}}` from the run's own event record
...
- `emergent_datacentre_blockade_protest` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated physical protests block or damage a gigafactory construction site or grid-transformer delivery, turning local opposition over power, siting and jobs into a national anti-AI confrontation.
...
- Turn 2 (4 turn(s) ago): bio_uplift_findings, eval_anomaly_reports
- Turn 3 (3 turn(s) ago): capability_jump, taiwan_tension_rise
- Turn 4 (2 turn(s) ago): eval_anomaly_reports, opaque_reasoning, medical_breakthrough
- Turn 5 (1 turn(s) ago): emergent_siting_blockade, election_consolidation
