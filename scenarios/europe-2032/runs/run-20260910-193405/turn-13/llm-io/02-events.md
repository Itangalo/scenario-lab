...
- characters 1495-3369: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3425-4275: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4338-29337: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29692-31050: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Bio Containment and Essential Continuity Shield −2, priority ineffective (capital below 20, no cost, no pull-in) = −2
PROPOSAL BONUS: EU Bio Containment and Essential Continuity Shield (cat 6, small) +4 — bio_incident real release this turn and this answers it directly
LEGITIMACY LENDS: capital 2, sentiment 0 -> none, capital above sentiment
SOVEREIGNTY: 8 last turn, no finish, no in-flight build, supply_chain_coercion t12 −2, capability rose 2.0 −1 = 5

## Emerging developments (tracked)

- `emergent_embodied_telemetry_pool` -- first noted turn 11, listed in 2 turn(s) so far: Municipal operators in Lyon and Hamburg quietly pool maintenance telemetry from Chinese logistics humanoids after a second warehouse stop-signal misread, creating an exogenous cross-border safety incident log outside EU procurement channels.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, eu_frontier_access_denied
- Turn 2 (11 turn(s) ago): bio_uplift_findings, eval_anomaly_reports
- Turn 3 (10 turn(s) ago): capability_jump, taiwan_tension_rise
- Turn 4 (9 turn(s) ago): eval_anomaly_reports, opaque_reasoning, medical_breakthrough
- Turn 5 (8 turn(s) ago): emergent_siting_blockade, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, eval_anomaly_reports, rsi_onset, eu_frontier_access_denied
- Turn 7 (6 turn(s) ago): cyber_major_incident, capability_jump, us_labs_nationalised
- Turn 8 (5 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, safety_breakthrough, export_control_escalation, joint_threat_response, emergent_med_power_curtailment
- Turn 9 (4 turn(s) ago): capability_jump, taiwan_blockade, bio_uplift_findings, taiwan_tension_rise, supply_chain_coercion, member_state_defection, joint_threat_response, emergent_asian_fallback_pool
- Turn 10 (3 turn(s) ago): capability_jump, safety_breakthrough, embodied_ai_deployment, taiwan_tension_rise, adoption_success
- Turn 11 (2 turn(s) ago): labour_displacement, knowledge_work_augmented, embodied_ai_deployment, export_control_escalation, us_china_agreement
- Turn 12 (1 turn(s) ago): bio_incident, bio_uplift_findings, safety_breakthrough, labour_displacement, export_control_escalation, supply_chain_coercion
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.15}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.08}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.03}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_loss_of_control_incident", "probability": 0.02}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.025}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.075}, {"description": "", "emergent": false, "id": "catastrophic_great_power_conflict", "probability": 0.125}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.26}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Municipal operators in Lyon and Hamburg quietly pool maintenance telemetry from Chinese logistics humanoids after a second warehouse stop-signal misread, creating an exogenous cross-border safety incident log outside EU procurement channels.", "emergent": true, "id": "emergent_embodied_telemetry_pool", "probability": 0.18}]
```
