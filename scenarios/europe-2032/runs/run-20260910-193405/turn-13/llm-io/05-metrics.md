...
- characters 107-12970: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13013-13201: `{{metrics_json}}` from the run's live metric values
- characters 13294-14371: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14415-16289: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16345-16827: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t13: M11 EU Bio Containment and Essential Continuity Shield −2, priority ineffective (capital below 20, no cost, no pull-in) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2, sentiment 0 -> none, capital above sentiment
SOVEREIGNTY: 5 last turn, no finish, no in-flight build, supply_chain_coercion t13 −2 (larger than export_control_escalation t13), capability rose 1.5 −1 = 2
