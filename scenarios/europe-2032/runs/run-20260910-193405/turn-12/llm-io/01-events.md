...
- characters 373-1753: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1796-3681: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3737-4497: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4560-30371: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30726-31930: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Continuity Benefit and Safe Deployment Protocol −2, priority ineffective (capital below 20, no cost, no pull-in) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 3, sentiment 2 -> none, capital above sentiment
SOVEREIGNTY: 11 last turn, no finish, no in-flight build, export_control_escalation t11 −2, capability rose 2.0 −1 = 8

## Emerging developments (tracked)

- `emergent_embodied_telemetry_pool` -- first noted turn 11, listed in 1 turn(s) so far: Municipal operators in Lyon and Hamburg quietly pool maintenance telemetry from Chinese logistics humanoids after a second warehouse stop-signal misread, creating an exogenous cross-border safety incident log outside EU procurement channels.
...
- Turn 2 (10 turn(s) ago): bio_uplift_findings, eval_anomaly_reports
- Turn 3 (9 turn(s) ago): capability_jump, taiwan_tension_rise
- Turn 4 (8 turn(s) ago): eval_anomaly_reports, opaque_reasoning, medical_breakthrough
- Turn 5 (7 turn(s) ago): emergent_siting_blockade, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, eval_anomaly_reports, rsi_onset, eu_frontier_access_denied
- Turn 7 (5 turn(s) ago): cyber_major_incident, capability_jump, us_labs_nationalised
- Turn 8 (4 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, safety_breakthrough, export_control_escalation, joint_threat_response, emergent_med_power_curtailment
- Turn 9 (3 turn(s) ago): capability_jump, taiwan_blockade, bio_uplift_findings, taiwan_tension_rise, supply_chain_coercion, member_state_defection, joint_threat_response, emergent_asian_fallback_pool
- Turn 10 (2 turn(s) ago): capability_jump, safety_breakthrough, embodied_ai_deployment, taiwan_tension_rise, adoption_success
- Turn 11 (1 turn(s) ago): labour_displacement, knowledge_work_augmented, embodied_ai_deployment, export_control_escalation, us_china_agreement
