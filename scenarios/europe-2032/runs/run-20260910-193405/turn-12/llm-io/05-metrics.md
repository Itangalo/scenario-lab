...
- characters 13419-13607: `{{metrics_json}}` from the run's live metric values
- characters 13700-15080: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15123-17008: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17064-17824: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Bio Containment and Essential Continuity Shield | 2 |
