...
- characters 375-2424: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2468-4719: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4775-5608: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5671-33706: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34061-34791: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Resilience Accession and Safety Adoption Pact −2 = −2 + priority ineffective (capital below 20, no cost, no pull-in)
PROPOSAL BONUS: EU Resilience Accession and Safety Adoption Pact (cat 6, small) +3 — joint_threat_response invitation plus safety_breakthrough and loss-of-control episode last turn, answers directly
LEGITIMACY LENDS: capital 5, sentiment 15 -> +2 (capped below sentiment)
SOVEREIGNTY: 20 last turn, no finish, no in-flight build bonus, export_control_escalation t8 −2, capability rose 3.0 −1 = 17

## Emerging developments (tracked)

- `emergent_asian_fallback_pool` -- first noted turn 7, listed in 2 turn(s) so far: Japanese and Korean providers offer the EU a pooled, long-term inference and emergency-fallback capacity deal on published quotas after the US cutoff, outside any EU measure.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, eu_frontier_access_denied
- Turn 2 (7 turn(s) ago): bio_uplift_findings, eval_anomaly_reports
- Turn 3 (6 turn(s) ago): capability_jump, taiwan_tension_rise
- Turn 4 (5 turn(s) ago): eval_anomaly_reports, opaque_reasoning, medical_breakthrough
- Turn 5 (4 turn(s) ago): emergent_siting_blockade, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, rsi_onset, eu_frontier_access_denied
- Turn 7 (2 turn(s) ago): cyber_major_incident, capability_jump, us_labs_nationalised
- Turn 8 (1 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, safety_breakthrough, export_control_escalation, joint_threat_response, emergent_med_power_curtailment
