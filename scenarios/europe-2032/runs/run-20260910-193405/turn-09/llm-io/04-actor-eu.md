...
- characters 2546-4797: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7687-8182: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10726-12834: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Resilience Accession and Safety Adoption Pact | 6 | small | 8 | 10 | coalition | resilience up strongly, ai_safety up slightly | 2 | running |
