...
- characters 13068-13258: `{{metrics_json}}` from the run's live metric values
- characters 13351-15400: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15444-17695: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17751-18288: `{{notepad}}` from the Game Master's notepad, carried across turns
