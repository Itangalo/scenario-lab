...
- characters 375-1448: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1492-3502: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3558-4119: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4182-31499: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31854-32913: `{{event_history}}` from the run's own event record
...
- Turn 2 (9 turn(s) ago): bio_uplift_findings, eval_anomaly_reports
- Turn 3 (8 turn(s) ago): capability_jump, taiwan_tension_rise
- Turn 4 (7 turn(s) ago): eval_anomaly_reports, opaque_reasoning, medical_breakthrough
- Turn 5 (6 turn(s) ago): emergent_siting_blockade, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, eval_anomaly_reports, rsi_onset, eu_frontier_access_denied
- Turn 7 (4 turn(s) ago): cyber_major_incident, capability_jump, us_labs_nationalised
- Turn 8 (3 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, safety_breakthrough, export_control_escalation, joint_threat_response, emergent_med_power_curtailment
- Turn 9 (2 turn(s) ago): capability_jump, taiwan_blockade, bio_uplift_findings, taiwan_tension_rise, supply_chain_coercion, member_state_defection, joint_threat_response, emergent_asian_fallback_pool
- Turn 10 (1 turn(s) ago): capability_jump, safety_breakthrough, embodied_ai_deployment, taiwan_tension_rise, adoption_success
