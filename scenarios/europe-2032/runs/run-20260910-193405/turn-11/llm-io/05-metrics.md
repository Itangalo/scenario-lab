...
- characters 107-13343: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13386-13575: `{{metrics_json}}` from the run's live metric values
- characters 13668-14741: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14785-16795: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16851-17780: `{{notepad}}` from the Game Master's notepad, carried across turns
