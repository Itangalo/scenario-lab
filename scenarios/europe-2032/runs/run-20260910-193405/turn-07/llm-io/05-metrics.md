...
- characters 13786-14690: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14734-16832: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16888-17963: `{{notepad}}` from the Game Master's notepad, carried across turns
