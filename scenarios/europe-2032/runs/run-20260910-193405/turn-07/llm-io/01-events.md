...
- characters 375-1279: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1323-3421: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3477-3945: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4008-32529: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32884-33352: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, EU Black-Box Assurance Programme −2, EU Transatlantic AI Access and Leverage Track −2, priority M7 −1 = −8
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 4, sentiment 22 -> +2 (included in capital total, capped below sentiment)
SOVEREIGNTY: 15 last turn, Tech sovereignty package finishes t6 +5, Gigafactories in flight +1, eu_frontier_access_denied t6 −2, capability rose 7.0 −1 = 18
...
- Turn 2 (5 turn(s) ago): bio_uplift_findings, eval_anomaly_reports
- Turn 3 (4 turn(s) ago): capability_jump, taiwan_tension_rise
- Turn 4 (3 turn(s) ago): eval_anomaly_reports, opaque_reasoning, medical_breakthrough
- Turn 5 (2 turn(s) ago): emergent_siting_blockade, election_consolidation
- Turn 6 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, rsi_onset, eu_frontier_access_denied
