...
- characters 106-13519: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13562-13754: `{{metrics_json}}` from the run's live metric values
- characters 13847-14962: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15006-17169: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17225-18143: `{{notepad}}` from the Game Master's notepad, carried across turns
