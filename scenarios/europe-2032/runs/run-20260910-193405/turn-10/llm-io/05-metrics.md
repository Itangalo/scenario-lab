...
- characters 13448-13637: `{{metrics_json}}` from the run's live metric values
- characters 13730-15103: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15146-17264: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17320-17908: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Asian Fallback and Wartime Rationing Compact | 2 |
| M10 | EU Continuity Benefit and Safe Deployment Protocol | 2 |
...
## Metrics
```json
{"ai_capability": 91.0, "openweight_capability": 84.0, "ai_safety": 3.0, "resilience": 40.0, "eu_ai_sovereignty": 11.0, "eu_political_capital": 2.0, "public_sentiment": 4.0}
```
