...
- characters 452-1825: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1868-3986: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6010-6507: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9203-11594: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Asian Fallback and Wartime Rationing Compact | 8 | small | 9 | 11 | coalition | eu_ai_sovereignty up slightly, resilience up | 2 | running |
