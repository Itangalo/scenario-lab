...
- characters 374-1547: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1590-3916: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3972-4979: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5042-33077: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33432-33986: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU Transatlantic AI Access and Leverage Track −2, priority M7 −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 4, sentiment 22 -> +2 (included in capital total, capped below sentiment)
SOVEREIGNTY: 18 last turn, InvestAI Gigafactories finishes t7 +5, no capacity measure in flight, us_labs_nationalised t7 −2, capability rose 5.0 −1 = 20

## Emerging developments (tracked)

- `emergent_asian_fallback_pool` -- first noted turn 7, listed in 1 turn(s) so far: Japanese and Korean providers offer the EU a pooled, long-term inference and emergency-fallback capacity deal on published quotas after the US cutoff, outside any EU measure.
- `emergent_med_power_curtailment` -- first noted turn 7, listed in 1 turn(s) so far: A severe winter heatwave-drought across the Mediterranean forces rolling power curtailments that idle both stalled gigafactory sites and hospital backup compute, turning the AI access cutoff into physical capacity shortages.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, eu_frontier_access_denied
- Turn 2 (6 turn(s) ago): bio_uplift_findings, eval_anomaly_reports
- Turn 3 (5 turn(s) ago): capability_jump, taiwan_tension_rise
- Turn 4 (4 turn(s) ago): eval_anomaly_reports, opaque_reasoning, medical_breakthrough
- Turn 5 (3 turn(s) ago): emergent_siting_blockade, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, rsi_onset, eu_frontier_access_denied
- Turn 7 (1 turn(s) ago): cyber_major_incident, capability_jump, us_labs_nationalised
