...
- characters 378-1384: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1428-3081: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3137-3566: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3629-28570: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28925-29725: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M9 European Supply-Chain Leverage Pact −2, M10 European Visible Benefit Scale-Up −2, priority −1 not charged (capital below 20, no effect) = −4
PROPOSAL BONUS: none — new Scale-Up proposal answers positive adoption window, not a negative event from last three turns
LEGITIMACY LENDS: capital 18, sentiment 30 -> +2
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, loss_of_control_incident, export_control_escalation
- Turn 2 (9 turn(s) ago): adoption_success
- Turn 3 (8 turn(s) ago): loss_of_control_incident, openweight_frontier_release, emergent_kimi_copycat_wave, emergent_bio_publication_moratorium
- Turn 4 (7 turn(s) ago): emergent_screening_bypass_kit, emergent_insurer_open_model_boycott
- Turn 5 (6 turn(s) ago): member_state_defection, election_alliance
- Turn 6 (5 turn(s) ago): loss_of_control_incident
- Turn 7 (4 turn(s) ago): safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise, automated_decision_scandal, emergent_kit_hosting_as_service
- Turn 8 (3 turn(s) ago): adoption_success
- Turn 9 (2 turn(s) ago): taiwan_blockade, medical_breakthrough
