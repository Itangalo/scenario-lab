...
- characters 455-1591: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1634-3501: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3569-4045: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7347-9106: `{{previous_actions}}` from the actor's own response from the previous turn
