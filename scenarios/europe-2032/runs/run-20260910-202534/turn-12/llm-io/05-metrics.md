...
- characters 106-13477: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13520-13712: `{{metrics_json}}` from the run's live metric values
- characters 13805-14941: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14984-16851: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16907-18015: `{{notepad}}` from the Game Master's notepad, carried across turns
