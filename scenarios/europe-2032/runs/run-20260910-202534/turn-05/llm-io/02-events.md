...
- characters 377-1848: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1892-4280: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4336-4891: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4954-28735: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29090-29465: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, loss_of_control_incident, export_control_escalation
- Turn 2 (3 turn(s) ago): adoption_success
- Turn 3 (2 turn(s) ago): loss_of_control_incident, openweight_frontier_release, emergent_kimi_copycat_wave, emergent_bio_publication_moratorium
- Turn 4 (1 turn(s) ago): emergent_screening_bypass_kit, emergent_insurer_open_model_boycott
