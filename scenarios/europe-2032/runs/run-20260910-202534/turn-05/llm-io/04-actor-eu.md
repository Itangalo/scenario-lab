...
- characters 455-1926: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1970-4358: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5584-6051: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8343-10428: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Pathogen-Methods Screening Enforcement | 6 | small | 4 | 7 | own jurisdiction | resilience up, ai_safety up slightly via bio-misuse blocking | 2 | running |
