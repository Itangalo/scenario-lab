...
- characters 13786-15257: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15301-17689: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17745-18926: `{{notepad}}` from the Game Master's notepad, carried across turns
