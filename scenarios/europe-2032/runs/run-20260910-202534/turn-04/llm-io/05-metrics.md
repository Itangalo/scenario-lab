...
- characters 105-12978: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13021-13213: `{{metrics_json}}` from the run's live metric values
- characters 13306-14392: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14435-16458: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16514-16980: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | European Public AI Dividend | 2 |
| M5 | EU Agent Containment Protocol | 2 |
| M6 | EU Pathogen-Methods Screening Enforcement | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, European Public AI Dividend −2, EU Agent Containment Protocol −2, priority −1 = −11
PROPOSAL BONUS: EU Agent Containment Protocol (cat 6, small) +3 — loss_of_control_incident landed this turn plus copycat wave and this answers it directly
LEGITIMACY LENDS: capital 24, sentiment 36 -> +2
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, European Public AI Dividend −2, EU Agent Containment Protocol −2, EU Pathogen-Methods Screening Enforcement −2, priority −1 = −13
PROPOSAL BONUS: EU Pathogen-Methods Screening Enforcement (cat 6, small) +3 — bypass kit circulating this turn directly undermines journal screening and this answers it plus backs private blacklist
LEGITIMACY LENDS: capital 16, sentiment 35 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 20
