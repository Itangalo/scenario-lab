...
- characters 1505-3528: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3584-4050: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4113-27395: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27750-28032: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, loss_of_control_incident, export_control_escalation
- Turn 2 (2 turn(s) ago): adoption_success
- Turn 3 (1 turn(s) ago): loss_of_control_incident, openweight_frontier_release, emergent_kimi_copycat_wave, emergent_bio_publication_moratorium
