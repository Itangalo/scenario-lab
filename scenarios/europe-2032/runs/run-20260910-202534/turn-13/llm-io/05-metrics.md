...
- characters 107-13294: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13337-13529: `{{metrics_json}}` from the run's live metric values
- characters 13622-14778: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14822-16760: `{{world_state}}` from the Game Master's narrative from the previous turn
...
|---|---|---|
| M12 | EU Offline Kill-Switch Retrofit | 2 |
| M13 | European Medical Safety Deployment | 2 |
...
## Notepad
PORTFOLIO CHARGE t13: M12 EU Offline Kill-Switch Retrofit −2, M13 European Medical Safety Deployment −2, priority −1 = −5
PROPOSAL BONUS: European Medical Safety Deployment (cat 9, small) +2 — answers ai_investment_collapse directly by re-anchoring hosting and Europeanising therapies, small size caps gain
LEGITIMACY LENDS: capital 19, sentiment 47.0 -> +2 (capped below sentiment)
SOVEREIGNTY: 24 last turn, no capacity event, no cat4 in flight, capability rose 0.6 −0 = 24
