...
- characters 378-1534: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1578-3516: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3572-4627: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4690-30484: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30839-31711: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M10 European Visible Benefit Scale-Up −2, M12 EU Offline Kill-Switch Retrofit −2, priority −1 = −4
PROPOSAL BONUS: none — no external event in last three turns that this measure answers; drills and loss-of-control are standing conditions, not a priced event
LEGITIMACY LENDS: capital 21, sentiment 40.0 -> +2 (capped below sentiment)
SOVEREIGNTY: 24 last turn, no capacity event, no cat4 in flight, capability rose 0.7 −0 = 24

## Emerging developments (tracked)

- `emergent_grid_connection_sabotage` -- first noted turn 11, listed in 2 turn(s) so far: Coordinated physical blockade of grid-connection works for EU compute sites spreads beyond the two protest camps, with transformer deliveries sabotaged and construction delayed for months.
- `emergent_care_federation_boycott` -- first noted turn 11, listed in 2 turn(s) so far: Municipal grid operators and hospital IT federations publish a joint refusal to host unlogged frontier medical models, triggering a coordinated procurement boycott that stalls DG REFORM scale-up sites.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, loss_of_control_incident, export_control_escalation
- Turn 2 (11 turn(s) ago): adoption_success
- Turn 3 (10 turn(s) ago): loss_of_control_incident, openweight_frontier_release, emergent_kimi_copycat_wave, emergent_bio_publication_moratorium
- Turn 4 (9 turn(s) ago): emergent_screening_bypass_kit, emergent_insurer_open_model_boycott
- Turn 5 (8 turn(s) ago): member_state_defection, election_alliance
- Turn 6 (7 turn(s) ago): loss_of_control_incident
- Turn 7 (6 turn(s) ago): safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise, automated_decision_scandal, emergent_kit_hosting_as_service
- Turn 8 (5 turn(s) ago): adoption_success
- Turn 9 (4 turn(s) ago): taiwan_blockade, medical_breakthrough
- Turn 10 (3 turn(s) ago): adoption_success
- Turn 11 (2 turn(s) ago): loss_of_control_incident, adoption_success
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.1}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.03}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.05}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.14}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.04}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.03}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "Coordinated physical blockade of grid-connection works for EU compute sites spreads beyond the two protest camps, with transformer deliveries sabotaged and construction delayed for months.", "emergent": true, "id": "emergent_grid_connection_sabotage", "probability": 0.18}, {"description": "Municipal grid operators and hospital IT federations publish a joint refusal to host unlogged frontier medical models, triggering a coordinated procurement boycott that stalls DG REFORM scale-up sites.", "emergent": true, "id": "emergent_care_federation_boycott", "probability": 0.15}]
```
