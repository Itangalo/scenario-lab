...
- characters 454-1898: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1941-4197: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4891-5345: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7638-9372: `{{previous_actions}}` from the actor's own response from the previous turn
