...
- characters 13621-15457: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15500-17431: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17487-17949: `{{notepad}}` from the Game Master's notepad, carried across turns
