...
- characters 377-2213: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2256-4187: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4243-5247: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5310-30251: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30606-31361: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M8 European Public Results Programme −2, M9 European Supply-Chain Leverage Pact −2, priority −1 not charged (capital below 20, no effect) = −4
PROPOSAL BONUS: European Supply-Chain Leverage Pact (cat 8, small) +4 — taiwan_blockade landed this turn and this answers it directly
LEGITIMACY LENDS: capital 17, sentiment 30 -> +2
SOVEREIGNTY: 26 last turn, no capacity event, no cat4 in flight, taiwan_blockade t9 −2, capability rose 0.6 −0 = 24

## Emerging developments (tracked)

- `emergent_datacentre_siting_blockade` -- first noted turn 8, listed in 2 turn(s) so far: Coordinated physical protests block several planned data-centre and grid-connection sites across member states, turning siting into a national political fight.
- `emergent_shipping_compute_squeeze` -- first noted turn 8, listed in 2 turn(s) so far: Taiwan exercises push container shipping insurance sharply higher, delaying GPU and spare-part deliveries to EU sites and spiking EU cloud spot prices for the half.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, loss_of_control_incident, export_control_escalation
- Turn 2 (8 turn(s) ago): adoption_success
- Turn 3 (7 turn(s) ago): loss_of_control_incident, openweight_frontier_release, emergent_kimi_copycat_wave, emergent_bio_publication_moratorium
- Turn 4 (6 turn(s) ago): emergent_screening_bypass_kit, emergent_insurer_open_model_boycott
- Turn 5 (5 turn(s) ago): member_state_defection, election_alliance
- Turn 6 (4 turn(s) ago): loss_of_control_incident
- Turn 7 (3 turn(s) ago): safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise, automated_decision_scandal, emergent_kit_hosting_as_service
- Turn 8 (2 turn(s) ago): adoption_success
- Turn 9 (1 turn(s) ago): taiwan_blockade, medical_breakthrough
