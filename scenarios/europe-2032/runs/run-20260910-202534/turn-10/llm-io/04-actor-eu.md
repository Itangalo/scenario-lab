...
- characters 455-2291: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2334-4265: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4632-5108: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8023-10396: `{{previous_actions}}` from the actor's own response from the previous turn
