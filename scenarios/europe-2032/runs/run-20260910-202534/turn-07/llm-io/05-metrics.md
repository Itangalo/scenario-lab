...
- characters 106-13335: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13378-13570: `{{metrics_json}}` from the run's live metric values
- characters 13663-15524: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15568-17621: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17677-18094: `{{notepad}}` from the Game Master's notepad, carried across turns
