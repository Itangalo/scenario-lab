...
- characters 13248-14421: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14464-16768: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16824-17949: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 48.5, "ai_safety": 30.0, "resilience": 36.5, "eu_ai_sovereignty": 20.0, "eu_political_capital": 26.0, "public_sentiment": 39.0}
```
