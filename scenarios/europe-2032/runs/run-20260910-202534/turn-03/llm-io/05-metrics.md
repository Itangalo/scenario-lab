...
- characters 106-13302: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13345-13537: `{{metrics_json}}` from the run's live metric values
- characters 13630-14849: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14893-16607: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16663-17139: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, European Public AI Dividend −2, priority −1 = −12
PROPOSAL BONUS: European Public AI Dividend (cat 9, small) +2 — adoption_success landed this turn with visible European-attributed benefit and this answers it directly
...
## Metrics
```json
{"ai_capability": 56.5, "openweight_capability": 49.5, "ai_safety": 28.0, "resilience": 40.5, "eu_ai_sovereignty": 20.0, "eu_political_capital": 26.0, "public_sentiment": 36.0}
```
## Narrative
