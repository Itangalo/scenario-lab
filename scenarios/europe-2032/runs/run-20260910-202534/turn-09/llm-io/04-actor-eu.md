...
- characters 455-2632: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2676-4516: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5349-5803: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8500-10478: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | European Public Results Programme | 9 | small | 8 | 10 | own jurisdiction | public_sentiment up moderately, eu_political_capital up slightly, resilience up slightly via state capacity | 2 | running |
