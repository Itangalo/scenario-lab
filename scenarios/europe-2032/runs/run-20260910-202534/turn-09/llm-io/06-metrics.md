...
- characters 13605-15782: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15826-17666: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17722-18672: `{{notepad}}` from the Game Master's notepad, carried across turns
