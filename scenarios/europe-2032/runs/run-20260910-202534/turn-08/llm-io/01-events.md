...
- characters 2071-4593: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4649-5032: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5095-30151: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30506-31154: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, loss_of_control_incident, export_control_escalation
- Turn 2 (6 turn(s) ago): adoption_success
- Turn 3 (5 turn(s) ago): loss_of_control_incident, openweight_frontier_release, emergent_kimi_copycat_wave, emergent_bio_publication_moratorium
- Turn 4 (4 turn(s) ago): emergent_screening_bypass_kit, emergent_insurer_open_model_boycott
- Turn 5 (3 turn(s) ago): member_state_defection, election_alliance
- Turn 6 (2 turn(s) ago): loss_of_control_incident
- Turn 7 (1 turn(s) ago): safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise, automated_decision_scandal, emergent_kit_hosting_as_service
