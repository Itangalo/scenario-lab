...
- characters 105-12848: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12891-13083: `{{metrics_json}}` from the run's live metric values
- characters 13176-14828: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14871-17393: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17449-18374: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Assurance Uptake Cell | 2 |
| M8 | European Public Results Programme | 2 |
...
PORTFOLIO CHARGE t7: EU Assurance Uptake Cell −2, priority −1 = −3
PROPOSAL BONUS: EU Assurance Uptake Cell (cat 5, small) +2 — safety_breakthrough landed this turn and this answers it directly, plus agent scare aftermath
LEGITIMACY LENDS: capital 13, sentiment 24 -> +2
SOVEREIGNTY: 22 last turn, InvestAI Gigafactories finishes t7 +4, no capacity event, capability rose 0.8 −0 = 26
...
## Metrics
```json
{"ai_capability": 62.5, "openweight_capability": 60.6, "ai_safety": 28.0, "resilience": 43.0, "eu_ai_sovereignty": 26.0, "eu_political_capital": 13.0, "public_sentiment": 28.0}
```
