...
- characters 454-1543: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1586-3843: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4686-5136: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7591-9841: `{{previous_actions}}` from the actor's own response from the previous turn
