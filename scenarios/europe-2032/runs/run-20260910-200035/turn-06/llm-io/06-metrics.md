...
- characters 105-13607: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13650-13842: `{{metrics_json}}` from the run's live metric values
- characters 13935-15024: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15067-17324: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17380-17874: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | EU Bio Emergency Containment Surge | 2 |
