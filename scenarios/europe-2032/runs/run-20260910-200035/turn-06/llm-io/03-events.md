...
- characters 376-1465: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1508-3765: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3821-4956: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5019-31623: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31978-32397: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Bio Detection and Medical Countermeasure Reserve −2, EU Essential Services Cyber Recovery Corps −2, priority −1 = −11
PROPOSAL BONUS: EU Essential Services Cyber Recovery Corps (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly
...
- `emergent_continuity_backlash` -- first noted turn 4, listed in 2 turn(s) so far: Clinician and patient groups publish documented cases of degraded triage and delayed care linked to the forced migration to less capable domestic models after the US cutoff, turning the Continuity Switch into a domestic liability debate.
- `emergent_care_degradation_backlash` -- first noted turn 4, listed in 2 turn(s) so far: Clinician-led protests and press investigations in two member states frame degraded domestic substitutes after the US cutoff as a patient-safety failure, forcing emergency procurement audits.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (4 turn(s) ago): openweight_frontier_release
- Turn 3 (3 turn(s) ago): openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
- Turn 4 (2 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, adoption_success
- Turn 5 (1 turn(s) ago): cyber_major_incident, election_consolidation
