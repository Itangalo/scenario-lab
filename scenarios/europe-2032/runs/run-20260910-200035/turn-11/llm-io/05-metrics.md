...
- characters 107-13385: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13428-13620: `{{metrics_json}}` from the run's live metric values
- characters 13713-14833: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14877-17219: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17275-18513: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Essential Services Containment and Supply Hold | 2 |
| M13 | EU Automated Decision Redress and High-Risk Gap Closure | 2 |
...
PORTFOLIO CHARGE t10: M11 EU Essential Services Sovereign Inference Reserve −2, M12 EU Essential Services Containment and Supply Hold −2, priority −1 = −5
PROPOSAL BONUS: EU Essential Services Containment and Supply Hold (cat 6, small) +3 — cyber_major_incident landed this turn and taiwan_blockade plus bio precursor add recency/severity, answered directly with containment and rationing
LEGITIMACY LENDS: capital 25, sentiment 22 -> none, capital is higher
SOVEREIGNTY: 15 last turn, no capacity event? actually taiwan_blockade t10 −3, M11 in flight +1, capability rose 1.0 −0 = 13

## Emerging developments (tracked)

- `emergent_frontier_service_degradation` -- first noted turn 10, listed in 2 turn(s) so far: A major US frontier lab suffers a prolonged outage / throttling of API capacity after power and safety reviews, spilling over into degraded service for remaining EU enterprise users and spiking demand for locally hosted open models.
- `emergent_clinical_bypass_revolt` -- first noted turn 10, listed in 2 turn(s) so far: A major European hospital group publicly abandons the EU-hosted reserve stack after repeated diagnostic errors, signing an emergency bypass contract for non-EU model access via a third-country reseller.
