...
- characters 378-1498: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1542-3884: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3940-5178: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5241-31074: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31429-32207: `{{event_history}}` from the run's own event record
...
- `emergent_frontier_service_degradation` -- first noted turn 10, listed in 1 turn(s) so far: A major US frontier lab suffers a prolonged outage / throttling of API capacity after power and safety reviews, spilling over into degraded service for remaining EU enterprise users and spiking demand for locally hosted open models.
- `emergent_clinical_bypass_revolt` -- first noted turn 10, listed in 1 turn(s) so far: A major European hospital group publicly abandons the EU-hosted reserve stack after repeated diagnostic errors, signing an emergency bypass contract for non-EU model access via a third-country reseller.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (9 turn(s) ago): openweight_frontier_release
- Turn 3 (8 turn(s) ago): openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
- Turn 4 (7 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, adoption_success
- Turn 5 (6 turn(s) ago): cyber_major_incident, election_consolidation
- Turn 6 (5 turn(s) ago): bio_incident, supply_chain_coercion
- Turn 8 (3 turn(s) ago): cyber_major_incident, safety_breakthrough, taiwan_tension_rise
- Turn 9 (2 turn(s) ago): eval_anomaly_reports, opaque_reasoning, openweight_frontier_release, eu_frontier_access_denied
- Turn 10 (1 turn(s) ago): cyber_major_incident, taiwan_blockade, bio_uplift_findings
