...
- characters 455-1769: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1813-3885: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5262-5714: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8037-10135: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Bio Detection and Medical Countermeasure Reserve | 6 | small | 4 | 6 | own jurisdiction | resilience up, ai_safety up slightly via bio-risk detection | 2 | running |
