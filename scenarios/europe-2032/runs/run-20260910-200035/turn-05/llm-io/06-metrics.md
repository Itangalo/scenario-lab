...
- characters 106-13065: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13108-13300: `{{metrics_json}}` from the run's live metric values
- characters 13393-14707: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14751-16823: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16879-17999: `{{notepad}}` from the Game Master's notepad, carried across turns
