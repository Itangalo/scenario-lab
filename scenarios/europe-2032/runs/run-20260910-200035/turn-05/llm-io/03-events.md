...
- characters 377-1691: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1735-3807: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3863-4983: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5046-33531: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33886-34234: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Bio Detection and Medical Countermeasure Reserve −2, priority −1 = −9
PROPOSAL BONUS: none — knowledge-work augmentation removes displacement crisis to point at, new bio reserve answers precursor finding not a realised negative event with felt harm
LEGITIMACY LENDS: capital 26, sentiment 42 -> +2
SOVEREIGNTY: 17 last turn, no capacity event, Gigafactories in flight +0, capability rose 2.0 −1 = 16

## Emerging developments (tracked)

- `emergent_continuity_backlash` -- first noted turn 4, listed in 1 turn(s) so far: Clinician and patient groups publish documented cases of degraded triage and delayed care linked to the forced migration to less capable domestic models after the US cutoff, turning the Continuity Switch into a domestic liability debate.
- `emergent_care_degradation_backlash` -- first noted turn 4, listed in 1 turn(s) so far: Clinician-led protests and press investigations in two member states frame degraded domestic substitutes after the US cutoff as a patient-safety failure, forcing emergency procurement audits.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (3 turn(s) ago): openweight_frontier_release
- Turn 3 (2 turn(s) ago): openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
- Turn 4 (1 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, adoption_success
