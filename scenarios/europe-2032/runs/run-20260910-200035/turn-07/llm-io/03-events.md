...
- characters 377-1302: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1346-3325: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3381-3881: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3944-30339: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30694-31175: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (5 turn(s) ago): openweight_frontier_release
- Turn 3 (4 turn(s) ago): openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
- Turn 4 (3 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, adoption_success
- Turn 5 (2 turn(s) ago): cyber_major_incident, election_consolidation
- Turn 6 (1 turn(s) ago): bio_incident, supply_chain_coercion
