...
- characters 106-13507: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13550-13742: `{{metrics_json}}` from the run's live metric values
- characters 13835-14760: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14804-16783: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16839-17339: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Essential Services Cyber Recovery Corps | 2 |
| M9 | EU Lithography Leverage Compact | 2 |
