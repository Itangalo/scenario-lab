...
- characters 377-1409: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1453-3851: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3907-4336: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4399-30794: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31149-31719: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (7 turn(s) ago): openweight_frontier_release
- Turn 3 (6 turn(s) ago): openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
- Turn 4 (5 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, adoption_success
- Turn 5 (4 turn(s) ago): cyber_major_incident, election_consolidation
- Turn 6 (3 turn(s) ago): bio_incident, supply_chain_coercion
- Turn 8 (1 turn(s) ago): cyber_major_incident, safety_breakthrough, taiwan_tension_rise
