...
- characters 13634-14666: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14710-17108: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17164-17593: `{{notepad}}` from the Game Master's notepad, carried across turns
