...
- characters 455-1487: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1531-3929: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5893-6396: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9178-11067: `{{previous_actions}}` from the actor's own response from the previous turn
