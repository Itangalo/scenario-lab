...
- characters 377-1737: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1780-4194: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4250-5652: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5715-31548: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31903-32813: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (10 turn(s) ago): openweight_frontier_release
- Turn 3 (9 turn(s) ago): openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
- Turn 4 (8 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, adoption_success
- Turn 5 (7 turn(s) ago): cyber_major_incident, election_consolidation
- Turn 6 (6 turn(s) ago): bio_incident, supply_chain_coercion
- Turn 8 (4 turn(s) ago): cyber_major_incident, safety_breakthrough, taiwan_tension_rise
- Turn 9 (3 turn(s) ago): eval_anomaly_reports, opaque_reasoning, openweight_frontier_release, eu_frontier_access_denied
- Turn 10 (2 turn(s) ago): cyber_major_incident, taiwan_blockade, bio_uplift_findings
- Turn 11 (1 turn(s) ago): knowledge_work_augmented, export_control_escalation, member_state_defection, automated_decision_scandal
