...
- characters 13751-15111: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15154-17568: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17624-18371: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M14 | EU Loss-of-Control Containment and Agent Action Audit | 2 |
