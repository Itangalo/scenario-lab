...
- characters 1718-3793: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3849-4415: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4478-29382: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29737-29995: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (2 turn(s) ago): openweight_frontier_release
- Turn 3 (1 turn(s) ago): openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
