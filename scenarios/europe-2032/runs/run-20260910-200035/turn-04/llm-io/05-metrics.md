...
- characters 105-13583: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13626-13818: `{{metrics_json}}` from the run's live metric values
- characters 13911-15210: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15253-17328: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17384-18591: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Bio Detection and Medical Countermeasure Reserve | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Incident Reporting and Open-Model Watch −2, EU Continuity Switch for Essential Services −2, priority −1 = −11
PROPOSAL BONUS: EU Continuity Switch (cat 9, small) +3 — eu_frontier_access_denied landed this turn hitting hospitals/ministries and this answers it directly but small size limits value
LEGITIMACY LENDS: capital 24, sentiment 42 -> +2
