...
- characters 1722-3920: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3976-4476: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4539-31090: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31445-32136: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (8 turn(s) ago): openweight_frontier_release
- Turn 3 (7 turn(s) ago): openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
- Turn 4 (6 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, adoption_success
- Turn 5 (5 turn(s) ago): cyber_major_incident, election_consolidation
- Turn 6 (4 turn(s) ago): bio_incident, supply_chain_coercion
- Turn 8 (2 turn(s) ago): cyber_major_incident, safety_breakthrough, taiwan_tension_rise
- Turn 9 (1 turn(s) ago): eval_anomaly_reports, opaque_reasoning, openweight_frontier_release, eu_frontier_access_denied
