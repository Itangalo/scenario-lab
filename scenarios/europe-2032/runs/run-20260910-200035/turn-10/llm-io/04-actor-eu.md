...
- characters 1800-3998: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5396-5878: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8964-11216: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Essential Services Sovereign Inference Reserve | 4 | small | 9 | 11 | own jurisdiction | eu_ai_sovereignty up, resilience up | 2 | running |
