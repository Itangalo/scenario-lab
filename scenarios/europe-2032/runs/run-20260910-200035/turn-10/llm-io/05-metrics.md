...
- characters 106-13004: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13047-13239: `{{metrics_json}}` from the run's live metric values
- characters 13332-14634: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14677-16875: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16931-18086: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Essential Services Sovereign Inference Reserve | 2 |
