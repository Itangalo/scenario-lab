...
- characters 106-13445: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13488-13680: `{{metrics_json}}` from the run's live metric values
- characters 13773-15415: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15459-17571: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17627-18168: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Incident Reporting and Open-Model Watch | 2 |
| M5 | EU Continuity Switch for Essential Services | 2 |
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 52.0, "ai_safety": 28.0, "resilience": 41.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 26.0, "public_sentiment": 42.0}
```
## Narrative
### The cutoff
