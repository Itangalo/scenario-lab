...
- characters 107-13469: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13512-13704: `{{metrics_json}}` from the run's live metric values
- characters 13797-15494: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15538-17612: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17668-18239: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M15 | EU Joint Threat Telemetry and Biosurveillance Accession | 2 |
