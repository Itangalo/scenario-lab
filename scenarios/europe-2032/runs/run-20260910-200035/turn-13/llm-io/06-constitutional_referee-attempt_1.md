...
- characters 2909-3462: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t13: M14 EU Loss-of-Control Containment and Agent Action Audit −2, M15 EU Joint Threat Telemetry and Biosurveillance Accession −2 = −4 (capital below 20 so priority has no effect and is not charged, measures only −4)
PROPOSAL BONUS: none — M15 (cat 6, small) takes up joint invitation, a protective opportunity not a negative shock from last three rounds, no payout
LEGITIMACY LENDS: capital 10, sentiment 16 -> +2
SOVEREIGNTY: 15 last turn, no cat 4 finish, no cat 4 in flight, supply_chain_coercion t13 −2, capability rose 1.0 −0 = 13
