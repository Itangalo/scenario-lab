...
- characters 376-1765: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1808-5172: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5228-5662: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5725-32120: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32475-32956: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (6 turn(s) ago): openweight_frontier_release
- Turn 3 (5 turn(s) ago): openweight_frontier_release, export_control_escalation, eu_frontier_access_denied
- Turn 4 (4 turn(s) ago): bio_uplift_findings, knowledge_work_augmented, adoption_success
- Turn 5 (3 turn(s) ago): cyber_major_incident, election_consolidation
- Turn 6 (2 turn(s) ago): bio_incident, supply_chain_coercion
