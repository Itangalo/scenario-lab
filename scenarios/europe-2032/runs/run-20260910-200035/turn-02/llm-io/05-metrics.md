...
- characters 105-13046: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13089-13281: `{{metrics_json}}` from the run's live metric values
- characters 13374-14774: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14817-16835: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16891-17976: `{{notepad}}` from the Game Master's notepad, carried across turns
