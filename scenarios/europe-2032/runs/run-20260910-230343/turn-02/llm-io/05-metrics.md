...
- characters 16617-17371: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_gigafactory_siting_backlash` -- first noted turn 2, listed in 1 turn(s) so far: Coordinated local opposition stalls one or more gigafactory shortlist sites over power prices, water use and planning, forcing a site delay or relocation fight in the first half of 2027.
