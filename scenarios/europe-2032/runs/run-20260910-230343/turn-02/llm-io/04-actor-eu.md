...
- characters 4000-4472: `{{statement_ledger}}` from the actor's live statement ledger
- characters 5944-8071: `{{previous_actions}}` from the actor's own response from the previous turn
