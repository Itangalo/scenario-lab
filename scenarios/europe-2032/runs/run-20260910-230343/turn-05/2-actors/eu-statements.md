...
- `two_year_commitment` (commitment): Build sovereign European AI capacity that protects livelihoods and can be stopped when it fails

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Build sovereign European AI capacity that protects livelihoods and can be stopped when it fails
