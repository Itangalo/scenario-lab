...
- characters 2463-4579: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4635-5138: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5201-32092: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32447-32623: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Evaluation Cell −2, EU Municipal Recovery Surge −2, EU Entry-Level Transition Fund −2, priority −1 = −13
PROPOSAL BONUS: EU Entry-Level Transition Fund (cat 7, small) +3 — labour_displacement fired this turn hitting entry-level hiring and this answers it directly
...
- Turn 4 (1 turn(s) ago): labour_displacement
