...
- characters 2541-4657: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6456-6928: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9185-11090: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Entry-Level Transition Fund | 7 | small | 4 | 6 | own jurisdiction | public_sentiment up, eu_political_capital stabilised, resilience up modestly | 2 | running |
...
| M4 | EU Frontier Evaluation Cell | 5 | small | 2 | 5 | own jurisdiction | ai_safety up modestly, eu_ai_sovereignty up indirectly via talent | 2 | finished |
| M5 | EU Municipal Recovery Surge | 6 | small | 3 | 5 | own jurisdiction | resilience up, public_sentiment stabilised | 2 | finished |
