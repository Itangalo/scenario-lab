...
- characters 377-2045: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2089-4364: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4420-5186: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5249-28531: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28886-28969: `{{event_history}}` from the run's own event record
