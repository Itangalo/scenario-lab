...
- characters 106-13066: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13109-13301: `{{metrics_json}}` from the run's live metric values
- characters 13394-15062: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15106-17381: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17437-18203: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PROPOSAL BONUS: EU Frontier Evaluation Cell (cat 5, small) +3 — capability_jump this turn widened assurance gap and this answers it directly
LEGITIMACY LENDS: capital 27, sentiment 37 -> +1
SOVEREIGNTY: 22 last turn, no capacity event, Gigafactories in flight +0, capability rose 4.0 −1 = 21

## Emerging developments (tracked)

- `emergent_gigafactory_siting_backlash` -- first noted turn 2, listed in 2 turn(s) so far: Coordinated local opposition stalls one or more gigafactory shortlist sites over power prices, water use and planning, forcing a site delay or relocation fight in the first half of 2027.
