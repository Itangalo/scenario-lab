...
- characters 13782-15801: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15844-17804: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17860-18365: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Municipal Recovery Surge | 2 |
| M6 | EU Entry-Level Transition Fund | 2 |
...
## Metrics
```json
{"ai_capability": 60.5, "openweight_capability": 56.2, "ai_safety": 26.0, "resilience": 42.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 23.0, "public_sentiment": 27.0}
```
