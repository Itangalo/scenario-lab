...
- characters 376-2395: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2438-4398: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4454-5275: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5338-29119: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29474-29604: `{{event_history}}` from the run's own event record
