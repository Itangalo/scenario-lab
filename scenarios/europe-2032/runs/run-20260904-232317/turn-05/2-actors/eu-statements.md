...
- `two_year_commitment` (commitment): Secure sovereign AI capacity to anchor control, resilience, and strategic autonomy

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign AI capacity to anchor control, resilience, and strategic autonomy
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The commitment's time-bound nature is central to its purpose; expiry of the period directly changes the actor's obligation and rationale for maintaining the original statement.
