...
- `two_year_commitment` (commitment): Regain European control over essential services and harden society to absorb AI harm

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Regain European control over essential services and harden society to absorb AI harm
