...
- characters 377-2516: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2560-5060: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5116-5626: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5689-34665: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35020-35422: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Evaluation and Bio-Uplift Observatory −2, Municipal Continuity Backstop −2, priority −1 = −11
PROPOSAL BONUS: Municipal Continuity Backstop (cat 6, small) +3 — insurer repricing crunch fired this turn forcing cuts, and this answers it directly alongside finishing Shield
LEGITIMACY LENDS: capital 18, sentiment 24 -> +1
SOVEREIGNTY: 17 last turn, no capacity event, Gigafactories in flight +0, capability rose 5.0 −1 = 16
...
- Turn 2 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, knowledge_work_augmented, export_control_escalation
- Turn 3 (2 turn(s) ago): loss_of_control_incident, adoption_success
- Turn 4 (1 turn(s) ago): loss_of_control_incident, capability_jump, adoption_success, automated_decision_scandal, emergent_utility_insurance_crunch
