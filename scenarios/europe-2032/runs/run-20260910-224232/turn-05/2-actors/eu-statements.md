...
- `two_year_commitment` (commitment): Hold essential services and public trust through AI shocks while rebuilding independent capacity to act

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold essential services and public trust through AI shocks while rebuilding independent capacity to act
