...
- characters 106-13179: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13222-13414: `{{metrics_json}}` from the run's live metric values
- characters 13507-14859: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14903-17469: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17525-18485: `{{notepad}}` from the Game Master's notepad, carried across turns
