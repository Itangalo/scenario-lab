...
- characters 376-2149: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2192-4294: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4350-5106: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5169-32113: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32468-32721: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, knowledge_work_augmented, export_control_escalation
- Turn 3 (1 turn(s) ago): loss_of_control_incident, adoption_success
