...
- characters 13894-15667: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15710-17812: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17868-18256: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | Municipal Continuity Backstop | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, EU Frontier Evaluation and Bio-Uplift Observatory −2, priority −1 = −12
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 23, sentiment 30 -> +2
