...
- characters 6579-7051: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8523-10650: `{{previous_actions}}` from the actor's own response from the previous turn
