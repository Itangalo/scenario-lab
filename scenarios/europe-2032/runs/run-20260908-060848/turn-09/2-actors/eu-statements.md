...
- `two_year_commitment` (commitment): Secure autonomous defence and sovereign response capacity against AI-enabled threats to critical infrastructure

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure autonomous defence and sovereign response capacity against AI-enabled threats to critical infrastructure
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the two-year period directly ends the original commitment's timeframe, changing the cost of maintaining the old statement and necessitating a strategic update.
