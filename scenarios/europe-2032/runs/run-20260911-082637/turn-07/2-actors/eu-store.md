...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Loss-of-Control Rapid Containment Protocol", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety loss contained via faster containment"}, "grounds": "to answer loss-of-control incident with low capital"}
  - Grounds: to answer loss-of-control incident with low capital
