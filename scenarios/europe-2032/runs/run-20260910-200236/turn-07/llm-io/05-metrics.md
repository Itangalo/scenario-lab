...
- characters 106-13587: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13630-13822: `{{metrics_json}}` from the run's live metric values
- characters 13915-15253: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15297-18231: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18287-19386: `{{notepad}}` from the Game Master's notepad, carried across turns
