...
- characters 1759-4693: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4749-5848: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5911-30260: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30615-31024: `{{event_history}}` from the run's own event record
...
- `emergent_permit_backlash_spillover` -- first noted turn 6, listed in 1 turn(s) so far: US tiered-queue chip licensing leaks into EU press, triggering coordinated municipal backlash against new data-centre permits in France, Germany and the Netherlands.
- `emergent_allocation_humiliation` -- first noted turn 6, listed in 1 turn(s) so far: US tiered chip queue leaks showing EU allocations explicitly subordinated to domestic buyers, triggering public procurement freeze threats in two member states.
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, knowledge_work_augmented, export_control_escalation
- Turn 3 (4 turn(s) ago): ai_investment_collapse, taiwan_tension_rise, emergent_provenance_mandate
- Turn 4 (3 turn(s) ago): knowledge_work_augmented
- Turn 5 (2 turn(s) ago): loss_of_control_incident, election_consolidation
- Turn 6 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, taiwan_tension_rise
