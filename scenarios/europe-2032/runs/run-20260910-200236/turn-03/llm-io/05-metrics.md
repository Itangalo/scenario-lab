...
- characters 13613-15196: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15240-16896: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16952-17317: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | Cross-Border Repair and Continuity Reserve | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Shield Hardening Programme −3, priority −1 = −10
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 30, sentiment 40.5 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, Gigafactories/tech package in flight +0, capability rose 1.5 no term = 20
...
## Metrics
```json
{"ai_capability": 56.5, "openweight_capability": 52.2, "ai_safety": 28.0, "resilience": 41.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 26.0, "public_sentiment": 37.5}
```
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, Cross-Border Repair and Continuity Reserve −2, priority −1 = −9
PROPOSAL BONUS: Cross-Border Repair and Continuity Reserve (cat 6, small) +2 — answers autumn grid/port intrusions and repair-stock blockage from last two turns directly, Taiwan risk adds recency
LEGITIMACY LENDS: capital 24, sentiment 37.5 -> +2
