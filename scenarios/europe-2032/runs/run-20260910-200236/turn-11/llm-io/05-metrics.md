...
- characters 107-13258: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13301-13493: `{{metrics_json}}` from the run's live metric values
- characters 13586-14599: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14643-16758: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16814-17229: `{{notepad}}` from the Game Master's notepad, carried across turns
