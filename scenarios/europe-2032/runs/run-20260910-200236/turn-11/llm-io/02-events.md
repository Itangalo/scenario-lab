...
- characters 378-1391: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1435-3550: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3606-4334: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4397-27843: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28198-29034: `{{event_history}}` from the run's own event record
...
- Turn 3 (8 turn(s) ago): ai_investment_collapse, taiwan_tension_rise, emergent_provenance_mandate
- Turn 4 (7 turn(s) ago): knowledge_work_augmented
- Turn 5 (6 turn(s) ago): loss_of_control_incident, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, eval_anomaly_reports, taiwan_tension_rise
- Turn 7 (4 turn(s) ago): cyber_major_incident, taiwan_tension_rise, export_control_escalation, us_china_agreement
- Turn 8 (3 turn(s) ago): openweight_frontier_release, labour_displacement, adoption_success, emergent_permit_backlash_spillover
- Turn 9 (2 turn(s) ago): export_control_escalation, automated_decision_scandal, emergent_permit_referendum_wave
- Turn 10 (1 turn(s) ago): cyber_major_incident, safety_breakthrough
