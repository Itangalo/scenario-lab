...
- characters 376-2696: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2739-5024: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5080-5651: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5714-26953: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27308-27627: `{{event_history}}` from the run's own event record
...
- Turn 3 (3 turn(s) ago): ai_investment_collapse, taiwan_tension_rise, emergent_provenance_mandate
