...
- characters 454-2774: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2817-5102: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6456-6919: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9177-11707: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Agent Loss-of-Control Containment and Mutual Aid Protocol | 6 | small | 5 | 7 | own jurisdiction | resilience up, ai_safety up slightly via containment | 2 | running |
