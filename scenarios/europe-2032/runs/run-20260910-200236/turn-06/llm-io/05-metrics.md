...
- characters 13729-16049: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16092-18377: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18433-19545: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Agent Loss-of-Control Containment and Mutual Aid Protocol | 2 |
| M7 | EU Cyber Emergency Containment Surge | 2 |
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 election won by keep-AI-at-home president, takes office turn 6"}, {"op": "update", "table": "measures", "id": "M7", "fields": {"finish_turn": 7}, "grounds": "named priority"}]}
```
```
