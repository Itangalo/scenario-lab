...
- characters 105-12890: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12933-13125: `{{metrics_json}}` from the run's live metric values
- characters 13218-14381: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14424-17044: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17100-18383: `{{notepad}}` from the Game Master's notepad, carried across turns
