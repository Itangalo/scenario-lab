...
- characters 105-12819: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12862-13054: `{{metrics_json}}` from the run's live metric values
- characters 13147-14359: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14402-16821: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16877-17358: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Community-Anchored Compute Compact | 2 |
