...
- characters 376-1588: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1631-4050: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4106-5128: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5191-28034: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28389-28913: `{{event_history}}` from the run's own event record
...
- `emergent_permit_backlash_spillover` -- first noted turn 6, listed in 2 turn(s) so far: US tiered-queue chip licensing leaks into EU press, triggering coordinated municipal backlash against new data-centre permits in France, Germany and the Netherlands.
- `emergent_allocation_humiliation` -- first noted turn 6, listed in 2 turn(s) so far: US tiered chip queue leaks showing EU allocations explicitly subordinated to domestic buyers, triggering public procurement freeze threats in two member states.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, knowledge_work_augmented, export_control_escalation
- Turn 3 (5 turn(s) ago): ai_investment_collapse, taiwan_tension_rise, emergent_provenance_mandate
- Turn 4 (4 turn(s) ago): knowledge_work_augmented
- Turn 5 (3 turn(s) ago): loss_of_control_incident, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, taiwan_tension_rise
- Turn 7 (1 turn(s) ago): cyber_major_incident, taiwan_tension_rise, export_control_escalation, us_china_agreement
