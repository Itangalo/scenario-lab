...
- characters 377-1503: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1546-3690: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3746-4551: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4614-28060: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28415-29181: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Accountable Deployment and Redress Guarantee −2, priority −1 = −3
PROPOSAL BONUS: EU Accountable Deployment and Redress Guarantee (cat 9, small) +3 — automated-decision scandal fired this turn and this answers oversight/redress directly
LEGITIMACY LENDS: capital 24, sentiment 21 -> none, capital higher
SOVEREIGNTY: 23 last turn, EU Community-Anchored Compute Compact finishes t9 +4, no in-flight build +0, export_control_escalation t9 −2, capability rose 0.7 −0 = 25

## Emerging developments (tracked)

- `emergent_graduate_permit_protests` -- first noted turn 9, listed in 1 turn(s) so far: Graduate-led protests against AI-driven hiring freezes escalate in two or more EU university cities, with occupations targeting data-centre permit hearings and demands for hiring quotas.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, knowledge_work_augmented, export_control_escalation
- Turn 3 (7 turn(s) ago): ai_investment_collapse, taiwan_tension_rise, emergent_provenance_mandate
- Turn 4 (6 turn(s) ago): knowledge_work_augmented
- Turn 5 (5 turn(s) ago): loss_of_control_incident, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, taiwan_tension_rise
- Turn 7 (3 turn(s) ago): cyber_major_incident, taiwan_tension_rise, export_control_escalation, us_china_agreement
- Turn 8 (2 turn(s) ago): openweight_frontier_release, labour_displacement, adoption_success, emergent_permit_backlash_spillover
- Turn 9 (1 turn(s) ago): export_control_escalation, automated_decision_scandal, emergent_permit_referendum_wave
