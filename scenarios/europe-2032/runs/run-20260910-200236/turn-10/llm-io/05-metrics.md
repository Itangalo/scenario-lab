...
- characters 106-13255: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13298-13490: `{{metrics_json}}` from the run's live metric values
- characters 13583-14709: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14752-16896: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16952-17757: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Cyber Restoration and Safe-Systems Adoption Surge | 2 |
...
- `emergent_graduate_permit_protests` -- first noted turn 9, listed in 2 turn(s) so far: Graduate-led protests against AI-driven hiring freezes escalate in two or more EU university cities, with occupations targeting data-centre permit hearings and demands for hiring quotas.
