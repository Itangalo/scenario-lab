...
- characters 455-1581: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1624-3768: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4644-5152: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7779-10303: `{{previous_actions}}` from the actor's own response from the previous turn
