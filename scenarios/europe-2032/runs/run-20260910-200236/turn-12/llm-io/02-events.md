...
- characters 377-1696: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1739-3351: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3407-3852: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3915-27361: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27716-28552: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Local Services Continuity and Livelihood Bridge −2, priority −1 = −3
PROPOSAL BONUS: EU Local Services Continuity and Livelihood Bridge (cat 7, small) +2 — February freezes/coordinated cyberattack landed in t10 and this answers continuity/livelihood directly
LEGITIMACY LENDS: none — capital 23, sentiment 15, capital higher
...
- Turn 3 (9 turn(s) ago): ai_investment_collapse, taiwan_tension_rise, emergent_provenance_mandate
- Turn 4 (8 turn(s) ago): knowledge_work_augmented
- Turn 5 (7 turn(s) ago): loss_of_control_incident, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, eval_anomaly_reports, taiwan_tension_rise
- Turn 7 (5 turn(s) ago): cyber_major_incident, taiwan_tension_rise, export_control_escalation, us_china_agreement
- Turn 8 (4 turn(s) ago): openweight_frontier_release, labour_displacement, adoption_success, emergent_permit_backlash_spillover
- Turn 9 (3 turn(s) ago): export_control_escalation, automated_decision_scandal, emergent_permit_referendum_wave
- Turn 10 (2 turn(s) ago): cyber_major_incident, safety_breakthrough
