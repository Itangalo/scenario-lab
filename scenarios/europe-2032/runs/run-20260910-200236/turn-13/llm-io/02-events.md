...
- characters 378-1323: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1367-2866: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 2922-3699: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3762-27208: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27563-28400: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Local Services Continuity and Livelihood Bridge −2, EU Human Front-Door and Trusted Stewards −2, priority −1 = −5
PROPOSAL BONUS: EU Human Front-Door and Trusted Stewards (cat 9, small) +2 — February freezes/coordinated cyberattack in t10 within last three turns and this answers trust/continuity directly
LEGITIMACY LENDS: none — capital 25, sentiment 17, capital higher
SOVEREIGNTY: 25 last turn, no capacity event, no cat4 in flight +0, capability rose 0.7 −0 = 25

## Emerging developments (tracked)

- `emergent_rebuild_site_blockades` -- first noted turn 12, listed in 1 turn(s) so far: Coordinated physical blockades of hardened rebuild sites and EU-anchored server installations in hit-state municipalities, forcing a pause in continuity works.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, knowledge_work_augmented, export_control_escalation
- Turn 3 (10 turn(s) ago): ai_investment_collapse, taiwan_tension_rise, emergent_provenance_mandate
- Turn 4 (9 turn(s) ago): knowledge_work_augmented
- Turn 5 (8 turn(s) ago): loss_of_control_incident, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, eval_anomaly_reports, taiwan_tension_rise
- Turn 7 (6 turn(s) ago): cyber_major_incident, taiwan_tension_rise, export_control_escalation, us_china_agreement
- Turn 8 (5 turn(s) ago): openweight_frontier_release, labour_displacement, adoption_success, emergent_permit_backlash_spillover
- Turn 9 (4 turn(s) ago): export_control_escalation, automated_decision_scandal, emergent_permit_referendum_wave
- Turn 10 (3 turn(s) ago): cyber_major_incident, safety_breakthrough
