...
- characters 13542-14487: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14531-16030: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16086-16863: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_rebuild_site_blockades` -- first noted turn 12, listed in 2 turn(s) so far: Coordinated physical blockades of hardened rebuild sites and EU-anchored server installations in hit-state municipalities, forcing a pause in continuity works.
...
## Metrics
```json
{"ai_capability": 65.6, "openweight_capability": 64.2, "ai_safety": 15.0, "resilience": 46.5, "eu_ai_sovereignty": 25.0, "eu_political_capital": 22.0, "public_sentiment": 20.0}
```
...
## Notepad
PORTFOLIO CHARGE t13: EU Human Front-Door and Trusted Stewards −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: none — capital 22, sentiment 17, capital higher
SOVEREIGNTY: 25 last turn, no capacity event, no cat4 in flight +0, capability rose 0.7 −0 = 25
