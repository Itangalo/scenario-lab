...
- characters 106-12969: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13012-13204: `{{metrics_json}}` from the run's live metric values
- characters 13297-15107: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15151-17385: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17441-17888: `{{notepad}}` from the Game Master's notepad, carried across turns
