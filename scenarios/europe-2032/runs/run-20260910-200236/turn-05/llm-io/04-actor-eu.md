...
- characters 455-2265: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2309-4543: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6064-6546: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8625-10781: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU Workplace Transition and Income Bridge | 7 | small | 4 | 7 | own jurisdiction | resilience up moderately, public_sentiment up | 2 | running |
