...
- characters 106-13217: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13260-13452: `{{metrics_json}}` from the run's live metric values
- characters 13545-14474: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14518-16751: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16807-17540: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Accountable Deployment and Redress Guarantee | 2 |
