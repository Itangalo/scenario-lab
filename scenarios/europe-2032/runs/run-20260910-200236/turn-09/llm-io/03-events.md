...
- characters 377-1306: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1350-3583: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3639-4059: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4122-27568: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27923-28576: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Community-Anchored Compute Compact −2, priority −1 = −3
PROPOSAL BONUS: EU Community-Anchored Compute Compact (cat 4, small) +3 — emergent_permit_backlash_spillover blocking FR-DE-NL permits this turn and this answers it directly
LEGITIMACY LENDS: capital 24, sentiment 21 -> none, capital higher
SOVEREIGNTY: 23 last turn, no capacity event, M8 proposed this turn +0, capability rose 0.7 −0 = 23
...
- Turn 3 (6 turn(s) ago): ai_investment_collapse, taiwan_tension_rise, emergent_provenance_mandate
- Turn 4 (5 turn(s) ago): knowledge_work_augmented
- Turn 5 (4 turn(s) ago): loss_of_control_incident, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, taiwan_tension_rise
- Turn 7 (2 turn(s) ago): cyber_major_incident, taiwan_tension_rise, export_control_escalation, us_china_agreement
- Turn 8 (1 turn(s) ago): openweight_frontier_release, labour_displacement, adoption_success, emergent_permit_backlash_spillover
