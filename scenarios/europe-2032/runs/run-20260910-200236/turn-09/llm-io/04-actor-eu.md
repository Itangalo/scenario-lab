...
- characters 455-1384: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1428-3661: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5634-6097: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8529-10586: `{{previous_actions}}` from the actor's own response from the previous turn
