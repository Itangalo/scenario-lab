...
- `two_year_commitment` (commitment): Rebuild public trust by keeping essential services running through AI disruption

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild public trust by keeping essential services running through AI disruption
