...
| M7 | EU Municipal Continuity and Bio-Sentinel Surge | 6 | small | 8 | 10 | own jurisdiction | resilience up, ai_safety up modestly via detection | 2 | running |
...
- **applied** `M7` — {"op": "add", "table": "measures", "fields": {"name": "EU Municipal Continuity and Bio-Sentinel Surge", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up modestly via detection"}, "grounds": "back-to-back automated outages plus bio uplift precursor demand immediate hardening"}
  - Grounds: back-to-back automated outages plus bio uplift precursor demand immediate hardening
