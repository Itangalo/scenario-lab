...
- characters 1488-3597: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3653-4140: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4203-32688: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33043-33249: `{{event_history}}` from the run's own event record
...
- Turn 3 (2 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 4 (1 turn(s) ago): knowledge_work_augmented, emergent_grid_forensics_disclosure
