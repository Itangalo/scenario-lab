...
- characters 1566-3675: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5129-5601: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7754-10147: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | Municipal Grid Credential Reset and Copycat Shield | 6 | small | 4 | 5 | own jurisdiction | resilience up modestly, ai_safety protected via incident response | 2 | finished |
