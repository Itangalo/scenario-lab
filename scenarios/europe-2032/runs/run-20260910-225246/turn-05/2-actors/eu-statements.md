...
- `two_year_commitment` (commitment): Secure sovereign capacity and societal resilience against coercion and AI-enabled harm

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign capacity and societal resilience against coercion and AI-enabled harm
