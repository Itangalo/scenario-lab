...
- characters 105-13537: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13580-13772: `{{metrics_json}}` from the run's live metric values
- characters 13865-15139: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15182-17375: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17431-17945: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Chips-for-Access Compact | 2 |
| M5 | Municipal Grid Credential Reset and Copycat Shield | 2 |
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Chips-for-Access Compact −2, Municipal Grid Credential Reset and Copycat Shield −2, priority −1 = −11
PROPOSAL BONUS: Municipal Grid Credential Reset (cat 6, small) +3 — copycat scanning after published grid forensics this turn and this answers it directly
