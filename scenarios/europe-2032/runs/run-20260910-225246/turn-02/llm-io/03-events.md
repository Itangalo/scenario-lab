...
- characters 1609-3701: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3757-4195: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4258-28485: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28840-28881: `{{event_history}}` from the run's own event record
