...
```
## New measure
None this turn. We are waiting for the four-to-five gigafactory site decisions and Shield funding flows to clear permitting before staking further capital.

## Store changes
No changes.

## Priority
InvestAI Gigafactories (M1) – because without legally anchored domestic compute the switch-off precedent leaves Shield hardening and every other aim revocable.

## In practice
We are driving M1/M2 through DG CNECT and the Competitiveness Council toward final investment decisions, using InvestAI guarantees and EIB co-financing with grid-priority permits, trading EU-paid grid upgrades for regions to stop undercutting each other on siting. Legal anchoring under the EU jurisdiction clause is non-negotiable.

We execute the Shield (M3) via ENISA and HERA, starting mandatory reporting drills for transmission operators, ports and water utilities hit in autumn, with pooled procurement of detection stacks funded from the Civil Protection uplift. Interior ministers get hardening funds only against signed, exercised continuity plans.
```
