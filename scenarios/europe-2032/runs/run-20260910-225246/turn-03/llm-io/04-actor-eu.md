...
- characters 1691-3543: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5016-5488: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6960-8008: `{{previous_actions}}` from the actor's own response from the previous turn
