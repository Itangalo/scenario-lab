...
- characters 106-13129: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13172-13364: `{{metrics_json}}` from the run's live metric values
- characters 13457-14649: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14693-16545: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16601-17612: `{{notepad}}` from the Game Master's notepad, carried across turns
