...
- characters 105-13626: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13669-13861: `{{metrics_json}}` from the run's live metric values
- characters 13954-15235: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15278-17337: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17393-17916: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, EU AI Displacement Transition Facility −2, priority −1 = −6
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 7, sentiment 28 -> +2
SOVEREIGNTY: 18 last turn, no capacity event finishes, Gigafactories in flight +0, supply_chain_coercion t4 −2, capability rose 6.5 −1 = 15
## Store changes
```json
{"store": []}
```
