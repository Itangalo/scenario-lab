...
- characters 4888-5328: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6782-8873: `{{previous_actions}}` from the actor's own response from the previous turn
