...
- `two_year_commitment` (commitment): Resilient European autonomy that absorbs AI shocks and holds leverage

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Resilient European autonomy that absorbs AI shocks and holds leverage
