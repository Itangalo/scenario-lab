...
- characters 106-13088: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13131-13322: `{{metrics_json}}` from the run's live metric values
- characters 13415-15016: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15060-17210: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17266-17618: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, EU AI Displacement Transition Facility −2, priority −1 = −6
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 3, sentiment 25 -> +2 already included in capital movement
SOVEREIGNTY: 15 last turn, no capacity event, Gigafactories in flight +0, capability rose 5.5 −1 = 14
