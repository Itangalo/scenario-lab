...
- characters 376-1977: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2021-4171: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4227-4579: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4642-33024: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33379-33672: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): eval_anomaly_reports, export_control_escalation
- Turn 3 (2 turn(s) ago): labour_displacement
- Turn 4 (1 turn(s) ago): capability_jump, ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, supply_chain_coercion
