...
- characters 1571-3665: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4870-5380: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7673-9379: `{{previous_actions}}` from the actor's own response from the previous turn
