...
- characters 1493-3587: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3643-4681: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4744-30754: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31109-31605: `{{event_history}}` from the run's own event record
...
- `emergent_distressed_asset_grab` -- first noted turn 4, listed in 2 turn(s) so far: Distressed private data-centre shells and cancelled power reservations are bought up at scale by non-EU hyperscalers and sovereign funds, permanently removing them from the EU-anchored lease pool Brussels is trying to assemble.
- `emergent_distressed_asset_flight` -- first noted turn 4, listed in 2 turn(s) so far: Distressed private data-centre operators and chip holders fire-sale EU-sited assets to non-EU buyers before the Commission's lease sweep closes, permanently removing scarce power and equipment from EU control.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, member_state_defection
- Turn 2 (4 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, adoption_success, emergent_clinical_trust_pause
- Turn 3 (3 turn(s) ago): capability_jump, ai_investment_collapse, eu_frontier_access_denied
- Turn 4 (2 turn(s) ago): capability_jump
- Turn 5 (1 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, election_consolidation
