...
- characters 105-13680: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13723-13915: `{{metrics_json}}` from the run's live metric values
- characters 14008-15082: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15125-17219: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17275-17664: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Trusted Public AI Dividend | 2 |
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Continuity Capacity Acquisition −2, EU Probe Containment Surge −2, priority M6 −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 8, sentiment 34 -> +2
SOVEREIGNTY: 14 last turn, no capacity event, Gigafactories + Tech package in flight +0, capability rose 1.0 −0 = 14
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 elected consolidation president, takes office turn 6"}]}
```
```
