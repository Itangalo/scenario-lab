...
- characters 105-13460: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13503-13695: `{{metrics_json}}` from the run's live metric values
- characters 13788-15597: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15640-17732: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17788-19066: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Clinical Sovereignty Pilot | 2 |
| M5 | EU Continuity Capacity Acquisition | 2 |
| M6 | EU Probe Containment Surge | 2 |
...
- `emergent_distressed_asset_grab` -- first noted turn 4, listed in 1 turn(s) so far: Distressed private data-centre shells and cancelled power reservations are bought up at scale by non-EU hyperscalers and sovereign funds, permanently removing them from the EU-anchored lease pool Brussels is trying to assemble.
- `emergent_distressed_asset_flight` -- first noted turn 4, listed in 1 turn(s) so far: Distressed private data-centre operators and chip holders fire-sale EU-sited assets to non-EU buyers before the Commission's lease sweep closes, permanently removing scarce power and equipment from EU control.
...
## Metrics
```json
{"ai_capability": 60.0, "openweight_capability": 55.5, "ai_safety": 16.0, "resilience": 39.5, "eu_ai_sovereignty": 14.0, "eu_political_capital": 16.0, "public_sentiment": 34.0}
```
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Clinical Sovereignty Pilot −2, EU Continuity Capacity Acquisition −2, EU Probe Containment Surge −2, priority M5 −1 = −13
PROPOSAL BONUS: EU Probe Containment Surge (cat 6, small) +2 — capability_jump this turn, severe and directly answered by executable-probe containment
LEGITIMACY LENDS: capital 14, sentiment 33 -> +2
SOVEREIGNTY: 15 last turn, no capacity event, Gigafactories + Tech package in flight +0, capability rose 2.0 −1 = 14
