...
- characters 1906-4065: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6658-7168: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9996-11902: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Assurance Adoption Pact | 5 | small | 8 | 10 | own jurisdiction | ai_safety up materially, resilience up slightly via trusted restore | 2 | running |
