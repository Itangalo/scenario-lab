...
- characters 13379-13571: `{{metrics_json}}` from the run's live metric values
- characters 13664-15071: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15115-17274: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17330-17813: `{{notepad}}` from the Game Master's notepad, carried across turns
