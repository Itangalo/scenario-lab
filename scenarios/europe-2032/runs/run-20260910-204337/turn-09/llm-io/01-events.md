...
- characters 1828-3987: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4043-4526: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4589-28999: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29354-30079: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M8 EU Municipal Recovery Corps −2, M9 EU Assurance Adoption Pact −2, priority M8 no effect under capital <20 −0 = −4
PROPOSAL BONUS: EU Assurance Adoption Pact (cat 5, small) +1 — openweight_frontier_release landed this turn and this answers it partially via safe deployment, small size limits value
LEGITIMACY LENDS: capital 13, sentiment 38 -> +1
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, member_state_defection
- Turn 2 (7 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, adoption_success, emergent_clinical_trust_pause
- Turn 3 (6 turn(s) ago): capability_jump, ai_investment_collapse, eu_frontier_access_denied
- Turn 4 (5 turn(s) ago): capability_jump
- Turn 5 (4 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, election_consolidation
- Turn 6 (3 turn(s) ago): us_china_agreement, adoption_success
- Turn 7 (2 turn(s) ago): cyber_major_incident, opaque_reasoning, knowledge_work_augmented
- Turn 8 (1 turn(s) ago): openweight_frontier_release, safety_breakthrough
