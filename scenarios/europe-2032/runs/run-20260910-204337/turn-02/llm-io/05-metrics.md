...
- characters 105-13026: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13069-13261: `{{metrics_json}}` from the run's live metric values
- characters 13354-14469: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14512-16930: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16986-17905: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_research_integrity_crisis` -- first noted turn 1, listed in 2 turn(s) so far: A major European scientific publisher retracts dozens of papers after finding LLM-generated fabricated citations and data, triggering university bans on AI research assistants that spill into public debate.
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 49.0, "ai_safety": 30.0, "resilience": 37.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 26.0, "public_sentiment": 39.0}
```
