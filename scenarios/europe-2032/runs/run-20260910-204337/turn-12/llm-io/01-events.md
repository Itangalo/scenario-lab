...
- characters 377-1666: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1709-3941: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3997-4596: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4659-29922: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30277-31319: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, member_state_defection
- Turn 2 (10 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, adoption_success, emergent_clinical_trust_pause
- Turn 3 (9 turn(s) ago): capability_jump, ai_investment_collapse, eu_frontier_access_denied
- Turn 4 (8 turn(s) ago): capability_jump
- Turn 5 (7 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, election_consolidation
- Turn 6 (6 turn(s) ago): us_china_agreement, adoption_success
- Turn 7 (5 turn(s) ago): cyber_major_incident, opaque_reasoning, knowledge_work_augmented
- Turn 8 (4 turn(s) ago): openweight_frontier_release, safety_breakthrough
- Turn 9 (3 turn(s) ago): research_breakthrough, safety_breakthrough, knowledge_work_augmented
- Turn 10 (2 turn(s) ago): bio_uplift_findings, adoption_success
- Turn 11 (1 turn(s) ago): research_breakthrough, openweight_frontier_release, loss_of_control_incident, export_control_escalation, member_state_defection
