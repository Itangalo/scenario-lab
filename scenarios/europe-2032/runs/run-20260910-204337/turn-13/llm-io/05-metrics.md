...
- characters 107-12972: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13015-13206: `{{metrics_json}}` from the run's live metric values
- characters 13299-14781: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14825-16953: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17009-17512: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t13: M11 EU Containment and Continuity Surge −2, M12 EU Certified Assurance Upgrade −2, priority no effect under capital <20 −0 = −4
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 5, sentiment 43 -> +2
SOVEREIGNTY: 18 last turn, no capacity event, no cat4 in flight +0, capability rose 1.0 −0 = 18
