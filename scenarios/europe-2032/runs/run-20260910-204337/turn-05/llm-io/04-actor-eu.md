...
- characters 455-1794: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1838-4158: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5837-6324: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8615-10546: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Probe Containment Surge | 6 | small | 4 | 6 | own jurisdiction | resilience up, ai_safety up slightly via incident learning | 2 | running |
