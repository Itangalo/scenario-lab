...
- characters 13772-15111: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15155-17475: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17531-18698: `{{notepad}}` from the Game Master's notepad, carried across turns
