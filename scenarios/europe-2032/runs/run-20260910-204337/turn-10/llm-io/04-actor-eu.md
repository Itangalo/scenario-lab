...
- characters 455-1577: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1620-3910: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4761-5194: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8214-10412: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Certified Work Dividend | 9 | small | 9 | 11 | own jurisdiction | public_sentiment up, eu_political_capital up on success, resilience up slightly via sustained use | 2 | running |
