...
- characters 377-1499: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1542-3832: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3888-4322: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4385-28795: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29150-29970: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, member_state_defection
- Turn 2 (8 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, adoption_success, emergent_clinical_trust_pause
- Turn 3 (7 turn(s) ago): capability_jump, ai_investment_collapse, eu_frontier_access_denied
- Turn 4 (6 turn(s) ago): capability_jump
- Turn 5 (5 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, election_consolidation
- Turn 6 (4 turn(s) ago): us_china_agreement, adoption_success
- Turn 7 (3 turn(s) ago): cyber_major_incident, opaque_reasoning, knowledge_work_augmented
- Turn 8 (2 turn(s) ago): openweight_frontier_release, safety_breakthrough
- Turn 9 (1 turn(s) ago): research_breakthrough, safety_breakthrough, knowledge_work_augmented
