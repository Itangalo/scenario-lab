...
- characters 13342-13534: `{{metrics_json}}` from the run's live metric values
- characters 13627-14749: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14792-17082: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17138-17572: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Certified Work Dividend | 2 |
