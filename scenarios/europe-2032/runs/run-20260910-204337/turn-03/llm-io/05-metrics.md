...
- characters 106-13075: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13118-13310: `{{metrics_json}}` from the run's live metric values
- characters 13403-14914: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14958-17492: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17548-18066: `{{notepad}}` from the Game Master's notepad, carried across turns
