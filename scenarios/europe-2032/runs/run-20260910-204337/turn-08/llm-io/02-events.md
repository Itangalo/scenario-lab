...
- characters 1478-4182: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4238-4726: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4789-29199: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29554-30204: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, member_state_defection
- Turn 2 (6 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, adoption_success, emergent_clinical_trust_pause
- Turn 3 (5 turn(s) ago): capability_jump, ai_investment_collapse, eu_frontier_access_denied
- Turn 4 (4 turn(s) ago): capability_jump
- Turn 5 (3 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, election_consolidation
- Turn 6 (2 turn(s) ago): us_china_agreement, adoption_success
- Turn 7 (1 turn(s) ago): cyber_major_incident, opaque_reasoning, knowledge_work_augmented
