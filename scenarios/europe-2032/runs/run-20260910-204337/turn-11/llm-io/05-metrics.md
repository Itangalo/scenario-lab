...
- characters 107-13340: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13383-13575: `{{metrics_json}}` from the run's live metric values
- characters 13668-14935: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14979-16836: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16892-17213: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Containment and Continuity Surge | 2 |
...
PORTFOLIO CHARGE t10: M10 EU Certified Work Dividend −2, priority no effect under capital <20 −0 = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 14, sentiment 47 -> +2
...
## Metrics
```json
{"ai_capability": 66.5, "openweight_capability": 65.0, "ai_safety": 18.0, "resilience": 39.5, "eu_ai_sovereignty": 20.0, "eu_political_capital": 11.0, "public_sentiment": 46.0}
```
...
## Notepad
PORTFOLIO CHARGE t11: M11 EU Containment and Continuity Surge −2, priority no effect under capital <20 −0 = −2
PROPOSAL BONUS: EU Containment and Continuity Surge (cat 6, small) +3 — loss-of-control incident this turn plus contested bio-design claim, answers directly
LEGITIMACY LENDS: capital 11, sentiment 46 -> +2 [included in capital calc: 16 −2 +3 finish +3 proposal −11 events net +2 legitimacy = 11]
SOVEREIGNTY: 22 last turn, no cat4 finishes, no cat4 in flight +0, export_control_escalation t11 −2 (largest capacity event; member_state_defection also qualifies), capability rose 1.0 −0 = 20
