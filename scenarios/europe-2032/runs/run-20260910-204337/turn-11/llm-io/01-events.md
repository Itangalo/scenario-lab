...
- characters 378-1645: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1689-3546: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3602-3923: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3986-29249: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29604-30490: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, member_state_defection
- Turn 2 (9 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, adoption_success, emergent_clinical_trust_pause
- Turn 3 (8 turn(s) ago): capability_jump, ai_investment_collapse, eu_frontier_access_denied
- Turn 4 (7 turn(s) ago): capability_jump
- Turn 5 (6 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, election_consolidation
- Turn 6 (5 turn(s) ago): us_china_agreement, adoption_success
- Turn 7 (4 turn(s) ago): cyber_major_incident, opaque_reasoning, knowledge_work_augmented
- Turn 8 (3 turn(s) ago): openweight_frontier_release, safety_breakthrough
- Turn 9 (2 turn(s) ago): research_breakthrough, safety_breakthrough, knowledge_work_augmented
- Turn 10 (1 turn(s) ago): bio_uplift_findings, adoption_success
