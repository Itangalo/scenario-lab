...
- characters 13650-15203: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15247-17363: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17419-17877: `{{notepad}}` from the Game Master's notepad, carried across turns
