...
- characters 16339-16977: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_research_integrity_crisis` -- first noted turn 1, listed in 1 turn(s) so far: A major European scientific publisher retracts dozens of papers after finding LLM-generated fabricated citations and data, triggering university bans on AI research assistants that spill into public debate.
- `emergent_clinical_trust_pause` -- first noted turn 1, listed in 1 turn(s) so far: Major European research hospitals pause a US-model clinical pilot after the June switch-off scare, publicly citing continuity risk and triggering an EU-wide debate over reliance on foreign frontier models for healthcare.
