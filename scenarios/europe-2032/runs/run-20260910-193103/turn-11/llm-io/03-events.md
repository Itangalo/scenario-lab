...
- characters 1399-3577: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3633-4491: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4554-32378: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32733-33624: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, bio_incident, emergent_openweight_backlash
- Turn 2 (9 turn(s) ago): safety_breakthrough, emergent_pathogen_data_freeze
- Turn 3 (8 turn(s) ago): capability_jump, taiwan_tension_rise, export_control_escalation, us_china_agreement, joint_threat_response
- Turn 4 (7 turn(s) ago): cyber_major_incident, opaque_reasoning, research_breakthrough, medical_breakthrough
- Turn 5 (6 turn(s) ago): eval_anomaly_reports, election_consolidation
- Turn 6 (5 turn(s) ago): loss_of_control_incident
- Turn 7 (4 turn(s) ago): cyber_major_incident, emergent_tiering_scare_throttle
- Turn 8 (3 turn(s) ago): safety_breakthrough, emergent_deposit_strike
- Turn 9 (2 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 10 (1 turn(s) ago): loss_of_control_incident, safety_breakthrough, eu_frontier_access_denied, emergent_sample_escrow_defection
