...
- characters 107-13105: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13148-13338: `{{metrics_json}}` from the run's live metric values
- characters 13431-14410: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14454-16632: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16688-17205: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 90.0, "openweight_capability": 80.0, "ai_safety": 6.0, "resilience": 39.0, "eu_ai_sovereignty": 11.0, "eu_political_capital": 6.0, "public_sentiment": 2.0}
```
