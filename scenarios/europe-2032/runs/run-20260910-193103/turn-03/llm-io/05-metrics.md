...
- characters 106-13170: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13213-13405: `{{metrics_json}}` from the run's live metric values
- characters 13498-14789: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14833-17022: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17078-17938: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Assurance Uptake and Secure Bio-Data Commons | 2 |
| M5 | EU Entry into Joint Cyber-Bio Response and US-China Safety Accord | 2 |
...
- `emergent_evasion_toolkit_spread` -- first noted turn 3, listed in 1 turn(s) so far: Non-EU labs publish open toolkits that automate design of detection-evading pathogen edits, prompting copycat experiments outside vetted facilities.
