...
- characters 2255-4381: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5075-5539: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8022-10482: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Transatlantic Continuity and Diversification Pact | 8 | small | 5 | 7 | coalition (US, middle-power supply-chain partners) | eu_ai_sovereignty up slightly, resilience up slightly, slows fall in eu_political_capital | 2 | running |
