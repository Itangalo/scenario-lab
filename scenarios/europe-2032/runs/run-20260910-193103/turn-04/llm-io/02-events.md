...
- characters 376-1742: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1785-4577: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4633-5630: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5693-30923: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31278-31573: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, bio_incident, emergent_openweight_backlash
- Turn 2 (2 turn(s) ago): safety_breakthrough, emergent_pathogen_data_freeze
- Turn 3 (1 turn(s) ago): capability_jump, taiwan_tension_rise, export_control_escalation, us_china_agreement, joint_threat_response
