...
- characters 105-13515: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13558-13750: `{{metrics_json}}` from the run's live metric values
- characters 13843-15209: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15252-18044: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18100-19097: `{{notepad}}` from the Game Master's notepad, carried across turns
