...
- characters 373-1680: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1723-4518: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4574-5220: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5283-32532: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32887-33884: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, bio_incident, emergent_openweight_backlash
- Turn 2 (10 turn(s) ago): safety_breakthrough, emergent_pathogen_data_freeze
- Turn 3 (9 turn(s) ago): capability_jump, taiwan_tension_rise, export_control_escalation, us_china_agreement, joint_threat_response
- Turn 4 (8 turn(s) ago): cyber_major_incident, opaque_reasoning, research_breakthrough, medical_breakthrough
- Turn 5 (7 turn(s) ago): eval_anomaly_reports, election_consolidation
- Turn 6 (6 turn(s) ago): loss_of_control_incident
- Turn 7 (5 turn(s) ago): cyber_major_incident, emergent_tiering_scare_throttle
- Turn 8 (4 turn(s) ago): safety_breakthrough, emergent_deposit_strike
- Turn 9 (3 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 10 (2 turn(s) ago): loss_of_control_incident, safety_breakthrough, eu_frontier_access_denied, emergent_sample_escrow_defection
- Turn 11 (1 turn(s) ago): capability_jump, rsi_onset, eu_frontier_access_denied, middle_power_coalition
