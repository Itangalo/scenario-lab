...
- characters 375-1997: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2040-4229: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4285-5392: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5455-33279: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33634-34390: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M9 EU Assured Operations and Bio-Deposit Restoration −2, M10 EU AI Transition Buffer and Retraining Guarantee −2, priority −1 = −5
PROPOSAL BONUS: EU AI Transition Buffer and Retraining Guarantee (cat 7, small) +2 — answers knowledge-work displacement tipping this turn while sentiment 14 and capital 17
LEGITIMACY LENDS: capital 17, sentiment 14 -> none, capital higher
SOVEREIGNTY: 16 last turn, no cat4 finish, no cat4 in flight, export_control_escalation t9 −2, capability rose 3.0 −1 = 13

## Emerging developments (tracked)

- `emergent_sample_escrow_defection` -- first noted turn 9, listed in 1 turn(s) so far: Municipal hospital federations formalize a cross-border biosample escrow with a non-EU research consortium, routing deposits outside HERA to force arrears payment.
- `emergent_bio_deposit_freeze_spread` -- first noted turn 9, listed in 1 turn(s) so far: Hospital federations extend the biosample deposit suspension to additional member states and formalize a joint freezer-stockpile, leaving EU early-warning blind for months and triggering open US and WHO criticism.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, bio_incident, emergent_openweight_backlash
- Turn 2 (8 turn(s) ago): safety_breakthrough, emergent_pathogen_data_freeze
- Turn 3 (7 turn(s) ago): capability_jump, taiwan_tension_rise, export_control_escalation, us_china_agreement, joint_threat_response
- Turn 4 (6 turn(s) ago): cyber_major_incident, opaque_reasoning, research_breakthrough, medical_breakthrough
- Turn 5 (5 turn(s) ago): eval_anomaly_reports, election_consolidation
- Turn 6 (4 turn(s) ago): loss_of_control_incident
- Turn 7 (3 turn(s) ago): cyber_major_incident, emergent_tiering_scare_throttle
- Turn 8 (2 turn(s) ago): safety_breakthrough, emergent_deposit_strike
- Turn 9 (1 turn(s) ago): knowledge_work_augmented, export_control_escalation
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.06}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "rsi_onset", "probability": 0.35}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_loss_of_control_incident", "probability": 0.02}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.075}, {"description": "", "emergent": false, "id": "catastrophic_great_power_conflict", "probability": 0.035}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "us_labs_nationalised", "probability": 0.14}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Municipal hospital federations formalize a cross-border biosample escrow with a non-EU research consortium, routing deposits outside HERA to force arrears payment.", "emergent": true, "id": "emergent_sample_escrow_defection", "probability": 0.22}, {"description": "Hospital federations extend the biosample deposit suspension to additional member states and formalize a joint freezer-stockpile, leaving EU early-warning blind for months and triggering open US and WHO criticism.", "emergent": true, "id": "emergent_bio_deposit_freeze_spread", "probability": 0.26}]
```
