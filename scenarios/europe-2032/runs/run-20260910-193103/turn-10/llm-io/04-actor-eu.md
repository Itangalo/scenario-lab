...
- characters 453-2075: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2118-4307: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5945-6419: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9552-11862: `{{previous_actions}}` from the actor's own response from the previous turn
...
**emergent_sample_escrow_defection (emergent event):** Municipal hospital federations formalize a cross-border biosample escrow with a non-EU research consortium, routing deposits outside HERA to force arrears payment.
