...
- characters 106-13421: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13464-13654: `{{metrics_json}}` from the run's live metric values
- characters 13747-15369: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15412-17601: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17657-18512: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU AI Transition Buffer and Retraining Guarantee | 2 |
| M11 | EU Sovereign Fallback and Assured Control Deployment | 2 |
...
- `emergent_bio_deposit_freeze_spread` -- first noted turn 9, listed in 2 turn(s) so far: Hospital federations extend the biosample deposit suspension to additional member states and formalize a joint freezer-stockpile, leaving EU early-warning blind for months and triggering open US and WHO criticism.
