...
- characters 13418-14380: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14423-16679: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16735-17265: `{{notepad}}` from the Game Master's notepad, carried across turns
