...
- characters 2583-3205: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 74.0, "openweight_capability": 67.8, "ai_safety": 15.0, "resilience": 35.0, "eu_ai_sovereignty": 22.0, "eu_political_capital": 22.0, "public_sentiment": 12.0}
```
