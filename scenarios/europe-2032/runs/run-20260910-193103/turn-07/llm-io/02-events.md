...
- characters 377-2279: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2323-4907: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4963-6136: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6199-31810: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32165-32692: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, bio_incident, emergent_openweight_backlash
- Turn 2 (5 turn(s) ago): safety_breakthrough, emergent_pathogen_data_freeze
- Turn 3 (4 turn(s) ago): capability_jump, taiwan_tension_rise, export_control_escalation, us_china_agreement, joint_threat_response
- Turn 4 (3 turn(s) ago): cyber_major_incident, opaque_reasoning, research_breakthrough, medical_breakthrough
- Turn 5 (2 turn(s) ago): eval_anomaly_reports, election_consolidation
