...
- characters 1777-3585: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4380-4844: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7800-9913: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Assured Operations and Bio-Deposit Restoration | 5 | small | 8 | 10 | own jurisdiction | ai_safety up moderately, resilience up moderately | 2 | running |
