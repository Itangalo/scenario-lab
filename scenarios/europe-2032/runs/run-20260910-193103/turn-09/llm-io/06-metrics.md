...
- characters 13356-14634: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14678-16486: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16542-17604: `{{notepad}}` from the Game Master's notepad, carried across turns
