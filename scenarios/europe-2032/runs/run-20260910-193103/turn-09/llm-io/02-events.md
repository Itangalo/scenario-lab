...
- characters 377-1655: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1699-3507: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3563-4032: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4095-30873: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31228-31906: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M9 EU Assured Operations and Bio-Deposit Restoration −2, priority −1 = −3
PROPOSAL BONUS: EU Assured Operations and Bio-Deposit Restoration (cat 5, small) +2 — answers deposit routine break and deploys safety breakthrough, but strike fired this same turn and arrears grievance predates it
LEGITIMACY LENDS: capital 17, sentiment 14 -> none, capital higher
SOVEREIGNTY: 17 last turn, no capacity event, no cat4 in flight, capability rose 3.0 −1 = 16
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, bio_incident, emergent_openweight_backlash
- Turn 2 (7 turn(s) ago): safety_breakthrough, emergent_pathogen_data_freeze
- Turn 3 (6 turn(s) ago): capability_jump, taiwan_tension_rise, export_control_escalation, us_china_agreement, joint_threat_response
- Turn 4 (5 turn(s) ago): cyber_major_incident, opaque_reasoning, research_breakthrough, medical_breakthrough
- Turn 5 (4 turn(s) ago): eval_anomaly_reports, election_consolidation
- Turn 6 (3 turn(s) ago): loss_of_control_incident
- Turn 7 (2 turn(s) ago): cyber_major_incident, emergent_tiering_scare_throttle
- Turn 8 (1 turn(s) ago): safety_breakthrough, emergent_deposit_strike
