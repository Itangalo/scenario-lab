...
- characters 377-1447: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1491-3834: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3890-4687: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4750-30710: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31065-31470: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Assurance Uptake and Secure Bio-Data Commons −2, M5 EU Entry into Joint Cyber-Bio Response and US-China Safety Accord −2, priority M5 −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 20, sentiment 29 -> +1 [applied after charge/finish/event terms, capped by sentiment]
SOVEREIGNTY: 17 last turn, no category 4 finish, no capacity event, Gigafactories in flight +0, capability rose 3.0 −1 = 16

## Emerging developments (tracked)

- `emergent_evasion_toolkit_spread` -- first noted turn 3, listed in 2 turn(s) so far: Non-EU labs publish open toolkits that automate design of detection-evading pathogen edits, prompting copycat experiments outside vetted facilities.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, bio_incident, emergent_openweight_backlash
- Turn 2 (3 turn(s) ago): safety_breakthrough, emergent_pathogen_data_freeze
- Turn 3 (2 turn(s) ago): capability_jump, taiwan_tension_rise, export_control_escalation, us_china_agreement, joint_threat_response
- Turn 4 (1 turn(s) ago): cyber_major_incident, opaque_reasoning, research_breakthrough, medical_breakthrough
