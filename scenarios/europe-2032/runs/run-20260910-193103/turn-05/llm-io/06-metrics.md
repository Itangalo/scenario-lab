...
- characters 13854-14924: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14968-17311: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17367-17891: `{{notepad}}` from the Game Master's notepad, carried across turns
