...
- characters 1569-3912: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5366-5835: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8075-9617: `{{previous_actions}}` from the actor's own response from the previous turn
