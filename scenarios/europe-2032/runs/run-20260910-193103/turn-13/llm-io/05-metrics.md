...
- characters 107-13403: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13446-13634: `{{metrics_json}}` from the run's live metric values
- characters 13727-14846: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14890-16904: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16960-17724: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Middle-Power Supply-Chain Bargain for Compute Access | 2 |
...
- `emergent_infrastructure_sabotage_wave` -- first noted turn 12, listed in 2 turn(s) so far: Coordinated sabotage of data-centre power feeds and fibre links by anti-AI activists causes multi-day outages in two member states, framed as resistance to automated systems.
