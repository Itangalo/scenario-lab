...
- characters 374-1493: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1537-3551: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3607-4371: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4434-30151: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30506-31646: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M11 EU Sovereign Fallback and Assured Control Deployment −2, M12 EU Middle-Power Supply-Chain Bargain for Compute Access −2, priority −1 suspended (capital below 20, no effect no cost) = −4
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 4, sentiment 2 -> none, capital higher
SOVEREIGNTY: 5 last turn, no cat4 finish, no cat4 in flight partial, us_labs_nationalised t12 −3, capability rose 4.0 −1 = 1

## Emerging developments (tracked)

- `emergent_infrastructure_sabotage_wave` -- first noted turn 12, listed in 1 turn(s) so far: Coordinated sabotage of data-centre power feeds and fibre links by anti-AI activists causes multi-day outages in two member states, framed as resistance to automated systems.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, bio_incident, emergent_openweight_backlash
- Turn 2 (11 turn(s) ago): safety_breakthrough, emergent_pathogen_data_freeze
- Turn 3 (10 turn(s) ago): capability_jump, taiwan_tension_rise, export_control_escalation, us_china_agreement, joint_threat_response
- Turn 4 (9 turn(s) ago): cyber_major_incident, opaque_reasoning, research_breakthrough, medical_breakthrough
- Turn 5 (8 turn(s) ago): eval_anomaly_reports, election_consolidation
- Turn 6 (7 turn(s) ago): loss_of_control_incident
- Turn 7 (6 turn(s) ago): cyber_major_incident, emergent_tiering_scare_throttle
- Turn 8 (5 turn(s) ago): safety_breakthrough, emergent_deposit_strike
- Turn 9 (4 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 10 (3 turn(s) ago): loss_of_control_incident, safety_breakthrough, eu_frontier_access_denied, emergent_sample_escrow_defection
- Turn 11 (2 turn(s) ago): capability_jump, rsi_onset, eu_frontier_access_denied, middle_power_coalition
- Turn 12 (1 turn(s) ago): capability_jump, loss_of_control_incident, safety_breakthrough, us_labs_nationalised, emergent_grid_manual_holdout
