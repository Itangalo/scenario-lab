...
- characters 105-13490: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13533-13725: `{{metrics_json}}` from the run's live metric values
- characters 13818-14838: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14881-17101: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17157-17703: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Assured Operations and Bio-Deposit Restoration | 2 |
