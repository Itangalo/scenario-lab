...
- characters 1439-3659: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3715-4564: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4627-30238: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30593-31200: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, bio_incident, emergent_openweight_backlash
- Turn 2 (6 turn(s) ago): safety_breakthrough, emergent_pathogen_data_freeze
- Turn 3 (5 turn(s) ago): capability_jump, taiwan_tension_rise, export_control_escalation, us_china_agreement, joint_threat_response
- Turn 4 (4 turn(s) ago): cyber_major_incident, opaque_reasoning, research_breakthrough, medical_breakthrough
- Turn 5 (3 turn(s) ago): eval_anomaly_reports, election_consolidation
- Turn 6 (2 turn(s) ago): loss_of_control_incident
- Turn 7 (1 turn(s) ago): cyber_major_incident, emergent_tiering_scare_throttle
