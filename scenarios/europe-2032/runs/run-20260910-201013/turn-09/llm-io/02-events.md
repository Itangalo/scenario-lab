...
- characters 377-1546: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1590-3575: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3631-4253: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4316-30887: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31242-32011: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M7 Emergency Cyber Hardening for Swapped Public Systems −2, priority −0 (capital below 20, no effect no cost) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 11, sentiment 36 -> +2
SOVEREIGNTY: 17 last turn, no capacity event, no category 4 in flight +0, capability rose 0.8 −0 = 17

## Emerging developments (tracked)

- `emergent_siting_freeze_spread` -- first noted turn 8, listed in 1 turn(s) so far: Coordinated municipal moratoria on new data-centre grid connections spread beyond France and Germany, forcing a de facto EU-wide siting freeze for the turn.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal
- Turn 2 (7 turn(s) ago): bio_uplift_findings
- Turn 3 (6 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 5 (4 turn(s) ago): openweight_frontier_release, safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise, taiwan_blockade, eu_frontier_access_denied, member_state_defection, election_retrenchment
- Turn 6 (3 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, eu_frontier_access_denied, adoption_success
- Turn 7 (2 turn(s) ago): capability_jump, emergent_energy_siting_backlash
- Turn 8 (1 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, safety_breakthrough
