...
- characters 3476-5461: `{{world_state}}` from background/context.md, seeded as the opening world state
- characters 5494-8608: `{{previous_actions}}` from the actor's own response from the previous turn
...
Rewrite it to read: We will hold deployed systems and essential services first, and defer new frontier builds until consent and capital recover

## The development the actor names as its trigger

eu_ai_sovereignty at 17 with political capital at 13, gigafactory siting frozen, frontier access denied, and simultaneous cyber, loss-of-control and investment-collapse events this turn
...
```json
{
  ...
  "found": true,
  "verdict": "BEARS",
  "reason": "Frontier access denial directly undermines the EU's ability to deploy new frontier systems, making continued commitment to acting under uncertainty costly and impractical."
}
```
```
