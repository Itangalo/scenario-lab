...
- characters 455-1624: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1668-3653: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6522-6974: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9280-10506: `{{previous_actions}}` from the actor's own response from the previous turn
