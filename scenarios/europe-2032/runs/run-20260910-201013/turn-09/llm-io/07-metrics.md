...
- characters 13629-14798: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14842-16827: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16883-17505: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 64.5, "openweight_capability": 62.7, "ai_safety": 24.0, "resilience": 45.5, "eu_ai_sovereignty": 15.0, "eu_political_capital": 10.0, "public_sentiment": 28.0}
```
## Narrative
### Holding on by hand
