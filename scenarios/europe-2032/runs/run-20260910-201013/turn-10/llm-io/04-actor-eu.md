...
- characters 455-1930: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1973-4520: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6975-7448: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10099-13213: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Essential Services Continuity Corps | 6 | small | 9 | 11 | own jurisdiction | resilience up materially, public_sentiment up slightly, eu_political_capital up slightly | 2 | running |
