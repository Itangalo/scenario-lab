...
- characters 13255-14730: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14773-17320: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17376-17854: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Essential Services Continuity Corps | 2 |
...
## Metrics
```json
{"ai_capability": 65.3, "openweight_capability": 63.6, "ai_safety": 22.0, "resilience": 44.5, "eu_ai_sovereignty": 15.0, "eu_political_capital": 2.0, "public_sentiment": 20.0}
```
