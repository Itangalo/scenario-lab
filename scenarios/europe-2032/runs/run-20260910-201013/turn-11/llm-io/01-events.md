...
- characters 1664-3401: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3457-3836: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3899-30729: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31084-32123: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal
- Turn 2 (9 turn(s) ago): bio_uplift_findings
- Turn 3 (8 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 5 (6 turn(s) ago): openweight_frontier_release, safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise, taiwan_blockade, eu_frontier_access_denied, member_state_defection, election_retrenchment
- Turn 6 (5 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, eu_frontier_access_denied, adoption_success
- Turn 7 (4 turn(s) ago): capability_jump, emergent_energy_siting_backlash
- Turn 8 (3 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, safety_breakthrough
- Turn 9 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied
- Turn 10 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, automated_decision_scandal
