...
- characters 13383-13574: `{{metrics_json}}` from the run's live metric values
- characters 13667-14910: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14954-16691: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16747-17126: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Verifiable-Capability Patch Cell | 2 |
...
PORTFOLIO CHARGE t10: M8 EU Essential Services Continuity Corps −2, priority −0 (capital below 20, no effect no cost) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0 after charges and events, sentiment 20 -> +2 (capped below sentiment)
SOVEREIGNTY: 15 last turn, no capacity event, no category 4 in flight +0, capability rose 0.8 −0 = 15
...
## Metrics
```json
{"ai_capability": 66.3, "openweight_capability": 64.4, "ai_safety": 14.0, "resilience": 48.5, "eu_ai_sovereignty": 15.0, "eu_political_capital": 6.0, "public_sentiment": 25.0}
```
...
## Notepad
PORTFOLIO CHARGE t11: M9 EU Verifiable-Capability Patch Cell −2, priority −0 (capital below 20, no effect no cost) = −2
PROPOSAL BONUS: none — knowledge_work_augmented removes displacement crisis framing, no recent negative event bonus applies despite capability jump answered by small measure
LEGITIMACY LENDS: capital 4, sentiment 25 -> +2 (capped below sentiment)
SOVEREIGNTY: 15 last turn, no capacity event, no category 4 in flight +0, capability rose 1.0 −0 = 15
