...
- characters 105-13030: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13073-13265: `{{metrics_json}}` from the run's live metric values
- characters 13358-15026: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15069-17619: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17675-18819: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Bio Detection and Response Net | 3 |
