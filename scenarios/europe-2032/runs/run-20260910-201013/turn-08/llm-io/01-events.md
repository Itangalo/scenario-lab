...
- characters 376-1591: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1634-4193: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4249-4764: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4827-31398: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31753-32427: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal
- Turn 2 (6 turn(s) ago): bio_uplift_findings
- Turn 3 (5 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 5 (3 turn(s) ago): openweight_frontier_release, safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise, taiwan_blockade, eu_frontier_access_denied, member_state_defection, election_retrenchment
- Turn 6 (2 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, eu_frontier_access_denied, adoption_success
- Turn 7 (1 turn(s) ago): capability_jump, emergent_energy_siting_backlash
