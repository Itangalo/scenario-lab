...
- characters 105-13331: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13374-13566: `{{metrics_json}}` from the run's live metric values
- characters 13659-14874: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14917-17476: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17532-18326: `{{notepad}}` from the Game Master's notepad, carried across turns
