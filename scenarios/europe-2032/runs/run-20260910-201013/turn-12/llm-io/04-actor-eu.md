...
- characters 454-1829: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1872-3922: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6501-6974: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9774-11440: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Verifiable-Capability Patch Cell | 6 | small | 11 | 13 | own jurisdiction | resilience up slightly, ai_safety up slightly | 2 | running |
