...
- characters 376-1751: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1794-3844: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3900-4368: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4431-31261: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31616-32746: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal
- Turn 2 (10 turn(s) ago): bio_uplift_findings
- Turn 3 (9 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 5 (7 turn(s) ago): openweight_frontier_release, safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise, taiwan_blockade, eu_frontier_access_denied, member_state_defection, election_retrenchment
- Turn 6 (6 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, eu_frontier_access_denied, adoption_success
- Turn 7 (5 turn(s) ago): capability_jump, emergent_energy_siting_backlash
- Turn 8 (4 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, safety_breakthrough
- Turn 9 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied
- Turn 10 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, automated_decision_scandal
- Turn 11 (1 turn(s) ago): capability_jump, knowledge_work_augmented, taiwan_tension_rise
