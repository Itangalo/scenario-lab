...
- characters 12967-13158: `{{metrics_json}}` from the run's live metric values
- characters 13251-14626: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14669-16719: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16775-17243: `{{notepad}}` from the Game Master's notepad, carried across turns
