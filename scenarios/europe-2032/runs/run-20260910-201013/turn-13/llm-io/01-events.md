...
- characters 377-1849: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1893-3885: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3941-4332: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4395-29719: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30074-31308: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M9 EU Verifiable-Capability Patch Cell −2, priority −0 (capital below 20, no effect no cost) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 3, sentiment 19 -> +2 (capped below sentiment, applied after charges and event losses)
SOVEREIGNTY: 15 last turn, no capacity event, no category 4 in flight +0, capability rose 0.5 −0 = 15
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal
- Turn 2 (11 turn(s) ago): bio_uplift_findings
- Turn 3 (10 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 5 (8 turn(s) ago): openweight_frontier_release, safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise, taiwan_blockade, eu_frontier_access_denied, member_state_defection, election_retrenchment
- Turn 6 (7 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, eu_frontier_access_denied, adoption_success
- Turn 7 (6 turn(s) ago): capability_jump, emergent_energy_siting_backlash
- Turn 8 (5 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, safety_breakthrough
- Turn 9 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied
- Turn 10 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, automated_decision_scandal
- Turn 11 (2 turn(s) ago): capability_jump, knowledge_work_augmented, taiwan_tension_rise
- Turn 12 (1 turn(s) ago): openweight_frontier_release, us_china_agreement, automated_decision_scandal
