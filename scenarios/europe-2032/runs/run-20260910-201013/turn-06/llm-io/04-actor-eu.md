...
- characters 454-1605: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1648-3650: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6121-6573: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8702-10160: `{{previous_actions}}` from the actor's own response from the previous turn
