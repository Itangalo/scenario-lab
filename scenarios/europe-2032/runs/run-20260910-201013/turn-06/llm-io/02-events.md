...
- characters 376-1527: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1570-3572: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3628-4635: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4698-30666: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31021-31504: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, priority −0 (capital below 20, no effect no cost) = −6
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 7, sentiment 37 -> +2
SOVEREIGNTY: 18 last turn, no capacity event finish, Gigafactories in flight +0, eu_frontier_access_denied t5 −2 (largest of blockade/access/defection), capability rose 1.0 −0 = 16

## Emerging developments (tracked)

- `emergent_energy_siting_backlash` -- first noted turn 5, listed in 1 turn(s) so far: Coordinated protests and blockades against new data-centre and grid-upgrade sites in France and Germany force temporary construction halts after energy-price rises are blamed on AI infrastructure.
- `emergent_winter_grid_strain` -- first noted turn 5, listed in 1 turn(s) so far: A severe winter storm exposes thin power margins in France and Germany, forcing emergency load-shedding that is publicly blamed on delayed grid segmentation and backup relay work.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal
- Turn 2 (4 turn(s) ago): bio_uplift_findings
- Turn 3 (3 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 5 (1 turn(s) ago): openweight_frontier_release, safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise, taiwan_blockade, eu_frontier_access_denied, member_state_defection, election_retrenchment
