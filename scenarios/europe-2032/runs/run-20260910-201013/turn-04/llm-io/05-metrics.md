...
- characters 13411-14400: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14443-16353: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16409-16957: `{{notepad}}` from the Game Master's notepad, carried across turns
