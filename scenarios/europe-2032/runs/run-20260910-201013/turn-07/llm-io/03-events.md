...
- characters 377-1432: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1476-3565: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3621-4635: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4698-31269: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31624-32223: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal
- Turn 2 (5 turn(s) ago): bio_uplift_findings
- Turn 3 (4 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 5 (2 turn(s) ago): openweight_frontier_release, safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise, taiwan_blockade, eu_frontier_access_denied, member_state_defection, election_retrenchment
- Turn 6 (1 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, eu_frontier_access_denied, adoption_success
