...
- characters 376-1392: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1436-3134: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3190-3657: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3720-32205: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32560-32830: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Systems Shield −3, M4 EU Bio Detection and Response Net −3, M5 EU Loss-of-Control Containment Playbook −2 = −14 (priority named but no cost — capital 19 below 20)
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 5, sentiment 37 -> +2
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, automated_decision_scandal
- Turn 2 (3 turn(s) ago): bio_uplift_findings
- Turn 3 (2 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, taiwan_tension_rise
