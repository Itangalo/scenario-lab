...
- characters 106-13667: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13710-13901: `{{metrics_json}}` from the run's live metric values
- characters 13994-15010: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15054-16752: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16808-17859: `{{notepad}}` from the Game Master's notepad, carried across turns
