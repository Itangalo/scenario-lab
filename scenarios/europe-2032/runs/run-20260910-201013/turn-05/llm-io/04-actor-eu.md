...
- characters 454-1470: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1514-3212: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7177-7649: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9777-11022: `{{previous_actions}}` from the actor's own response from the previous turn
