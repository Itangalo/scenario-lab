...
- characters 375-1960: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2003-4093: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4149-5211: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5274-25089: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 25444-25897: `{{event_history}}` from the run's own event record
...
- `emergent_ai_act_court_timetable` -- first noted turn 4, listed in 2 turn(s) so far: ECJ Advocate General issues interim opinion backing NGO/MEP challenge that high-risk and GPAI obligations were unlawfully shelved, forcing the Commission to publish a binding timetable during this semester.
- `emergent_permit_injunction_freeze` -- first noted turn 4, listed in 2 turn(s) so far: Municipal courts in two member states issue interim injunctions halting Gigafactory zone permits on power-grid and environmental grounds, freezing site works through mid-2028.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, loss_of_control_incident, safety_breakthrough
- Turn 2 (4 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (3 turn(s) ago): us_china_agreement, emergent_ai_act_delay_challenge
- Turn 4 (2 turn(s) ago): ai_investment_collapse, member_state_defection, adoption_success
