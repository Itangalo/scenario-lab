...
- characters 2419-2885: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 59.5, "openweight_capability": 57.0, "ai_safety": 30.0, "resilience": 37.5, "eu_ai_sovereignty": 22.0, "eu_political_capital": 9.0, "public_sentiment": 38.0}
```
