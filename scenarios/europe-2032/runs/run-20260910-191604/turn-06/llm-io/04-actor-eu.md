...
- characters 453-2038: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2081-4171: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5047-5492: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7766-9232: `{{previous_actions}}` from the actor's own response from the previous turn
