...
- characters 454-2517: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2561-4401: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4951-5451: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7725-9006: `{{previous_actions}}` from the actor's own response from the previous turn
