...
- characters 13238-13429: `{{metrics_json}}` from the run's live metric values
- characters 13522-15585: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15629-17469: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17525-17876: `{{notepad}}` from the Game Master's notepad, carried across turns
