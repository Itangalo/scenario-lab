...
- characters 376-2439: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2483-4323: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4379-4730: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4793-27718: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28073-28794: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M7 EU Municipal Shield Patch −2 = −2 + priority no effect, no cost (capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 6, sentiment 31 -> +2
SOVEREIGNTY: 22 last turn, no capacity event finishes, no cat4 in flight +0, member_state_defection t8 −2, capability rose 0.5 −0 = 20
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, loss_of_control_incident, safety_breakthrough
- Turn 2 (7 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (6 turn(s) ago): us_china_agreement, emergent_ai_act_delay_challenge
- Turn 4 (5 turn(s) ago): ai_investment_collapse, member_state_defection, adoption_success
- Turn 5 (4 turn(s) ago): adoption_success, election_retrenchment
- Turn 6 (3 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings
- Turn 7 (2 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, supply_chain_coercion, adoption_success
- Turn 8 (1 turn(s) ago): openweight_frontier_release, member_state_defection
