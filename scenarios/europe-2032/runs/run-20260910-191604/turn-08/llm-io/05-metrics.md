...
- characters 105-12806: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12849-13041: `{{metrics_json}}` from the run's live metric values
- characters 13134-15032: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15075-17391: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17447-17898: `{{notepad}}` from the Game Master's notepad, carried across turns
