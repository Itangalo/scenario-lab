...
- characters 455-1913: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1957-4313: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5518-5977: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8250-10525: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Adoption Dividend | 9 | small | 4 | 7 | own jurisdiction | public_sentiment up, resilience up slightly via sustained services | 2 | running |
