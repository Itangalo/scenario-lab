...
- characters 106-12910: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12953-13145: `{{metrics_json}}` from the run's live metric values
- characters 13238-14696: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14740-17096: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17152-18282: `{{notepad}}` from the Game Master's notepad, carried across turns
