...
- characters 377-1835: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1879-4235: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4291-5421: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5484-26599: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26954-27341: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, loss_of_control_incident, safety_breakthrough
- Turn 2 (3 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (2 turn(s) ago): us_china_agreement, emergent_ai_act_delay_challenge
- Turn 4 (1 turn(s) ago): ai_investment_collapse, member_state_defection, adoption_success
...
```
[{"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.3}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.18}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.26}, {"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.03}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.05}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.14}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.05}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "ECJ Advocate General issues interim opinion backing NGO/MEP challenge that high-risk and GPAI obligations were unlawfully shelved, forcing the Commission to publish a binding timetable during this semester.", "emergent": true, "id": "emergent_ai_act_court_timetable", "probability": 0.3}, {"description": "Municipal courts in two member states issue interim injunctions halting Gigafactory zone permits on power-grid and environmental grounds, freezing site works through late 2028.", "emergent": true, "id": "emergent_permit_injunction_freeze", "probability": 0.25}]
```
