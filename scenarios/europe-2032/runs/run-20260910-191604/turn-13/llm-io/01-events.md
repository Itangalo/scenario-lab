...
- characters 378-2023: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2067-4212: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4268-4714: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4777-28305: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28660-29779: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, loss_of_control_incident, safety_breakthrough
- Turn 2 (11 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (10 turn(s) ago): us_china_agreement, emergent_ai_act_delay_challenge
- Turn 4 (9 turn(s) ago): ai_investment_collapse, member_state_defection, adoption_success
- Turn 5 (8 turn(s) ago): adoption_success, election_retrenchment
- Turn 6 (7 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings
- Turn 7 (6 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, supply_chain_coercion, adoption_success
- Turn 8 (5 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 9 (4 turn(s) ago): cyber_major_incident
- Turn 10 (3 turn(s) ago): loss_of_control_incident, safety_breakthrough, export_control_escalation, supply_chain_coercion, joint_threat_response
- Turn 11 (2 turn(s) ago): loss_of_control_incident, safety_breakthrough, emergent_restoration_litigation_freeze
- Turn 12 (1 turn(s) ago): cyber_defence_breakthrough, emergent_municipal_payment_freeze
