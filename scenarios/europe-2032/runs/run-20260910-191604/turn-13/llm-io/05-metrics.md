...
- characters 107-12907: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12950-13142: `{{metrics_json}}` from the run's live metric values
- characters 13235-14880: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14924-17069: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17125-18161: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Municipal Payments and Services Hardening Sprint | 2 |
| M11 | EU Major Incident Containment and Continuity Operation | 2 |
...
- `emergent_fringe_mayors_revolt` -- first noted turn 13, listed in 1 turn(s) so far: Cash-queue protests coalesce into a coordinated municipal refusal movement, with mayors in fringe regions jointly suspending EU-mandated digital procedures until crews and cash reimbursement arrive.
- `emergent_cash_rebellion` -- first noted turn 13, listed in 1 turn(s) so far: Cash-queue protests in fringe towns coalesce into coordinated refusal to use EU-signed payment updates, with local councils voting to keep manual cash systems and barring central sensors.
...
## Notepad
PORTFOLIO CHARGE t13: M10 EU Municipal Payments and Services Hardening Sprint −2, M11 EU Major Incident Containment and Continuity Operation −2, priority no effect, no cost (capital below 20) = −4
PROPOSAL BONUS: M11 (cat 6, small) +2 — cyber_major_incident landed this turn and this answers it directly with containment/continuity
LEGITIMACY LENDS: capital 11, sentiment 12.5 -> +2 capped by sentiment, net 13 after rounding (applied)
SOVEREIGNTY: 18 last turn, no capacity event, no cat4 in flight +0, capability rose 0.5 −0 = 18
