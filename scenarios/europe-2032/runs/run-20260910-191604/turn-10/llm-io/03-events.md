...
- characters 377-3069: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3112-5040: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5096-5523: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5586-28511: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28866-29634: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, loss_of_control_incident, safety_breakthrough
- Turn 2 (8 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (7 turn(s) ago): us_china_agreement, emergent_ai_act_delay_challenge
- Turn 4 (6 turn(s) ago): ai_investment_collapse, member_state_defection, adoption_success
- Turn 5 (5 turn(s) ago): adoption_success, election_retrenchment
- Turn 6 (4 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings
- Turn 7 (3 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, supply_chain_coercion, adoption_success
- Turn 8 (2 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 9 (1 turn(s) ago): cyber_major_incident
