...
- characters 13226-15918: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15961-17889: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17945-19036: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Edge Restoration and Containment Corps | 2 |
| M9 | EU Joint Response Accession and Assured Control Deployment | 2 |
...
PORTFOLIO CHARGE t9: M8 EU Edge Restoration and Containment Corps −2 = −2 + priority no effect, no cost (capital below 20) = −2
PROPOSAL BONUS: EU Edge Restoration and Containment Corps (cat 6, small) +2 — cyber_major_incident landed this turn and this answers edge failure directly
LEGITIMACY LENDS: capital 13, sentiment 31 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, no cat4 in flight +0, capability rose 0.5 −0 = 20
