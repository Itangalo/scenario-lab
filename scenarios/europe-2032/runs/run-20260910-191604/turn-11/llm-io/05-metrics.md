...
- characters 107-13232: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13275-13467: `{{metrics_json}}` from the run's live metric values
- characters 13560-14661: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14705-16887: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16943-17905: `{{notepad}}` from the Game Master's notepad, carried across turns
