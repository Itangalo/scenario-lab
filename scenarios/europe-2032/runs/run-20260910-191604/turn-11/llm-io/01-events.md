...
- characters 378-1479: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1523-3705: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3761-5048: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5111-28639: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28994-29909: `{{event_history}}` from the run's own event record
...
- `emergent_municipal_payment_freeze` -- first noted turn 10, listed in 1 turn(s) so far: A coordinated fraud-driven run on municipal payment and reimbursement systems forces several towns to suspend direct debits and revert to cash counters for weeks, deepening distrust of digitised public services.
- `emergent_restoration_litigation_freeze` -- first noted turn 10, listed in 1 turn(s) so far: Municipal outage maps and restoration prioritization trigger coordinated legal challenges by fringe villages and single-doctor practices alleging discriminatory restoration, freezing ENISA corps deployments pending court rulings.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, loss_of_control_incident, safety_breakthrough
- Turn 2 (9 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (8 turn(s) ago): us_china_agreement, emergent_ai_act_delay_challenge
- Turn 4 (7 turn(s) ago): ai_investment_collapse, member_state_defection, adoption_success
- Turn 5 (6 turn(s) ago): adoption_success, election_retrenchment
- Turn 6 (5 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings
- Turn 7 (4 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, supply_chain_coercion, adoption_success
- Turn 8 (3 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 9 (2 turn(s) ago): cyber_major_incident
- Turn 10 (1 turn(s) ago): loss_of_control_incident, safety_breakthrough, export_control_escalation, supply_chain_coercion, joint_threat_response
