...
- characters 13623-14883: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14927-17384: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17440-17898: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Continuity Stack −2, priority −1 = −12
PROPOSAL BONUS: EU Continuity Stack (cat 9, small) +3 — frontier access denial landed this turn and this answers it directly
LEGITIMACY LENDS: capital 28, sentiment 31 -> +2
SOVEREIGNTY: 22 last turn, no capacity event, Gigafactories in flight +0, eu_frontier_access_denied t2 −2, capability rose 1.5 −0 = 20
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 51.5, "ai_safety": 36.0, "resilience": 40.5, "eu_ai_sovereignty": 20.0, "eu_political_capital": 19.0, "public_sentiment": 29.0}
```
