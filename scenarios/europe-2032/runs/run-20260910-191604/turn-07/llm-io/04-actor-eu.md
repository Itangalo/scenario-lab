...
- characters 454-2236: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2280-4549: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6158-6658: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8782-10529: `{{previous_actions}}` from the actor's own response from the previous turn
