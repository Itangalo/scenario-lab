...
- characters 376-2158: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2202-4471: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4527-4905: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4968-24783: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 25138-25665: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, loss_of_control_incident, safety_breakthrough
- Turn 2 (5 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (4 turn(s) ago): us_china_agreement, emergent_ai_act_delay_challenge
- Turn 4 (3 turn(s) ago): ai_investment_collapse, member_state_defection, adoption_success
- Turn 5 (2 turn(s) ago): adoption_success, election_retrenchment
- Turn 6 (1 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings
