...
- characters 106-13325: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13368-13559: `{{metrics_json}}` from the run's live metric values
- characters 13652-15434: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15478-17747: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17803-18181: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Municipal Shield Patch | 2 |
