...
- characters 454-1913: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1956-3844: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4504-4998: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7616-9004: `{{previous_actions}}` from the actor's own response from the previous turn
...
**emergent_municipal_payment_freeze (emergent event):** A coordinated fraud-driven run on municipal payment and reimbursement systems forces several towns to suspend direct debits and revert to cash counters for weeks, deepening distrust of digitised public services.
