...
- characters 13562-15021: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15064-16952: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17008-17408: `{{notepad}}` from the Game Master's notepad, carried across turns
