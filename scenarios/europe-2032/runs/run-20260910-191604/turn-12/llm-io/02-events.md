...
- characters 376-1835: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1878-3766: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3822-4561: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4624-28152: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28507-29536: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M9 EU Joint Response Accession and Assured Control Deployment −2, priority no effect, no cost (capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 8, sentiment 14 -> +2 capped by prior terms, net still 8 after rounding (applied)
SOVEREIGNTY: 18 last turn, no capacity event, no cat4 in flight +0, capability rose 0.5 −0 = 18

## Emerging developments (tracked)

- `emergent_municipal_payment_freeze` -- first noted turn 10, listed in 2 turn(s) so far: A coordinated fraud-driven run on municipal payment and reimbursement systems forces several towns to suspend direct debits and revert to cash counters for weeks, deepening distrust of digitised public services.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, loss_of_control_incident, safety_breakthrough
- Turn 2 (10 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (9 turn(s) ago): us_china_agreement, emergent_ai_act_delay_challenge
- Turn 4 (8 turn(s) ago): ai_investment_collapse, member_state_defection, adoption_success
- Turn 5 (7 turn(s) ago): adoption_success, election_retrenchment
- Turn 6 (6 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings
- Turn 7 (5 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, supply_chain_coercion, adoption_success
- Turn 8 (4 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 9 (3 turn(s) ago): cyber_major_incident
- Turn 10 (2 turn(s) ago): loss_of_control_incident, safety_breakthrough, export_control_escalation, supply_chain_coercion, joint_threat_response
- Turn 11 (1 turn(s) ago): loss_of_control_incident, safety_breakthrough, emergent_restoration_litigation_freeze
