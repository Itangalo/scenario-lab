...
- characters 16235-16778: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_ai_act_delay_challenge` -- first noted turn 1, listed in 1 turn(s) so far: EU NGOs and a coalition of MEPs file a legal challenge to the postponement of AI Act high-risk and GPAI obligations to 2027-2028, forcing a public court battle over enforcement timelines.
- `emergent_compute_bottleneck_shock` -- first noted turn 1, listed in 1 turn(s) so far: Major US AI lab announces emergency compute rationing after grid interconnection delays and transformer shortages stall new data centre phases.
...
PROPOSAL BONUS: EU Critical Systems Shield (cat 6, large) +4 — cyber_test_shot landed this turn and this answers it directly
LEGITIMACY LENDS: capital 40, sentiment 35 -> none, capital higher
