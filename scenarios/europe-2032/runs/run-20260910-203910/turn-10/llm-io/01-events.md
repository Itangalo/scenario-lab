...
- characters 376-1344: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1387-3519: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3575-4409: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4472-34225: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34580-35275: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M8 EU Essential Continuity and Substitution Programme −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: EU Essential Continuity and Substitution Programme (cat 6, small) +3 — eu_frontier_access_denied landed this turn and this answers it directly
LEGITIMACY LENDS: capital 3, sentiment 22 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, no cat4 finish or in-flight bonus, eu_frontier_access_denied t9 −3, capability rose 3.5 −1 = 15

## Emerging developments (tracked)

- `emergent_servicing_walkout` -- first noted turn 9, listed in 1 turn(s) so far: A coordinated walkout by maintenance technicians servicing foreign-contracted factory automation spreads from the side-deal capital to two other member states, freezing restart talks and forcing emergency servicing negotiations.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, ai_investment_collapse, taiwan_tension_rise
- Turn 2 (8 turn(s) ago): emergent_sovereign_hosting_offer
- Turn 3 (7 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough
- Turn 4 (6 turn(s) ago): embodied_ai_deployment
- Turn 5 (5 turn(s) ago): bio_uplift_findings, emergent_humanoid_backlash, election_retrenchment
- Turn 6 (4 turn(s) ago): eval_anomaly_reports
- Turn 7 (3 turn(s) ago): eval_anomaly_reports, labour_displacement, member_state_defection, emergent_factory_occupation_wave
- Turn 8 (2 turn(s) ago): eval_anomaly_reports, rsi_onset, knowledge_work_augmented
- Turn 9 (1 turn(s) ago): labour_displacement, eu_frontier_access_denied
