...
- characters 106-13035: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13078-13269: `{{metrics_json}}` from the run's live metric values
- characters 13362-14330: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14373-16505: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16561-17395: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Essential Continuity and Substitution Programme | 2 |
| M9 | EU Cyber Recovery and Assured Substitution Deployment | 2 |
