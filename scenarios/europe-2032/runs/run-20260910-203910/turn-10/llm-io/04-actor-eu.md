...
- characters 1465-3597: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5746-6225: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8902-11151: `{{previous_actions}}` from the actor's own response from the previous turn
