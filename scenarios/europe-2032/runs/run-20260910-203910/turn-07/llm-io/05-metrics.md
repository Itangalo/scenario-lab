...
- characters 106-13377: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13420-13611: `{{metrics_json}}` from the run's live metric values
- characters 13704-14594: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14638-16695: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16751-17399: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M6 | European Automation Transition Fund | 2 |
| M7 | EU Manufacturing Pilot Pause-and-Restart Compact | 2 |
...
## Metrics
```json
{"ai_capability": 72.5, "openweight_capability": 66.3, "ai_safety": 27.5, "resilience": 43.5, "eu_ai_sovereignty": 20.0, "eu_political_capital": 4.0, "public_sentiment": 23.0}
```
