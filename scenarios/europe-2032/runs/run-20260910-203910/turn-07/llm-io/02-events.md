...
- characters 376-1266: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1310-3367: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3423-4334: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4397-30980: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31335-31747: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: M1 InvestAI Gigafactories −3, M6 European Automation Transition Fund −2, priority M1 −1 = −6
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 7, sentiment 31 -> +2
SOVEREIGNTY: 19 last turn, M2 Tech sovereignty package finishes t6 +5, M1 Gigafactories in flight +1, no capacity event, capability rose 3.0 −1 = 24

## Emerging developments (tracked)

- `emergent_us_tiering_clarification` -- first noted turn 6, listed in 1 turn(s) so far: A new US administration clarification on AI model access tiers leaks, with allied industry fearing prolonged rationing of frontier inference through 2029.
- `emergent_factory_occupation_wave` -- first noted turn 6, listed in 1 turn(s) so far: Coordinated cross-border factory occupations and equipment sabotage targeting foreign humanoid pilot lines force a temporary EU-wide pause on new manufacturing robot permits.
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, ai_investment_collapse, taiwan_tension_rise
- Turn 2 (5 turn(s) ago): emergent_sovereign_hosting_offer
- Turn 3 (4 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough
- Turn 4 (3 turn(s) ago): embodied_ai_deployment
- Turn 5 (2 turn(s) ago): bio_uplift_findings, emergent_humanoid_backlash, election_retrenchment
- Turn 6 (1 turn(s) ago): eval_anomaly_reports
