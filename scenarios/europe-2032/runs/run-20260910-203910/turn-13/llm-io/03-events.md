...
- characters 376-1621: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1665-3499: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3555-3943: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4006-32253: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32608-33565: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M10 EU Degraded-Essentials Sustainment −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: none — no new measure proposed this turn (M10 already in flight)
LEGITIMACY LENDS: capital 3, sentiment 2 -> none, capital higher
SOVEREIGNTY: 11 last turn, no capacity event, no cat4 finish, M10 in flight +0 (not cat4), capability rose 1.5 −0 = 11
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, ai_investment_collapse, taiwan_tension_rise
- Turn 2 (11 turn(s) ago): emergent_sovereign_hosting_offer
- Turn 3 (10 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough
- Turn 4 (9 turn(s) ago): embodied_ai_deployment
- Turn 5 (8 turn(s) ago): bio_uplift_findings, emergent_humanoid_backlash, election_retrenchment
- Turn 6 (7 turn(s) ago): eval_anomaly_reports
- Turn 7 (6 turn(s) ago): eval_anomaly_reports, labour_displacement, member_state_defection, emergent_factory_occupation_wave
- Turn 8 (5 turn(s) ago): eval_anomaly_reports, rsi_onset, knowledge_work_augmented
- Turn 9 (4 turn(s) ago): labour_displacement, eu_frontier_access_denied
- Turn 10 (3 turn(s) ago): cyber_major_incident, research_breakthrough, safety_breakthrough
- Turn 11 (2 turn(s) ago): loss_of_control_incident, bio_uplift_findings, research_breakthrough, embodied_ai_deployment, export_control_escalation, us_china_agreement
