...
- characters 454-1699: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1743-3577: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5306-5785: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8803-10485: `{{previous_actions}}` from the actor's own response from the previous turn
