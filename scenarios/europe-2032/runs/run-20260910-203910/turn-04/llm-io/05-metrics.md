...
- characters 105-13429: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13472-13664: `{{metrics_json}}` from the run's live metric values
- characters 13757-15413: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15456-18782: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18838-19355: `{{notepad}}` from the Game Master's notepad, carried across turns
