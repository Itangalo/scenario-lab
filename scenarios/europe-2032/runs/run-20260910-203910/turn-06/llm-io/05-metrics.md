...
- characters 13603-13794: `{{metrics_json}}` from the run's live metric values
- characters 13887-15088: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15131-17168: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17224-18280: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 election settled, administration takes office turn 6"}]}
```
```
