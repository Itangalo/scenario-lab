...
- characters 375-1576: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1619-3656: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3712-4768: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4831-31414: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31769-32134: `{{event_history}}` from the run's own event record
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, ai_investment_collapse, taiwan_tension_rise
- Turn 2 (4 turn(s) ago): emergent_sovereign_hosting_offer
- Turn 3 (3 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough
- Turn 4 (2 turn(s) ago): embodied_ai_deployment
- Turn 5 (1 turn(s) ago): bio_uplift_findings, emergent_humanoid_backlash, election_retrenchment
