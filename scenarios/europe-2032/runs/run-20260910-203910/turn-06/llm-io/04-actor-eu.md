...
- characters 453-1654: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1697-3734: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4361-4813: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7095-9439: `{{previous_actions}}` from the actor's own response from the previous turn
