...
- characters 1509-4130: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4186-4693: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4756-33003: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33358-34314: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, ai_investment_collapse, taiwan_tension_rise
- Turn 2 (10 turn(s) ago): emergent_sovereign_hosting_offer
- Turn 3 (9 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough
- Turn 4 (8 turn(s) ago): embodied_ai_deployment
- Turn 5 (7 turn(s) ago): bio_uplift_findings, emergent_humanoid_backlash, election_retrenchment
- Turn 6 (6 turn(s) ago): eval_anomaly_reports
- Turn 7 (5 turn(s) ago): eval_anomaly_reports, labour_displacement, member_state_defection, emergent_factory_occupation_wave
- Turn 8 (4 turn(s) ago): eval_anomaly_reports, rsi_onset, knowledge_work_augmented
- Turn 9 (3 turn(s) ago): labour_displacement, eu_frontier_access_denied
- Turn 10 (2 turn(s) ago): cyber_major_incident, research_breakthrough, safety_breakthrough
- Turn 11 (1 turn(s) ago): loss_of_control_incident, bio_uplift_findings, research_breakthrough, embodied_ai_deployment, export_control_escalation, us_china_agreement
