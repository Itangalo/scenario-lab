...
- characters 106-13555: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13598-13788: `{{metrics_json}}` from the run's live metric values
- characters 13881-14972: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15015-17636: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17692-18199: `{{notepad}}` from the Game Master's notepad, carried across turns
