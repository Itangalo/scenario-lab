...
- characters 454-1237: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1281-3262: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4039-4552: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6884-8720: `{{previous_actions}}` from the actor's own response from the previous turn
