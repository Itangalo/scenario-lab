...
- characters 376-1159: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1203-3184: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3240-3589: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3652-32359: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32714-33336: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M7 EU Manufacturing Pilot Pause-and-Restart Compact −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 22 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, no cat4 finish or in-flight bonus, capability rose 7.0 −1 = 19
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, ai_investment_collapse, taiwan_tension_rise
- Turn 2 (7 turn(s) ago): emergent_sovereign_hosting_offer
- Turn 3 (6 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough
- Turn 4 (5 turn(s) ago): embodied_ai_deployment
- Turn 5 (4 turn(s) ago): bio_uplift_findings, emergent_humanoid_backlash, election_retrenchment
- Turn 6 (3 turn(s) ago): eval_anomaly_reports
- Turn 7 (2 turn(s) ago): eval_anomaly_reports, labour_displacement, member_state_defection, emergent_factory_occupation_wave
- Turn 8 (1 turn(s) ago): eval_anomaly_reports, rsi_onset, knowledge_work_augmented
