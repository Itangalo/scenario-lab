...
- characters 13714-14497: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14541-16522: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16578-17275: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 83.0, "openweight_capability": 74.4, "ai_safety": 16.0, "resilience": 40.5, "eu_ai_sovereignty": 15.0, "eu_political_capital": 5.0, "public_sentiment": 14.0}
```
