...
- characters 13770-15128: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15172-17190: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17246-17656: `{{notepad}}` from the Game Master's notepad, carried across turns
