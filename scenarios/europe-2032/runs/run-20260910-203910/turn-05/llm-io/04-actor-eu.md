...
- characters 1857-3875: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5513-5961: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8042-9422: `{{previous_actions}}` from the actor's own response from the previous turn
