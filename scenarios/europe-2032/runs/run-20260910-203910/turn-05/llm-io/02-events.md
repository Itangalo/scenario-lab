...
- characters 1779-3797: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3853-4263: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4326-31280: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31635-31903: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, ai_investment_collapse, taiwan_tension_rise
- Turn 2 (3 turn(s) ago): emergent_sovereign_hosting_offer
- Turn 3 (2 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough
- Turn 4 (1 turn(s) ago): embodied_ai_deployment
