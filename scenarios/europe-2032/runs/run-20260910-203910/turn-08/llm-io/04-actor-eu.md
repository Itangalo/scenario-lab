...
- characters 453-1632: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1675-3573: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4951-5403: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7886-9781: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | EU Manufacturing Pilot Pause-and-Restart Compact | 7 | small | 7 | 9 | own jurisdiction | resilience up slightly, public_sentiment up slightly, eu_political_capital stabilised | 2 | running |
