...
- characters 375-1554: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1597-3495: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3551-4333: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4396-32511: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32866-33404: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: M6 European Automation Transition Fund −2, M7 EU Manufacturing Pilot Pause-and-Restart Compact −2, priority M6 −1 = −5
PROPOSAL BONUS: EU Manufacturing Pilot Pause-and-Restart Compact (cat 7, small) +2 — occupation wave forced de facto pause this turn and this answers it directly
LEGITIMACY LENDS: capital 4, sentiment 23 -> +2
SOVEREIGNTY: 19 last turn, M1 InvestAI Gigafactories finishes t7 +4, no in-flight cat4 bonus, member_state_defection t7 −2, capability rose 3.0 −1 = 20

## Emerging developments (tracked)

- `emergent_us_tiering_clarification` -- first noted turn 6, listed in 2 turn(s) so far: A new US administration clarification on AI model access tiers leaks, with allied industry fearing prolonged rationing of frontier inference through 2029.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, ai_investment_collapse, taiwan_tension_rise
- Turn 2 (6 turn(s) ago): emergent_sovereign_hosting_offer
- Turn 3 (5 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough
- Turn 4 (4 turn(s) ago): embodied_ai_deployment
- Turn 5 (3 turn(s) ago): bio_uplift_findings, emergent_humanoid_backlash, election_retrenchment
- Turn 6 (2 turn(s) ago): eval_anomaly_reports
- Turn 7 (1 turn(s) ago): eval_anomaly_reports, labour_displacement, member_state_defection, emergent_factory_occupation_wave
