...
- characters 13710-14889: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14932-16830: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16886-17387: `{{notepad}}` from the Game Master's notepad, carried across turns
