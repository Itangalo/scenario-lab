...
- characters 107-13036: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13079-13269: `{{metrics_json}}` from the run's live metric values
- characters 13362-14398: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14442-16771: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16827-17340: `{{notepad}}` from the Game Master's notepad, carried across turns
