...
| M13 | EU Trusted Cures Access Programme | 9 | small | 12 | 14 | own jurisdiction | public_sentiment up sharply, eu_political_capital up via visible benefit, resilience up slightly via health continuity | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Trusted Cures Access Programme", "category": 9, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up sharply, eu_political_capital up via visible benefit, resilience up slightly via health continuity"}, "grounds": "medical breakthrough plus need to rebuild trust at rock bottom"}
  - Grounds: medical breakthrough plus need to rebuild trust at rock bottom
