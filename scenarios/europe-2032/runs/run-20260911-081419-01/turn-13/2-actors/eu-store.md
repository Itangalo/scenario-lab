...
| M12 | EU Municipal Auto-Patch and Swarm Shield | 6 | small | 11 | 12 | own jurisdiction | resilience up, ai_safety up slightly via reduced cyber harm | 2 | finished |
| M13 | EU Trusted Cures Access Programme | 9 | small | 12 | 13 | own jurisdiction | public_sentiment up sharply, eu_political_capital up via visible benefit, resilience up slightly via health continuity | 2 | finished |
| M14 | EU Assured Deployment Uptake | 5 | small | 13 | 15 | own jurisdiction | ai_safety up materially, resilience up slightly via certified containment | 2 | running |
...
- **applied** `M14` — {"op": "add", "table": "measures", "fields": {"name": "EU Assured Deployment Uptake", "category": 5, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "ai_safety up materially, resilience up slightly via certified containment"}, "grounds": "safety breakthrough must land on deployed systems while open frontier release closes gap"}
  - Grounds: safety breakthrough must land on deployed systems while open frontier release closes gap
