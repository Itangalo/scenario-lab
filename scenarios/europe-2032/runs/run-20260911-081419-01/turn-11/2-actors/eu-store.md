...
| M12 | EU Municipal Auto-Patch and Swarm Shield | 6 | small | 11 | 13 | own jurisdiction | resilience up, ai_safety up slightly via reduced cyber harm | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Municipal Auto-Patch and Swarm Shield", "category": 6, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly via reduced cyber harm"}, "grounds": "major automated attack plus first real defensive breakthrough"}
  - Grounds: major automated attack plus first real defensive breakthrough
