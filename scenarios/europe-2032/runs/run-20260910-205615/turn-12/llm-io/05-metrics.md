...
- characters 106-12869: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12912-13104: `{{metrics_json}}` from the run's live metric values
- characters 13197-14764: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14807-16639: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16695-17100: `{{notepad}}` from the Game Master's notepad, carried across turns
