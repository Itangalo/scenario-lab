...
- characters 377-1944: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1987-3819: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3875-4602: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4665-28157: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28512-29636: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M9 EU Trusted Public Services Deployment −2, priority −0 (no cost, capital below 20) = −2
PROPOSAL BONUS: none — duplicate proposal of in-flight M9 answers older cutoff but no event in last three turns directly answered
LEGITIMACY LENDS: capital 20, sentiment 22 -> +1
SOVEREIGNTY: 27 last turn, no capacity event, no cat4 finish, no in-flight cat4 bonus, capability rose 0.7 −0 = 27

## Emerging developments (tracked)

- `emergent_infrastructure_sabotage_wave` -- first noted turn 10, listed in 2 turn(s) so far: Coordinated physical sabotage and arson attempts against AI data-centre construction sites and grid-connection works in several member states, driven by anti-AI hostility and job-loss anger.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, eu_access_secured, automated_decision_scandal, emergent_datacentre_siting_backlash
- Turn 2 (10 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, member_state_defection
- Turn 3 (9 turn(s) ago): loss_of_control_incident, openweight_frontier_release, export_control_escalation, us_china_agreement
- Turn 4 (8 turn(s) ago): cyber_major_incident, adoption_success
- Turn 5 (7 turn(s) ago): bio_uplift_findings, election_alliance
- Turn 6 (6 turn(s) ago): joint_threat_response
- Turn 7 (5 turn(s) ago): joint_threat_response
- Turn 8 (4 turn(s) ago): eu_frontier_access_denied
- Turn 9 (3 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, eu_frontier_access_denied, member_state_defection, adoption_success, automated_decision_scandal, emergent_resilience_build_blockade, emergent_commercial_queue_jump_offer
- Turn 10 (2 turn(s) ago): eu_frontier_access_denied
- Turn 11 (1 turn(s) ago): eval_anomaly_reports, research_breakthrough, knowledge_work_augmented, taiwan_tension_rise
