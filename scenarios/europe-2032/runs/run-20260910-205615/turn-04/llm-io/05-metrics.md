...
- characters 105-13482: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13525-13717: `{{metrics_json}}` from the run's live metric values
- characters 13810-15100: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15143-17226: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17282-18556: `{{notepad}}` from the Game Master's notepad, carried across turns
