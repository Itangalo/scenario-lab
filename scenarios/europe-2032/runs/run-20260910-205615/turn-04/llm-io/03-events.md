...
- characters 1709-3792: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3848-4516: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4579-25694: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26049-26477: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, eu_access_secured, automated_decision_scandal, emergent_datacentre_siting_backlash
- Turn 2 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, member_state_defection
- Turn 3 (1 turn(s) ago): loss_of_control_incident, openweight_frontier_release, export_control_escalation, us_china_agreement
