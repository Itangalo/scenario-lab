...
- characters 376-1563: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1606-3446: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3502-4449: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4512-27401: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27756-28410: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: M6 EU Bio Shield and Continuity Corps −2, priority M6 −0 (no cost, capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 14, sentiment 30 -> +1
SOVEREIGNTY: 28 last turn, M1 InvestAI Gigafactories finishes t7 +5, no capacity event, capability rose 0.8 −0 = 33

## Emerging developments (tracked)

- `emergent_resilience_build_blockade` -- first noted turn 7, listed in 1 turn(s) so far: A coordinated municipal revolt blocks grid-islanding and detection-pilot sites, with injunctions in three more member states halting EU-funded resilience construction through winter.
- `emergent_commercial_queue_jump_offer` -- first noted turn 7, listed in 1 turn(s) so far: A US chipmaker quietly offers EU gigafactory sites priority wafer allocations in exchange for long-term offtake and on-site verification, testing whether allied-access promises extend to commercial queue-jumping.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, eu_access_secured, automated_decision_scandal, emergent_datacentre_siting_backlash
- Turn 2 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, member_state_defection
- Turn 3 (5 turn(s) ago): loss_of_control_incident, openweight_frontier_release, export_control_escalation, us_china_agreement
- Turn 4 (4 turn(s) ago): cyber_major_incident, adoption_success
- Turn 5 (3 turn(s) ago): bio_uplift_findings, election_alliance
- Turn 6 (2 turn(s) ago): joint_threat_response
- Turn 7 (1 turn(s) ago): joint_threat_response
