...
- characters 105-12862: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12905-13097: `{{metrics_json}}` from the run's live metric values
- characters 13190-14377: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14420-16260: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16316-17263: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M6 | EU Bio Shield and Continuity Corps | 2 |
| M7 | EU Essential-Service Failover Reserve | 2 |
