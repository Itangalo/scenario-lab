...
- characters 375-2266: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2309-4552: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4608-5803: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5866-25645: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26000-26558: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M5 EU Verification Bridge and Allied Supply Compact −2, M6 EU Bio Shield and Continuity Corps −2, priority M5 −1 = −11
PROPOSAL BONUS: EU Bio Shield and Continuity Corps (cat 6, small) +2 — bio uplift precursor fired this turn plus repeat municipal/clinic sweep in prior turns, answered directly but small size
LEGITIMACY LENDS: capital 9, sentiment 25 -> +2 (capped by sentiment dynamics, applied after charges)
SOVEREIGNTY: 21 last turn, no capacity event, M1/M2 in flight +1, capability rose 1.5 −0 = 22

## Emerging developments (tracked)

- `emergent_care_staff_ai_refusal` -- first noted turn 4, listed in 2 turn(s) so far: Municipal hospital staff stage coordinated walkouts refusing to work with AI triage tools after the ransomware and clearing-agent failures, forcing temporary ward closures in several member states.
- `emergent_siting_freeze_escalation` -- first noted turn 4, listed in 2 turn(s) so far: A coordinated municipal moratorium wave halts three planned EU gigafactory and data-centre sites after local referendums over power prices and water use, freezing capacity expansion for the turn.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, eu_access_secured, automated_decision_scandal, emergent_datacentre_siting_backlash
- Turn 2 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, member_state_defection
- Turn 3 (3 turn(s) ago): loss_of_control_incident, openweight_frontier_release, export_control_escalation, us_china_agreement
- Turn 4 (2 turn(s) ago): cyber_major_incident, adoption_success
- Turn 5 (1 turn(s) ago): bio_uplift_findings, election_alliance
