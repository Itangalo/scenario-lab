...
- characters 453-2344: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2387-4630: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5162-5636: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7983-10421: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU Verification Bridge and Allied Supply Compact | 8 | small | 3 | 7 | coalition | ai_safety up via shared assurance, eu_ai_sovereignty up slightly via secured supply | 2 | running |
