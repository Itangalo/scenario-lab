...
- characters 455-1130: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1174-2924: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6412-6886: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9417-11443: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | EU Essential-Service Failover Reserve | 6 | small | 8 | 10 | own jurisdiction | resilience up materially, eu_ai_sovereignty up slightly via EU-hosted serving | 2 | running |
