...
- characters 377-1052: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1096-2846: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 2902-4038: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4101-26990: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27345-28051: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M6 EU Bio Shield and Continuity Corps −2, M7 EU Essential-Service Failover Reserve −2, priority −0 (no cost, capital below 20) = −4
PROPOSAL BONUS: EU Essential-Service Failover Reserve (cat 6, small) +3 — eu_frontier_access_denied fired this turn stranding hospitals/ministries and this answers it directly
LEGITIMACY LENDS: capital 16, sentiment 25 -> +2
SOVEREIGNTY: 33 last turn, no measure finishes this turn, no in-flight cat4 bonus, eu_frontier_access_denied t8 −2, capability rose 0.7 −0 = 31

## Emerging developments (tracked)

- `emergent_resilience_build_blockade` -- first noted turn 7, listed in 2 turn(s) so far: A coordinated municipal revolt blocks grid-islanding and detection-pilot sites, with injunctions in three more member states halting EU-funded resilience construction through winter.
- `emergent_commercial_queue_jump_offer` -- first noted turn 7, listed in 2 turn(s) so far: A US chipmaker quietly offers EU gigafactory sites priority wafer allocations in exchange for long-term offtake and on-site verification, testing whether allied-access promises extend to commercial queue-jumping.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, eu_access_secured, automated_decision_scandal, emergent_datacentre_siting_backlash
- Turn 2 (7 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, member_state_defection
- Turn 3 (6 turn(s) ago): loss_of_control_incident, openweight_frontier_release, export_control_escalation, us_china_agreement
- Turn 4 (5 turn(s) ago): cyber_major_incident, adoption_success
- Turn 5 (4 turn(s) ago): bio_uplift_findings, election_alliance
- Turn 6 (3 turn(s) ago): joint_threat_response
- Turn 7 (2 turn(s) ago): joint_threat_response
- Turn 8 (1 turn(s) ago): eu_frontier_access_denied
