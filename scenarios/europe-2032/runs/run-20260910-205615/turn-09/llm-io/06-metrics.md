...
- characters 13577-14252: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14296-16046: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16102-16623: `{{notepad}}` from the Game Master's notepad, carried across turns
