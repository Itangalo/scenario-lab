...
- characters 13411-13602: `{{metrics_json}}` from the run's live metric values
- characters 13695-14750: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14794-16485: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16541-17615: `{{notepad}}` from the Game Master's notepad, carried across turns
