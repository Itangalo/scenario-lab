...
- characters 376-1431: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1475-3166: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3222-3681: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3744-26633: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26988-27594: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: M1 InvestAI Gigafactories −3, M5 EU Verification Bridge and Allied Supply Compact −2, M6 EU Bio Shield and Continuity Corps −2, priority M6 −1 = −8
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 7, sentiment 27 -> +2 (capped by sentiment dynamics, applied after charges)
SOVEREIGNTY: 22 last turn, Tech sovereignty package finishes t6 +5, M1 in flight +1, no capacity event, capability rose 1.5 −0 = 28
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, eu_access_secured, automated_decision_scandal, emergent_datacentre_siting_backlash
- Turn 2 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, member_state_defection
- Turn 3 (4 turn(s) ago): loss_of_control_incident, openweight_frontier_release, export_control_escalation, us_china_agreement
- Turn 4 (3 turn(s) ago): cyber_major_incident, adoption_success
- Turn 5 (2 turn(s) ago): bio_uplift_findings, election_alliance
- Turn 6 (1 turn(s) ago): joint_threat_response
