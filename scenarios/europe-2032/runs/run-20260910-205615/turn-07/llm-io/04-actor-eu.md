...
- characters 454-1509: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1553-3244: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3776-4250: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6599-8230: `{{previous_actions}}` from the actor's own response from the previous turn
