...
- characters 378-1670: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1714-3421: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3477-4145: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4208-27700: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28055-29060: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M8 EU Assured Failover Upgrade −2, priority −0 (no cost, capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 11, sentiment 22 -> +2
SOVEREIGNTY: 29 last turn, no capacity cat4 finish, no in-flight cat4 bonus, eu_frontier_access_denied t10 −2, capability rose 0.7 −0 = 27

## Emerging developments (tracked)

- `emergent_infrastructure_sabotage_wave` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated physical sabotage and arson attempts against AI data-centre construction sites and grid-connection works in several member states, driven by anti-AI hostility and job-loss anger.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, eu_access_secured, automated_decision_scandal, emergent_datacentre_siting_backlash
- Turn 2 (9 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, member_state_defection
- Turn 3 (8 turn(s) ago): loss_of_control_incident, openweight_frontier_release, export_control_escalation, us_china_agreement
- Turn 4 (7 turn(s) ago): cyber_major_incident, adoption_success
- Turn 5 (6 turn(s) ago): bio_uplift_findings, election_alliance
- Turn 6 (5 turn(s) ago): joint_threat_response
- Turn 7 (4 turn(s) ago): joint_threat_response
- Turn 8 (3 turn(s) ago): eu_frontier_access_denied
- Turn 9 (2 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, eu_frontier_access_denied, member_state_defection, adoption_success, automated_decision_scandal, emergent_resilience_build_blockade, emergent_commercial_queue_jump_offer
