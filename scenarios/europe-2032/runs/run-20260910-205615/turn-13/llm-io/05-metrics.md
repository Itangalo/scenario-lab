...
- characters 107-12870: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12913-13105: `{{metrics_json}}` from the run's live metric values
- characters 13198-14531: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14575-16546: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16602-17405: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Anomaly Review and Frontier Watch | 2 |
...
- `emergent_catalogue_audit_backlash` -- first noted turn 13, listed in 1 turn(s) so far: Hospital audit logs from the certified fallback catalogue leak to press, showing systematic triage downgrades and fuelling lawsuits that freeze further EU-hosted deployment grants.
...
## Notepad
PORTFOLIO CHARGE t13: M9 EU Trusted Public Services Deployment −2, M10 EU Anomaly Review and Frontier Watch −2, priority −1 = −5
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 12, sentiment 24 -> +2 (capped by sentiment, applied after costs and event terms)
SOVEREIGNTY: 27 last turn, no capacity event? member_state_defection t13 −2 and middle_power_coalition t13 +2, largest single term +2, no cat4 finish, no in-flight cat4 bonus, capability rose 0.7 −0 = 29
