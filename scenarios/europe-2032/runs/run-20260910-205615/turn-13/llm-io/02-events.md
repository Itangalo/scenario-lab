...
- characters 378-1711: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1755-3726: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3782-4277: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4340-27832: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28187-29360: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, eu_access_secured, automated_decision_scandal, emergent_datacentre_siting_backlash
- Turn 2 (11 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, member_state_defection
- Turn 3 (10 turn(s) ago): loss_of_control_incident, openweight_frontier_release, export_control_escalation, us_china_agreement
- Turn 4 (9 turn(s) ago): cyber_major_incident, adoption_success
- Turn 5 (8 turn(s) ago): bio_uplift_findings, election_alliance
- Turn 6 (7 turn(s) ago): joint_threat_response
- Turn 7 (6 turn(s) ago): joint_threat_response
- Turn 8 (5 turn(s) ago): eu_frontier_access_denied
- Turn 9 (4 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, eu_frontier_access_denied, member_state_defection, adoption_success, automated_decision_scandal, emergent_resilience_build_blockade, emergent_commercial_queue_jump_offer
- Turn 10 (3 turn(s) ago): eu_frontier_access_denied
- Turn 11 (2 turn(s) ago): eval_anomaly_reports, research_breakthrough, knowledge_work_augmented, taiwan_tension_rise
- Turn 12 (1 turn(s) ago): eval_anomaly_reports
