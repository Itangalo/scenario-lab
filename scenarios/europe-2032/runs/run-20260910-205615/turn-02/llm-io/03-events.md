...
- characters 376-1926: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1969-4463: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4519-5260: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5323-28605: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28960-29140: `{{event_history}}` from the run's own event record
...
- Turn 1 (1 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, eu_access_secured, automated_decision_scandal, emergent_datacentre_siting_backlash
