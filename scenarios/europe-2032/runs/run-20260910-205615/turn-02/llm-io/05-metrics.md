...
- characters 105-12964: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13007-13199: `{{metrics_json}}` from the run's live metric values
- characters 13292-14842: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14885-17379: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17435-18176: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 54.5, "openweight_capability": 49.5, "ai_safety": 30.0, "resilience": 37.0, "eu_ai_sovereignty": 22.0, "eu_political_capital": 22.0, "public_sentiment": 32.0}
```
