...
- characters 106-12888: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12931-13123: `{{metrics_json}}` from the run's live metric values
- characters 13239-16188: `{{world_state}}` from background/context.md, seeded as the opening world state
- characters 16244-16552: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_provenance_mandate` -- first noted turn 1, listed in 1 turn(s) so far: Major EU scientific publishers and universities jointly mandate watermarking and provenance disclosure for AI-assisted papers after the Millennium Prize proof faces authenticity challenges.
...
**emergent_datacentre_siting_backlash (emergent event):** Coordinated local opposition across several member states blocks or delays grid connections for new large data-centre builds through lawsuits and siting protests, tightening EU compute constraints for 2027.
