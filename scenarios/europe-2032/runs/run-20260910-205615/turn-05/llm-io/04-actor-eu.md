...
- characters 455-1969: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2013-3990: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5410-5887: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8063-9409: `{{previous_actions}}` from the actor's own response from the previous turn
