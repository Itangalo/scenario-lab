...
- characters 377-1891: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1935-3912: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3968-4973: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5036-26151: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26506-26999: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M5 EU Verification Bridge and Allied Supply Compact −2, priority M4 −0 (capital 12 below 20, no effect no cost) = −8
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 16, sentiment 25 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, M1/M2 in flight +1, capability rose 1.5 −0 = 21

## Emerging developments (tracked)

- `emergent_care_staff_ai_refusal` -- first noted turn 4, listed in 1 turn(s) so far: Municipal hospital staff stage coordinated walkouts refusing to work with AI triage tools after the ransomware and clearing-agent failures, forcing temporary ward closures in several member states.
- `emergent_siting_freeze_escalation` -- first noted turn 4, listed in 1 turn(s) so far: A coordinated municipal moratorium wave halts three planned EU gigafactory and data-centre sites after local referendums over power prices and water use, freezing capacity expansion for the turn.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, eu_access_secured, automated_decision_scandal, emergent_datacentre_siting_backlash
- Turn 2 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, member_state_defection
- Turn 3 (2 turn(s) ago): loss_of_control_incident, openweight_frontier_release, export_control_escalation, us_china_agreement
- Turn 4 (1 turn(s) ago): cyber_major_incident, adoption_success
