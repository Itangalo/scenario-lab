...
- characters 106-12950: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12993-13185: `{{metrics_json}}` from the run's live metric values
- characters 13278-14792: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14836-16813: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16869-17874: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "pending"}}, {"op": "update", "table": "measures", "id": "M5", "fields": {"finish_turn": 7}, "grounds": "named priority"}]}
```
```
