...
- characters 455-1627: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1670-3456: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3945-4420: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7155-9759: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Assured Failover Upgrade | 5 | small | 9 | 11 | own jurisdiction | ai_safety up materially, resilience up slightly, public_sentiment up slightly via demonstrably safer services | 2 | running |
