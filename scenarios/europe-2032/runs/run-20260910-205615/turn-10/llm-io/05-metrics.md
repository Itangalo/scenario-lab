...
- characters 13254-13446: `{{metrics_json}}` from the run's live metric values
- characters 13539-14711: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14754-16540: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16596-17459: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Assured Failover Upgrade | 2 |
