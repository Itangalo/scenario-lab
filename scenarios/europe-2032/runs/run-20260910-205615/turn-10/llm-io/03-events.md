...
- characters 377-1549: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1592-3378: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3434-3975: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4038-27530: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27885-28836: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M7 EU Essential-Service Failover Reserve −2, M8 EU Assured Failover Upgrade −2, priority −0 (no cost, capital below 20) = −4
PROPOSAL BONUS: EU Assured Failover Upgrade (cat 5, small) +3 — cutoff stranding hospitals/ministries last turn and this turn, plus decision scandal, this answers both directly
LEGITIMACY LENDS: capital 9, sentiment 22 -> +2
SOVEREIGNTY: 31 last turn, no capacity cat4 finish, no in-flight cat4 bonus, eu_frontier_access_denied t9 −2 (largest of two takeaway events), capability rose 0.7 −0 = 29
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, eu_access_secured, automated_decision_scandal, emergent_datacentre_siting_backlash
- Turn 2 (8 turn(s) ago): cyber_major_incident, loss_of_control_incident, ai_investment_collapse, member_state_defection
- Turn 3 (7 turn(s) ago): loss_of_control_incident, openweight_frontier_release, export_control_escalation, us_china_agreement
- Turn 4 (6 turn(s) ago): cyber_major_incident, adoption_success
- Turn 5 (5 turn(s) ago): bio_uplift_findings, election_alliance
- Turn 6 (4 turn(s) ago): joint_threat_response
- Turn 7 (3 turn(s) ago): joint_threat_response
- Turn 8 (2 turn(s) ago): eu_frontier_access_denied
- Turn 9 (1 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, eu_frontier_access_denied, member_state_defection, adoption_success, automated_decision_scandal, emergent_resilience_build_blockade, emergent_commercial_queue_jump_offer
