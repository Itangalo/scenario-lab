...
- characters 3731-4203: `{{statement_ledger}}` from the actor's live statement ledger
- characters 5675-7802: `{{previous_actions}}` from the actor's own response from the previous turn
