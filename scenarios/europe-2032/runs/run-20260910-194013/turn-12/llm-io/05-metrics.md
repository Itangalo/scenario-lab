...
- characters 106-12957: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13000-13191: `{{metrics_json}}` from the run's live metric values
- characters 13284-14272: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14315-16054: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16110-16641: `{{notepad}}` from the Game Master's notepad, carried across turns
