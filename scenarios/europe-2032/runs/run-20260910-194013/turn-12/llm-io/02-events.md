...
- characters 376-1364: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1407-3146: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3202-4302: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4365-31113: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31468-32470: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M13 EU Trusted Assurance Retrofit −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: EU Trusted Assurance Retrofit (cat 5, small) +3 — collapsing assurance and daily probes over last turns plus safety breakthrough this turn this answers directly
LEGITIMACY LENDS: capital 19, sentiment 12 -> none, capital is higher
SOVEREIGNTY: 26 last turn, M12 EU Distressed Capacity Anchor finishes t11 +4, no capacity in-flight bonus, embodied_ai_deployment t11 −2, capability rose 1.0 −0 = 28

## Emerging developments (tracked)

- `emergent_siting_blockade_escalation` -- first noted turn 10, listed in 2 turn(s) so far: Coordinated physical protests block permitting hearings for two gigafactory expansion sites, delaying emergency inference capacity build-out by months.
- `emergent_fallback_staff_resistance` -- first noted turn 10, listed in 2 turn(s) so far: Municipal grid operators stage coordinated go-slow on automated patching tools after a faulty update causes local outages, slowing shield rollout and leaving fallback procedures as the only cover.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, adoption_success
- Turn 2 (10 turn(s) ago): cyber_major_incident, taiwan_tension_rise
- Turn 3 (9 turn(s) ago): eval_anomaly_reports, emergent_relay_supply_crunch
- Turn 4 (8 turn(s) ago): eval_anomaly_reports, export_control_escalation, member_state_defection
- Turn 5 (7 turn(s) ago): cyber_major_incident, safety_breakthrough, knowledge_work_augmented, election_consolidation
- Turn 6 (6 turn(s) ago): capability_jump, emergent_technician_licensing_backlash
- Turn 7 (5 turn(s) ago): cyber_major_incident, taiwan_blockade, openweight_frontier_release, joint_threat_response
- Turn 8 (4 turn(s) ago): cyber_major_incident, openweight_frontier_release, eu_frontier_access_denied
- Turn 9 (3 turn(s) ago): medical_breakthrough, openweight_frontier_release, knowledge_work_augmented, emergent_probe_as_a_service
- Turn 10 (2 turn(s) ago): ai_investment_collapse, export_control_escalation
- Turn 11 (1 turn(s) ago): safety_breakthrough, embodied_ai_deployment
