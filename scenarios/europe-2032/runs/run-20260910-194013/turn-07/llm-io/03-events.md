...
- characters 377-1627: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1671-3699: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3755-4317: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4380-31587: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31942-32444: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, adoption_success
- Turn 2 (5 turn(s) ago): cyber_major_incident, taiwan_tension_rise
- Turn 3 (4 turn(s) ago): eval_anomaly_reports, emergent_relay_supply_crunch
- Turn 4 (3 turn(s) ago): eval_anomaly_reports, export_control_escalation, member_state_defection
- Turn 5 (2 turn(s) ago): cyber_major_incident, safety_breakthrough, knowledge_work_augmented, election_consolidation
- Turn 6 (1 turn(s) ago): capability_jump, emergent_technician_licensing_backlash
