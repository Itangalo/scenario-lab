...
- characters 106-13547: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13590-13782: `{{metrics_json}}` from the run's live metric values
- characters 13875-15125: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15169-17197: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17253-18452: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Technician Settlement and Registry Patch Surge | 2 |
| M9 | EU Supply-Chain Shield and Joint Response Accession | 2 |
...
PORTFOLIO CHARGE t6: M1 InvestAI Gigafactories −3, M7 EU Essential Services Continuity and Cross-Border Mutual Aid −2, M8 EU Technician Settlement and Registry Patch Surge −2, priority M7 −1 = −8
PROPOSAL BONUS: EU Technician Settlement and Registry Patch Surge (cat 6, small) +3 — capability jump and walkout freeze relays this turn and this answers both directly
LEGITIMACY LENDS: capital 18, sentiment 26 -> +2
SOVEREIGNTY: 17 last turn, M2 Tech sovereignty package finishes t6 +4, M1 Gigafactories in flight +1, no capacity event, capability rose 1.0 −0 = 22

## Emerging developments (tracked)

- `emergent_probe_as_a_service` -- first noted turn 7, listed in 1 turn(s) so far: Independent red-team labs publish evidence that self-rewriting intrusion probes are now routinely offered as a paid service on cybercrime forums, collapsing the skill barrier for grid and registry attacks.
- `emergent_us_tiered_access_queue` -- first noted turn 7, listed in 1 turn(s) so far: US tiered-access licensing rules are published and EU-hosted inference of the newest closed models is placed in a delayed review queue, forcing hospitals and ministries built on US APIs onto throttled quotas through autumn.
...
## Notepad
PORTFOLIO CHARGE t7: M8 EU Technician Settlement and Registry Patch Surge −2, M9 EU Supply-Chain Shield and Joint Response Accession −2, priority M8 −1 = −5
PROPOSAL BONUS: EU Supply-Chain Shield and Joint Response Accession (cat 8, small) +4 — cyber_major_incident and Taiwan blockade land this turn and this answers both directly via joint command and supply-chain coordination
LEGITIMACY LENDS: capital 21, sentiment 26 -> +2
SOVEREIGNTY: 22 last turn, M1 InvestAI Gigafactories finishes t7 +5, no capacity event in flight bonus +0, taiwan_blockade t7 −2, capability rose 1.0 −0 = 25
