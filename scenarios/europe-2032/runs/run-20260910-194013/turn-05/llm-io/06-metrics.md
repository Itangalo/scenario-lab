...
- characters 13781-15726: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15770-18195: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18251-19497: `{{notepad}}` from the Game Master's notepad, carried across turns
