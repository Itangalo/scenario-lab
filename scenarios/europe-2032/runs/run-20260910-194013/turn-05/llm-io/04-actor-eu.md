...
- characters 2444-4869: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7613-8072: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10435-12746: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU AI Solidarity and Supply-Chain Bargain | 8 | small | 4 | 6 | own jurisdiction plus coalition partners | eu_ai_sovereignty up slightly, eu_political_capital stabilized via cohesion | 2 | running |
