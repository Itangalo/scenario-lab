...
- characters 2366-4791: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4847-6093: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6156-34641: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34996-35298: `{{event_history}}` from the run's own event record
...
- `emergent_technician_licensing_backlash` -- first noted turn 4, listed in 1 turn(s) so far: Fast-tracked OT technician licences trigger coordinated walkouts and safety refusals by transmission-operator unions in two member states, freezing relay installations despite joint procurement.
- `emergent_counterfeit_relay_influx` -- first noted turn 4, listed in 1 turn(s) so far: Rushed joint procurement and fast-track certification draw grey-market certified relays into EU transmission supply chains, with counterfeit or mis-graded components discovered during installation.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, adoption_success
- Turn 2 (3 turn(s) ago): cyber_major_incident, taiwan_tension_rise
- Turn 3 (2 turn(s) ago): eval_anomaly_reports, emergent_relay_supply_crunch
- Turn 4 (1 turn(s) ago): eval_anomaly_reports, export_control_escalation, member_state_defection
