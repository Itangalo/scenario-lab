...
- characters 106-13458: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13501-13693: `{{metrics_json}}` from the run's live metric values
- characters 13786-15140: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15184-17217: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17273-17820: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Incident Reporting and Software Dependency Registry | 2 |
| M5 | EU Relay Surge and OT Engineer Corps | 2 |
...
PORTFOLIO CHARGE t2: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Infrastructure Cyber Shield −3, M4 EU Incident Reporting and Software Dependency Registry −2, priority M3 −1 = −12
PROPOSAL BONUS: EU Incident Reporting and Software Dependency Registry (cat 2, small) +3 — cyber_major_incident landed this turn with unknown blast radius and this answers it directly
LEGITIMACY LENDS: capital 36, sentiment 37 -> +1
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 53.0, "ai_safety": 28.0, "resilience": 41.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 35.0, "public_sentiment": 36.0}
```
## Narrative
...
## Notepad
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Incident Reporting and Software Dependency Registry −2, M5 EU Relay Surge and OT Engineer Corps −2, priority M4 −1 = −11
PROPOSAL BONUS: EU Relay Surge and OT Engineer Corps (cat 6, small) +2 — spring grid-check relay/engineer shortage delaying hardening, answers emergent crunch directly
