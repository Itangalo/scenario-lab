...
- characters 377-1731: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1775-3808: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3864-5001: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5064-29291: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29646-29773: `{{event_history}}` from the run's own event record
...
- `emergent_datacentre_backlash` -- first noted turn 1, listed in 2 turn(s) so far: Coordinated local opposition blocks or delays at least one major EU data-centre / supercomputer siting decision through permits, litigation or protest during H2 2026.
- `emergent_relay_supply_crunch` -- first noted turn 2, listed in 1 turn(s) so far: Spring mandatory grid checks reveal a shortage of certified relays and control-system engineers, forcing several member states to request derogations and delaying replacement in power and water sites through mid-2027.
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, adoption_success
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.28}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.08}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.06}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.1}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.15}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.08}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Coordinated local opposition blocks or delays at least one major EU data-centre / supercomputer siting decision through permits, litigation or protest during H2 2026.", "emergent": true, "id": "emergent_datacentre_backlash", "probability": 0.22}, {"description": "Spring mandatory grid checks reveal a shortage of certified relays and control-system engineers, forcing several member states to request derogations and delaying replacement in power and water sites through mid-2027.", "emergent": true, "id": "emergent_relay_supply_crunch", "probability": 0.28}]
```
