...
- characters 376-1655: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1698-3804: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3860-5083: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5146-31635: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31990-32608: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, adoption_success
- Turn 2 (6 turn(s) ago): cyber_major_incident, taiwan_tension_rise
- Turn 3 (5 turn(s) ago): eval_anomaly_reports, emergent_relay_supply_crunch
- Turn 4 (4 turn(s) ago): eval_anomaly_reports, export_control_escalation, member_state_defection
- Turn 5 (3 turn(s) ago): cyber_major_incident, safety_breakthrough, knowledge_work_augmented, election_consolidation
- Turn 6 (2 turn(s) ago): capability_jump, emergent_technician_licensing_backlash
- Turn 7 (1 turn(s) ago): cyber_major_incident, taiwan_blockade, openweight_frontier_release, joint_threat_response
