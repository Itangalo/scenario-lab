...
- characters 105-13467: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13510-13702: `{{metrics_json}}` from the run's live metric values
- characters 13795-15645: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15688-18127: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18183-19324: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU AI Solidarity and Supply-Chain Bargain | 2 |
