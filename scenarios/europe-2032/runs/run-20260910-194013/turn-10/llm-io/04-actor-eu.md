...
- characters 1519-3475: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4202-4681: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7897-10639: `{{previous_actions}}` from the actor's own response from the previous turn
