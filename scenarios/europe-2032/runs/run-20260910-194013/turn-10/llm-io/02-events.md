...
- characters 1441-3397: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3453-3901: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3964-31306: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31661-32513: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): cyber_major_incident, taiwan_tension_rise
- Turn 3 (7 turn(s) ago): eval_anomaly_reports, emergent_relay_supply_crunch
- Turn 4 (6 turn(s) ago): eval_anomaly_reports, export_control_escalation, member_state_defection
- Turn 5 (5 turn(s) ago): cyber_major_incident, safety_breakthrough, knowledge_work_augmented, election_consolidation
- Turn 6 (4 turn(s) ago): capability_jump, emergent_technician_licensing_backlash
- Turn 7 (3 turn(s) ago): cyber_major_incident, taiwan_blockade, openweight_frontier_release, joint_threat_response
- Turn 8 (2 turn(s) ago): cyber_major_incident, openweight_frontier_release, eu_frontier_access_denied
- Turn 9 (1 turn(s) ago): medical_breakthrough, openweight_frontier_release, knowledge_work_augmented, emergent_probe_as_a_service
