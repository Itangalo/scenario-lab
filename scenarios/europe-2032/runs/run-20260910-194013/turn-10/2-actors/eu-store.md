...
| M12 | EU Distressed Capacity Anchor | 4 | small | 10 | 12 | own jurisdiction | eu_ai_sovereignty up slightly, eu_political_capital stabilized via retained jobs and sites | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Distressed Capacity Anchor", "category": 4, "size": "small", "finish_turn": 12, "applies_to": "own jurisdiction", "targeted_effect": "eu_ai_sovereignty up slightly, eu_political_capital stabilized via retained jobs and sites"}, "grounds": "investment collapse cancelling build-out the EU depended on plus export-control rationing"}
  - Grounds: investment collapse cancelling build-out the EU depended on plus export-control rationing
