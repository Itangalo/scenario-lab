...
- characters 456-1127: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1171-3122: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4706-5185: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8590-10715: `{{previous_actions}}` from the actor's own response from the previous turn
