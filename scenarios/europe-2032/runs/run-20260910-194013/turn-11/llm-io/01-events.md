...
- characters 378-1049: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1093-3044: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3100-4117: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4180-30928: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31283-32213: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M12 EU Distressed Capacity Anchor −2, priority M12 −1 = −3
PROPOSAL BONUS: EU Distressed Capacity Anchor (cat 4, small) +3 — ai_investment_collapse and export tightening this turn strand sites this answers directly
LEGITIMACY LENDS: capital 19, sentiment 12 -> none, capital is higher
SOVEREIGNTY: 28 last turn, no cat4 finish, no in-flight bonus in proposal turn, export_control_escalation t10 −2, capability rose 0.5 −0 = 26

## Emerging developments (tracked)

- `emergent_siting_blockade_escalation` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated physical protests block permitting hearings for two gigafactory expansion sites, delaying emergency inference capacity build-out by months.
- `emergent_fallback_staff_resistance` -- first noted turn 10, listed in 1 turn(s) so far: Municipal grid operators stage coordinated go-slow on automated patching tools after a faulty update causes local outages, slowing shield rollout and leaving fallback procedures as the only cover.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, adoption_success
- Turn 2 (9 turn(s) ago): cyber_major_incident, taiwan_tension_rise
- Turn 3 (8 turn(s) ago): eval_anomaly_reports, emergent_relay_supply_crunch
- Turn 4 (7 turn(s) ago): eval_anomaly_reports, export_control_escalation, member_state_defection
- Turn 5 (6 turn(s) ago): cyber_major_incident, safety_breakthrough, knowledge_work_augmented, election_consolidation
- Turn 6 (5 turn(s) ago): capability_jump, emergent_technician_licensing_backlash
- Turn 7 (4 turn(s) ago): cyber_major_incident, taiwan_blockade, openweight_frontier_release, joint_threat_response
- Turn 8 (3 turn(s) ago): cyber_major_incident, openweight_frontier_release, eu_frontier_access_denied
- Turn 9 (2 turn(s) ago): medical_breakthrough, openweight_frontier_release, knowledge_work_augmented, emergent_probe_as_a_service
- Turn 10 (1 turn(s) ago): ai_investment_collapse, export_control_escalation
