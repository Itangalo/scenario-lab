...
- characters 455-1430: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1474-3252: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5368-5884: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8904-11182: `{{previous_actions}}` from the actor's own response from the previous turn
