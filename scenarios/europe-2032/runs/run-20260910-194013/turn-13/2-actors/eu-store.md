...
| M15 | EU Anomaly Verification Hold | 1 | small | 13 | 15 | own jurisdiction | ai_safety up slightly, public_sentiment stabilized via visible caution | 2 | running |
...
- **applied** `M15` — {"op": "add", "table": "measures", "fields": {"name": "EU Anomaly Verification Hold", "category": 1, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "ai_safety up slightly, public_sentiment stabilized via visible caution"}, "grounds": "leaked eval anomaly plus bottom trust requires verification before further rollout"}
  - Grounds: leaked eval anomaly plus bottom trust requires verification before further rollout
