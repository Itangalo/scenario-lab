...
- characters 1609-3545: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4172-4651: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8604-10764: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M14 | EU Shield Patch Sprint | 6 | small | 12 | 14 | own jurisdiction | resilience up materially, ai_safety up slightly, public_sentiment stabilized via visible defence gain | 2 | running |
