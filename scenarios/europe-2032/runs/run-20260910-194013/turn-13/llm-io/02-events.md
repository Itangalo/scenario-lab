...
- characters 1531-3467: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3523-4034: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4097-30845: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31200-32380: `{{event_history}}` from the run's own event record
...
- Turn 2 (11 turn(s) ago): cyber_major_incident, taiwan_tension_rise
- Turn 3 (10 turn(s) ago): eval_anomaly_reports, emergent_relay_supply_crunch
- Turn 4 (9 turn(s) ago): eval_anomaly_reports, export_control_escalation, member_state_defection
- Turn 5 (8 turn(s) ago): cyber_major_incident, safety_breakthrough, knowledge_work_augmented, election_consolidation
- Turn 6 (7 turn(s) ago): capability_jump, emergent_technician_licensing_backlash
- Turn 7 (6 turn(s) ago): cyber_major_incident, taiwan_blockade, openweight_frontier_release, joint_threat_response
- Turn 8 (5 turn(s) ago): cyber_major_incident, openweight_frontier_release, eu_frontier_access_denied
- Turn 9 (4 turn(s) ago): medical_breakthrough, openweight_frontier_release, knowledge_work_augmented, emergent_probe_as_a_service
- Turn 10 (3 turn(s) ago): ai_investment_collapse, export_control_escalation
- Turn 11 (2 turn(s) ago): safety_breakthrough, embodied_ai_deployment
- Turn 12 (1 turn(s) ago): cyber_defence_breakthrough, research_breakthrough, embodied_ai_deployment, taiwan_tension_rise, adoption_success, emergent_siting_blockade_escalation
