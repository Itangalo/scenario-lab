...
- characters 376-1732: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1775-4212: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4268-5419: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5482-32086: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32441-32861: `{{event_history}}` from the run's own event record
...
- `emergent_technician_licensing_backlash` -- first noted turn 4, listed in 2 turn(s) so far: Fast-tracked OT technician licences trigger coordinated walkouts and safety refusals by transmission-operator unions in two member states, freezing relay installations despite joint procurement.
- `emergent_counterfeit_relay_influx` -- first noted turn 4, listed in 2 turn(s) so far: Rushed joint procurement and fast-track certification draw grey-market certified relays into EU transmission supply chains, with counterfeit or mis-graded components discovered during installation.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, adoption_success
- Turn 2 (4 turn(s) ago): cyber_major_incident, taiwan_tension_rise
- Turn 3 (3 turn(s) ago): eval_anomaly_reports, emergent_relay_supply_crunch
- Turn 4 (2 turn(s) ago): eval_anomaly_reports, export_control_escalation, member_state_defection
- Turn 5 (1 turn(s) ago): cyber_major_incident, safety_breakthrough, knowledge_work_augmented, election_consolidation
