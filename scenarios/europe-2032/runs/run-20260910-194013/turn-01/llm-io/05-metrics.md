...
- characters 16352-16638: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_datacentre_backlash` -- first noted turn 1, listed in 1 turn(s) so far: Coordinated local opposition blocks or delays at least one major EU data-centre / supercomputer siting decision through permits, litigation or protest during H2 2026.
...
## Metrics
```json
{"ai_capability": 54.0, "openweight_capability": 46.0, "ai_safety": 32.0, "resilience": 38.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 43.0, "public_sentiment": 43.0}
```
## Narrative
### The autumn audit
...
PROPOSAL BONUS: EU Critical Infrastructure Cyber Shield (cat 6, large) +3 — autumn swarm intrusion across grids/ports/water landed this turn and this answers it directly
