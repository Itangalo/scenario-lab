...
- characters 376-1449: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1492-3584: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3640-4384: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4447-28674: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29029-29088: `{{event_history}}` from the run's own event record
