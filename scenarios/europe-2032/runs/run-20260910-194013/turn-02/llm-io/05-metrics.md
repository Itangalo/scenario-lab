...
- characters 13392-14465: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14508-16600: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16656-17702: `{{notepad}}` from the Game Master's notepad, carried across turns
