...
- characters 377-2043: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2087-4045: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4101-4908: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4971-29198: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29553-29707: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Grid and Public Services Shield −3, priority −1 = −13
PROPOSAL BONUS: EU Grid and Public Services Shield (cat 6, large) +4 — cyber_major_incident landed this turn severe and this answers it directly
LEGITIMACY LENDS: capital 23, sentiment 30 -> +2
SOVEREIGNTY: 21 last turn, no capacity finish, Gigafactories in flight +0, eu_frontier_access_denied t2 −2, capability rose 2.0 −1 = 18

## Emerging developments (tracked)

- `emergent_power_price_protests` -- first noted turn 2, listed in 1 turn(s) so far: Municipal protests and permitting lawsuits stall two gigafactory shortlist sites over power prices and water use, forcing renegotiation of grid connections and co-financing terms.
...
- Turn 2 (1 turn(s) ago): cyber_major_incident, safety_breakthrough, eu_frontier_access_denied, adoption_success
