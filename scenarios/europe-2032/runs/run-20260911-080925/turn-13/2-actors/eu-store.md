...
| M13 | EU Middle-Power Supply and Access Pact | 8 | small | 11 | 13 | coalition partners holding supply-chain chokepoints plus own jurisdiction | eu_ai_sovereignty up, eu_political_capital up slightly via secured access | 2 | finished |
| M14 | EU Joint Cyber Command Accession | 6 | small | 13 | 15 | own jurisdiction plus coalition partners in joint command | resilience up, ai_safety up slightly via shared telemetry | 2 | running |
...
- **applied** `M14` — {"op": "add", "table": "measures", "fields": {"name": "EU Joint Cyber Command Accession", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction plus coalition partners in joint command", "targeted_effect": "resilience up, ai_safety up slightly via shared telemetry"}, "grounds": "to answer major automated incident via invited joint response"}
  - Grounds: to answer major automated incident via invited joint response
