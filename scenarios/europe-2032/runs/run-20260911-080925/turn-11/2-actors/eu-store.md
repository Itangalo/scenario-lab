...
| M13 | EU Middle-Power Supply and Access Pact | 8 | small | 11 | 13 | coalition partners holding supply-chain chokepoints plus own jurisdiction | eu_ai_sovereignty up, eu_political_capital up slightly via secured access | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Middle-Power Supply and Access Pact", "category": 8, "size": "small", "finish_turn": 13, "applies_to": "coalition partners holding supply-chain chokepoints plus own jurisdiction", "targeted_effect": "eu_ai_sovereignty up, eu_political_capital up slightly via secured access"}, "grounds": "to convert coalition opening into replacement compute
  - Grounds: to convert coalition opening into replacement compute
