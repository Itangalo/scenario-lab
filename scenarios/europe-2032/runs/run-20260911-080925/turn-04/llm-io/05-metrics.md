...
- characters 105-13692: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13735-13927: `{{metrics_json}}` from the run's live metric values
- characters 14020-15459: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15502-17673: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17729-18276: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Joint Threat and Bio-Surveillance Integration | 2 |
