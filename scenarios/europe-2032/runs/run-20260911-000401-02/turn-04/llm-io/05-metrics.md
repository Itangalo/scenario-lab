...
- characters 13746-15203: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15246-17631: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17687-18116: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | Small-Operator Hardening Sprint | 2 |
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 52.5, "ai_safety": 26.0, "resilience": 42.0, "eu_ai_sovereignty": 22.0, "eu_political_capital": 20.0, "public_sentiment": 43.0}
```
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Public Benefit AI Deployment −2, Small-Operator Hardening Sprint −2, priority −1 = −11
PROPOSAL BONUS: Small-Operator Hardening Sprint (cat 6, small) +2 — open-weight jump leaves pre-positioned access unrecallable and insurers demanding proof, this answers directly
LEGITIMACY LENDS: capital 18, sentiment 43 -> +2
SOVEREIGNTY: 22 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 22
