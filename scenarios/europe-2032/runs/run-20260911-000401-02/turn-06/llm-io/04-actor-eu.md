...
- characters 1866-4015: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5108-5581: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7920-10379: `{{previous_actions}}` from the actor's own response from the previous turn
...
- `two_year_commitment` (commitment): Hold autonomous EU capacity and absorption through US retrenchment and unrecallable open diffusion
...
| M6 | EU Autonomy Pact Network | 8 | small | 5 | 7 | own jurisdiction plus middle-power coalition | eu_ai_sovereignty up modestly, eu_political_capital protected via cohesion | 2 | running |
