...
- characters 106-12825: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12868-13057: `{{metrics_json}}` from the run's live metric values
- characters 13150-14264: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14307-16545: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16601-17695: `{{notepad}}` from the Game Master's notepad, carried across turns
