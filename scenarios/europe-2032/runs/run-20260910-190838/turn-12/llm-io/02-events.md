...
- characters 374-1488: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1531-3769: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3825-4324: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4387-30192: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30547-31292: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, bio_uplift_findings, knowledge_work_augmented, eu_frontier_access_denied, automated_decision_scandal
- Turn 4 (8 turn(s) ago): emergent_genome_paper_leak
- Turn 5 (7 turn(s) ago): export_control_escalation, member_state_defection, election_consolidation
- Turn 6 (6 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, openweight_frontier_release, supply_chain_coercion
- Turn 7 (5 turn(s) ago): export_control_escalation, eu_frontier_access_denied
- Turn 8 (4 turn(s) ago): capability_jump, taiwan_tension_rise
- Turn 9 (3 turn(s) ago): supply_chain_coercion, emergent_insurance_supply_seizure
- Turn 11 (1 turn(s) ago): loss_of_control_incident, adoption_success, emergent_municipal_grid_pact
