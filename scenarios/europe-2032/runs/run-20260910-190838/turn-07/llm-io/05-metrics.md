...
- characters 106-13226: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13269-13461: `{{metrics_json}}` from the run's live metric values
- characters 13554-15117: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15161-17892: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17948-19104: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M6 | EU Hold-the-Line Resilience Facility | 2 |
| M7 | EU Cut-Off Continuity Switch | 2 |
...
PORTFOLIO CHARGE t6: M1 InvestAI Gigafactories −3, M6 EU Hold-the-Line Resilience Facility −2, priority −1 = −6
PROPOSAL BONUS: EU Hold-the-Line Resilience Facility (cat 6, small) +3 — ai_investment_collapse + openweight_frontier_release + tiered rationing landed this turn and this answers harm-absorption directly
LEGITIMACY LENDS: capital 17, sentiment 20 -> +2 (capped at sentiment 20)
SOVEREIGNTY: 19 last turn, Tech sovereignty package finishes t6 +4, M1 in flight +0, supply_chain_coercion t6 −2, capability rose 1.0 −0 = 21
