...
- characters 455-2018: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2062-4793: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5624-6126: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8392-11176: `{{previous_actions}}` from the actor's own response from the previous turn
