...
- characters 453-1685: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1729-3629: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4446-4948: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7607-9681: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Livelihood Bridge for AI-Displaced Workers | 7 | small | 8 | 10 | own jurisdiction | resilience up moderately via social absorption, eu_political_capital up slightly, public_sentiment up slightly | 2 | running |
