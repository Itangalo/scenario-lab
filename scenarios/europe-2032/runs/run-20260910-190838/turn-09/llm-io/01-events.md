...
- characters 375-1607: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1651-3551: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3607-4085: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4148-29953: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30308-30869: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, bio_uplift_findings, knowledge_work_augmented, eu_frontier_access_denied, automated_decision_scandal
- Turn 4 (5 turn(s) ago): emergent_genome_paper_leak
- Turn 5 (4 turn(s) ago): export_control_escalation, member_state_defection, election_consolidation
- Turn 6 (3 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, openweight_frontier_release, supply_chain_coercion
- Turn 7 (2 turn(s) ago): export_control_escalation, eu_frontier_access_denied
- Turn 8 (1 turn(s) ago): capability_jump, taiwan_tension_rise
