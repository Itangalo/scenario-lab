...
- characters 1690-3610: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5159-5603: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7692-9574: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU Genome-Leak Bio Shield Surge | 6 | small | 4 | 6 | own jurisdiction | resilience up moderately, ai_safety up slightly via misuse containment | 2 | running |
