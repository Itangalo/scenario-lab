...
- characters 13212-14403: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14447-16367: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16423-16844: `{{notepad}}` from the Game Master's notepad, carried across turns
