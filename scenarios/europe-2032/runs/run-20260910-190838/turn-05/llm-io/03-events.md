...
- characters 1612-3532: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3588-4009: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4072-27853: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28208-28404: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, bio_uplift_findings, knowledge_work_augmented, eu_frontier_access_denied, automated_decision_scandal
- Turn 4 (1 turn(s) ago): emergent_genome_paper_leak
