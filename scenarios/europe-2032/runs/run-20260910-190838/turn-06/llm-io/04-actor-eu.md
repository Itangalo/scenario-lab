...
- characters 454-1975: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2018-4025: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5777-6217: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8308-9950: `{{previous_actions}}` from the actor's own response from the previous turn
