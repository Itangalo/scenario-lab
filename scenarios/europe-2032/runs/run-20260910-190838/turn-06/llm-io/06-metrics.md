...
- characters 13768-15289: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15332-17339: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17395-18448: `{{notepad}}` from the Game Master's notepad, carried across turns
