...
- characters 376-1897: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1940-3947: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4003-4431: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4494-26394: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26749-27045: `{{event_history}}` from the run's own event record
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, bio_uplift_findings, knowledge_work_augmented, eu_frontier_access_denied, automated_decision_scandal
- Turn 4 (2 turn(s) ago): emergent_genome_paper_leak
- Turn 5 (1 turn(s) ago): export_control_escalation, member_state_defection, election_consolidation
