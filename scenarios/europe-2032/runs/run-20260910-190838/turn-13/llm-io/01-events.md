...
- characters 376-1397: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1441-3409: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3465-4416: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4479-30284: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30639-31431: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M10 EU Trusted Public Services AI Scale-Up −2, priority −1 not charged — capital below 20, priority has no effect and no cost = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 5 -> +1
SOVEREIGNTY: 20 last turn, no capacity event, no cat 4 in flight +0, capability rose 0.5 no −1 = 20

## Emerging developments (tracked)

- `emergent_transformer_supply_easing` -- first noted turn 12, listed in 1 turn(s) so far: A major European transformer manufacturer brings a modular fast-deploy substation to market early, cutting large-transformer lead times from over a year to months for standard grid repairs.
- `emergent_agentic_pullback_wave` -- first noted turn 12, listed in 1 turn(s) so far: Copycat agentic failures in municipal back-office systems trigger coordinated service pullbacks, with several cities outside the pact suspending autonomous procurement tools pending audits.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, bio_uplift_findings, knowledge_work_augmented, eu_frontier_access_denied, automated_decision_scandal
- Turn 4 (9 turn(s) ago): emergent_genome_paper_leak
- Turn 5 (8 turn(s) ago): export_control_escalation, member_state_defection, election_consolidation
- Turn 6 (7 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, openweight_frontier_release, supply_chain_coercion
- Turn 7 (6 turn(s) ago): export_control_escalation, eu_frontier_access_denied
- Turn 8 (5 turn(s) ago): capability_jump, taiwan_tension_rise
- Turn 9 (4 turn(s) ago): supply_chain_coercion, emergent_insurance_supply_seizure
- Turn 11 (2 turn(s) ago): loss_of_control_incident, adoption_success, emergent_municipal_grid_pact
- Turn 12 (1 turn(s) ago): safety_breakthrough
