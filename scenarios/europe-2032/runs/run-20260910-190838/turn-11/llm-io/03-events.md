...
- characters 375-1524: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1568-3386: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3442-4126: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4189-29994: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30349-30994: `{{event_history}}` from the run's own event record
...
- `emergent_municipal_grid_pact` -- first noted turn 9, listed in 2 turn(s) so far: Stalled-zone councils coordinate a formal refusal pact linking grid-connection freezes to demands for EU energy-price compensation, turning local siting blocks into a collective bargaining lever.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, bio_uplift_findings, knowledge_work_augmented, eu_frontier_access_denied, automated_decision_scandal
- Turn 4 (7 turn(s) ago): emergent_genome_paper_leak
- Turn 5 (6 turn(s) ago): export_control_escalation, member_state_defection, election_consolidation
- Turn 6 (5 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, openweight_frontier_release, supply_chain_coercion
- Turn 7 (4 turn(s) ago): export_control_escalation, eu_frontier_access_denied
- Turn 8 (3 turn(s) ago): capability_jump, taiwan_tension_rise
- Turn 9 (2 turn(s) ago): supply_chain_coercion, emergent_insurance_supply_seizure
