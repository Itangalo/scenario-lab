...
- characters 107-13239: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13282-13471: `{{metrics_json}}` from the run's live metric values
- characters 13564-14713: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14757-16575: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16631-16998: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Trusted Public Services AI Scale-Up | 2 |
...
PORTFOLIO CHARGE t10: M9 EU Critical Spares Buffer for Grid and Chips −2, priority −1 not charged — capital below 20, priority has no effect and no cost = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: none — capital 6 above sentiment 4
SOVEREIGNTY: 20 last turn, no capacity event, no cat 4 in flight +0, capability rose 0.7 no −1 = 20
...
## Notepad
PORTFOLIO CHARGE t11: M10 EU Trusted Public Services AI Scale-Up −2, priority −1 not charged — capital below 20, priority has no effect and no cost = −2
PROPOSAL BONUS: EU Trusted Public Services AI Scale-Up (cat 9, small) +2 — answers formal refusal pact this turn and builds on adoption success, small size limits gain
LEGITIMACY LENDS: capital 7, sentiment 7 -> none — capital not below sentiment
