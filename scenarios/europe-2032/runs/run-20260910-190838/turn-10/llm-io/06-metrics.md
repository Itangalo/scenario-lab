...
- characters 13317-13506: `{{metrics_json}}` from the run's live metric values
- characters 13599-14842: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14885-17184: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17240-18128: `{{notepad}}` from the Game Master's notepad, carried across turns
