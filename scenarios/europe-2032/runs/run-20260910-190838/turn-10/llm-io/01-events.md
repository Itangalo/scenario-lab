...
- characters 374-1617: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1660-3959: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4015-4903: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4966-30771: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31126-31770: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M8 EU Livelihood Bridge for AI-Displaced Workers −2, M9 EU Critical Spares Buffer for Grid and Chips −2 = −4 plus priority −1 not charged — capital below 20, priority has no effect and no cost
PROPOSAL BONUS: EU Critical Spares Buffer (cat 6, small) +3 — supply_chain_coercion and insurance suspension of chip/transformer deliveries this turn and this answers directly
LEGITIMACY LENDS: none — capital 6 above sentiment 4
SOVEREIGNTY: 22 last turn, no capacity event? supply_chain_coercion t9 −2, no cat 4 in flight +0, capability rose 0.7 no −1 = 20

## Emerging developments (tracked)

- `emergent_municipal_grid_pact` -- first noted turn 9, listed in 1 turn(s) so far: Stalled-zone councils coordinate a formal refusal pact linking grid-connection freezes to demands for EU energy-price compensation, turning local siting blocks into a collective bargaining lever.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, bio_uplift_findings, knowledge_work_augmented, eu_frontier_access_denied, automated_decision_scandal
- Turn 4 (6 turn(s) ago): emergent_genome_paper_leak
- Turn 5 (5 turn(s) ago): export_control_escalation, member_state_defection, election_consolidation
- Turn 6 (4 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, openweight_frontier_release, supply_chain_coercion
- Turn 7 (3 turn(s) ago): export_control_escalation, eu_frontier_access_denied
- Turn 8 (2 turn(s) ago): capability_jump, taiwan_tension_rise
- Turn 9 (1 turn(s) ago): supply_chain_coercion, emergent_insurance_supply_seizure
