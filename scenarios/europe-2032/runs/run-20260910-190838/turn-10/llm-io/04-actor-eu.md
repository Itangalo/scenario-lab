...
- characters 452-1695: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1738-4037: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4105-4600: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7451-9918: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Critical Spares Buffer for Grid and Chips | 6 | small | 9 | 11 | own jurisdiction | resilience up moderately, eu_political_capital down slightly if seen as hoarding | 2 | running |
