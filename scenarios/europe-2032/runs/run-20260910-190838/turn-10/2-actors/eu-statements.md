...
- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild independent supply for grids, chips and livelihoods so coercion cannot stop essential services
  ...
  - Evidence quoted: the two-year commitment period closes this turn and a new four-turn term opens under open lithography coercion and suspended strait deliveries
