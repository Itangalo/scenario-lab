...
- characters 106-13280: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13323-13515: `{{metrics_json}}` from the run's live metric values
- characters 13608-14912: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14956-16770: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16826-17160: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Patch-and-Drill Completion Facility | 2 |
...
PORTFOLIO CHARGE t2: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Systems Shield −3, priority −1 = −10
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 20, sentiment 31 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, M1/M2 in flight +1, capability rose 1.5 −0 = 20
...
## Notepad
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Patch-and-Drill Completion Facility −2, priority −1 = −9
PROPOSAL BONUS: none — no external event in last three turns; M4 (cat 6, small) closes implementation gaps, not a shock response
LEGITIMACY LENDS: capital 19, sentiment 30 -> +2 capped, applied in capital total
