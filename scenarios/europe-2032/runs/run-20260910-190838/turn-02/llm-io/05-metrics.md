...
- characters 105-12878: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12921-13113: `{{metrics_json}}` from the run's live metric values
- characters 13206-14666: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14709-16985: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17041-17907: `{{notepad}}` from the Game Master's notepad, carried across turns
