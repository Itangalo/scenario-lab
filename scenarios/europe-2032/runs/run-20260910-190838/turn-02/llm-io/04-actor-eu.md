...
- characters 454-1914: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1957-4233: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4301-4745: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6220-8466: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M3 | EU Critical Systems Shield | 6 | large | 1 | 3 | own jurisdiction | resilience up strongly, eu_ai_sovereignty up modestly via fallback capacity | 3 | running |
