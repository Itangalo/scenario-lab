...
- characters 375-1657: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1700-3920: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3976-5100: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5163-29512: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29867-30365: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: M6 EU Hold-the-Line Resilience Facility −2, M7 EU Cut-Off Continuity Switch −2, priority −1 = −5
PROPOSAL BONUS: EU Cut-Off Continuity Switch (cat 6, small) +4 — eu_frontier_access_denied + export_control_escalation landed this turn and this answers harm-absorption directly
LEGITIMACY LENDS: none — capital 15 above sentiment 9
SOVEREIGNTY: 21 last turn, M1 InvestAI Gigafactories finishes t7 +4, no in-flight bonus, eu_frontier_access_denied t7 −2, capability rose 0.7 −0 = 23

## Emerging developments (tracked)

- `emergent_build_zone_freeze` -- first noted turn 6, listed in 2 turn(s) so far: A coordinated municipal revolt in stalled gigafactory zones blocks grid and land options through local zoning freezes, removing sites from the legally-alive portfolio before any federal funding decision.
- `emergent_grid_block_municipalities` -- first noted turn 6, listed in 2 turn(s) so far: Coordinated municipal bans on new data-centre grid connections spread across several member states amid power-price protests, freezing queued gigafactory power reservations through courts rather than ministries.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, bio_uplift_findings, knowledge_work_augmented, eu_frontier_access_denied, automated_decision_scandal
- Turn 4 (4 turn(s) ago): emergent_genome_paper_leak
- Turn 5 (3 turn(s) ago): export_control_escalation, member_state_defection, election_consolidation
- Turn 6 (2 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, openweight_frontier_release, supply_chain_coercion
- Turn 7 (1 turn(s) ago): export_control_escalation, eu_frontier_access_denied
