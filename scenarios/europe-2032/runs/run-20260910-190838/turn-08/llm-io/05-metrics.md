...
- characters 105-12919: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12962-13153: `{{metrics_json}}` from the run's live metric values
- characters 13246-14528: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14571-16791: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16847-17346: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | EU Livelihood Bridge for AI-Displaced Workers | 2 |
...
## Notepad
PORTFOLIO CHARGE t8: M6 EU Hold-the-Line Resilience Facility −2, M7 EU Cut-Off Continuity Switch −2, M8 EU Livelihood Bridge for AI-Displaced Workers −2, priority −1 = −7
PROPOSAL BONUS: none — M8 (cat 7, small) gestures at livelihood anger but no labour-displacement or cohesion event fired in last three turns to answer directly
LEGITIMACY LENDS: none — capital 15 above sentiment 9
SOVEREIGNTY: 23 last turn, no capacity event, no cat 4 in flight, capability rose 4.5 −1 = 22
