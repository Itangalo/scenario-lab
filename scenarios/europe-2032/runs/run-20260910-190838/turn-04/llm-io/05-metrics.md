...
- characters 105-13233: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13276-13468: `{{metrics_json}}` from the run's live metric values
- characters 13561-14845: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14888-16649: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16705-17155: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Genome-Leak Bio Shield Surge | 2 |
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 54.3, "ai_safety": 26.0, "resilience": 44.5, "eu_ai_sovereignty": 21.0, "eu_political_capital": 19.0, "public_sentiment": 26.0}
```
