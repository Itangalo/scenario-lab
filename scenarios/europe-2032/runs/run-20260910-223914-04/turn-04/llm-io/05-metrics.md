...
- characters 105-13617: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13660-13852: `{{metrics_json}}` from the run's live metric values
- characters 13945-15750: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15793-17934: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17990-18585: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Agent Containment and Kill-Switch Regime | 2 |
...
## Metrics
```json
{"ai_capability": 64.0, "openweight_capability": 57.5, "ai_safety": 26.0, "resilience": 41.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 17.0, "public_sentiment": 30.0}
```
