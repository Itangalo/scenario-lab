...
- characters 13489-14818: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14861-17338: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17394-18439: `{{notepad}}` from the Game Master's notepad, carried across turns
