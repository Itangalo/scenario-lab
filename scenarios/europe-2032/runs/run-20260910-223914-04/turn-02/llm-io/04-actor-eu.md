...
- characters 4371-4843: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6315-8442: `{{previous_actions}}` from the actor's own response from the previous turn
