...
- characters 13887-16228: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16272-18324: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18380-19675: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|---|---|---|---|---|---|---|
| M4 | EU Supply-Chain Leverage Compact | 8 | small | 2 | 5 | coalition | eu_ai_sovereignty up moderately, ai_capability growth slowed | 2 | finished |
...
- `emergent_agent_insurance_freeze` -- first noted turn 5, listed in 1 turn(s) so far: A cross-border coalition of European insurers and energy traders imposes emergency agent-liability exclusions and mandatory human sign-off for autonomous transactions after the February containment failure, freezing rollout of agentic trading systems through year-end.
- `emergent_compute_moratorium_precedent` -- first noted turn 5, listed in 1 turn(s) so far: National courts cite the paused gigafactory injunction to freeze grid connections for two further large datacentre projects, turning a local construction pause into a de facto moratorium precedent across member states.
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Attribution and Rapid Disclosure Cell −2, EU Agent Containment and Kill-Switch Regime −2, priority −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 11, sentiment 33 -> +2
