...
- characters 2762-4814: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4870-5460: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5523-33071: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33426-33623: `{{event_history}}` from the run's own event record
...
- Turn 3 (2 turn(s) ago): emergent_attribution_leak
- Turn 4 (1 turn(s) ago): loss_of_control_incident, research_breakthrough, emergent_datacentre_backlash
