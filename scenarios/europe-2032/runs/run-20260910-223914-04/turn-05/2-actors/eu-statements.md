...
- `two_year_commitment` (commitment): Survive dependence and absorb autonomy shocks while rebuilding capacity to act

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Survive dependence and absorb autonomy shocks while rebuilding capacity to act
