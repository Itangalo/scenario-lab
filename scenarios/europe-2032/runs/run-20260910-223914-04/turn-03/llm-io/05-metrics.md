...
- characters 106-13216: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13259-13451: `{{metrics_json}}` from the run's live metric values
- characters 13544-14691: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14735-16783: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16839-17672: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Supply-Chain Leverage Compact | 2 |
| M5 | EU Attribution and Rapid Disclosure Cell | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, EU Supply-Chain Leverage Compact −2, priority −1 = −12
PROPOSAL BONUS: EU Supply-Chain Leverage Compact (cat 8, small) +2 — autumn swarm last turn showed distributed offensive capability and EU compute gap, this answers it directly but via coordination not capacity
...
- `emergent_datacentre_backlash` -- first noted turn 2, listed in 2 turn(s) so far: Coordinated local protests and municipal permit challenges stall at least one AI factory site, forcing a temporary construction pause and national debate over power prices and water use.
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 54.0, "ai_safety": 28.0, "resilience": 36.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 25.0, "public_sentiment": 34.0}
```
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, EU Supply-Chain Leverage Compact −2, EU Attribution and Rapid Disclosure Cell −2, priority −1 = −14
PROPOSAL BONUS: EU Attribution and Rapid Disclosure Cell (cat 2, small) +3 — emergent_attribution_leak last turn forced public attribution debate over autumn pre-positioning and this answers it directly with EU-owned disclosure channel
LEGITIMACY LENDS: capital 23, sentiment 34 -> +2
