...
- characters 1656-3875: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3931-4562: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4625-27346: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27701-27861: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, knowledge_work_augmented, member_state_defection
- Turn 3 (1 turn(s) ago): us_china_agreement, member_state_defection
