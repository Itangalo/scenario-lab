...
- characters 454-1721: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1764-4045: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5036-5492: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7961-10319: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU–Middle Power Supply-Chain and Access Pact | 8 | small | 5 | 7 | middle-power coalition | eu_ai_sovereignty up, eu_political_capital up via joint leverage | 2 | running |
