...
- characters 454-1501: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1544-3631: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6239-6710: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10113-11452: `{{previous_actions}}` from the actor's own response from the previous turn
