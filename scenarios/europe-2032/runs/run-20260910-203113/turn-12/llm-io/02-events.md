...
- characters 376-1423: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1466-3553: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3609-4434: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4497-29542: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29897-30933: `{{event_history}}` from the run's own event record
...
- `emergent_trusted_assistant_backlash` -- first noted turn 11, listed in 1 turn(s) so far: Municipal pilot clinics and permit offices using signed assistants suffer coordinated fraud-driven lockouts, forcing temporary shutdowns that deepen public hostility to AI deployment.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, knowledge_work_augmented, member_state_defection
- Turn 3 (9 turn(s) ago): us_china_agreement, member_state_defection
- Turn 4 (8 turn(s) ago): capability_jump, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied
- Turn 5 (7 turn(s) ago): capability_jump, bio_uplift_findings, eu_frontier_access_denied, middle_power_coalition, election_consolidation
- Turn 6 (6 turn(s) ago): bio_incident, export_control_escalation, emergent_fallback_host_outage
- Turn 7 (5 turn(s) ago): capability_jump, eval_anomaly_reports, opaque_reasoning, member_state_defection, emergent_fallback_capacity_crunch
- Turn 8 (4 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 9 (3 turn(s) ago): cyber_major_incident, capability_jump, embodied_ai_deployment, adoption_success, joint_threat_response
- Turn 10 (2 turn(s) ago): bio_uplift_findings, export_control_escalation
- Turn 11 (1 turn(s) ago): openweight_frontier_release, embodied_ai_deployment, taiwan_tension_rise
