...
- characters 106-13541: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13584-13776: `{{metrics_json}}` from the run's live metric values
- characters 13869-15388: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15432-17960: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18016-18574: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | EU Black-Box Assurance and Model Inspection Cell | 2 |
...
## Metrics
```json
{"ai_capability": 63.5, "openweight_capability": 60.4, "ai_safety": 1.0, "resilience": 37.5, "eu_ai_sovereignty": 19.5, "eu_political_capital": 19.0, "public_sentiment": 21.0}
```
...
## Notepad
PORTFOLIO CHARGE t7: M8 EU Bio-Incident and Continuity Hardening Surge −2, M9 EU Black-Box Assurance and Model Inspection Cell −2, priority M8 −1 = −5
PROPOSAL BONUS: EU Black-Box Assurance and Model Inspection Cell (cat 5, small) +3 — opaque reasoning plus leaked eval anomalies and code/cyber jump landed this turn and this answers them directly
LEGITIMACY LENDS: capital 17, sentiment 27 -> +2
SOVEREIGNTY: 16.5 last turn, M1 InvestAI Gigafactories finishes t7 +5, member_state_defection t7 −2, capability rose 1.5 −0 = 19.5
