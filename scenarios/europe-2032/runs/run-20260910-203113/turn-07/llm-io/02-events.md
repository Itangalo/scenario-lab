...
- characters 377-1896: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1940-4468: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4524-5407: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5470-30359: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30714-31233: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, knowledge_work_augmented, member_state_defection
- Turn 3 (4 turn(s) ago): us_china_agreement, member_state_defection
- Turn 4 (3 turn(s) ago): capability_jump, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied
- Turn 5 (2 turn(s) ago): capability_jump, bio_uplift_findings, eu_frontier_access_denied, middle_power_coalition, election_consolidation
- Turn 6 (1 turn(s) ago): bio_incident, export_control_escalation, emergent_fallback_host_outage
