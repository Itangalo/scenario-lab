...
- characters 13430-13621: `{{metrics_json}}` from the run's live metric values
- characters 13714-14977: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15020-17037: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17093-17929: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Essential Workloads Continuity and Rationing Reserve | 2 |
...
- `emergent_clinical_triage_walkout` -- first noted turn 8, listed in 1 turn(s) so far: A coordinated walkout by radiologists and hospital technicians in two member states over erratic rationed triage tools forces emergency suspension of US-licensed diagnostic inference.
