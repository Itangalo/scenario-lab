...
- characters 1681-3698: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3754-4281: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4344-28536: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28891-29551: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, knowledge_work_augmented, member_state_defection
- Turn 3 (5 turn(s) ago): us_china_agreement, member_state_defection
- Turn 4 (4 turn(s) ago): capability_jump, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied
- Turn 5 (3 turn(s) ago): capability_jump, bio_uplift_findings, eu_frontier_access_denied, middle_power_coalition, election_consolidation
- Turn 6 (2 turn(s) ago): bio_incident, export_control_escalation, emergent_fallback_host_outage
- Turn 7 (1 turn(s) ago): capability_jump, eval_anomaly_reports, opaque_reasoning, member_state_defection, emergent_fallback_capacity_crunch
