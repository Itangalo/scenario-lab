...
- characters 13356-14230: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14273-16440: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16496-17321: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_datacentre_backlash` -- first noted turn 1, listed in 2 turn(s) so far: Coordinated local protests and municipal permit challenges delay at least one major EU data-centre / supercomputer expansion slated for late 2026, turning energy cost and water use into a national debate.
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 50.0, "ai_safety": 30.0, "resilience": 37.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 32.0, "public_sentiment": 44.0}
```
