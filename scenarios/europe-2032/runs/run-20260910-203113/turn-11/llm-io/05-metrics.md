...
- characters 107-13436: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13479-13670: `{{metrics_json}}` from the run's live metric values
- characters 13763-14800: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14844-17235: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17291-18213: `{{notepad}}` from the Game Master's notepad, carried across turns
