...
- characters 16339-16663: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_datacentre_backlash` -- first noted turn 1, listed in 1 turn(s) so far: Coordinated local protests and municipal permit challenges delay at least one major EU data-centre / supercomputer expansion slated for late 2026, turning energy cost and water use into a national debate.
...
## Metrics
```json
{"ai_capability": 54.0, "openweight_capability": 46.0, "ai_safety": 32.0, "resilience": 38.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 40.0, "public_sentiment": 44.0}
```
...
PROPOSAL BONUS: EU Critical Systems Shield (cat 6, large) +4 — autumn cross-continent swarm intrusion landed this turn and this answers it directly; labour-displacement bonus blocked by augmentation without job loss
LEGITIMACY LENDS: capital 38, sentiment 44 -> +2
SOVEREIGNTY: 22 last turn, no finishing cat4, in flight +0, member_state_defection t1 −2, capability rose 2.0 −1 = 19
## Store changes
```json
