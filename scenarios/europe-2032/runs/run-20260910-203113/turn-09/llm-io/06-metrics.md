...
- characters 106-13076: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13119-13310: `{{metrics_json}}` from the run's live metric values
- characters 13403-14820: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14864-16960: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17016-17771: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 66.0, "openweight_capability": 63.3, "ai_safety": 0.0, "resilience": 42.5, "eu_ai_sovereignty": 17.5, "eu_political_capital": 18.0, "public_sentiment": 22.0}
```
