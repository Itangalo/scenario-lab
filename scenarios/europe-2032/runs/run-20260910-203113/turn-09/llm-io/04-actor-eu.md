...
- characters 454-1871: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1915-4011: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6836-7292: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10276-12417: `{{previous_actions}}` from the actor's own response from the previous turn
