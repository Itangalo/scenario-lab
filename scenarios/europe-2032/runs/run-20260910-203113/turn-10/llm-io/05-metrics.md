...
- characters 106-13480: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13523-13714: `{{metrics_json}}` from the run's live metric values
- characters 13807-15738: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15781-18085: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18141-18737: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M11 | EU Public Benefit AI Deployment with Trusted Signatures | 2 |
| M12 | EU Logistics Displacement Transition and Care Retraining Compact | 2 |
...
## Metrics
```json
{"ai_capability": 67.0, "openweight_capability": 64.6, "ai_safety": 0.0, "resilience": 41.0, "eu_ai_sovereignty": 15.5, "eu_political_capital": 14.0, "public_sentiment": 21.0}
```
