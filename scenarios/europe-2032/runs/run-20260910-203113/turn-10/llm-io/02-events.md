...
- characters 376-2307: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2350-4654: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4710-5615: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5678-30723: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31078-31939: `{{event_history}}` from the run's own event record
...
- `emergent_clinical_triage_walkout` -- first noted turn 8, listed in 2 turn(s) so far: A coordinated walkout by radiologists and hospital technicians in two member states over erratic rationed triage tools forces emergency suspension of US-licensed diagnostic inference.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, knowledge_work_augmented, member_state_defection
- Turn 3 (7 turn(s) ago): us_china_agreement, member_state_defection
- Turn 4 (6 turn(s) ago): capability_jump, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied
- Turn 5 (5 turn(s) ago): capability_jump, bio_uplift_findings, eu_frontier_access_denied, middle_power_coalition, election_consolidation
- Turn 6 (4 turn(s) ago): bio_incident, export_control_escalation, emergent_fallback_host_outage
- Turn 7 (3 turn(s) ago): capability_jump, eval_anomaly_reports, opaque_reasoning, member_state_defection, emergent_fallback_capacity_crunch
- Turn 8 (2 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 9 (1 turn(s) ago): cyber_major_incident, capability_jump, embodied_ai_deployment, adoption_success, joint_threat_response
