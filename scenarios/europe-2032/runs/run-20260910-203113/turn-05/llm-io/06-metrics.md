...
- characters 13384-15016: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15060-17083: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17139-18306: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 56.5, "ai_safety": 12.0, "resilience": 38.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 22.0, "public_sentiment": 32.0}
```
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "pending"}, "grounds": "turn 5 election settles winner only, administration not in office"}]}
```
```
