...
- characters 377-2009: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2053-4076: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4132-4655: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4718-28116: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28471-28755: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, knowledge_work_augmented, member_state_defection
- Turn 3 (2 turn(s) ago): us_china_agreement, member_state_defection
- Turn 4 (1 turn(s) ago): capability_jump, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied
