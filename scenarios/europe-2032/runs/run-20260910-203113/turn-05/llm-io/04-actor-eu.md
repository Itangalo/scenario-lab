...
- characters 2131-4154: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6796-7269: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9556-11735: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Essential Services Continuity Reserve | 6 | small | 4 | 6 | own jurisdiction | resilience up, eu_ai_sovereignty up via fallback capacity | 2 | running |
