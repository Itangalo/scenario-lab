...
- characters 377-1467: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1511-3486: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3542-4474: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4537-29582: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29937-31091: `{{event_history}}` from the run's own event record
...
- `emergent_trusted_assistant_backlash` -- first noted turn 11, listed in 2 turn(s) so far: Municipal pilot clinics and permit offices using signed assistants suffer coordinated fraud-driven lockouts, forcing temporary shutdowns that deepen public hostility to AI deployment.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, knowledge_work_augmented, member_state_defection
- Turn 3 (10 turn(s) ago): us_china_agreement, member_state_defection
- Turn 4 (9 turn(s) ago): capability_jump, openweight_frontier_release, knowledge_work_augmented, eu_frontier_access_denied
- Turn 5 (8 turn(s) ago): capability_jump, bio_uplift_findings, eu_frontier_access_denied, middle_power_coalition, election_consolidation
- Turn 6 (7 turn(s) ago): bio_incident, export_control_escalation, emergent_fallback_host_outage
- Turn 7 (6 turn(s) ago): capability_jump, eval_anomaly_reports, opaque_reasoning, member_state_defection, emergent_fallback_capacity_crunch
- Turn 8 (5 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 9 (4 turn(s) ago): cyber_major_incident, capability_jump, embodied_ai_deployment, adoption_success, joint_threat_response
- Turn 10 (3 turn(s) ago): bio_uplift_findings, export_control_escalation
- Turn 11 (2 turn(s) ago): openweight_frontier_release, embodied_ai_deployment, taiwan_tension_rise
- Turn 12 (1 turn(s) ago): cyber_major_incident, research_breakthrough, supply_chain_coercion, joint_threat_response
