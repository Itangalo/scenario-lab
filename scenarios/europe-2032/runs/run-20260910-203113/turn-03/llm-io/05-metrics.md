...
- characters 106-13095: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13138-13330: `{{metrics_json}}` from the run's live metric values
- characters 13423-14493: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14537-16676: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16732-17265: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU OT Intrusion Shared Registry | 2 |
| M5 | EU Third-Pillar Accession to US-China AI Risk Accord | 2 |
