...
- characters 1777-4353: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4409-4996: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5059-26733: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27088-27354: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (1 turn(s) ago): ai_investment_collapse, openweight_frontier_release, knowledge_work_augmented, export_control_escalation
