...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Cutover Continuity Activation", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital stabilise if cutover holds"}, "grounds": "answer frontier access cutoff on essential services"}
  - Grounds: answer frontier access cutoff on essential services
