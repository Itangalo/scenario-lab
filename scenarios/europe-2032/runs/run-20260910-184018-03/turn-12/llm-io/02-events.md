...
- characters 377-1792: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1835-3868: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3924-4398: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4461-26960: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27315-28011: `{{event_history}}` from the run's own event record
...
- Turn 2 (10 turn(s) ago): taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (9 turn(s) ago): ai_investment_collapse, openweight_frontier_release, knowledge_work_augmented, export_control_escalation
- Turn 4 (8 turn(s) ago): export_control_escalation
- Turn 5 (7 turn(s) ago): knowledge_work_augmented, export_control_escalation, emergent_siting_backlash_freeze, election_consolidation
- Turn 8 (4 turn(s) ago): embodied_ai_deployment
- Turn 9 (3 turn(s) ago): eval_anomaly_reports
- Turn 10 (2 turn(s) ago): openweight_frontier_release, us_china_agreement
- Turn 11 (1 turn(s) ago): research_breakthrough, safety_breakthrough
