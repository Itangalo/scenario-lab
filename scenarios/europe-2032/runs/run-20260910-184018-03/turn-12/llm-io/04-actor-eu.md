...
- characters 455-1870: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1913-3946: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4435-4887: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8099-10596: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Deployed Assurance Uptake | 5 | small | 11 | 13 | own jurisdiction | ai_safety up moderately, resilience up slightly via certified deployed safeguards | 2 | running |
