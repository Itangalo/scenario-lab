...
- characters 455-1437: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1481-3497: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5502-5966: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8233-9236: `{{previous_actions}}` from the actor's own response from the previous turn
