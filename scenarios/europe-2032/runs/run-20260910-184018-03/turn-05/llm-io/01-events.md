...
- characters 377-1359: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1403-3419: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3475-4463: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4526-26200: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26555-26873: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Distributed-Capability Resilience Sprint −2, priority −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 17, sentiment 31 -> +2
SOVEREIGNTY: 18 last turn, no cat4 finishes, in flight +0, export_control_escalation t4 −2, capability rose 1.5 −0 = 16

## Emerging developments (tracked)

- `emergent_stripped_weights_ransomware` -- first noted turn 4, listed in 1 turn(s) so far: Municipal utilities and regional hospitals running stripped October open weights on local servers suffer a coordinated ransomware wave using model-generated exploits, forcing emergency EU cyber-agency intervention.
- `emergent_siting_backlash_freeze` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated siting protests and municipal water-use injunctions stall remaining EU gigafactory permits in Spain and Sweden, forcing formal permit extensions rather than construction starts.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, safety_breakthrough
- Turn 2 (3 turn(s) ago): taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (2 turn(s) ago): ai_investment_collapse, openweight_frontier_release, knowledge_work_augmented, export_control_escalation
- Turn 4 (1 turn(s) ago): export_control_escalation
