...
- characters 13212-14116: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14160-16127: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16183-16594: `{{notepad}}` from the Game Master's notepad, carried across turns
