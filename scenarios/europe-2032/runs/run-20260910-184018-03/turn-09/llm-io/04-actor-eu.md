...
- characters 455-1359: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1403-3370: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3997-4436: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7063-8789: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | EU Essential Services Fallback Sustainment | 6 | small | 8 | 10 | own jurisdiction | resilience up slightly, ai_safety up slightly via deployed safeguards | 2 | running |
