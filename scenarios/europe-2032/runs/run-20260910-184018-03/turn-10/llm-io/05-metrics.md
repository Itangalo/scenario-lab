...
- characters 106-13283: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13326-13518: `{{metrics_json}}` from the run's live metric values
- characters 13611-14624: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14667-16636: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16692-17214: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Eval Anomaly Watch and Containment Triage | 2 |
| M9 | EU Bridge to the Bilateral Safety Floor | 2 |
...
PORTFOLIO CHARGE t9: M7 EU Essential Services Fallback Sustainment −2, M8 EU Eval Anomaly Watch and Containment Triage −2, priority has no effect below 20 −0 = −4
PROPOSAL BONUS: EU Eval Anomaly Watch (cat 1, small) +2 — eval anomaly reports landed this turn and this answers it directly, small size and own-jurisdiction only
LEGITIMACY LENDS: capital 13, sentiment 23 -> +2 (capped below sentiment, ends 15+2=17)
SOVEREIGNTY: 20 last turn, no cat4 finish, no cat4 in flight, no capacity event, capability rose 0.7 −0 = 20
...
## Metrics
```json
{"ai_capability": 63.2, "openweight_capability": 61.8, "ai_safety": 21.0, "resilience": 46.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 20.0, "public_sentiment": 21.0}
```
...
## Notepad
PORTFOLIO CHARGE t10: M8 EU Eval Anomaly Watch and Containment Triage −2, M9 EU Bridge to the Bilateral Safety Floor −2, priority has no effect below 20 −0 = −4
PROPOSAL BONUS: none — Bridge answers us_china_agreement (positive opening, not negative shock) and does not answer openweight release directly
LEGITIMACY LENDS: capital 18, sentiment 21 -> +2 (capped below sentiment, ends 18+2=20)
SOVEREIGNTY: 20 last turn, no cat4 finish, no cat4 in flight, no capacity event, capability rose 0.5 −0 = 20
