...
- characters 377-1390: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1433-3402: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3458-3980: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4043-28048: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28403-28952: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, safety_breakthrough
- Turn 2 (8 turn(s) ago): taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (7 turn(s) ago): ai_investment_collapse, openweight_frontier_release, knowledge_work_augmented, export_control_escalation
- Turn 4 (6 turn(s) ago): export_control_escalation
- Turn 5 (5 turn(s) ago): knowledge_work_augmented, export_control_escalation, emergent_siting_backlash_freeze, election_consolidation
- Turn 8 (2 turn(s) ago): embodied_ai_deployment
- Turn 9 (1 turn(s) ago): eval_anomaly_reports
