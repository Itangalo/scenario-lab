...
- characters 455-1468: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1511-3480: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4758-5210: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8012-10190: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Eval Anomaly Watch and Containment Triage | 1 | small | 9 | 11 | own jurisdiction | ai_safety up slightly, resilience up slightly via early warning | 2 | running |
