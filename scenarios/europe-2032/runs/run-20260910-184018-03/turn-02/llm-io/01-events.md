...
- characters 1438-3945: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4001-5080: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5143-27478: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27833-27895: `{{event_history}}` from the run's own event record
