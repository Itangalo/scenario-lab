...
- characters 105-12959: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13002-13194: `{{metrics_json}}` from the run's live metric values
- characters 13287-14306: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14349-16856: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16912-17991: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M3 | EU Grid and Critical Services Cyber Hardening Sprint | 2 |
| M4 | EU Continuity and Reciprocity Instrument | 3 |
...
PORTFOLIO CHARGE t1: Gigafactories −3, Tech sovereignty package −3, EU Grid and Critical Services Cyber Hardening Sprint −2, priority −1 = −9
PROPOSAL BONUS: EU Grid and Critical Services Cyber Hardening Sprint (cat 6, small) +2 — autumn intrusion across transmission operators landed this turn and this answers it directly
LEGITIMACY LENDS: capital 41, sentiment 42 -> +1
SOVEREIGNTY: 22 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 22

## Emerging developments (tracked)

- `emergent_datacentre_backlash` -- first noted turn 1, listed in 2 turn(s) so far: Coordinated physical protests and grid-connection lawsuits stall at least one major EU hyperscale data-centre project for months, turning siting into a national political issue.
- `emergent_kimi_exploit_wave` -- first noted turn 1, listed in 2 turn(s) so far: Copycat crews weaponise Kimi K3's offensive cyber capability in a wave of low-sophistication intrusions against EU municipalities and mid-sized firms, widely reported but falling short of critical infrastructure disruption.
...
## Notepad
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Grid and Critical Services Cyber Hardening Sprint −2, EU Continuity and Reciprocity Instrument −3, priority −1 = −12
PROPOSAL BONUS: EU Continuity and Reciprocity Instrument (cat 8, large) +5 — frontier access denial landed this turn cutting off hospitals/ministries and this answers it directly
LEGITIMACY LENDS: capital 35, sentiment 34 -> none, capital higher
SOVEREIGNTY: 22 last turn, no finished cat4, Gigafactories in flight +0, eu_frontier_access_denied t2 −2, capability rose 1.5 −0 = 20
