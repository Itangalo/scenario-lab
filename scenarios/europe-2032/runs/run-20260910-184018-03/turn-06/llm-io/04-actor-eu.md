...
- characters 1696-3852: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3920-4359: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6627-7977: `{{previous_actions}}` from the actor's own response from the previous turn
