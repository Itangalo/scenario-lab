...
- characters 106-13362: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13405-13597: `{{metrics_json}}` from the run's live metric values
- characters 13690-14682: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14726-16943: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16999-17575: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Distributed-Capability Resilience Sprint | 2 |
