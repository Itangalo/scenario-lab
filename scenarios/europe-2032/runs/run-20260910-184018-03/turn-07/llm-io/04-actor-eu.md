...
- characters 455-1407: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1451-3410: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3478-3917: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6365-8115: `{{previous_actions}}` from the actor's own response from the previous turn
