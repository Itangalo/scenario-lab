...
- characters 13518-14470: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14514-16473: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16529-16992: `{{notepad}}` from the Game Master's notepad, carried across turns
