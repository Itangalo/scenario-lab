...
- characters 376-1253: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1296-3404: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3460-3769: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3832-27234: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27589-28042: `{{event_history}}` from the run's own event record
...
- Turn 2 (6 turn(s) ago): taiwan_tension_rise, eu_frontier_access_denied
- Turn 3 (5 turn(s) ago): ai_investment_collapse, openweight_frontier_release, knowledge_work_augmented, export_control_escalation
- Turn 4 (4 turn(s) ago): export_control_escalation
- Turn 5 (3 turn(s) ago): knowledge_work_augmented, export_control_escalation, emergent_siting_backlash_freeze, election_consolidation
