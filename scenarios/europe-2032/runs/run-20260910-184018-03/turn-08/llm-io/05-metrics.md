...
- characters 105-13225: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13268-13460: `{{metrics_json}}` from the run's live metric values
- characters 13553-14430: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14473-16581: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16637-16946: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Essential Services Fallback Sustainment | 2 |
...
## Notepad
PORTFOLIO CHARGE t8: M7 EU Essential Services Fallback Sustainment −2, priority has no effect below 20 −0 = −2
PROPOSAL BONUS: none — continuity sustainment answers no severe event from last three turns, small size gesturing at routine strain
LEGITIMACY LENDS: capital 17, sentiment 27 -> +2
SOVEREIGNTY: 22 last turn, no cat4 finish, no cat4 in flight, embodied_ai_deployment t8 −2, capability rose 0.7 −0 = 20
