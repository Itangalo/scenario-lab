...
- characters 107-13265: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13308-13500: `{{metrics_json}}` from the run's live metric values
- characters 13593-14993: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15037-17016: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17072-17573: `{{notepad}}` from the Game Master's notepad, carried across turns
