...
- characters 107-13259: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13302-13494: `{{metrics_json}}` from the run's live metric values
- characters 13587-15214: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15258-16900: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16956-17726: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M12 | EU Fallback Shield Patch | 2 |
...
- `emergent_triage_queue_protests` -- first noted turn 13, listed in 1 turn(s) so far: Coordinated hospital staff walkouts and municipal protests in France, Netherlands and Germany over lengthened AI-triage queues and slower fallback models, forcing temporary service curbs.
...
## Notepad
PORTFOLIO CHARGE t13: M11 EU Cutover Continuity Activation −2, M12 EU Fallback Shield Patch −2, priority M11 −1 = −5
PROPOSAL BONUS: EU Fallback Shield Patch (cat 6, small) +2 — bio_uplift_findings landed this turn and this answers it directly plus deploys safety gain
LEGITIMACY LENDS: capital 20, sentiment 18 -> none, capital higher
SOVEREIGNTY: 17 last turn, no capacity event, no cat4 in flight +0, capability rose 0.7 −0 = 17
