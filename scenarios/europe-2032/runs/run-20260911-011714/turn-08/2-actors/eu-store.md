...
| M6 | Municipal Recovery and Continuity Corps | 6 | small | 8 | 10 | own jurisdiction | resilience up moderately, eu_political_capital up slightly via visible delivery | 2 | running |
...
- **applied** `M6` — {"op": "add", "table": "measures", "fields": {"name": "Municipal Recovery and Continuity Corps", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital up slightly via visible delivery"}, "grounds": "back-to-back automated attacks with cutoff and freeze require funded recovery"}
  - Grounds: back-to-back automated attacks with cutoff and freeze require funded recovery
