...
- characters 106-13573: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13616-13807: `{{metrics_json}}` from the run's live metric values
- characters 13900-15646: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15689-17905: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17961-18768: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Civic AI Trust and Adoption Repair | 2 |
| M12 | EU Joint Cyber Command Accession | 2 |

     **so 2 measures are in flight and they come to −4 `eu_political_capital` this turn.** That figure is the `cost_per_turn` column of the rows above, added up, and nothing else: the named priority's −1 below is charged on top of it, and is not in it. Your charge line carries one term per measure -- 2 of them before the priority. **A measure is charged in every turn up to but not including its finishing turn. A measure added this turn is charged from this turn -- it appears in the rows above and in your total.**
...
PORTFOLIO CHARGE t9: M10 EU Chips-for-Compute and Civic Liability Pact −2, M11 EU Civic AI Trust and Adoption Repair −2, priority −0 (capital below 20, no effect, no cost) = −4
PROPOSAL BONUS: EU Civic AI Trust and Adoption Repair (cat 9, small) +3 — automated-decision scandal landed this turn and this answers it directly, plus insurer freeze
LEGITIMACY LENDS: capital 11, sentiment 23 -> +2
SOVEREIGNTY: 15 last turn, no capacity event, no cat4 finish, no cat4 in flight +0, capability rose 0.8 −0 = 15

## Emerging developments (tracked)

- `emergent_distressed_capacity_sale` -- first noted turn 10, listed in 1 turn(s) so far: US hyperscalers announce emergency sale of cancelled EU data-centre sites and power contracts to non-US buyers, creating a one-off cheap capacity window Brussels could seize.
...
## Notepad
PORTFOLIO CHARGE t10: M11 EU Civic AI Trust and Adoption Repair −2, M12 EU Joint Cyber Command Accession −2, priority −0 (capital below 20, no effect, no cost) = −4
PROPOSAL BONUS: none — joint pooled invitation is positive opportunity, not negative shock from last three rounds answered by cat 8 accession
LEGITIMACY LENDS: capital 11, sentiment 23 -> +2
SOVEREIGNTY: 15 last turn, no capacity event, no cat4 finish, no cat4 in flight +0, capability rose 0.7 −0 = 15
