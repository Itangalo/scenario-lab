...
- characters 376-2122: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2165-4381: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4437-4942: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5005-30285: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30640-31493: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise
- Turn 3 (7 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation
- Turn 4 (6 turn(s) ago): bio_uplift_findings, joint_threat_response
- Turn 5 (5 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise, election_retrenchment
- Turn 6 (4 turn(s) ago): capability_jump, opaque_reasoning, openweight_frontier_release, member_state_defection
- Turn 7 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, knowledge_work_augmented, member_state_defection
- Turn 8 (2 turn(s) ago): cyber_major_incident, taiwan_blockade, knowledge_work_augmented, embodied_ai_deployment, emergent_civic_insurance_freeze
- Turn 9 (1 turn(s) ago): ai_investment_collapse, adoption_success, automated_decision_scandal
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.36}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.08}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.07}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.05}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.05}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.14}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "US hyperscalers announce emergency sale of cancelled EU data-centre sites and power contracts to non-US buyers, creating a one-off cheap capacity window Brussels could seize.", "emergent": true, "id": "emergent_distressed_capacity_sale", "probability": 0.12}]
```
