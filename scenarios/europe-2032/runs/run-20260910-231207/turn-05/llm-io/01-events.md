...
- characters 377-2377: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2421-4489: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4545-4932: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4995-28776: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29131-29425: `{{event_history}}` from the run's own event record
...
- Turn 3 (2 turn(s) ago): openweight_frontier_release, safety_breakthrough
- Turn 4 (1 turn(s) ago): openweight_frontier_release, member_state_defection, emergent_grid_toolkit_copycats
