...
- characters 13731-15731: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15775-17843: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17899-18595: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Displaced-Worker Transition Guarantee | 2 |
...
|---|---|---|---|---|---|---|---|---|---|
| M5 | EU Incident Reporting and Assured Deployment Regime | 2 | small | 3 | 5 | own jurisdiction | ai_safety up moderately, resilience up modestly via faster detection | 2 | finished |
...
- `emergent_siting_moratoria_wave` -- first noted turn 5, listed in 1 turn(s) so far: A wave of municipal councils imposes de facto moratoria on new data-centre and AI-factory siting over power prices and water use, freezing several EU site selections through the winter.
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Displaced-Worker Transition Guarantee −2, priority −1 = −9
PROPOSAL BONUS: EU Displaced-Worker Transition Guarantee (cat 7, small) +2 — labour_displacement landed this turn with measurable graduate losses and this answers it directly
