...
- characters 455-2455: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2499-4567: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6309-6749: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8877-10360: `{{previous_actions}}` from the actor's own response from the previous turn
