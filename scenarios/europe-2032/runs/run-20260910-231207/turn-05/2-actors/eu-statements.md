...
- `two_year_commitment` (commitment): Hold essential services, livelihoods and EU leverage through unrecallable AI and tiered access

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold essential services, livelihoods and EU leverage through unrecallable AI and tiered access
