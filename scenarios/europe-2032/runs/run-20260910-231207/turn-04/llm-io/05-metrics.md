...
- characters 105-13544: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13587-13779: `{{metrics_json}}` from the run's live metric values
- characters 13872-15632: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15675-17758: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17814-18390: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Incident Reporting and Assured Deployment Regime −2, priority −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 26, sentiment 34 -> +2
SOVEREIGNTY: 20 last turn, no capacity event? member_state_defection t4 −2, Gigafactories in flight +0, capability rose 1.5 −0 = 18
