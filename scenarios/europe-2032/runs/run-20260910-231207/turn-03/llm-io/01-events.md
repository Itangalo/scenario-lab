...
- characters 1587-3546: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3602-4703: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4766-28048: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28403-28512: `{{event_history}}` from the run's own event record
