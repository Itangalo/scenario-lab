...
- characters 5429-5869: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7323-9414: `{{previous_actions}}` from the actor's own response from the previous turn
