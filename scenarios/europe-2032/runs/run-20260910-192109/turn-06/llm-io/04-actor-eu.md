...
- characters 1956-4117: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4480-4930: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7450-10087: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Bio-Detection and Medical Stockpile Surge | 6 | small | 4 | 7 | own jurisdiction | resilience up moderately, ai_safety up slightly via misuse learning | 2 | running |
