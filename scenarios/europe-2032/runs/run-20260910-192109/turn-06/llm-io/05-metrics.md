...
- characters 13814-15273: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15316-17477: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17533-18043: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Public Benefit AI Deployment | 2 |
| M8 | EU Bio Emergency Containment and Care Surge | 2 |
...
## Metrics
```json
{"ai_capability": 61.8, "openweight_capability": 59.4, "ai_safety": 23.0, "resilience": 43.5, "eu_ai_sovereignty": 22.0, "eu_political_capital": 14.0, "public_sentiment": 34.0}
```
## Narrative
### Containment
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "RETRENCHMENT"}, "grounds": "turn 5 election won by anti-AI retrenchment ticket, takes office turn 6"}]}
```
```
