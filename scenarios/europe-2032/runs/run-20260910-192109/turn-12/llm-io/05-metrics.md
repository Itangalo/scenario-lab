...
- characters 106-13336: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13379-13570: `{{metrics_json}}` from the run's live metric values
- characters 13663-14788: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14831-16863: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16919-17708: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Essential Services Continuity Sustainment | 2 |
...
PORTFOLIO CHARGE t11: EU Open-Weight Bio-Cyber Containment Patch −2, priority −1 = −3
PROPOSAL BONUS: none — knowledge-work augmentation removes felt displacement crisis, no bonus for spending against unfelt problem despite recent ransomware/bio signals
LEGITIMACY LENDS: capital 21, sentiment 31 -> +2
SOVEREIGNTY: 25.8 last turn, no cat4 finish, no cat4 in flight, export_control_escalation t11 −2, capability rose 0.8 no charge = 23.8
