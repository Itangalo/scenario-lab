...
- characters 376-1501: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1544-3576: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3632-4421: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4484-31220: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31575-32629: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise
- Turn 2 (10 turn(s) ago): knowledge_work_augmented
- Turn 4 (8 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, labour_displacement, taiwan_tension_rise
- Turn 5 (7 turn(s) ago): loss_of_control_incident, adoption_success, election_retrenchment
- Turn 6 (6 turn(s) ago): bio_incident
- Turn 7 (5 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented
- Turn 8 (4 turn(s) ago): ai_investment_collapse, bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented, embodied_ai_deployment, adoption_success, emergent_biosurveillance_mandate_push
- Turn 9 (3 turn(s) ago): loss_of_control_incident, capability_jump, bio_uplift_findings
- Turn 10 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings
- Turn 11 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, export_control_escalation
