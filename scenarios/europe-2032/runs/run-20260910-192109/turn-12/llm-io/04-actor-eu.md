...
- characters 454-1579: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1622-3654: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3722-4201: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7509-9611: `{{previous_actions}}` from the actor's own response from the previous turn
