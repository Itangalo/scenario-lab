...
- characters 377-1794: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1838-3847: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3903-4612: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4675-31411: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31766-32820: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Essential Services Continuity Sustainment −2, priority −1 = −3
PROPOSAL BONUS: none — no event in last three turns, sustainment continues existing work without new shock to answer
LEGITIMACY LENDS: capital 22, sentiment 30 -> +2
SOVEREIGNTY: 23.8 last turn, no capacity event, no cat4 in flight, capability rose 0.7 no charge = 23.8

## Emerging developments (tracked)

- `emergent_rebuild_exploitation_market` -- first noted turn 11, listed in 2 turn(s) so far: Underground market for pre-patched municipal backup images and stolen hospital triage model adapters spreads across EU forums, letting low-skill crews re-enter already-rebuilt councils with fresh model-generated exploits.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise
- Turn 2 (11 turn(s) ago): knowledge_work_augmented
- Turn 4 (9 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, labour_displacement, taiwan_tension_rise
- Turn 5 (8 turn(s) ago): loss_of_control_incident, adoption_success, election_retrenchment
- Turn 6 (7 turn(s) ago): bio_incident
- Turn 7 (6 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented
- Turn 8 (5 turn(s) ago): ai_investment_collapse, bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented, embodied_ai_deployment, adoption_success, emergent_biosurveillance_mandate_push
- Turn 9 (4 turn(s) ago): loss_of_control_incident, capability_jump, bio_uplift_findings
- Turn 10 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings
- Turn 11 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, export_control_escalation
