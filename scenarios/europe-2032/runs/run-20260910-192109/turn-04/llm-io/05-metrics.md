...
- characters 105-13102: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13145-13337: `{{metrics_json}}` from the run's live metric values
- characters 13430-15042: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15085-17339: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17395-18464: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Evaluation and Assurance Capacity | 2 |
| M5 | Synchronous-Area Detection Deployment | 2 |
| M6 | EU Bio-Detection and Medical Stockpile Surge | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Evaluation and Assurance Capacity −2, Synchronous-Area Detection Deployment −2, priority −1 = −11
PROPOSAL BONUS: none — no external event in last three turns; persistent intrusion traces are background conditions, not a priced event this measure answers
LEGITIMACY LENDS: capital 26, sentiment 48 -> +2
