...
- characters 13361-14532: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14575-16884: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16940-17971: `{{notepad}}` from the Game Master's notepad, carried across turns
