...
- characters 2294-4163: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4219-4727: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4790-30673: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31028-31860: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise
- Turn 2 (8 turn(s) ago): knowledge_work_augmented
- Turn 4 (6 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, labour_displacement, taiwan_tension_rise
- Turn 5 (5 turn(s) ago): loss_of_control_incident, adoption_success, election_retrenchment
- Turn 6 (4 turn(s) ago): bio_incident
- Turn 7 (3 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented
- Turn 8 (2 turn(s) ago): ai_investment_collapse, bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented, embodied_ai_deployment, adoption_success, emergent_biosurveillance_mandate_push
- Turn 9 (1 turn(s) ago): loss_of_control_incident, capability_jump, bio_uplift_findings
