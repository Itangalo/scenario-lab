...
- characters 455-2329: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2372-4241: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5275-5754: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8689-11551: `{{previous_actions}}` from the actor's own response from the previous turn
