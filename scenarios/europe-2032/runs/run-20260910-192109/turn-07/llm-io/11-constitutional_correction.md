...
- characters 3490-4042: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 62.6, "openweight_capability": 60.6, "ai_safety": 21.0, "resilience": 46.5, "eu_ai_sovereignty": 27.8, "eu_political_capital": 14.0, "public_sentiment": 32.0}
```
