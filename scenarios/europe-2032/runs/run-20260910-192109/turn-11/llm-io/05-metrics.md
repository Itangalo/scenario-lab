...
- characters 107-13346: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13389-13581: `{{metrics_json}}` from the run's live metric values
- characters 13674-15347: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15391-17457: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17513-18198: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Open-Weight Bio-Cyber Containment Patch | 2 |
