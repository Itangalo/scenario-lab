...
- characters 378-2051: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2095-4161: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4217-4550: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4613-31349: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31704-32606: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise
- Turn 2 (9 turn(s) ago): knowledge_work_augmented
- Turn 4 (7 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, labour_displacement, taiwan_tension_rise
- Turn 5 (6 turn(s) ago): loss_of_control_incident, adoption_success, election_retrenchment
- Turn 6 (5 turn(s) ago): bio_incident
- Turn 7 (4 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented
- Turn 8 (3 turn(s) ago): ai_investment_collapse, bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented, embodied_ai_deployment, adoption_success, emergent_biosurveillance_mandate_push
- Turn 9 (2 turn(s) ago): loss_of_control_incident, capability_jump, bio_uplift_findings
- Turn 10 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings
