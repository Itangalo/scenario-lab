...
- characters 377-1687: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1731-3648: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3704-4772: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4835-29062: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29417-29585: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Evaluation and Assurance Capacity −2, priority −1 = −12
PROPOSAL BONUS: none — productivity gains with no displacement mean no recent negative event bonus applies to Evaluation and Assurance Capacity
...
- `emergent_open_exploit_proliferation` -- first noted turn 1, listed in 2 turn(s) so far: A Kimi K3-derived automated intrusion toolkit targeting municipal utilities circulates openly on underground forums, with copycat use reported outside the main test-shot campaign.
- `emergent_datacentre_permit_freeze` -- first noted turn 1, listed in 2 turn(s) so far: A coordinated activist campaign blocks grid connections for two hyperscale data-centre projects in Spain and Germany, forcing a national-level permitting review that delays EU compute expansion.
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise
- Turn 2 (1 turn(s) ago): knowledge_work_augmented
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.28}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.08}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.06}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.16}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.15}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "A Kimi K3-derived automated intrusion toolkit targeting municipal utilities circulates openly on underground forums, with copycat use reported outside the main test-shot campaign.", "emergent": true, "id": "emergent_open_exploit_proliferation", "probability": 0.22}, {"description": "A coordinated activist campaign blocks grid connections for two hyperscale data-centre projects in Spain and Germany, forcing a national-level permitting review that delays EU compute expansion.", "emergent": true, "id": "emergent_datacentre_permit_freeze", "probability": 0.18}]
```
