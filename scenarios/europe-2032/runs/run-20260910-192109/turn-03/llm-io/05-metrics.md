...
- characters 106-13426: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13469-13661: `{{metrics_json}}` from the run's live metric values
- characters 13754-15064: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15108-17025: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17081-17557: `{{notepad}}` from the Game Master's notepad, carried across turns
