...
- characters 455-2311: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2355-4519: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6328-6808: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9135-11056: `{{previous_actions}}` from the actor's own response from the previous turn
