...
- characters 377-1721: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1765-4032: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4088-4821: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4884-30767: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31122-31865: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise
- Turn 2 (7 turn(s) ago): knowledge_work_augmented
- Turn 4 (5 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, labour_displacement, taiwan_tension_rise
- Turn 5 (4 turn(s) ago): loss_of_control_incident, adoption_success, election_retrenchment
- Turn 6 (3 turn(s) ago): bio_incident
- Turn 7 (2 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented
- Turn 8 (1 turn(s) ago): ai_investment_collapse, bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented, embodied_ai_deployment, adoption_success, emergent_biosurveillance_mandate_push
