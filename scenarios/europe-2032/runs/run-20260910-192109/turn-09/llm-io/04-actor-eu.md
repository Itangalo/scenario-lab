...
- characters 1843-4110: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5676-6126: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9009-10899: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Distributed Defence and Bio-Response Hardening | 6 | small | 8 | 10 | own jurisdiction | resilience up moderately, ai_safety up slightly via misuse learning | 2 | running |
