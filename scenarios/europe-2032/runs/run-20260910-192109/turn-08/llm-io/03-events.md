...
- characters 376-1795: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1838-4895: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4951-5900: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5963-32440: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32795-33332: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise
- Turn 2 (6 turn(s) ago): knowledge_work_augmented
- Turn 4 (4 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, labour_displacement, taiwan_tension_rise
- Turn 5 (3 turn(s) ago): loss_of_control_incident, adoption_success, election_retrenchment
- Turn 6 (2 turn(s) ago): bio_incident
- Turn 7 (1 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented
