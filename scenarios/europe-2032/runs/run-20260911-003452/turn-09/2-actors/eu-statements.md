...
- `two_year_commitment` (commitment): Survive the autonomous frontier by hardening European society and anchoring EU leverage in shared great-power guardrails

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Survive the autonomous frontier by hardening European society and anchoring EU leverage in shared great-power guardrails
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the timeframe for the original statement, necessitating a revision of the commitment.
