...
- characters 377-1235: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1279-3171: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3227-3804: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3867-29567: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29922-30979: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: Northern Sites Shield and Bio-Uplift Watch −2, EU Automated-Attack Containment and Defensive Patch Surge −2, priority −1 = −4 (capital below 20, priority has no effect and no cost, measures only −4)
PROPOSAL BONUS: EU Automated-Attack Containment and Defensive Patch Surge (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly with containment and patching
LEGITIMACY LENDS: capital 14, sentiment 4 -> none (capital higher)
SOVEREIGNTY: 18 last turn, no capacity event, no category 4 in flight, capability rose 0.7 −0 = 18
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, bio_uplift_findings
- Turn 2 (11 turn(s) ago): cyber_major_incident, taiwan_tension_rise, emergent_provenance_mandate
- Turn 3 (10 turn(s) ago): bio_incident, openweight_frontier_release, emergent_kimi_exploit_kit
- Turn 4 (9 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied, member_state_defection
- Turn 5 (8 turn(s) ago): bio_uplift_findings, joint_threat_response, emergent_municipal_soc_pact, election_alliance
- Turn 6 (7 turn(s) ago): member_state_defection
- Turn 7 (6 turn(s) ago): export_control_escalation, eu_frontier_access_denied
- Turn 8 (5 turn(s) ago): cyber_major_incident, emergent_gigafactory_siting_blockade
- Turn 9 (4 turn(s) ago): eu_frontier_access_denied, supply_chain_coercion, emergent_southern_sites_freeze
- Turn 10 (3 turn(s) ago): knowledge_work_augmented, eu_frontier_access_denied
- Turn 11 (2 turn(s) ago): bio_uplift_findings, emergent_anti_ai_infrastructure_sabotage
- Turn 12 (1 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough
