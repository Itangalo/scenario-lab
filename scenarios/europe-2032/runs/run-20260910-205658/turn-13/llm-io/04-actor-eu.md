...
- characters 455-1313: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1357-3249: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4183-4667: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8137-10307: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M13 | EU Automated-Attack Containment and Defensive Patch Surge | 6 | small | 12 | 14 | own jurisdiction | resilience up, ai_safety up slightly via incident learning | 2 | running |
