...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Offline Backup and Clean Rebuild Standard", "category": 6, "size": "small", "finish_turn": 12, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly via incident learning"}, "grounds": "to prevent reinfection and hold core services after second US cutoff"}
  - Grounds: to prevent reinfection and hold core services after second US cutoff
