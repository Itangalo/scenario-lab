...
- characters 1687-3935: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4926-5410: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8358-10826: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Small-Site Clean Recovery Network | 6 | small | 9 | 11 | own jurisdiction | resilience up, public_sentiment up slightly | 2 | running |
