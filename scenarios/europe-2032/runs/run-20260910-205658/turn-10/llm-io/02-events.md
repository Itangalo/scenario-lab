...
- characters 1609-3857: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3913-4498: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4561-29408: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29763-30573: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Major Cyber Incident Containment and Recovery Cell −2, EU Small-Site Clean Recovery Network −2, priority −1 = −5
PROPOSAL BONUS: EU Small-Site Clean Recovery Network (cat 6, small) +2 — ransomware cascade plus small-site outages in last two turns and this answers it directly
LEGITIMACY LENDS: capital 18, sentiment 10 -> none (capital higher)
SOVEREIGNTY: 24 last turn, no category 4 finish, no build in flight +0, eu_frontier_access_denied t9 −2 (largest of three capacity events, supply coercion and southern freeze also qualify), capability rose 0.6 −0 = 22
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, bio_uplift_findings
- Turn 2 (8 turn(s) ago): cyber_major_incident, taiwan_tension_rise, emergent_provenance_mandate
- Turn 3 (7 turn(s) ago): bio_incident, openweight_frontier_release, emergent_kimi_exploit_kit
- Turn 4 (6 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied, member_state_defection
- Turn 5 (5 turn(s) ago): bio_uplift_findings, joint_threat_response, emergent_municipal_soc_pact, election_alliance
- Turn 6 (4 turn(s) ago): member_state_defection
- Turn 7 (3 turn(s) ago): export_control_escalation, eu_frontier_access_denied
- Turn 8 (2 turn(s) ago): cyber_major_incident, emergent_gigafactory_siting_blockade
- Turn 9 (1 turn(s) ago): eu_frontier_access_denied, supply_chain_coercion, emergent_southern_sites_freeze
