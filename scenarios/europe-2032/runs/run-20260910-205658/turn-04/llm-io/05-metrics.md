...
- characters 13327-15209: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15252-17299: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17355-18488: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Supply-Chain Continuity Coalition | 2 |
| M5 | EU Bio-Cyber Containment and Hardening Surge | 3 |
| M6 | EU Essential Services Continuity Stack | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Supply-Chain Continuity Coalition −2, EU Bio-Cyber Containment and Hardening Surge −3, priority −1 = −12
PROPOSAL BONUS: EU Bio-Cyber Containment and Hardening Surge (cat 6, large) +6 — bio_incident landed this turn and this answers it directly, plus exploit-kit circulation
...
- `emergent_municipal_soc_pact` -- first noted turn 4, listed in 1 turn(s) so far: Small municipalities and hospital groups unable to obtain EU cyber teams pool incident logs and procurement in a cross-border mutual-aid pact, creating a de facto shared SOC outside Brussels control.
- `emergent_municipal_backlash_siting` -- first noted turn 4, listed in 1 turn(s) so far: Small municipalities and hospital groups that queued for EU cyber help publicly blame Brussels for uneven rollout, triggering coordinated local-government resistance to hosting new AI infrastructure.
