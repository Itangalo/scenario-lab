...
- characters 377-1843: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1887-4000: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4056-4889: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4952-29799: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30154-30857: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Cutoff Emergency Continuity Operation −2, EU Major Cyber Incident Containment and Recovery Cell −2, priority −1 = −5
PROPOSAL BONUS: EU Major Cyber Incident Containment and Recovery Cell (cat 6, small) +3 — cyber_major_incident landed this turn on cutoff-weakened services and this answers it directly
LEGITIMACY LENDS: capital 18, sentiment 10 -> none (capital higher)
SOVEREIGNTY: 26 last turn, no category 4 finish, emergent_gigafactory_siting_blockade t8 −2, capability rose 0.7 −0 = 24

## Emerging developments (tracked)

- `emergent_southern_sites_freeze` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated physical protests and planning lawsuits stall the two southern gigafactory sites indefinitely, forcing Brussels to renegotiate grid and water permits under national court supervision.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, bio_uplift_findings
- Turn 2 (7 turn(s) ago): cyber_major_incident, taiwan_tension_rise, emergent_provenance_mandate
- Turn 3 (6 turn(s) ago): bio_incident, openweight_frontier_release, emergent_kimi_exploit_kit
- Turn 4 (5 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied, member_state_defection
- Turn 5 (4 turn(s) ago): bio_uplift_findings, joint_threat_response, emergent_municipal_soc_pact, election_alliance
- Turn 6 (3 turn(s) ago): member_state_defection
- Turn 7 (2 turn(s) ago): export_control_escalation, eu_frontier_access_denied
- Turn 8 (1 turn(s) ago): cyber_major_incident, emergent_gigafactory_siting_blockade
