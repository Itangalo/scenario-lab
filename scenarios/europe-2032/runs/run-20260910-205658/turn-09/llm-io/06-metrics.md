...
- characters 13597-15063: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15107-17220: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17276-17790: `{{notepad}}` from the Game Master's notepad, carried across turns
