...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Small-Site Clean Recovery Network", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, public_sentiment up slightly"}, "grounds": "to restore dark small clinics and municipalities after cutoff plus ransomware cascade"}
  - Grounds: to restore dark small clinics and municipalities after cutoff plus ransomware cascade
