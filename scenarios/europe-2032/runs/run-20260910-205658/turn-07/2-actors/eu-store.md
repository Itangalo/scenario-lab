...
- **applied** `M8` — {"op": "add", "table": "measures", "fields": {"name": "EU Cutoff Emergency Continuity Operation", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_political_capital down slightly if fails"}, "grounds": "to absorb immediate frontier cutoff impact on essential services"}
  - Grounds: to absorb immediate frontier cutoff impact on essential services
