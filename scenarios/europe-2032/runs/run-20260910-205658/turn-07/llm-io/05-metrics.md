...
- characters 13439-13631: `{{metrics_json}}` from the run's live metric values
- characters 13724-16739: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16783-18722: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18778-19924: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.8, "openweight_capability": 59.3, "ai_safety": 22.0, "resilience": 44.0, "eu_ai_sovereignty": 32.0, "eu_political_capital": 16.0, "public_sentiment": 14.0}
```
## Narrative
### Cut off
