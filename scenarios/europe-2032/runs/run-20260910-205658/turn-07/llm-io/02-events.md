...
- characters 377-3392: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3436-5375: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5431-6000: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6063-30307: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30662-31201: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): cyber_major_incident, taiwan_tension_rise, emergent_provenance_mandate
- Turn 3 (4 turn(s) ago): bio_incident, openweight_frontier_release, emergent_kimi_exploit_kit
- Turn 4 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied, member_state_defection
- Turn 5 (2 turn(s) ago): bio_uplift_findings, joint_threat_response, emergent_municipal_soc_pact, election_alliance
- Turn 6 (1 turn(s) ago): member_state_defection
