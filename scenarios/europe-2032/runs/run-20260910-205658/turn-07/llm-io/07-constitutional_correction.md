...
- characters 2860-3429: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.8, "openweight_capability": 59.3, "ai_safety": 22.0, "resilience": 44.0, "eu_ai_sovereignty": 26.0, "eu_political_capital": 16.0, "public_sentiment": 14.0}
```
