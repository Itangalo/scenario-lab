...
- characters 105-13329: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13372-13564: `{{metrics_json}}` from the run's live metric values
- characters 13657-16036: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16079-18507: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18563-18963: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Common Access and No-Side-Deal Compact | 2 |
