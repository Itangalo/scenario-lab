...
- characters 376-2755: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2798-5226: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5282-6009: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6072-27206: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27561-28051: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Essential Services Continuity Stack −2, priority −1 = −8 + 1 more for the priority = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 19, sentiment 20 -> +1
SOVEREIGNTY: 20 last turn, no capacity event, EU Essential Services Continuity Stack in flight +1, capability rose 1.5 −0 = 21

## Emerging developments (tracked)

- `emergent_municipal_backlash_siting` -- first noted turn 4, listed in 2 turn(s) so far: Small municipalities and hospital groups that queued for EU cyber help publicly blame Brussels for uneven rollout, triggering coordinated local-government resistance to hosting new AI infrastructure.
...
- Turn 2 (4 turn(s) ago): cyber_major_incident, taiwan_tension_rise, emergent_provenance_mandate
- Turn 3 (3 turn(s) ago): bio_incident, openweight_frontier_release, emergent_kimi_exploit_kit
- Turn 4 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied, member_state_defection
- Turn 5 (1 turn(s) ago): bio_uplift_findings, joint_threat_response, emergent_municipal_soc_pact, election_alliance
