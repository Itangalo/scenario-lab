...
- characters 454-2833: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2876-5304: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5684-6185: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8476-10322: `{{previous_actions}}` from the actor's own response from the previous turn
