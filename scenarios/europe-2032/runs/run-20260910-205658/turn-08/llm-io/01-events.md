...
- characters 1503-4702: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4758-5902: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5965-30209: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30564-31182: `{{event_history}}` from the run's own event record
...
- `emergent_southern_sites_freeze` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated physical protests and planning lawsuits stall the two southern gigafactory sites indefinitely, forcing Brussels to renegotiate grid and water permits under national court supervision.
- `emergent_gigafactory_siting_blockade` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated physical protests and court injunctions halt construction at a southern EU gigafactory site over power and water use, delaying grid connection by months.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, bio_uplift_findings
- Turn 2 (6 turn(s) ago): cyber_major_incident, taiwan_tension_rise, emergent_provenance_mandate
- Turn 3 (5 turn(s) ago): bio_incident, openweight_frontier_release, emergent_kimi_exploit_kit
- Turn 4 (4 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied, member_state_defection
- Turn 5 (3 turn(s) ago): bio_uplift_findings, joint_threat_response, emergent_municipal_soc_pact, election_alliance
- Turn 6 (2 turn(s) ago): member_state_defection
