...
- characters 1581-4780: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5555-6088: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8709-10470: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Cutoff Emergency Continuity Operation | 6 | small | 7 | 9 | own jurisdiction | resilience up, eu_political_capital down slightly if fails | 2 | running |
