...
- characters 13482-13674: `{{metrics_json}}` from the run's live metric values
- characters 13767-15743: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15787-17936: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17992-19038: `{{notepad}}` from the Game Master's notepad, carried across turns
