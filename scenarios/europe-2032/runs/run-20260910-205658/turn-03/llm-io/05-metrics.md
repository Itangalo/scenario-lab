...
- characters 13678-15431: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15475-17538: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17594-18071: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Hardening and Response Pact −3, EU Supply-Chain Continuity Coalition −2, priority −1 = −12
PROPOSAL BONUS: EU Supply-Chain Continuity Coalition (cat 8, small) +2 — taiwan_tension_rise opened this turn and this answers it directly
