...
- characters 376-1521: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1564-4079: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4135-5023: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5086-29933: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30288-31268: `{{event_history}}` from the run's own event record
...
- `emergent_permit_precedent_contagion` -- first noted turn 10, listed in 2 turn(s) so far: Regional courts handling southern gigafactory permits issue a coordinated ruling framework that becomes a template for anti-data-centre litigation across other member states, freezing additional sites.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, bio_uplift_findings
- Turn 2 (10 turn(s) ago): cyber_major_incident, taiwan_tension_rise, emergent_provenance_mandate
- Turn 3 (9 turn(s) ago): bio_incident, openweight_frontier_release, emergent_kimi_exploit_kit
- Turn 4 (8 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied, member_state_defection
- Turn 5 (7 turn(s) ago): bio_uplift_findings, joint_threat_response, emergent_municipal_soc_pact, election_alliance
- Turn 6 (6 turn(s) ago): member_state_defection
- Turn 7 (5 turn(s) ago): export_control_escalation, eu_frontier_access_denied
- Turn 8 (4 turn(s) ago): cyber_major_incident, emergent_gigafactory_siting_blockade
- Turn 9 (3 turn(s) ago): eu_frontier_access_denied, supply_chain_coercion, emergent_southern_sites_freeze
- Turn 10 (2 turn(s) ago): knowledge_work_augmented, eu_frontier_access_denied
- Turn 11 (1 turn(s) ago): bio_uplift_findings, emergent_anti_ai_infrastructure_sabotage
