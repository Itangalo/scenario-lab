...
- characters 13616-14761: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14804-17319: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17375-17932: `{{notepad}}` from the Game Master's notepad, carried across turns
