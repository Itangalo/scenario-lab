...
- characters 376-1736: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1779-3987: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4043-5093: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5156-28438: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28793-28855: `{{event_history}}` from the run's own event record
