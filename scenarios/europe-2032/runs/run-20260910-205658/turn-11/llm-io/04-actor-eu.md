...
- characters 455-1599: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1643-4037: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4877-5361: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8481-10613: `{{previous_actions}}` from the actor's own response from the previous turn
...
**emergent_anti_ai_infrastructure_sabotage (emergent event):** Coordinated physical sabotage and mass protests disable grid connections and construction logistics at northern EU compute sites, spreading the southern blockade pattern north as public hostility peaks.
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Offline Backup and Clean Rebuild Standard | 6 | small | 10 | 12 | own jurisdiction | resilience up, ai_safety up slightly via incident learning | 2 | running |
