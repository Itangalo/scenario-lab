...
- characters 377-1521: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1565-3959: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4015-5144: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5207-30054: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30409-31299: `{{event_history}}` from the run's own event record
...
- `emergent_permit_precedent_contagion` -- first noted turn 10, listed in 1 turn(s) so far: Regional courts handling southern gigafactory permits issue a coordinated ruling framework that becomes a template for anti-data-centre litigation across other member states, freezing additional sites.
- `emergent_anti_ai_infrastructure_sabotage` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated physical sabotage and mass protests disable grid connections and construction logistics at northern EU compute sites, spreading the southern blockade pattern north as public hostility peaks.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, bio_uplift_findings
- Turn 2 (9 turn(s) ago): cyber_major_incident, taiwan_tension_rise, emergent_provenance_mandate
- Turn 3 (8 turn(s) ago): bio_incident, openweight_frontier_release, emergent_kimi_exploit_kit
- Turn 4 (7 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied, member_state_defection
- Turn 5 (6 turn(s) ago): bio_uplift_findings, joint_threat_response, emergent_municipal_soc_pact, election_alliance
- Turn 6 (5 turn(s) ago): member_state_defection
- Turn 7 (4 turn(s) ago): export_control_escalation, eu_frontier_access_denied
- Turn 8 (3 turn(s) ago): cyber_major_incident, emergent_gigafactory_siting_blockade
- Turn 9 (2 turn(s) ago): eu_frontier_access_denied, supply_chain_coercion, emergent_southern_sites_freeze
- Turn 10 (1 turn(s) ago): knowledge_work_augmented, eu_frontier_access_denied
