...
- `two_year_commitment` (commitment): Restore trusted public capacity by containing bio-enabled harm and delivering visible public benefit

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Restore trusted public capacity by containing bio-enabled harm and delivering visible public benefit
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the timeframe for the original statement, changing the actor's obligation and enabling a strategic shift.
