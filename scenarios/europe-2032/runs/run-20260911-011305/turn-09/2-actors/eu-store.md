...
| M7 | EU Municipal Continuity Shield | 6 | small | 8 | 10 | own jurisdiction | resilience up, eu_political_capital up modestly via visible restoration | 2 | running |
| M8 | EU Bio-Containment and Trusted Care Shield | 6 | small | 9 | 11 | own jurisdiction | resilience up, eu_political_capital up modestly via containment and visible benefit | 2 | running |
...
- **applied** `M8` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio-Containment and Trusted Care Shield", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_political_capital up modestly via containment and visible benefit"}, "grounds": "bio incident plus adoption success demands containment tied to trust"}
  - Grounds: bio incident plus adoption success demands containment tied to trust
