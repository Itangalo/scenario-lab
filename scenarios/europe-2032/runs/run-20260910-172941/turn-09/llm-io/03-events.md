...
- characters 375-1901: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1945-4177: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4233-5023: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5086-31518: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31873-32493: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Grid-anchored Sovereign Inference Pool −2, EU Cyber-Continuity and Patch Surge −2, priority M8 −1 = −5
PROPOSAL BONUS: EU Cyber-Continuity and Patch Surge (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly with breakthrough tooling
LEGITIMACY LENDS: capital 5, sentiment 21 -> +2
SOVEREIGNTY: 17 last turn, no cat4 finish, M8 in flight +1, supply_chain_coercion t8 −2, capability rose 6.0 −1 = 15

## Emerging developments (tracked)

- `emergent_open_biosurveillance_backfire` -- first noted turn 7, listed in 2 turn(s) so far: Municipal wastewater and hospital triage data from the recent containment are pooled into an EU-wide open biosurveillance feed, which independent researchers then mine to reconstruct pathogen mutations.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough
- Turn 2 (7 turn(s) ago): bio_uplift_findings, automated_decision_scandal
- Turn 3 (6 turn(s) ago): eval_anomaly_reports, export_control_escalation, adoption_success
- Turn 4 (5 turn(s) ago): eval_anomaly_reports, member_state_defection
- Turn 5 (4 turn(s) ago): capability_jump, election_alliance
- Turn 6 (3 turn(s) ago): bio_incident, capability_jump, automated_decision_scandal
- Turn 7 (2 turn(s) ago): rsi_onset
- Turn 8 (1 turn(s) ago): cyber_major_incident, capability_jump, cyber_defence_breakthrough, opaque_reasoning, supply_chain_coercion
