...
- characters 13092-13282: `{{metrics_json}}` from the run's live metric values
- characters 13375-14901: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14945-17177: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17233-17689: `{{notepad}}` from the Game Master's notepad, carried across turns
