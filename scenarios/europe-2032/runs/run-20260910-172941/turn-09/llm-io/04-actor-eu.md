...
- characters 453-1979: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2023-4255: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6106-6609: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9553-12133: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M9 | EU Cyber-Continuity and Patch Surge | 6 | small | 8 | 10 | own jurisdiction | resilience up, ai_safety down less via incident learning | 2 | running |
