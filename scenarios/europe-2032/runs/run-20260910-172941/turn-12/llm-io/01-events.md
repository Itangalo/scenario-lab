...
- characters 374-2059: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2102-3967: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4023-4406: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4469-30183: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30538-31523: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M10 EU Automation Displacement Bridge −2, priority M10 −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 6 -> +1 (capped, sentiment above capital, net after charges and event losses)
SOVEREIGNTY: 16 last turn, no finish, no in-flight cat4 bonus +0, embodied_ai_deployment t11 −2, capability rose 2.0 −1 = 13
...
- Turn 2 (10 turn(s) ago): bio_uplift_findings, automated_decision_scandal
- Turn 3 (9 turn(s) ago): eval_anomaly_reports, export_control_escalation, adoption_success
- Turn 4 (8 turn(s) ago): eval_anomaly_reports, member_state_defection
- Turn 5 (7 turn(s) ago): capability_jump, election_alliance
- Turn 6 (6 turn(s) ago): bio_incident, capability_jump, automated_decision_scandal
- Turn 7 (5 turn(s) ago): rsi_onset
- Turn 8 (4 turn(s) ago): cyber_major_incident, capability_jump, cyber_defence_breakthrough, opaque_reasoning, supply_chain_coercion
- Turn 9 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, embodied_ai_deployment
- Turn 10 (2 turn(s) ago): taiwan_blockade, bio_uplift_findings, eval_anomaly_reports, medical_breakthrough, adoption_success
- Turn 11 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, embodied_ai_deployment, taiwan_tension_rise, emergent_anti_robot_sabotage
