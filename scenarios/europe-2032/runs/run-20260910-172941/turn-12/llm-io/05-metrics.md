...
- characters 13624-15309: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15352-17217: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17273-17656: `{{notepad}}` from the Game Master's notepad, carried across turns
