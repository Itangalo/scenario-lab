...
- characters 377-1809: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1853-4733: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4789-5861: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5924-28553: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28908-29051: `{{event_history}}` from the run's own event record
...
- Turn 2 (1 turn(s) ago): bio_uplift_findings, automated_decision_scandal
