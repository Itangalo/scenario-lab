...
- characters 106-13467: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13510-13702: `{{metrics_json}}` from the run's live metric values
- characters 13795-15227: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15271-18151: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18207-18687: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Eval Anomaly Response Cell | 2 |
