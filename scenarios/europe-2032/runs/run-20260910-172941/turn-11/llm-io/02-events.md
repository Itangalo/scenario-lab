...
- characters 376-2040: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2084-4121: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4177-4898: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4961-30675: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31030-31869: `{{event_history}}` from the run's own event record
...
- `emergent_anti_robot_sabotage` -- first noted turn 10, listed in 1 turn(s) so far: Anti-robot sabotage spreads from protests to coordinated arson of deployed humanoid fleets and gigafactory construction sites in two or more member states, forcing operators to pause rollouts.
...
- Turn 2 (9 turn(s) ago): bio_uplift_findings, automated_decision_scandal
- Turn 3 (8 turn(s) ago): eval_anomaly_reports, export_control_escalation, adoption_success
- Turn 4 (7 turn(s) ago): eval_anomaly_reports, member_state_defection
- Turn 5 (6 turn(s) ago): capability_jump, election_alliance
- Turn 6 (5 turn(s) ago): bio_incident, capability_jump, automated_decision_scandal
- Turn 7 (4 turn(s) ago): rsi_onset
- Turn 8 (3 turn(s) ago): cyber_major_incident, capability_jump, cyber_defence_breakthrough, opaque_reasoning, supply_chain_coercion
- Turn 9 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, embodied_ai_deployment
- Turn 10 (1 turn(s) ago): taiwan_blockade, bio_uplift_findings, eval_anomaly_reports, medical_breakthrough, adoption_success
