...
- characters 107-12948: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12991-13181: `{{metrics_json}}` from the run's live metric values
- characters 13274-14938: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14982-17019: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17075-17481: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Automation Displacement Bridge | 2 |
