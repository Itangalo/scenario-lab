...
- characters 13419-13610: `{{metrics_json}}` from the run's live metric values
- characters 13703-14921: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14965-17386: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17442-18309: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Bio-Containment and Entitlement Audit Surge | 2 |
| M8 | EU Grid-anchored Sovereign Inference Pool | 2 |
