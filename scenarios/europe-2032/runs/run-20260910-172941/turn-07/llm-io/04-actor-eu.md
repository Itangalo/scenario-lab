...
- characters 454-1672: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1716-4137: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4615-5127: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7702-10335: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | EU Bio-Containment and Entitlement Audit Surge | 6 | small | 6 | 8 | own jurisdiction | resilience up, ai_safety up slightly via misuse learning, eu_political_capital down less via visible response | 2 | running |
