...
- characters 1638-4059: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4115-4648: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4711-31370: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31725-32176: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): bio_uplift_findings, automated_decision_scandal
- Turn 3 (4 turn(s) ago): eval_anomaly_reports, export_control_escalation, adoption_success
- Turn 4 (3 turn(s) ago): eval_anomaly_reports, member_state_defection
- Turn 5 (2 turn(s) ago): capability_jump, election_alliance
- Turn 6 (1 turn(s) ago): bio_incident, capability_jump, automated_decision_scandal
