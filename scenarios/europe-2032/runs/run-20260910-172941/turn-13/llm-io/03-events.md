...
- characters 374-2162: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2206-4330: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4386-4824: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4887-29434: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29789-30951: `{{event_history}}` from the run's own event record
...
- Turn 2 (11 turn(s) ago): bio_uplift_findings, automated_decision_scandal
- Turn 3 (10 turn(s) ago): eval_anomaly_reports, export_control_escalation, adoption_success
- Turn 4 (9 turn(s) ago): eval_anomaly_reports, member_state_defection
- Turn 5 (8 turn(s) ago): capability_jump, election_alliance
- Turn 6 (7 turn(s) ago): bio_incident, capability_jump, automated_decision_scandal
- Turn 7 (6 turn(s) ago): rsi_onset
- Turn 8 (5 turn(s) ago): cyber_major_incident, capability_jump, cyber_defence_breakthrough, opaque_reasoning, supply_chain_coercion
- Turn 9 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, embodied_ai_deployment
- Turn 10 (3 turn(s) ago): taiwan_blockade, bio_uplift_findings, eval_anomaly_reports, medical_breakthrough, adoption_success
- Turn 11 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, embodied_ai_deployment, taiwan_tension_rise, emergent_anti_robot_sabotage
- Turn 12 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, cyber_defence_breakthrough, catastrophic_loss_of_control_incident, catastrophic_great_power_conflict
