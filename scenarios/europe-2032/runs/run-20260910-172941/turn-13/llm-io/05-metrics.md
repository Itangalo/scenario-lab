...
- characters 107-12863: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12906-13094: `{{metrics_json}}` from the run's live metric values
- characters 13187-14975: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15019-17143: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17199-17637: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 94.0, "openweight_capability": 89.0, "ai_safety": 1.0, "resilience": 42.0, "eu_ai_sovereignty": 9.0, "eu_political_capital": 4.0, "public_sentiment": 2.0}
```
...
## Notepad
PORTFOLIO CHARGE t13: (none in flight) = -0 + priority none = -0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 4, sentiment 2 -> none (capital above sentiment)
SOVEREIGNTY: 9 last turn, no capacity event, no cat4 in flight +0, capability rose 1.5 (<2) -0 = 9
