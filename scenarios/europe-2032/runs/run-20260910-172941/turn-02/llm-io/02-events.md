...
- characters 376-1386: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1429-3203: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3259-4514: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4577-26707: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27062-27131: `{{event_history}}` from the run's own event record
