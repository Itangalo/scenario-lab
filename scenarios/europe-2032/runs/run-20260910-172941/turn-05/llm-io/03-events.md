...
- characters 377-1308: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1352-3222: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3278-4341: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4404-30274: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30629-30935: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Biological Resilience Shield −3, EU Cohesion and Non-US Inputs Compact −2, priority M4 −1 = −12
PROPOSAL BONUS: EU Cohesion and Non-US Inputs Compact (cat 8, small) +2 — member-state defection and US licence rationing landed this turn/last turn and this answers it directly
LEGITIMACY LENDS: capital 9, sentiment 37 -> +2
SOVEREIGNTY: 18 last turn, no finish, no in-flight bonus, member_state_defection t4 −2, capability rose 3.0 −1 = 15

## Emerging developments (tracked)

- `emergent_alternative_compute_offer` -- first noted turn 4, listed in 1 turn(s) so far: A non-US accelerator supplier offers the EU volume delivery on non-rationed terms, but tied to long-term servicing and alignment on re-export controls.
- `emergent_non_us_compute_offer` -- first noted turn 4, listed in 1 turn(s) so far: A non-US compute provider offers the EU pooled sovereign inference capacity on non-American accelerators, easing Gigafactory lead-time pressure but forcing a quick alignment choice.
...
- Turn 2 (3 turn(s) ago): bio_uplift_findings, automated_decision_scandal
- Turn 3 (2 turn(s) ago): eval_anomaly_reports, export_control_escalation, adoption_success
- Turn 4 (1 turn(s) ago): eval_anomaly_reports, member_state_defection
