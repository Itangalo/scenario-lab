...
- characters 13739-14670: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14714-16584: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16640-17703: `{{notepad}}` from the Game Master's notepad, carried across turns
