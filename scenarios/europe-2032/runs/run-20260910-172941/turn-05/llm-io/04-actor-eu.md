...
- characters 1430-3300: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4483-4942: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7293-9532: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Cohesion and Non-US Inputs Compact | 8 | small | 4 | 6 | own jurisdiction and middle-power coalition | eu_ai_sovereignty up slightly, eu_political_capital up slightly via cohesion | 2 | running |
