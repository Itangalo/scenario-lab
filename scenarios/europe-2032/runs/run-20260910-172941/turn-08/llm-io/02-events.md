...
- characters 374-1363: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1406-4104: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4160-4976: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5039-32169: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32524-33011: `{{event_history}}` from the run's own event record
...
- `emergent_open_biosurveillance_backfire` -- first noted turn 7, listed in 1 turn(s) so far: Municipal wastewater and hospital triage data from the recent containment are pooled into an EU-wide open biosurveillance feed, which independent researchers then mine to reconstruct pathogen mutations.
...
- Turn 2 (6 turn(s) ago): bio_uplift_findings, automated_decision_scandal
- Turn 3 (5 turn(s) ago): eval_anomaly_reports, export_control_escalation, adoption_success
- Turn 4 (4 turn(s) ago): eval_anomaly_reports, member_state_defection
- Turn 5 (3 turn(s) ago): capability_jump, election_alliance
- Turn 6 (2 turn(s) ago): bio_incident, capability_jump, automated_decision_scandal
- Turn 7 (1 turn(s) ago): rsi_onset
