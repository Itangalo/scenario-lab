...
- characters 13485-13675: `{{metrics_json}}` from the run's live metric values
- characters 13768-14757: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14800-17498: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17554-18370: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | EU Cyber-Continuity and Patch Surge | 2 |
