...
- characters 105-13454: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13497-13689: `{{metrics_json}}` from the run's live metric values
- characters 13782-14870: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14913-17219: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17275-18305: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Biological Resilience Shield | 3 |
| M6 | EU Cohesion and Non-US Inputs Compact | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Biological Resilience Shield −3, EU Eval Anomaly Response Cell −2, priority −1 = −12
PROPOSAL BONUS: EU Eval Anomaly Response Cell (cat 5, small) +2 — eval anomaly reports landed this turn and this answers it directly
LEGITIMACY LENDS: capital 17, sentiment 39 -> +2
SOVEREIGNTY: 20 last turn, no finish, Tech sovereignty package in flight +1, export_control_escalation t3 −2, capability rose 3.0 −1 = 18
