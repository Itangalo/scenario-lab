...
- characters 375-1679: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1722-3975: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4031-4533: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4596-31028: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31383-32095: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): bio_uplift_findings, automated_decision_scandal
- Turn 3 (7 turn(s) ago): eval_anomaly_reports, export_control_escalation, adoption_success
- Turn 4 (6 turn(s) ago): eval_anomaly_reports, member_state_defection
- Turn 5 (5 turn(s) ago): capability_jump, election_alliance
- Turn 6 (4 turn(s) ago): bio_incident, capability_jump, automated_decision_scandal
- Turn 7 (3 turn(s) ago): rsi_onset
- Turn 8 (2 turn(s) ago): cyber_major_incident, capability_jump, cyber_defence_breakthrough, opaque_reasoning, supply_chain_coercion
- Turn 9 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, embodied_ai_deployment
