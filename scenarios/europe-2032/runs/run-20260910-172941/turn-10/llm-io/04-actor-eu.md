...
- characters 453-1757: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1800-4053: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6184-6645: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9806-12182: `{{previous_actions}}` from the actor's own response from the previous turn
