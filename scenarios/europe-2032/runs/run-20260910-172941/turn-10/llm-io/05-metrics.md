...
- characters 106-13538: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13581-13771: `{{metrics_json}}` from the run's live metric values
- characters 13864-15168: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15211-17464: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17520-18337: `{{notepad}}` from the Game Master's notepad, carried across turns
