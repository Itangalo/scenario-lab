...
- characters 453-1284: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1327-3531: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4495-4939: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7292-9076: `{{previous_actions}}` from the actor's own response from the previous turn
