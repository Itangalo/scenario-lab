...
- characters 375-1206: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1249-3453: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3509-4403: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4466-30770: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31125-31492: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Cohesion and Non-US Inputs Compact −2, priority M6 −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 6, sentiment 36 -> +2
SOVEREIGNTY: 15 last turn, no capacity event, no finish, no in-flight bonus, capability rose 6.0 −1 = 14

## Emerging developments (tracked)

- `emergent_alternative_compute_offer` -- first noted turn 4, listed in 2 turn(s) so far: A non-US accelerator supplier offers the EU volume delivery on non-rationed terms, but tied to long-term servicing and alignment on re-export controls.
- `emergent_non_us_compute_offer` -- first noted turn 4, listed in 2 turn(s) so far: A non-US compute provider offers the EU pooled sovereign inference capacity on non-American accelerators, easing Gigafactory lead-time pressure but forcing a quick alignment choice.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough
- Turn 2 (4 turn(s) ago): bio_uplift_findings, automated_decision_scandal
- Turn 3 (3 turn(s) ago): eval_anomaly_reports, export_control_escalation, adoption_success
- Turn 4 (2 turn(s) ago): eval_anomaly_reports, member_state_defection
- Turn 5 (1 turn(s) ago): capability_jump, election_alliance
