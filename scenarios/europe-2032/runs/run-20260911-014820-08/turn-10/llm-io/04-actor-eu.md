...
- characters 454-1430: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1473-4219: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8033-8476: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11389-13729: `{{previous_actions}}` from the actor's own response from the previous turn
