...
- characters 376-1352: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1395-4141: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4197-4702: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4765-34393: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34748-35441: `{{event_history}}` from the run's own event record
...
- Turn 3 (7 turn(s) ago): capability_jump, bio_uplift_findings, labour_displacement
- Turn 4 (6 turn(s) ago): eval_anomaly_reports, medical_breakthrough, adoption_success
- Turn 5 (5 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment, taiwan_blockade, election_retrenchment
- Turn 6 (4 turn(s) ago): eval_anomaly_reports
- Turn 7 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, research_breakthrough, knowledge_work_augmented, automated_decision_scandal
- Turn 8 (2 turn(s) ago): medical_breakthrough
- Turn 9 (1 turn(s) ago): cyber_major_incident, rsi_onset, labour_displacement
