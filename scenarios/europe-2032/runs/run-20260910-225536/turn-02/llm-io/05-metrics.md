...
- characters 105-13161: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13204-13396: `{{metrics_json}}` from the run's live metric values
- characters 13489-14702: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14745-16940: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16996-18055: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 50.0, "ai_safety": 37.0, "resilience": 37.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 25.0, "public_sentiment": 42.0}
```
