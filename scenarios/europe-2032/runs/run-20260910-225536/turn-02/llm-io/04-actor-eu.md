...
- characters 4321-4761: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6215-8306: `{{previous_actions}}` from the actor's own response from the previous turn
