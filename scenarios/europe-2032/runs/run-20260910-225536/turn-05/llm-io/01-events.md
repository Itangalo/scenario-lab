...
- characters 1541-3325: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3381-3830: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3893-32378: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32733-32945: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Grid Cyber-Hardening and Segmentation Directive −2, EU Common Terms for External AI Capacity Deals −2, priority −1 = −13
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 29 -> +2
...
- Turn 3 (2 turn(s) ago): member_state_defection, emergent_gulf_compute_offer
