...
- characters 1619-3403: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6307-6747: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8861-10241: `{{previous_actions}}` from the actor's own response from the previous turn
