...
- `two_year_commitment` (commitment): Secure resilient essential services and trustworthy diffusion on EU-anchored capacity

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure resilient essential services and trustworthy diffusion on EU-anchored capacity
