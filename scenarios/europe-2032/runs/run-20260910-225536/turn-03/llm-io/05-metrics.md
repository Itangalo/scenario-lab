...
- characters 106-13222: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13265-13457: `{{metrics_json}}` from the run's live metric values
- characters 13550-14916: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14960-16748: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16804-17673: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Grid Cyber-Hardening and Segmentation Directive | 2 |
| M5 | EU Common Terms for External AI Capacity Deals | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Grid Cyber-Hardening and Segmentation Directive −2, priority −1 = −12
PROPOSAL BONUS: none — new grid directive (cat 6, small) gestures at autumn intrusion narrative but no qualifying negative event in last three turns; safety_breakthrough is positive
LEGITIMACY LENDS: capital 23, sentiment 42 -> +2
SOVEREIGNTY: 21 last turn, no capacity event, Gigafactories in flight +0, capability rose 2.0 −1 = 20

## Emerging developments (tracked)

- `emergent_ics_toolkit_proliferation` -- first noted turn 2, listed in 2 turn(s) so far: Forensic write-ups of the autumn grid intrusions circulate and a repackaged ICS-probing toolkit derived from a frontier-class open model spreads on underground forums, lowering the bar for copycat grid reconnaissance.
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 53.0, "ai_safety": 35.0, "resilience": 36.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 10.0, "public_sentiment": 36.0}
```
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Grid Cyber-Hardening and Segmentation Directive −2, EU Common Terms for External AI Capacity Deals −2, priority −1 = −14
PROPOSAL BONUS: EU Common Terms (cat 8, small) +3 — member_state_defection this turn and Gulf offer together directly answered by common terms
LEGITIMACY LENDS: capital 8, sentiment 36 -> +2
SOVEREIGNTY: 20 last turn, no finishing cat4, in flight +0, member_state_defection t3 −2, capability rose 2.0 −1 = 17
