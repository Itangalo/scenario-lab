...
- characters 1791-3778: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3834-4730: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4793-29697: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30052-30217: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): safety_breakthrough
- Turn 3 (1 turn(s) ago): member_state_defection, emergent_gulf_compute_offer
