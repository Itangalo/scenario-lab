...
- characters 105-13221: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13264-13456: `{{metrics_json}}` from the run's live metric values
- characters 13549-14921: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14964-16951: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17007-17558: `{{notepad}}` from the Game Master's notepad, carried across turns
