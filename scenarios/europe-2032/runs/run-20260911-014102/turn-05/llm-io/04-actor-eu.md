...
- characters 2300-4910: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7023-7463: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9688-11603: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Continuity Stack for Cut-Off Services | 9 | small | 4 | 6 | own jurisdiction | resilience up, eu_ai_sovereignty up modestly, public_sentiment up modestly | 2 | running |
