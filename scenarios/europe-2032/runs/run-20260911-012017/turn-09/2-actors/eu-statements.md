...
- `two_year_commitment` (commitment): Rebuild agency through defended deployment and pooled leverage under opaque frontier conditions

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild agency through defended deployment and pooled leverage under opaque frontier conditions
