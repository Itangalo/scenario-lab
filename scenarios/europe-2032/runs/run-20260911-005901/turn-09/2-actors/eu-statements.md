...
- `two_year_commitment` (commitment): Rebuild trusted resilience and shared safety leverage so Europe endures shocks without losing agency

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild trusted resilience and shared safety leverage so Europe endures shocks without losing agency
