...
| M9 | EU Essential Services Restoration Surge | 6 | small | 7 | 8 | own jurisdiction | resilience up to absorb incident, eu_political_capital protected from service failure | 2 | finished |
| M10 | EU Screened Synthesis Enforcement and Bio-Detection Surge | 3 | small | 8 | 9 | own jurisdiction | resilience up, ai_safety up slightly via reduced bio misuse | 2 | finished |
| M11 | EU Joint Cyber-Bio Threat Response Accession | 8 | small | 9 | 11 | coalition partners in joint command/pact plus own jurisdiction | resilience up, ai_safety up slightly via shared telemetry and verification | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Joint Cyber-Bio Threat Response Accession", "category": 8, "size": "small", "finish_turn": 11, "applies_to": "coalition partners in joint command/pact plus own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly via shared telemetry and verification"}, "grounds": "to lock in pooled protection and safety leverage after ca
  - Grounds: to lock in pooled protection and safety leverage after capability jump
