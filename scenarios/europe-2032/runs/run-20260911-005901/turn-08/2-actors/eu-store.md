...
| M10 | EU Screened Synthesis Enforcement and Bio-Detection Surge | 3 | small | 8 | 10 | own jurisdiction | resilience up, ai_safety up slightly via reduced bio misuse | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Screened Synthesis Enforcement and Bio-Detection Surge", "category": 3, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly via reduced bio misuse"}, "grounds": "to close unscreened DNA market and lift bio-detection after automated attack"}
  - Grounds: to close unscreened DNA market and lift bio-detection after automated attack
