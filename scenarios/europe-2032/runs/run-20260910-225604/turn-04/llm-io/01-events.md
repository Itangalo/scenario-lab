...
- characters 376-1698: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1741-4316: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4372-5275: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5338-30242: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30597-30794: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): loss_of_control_incident
- Turn 3 (1 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, emergent_grid_forensics_leak
