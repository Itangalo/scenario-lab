...
- characters 105-13660: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13703-13895: `{{metrics_json}}` from the run's live metric values
- characters 13988-15310: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15353-17928: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17984-18563: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Bridge to the US-China Safety Floor | 2 |
...
## Metrics
```json
{"ai_capability": 59.5, "openweight_capability": 55.5, "ai_safety": 27.0, "resilience": 39.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 13.0, "public_sentiment": 32.0}
```
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Open-Weight Release Accountability Act −2, EU Bridge to the US-China Safety Floor −2, priority −1 = −11
PROPOSAL BONUS: none — new Bridge measure (cat 8, small) answers US-China agreement which is a cooperative opening, not a negative shock from last three turns
LEGITIMACY LENDS: capital 13, sentiment 31 -> +2
