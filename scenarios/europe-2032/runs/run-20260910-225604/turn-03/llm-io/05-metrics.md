...
- characters 106-13203: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13246-13438: `{{metrics_json}}` from the run's live metric values
- characters 13531-14918: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14962-17148: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17204-18036: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Grid and Agent Containment Shield | 2 |
| M5 | EU Open-Weight Release Accountability Act | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Grid and Agent Containment Shield −2, priority −1 = −12
PROPOSAL BONUS: EU Grid and Agent Containment Shield (cat 6, small) +3 — loss_of_control_incident this turn severe and this answers it directly, plus autumn grid intrusion context
LEGITIMACY LENDS: capital 26, sentiment 34 -> +2
SOVEREIGNTY: 21 last turn, no capacity event, Gigafactories in flight +0, capability rose 2.0 −1 = 20

## Emerging developments (tracked)

- `emergent_gigafactory_siting_backlash` -- first noted turn 2, listed in 2 turn(s) so far: Municipal and regional opposition coalesces against gigafactory shortlist sites over power prices, water use and permitting, delaying grid-connection approvals in at least one shortlisted state.
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Grid and Agent Containment Shield −2, EU Open-Weight Release Accountability Act −2, priority −1 = −14
PROPOSAL BONUS: EU Open-Weight Release Accountability Act (cat 3, small) +2 — forensic leak linking grid intrusion to downloadable model plus automated attack this turn severe and this answers it directly
LEGITIMACY LENDS: capital 13, sentiment 31 -> +2
