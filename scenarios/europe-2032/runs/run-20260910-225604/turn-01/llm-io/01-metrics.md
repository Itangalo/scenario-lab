...
- characters 106-13097: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13140-13332: `{{metrics_json}}` from the run's live metric values
- characters 13448-16397: `{{world_state}}` from background/context.md, seeded as the opening world state
...
## Metrics
```json
{"ai_capability": 54.0, "openweight_capability": 46.0, "ai_safety": 32.0, "resilience": 38.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 35.0, "public_sentiment": 40.0}
```
