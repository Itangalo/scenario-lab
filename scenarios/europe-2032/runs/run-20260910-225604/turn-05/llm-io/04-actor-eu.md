...
- characters 1837-3702: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5290-5730: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7949-9822: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Bridge to the US-China Safety Floor | 8 | small | 4 | 6 | US, China, coalition | ai_safety up, eu_ai_sovereignty up modestly via leverage | 2 | running |
