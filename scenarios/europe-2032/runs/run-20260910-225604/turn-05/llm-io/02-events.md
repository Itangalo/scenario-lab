...
- characters 1759-3624: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3680-4173: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4236-27634: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27989-28269: `{{event_history}}` from the run's own event record
...
- Turn 3 (2 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, emergent_grid_forensics_leak
- Turn 4 (1 turn(s) ago): us_china_agreement, emergent_gigafactory_siting_backlash
