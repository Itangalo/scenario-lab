...
- characters 106-13154: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13197-13389: `{{metrics_json}}` from the run's live metric values
- characters 13482-14820: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14864-16729: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16785-17945: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_anti_datacentre_blockade` -- first noted turn 5, listed in 1 turn(s) so far: Coordinated physical protests block grid-connection works and water permits at two additional gigafactory shortlist sites, turning the siting backlash into a sustained national movement against AI infrastructure expansion.
- `emergent_municipal_energy_revolt` -- first noted turn 5, listed in 1 turn(s) so far: Coordinated municipal and water-board opposition spreads beyond the two gigafactory shortlist regions into a wider moratorium movement against large AI infrastructure, delaying grid connections EU-wide through courts and permits.
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Open-Weight Release Accountability Act −2, EU Bridge to the US-China Safety Floor −2, priority −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 5, sentiment 33 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.8 −0 = 19
