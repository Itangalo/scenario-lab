...
- `two_year_commitment` (commitment): Secure allied capability and domestic resilience while rebuilding leverage to decide our own future

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure allied capability and domestic resilience while rebuilding leverage to decide our own future
