...
- characters 105-13147: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13190-13382: `{{metrics_json}}` from the run's live metric values
- characters 13475-14688: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14731-16926: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16982-18016: `{{notepad}}` from the Game Master's notepad, carried across turns
