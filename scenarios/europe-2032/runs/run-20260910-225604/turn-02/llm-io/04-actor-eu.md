...
- characters 4599-5039: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6493-8584: `{{previous_actions}}` from the actor's own response from the previous turn
