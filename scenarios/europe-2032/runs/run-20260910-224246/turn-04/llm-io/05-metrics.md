...
- characters 105-13656: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13699-13891: `{{metrics_json}}` from the run's live metric values
- characters 13984-15871: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15914-17906: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17962-18580: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Civil Biodefence and Infrastructure Hardening Shield | 3 |
| M5 | EU Accession to Joint Cyber-Bio Threat Response Pact | 2 |
| M6 | EU Critical Operator Patching and Segmentation Disclosure Mandate | 2 |
