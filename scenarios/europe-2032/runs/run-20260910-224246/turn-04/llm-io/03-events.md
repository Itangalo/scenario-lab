...
- characters 376-2263: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2306-4298: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4354-5617: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5680-31812: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32167-32295: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): bio_incident
- Turn 3 (1 turn(s) ago): joint_threat_response
