...
- characters 105-13194: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13237-13429: `{{metrics_json}}` from the run's live metric values
- characters 13522-14689: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14732-16987: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17043-18103: `{{notepad}}` from the Game Master's notepad, carried across turns
