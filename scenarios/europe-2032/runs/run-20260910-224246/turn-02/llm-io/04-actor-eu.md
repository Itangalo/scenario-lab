...
- characters 4282-4722: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6176-8267: `{{previous_actions}}` from the actor's own response from the previous turn
