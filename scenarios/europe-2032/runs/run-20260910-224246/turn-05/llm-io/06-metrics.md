...
- characters 14057-15214: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15258-17146: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17202-18164: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_operator_backlash_strike` -- first noted turn 5, listed in 1 turn(s) so far: Municipal water utilities and small grid operators stage coordinated service slowdowns over telemetry and patching costs, forcing a temporary EU cost-sharing facility.
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Operator Patching and Segmentation Disclosure Mandate −2, priority −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 11, sentiment 29 -> +2
SOVEREIGNTY: 18 last turn, no capacity event, Gigafactories in flight +0, member_state_defection t5 −2, capability rose 3.0 −1 = 15
