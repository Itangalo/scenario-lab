...
- characters 377-1534: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1578-3466: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3522-4190: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4253-31719: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32074-32347: `{{event_history}}` from the run's own event record
...
- Turn 4 (1 turn(s) ago): capability_jump, cyber_defence_breakthrough, bio_uplift_findings, opaque_reasoning, emergent_cyber_insurance_repricing
