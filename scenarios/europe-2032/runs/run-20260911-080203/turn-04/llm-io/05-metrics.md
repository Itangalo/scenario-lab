...
- characters 105-13579: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13622-13814: `{{metrics_json}}` from the run's live metric values
- characters 13907-15378: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15421-17589: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17645-18186: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Proven-Gains Scale-Up for Health and Public Services | 2 |
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Bio-Detection and Critical-Service Hardening Sprint −2, EU Proven-Gains Scale-Up for Health and Public Services −2, priority −1 = −11
PROPOSAL BONUS: EU Proven-Gains Scale-Up for Health and Public Services (cat 9, small) +4 — adoption_success and medical_breakthrough landed this turn severe and this answers European-attributed benefit directly
LEGITIMACY LENDS: capital 17, sentiment 38 -> +2
