...
| M11 | EU Breakthrough Therapies Continuity Delivery | 9 | small | 11 | 13 | own jurisdiction | public_sentiment up sharply, resilience up modestly, eu_political_capital up | 2 | running |
| M12 | EU Embodied Automation Transition Shield | 7 | small | 12 | 14 | own jurisdiction | resilience up modestly, public_sentiment up, eu_political_capital protected | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Embodied Automation Transition Shield", "category": 7, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up modestly, public_sentiment up, eu_political_capital protected"}, "grounds": "to hold livelihoods as embodied AI displaces work"}
  - Grounds: to hold livelihoods as embodied AI displaces work
