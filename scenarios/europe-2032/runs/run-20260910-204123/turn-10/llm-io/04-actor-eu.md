...
- characters 453-1432: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1475-3540: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4976-5450: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7783-9404: `{{previous_actions}}` from the actor's own response from the previous turn
