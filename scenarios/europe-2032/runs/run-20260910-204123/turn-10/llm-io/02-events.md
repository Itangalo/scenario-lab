...
- characters 375-1354: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1397-3462: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3518-3921: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3984-31431: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31786-32790: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): cyber_major_incident, loss_of_control_incident
- Turn 3 (7 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, eval_anomaly_reports, export_control_escalation, emergent_fraud_wave
- Turn 4 (6 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 5 (5 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, medical_breakthrough, knowledge_work_augmented, embodied_ai_deployment, election_consolidation
- Turn 6 (4 turn(s) ago): loss_of_control_incident, rsi_onset, safety_breakthrough, labour_displacement, knowledge_work_augmented, export_control_escalation
- Turn 7 (3 turn(s) ago): openweight_frontier_release, adoption_success
- Turn 8 (2 turn(s) ago): eval_anomaly_reports, us_china_agreement, eu_frontier_access_denied
- Turn 9 (1 turn(s) ago): capability_jump, eval_anomaly_reports, research_breakthrough, automated_decision_scandal
