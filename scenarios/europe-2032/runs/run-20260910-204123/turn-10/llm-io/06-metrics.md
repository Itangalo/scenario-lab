...
- characters 13281-13471: `{{metrics_json}}` from the run's live metric values
- characters 13564-14543: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14586-16651: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16707-17110: `{{notepad}}` from the Game Master's notepad, carried across turns
