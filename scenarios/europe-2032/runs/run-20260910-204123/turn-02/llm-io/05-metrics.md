...
- characters 13394-14533: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14576-16275: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16331-17100: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Agent Containment and Reporting Regime | 2 |
...
- `emergent_fraud_wave` -- first noted turn 1, listed in 2 turn(s) so far: A wave of AI-generated voice and video fraud hits banks and public administrations across several EU states using open Mythos-class models, causing hundreds of millions in losses and forcing emergency authentication rules.
...
## Notepad
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Agent Containment and Reporting Regime −2, priority −1 = −12
PROPOSAL BONUS: EU Agent Containment and Reporting Regime (cat 1, small) +3 — loss_of_control_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 31, sentiment 40 -> +2
SOVEREIGNTY: 23 last turn, no capacity event, Gigafactories in flight +0, capability rose 3.5 −1 = 22
