...
- characters 376-1515: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1558-3257: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3313-4082: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4145-27222: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27577-27637: `{{event_history}}` from the run's own event record
