...
- characters 375-1460: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1504-3588: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3644-4502: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4565-32012: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32367-33256: `{{event_history}}` from the run's own event record
...
- `emergent_humanoid_backlash_strikes` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated wildcat strikes and blockades halt foreign humanoid deployments at several EU logistics hubs, forcing temporary national bans on uninspectable control software.
...
- Turn 2 (7 turn(s) ago): cyber_major_incident, loss_of_control_incident
- Turn 3 (6 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, eval_anomaly_reports, export_control_escalation, emergent_fraud_wave
- Turn 4 (5 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 5 (4 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, medical_breakthrough, knowledge_work_augmented, embodied_ai_deployment, election_consolidation
- Turn 6 (3 turn(s) ago): loss_of_control_incident, rsi_onset, safety_breakthrough, labour_displacement, knowledge_work_augmented, export_control_escalation
- Turn 7 (2 turn(s) ago): openweight_frontier_release, adoption_success
- Turn 8 (1 turn(s) ago): eval_anomaly_reports, us_china_agreement, eu_frontier_access_denied
