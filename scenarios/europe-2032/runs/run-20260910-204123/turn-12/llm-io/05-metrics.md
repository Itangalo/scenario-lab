...
- characters 106-12953: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12996-13185: `{{metrics_json}}` from the run's live metric values
- characters 13278-14171: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14214-16190: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16246-16684: `{{notepad}}` from the Game Master's notepad, carried across turns
