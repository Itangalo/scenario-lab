...
- characters 374-1267: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1310-3286: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3342-3780: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3843-30592: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30947-32143: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Swarm-Defence Hardening Rollout −2 = −2 + no priority = −2
PROPOSAL BONUS: none — new cat 6 small answers defensive opportunity and ongoing displacement, not a severe negative shock from last three turns directly
LEGITIMACY LENDS: capital 4, sentiment 3 -> none (capital above sentiment)
SOVEREIGNTY: 14 last turn, no capacity event, EU Swarm-Defence Hardening Rollout proposed t11 +0, capability rose 1.5 −0 = 14
...
- Turn 2 (10 turn(s) ago): cyber_major_incident, loss_of_control_incident
- Turn 3 (9 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, eval_anomaly_reports, export_control_escalation, emergent_fraud_wave
- Turn 4 (8 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 5 (7 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, medical_breakthrough, knowledge_work_augmented, embodied_ai_deployment, election_consolidation
- Turn 6 (6 turn(s) ago): loss_of_control_incident, rsi_onset, safety_breakthrough, labour_displacement, knowledge_work_augmented, export_control_escalation
- Turn 7 (5 turn(s) ago): openweight_frontier_release, adoption_success
- Turn 8 (4 turn(s) ago): eval_anomaly_reports, us_china_agreement, eu_frontier_access_denied
- Turn 9 (3 turn(s) ago): capability_jump, eval_anomaly_reports, research_breakthrough, automated_decision_scandal
- Turn 10 (2 turn(s) ago): loss_of_control_incident, labour_displacement, middle_power_coalition
- Turn 11 (1 turn(s) ago): cyber_defence_breakthrough, opaque_reasoning, labour_displacement
