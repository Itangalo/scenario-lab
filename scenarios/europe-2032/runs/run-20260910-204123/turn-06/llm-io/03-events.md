...
- characters 375-1346: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1389-3589: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3645-4548: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4611-30394: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30749-31315: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, priority −1 = −4
PROPOSAL BONUS: none
LEGITIMACY LENDS: capital 4, sentiment 12 -> +2
SOVEREIGNTY: 15 last turn, EU Essential Services Fallback Stack finishes t5 +3, InvestAI Gigafactories in flight +1, embodied_ai_deployment t5 −2, capability rose 3.0 −1 = 16

## Emerging developments (tracked)

- `emergent_municipal_payment_freeze` -- first noted turn 4, listed in 2 turn(s) so far: Municipalities hit by synthetic-voice fraud suspend phone-based payments and in-person verification queues overflow, forcing emergency cash disbursement and a short-lived run on local bank branches.
- `emergent_shipping_insurance_freeze` -- first noted turn 4, listed in 2 turn(s) so far: Major reinsurers suspend standard cover for Taiwan Strait cargo and chip fabs demand war-risk premiums, freezing commercial accelerator shipments even where export licences exist.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, eu_access_secured
- Turn 2 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident
- Turn 3 (3 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, eval_anomaly_reports, export_control_escalation, emergent_fraud_wave
- Turn 4 (2 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 5 (1 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, medical_breakthrough, knowledge_work_augmented, embodied_ai_deployment, election_consolidation
