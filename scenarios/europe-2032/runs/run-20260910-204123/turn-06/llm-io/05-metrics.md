...
- characters 105-12975: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13018-13209: `{{metrics_json}}` from the run's live metric values
- characters 13302-14273: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14316-16516: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16572-16880: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Displacement Transition Fund | 2 |
