...
- characters 453-1424: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1467-3667: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6068-6528: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8565-10219: `{{previous_actions}}` from the actor's own response from the previous turn
