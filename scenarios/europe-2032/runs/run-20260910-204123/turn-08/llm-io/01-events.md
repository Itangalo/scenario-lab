...
- characters 374-2170: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2213-4276: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4332-5235: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5298-33205: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33560-34355: `{{event_history}}` from the run's own event record
...
- `emergent_humanoid_backlash_strikes` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated wildcat strikes and blockades halt foreign humanoid deployments at several EU logistics hubs, forcing temporary national bans on uninspectable control software.
...
- Turn 2 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident
- Turn 3 (5 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, eval_anomaly_reports, export_control_escalation, emergent_fraud_wave
- Turn 4 (4 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 5 (3 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, medical_breakthrough, knowledge_work_augmented, embodied_ai_deployment, election_consolidation
- Turn 6 (2 turn(s) ago): loss_of_control_incident, rsi_onset, safety_breakthrough, labour_displacement, knowledge_work_augmented, export_control_escalation
- Turn 7 (1 turn(s) ago): openweight_frontier_release, adoption_success
