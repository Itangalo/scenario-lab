...
- characters 105-13353: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13396-13586: `{{metrics_json}}` from the run's live metric values
- characters 13679-15475: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15518-17581: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17637-18540: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 80.0, "openweight_capability": 73.5, "ai_safety": 18.0, "resilience": 35.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 0.0, "public_sentiment": 7.0}
```
