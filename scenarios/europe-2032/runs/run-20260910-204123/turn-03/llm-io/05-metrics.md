...
- characters 106-13110: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13153-13345: `{{metrics_json}}` from the run's live metric values
- characters 13438-14677: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14721-16681: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16737-17208: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Supply-Chain Leverage Pact | 2 |
