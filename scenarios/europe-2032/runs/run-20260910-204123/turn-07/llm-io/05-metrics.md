...
- characters 106-13358: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13401-13591: `{{metrics_json}}` from the run's live metric values
- characters 13684-14903: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14947-17296: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17352-18136: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | EU Visible Benefit Adoption Drive | 2 |
...
## Metrics
```json
{"ai_capability": 77.5, "openweight_capability": 69.5, "ai_safety": 20.0, "resilience": 36.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 0.0, "public_sentiment": 8.0}
```
