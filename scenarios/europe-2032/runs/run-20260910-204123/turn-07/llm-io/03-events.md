...
- characters 1638-3987: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4043-4527: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4590-31330: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31685-32408: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, EU Displacement Transition Fund −2, priority −1 = −6
PROPOSAL BONUS: EU Displacement Transition Fund (cat 7, small) +2 — labour_displacement and union backlash over humanoids last two turns and this answers directly, small size caps it
LEGITIMACY LENDS: capital 2, sentiment 12 -> +2
SOVEREIGNTY: 16 last turn, no capacity event finishes, InvestAI Gigafactories in flight +0, export_control_escalation t6 −2, capability rose 7.0 −1 = 13
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, eu_access_secured
- Turn 2 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident
- Turn 3 (4 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, eval_anomaly_reports, export_control_escalation, emergent_fraud_wave
- Turn 4 (3 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 5 (2 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, medical_breakthrough, knowledge_work_augmented, embodied_ai_deployment, election_consolidation
- Turn 6 (1 turn(s) ago): loss_of_control_incident, rsi_onset, safety_breakthrough, labour_displacement, knowledge_work_augmented, export_control_escalation
