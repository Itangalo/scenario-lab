...
- characters 453-1564: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1608-3815: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5083-5606: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7939-9681: `{{previous_actions}}` from the actor's own response from the previous turn
