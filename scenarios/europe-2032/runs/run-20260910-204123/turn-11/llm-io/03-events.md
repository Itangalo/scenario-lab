...
- characters 375-1486: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1530-3737: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3793-4107: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4170-31617: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31972-33074: `{{event_history}}` from the run's own event record
...
LEGITIMACY LENDS: capital 0 before lends, sentiment 3 -> none (capital above sentiment)
SOVEREIGNTY: 13 last turn, no category 4 finish or in flight, middle_power_coalition t10 +2, capability rose 3.0 −1 = 14
...
- Turn 2 (9 turn(s) ago): cyber_major_incident, loss_of_control_incident
- Turn 3 (8 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, eval_anomaly_reports, export_control_escalation, emergent_fraud_wave
- Turn 4 (7 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 5 (6 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, medical_breakthrough, knowledge_work_augmented, embodied_ai_deployment, election_consolidation
- Turn 6 (5 turn(s) ago): loss_of_control_incident, rsi_onset, safety_breakthrough, labour_displacement, knowledge_work_augmented, export_control_escalation
- Turn 7 (4 turn(s) ago): openweight_frontier_release, adoption_success
- Turn 8 (3 turn(s) ago): eval_anomaly_reports, us_china_agreement, eu_frontier_access_denied
- Turn 9 (2 turn(s) ago): capability_jump, eval_anomaly_reports, research_breakthrough, automated_decision_scandal
- Turn 10 (1 turn(s) ago): loss_of_control_incident, labour_displacement, middle_power_coalition
