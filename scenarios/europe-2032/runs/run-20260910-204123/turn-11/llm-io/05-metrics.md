...
- characters 107-12954: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12997-13186: `{{metrics_json}}` from the run's live metric values
- characters 13279-14390: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14434-16641: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16697-17011: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Swarm-Defence Hardening Rollout | 2 |
