...
- characters 16367-16700: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_fraud_wave` -- first noted turn 1, listed in 1 turn(s) so far: A wave of AI-generated voice and video fraud hits banks and public administrations across several EU states using open Mythos-class models, causing hundreds of millions in losses and forcing emergency authentication rules.
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 46.0, "ai_safety": 32.0, "resilience": 37.0, "eu_ai_sovereignty": 23.0, "eu_political_capital": 43.0, "public_sentiment": 40.0}
```
## Narrative
...
SOVEREIGNTY: 22 last turn, no category 4 finish, in flight +0, eu_access_secured t1 +2, capability rose 3.0 −1 = 23
## Store changes
```json
