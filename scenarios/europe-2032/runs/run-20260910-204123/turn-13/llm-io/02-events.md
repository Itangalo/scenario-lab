...
- characters 375-1324: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1368-3182: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3238-3562: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3625-30374: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30729-32002: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M10 EU Swarm-Defence Hardening Rollout −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 0 -> none (capital not below sentiment at start)
SOVEREIGNTY: 14 last turn, no capacity event, M10 cat 6 in flight +0, capability rose 1.5 −0 = 14
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, eu_access_secured
- Turn 2 (11 turn(s) ago): cyber_major_incident, loss_of_control_incident
- Turn 3 (10 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, eval_anomaly_reports, export_control_escalation, emergent_fraud_wave
- Turn 4 (9 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, member_state_defection, adoption_success
- Turn 5 (8 turn(s) ago): loss_of_control_incident, cyber_defence_breakthrough, medical_breakthrough, knowledge_work_augmented, embodied_ai_deployment, election_consolidation
- Turn 6 (7 turn(s) ago): loss_of_control_incident, rsi_onset, safety_breakthrough, labour_displacement, knowledge_work_augmented, export_control_escalation
- Turn 7 (6 turn(s) ago): openweight_frontier_release, adoption_success
- Turn 8 (5 turn(s) ago): eval_anomaly_reports, us_china_agreement, eu_frontier_access_denied
- Turn 9 (4 turn(s) ago): capability_jump, eval_anomaly_reports, research_breakthrough, automated_decision_scandal
- Turn 10 (3 turn(s) ago): loss_of_control_incident, labour_displacement, middle_power_coalition
- Turn 11 (2 turn(s) ago): cyber_defence_breakthrough, opaque_reasoning, labour_displacement
- Turn 12 (1 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports
