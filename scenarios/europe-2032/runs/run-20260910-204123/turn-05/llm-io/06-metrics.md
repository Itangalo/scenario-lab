...
- characters 106-13613: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13656-13847: `{{metrics_json}}` from the run's live metric values
- characters 13940-15254: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15298-17527: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17583-18679: `{{notepad}}` from the Game Master's notepad, carried across turns
