...
- characters 454-1768: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1812-4041: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7423-7906: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9943-12033: `{{previous_actions}}` from the actor's own response from the previous turn
