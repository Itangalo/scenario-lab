...
- characters 376-1690: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1734-3963: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4019-5115: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5178-31414: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31769-32160: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, EU Critical Systems Shield −3, EU Supply-Chain Leverage Pact −2, EU Essential Services Fallback Stack −2, priority −1 = −11
PROPOSAL BONUS: EU Essential Services Fallback Stack (cat 4, small) +4 — eu_frontier_access_denied landed this turn and this answers it directly
LEGITIMACY LENDS: capital 5, sentiment 18 -> +2
SOVEREIGNTY: 19 last turn, no capacity event finish, no build in flight +0, eu_frontier_access_denied t4 −3, capability rose 3.0 −1 = 15

## Emerging developments (tracked)

- `emergent_municipal_payment_freeze` -- first noted turn 4, listed in 1 turn(s) so far: Municipalities hit by synthetic-voice fraud suspend phone-based payments and in-person verification queues overflow, forcing emergency cash disbursement and a short-lived run on local bank branches.
- `emergent_shipping_insurance_freeze` -- first noted turn 4, listed in 1 turn(s) so far: Major reinsurers suspend standard cover for Taiwan Strait cargo and chip fabs demand war-risk premiums, freezing commercial accelerator shipments even where export licences exist.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, eu_access_secured
- Turn 2 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident
- Turn 3 (2 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, eval_anomaly_reports, export_control_escalation, emergent_fraud_wave
- Turn 4 (1 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, member_state_defection, adoption_success
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.3}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.12}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.06}, {"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.38}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.12}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.33}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.16}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.15}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Municipalities hit by synthetic-voice fraud suspend phone-based payments and in-person verification queues overflow, forcing emergency cash disbursement and a short-lived run on local bank branches.", "emergent": true, "id": "emergent_municipal_payment_freeze", "probability": 0.22}, {"description": "Major reinsurers suspend standard cover for Taiwan Strait cargo and chip fabs demand war-risk premiums, freezing commercial accelerator shipments even where export licences exist.", "emergent": true, "id": "emergent_shipping_insurance_freeze", "probability": 0.24}]
```
