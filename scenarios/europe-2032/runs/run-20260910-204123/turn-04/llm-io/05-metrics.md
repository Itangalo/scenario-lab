...
- characters 105-13442: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13485-13677: `{{metrics_json}}` from the run's live metric values
- characters 13770-15169: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15212-17627: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17683-18792: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Essential Services Fallback Stack | 2 |
