...
- characters 377-1919: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1963-3948: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4004-5062: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5125-28701: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29056-29202: `{{event_history}}` from the run's own event record
...
- Turn 2 (1 turn(s) ago): openweight_frontier_release, member_state_defection
