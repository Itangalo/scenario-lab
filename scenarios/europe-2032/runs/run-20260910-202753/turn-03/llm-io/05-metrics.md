...
- characters 13759-15301: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15345-17330: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17386-17853: `{{notepad}}` from the Game Master's notepad, carried across turns
