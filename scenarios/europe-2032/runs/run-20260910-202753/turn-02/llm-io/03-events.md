...
- characters 1540-3914: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3970-5116: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5179-28256: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28611-28679: `{{event_history}}` from the run's own event record
