...
- characters 453-1539: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1583-3820: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5772-6288: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8375-10267: `{{previous_actions}}` from the actor's own response from the previous turn
