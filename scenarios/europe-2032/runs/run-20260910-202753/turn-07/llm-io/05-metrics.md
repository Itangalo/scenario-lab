...
- characters 13565-13755: `{{metrics_json}}` from the run's live metric values
- characters 13848-14934: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14978-17215: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17271-17681: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Hospital Continuity and Loss-of-Control Containment Reserve | 2 |
