...
- characters 375-1461: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1505-3742: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3798-4519: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4582-31165: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31520-32002: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, EU Transition and Siting Compact −2, priority −1 not charged (capital 9 <20, no effect) = −5
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 15 -> +2 (capped below sentiment)
SOVEREIGNTY: 13 last turn, Tech sovereignty package finishes t6 +5, in flight +0, embodied_ai_deployment t6 −2, capability rose 2.5 −1 = 15

## Emerging developments (tracked)

- `emergent_siting_legal_contagion` -- first noted turn 5, listed in 2 turn(s) so far: Coordinated municipal injunctions against data-centre and grid works spread into a cross-border legal template, freezing a further tranche of EU compute and energy projects through 2029.
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, eu_frontier_access_denied
- Turn 2 (5 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 3 (4 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, labour_displacement
- Turn 4 (3 turn(s) ago): joint_threat_response, emergent_infrastructure_backlash_freeze
- Turn 5 (2 turn(s) ago): emergent_siting_veto_network, election_retrenchment
- Turn 6 (1 turn(s) ago): embodied_ai_deployment
