...
- characters 374-2523: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2567-5501: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5557-6684: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6747-33103: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33458-34568: `{{event_history}}` from the run's own event record
...
- `emergent_care_staff_refusal` -- first noted turn 11, listed in 2 turn(s) so far: Coordinated wildcat strikes by hospital staff and municipal workers refuse to operate AI triage and rostering tools after dosage misfires, forcing emergency staffing measures in several member states.
- `emergent_lab_staff_revolt` -- first noted turn 11, listed in 2 turn(s) so far: Frontier self-directed training leaks trigger a coordinated walkout and whistleblower dossier by safety researchers at two leading labs, forcing a temporary external audit debate.
...
- Turn 2 (11 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 3 (10 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, labour_displacement
- Turn 4 (9 turn(s) ago): joint_threat_response, emergent_infrastructure_backlash_freeze
- Turn 5 (8 turn(s) ago): emergent_siting_veto_network, election_retrenchment
- Turn 6 (7 turn(s) ago): embodied_ai_deployment
- Turn 7 (6 turn(s) ago): medical_breakthrough, loss_of_control_incident, eu_frontier_access_denied, supply_chain_coercion
- Turn 8 (5 turn(s) ago): medical_breakthrough, embodied_ai_deployment, export_control_escalation
- Turn 9 (4 turn(s) ago): supply_chain_coercion
- Turn 10 (3 turn(s) ago): rsi_onset, knowledge_work_augmented, member_state_defection
- Turn 11 (2 turn(s) ago): opaque_reasoning, catastrophic_loss_of_control_incident, labour_displacement, us_labs_nationalised
- Turn 12 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, safety_breakthrough, catastrophic_great_power_conflict, adoption_success
