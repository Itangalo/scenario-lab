...
- characters 13191-15340: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15384-18318: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18374-18917: `{{notepad}}` from the Game Master's notepad, carried across turns
