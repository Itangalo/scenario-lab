...
- characters 13079-13269: `{{metrics_json}}` from the run's live metric values
- characters 13362-14357: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14400-16579: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16635-17539: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | EU Shopfloor Continuity and Displacement Bridge | 2 |
