...
- characters 1412-3591: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3647-4278: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4341-32456: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32811-33416: `{{event_history}}` from the run's own event record
...
- Turn 2 (6 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 3 (5 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, labour_displacement
- Turn 4 (4 turn(s) ago): joint_threat_response, emergent_infrastructure_backlash_freeze
- Turn 5 (3 turn(s) ago): emergent_siting_veto_network, election_retrenchment
- Turn 6 (2 turn(s) ago): embodied_ai_deployment
- Turn 7 (1 turn(s) ago): medical_breakthrough, loss_of_control_incident, eu_frontier_access_denied, supply_chain_coercion
