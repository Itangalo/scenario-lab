...
- characters 453-1950: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1993-4136: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5043-5519: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7756-9273: `{{previous_actions}}` from the actor's own response from the previous turn
