...
- characters 375-1872: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1915-4058: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4114-4880: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4943-31526: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31881-32314: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Transition and Siting Compact −2 = −8 (priority named but capital 17 <20 so priority −1 not charged, no pull-in)
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 12, sentiment 18 -> +2 (after charge and M4 finish, capped below sentiment)
SOVEREIGNTY: 14 last turn, no capacity event, no cat4 finish, in flight +0, capability rose 3.0 −1 = 13

## Emerging developments (tracked)

- `emergent_siting_legal_contagion` -- first noted turn 5, listed in 1 turn(s) so far: Coordinated municipal injunctions against data-centre and grid works spread into a cross-border legal template, freezing a further tranche of EU compute and energy projects through 2029.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, eu_frontier_access_denied
- Turn 2 (4 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 3 (3 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, labour_displacement
- Turn 4 (2 turn(s) ago): joint_threat_response, emergent_infrastructure_backlash_freeze
- Turn 5 (1 turn(s) ago): emergent_siting_veto_network, election_retrenchment
