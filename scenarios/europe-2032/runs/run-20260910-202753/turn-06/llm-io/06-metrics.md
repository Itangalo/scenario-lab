...
- characters 13443-13634: `{{metrics_json}}` from the run's live metric values
- characters 13727-15224: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15267-17410: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17466-18232: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 69.5, "openweight_capability": 63.8, "ai_safety": 23.0, "resilience": 43.5, "eu_ai_sovereignty": 15.0, "eu_political_capital": 4.0, "public_sentiment": 9.0}
```
