...
- characters 452-1603: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1647-3596: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6146-6696: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9126-11515: `{{previous_actions}}` from the actor's own response from the previous turn
