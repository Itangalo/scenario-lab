...
- characters 374-1525: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1569-3518: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3574-3905: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3968-33721: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34076-34915: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: no measures in flight, 0 measures = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 1 -> none (capital not below sentiment)
SOVEREIGNTY: 10 last turn, no category 4 finish, no category 4 in flight +0, member_state_defection t10 −2, capability rose 6.2 −1 = 7
...
- Turn 2 (9 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 3 (8 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, labour_displacement
- Turn 4 (7 turn(s) ago): joint_threat_response, emergent_infrastructure_backlash_freeze
- Turn 5 (6 turn(s) ago): emergent_siting_veto_network, election_retrenchment
- Turn 6 (5 turn(s) ago): embodied_ai_deployment
- Turn 7 (4 turn(s) ago): medical_breakthrough, loss_of_control_incident, eu_frontier_access_denied, supply_chain_coercion
- Turn 8 (3 turn(s) ago): medical_breakthrough, embodied_ai_deployment, export_control_escalation
- Turn 9 (2 turn(s) ago): supply_chain_coercion
- Turn 10 (1 turn(s) ago): rsi_onset, knowledge_work_augmented, member_state_defection
