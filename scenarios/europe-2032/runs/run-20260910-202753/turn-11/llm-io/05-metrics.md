...
- characters 107-12867: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12910-13098: `{{metrics_json}}` from the run's live metric values
- characters 13191-14342: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14386-16335: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16391-17306: `{{notepad}}` from the Game Master's notepad, carried across turns
