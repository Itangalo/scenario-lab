...
- characters 375-2093: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2137-4563: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4619-5643: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5706-33821: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34176-34879: `{{event_history}}` from the run's own event record
...
- `emergent_clinical_fallback_backlash` -- first noted turn 8, listed in 1 turn(s) so far: Clinician-led lawsuits and regional bans on fallback open models after dosage hallucinations cause patient harm, freezing EU hospital rerouting.
...
- Turn 2 (7 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 3 (6 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, labour_displacement
- Turn 4 (5 turn(s) ago): joint_threat_response, emergent_infrastructure_backlash_freeze
- Turn 5 (4 turn(s) ago): emergent_siting_veto_network, election_retrenchment
- Turn 6 (3 turn(s) ago): embodied_ai_deployment
- Turn 7 (2 turn(s) ago): medical_breakthrough, loss_of_control_incident, eu_frontier_access_denied, supply_chain_coercion
- Turn 8 (1 turn(s) ago): medical_breakthrough, embodied_ai_deployment, export_control_escalation
