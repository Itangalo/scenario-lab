...
- characters 453-2171: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2215-4641: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5211-5727: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8308-10368: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Shopfloor Continuity and Displacement Bridge | 7 | small | 8 | 10 | own jurisdiction | resilience up slightly, public_sentiment up slightly | 2 | running |
