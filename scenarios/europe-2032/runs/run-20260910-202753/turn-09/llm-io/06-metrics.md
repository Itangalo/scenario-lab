...
- characters 13402-13592: `{{metrics_json}}` from the run's live metric values
- characters 13685-15403: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15447-17873: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17929-18953: `{{notepad}}` from the Game Master's notepad, carried across turns
