...
- characters 375-1371: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1414-3366: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3422-4170: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4233-33515: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33870-34621: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Shopfloor Continuity and Displacement Bridge −2, priority −1 not charged (capital 2 <20, no effect) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 3 -> +1 (capped below sentiment) applied in total; negative-event net (supply_chain_coercion undampened −5) included
SOVEREIGNTY: 13 last turn, no category 4 finish, no category 4 in flight +0, supply_chain_coercion t9 −2, capability rose 2.4 −1 = 10

## Emerging developments (tracked)

- `emergent_clinical_fallback_backlash` -- first noted turn 8, listed in 2 turn(s) so far: Clinician-led lawsuits and regional bans on fallback open models after dosage hallucinations cause patient harm, freezing EU hospital rerouting.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, eu_frontier_access_denied
- Turn 2 (8 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 3 (7 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, labour_displacement
- Turn 4 (6 turn(s) ago): joint_threat_response, emergent_infrastructure_backlash_freeze
- Turn 5 (5 turn(s) ago): emergent_siting_veto_network, election_retrenchment
- Turn 6 (4 turn(s) ago): embodied_ai_deployment
- Turn 7 (3 turn(s) ago): medical_breakthrough, loss_of_control_incident, eu_frontier_access_denied, supply_chain_coercion
- Turn 8 (2 turn(s) ago): medical_breakthrough, embodied_ai_deployment, export_control_escalation
- Turn 9 (1 turn(s) ago): supply_chain_coercion
