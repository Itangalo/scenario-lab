...
- characters 453-1449: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1492-3444: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4575-5053: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7483-9028: `{{previous_actions}}` from the actor's own response from the previous turn
