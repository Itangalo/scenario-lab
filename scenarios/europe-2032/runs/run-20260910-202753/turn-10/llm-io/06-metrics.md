...
- characters 106-13254: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13297-13487: `{{metrics_json}}` from the run's live metric values
- characters 13580-14576: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14619-16571: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16627-17102: `{{notepad}}` from the Game Master's notepad, carried across turns
