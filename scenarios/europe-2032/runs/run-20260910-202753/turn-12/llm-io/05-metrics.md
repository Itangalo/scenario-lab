...
- characters 106-12866: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12909-13097: `{{metrics_json}}` from the run's live metric values
- characters 13190-14830: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14873-17262: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17318-18222: `{{notepad}}` from the Game Master's notepad, carried across turns
