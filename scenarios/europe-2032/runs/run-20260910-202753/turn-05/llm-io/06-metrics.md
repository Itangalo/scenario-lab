...
- characters 13723-14926: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14970-16995: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17051-17839: `{{notepad}}` from the Game Master's notepad, carried across turns
