...
- characters 455-1658: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1702-3727: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4900-5382: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7618-9552: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Transition and Siting Compact | 7 | small | 4 | 7 | own jurisdiction | public_sentiment up moderately, resilience up slightly via unfreezing Shield sites | 2 | running |
