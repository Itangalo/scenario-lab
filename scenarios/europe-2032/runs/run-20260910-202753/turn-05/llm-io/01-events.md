...
- characters 377-1580: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1624-3649: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3705-4182: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4245-31199: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31554-31909: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Evaluation Cell −2, EU Transition and Siting Compact −2, priority −1 = −11
PROPOSAL BONUS: EU Transition and Siting Compact (cat 7, small) +3 — backlash freeze plus graduate displacement in last two turns and this answers both directly
LEGITIMACY LENDS: capital 16, sentiment 20 -> +1
SOVEREIGNTY: 15 last turn, no capacity event, no cat4 finish, in flight +0, capability rose 3.0 −1 = 14
...
- Turn 2 (3 turn(s) ago): openweight_frontier_release, member_state_defection
- Turn 3 (2 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, labour_displacement
- Turn 4 (1 turn(s) ago): joint_threat_response, emergent_infrastructure_backlash_freeze
