...
- characters 105-13387: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13430-13622: `{{metrics_json}}` from the run's live metric values
- characters 13715-14723: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14766-16999: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17055-17486: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Transition and Siting Compact | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Evaluation Cell −2, EU Recovery Surge −2, priority −1 = −11
PROPOSAL BONUS: EU Recovery Surge (cat 6, small) +3 — cyber_major_incident landed this turn and this answers restoration directly
LEGITIMACY LENDS: capital 17, sentiment 20 -> +2
SOVEREIGNTY: 16 last turn, no capacity event, no cat4 finish, in flight +0, capability rose 3.0 −1 = 15
...
## Metrics
```json
{"ai_capability": 64.0, "openweight_capability": 57.5, "ai_safety": 26.0, "resilience": 46.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 17.0, "public_sentiment": 18.0}
```
