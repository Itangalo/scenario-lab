...
- characters 12959-13150: `{{metrics_json}}` from the run's live metric values
- characters 13243-14836: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14879-17614: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17670-18424: `{{notepad}}` from the Game Master's notepad, carried across turns
