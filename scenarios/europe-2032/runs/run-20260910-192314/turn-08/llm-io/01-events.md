...
- characters 375-1968: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2011-4746: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4802-5556: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5619-32108: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32463-33073: `{{event_history}}` from the run's own event record
...
- `emergent_municipal_utility_insolvency` -- first noted turn 7, listed in 1 turn(s) so far: Several mid-size EU municipal utilities declare inability to fund both winter hardship relief and mandated cyber-rebuild costs, forcing emergency state takeovers of local grids.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, knowledge_work_augmented
- Turn 2 (6 turn(s) ago): cyber_major_incident, knowledge_work_augmented, automated_decision_scandal
- Turn 3 (5 turn(s) ago): capability_jump, adoption_success, automated_decision_scandal
- Turn 4 (4 turn(s) ago): taiwan_blockade, emergent_datacentre_blockade_protest
- Turn 5 (3 turn(s) ago): cyber_major_incident, knowledge_work_augmented, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, safety_breakthrough, embodied_ai_deployment, emergent_energy_rationing_backlash
- Turn 7 (1 turn(s) ago): member_state_defection
