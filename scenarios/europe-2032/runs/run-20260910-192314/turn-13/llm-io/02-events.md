...
- characters 376-2970: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3014-4969: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5025-5775: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5838-33180: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33535-34742: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: Repair-to-Jobs Transition Fund −2, priority −1 = −2 (priority has no effect and no cost as capital 9 below 20, measures total −2)
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 9, sentiment 6 -> none, sentiment not above capital
SOVEREIGNTY: 26 last turn, no category 4 finishes, no capacity event, no in-flight build bonus, capability rose 1.0 no deduction = 26

## Emerging developments (tracked)

- `emergent_gridsiege_protests` -- first noted turn 11, listed in 2 turn(s) so far: Coordinated physical blockades of grid interconnectors and logistics hubs by anti-AI municipal coalitions spread across several member states, disrupting repair-crew movements and server deliveries for weeks.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, knowledge_work_augmented
- Turn 2 (11 turn(s) ago): cyber_major_incident, knowledge_work_augmented, automated_decision_scandal
- Turn 3 (10 turn(s) ago): capability_jump, adoption_success, automated_decision_scandal
- Turn 4 (9 turn(s) ago): taiwan_blockade, emergent_datacentre_blockade_protest
- Turn 5 (8 turn(s) ago): cyber_major_incident, knowledge_work_augmented, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, safety_breakthrough, embodied_ai_deployment, emergent_energy_rationing_backlash
- Turn 7 (6 turn(s) ago): member_state_defection
- Turn 8 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, knowledge_work_augmented
- Turn 9 (4 turn(s) ago): bio_uplift_findings, member_state_defection, middle_power_coalition
- Turn 10 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, capability_jump, safety_breakthrough
- Turn 11 (2 turn(s) ago): cyber_major_incident, research_breakthrough, member_state_defection, middle_power_coalition
- Turn 12 (1 turn(s) ago): capability_jump, cyber_defence_breakthrough, medical_breakthrough, safety_breakthrough, labour_displacement, adoption_success
