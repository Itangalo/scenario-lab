...
- characters 2133-3984: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5852-6304: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8359-10044: `{{previous_actions}}` from the actor's own response from the previous turn
