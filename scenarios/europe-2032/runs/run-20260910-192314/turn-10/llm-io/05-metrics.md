...
- characters 106-12927: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12970-13161: `{{metrics_json}}` from the run's live metric values
- characters 13254-14890: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14933-16784: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16840-17171: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M6 | Municipal Repair and Containment Cell | 2 |
...
## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M6", "fields": {"finish_turn": 11}, "grounds": "named priority"}]}
```
```
