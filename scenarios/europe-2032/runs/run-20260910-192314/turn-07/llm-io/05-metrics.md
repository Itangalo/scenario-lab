...
- characters 106-13282: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13325-13516: `{{metrics_json}}` from the run's live metric values
- characters 13609-14969: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15013-17658: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17714-18411: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M5 | Member-State AI Deal Clearance | 2 |
