...
- characters 4481-4870: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4933-31422: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31777-32338: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, knowledge_work_augmented
- Turn 2 (5 turn(s) ago): cyber_major_incident, knowledge_work_augmented, automated_decision_scandal
- Turn 3 (4 turn(s) ago): capability_jump, adoption_success, automated_decision_scandal
- Turn 4 (3 turn(s) ago): taiwan_blockade, emergent_datacentre_blockade_protest
- Turn 5 (2 turn(s) ago): cyber_major_incident, knowledge_work_augmented, election_consolidation
- Turn 6 (1 turn(s) ago): cyber_major_incident, safety_breakthrough, embodied_ai_deployment, emergent_energy_rationing_backlash
