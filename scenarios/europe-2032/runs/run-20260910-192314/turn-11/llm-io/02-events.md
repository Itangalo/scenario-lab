...
- characters 376-1800: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1844-4447: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4503-4916: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4979-32321: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32676-33609: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, knowledge_work_augmented
- Turn 2 (9 turn(s) ago): cyber_major_incident, knowledge_work_augmented, automated_decision_scandal
- Turn 3 (8 turn(s) ago): capability_jump, adoption_success, automated_decision_scandal
- Turn 4 (7 turn(s) ago): taiwan_blockade, emergent_datacentre_blockade_protest
- Turn 5 (6 turn(s) ago): cyber_major_incident, knowledge_work_augmented, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, safety_breakthrough, embodied_ai_deployment, emergent_energy_rationing_backlash
- Turn 7 (4 turn(s) ago): member_state_defection
- Turn 8 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, knowledge_work_augmented
- Turn 9 (2 turn(s) ago): bio_uplift_findings, member_state_defection, middle_power_coalition
- Turn 10 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, capability_jump, safety_breakthrough
