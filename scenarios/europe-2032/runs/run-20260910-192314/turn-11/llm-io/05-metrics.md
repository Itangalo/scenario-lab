...
- characters 107-13342: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13385-13575: `{{metrics_json}}` from the run's live metric values
- characters 13668-15092: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15136-17739: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17795-18538: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | Repair-to-Jobs Transition Fund | 2 |
