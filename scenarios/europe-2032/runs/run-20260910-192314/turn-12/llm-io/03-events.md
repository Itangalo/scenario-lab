...
- characters 375-2512: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2555-4957: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5013-5803: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5866-33208: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33563-34616: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: Repair-to-Jobs Transition Fund −2, priority −1 = −3
PROPOSAL BONUS: none — Repair-to-Jobs Transition Fund already in flight as M7, no new distinct measure started this turn
LEGITIMACY LENDS: capital 8, sentiment 8 -> none, sentiment not above capital
SOVEREIGNTY: 24 last turn, no category 4 finishes, middle_power_coalition t11 +2 (largest capacity event, outweighs member_state_defection takeaway), capability rose 1.0 no deduction = 26

## Emerging developments (tracked)

- `emergent_gridsiege_protests` -- first noted turn 11, listed in 1 turn(s) so far: Coordinated physical blockades of grid interconnectors and logistics hubs by anti-AI municipal coalitions spread across several member states, disrupting repair-crew movements and server deliveries for weeks.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, knowledge_work_augmented
- Turn 2 (10 turn(s) ago): cyber_major_incident, knowledge_work_augmented, automated_decision_scandal
- Turn 3 (9 turn(s) ago): capability_jump, adoption_success, automated_decision_scandal
- Turn 4 (8 turn(s) ago): taiwan_blockade, emergent_datacentre_blockade_protest
- Turn 5 (7 turn(s) ago): cyber_major_incident, knowledge_work_augmented, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, safety_breakthrough, embodied_ai_deployment, emergent_energy_rationing_backlash
- Turn 7 (5 turn(s) ago): member_state_defection
- Turn 8 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, knowledge_work_augmented
- Turn 9 (3 turn(s) ago): bio_uplift_findings, member_state_defection, middle_power_coalition
- Turn 10 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, capability_jump, safety_breakthrough
- Turn 11 (1 turn(s) ago): cyber_major_incident, research_breakthrough, member_state_defection, middle_power_coalition
