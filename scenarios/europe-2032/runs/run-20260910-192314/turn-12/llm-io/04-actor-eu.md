...
- characters 453-2590: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2633-5035: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7264-7716: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10334-12140: `{{previous_actions}}` from the actor's own response from the previous turn
