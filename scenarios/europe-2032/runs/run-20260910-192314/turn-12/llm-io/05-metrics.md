...
- characters 106-12920: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12963-13153: `{{metrics_json}}` from the run's live metric values
- characters 13246-15383: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15426-17828: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17884-18674: `{{notepad}}` from the Game Master's notepad, carried across turns
