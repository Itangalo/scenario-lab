...
- characters 454-1847: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1891-3964: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6382-6866: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8874-10555: `{{previous_actions}}` from the actor's own response from the previous turn
