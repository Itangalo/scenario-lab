...
- characters 12986-13177: `{{metrics_json}}` from the run's live metric values
- characters 13270-14663: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14707-16780: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16836-17573: `{{notepad}}` from the Game Master's notepad, carried across turns
