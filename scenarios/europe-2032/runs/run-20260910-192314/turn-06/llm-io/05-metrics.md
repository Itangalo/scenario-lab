...
- characters 13653-14710: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14753-16579: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16635-17001: `{{notepad}}` from the Game Master's notepad, carried across turns
...
**emergent_energy_rationing_backlash (emergent event):** Transmission operators impose emergency winter load-shedding that prioritises grid-connection works for AI factories over municipal demand, triggering coordinated mayor-led legal challenges and street blockades beyond the two existing sites.
