...
- characters 453-1510: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1553-3379: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5722-6171: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8180-9760: `{{previous_actions}}` from the actor's own response from the previous turn
