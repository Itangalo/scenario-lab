...
- characters 1916-4982: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5038-5479: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5542-29769: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30124-30380: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, knowledge_work_augmented
- Turn 2 (2 turn(s) ago): cyber_major_incident, knowledge_work_augmented, automated_decision_scandal
- Turn 3 (1 turn(s) ago): capability_jump, adoption_success, automated_decision_scandal
