...
- characters 105-13546: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13589-13781: `{{metrics_json}}` from the run's live metric values
- characters 13874-15371: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15414-18480: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18536-18977: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Shield −3, EU Incident Reporting and High-Risk Enforcement Surge −2, priority −1 = −12
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 11 after charge, sentiment 36 -> +2 (capped well below sentiment)
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, priority −1 ineffective (capital below 20, no charge) = −6
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2, sentiment 30 -> +2
SOVEREIGNTY: 20 last turn, no category 4 finish, Gigafactories in flight +0, taiwan_blockade t4 −2, capability rose 2.0 −1 = 17
