...
- characters 454-2013: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2057-3982: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5300-5749: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7804-9170: `{{previous_actions}}` from the actor's own response from the previous turn
