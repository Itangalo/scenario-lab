...
- characters 376-1935: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1979-3904: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3960-4615: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4678-31167: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31522-32248: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M5 Member-State AI Deal Clearance −2, priority ineffective (capital below 20, no charge) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital -1, sentiment 18 -> +2 (capped, applied in total)
SOVEREIGNTY: 22 last turn, no capacity event, no finish, capability rose 1.0 (<2) no deduction = 22

## Emerging developments (tracked)

- `emergent_municipal_utility_insolvency` -- first noted turn 7, listed in 2 turn(s) so far: Several mid-size EU municipal utilities declare inability to fund both winter hardship relief and mandated cyber-rebuild costs, forcing emergency state takeovers of local grids.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, knowledge_work_augmented
- Turn 2 (7 turn(s) ago): cyber_major_incident, knowledge_work_augmented, automated_decision_scandal
- Turn 3 (6 turn(s) ago): capability_jump, adoption_success, automated_decision_scandal
- Turn 4 (5 turn(s) ago): taiwan_blockade, emergent_datacentre_blockade_protest
- Turn 5 (4 turn(s) ago): cyber_major_incident, knowledge_work_augmented, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, safety_breakthrough, embodied_ai_deployment, emergent_energy_rationing_backlash
- Turn 7 (2 turn(s) ago): member_state_defection
- Turn 8 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, knowledge_work_augmented
