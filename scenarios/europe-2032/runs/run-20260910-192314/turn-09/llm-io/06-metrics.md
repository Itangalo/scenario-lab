...
- characters 13298-13489: `{{metrics_json}}` from the run's live metric values
- characters 13582-15141: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15185-17110: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17166-17513: `{{notepad}}` from the Game Master's notepad, carried across turns
