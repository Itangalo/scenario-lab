...
- characters 106-13058: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13101-13293: `{{metrics_json}}` from the run's live metric values
- characters 13386-15005: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15049-17703: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17759-18254: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 57.5, "openweight_capability": 53.0, "ai_safety": 21.0, "resilience": 35.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 6.0, "public_sentiment": 36.0}
```
## Narrative
### The jump
