...
- characters 455-1750: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1794-3656: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5211-5683: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7791-8906: `{{previous_actions}}` from the actor's own response from the previous turn
