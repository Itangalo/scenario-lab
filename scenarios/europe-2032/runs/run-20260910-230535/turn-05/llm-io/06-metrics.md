...
- characters 13710-15005: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15049-16911: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16967-18045: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|---|---|---|---|---|---|---|
| M4 | EU Bio Detection and Synthesis Screening Net | 6 | small | 2 | 5 | own jurisdiction | resilience up, ai_safety indirectly via early warning | 2 | finished |
...
- `emergent_eu_buyer_bloc` -- first noted turn 5, listed in 1 turn(s) so far: Municipal utilities and regional hospitals, strained by the interim US hosting contracts, fast-track joint procurement of EU-built secure inference appliances, creating a first standing buyer bloc for domestic gigafactory output.
- `emergent_siting_backlash_freeze` -- first noted turn 5, listed in 1 turn(s) so far: A coordinated municipal siting revolt blocks grid connections for interim US-hosted inference sites and stalled gigafactory locations, driven by power-price and jobs protests rather than any EU decision.
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Continuity Stack for Critical Services −2, priority M5 −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 18, sentiment 26 -> +2
SOVEREIGNTY: 21 last turn, no cat4 finishes, Gigafactories/Tech sovereignty in flight +1, export_control_escalation t5 −2, capability rose 1.5 −0 = 20
