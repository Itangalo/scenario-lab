...
- characters 4237-4709: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6181-8308: `{{previous_actions}}` from the actor's own response from the previous turn
