...
- characters 13425-14653: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14697-16778: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16834-17961: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, EU Bio Detection and Synthesis Screening Net −2, priority −1 = −12
PROPOSAL BONUS: EU Bio Detection and Synthesis Screening Net (cat 6, small) +3 — bio uplift precursor this turn categorically stronger signal, measure answers it directly
...
- `emergent_interim_hosted_offer` -- first noted turn 2, listed in 2 turn(s) so far: A major US hyperscaler publicly offers interim sovereign-hosted inference capacity to EU governments and hospitals on EU soil while gigafactories are built, easing near-term dependence fears but complicating anchoring negotiations.
- `emergent_hyperscaler_pause_eu_build` -- first noted turn 2, listed in 2 turn(s) so far: A major US hyperscaler publicly pauses two planned EU data-centre expansions, citing grid-connection delays and power-price uncertainty amid gigafactory site bidding.
