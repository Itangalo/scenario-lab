...
- characters 1649-3730: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3786-4913: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4976-28258: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28613-28700: `{{event_history}}` from the run's own event record
