...
- `two_year_commitment` (commitment): Rebuild resilience and public consent so essential services stay running on European-controlled capacity

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild resilience and public consent so essential services stay running on European-controlled capacity
