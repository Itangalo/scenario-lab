...
- characters 375-1196: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1239-2709: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 2765-3283: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3346-29356: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29711-30078: `{{event_history}}` from the run's own event record
...
- Turn 2 (4 turn(s) ago): cyber_major_incident, safety_breakthrough, eu_frontier_access_denied, adoption_success
- Turn 3 (3 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, taiwan_tension_rise
- Turn 4 (2 turn(s) ago): supply_chain_coercion
- Turn 5 (1 turn(s) ago): middle_power_coalition, election_consolidation
