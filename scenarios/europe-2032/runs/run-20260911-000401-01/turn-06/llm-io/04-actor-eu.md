...
- characters 453-1274: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1317-2787: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3627-4098: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6239-8602: `{{previous_actions}}` from the actor's own response from the previous turn
