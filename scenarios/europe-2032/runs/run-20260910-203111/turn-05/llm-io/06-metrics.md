...
- characters 106-13394: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13437-13629: `{{metrics_json}}` from the run's live metric values
- characters 13722-15621: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15665-17784: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17840-19005: `{{notepad}}` from the Game Master's notepad, carried across turns
