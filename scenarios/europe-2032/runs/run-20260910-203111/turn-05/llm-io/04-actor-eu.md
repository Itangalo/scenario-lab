...
- characters 2398-4517: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7666-8131: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10323-12231: `{{previous_actions}}` from the actor's own response from the previous turn
