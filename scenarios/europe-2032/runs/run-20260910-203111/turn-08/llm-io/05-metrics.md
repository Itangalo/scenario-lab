...
- characters 13269-13460: `{{metrics_json}}` from the run's live metric values
- characters 13553-15169: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15212-18319: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18375-18845: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Containment and Trust Recovery Pact | 2 |
| M10 | EU Degraded Operations Endurance Fund | 2 |
