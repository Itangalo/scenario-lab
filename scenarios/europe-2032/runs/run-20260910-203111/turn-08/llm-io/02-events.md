...
- characters 375-1991: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2034-5141: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5197-5667: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5730-29349: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29704-30457: `{{event_history}}` from the run's own event record
...
- Turn 2 (6 turn(s) ago): cyber_major_incident, safety_breakthrough, emergent_bio_publication_fight, emergent_talent_retention_pact
- Turn 3 (5 turn(s) ago): eu_frontier_access_denied, automated_decision_scandal, emergent_municipal_backlash_strike
- Turn 4 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, member_state_defection, emergent_municipal_cyber_insurance_crunch
- Turn 5 (3 turn(s) ago): cyber_major_incident, ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented, supply_chain_coercion, election_retrenchment
- Turn 6 (2 turn(s) ago): eu_frontier_access_denied
- Turn 7 (1 turn(s) ago): bio_incident, loss_of_control_incident, adoption_success
