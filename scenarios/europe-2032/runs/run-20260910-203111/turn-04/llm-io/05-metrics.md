...
- characters 105-13294: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13337-13529: `{{metrics_json}}` from the run's live metric values
- characters 13622-15452: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15495-17895: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17951-18475: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Municipal Pooled Cyber Cover Facility | 2 |
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Continuity Deployment Stack −2, EU Municipal Pooled Cyber Cover Facility −2, priority −1 = −11
PROPOSAL BONUS: EU Municipal Pooled Cyber Cover Facility (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly, municipal insurance crunch adds weight
LEGITIMACY LENDS: capital 13, sentiment 18 -> +2
SOVEREIGNTY: 20 last turn, no capacity build finishes, Gigafactories in flight +0, member_state_defection t4 −2, capability rose 1.5 −0 = 18
