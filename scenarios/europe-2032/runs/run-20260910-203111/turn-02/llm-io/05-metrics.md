...
- characters 105-13256: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13299-13491: `{{metrics_json}}` from the run's live metric values
- characters 13584-14858: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14901-17033: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17089-17517: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | Joint Incident Response and OT Recovery Force | 2 |
...
PORTFOLIO CHARGE t1: Gigafactories −3, Tech sovereignty package −3, Grid Shield Hardening Programme −2, priority −1 = −9
PROPOSAL BONUS: Grid Shield Hardening Programme (cat 6, small) +2 — autumn cross-continent test-shot intrusion landed this turn and this answers it directly
...
## Notepad
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, Joint Incident Response and OT Recovery Force −2, priority −1 = −9
PROPOSAL BONUS: Joint Incident Response and OT Recovery Force (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 38, sentiment 35 -> none, capital higher
SOVEREIGNTY: 22 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 22
## Store changes
```json
