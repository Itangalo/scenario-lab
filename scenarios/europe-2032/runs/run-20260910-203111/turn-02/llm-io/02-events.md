...
- characters 1693-3825: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3881-4957: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5020-28302: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28657-28698: `{{event_history}}` from the run's own event record
