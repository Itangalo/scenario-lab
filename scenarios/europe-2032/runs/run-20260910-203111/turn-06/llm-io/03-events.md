...
- characters 376-3227: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3270-5826: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5882-6984: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 7047-28368: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28723-29341: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Bio Shield Detection Net −2, priority −1 = −9
PROPOSAL BONUS: EU Bio Shield Detection Net (cat 6, small) +3 — bio_uplift_findings precursor opened 4-turn gate this turn and this answers it directly, amid cyber-brittle towns
LEGITIMACY LENDS: capital 13, sentiment 16 -> +1
SOVEREIGNTY: 18 last turn, no capacity event? supply_chain_coercion t5 −2, no cat4 finish, in flight +0, capability rose 1.5 −0 = 16

## Emerging developments (tracked)

- `emergent_anti_datacentre_blockades` -- first noted turn 5, listed in 1 turn(s) so far: Coordinated protests and site blockades target planned gigafactory and data-centre locations across several member states, delaying permits and construction amid hostility to AI infrastructure.
- `emergent_reinsurer_retreat` -- first noted turn 5, listed in 1 turn(s) so far: Major global cyber-reinsurers announce a coordinated pause on new municipal industrial-control cover across Europe, citing correlated AI-assisted loss, forcing towns onto the EU pooled facility or to go uninsured.
...
- Turn 2 (4 turn(s) ago): cyber_major_incident, safety_breakthrough, emergent_bio_publication_fight, emergent_talent_retention_pact
- Turn 3 (3 turn(s) ago): eu_frontier_access_denied, automated_decision_scandal, emergent_municipal_backlash_strike
- Turn 4 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, member_state_defection, emergent_municipal_cyber_insurance_crunch
- Turn 5 (1 turn(s) ago): cyber_major_incident, ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented, supply_chain_coercion, election_retrenchment
