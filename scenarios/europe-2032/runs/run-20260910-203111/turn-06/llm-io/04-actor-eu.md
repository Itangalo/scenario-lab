...
- characters 454-3305: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3348-5904: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6393-6893: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9219-11695: `{{previous_actions}}` from the actor's own response from the previous turn
