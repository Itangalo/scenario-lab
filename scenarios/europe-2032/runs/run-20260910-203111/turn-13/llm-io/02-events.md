...
- characters 377-1468: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1512-3794: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3850-4494: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4557-27429: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27784-28918: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M12 −2, priority −1 = −3
PROPOSAL BONUS: none — new M12 answers coalition opportunity, not a negative event from last three turns
LEGITIMACY LENDS: capital 11, sentiment 3 -> none
SOVEREIGNTY: 14 last turn, no cat4 finish or in flight, middle_power_coalition t12 +2, capability rose 0.5 −0 = 16

## Emerging developments (tracked)

- `emergent_graduate_certification_boycott` -- first noted turn 12, listed in 1 turn(s) so far: A coordinated graduate-led boycott of foreign-model certifications spreads across universities in three member states, collapsing enrolment in EU-mandated fallback-system courses for a semester.
...
- Turn 2 (11 turn(s) ago): cyber_major_incident, safety_breakthrough, emergent_bio_publication_fight, emergent_talent_retention_pact
- Turn 3 (10 turn(s) ago): eu_frontier_access_denied, automated_decision_scandal, emergent_municipal_backlash_strike
- Turn 4 (9 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, member_state_defection, emergent_municipal_cyber_insurance_crunch
- Turn 5 (8 turn(s) ago): cyber_major_incident, ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented, supply_chain_coercion, election_retrenchment
- Turn 6 (7 turn(s) ago): eu_frontier_access_denied
- Turn 7 (6 turn(s) ago): bio_incident, loss_of_control_incident, adoption_success
- Turn 9 (4 turn(s) ago): capability_jump, opaque_reasoning, openweight_frontier_release, labour_displacement, us_china_agreement, eu_frontier_access_denied, member_state_defection
- Turn 10 (3 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, labour_displacement
- Turn 12 (1 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, middle_power_coalition
