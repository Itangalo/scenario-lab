...
- characters 106-12943: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12986-13178: `{{metrics_json}}` from the run's live metric values
- characters 13271-14609: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14653-17168: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17224-18003: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Continuity Deployment Stack | 2 |
...
- `emergent_municipal_cyber_insurance_crunch` -- first noted turn 3, listed in 1 turn(s) so far: Major cyber-insurers sharply raise premiums or pause cover for unhardened municipal and OT systems after the February sweep, forcing towns and utilities toward pooled EU-backed cover.
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, Joint Incident Response and OT Recovery Force −2, EU Continuity Deployment Stack −2, priority −1 = −11
PROPOSAL BONUS: EU Continuity Deployment Stack (cat 9, small) +3 — frontier cutoff landed this turn and this answers it directly, municipal collapse adds weight
