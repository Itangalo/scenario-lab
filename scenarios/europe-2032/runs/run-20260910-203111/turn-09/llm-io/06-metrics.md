...
- characters 13308-13499: `{{metrics_json}}` from the run's live metric values
- characters 13592-15091: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15135-16745: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16801-17493: `{{notepad}}` from the Game Master's notepad, carried across turns
