...
- characters 376-1875: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1919-3529: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3585-3920: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3983-27602: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27957-28710: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M9 −2, M10 −2, priority −1 = −5
PROPOSAL BONUS: EU Degraded Operations Endurance Fund (cat 6, small) +2 — answers t7 bio-release and rogue-agent shocks by funding degraded fallback endurance
LEGITIMACY LENDS: capital 14, sentiment 6 -> none
SOVEREIGNTY: 18 last turn, no capacity event, capability rose 0.5 −0 = 18
...
- Turn 2 (7 turn(s) ago): cyber_major_incident, safety_breakthrough, emergent_bio_publication_fight, emergent_talent_retention_pact
- Turn 3 (6 turn(s) ago): eu_frontier_access_denied, automated_decision_scandal, emergent_municipal_backlash_strike
- Turn 4 (5 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, member_state_defection, emergent_municipal_cyber_insurance_crunch
- Turn 5 (4 turn(s) ago): cyber_major_incident, ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented, supply_chain_coercion, election_retrenchment
- Turn 6 (3 turn(s) ago): eu_frontier_access_denied
- Turn 7 (2 turn(s) ago): bio_incident, loss_of_control_incident, adoption_success
