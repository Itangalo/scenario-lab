...
- characters 377-4218: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 4262-6240: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6296-7407: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 7470-31901: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32256-32926: `{{event_history}}` from the run's own event record
...
- `emergent_anti_datacentre_blockades` -- first noted turn 5, listed in 2 turn(s) so far: Coordinated protests and site blockades target planned gigafactory and data-centre locations across several member states, delaying permits and construction amid hostility to AI infrastructure.
- `emergent_reinsurer_retreat` -- first noted turn 5, listed in 2 turn(s) so far: Major global cyber-reinsurers announce a coordinated pause on new municipal industrial-control cover across Europe, citing correlated AI-assisted loss, forcing towns onto the EU pooled facility or to go uninsured.
...
- Turn 1 (6 turn(s) ago): cyber_test_shot
- Turn 2 (5 turn(s) ago): cyber_major_incident, safety_breakthrough, emergent_bio_publication_fight, emergent_talent_retention_pact
- Turn 3 (4 turn(s) ago): eu_frontier_access_denied, automated_decision_scandal, emergent_municipal_backlash_strike
- Turn 4 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, member_state_defection, emergent_municipal_cyber_insurance_crunch
- Turn 5 (2 turn(s) ago): cyber_major_incident, ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented, supply_chain_coercion, election_retrenchment
- Turn 6 (1 turn(s) ago): eu_frontier_access_denied
