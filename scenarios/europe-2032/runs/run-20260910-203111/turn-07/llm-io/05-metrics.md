...
- characters 13721-17562: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 17606-19584: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 19640-20134: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 59.0, "ai_safety": 27.0, "resilience": 42.0, "eu_ai_sovereignty": 22.0, "eu_political_capital": 14.0, "public_sentiment": 6.0}
```
