...
- characters 106-13190: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13233-13423: `{{metrics_json}}` from the run's live metric values
- characters 13516-14578: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14621-16134: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16190-16774: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU–Middle-Power Supply-Chain Bargain | 2 |
...
PORTFOLIO CHARGE t11: M11 −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 12, sentiment 0 -> none
...
## Metrics
```json
{"ai_capability": 66.5, "openweight_capability": 65.1, "ai_safety": 14.0, "resilience": 52.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 11.0, "public_sentiment": 3.0}
```
