...
- characters 375-1437: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1480-2993: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3049-3305: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3368-26240: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26595-27627: `{{event_history}}` from the run's own event record
...
- Turn 2 (10 turn(s) ago): cyber_major_incident, safety_breakthrough, emergent_bio_publication_fight, emergent_talent_retention_pact
- Turn 3 (9 turn(s) ago): eu_frontier_access_denied, automated_decision_scandal, emergent_municipal_backlash_strike
- Turn 4 (8 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, member_state_defection, emergent_municipal_cyber_insurance_crunch
- Turn 5 (7 turn(s) ago): cyber_major_incident, ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented, supply_chain_coercion, election_retrenchment
- Turn 6 (6 turn(s) ago): eu_frontier_access_denied
- Turn 7 (5 turn(s) ago): bio_incident, loss_of_control_incident, adoption_success
- Turn 9 (3 turn(s) ago): capability_jump, opaque_reasoning, openweight_frontier_release, labour_displacement, us_china_agreement, eu_frontier_access_denied, member_state_defection
- Turn 10 (2 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, labour_displacement
