...
- characters 376-1805: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1848-3824: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3880-4690: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4753-27625: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27980-28914: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M10 −2, M11 −2, priority −1 = −5
PROPOSAL BONUS: EU Entry-Level Transition Guarantee (cat 7, small) +2 — labour_displacement landed this turn and this answers it directly, amid access cut-off and defection
LEGITIMACY LENDS: capital 10, sentiment 3 -> none
SOVEREIGNTY: 18 last turn, no capacity event, no cat4 finish or in flight, eu_frontier_access_denied t9 −3 (largest of access-denied and defection), capability rose 3.5 −1 = 14

## Emerging developments (tracked)

- `emergent_endurance_audit_reprieve` -- first noted turn 9, listed in 1 turn(s) so far: Regional hospital networks publish a joint audit showing manual-fallback procedures kept mortality stable during degraded operations, briefly reframing endurance as competence and easing local opposition to EU health coordination.
...
- Turn 2 (8 turn(s) ago): cyber_major_incident, safety_breakthrough, emergent_bio_publication_fight, emergent_talent_retention_pact
- Turn 3 (7 turn(s) ago): eu_frontier_access_denied, automated_decision_scandal, emergent_municipal_backlash_strike
- Turn 4 (6 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, member_state_defection, emergent_municipal_cyber_insurance_crunch
- Turn 5 (5 turn(s) ago): cyber_major_incident, ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented, supply_chain_coercion, election_retrenchment
- Turn 6 (4 turn(s) ago): eu_frontier_access_denied
- Turn 7 (3 turn(s) ago): bio_incident, loss_of_control_incident, adoption_success
- Turn 9 (1 turn(s) ago): capability_jump, opaque_reasoning, openweight_frontier_release, labour_displacement, us_china_agreement, eu_frontier_access_denied, member_state_defection
