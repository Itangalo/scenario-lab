...
- characters 454-1883: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1926-3902: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4908-5386: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8349-10822: `{{previous_actions}}` from the actor's own response from the previous turn
