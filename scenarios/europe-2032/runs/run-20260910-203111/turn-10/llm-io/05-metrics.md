...
- characters 13518-14947: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14990-16966: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17022-17832: `{{notepad}}` from the Game Master's notepad, carried across turns
