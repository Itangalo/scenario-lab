...
- characters 377-1508: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1552-3826: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3882-4495: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4558-27430: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27785-28816: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M11 −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 10, sentiment 3 -> none
SOVEREIGNTY: 14 last turn, no capacity event, no cat4 finish or in flight, capability rose 0.5 −0 = 14

## Emerging developments (tracked)

- `emergent_endurance_audit_reprieve` -- first noted turn 9, listed in 2 turn(s) so far: Regional hospital networks publish a joint audit showing manual-fallback procedures kept mortality stable during degraded operations, briefly reframing endurance as competence and easing local opposition to EU health coordination.
...
- Turn 2 (9 turn(s) ago): cyber_major_incident, safety_breakthrough, emergent_bio_publication_fight, emergent_talent_retention_pact
- Turn 3 (8 turn(s) ago): eu_frontier_access_denied, automated_decision_scandal, emergent_municipal_backlash_strike
- Turn 4 (7 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release, member_state_defection, emergent_municipal_cyber_insurance_crunch
- Turn 5 (6 turn(s) ago): cyber_major_incident, ai_investment_collapse, bio_uplift_findings, knowledge_work_augmented, supply_chain_coercion, election_retrenchment
- Turn 6 (5 turn(s) ago): eu_frontier_access_denied
- Turn 7 (4 turn(s) ago): bio_incident, loss_of_control_incident, adoption_success
- Turn 9 (2 turn(s) ago): capability_jump, opaque_reasoning, openweight_frontier_release, labour_displacement, us_china_agreement, eu_frontier_access_denied, member_state_defection
- Turn 10 (1 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, labour_displacement
