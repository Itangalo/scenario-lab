...
- characters 12865-13056: `{{metrics_json}}` from the run's live metric values
- characters 13149-14280: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14324-16598: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16654-16910: `{{notepad}}` from the Game Master's notepad, carried across turns
