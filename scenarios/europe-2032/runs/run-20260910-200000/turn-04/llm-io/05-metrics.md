...
- characters 13274-15956: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15999-18016: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18072-18951: `{{notepad}}` from the Game Master's notepad, carried across turns
