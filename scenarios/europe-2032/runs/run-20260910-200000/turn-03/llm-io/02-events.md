...
- characters 377-2013: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2057-4394: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4450-5413: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5476-28040: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28395-28613: `{{event_history}}` from the run's own event record
...
- Turn 2 (1 turn(s) ago): loss_of_control_incident, taiwan_blockade, knowledge_work_augmented, export_control_escalation, emergent_sovereign_hosting_offer
