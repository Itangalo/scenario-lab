...
- characters 106-13322: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13365-13557: `{{metrics_json}}` from the run's live metric values
- characters 13650-15286: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15330-17667: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17723-18339: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Open-Weights Consequence Shield | 2 |
...
## Metrics
```json
{"ai_capability": 56.5, "openweight_capability": 50.5, "ai_safety": 28.0, "resilience": 41.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 30.0, "public_sentiment": 35.0}
```
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Sovereign Hosting and Supply-Chain Compact −3, EU Open-Weights Consequence Shield −2, priority −1 = −12
PROPOSAL BONUS: EU Open-Weights Consequence Shield (cat 6, small) +4 — open-weight frontier release lands this turn unrecallable and this answers it directly, plus March rogue-agent and Autumn OT intrusions
LEGITIMACY LENDS: capital 28, sentiment 35 -> +2
