...
- characters 1693-3858: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4274-4744: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7307-9032: `{{previous_actions}}` from the actor's own response from the previous turn
