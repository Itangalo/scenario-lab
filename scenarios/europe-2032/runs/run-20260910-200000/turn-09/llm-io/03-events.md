...
- characters 377-1571: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1615-3780: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3836-4181: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4244-28373: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28728-29320: `{{event_history}}` from the run's own event record
...
- Turn 2 (7 turn(s) ago): loss_of_control_incident, taiwan_blockade, knowledge_work_augmented, export_control_escalation, emergent_sovereign_hosting_offer
- Turn 3 (6 turn(s) ago): openweight_frontier_release
- Turn 5 (4 turn(s) ago): taiwan_tension_rise, adoption_success, election_alliance
- Turn 6 (3 turn(s) ago): bio_incident, eval_anomaly_reports, openweight_frontier_release, automated_decision_scandal
- Turn 7 (2 turn(s) ago): knowledge_work_augmented
- Turn 8 (1 turn(s) ago): cyber_major_incident, taiwan_tension_rise
