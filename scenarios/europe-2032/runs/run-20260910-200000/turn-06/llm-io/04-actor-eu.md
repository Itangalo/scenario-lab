...
- characters 454-1920: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1963-4285: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6836-7306: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9674-11916: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | European Trustworthy Adoption Accelerator | 9 | small | 5 | 7 | own jurisdiction | public_sentiment up materially, eu_political_capital up slightly, resilience up slightly | 2 | running |
