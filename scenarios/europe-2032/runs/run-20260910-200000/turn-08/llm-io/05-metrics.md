...
- characters 13258-13450: `{{metrics_json}}` from the run's live metric values
- characters 13543-14937: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14980-17300: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17356-17664: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Municipal Services Cyber Restoration Surge | 2 |
