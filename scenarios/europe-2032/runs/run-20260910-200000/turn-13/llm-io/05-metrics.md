...
- characters 107-13238: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13281-13472: `{{metrics_json}}` from the run's live metric values
- characters 13565-14753: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14797-16862: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16918-17367: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t13: M12 EU Joint Cyber Command Accession −2, priority −0 (capital below 20, no effect, no cost) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1.0 after charge/finish/events, sentiment 12.0 -> +1 (capped below sentiment)
SOVEREIGNTY: 25 last turn, no capacity event, no cat4 in flight +0, capability rose 0.7 −0 = 25
