...
- characters 377-1565: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1609-3674: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3730-4499: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4562-28883: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29238-30164: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M11 EU Transition Guarantee Scale-Up and Redress Facility −2, M12 EU Joint Cyber Command Accession −2, priority −0 (capital below 20, no effect, no cost) = −4
PROPOSAL BONUS: none — M12 (cat 6, small) answers joint invitation opportunity, not a negative event from last three rounds
LEGITIMACY LENDS: capital 11, sentiment 17 -> +2
SOVEREIGNTY: 25 last turn, no capacity event, no cat4 in flight +0, capability rose 0.7 −0 = 25

## Emerging developments (tracked)

- `emergent_graduate_protest_wave` -- first noted turn 11, listed in 2 turn(s) so far: Coordinated graduate-led protests across several university cities block data-centre expansion hearings and demand hiring guarantees, turning graduate unemployment into sustained street pressure.
...
- Turn 2 (11 turn(s) ago): loss_of_control_incident, taiwan_blockade, knowledge_work_augmented, export_control_escalation, emergent_sovereign_hosting_offer
- Turn 3 (10 turn(s) ago): openweight_frontier_release
- Turn 5 (8 turn(s) ago): taiwan_tension_rise, adoption_success, election_alliance
- Turn 6 (7 turn(s) ago): bio_incident, eval_anomaly_reports, openweight_frontier_release, automated_decision_scandal
- Turn 7 (6 turn(s) ago): knowledge_work_augmented
- Turn 8 (5 turn(s) ago): cyber_major_incident, taiwan_tension_rise
- Turn 9 (4 turn(s) ago): safety_breakthrough
- Turn 10 (3 turn(s) ago): labour_displacement, member_state_defection, automated_decision_scandal
- Turn 11 (2 turn(s) ago): ai_investment_collapse, automated_decision_scandal
- Turn 12 (1 turn(s) ago): automated_decision_scandal, joint_threat_response, emergent_graduate_occupations
