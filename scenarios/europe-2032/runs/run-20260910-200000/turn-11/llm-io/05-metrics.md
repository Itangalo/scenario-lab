...
- characters 107-13270: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13313-13505: `{{metrics_json}}` from the run's live metric values
- characters 13598-14991: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15035-17326: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17382-18450: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Transition Guarantee Scale-Up and Redress Facility | 2 |
...
PORTFOLIO CHARGE t10: M10 EU Graduate and Displaced-Worker Transition Guarantee −2, priority −1 = −3
PROPOSAL BONUS: M10 (cat 7, small) +3 — labour_displacement landed this turn and this answers it directly, plus displacement pressure building
LEGITIMACY LENDS: capital 17, sentiment 22 -> +2 (included in capital arithmetic, capped below sentiment)
SOVEREIGNTY: 29 last turn, no cat4 finish, no cat4 in flight, member_state_defection t10 −2, capability rose 0.7 −0 = 27
