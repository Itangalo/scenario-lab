...
- characters 106-12882: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12925-13117: `{{metrics_json}}` from the run's live metric values
- characters 13210-14405: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14448-16542: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16598-17410: `{{notepad}}` from the Game Master's notepad, carried across turns
