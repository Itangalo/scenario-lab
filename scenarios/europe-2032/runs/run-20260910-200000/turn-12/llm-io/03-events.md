...
- characters 377-1572: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1615-3709: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3765-4855: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4918-28386: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28741-29558: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M11 EU Transition Guarantee Scale-Up and Redress Facility −2, priority −0 (capital below 20, no effect, no cost) = −2
PROPOSAL BONUS: M11 (cat 7, small) +4 — graduate unemployment crisis and benefits-scoring scandal both landed last turn/this turn and this answers them directly, small size caps it
LEGITIMACY LENDS: capital 9, sentiment 17 -> +2
SOVEREIGNTY: 27 last turn, no cat4 finish, no cat4 in flight +0, ai_investment_collapse t11 −2, capability rose 0.6 −0 = 25

## Emerging developments (tracked)

- `emergent_graduate_occupations` -- first noted turn 11, listed in 1 turn(s) so far: Coordinated graduate occupations of university administration buildings across several EU capitals demanding hiring quotas and AI hiring levies, forcing emergency education-ministers council.
- `emergent_graduate_protest_wave` -- first noted turn 11, listed in 1 turn(s) so far: Coordinated graduate-led protests across several university cities block data-centre expansion hearings and demand hiring guarantees, turning graduate unemployment into sustained street pressure.
...
- Turn 2 (10 turn(s) ago): loss_of_control_incident, taiwan_blockade, knowledge_work_augmented, export_control_escalation, emergent_sovereign_hosting_offer
- Turn 3 (9 turn(s) ago): openweight_frontier_release
- Turn 5 (7 turn(s) ago): taiwan_tension_rise, adoption_success, election_alliance
- Turn 6 (6 turn(s) ago): bio_incident, eval_anomaly_reports, openweight_frontier_release, automated_decision_scandal
- Turn 7 (5 turn(s) ago): knowledge_work_augmented
- Turn 8 (4 turn(s) ago): cyber_major_incident, taiwan_tension_rise
- Turn 9 (3 turn(s) ago): safety_breakthrough
- Turn 10 (2 turn(s) ago): labour_displacement, member_state_defection, automated_decision_scandal
- Turn 11 (1 turn(s) ago): ai_investment_collapse, automated_decision_scandal
