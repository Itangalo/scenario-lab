...
- characters 377-1526: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1570-3359: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3415-4156: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4219-27282: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27637-27909: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Sovereign Hosting and Supply-Chain Compact −3, M5 EU Open-Weights Consequence Shield −2, priority −1 = −12
...
- `emergent_municipal_insurance_pullback` -- first noted turn 4, listed in 1 turn(s) so far: Municipal insurers begin refusing to cover OT and hospital outages tied to unpatched open-weight tooling, forcing a wave of deferred digitisation projects to stall across mid-sized cities.
...
- Turn 2 (3 turn(s) ago): loss_of_control_incident, taiwan_blockade, knowledge_work_augmented, export_control_escalation, emergent_sovereign_hosting_offer
