...
- characters 455-1604: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1648-3437: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4917-5377: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7549-8633: `{{previous_actions}}` from the actor's own response from the previous turn
