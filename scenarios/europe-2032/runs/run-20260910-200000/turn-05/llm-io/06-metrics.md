...
- characters 13836-14985: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15029-16818: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16874-17615: `{{notepad}}` from the Game Master's notepad, carried across turns
