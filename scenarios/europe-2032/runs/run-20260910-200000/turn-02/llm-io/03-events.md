...
- characters 1752-3821: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3877-4979: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5042-28324: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28679-28742: `{{event_history}}` from the run's own event record
