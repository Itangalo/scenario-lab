...
- characters 105-12938: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12981-13173: `{{metrics_json}}` from the run's live metric values
- characters 13266-14599: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14642-16711: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16767-17592: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Sovereign Hosting and Supply-Chain Compact | 3 |
...
- `emergent_journal_biosecurity_boycott` -- first noted turn 1, listed in 2 turn(s) so far: A major European scientific publisher or preprint server imposes mandatory biosecurity screening and refusal to publish AI-designed pathogen methods after the phage results, triggering a wider journals boycott debate.
