...
- characters 106-13247: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13290-13482: `{{metrics_json}}` from the run's live metric values
- characters 13575-14742: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14785-16726: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16782-17150: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Graduate and Displaced-Worker Transition Guarantee | 2 |
...
PORTFOLIO CHARGE t9: M9 EU Assured Deployment Certification Fast-Track −2, priority −1 = −3
PROPOSAL BONUS: none — new M9 (cat 5, small) answers safety_breakthrough positive advance, not a negative event from last three rounds
LEGITIMACY LENDS: capital 19, sentiment 28 -> +2
SOVEREIGNTY: 29 last turn, no capacity event, no cat4 in flight, capability rose 0.7 −0 = 29
