...
- characters 1665-3606: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5575-6017: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8771-10872: `{{previous_actions}}` from the actor's own response from the previous turn
