...
- characters 2160-4424: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4480-4995: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5058-28584: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28939-29412: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): loss_of_control_incident, taiwan_blockade, knowledge_work_augmented, export_control_escalation, emergent_sovereign_hosting_offer
- Turn 3 (4 turn(s) ago): openweight_frontier_release
- Turn 5 (2 turn(s) ago): taiwan_tension_rise, adoption_success, election_alliance
- Turn 6 (1 turn(s) ago): bio_incident, eval_anomaly_reports, openweight_frontier_release, automated_decision_scandal
