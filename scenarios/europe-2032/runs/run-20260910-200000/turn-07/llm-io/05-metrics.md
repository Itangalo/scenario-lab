...
- characters 13711-15450: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15494-17758: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17814-18329: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.7, "openweight_capability": 58.4, "ai_safety": 22.0, "resilience": 42.0, "eu_ai_sovereignty": 29.0, "eu_political_capital": 22.0, "public_sentiment": 34.0}
```
