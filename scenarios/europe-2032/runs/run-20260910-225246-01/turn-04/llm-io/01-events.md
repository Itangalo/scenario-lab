...
- characters 376-2030: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2073-4044: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4100-5240: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5303-30207: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30562-30724: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): bio_uplift_findings, openweight_frontier_release
- Turn 3 (1 turn(s) ago): safety_breakthrough
