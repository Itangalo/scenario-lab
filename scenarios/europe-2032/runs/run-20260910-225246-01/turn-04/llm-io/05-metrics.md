...
- characters 105-13517: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13560-13752: `{{metrics_json}}` from the run's live metric values
- characters 13845-15499: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15542-17513: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17569-18082: `{{notepad}}` from the Game Master's notepad, carried across turns
