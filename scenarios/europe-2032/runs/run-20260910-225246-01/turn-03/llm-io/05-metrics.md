...
- characters 106-13173: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13216-13408: `{{metrics_json}}` from the run's live metric values
- characters 13501-14908: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14952-16979: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17035-18176: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Bio-Cyber Evaluation Cell | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, EU Bio-Cyber Evaluation Cell −2, priority −1 = −12
PROPOSAL BONUS: EU Bio-Cyber Evaluation Cell (cat 5, small) +3 — bio uplift precursor this turn plus unrecallable frontier open release this turn and grid intrusions last turn, this answers them directly
...
- `emergent_grid_tooling_copycats` -- first noted turn 2, listed in 2 turn(s) so far: Copycat crews reuse the leaked grid-probing tooling for extortion against European municipal utilities and regional water operators, forcing paid shutdowns and public ransom disputes.
- `emergent_toolkit_teardown_row` -- first noted turn 2, listed in 2 turn(s) so far: Independent university teams publish a reproducible teardown showing how the freely available frontier-class model was adapted into the grid-probing toolkit, triggering repository takedown demands and a cross-border press controversy.
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, EU Bio-Cyber Evaluation Cell −2, EU Assured Deployment Upgrade −2, priority −1 = −14
PROPOSAL BONUS: none — safety_breakthrough is positive and adoptable, not a negative shock this measure answers; no negative event in last three turns directly answered
LEGITIMACY LENDS: capital 11, sentiment 38 -> +2
