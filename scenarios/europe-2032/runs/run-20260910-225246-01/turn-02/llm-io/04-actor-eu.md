...
- characters 4703-5175: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6647-8774: `{{previous_actions}}` from the actor's own response from the previous turn
