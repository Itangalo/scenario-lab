...
- characters 106-13456: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13499-13691: `{{metrics_json}}` from the run's live metric values
- characters 13784-15694: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15738-17657: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17713-18411: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Assured Deployment Upgrade | 2 |
...
|---|---|---|---|---|---|---|---|---|---|
| M4 | EU Bio-Cyber Evaluation Cell | 5 | small | 2 | 5 | own jurisdiction | ai_safety up, resilience up via bio/cyber detection | 2 | finished |
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Bio-Cyber Evaluation Cell −2, EU Assured Deployment Upgrade −2, priority −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 10, sentiment 35 -> +2
SOVEREIGNTY: 19 last turn, no capacity measure finishes, Gigafactories in flight +0, export_control_escalation t4 −2, capability rose 2.0 −1 = 16

## Emerging developments (tracked)

- `emergent_siting_freeze` -- first noted turn 5, listed in 1 turn(s) so far: Coordinated municipal opposition and court injunctions stall two gigafactory and data-centre sites over power prices and water use, freezing construction through winter.
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Assured Deployment Upgrade −2, priority −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 8, sentiment 29 -> +2
