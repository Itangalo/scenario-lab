...
- characters 455-2365: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2409-4328: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6948-7420: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9504-10773: `{{previous_actions}}` from the actor's own response from the previous turn
