...
- characters 377-2287: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2331-4250: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4306-4719: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4782-33267: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33622-33906: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): bio_uplift_findings, openweight_frontier_release
- Turn 3 (2 turn(s) ago): safety_breakthrough
- Turn 4 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, knowledge_work_augmented, export_control_escalation
