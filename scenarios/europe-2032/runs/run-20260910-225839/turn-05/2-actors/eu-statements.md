...
- `two_year_commitment` (commitment): Rebuild trusted resilient public services under enforceable AI safeguards

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild trusted resilient public services under enforceable AI safeguards
