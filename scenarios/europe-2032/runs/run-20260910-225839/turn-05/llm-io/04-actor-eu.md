...
- characters 2066-4159: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7745-8185: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10325-11533: `{{previous_actions}}` from the actor's own response from the previous turn
