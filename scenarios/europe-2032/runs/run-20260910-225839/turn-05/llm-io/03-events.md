...
- characters 1988-4081: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4137-4541: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4604-33089: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33444-33732: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Cyber Shield −3, EU AI Incident Reporting and High-Risk Enforcement Fix −2, priority −1 = −12
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 26 -> +2
...
- Turn 3 (2 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, automated_decision_scandal, emergent_grid_hardware_backlog
- Turn 4 (1 turn(s) ago): knowledge_work_augmented, automated_decision_scandal, emergent_grid_disclosure_cascade
