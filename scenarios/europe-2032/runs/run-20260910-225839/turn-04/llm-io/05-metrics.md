...
- characters 105-13535: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13578-13770: `{{metrics_json}}` from the run's live metric values
- characters 13863-15412: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15455-17606: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17662-18290: `{{notepad}}` from the Game Master's notepad, carried across turns
