...
- characters 454-2515: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2558-4780: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5312-5765: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8215-10590: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Middle-Power Supply-Chain Compact | 8 | small | 5 | 7 | coalition | eu_ai_sovereignty up, eu_political_capital up modestly via leverage | 2 | running |
