...
- characters 4675-5115: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6569-8660: `{{previous_actions}}` from the actor's own response from the previous turn
