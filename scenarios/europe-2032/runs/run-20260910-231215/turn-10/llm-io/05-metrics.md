...
- characters 106-13537: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13580-13772: `{{metrics_json}}` from the run's live metric values
- characters 13865-14977: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15020-17167: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17223-18232: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Taiwan Shock Continuity Shield | 2 |
...
PORTFOLIO CHARGE t9: EU Graduate Transition Guarantee −2, EU Essential Services Continuity Reserve −2, priority −1 = −5
PROPOSAL BONUS: EU Essential Services Continuity Reserve (cat 6, small) +3 — answers US access withdrawal and peak-care risk from t8 directly
LEGITIMACY LENDS: capital 30, sentiment 44.5 -> +2
SOVEREIGNTY: 19.5 last turn, no capacity event, no category 4 in flight +0, capability rose 0.7 −0 = 19.5

## Emerging developments (tracked)

- `emergent_inference_siting_backlash` -- first noted turn 10, listed in 1 turn(s) so far: A coordinated campaign of physical sabotage and blockades targets new domestic inference sites and grid connections in two member states, delaying reserved peak-overflow capacity and forcing a public siting review.
- `emergent_datacentre_siting_backlash` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated physical protests and grid-connection blockades halt two domestic AI data-centre expansions, forcing a siting moratorium debate in the Council.
