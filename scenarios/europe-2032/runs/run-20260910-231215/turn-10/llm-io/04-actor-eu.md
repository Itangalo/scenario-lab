...
- characters 455-1567: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1610-3757: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4391-4839: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7854-10172: `{{previous_actions}}` from the actor's own response from the previous turn
