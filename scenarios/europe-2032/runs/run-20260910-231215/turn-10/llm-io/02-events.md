...
- characters 377-1489: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1532-3679: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3735-4153: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4216-29875: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30230-30801: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): taiwan_tension_rise
- Turn 3 (7 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 4 (6 turn(s) ago): safety_breakthrough, member_state_defection, adoption_success
- Turn 5 (5 turn(s) ago): capability_jump, middle_power_coalition, election_alliance
- Turn 6 (4 turn(s) ago): joint_threat_response
- Turn 7 (3 turn(s) ago): openweight_frontier_release, knowledge_work_augmented
- Turn 8 (2 turn(s) ago): research_breakthrough, labour_displacement, eu_frontier_access_denied, adoption_success
