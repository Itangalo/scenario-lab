...
- characters 106-12991: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13034-13226: `{{metrics_json}}` from the run's live metric values
- characters 13319-14994: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15037-16792: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16848-17292: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M14 | EU Chip Continuity and Upstream Leverage Regime | 2 |
...
## Notepad
PORTFOLIO CHARGE t12: EU Inference Siting and Grid Protection Pact −2, EU Chip Continuity and Upstream Leverage Regime −2, priority −1 = −5
PROPOSAL BONUS: EU Chip Continuity and Upstream Leverage Regime (cat 4, small) +4 — taiwan_blockade halting advanced exports this turn, severe and immediate, this answers supply continuity directly
LEGITIMACY LENDS: capital 31, sentiment 54 -> +2
SOVEREIGNTY: 19.5 last turn, no capacity event? no — taiwan_blockade t12 −2, EU Chip Continuity in flight +0, capability rose 0.6 −0 = 17.5
