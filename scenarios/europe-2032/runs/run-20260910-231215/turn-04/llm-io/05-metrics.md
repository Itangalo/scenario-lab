...
- characters 13891-15184: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15227-17768: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17824-18377: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Trusted Adoption Accelerator | 2 |
