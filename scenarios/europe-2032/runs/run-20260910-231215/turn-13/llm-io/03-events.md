...
- characters 378-1361: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1405-3455: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3511-4037: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4100-29894: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30249-31151: `{{event_history}}` from the run's own event record
...
- Turn 2 (11 turn(s) ago): taiwan_tension_rise
- Turn 3 (10 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 4 (9 turn(s) ago): safety_breakthrough, member_state_defection, adoption_success
- Turn 5 (8 turn(s) ago): capability_jump, middle_power_coalition, election_alliance
- Turn 6 (7 turn(s) ago): joint_threat_response
- Turn 7 (6 turn(s) ago): openweight_frontier_release, knowledge_work_augmented
- Turn 8 (5 turn(s) ago): research_breakthrough, labour_displacement, eu_frontier_access_denied, adoption_success
- Turn 10 (3 turn(s) ago): taiwan_tension_rise, adoption_success
- Turn 11 (2 turn(s) ago): research_breakthrough, emergent_inference_siting_backlash
- Turn 12 (1 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, bio_uplift_findings, taiwan_tension_rise, automated_decision_scandal, emergent_datacentre_siting_backlash
