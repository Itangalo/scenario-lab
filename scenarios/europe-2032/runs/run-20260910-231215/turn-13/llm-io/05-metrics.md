...
- characters 107-13432: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13475-13667: `{{metrics_json}}` from the run's live metric values
- characters 13760-14743: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14787-16837: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16893-17419: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M15 | EU Joint Threat Response Accession | 2 |
