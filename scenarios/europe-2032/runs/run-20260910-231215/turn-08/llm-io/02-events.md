...
- characters 376-2019: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2062-4543: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4599-5028: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5091-30750: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31105-31562: `{{event_history}}` from the run's own event record
...
- Turn 2 (6 turn(s) ago): taiwan_tension_rise
- Turn 3 (5 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 4 (4 turn(s) ago): safety_breakthrough, member_state_defection, adoption_success
- Turn 5 (3 turn(s) ago): capability_jump, middle_power_coalition, election_alliance
- Turn 6 (2 turn(s) ago): joint_threat_response
- Turn 7 (1 turn(s) ago): openweight_frontier_release, knowledge_work_augmented
