...
- characters 105-13302: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13345-13537: `{{metrics_json}}` from the run's live metric values
- characters 13630-15273: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15316-17797: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17853-18282: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Graduate Transition Guarantee | 2 |
...
PORTFOLIO CHARGE t7: EU Distributed Capability Shield −2, priority −1 = −3
PROPOSAL BONUS: EU Distributed Capability Shield (cat 6, small) +3 — answers unrecallable open-weight release this turn and summer ransomware sweep / partial shield join from prior turns
LEGITIMACY LENDS: capital 41, sentiment 43.5 -> +1
SOVEREIGNTY: 20.0 last turn, InvestAI Gigafactories finishes t7 +5, no capacity event, capability rose 0.7 −0 = 25.0
...
## Notepad
PORTFOLIO CHARGE t8: EU Graduate Transition Guarantee −2, priority −1 = −3
PROPOSAL BONUS: EU Graduate Transition Guarantee (cat 7, small) +4 — answers labour_displacement and eu_frontier_access_denied firing this turn directly
LEGITIMACY LENDS: capital 30, sentiment 43.0 -> +2
SOVEREIGNTY: 21.5 last turn, no category 4 finish, no category 4 in flight +0, eu_frontier_access_denied t8 −2, capability rose 0.7 −0 = 19.5
