...
- characters 107-13331: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13374-13566: `{{metrics_json}}` from the run's live metric values
- characters 13659-14811: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14855-17075: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17131-17819: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Inference Siting and Grid Protection Pact | 2 |
...
PORTFOLIO CHARGE t10: EU Taiwan Shock Continuity Shield −2, priority −1 = −3
PROPOSAL BONUS: EU Taiwan Shock Continuity Shield (cat 6, small) +2 — taiwan_tension_rise this turn signals strait closure risk and this answers supply continuity directly
LEGITIMACY LENDS: capital 37, sentiment 52 -> +2
SOVEREIGNTY: 19.5 last turn, no capacity event, no category 4 in flight +0, capability rose 0.7 −0 = 19.5

## Emerging developments (tracked)

- `emergent_datacentre_siting_backlash` -- first noted turn 10, listed in 2 turn(s) so far: Coordinated physical protests and grid-connection blockades halt two domestic AI data-centre expansions, forcing a siting moratorium debate in the Council.
...
## Notepad
PORTFOLIO CHARGE t11: EU Inference Siting and Grid Protection Pact −2, priority −1 = −3
PROPOSAL BONUS: EU Inference Siting and Grid Protection Pact (cat 6, small) +3 — coordinated sabotage/blockades firing this turn directly threaten continuity capacity and this answers siting legitimacy
LEGITIMACY LENDS: capital 36, sentiment 54 -> +2
SOVEREIGNTY: 19.5 last turn, no capacity event, no category 4 in flight +0, capability rose 0.7 −0 = 19.5
