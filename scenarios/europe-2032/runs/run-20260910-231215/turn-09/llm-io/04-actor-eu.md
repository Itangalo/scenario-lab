...
- characters 455-1349: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1393-3451: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3519-3972: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6945-9254: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Graduate Transition Guarantee | 7 | small | 8 | 10 | own jurisdiction | resilience up via labour absorption, eu_political_capital up via visible protection, public_sentiment up | 2 | running |
