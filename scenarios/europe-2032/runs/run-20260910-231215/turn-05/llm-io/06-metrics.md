...
- characters 13751-15331: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15375-17522: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17578-18522: `{{notepad}}` from the Game Master's notepad, carried across turns
