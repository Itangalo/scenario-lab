...
- characters 2001-4148: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4204-4804: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4867-28648: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29003-29247: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Incident Reporting Mandate −2, EU Trusted Adoption Accelerator −2, priority −1 = −11
PROPOSAL BONUS: EU Trusted Adoption Accelerator (cat 9, small) +4 — adoption_success landed this turn visible and attributed to EU, plus member_state_defection last/this turn directly answered by tying adoption to EU-hosted models
LEGITIMACY LENDS: capital 29, sentiment 38 -> +2
SOVEREIGNTY: 20 last turn, no capacity event [cat4 none finishes], Gigafactories in flight +0, member_state_defection t4 −2, capability rose 1.5 −0 = 18
...
- Turn 2 (3 turn(s) ago): taiwan_tension_rise
- Turn 3 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 4 (1 turn(s) ago): safety_breakthrough, member_state_defection, adoption_success
