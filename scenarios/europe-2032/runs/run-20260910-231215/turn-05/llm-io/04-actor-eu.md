...
- characters 2079-4226: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5863-6303: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8589-10585: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Trusted Adoption Accelerator | 9 | small | 4 | 6 | own jurisdiction | public_sentiment up, eu_political_capital up, eu_ai_sovereignty up modestly via demand pull | 2 | running |
