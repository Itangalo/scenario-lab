...
- characters 377-1861: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1905-5257: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5313-6165: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6228-31887: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32242-32619: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): taiwan_tension_rise
- Turn 3 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 4 (3 turn(s) ago): safety_breakthrough, member_state_defection, adoption_success
- Turn 5 (2 turn(s) ago): capability_jump, middle_power_coalition, election_alliance
