...
- characters 106-13590: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13633-13825: `{{metrics_json}}` from the run's live metric values
- characters 13918-15402: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15446-18798: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18854-19362: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Distributed Capability Shield | 2 |
