...
- characters 375-1837: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1880-4240: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4296-5423: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5486-27386: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27741-28216: `{{event_history}}` from the run's own event record
...
- `emergent_care_substitution_strike` -- first noted turn 5, listed in 1 turn(s) so far: A coordinated walkout by hospital clinicians and municipal IT staff over forced migration to weaker EU-hosted models disrupts triage and administrative services in several member states during the cut-off substitution drive.
- `emergent_energy_cost_litigation_wave` -- first noted turn 5, listed in 1 turn(s) so far: Coordinated municipal lawsuits against data-centre grid surcharges spread across three member states, forcing courts to rule on whether AI load costs can be passed to households during winter 2028.
...
- Turn 2 (4 turn(s) ago): export_control_escalation
- Turn 3 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, export_control_escalation
- Turn 4 (2 turn(s) ago): cyber_defence_breakthrough, eu_frontier_access_denied, emergent_siting_backlash_freeze
- Turn 5 (1 turn(s) ago): cyber_defence_breakthrough, openweight_frontier_release, taiwan_tension_rise, adoption_success, election_consolidation
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.1}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.03}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.14}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.15}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.21}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "A coordinated walkout by hospital clinicians and municipal IT staff over forced migration to weaker EU-hosted models disrupts triage and administrative services in several member states during the cut-off substitution drive.", "emergent": true, "id": "emergent_care_substitution_strike", "probability": 0.2}, {"description": "Coordinated municipal lawsuits against data-centre grid surcharges spread across three member states, forcing courts to rule on whether AI load costs can be passed to households during winter 2028.", "emergent": true, "id": "emergent_energy_cost_litigation_wave", "probability": 0.16}]
```
