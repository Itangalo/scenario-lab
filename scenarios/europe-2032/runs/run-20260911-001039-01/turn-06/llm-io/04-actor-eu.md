...
- characters 453-1915: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1958-4318: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5293-5765: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7849-9763: `{{previous_actions}}` from the actor's own response from the previous turn
...
- `two_year_commitment` (commitment): Keep essential services running on European-controlled AI through cut-off and open-model exposure
