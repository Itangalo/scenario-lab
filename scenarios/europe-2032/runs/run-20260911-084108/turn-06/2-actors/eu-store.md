...
- **applied** `M1` — {"op": "delete", "table": "measures", "id": "M1", "grounds": "€200bn gigafactory build unfundable with capital at 4 and no private money; permits held via compact instead"}
  - Grounds: €200bn gigafactory build unfundable with capital at 4 and no private money; permits held via compact instead
