...
- characters 13278-14518: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14561-16333: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16389-17348: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 54.5, "openweight_capability": 49.5, "ai_safety": 30.0, "resilience": 36.5, "eu_ai_sovereignty": 20.0, "eu_political_capital": 26.0, "public_sentiment": 32.0}
```
