...
- characters 1659-3431: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3487-4794: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4857-28139: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28494-28535: `{{event_history}}` from the run's own event record
