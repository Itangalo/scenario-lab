...
- characters 107-13201: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13244-13434: `{{metrics_json}}` from the run's live metric values
- characters 13527-14607: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14651-16985: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17041-17452: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Verified Public Benefit Rollout | 2 |
...
## Metrics
```json
{"ai_capability": 65.5, "openweight_capability": 64.0, "ai_safety": 4.0, "resilience": 46.0, "eu_ai_sovereignty": 7.0, "eu_political_capital": 4.0, "public_sentiment": 8.0}
```
