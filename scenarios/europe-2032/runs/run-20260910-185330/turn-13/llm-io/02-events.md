...
- characters 376-1456: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1500-3834: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3890-4301: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4364-28619: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28974-29973: `{{event_history}}` from the run's own event record
...
- Turn 2 (11 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, emergent_research_sovereignty_protests
- Turn 3 (10 turn(s) ago): export_control_escalation
- Turn 4 (9 turn(s) ago): member_state_defection
- Turn 5 (8 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, supply_chain_coercion, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, loss_of_control_incident, export_control_escalation
- Turn 8 (5 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, research_breakthrough
- Turn 9 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, export_control_escalation
- Turn 10 (3 turn(s) ago): opaque_reasoning, knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied, supply_chain_coercion, member_state_defection
- Turn 11 (2 turn(s) ago): cyber_major_incident, medical_breakthrough, export_control_escalation
- Turn 12 (1 turn(s) ago): cyber_major_incident, taiwan_tension_rise
