...
- characters 13335-13527: `{{metrics_json}}` from the run's live metric values
- characters 13620-15433: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15477-17174: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17230-17971: `{{notepad}}` from the Game Master's notepad, carried across turns
