...
- characters 377-2190: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2234-3931: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3987-4728: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4791-27412: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27767-28025: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU-US Volume Licence and Anti-Coercion Buffer −2, priority −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 15, sentiment 29 -> +2
SOVEREIGNTY: 18 last turn, no capacity finish, Gigafactories/tech package in flight +0, member_state_defection t4 −2, capability rose 1.5 −0 = 16

## Emerging developments (tracked)

- `emergent_clinical_staff_walkout` -- first noted turn 4, listed in 1 turn(s) so far: A coordinated walkout by radiologists and hospital technicians in two member states over slower open-weight clinical systems forces temporary ward closures, turning continuity migration into a national industrial dispute.
...
- Turn 2 (3 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, emergent_research_sovereignty_protests
