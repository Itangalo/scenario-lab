...
- characters 455-2268: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2312-4009: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6445-6905: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9024-10286: `{{previous_actions}}` from the actor's own response from the previous turn
