...
- characters 375-1303: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1346-3556: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3612-4400: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4463-28718: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29073-30002: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Municipal Cyber-Medical Continuity Corps −2, priority −1 = −3
PROPOSAL BONUS: EU Municipal Cyber-Medical Continuity Corps (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly, with cutoff continuity
LEGITIMACY LENDS: capital 14, sentiment 14 -> none, sentiment not above capital
SOVEREIGNTY: 11 last turn, no capacity finish, no cat4 in flight +0, export_control_escalation t11 −2, capability rose 0.7 −0 = 9

## Emerging developments (tracked)

- `emergent_care_staff_revolt` -- first noted turn 10, listed in 2 turn(s) so far: Municipal hospital staff in southern member states stage coordinated walkouts refusing to operate AI-segmented diagnostic clouds without hazard pay, forcing temporary reversion to fully manual triage.
...
- Turn 2 (10 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, emergent_research_sovereignty_protests
- Turn 3 (9 turn(s) ago): export_control_escalation
- Turn 4 (8 turn(s) ago): member_state_defection
- Turn 5 (7 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, supply_chain_coercion, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident, export_control_escalation
- Turn 8 (4 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, research_breakthrough
- Turn 9 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, export_control_escalation
- Turn 10 (2 turn(s) ago): opaque_reasoning, knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied, supply_chain_coercion, member_state_defection
- Turn 11 (1 turn(s) ago): cyber_major_incident, medical_breakthrough, export_control_escalation
