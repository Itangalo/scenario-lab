...
- characters 453-1381: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1424-3634: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4451-4898: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8131-10115: `{{previous_actions}}` from the actor's own response from the previous turn
