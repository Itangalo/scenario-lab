...
- characters 106-13209: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13252-13442: `{{metrics_json}}` from the run's live metric values
- characters 13535-14463: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14506-16716: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16772-17239: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Essential Care Continuity Corps | 2 |
...
## Metrics
```json
{"ai_capability": 64.8, "openweight_capability": 63.3, "ai_safety": 4.0, "resilience": 42.0, "eu_ai_sovereignty": 9.0, "eu_political_capital": 22.0, "public_sentiment": 11.0}
```
...
Brussels paid the overtime from repurposed digital and health budgets, which held the line but bred grievance. Mayors complained of hazard pay arriving late, and corridor talk of night-shift refusals persisted even as officials denied any walkout.
...
Washington offered no relief. Export licences tightened again under tiered rationing, with long-promised medical and recovery exemptions still unwritten. Pressure over servicing of older chip-making tools in the Netherlands continued; The Hague was placated with a shared-servicing arrangement rather than a confrontation.
