...
- characters 2833-3300: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 64.8, "openweight_capability": 63.3, "ai_safety": 6.0, "resilience": 42.0, "eu_ai_sovereignty": 9.0, "eu_political_capital": 14.0, "public_sentiment": 11.0}
```
