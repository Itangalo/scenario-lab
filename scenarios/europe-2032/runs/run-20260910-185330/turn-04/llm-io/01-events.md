...
- characters 376-2417: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2460-4287: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4343-4923: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4986-27607: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27962-28171: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, emergent_research_sovereignty_protests
- Turn 3 (1 turn(s) ago): export_control_escalation
