...
- characters 105-13288: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13331-13523: `{{metrics_json}}` from the run's live metric values
- characters 13616-15657: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15700-17527: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17583-18509: `{{notepad}}` from the Game Master's notepad, carried across turns
