...
- characters 377-1730: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1774-3889: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3945-4782: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4845-29100: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29455-30286: `{{event_history}}` from the run's own event record
...
- `emergent_care_staff_revolt` -- first noted turn 10, listed in 1 turn(s) so far: Municipal hospital staff in southern member states stage coordinated walkouts refusing to operate AI-segmented diagnostic clouds without hazard pay, forcing temporary reversion to fully manual triage.
...
- Turn 2 (9 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, emergent_research_sovereignty_protests
- Turn 3 (8 turn(s) ago): export_control_escalation
- Turn 4 (7 turn(s) ago): member_state_defection
- Turn 5 (6 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, supply_chain_coercion, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, export_control_escalation
- Turn 8 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, research_breakthrough
- Turn 9 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, export_control_escalation
- Turn 10 (1 turn(s) ago): opaque_reasoning, knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied, supply_chain_coercion, member_state_defection
