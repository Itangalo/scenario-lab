...
- characters 107-13240: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13283-13474: `{{metrics_json}}` from the run's live metric values
- characters 13567-14920: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14964-17079: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17135-17972: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Municipal Cyber-Medical Continuity Corps | 2 |
