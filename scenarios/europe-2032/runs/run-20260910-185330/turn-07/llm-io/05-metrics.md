...
- characters 106-13552: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13595-13787: `{{metrics_json}}` from the run's live metric values
- characters 13880-15071: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15115-17252: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17308-18475: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Municipal Repair and Work Transition Fund | 2 |
...
## Metrics
```json
{"ai_capability": 61.2, "openweight_capability": 59.0, "ai_safety": 20.0, "resilience": 39.5, "eu_ai_sovereignty": 21.0, "eu_political_capital": 22.0, "public_sentiment": 22.0}
```
## Narrative
### Concrete and cash
