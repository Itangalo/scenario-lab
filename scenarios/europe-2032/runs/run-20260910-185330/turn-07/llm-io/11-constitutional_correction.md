...
- characters 3559-4100: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.2, "openweight_capability": 58.0, "ai_safety": 20.0, "resilience": 35.5, "eu_ai_sovereignty": 16.0, "eu_political_capital": 13.0, "public_sentiment": 18.0}
```
