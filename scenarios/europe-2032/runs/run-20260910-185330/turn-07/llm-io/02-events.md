...
- characters 377-1568: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1612-3749: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3805-4346: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4409-28758: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29113-29591: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, emergent_research_sovereignty_protests
- Turn 3 (4 turn(s) ago): export_control_escalation
- Turn 4 (3 turn(s) ago): member_state_defection
- Turn 5 (2 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, supply_chain_coercion, election_consolidation
- Turn 6 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, export_control_escalation
