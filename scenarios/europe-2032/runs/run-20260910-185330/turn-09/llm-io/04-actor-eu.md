...
- characters 1610-4107: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5536-5997: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8709-10516: `{{previous_actions}}` from the actor's own response from the previous turn
