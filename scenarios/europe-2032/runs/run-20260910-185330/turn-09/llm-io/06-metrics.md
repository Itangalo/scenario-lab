...
- characters 13561-14672: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14716-17213: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17269-17740: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Critical Services Cyber Restoration Pact | 2 |
...
## Metrics
```json
{"ai_capability": 62.6, "openweight_capability": 60.8, "ai_safety": 16.0, "resilience": 37.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 18.0, "public_sentiment": 18.0}
```
