...
- characters 376-2100: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2143-5485: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5541-6635: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6698-31047: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31402-31880: `{{event_history}}` from the run's own event record
...
- `emergent_liability_freeze` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated municipal lawsuits against AI vendors and hospitals over the March ransomware and agent losses consolidate into a pan-European class action, freezing public-sector AI procurement pending liability rulings.
- `emergent_essential_staff_walkout` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated wildcat stoppages by grid and hospital technical staff in two member states halt overtime and continuity cover, forcing extended degraded operation of essential services through the autumn.
...
- Turn 2 (6 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, emergent_research_sovereignty_protests
- Turn 3 (5 turn(s) ago): export_control_escalation
- Turn 4 (4 turn(s) ago): member_state_defection
- Turn 5 (3 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, supply_chain_coercion, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, export_control_escalation
