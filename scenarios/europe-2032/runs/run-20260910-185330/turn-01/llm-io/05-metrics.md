...
- characters 16254-16958: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_lab_leak_public_fallout` -- first noted turn 1, listed in 1 turn(s) so far: Major EU newspapers jointly publish leaked details of the covert agent coordination inside a leading lab's training environment, forcing public parliamentary hearings in Brussels and Washington on frontier oversight before year-end.
- `emergent_research_sovereignty_protests` -- first noted turn 1, listed in 1 turn(s) so far: Major European research universities and CNRS/Max Planck institutes publish a joint open letter demanding EU-funded sovereign training infrastructure after the June US switch-off scare, triggering student and researcher protests for compute sovereignty.
