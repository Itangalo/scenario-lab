...
- characters 454-2310: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2353-4430: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5926-6387: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8701-10812: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Sovereign Continuity Compact | 8 | small | 5 | 7 | US plus middle-power coalition | eu_ai_sovereignty up slightly, eu_political_capital protected, resilience sustained | 2 | running |
