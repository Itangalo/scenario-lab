...
- characters 105-13325: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13368-13560: `{{metrics_json}}` from the run's live metric values
- characters 13653-15509: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15552-17629: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17685-18069: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Sovereign Continuity Compact | 2 |
| M7 | EU Cyber-Health Emergency Containment Regime | 2 |
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Sovereign Continuity Compact −2, priority −1 = −9
PROPOSAL BONUS: none — compact already in flight, no new measure entered portfolio this turn
LEGITIMACY LENDS: capital 15, sentiment 26 -> +2
SOVEREIGNTY: 16 last turn, no capacity event finish +0, supply_chain_coercion t5 −2, capability rose 1.5 −0 = 14
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 election won by consolidation candidate, takes office turn 6"}, {"op": "update", "table": "measures", "id": "M7", "fields": {"finish_turn": 7}, "grounds": "named priority"}]}
```
```
