...
- characters 376-2232: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2275-4352: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4408-5138: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5201-26440: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26795-27173: `{{event_history}}` from the run's own event record
...
- `emergent_clinical_staff_walkout` -- first noted turn 4, listed in 2 turn(s) so far: A coordinated walkout by radiologists and hospital technicians in two member states over slower open-weight clinical systems forces temporary ward closures, turning continuity migration into a national industrial dispute.
...
- Turn 2 (4 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, emergent_research_sovereignty_protests
- Turn 3 (3 turn(s) ago): export_control_escalation
- Turn 4 (2 turn(s) ago): member_state_defection
- Turn 5 (1 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, supply_chain_coercion, election_consolidation
