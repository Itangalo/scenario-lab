...
- characters 106-13218: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13261-13453: `{{metrics_json}}` from the run's live metric values
- characters 13546-15188: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15231-17201: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17257-17995: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Cutoff Fallback and Continuity Deployment | 2 |
