...
- characters 2140-4110: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6726-7173: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10051-12248: `{{previous_actions}}` from the actor's own response from the previous turn
