...
- characters 2062-4032: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4088-4505: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4568-29520: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29875-30540: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Critical Services Cyber Restoration Pact −2, priority −1 = −3
PROPOSAL BONUS: EU Critical Services Cyber Restoration Pact (cat 6, small) +4 — cyber_major_incident landed this turn and this answers containment directly
LEGITIMACY LENDS: capital 17, sentiment 22 -> +1
SOVEREIGNTY: 16 last turn, no capacity build finish or in flight, export_control_escalation t9 −2, capability rose 0.7 −0 = 14
...
- Turn 2 (8 turn(s) ago): ai_investment_collapse, eu_frontier_access_denied, emergent_research_sovereignty_protests
- Turn 3 (7 turn(s) ago): export_control_escalation
- Turn 4 (6 turn(s) ago): member_state_defection
- Turn 5 (5 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, supply_chain_coercion, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, export_control_escalation
- Turn 8 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, research_breakthrough
- Turn 9 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, export_control_escalation
