...
- characters 106-13309: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13352-13544: `{{metrics_json}}` from the run's live metric values
- characters 13637-15301: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15345-17451: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17507-18073: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU-US Volume Licence and Anti-Coercion Buffer | 2 |
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Essential Services Continuity Stack −2, EU-US Volume Licence and Anti-Coercion Buffer −2, priority −1 = −11
PROPOSAL BONUS: EU-US Volume Licence and Anti-Coercion Buffer (cat 8, small) +3 — export control escalation landed this turn tightening allied chip/model access, this answers it directly
LEGITIMACY LENDS: capital 25, sentiment 30 -> +2
SOVEREIGNTY: 20 last turn, no capacity event finishes, Gigafactories/tech package in flight +0, export_control_escalation t3 −2, capability rose 1.5 −0 = 18
