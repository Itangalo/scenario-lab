...
- characters 4408-4848: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6302-8393: `{{previous_actions}}` from the actor's own response from the previous turn
