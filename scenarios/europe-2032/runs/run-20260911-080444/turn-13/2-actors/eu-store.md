...
| M11 | EU State-to-State Assurance and Bio-Cyber Shield | 8 | small | 12 | 15 | own jurisdiction with US state counterpart and coalition partners | resilience up moderately, ai_safety protected, eu_ai_sovereignty protected | 2 | running |
| M12 | EU Cut-Off Continuity and Embodied Displacement Buffer | 6 | small | 13 | 15 | own jurisdiction | resilience up moderately, public_sentiment protected, eu_political_capital protected | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Cut-Off Continuity and Embodied Displacement Buffer", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, public_sentiment protected, eu_political_capital protected"}, "grounds": "US access cut-off landed and embodied deployment removes retraining interval"}
  - Grounds: US access cut-off landed and embodied deployment removes retraining interval
