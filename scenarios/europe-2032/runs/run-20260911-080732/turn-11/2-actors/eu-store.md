...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Certified Assurance Rollout", "category": 5, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "ai_safety up, resilience up slightly via certified containment"}, "grounds": "to adopt safety breakthrough onto deployed systems during live attack"}
  - Grounds: to adopt safety breakthrough onto deployed systems during live attack
