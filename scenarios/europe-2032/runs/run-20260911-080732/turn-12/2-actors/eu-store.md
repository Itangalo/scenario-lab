...
| M13 | EU Certified Assurance Rollout | 5 | small | 11 | 13 | own jurisdiction | ai_safety up, resilience up slightly via certified containment | 2 | running |
| M14 | EU Municipal Repair and Hardening Surge | 6 | small | 12 | 14 | own jurisdiction | resilience up, eu_political_capital protected from service failure | 2 | running |
...
- **applied** `M14` — {"op": "add", "table": "measures", "fields": {"name": "EU Municipal Repair and Hardening Surge", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_political_capital protected from service failure"}, "grounds": "to close recovery divide during ongoing automated ransomware sweep"}
  - Grounds: to close recovery divide during ongoing automated ransomware sweep
