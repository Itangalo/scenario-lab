...
- `two_year_commitment` (commitment): Secure the foundations of autonomous action in an age of uncontrollable capability

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure the foundations of autonomous action in an age of uncontrollable capability
