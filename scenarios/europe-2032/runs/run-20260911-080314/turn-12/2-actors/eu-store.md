...
| M11 | EU Entry-Work Guarantee and Wage-Insurance Transition Fund | 7 | small | 11 | 13 | own jurisdiction | public_sentiment up, eu_political_capital protected, resilience up modestly | 2 | running |
| M12 | EU Degrade-Gracefully and Detection Surge for Open Superhuman Diffusion | 6 | small | 12 | 14 | own jurisdiction | resilience up moderately, eu_political_capital protected | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Degrade-Gracefully and Detection Surge for Open Superhuman Diffusion", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital protected"}, "grounds": "to absorb unrecallable open superhuman capability and unreadable evals"}
  - Grounds: to absorb unrecallable open superhuman capability and unreadable evals
