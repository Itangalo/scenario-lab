...
- `two_year_commitment` (commitment): Secure sovereign evaluation and control over AI systems at the frontier

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign evaluation and control over AI systems at the frontier
