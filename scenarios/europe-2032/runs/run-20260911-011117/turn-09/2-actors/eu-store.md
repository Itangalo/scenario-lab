...
| M7 | Decision Accountability and Redress Surge | 2 | small | 9 | 11 | own jurisdiction | eu_political_capital up modestly, public_sentiment up modestly via redress | 2 | running |
...
- **applied** `M7` — {"op": "add", "table": "measures", "fields": {"name": "Decision Accountability and Redress Surge", "category": 2, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "eu_political_capital up modestly, public_sentiment up modestly via redress"}, "grounds": "answers the internal-origin scandal now"}
  - Grounds: answers the internal-origin scandal now
