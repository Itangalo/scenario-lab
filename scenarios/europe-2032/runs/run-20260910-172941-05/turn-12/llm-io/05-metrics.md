...
- characters 13647-15046: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15089-16998: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17054-17885: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Cyber Major Incident Surge and Service Continuity Operation | 2 |
| M13 | EU Hardened Clinical IT Replacement Fund | 2 |
...
## Metrics
```json
{"ai_capability": 63.5, "openweight_capability": 62.3, "ai_safety": 28.0, "resilience": 54.0, "eu_ai_sovereignty": 25.0, "eu_political_capital": 16.0, "public_sentiment": 15.0}
```
