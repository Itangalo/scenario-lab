...
- characters 1575-3313: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3369-3964: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4027-27383: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27738-28448: `{{event_history}}` from the run's own event record
...
- `emergent_gigafactory_siting_backlash` -- first noted turn 9, listed in 1 turn(s) so far: Graduate unemployment protests and union blockades halt grid connection work at one fenced gigafactory site for weeks, turning the power-slip warning into a political standoff over jobs-first AI.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, ai_investment_collapse, knowledge_work_augmented
- Turn 2 (8 turn(s) ago): openweight_frontier_release
- Turn 3 (7 turn(s) ago): cyber_defence_breakthrough
- Turn 4 (6 turn(s) ago): cyber_major_incident, openweight_frontier_release, member_state_defection
- Turn 5 (5 turn(s) ago): safety_breakthrough, export_control_escalation, eu_frontier_access_denied, emergent_insurer_fraud_reckoning, election_retrenchment
- Turn 6 (4 turn(s) ago): eval_anomaly_reports, openweight_frontier_release
- Turn 7 (3 turn(s) ago): labour_displacement, supply_chain_coercion, member_state_defection
- Turn 9 (1 turn(s) ago): openweight_frontier_release, emergent_graduate_protest_wave
