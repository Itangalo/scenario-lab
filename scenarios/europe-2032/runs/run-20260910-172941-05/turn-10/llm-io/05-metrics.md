...
- characters 13551-14706: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14749-16487: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16543-17138: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Loss-of-Control Containment and Care Continuity Protocol | 2 |
...
PORTFOLIO CHARGE t9: EU Supply-Chain Leverage Compact −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 15, sentiment 23 -> +2
SOVEREIGNTY: 25 last turn, no capacity event, no cat4 finish, capability rose 0.5 −0 = 25

## Emerging developments (tracked)

- `emergent_gigafactory_siting_backlash` -- first noted turn 9, listed in 2 turn(s) so far: Graduate unemployment protests and union blockades halt grid connection work at one fenced gigafactory site for weeks, turning the power-slip warning into a political standoff over jobs-first AI.
...
## Notepad
PORTFOLIO CHARGE t10: EU Loss-of-Control Containment and Care Continuity Protocol −2 = −2 (priority named but no effect and no cost as capital below 20)
PROPOSAL BONUS: EU Loss-of-Control Containment and Care Continuity Protocol (cat 6, small) +2 — loss_of_control_incident landed this turn and this answers it directly, small size limits value
