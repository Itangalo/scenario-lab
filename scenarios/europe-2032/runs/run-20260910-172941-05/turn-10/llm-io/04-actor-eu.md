...
- characters 1653-3391: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4464-4912: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7667-9310: `{{previous_actions}}` from the actor's own response from the previous turn
