...
- characters 377-2505: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2549-4505: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4561-5656: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5719-27892: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28247-28545: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Incident Surge Response −2, priority −1 = −9
PROPOSAL BONUS: EU Incident Surge Response (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 26, sentiment 32 -> +2
SOVEREIGNTY: 22 last turn, no capacity event finishes, Gigafactories in flight +0, member_state_defection t4 −2, capability rose 1.5 −0 = 20

## Emerging developments (tracked)

- `emergent_cyber_insurance_repricing` -- first noted turn 4, listed in 1 turn(s) so far: A major European insurer publishes actuarial data quantifying AI-assisted fraud and intrusion losses across municipalities, triggering a sudden repricing of cyber coverage for public-sector bodies.
- `emergent_insurer_fraud_reckoning` -- first noted turn 4, listed in 1 turn(s) so far: A major European insurer publishes actuarial data showing AI-assisted fraud losses spiking in municipalities that did not adopt the patch kits, triggering lawsuits against lagging councils and sudden demand for the EU installation teams.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, ai_investment_collapse, knowledge_work_augmented
- Turn 2 (3 turn(s) ago): openweight_frontier_release
- Turn 3 (2 turn(s) ago): cyber_defence_breakthrough
- Turn 4 (1 turn(s) ago): cyber_major_incident, openweight_frontier_release, member_state_defection
...
```
[{"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.4}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.18}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.25}, {"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.045}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.13}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.1}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.03}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.14}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.05}, {"description": "A major European insurer publishes actuarial data quantifying AI-assisted fraud and intrusion losses across municipalities, triggering a sudden repricing of cyber coverage for public-sector bodies.", "emergent": true, "id": "emergent_cyber_insurance_repricing", "probability": 0.2}, {"description": "A major European insurer publishes actuarial data showing AI-assisted fraud losses spiking in municipalities that did not adopt the patch kits, triggering lawsuits against lagging councils and sudden demand for the EU installation teams.", "emergent": true, "id": "emergent_insurer_fraud_reckoning", "probability": 0.17}]
```
