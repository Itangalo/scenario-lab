...
- characters 2627-4583: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6871-7346: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9578-11471: `{{previous_actions}}` from the actor's own response from the previous turn
