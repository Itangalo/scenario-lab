...
- characters 106-13260: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13303-13495: `{{metrics_json}}` from the run's live metric values
- characters 13588-15716: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15760-17716: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17772-18541: `{{notepad}}` from the Game Master's notepad, carried across turns
