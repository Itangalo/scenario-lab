...
- characters 377-2080: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2124-4345: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4401-5633: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5696-28449: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28804-29335: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, ai_investment_collapse, knowledge_work_augmented
- Turn 2 (5 turn(s) ago): openweight_frontier_release
- Turn 3 (4 turn(s) ago): cyber_defence_breakthrough
- Turn 4 (3 turn(s) ago): cyber_major_incident, openweight_frontier_release, member_state_defection
- Turn 5 (2 turn(s) ago): safety_breakthrough, export_control_escalation, eu_frontier_access_denied, emergent_insurer_fraud_reckoning, election_retrenchment
- Turn 6 (1 turn(s) ago): eval_anomaly_reports, openweight_frontier_release
