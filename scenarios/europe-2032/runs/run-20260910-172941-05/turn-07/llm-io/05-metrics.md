...
- characters 106-13295: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13338-13530: `{{metrics_json}}` from the run's live metric values
- characters 13623-15326: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15370-17591: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17647-18879: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | EU Displaced-Worker Transition Guarantee | 2 |
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 58.0, "ai_safety": 28.0, "resilience": 51.0, "eu_ai_sovereignty": 22.0, "eu_political_capital": 14.0, "public_sentiment": 24.0}
```
## Narrative
