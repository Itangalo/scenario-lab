...
- characters 378-1578: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1622-3777: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3833-4648: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4711-28067: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28422-29376: `{{event_history}}` from the run's own event record
...
- `emergent_municipal_restore_strike` -- first noted turn 12, listed in 1 turn(s) so far: Municipal paper-system backlog triggers a coordinated sick-out and registry strike wave, freezing restoration work and forcing emergency pay deals.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, ai_investment_collapse, knowledge_work_augmented
- Turn 2 (11 turn(s) ago): openweight_frontier_release
- Turn 3 (10 turn(s) ago): cyber_defence_breakthrough
- Turn 4 (9 turn(s) ago): cyber_major_incident, openweight_frontier_release, member_state_defection
- Turn 5 (8 turn(s) ago): safety_breakthrough, export_control_escalation, eu_frontier_access_denied, emergent_insurer_fraud_reckoning, election_retrenchment
- Turn 6 (7 turn(s) ago): eval_anomaly_reports, openweight_frontier_release
- Turn 7 (6 turn(s) ago): labour_displacement, supply_chain_coercion, member_state_defection
- Turn 9 (4 turn(s) ago): openweight_frontier_release, emergent_graduate_protest_wave
- Turn 10 (3 turn(s) ago): loss_of_control_incident, medical_breakthrough
- Turn 11 (2 turn(s) ago): cyber_major_incident
- Turn 12 (1 turn(s) ago): cyber_major_incident, safety_breakthrough, joint_threat_response, emergent_care_it_standoff
