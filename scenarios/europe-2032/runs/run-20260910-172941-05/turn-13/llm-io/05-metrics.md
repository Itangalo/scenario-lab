...
- characters 13643-14843: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14887-17042: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17098-17913: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M14 | EU Municipal Clean Rebuild and Service Restoration Surge | 2 |
...
- `emergent_municipal_restore_strike` -- first noted turn 12, listed in 2 turn(s) so far: Municipal paper-system backlog triggers a coordinated sick-out and registry strike wave, freezing restoration work and forcing emergency pay deals.
