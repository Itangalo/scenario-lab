...
- characters 2178-4169: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5146-5597: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7985-10531: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Assurance and Sovereign Evaluation Capacity | 5 | small | 5 | 7 | own jurisdiction | ai_safety up, eu_ai_sovereignty up modestly | 2 | running |
