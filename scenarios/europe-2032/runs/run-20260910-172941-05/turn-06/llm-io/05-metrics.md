...
- characters 105-13342: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13385-13577: `{{metrics_json}}` from the run's live metric values
- characters 13670-15351: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15394-17385: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17441-18618: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Assurance and Sovereign Evaluation Capacity | 2 |
| M8 | EU Frontier Open-Weight Containment Thresholds | 2 |
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Assurance and Sovereign Evaluation Capacity −2, priority −1 = −9
PROPOSAL BONUS: EU Assurance and Sovereign Evaluation Capacity (cat 5, small) +4 — eu_frontier_access_denied and safety_breakthrough both landed this turn and this answers them directly
LEGITIMACY LENDS: capital 21, sentiment 29 -> +2
SOVEREIGNTY: 20 last turn, no capacity event finishes, Gigafactories in flight +0, eu_frontier_access_denied t5 −2, capability rose 1.5 −0 = 18

## Emerging developments (tracked)

- `emergent_us_moratorium_freeze` -- first noted turn 6, listed in 1 turn(s) so far: US retrenchment administration publishes draft rules pausing frontier federal procurement and conditioning research funding on moratorium compliance, freezing joint evaluation channels with the EU through June.
- `emergent_us_moratorium_backlash_disruption` -- first noted turn 6, listed in 1 turn(s) so far: US states enacting AI moratoriums and school/court curbs trigger coordinated student and teacher lawsuits and campus shutdowns that disrupt American frontier lab recruiting pipelines and evaluation partnerships for months.
...
## Notepad
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, EU Assurance and Sovereign Evaluation Capacity −2, EU Frontier Open-Weight Containment Thresholds −2, priority −1 = −8
PROPOSAL BONUS: EU Frontier Open-Weight Containment Thresholds (cat 3, small) +2 — eu_frontier_access_denied t5 and winter intrusion sweep argued for containment, this answers diffusion directly but small and rules-only
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "RETRENCHMENT"}}, {"op": "update", "table": "measures", "id": "M1", "fields": {"finish_turn": 8}, "grounds": "named priority"}]}
```
```
