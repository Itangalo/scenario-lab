...
- characters 2100-4091: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4147-4995: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5058-25432: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 25787-26242: `{{event_history}}` from the run's own event record
...
- `emergent_cyber_insurance_repricing` -- first noted turn 4, listed in 2 turn(s) so far: A major European insurer publishes actuarial data quantifying AI-assisted fraud and intrusion losses across municipalities, triggering a sudden repricing of cyber coverage for public-sector bodies.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, ai_investment_collapse, knowledge_work_augmented
- Turn 2 (4 turn(s) ago): openweight_frontier_release
- Turn 3 (3 turn(s) ago): cyber_defence_breakthrough
- Turn 4 (2 turn(s) ago): cyber_major_incident, openweight_frontier_release, member_state_defection
- Turn 5 (1 turn(s) ago): safety_breakthrough, export_control_escalation, eu_frontier_access_denied, emergent_insurer_fraud_reckoning, election_retrenchment
