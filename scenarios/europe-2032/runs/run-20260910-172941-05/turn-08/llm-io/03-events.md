...
- characters 376-2213: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2256-4571: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4627-5820: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5883-28636: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28991-29615: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: InvestAI Gigafactories −3, EU Frontier Open-Weight Containment Thresholds −2, EU Displaced-Worker Transition Guarantee −2, priority −1 = −8
PROPOSAL BONUS: EU Displaced-Worker Transition Guarantee (cat 7, small) +4 — labour_displacement landed this turn severe and recent and this answers it directly, hostile sentiment argued for safety-net
LEGITIMACY LENDS: capital 12, sentiment 24 -> +2
SOVEREIGNTY: 23 last turn, no cat4 finish, Gigafactories in flight +1, supply_chain_coercion t7 −2, capability rose 0.5 −0 = 22

## Emerging developments (tracked)

- `emergent_us_moratorium_freeze` -- first noted turn 6, listed in 2 turn(s) so far: US retrenchment administration publishes draft rules pausing frontier federal procurement and conditioning research funding on moratorium compliance, freezing joint evaluation channels with the EU through June.
- `emergent_us_moratorium_backlash_disruption` -- first noted turn 6, listed in 2 turn(s) so far: US states enacting AI moratoriums and school/court curbs trigger coordinated student and teacher lawsuits and campus shutdowns that disrupt American frontier lab recruiting pipelines and evaluation partnerships for months.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, ai_investment_collapse, knowledge_work_augmented
- Turn 2 (6 turn(s) ago): openweight_frontier_release
- Turn 3 (5 turn(s) ago): cyber_defence_breakthrough
- Turn 4 (4 turn(s) ago): cyber_major_incident, openweight_frontier_release, member_state_defection
- Turn 5 (3 turn(s) ago): safety_breakthrough, export_control_escalation, eu_frontier_access_denied, emergent_insurer_fraud_reckoning, election_retrenchment
- Turn 6 (2 turn(s) ago): eval_anomaly_reports, openweight_frontier_release
- Turn 7 (1 turn(s) ago): labour_displacement, supply_chain_coercion, member_state_defection
