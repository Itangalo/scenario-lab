...
- characters 13746-15583: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15626-17941: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17997-18536: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Supply-Chain Leverage Compact | 2 |
...
## Metrics
```json
{"ai_capability": 61.5, "openweight_capability": 59.5, "ai_safety": 29.0, "resilience": 50.0, "eu_ai_sovereignty": 25.0, "eu_political_capital": 15.0, "public_sentiment": 23.0}
```
