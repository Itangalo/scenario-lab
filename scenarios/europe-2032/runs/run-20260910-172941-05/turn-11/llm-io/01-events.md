...
- characters 378-1835: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1879-3871: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3927-4735: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4798-28154: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28509-29294: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, ai_investment_collapse, knowledge_work_augmented
- Turn 2 (9 turn(s) ago): openweight_frontier_release
- Turn 3 (8 turn(s) ago): cyber_defence_breakthrough
- Turn 4 (7 turn(s) ago): cyber_major_incident, openweight_frontier_release, member_state_defection
- Turn 5 (6 turn(s) ago): safety_breakthrough, export_control_escalation, eu_frontier_access_denied, emergent_insurer_fraud_reckoning, election_retrenchment
- Turn 6 (5 turn(s) ago): eval_anomaly_reports, openweight_frontier_release
- Turn 7 (4 turn(s) ago): labour_displacement, supply_chain_coercion, member_state_defection
- Turn 9 (2 turn(s) ago): openweight_frontier_release, emergent_graduate_protest_wave
- Turn 10 (1 turn(s) ago): loss_of_control_incident, medical_breakthrough
