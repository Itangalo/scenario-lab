...
- characters 13251-14708: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14752-16744: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16800-17283: `{{notepad}}` from the Game Master's notepad, carried across turns
