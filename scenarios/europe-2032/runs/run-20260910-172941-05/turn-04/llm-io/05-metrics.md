...
- characters 105-13378: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13421-13613: `{{metrics_json}}` from the run's live metric values
- characters 13706-15161: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15204-16751: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16807-17969: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Incident Surge Response | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, Municipal and Hospital Patch Sprint −2, EU-Wide Defensive Tooling Scale-Up −2, priority −1 = −11
PROPOSAL BONUS: EU-Wide Defensive Tooling Scale-Up (cat 6, small) +2 — winter open-weight release putting grid-intrusion tradecraft on private hardware in t2 and this answers it directly
