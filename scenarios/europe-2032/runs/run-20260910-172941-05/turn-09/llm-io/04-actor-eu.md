...
- characters 455-2113: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2157-4294: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5036-5487: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8393-10450: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Supply-Chain Leverage Compact | 8 | small | 8 | 10 | coalition | eu_ai_sovereignty up modestly, eu_political_capital up modestly | 2 | running |
