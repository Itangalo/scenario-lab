...
- characters 13255-13447: `{{metrics_json}}` from the run's live metric values
- characters 13540-15198: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15242-17379: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17435-18146: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 62.0, "openweight_capability": 60.0, "ai_safety": 27.0, "resilience": 49.0, "eu_ai_sovereignty": 25.0, "eu_political_capital": 10.0, "public_sentiment": 20.0}
```
