...
- `two_year_commitment` (commitment): Secure autonomous AI capacity to anchor European strategic freedom

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure autonomous AI capacity to anchor European strategic freedom
