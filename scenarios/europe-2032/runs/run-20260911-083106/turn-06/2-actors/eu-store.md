...
| M6 | EU Cyber Emergency Repair Cell | 6 | small | 6 | 8 | own jurisdiction | resilience up, eu_political_capital up modestly via visible response | 2 | running |
...
- **applied** `M6` — {"op": "add", "table": "measures", "fields": {"name": "EU Cyber Emergency Repair Cell", "category": 6, "size": "small", "finish_turn": 8, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_political_capital up modestly via visible response"}, "grounds": "major automated attack requires immediate restoration"}
  - Grounds: major automated attack requires immediate restoration
