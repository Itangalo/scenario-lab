...
- characters 2142-4230: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4286-4833: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4896-30509: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30864-31624: `{{event_history}}` from the run's own event record
...
- Turn 8 (2 turn(s) ago): loss_of_control_incident, supply_chain_coercion
- Turn 9 (1 turn(s) ago): cyber_major_incident, export_control_escalation
