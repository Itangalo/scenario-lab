...
- characters 454-2177: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2220-4308: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5571-6047: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8440-10852: `{{previous_actions}}` from the actor's own response from the previous turn
...
- `two_year_commitment` (commitment): Hold essential services and social order together through cut-off, open-model exposure and hostile AI
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Essential Services Black-Start and Manual Fallback Network | 6 | small | 9 | 11 | own jurisdiction | resilience up strongly | 2 | running |
...
| M4 | EU Grid Shield Hardening Programme | 6 | large | 2 | 7 | own jurisdiction | resilience up strongly, ai_safety up modestly | 3 | finished |
