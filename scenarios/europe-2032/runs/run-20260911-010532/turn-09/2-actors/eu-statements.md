...
- `two_year_commitment` (commitment): Hold essential services through open-weight harm and keep a serviced compute path open until sovereignty can be rebuilt

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold essential services through open-weight harm and keep a serviced compute path open until sovereignty can be rebuilt
