...
- **modify** `two_year_commitment` — applied
  ...
  - Reason: The expiration of the commitment period directly changes the actor's obligation to uphold the statement, altering the cost and rationale for maintaining it.
