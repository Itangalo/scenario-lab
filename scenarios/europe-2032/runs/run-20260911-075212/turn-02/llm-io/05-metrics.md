...
- characters 105-13183: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13226-13418: `{{metrics_json}}` from the run's live metric values
- characters 13511-14678: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14721-16976: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17032-18027: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Continuity Fallback for Critical AI Users | 2 |
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 50.5, "ai_safety": 30.0, "resilience": 37.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 28.0, "public_sentiment": 36.0}
```
