...
- characters 376-1628: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1671-3585: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3641-4452: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4515-31459: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31814-32011: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, export_control_escalation, adoption_success, emergent_datacentre_siting_backlash
