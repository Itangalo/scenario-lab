...
- characters 13438-14690: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14733-16647: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16703-17201: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Bio Detection Uplift | 2 |
| M6 | EU Agent Containment and Bio Response Surge | 2 |
...
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 Supply-Chain Leverage Coalition −2, M5 EU Bio Detection Uplift −2, priority M5 −1 = −11
PROPOSAL BONUS: EU Bio Detection Uplift (cat 6, small) +3 — bio_uplift_findings fired this turn opening 4-turn precursor window and this answers it directly
LEGITIMACY LENDS: capital 21, sentiment 42 -> +2 (capped below sentiment)
