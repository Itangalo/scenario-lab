...
- characters 454-3019: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3063-5531: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7292-7745: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10781-12951: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Continuity Switch-Over | 9 | small | 8 | 10 | own jurisdiction | eu_ai_sovereignty up slightly via use under EU control, resilience up moderately via continuity, eu_political_capital up slightly if services stay on | 2 | running |
