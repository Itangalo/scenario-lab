...
- characters 13707-16272: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16316-18784: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18840-19936: `{{notepad}}` from the Game Master's notepad, carried across turns
