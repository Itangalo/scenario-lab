...
- characters 13384-14814: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14857-17268: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17324-18158: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | Supply-Chain Leverage Coalition | 2 |
...
- `emergent_grid_insurance_crunch` -- first noted turn 2, listed in 1 turn(s) so far: European grid and port operators face a sudden spike in cyber-insurance premia and coverage exclusions after the autumn swarm mapping becomes public, forcing temporary self-insurance pools.
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 50.5, "ai_safety": 36.0, "resilience": 37.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 26.0, "public_sentiment": 43.0}
```
...
## Notepad
PORTFOLIO CHARGE t2: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Systems Shield −3, M4 Supply-Chain Leverage Coalition −2, priority M3 −1 = −12
PROPOSAL BONUS: none — Coalition answers US control tightening which is standing pressure not a fired event in last three turns, not a bonus event
LEGITIMACY LENDS: capital 24, sentiment 43 -> +2
