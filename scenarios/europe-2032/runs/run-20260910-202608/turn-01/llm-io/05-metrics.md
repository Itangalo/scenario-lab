...
**emergent_datacentre_siting_backlash (emergent event):** Coordinated municipal opposition blocks or delays two large data-centre projects in the EU over power prices and water use, forcing a national-level energy siting dispute.
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 46.0, "ai_safety": 38.0, "resilience": 37.5, "eu_ai_sovereignty": 19.0, "eu_political_capital": 36.0, "public_sentiment": 44.0}
```
...
PROPOSAL BONUS: EU Critical Systems Shield (cat 6, large) +4 — autumn swarm intrusion landed this turn establishing precursor window and this answers it directly
LEGITIMACY LENDS: capital 36, sentiment 44 -> +2 (included in capital total)
SOVEREIGNTY: 22 last turn, no capacity build finishes, Gigafactories/tech package in flight +0, export_control_escalation t1 −2, capability rose 3.0 −1 = 19
