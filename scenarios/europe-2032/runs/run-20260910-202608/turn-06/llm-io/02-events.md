...
- characters 376-1731: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1774-3721: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3777-4583: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4646-30929: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31284-31644: `{{event_history}}` from the run's own event record
...
- `emergent_insurance_capacity_freeze` -- first noted turn 5, listed in 1 turn(s) so far: Major European reinsurers jointly suspend new cyber-biological business-interruption cover for hospitals and municipal utilities pending EU-wide reporting standards, freezing renewals across several member states.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, export_control_escalation, adoption_success, emergent_datacentre_siting_backlash
- Turn 3 (3 turn(s) ago): bio_uplift_findings
- Turn 4 (2 turn(s) ago): bio_incident, loss_of_control_incident
- Turn 5 (1 turn(s) ago): cyber_major_incident, export_control_escalation, election_consolidation
