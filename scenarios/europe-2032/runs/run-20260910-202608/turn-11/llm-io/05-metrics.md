...
- characters 107-13444: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13487-13677: `{{metrics_json}}` from the run's live metric values
- characters 13770-17099: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 17143-19171: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 19227-19753: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M13 | EU Graduate Transition and Decision Redress | 2 |
