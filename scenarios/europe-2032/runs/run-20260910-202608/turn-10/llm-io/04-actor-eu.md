...
- characters 454-3705: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3748-5865: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6657-7114: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10357-12777: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Municipal and Hospital Cyber Triage | 6 | small | 9 | 11 | own jurisdiction | resilience up moderately via incident containment, eu_political_capital up slightly if services hold | 2 | running |
