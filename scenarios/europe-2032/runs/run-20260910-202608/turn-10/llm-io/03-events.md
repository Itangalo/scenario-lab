...
- characters 376-3627: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3670-5787: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5843-6899: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6962-35350: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35705-36430: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M10 EU Continuity Switch-Over −2, M11 EU Municipal and Hospital Cyber Triage −2, priority −1 = −5
PROPOSAL BONUS: EU Municipal and Hospital Cyber Triage (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly as containment
LEGITIMACY LENDS: capital 8, sentiment 6 -> none, capital not above sentiment is false
SOVEREIGNTY: 16 last turn, no capacity event, no cat4 in flight +0, capability rose 3.0 −1 = 15

## Emerging developments (tracked)

- `emergent_care_outsourcing_bypass` -- first noted turn 9, listed in 1 turn(s) so far: Regional hospital groups that paused EU swap-kits sign emergency staffing contracts with US vendors for remote triage, creating a de-facto parallel health data flow outside EU oversight.
- `emergent_substitute_defection` -- first noted turn 9, listed in 1 turn(s) so far: Regional hospital groups that paused migration to European-hosted substitutes publicly revert to US-linked licensed models via third-country intermediaries, fracturing the continuity procurement pool.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, export_control_escalation, adoption_success, emergent_datacentre_siting_backlash
- Turn 3 (7 turn(s) ago): bio_uplift_findings
- Turn 4 (6 turn(s) ago): bio_incident, loss_of_control_incident
- Turn 5 (5 turn(s) ago): cyber_major_incident, export_control_escalation, election_consolidation
- Turn 6 (4 turn(s) ago): bio_uplift_findings
- Turn 7 (3 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, research_breakthrough, knowledge_work_augmented, automated_decision_scandal
- Turn 8 (2 turn(s) ago): eu_frontier_access_denied
- Turn 9 (1 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports, medical_breakthrough
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.05}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.3}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.08}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.03}, {"description": "", "emergent": false, "id": "rsi_onset", "probability": 0.35}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_great_power_conflict", "probability": 0.01}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "us_labs_nationalised", "probability": 0.14}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Regional hospital groups that paused EU swap-kits sign emergency staffing contracts with US vendors for remote triage, creating a de-facto parallel health data flow outside EU oversight.", "emergent": true, "id": "emergent_care_outsourcing_bypass", "probability": 0.22}, {"description": "Regional hospital groups that paused migration to European-hosted substitutes publicly revert to US-linked licensed models via third-country intermediaries, fracturing the continuity procurement pool.", "emergent": true, "id": "emergent_substitute_defection", "probability": 0.18}]
```
