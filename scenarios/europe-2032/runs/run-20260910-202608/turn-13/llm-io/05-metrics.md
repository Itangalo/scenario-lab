...
- characters 107-12963: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13006-13195: `{{metrics_json}}` from the run's live metric values
- characters 13288-15150: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15194-17276: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17332-18061: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_shadow_automation_layer` -- first noted turn 13, listed in 1 turn(s) so far: Municipal utilities quietly switch critical control systems to smuggled open-weight agents for maintenance, creating an undeclared shadow automation layer outside EU oversight.
...
## Metrics
```json
{"ai_capability": 91.5, "openweight_capability": 85.0, "ai_safety": 1.0, "resilience": 51.0, "eu_ai_sovereignty": 6.0, "eu_political_capital": 0.0, "public_sentiment": 0.0}
```
...
## Notepad
PORTFOLIO CHARGE t13: M13 EU Graduate Transition and Decision Redress −2, priority no effect and no cost (capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 1 -> none, capital not below sentiment
SOVEREIGNTY: 10 last turn, no cat4 finish +0, no cat4 in flight +0, us_labs_nationalised t13 −3, capability rose 3.5 −1 = 6
