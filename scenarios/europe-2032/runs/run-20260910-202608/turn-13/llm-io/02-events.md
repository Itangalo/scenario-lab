...
- characters 375-2237: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2281-4363: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4419-4845: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4908-32118: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32473-33505: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M13 EU Graduate Transition and Decision Redress −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2, sentiment 2 -> none, capital not below sentiment
SOVEREIGNTY: 13 last turn, no capacity event? member_state_defection t12 −2 (largest of blockade/defection), no cat4 in flight +0, capability rose 3.0 −1 = 10
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, export_control_escalation, adoption_success, emergent_datacentre_siting_backlash
- Turn 3 (10 turn(s) ago): bio_uplift_findings
- Turn 4 (9 turn(s) ago): bio_incident, loss_of_control_incident
- Turn 5 (8 turn(s) ago): cyber_major_incident, export_control_escalation, election_consolidation
- Turn 6 (7 turn(s) ago): bio_uplift_findings
- Turn 7 (6 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, research_breakthrough, knowledge_work_augmented, automated_decision_scandal
- Turn 8 (5 turn(s) ago): eu_frontier_access_denied
- Turn 9 (4 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports, medical_breakthrough
- Turn 10 (3 turn(s) ago): cyber_major_incident, emergent_care_outsourcing_bypass
- Turn 11 (2 turn(s) ago): labour_displacement, us_china_agreement, automated_decision_scandal
- Turn 12 (1 turn(s) ago): capability_jump, taiwan_blockade, labour_displacement, member_state_defection, joint_threat_response
