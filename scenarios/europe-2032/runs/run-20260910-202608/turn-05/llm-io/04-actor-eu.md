...
- characters 455-1634: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1678-3284: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5003-5464: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7750-9855: `{{previous_actions}}` from the actor's own response from the previous turn
