...
- characters 106-13748: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13791-13983: `{{metrics_json}}` from the run's live metric values
- characters 14076-15255: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15299-16905: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16961-17861: `{{notepad}}` from the Game Master's notepad, carried across turns
