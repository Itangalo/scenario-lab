...
- characters 13760-15253: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15297-16962: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17018-17818: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_grid_insurance_crunch` -- first noted turn 2, listed in 2 turn(s) so far: European grid and port operators face a sudden spike in cyber-insurance premia and coverage exclusions after the autumn swarm mapping becomes public, forcing temporary self-insurance pools.
