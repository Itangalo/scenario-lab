...
- characters 1914-3579: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3635-4435: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4498-28074: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28429-28580: `{{event_history}}` from the run's own event record
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, export_control_escalation, adoption_success, emergent_datacentre_siting_backlash
