...
- characters 377-1574: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1618-3957: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4013-4850: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4913-32728: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33083-33489: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, export_control_escalation, adoption_success, emergent_datacentre_siting_backlash
- Turn 3 (4 turn(s) ago): bio_uplift_findings
- Turn 4 (3 turn(s) ago): bio_incident, loss_of_control_incident
- Turn 5 (2 turn(s) ago): cyber_major_incident, export_control_escalation, election_consolidation
- Turn 6 (1 turn(s) ago): bio_uplift_findings
