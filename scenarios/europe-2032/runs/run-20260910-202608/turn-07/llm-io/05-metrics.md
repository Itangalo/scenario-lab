...
- characters 13865-15062: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15106-17445: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17501-17997: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | EU Swarm-Defence Rapid Deployment | 2 |
...
## Notepad
PORTFOLIO CHARGE t7: M8 EU Bio-Capability Evaluation Cell −2, M9 EU Swarm-Defence Rapid Deployment −2, priority M8 −1 = −5
PROPOSAL BONUS: EU Swarm-Defence Rapid Deployment (cat 6, small) +3 — 2029 dependency sweep and hospital cascade in last three turns and this answers it directly with breakthrough tooling
LEGITIMACY LENDS: capital 15, sentiment 15 -> none, capital not below sentiment
SOVEREIGNTY: 16 last turn, M1 InvestAI Gigafactories finishes t7 +5, no cat4 in flight +0, no capacity event, capability rose 3.0 −1 = 20
## Store changes
```json
