...
- characters 13491-13681: `{{metrics_json}}` from the run's live metric values
- characters 13774-15685: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15728-17818: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17874-18419: `{{notepad}}` from the Game Master's notepad, carried across turns
