...
- characters 375-2286: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2329-4419: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4475-5020: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5083-33011: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33366-34269: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, export_control_escalation, adoption_success, emergent_datacentre_siting_backlash
- Turn 3 (9 turn(s) ago): bio_uplift_findings
- Turn 4 (8 turn(s) ago): bio_incident, loss_of_control_incident
- Turn 5 (7 turn(s) ago): cyber_major_incident, export_control_escalation, election_consolidation
- Turn 6 (6 turn(s) ago): bio_uplift_findings
- Turn 7 (5 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, research_breakthrough, knowledge_work_augmented, automated_decision_scandal
- Turn 8 (4 turn(s) ago): eu_frontier_access_denied
- Turn 9 (3 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports, medical_breakthrough
- Turn 10 (2 turn(s) ago): cyber_major_incident, emergent_care_outsourcing_bypass
- Turn 11 (1 turn(s) ago): labour_displacement, us_china_agreement, automated_decision_scandal
