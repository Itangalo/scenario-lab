...
- characters 376-2373: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2416-4529: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4585-5113: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5176-32991: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33346-33904: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, export_control_escalation, adoption_success, emergent_datacentre_siting_backlash
- Turn 3 (5 turn(s) ago): bio_uplift_findings
- Turn 4 (4 turn(s) ago): bio_incident, loss_of_control_incident
- Turn 5 (3 turn(s) ago): cyber_major_incident, export_control_escalation, election_consolidation
- Turn 6 (2 turn(s) ago): bio_uplift_findings
- Turn 7 (1 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, research_breakthrough, knowledge_work_augmented, automated_decision_scandal
