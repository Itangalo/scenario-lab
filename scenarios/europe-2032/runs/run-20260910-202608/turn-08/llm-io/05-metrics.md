...
- characters 105-13373: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13416-13608: `{{metrics_json}}` from the run's live metric values
- characters 13701-15698: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15741-17854: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17910-18438: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Continuity Switch-Over | 2 |
...
## Metrics
```json
{"ai_capability": 76.0, "openweight_capability": 70.0, "ai_safety": 24.0, "resilience": 48.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 12.0, "public_sentiment": 8.0}
```
...
## Notepad
PORTFOLIO CHARGE t8: M9 EU Swarm-Defence Rapid Deployment −2, M10 EU Continuity Switch-Over −2, priority −1 = −5
PROPOSAL BONUS: EU Continuity Switch-Over (cat 9, small) +4 — eu_frontier_access_denied fired this turn cutting hospitals/ministries/firms and this answers it directly as fallback
LEGITIMACY LENDS: capital 15, sentiment 15 -> none, capital not above sentiment
SOVEREIGNTY: 20 last turn, no cat4 finish, no cat4 in flight +0, eu_frontier_access_denied t8 −3, capability rose 3.0 −1 = 16
