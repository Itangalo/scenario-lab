...
- characters 13369-14600: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14643-17233: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17289-18102: `{{notepad}}` from the Game Master's notepad, carried across turns
