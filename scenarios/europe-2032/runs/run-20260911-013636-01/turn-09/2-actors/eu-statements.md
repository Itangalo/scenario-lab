...
- `two_year_commitment` (commitment): Rebuild jobs, services and trust on European-controlled capacity

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild jobs, services and trust on European-controlled capacity
