...
- `two_year_commitment` (commitment): Sovereign access to frontier-level AI capability for critical decision-making autonomy

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Sovereign access to frontier-level AI capability for critical decision-making autonomy
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the commitment period directly changes the cost of maintaining the original statement, triggering a natural review point for renewal or revision.
