...
- characters 13613-15208: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15252-17176: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17232-17995: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Cutoff Continuity Reserve | 2 |
...
- `emergent_gulf_spare_release` -- first noted turn 10, listed in 2 turn(s) so far: Gulf foundry spare capacity earmarked for non-US customers is released for commercial sale as domestic orders pause, briefly opening a buyable compute window for European buyers despite the strait closure.
...
## Notepad
PORTFOLIO CHARGE t11: EU Cutoff Continuity Reserve −2, priority −1 = −3
PROPOSAL BONUS: EU Cutoff Continuity Reserve (cat 6, small) +3 — eu_frontier_access_denied landed this turn and this answers it directly
LEGITIMACY LENDS: capital 19, sentiment 35 -> +2
SOVEREIGNTY: 24 last turn, no capacity event, no cat4 in flight +0, eu_frontier_access_denied t11 −2, capability rose 0.8 −0 = 22
## Store changes
```json
