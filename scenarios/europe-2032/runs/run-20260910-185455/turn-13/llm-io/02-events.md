...
- characters 378-2165: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2209-4220: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4276-4673: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4736-31566: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31921-33047: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Cyber Recovery and Hardening Surge −2, priority −1 = −3
PROPOSAL BONUS: EU Cyber Recovery and Hardening Surge (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 20, sentiment 28 -> +2
SOVEREIGNTY: 22 last turn, no capacity event, no cat4 in flight +0, member_state_defection t12 −2, capability rose 0.7 −0 = 20
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (11 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 3 (10 turn(s) ago): capability_jump, cyber_defence_breakthrough, member_state_defection
- Turn 4 (9 turn(s) ago): openweight_frontier_release, safety_breakthrough
- Turn 5 (8 turn(s) ago): election_retrenchment
- Turn 6 (7 turn(s) ago): cyber_major_incident, member_state_defection, middle_power_coalition, emergent_clinic_system_collapse
- Turn 7 (6 turn(s) ago): cyber_major_incident, capability_jump, taiwan_blockade, adoption_success
- Turn 8 (5 turn(s) ago): taiwan_tension_rise
- Turn 9 (4 turn(s) ago): medical_breakthrough, embodied_ai_deployment
- Turn 10 (3 turn(s) ago): safety_breakthrough, knowledge_work_augmented
- Turn 11 (2 turn(s) ago): bio_uplift_findings, openweight_frontier_release, eu_frontier_access_denied, adoption_success
- Turn 12 (1 turn(s) ago): cyber_major_incident, openweight_frontier_release, member_state_defection
