...
- characters 2445-4760: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5688-6161: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8204-10063: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU Certified Assurance Uptake | 5 | small | 4 | 6 | own jurisdiction | ai_safety up moderately | 2 | running |
