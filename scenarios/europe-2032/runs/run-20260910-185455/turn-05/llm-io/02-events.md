...
- characters 377-2323: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2367-4682: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4738-5783: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5846-30156: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30511-30947: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Shield −3, EU Certified Assurance Uptake −2, priority −1 = −12
PROPOSAL BONUS: EU Certified Assurance Uptake (cat 5, small) +2 — open-weight diffusion landed this turn making recall impossible and interpretability breakthrough adoptable, this answers it directly
LEGITIMACY LENDS: capital 17, sentiment 40 -> +2
SOVEREIGNTY: 21 last turn, no capacity event, Gigafactories in flight +0, capability rose 2.0 −1 = 20

## Emerging developments (tracked)

- `emergent_care_system_failover` -- first noted turn 4, listed in 1 turn(s) so far: Municipal clinic ransomware cascade forces emergency EU health-data hosting on foreign hyperscale capacity outside common evaluation terms.
- `emergent_clinic_system_collapse` -- first noted turn 4, listed in 1 turn(s) so far: Municipal hospital ransomware cascade forces several regions to revert to paper triage for weeks, turning uneven patching coverage into a national debate over EU-funded rebuilds.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (3 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 3 (2 turn(s) ago): capability_jump, cyber_defence_breakthrough, member_state_defection
- Turn 4 (1 turn(s) ago): openweight_frontier_release, safety_breakthrough
