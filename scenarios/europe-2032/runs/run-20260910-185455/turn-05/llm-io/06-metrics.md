...
- characters 106-13436: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13479-13671: `{{metrics_json}}` from the run's live metric values
- characters 13764-15710: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15754-18069: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18125-19170: `{{notepad}}` from the Game Master's notepad, carried across turns
