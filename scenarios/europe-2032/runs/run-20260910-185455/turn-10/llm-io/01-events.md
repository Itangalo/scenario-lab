...
- characters 1934-4254: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4310-4760: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4823-30800: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31155-31983: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (8 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 3 (7 turn(s) ago): capability_jump, cyber_defence_breakthrough, member_state_defection
- Turn 4 (6 turn(s) ago): openweight_frontier_release, safety_breakthrough
- Turn 5 (5 turn(s) ago): election_retrenchment
- Turn 6 (4 turn(s) ago): cyber_major_incident, member_state_defection, middle_power_coalition, emergent_clinic_system_collapse
- Turn 7 (3 turn(s) ago): cyber_major_incident, capability_jump, taiwan_blockade, adoption_success
- Turn 8 (2 turn(s) ago): taiwan_tension_rise
- Turn 9 (1 turn(s) ago): medical_breakthrough, embodied_ai_deployment
