...
- characters 2012-4332: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5789-6238: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8704-10813: `{{previous_actions}}` from the actor's own response from the previous turn
