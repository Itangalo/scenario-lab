...
- characters 106-13311: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13354-13545: `{{metrics_json}}` from the run's live metric values
- characters 13638-15153: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15196-17516: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17572-18349: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Assurance Uptake for Deployed Frontier Systems | 2 |
...
PORTFOLIO CHARGE t9: EU Trusted Medical AI Deployment −2, priority −1 = −3
PROPOSAL BONUS: none — new medical deployment answers this turn's positive breakthrough, not a negative event from last three rounds; embodied deployment not addressed by it
LEGITIMACY LENDS: capital 10, sentiment 31 -> +2
SOVEREIGNTY: 22 last turn, Blockade-Era Upstream Bargain finishes t9 +4, no cat4 in flight +0, embodied_ai_deployment t9 −2, capability rose 0.8 −0 = 24

## Emerging developments (tracked)

- `emergent_gulf_spare_release` -- first noted turn 10, listed in 1 turn(s) so far: Gulf foundry spare capacity earmarked for non-US customers is released for commercial sale as domestic orders pause, briefly opening a buyable compute window for European buyers despite the strait closure.
...
## Notepad
PORTFOLIO CHARGE t10: EU Assurance Uptake for Deployed Frontier Systems −2, priority −1 = −3
PROPOSAL BONUS: none — new assurance uptake answers safety collapse and positive breakthrough, not a negative event from last three rounds; knowledge-work augmentation creates no bonus-eligible harm
LEGITIMACY LENDS: capital 12, sentiment 39 -> +2
SOVEREIGNTY: 24 last turn, no capacity event, no cat4 in flight +0, capability rose 0.8 −0 = 24
