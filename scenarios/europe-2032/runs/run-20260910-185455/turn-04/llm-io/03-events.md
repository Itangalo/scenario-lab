...
- characters 1655-4333: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4389-4807: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4870-28503: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28858-29219: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (2 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 3 (1 turn(s) ago): capability_jump, cyber_defence_breakthrough, member_state_defection
