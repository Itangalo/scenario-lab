...
- characters 105-13436: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13479-13671: `{{metrics_json}}` from the run's live metric values
- characters 13764-14847: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14890-17129: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17185-18039: `{{notepad}}` from the Game Master's notepad, carried across turns
