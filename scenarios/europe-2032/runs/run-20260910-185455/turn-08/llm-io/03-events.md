...
- characters 376-1459: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1502-3741: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3797-4651: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4714-30691: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31046-31757: `{{event_history}}` from the run's own event record
...
- `emergent_gulf_allocation_freeze` -- first noted turn 7, listed in 1 turn(s) so far: A major Gulf capacity holder pauses new foreign compute allocations after domestic demand surge, freezing pooled-procurement talks with the EU for the turn.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (6 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 3 (5 turn(s) ago): capability_jump, cyber_defence_breakthrough, member_state_defection
- Turn 4 (4 turn(s) ago): openweight_frontier_release, safety_breakthrough
- Turn 5 (3 turn(s) ago): election_retrenchment
- Turn 6 (2 turn(s) ago): cyber_major_incident, member_state_defection, middle_power_coalition, emergent_clinic_system_collapse
- Turn 7 (1 turn(s) ago): cyber_major_incident, capability_jump, taiwan_blockade, adoption_success
