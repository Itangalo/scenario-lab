...
- characters 13438-13630: `{{metrics_json}}` from the run's live metric values
- characters 13723-14875: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14919-17280: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17336-18213: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | Blockade-Era Upstream Bargain | 2 |
