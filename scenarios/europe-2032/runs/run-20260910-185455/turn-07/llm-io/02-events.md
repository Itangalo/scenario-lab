...
- characters 377-1529: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1573-3934: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3990-4586: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4649-31344: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31699-32311: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (5 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 3 (4 turn(s) ago): capability_jump, cyber_defence_breakthrough, member_state_defection
- Turn 4 (3 turn(s) ago): openweight_frontier_release, safety_breakthrough
- Turn 5 (2 turn(s) ago): election_retrenchment
- Turn 6 (1 turn(s) ago): cyber_major_incident, member_state_defection, middle_power_coalition, emergent_clinic_system_collapse
