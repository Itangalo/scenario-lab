...
- characters 13588-14967: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15011-17694: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17750-18068: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Trusted Medical AI Deployment | 2 |
...
## Metrics
```json
{"ai_capability": 64.7, "openweight_capability": 62.3, "ai_safety": 9.5, "resilience": 38.0, "eu_ai_sovereignty": 24.0, "eu_political_capital": 12.0, "public_sentiment": 31.0}
```
