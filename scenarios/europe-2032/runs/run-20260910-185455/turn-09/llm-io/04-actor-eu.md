...
- characters 455-1834: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1878-4561: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6198-6648: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8963-10118: `{{previous_actions}}` from the actor's own response from the previous turn
