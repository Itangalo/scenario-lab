...
- characters 106-13039: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13082-13274: `{{metrics_json}}` from the run's live metric values
- characters 13367-14659: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14703-16991: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17047-17539: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Shield −3, EU Breakthrough Defence Deployment −2, priority −1 = −12
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 13, sentiment 42 -> +2
SOVEREIGNTY: 23 last turn, no capacity event finishes, Gigafactories in flight +0, member_state_defection t3 −2, capability rose 1.5 −0 = 21
