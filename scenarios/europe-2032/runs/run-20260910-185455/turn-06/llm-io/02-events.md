...
- characters 376-1821: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1864-4249: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4305-5383: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5446-31538: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31893-32377: `{{event_history}}` from the run's own event record
...
- `emergent_care_system_failover` -- first noted turn 4, listed in 2 turn(s) so far: Municipal clinic ransomware cascade forces emergency EU health-data hosting on foreign hyperscale capacity outside common evaluation terms.
- `emergent_clinic_system_collapse` -- first noted turn 4, listed in 2 turn(s) so far: Municipal hospital ransomware cascade forces several regions to revert to paper triage for weeks, turning uneven patching coverage into a national debate over EU-funded rebuilds.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (4 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 3 (3 turn(s) ago): capability_jump, cyber_defence_breakthrough, member_state_defection
- Turn 4 (2 turn(s) ago): openweight_frontier_release, safety_breakthrough
- Turn 5 (1 turn(s) ago): election_retrenchment
