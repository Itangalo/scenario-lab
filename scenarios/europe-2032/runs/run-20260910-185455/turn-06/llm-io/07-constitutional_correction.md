...
- characters 2391-2941: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 62.3, "openweight_capability": 59.3, "ai_safety": 22.5, "resilience": 42.0, "eu_ai_sovereignty": 23.0, "eu_political_capital": 18.0, "public_sentiment": 33.0}
```
