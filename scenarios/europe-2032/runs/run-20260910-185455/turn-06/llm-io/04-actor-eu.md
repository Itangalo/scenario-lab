...
- characters 454-1899: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1942-4327: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5854-6304: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8488-10967: `{{previous_actions}}` from the actor's own response from the previous turn
