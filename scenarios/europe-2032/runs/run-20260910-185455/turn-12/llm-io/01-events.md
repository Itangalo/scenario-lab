...
- characters 377-1405: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1448-3407: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3463-4177: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4240-31070: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31425-32449: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, openweight_frontier_release, knowledge_work_augmented, export_control_escalation, eu_access_secured
- Turn 2 (10 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 3 (9 turn(s) ago): capability_jump, cyber_defence_breakthrough, member_state_defection
- Turn 4 (8 turn(s) ago): openweight_frontier_release, safety_breakthrough
- Turn 5 (7 turn(s) ago): election_retrenchment
- Turn 6 (6 turn(s) ago): cyber_major_incident, member_state_defection, middle_power_coalition, emergent_clinic_system_collapse
- Turn 7 (5 turn(s) ago): cyber_major_incident, capability_jump, taiwan_blockade, adoption_success
- Turn 8 (4 turn(s) ago): taiwan_tension_rise
- Turn 9 (3 turn(s) ago): medical_breakthrough, embodied_ai_deployment
- Turn 10 (2 turn(s) ago): safety_breakthrough, knowledge_work_augmented
- Turn 11 (1 turn(s) ago): bio_uplift_findings, openweight_frontier_release, eu_frontier_access_denied, adoption_success
