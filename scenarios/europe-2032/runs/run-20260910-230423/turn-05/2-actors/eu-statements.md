...
- `two_year_commitment` (commitment): Hold a sovereignty foothold through allied access while making bio-enabled harm containable

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold a sovereignty foothold through allied access while making bio-enabled harm containable
