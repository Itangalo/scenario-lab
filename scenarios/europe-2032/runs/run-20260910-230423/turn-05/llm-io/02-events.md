...
- characters 377-1552: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1596-4266: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4322-4946: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5009-27630: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27985-28178: `{{event_history}}` from the run's own event record
...
- Turn 4 (1 turn(s) ago): ai_investment_collapse, member_state_defection, emergent_cyber_insurance_crunch
