...
- characters 455-1630: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1674-4344: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5764-6236: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8372-10432: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | Certified Resilience Backstop | 6 | small | 4 | 6 | own jurisdiction | resilience up moderately, eu_political_capital stabilised via visible protection | 2 | running |
...
| M4 | EU Assurance Adoption Programme | 5 | small | 2 | 5 | own jurisdiction | ai_safety up moderately, resilience up slightly via certified deployments | 2 | finished |
