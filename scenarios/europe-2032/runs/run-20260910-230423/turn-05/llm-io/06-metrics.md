...
- characters 13750-14925: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14969-17639: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17695-18659: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | Certified Bio-Screening Uplift | 2 |
...
- `emergent_distressed_compute_selloff` -- first noted turn 5, listed in 1 turn(s) so far: Distressed European data-centre assets and power reservations from the shelved gigafactory-linked builds are sold at fire-sale prices to non-EU buyers, permanently removing two shortlisted sites from EU control.
