...
- characters 376-2909: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2952-4604: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4660-5597: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5660-28942: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29297-29384: `{{event_history}}` from the run's own event record
