...
- characters 377-2112: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2156-4453: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4509-5521: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5584-28866: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29221-29308: `{{event_history}}` from the run's own event record
