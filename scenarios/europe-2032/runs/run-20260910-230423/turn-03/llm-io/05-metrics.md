...
- characters 13357-15092: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15136-17433: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17489-18501: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_cyber_insurance_crunch` -- first noted turn 2, listed in 2 turn(s) so far: A major European insurer reprices cyber cover after the autumn pre-positioning audits, sharply raising premiums or withdrawing cover for municipal utilities and hospitals lacking certified detection.
- `emergent_hyperscaler_pause` -- first noted turn 2, listed in 2 turn(s) so far: A major US hyperscaler freezes two planned EU data-centre expansions, citing grid-connection delays and power-price uncertainty amid competing gigafactory bids.
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, EU Assurance Adoption Programme −2, priority −1 = −12
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 31, sentiment 40 -> +2
SOVEREIGNTY: 22 last turn, no capacity event, Gigafactories in flight +1, capability rose 1.5 −0 = 23
