...
- characters 454-1591: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1634-3663: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4079-4551: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6023-8150: `{{previous_actions}}` from the actor's own response from the previous turn
