...
- characters 377-2182: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2226-4088: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4144-4738: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4801-29602: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29957-30534: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M9 EU Cyber Shield Deployment −2, priority M9 −1 = −3
...
- `emergent_municipal_permit_revolt` -- first noted turn 8, listed in 1 turn(s) so far: Understaffed municipalities facing ENISA patch mandates and grid-site pressure stage coordinated permit slowdowns, demanding EU-funded staffing before unblocking gigafactory power connections.
...
- Turn 2 (7 turn(s) ago): bio_uplift_findings, supply_chain_coercion
- Turn 3 (6 turn(s) ago): cyber_major_incident, bio_uplift_findings, knowledge_work_augmented
- Turn 4 (5 turn(s) ago): export_control_escalation, adoption_success
- Turn 5 (4 turn(s) ago): bio_incident, election_consolidation
- Turn 6 (3 turn(s) ago): openweight_frontier_release, safety_breakthrough, taiwan_tension_rise
- Turn 7 (2 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports
- Turn 8 (1 turn(s) ago): research_breakthrough, taiwan_tension_rise
