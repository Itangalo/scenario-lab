...
- characters 455-2260: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2304-4166: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4234-4739: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7323-8828: `{{previous_actions}}` from the actor's own response from the previous turn
