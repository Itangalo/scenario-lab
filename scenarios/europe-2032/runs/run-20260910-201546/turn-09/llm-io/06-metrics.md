...
- characters 106-13155: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13198-13390: `{{metrics_json}}` from the run's live metric values
- characters 13483-15288: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15332-17194: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17250-17844: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Last-Mile Resilience Corps | 2 |
