...
- characters 107-13285: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13328-13520: `{{metrics_json}}` from the run's live metric values
- characters 13613-14600: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14644-16602: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16658-17419: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Automated Ransomware Containment and Recovery Surge | 2 |
...
PORTFOLIO CHARGE t10: M11 EU Municipal Staffing and Care Access Guarantee −2, priority M11 −1 = −3
PROPOSAL BONUS: M11 (cat 9, small) +2 — emergent permit revolt this turn and medical breakthrough access risk, answers both directly but small and just started
...
- `emergent_substation_supply_crunch` -- first noted turn 11, listed in 1 turn(s) so far: A major non-EU supplier of grid transformers and substation switchgear announces 12-18 month delivery delays after a fire and export backlog, freezing EU factory grid connections and hospital backup upgrades regardless of permits.
