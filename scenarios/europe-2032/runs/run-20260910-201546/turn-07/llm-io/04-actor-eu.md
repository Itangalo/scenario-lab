...
- characters 1456-3389: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4318-4823: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7437-9843: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | EU Bio-Harm Containment and Attribution Surge | 6 | small | 5 | 8 | own jurisdiction | resilience up substantially, ai_safety up slightly | 2 | running |
| M8 | EU Assurance Uptake and Open-Weight Triage | 5 | small | 6 | 8 | own jurisdiction | ai_safety up moderately, resilience up slightly | 2 | running |
