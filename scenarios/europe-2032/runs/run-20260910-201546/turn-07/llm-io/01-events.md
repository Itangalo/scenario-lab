...
- characters 1378-3311: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3367-3918: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3981-28179: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28534-28967: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): bio_uplift_findings, supply_chain_coercion
- Turn 3 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, knowledge_work_augmented
- Turn 4 (3 turn(s) ago): export_control_escalation, adoption_success
- Turn 5 (2 turn(s) ago): bio_incident, election_consolidation
- Turn 6 (1 turn(s) ago): openweight_frontier_release, safety_breakthrough, taiwan_tension_rise
