...
- characters 105-13505: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13548-13740: `{{metrics_json}}` from the run's live metric values
- characters 13833-15043: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15086-17861: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17917-19020: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Bio-Detection and Health Response Surge | 2 |
| M6 | European Public Results Programme | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Hardening and Response Pact −3, EU Chokepoint Defence and Coalition −2, EU Bio-Detection and Health Response Surge −2, priority −1 = −14
PROPOSAL BONUS: EU Bio-Detection and Health Response Surge (cat 6, small) +3 — bio uplift precursor fired this turn opening 4-turn gate and this answers it directly
LEGITIMACY LENDS: capital 22, sentiment 29 -> +2
