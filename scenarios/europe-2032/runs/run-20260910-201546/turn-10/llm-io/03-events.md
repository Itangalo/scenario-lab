...
- characters 1573-3622: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3678-4308: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4371-29172: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29527-30104: `{{event_history}}` from the run's own event record
...
- `emergent_municipal_permit_revolt` -- first noted turn 8, listed in 2 turn(s) so far: Understaffed municipalities facing ENISA patch mandates and grid-site pressure stage coordinated permit slowdowns, demanding EU-funded staffing before unblocking gigafactory power connections.
...
- Turn 2 (8 turn(s) ago): bio_uplift_findings, supply_chain_coercion
- Turn 3 (7 turn(s) ago): cyber_major_incident, bio_uplift_findings, knowledge_work_augmented
- Turn 4 (6 turn(s) ago): export_control_escalation, adoption_success
- Turn 5 (5 turn(s) ago): bio_incident, election_consolidation
- Turn 6 (4 turn(s) ago): openweight_frontier_release, safety_breakthrough, taiwan_tension_rise
- Turn 7 (3 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports
- Turn 8 (2 turn(s) ago): research_breakthrough, taiwan_tension_rise
