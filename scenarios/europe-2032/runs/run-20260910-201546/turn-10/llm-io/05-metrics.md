...
- characters 106-13207: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13250-13442: `{{metrics_json}}` from the run's live metric values
- characters 13535-14688: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14731-16780: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16836-17148: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Municipal Staffing and Care Access Guarantee | 2 |
...
PORTFOLIO CHARGE t9: M10 EU Last-Mile Resilience Corps −2, priority M10 −1 = −3
PROPOSAL BONUS: none — no external event in last three turns that this answers directly
LEGITIMACY LENDS: capital 22, sentiment 26 -> +2
SOVEREIGNTY: 24 last turn, no capacity event, no cat4 in flight +0, capability rose 0.7 −0 = 24
