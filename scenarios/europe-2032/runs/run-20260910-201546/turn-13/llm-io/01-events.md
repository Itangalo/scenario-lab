...
- characters 378-1433: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1477-3462: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3518-4318: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4381-30035: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30390-31236: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M13 EU Clinical Continuity and Sovereign Inference Reserve −3, priority M13 −1 = −4
PROPOSAL BONUS: M13 (cat 4, large) +5 — eu_frontier_access_denied and medical_breakthrough this turn, answers cutoff directly and ties cures to EU terms
LEGITIMACY LENDS: capital 26, sentiment 28 -> +1
SOVEREIGNTY: 23 last turn, no capacity event? no — eu_frontier_access_denied t12 −3, M13 just proposed +0, capability rose 0.6 −0 = 20

## Emerging developments (tracked)

- `emergent_substation_supply_crunch` -- first noted turn 11, listed in 2 turn(s) so far: A major non-EU supplier of grid transformers and substation switchgear announces 12-18 month delivery delays after a fire and export backlog, freezing EU factory grid connections and hospital backup upgrades regardless of permits.
...
- Turn 2 (11 turn(s) ago): bio_uplift_findings, supply_chain_coercion
- Turn 3 (10 turn(s) ago): cyber_major_incident, bio_uplift_findings, knowledge_work_augmented
- Turn 4 (9 turn(s) ago): export_control_escalation, adoption_success
- Turn 5 (8 turn(s) ago): bio_incident, election_consolidation
- Turn 6 (7 turn(s) ago): openweight_frontier_release, safety_breakthrough, taiwan_tension_rise
- Turn 7 (6 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports
- Turn 8 (5 turn(s) ago): research_breakthrough, taiwan_tension_rise
- Turn 10 (3 turn(s) ago): capability_jump, medical_breakthrough, safety_breakthrough, emergent_municipal_permit_revolt
- Turn 11 (2 turn(s) ago): cyber_major_incident, research_breakthrough
- Turn 12 (1 turn(s) ago): medical_breakthrough, eu_frontier_access_denied
