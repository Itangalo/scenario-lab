...
- characters 107-12898: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12941-13133: `{{metrics_json}}` from the run's live metric values
- characters 13226-14281: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14325-16310: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16366-16808: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M14 | EU Allied Access and Supply-Chain Bargain | 2 |
...
## Notepad
PORTFOLIO CHARGE t13: M13 EU Clinical Continuity and Sovereign Inference Reserve −3, M14 EU Allied Access and Supply-Chain Bargain −2, priority M13 −1 = −6
PROPOSAL BONUS: M14 (cat 8, small) +2 — export tightening this turn rations allies, this answers it directly as coalition bargain
LEGITIMACY LENDS: capital 19, sentiment 28 -> +2
SOVEREIGNTY: 20 last turn, no cat4 finish, M13 in flight +0, export_control_escalation t13 −2, capability rose 0.6 −0 = 18
