...
- characters 454-1347: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1390-3297: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4330-4792: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7250-9391: `{{previous_actions}}` from the actor's own response from the previous turn
