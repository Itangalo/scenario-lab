...
- characters 13839-14732: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14775-16682: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16738-17244: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 election winner campaigned on strategic asset with country-tier rationing"}]}
```
```
