...
- characters 376-2059: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2102-4363: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4419-4927: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4990-29188: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29543-30051: `{{event_history}}` from the run's own event record
...
- Turn 2 (6 turn(s) ago): bio_uplift_findings, supply_chain_coercion
- Turn 3 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings, knowledge_work_augmented
- Turn 4 (4 turn(s) ago): export_control_escalation, adoption_success
- Turn 5 (3 turn(s) ago): bio_incident, election_consolidation
- Turn 6 (2 turn(s) ago): openweight_frontier_release, safety_breakthrough, taiwan_tension_rise
- Turn 7 (1 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports
