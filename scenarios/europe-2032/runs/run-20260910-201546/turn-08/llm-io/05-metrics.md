...
- characters 13390-13582: `{{metrics_json}}` from the run's live metric values
- characters 13675-15358: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15401-17662: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17718-18544: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Cyber Shield Deployment | 2 |
