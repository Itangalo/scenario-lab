...
- characters 1351-3451: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3507-4231: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4294-29948: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30303-31073: `{{event_history}}` from the run's own event record
...
- Turn 2 (10 turn(s) ago): bio_uplift_findings, supply_chain_coercion
- Turn 3 (9 turn(s) ago): cyber_major_incident, bio_uplift_findings, knowledge_work_augmented
- Turn 4 (8 turn(s) ago): export_control_escalation, adoption_success
- Turn 5 (7 turn(s) ago): bio_incident, election_consolidation
- Turn 6 (6 turn(s) ago): openweight_frontier_release, safety_breakthrough, taiwan_tension_rise
- Turn 7 (5 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports
- Turn 8 (4 turn(s) ago): research_breakthrough, taiwan_tension_rise
- Turn 10 (2 turn(s) ago): capability_jump, medical_breakthrough, safety_breakthrough, emergent_municipal_permit_revolt
- Turn 11 (1 turn(s) ago): cyber_major_incident, research_breakthrough
