...
- characters 106-13285: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13328-13520: `{{metrics_json}}` from the run's live metric values
- characters 13613-14544: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14587-16687: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16743-17467: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Clinical Continuity and Sovereign Inference Reserve | 3 |
...
PORTFOLIO CHARGE t11: M12 EU Automated Ransomware Containment and Recovery Surge −2, priority M12 −1 = −3
PROPOSAL BONUS: M12 (cat 6, small) +2 — cyber_major_incident this turn, answers directly but small and just started
