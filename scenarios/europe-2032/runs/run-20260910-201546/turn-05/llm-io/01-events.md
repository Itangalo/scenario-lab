...
- characters 377-1474: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1518-3737: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3793-4887: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4950-28731: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29086-29360: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Bio-Detection and Health Response Surge −2, European Public Results Programme −2, priority −1 = −11
PROPOSAL BONUS: none — new cat 9 measure answers adoption success (positive) not a negative shock from last three turns, and does not directly answer export tightening
LEGITIMACY LENDS: capital 22, sentiment 31 -> +2
SOVEREIGNTY: 20 last turn, no capacity build finishes, Gigafactories in flight +0, export_control_escalation t4 −1, capability rose 1.5 −0 = 19

## Emerging developments (tracked)

- `emergent_datacentre_siting_blockade` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated physical protests block construction or grid connection of two or more planned AI data-centre sites, forcing delays and national debate on energy costs.
- `emergent_siting_litigation_wave` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated municipal lawsuits seek to block paused data-centre grid connections from being reallocated to AI factories, turning local recovery anger into siting litigation.
...
- Turn 2 (3 turn(s) ago): bio_uplift_findings, supply_chain_coercion
- Turn 3 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, knowledge_work_augmented
- Turn 4 (1 turn(s) ago): export_control_escalation, adoption_success
...
```
[{"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.5}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.22}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.12}, {"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.045}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.13}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.1}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.03}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.14}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.15}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Coordinated physical protests block construction or grid connection of two or more planned AI data-centre sites, forcing delays and national debate on energy costs.", "emergent": true, "id": "emergent_datacentre_siting_blockade", "probability": 0.24}, {"description": "Coordinated municipal lawsuits seek to block paused data-centre grid connections from being reallocated to AI factories, turning local recovery anger into siting litigation.", "emergent": true, "id": "emergent_siting_litigation_wave", "probability": 0.21}]
```
