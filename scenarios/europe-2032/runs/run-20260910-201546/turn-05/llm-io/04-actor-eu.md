...
- characters 455-1552: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1596-3815: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5005-5474: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7769-9509: `{{previous_actions}}` from the actor's own response from the previous turn
