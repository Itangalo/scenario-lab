...
- characters 1609-3957: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4013-4863: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4926-28208: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28563-28604: `{{event_history}}` from the run's own event record
