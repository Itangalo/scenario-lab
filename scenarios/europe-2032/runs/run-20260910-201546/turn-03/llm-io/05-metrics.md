...
- characters 13334-14600: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14644-16723: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16779-17304: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Chokepoint Defence and Coalition | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Hardening and Response Pact −3, EU Chokepoint Defence and Coalition −2, priority −1 = −12
PROPOSAL BONUS: EU Chokepoint Defence and Coalition (cat 8, small) +2 — supply coercion pressure this turn directly answered, small defensive measure
LEGITIMACY LENDS: capital 29, sentiment 34 -> +2
SOVEREIGNTY: 22 last turn, no capacity event finishes, Gigafactories in flight +0, supply_chain_coercion t2 −2, capability rose 1.5 −0 = 20
