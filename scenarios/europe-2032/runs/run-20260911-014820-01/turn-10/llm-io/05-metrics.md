...
- characters 106-13221: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13264-13455: `{{metrics_json}}` from the run's live metric values
- characters 13548-14397: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14440-16548: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16604-17205: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Transition Shield for Displaced Work and Essential Services | 2 |
| M11 | EU Bio-Detection and Trusted Care Continuity Network | 2 |
| M12 | EU Wartime Neutrality and Critical Infrastructure Shield | 2 |
...
## Metrics
```json
{"ai_capability": 89.0, "openweight_capability": 83.7, "ai_safety": 0.5, "resilience": 38.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 8.0, "public_sentiment": 22.0}
```
