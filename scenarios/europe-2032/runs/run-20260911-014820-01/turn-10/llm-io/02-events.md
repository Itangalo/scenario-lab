...
- characters 376-1225: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1268-3376: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3432-4033: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4096-33724: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34079-34868: `{{event_history}}` from the run's own event record
...
- Turn 7 (3 turn(s) ago): cyber_major_incident, capability_jump, loss_of_control_incident, embodied_ai_deployment, taiwan_tension_rise
- Turn 8 (2 turn(s) ago): cyber_major_incident, capability_jump, rsi_onset, research_breakthrough, labour_displacement, knowledge_work_augmented
- Turn 9 (1 turn(s) ago): bio_uplift_findings, research_breakthrough, adoption_success
