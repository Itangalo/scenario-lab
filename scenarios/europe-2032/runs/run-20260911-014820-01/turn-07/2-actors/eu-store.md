...
| M9 | EU Cyber-Continuity and Loss-of-Control Containment Sprint | 6 | small | 7 | 9 | own jurisdiction | resilience up, ai_safety protected | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Cyber-Continuity and Loss-of-Control Containment Sprint", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety protected"}, "grounds": "to absorb ongoing cyber and agentic incident and keep essential services running"}
  - Grounds: to absorb ongoing cyber and agentic incident and keep essential services running
