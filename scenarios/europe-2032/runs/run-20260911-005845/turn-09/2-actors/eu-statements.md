...
- `two_year_commitment` (commitment): Keep essential services running and rebuild trusted capacity under European control

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Keep essential services running and rebuild trusted capacity under European control
