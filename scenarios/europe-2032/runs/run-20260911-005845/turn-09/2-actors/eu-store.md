...
| M9 | EU Agentic Containment and Bio-Uplift Shield | 6 | small | 7 | 8 | own jurisdiction | resilience up, ai_safety up slightly via containment and bio response | 2 | finished |
| M10 | EU Lithography-for-Compute Security Pact | 8 | small | 8 | 9 | coalition partners holding supply-chain chokepoints plus own jurisdiction | eu_ai_sovereignty up, resilience up slightly via secured compute for essential services | 2 | finished |
| M11 | EU Essential Services Defence and Continuity Surge | 6 | small | 9 | 11 | own jurisdiction | resilience up, ai_safety up slightly via reduced cyber harm | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Essential Services Defence and Continuity Surge", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly via reduced cyber harm"}, "grounds": "to answer major cyber incident under rationing and collapse"}
  - Grounds: to answer major cyber incident under rationing and collapse
