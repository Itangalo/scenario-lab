...
| M8 | EU Opaque-Systems Black-Box Assurance Cell | 5 | small | 6 | 8 | own jurisdiction plus coalition partners in joint command/pact | ai_safety up, resilience up slightly via reduced cyber/bio misuse | 2 | running |
| M9 | EU Agentic Containment and Bio-Uplift Shield | 6 | small | 7 | 9 | own jurisdiction | resilience up, ai_safety up slightly via containment and bio response | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Agentic Containment and Bio-Uplift Shield", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly via containment and bio response"}, "grounds": "to answer loss-of-control incident and bio-uplift precursor before cascade"}
  - Grounds: to answer loss-of-control incident and bio-uplift precursor before cascade
