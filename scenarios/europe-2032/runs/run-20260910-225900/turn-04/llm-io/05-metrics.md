...
- characters 105-13730: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13773-13965: `{{metrics_json}}` from the run's live metric values
- characters 14058-15186: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15229-17411: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17467-18040: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Continuity Access and Joint Response Accession | 2 |
