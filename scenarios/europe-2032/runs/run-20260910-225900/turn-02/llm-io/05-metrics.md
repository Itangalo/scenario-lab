...
- characters 105-13165: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13208-13400: `{{metrics_json}}` from the run's live metric values
- characters 13493-14706: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14749-16944: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17000-18071: `{{notepad}}` from the Game Master's notepad, carried across turns
