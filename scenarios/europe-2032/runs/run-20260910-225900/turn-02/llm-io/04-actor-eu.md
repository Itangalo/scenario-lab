...
- characters 5625-6065: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7519-9610: `{{previous_actions}}` from the actor's own response from the previous turn
