...
- characters 377-1656: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1700-4050: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4106-5304: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5367-29594: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29949-30106: `{{event_history}}` from the run's own event record
...
- `emergent_grid_disclosure_surge` -- first noted turn 2, listed in 1 turn(s) so far: A coordinated disclosure by European grid operators and vendors publishes indicators and tooling from the autumn transmission-network intrusions, triggering emergency procurement of OT monitoring across member states.
- `emergent_grid_pact` -- first noted turn 2, listed in 1 turn(s) so far: European grid operators and vendors quietly form a cross-border OT threat-intelligence sharing pact after the autumn intrusion, publishing joint segmentation standards that non-EU suppliers must meet to retain contracts.
...
- Turn 2 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, taiwan_tension_rise, export_control_escalation
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.28}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.1}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.18}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.25}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.06}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.15}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.15}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "A coordinated disclosure by European grid operators and vendors publishes indicators and tooling from the autumn transmission-network intrusions, triggering emergency procurement of OT monitoring across member states.", "emergent": true, "id": "emergent_grid_disclosure_surge", "probability": 0.2}, {"description": "European grid operators and vendors quietly form a cross-border OT threat-intelligence sharing pact after the autumn intrusion, publishing joint segmentation standards that non-EU suppliers must meet to retain contracts.", "emergent": true, "id": "emergent_grid_pact", "probability": 0.16}]
```
