...
- characters 455-1605: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1649-3725: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5834-6274: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8570-10423: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Continuity Access and Joint Response Accession | 6 | small | 4 | 7 | coalition | resilience up materially, eu_political_capital protected | 2 | running |
