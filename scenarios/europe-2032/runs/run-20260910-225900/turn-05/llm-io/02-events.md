...
- characters 377-1527: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1571-3647: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3703-4256: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4319-31992: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32347-32691: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, taiwan_tension_rise, export_control_escalation
- Turn 3 (2 turn(s) ago): bio_incident, safety_breakthrough, supply_chain_coercion
- Turn 4 (1 turn(s) ago): openweight_frontier_release, eu_frontier_access_denied, joint_threat_response
