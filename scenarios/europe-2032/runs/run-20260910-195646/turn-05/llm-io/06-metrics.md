...
- characters 13711-15691: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15735-17991: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18047-19298: `{{notepad}}` from the Game Master's notepad, carried across turns
