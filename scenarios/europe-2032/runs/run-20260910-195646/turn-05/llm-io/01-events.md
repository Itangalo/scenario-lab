...
- characters 377-2357: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2401-4657: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4713-5964: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6027-35003: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35358-35544: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M6 EU Critical Services Fallback Stack −3, priority −1 = −10
PROPOSAL BONUS: EU Critical Services Fallback Stack (cat 6, large) +5 — eu_frontier_access_denied this turn cut hospitals/ministries/firms off leading model and this answers it directly
LEGITIMACY LENDS: none — capital 36, sentiment 31, capital higher so no lend
SOVEREIGNTY: 19 last turn, no cat4 finish, Gigafactories in flight +0, eu_frontier_access_denied t4 −2, capability rose 3.0 −1 = 16

## Emerging developments (tracked)

- `emergent_pause_legal_challenge` -- first noted turn 4, listed in 1 turn(s) so far: A coalition of US labs and industry groups files for interim relief against the Commission's conditional hold in EU courts and via US trade channels, forcing a public legal test of the emergency systemic-risk base before test criteria are final.
- `emergent_court_challenge_to_hold` -- first noted turn 4, listed in 1 turn(s) so far: A coalition of providers and a member-state government files for interim relief before the EU General Court challenging the Commission's conditional market hold, arguing the emergency legal base is invalid and seeking suspension of clearance requirements.
...
- Turn 2 (3 turn(s) ago): knowledge_work_augmented
- Turn 3 (2 turn(s) ago): capability_jump
- Turn 4 (1 turn(s) ago): eu_frontier_access_denied
...
```
[{"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.45}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.15}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.12}, {"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.06}, {"description": "", "emergent": false, "id": "rsi_onset", "probability": 0.35}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.16}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.08}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "A coalition of US labs and industry groups files for interim relief against the Commission's conditional hold in EU courts and via US trade channels, forcing a public legal test of the emergency systemic-risk base before test criteria are final.", "emergent": true, "id": "emergent_pause_legal_challenge", "probability": 0.22}, {"description": "A coalition of providers and a member-state government files for interim relief before the EU General Court challenging the Commission's conditional market hold, arguing the emergency legal base is invalid and seeking suspension of clearance requirements.", "emergent": true, "id": "emergent_court_challenge_to_hold", "probability": 0.18}]
```
