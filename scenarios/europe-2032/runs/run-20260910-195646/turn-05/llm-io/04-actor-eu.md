...
- characters 455-2435: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2479-4735: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 9931-10409: `{{statement_ledger}}` from the actor's live statement ledger
- characters 12659-14846: `{{previous_actions}}` from the actor's own response from the previous turn
