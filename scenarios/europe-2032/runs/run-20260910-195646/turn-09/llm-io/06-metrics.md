...
- characters 13474-13665: `{{metrics_json}}` from the run's live metric values
- characters 13758-14789: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14833-16906: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16962-17392: `{{notepad}}` from the Game Master's notepad, carried across turns
