...
- characters 376-1407: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1451-3524: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3580-4318: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4381-34030: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34385-35139: `{{event_history}}` from the run's own event record
...
- `emergent_bench_synthesis_workaround` -- first noted turn 7, listed in 2 turn(s) so far: Underground brokers advertise desktop synthesis protocol workarounds paired with open-weight genome design assistance, prompting coordinated seizures across several member states.
...
- Turn 2 (7 turn(s) ago): knowledge_work_augmented
- Turn 3 (6 turn(s) ago): capability_jump
- Turn 4 (5 turn(s) ago): eu_frontier_access_denied
- Turn 5 (4 turn(s) ago): rsi_onset, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning, research_breakthrough, medical_breakthrough, export_control_escalation, adoption_success, election_retrenchment
- Turn 6 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, medical_breakthrough, member_state_defection
- Turn 7 (2 turn(s) ago): capability_jump, research_breakthrough, labour_displacement, taiwan_tension_rise, member_state_defection
- Turn 8 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, research_breakthrough
