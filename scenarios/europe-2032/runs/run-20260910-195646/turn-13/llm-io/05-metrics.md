...
- characters 107-13378: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13421-13609: `{{metrics_json}}` from the run's live metric values
- characters 13702-14991: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15035-17303: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17359-18036: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M15 | EU Pandemic Survival Mobilisation | 2 |
...
## Notepad
PORTFOLIO CHARGE t13: M14 EU Middle-Power Leverage Activation −2, M15 EU Pandemic Survival Mobilisation −2, priority −1 = −5
PROPOSAL BONUS: EU Pandemic Survival Mobilisation (cat 6, small) +4 — catastrophic_bio_incident fired this turn and this answers it directly, small size limits gain
LEGITIMACY LENDS: capital 13, sentiment 5 -> none, capital higher
SOVEREIGNTY: 7 last turn, no capacity finish, no cat4 in flight +0, supply_chain_coercion t13 −2, capability rose 2.0 −1 = 4
