...
- characters 374-1663: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1707-3975: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4031-5055: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5118-33600: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33955-35283: `{{event_history}}` from the run's own event record
...
- Turn 2 (11 turn(s) ago): knowledge_work_augmented
- Turn 3 (10 turn(s) ago): capability_jump
- Turn 4 (9 turn(s) ago): eu_frontier_access_denied
- Turn 5 (8 turn(s) ago): rsi_onset, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning, research_breakthrough, medical_breakthrough, export_control_escalation, adoption_success, election_retrenchment
- Turn 6 (7 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, medical_breakthrough, member_state_defection
- Turn 7 (6 turn(s) ago): capability_jump, research_breakthrough, labour_displacement, taiwan_tension_rise, member_state_defection
- Turn 8 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, research_breakthrough
- Turn 9 (4 turn(s) ago): capability_jump, bio_uplift_findings, export_control_escalation, middle_power_coalition
- Turn 10 (3 turn(s) ago): medical_breakthrough, embodied_ai_deployment, taiwan_tension_rise, eu_frontier_access_denied, supply_chain_coercion, adoption_success, automated_decision_scandal
- Turn 11 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, embodied_ai_deployment, catastrophic_great_power_conflict, supply_chain_coercion
- Turn 12 (1 turn(s) ago): loss_of_control_incident, capability_jump, supply_chain_coercion, middle_power_coalition
