...
- characters 376-1885: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1928-3923: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3979-4464: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4527-34176: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34531-35399: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): knowledge_work_augmented
- Turn 3 (7 turn(s) ago): capability_jump
- Turn 4 (6 turn(s) ago): eu_frontier_access_denied
- Turn 5 (5 turn(s) ago): rsi_onset, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning, research_breakthrough, medical_breakthrough, export_control_escalation, adoption_success, election_retrenchment
- Turn 6 (4 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, medical_breakthrough, member_state_defection
- Turn 7 (3 turn(s) ago): capability_jump, research_breakthrough, labour_displacement, taiwan_tension_rise, member_state_defection
- Turn 8 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, research_breakthrough
- Turn 9 (1 turn(s) ago): capability_jump, bio_uplift_findings, export_control_escalation, middle_power_coalition
