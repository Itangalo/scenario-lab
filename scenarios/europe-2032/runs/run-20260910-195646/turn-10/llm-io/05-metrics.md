...
- characters 106-13396: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13439-13630: `{{metrics_json}}` from the run's live metric values
- characters 13723-15232: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15275-17270: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17326-17811: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Middle-Power Supply Chain Compact | 2 |
...
PORTFOLIO CHARGE t9: M10 EU Municipal Services Cyber Restoration Cell −2, M11 EU Middle-Power Supply Chain Compact −2, priority M10 −1 = −5
PROPOSAL BONUS: EU Middle-Power Supply Chain Compact (cat 8, small) +2 — export_control_escalation and capability_jump landed this turn and this answers them directly
LEGITIMACY LENDS: capital 19, sentiment 21 -> +1
SOVEREIGNTY: 18 last turn, no capacity event finish, no cat4 in flight, middle_power_coalition t9 +2, capability rose 5.0 −1 = 19
