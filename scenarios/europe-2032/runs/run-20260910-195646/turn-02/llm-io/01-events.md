...
- characters 1675-3655: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3711-4709: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4772-27849: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28204-28245: `{{event_history}}` from the run's own event record
