...
- characters 106-13401: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13444-13635: `{{metrics_json}}` from the run's live metric values
- characters 13728-14813: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14856-16806: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16862-17762: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M14 | EU Middle-Power Leverage Activation | 2 |
...
- `emergent_anti_ai_infrastructure_sabotage` -- first noted turn 11, listed in 2 turn(s) so far: Coordinated physical sabotage against European data-centre construction sites and grid connections, claimed by anti-AI networks and amplified by local siting disputes, halting at least one major build for months.
