...
- characters 376-1461: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1504-3454: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3510-4410: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4473-32955: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33310-34521: `{{event_history}}` from the run's own event record
...
- Turn 2 (10 turn(s) ago): knowledge_work_augmented
- Turn 3 (9 turn(s) ago): capability_jump
- Turn 4 (8 turn(s) ago): eu_frontier_access_denied
- Turn 5 (7 turn(s) ago): rsi_onset, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning, research_breakthrough, medical_breakthrough, export_control_escalation, adoption_success, election_retrenchment
- Turn 6 (6 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, medical_breakthrough, member_state_defection
- Turn 7 (5 turn(s) ago): capability_jump, research_breakthrough, labour_displacement, taiwan_tension_rise, member_state_defection
- Turn 8 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, research_breakthrough
- Turn 9 (3 turn(s) ago): capability_jump, bio_uplift_findings, export_control_escalation, middle_power_coalition
- Turn 10 (2 turn(s) ago): medical_breakthrough, embodied_ai_deployment, taiwan_tension_rise, eu_frontier_access_denied, supply_chain_coercion, adoption_success, automated_decision_scandal
- Turn 11 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, embodied_ai_deployment, catastrophic_great_power_conflict, supply_chain_coercion
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.3}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.03}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.15}, {"description": "", "emergent": false, "id": "us_labs_nationalised", "probability": 0.06}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Coordinated physical sabotage against European data-centre construction sites and grid connections, claimed by anti-AI networks and amplified by local siting disputes, halting at least one major build for months.", "emergent": true, "id": "emergent_anti_ai_infrastructure_sabotage", "probability": 0.28}]
```
