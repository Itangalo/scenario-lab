...
- characters 374-1549: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1592-3777: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3833-4636: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4699-34348: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34703-35344: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: M7 EU Bio-Cyber Resilience Surge −3, M8 EU Assurance Restoration Taskforce −2, M9 EU Graduate Transition Guarantee −2, priority −1 = −8
PROPOSAL BONUS: EU Graduate Transition Guarantee (cat 7, small) +2 — labour_displacement landed this turn and this answers it directly
LEGITIMACY LENDS: capital 6, sentiment 26 -> +2
SOVEREIGNTY: 17 last turn, M1 InvestAI Gigafactories finishes t7 +5, no capacity event in flight, member_state_defection t7 −2, capability rose 5.0 −1 = 19

## Emerging developments (tracked)

- `emergent_bench_synthesis_workaround` -- first noted turn 7, listed in 1 turn(s) so far: Underground brokers advertise desktop synthesis protocol workarounds paired with open-weight genome design assistance, prompting coordinated seizures across several member states.
...
- Turn 2 (6 turn(s) ago): knowledge_work_augmented
- Turn 3 (5 turn(s) ago): capability_jump
- Turn 4 (4 turn(s) ago): eu_frontier_access_denied
- Turn 5 (3 turn(s) ago): rsi_onset, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning, research_breakthrough, medical_breakthrough, export_control_escalation, adoption_success, election_retrenchment
- Turn 6 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, medical_breakthrough, member_state_defection
- Turn 7 (1 turn(s) ago): capability_jump, research_breakthrough, labour_displacement, taiwan_tension_rise, member_state_defection
