...
- characters 105-13559: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13602-13792: `{{metrics_json}}` from the run's live metric values
- characters 13885-15060: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15103-17288: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17344-18147: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Municipal Services Cyber Restoration Cell | 2 |
