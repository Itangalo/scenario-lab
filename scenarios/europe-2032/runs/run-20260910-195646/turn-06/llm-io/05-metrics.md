...
- characters 105-13445: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13488-13679: `{{metrics_json}}` from the run's live metric values
- characters 13772-15089: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15132-17767: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17823-18331: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 75.0, "openweight_capability": 66.0, "ai_safety": 4.0, "resilience": 41.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 23.0, "public_sentiment": 32.0}
```
## Narrative
