...
- characters 375-1692: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1735-4370: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4426-5647: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5710-33146: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33501-33897: `{{event_history}}` from the run's own event record
...
- `emergent_pause_legal_challenge` -- first noted turn 4, listed in 2 turn(s) so far: A coalition of US labs and industry groups files for interim relief against the Commission's conditional hold in EU courts and via US trade channels, forcing a public legal test of the emergency systemic-risk base before test criteria are final.
- `emergent_court_challenge_to_hold` -- first noted turn 4, listed in 2 turn(s) so far: A coalition of providers and a member-state government files for interim relief before the EU General Court challenging the Commission's conditional market hold, arguing the emergency legal base is invalid and seeking suspension of clearance requirements.
...
- Turn 3 (3 turn(s) ago): capability_jump
- Turn 4 (2 turn(s) ago): eu_frontier_access_denied
- Turn 5 (1 turn(s) ago): rsi_onset, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning, research_breakthrough, medical_breakthrough, export_control_escalation, adoption_success, election_retrenchment
