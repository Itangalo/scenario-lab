...
- characters 453-1770: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1813-4448: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6228-6696: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9109-11698: `{{previous_actions}}` from the actor's own response from the previous turn
