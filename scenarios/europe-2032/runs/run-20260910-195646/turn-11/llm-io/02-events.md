...
- characters 377-1769: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1813-3925: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3981-4519: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4582-34231: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34586-35644: `{{event_history}}` from the run's own event record
...
- Turn 2 (9 turn(s) ago): knowledge_work_augmented
- Turn 3 (8 turn(s) ago): capability_jump
- Turn 4 (7 turn(s) ago): eu_frontier_access_denied
- Turn 5 (6 turn(s) ago): rsi_onset, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning, research_breakthrough, medical_breakthrough, export_control_escalation, adoption_success, election_retrenchment
- Turn 6 (5 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, medical_breakthrough, member_state_defection
- Turn 7 (4 turn(s) ago): capability_jump, research_breakthrough, labour_displacement, taiwan_tension_rise, member_state_defection
- Turn 8 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, research_breakthrough
- Turn 9 (2 turn(s) ago): capability_jump, bio_uplift_findings, export_control_escalation, middle_power_coalition
- Turn 10 (1 turn(s) ago): medical_breakthrough, embodied_ai_deployment, taiwan_tension_rise, eu_frontier_access_denied, supply_chain_coercion, adoption_success, automated_decision_scandal
