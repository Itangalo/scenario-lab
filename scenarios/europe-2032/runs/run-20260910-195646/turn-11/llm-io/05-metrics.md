...
- characters 107-13398: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13441-13632: `{{metrics_json}}` from the run's live metric values
- characters 13725-15117: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15161-17273: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17329-18214: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Trusted Public Benefit Deployment | 2 |
| M13 | EU Wartime Continuity Shield | 2 |
...
PORTFOLIO CHARGE t10: M11 EU Middle-Power Supply Chain Compact −2, M12 EU Trusted Public Benefit Deployment −2, priority M11 −1 = −5
PROPOSAL BONUS: EU Trusted Public Benefit Deployment (cat 9, small) +3 — eu_frontier_access_denied and supply_chain_coercion landed this turn and adoption_success plus medical breakthrough open window this answers directly
LEGITIMACY LENDS: capital 14, sentiment 18 -> +1
SOVEREIGNTY: 19 last turn, no capacity event finish, no cat4 in flight, eu_frontier_access_denied t10 −3, capability rose 1.5 −1 = 15

## Emerging developments (tracked)

- `emergent_anti_ai_infrastructure_sabotage` -- first noted turn 11, listed in 1 turn(s) so far: Coordinated physical sabotage against European data-centre construction sites and grid connections, claimed by anti-AI networks and amplified by local siting disputes, halting at least one major build for months.
...
## Notepad
PORTFOLIO CHARGE t11: M12 EU Trusted Public Benefit Deployment −2, M13 EU Wartime Continuity Shield −2, priority no effect/cost below 20 = −4
PROPOSAL BONUS: EU Wartime Continuity Shield (cat 6, small) +4 — catastrophic war plus cyber_major_incident landed this turn and this answers both directly
LEGITIMACY LENDS: capital 12, sentiment 10 -> none, capital higher
SOVEREIGNTY: 15 last turn, no capacity finish, no cat4 in flight +0, supply_chain_coercion t11 −3 (largest of coercion / embodied deployment / war access loss), capability rose 2.0 −1 = 11
## Store changes
```json
{"store": []}
```
