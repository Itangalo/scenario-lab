...
- characters 16367-16916: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_datacentre_siting_backlash` -- first noted turn 1, listed in 1 turn(s) so far: Coordinated municipal protests and permit challenges stall two planned hyperscale data-centre sites in the EU over power and water use, forcing a national-level siting debate.
- `emergent_datacentre_backlash` -- first noted turn 1, listed in 1 turn(s) so far: Coordinated protests and local permit challenges stall several planned EU data-centre expansions in autumn 2026 after energy-cost and jobs coverage turns hostile.
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 46.0, "ai_safety": 32.0, "resilience": 38.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 44.0, "public_sentiment": 39.0}
```
## Narrative
...
PROPOSAL BONUS: EU Critical Systems Shield (cat 6, large) +4 — autumn intrusion pre-positioning in EU grids landed this turn and this answers it directly
LEGITIMACY LENDS: none — capital 44, sentiment 39, capital higher
