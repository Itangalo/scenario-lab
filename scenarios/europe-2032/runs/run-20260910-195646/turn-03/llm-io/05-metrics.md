...
- characters 106-13056: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13099-13291: `{{metrics_json}}` from the run's live metric values
- characters 13384-15000: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15044-17392: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17448-17914: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Deployment Pause Trigger | 3 |
...
## Metrics
```json
{"ai_capability": 62.0, "openweight_capability": 54.0, "ai_safety": 22.0, "resilience": 40.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 33.0, "public_sentiment": 38.0}
```
