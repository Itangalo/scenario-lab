...
- characters 2037-4385: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4441-5458: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5521-29097: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29452-29544: `{{event_history}}` from the run's own event record
