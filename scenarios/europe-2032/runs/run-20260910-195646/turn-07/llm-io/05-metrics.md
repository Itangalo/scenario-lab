...
- characters 106-13403: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13446-13637: `{{metrics_json}}` from the run's live metric values
- characters 13730-15502: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15546-17707: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17763-18599: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Bio-Cyber Resilience Surge | 3 |
| M8 | EU Assurance Restoration Taskforce | 2 |
| M9 | EU Graduate Transition Guarantee | 2 |
