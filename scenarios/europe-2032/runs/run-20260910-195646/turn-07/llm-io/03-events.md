...
- characters 376-2148: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2192-4353: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4409-4937: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5000-33603: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33958-34468: `{{event_history}}` from the run's own event record
...
- Turn 3 (4 turn(s) ago): capability_jump
- Turn 4 (3 turn(s) ago): eu_frontier_access_denied
- Turn 5 (2 turn(s) ago): rsi_onset, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning, research_breakthrough, medical_breakthrough, export_control_escalation, adoption_success, election_retrenchment
- Turn 6 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, medical_breakthrough, member_state_defection
