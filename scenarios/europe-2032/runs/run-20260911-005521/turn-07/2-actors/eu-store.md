...
| M9 | EU Shield Patch-Speed Deployment | 6 | small | 7 | 9 | own jurisdiction | resilience up, ai_safety up slightly via reduced cyber harm | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Shield Patch-Speed Deployment", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly via reduced cyber harm"}, "grounds": "to exploit defensive breakthrough against the verifiable-domain jump"}
  - Grounds: to exploit defensive breakthrough against the verifiable-domain jump
