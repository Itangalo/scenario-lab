...
- `two_year_commitment` (commitment): Keep essential services running through AI-enabled shocks while rebuilding shared leverage to constrain harm

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Keep essential services running through AI-enabled shocks while rebuilding shared leverage to constrain harm
