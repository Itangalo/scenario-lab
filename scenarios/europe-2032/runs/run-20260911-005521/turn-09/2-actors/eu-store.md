...
| M10 | EU Upstream Leverage and Continuity Compact | 8 | small | 8 | 9 | coalition partners holding supply-chain chokepoints plus own jurisdiction | eu_ai_sovereignty up, resilience up via secured supply and bio-response | 2 | finished |
| M11 | EU Essential Continuity and Cascade Arrest | 6 | small | 9 | 11 | own jurisdiction | resilience up, eu_political_capital protected from service failure | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Essential Continuity and Cascade Arrest", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_political_capital protected from service failure"}, "grounds": "to arrest cascade from major automated attack during containment weeks"}
  - Grounds: to arrest cascade from major automated attack during containment weeks
