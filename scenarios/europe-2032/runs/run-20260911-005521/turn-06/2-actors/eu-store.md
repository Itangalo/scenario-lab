...
- **applied** `M8` — {"op": "add", "table": "measures", "fields": {"name": "EU Opaque-Systems Black-Box Assurance Cell", "category": 5, "size": "small", "finish_turn": 8, "applies_to": "own jurisdiction plus coalition partners in joint command/pact", "targeted_effect": "ai_safety up, resilience up slightly via reduced cyber/bio misuse"}, "grounds": "to replace CoT-dependent oversight after opacity shock and openweight
  - Grounds: to replace CoT-dependent oversight after opacity shock and openweight jump
