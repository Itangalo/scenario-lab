...
| M9 | EU Shield Patch-Speed Deployment | 6 | small | 7 | 8 | own jurisdiction | resilience up, ai_safety up slightly via reduced cyber harm | 2 | finished |
| M10 | EU Upstream Leverage and Continuity Compact | 8 | small | 8 | 10 | coalition partners holding supply-chain chokepoints plus own jurisdiction | eu_ai_sovereignty up, resilience up via secured supply and bio-response | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Upstream Leverage and Continuity Compact", "category": 8, "size": "small", "finish_turn": 10, "applies_to": "coalition partners holding supply-chain chokepoints plus own jurisdiction", "targeted_effect": "eu_ai_sovereignty up, resilience up via secured supply and bio-response"}, "grounds": "to convert upstream position into supply security 
  - Grounds: to convert upstream position into supply security during blockade and bio incident
