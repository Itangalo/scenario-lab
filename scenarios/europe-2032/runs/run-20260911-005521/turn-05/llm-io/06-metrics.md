...
- characters 106-13563: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13606-13798: `{{metrics_json}}` from the run's live metric values
- characters 13891-16003: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16047-18070: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18126-18979: `{{notepad}}` from the Game Master's notepad, carried across turns
