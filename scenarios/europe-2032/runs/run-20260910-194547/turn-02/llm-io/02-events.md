...
- characters 1789-3707: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3763-4521: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4584-27661: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28016-28100: `{{event_history}}` from the run's own event record
