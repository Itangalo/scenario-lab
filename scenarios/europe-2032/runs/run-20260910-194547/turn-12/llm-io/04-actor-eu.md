...
- characters 453-4531: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 4574-6556: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7959-8418: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11848-13853: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M12 | EU Bio-Detection Staffing and Response Surge | 6 | small | 11 | 13 | own jurisdiction | resilience up slightly via staffed detection and response | 2 | running |
