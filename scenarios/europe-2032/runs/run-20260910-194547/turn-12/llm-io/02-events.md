...
- characters 375-4453: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 4496-6478: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6534-7087: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 7150-36169: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 36524-37509: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M10 EU Essential Work Continuity Pact −2, M11 EU Jump Triage and Degraded Operations Order −2, M12 EU Bio-Detection Staffing and Response Surge −2 = −6 (priority named but capital below 20 so no effect and no cost)
PROPOSAL BONUS: M12 (cat 6, small) +3 — contested viable-design preprint opened bio risk this turn and this staffs the deployed shield directly
LEGITIMACY LENDS: capital 7, sentiment 11 -> +2 (capped, counted in capital)
SOVEREIGNTY: 21 last turn, no capacity event, no cat4 in flight +0, capability rose 3.0 −1 = 20
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports
- Turn 2 (10 turn(s) ago): capability_jump, bio_uplift_findings, export_control_escalation, eu_frontier_access_denied
- Turn 3 (9 turn(s) ago): opaque_reasoning
- Turn 4 (8 turn(s) ago): eval_anomaly_reports, research_breakthrough, medical_breakthrough, taiwan_tension_rise, emergent_opaque_deception_leak
- Turn 5 (7 turn(s) ago): capability_jump, medical_breakthrough, safety_breakthrough, taiwan_tension_rise, member_state_defection, adoption_success, election_alliance
- Turn 6 (6 turn(s) ago): medical_breakthrough, safety_breakthrough, export_control_escalation, emergent_opaque_clinical_harm
- Turn 7 (5 turn(s) ago): rsi_onset, openweight_frontier_release
- Turn 8 (4 turn(s) ago): ai_investment_collapse, bio_uplift_findings, taiwan_tension_rise, emergent_clinical_trust_boycott
- Turn 10 (2 turn(s) ago): capability_jump
- Turn 11 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports
