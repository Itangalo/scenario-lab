...
- characters 13590-13780: `{{metrics_json}}` from the run's live metric values
- characters 13873-17951: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 17994-19976: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 20032-20906: `{{notepad}}` from the Game Master's notepad, carried across turns
