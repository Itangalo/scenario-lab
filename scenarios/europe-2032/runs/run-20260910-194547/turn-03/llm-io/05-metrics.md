...
- characters 106-13473: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13516-13708: `{{metrics_json}}` from the run's live metric values
- characters 13801-14978: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15022-16897: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16953-17516: `{{notepad}}` from the Game Master's notepad, carried across turns
