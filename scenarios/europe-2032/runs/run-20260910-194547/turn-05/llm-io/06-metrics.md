...
- characters 13458-15811: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15855-18423: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18479-19422: `{{notepad}}` from the Game Master's notepad, carried across turns
