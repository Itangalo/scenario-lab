...
- characters 455-2808: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2852-5420: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8142-8609: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10924-13216: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Concealed-Planning Inquiry Shield | 2 | small | 4 | 6 | own jurisdiction | ai_safety up slightly, public_sentiment up slightly via secured medical access | 2 | running |
