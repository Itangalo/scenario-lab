...
- characters 454-2359: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2403-4748: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4816-5257: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8148-10327: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Bio-Capability Detection and Clinical Shield | 6 | small | 8 | 10 | own jurisdiction | resilience up moderately, ai_safety up slightly via early detection | 2 | running |
