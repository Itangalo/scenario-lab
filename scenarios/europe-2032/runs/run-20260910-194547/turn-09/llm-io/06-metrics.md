...
- characters 13726-15631: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15675-18020: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18076-18887: `{{notepad}}` from the Game Master's notepad, carried across turns
