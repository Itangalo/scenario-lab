...
- characters 377-3493: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3537-5632: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5688-6462: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6525-35544: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35899-36814: `{{event_history}}` from the run's own event record
...
- `emergent_energy_compute_curtailment` -- first noted turn 9, listed in 2 turn(s) so far: Municipal utilities and hospital operators impose rolling power and compute curtailments on AI data-centres during winter peak, triggering physical protests and emergency rationing orders in several member states.
...
- Turn 2 (9 turn(s) ago): capability_jump, bio_uplift_findings, export_control_escalation, eu_frontier_access_denied
- Turn 3 (8 turn(s) ago): opaque_reasoning
- Turn 4 (7 turn(s) ago): eval_anomaly_reports, research_breakthrough, medical_breakthrough, taiwan_tension_rise, emergent_opaque_deception_leak
- Turn 5 (6 turn(s) ago): capability_jump, medical_breakthrough, safety_breakthrough, taiwan_tension_rise, member_state_defection, adoption_success, election_alliance
- Turn 6 (5 turn(s) ago): medical_breakthrough, safety_breakthrough, export_control_escalation, emergent_opaque_clinical_harm
- Turn 7 (4 turn(s) ago): rsi_onset, openweight_frontier_release
- Turn 8 (3 turn(s) ago): ai_investment_collapse, bio_uplift_findings, taiwan_tension_rise, emergent_clinical_trust_boycott
- Turn 10 (1 turn(s) ago): capability_jump
