...
- characters 107-13066: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13109-13300: `{{metrics_json}}` from the run's live metric values
- characters 13393-16509: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16553-18648: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18704-19136: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M12 | EU Bio-Detection Staffing and Response Surge | 2 |
