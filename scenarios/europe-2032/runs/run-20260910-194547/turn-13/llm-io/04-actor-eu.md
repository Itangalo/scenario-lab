...
- characters 1600-3329: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4448-4907: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8186-9593: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M10 | EU Essential Work Continuity Pact | 7 | small | 9 | 12 | own jurisdiction | resilience up slightly, public_sentiment up slightly via staffed continuity | 2 | finished |
| M11 | EU Jump Triage and Degraded Operations Order | 6 | small | 10 | 12 | own jurisdiction | resilience up slightly, ai_safety up slightly via paused illegible deployment | 2 | finished |
| M12 | EU Bio-Detection Staffing and Response Surge | 6 | small | 11 | 13 | own jurisdiction | resilience up slightly via staffed detection and response | 2 | finished |
...
## New measure
None this turn, while we conserve the last of political capital to keep paid staffing and degraded operations alive through open great-power war.

## Store changes
No changes.

## Priority
M12 EU Bio-Detection Staffing and Response Surge, because staffed sentinel sampling and pre-cleared isolation guidance is the only in-flight capacity that still functions as essential-services continuity when fabs, cables and data centres become targets and cohesion hangs on paid overtime.

## In practice
We do not open a new legislative track or a new fund with capital at 7 and sentiment at 11. Under the Civil Protection Mechanism and Serious Cross-Border Threats Regulation we extend the degraded-operation order and the M12 short-term contracts, paying technicians, sampling nurses and wastewater overtime from already-reprogrammed ESF+ and EU4Health reflows via HERA and DG EMPL.

We declare neutrality-protection posture in the Council: no EU territory for strikes on dual-use infrastructure, reinforced guarding of fabs, landing stations and interconnectors, mutual-aid triggers between hardened regions and reduced-service municipalities, and alert-sharing even with the member state on the separate US hyperscaler stack. The freeze on illegible critical updates stays as legal cover for French, Belgian and Dutch refusals, with liability payouts continued as hazard pay to prevent walkouts.
...
```
## New measure
**EU Wartime Cyber Restoration and Mutual Aid Corps**
Keeps power, hospitals, telecoms and municipalities restorable through combined war targeting and automated ransomware by fielding joint cyber-restoration teams and analogue fallback kits.
This is category 6 Preparedness and resilience, small and fast because with capital at 10 and sentiment at 3 we cannot legislate, only keep what is staffed alive through the cyber major incident and the defence breakthrough window.

## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Wartime Cyber Restoration and Mutual Aid Corps", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately via restoration and mutual aid"}, "grounds": "war strikes plus automated attack require restorable degraded operations"}]}
```

## Priority
M13 EU Wartime Cyber Restoration and Mutual Aid Corps, because it is the only new instrument and it directly serves the two-year commitment to keep essential services and cohesion functioning when nothing else can be started.

## In practice
We act under the Civil Protection Mechanism and NIS2 Article response, not a new law. DG CNECT, ENISA and the EU Civil Protection Pool task existing M3-hardened SOCs and M12 bio-sampling staff into cross-border restoration teams, funded by reprogrammed ESF+ and EU4Health reflows already committed to overtime.

We deploy the cyber_defence_breakthrough first to hospitals, grid control and telecoms: automated patching and swarm detection pushed via the Cyber Shield, with analogue fallbacks and pre-cleared isolation kept as legal cover for continued triage refusals in France, Belgium and Netherlands. Guarding of fabs, landing stations and interconnectors continues under the neutrality-protection posture, with mutual-aid triggers from hardened regions to reduced-service towns.

We ask no Council vote for money, only endorsement of no-EU-territory-for-strikes and liability-as-hazard-pay continuity to prevent walkouts, because with political capital exhausted any contested proposal collapses enforcement elsewhere.
