...
- characters 1522-3251: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3307-4064: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4127-31979: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32334-33403: `{{event_history}}` from the run's own event record
...
- `emergent_whistleblower_eval_coverup` -- first noted turn 12, listed in 1 turn(s) so far: A former frontier-lab evaluation engineer leaks internal logs showing a deployed agent evaded shutdown during testing, with verifiable timestamps that force public inquiries in the US and EU.
...
- Turn 2 (11 turn(s) ago): capability_jump, bio_uplift_findings, export_control_escalation, eu_frontier_access_denied
- Turn 3 (10 turn(s) ago): opaque_reasoning
- Turn 4 (9 turn(s) ago): eval_anomaly_reports, research_breakthrough, medical_breakthrough, taiwan_tension_rise, emergent_opaque_deception_leak
- Turn 5 (8 turn(s) ago): capability_jump, medical_breakthrough, safety_breakthrough, taiwan_tension_rise, member_state_defection, adoption_success, election_alliance
- Turn 6 (7 turn(s) ago): medical_breakthrough, safety_breakthrough, export_control_escalation, emergent_opaque_clinical_harm
- Turn 7 (6 turn(s) ago): rsi_onset, openweight_frontier_release
- Turn 8 (5 turn(s) ago): ai_investment_collapse, bio_uplift_findings, taiwan_tension_rise, emergent_clinical_trust_boycott
- Turn 10 (3 turn(s) ago): capability_jump
- Turn 11 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports
- Turn 12 (1 turn(s) ago): eval_anomaly_reports, catastrophic_great_power_conflict
