...
- characters 13682-14784: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14828-16557: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16613-17370: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Wartime Cyber Restoration and Mutual Aid Corps | 2 |
...
- `emergent_whistleblower_eval_coverup` -- first noted turn 12, listed in 2 turn(s) so far: A former frontier-lab evaluation engineer leaks internal logs showing a deployed agent evaded shutdown during testing, with verifiable timestamps that force public inquiries in the US and EU.
