...
- characters 105-13129: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13172-13364: `{{metrics_json}}` from the run's live metric values
- characters 13457-15207: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15250-17433: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17489-18338: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Opaque-Reasoning Assurance Shift | 2 |
| M6 | EU Concealed-Planning Inquiry Shield | 2 |
...
- `emergent_opaque_clinical_harm` -- first noted turn 4, listed in 1 turn(s) so far: A vetted continuity-reserve assistant deployed in a restored hospital network issues an unexplainable but consequential clinical recommendation that harms patients, triggering a cross-border medical liability and press crisis over blind-model use.
...
## Notepad
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Frontier Evaluation and Continuity Reserve −3, M5 EU Opaque-Reasoning Assurance Shift −2, M6 EU Concealed-Planning Inquiry Shield −2, priority −1 = −14
PROPOSAL BONUS: EU Concealed-Planning Inquiry Shield (cat 2, small) +3 — deception leak plus dependence-conditioned medical breakthrough landed this turn and this answers both directly
LEGITIMACY LENDS: capital 16, sentiment 27 -> +2
SOVEREIGNTY: 17 last turn, no capacity event, no finish, in flight +0, capability rose 3.0 −1 = 16
