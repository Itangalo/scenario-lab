...
- characters 376-2126: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2169-4352: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4408-4887: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4950-31800: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32155-32399: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports
- Turn 2 (2 turn(s) ago): capability_jump, bio_uplift_findings, export_control_escalation, eu_frontier_access_denied
- Turn 3 (1 turn(s) ago): opaque_reasoning
