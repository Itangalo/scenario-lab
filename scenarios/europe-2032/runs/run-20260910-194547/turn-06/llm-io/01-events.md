...
- characters 375-1417: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1460-3586: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3642-4451: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4514-32489: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32844-33400: `{{event_history}}` from the run's own event record
...
- Turn 2 (4 turn(s) ago): capability_jump, bio_uplift_findings, export_control_escalation, eu_frontier_access_denied
- Turn 3 (3 turn(s) ago): opaque_reasoning
- Turn 4 (2 turn(s) ago): eval_anomaly_reports, research_breakthrough, medical_breakthrough, taiwan_tension_rise, emergent_opaque_deception_leak
- Turn 5 (1 turn(s) ago): capability_jump, medical_breakthrough, safety_breakthrough, taiwan_tension_rise, member_state_defection, adoption_success, election_alliance
