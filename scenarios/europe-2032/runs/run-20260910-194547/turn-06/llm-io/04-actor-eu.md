...
- characters 453-1495: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1538-3664: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5101-5542: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7859-9591: `{{previous_actions}}` from the actor's own response from the previous turn
