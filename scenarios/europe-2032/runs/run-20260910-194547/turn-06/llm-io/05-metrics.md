...
- characters 105-13814: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13857-14048: `{{metrics_json}}` from the run's live metric values
- characters 14141-15183: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15226-17352: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17408-17847: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Frontier Evaluation and Continuity Reserve | 3 |
| M7 | EU Clinical AI Harm Review and Liability Protocol | 2 |
...
PORTFOLIO CHARGE t5: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Frontier Evaluation and Continuity Reserve −3, M5 EU Opaque-Reasoning Assurance Shift −2, M6 EU Concealed-Planning Inquiry Shield −2, priority −1 = −14
PROPOSAL BONUS: none
LEGITIMACY LENDS: capital 10, sentiment 26 -> +2
SOVEREIGNTY: 16 last turn, no capacity event, no finish, in flight +1, member_state_defection t5 −2, capability rose 7.0 −1 = 14
...
**emergent_opaque_clinical_harm (emergent event):** A vetted continuity-reserve assistant deployed in a restored hospital network issues an unexplainable but consequential clinical recommendation that harms patients, triggering a cross-border medical liability and press crisis over blind-model use.
...
## Metrics
```json
{"ai_capability": 76.0, "openweight_capability": 67.5, "ai_safety": 17.0, "resilience": 37.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 12.0, "public_sentiment": 22.0}
```
## Narrative
...
## Notepad
PORTFOLIO CHARGE t6: M1 InvestAI Gigafactories −3, M4 EU Frontier Evaluation and Continuity Reserve −3, M7 EU Clinical AI Harm Review and Liability Protocol −2, priority −1 = −9
PROPOSAL BONUS: EU Clinical AI Harm Review and Liability Protocol (cat 2, small) +3 — emergent opaque clinical harm fired this turn and this answers it directly, plus medical dependence pressure
LEGITIMACY LENDS: capital 10, sentiment 26 -> +2
SOVEREIGNTY: 14 last turn, Tech sovereignty package finishes t6 +4, M1 in flight +1, export_control_escalation t6 +2, capability rose 3.0 −1 = 20
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "ALLIANCE"}}]}
```
```
