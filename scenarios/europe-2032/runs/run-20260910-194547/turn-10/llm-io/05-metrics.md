...
- characters 13452-13643: `{{metrics_json}}` from the run's live metric values
- characters 13736-15917: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15960-17846: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17902-18679: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Essential Work Continuity Pact | 2 |
| M11 | EU Jump Triage and Degraded Operations Order | 2 |
