...
- characters 376-2557: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2600-4486: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4542-5319: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5382-34401: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34756-35627: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M9 EU Bio-Capability Detection and Clinical Shield −2, M10 EU Essential Work Continuity Pact −2, priority −1 = −5
PROPOSAL BONUS: none — no external event in last three turns that M10 answers; boycotts and unfunded mandates are ongoing conditions, not a qualifying event
LEGITIMACY LENDS: capital 6, sentiment 14 -> +2
SOVEREIGNTY: 23 last turn, no capacity event, no cat4 in flight +0, capability rose 1.5 −1 = 22

## Emerging developments (tracked)

- `emergent_energy_compute_curtailment` -- first noted turn 9, listed in 1 turn(s) so far: Municipal utilities and hospital operators impose rolling power and compute curtailments on AI data-centres during winter peak, triggering physical protests and emergency rationing orders in several member states.
...
- Turn 2 (8 turn(s) ago): capability_jump, bio_uplift_findings, export_control_escalation, eu_frontier_access_denied
- Turn 3 (7 turn(s) ago): opaque_reasoning
- Turn 4 (6 turn(s) ago): eval_anomaly_reports, research_breakthrough, medical_breakthrough, taiwan_tension_rise, emergent_opaque_deception_leak
- Turn 5 (5 turn(s) ago): capability_jump, medical_breakthrough, safety_breakthrough, taiwan_tension_rise, member_state_defection, adoption_success, election_alliance
- Turn 6 (4 turn(s) ago): medical_breakthrough, safety_breakthrough, export_control_escalation, emergent_opaque_clinical_harm
- Turn 7 (3 turn(s) ago): rsi_onset, openweight_frontier_release
- Turn 8 (2 turn(s) ago): ai_investment_collapse, bio_uplift_findings, taiwan_tension_rise, emergent_clinical_trust_boycott
