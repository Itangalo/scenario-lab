...
- characters 454-2635: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2678-4564: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4901-5360: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8428-10698: `{{previous_actions}}` from the actor's own response from the previous turn
