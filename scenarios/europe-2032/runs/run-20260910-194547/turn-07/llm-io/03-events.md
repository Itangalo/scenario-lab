...
- characters 1613-3475: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3531-4098: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4161-33303: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33658-34340: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports
- Turn 2 (5 turn(s) ago): capability_jump, bio_uplift_findings, export_control_escalation, eu_frontier_access_denied
- Turn 3 (4 turn(s) ago): opaque_reasoning
- Turn 4 (3 turn(s) ago): eval_anomaly_reports, research_breakthrough, medical_breakthrough, taiwan_tension_rise, emergent_opaque_deception_leak
- Turn 5 (2 turn(s) ago): capability_jump, medical_breakthrough, safety_breakthrough, taiwan_tension_rise, member_state_defection, adoption_success, election_alliance
- Turn 6 (1 turn(s) ago): medical_breakthrough, safety_breakthrough, export_control_escalation, emergent_opaque_clinical_harm
