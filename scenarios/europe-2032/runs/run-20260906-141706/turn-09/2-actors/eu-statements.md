...
- `two_year_commitment` (commitment): Sovereign AI infrastructure operational and auditable under Union authority

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Sovereign AI infrastructure operational and auditable under Union authority
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly changes the actor's obligation to maintain the original statement's timeframe, enabling a shift to a present-tense operational claim.
