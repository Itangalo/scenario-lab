...
- characters 105-13461: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13504-13696: `{{metrics_json}}` from the run's live metric values
- characters 13789-15094: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15137-17265: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17321-17703: `{{notepad}}` from the Game Master's notepad, carried across turns
