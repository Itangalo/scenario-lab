...
| M9 | EU Municipal Recovery Corps | 6 | small | 8 | 9 | own jurisdiction | resilience up to restore services and stop cascade | 2 | finished |
| M10 | EU Loss-of-Control Containment and Service-Isolation Protocol | 6 | small | 9 | 11 | own jurisdiction | resilience up, ai_safety up slightly via containment | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Loss-of-Control Containment and Service-Isolation Protocol", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly via containment"}, "grounds": "agentic loss-of-control with days-long containment uncertainty"}
  - Grounds: agentic loss-of-control with days-long containment uncertainty
