...
- `two_year_commitment` (commitment): Rebuild public trust through resilient services and jobs anchored in a verifiable international safety order

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild public trust through resilient services and jobs anchored in a verifiable international safety order
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the commitment period directly ends the timeframe for the original pledge, changing the cost and relevance of maintaining it.
