...
| M9 | EU Municipal Recovery Corps | 6 | small | 8 | 10 | own jurisdiction | resilience up to restore services and stop cascade | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Municipal Recovery Corps", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up to restore services and stop cascade"}, "grounds": "automated ransomware sweep has municipal systems dark"}
  - Grounds: automated ransomware sweep has municipal systems dark
