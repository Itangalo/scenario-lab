...
| M9 | EU Trusted Cures Deployment | 9 | small | 7 | 9 | own jurisdiction | public_sentiment up sharply, resilience up slightly via health capacity | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Trusted Cures Deployment", "category": 9, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up sharply, resilience up slightly via health capacity"}, "grounds": "to capture medical breakthrough for legitimacy before dependence narrative sets"}
  - Grounds: to capture medical breakthrough for legitimacy before dependence narrative sets
