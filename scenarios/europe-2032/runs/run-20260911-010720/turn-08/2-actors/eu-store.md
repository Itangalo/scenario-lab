...
| M10 | EU Bio-Incident Containment Surge | 6 | small | 8 | 10 | own jurisdiction | resilience up substantially to stop cascade, ai_safety loss contained | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio-Incident Containment Surge", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up substantially to stop cascade, ai_safety loss contained"}, "grounds": "to contain real bio incident now"}
  - Grounds: to contain real bio incident now
