...
- `two_year_commitment` (commitment): Rebuild European agency through resilient society and readable EU-anchored AI

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild European agency through resilient society and readable EU-anchored AI
