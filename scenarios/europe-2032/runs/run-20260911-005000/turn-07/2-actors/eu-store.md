...
| M8 | EU Essential Care Continuity and Bio-Uplift Shield | 6 | small | 7 | 9 | own jurisdiction | resilience up moderately, ai_safety protected, public_sentiment protected | 2 | running |
...
- **applied** `M8` — {"op": "add", "table": "measures", "fields": {"name": "EU Essential Care Continuity and Bio-Uplift Shield", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected, public_sentiment protected"}, "grounds": "frontier access denied and bio uplift precursor demand immediate continuity and shielding"}
  - Grounds: frontier access denied and bio uplift precursor demand immediate continuity and shielding
