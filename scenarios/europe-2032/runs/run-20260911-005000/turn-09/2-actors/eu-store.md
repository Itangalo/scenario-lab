...
| M8 | EU Essential Care Continuity and Bio-Uplift Shield | 6 | small | 7 | 9 | own jurisdiction | resilience up moderately, ai_safety protected, public_sentiment protected | 2 | finished |
| M9 | Transatlantic State-Level AI Access Accord | 8 | small | 9 | 12 | US with coalition and supply-chain partners | eu_ai_sovereignty protected/up modestly via assured access, resilience protected, ai_safety up modestly via joint evaluation | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "Transatlantic State-Level AI Access Accord", "category": 8, "size": "small", "finish_turn": 12, "applies_to": "US with coalition and supply-chain partners", "targeted_effect": "eu_ai_sovereignty protected/up modestly via assured access, resilience protected, ai_safety up modestly via joint evaluation"}, "grounds": "US nationalisation requires 
  - Grounds: US nationalisation requires state-to-state bargain
