...
| M6 | EU Essential Services Continuity and Energy Triage | 6 | small | 8 | 10 | own jurisdiction | resilience up moderately, eu_political_capital up slightly if continuity holds | 2 | running |
...
- **applied** `M6` — {"op": "add", "table": "measures", "fields": {"name": "EU Essential Services Continuity and Energy Triage", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital up slightly if continuity holds"}, "grounds": "energy curtailment and degraded services demand immediate absorption"}
  - Grounds: energy curtailment and degraded services demand immediate absorption
