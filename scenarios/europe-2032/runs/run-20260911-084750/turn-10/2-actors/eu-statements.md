...
- **modify** `two_year_commitment` — applied
  ...
  - Reason: The closure of the commitment period directly ends the timeframe the original statement was bound to, changing the cost of maintaining it and triggering a necessary reassessment.
