...
| M8 | EU Critical Services Cyber Recovery Corps and Dependency Patching Pact | 6 | small | 10 | 12 | own jurisdiction | resilience up moderately, eu_political_capital up slightly if recovery visible | 2 | running |
...
- **applied** `M8` — {"op": "add", "table": "measures", "fields": {"name": "EU Critical Services Cyber Recovery Corps and Dependency Patching Pact", "category": 6, "size": "small", "finish_turn": 12, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital up slightly if recovery visible"}, "grounds": "automated cyber sweep demands immediate containment"}
  - Grounds: automated cyber sweep demands immediate containment
