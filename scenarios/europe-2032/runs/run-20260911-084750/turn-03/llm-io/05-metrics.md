...
- characters 106-13146: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13189-13381: `{{metrics_json}}` from the run's live metric values
- characters 13474-15140: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15184-17142: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17198-18005: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_power_price_protests` -- first noted turn 2, listed in 2 turn(s) so far: Municipal protests and permitting lawsuits stall two gigafactory shortlist sites over power prices and water use, forcing renegotiation of grid connections and co-financing terms.
...
## Metrics
```json
{"ai_capability": 57.5, "openweight_capability": 53.0, "ai_safety": 35.0, "resilience": 35.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 11.0, "public_sentiment": 28.0}
```
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Grid and Public Services Shield −3, priority −1 = −13
