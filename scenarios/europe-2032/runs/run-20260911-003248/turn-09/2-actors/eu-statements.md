...
- `two_year_commitment` (commitment): Survive the cascade by keeping essential services running and rebuilding trust through protection that people can see

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Survive the cascade by keeping essential services running and rebuilding trust through protection that people can see
