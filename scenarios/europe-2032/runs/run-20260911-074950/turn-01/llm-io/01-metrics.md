...
- characters 13476-16425: `{{world_state}}` from background/context.md, seeded as the opening world state
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 46.0, "ai_safety": 32.0, "resilience": 38.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 34.0, "public_sentiment": 42.0}
```
