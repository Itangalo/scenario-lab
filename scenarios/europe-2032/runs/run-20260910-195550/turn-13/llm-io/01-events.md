...
- characters 376-1367: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1411-3719: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3775-4255: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4318-31681: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32036-33025: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M9 EU Embodied-Work Transition Shield −2, priority has no effect and no cost as capital 5 below 20 = −2
PROPOSAL BONUS: EU Embodied-Work Transition Shield (cat 7, small) +3 — embodied_ai_deployment landed this turn splitting warehouse/logistics work and this answers it directly
LEGITIMACY LENDS: capital 7, sentiment 16 -> +2
SOVEREIGNTY: 16 last turn, M8 finishes t12 not cat4 +0, M9 in flight +0, embodied_ai_deployment t12 −2, capability rose 1.0 −0 = 14
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, supply_chain_coercion
- Turn 2 (11 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
- Turn 3 (10 turn(s) ago): loss_of_control_incident, export_control_escalation
- Turn 4 (9 turn(s) ago): capability_jump, cyber_defence_breakthrough
- Turn 5 (8 turn(s) ago): cyber_major_incident, knowledge_work_augmented, emergent_datacentre_blockades, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, openweight_frontier_release, supply_chain_coercion
- Turn 7 (6 turn(s) ago): bio_uplift_findings, opaque_reasoning, openweight_frontier_release
- Turn 8 (5 turn(s) ago): cyber_major_incident
- Turn 10 (3 turn(s) ago): knowledge_work_augmented, eu_frontier_access_denied, adoption_success
- Turn 11 (2 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, emergent_infrastructure_backlash
- Turn 12 (1 turn(s) ago): openweight_frontier_release, embodied_ai_deployment
