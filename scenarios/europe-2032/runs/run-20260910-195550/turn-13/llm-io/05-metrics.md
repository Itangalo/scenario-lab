...
- characters 13251-14242: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14286-16594: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16650-17692: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_robot_sabotage_wave` -- first noted turn 13, listed in 1 turn(s) so far: Coordinated warehouse-robot sabotage campaign spreads across Venlo, Lille and Lodz, with activists disabling pallet units and integrators threatening to withdraw service contracts.
- `emergent_warehouse_robot_sabotage` -- first noted turn 13, listed in 1 turn(s) so far: Coordinated sabotage disables palletized warehouse robots in several EU logistics hubs, filmed as anti-machine resistance and forcing temporary return to manual shifts.
...
## Notepad
PORTFOLIO CHARGE t13: M9 EU Embodied-Work Transition Shield −2 = −2 + priority has no effect and no cost as capital 7 below 20
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 7, sentiment 16 -> +2 (capped by subsequent negative events, applied before them)
SOVEREIGNTY: 14 last turn, no cat4 finish +0, M9 in flight +0, middle_power_coalition t13 +2 (largest capacity event, securing over member_state_defection taking away), capability rose 1.2 −0 = 16
