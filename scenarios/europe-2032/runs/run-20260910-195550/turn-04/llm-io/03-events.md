...
- characters 376-1970: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2013-4915: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4971-5709: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5772-30676: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31031-31268: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
- Turn 3 (1 turn(s) ago): loss_of_control_incident, export_control_escalation
