...
- characters 13489-15083: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15126-18028: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18084-19424: `{{notepad}}` from the Game Master's notepad, carried across turns
