...
- characters 375-1745: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1788-3553: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3609-4163: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4226-31589: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31944-32646: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M7 EU Local Continuity and Livelihood Bridge −2, priority has no effect and no cost as capital 11 below 20 = −2
PROPOSAL BONUS: EU Local Continuity and Livelihood Bridge (cat 7, small) +2 — February combined ransomware + poisoned update wave and degraded hospitals/municipalities in prior turns, this answers restoration and income support directly
LEGITIMACY LENDS: capital 14 after charge+finish+bonus, sentiment 5 -> none, capital higher
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, supply_chain_coercion
- Turn 2 (8 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
- Turn 3 (7 turn(s) ago): loss_of_control_incident, export_control_escalation
- Turn 4 (6 turn(s) ago): capability_jump, cyber_defence_breakthrough
- Turn 5 (5 turn(s) ago): cyber_major_incident, knowledge_work_augmented, emergent_datacentre_blockades, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, openweight_frontier_release, supply_chain_coercion
- Turn 7 (3 turn(s) ago): bio_uplift_findings, opaque_reasoning, openweight_frontier_release
