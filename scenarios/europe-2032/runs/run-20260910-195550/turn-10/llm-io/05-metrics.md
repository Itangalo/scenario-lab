...
- characters 106-12972: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13015-13205: `{{metrics_json}}` from the run's live metric values
- characters 13298-14668: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14711-16476: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16532-17648: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Local Continuity and Livelihood Bridge | 2 |
| M8 | EU Service Continuity Stack | 2 |
