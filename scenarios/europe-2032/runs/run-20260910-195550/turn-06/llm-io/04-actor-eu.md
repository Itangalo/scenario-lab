...
- characters 453-1791: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1834-4160: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5842-6337: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8505-10099: `{{previous_actions}}` from the actor's own response from the previous turn
