...
- characters 375-1713: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1756-4082: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4138-4898: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4961-31565: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31920-32355: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Loss-of-Control Containment and Agent Accountability Protocol −2 = −8 (priority named but has no effect and no cost as capital 9 below 20)
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 7, sentiment 17 -> +2 (capped below sentiment)
SOVEREIGNTY: 16 last turn, no capacity event, Gigafactories/tech package in flight +0, capability rose 2.0 −1 = 15

## Emerging developments (tracked)

- `emergent_anti_ai_site_blockades` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated physical protests and blockades target data-centre and gigafactory sites in multiple member states, forcing temporary construction halts and police deployments.
...
- Turn 2 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
- Turn 3 (3 turn(s) ago): loss_of_control_incident, export_control_escalation
- Turn 4 (2 turn(s) ago): capability_jump, cyber_defence_breakthrough
- Turn 5 (1 turn(s) ago): cyber_major_incident, knowledge_work_augmented, emergent_datacentre_blockades, election_consolidation
