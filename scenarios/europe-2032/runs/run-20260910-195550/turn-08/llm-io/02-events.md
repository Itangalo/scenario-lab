...
- characters 1873-4009: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4065-4887: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4950-31460: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31815-32470: `{{event_history}}` from the run's own event record
...
- `emergent_anti_ai_sabotage_escalation` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated physical sabotage hits power substations feeding idle compute-factory sites and a data-centre construction camp, claimed by anti-AI groups, forcing emergency security deployments.
...
- Turn 2 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
- Turn 3 (5 turn(s) ago): loss_of_control_incident, export_control_escalation
- Turn 4 (4 turn(s) ago): capability_jump, cyber_defence_breakthrough
- Turn 5 (3 turn(s) ago): cyber_major_incident, knowledge_work_augmented, emergent_datacentre_blockades, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, openweight_frontier_release, supply_chain_coercion
- Turn 7 (1 turn(s) ago): bio_uplift_findings, opaque_reasoning, openweight_frontier_release
