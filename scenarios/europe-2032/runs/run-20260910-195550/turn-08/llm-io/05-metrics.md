...
- characters 13262-14716: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14759-16895: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16951-17773: `{{notepad}}` from the Game Master's notepad, carried across turns
