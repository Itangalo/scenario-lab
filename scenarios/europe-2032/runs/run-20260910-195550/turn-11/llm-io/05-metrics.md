...
- characters 107-13351: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13394-13584: `{{metrics_json}}` from the run's live metric values
- characters 13677-14860: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14904-17051: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17107-17951: `{{notepad}}` from the Game Master's notepad, carried across turns
