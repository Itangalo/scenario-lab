...
- characters 106-13162: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13205-13397: `{{metrics_json}}` from the run's live metric values
- characters 13490-15028: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15072-17440: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17496-18125: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Loss-of-Control Containment and Agent Accountability Protocol | 2 |
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 53.0, "ai_safety": 28.0, "resilience": 36.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 9.0, "public_sentiment": 20.0}
```
