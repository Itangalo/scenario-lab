...
- characters 13644-13835: `{{metrics_json}}` from the run's live metric values
- characters 13928-14956: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15000-17861: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17917-18835: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.5, "openweight_capability": 57.5, "ai_safety": 18.0, "resilience": 39.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 9.0, "public_sentiment": 17.0}
```
## Narrative
### The sweep
