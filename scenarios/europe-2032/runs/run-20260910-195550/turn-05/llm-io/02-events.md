...
- characters 376-1404: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1448-4309: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4365-5588: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5651-30555: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30910-31217: `{{event_history}}` from the run's own event record
...
- `emergent_anti_ai_site_blockades` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated physical protests and blockades target data-centre and gigafactory sites in multiple member states, forcing temporary construction halts and police deployments.
- `emergent_datacentre_blockades` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated physical protests block data-centre and compute-factory sites in several member states, with sit-ins and sabotage attempts that halt construction for weeks and force a national debate on power and water use.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, supply_chain_coercion
- Turn 2 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
- Turn 3 (2 turn(s) ago): loss_of_control_incident, export_control_escalation
- Turn 4 (1 turn(s) ago): capability_jump, cyber_defence_breakthrough
