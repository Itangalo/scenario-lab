...
- characters 454-1482: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1526-4387: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7077-7553: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9719-11143: `{{previous_actions}}` from the actor's own response from the previous turn
