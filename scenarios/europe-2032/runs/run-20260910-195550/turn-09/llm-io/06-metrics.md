...
- characters 13387-13578: `{{metrics_json}}` from the run's live metric values
- characters 13671-14516: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14560-16472: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16528-16903: `{{notepad}}` from the Game Master's notepad, carried across turns
