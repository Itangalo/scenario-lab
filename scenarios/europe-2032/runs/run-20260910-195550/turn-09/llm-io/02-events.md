...
- characters 1265-3177: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3233-3929: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3992-30502: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30857-31559: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M6 EU Degraded-Mode Continuity and Bio-Signal Surge −2, priority has no effect and no cost as capital 10 below 20 = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 8 after charge, sentiment 12 -> +1 (capped below sentiment)
SOVEREIGNTY: 19 last turn, no capacity event, no cat4 in flight, capability rose 1.0 −0 = 19

## Emerging developments (tracked)

- `emergent_anti_ai_sabotage_escalation` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated physical sabotage hits power substations feeding idle compute-factory sites and a data-centre construction camp, claimed by anti-AI groups, forcing emergency security deployments.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, supply_chain_coercion
- Turn 2 (7 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
- Turn 3 (6 turn(s) ago): loss_of_control_incident, export_control_escalation
- Turn 4 (5 turn(s) ago): capability_jump, cyber_defence_breakthrough
- Turn 5 (4 turn(s) ago): cyber_major_incident, knowledge_work_augmented, emergent_datacentre_blockades, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, openweight_frontier_release, supply_chain_coercion
- Turn 7 (2 turn(s) ago): bio_uplift_findings, opaque_reasoning, openweight_frontier_release
