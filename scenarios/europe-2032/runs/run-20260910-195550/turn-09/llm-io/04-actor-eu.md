...
- characters 1343-3255: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3323-3818: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6029-7453: `{{previous_actions}}` from the actor's own response from the previous turn
