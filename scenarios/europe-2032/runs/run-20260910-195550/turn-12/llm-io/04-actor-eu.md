...
- characters 453-1863: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1906-3982: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5590-6057: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8679-9694: `{{previous_actions}}` from the actor's own response from the previous turn
