...
- characters 375-1785: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1828-3904: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3960-4597: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4660-32023: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32378-33287: `{{event_history}}` from the run's own event record
...
- `emergent_infrastructure_sabotage_wave` -- first noted turn 10, listed in 2 turn(s) so far: Coordinated physical attacks on idle gigafactory shells and grid substations by anti-AI local groups, forcing prolonged security shutdowns and national guard deployments in two member states.
...
- Turn 2 (10 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
- Turn 3 (9 turn(s) ago): loss_of_control_incident, export_control_escalation
- Turn 4 (8 turn(s) ago): capability_jump, cyber_defence_breakthrough
- Turn 5 (7 turn(s) ago): cyber_major_incident, knowledge_work_augmented, emergent_datacentre_blockades, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, openweight_frontier_release, supply_chain_coercion
- Turn 7 (5 turn(s) ago): bio_uplift_findings, opaque_reasoning, openweight_frontier_release
- Turn 8 (4 turn(s) ago): cyber_major_incident
- Turn 10 (2 turn(s) ago): knowledge_work_augmented, eu_frontier_access_denied, adoption_success
- Turn 11 (1 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, emergent_infrastructure_backlash
