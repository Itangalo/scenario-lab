...
- characters 106-13344: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13387-13577: `{{metrics_json}}` from the run's live metric values
- characters 13670-15080: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15123-17199: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17255-17569: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Embodied-Work Transition Shield | 2 |
...
## Metrics
```json
{"ai_capability": 68.5, "openweight_capability": 65.8, "ai_safety": 3.0, "resilience": 40.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 7.0, "public_sentiment": 16.0}
```
## Narrative
### The machines arrive
