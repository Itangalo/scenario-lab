...
- characters 105-13633: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13676-13868: `{{metrics_json}}` from the run's live metric values
- characters 13961-15395: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15438-17813: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17869-18502: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Critical Services Cyber-Bio Shield | 2 |
