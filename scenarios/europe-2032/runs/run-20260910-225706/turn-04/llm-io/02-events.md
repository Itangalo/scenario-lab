...
- characters 376-1810: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1853-4228: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4284-5298: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5361-30265: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30620-30890: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, adoption_success, automated_decision_scandal
- Turn 3 (1 turn(s) ago): loss_of_control_incident, safety_breakthrough, emergent_gigafactory_siting_backlash
