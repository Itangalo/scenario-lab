...
- characters 1908-4397: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6224-6664: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8809-10815: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Critical Services Cyber-Bio Shield | 6 | small | 4 | 6 | own jurisdiction | resilience up | 2 | running |
...
| M5 | EU Agentic Containment Protocol | 6 | small | 3 | 5 | own jurisdiction | ai_safety up modestly, resilience up | 2 | finished |
