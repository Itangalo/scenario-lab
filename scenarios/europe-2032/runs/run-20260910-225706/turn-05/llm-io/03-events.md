...
- characters 377-1786: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1830-4319: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4375-4882: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4945-33430: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33785-34150: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Agentic Containment Protocol −2, EU Critical Services Cyber-Bio Shield −2 = −10 + priority no effect/cost as capital below 20
PROPOSAL BONUS: none — Cyber-Bio Shield already in flight as M6, no new measure entered portfolio this turn
LEGITIMACY LENDS: capital 9, sentiment 32 -> +2 capped by prior terms
SOVEREIGNTY: 19 last turn, no category 4 finish, in flight +0, export_control_escalation t4 −2, capability rose 2.0 −1 = 16
...
- Turn 2 (3 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, adoption_success, automated_decision_scandal
- Turn 3 (2 turn(s) ago): loss_of_control_incident, safety_breakthrough, emergent_gigafactory_siting_backlash
- Turn 4 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, export_control_escalation
