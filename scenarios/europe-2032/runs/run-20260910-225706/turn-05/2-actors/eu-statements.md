...
- `two_year_commitment` (commitment): Hold autonomy through supply-chain leverage and resilient essential services

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold autonomy through supply-chain leverage and resilient essential services
