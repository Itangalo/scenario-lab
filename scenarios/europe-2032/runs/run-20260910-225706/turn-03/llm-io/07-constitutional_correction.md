...
- characters 2785-3285: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 53.0, "ai_safety": 35.0, "resilience": 36.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 15.0, "public_sentiment": 38.0}
```
