...
- characters 7151-7591: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9045-11136: `{{previous_actions}}` from the actor's own response from the previous turn
