...
- characters 105-13154: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13197-13389: `{{metrics_json}}` from the run's live metric values
- characters 13482-14695: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14738-16933: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16989-18062: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 50.0, "ai_safety": 30.0, "resilience": 37.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 17.0, "public_sentiment": 42.0}
```
