...
- characters 1632-3827: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3883-4318: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4381-28608: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28963-29004: `{{event_history}}` from the run's own event record
