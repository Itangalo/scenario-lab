...
- characters 453-2212: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2255-4362: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8032-8524: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10706-12616: `{{previous_actions}}` from the actor's own response from the previous turn
