...
- characters 375-2134: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2177-4284: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4340-5353: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5416-32020: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32375-32689: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Evaluation and Assurance Capacity −2, EU Essential Services Continuity Fallback −2, priority −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 3, sentiment 28.5 -> +2
SOVEREIGNTY: 12 last turn, no capacity event, in flight +0, capability rose 1.0 −0 = 12

## Emerging developments (tracked)

- `emergent_grid_sabotage_protests` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated physical sabotage against transmission substations and data-centre power feeds in two member states, claimed by anti-AI activists and timed to the permit-freeze protests, forcing temporary load-shedding.
- `emergent_datacentre_construction_halt` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated physical protests and grid-connection blockades halt construction at two EU gigafactory-linked data-centre sites after municipal permit freezes, delaying fallback hosting capacity for months.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, eu_frontier_access_denied
- Turn 3 (3 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (2 turn(s) ago): bio_uplift_findings, export_control_escalation
