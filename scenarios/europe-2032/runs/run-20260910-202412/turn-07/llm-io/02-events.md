...
- characters 376-2016: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2060-4476: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4532-4961: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5024-32231: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32586-33047: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, priority −1 (no effect, capital below 20, not charged) = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 22.0 -> +2 (capped by sentiment, applied after charges and completions)
SOVEREIGNTY: 12 last turn, Tech sovereignty package finishes t6 +5, Gigafactories in flight +1, embodied_ai_deployment t6 −2, capability rose 1.0 −0 = 16
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, eu_frontier_access_denied
- Turn 3 (4 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (3 turn(s) ago): bio_uplift_findings, export_control_escalation
- Turn 5 (2 turn(s) ago): cyber_major_incident, election_consolidation
- Turn 6 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, embodied_ai_deployment
