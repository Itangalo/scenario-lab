...
- characters 376-1383: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1427-3534: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3590-3938: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4001-31208: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31563-32230: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, eu_frontier_access_denied
- Turn 3 (6 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (5 turn(s) ago): bio_uplift_findings, export_control_escalation
- Turn 5 (4 turn(s) ago): cyber_major_incident, election_consolidation
- Turn 6 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, embodied_ai_deployment
- Turn 7 (2 turn(s) ago): export_control_escalation
- Turn 8 (1 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response, emergent_grid_siting_sabotage
