...
- characters 454-1461: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1505-3612: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7388-7880: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9911-11507: `{{previous_actions}}` from the actor's own response from the previous turn
