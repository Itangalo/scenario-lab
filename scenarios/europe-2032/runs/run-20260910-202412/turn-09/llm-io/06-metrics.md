...
- characters 106-12837: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12880-13071: `{{metrics_json}}` from the run's live metric values
- characters 13164-14171: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14215-16322: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16378-16726: `{{notepad}}` from the Game Master's notepad, carried across turns
