...
- characters 377-1783: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1827-3975: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4031-4838: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4901-32367: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32722-33805: `{{event_history}}` from the run's own event record
...
- `emergent_municipal_compute_freeze` -- first noted turn 10, listed in 1 turn(s) so far: Several municipal councils impose emergency moratoria on new data-centre grid connections after the autumn outages, freezing already-quota-constrained EU compute expansion for months.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, eu_frontier_access_denied
- Turn 3 (8 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (7 turn(s) ago): bio_uplift_findings, export_control_escalation
- Turn 5 (6 turn(s) ago): cyber_major_incident, election_consolidation
- Turn 6 (5 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, embodied_ai_deployment
- Turn 7 (4 turn(s) ago): export_control_escalation
- Turn 8 (3 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response, emergent_grid_siting_sabotage
- Turn 9 (2 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, research_breakthrough, knowledge_work_augmented, taiwan_tension_rise, supply_chain_coercion
- Turn 10 (1 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, safety_breakthrough, embodied_ai_deployment, taiwan_tension_rise, eu_frontier_access_denied, adoption_success, emergent_infrastructure_backlash_blockade
