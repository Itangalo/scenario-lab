...
- characters 1905-4053: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5039-5562: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7593-9541: `{{previous_actions}}` from the actor's own response from the previous turn
