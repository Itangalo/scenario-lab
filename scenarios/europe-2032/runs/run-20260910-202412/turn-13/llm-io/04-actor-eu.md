...
- characters 455-2001: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2045-4007: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5888-6419: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8635-11260: `{{previous_actions}}` from the actor's own response from the previous turn
...
- `two_year_commitment` (commitment): Contain bio-uplift and keep essential services alive through joint detection, patching and fallback while rebuilding leverage for independent EU AI capacity
