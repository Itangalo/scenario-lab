...
- characters 377-1923: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1967-3929: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3985-4435: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4498-31964: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32319-33523: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Bio-Detection and Essential Continuity Surge −2, priority −1 = −3
PROPOSAL BONUS: EU Bio-Detection and Essential Continuity Surge (cat 6, small) +3 — bio_uplift_findings fired this turn opening 4-turn bio window and this answers it directly
LEGITIMACY LENDS: capital 5, sentiment 13 -> +2 (capped by sentiment)
SOVEREIGNTY: 13 last turn, no capacity event, no category 4 finishing or in flight +0, capability rose 1.0 −0 = 13
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, eu_frontier_access_denied
- Turn 3 (10 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (9 turn(s) ago): bio_uplift_findings, export_control_escalation
- Turn 5 (8 turn(s) ago): cyber_major_incident, election_consolidation
- Turn 6 (7 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, embodied_ai_deployment
- Turn 7 (6 turn(s) ago): export_control_escalation
- Turn 8 (5 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response, emergent_grid_siting_sabotage
- Turn 9 (4 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, research_breakthrough, knowledge_work_augmented, taiwan_tension_rise, supply_chain_coercion
- Turn 10 (3 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, safety_breakthrough, embodied_ai_deployment, taiwan_tension_rise, eu_frontier_access_denied, adoption_success, emergent_infrastructure_backlash_blockade
- Turn 11 (2 turn(s) ago): joint_threat_response, middle_power_coalition
