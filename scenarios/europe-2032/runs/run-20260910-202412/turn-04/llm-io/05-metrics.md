...
- characters 105-13447: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13490-13682: `{{metrics_json}}` from the run's live metric values
- characters 13775-15262: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15305-17248: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17304-18527: `{{notepad}}` from the Game Master's notepad, carried across turns
