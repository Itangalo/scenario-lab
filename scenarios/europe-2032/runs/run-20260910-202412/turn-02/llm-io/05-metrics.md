...
- characters 13374-14919: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14962-17580: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17636-18946: `{{notepad}}` from the Game Master's notepad, carried across turns
