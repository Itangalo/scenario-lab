...
- characters 1733-3876: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4450-4973: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7004-8488: `{{previous_actions}}` from the actor's own response from the previous turn
