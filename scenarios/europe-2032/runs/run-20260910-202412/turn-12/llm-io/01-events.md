...
- characters 376-1612: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1655-3798: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3854-4526: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4589-32055: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32410-33566: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: no measures in flight = −0 + no priority = −0 = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 12.0 -> +2 (capped by sentiment, capital remains below sentiment)
SOVEREIGNTY: 11 last turn, no category 4 finishing or in flight +0, middle_power_coalition t11 +2, capability rose 1.0 −0 = 13

## Emerging developments (tracked)

- `emergent_municipal_compute_freeze` -- first noted turn 10, listed in 2 turn(s) so far: Several municipal councils impose emergency moratoria on new data-centre grid connections after the autumn outages, freezing already-quota-constrained EU compute expansion for months.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, eu_frontier_access_denied
- Turn 3 (9 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (8 turn(s) ago): bio_uplift_findings, export_control_escalation
- Turn 5 (7 turn(s) ago): cyber_major_incident, election_consolidation
- Turn 6 (6 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, embodied_ai_deployment
- Turn 7 (5 turn(s) ago): export_control_escalation
- Turn 8 (4 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response, emergent_grid_siting_sabotage
- Turn 9 (3 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, research_breakthrough, knowledge_work_augmented, taiwan_tension_rise, supply_chain_coercion
- Turn 10 (2 turn(s) ago): ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, safety_breakthrough, embodied_ai_deployment, taiwan_tension_rise, eu_frontier_access_denied, adoption_success, emergent_infrastructure_backlash_blockade
- Turn 11 (1 turn(s) ago): joint_threat_response, middle_power_coalition
