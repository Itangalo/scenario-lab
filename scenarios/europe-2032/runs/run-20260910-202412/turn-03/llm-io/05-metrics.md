...
- characters 106-13102: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13145-13337: `{{metrics_json}}` from the run's live metric values
- characters 13430-15472: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15516-17360: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17416-17957: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Essential Services Continuity Fallback | 2 |
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Cyber Shield −3, EU Evaluation and Assurance Capacity −2, EU Essential Services Continuity Fallback −2, priority −1 = −14
PROPOSAL BONUS: EU Essential Services Continuity Fallback (cat 6, small) +3 — eu_frontier_access_denied fired this turn hitting hospitals/ministries and this answers it directly
LEGITIMACY LENDS: capital 11, sentiment 30.5 -> +2
SOVEREIGNTY: 18 last turn, no capacity event, no finish, in flight +0, eu_frontier_access_denied t3 −2, capability rose 2.0 −1 = 15
