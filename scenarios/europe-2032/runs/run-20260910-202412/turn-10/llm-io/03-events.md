...
- characters 376-1525: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1568-3779: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3835-4229: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4292-32352: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32707-33542: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: no measures in flight = −0 = −0 + no priority = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0 after charges and events, sentiment 16.0 -> +2 (capped by sentiment, applied but floored by external shocks)
SOVEREIGNTY: 16 last turn, no capacity build finishing or in flight +0, supply_chain_coercion t9 −2, capability rose 1.0 −0 = 14
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, eu_frontier_access_denied
- Turn 3 (7 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (6 turn(s) ago): bio_uplift_findings, export_control_escalation
- Turn 5 (5 turn(s) ago): cyber_major_incident, election_consolidation
- Turn 6 (4 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, embodied_ai_deployment
- Turn 7 (3 turn(s) ago): export_control_escalation
- Turn 8 (2 turn(s) ago): cyber_major_incident, knowledge_work_augmented, export_control_escalation, joint_threat_response, emergent_grid_siting_sabotage
- Turn 9 (1 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, research_breakthrough, knowledge_work_augmented, taiwan_tension_rise, supply_chain_coercion
