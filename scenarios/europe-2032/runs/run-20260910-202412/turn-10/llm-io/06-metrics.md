...
- characters 12882-13073: `{{metrics_json}}` from the run's live metric values
- characters 13166-14315: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14358-16569: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16625-17330: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 65.5, "openweight_capability": 64.0, "ai_safety": 22.0, "resilience": 41.0, "eu_ai_sovereignty": 11.0, "eu_political_capital": 0.0, "public_sentiment": 12.0}
```
