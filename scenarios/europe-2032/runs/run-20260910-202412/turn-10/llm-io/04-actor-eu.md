...
- characters 454-1603: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1646-3857: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7946-8414: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10445-12280: `{{previous_actions}}` from the actor's own response from the previous turn
