...
- characters 106-13049: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13092-13283: `{{metrics_json}}` from the run's live metric values
- characters 13376-15213: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15257-17695: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17751-18798: `{{notepad}}` from the Game Master's notepad, carried across turns
