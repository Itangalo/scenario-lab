...
- characters 2335-4773: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6150-6615: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8795-10423: `{{previous_actions}}` from the actor's own response from the previous turn
