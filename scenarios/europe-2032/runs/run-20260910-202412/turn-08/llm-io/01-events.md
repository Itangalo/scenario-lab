...
- characters 375-1447: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1490-3393: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3449-4138: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4201-31408: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31763-32276: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, eu_frontier_access_denied
- Turn 3 (5 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (4 turn(s) ago): bio_uplift_findings, export_control_escalation
- Turn 5 (3 turn(s) ago): cyber_major_incident, election_consolidation
- Turn 6 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented, embodied_ai_deployment
