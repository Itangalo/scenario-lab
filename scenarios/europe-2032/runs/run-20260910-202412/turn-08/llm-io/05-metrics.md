...
- characters 105-12835: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12878-13069: `{{metrics_json}}` from the run's live metric values
- characters 13162-14234: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14277-16180: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16236-16578: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t7: no measures in flight = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 23.0 -> +2 (capped by sentiment, applied after charges and completions)
SOVEREIGNTY: 16 last turn, InvestAI Gigafactories finishes t7 +4, export_control_escalation t7 −2, capability rose 1.0 −0 = 18
...
## Notepad
PORTFOLIO CHARGE t8: no measures in flight = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 16.0 -> +2 (capped by sentiment, applied after charges and completions)
SOVEREIGNTY: 18 last turn, no capacity build finishing or in flight +0, export_control_escalation t8 −2, capability rose 1.0 −0 = 16
