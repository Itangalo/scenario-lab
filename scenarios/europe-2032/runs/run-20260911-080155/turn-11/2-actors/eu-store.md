...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Swarm Defence Deployment and Essential Services Shield", "category": 6, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected"}, "grounds": "to exploit defensive breakthrough against resident intruder"}
  - Grounds: to exploit defensive breakthrough against resident intruder
