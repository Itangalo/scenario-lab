...
- `two_year_commitment` (commitment): Prevent irreversible dependency on foreign AI systems and infrastructure

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Prevent irreversible dependency on foreign AI systems and infrastructure
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the two-year period directly ends the timeframe originally staked to the commitment, changing its relevance and cost of continuation.
