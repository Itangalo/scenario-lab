...
| M11 | EU Wartime Continuity and Neutral Infrastructure Protocol | 6 | small | 11 | 13 | own jurisdiction | resilience up modestly, eu_political_capital protected | 2 | finished |
| M12 | EU Cutoff Continuity Enclave | 6 | small | 13 | 15 | own jurisdiction | resilience up modestly, ai_safety protected/up modestly | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Cutoff Continuity Enclave", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up modestly, ai_safety protected/up modestly"}, "grounds": "US access denial requires funded fallback"}
  - Grounds: US access denial requires funded fallback
