...
| M11 | EU Wartime Continuity and Neutral Infrastructure Protocol | 6 | small | 11 | 13 | own jurisdiction | resilience up modestly, eu_political_capital protected | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Wartime Continuity and Neutral Infrastructure Protocol", "category": 6, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "resilience up modestly, eu_political_capital protected"}, "grounds": "to hold essential services through US-CN war under livelihoods commitment"}
  - Grounds: to hold essential services through US-CN war under livelihoods commitment
