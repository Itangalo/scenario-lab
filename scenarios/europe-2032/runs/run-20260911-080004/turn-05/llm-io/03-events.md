...
- characters 1896-3743: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3799-4375: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4438-33414: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33769-34033: `{{event_history}}` from the run's own event record
...
- Turn 3 (2 turn(s) ago): capability_jump, bio_uplift_findings, labour_displacement
- Turn 4 (1 turn(s) ago): eval_anomaly_reports, medical_breakthrough, adoption_success
