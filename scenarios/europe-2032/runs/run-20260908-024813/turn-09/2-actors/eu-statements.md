...
- `two_year_commitment` (commitment): Sovereign control over autonomous AI systems

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Sovereign control over autonomous AI systems
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the commitment period directly changes the actor's obligation to uphold the original statement, triggering a legitimate reassessment of its current position.
