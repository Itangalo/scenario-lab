...
- characters 377-1638: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1682-3914: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3970-5091: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5154-32124: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32479-32737: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Transition Bridge for AI-Displaced Workers −2, EU Assurance Scale-up and Anomaly Watch −2, priority −1 = −14
PROPOSAL BONUS: EU Assurance Scale-up and Anomaly Watch (cat 5, small) +3 — eval_anomaly_reports leaked this turn and this answers it directly plus locks in M4 pilot
...
- `emergent_siting_blockade` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated physical blockades halt construction at two planned gigafactory and data-centre sites for weeks, forcing a national government to pause permitting pending a safety review.
- `emergent_siting_blockade_protests` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated physical protests block access to two planned gigafactory and data-centre sites for weeks, forcing a construction pause and national debate on energy costs and automation job losses.
...
- Turn 2 (3 turn(s) ago): cyber_major_incident, safety_breakthrough
- Turn 3 (2 turn(s) ago): cyber_major_incident
- Turn 4 (1 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented
