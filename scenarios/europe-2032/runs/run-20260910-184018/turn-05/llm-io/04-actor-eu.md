...
- characters 1760-3992: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5308-5755: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8018-10166: `{{previous_actions}}` from the actor's own response from the previous turn
