...
- characters 106-13151: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13194-13386: `{{metrics_json}}` from the run's live metric values
- characters 13479-14740: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14784-17016: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17072-18193: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 57.8, "ai_safety": 32.0, "resilience": 31.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 19.0, "public_sentiment": 26.0}
```
## Narrative
### The cutoff
