...
- characters 378-2666: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2710-5094: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5150-6142: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6205-31459: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31814-32634: `{{event_history}}` from the run's own event record
...
- `emergent_telemetry_privacy_backlash` -- first noted turn 11, listed in 2 turn(s) so far: Allied media investigation alleges pooled EU municipal telemetry shared via the joint cyber command was retained beyond anonymisation limits, triggering court challenges to ENISA gateway feeds.
- `emergent_telemetry_privacy_freeze` -- first noted turn 11, listed in 2 turn(s) so far: Allied telemetry pooled via the joint cyber command is found to have ingested unredacted EU municipal registry data, triggering court injunctions in two member states to suspend ENISA outflows.
...
- Turn 2 (11 turn(s) ago): cyber_major_incident, safety_breakthrough
- Turn 3 (10 turn(s) ago): cyber_major_incident
- Turn 4 (9 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented
- Turn 5 (8 turn(s) ago): eu_frontier_access_denied, election_consolidation
- Turn 6 (7 turn(s) ago): capability_jump, opaque_reasoning, research_breakthrough
- Turn 7 (6 turn(s) ago): knowledge_work_augmented
- Turn 8 (5 turn(s) ago): cyber_major_incident
- Turn 9 (4 turn(s) ago): ai_investment_collapse, openweight_frontier_release
- Turn 10 (3 turn(s) ago): joint_threat_response
- Turn 11 (2 turn(s) ago): cyber_major_incident, research_breakthrough, joint_threat_response
- Turn 12 (1 turn(s) ago): openweight_frontier_release, knowledge_work_augmented
