...
- characters 13672-15960: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16004-18388: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18444-18829: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M14 | EU Essential Services Continuity and Bio-Response Surge | 2 |
...
## Notepad
PORTFOLIO CHARGE t13: M13 EU Augmentation Dividend Demonstrators −2, M14 EU Essential Services Continuity and Bio-Response Surge −2, priority −1 = −5
PROPOSAL BONUS: EU Essential Services Continuity and Bio-Response Surge (cat 6, small) +4 — answers simultaneous cyber sweep and bio release landing this turn directly
LEGITIMACY LENDS: capital 26, sentiment 16 -> none, capital higher
