...
- characters 16339-16978: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_bio_publishing_freeze` -- first noted turn 1, listed in 1 turn(s) so far: A major European scientific publisher and preprint servers adopt mandatory AI-assisted screening disclosure and coordinated hold procedures for high-risk biological design papers after the phage controversy.
- `emergent_health_data_leak` -- first noted turn 1, listed in 1 turn(s) so far: Major European research hospitals publish evidence that clinical triage copilots built on open-weight models leaked sensitive patient data through prompt-logging pipelines, triggering cross-border data-protection investigations.
...
## Metrics
```json
{"ai_capability": 54.0, "openweight_capability": 46.0, "ai_safety": 32.0, "resilience": 38.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 43.0, "public_sentiment": 41.0}
```
