...
- characters 377-2756: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2799-5039: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5095-6250: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6313-31567: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31922-32660: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M10 EU Open-Weight Hardening and Dependency Removal −2, M11 EU Accession to Joint Cyber Command Telemetry Pool −2, M12 EU Municipal Continuity Surge −2, priority −1 not charged (capital below 20, no effect) = −6
PROPOSAL BONUS: EU Municipal Continuity Surge (cat 6, small) +3 — cyber_major_incident landed this turn on paper-run communes and this answers it directly via absorption
...
- `emergent_telemetry_privacy_backlash` -- first noted turn 11, listed in 1 turn(s) so far: Allied media investigation alleges pooled EU municipal telemetry shared via the joint cyber command was retained beyond anonymisation limits, triggering court challenges to ENISA gateway feeds.
- `emergent_telemetry_privacy_freeze` -- first noted turn 11, listed in 1 turn(s) so far: Allied telemetry pooled via the joint cyber command is found to have ingested unredacted EU municipal registry data, triggering court injunctions in two member states to suspend ENISA outflows.
...
- Turn 2 (10 turn(s) ago): cyber_major_incident, safety_breakthrough
- Turn 3 (9 turn(s) ago): cyber_major_incident
- Turn 4 (8 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented
- Turn 5 (7 turn(s) ago): eu_frontier_access_denied, election_consolidation
- Turn 6 (6 turn(s) ago): capability_jump, opaque_reasoning, research_breakthrough
- Turn 7 (5 turn(s) ago): knowledge_work_augmented
- Turn 8 (4 turn(s) ago): cyber_major_incident
- Turn 9 (3 turn(s) ago): ai_investment_collapse, openweight_frontier_release
- Turn 10 (2 turn(s) ago): joint_threat_response
- Turn 11 (1 turn(s) ago): cyber_major_incident, research_breakthrough, joint_threat_response
