...
- characters 106-13508: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13551-13743: `{{metrics_json}}` from the run's live metric values
- characters 13836-16215: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16258-18498: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18554-19709: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Municipal Continuity Surge | 2 |
| M13 | EU Augmentation Dividend Demonstrators | 2 |
