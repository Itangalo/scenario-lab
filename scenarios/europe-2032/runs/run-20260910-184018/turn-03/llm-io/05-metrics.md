...
- characters 106-13083: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13126-13318: `{{metrics_json}}` from the run's live metric values
- characters 13411-14813: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14857-17025: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17081-17550: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 53.0, "ai_safety": 35.0, "resilience": 35.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 30.0, "public_sentiment": 29.0}
```
## Narrative
### Paper fallbacks
