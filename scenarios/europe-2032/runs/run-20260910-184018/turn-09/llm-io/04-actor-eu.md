...
- characters 455-2401: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2445-4392: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5127-5569: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8246-10232: `{{previous_actions}}` from the actor's own response from the previous turn
