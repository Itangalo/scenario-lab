...
- characters 106-13531: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13574-13766: `{{metrics_json}}` from the run's live metric values
- characters 13859-15805: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15849-17796: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17852-18276: `{{notepad}}` from the Game Master's notepad, carried across turns
