...
- characters 2367-4314: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4370-5397: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5460-30455: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30810-31325: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M8 EU Workplace Augmentation Pact −2, M9 EU Municipal Restoration and Dependency Triage −2, priority −1 = −5
PROPOSAL BONUS: EU Municipal Restoration and Dependency Triage (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 16, sentiment 21 -> +2
SOVEREIGNTY: 15 last turn, no capacity event, no cat4 in flight +0, capability rose 1.0 −0 = 15

## Emerging developments (tracked)

- `emergent_construction_sabotage_wave` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated physical blockades and grid-connection sabotage halt construction at multiple EU data-centre and gigafactory sites for weeks, forcing contractors to withdraw.
- `emergent_anti_build_escalation` -- first noted turn 7, listed in 2 turn(s) so far: Municipal paper-fallback outages and hospital cutover failures trigger coordinated sit-ins and sabotage threats at the two blockaded gigafactory sites and a data-centre permitting office, forcing a construction pause.
...
- Turn 2 (7 turn(s) ago): cyber_major_incident, safety_breakthrough
- Turn 3 (6 turn(s) ago): cyber_major_incident
- Turn 4 (5 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented
- Turn 5 (4 turn(s) ago): eu_frontier_access_denied, election_consolidation
- Turn 6 (3 turn(s) ago): capability_jump, opaque_reasoning, research_breakthrough
- Turn 7 (2 turn(s) ago): knowledge_work_augmented
- Turn 8 (1 turn(s) ago): cyber_major_incident
