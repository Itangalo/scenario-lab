...
- characters 378-2234: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2278-4210: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4266-4870: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4933-30187: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30542-31185: `{{event_history}}` from the run's own event record
...
- Turn 2 (9 turn(s) ago): cyber_major_incident, safety_breakthrough
- Turn 3 (8 turn(s) ago): cyber_major_incident
- Turn 4 (7 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented
- Turn 5 (6 turn(s) ago): eu_frontier_access_denied, election_consolidation
- Turn 6 (5 turn(s) ago): capability_jump, opaque_reasoning, research_breakthrough
- Turn 7 (4 turn(s) ago): knowledge_work_augmented
- Turn 8 (3 turn(s) ago): cyber_major_incident
- Turn 9 (2 turn(s) ago): ai_investment_collapse, openweight_frontier_release
