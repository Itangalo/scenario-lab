...
- characters 107-13048: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13091-13283: `{{metrics_json}}` from the run's live metric values
- characters 13376-15232: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15276-17208: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17264-18475: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Open-Weight Hardening and Dependency Removal | 2 |
| M11 | EU Accession to Joint Cyber Command Telemetry Pool | 2 |
