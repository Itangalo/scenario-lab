...
- characters 376-1869: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1912-4086: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4142-5187: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5250-30245: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30600-31068: `{{event_history}}` from the run's own event record
...
- `emergent_construction_sabotage_wave` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated physical blockades and grid-connection sabotage halt construction at multiple EU data-centre and gigafactory sites for weeks, forcing contractors to withdraw.
- `emergent_anti_build_escalation` -- first noted turn 7, listed in 1 turn(s) so far: Municipal paper-fallback outages and hospital cutover failures trigger coordinated sit-ins and sabotage threats at the two blockaded gigafactory sites and a data-centre permitting office, forcing a construction pause.
...
- Turn 2 (6 turn(s) ago): cyber_major_incident, safety_breakthrough
- Turn 3 (5 turn(s) ago): cyber_major_incident
- Turn 4 (4 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented
- Turn 5 (3 turn(s) ago): eu_frontier_access_denied, election_consolidation
- Turn 6 (2 turn(s) ago): capability_jump, opaque_reasoning, research_breakthrough
- Turn 7 (1 turn(s) ago): knowledge_work_augmented
