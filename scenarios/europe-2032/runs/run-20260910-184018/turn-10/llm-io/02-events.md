...
- characters 377-1659: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1702-3327: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3383-3859: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3922-29176: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29531-30124: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M10 EU Open-Weight Hardening and Dependency Removal −2, priority −1 = −3
PROPOSAL BONUS: EU Open-Weight Hardening and Dependency Removal (cat 6, small) +3 — January ransomware wave from last turn plus open frontier tooling this turn and this answers it directly
LEGITIMACY LENDS: capital 19, sentiment 24 -> +2 capped by prior terms, included in capital total
SOVEREIGNTY: 15 last turn, no capacity event, no cat4 in flight +0, capability rose 0.5 −0 = 15
...
- Turn 2 (8 turn(s) ago): cyber_major_incident, safety_breakthrough
- Turn 3 (7 turn(s) ago): cyber_major_incident
- Turn 4 (6 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented
- Turn 5 (5 turn(s) ago): eu_frontier_access_denied, election_consolidation
- Turn 6 (4 turn(s) ago): capability_jump, opaque_reasoning, research_breakthrough
- Turn 7 (3 turn(s) ago): knowledge_work_augmented
- Turn 8 (2 turn(s) ago): cyber_major_incident
- Turn 9 (1 turn(s) ago): ai_investment_collapse, openweight_frontier_release
