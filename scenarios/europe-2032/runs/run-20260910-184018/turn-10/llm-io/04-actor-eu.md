...
- characters 455-1737: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1780-3405: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3937-4613: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7618-10613: `{{previous_actions}}` from the actor's own response from the previous turn
