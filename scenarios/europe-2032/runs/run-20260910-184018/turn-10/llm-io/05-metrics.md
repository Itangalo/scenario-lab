...
- characters 106-13003: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13046-13238: `{{metrics_json}}` from the run's live metric values
- characters 13331-14613: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14656-16281: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16337-16813: `{{notepad}}` from the Game Master's notepad, carried across turns
