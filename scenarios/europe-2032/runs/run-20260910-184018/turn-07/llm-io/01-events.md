...
- characters 1615-5043: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5099-5599: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5662-30657: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31012-31429: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): cyber_major_incident, safety_breakthrough
- Turn 3 (4 turn(s) ago): cyber_major_incident
- Turn 4 (3 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented
- Turn 5 (2 turn(s) ago): eu_frontier_access_denied, election_consolidation
- Turn 6 (1 turn(s) ago): capability_jump, opaque_reasoning, research_breakthrough
