...
- characters 106-13859: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13902-14094: `{{metrics_json}}` from the run's live metric values
- characters 14187-15381: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15425-18853: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18909-20012: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 63.5, "openweight_capability": 61.0, "ai_safety": 28.0, "resilience": 39.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 21.0, "public_sentiment": 28.0}
```
## Narrative
