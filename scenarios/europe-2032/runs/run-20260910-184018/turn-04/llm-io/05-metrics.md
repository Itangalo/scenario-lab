...
- characters 105-13432: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13475-13667: `{{metrics_json}}` from the run's live metric values
- characters 13760-14989: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15032-17494: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17550-18621: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Transition Bridge for AI-Displaced Workers | 2 |
| M6 | EU Assurance Scale-up and Anomaly Watch | 2 |
