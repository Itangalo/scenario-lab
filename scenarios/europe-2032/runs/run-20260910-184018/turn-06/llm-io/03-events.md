...
- characters 376-1490: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1533-3685: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3741-4972: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5035-30124: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30479-30813: `{{event_history}}` from the run's own event record
...
- `emergent_siting_blockade` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated physical blockades halt construction at two planned gigafactory and data-centre sites for weeks, forcing a national government to pause permitting pending a safety review.
- `emergent_siting_blockade_protests` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated physical protests block access to two planned gigafactory and data-centre sites for weeks, forcing a construction pause and national debate on energy costs and automation job losses.
...
- Turn 2 (4 turn(s) ago): cyber_major_incident, safety_breakthrough
- Turn 3 (3 turn(s) ago): cyber_major_incident
- Turn 4 (2 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented
- Turn 5 (1 turn(s) ago): eu_frontier_access_denied, election_consolidation
