...
- characters 454-1568: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1611-3763: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5965-6407: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8858-11414: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Continuity Switch for Cut-Off Services | 6 | small | 5 | 7 | own jurisdiction | resilience up moderately, public_sentiment up slightly via kept services running | 2 | running |
