...
- characters 376-1534: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1577-3621: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3677-4762: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4825-27537: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27892-27962: `{{event_history}}` from the run's own event record
