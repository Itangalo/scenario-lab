...
- characters 105-13023: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13066-13258: `{{metrics_json}}` from the run's live metric values
- characters 13351-14509: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14552-16596: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16652-17737: `{{notepad}}` from the Game Master's notepad, carried across turns
