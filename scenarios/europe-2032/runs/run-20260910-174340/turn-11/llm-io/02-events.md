...
- characters 375-2221: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2265-4442: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4498-5476: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5539-30162: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30517-31517: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: no measures in flight = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 5 -> +2, capped at 2
SOVEREIGNTY: 14 last turn, no capacity event? member_state_defection t10 −2 and middle_power_coalition t10 +2, largest +2 secured, no finish, no in-flight cat4, capability rose 0.8 −0 = 16

## Emerging developments (tracked)

- `emergent_anti_ai_electoral_surge` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated anti-AI municipal coalitions win seats on platforms to ban foreign warehouse robots and data-centre expansions, turning siting disputes into a Union-wide electoral bloc.
- `emergent_anti_ai_sabotage_wave` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated physical sabotage and blockades targeting foreign-owned data centres, robot depots and chip shipments in several member states, driven by hostile public sentiment and blamed on distributed open-weight planning tools.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, eval_anomaly_reports
- Turn 2 (9 turn(s) ago): cyber_major_incident, capability_jump, ai_investment_collapse
- Turn 4 (7 turn(s) ago): openweight_frontier_release, automated_decision_scandal, emergent_municipal_backlash_stall
- Turn 5 (6 turn(s) ago): loss_of_control_incident, election_retrenchment
- Turn 6 (5 turn(s) ago): eval_anomaly_reports, opaque_reasoning, knowledge_work_augmented, embodied_ai_deployment, eu_frontier_access_denied, emergent_municipal_fiscal_crunch
- Turn 7 (4 turn(s) ago): capability_jump, supply_chain_coercion
- Turn 8 (3 turn(s) ago): loss_of_control_incident, eu_frontier_access_denied, member_state_defection, emergent_robot_fleet_leverage
- Turn 9 (2 turn(s) ago): loss_of_control_incident, safety_breakthrough, knowledge_work_augmented, embodied_ai_deployment, export_control_escalation
- Turn 10 (1 turn(s) ago): bio_uplift_findings, taiwan_tension_rise, member_state_defection, adoption_success, middle_power_coalition
