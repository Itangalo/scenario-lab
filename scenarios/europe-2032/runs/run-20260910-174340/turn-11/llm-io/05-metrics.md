...
- characters 107-12839: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12882-13071: `{{metrics_json}}` from the run's live metric values
- characters 13164-15010: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15054-17231: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17287-18265: `{{notepad}}` from the Game Master's notepad, carried across turns
