...
- characters 106-13289: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13332-13522: `{{metrics_json}}` from the run's live metric values
- characters 13615-15006: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15050-18355: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18411-19395: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 63.3, "openweight_capability": 60.4, "ai_safety": 2.0, "resilience": 36.5, "eu_ai_sovereignty": 21.0, "eu_political_capital": 5.0, "public_sentiment": 16.0}
```
