...
- characters 453-1844: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1888-5193: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6151-6633: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8573-10269: `{{previous_actions}}` from the actor's own response from the previous turn
