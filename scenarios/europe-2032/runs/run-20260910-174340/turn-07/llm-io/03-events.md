...
- characters 375-1766: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1810-5115: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5171-5553: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5616-28783: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29138-29656: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): cyber_major_incident, capability_jump, ai_investment_collapse
- Turn 4 (3 turn(s) ago): openweight_frontier_release, automated_decision_scandal, emergent_municipal_backlash_stall
- Turn 5 (2 turn(s) ago): loss_of_control_incident, election_retrenchment
- Turn 6 (1 turn(s) ago): eval_anomaly_reports, opaque_reasoning, knowledge_work_augmented, embodied_ai_deployment, eu_frontier_access_denied, emergent_municipal_fiscal_crunch
