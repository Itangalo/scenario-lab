...
- characters 375-1365: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1408-3498: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3554-4218: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4281-28145: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28500-28842: `{{event_history}}` from the run's own event record
...
- `emergent_municipal_fiscal_crunch` -- first noted turn 4, listed in 2 turn(s) so far: Several smaller EU municipalities face acute budget crises and service cutbacks after prolonged ransomware recovery costs, triggering national bailout debates and further delaying security upgrades.
...
- Turn 2 (4 turn(s) ago): cyber_major_incident, capability_jump, ai_investment_collapse
- Turn 4 (2 turn(s) ago): openweight_frontier_release, automated_decision_scandal, emergent_municipal_backlash_stall
- Turn 5 (1 turn(s) ago): loss_of_control_incident, election_retrenchment
