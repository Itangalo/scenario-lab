...
- characters 453-1443: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1486-3576: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7085-7531: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9622-11127: `{{previous_actions}}` from the actor's own response from the previous turn
