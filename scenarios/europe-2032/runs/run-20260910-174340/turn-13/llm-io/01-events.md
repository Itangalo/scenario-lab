...
- characters 375-1959: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2003-4038: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4094-4534: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4597-29220: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29575-30818: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: no measures in flight = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0.0, sentiment 1.0 -> +1, capped at sentiment [applied, net still floored at 0 by multiple negative events]
SOVEREIGNTY: 14 last turn, no capacity build finishes, eu_frontier_access_denied t12 −3 (largest capacity event, supply_chain_coercion also qualifies but single term only), capability rose 1.5 −0 = 11
...
- Turn 2 (11 turn(s) ago): cyber_major_incident, capability_jump, ai_investment_collapse
- Turn 4 (9 turn(s) ago): openweight_frontier_release, automated_decision_scandal, emergent_municipal_backlash_stall
- Turn 5 (8 turn(s) ago): loss_of_control_incident, election_retrenchment
- Turn 6 (7 turn(s) ago): eval_anomaly_reports, opaque_reasoning, knowledge_work_augmented, embodied_ai_deployment, eu_frontier_access_denied, emergent_municipal_fiscal_crunch
- Turn 7 (6 turn(s) ago): capability_jump, supply_chain_coercion
- Turn 8 (5 turn(s) ago): loss_of_control_incident, eu_frontier_access_denied, member_state_defection, emergent_robot_fleet_leverage
- Turn 9 (4 turn(s) ago): loss_of_control_incident, safety_breakthrough, knowledge_work_augmented, embodied_ai_deployment, export_control_escalation
- Turn 10 (3 turn(s) ago): bio_uplift_findings, taiwan_tension_rise, member_state_defection, adoption_success, middle_power_coalition
- Turn 11 (2 turn(s) ago): medical_breakthrough, taiwan_tension_rise, export_control_escalation
- Turn 12 (1 turn(s) ago): capability_jump, bio_uplift_findings, eu_frontier_access_denied, supply_chain_coercion, emergent_anti_ai_sabotage_wave
