...
- characters 13346-14901: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14945-17131: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17187-17615: `{{notepad}}` from the Game Master's notepad, carried across turns
