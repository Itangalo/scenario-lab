...
- characters 13163-15248: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15291-17570: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17626-17912: `{{notepad}}` from the Game Master's notepad, carried across turns
