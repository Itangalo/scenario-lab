...
- characters 374-2266: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2309-4392: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4448-4752: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4815-28585: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28940-29805: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): cyber_major_incident, capability_jump, ai_investment_collapse
- Turn 4 (6 turn(s) ago): openweight_frontier_release, automated_decision_scandal, emergent_municipal_backlash_stall
- Turn 5 (5 turn(s) ago): loss_of_control_incident, election_retrenchment
- Turn 6 (4 turn(s) ago): eval_anomaly_reports, opaque_reasoning, knowledge_work_augmented, embodied_ai_deployment, eu_frontier_access_denied, emergent_municipal_fiscal_crunch
- Turn 7 (3 turn(s) ago): capability_jump, supply_chain_coercion
- Turn 8 (2 turn(s) ago): loss_of_control_incident, eu_frontier_access_denied, member_state_defection, emergent_robot_fleet_leverage
- Turn 9 (1 turn(s) ago): loss_of_control_incident, safety_breakthrough, knowledge_work_augmented, embodied_ai_deployment, export_control_escalation
