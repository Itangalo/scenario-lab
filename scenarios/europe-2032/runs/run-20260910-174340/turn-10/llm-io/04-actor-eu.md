...
- characters 452-2344: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2387-4470: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6332-6810: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8907-10766: `{{previous_actions}}` from the actor's own response from the previous turn
