...
- characters 106-12838: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12881-13070: `{{metrics_json}}` from the run's live metric values
- characters 13163-15055: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15098-17181: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17237-18165: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t9: no measures in flight = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 5, sentiment 8 -> +2, capped by subsequent event losses
SOVEREIGNTY: 16 last turn, no finish, no in-flight cat4, export_control_escalation t9 −2, capability rose 0.7 −0 = 14
