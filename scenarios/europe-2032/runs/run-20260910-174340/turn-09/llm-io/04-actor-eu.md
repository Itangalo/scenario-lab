...
- characters 452-1530: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1574-3720: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6723-7205: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9302-11002: `{{previous_actions}}` from the actor's own response from the previous turn
