...
- characters 13539-14617: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14661-16807: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16863-17246: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 64.8, "openweight_capability": 62.9, "ai_safety": 6.0, "resilience": 38.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 1.0, "public_sentiment": 3.0}
```
