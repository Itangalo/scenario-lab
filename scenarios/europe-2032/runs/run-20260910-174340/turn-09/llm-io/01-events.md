...
- characters 374-1452: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1496-3642: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3698-4393: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4456-28226: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28581-29297: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M6 EU Essential Services Continuity Corps −2, priority void (capital below 20, no cost, no pull-in) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 5, sentiment 16 -> +2, capped by subsequent event losses
SOVEREIGNTY: 18 last turn, no finish, no in-flight cat4, eu_frontier_access_denied t8 −2, capability rose 0.8 −0 = 16

## Emerging developments (tracked)

- `emergent_inference_site_blockade` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated physical protests and blockades halt grid-connection works for the Spain and Sweden inference plants for weeks, forcing costly security and delaying health-system onboarding.
...
- Turn 2 (7 turn(s) ago): cyber_major_incident, capability_jump, ai_investment_collapse
- Turn 4 (5 turn(s) ago): openweight_frontier_release, automated_decision_scandal, emergent_municipal_backlash_stall
- Turn 5 (4 turn(s) ago): loss_of_control_incident, election_retrenchment
- Turn 6 (3 turn(s) ago): eval_anomaly_reports, opaque_reasoning, knowledge_work_augmented, embodied_ai_deployment, eu_frontier_access_denied, emergent_municipal_fiscal_crunch
- Turn 7 (2 turn(s) ago): capability_jump, supply_chain_coercion
- Turn 8 (1 turn(s) ago): loss_of_control_incident, eu_frontier_access_denied, member_state_defection, emergent_robot_fleet_leverage
