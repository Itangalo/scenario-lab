...
- characters 16339-16727: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_phage_publication_moratorium_call` -- first noted turn 1, listed in 1 turn(s) so far: A coalition of leading virologists and biosecurity researchers publicly calls for a moratorium on publication of genome-language-model-designed pathogen methods after the AI-designed phage results, triggering press coverage and university review debates.
