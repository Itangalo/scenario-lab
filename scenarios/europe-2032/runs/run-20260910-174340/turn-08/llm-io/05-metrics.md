...
- characters 12966-13156: `{{metrics_json}}` from the run's live metric values
- characters 13249-14332: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14375-17416: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17472-18272: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M6 | EU Essential Services Continuity Corps | 2 |
...
## Metrics
```json
{"ai_capability": 64.1, "openweight_capability": 61.8, "ai_safety": 1.0, "resilience": 35.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 2.0, "public_sentiment": 8.0}
```
