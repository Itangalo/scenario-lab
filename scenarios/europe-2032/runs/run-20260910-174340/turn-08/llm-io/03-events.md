...
- characters 374-1457: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1500-4541: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4597-5687: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5750-29520: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29875-30458: `{{event_history}}` from the run's own event record
...
- `emergent_inference_site_blockade` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated physical protests and blockades halt grid-connection works for the Spain and Sweden inference plants for weeks, forcing costly security and delaying health-system onboarding.
- `emergent_robot_fleet_leverage` -- first noted turn 7, listed in 1 turn(s) so far: Foreign logistics-robot vendors push a mandatory cloud-update that bricks or degrades warehouse fleets in EU ports unless operators accept new telemetry and pricing terms, exposing operational dependence.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, eval_anomaly_reports
- Turn 2 (6 turn(s) ago): cyber_major_incident, capability_jump, ai_investment_collapse
- Turn 4 (4 turn(s) ago): openweight_frontier_release, automated_decision_scandal, emergent_municipal_backlash_stall
- Turn 5 (3 turn(s) ago): loss_of_control_incident, election_retrenchment
- Turn 6 (2 turn(s) ago): eval_anomaly_reports, opaque_reasoning, knowledge_work_augmented, embodied_ai_deployment, eu_frontier_access_denied, emergent_municipal_fiscal_crunch
- Turn 7 (1 turn(s) ago): capability_jump, supply_chain_coercion
