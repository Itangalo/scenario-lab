...
- characters 13407-13598: `{{metrics_json}}` from the run's live metric values
- characters 13691-14729: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14773-17696: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17752-18570: `{{notepad}}` from the Game Master's notepad, carried across turns
