...
- characters 454-1492: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1536-4459: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5991-6443: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8532-10458: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | Municipal Resilience Labour Pact | 7 | small | 4 | 6 | own jurisdiction | resilience up slightly, public_sentiment up slightly by unblocking patching | 2 | running |
