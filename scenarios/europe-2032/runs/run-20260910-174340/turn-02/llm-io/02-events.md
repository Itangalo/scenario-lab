...
- characters 376-2068: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2111-4321: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4377-5437: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5500-28212: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28567-28630: `{{event_history}}` from the run's own event record
