...
- characters 377-2497: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2540-4988: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5044-5467: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5530-27634: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27989-28996: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Bio-Uplift Containment Net −2, priority −1 = −3
PROPOSAL BONUS: EU Bio-Uplift Containment Net (cat 6, small) +3 — bio_uplift_findings plus opaque_reasoning landed this turn and this answers them directly
LEGITIMACY LENDS: capital 21, sentiment 14 -> none, capital is higher
SOVEREIGNTY: 12 last turn, no cat4 finish, no cat4 in flight +0, export_control_escalation t9 −2, capability rose 1.0 −0 = 10
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, export_control_escalation
- Turn 2 (8 turn(s) ago): capability_jump, eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (6 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied
- Turn 5 (5 turn(s) ago): cyber_major_incident, research_breakthrough, embodied_ai_deployment, emergent_clinical_fallback_reckoning, election_alliance
- Turn 6 (4 turn(s) ago): capability_jump, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied, middle_power_coalition
- Turn 7 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, taiwan_blockade, openweight_frontier_release, us_china_agreement, eu_frontier_access_denied
- Turn 8 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, knowledge_work_augmented, export_control_escalation, member_state_defection
- Turn 9 (1 turn(s) ago): bio_uplift_findings, opaque_reasoning, knowledge_work_augmented, export_control_escalation
