...
- characters 106-13323: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13366-13558: `{{metrics_json}}` from the run's live metric values
- characters 13651-15771: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15814-18262: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18318-18741: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Hospital and Grid Cyber-Agent Restoration Shield | 2 |
...
## Notepad
PORTFOLIO CHARGE t10: EU Hospital and Grid Cyber-Agent Restoration Shield −2, priority −1 = −3
PROPOSAL BONUS: EU Hospital and Grid Cyber-Agent Restoration Shield (cat 6, small) +4 — cyber_major_incident plus loss_of_control_incident landed this turn and this answers them directly
LEGITIMACY LENDS: capital 23, sentiment 8 -> none, capital is higher
