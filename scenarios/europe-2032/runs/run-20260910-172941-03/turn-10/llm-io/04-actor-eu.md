...
- characters 455-2575: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2618-5066: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6757-7218: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10215-12691: `{{previous_actions}}` from the actor's own response from the previous turn
