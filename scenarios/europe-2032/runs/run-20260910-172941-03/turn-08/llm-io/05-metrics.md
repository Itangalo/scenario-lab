...
- characters 105-13390: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13433-13625: `{{metrics_json}}` from the run's live metric values
- characters 13718-15650: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15693-18216: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18272-18753: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Municipal and Clinical Continuity Corps | 2 |
...
## Metrics
```json
{"ai_capability": 63.5, "openweight_capability": 61.2, "ai_safety": 16.0, "resilience": 49.0, "eu_ai_sovereignty": 12.0, "eu_political_capital": 22.0, "public_sentiment": 13.0}
```
