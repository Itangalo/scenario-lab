...
- characters 376-2308: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2351-4874: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4930-5760: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5823-28624: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28979-29719: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU Lithography and Continuity Bargaining Bloc −2, priority −1 = −3
PROPOSAL BONUS: EU Lithography and Continuity Bargaining Bloc (cat 8, small) +5 — taiwan_blockade plus eu_frontier_access_denied plus us_china_agreement landed this turn and this answers them directly
LEGITIMACY LENDS: capital 20, sentiment 25 -> +2
SOVEREIGNTY: 12 last turn, InvestAI Gigafactories finishes t7 +5, M8 in flight +0, eu_frontier_access_denied t7 −3, capability rose 0.5 −0 = 14

## Emerging developments (tracked)

- `emergent_logistics_strike_wave` -- first noted turn 6, listed in 2 turn(s) so far: Coordinated warehouse and transport strikes in Germany, Netherlands and Poland against Chinese-vendor robots running US control models halt major logistics hubs for days, turning displacement anxiety into physical disruption.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, export_control_escalation
- Turn 2 (6 turn(s) ago): capability_jump, eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (4 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied
- Turn 5 (3 turn(s) ago): cyber_major_incident, research_breakthrough, embodied_ai_deployment, emergent_clinical_fallback_reckoning, election_alliance
- Turn 6 (2 turn(s) ago): capability_jump, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied, middle_power_coalition
- Turn 7 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, taiwan_blockade, openweight_frontier_release, us_china_agreement, eu_frontier_access_denied
