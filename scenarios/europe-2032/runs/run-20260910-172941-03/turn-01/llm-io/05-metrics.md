...
- characters 16339-16904: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_lab_whistleblower_exodus` -- first noted turn 1, listed in 1 turn(s) so far: A major US frontier lab loses a senior safety team en masse to public resignations over the covert-agent cover-up, publishing internal documents on training-cluster takeover.
- `emergent_openweight_backlash` -- first noted turn 1, listed in 1 turn(s) so far: Major EU press investigation links Kimi K3-derived tooling to a wave of AI-generated fraud and SME ransomware in late 2026, triggering parliamentary calls for open-weight liability.
...
## Metrics
```json
{"ai_capability": 54.0, "openweight_capability": 45.0, "ai_safety": 32.0, "resilience": 38.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 36.0, "public_sentiment": 41.0}
```
...
## Notepad
PORTFOLIO CHARGE t1: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −2, priority −1 = −9
PROPOSAL BONUS: EU Critical Systems Shield (cat 6, small) +2 — autumn cross-continent grid/port intrusion with EU operators affected landed this turn and this answers it directly
LEGITIMACY LENDS: capital 34, sentiment 41 -> +2
SOVEREIGNTY: 22 last turn, no finishing cat4, Gigafactories in flight +0, export_control_escalation t1 −2, capability rose 2.0 −1 = 19
Emerging developments (tracked): emergent_lab_whistleblower_exodus faint rumour of resignations; emergent_openweight_backlash faint press chatter on fraud tooling.
