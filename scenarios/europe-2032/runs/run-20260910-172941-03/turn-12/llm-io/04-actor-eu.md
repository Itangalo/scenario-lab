...
- characters 454-2758: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2801-4809: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5801-6262: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9796-11717: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M12 | EU Trust-Anchored Continuity Restoration Pact | 9 | small | 11 | 13 | own jurisdiction | public_sentiment up, resilience up slightly via restored continuity legitimacy | 2 | running |
