...
- characters 13031-13222: `{{metrics_json}}` from the run's live metric values
- characters 13315-15619: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15662-17670: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17726-18081: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M13 | EU Joint Cyber-Bio Threat Fusion Accession | 2 |
