...
- characters 377-1482: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1526-3679: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3735-4508: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4571-29596: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29951-30525: `{{event_history}}` from the run's own event record
...
- `emergent_logistics_strike_wave` -- first noted turn 6, listed in 1 turn(s) so far: Coordinated warehouse and transport strikes in Germany, Netherlands and Poland against Chinese-vendor robots running US control models halt major logistics hubs for days, turning displacement anxiety into physical disruption.
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, export_control_escalation
- Turn 2 (5 turn(s) ago): capability_jump, eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied
- Turn 5 (2 turn(s) ago): cyber_major_incident, research_breakthrough, embodied_ai_deployment, emergent_clinical_fallback_reckoning, election_alliance
- Turn 6 (1 turn(s) ago): capability_jump, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied, middle_power_coalition
