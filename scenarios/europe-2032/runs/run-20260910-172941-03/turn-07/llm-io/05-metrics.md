...
- characters 106-13668: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13711-13903: `{{metrics_json}}` from the run's live metric values
- characters 13996-15101: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15145-17298: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17354-18127: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Lithography and Continuity Bargaining Bloc | 2 |
