...
- characters 107-13536: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13579-13769: `{{metrics_json}}` from the run's live metric values
- characters 13862-17185: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 17229-19402: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 19458-19951: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Sovereign Continuity Mesh | 2 |
