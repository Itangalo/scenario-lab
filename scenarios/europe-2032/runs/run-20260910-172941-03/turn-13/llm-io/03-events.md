...
- characters 376-3699: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3743-5916: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5972-6465: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6528-29485: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29840-31216: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, export_control_escalation
- Turn 2 (11 turn(s) ago): capability_jump, eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (9 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied
- Turn 5 (8 turn(s) ago): cyber_major_incident, research_breakthrough, embodied_ai_deployment, emergent_clinical_fallback_reckoning, election_alliance
- Turn 6 (7 turn(s) ago): capability_jump, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied, middle_power_coalition
- Turn 7 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident, taiwan_blockade, openweight_frontier_release, us_china_agreement, eu_frontier_access_denied
- Turn 8 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, knowledge_work_augmented, export_control_escalation, member_state_defection
- Turn 9 (4 turn(s) ago): bio_uplift_findings, opaque_reasoning, knowledge_work_augmented, export_control_escalation
- Turn 10 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
- Turn 11 (2 turn(s) ago): cyber_major_incident, capability_jump, cyber_defence_breakthrough, eval_anomaly_reports, medical_breakthrough, knowledge_work_augmented, emergent_care_delay_backlash_freeze
- Turn 12 (1 turn(s) ago): cyber_major_incident, joint_threat_response
