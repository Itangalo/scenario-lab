...
- characters 1858-4124: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7373-7817: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10102-12399: `{{previous_actions}}` from the actor's own response from the previous turn
