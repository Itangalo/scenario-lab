...
- characters 13826-15185: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15229-17495: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17551-18129: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 57.7, "ai_safety": 24.0, "resilience": 44.0, "eu_ai_sovereignty": 10.0, "eu_political_capital": 16.0, "public_sentiment": 28.0}
```
