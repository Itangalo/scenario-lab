...
- characters 106-13082: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13125-13317: `{{metrics_json}}` from the run's live metric values
- characters 13410-14674: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14718-17078: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17134-17663: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M3 | EU Critical Systems Shield | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −2, EU Essential Services Continuity Switch −2, priority −1 = −11
PROPOSAL BONUS: EU Essential Services Continuity Switch (cat 6, small) +3 — eu frontier cut-off hitting hospitals/ministries landed this turn and this answers it directly
LEGITIMACY LENDS: capital 30, sentiment 41 -> +2
SOVEREIGNTY: 19 last turn, no capacity event? no — eu_frontier_access_denied t2 −2, Gigafactories in flight +0, capability rose 2.0 −1 = 16
