...
- characters 376-2165: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2208-4331: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4387-4992: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5055-29477: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29832-30237: `{{event_history}}` from the run's own event record
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, export_control_escalation
- Turn 2 (4 turn(s) ago): capability_jump, eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied
- Turn 5 (1 turn(s) ago): cyber_major_incident, research_breakthrough, embodied_ai_deployment, emergent_clinical_fallback_reckoning, election_alliance
