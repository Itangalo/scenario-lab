...
- characters 455-2110: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2154-4735: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6712-7151: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9983-12152: `{{previous_actions}}` from the actor's own response from the previous turn
