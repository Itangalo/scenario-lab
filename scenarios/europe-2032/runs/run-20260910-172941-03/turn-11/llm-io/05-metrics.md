...
- characters 13389-13579: `{{metrics_json}}` from the run's live metric values
- characters 13672-15534: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15578-17539: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17595-18057: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Trust-Anchored Continuity Restoration Pact | 2 |
...
## Metrics
```json
{"ai_capability": 67.0, "openweight_capability": 64.5, "ai_safety": 3.0, "resilience": 61.0, "eu_ai_sovereignty": 10.0, "eu_political_capital": 23.0, "public_sentiment": 10.0}
```
## Narrative
...
## Notepad
PORTFOLIO CHARGE t11: EU Trust-Anchored Continuity Restoration Pact −2, priority −1 = −3
PROPOSAL BONUS: none — Trust Pact already in flight, no new measure started this turn
LEGITIMACY LENDS: capital 23, sentiment 8 -> none, capital is higher
SOVEREIGNTY: 10 last turn, no cat4 finish, no cat4 in flight +0, no capacity event, capability rose 1.5 −0 = 10
## Store changes
```json
{"store": []}
```
