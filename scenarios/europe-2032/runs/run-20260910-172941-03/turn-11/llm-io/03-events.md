...
- characters 376-2238: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2282-4243: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4299-4761: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4824-27781: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28136-29240: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, export_control_escalation
- Turn 2 (9 turn(s) ago): capability_jump, eval_anomaly_reports, eu_frontier_access_denied
- Turn 4 (7 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, eu_frontier_access_denied
- Turn 5 (6 turn(s) ago): cyber_major_incident, research_breakthrough, embodied_ai_deployment, emergent_clinical_fallback_reckoning, election_alliance
- Turn 6 (5 turn(s) ago): capability_jump, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise, eu_frontier_access_denied, middle_power_coalition
- Turn 7 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, taiwan_blockade, openweight_frontier_release, us_china_agreement, eu_frontier_access_denied
- Turn 8 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, knowledge_work_augmented, export_control_escalation, member_state_defection
- Turn 9 (2 turn(s) ago): bio_uplift_findings, opaque_reasoning, knowledge_work_augmented, export_control_escalation
- Turn 10 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
