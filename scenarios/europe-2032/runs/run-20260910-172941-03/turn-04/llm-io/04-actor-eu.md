...
- characters 454-1858: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1901-4015: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5525-5969: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8084-10414: `{{previous_actions}}` from the actor's own response from the previous turn
