...
- characters 107-12983: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13026-13218: `{{metrics_json}}` from the run's live metric values
- characters 13311-14956: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15000-17214: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17270-17705: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Municipal Recovery and Joint Response Bridging | 2 |
| M10 | EU Breakthrough Patching Scale-Up | 2 |
...
PORTFOLIO CHARGE t12: M9 EU Municipal Recovery and Joint Response Bridging −2, priority no effect capital below 20 not charged = −2
PROPOSAL BONUS: M9 (cat 6, small) +4 — cyber_major_incident this turn plus joint_threat_response invitation, directly answered
LEGITIMACY LENDS: capital 8, sentiment 22.0 -> +2
SOVEREIGNTY: 18 last turn, no capacity event? member_state_defection t12 −2, no cat4 in flight +0, capability rose 0.5 −0 = 16
...
## Metrics
```json
{"ai_capability": 68.3, "openweight_capability": 66.8, "ai_safety": 25.5, "resilience": 57.5, "eu_ai_sovereignty": 16.0, "eu_political_capital": 14.0, "public_sentiment": 20.0}
```
...
## Notepad
PORTFOLIO CHARGE t13: M9 EU Municipal Recovery and Joint Response Bridging −2, M10 EU Breakthrough Patching Scale-Up −2, priority no effect capital below 20 not charged = −4
PROPOSAL BONUS: M10 (cat 6, small) +4 — cyber_major_incident this turn plus cyber_defence_breakthrough, directly answered
LEGITIMACY LENDS: capital 12, sentiment 20.0 -> +2
SOVEREIGNTY: 16 last turn, no capacity event, no cat4 in flight +0, capability rose 0.8 −0 = 16
