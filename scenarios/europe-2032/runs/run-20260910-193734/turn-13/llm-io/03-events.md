...
- characters 2067-4281: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4337-4772: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4835-30123: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30478-31559: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, cyber_major_incident, ai_investment_collapse
- Turn 3 (10 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise
- Turn 4 (9 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 5 (8 turn(s) ago): taiwan_blockade, embodied_ai_deployment, member_state_defection, election_alliance
- Turn 6 (7 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, safety_breakthrough, adoption_success
- Turn 7 (6 turn(s) ago): cyber_major_incident, taiwan_tension_rise, adoption_success, emergent_cyber_insurance_repricing
- Turn 8 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, cyber_defence_breakthrough
- Turn 9 (4 turn(s) ago): eval_anomaly_reports, adoption_success
- Turn 10 (3 turn(s) ago): loss_of_control_incident, research_breakthrough, joint_threat_response
- Turn 11 (2 turn(s) ago): member_state_defection
- Turn 12 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, medical_breakthrough, openweight_frontier_release, us_china_agreement, member_state_defection, joint_threat_response
