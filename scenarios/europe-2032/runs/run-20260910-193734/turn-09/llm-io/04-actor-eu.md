...
- characters 2014-4104: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5008-5453: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7818-9785: `{{previous_actions}}` from the actor's own response from the previous turn
