...
- characters 1936-4026: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4082-4658: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4721-30662: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31017-31695: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, cyber_major_incident, ai_investment_collapse
- Turn 3 (6 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise
- Turn 4 (5 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 5 (4 turn(s) ago): taiwan_blockade, embodied_ai_deployment, member_state_defection, election_alliance
- Turn 6 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, safety_breakthrough, adoption_success
- Turn 7 (2 turn(s) ago): cyber_major_incident, taiwan_tension_rise, adoption_success, emergent_cyber_insurance_repricing
- Turn 8 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, cyber_defence_breakthrough
