...
- characters 13324-13515: `{{metrics_json}}` from the run's live metric values
- characters 13608-15124: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15168-17258: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17314-18181: `{{notepad}}` from the Game Master's notepad, carried across turns
