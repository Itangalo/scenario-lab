...
- characters 376-1396: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1440-3641: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3697-4463: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4526-32417: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32772-33011: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 Essential Services Continuity Reserve −2, M5 EU Swarm-Defence Fast Deployment −2, priority −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 3, sentiment 39 -> +2
...
- `emergent_cyber_insurance repricing` -- first noted turn 4, listed in 1 turn(s) so far: A major European insurer reprices cyber cover for OT operators after the pilot results, publicly differentiating assisted-defence sites and triggering procurement disputes over who pays for wider rollout.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, cyber_major_incident, ai_investment_collapse
- Turn 3 (2 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise
- Turn 4 (1 turn(s) ago): knowledge_work_augmented, export_control_escalation
