...
- characters 13481-13672: `{{metrics_json}}` from the run's live metric values
- characters 13765-14785: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14829-17030: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17086-18137: `{{notepad}}` from the Game Master's notepad, carried across turns
