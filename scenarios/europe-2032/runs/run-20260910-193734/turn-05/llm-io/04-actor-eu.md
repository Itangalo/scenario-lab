...
- characters 1518-3719: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6477-6919: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8991-10747: `{{previous_actions}}` from the actor's own response from the previous turn
