...
- characters 453-1570: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1613-3614: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5328-5773: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7846-9406: `{{previous_actions}}` from the actor's own response from the previous turn
