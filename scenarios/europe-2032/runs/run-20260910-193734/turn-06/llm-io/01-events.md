...
- characters 375-1492: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1535-3536: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3592-4554: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4617-29955: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30310-30658: `{{event_history}}` from the run's own event record
...
- `emergent_cyber_insurance_repricing` -- first noted turn 5, listed in 1 turn(s) so far: A major European insurer reprices cyber cover for OT operators after the pilot results, publicly differentiating assisted-defence sites and triggering procurement disputes over who pays for wider rollout.
- `emergent_cyber_insurance` -- first noted turn 5, listed in 1 turn(s) so far: A major European insurer reprices cyber cover for OT operators after the pilot results, publicly differentiating assisted-defence sites and triggering procurement disputes over who pays for wider rollout.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, cyber_major_incident, ai_investment_collapse
- Turn 3 (3 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise
- Turn 4 (2 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 5 (1 turn(s) ago): taiwan_blockade, embodied_ai_deployment, member_state_defection, election_alliance
