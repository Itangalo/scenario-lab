...
- characters 375-1623: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1666-4210: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4266-4816: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4879-30820: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31175-31752: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, cyber_major_incident, ai_investment_collapse
- Turn 3 (5 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise
- Turn 4 (4 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 5 (3 turn(s) ago): taiwan_blockade, embodied_ai_deployment, member_state_defection, election_alliance
- Turn 6 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, safety_breakthrough, adoption_success
- Turn 7 (1 turn(s) ago): cyber_major_incident, taiwan_tension_rise, adoption_success, emergent_cyber_insurance_repricing
