...
- characters 105-12981: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13024-13215: `{{metrics_json}}` from the run's live metric values
- characters 13308-14556: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14599-17143: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17199-17749: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Swarm-Behaviour Detection Rollout | 2 |
