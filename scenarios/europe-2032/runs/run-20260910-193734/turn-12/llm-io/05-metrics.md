...
- characters 13392-13583: `{{metrics_json}}` from the run's live metric values
- characters 13676-14753: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14796-16632: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16688-17058: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t11: M8 EU Agent Containment and Joint Telemetry Accession −2, priority −1 not charged capital below 20 no effect = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 13, sentiment 31.0 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, no cat4 in flight +0, member_state_defection t11 −2, capability rose 1.0 −0 = 18
