...
- characters 106-13094: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13137-13329: `{{metrics_json}}` from the run's live metric values
- characters 13422-14432: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14476-16429: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16485-17020: `{{notepad}}` from the Game Master's notepad, carried across turns
