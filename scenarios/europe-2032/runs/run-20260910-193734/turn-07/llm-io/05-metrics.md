...
- characters 106-13297: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13340-13531: `{{metrics_json}}` from the run's live metric values
- characters 13624-14746: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14790-16989: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17045-17465: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M6 | EU Assisted-Defence Extension to Exposed Operators | 2 |
