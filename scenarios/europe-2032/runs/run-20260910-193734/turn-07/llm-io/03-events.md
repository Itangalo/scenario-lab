...
- characters 376-1498: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1542-3741: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3797-4834: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4897-30838: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31193-31648: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, cyber_major_incident, ai_investment_collapse
- Turn 3 (4 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise
- Turn 4 (3 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 5 (2 turn(s) ago): taiwan_blockade, embodied_ai_deployment, member_state_defection, election_alliance
- Turn 6 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, safety_breakthrough, adoption_success
