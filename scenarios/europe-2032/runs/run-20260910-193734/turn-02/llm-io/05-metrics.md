...
- characters 105-13047: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13090-13282: `{{metrics_json}}` from the run's live metric values
- characters 13375-14796: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14839-17185: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17241-18358: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 50.0, "ai_safety": 30.0, "resilience": 36.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 24.0, "public_sentiment": 33.0}
```
