...
- characters 1918-4264: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4332-4774: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6254-8275: `{{previous_actions}}` from the actor's own response from the previous turn
