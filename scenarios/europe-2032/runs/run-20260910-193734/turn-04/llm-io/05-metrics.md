...
- characters 105-13434: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13477-13669: `{{metrics_json}}` from the run's live metric values
- characters 13762-14926: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14969-17559: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17615-18488: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | Essential Services Continuity Reserve | 2 |
| M5 | EU Swarm-Defence Fast Deployment | 2 |
...
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Infrastructure Cyber Shield −3, M4 Essential Services Continuity Reserve −2, M5 EU Swarm-Defence Fast Deployment −2, priority −1 = −14
PROPOSAL BONUS: none — defensive breakthrough is positive shift not negative shock, Taiwan rise is precursor watch not harm answered by resilience deployment
