...
- characters 378-1428: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1472-3539: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3595-4340: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4403-31197: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31552-32394: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M8 EU Agent Containment and Joint Telemetry Accession −2, priority −1 not charged capital below 20 no effect = −2
PROPOSAL BONUS: EU Agent Containment and Joint Telemetry Accession (cat 6, small) +3 — loss-of-control incident this turn and this answers it directly with joint accession
...
- `emergent_anti_ai_sabotage_wave` -- first noted turn 9, listed in 2 turn(s) so far: Coordinated physical attacks on municipal data centres and grid substations by anti-AI activists, forcing extended outages beyond the cyber incidents already underway.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, cyber_major_incident, ai_investment_collapse
- Turn 3 (8 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise
- Turn 4 (7 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 5 (6 turn(s) ago): taiwan_blockade, embodied_ai_deployment, member_state_defection, election_alliance
- Turn 6 (5 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, safety_breakthrough, adoption_success
- Turn 7 (4 turn(s) ago): cyber_major_incident, taiwan_tension_rise, adoption_success, emergent_cyber_insurance_repricing
- Turn 8 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, cyber_defence_breakthrough
- Turn 9 (2 turn(s) ago): eval_anomaly_reports, adoption_success
- Turn 10 (1 turn(s) ago): loss_of_control_incident, research_breakthrough, joint_threat_response
