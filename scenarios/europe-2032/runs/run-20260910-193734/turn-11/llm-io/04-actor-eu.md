...
- characters 456-1506: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1550-3617: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3997-4457: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7016-9451: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Agent Containment and Joint Telemetry Accession | 6 | small | 10 | 12 | own jurisdiction plus joint command partners | resilience up moderately, ai_safety up slightly | 2 | running |
