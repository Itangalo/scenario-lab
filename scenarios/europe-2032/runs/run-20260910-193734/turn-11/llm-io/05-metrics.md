...
- characters 107-12936: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12979-13171: `{{metrics_json}}` from the run's live metric values
- characters 13264-14314: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14358-16425: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16481-16935: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Agent Containment and Joint Telemetry Accession | 2 |
