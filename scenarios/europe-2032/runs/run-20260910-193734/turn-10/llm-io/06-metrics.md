...
- characters 13350-13541: `{{metrics_json}}` from the run's live metric values
- characters 13634-14885: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14928-16881: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16937-17553: `{{notepad}}` from the Game Master's notepad, carried across turns
