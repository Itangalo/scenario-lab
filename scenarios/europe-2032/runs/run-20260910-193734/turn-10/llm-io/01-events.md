...
- characters 1670-3623: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3679-4295: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4358-31152: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31507-32250: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M7 EU Swarm-Behaviour Detection Rollout −2, priority −1 not charged capital below 20 no effect = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 5.0, sentiment 33.5 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, no cat4 in flight +0, capability rose 1.0 −0 = 20

## Emerging developments (tracked)

- `emergent_anti_ai_sabotage_wave` -- first noted turn 9, listed in 1 turn(s) so far: Coordinated physical attacks on municipal data centres and grid substations by anti-AI activists, forcing extended outages beyond the cyber incidents already underway.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, cyber_major_incident, ai_investment_collapse
- Turn 3 (7 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise
- Turn 4 (6 turn(s) ago): knowledge_work_augmented, export_control_escalation
- Turn 5 (5 turn(s) ago): taiwan_blockade, embodied_ai_deployment, member_state_defection, election_alliance
- Turn 6 (4 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, safety_breakthrough, adoption_success
- Turn 7 (3 turn(s) ago): cyber_major_incident, taiwan_tension_rise, adoption_success, emergent_cyber_insurance_repricing
- Turn 8 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, cyber_defence_breakthrough
- Turn 9 (1 turn(s) ago): eval_anomaly_reports, adoption_success
