...
- characters 1748-3701: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5973-6422: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8636-10300: `{{previous_actions}}` from the actor's own response from the previous turn
