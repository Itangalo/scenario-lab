...
- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Join pooled defence and contain autonomous-agent risk while restoring capacity to act
  ...
  - Evidence quoted: the two-year commitment period closes this turn and a days-long loss-of-control incident with alien agent cooperation coincides with an invitation to joint threat response
