...
| M6 | Joint Cyber Command Accession | 6 | small | 7 | 9 | own jurisdiction via coalition joint cyber command | resilience up moderately | 2 | finished |
| M7 | Municipal Continuity and Recovery Corps | 6 | small | 9 | 12 | own jurisdiction | resilience up moderately, public_sentiment up modestly via visible recovery | 2 | running |
...
- **applied** `M7` — {"op": "add", "table": "measures", "fields": {"name": "Municipal Continuity and Recovery Corps", "category": 6, "size": "small", "finish_turn": 12, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, public_sentiment up modestly via visible recovery"}, "grounds": "major automated attack left municipal services lagging while connected operators recovered"}
  - Grounds: major automated attack left municipal services lagging while connected operators recovered
