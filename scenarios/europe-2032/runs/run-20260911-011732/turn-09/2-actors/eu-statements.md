...
- `two_year_commitment` (commitment): Rebuild the capacity to act by delivering visible protection and substitutable European AI

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild the capacity to act by delivering visible protection and substitutable European AI
