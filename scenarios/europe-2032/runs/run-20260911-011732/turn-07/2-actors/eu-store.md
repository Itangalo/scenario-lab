...
| M6 | Joint Cyber Command Accession | 6 | small | 7 | 9 | own jurisdiction via coalition joint cyber command | resilience up moderately | 2 | running |
...
- **applied** `M6` — {"op": "add", "table": "measures", "fields": {"name": "Joint Cyber Command Accession", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction via coalition joint cyber command", "targeted_effect": "resilience up moderately"}, "grounds": "invited seat after major incident with no domestic alternative"}
  - Grounds: invited seat after major incident with no domestic alternative
