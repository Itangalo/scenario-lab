...
- characters 105-13145: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13188-13380: `{{metrics_json}}` from the run's live metric values
- characters 13473-14686: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14729-16924: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16980-17717: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Grid and Public Services Shield | 3 |
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 50.0, "ai_safety": 37.0, "resilience": 36.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 25.0, "public_sentiment": 30.0}
```
## Narrative
