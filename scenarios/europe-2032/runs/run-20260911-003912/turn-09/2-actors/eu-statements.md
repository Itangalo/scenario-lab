...
- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold trustworthy daily services and biosecurity on what Europe can actually run
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the two-year period directly ends the timeframe the original commitment was bound to, changing the cost and relevance of maintaining the prior statement.
