...
- characters 376-1633: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1677-4012: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4068-4611: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4674-32813: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33168-33859: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, loss_of_control_incident, openweight_frontier_release
- Turn 2 (7 turn(s) ago): bio_uplift_findings, taiwan_tension_rise, emergent_lab_talent_exodus
- Turn 3 (6 turn(s) ago): emergent_bio_publication_moratorium
- Turn 4 (5 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release
- Turn 5 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, emergent_foreign_genome_bypass, election_consolidation
- Turn 6 (3 turn(s) ago): ai_investment_collapse, bio_uplift_findings
- Turn 7 (2 turn(s) ago): us_labs_nationalised
- Turn 8 (1 turn(s) ago): rsi_onset, joint_threat_response, emergent_us_tiered_access_terms
