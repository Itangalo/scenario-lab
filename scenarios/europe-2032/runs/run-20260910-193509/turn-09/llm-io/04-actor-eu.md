...
- characters 454-1711: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1755-4090: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5843-6330: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9055-11138: `{{previous_actions}}` from the actor's own response from the previous turn
