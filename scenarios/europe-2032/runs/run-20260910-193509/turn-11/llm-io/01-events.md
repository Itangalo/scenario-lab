...
- characters 376-1408: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1452-3787: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3843-5026: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5089-32416: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32771-33717: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Continuity and Substitution Shield −2, priority −1 = −3
PROPOSAL BONUS: EU Continuity and Substitution Shield (cat 6, small) +5 — eu_frontier_access_denied plus cyber_major_incident landed this turn and this answers them directly
LEGITIMACY LENDS: capital 25, sentiment 12 -> none, capital is higher
SOVEREIGNTY: 20 last turn, no capacity event finish, no cat4 in flight, eu_frontier_access_denied t10 −3 (largest of frontier cutoff / embodied deployment / defection), capability rose 2.5 −1 = 16

## Emerging developments (tracked)

- `emergent_power_grid_strain_curtailment` -- first noted turn 9, listed in 2 turn(s) so far: Rolling power shortfalls and grid instability across the US and EU as self-directed training loads collide with capped generation and cooling, forcing temporary curtailments of inference and training outside priority sites.
- `emergent_grid_strain_brownouts` -- first noted turn 9, listed in 2 turn(s) so far: A cascading winter power shortfall across allied grids, driven by AI data-centre load plus low renewables output, forces unplanned brownouts that idle training clusters and delay inference deliveries to Europe for weeks.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, loss_of_control_incident, openweight_frontier_release
- Turn 2 (9 turn(s) ago): bio_uplift_findings, taiwan_tension_rise, emergent_lab_talent_exodus
- Turn 3 (8 turn(s) ago): emergent_bio_publication_moratorium
- Turn 4 (7 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release
- Turn 5 (6 turn(s) ago): cyber_major_incident, eval_anomaly_reports, emergent_foreign_genome_bypass, election_consolidation
- Turn 6 (5 turn(s) ago): ai_investment_collapse, bio_uplift_findings
- Turn 7 (4 turn(s) ago): us_labs_nationalised
- Turn 8 (3 turn(s) ago): rsi_onset, joint_threat_response, emergent_us_tiered_access_terms
- Turn 9 (2 turn(s) ago): cyber_major_incident, bio_incident, loss_of_control_incident, safety_breakthrough
- Turn 10 (1 turn(s) ago): cyber_major_incident, embodied_ai_deployment, eu_frontier_access_denied, member_state_defection, joint_threat_response
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.04}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.03}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.03}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_great_power_conflict", "probability": 0.11}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.16}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Rolling power shortfalls and grid instability across the US and EU as self-directed training loads collide with capped generation and cooling, forcing temporary curtailments of inference and training outside priority sites.", "emergent": true, "id": "emergent_power_grid_strain_curtailment", "probability": 0.28}, {"description": "A cascading winter power shortfall across allied grids, driven by AI data-centre load plus low renewables output, forces unplanned brownouts that idle training clusters and delay inference deliveries to Europe for weeks.", "emergent": true, "id": "emergent_grid_strain_brownouts", "probability": 0.24}]
```
