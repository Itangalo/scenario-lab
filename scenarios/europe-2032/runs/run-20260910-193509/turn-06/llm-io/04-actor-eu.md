...
- characters 454-1805: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1848-4657: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5526-5990: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8271-9858: `{{previous_actions}}` from the actor's own response from the previous turn
