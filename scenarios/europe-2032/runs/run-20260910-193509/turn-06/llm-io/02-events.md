...
- characters 376-1727: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1770-4579: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4635-5331: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5394-32489: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32844-33326: `{{event_history}}` from the run's own event record
...
- `emergent_foreign_genome_release` -- first noted turn 4, listed in 2 turn(s) so far: A non-EU lab publishes open weights for a frontier genome design model with uplift comparable to the disputed claim, mirrored widely before any screening standard is agreed, directly undercutting the university moratorium.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, loss_of_control_incident, openweight_frontier_release
- Turn 2 (4 turn(s) ago): bio_uplift_findings, taiwan_tension_rise, emergent_lab_talent_exodus
- Turn 3 (3 turn(s) ago): emergent_bio_publication_moratorium
- Turn 4 (2 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release
- Turn 5 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, emergent_foreign_genome_bypass, election_consolidation
