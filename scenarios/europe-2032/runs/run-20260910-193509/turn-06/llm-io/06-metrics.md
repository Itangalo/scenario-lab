...
- characters 13888-15239: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15282-18091: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18147-19082: `{{notepad}}` from the Game Master's notepad, carried across turns
