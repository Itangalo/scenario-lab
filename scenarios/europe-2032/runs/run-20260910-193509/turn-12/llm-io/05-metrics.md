...
- characters 106-13387: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13430-13620: `{{metrics_json}}` from the run's live metric values
- characters 13713-14840: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14883-17403: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17459-17967: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Black-Box Containment and Bio-Uplift Interdiction Regime | 2 |
