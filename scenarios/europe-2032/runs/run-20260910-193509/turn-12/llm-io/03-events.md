...
- characters 375-1502: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1545-4065: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4121-4629: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4692-32019: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32374-33500: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, loss_of_control_incident, openweight_frontier_release
- Turn 2 (10 turn(s) ago): bio_uplift_findings, taiwan_tension_rise, emergent_lab_talent_exodus
- Turn 3 (9 turn(s) ago): emergent_bio_publication_moratorium
- Turn 4 (8 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release
- Turn 5 (7 turn(s) ago): cyber_major_incident, eval_anomaly_reports, emergent_foreign_genome_bypass, election_consolidation
- Turn 6 (6 turn(s) ago): ai_investment_collapse, bio_uplift_findings
- Turn 7 (5 turn(s) ago): us_labs_nationalised
- Turn 8 (4 turn(s) ago): rsi_onset, joint_threat_response, emergent_us_tiered_access_terms
- Turn 9 (3 turn(s) ago): cyber_major_incident, bio_incident, loss_of_control_incident, safety_breakthrough
- Turn 10 (2 turn(s) ago): cyber_major_incident, embodied_ai_deployment, eu_frontier_access_denied, member_state_defection, joint_threat_response
- Turn 11 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, medical_breakthrough, safety_breakthrough, export_control_escalation, emergent_power_grid_strain_curtailment
