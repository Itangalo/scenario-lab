...
- characters 376-2536: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2579-4907: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4963-6165: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6228-33555: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33910-34709: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU-US State-to-State AI Access Pact −2, EU Containment and Certified Assurance Deployment −2, priority −1 = −5
PROPOSAL BONUS: EU Containment and Certified Assurance Deployment (cat 5, small) +4 — loss-of-control incident plus cyber_major and bio incidents landed this turn and this answers them directly with safety_breakthrough to exploit
LEGITIMACY LENDS: capital 22, sentiment 19 -> none, capital is higher
SOVEREIGNTY: 21 last turn, no capacity event, no cat4 finish or in-flight bonus, capability rose 3.5 −1 = 20

## Emerging developments (tracked)

- `emergent_power_grid_strain_curtailment` -- first noted turn 9, listed in 1 turn(s) so far: Rolling power shortfalls and grid instability across the US and EU as self-directed training loads collide with capped generation and cooling, forcing temporary curtailments of inference and training outside priority sites.
- `emergent_grid_strain_brownouts` -- first noted turn 9, listed in 1 turn(s) so far: A cascading winter power shortfall across allied grids, driven by AI data-centre load plus low renewables output, forces unplanned brownouts that idle training clusters and delay inference deliveries to Europe for weeks.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, loss_of_control_incident, openweight_frontier_release
- Turn 2 (8 turn(s) ago): bio_uplift_findings, taiwan_tension_rise, emergent_lab_talent_exodus
- Turn 3 (7 turn(s) ago): emergent_bio_publication_moratorium
- Turn 4 (6 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release
- Turn 5 (5 turn(s) ago): cyber_major_incident, eval_anomaly_reports, emergent_foreign_genome_bypass, election_consolidation
- Turn 6 (4 turn(s) ago): ai_investment_collapse, bio_uplift_findings
- Turn 7 (3 turn(s) ago): us_labs_nationalised
- Turn 8 (2 turn(s) ago): rsi_onset, joint_threat_response, emergent_us_tiered_access_terms
- Turn 9 (1 turn(s) ago): cyber_major_incident, bio_incident, loss_of_control_incident, safety_breakthrough
