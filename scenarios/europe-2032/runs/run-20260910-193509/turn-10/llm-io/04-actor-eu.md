...
- characters 454-2614: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2657-4985: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7483-7968: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10712-13310: `{{previous_actions}}` from the actor's own response from the previous turn
