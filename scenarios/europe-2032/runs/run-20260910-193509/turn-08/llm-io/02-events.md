...
- characters 376-1634: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1677-3623: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3679-4789: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4852-31353: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31708-32307: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: Distressed Compute Buy-Up and Bio-Cyber Repair Facility −2, EU-US State-to-State AI Access Pact −2, priority −1 = −5
PROPOSAL BONUS: EU-US State-to-State AI Access Pact (cat 8, small) +3 — us_labs_nationalised landed this turn voiding market leverage and this answers it directly as state negotiation
LEGITIMACY LENDS: capital 20, sentiment 23 -> +2
SOVEREIGNTY: 18 last turn, InvestAI Gigafactories finishes t7 +4, Distressed Buy-Up in flight +1, us_labs_nationalised t7 −2, capability rose 2.5 −1 = 20

## Emerging developments (tracked)

- `emergent_us_tiered_access_terms` -- first noted turn 6, listed in 2 turn(s) so far: Washington publishes tiered AI access rules placing most EU member states in a second tier with volume caps and re-export approvals, prompting emergency EU talks on pooled procurement.
- `emergent_anti_ai_sabotage_wave` -- first noted turn 6, listed in 2 turn(s) so far: Coordinated physical sabotage and blockades against data-centre construction and grid upgrade sites in several member states, forcing delays and security costs amid hostile public sentiment.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, loss_of_control_incident, openweight_frontier_release
- Turn 2 (6 turn(s) ago): bio_uplift_findings, taiwan_tension_rise, emergent_lab_talent_exodus
- Turn 3 (5 turn(s) ago): emergent_bio_publication_moratorium
- Turn 4 (4 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release
- Turn 5 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, emergent_foreign_genome_bypass, election_consolidation
- Turn 6 (2 turn(s) ago): ai_investment_collapse, bio_uplift_findings
- Turn 7 (1 turn(s) ago): us_labs_nationalised
