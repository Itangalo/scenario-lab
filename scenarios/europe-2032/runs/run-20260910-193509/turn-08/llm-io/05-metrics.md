...
- characters 105-13398: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13441-13633: `{{metrics_json}}` from the run's live metric values
- characters 13726-14984: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15027-16973: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17029-17553: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | EU Joint Cyber-Bio Shield Accession | 2 |
...
## Notepad
PORTFOLIO CHARGE t8: EU-US State-to-State AI Access Pact −2, EU Joint Cyber-Bio Shield Accession −2, priority −1 = −5
PROPOSAL BONUS: EU Joint Cyber-Bio Shield Accession (cat 6, small) +3 — joint_threat_response invitation landed this turn and this answers it directly while bio window open
LEGITIMACY LENDS: capital 20, sentiment 23 -> +2
SOVEREIGNTY: 20 last turn, Distressed Compute Buy-Up and Bio-Cyber Repair Facility finishes t8 +4, no capacity event in flight bonus +0, emergent_us_tiered_access_terms t8 −2, capability rose 7.0 −1 = 21
