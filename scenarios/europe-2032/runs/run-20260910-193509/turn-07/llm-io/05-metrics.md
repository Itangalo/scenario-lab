...
- characters 106-13384: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13427-13619: `{{metrics_json}}` from the run's live metric values
- characters 13712-14762: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14806-17054: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17110-18220: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | Distressed Compute Buy-Up and Bio-Cyber Repair Facility | 2 |
| M8 | EU-US State-to-State AI Access Pact | 2 |
...
## Metrics
```json
{"ai_capability": 73.0, "openweight_capability": 65.5, "ai_safety": 14.0, "resilience": 42.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 22.0, "public_sentiment": 23.0}
```
