...
- characters 1549-3797: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4938-5425: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7885-10749: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | Distressed Compute Buy-Up and Bio-Cyber Repair Facility | 4 | small | 6 | 8 | own jurisdiction | eu_ai_sovereignty up moderately, resilience up moderately | 2 | running |
