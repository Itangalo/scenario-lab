...
- characters 377-1427: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1471-3719: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3775-4885: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4948-32981: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33336-33888: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, Distressed Compute Buy-Up and Bio-Cyber Repair Facility −2, priority −1 = −6
PROPOSAL BONUS: Distressed Compute Buy-Up (cat 4, small) +3 — ai_investment_collapse evaporated private build-out this turn and bio_uplift_findings opened 4-turn bio window, both answered directly
LEGITIMACY LENDS: capital 15, sentiment 27 -> +2
SOVEREIGNTY: 17 last turn, Tech sovereignty package finishes t6 +4, Gigafactories in flight +0, ai_investment_collapse t6 −2, capability rose 3.0 −1 = 18

## Emerging developments (tracked)

- `emergent_us_tiered_access_terms` -- first noted turn 6, listed in 1 turn(s) so far: Washington publishes tiered AI access rules placing most EU member states in a second tier with volume caps and re-export approvals, prompting emergency EU talks on pooled procurement.
- `emergent_anti_ai_sabotage_wave` -- first noted turn 6, listed in 1 turn(s) so far: Coordinated physical sabotage and blockades against data-centre construction and grid upgrade sites in several member states, forcing delays and security costs amid hostile public sentiment.
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, loss_of_control_incident, openweight_frontier_release
- Turn 2 (5 turn(s) ago): bio_uplift_findings, taiwan_tension_rise, emergent_lab_talent_exodus
- Turn 3 (4 turn(s) ago): emergent_bio_publication_moratorium
- Turn 4 (3 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release
- Turn 5 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, emergent_foreign_genome_bypass, election_consolidation
- Turn 6 (1 turn(s) ago): ai_investment_collapse, bio_uplift_findings
