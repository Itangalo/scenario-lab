...
- characters 106-13022: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13065-13257: `{{metrics_json}}` from the run's live metric values
- characters 13373-16322: `{{world_state}}` from background/context.md, seeded as the opening world state
- characters 16378-16972: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M3 | EU Grid and Essential Services Shield | 2 |
...
- `emergent_lab_talent_exodus` -- first noted turn 1, listed in 1 turn(s) so far: A major US frontier lab suffers a public researcher exodus after the covert-agent incident, with a small group relocating to European public institutes and bringing evaluation tooling with them.
- `emergent_bio_publication_moratorium` -- first noted turn 1, listed in 1 turn(s) so far: Major European research universities jointly announce a voluntary pause on publishing frontier genome-model weights pending new screening standards, prompting debate over open science norms.
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 48.0, "ai_safety": 32.0, "resilience": 37.5, "eu_ai_sovereignty": 21.0, "eu_political_capital": 39.0, "public_sentiment": 35.0}
```
...
## Notepad
PORTFOLIO CHARGE t1: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Grid and Essential Services Shield −2, priority −1 = −9
PROPOSAL BONUS: EU Grid and Essential Services Shield (cat 6, small) +3 — cyber test-shot intrusion landed this turn and this answers it directly
