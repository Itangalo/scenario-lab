...
- characters 106-13086: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13129-13321: `{{metrics_json}}` from the run's live metric values
- characters 13414-14830: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14874-17290: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17346-17809: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | European Evaluation Corps and Talent Reception | 2 |
| M5 | EU Bio Screening and Verification Shield | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, European Evaluation Corps and Talent Reception −2, priority −1 = −9
PROPOSAL BONUS: European Evaluation Corps and Talent Reception (cat 5, small) +3 — bio uplift signal landed this turn and lab exodus tooling window answers it directly
LEGITIMACY LENDS: capital 30, sentiment 33 -> +2
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 54.0, "ai_safety": 28.0, "resilience": 40.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 26.0, "public_sentiment": 33.0}
```
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, European Evaluation Corps and Talent Reception −2, EU Bio Screening and Verification Shield −2, priority −1 = −11
PROPOSAL BONUS: EU Bio Screening and Verification Shield (cat 6, small) +3 — genome-model bio-uplift claim from last two turns and university moratorium this turn, answers directly
