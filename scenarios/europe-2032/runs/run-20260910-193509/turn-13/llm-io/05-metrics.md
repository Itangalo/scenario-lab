...
- characters 13444-13634: `{{metrics_json}}` from the run's live metric values
- characters 13727-14690: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14734-16845: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16901-17404: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Accession to Joint Cyber-Bio Threat Response Command | 2 |
...
## Metrics
```json
{"ai_capability": 90.5, "openweight_capability": 87.0, "ai_safety": 7.0, "resilience": 64.0, "eu_ai_sovereignty": 8.0, "eu_political_capital": 21.0, "public_sentiment": 0.0}
```
...
## Notepad
PORTFOLIO CHARGE t13: EU Accession to Joint Cyber-Bio Threat Response Command −2, priority −1 = −3
PROPOSAL BONUS: none — EU Accession to Joint Cyber-Bio Threat Response Command (cat 8, small) joins a protective invitation, does not answer a negative event from last three rounds
LEGITIMACY LENDS: capital 21, sentiment 0 -> none, capital is higher
SOVEREIGNTY: 10 last turn, no capacity finish +0, M14 in flight +0 (not cat4), embodied_ai_deployment t13 −2, capability rose 1.5 −0 = 8
