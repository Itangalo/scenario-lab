...
- characters 376-1339: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1383-3494: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3550-4053: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4116-30745: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31100-32345: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Black-Box Containment and Bio-Uplift Interdiction Regime −2, priority −1 = −3
PROPOSAL BONUS: EU Black-Box Containment and Bio-Uplift Interdiction Regime (cat 6, small) +3 — bio_uplift_findings and opaque_reasoning landed this turn and this answers them directly
LEGITIMACY LENDS: capital 26, sentiment 5 -> none, capital is higher
SOVEREIGNTY: 13 last turn, no capacity event finish +0, M13 in flight +0 (not cat4), export_control_escalation t12 −2, capability rose 1.5 −1 = 10
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, loss_of_control_incident, openweight_frontier_release
- Turn 2 (11 turn(s) ago): bio_uplift_findings, taiwan_tension_rise, emergent_lab_talent_exodus
- Turn 3 (10 turn(s) ago): emergent_bio_publication_moratorium
- Turn 4 (9 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release
- Turn 5 (8 turn(s) ago): cyber_major_incident, eval_anomaly_reports, emergent_foreign_genome_bypass, election_consolidation
- Turn 6 (7 turn(s) ago): ai_investment_collapse, bio_uplift_findings
- Turn 7 (6 turn(s) ago): us_labs_nationalised
- Turn 8 (5 turn(s) ago): rsi_onset, joint_threat_response, emergent_us_tiered_access_terms
- Turn 9 (4 turn(s) ago): cyber_major_incident, bio_incident, loss_of_control_incident, safety_breakthrough
- Turn 10 (3 turn(s) ago): cyber_major_incident, embodied_ai_deployment, eu_frontier_access_denied, member_state_defection, joint_threat_response
- Turn 11 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, medical_breakthrough, safety_breakthrough, export_control_escalation, emergent_power_grid_strain_curtailment
- Turn 12 (1 turn(s) ago): bio_uplift_findings, opaque_reasoning, knowledge_work_augmented, export_control_escalation
