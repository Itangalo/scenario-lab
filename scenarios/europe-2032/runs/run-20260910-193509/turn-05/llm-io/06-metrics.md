...
- characters 106-13424: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13467-13659: `{{metrics_json}}` from the run's live metric values
- characters 13752-14922: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14966-17029: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17085-17931: `{{notepad}}` from the Game Master's notepad, carried across turns
