...
- characters 455-1625: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1669-3732: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5889-6355: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8634-10590: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Critical Systems Auto-Defence Deployment | 6 | small | 4 | 6 | own jurisdiction | resilience up substantially | 2 | running |
