...
- `two_year_commitment` (commitment): Hold essential services through allied rationing and rebuild domestic fallback capacity

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold essential services through allied rationing and rebuild domestic fallback capacity
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The development directly ends the timeframe the original commitment was based on, changing the actor's obligation and cost of maintaining the prior statement.
