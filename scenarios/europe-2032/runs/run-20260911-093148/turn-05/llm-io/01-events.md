...
- characters 376-2178: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2222-4832: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4888-5401: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5464-29245: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29600-29930: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): export_control_escalation
- Turn 3 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, export_control_escalation
- Turn 4 (1 turn(s) ago): cyber_defence_breakthrough, eu_frontier_access_denied, emergent_siting_backlash_freeze
