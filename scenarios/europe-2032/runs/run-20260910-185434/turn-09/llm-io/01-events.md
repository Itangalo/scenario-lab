...
- characters 376-1884: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1928-4137: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4193-5229: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5292-32288: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32643-33396: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Critical Services Auto-Patch and Swarm Shield −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 8, sentiment 12 -> +2
SOVEREIGNTY: 18 last turn, no capacity build finishes, no capacity event in flight bonus, export_control_escalation t8 −2, capability rose 3.0 −1 = 15

## Emerging developments (tracked)

- `emergent_distressed_compute_fire_sale` -- first noted turn 7, listed in 2 turn(s) so far: Distressed US data-centre developers and accelerator vendors, frozen out of domestic expansion capital, offer fire-sale leases and hardware tranches to Gulf and Asian sovereign funds outside US export-licence scope.
- `emergent_distressed_compute_diversion` -- first noted turn 7, listed in 2 turn(s) so far: Distressed US hyperscale vendors quietly sell cancelled EU-planned accelerator lots and half-built data-centre shells to Gulf-backed buyers who offer to re-site them outside EU jurisdiction, permanently removing the hardware Brussels hoped to anchor.
...
- Turn 2 (7 turn(s) ago): bio_uplift_findings, openweight_frontier_release, emergent_lab_whistleblower_disclosure
- Turn 3 (6 turn(s) ago): eval_anomaly_reports
- Turn 4 (5 turn(s) ago): loss_of_control_incident, export_control_escalation
- Turn 5 (4 turn(s) ago): eval_anomaly_reports, adoption_success, election_consolidation
- Turn 6 (3 turn(s) ago): ai_investment_collapse, opaque_reasoning
- Turn 7 (2 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, research_breakthrough, openweight_frontier_release, embodied_ai_deployment, taiwan_tension_rise, us_china_agreement
- Turn 8 (1 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, export_control_escalation, joint_threat_response
