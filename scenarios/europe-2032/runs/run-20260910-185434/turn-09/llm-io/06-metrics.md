...
- characters 13676-15184: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15228-17437: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17493-17839: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 78.5, "openweight_capability": 72.0, "ai_safety": 5.0, "resilience": 55.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 4.0, "public_sentiment": 6.0}
```
