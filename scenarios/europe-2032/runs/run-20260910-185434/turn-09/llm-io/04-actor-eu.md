...
- characters 454-1962: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2006-4215: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6161-6916: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9372-11192: `{{previous_actions}}` from the actor's own response from the previous turn
