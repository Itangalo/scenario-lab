...
- characters 452-1822: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1865-3962: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5598-6311: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8918-11052: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Critical Services Auto-Patch and Swarm Shield | 6 | small | 7 | 9 | own jurisdiction | resilience up, ai_safety up via incident learning | 2 | running |
