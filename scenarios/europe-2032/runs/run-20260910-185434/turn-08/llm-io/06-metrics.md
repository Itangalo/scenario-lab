...
- characters 105-13297: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13340-13530: `{{metrics_json}}` from the run's live metric values
- characters 13623-14993: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15036-17133: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17189-18371: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 75.5, "openweight_capability": 69.0, "ai_safety": 7.0, "resilience": 51.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 10.0, "public_sentiment": 10.0}
```
