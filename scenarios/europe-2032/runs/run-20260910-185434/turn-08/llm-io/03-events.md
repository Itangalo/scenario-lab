...
- characters 374-1744: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1787-3884: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3940-5122: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5185-31014: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31369-31997: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: Municipal Manual Fallback Staffing −2, EU Critical Services Auto-Patch and Swarm Shield −2, priority −1 = −5
PROPOSAL BONUS: EU Critical Services Auto-Patch and Swarm Shield (cat 6, small) +3 — cyber_major_incident landed this turn severe and this answers it directly with cyber_defence_breakthrough
LEGITIMACY LENDS: capital 6, sentiment 12 -> +2
SOVEREIGNTY: 17 last turn, InvestAI Gigafactories finishes t7 +4, embodied_ai_deployment t7 −2, capability rose 2.5 −1 = 18

## Emerging developments (tracked)

- `emergent_distressed_compute_fire_sale` -- first noted turn 7, listed in 1 turn(s) so far: Distressed US data-centre developers and accelerator vendors, frozen out of domestic expansion capital, offer fire-sale leases and hardware tranches to Gulf and Asian sovereign funds outside US export-licence scope.
- `emergent_distressed_compute_diversion` -- first noted turn 7, listed in 1 turn(s) so far: Distressed US hyperscale vendors quietly sell cancelled EU-planned accelerator lots and half-built data-centre shells to Gulf-backed buyers who offer to re-site them outside EU jurisdiction, permanently removing the hardware Brussels hoped to anchor.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot
- Turn 2 (6 turn(s) ago): bio_uplift_findings, openweight_frontier_release, emergent_lab_whistleblower_disclosure
- Turn 3 (5 turn(s) ago): eval_anomaly_reports
- Turn 4 (4 turn(s) ago): loss_of_control_incident, export_control_escalation
- Turn 5 (3 turn(s) ago): eval_anomaly_reports, adoption_success, election_consolidation
- Turn 6 (2 turn(s) ago): ai_investment_collapse, opaque_reasoning
- Turn 7 (1 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, research_breakthrough, openweight_frontier_release, embodied_ai_deployment, taiwan_tension_rise, us_china_agreement
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "rsi_onset", "probability": 0.35}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.05}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.21}, {"description": "", "emergent": false, "id": "us_labs_nationalised", "probability": 0.14}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Distressed US data-centre developers and accelerator vendors, frozen out of domestic expansion capital, offer fire-sale leases and hardware tranches to Gulf and Asian sovereign funds outside US export-licence scope.", "emergent": true, "id": "emergent_distressed_compute_fire_sale", "probability": 0.18}, {"description": "Distressed US hyperscale vendors quietly sell cancelled EU-planned accelerator lots and half-built data-centre shells to Gulf-backed buyers who offer to re-site them outside EU jurisdiction, permanently removing the hardware Brussels hoped to anchor.", "emergent": true, "id": "emergent_distressed_compute_diversion", "probability": 0.14}]
```
