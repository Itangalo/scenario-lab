...
- characters 455-1800: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1844-4266: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4893-5358: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7307-9358: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M4 | EU Frontier Incident Disclosure and Bio-Screening Order | 2 | large | 2 | 4 | own jurisdiction | ai_safety up, resilience up via bio detection | 3 | running |
