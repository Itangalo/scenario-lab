...
- characters 1766-4188: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4244-5083: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5146-28722: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29077-29232: `{{event_history}}` from the run's own event record
...
- Turn 2 (1 turn(s) ago): bio_uplift_findings, openweight_frontier_release, emergent_lab_whistleblower_disclosure
