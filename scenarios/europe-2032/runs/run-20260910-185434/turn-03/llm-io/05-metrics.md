...
- characters 13517-13709: `{{metrics_json}}` from the run's live metric values
- characters 13802-15147: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15191-17613: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17669-18195: `{{notepad}}` from the Game Master's notepad, carried across turns
