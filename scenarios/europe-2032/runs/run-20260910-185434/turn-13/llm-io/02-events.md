...
- characters 374-1445: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1489-3357: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3413-4598: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4661-30453: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30808-32073: `{{event_history}}` from the run's own event record
...
- `emergent_clearance_tier_offer` -- first noted turn 12, listed in 1 turn(s) so far: US-cleared frontier operators offer EU hospitals and ministries a paid clearance-gated access tier via US cloud, restoring partial capability but requiring US data jurisdiction and audit.
- `emergent_clearance_rerouting_market` -- first noted turn 12, listed in 1 turn(s) so far: A grey market emerges for US-cleared frontier inference, with EU hospitals and logistics firms routing queries via intermediaries in cleared third countries despite federal controls.
...
- Turn 2 (11 turn(s) ago): bio_uplift_findings, openweight_frontier_release, emergent_lab_whistleblower_disclosure
- Turn 3 (10 turn(s) ago): eval_anomaly_reports
- Turn 4 (9 turn(s) ago): loss_of_control_incident, export_control_escalation
- Turn 5 (8 turn(s) ago): eval_anomaly_reports, adoption_success, election_consolidation
- Turn 6 (7 turn(s) ago): ai_investment_collapse, opaque_reasoning
- Turn 7 (6 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, research_breakthrough, openweight_frontier_release, embodied_ai_deployment, taiwan_tension_rise, us_china_agreement
- Turn 8 (5 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, export_control_escalation, joint_threat_response
- Turn 9 (4 turn(s) ago): labour_displacement, taiwan_tension_rise, automated_decision_scandal
- Turn 10 (3 turn(s) ago): research_breakthrough, loss_of_control_incident
- Turn 11 (2 turn(s) ago): labour_displacement, us_labs_nationalised, eu_frontier_access_denied, emergent_graduate_protest_wave
- Turn 12 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, taiwan_blockade, export_control_escalation, member_state_defection, joint_threat_response
