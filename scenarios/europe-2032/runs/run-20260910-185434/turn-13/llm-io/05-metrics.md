...
- characters 107-13389: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13432-13620: `{{metrics_json}}` from the run's live metric values
- characters 13713-14784: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14828-16696: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16752-17937: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_clearance_tier_offer` -- first noted turn 12, listed in 2 turn(s) so far: US-cleared frontier operators offer EU hospitals and ministries a paid clearance-gated access tier via US cloud, restoring partial capability but requiring US data jurisdiction and audit.
- `emergent_clearance_rerouting_market` -- first noted turn 12, listed in 2 turn(s) so far: A grey market emerges for US-cleared frontier inference, with EU hospitals and logistics firms routing queries via intermediaries in cleared third countries despite federal controls.
...
## Notepad
PORTFOLIO CHARGE t13: M12 EU Joint Cyber-Bio Shield Accession −2, priority −1 not charged (capital below 20, priority has no effect) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 3, sentiment 1 -> none — capital higher
SOVEREIGNTY: 5 last turn, no category 4 finish, no category 4 build in flight +0, catastrophic_great_power_conflict t13 −3 (largest, embodied_ai_deployment also qualifies), capability rose 4.0 −1 = 1
