...
- characters 454-1512: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1555-3842: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4815-5528: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7857-10768: `{{previous_actions}}` from the actor's own response from the previous turn
