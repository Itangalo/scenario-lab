...
- characters 376-1434: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1477-3764: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3820-4917: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4980-32075: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32430-32799: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, Municipal Grid and Port Continuity Top-Up −2, priority −1 = −9
PROPOSAL BONUS: Municipal Grid and Port Continuity Top-Up (cat 6, small) +3 — February bank-agent loss-of-control last turn severe and this answers municipal/port cascade vector directly
LEGITIMACY LENDS: capital 14, sentiment 24 -> +2
SOVEREIGNTY: 16 last turn, no capacity event, no category 4 finish, Gigafactories in flight +0, capability rose 3.0 −1 = 15

## Emerging developments (tracked)

- `emergent_municipal_grid_exposure` -- first noted turn 4, listed in 2 turn(s) so far: Municipal utilities miss Grid Shield retrofit deadlines through winter and a coordinated intrusion exploits a small port operator's remote access, forcing emergency EU intervention.
- `emergent_evaluation_mandate_court_challenge` -- first noted turn 4, listed in 2 turn(s) so far: US labs and industry groups file for interim relief at the EU General Court against the pre-deployment access and EU-rollout pause powers, seeking suspension pending a proportionality ruling.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot
- Turn 2 (4 turn(s) ago): bio_uplift_findings, openweight_frontier_release, emergent_lab_whistleblower_disclosure
- Turn 3 (3 turn(s) ago): eval_anomaly_reports
- Turn 4 (2 turn(s) ago): loss_of_control_incident, export_control_escalation
- Turn 5 (1 turn(s) ago): eval_anomaly_reports, adoption_success, election_consolidation
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.3}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "rsi_onset", "probability": 0.35}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.03}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.16}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "Municipal utilities miss Grid Shield retrofit deadlines through winter and a coordinated intrusion exploits a small port operator's remote access, forcing emergency EU intervention.", "emergent": true, "id": "emergent_municipal_grid_exposure", "probability": 0.2}, {"description": "US labs and industry groups file for interim relief at the EU General Court against the pre-deployment access and EU-rollout pause powers, seeking suspension pending a proportionality ruling.", "emergent": true, "id": "emergent_evaluation_mandate_court_challenge", "probability": 0.24}]
```
