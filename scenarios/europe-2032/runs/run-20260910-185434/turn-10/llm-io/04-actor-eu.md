...
- characters 452-1785: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1828-3998: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5965-6754: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9558-12541: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Entry-Level Transition and Redress Guarantee | 7 | small | 9 | 11 | own jurisdiction | resilience up via social absorption, public_sentiment up, eu_political_capital up | 2 | running |
