...
- characters 13009-13198: `{{metrics_json}}` from the run's live metric values
- characters 13291-14624: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14667-16837: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16893-17704: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Entry-Level Transition and Redress Guarantee | 2 |
