...
- characters 374-1707: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1750-3920: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3976-4459: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4522-31518: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31873-32721: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Entry-Level Transition and Redress Guarantee −2, priority −1 not charged (capital below 20, priority has no effect) = −2
PROPOSAL BONUS: EU Entry-Level Transition and Redress Guarantee (cat 7, small) +4 — labour_displacement and automated_decision_scandal both fired this turn and this answers both directly
LEGITIMACY LENDS: capital 2, sentiment 6 -> +2
SOVEREIGNTY: 15 last turn, no capacity event, no category 4 build in flight, capability rose 3.0 −1 = 14
...
- Turn 2 (8 turn(s) ago): bio_uplift_findings, openweight_frontier_release, emergent_lab_whistleblower_disclosure
- Turn 3 (7 turn(s) ago): eval_anomaly_reports
- Turn 4 (6 turn(s) ago): loss_of_control_incident, export_control_escalation
- Turn 5 (5 turn(s) ago): eval_anomaly_reports, adoption_success, election_consolidation
- Turn 6 (4 turn(s) ago): ai_investment_collapse, opaque_reasoning
- Turn 7 (3 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, research_breakthrough, openweight_frontier_release, embodied_ai_deployment, taiwan_tension_rise, us_china_agreement
- Turn 8 (2 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, export_control_escalation, joint_threat_response
- Turn 9 (1 turn(s) ago): labour_displacement, taiwan_tension_rise, automated_decision_scandal
