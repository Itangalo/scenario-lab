...
- characters 107-13401: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13444-13633: `{{metrics_json}}` from the run's live metric values
- characters 13726-15020: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15064-17224: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17280-17651: `{{notepad}}` from the Game Master's notepad, carried across turns
