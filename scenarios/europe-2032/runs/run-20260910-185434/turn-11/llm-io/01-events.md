...
- characters 375-1669: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1713-3873: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3929-4628: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4691-32733: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33088-34012: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Entry-Level Transition and Redress Guarantee −2, priority −1 not charged (capital below 20, priority has no effect) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: none — capital 5, sentiment 3, capital higher
SOVEREIGNTY: 14 last turn, no capacity event, no category 4 build in flight, capability rose 3.0 −1 = 13

## Emerging developments (tracked)

- `emergent_graduate_protest_wave` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated graduate-led blockades target empty data-centre shells and university career offices across several member states, forcing temporary site closures and a national debate on entry-level hiring.
...
- Turn 2 (9 turn(s) ago): bio_uplift_findings, openweight_frontier_release, emergent_lab_whistleblower_disclosure
- Turn 3 (8 turn(s) ago): eval_anomaly_reports
- Turn 4 (7 turn(s) ago): loss_of_control_incident, export_control_escalation
- Turn 5 (6 turn(s) ago): eval_anomaly_reports, adoption_success, election_consolidation
- Turn 6 (5 turn(s) ago): ai_investment_collapse, opaque_reasoning
- Turn 7 (4 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, research_breakthrough, openweight_frontier_release, embodied_ai_deployment, taiwan_tension_rise, us_china_agreement
- Turn 8 (3 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, export_control_escalation, joint_threat_response
- Turn 9 (2 turn(s) ago): labour_displacement, taiwan_tension_rise, automated_decision_scandal
- Turn 10 (1 turn(s) ago): research_breakthrough, loss_of_control_incident
