...
- characters 455-2353: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2397-4479: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6210-6675: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8882-10852: `{{previous_actions}}` from the actor's own response from the previous turn
