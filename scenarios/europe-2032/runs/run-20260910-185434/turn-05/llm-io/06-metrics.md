...
- characters 106-13504: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13547-13739: `{{metrics_json}}` from the run's live metric values
- characters 13832-15730: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15774-17856: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17912-19056: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | Municipal Grid and Port Continuity Top-Up | 2 |
...
## Metrics
```json
{"ai_capability": 67.0, "openweight_capability": 60.5, "ai_safety": 21.0, "resilience": 43.5, "eu_ai_sovereignty": 15.0, "eu_political_capital": 16.0, "public_sentiment": 24.0}
```
## Narrative
