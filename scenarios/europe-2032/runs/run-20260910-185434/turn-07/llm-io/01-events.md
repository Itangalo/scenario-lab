...
- characters 377-1194: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1238-3361: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3417-3890: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3953-31288: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31643-32079: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): bio_uplift_findings, openweight_frontier_release, emergent_lab_whistleblower_disclosure
- Turn 3 (4 turn(s) ago): eval_anomaly_reports
- Turn 4 (3 turn(s) ago): loss_of_control_incident, export_control_escalation
- Turn 5 (2 turn(s) ago): eval_anomaly_reports, adoption_success, election_consolidation
- Turn 6 (1 turn(s) ago): ai_investment_collapse, opaque_reasoning
