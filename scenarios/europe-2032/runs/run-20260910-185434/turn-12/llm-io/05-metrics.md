...
- characters 13075-13263: `{{metrics_json}}` from the run's live metric values
- characters 13356-14692: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14735-16799: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16855-17993: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Graduate Entry Guarantee and Public-Service Continuity Corps | 2 |
| M12 | EU Joint Cyber-Bio Shield Accession | 2 |
