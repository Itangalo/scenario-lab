...
- characters 373-1709: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1752-3816: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3872-4424: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4487-30997: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31352-32405: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M11 EU Graduate Entry Guarantee and Public-Service Continuity Corps −2, priority −1 not charged (capital below 20, priority has no effect) = −2
PROPOSAL BONUS: M11 (cat 7, small) +4 — graduate blockade wave and hiring freeze last three turns, answered directly with paid placements
LEGITIMACY LENDS: none — capital 7, sentiment 2, capital higher
SOVEREIGNTY: 13 last turn, no capacity event finish, no category 4 build in flight +0, us_labs_nationalised t11 / eu_frontier_access_denied t11 −3 (largest), capability rose 2.5 −1 = 9
...
- Turn 2 (10 turn(s) ago): bio_uplift_findings, openweight_frontier_release, emergent_lab_whistleblower_disclosure
- Turn 3 (9 turn(s) ago): eval_anomaly_reports
- Turn 4 (8 turn(s) ago): loss_of_control_incident, export_control_escalation
- Turn 5 (7 turn(s) ago): eval_anomaly_reports, adoption_success, election_consolidation
- Turn 6 (6 turn(s) ago): ai_investment_collapse, opaque_reasoning
- Turn 7 (5 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, research_breakthrough, openweight_frontier_release, embodied_ai_deployment, taiwan_tension_rise, us_china_agreement
- Turn 8 (4 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, export_control_escalation, joint_threat_response
- Turn 9 (3 turn(s) ago): labour_displacement, taiwan_tension_rise, automated_decision_scandal
- Turn 10 (2 turn(s) ago): research_breakthrough, loss_of_control_incident
- Turn 11 (1 turn(s) ago): labour_displacement, us_labs_nationalised, eu_frontier_access_denied, emergent_graduate_protest_wave
