...
- characters 1376-3202: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3258-4305: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4368-27445: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27800-27841: `{{event_history}}` from the run's own event record
