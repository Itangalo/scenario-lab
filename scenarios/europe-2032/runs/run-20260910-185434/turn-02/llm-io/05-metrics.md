...
- characters 105-13096: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13139-13331: `{{metrics_json}}` from the run's live metric values
- characters 13424-14381: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14424-16250: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16306-17022: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Frontier Incident Disclosure and Bio-Screening Order | 3 |
...
- `emergent_authorship_integrity_pact` -- first noted turn 1, listed in 2 turn(s) so far: Major EU research universities and publishers jointly mandate disclosure and watermark verification for AI-assisted papers after the Millennium Prize claim triggers authorship disputes.
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 51.0, "ai_safety": 30.0, "resilience": 36.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 26.0, "public_sentiment": 34.0}
```
...
## Notepad
PORTFOLIO CHARGE t2: Gigafactories −3, Tech sovereignty package −3, Grid Shield and Critical Systems Hardening −3, EU Frontier Incident Disclosure and Bio-Screening Order −3, priority −1 = −13
PROPOSAL BONUS: EU Frontier Incident Disclosure and Bio-Screening Order (cat 2, large) +4 — whistleblower disclosure and bio-uplift precursor this turn and this answers them directly
LEGITIMACY LENDS: capital 29, sentiment 38 -> +2
