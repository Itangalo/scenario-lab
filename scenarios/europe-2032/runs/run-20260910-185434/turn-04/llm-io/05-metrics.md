...
- characters 13799-15557: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15600-17522: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17578-18665: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Pre-Release Evaluation Access Mandate | 2 |
| M6 | EU Agent Containment and Continuity Protocol | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Incident Disclosure and Bio-Screening Order −3, EU Pre-Release Evaluation Access Mandate −2, priority −1 = −12
PROPOSAL BONUS: EU Pre-Release Evaluation Access Mandate (cat 1, small) +2 — eval anomaly reports this turn and this answers them directly
