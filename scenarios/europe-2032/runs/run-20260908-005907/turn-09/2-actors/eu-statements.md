...
- `two_year_commitment` (commitment): Sovereign control of AI systems essential to public survival

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Sovereign control of AI systems essential to public survival
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the commitment period directly changes the actor's obligation to maintain the prior statement, enabling a reasoned update based on evolved conditions.
