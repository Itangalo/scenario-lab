...
- `two_year_commitment` (commitment): We secure our own future by acting before the danger is certain

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: We secure our own future by acting before the danger is certain
