...
- `two_year_commitment` (commitment): Secure our own future by acting before the danger is certain

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure our own future by acting before the danger is certain
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The development directly ends the time-bound condition underlying the commitment, altering the cost and relevance of maintaining the statement.
