...
- characters 375-1962: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2005-4378: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4434-5108: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5171-31321: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31676-32755: `{{event_history}}` from the run's own event record
...
- Turn 2 (10 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, safety_breakthrough, export_control_escalation, emergent_clinical_model_pullback
- Turn 4 (8 turn(s) ago): eval_anomaly_reports, adoption_success
- Turn 5 (7 turn(s) ago): capability_jump, bio_uplift_findings, safety_breakthrough, election_consolidation
- Turn 6 (6 turn(s) ago): eval_anomaly_reports, rsi_onset, labour_displacement, emergent_hospital_toolkit_blowback, emergent_counterfeit_chip_influx
- Turn 7 (5 turn(s) ago): cyber_defence_breakthrough, capability_jump
- Turn 8 (4 turn(s) ago): eval_anomaly_reports, labour_displacement
- Turn 9 (3 turn(s) ago): bio_uplift_findings, us_labs_nationalised
- Turn 10 (2 turn(s) ago): loss_of_control_incident, bio_uplift_findings, openweight_frontier_release, eu_frontier_access_denied, emergent_site_protection_breakdown
- Turn 11 (1 turn(s) ago): eval_anomaly_reports, opaque_reasoning, medical_breakthrough, catastrophic_great_power_conflict, member_state_defection
