...
- characters 453-2040: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2083-4456: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5143-5604: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9478-11745: `{{previous_actions}}` from the actor's own response from the previous turn
