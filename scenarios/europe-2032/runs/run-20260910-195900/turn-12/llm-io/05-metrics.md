...
- characters 106-13724: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13767-13957: `{{metrics_json}}` from the run's live metric values
- characters 14050-15637: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15680-18053: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18109-19332: `{{notepad}}` from the Game Master's notepad, carried across turns
