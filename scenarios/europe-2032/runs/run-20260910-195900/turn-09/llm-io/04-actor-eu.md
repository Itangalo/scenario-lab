...
- characters 455-2363: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2407-4694: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6319-6805: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9879-11898: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Entry-Level Transition Pact | 7 | small | 8 | 10 | own jurisdiction | public_sentiment up, eu_political_capital up via defused protests; resilience up slightly via social absorption | 2 | running |
