...
- characters 13743-15651: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15695-17982: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18038-18472: `{{notepad}}` from the Game Master's notepad, carried across turns
