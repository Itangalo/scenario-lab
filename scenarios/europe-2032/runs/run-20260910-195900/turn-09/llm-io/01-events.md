...
- characters 377-2285: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2329-4616: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4672-5644: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5707-35254: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35609-36306: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M9 EU Swarm-Defence Patch Rollout −2, M10 EU Entry-Level Transition Pact −2, priority −1 = −5
PROPOSAL BONUS: EU Entry-Level Transition Pact (cat 7, small) +2 — labour_displacement fires this turn and graduate blockades halted works, this answers it directly
LEGITIMACY LENDS: capital 24, sentiment 28 -> +1
SOVEREIGNTY: 20 last turn, no capacity event, no category 4 finish in flight, capability rose 3.0 −1 = 19

## Emerging developments (tracked)

- `emergent_grid_connection_blockade` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated graduate-led protests escalate into blockades of data-centre grid-connection works in two member states, halting construction for weeks.
- `emergent_spares_provenance_scandal` -- first noted turn 7, listed in 2 turn(s) so far: Investigations trace diverted and counterfeit maintenance chips to a broker network reselling US-tiered export stock, forcing recalls across hospital and utility suppliers.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, taiwan_tension_rise
- Turn 2 (7 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, safety_breakthrough, export_control_escalation, emergent_clinical_model_pullback
- Turn 4 (5 turn(s) ago): eval_anomaly_reports, adoption_success
- Turn 5 (4 turn(s) ago): capability_jump, bio_uplift_findings, safety_breakthrough, election_consolidation
- Turn 6 (3 turn(s) ago): eval_anomaly_reports, rsi_onset, labour_displacement, emergent_hospital_toolkit_blowback, emergent_counterfeit_chip_influx
- Turn 7 (2 turn(s) ago): cyber_defence_breakthrough, capability_jump
- Turn 8 (1 turn(s) ago): eval_anomaly_reports, labour_displacement
