...
- characters 455-1448: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1492-3393: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5367-5849: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8177-10241: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Anomaly Triage Cell | 1 | small | 4 | 6 | own jurisdiction | ai_safety up slightly, resilience up slightly via precautionary holds | 2 | running |
