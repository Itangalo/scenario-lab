...
- characters 13762-14755: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14799-16700: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16756-17820: `{{notepad}}` from the Game Master's notepad, carried across turns
