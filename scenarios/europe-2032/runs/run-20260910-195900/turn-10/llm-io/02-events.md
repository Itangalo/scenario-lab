...
- characters 377-1772: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1815-4344: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4400-4942: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5005-33020: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33375-34140: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, taiwan_tension_rise
- Turn 2 (8 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, safety_breakthrough, export_control_escalation, emergent_clinical_model_pullback
- Turn 4 (6 turn(s) ago): eval_anomaly_reports, adoption_success
- Turn 5 (5 turn(s) ago): capability_jump, bio_uplift_findings, safety_breakthrough, election_consolidation
- Turn 6 (4 turn(s) ago): eval_anomaly_reports, rsi_onset, labour_displacement, emergent_hospital_toolkit_blowback, emergent_counterfeit_chip_influx
- Turn 7 (3 turn(s) ago): cyber_defence_breakthrough, capability_jump
- Turn 8 (2 turn(s) ago): eval_anomaly_reports, labour_displacement
- Turn 9 (1 turn(s) ago): bio_uplift_findings, us_labs_nationalised
