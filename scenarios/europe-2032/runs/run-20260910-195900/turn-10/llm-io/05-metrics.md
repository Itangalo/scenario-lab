...
- characters 106-13489: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13532-13724: `{{metrics_json}}` from the run's live metric values
- characters 13817-15212: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15255-17784: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17840-18382: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU-US State-to-State Continuity and Bio-Safety Accord | 2 |
| M12 | EU Essential Services Manual Continuity and Agent Containment Operation | 2 |
...
PORTFOLIO CHARGE t9: M10 EU Entry-Level Transition Pact −2, M11 EU-US State-to-State Continuity and Bio-Safety Accord −2, priority −1 = −5
PROPOSAL BONUS: EU-US State-to-State Continuity and Bio-Safety Accord (cat 8, small) +3 — us_labs_nationalised fires this turn removing company counterparty and bio precursor opens for 4 turns, this answers both directly
LEGITIMACY LENDS: capital 25, sentiment 28 -> +1
SOVEREIGNTY: 19 last turn, no capacity event finish, no category 4 in flight, us_labs_nationalised t9 −3, capability rose 2.5 −1 = 15
...
## Notepad
PORTFOLIO CHARGE t10: M11 EU-US State-to-State Continuity and Bio-Safety Accord −2, M12 EU Essential Services Manual Continuity and Agent Containment Operation −2, priority −1 = −5
PROPOSAL BONUS: EU Essential Services Manual Continuity and Agent Containment Operation (cat 6, small) +4 — eu_frontier_access_denied plus loss_of_control_incident plus walkout all fired this turn and this answers cascading directly
LEGITIMACY LENDS: capital 17, sentiment 20 -> +2
SOVEREIGNTY: 15 last turn, no category 4 finish, no category 4 in flight, eu_frontier_access_denied t10 −3, capability rose 1.5 −0 = 12
