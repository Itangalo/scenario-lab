...
- characters 105-13408: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13451-13643: `{{metrics_json}}` from the run's live metric values
- characters 13736-15436: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15479-17353: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17409-18386: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Entry-Level Transition Pact | 2 |
