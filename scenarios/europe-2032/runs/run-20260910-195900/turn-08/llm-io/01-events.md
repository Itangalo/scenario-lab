...
- characters 376-2076: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2119-3993: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4049-5026: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5089-34636: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34991-35620: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: M8 Municipal Utility Patch and Spares Authentication −2, M9 EU Swarm-Defence Patch Rollout −2, priority −1 = −5
PROPOSAL BONUS: EU Swarm-Defence Patch Rollout (cat 6, small) +2 — answers recent municipal ransomware wave and thin-target exposure directly
LEGITIMACY LENDS: capital 22, sentiment 30 -> +2
SOVEREIGNTY: 16 last turn, M1 InvestAI Gigafactories finishes t7 +5, no capacity event, capability rose 6.5 −1 = 20

## Emerging developments (tracked)

- `emergent_grid_connection_blockade` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated graduate-led protests escalate into blockades of data-centre grid-connection works in two member states, halting construction for weeks.
- `emergent_spares_provenance_scandal` -- first noted turn 7, listed in 1 turn(s) so far: Investigations trace diverted and counterfeit maintenance chips to a broker network reselling US-tiered export stock, forcing recalls across hospital and utility suppliers.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, taiwan_tension_rise
- Turn 2 (6 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, safety_breakthrough, export_control_escalation, emergent_clinical_model_pullback
- Turn 4 (4 turn(s) ago): eval_anomaly_reports, adoption_success
- Turn 5 (3 turn(s) ago): capability_jump, bio_uplift_findings, safety_breakthrough, election_consolidation
- Turn 6 (2 turn(s) ago): eval_anomaly_reports, rsi_onset, labour_displacement, emergent_hospital_toolkit_blowback, emergent_counterfeit_chip_influx
- Turn 7 (1 turn(s) ago): cyber_defence_breakthrough, capability_jump
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.3}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.04}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.06}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.03}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.025}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_great_power_conflict", "probability": 0.19}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "us_labs_nationalised", "probability": 0.22}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "Coordinated graduate-led protests escalate into blockades of data-centre grid-connection works in two member states, halting construction for weeks.", "emergent": true, "id": "emergent_grid_connection_blockade", "probability": 0.22}, {"description": "Investigations trace diverted and counterfeit maintenance chips to a broker network reselling US-tiered export stock, forcing recalls across hospital and utility suppliers.", "emergent": true, "id": "emergent_spares_provenance_scandal", "probability": 0.18}]
```
