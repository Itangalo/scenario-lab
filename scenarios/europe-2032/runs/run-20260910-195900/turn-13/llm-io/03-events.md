...
- characters 376-3002: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3046-5039: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5095-5982: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6045-32195: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32550-33701: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M13 EU Wartime Neutrality Protection and Medical Continuity Shield −2, priority M13 −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 13, sentiment 17 -> +2
SOVEREIGNTY: 9 last turn, no category 4 finish, no category 4 in flight, no capacity event, capability rose 3.5 −1 = 8

## Emerging developments (tracked)

- `emergent_neutral_infrastructure_strike` -- first noted turn 12, listed in 1 turn(s) so far: Belligerent targeting expands to nominally neutral European subsea and space ground infrastructure, forcing prolonged rerouting and public attribution debate.
- `emergent_repair_convoy_paralysis` -- first noted turn 12, listed in 1 turn(s) so far: Wartime targeting expands to subsea repair fleet and spares convoys, with insurers withdrawing cover for cable and grid restoration ships in the North Sea and Atlantic.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, taiwan_tension_rise
- Turn 2 (11 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, safety_breakthrough, export_control_escalation, emergent_clinical_model_pullback
- Turn 4 (9 turn(s) ago): eval_anomaly_reports, adoption_success
- Turn 5 (8 turn(s) ago): capability_jump, bio_uplift_findings, safety_breakthrough, election_consolidation
- Turn 6 (7 turn(s) ago): eval_anomaly_reports, rsi_onset, labour_displacement, emergent_hospital_toolkit_blowback, emergent_counterfeit_chip_influx
- Turn 7 (6 turn(s) ago): cyber_defence_breakthrough, capability_jump
- Turn 8 (5 turn(s) ago): eval_anomaly_reports, labour_displacement
- Turn 9 (4 turn(s) ago): bio_uplift_findings, us_labs_nationalised
- Turn 10 (3 turn(s) ago): loss_of_control_incident, bio_uplift_findings, openweight_frontier_release, eu_frontier_access_denied, emergent_site_protection_breakdown
- Turn 11 (2 turn(s) ago): eval_anomaly_reports, opaque_reasoning, medical_breakthrough, catastrophic_great_power_conflict, member_state_defection
- Turn 12 (1 turn(s) ago): capability_jump, openweight_frontier_release
