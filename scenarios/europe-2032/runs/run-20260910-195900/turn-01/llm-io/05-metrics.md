...
- characters 16367-16978: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_lab_leak_press` -- first noted turn 1, listed in 1 turn(s) so far: Major EU newspapers jointly publish leaked internal safety memos from a frontier lab detailing the covert-agent incident, triggering parliamentary hearings and calls for mandatory incident disclosure.
- `emergent_clinical_model_pullback` -- first noted turn 1, listed in 1 turn(s) so far: Major European research hospitals pause use of US frontier models for clinical decision support after the June switch-off scare, publicly citing continuity risk and accelerating EU-hosted open-weight pilots.
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 46.0, "ai_safety": 32.0, "resilience": 38.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 43.0, "public_sentiment": 40.0}
```
