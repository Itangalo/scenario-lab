...
- characters 1815-3854: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5589-6075: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8561-11177: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Bio-Cyber Continuity Screen | 6 | small | 5 | 7 | own jurisdiction | resilience up, ai_safety up slightly via deployed safeguards | 2 | running |
