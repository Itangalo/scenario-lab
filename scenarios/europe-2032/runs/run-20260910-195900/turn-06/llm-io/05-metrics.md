...
- characters 105-13619: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13662-13854: `{{metrics_json}}` from the run's live metric values
- characters 13947-15265: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15308-17347: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17403-17938: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Bio-Cyber Continuity Screen | 2 |
| M8 | Municipal Utility Patch and Spares Authentication | 2 |
...
PORTFOLIO CHARGE t5: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M6 EU Anomaly Triage Cell −2, M7 EU Bio-Cyber Continuity Screen −2, priority −1 = −11
PROPOSAL BONUS: EU Bio-Cyber Continuity Screen (cat 6, small) +3 — bio uplift findings opened bio gate this turn plus capability jump dropped safety while same open weights run hospitals and this answers it directly
LEGITIMACY LENDS: capital 19, sentiment 34 -> +2
SOVEREIGNTY: 15 last turn, no capacity event, Gigafactories in flight +0, capability rose 5.0 −1 = 14
...
**emergent_hospital_toolkit_blowback (emergent event):** A coordinated municipal utility ransomware wave traced to hospital-hosted open weights forces emergency EU patch-liability intervention.
**emergent_counterfeit_chip_influx (emergent event):** A grey market in diverted maintenance chips and counterfeit spares surges as rationing bites, with faulty components entering municipal utility and hospital supply chains undetected.
...
## Notepad
PORTFOLIO CHARGE t6: M1 InvestAI Gigafactories −3, M7 EU Bio-Cyber Continuity Screen −2, M8 Municipal Utility Patch and Spares Authentication −2, priority −1 = −8
PROPOSAL BONUS: Municipal Utility Patch and Spares Authentication (cat 6, small) +3 — ransomware blowback and counterfeit spares wave hit municipals/hospitals this turn and this answers it directly
LEGITIMACY LENDS: capital 18, sentiment 29 -> +2
SOVEREIGNTY: 14 last turn, Tech sovereignty package finishes t6 +5, Gigafactories in flight +0, emergent_counterfeit_chip_influx t6 −2, capability rose 7.0 −1 = 16
