...
- characters 377-1606: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1650-3936: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3992-4858: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4921-27779: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28134-28371: `{{event_history}}` from the run's own event record
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, taiwan_tension_rise
- Turn 2 (1 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, safety_breakthrough, export_control_escalation, emergent_clinical_model_pullback
