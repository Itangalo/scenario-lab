...
- characters 106-13105: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13148-13340: `{{metrics_json}}` from the run's live metric values
- characters 13433-14662: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14706-16992: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17048-17597: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Clinical Open-Model Safety Net | 2 |
...
## Notepad
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Systems Shield −3, M4 European Chip Continuity Compact −3, M5 EU Clinical Open-Model Safety Net −2, priority −1 = −15
PROPOSAL BONUS: EU Clinical Open-Model Safety Net (cat 6, small) +2 — hospitals shifting to improvised EU-hosted open pilots in last two turns and this answers it directly
