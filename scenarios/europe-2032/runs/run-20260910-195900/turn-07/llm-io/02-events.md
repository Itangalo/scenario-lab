...
- characters 1588-3567: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3623-4196: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4259-32760: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33115-33674: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, taiwan_tension_rise
- Turn 2 (5 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, safety_breakthrough, export_control_escalation, emergent_clinical_model_pullback
- Turn 4 (3 turn(s) ago): eval_anomaly_reports, adoption_success
- Turn 5 (2 turn(s) ago): capability_jump, bio_uplift_findings, safety_breakthrough, election_consolidation
- Turn 6 (1 turn(s) ago): eval_anomaly_reports, rsi_onset, labour_displacement, emergent_hospital_toolkit_blowback, emergent_counterfeit_chip_influx
