...
- characters 106-13530: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13573-13765: `{{metrics_json}}` from the run's live metric values
- characters 13858-15025: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15069-17048: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17104-18215: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | EU Swarm-Defence Patch Rollout | 2 |
...
## Metrics
```json
{"ai_capability": 83.0, "openweight_capability": 71.0, "ai_safety": 20.5, "resilience": 47.5, "eu_ai_sovereignty": 20.0, "eu_political_capital": 24.0, "public_sentiment": 30.0}
```
