...
- characters 1584-3926: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3982-4580: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4643-32658: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33013-33944: `{{event_history}}` from the run's own event record
...
- Turn 2 (9 turn(s) ago): taiwan_blockade, eval_anomaly_reports, openweight_frontier_release, safety_breakthrough, export_control_escalation, emergent_clinical_model_pullback
- Turn 4 (7 turn(s) ago): eval_anomaly_reports, adoption_success
- Turn 5 (6 turn(s) ago): capability_jump, bio_uplift_findings, safety_breakthrough, election_consolidation
- Turn 6 (5 turn(s) ago): eval_anomaly_reports, rsi_onset, labour_displacement, emergent_hospital_toolkit_blowback, emergent_counterfeit_chip_influx
- Turn 7 (4 turn(s) ago): cyber_defence_breakthrough, capability_jump
- Turn 8 (3 turn(s) ago): eval_anomaly_reports, labour_displacement
- Turn 9 (2 turn(s) ago): bio_uplift_findings, us_labs_nationalised
- Turn 10 (1 turn(s) ago): loss_of_control_incident, bio_uplift_findings, openweight_frontier_release, eu_frontier_access_denied, emergent_site_protection_breakdown
