...
- characters 1470-3269: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3325-4571: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4634-27711: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28066-28128: `{{event_history}}` from the run's own event record
