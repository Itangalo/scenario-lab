...
| M9 | EU Critical Services Cyber Recovery and Hardening Operation | 6 | small | 7 | 9 | own jurisdiction | resilience up moderately, ai_safety protected | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Critical Services Cyber Recovery and Hardening Operation", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected"}, "grounds": "to absorb the major automated cyber incident and keep essential services running"}
  - Grounds: to absorb the major automated cyber incident and keep essential services running
