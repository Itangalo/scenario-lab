...
| M9 | EU Critical Services Cyber Recovery and Hardening Operation | 6 | small | 7 | 8 | own jurisdiction | resilience up moderately, ai_safety protected | 2 | finished |
| M10 | EU Hospital and Grid Continuity Shield | 6 | small | 8 | 10 | own jurisdiction | resilience up, public_sentiment up modestly, eu_political_capital protected | 2 | running |
| M11 | EU AI Displacement Safety Net and Retraining Guarantee | 7 | small | 9 | 12 | own jurisdiction | resilience up modestly, public_sentiment up, eu_political_capital protected | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU AI Displacement Safety Net and Retraining Guarantee", "category": 7, "size": "small", "finish_turn": 12, "applies_to": "own jurisdiction", "targeted_effect": "resilience up modestly, public_sentiment up, eu_political_capital protected"}, "grounds": "to answer labour displacement and embodied deployment before backlash hardens"}
  - Grounds: to answer labour displacement and embodied deployment before backlash hardens
