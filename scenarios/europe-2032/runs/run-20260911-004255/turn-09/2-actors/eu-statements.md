...
- `two_year_commitment` (commitment): Keep essential services running and livelihoods standing through AI disruption

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Keep essential services running and livelihoods standing through AI disruption
