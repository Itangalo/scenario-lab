...
- characters 107-13097: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13140-13330: `{{metrics_json}}` from the run's live metric values
- characters 13423-14618: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14662-16664: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16720-17514: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Distressed-Site Transition Works and Vetted Aid Corps | 2 |
| M14 | EU Breakthrough Shield and Cures Deployment | 2 |
| M15 | EU-US State-to-State AI Access and Restraint Pact | 2 |
...
- `emergent_shadow_aid_scandal` -- first noted turn 13, listed in 1 turn(s) so far: Municipal clinic staff leak prompt-workarounds for the new signed triage aids to national press, triggering a cross-border investigation into unlicensed medical AI use.
...
## Notepad
PORTFOLIO CHARGE t13: M13 EU Distressed-Site Transition Works and Vetted Aid Corps −2, M14 EU Breakthrough Shield and Cures Deployment −2, M15 EU-US State-to-State AI Access and Restraint Pact −2, priority −1 = −7
PROPOSAL BONUS: EU-US State-to-State AI Access and Restraint Pact (cat 8, small) +3 — us_labs_nationalised landed this turn and this answers it directly as state counterparty
LEGITIMACY LENDS: capital 20, sentiment 16 -> none, capital higher
SOVEREIGNTY: 9 last turn, no capacity event, no cat4 in flight +0, us_labs_nationalised t13 −3, capability rose 2.0 −1 = 5
