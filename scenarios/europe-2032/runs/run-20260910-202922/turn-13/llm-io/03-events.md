...
- characters 1615-3617: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3673-4177: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4240-30124: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30479-31560: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M13 EU Distressed-Site Transition Works and Vetted Aid Corps −2, M14 EU Breakthrough Shield and Cures Deployment −2, priority −1 = −5
PROPOSAL BONUS: EU Breakthrough Shield and Cures Deployment (cat 6, small) +3 — capability_jump landed this turn and bio_uplift_findings opened 4-turn gate and this answers both directly
LEGITIMACY LENDS: capital 30, sentiment 20 -> none, capital higher
SOVEREIGNTY: 10 last turn, no capacity event, no cat4 in flight +0, capability rose 3.0 −1 = 9
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, safety_breakthrough, taiwan_tension_rise, automated_decision_scandal, emergent_bioscreening_norm_shift
- Turn 2 (11 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, safety_breakthrough, automated_decision_scandal
- Turn 4 (9 turn(s) ago): capability_jump, eval_anomaly_reports, embodied_ai_deployment
- Turn 5 (8 turn(s) ago): rsi_onset, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning, medical_breakthrough, embodied_ai_deployment, election_retrenchment
- Turn 6 (7 turn(s) ago): loss_of_control_incident, catastrophic_bio_incident
- Turn 7 (6 turn(s) ago): medical_breakthrough
- Turn 8 (5 turn(s) ago): cyber_major_incident, bio_incident, medical_breakthrough, embodied_ai_deployment
- Turn 9 (4 turn(s) ago): labour_displacement, us_china_agreement, adoption_success, knowledge_work_augmented
- Turn 10 (3 turn(s) ago): supply_chain_coercion
- Turn 11 (2 turn(s) ago): ai_investment_collapse
- Turn 12 (1 turn(s) ago): capability_jump, cyber_defence_breakthrough, bio_uplift_findings, medical_breakthrough
