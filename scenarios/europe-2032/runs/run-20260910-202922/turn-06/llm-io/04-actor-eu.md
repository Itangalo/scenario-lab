...
- characters 1850-4309: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5331-5796: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8358-11069: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Embodied-AI Site Rules and Manual Fallback | 6 | small | 4 | 7 | own jurisdiction | resilience up moderately, eu_ai_sovereignty up slightly via procurement preference | 2 | running |
