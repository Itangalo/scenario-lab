...
- characters 376-1729: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1772-4231: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4287-5520: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5583-33019: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33374-33898: `{{event_history}}` from the run's own event record
...
- `emergent_infrastructure_blockade` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated physical protests block construction access at two Gigafactory and data-centre sites for weeks, forcing a permitting pause and national debate on energy and water costs.
- `emergent_grid_connection_revolt` -- first noted turn 4, listed in 2 turn(s) so far: Municipal utilities publish joint open letter refusing to connect new AI data centres to strained local grids until backup-power and staffing guarantees are funded, stalling gigafactory site selection.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, safety_breakthrough, taiwan_tension_rise, automated_decision_scandal, emergent_bioscreening_norm_shift
- Turn 2 (4 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, safety_breakthrough, automated_decision_scandal
- Turn 4 (2 turn(s) ago): capability_jump, eval_anomaly_reports, embodied_ai_deployment
- Turn 5 (1 turn(s) ago): rsi_onset, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning, medical_breakthrough, embodied_ai_deployment, election_retrenchment
