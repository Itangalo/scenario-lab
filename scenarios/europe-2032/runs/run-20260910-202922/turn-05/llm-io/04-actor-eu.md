...
- characters 1876-4263: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8384-8835: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11185-13512: `{{previous_actions}}` from the actor's own response from the previous turn
