...
- characters 377-1754: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1798-4185: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4241-5418: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5481-34457: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34812-35170: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Municipal Continuity Reserve −2, EU Embodied-AI Site Rules and Manual Fallback −2, priority −1 = −11
PROPOSAL BONUS: EU Embodied-AI Site Rules and Manual Fallback (cat 6, small) +3 — embodied_ai_deployment landed this turn plus capability_jump and eval_anomaly_reports and this answers site containment directly
LEGITIMACY LENDS: capital 22, sentiment 24 -> +1
SOVEREIGNTY: 19 last turn, no capacity build finishes, Gigafactories in flight +0, embodied_ai_deployment t4 −2, capability rose 5.0 −1 = 16

## Emerging developments (tracked)

- `emergent_infrastructure_blockade` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated physical protests block construction access at two Gigafactory and data-centre sites for weeks, forcing a permitting pause and national debate on energy and water costs.
- `emergent_grid_connection_revolt` -- first noted turn 4, listed in 1 turn(s) so far: Municipal utilities publish joint open letter refusing to connect new AI data centres to strained local grids until backup-power and staffing guarantees are funded, stalling gigafactory site selection.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, safety_breakthrough, taiwan_tension_rise, automated_decision_scandal, emergent_bioscreening_norm_shift
- Turn 2 (3 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, safety_breakthrough, automated_decision_scandal
- Turn 4 (1 turn(s) ago): capability_jump, eval_anomaly_reports, embodied_ai_deployment
