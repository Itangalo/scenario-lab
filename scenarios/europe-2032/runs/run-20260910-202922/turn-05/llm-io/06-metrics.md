...
- characters 106-13142: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13185-13377: `{{metrics_json}}` from the run's live metric values
- characters 13470-14847: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14891-17278: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17334-18511: `{{notepad}}` from the Game Master's notepad, carried across turns
