...
- characters 105-13470: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13513-13705: `{{metrics_json}}` from the run's live metric values
- characters 13798-15915: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15958-18287: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18343-19462: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Municipal Continuity Reserve | 2 |
| M6 | EU Embodied-AI Site Rules and Manual Fallback | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Defender Interpretability Deployment −2, EU Municipal Continuity Reserve −2, priority −1 = −11
PROPOSAL BONUS: EU Municipal Continuity Reserve (cat 6, small) +3 — autumn pre-positioning intrusions in grids/ports/water plus municipal gap landed in last two turns and this answers them directly
