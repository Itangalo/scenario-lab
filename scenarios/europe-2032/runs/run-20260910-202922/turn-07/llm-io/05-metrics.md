...
- characters 106-13685: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13728-13920: `{{metrics_json}}` from the run's live metric values
- characters 14013-15384: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15428-17679: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17735-18953: `{{notepad}}` from the Game Master's notepad, carried across turns
