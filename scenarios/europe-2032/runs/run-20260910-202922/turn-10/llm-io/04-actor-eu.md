...
- characters 2017-4145: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4715-5181: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8572-11349: `{{previous_actions}}` from the actor's own response from the previous turn
