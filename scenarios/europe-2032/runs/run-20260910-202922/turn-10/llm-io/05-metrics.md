...
- characters 106-13466: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13509-13700: `{{metrics_json}}` from the run's live metric values
- characters 13793-15313: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15356-17484: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17540-18383: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU AI Livelihood and Entry-Work Transition Guarantee | 2 |
| M12 | EU ASML Anti-Coercion Shield and Chokepoint Bargain | 2 |
...
PORTFOLIO CHARGE t9: EU Cyber-Bio-Physical Shield for Hospitals, Utilities and Borders −2, EU AI Livelihood and Entry-Work Transition Guarantee −2, priority −1 = −5
PROPOSAL BONUS: EU AI Livelihood and Entry-Work Transition Guarantee (cat 7, small) +4 — labour_displacement landed this turn with graduate hiring collapse and this answers it directly
...
- `emergent_shadow_care_network` -- first noted turn 10, listed in 1 turn(s) so far: Municipal clinics and pharmacies begin openly pooling black-market triage prompts and unvetted foreign diagnostic models into a shared informal library, creating a parallel care standard outside EU oversight.
...
## Notepad
PORTFOLIO CHARGE t10: EU AI Livelihood and Entry-Work Transition Guarantee −2, EU ASML Anti-Coercion Shield and Chokepoint Bargain −2, priority −1 = −5
PROPOSAL BONUS: EU ASML Anti-Coercion Shield and Chokepoint Bargain (cat 8, small) +3 — supply_chain_coercion landed this turn and this answers it directly
LEGITIMACY LENDS: capital 32, sentiment 11 -> none, capital higher
SOVEREIGNTY: 17 last turn, no capacity event, no cat4 in flight +0, supply_chain_coercion t10 −3, capability rose 2.0 −1 = 13
