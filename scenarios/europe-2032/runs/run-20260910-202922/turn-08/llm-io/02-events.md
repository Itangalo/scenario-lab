...
- characters 376-2097: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2140-4281: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4337-5518: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5581-33331: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33686-34335: `{{event_history}}` from the run's own event record
...
- `emergent_shadow_triage_models` -- first noted turn 7, listed in 1 turn(s) so far: Black-market triage models trained on leaked hospital data spread across EU clinics, offering unvetted treatment rankings outside any regulatory oversight.
- `emergent_shadow_health_ai` -- first noted turn 7, listed in 1 turn(s) so far: Desperate hospitals and municipalities procure black-market triage and diagnostic models run on local open-weight infrastructure, creating a permanent unregulated care layer outside EU oversight.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, safety_breakthrough, taiwan_tension_rise, automated_decision_scandal, emergent_bioscreening_norm_shift
- Turn 2 (6 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, safety_breakthrough, automated_decision_scandal
- Turn 4 (4 turn(s) ago): capability_jump, eval_anomaly_reports, embodied_ai_deployment
- Turn 5 (3 turn(s) ago): rsi_onset, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning, medical_breakthrough, embodied_ai_deployment, election_retrenchment
- Turn 6 (2 turn(s) ago): loss_of_control_incident, catastrophic_bio_incident
- Turn 7 (1 turn(s) ago): medical_breakthrough
