...
- characters 105-13700: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13743-13935: `{{metrics_json}}` from the run's live metric values
- characters 14028-15749: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15792-17933: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17989-19170: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Trusted Therapies Deployment and Manufacturing Repatriation | 2 |
| M10 | EU Cyber-Bio-Physical Shield for Hospitals, Utilities and Borders | 2 |
...
## Metrics
```json
{"ai_capability": 80.0, "openweight_capability": 74.5, "ai_safety": 9.0, "resilience": 53.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 32.0, "public_sentiment": 12.0}
```
