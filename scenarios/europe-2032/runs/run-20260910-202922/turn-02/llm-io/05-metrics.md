...
- characters 13410-14874: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14917-17239: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17295-18102: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_bioscreening_push` -- first noted turn 1, listed in 2 turn(s) so far: A major European scientific academy and several national research funders jointly call for mandatory screening of AI-designed DNA synthesis, triggering a public split with industry over voluntary regimes.
