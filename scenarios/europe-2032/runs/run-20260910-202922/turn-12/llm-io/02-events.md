...
- characters 1593-3956: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4012-4975: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5038-30922: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31277-32244: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, safety_breakthrough, taiwan_tension_rise, automated_decision_scandal, emergent_bioscreening_norm_shift
- Turn 2 (10 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, safety_breakthrough, automated_decision_scandal
- Turn 4 (8 turn(s) ago): capability_jump, eval_anomaly_reports, embodied_ai_deployment
- Turn 5 (7 turn(s) ago): rsi_onset, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning, medical_breakthrough, embodied_ai_deployment, election_retrenchment
- Turn 6 (6 turn(s) ago): loss_of_control_incident, catastrophic_bio_incident
- Turn 7 (5 turn(s) ago): medical_breakthrough
- Turn 8 (4 turn(s) ago): cyber_major_incident, bio_incident, medical_breakthrough, embodied_ai_deployment
- Turn 9 (3 turn(s) ago): labour_displacement, us_china_agreement, adoption_success, knowledge_work_augmented
- Turn 10 (2 turn(s) ago): supply_chain_coercion
- Turn 11 (1 turn(s) ago): ai_investment_collapse
