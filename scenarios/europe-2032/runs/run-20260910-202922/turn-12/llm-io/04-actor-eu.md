...
- characters 454-1628: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1671-4034: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5536-6002: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9795-12198: `{{previous_actions}}` from the actor's own response from the previous turn
