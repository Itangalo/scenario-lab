...
- characters 106-13652: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13695-13886: `{{metrics_json}}` from the run's live metric values
- characters 13979-15153: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15196-17559: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17615-18247: `{{notepad}}` from the Game Master's notepad, carried across turns
