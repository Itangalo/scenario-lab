...
- characters 13518-13709: `{{metrics_json}}` from the run's live metric values
- characters 13802-15083: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15127-16997: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17053-17605: `{{notepad}}` from the Game Master's notepad, carried across turns
