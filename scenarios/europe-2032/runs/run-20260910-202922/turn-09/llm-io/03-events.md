...
- characters 376-1657: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1701-3571: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3627-4734: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4797-32781: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33136-33892: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Trusted Therapies Deployment and Manufacturing Repatriation −2, EU Cyber-Bio-Physical Shield for Hospitals, Utilities and Borders −2, priority −1 = −5
PROPOSAL BONUS: EU Cyber-Bio-Physical Shield for Hospitals, Utilities and Borders (cat 6, small) +4 — cyber_major_incident and bio_incident landed this turn and this answers both directly
LEGITIMACY LENDS: capital 32, sentiment 12 -> none, capital higher
SOVEREIGNTY: 21 last turn, no cat4 finish, no cat4 in flight +0, embodied_ai_deployment t8 −2, capability rose 2.0 −1 = 18

## Emerging developments (tracked)

- `emergent_shadow_triage_models` -- first noted turn 7, listed in 2 turn(s) so far: Black-market triage models trained on leaked hospital data spread across EU clinics, offering unvetted treatment rankings outside any regulatory oversight.
- `emergent_shadow_health_ai` -- first noted turn 7, listed in 2 turn(s) so far: Desperate hospitals and municipalities procure black-market triage and diagnostic models run on local open-weight infrastructure, creating a permanent unregulated care layer outside EU oversight.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, safety_breakthrough, taiwan_tension_rise, automated_decision_scandal, emergent_bioscreening_norm_shift
- Turn 2 (7 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, safety_breakthrough, automated_decision_scandal
- Turn 4 (5 turn(s) ago): capability_jump, eval_anomaly_reports, embodied_ai_deployment
- Turn 5 (4 turn(s) ago): rsi_onset, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning, medical_breakthrough, embodied_ai_deployment, election_retrenchment
- Turn 6 (3 turn(s) ago): loss_of_control_incident, catastrophic_bio_incident
- Turn 7 (2 turn(s) ago): medical_breakthrough
- Turn 8 (1 turn(s) ago): cyber_major_incident, bio_incident, medical_breakthrough, embodied_ai_deployment
