...
- characters 1779-3649: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5505-5970: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9161-11601: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Cyber-Bio-Physical Shield for Hospitals, Utilities and Borders | 6 | small | 8 | 10 | own jurisdiction | resilience up substantially, ai_safety up slightly via incident containment | 2 | running |
