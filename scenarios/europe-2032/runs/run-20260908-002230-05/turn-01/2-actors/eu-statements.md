...
- `two_year_commitment` (commitment): Build sovereign AI capacity to secure strategic autonomy

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Build sovereign AI capacity to secure strategic autonomy
- **modify** `act_under_uncertainty` — rejected-structural
  - Tier: commitment
  - Text: We will commit before the picture is clear, and accept being wrong sometimes as the price of not being late — but we now act with increasing awareness that delay risks irreversible dependence.
