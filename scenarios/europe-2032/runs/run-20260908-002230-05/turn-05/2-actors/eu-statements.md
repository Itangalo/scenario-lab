...
- `two_year_commitment` (commitment): Sovereign AI capacity as a foundation for strategic autonomy and crisis resilience

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Sovereign AI capacity as a foundation for strategic autonomy and crisis resilience
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The commitment's time-bound nature ending directly affects the actor's rationale for updating the statement to reflect ongoing strategic priorities.
