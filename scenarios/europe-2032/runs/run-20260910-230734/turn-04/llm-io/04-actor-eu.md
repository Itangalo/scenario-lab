...
- characters 454-1367: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1410-3603: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5094-5534: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7464-8622: `{{previous_actions}}` from the actor's own response from the previous turn
