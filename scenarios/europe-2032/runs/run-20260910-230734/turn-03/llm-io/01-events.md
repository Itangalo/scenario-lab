...
- characters 377-1457: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1501-3733: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3789-4301: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4364-27646: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28001-28116: `{{event_history}}` from the run's own event record
