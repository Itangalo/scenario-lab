...
- characters 13382-14462: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14506-16738: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16794-17618: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_shipping_insurance_shock` -- first noted turn 3, listed in 1 turn(s) so far: Major European insurers jointly raise war-risk surcharges on Taiwan Strait chip shipments to a level that triggers EU-level contingency stockpiling talks, without any physical blockade.
...
## Metrics
```json
{"ai_capability": 56.5, "openweight_capability": 49.5, "ai_safety": 28.0, "resilience": 36.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 24.0, "public_sentiment": 37.0}
```
