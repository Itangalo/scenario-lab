...
- characters 1509-3691: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5564-6004: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8174-10225: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | Allied Chip Assurance and Stockpile Pact | 8 | small | 4 | 7 | coalition (US, Japan, Korea) plus own jurisdiction importers | eu_ai_sovereignty up modestly, resilience up modestly; eu_political_capital cost contained | 2 | running |
