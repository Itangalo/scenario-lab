...
- `two_year_commitment` (commitment): Hold autonomy through allied leverage and hardened resilience while frontier access is rationed

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold autonomy through allied leverage and hardened resilience while frontier access is rationed
