...
- characters 376-1607: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1650-4240: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4296-4756: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4819-28101: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28456-28497: `{{event_history}}` from the run's own event record
