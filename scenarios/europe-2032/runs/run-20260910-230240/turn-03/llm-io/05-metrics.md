...
- characters 106-13057: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13100-13292: `{{metrics_json}}` from the run's live metric values
- characters 13385-14576: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14620-16794: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16850-17676: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Continuity Switch | 2 |
| M5 | European Results Showcase | 2 |
...
- `emergent_siting_backlash_delay` -- first noted turn 2, listed in 2 turn(s) so far: Coordinated local opposition to gigafactory siting escalates, with municipal councils and grid operators delaying power connections over prices and land use, stalling site selection through mid-2027.
