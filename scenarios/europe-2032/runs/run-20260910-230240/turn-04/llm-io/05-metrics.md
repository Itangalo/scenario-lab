...
- characters 13729-15306: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15349-17389: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17445-17912: `{{notepad}}` from the Game Master's notepad, carried across turns
