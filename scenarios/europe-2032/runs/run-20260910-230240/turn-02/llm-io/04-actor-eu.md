...
- characters 4828-5300: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6772-8899: `{{previous_actions}}` from the actor's own response from the previous turn
