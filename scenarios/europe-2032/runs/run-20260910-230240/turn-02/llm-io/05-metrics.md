...
- characters 13345-14482: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14525-16554: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16610-17371: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_siting_backlash_delay` -- first noted turn 2, listed in 1 turn(s) so far: Coordinated local opposition to gigafactory siting escalates, with municipal councils and grid operators delaying power connections over prices and land use, stalling site selection through mid-2027.
