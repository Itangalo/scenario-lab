...
- `two_year_commitment` (commitment): Build controllable European AI capacity and societal resilience that holds under opaque frontier models

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Build controllable European AI capacity and societal resilience that holds under opaque frontier models
