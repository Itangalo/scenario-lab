...
- characters 455-2140: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2184-4441: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6565-7037: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9176-10378: `{{previous_actions}}` from the actor's own response from the previous turn
