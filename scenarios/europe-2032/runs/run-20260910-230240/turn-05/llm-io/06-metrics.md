...
- characters 106-13372: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13415-13607: `{{metrics_json}}` from the run's live metric values
- characters 13700-15385: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15429-17686: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17742-18542: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|---|---|---|---|---|---|---|
| M4 | EU Continuity Switch | 5 | small | 2 | 5 | own jurisdiction | eu_ai_sovereignty up modestly, ai_safety up via certified deployment, resilience up | 2 | finished |
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, European Results Showcase −2, priority −1 = −8 + 1 more for the priority = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 14, sentiment 39 -> +2
SOVEREIGNTY: 19 last turn, no capacity event? export_control_escalation t5 −2, Gigafactories in flight +0, capability rose 0.8 −0 = 17
