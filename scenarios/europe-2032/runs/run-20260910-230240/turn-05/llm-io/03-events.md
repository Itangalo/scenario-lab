...
- characters 377-2062: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2106-4363: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4419-4808: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4871-31762: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32117-32403: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): openweight_frontier_release, safety_breakthrough, eu_frontier_access_denied
- Turn 3 (2 turn(s) ago): adoption_success
- Turn 4 (1 turn(s) ago): capability_jump, knowledge_work_augmented, emergent_siting_backlash_delay
