...
- `two_year_commitment` (commitment): Keep essential services running and capture medical benefits under EU control despite foreign AI dependence

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Keep essential services running and capture medical benefits under EU control despite foreign AI dependence
