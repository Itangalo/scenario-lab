...
- characters 1701-3832: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6250-6722: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9075-11115: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Bio Detection and Medical Countermeasure Surge | 6 | small | 4 | 7 | own jurisdiction | resilience up moderately, ai_safety up slightly via early warning | 2 | running |
