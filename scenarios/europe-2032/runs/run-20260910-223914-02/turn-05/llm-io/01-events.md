...
- characters 377-1579: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1623-3754: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3810-5005: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5068-34044: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34399-34761: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Evaluation and Incident Clearinghouse −2, EU Displaced-Worker and Claimant Safety Net −2, EU Bio Detection and Medical Countermeasure Surge −2, priority −1 = −13
PROPOSAL BONUS: EU Bio Detection and Medical Countermeasure Surge (cat 6, small) +3 — bio_uplift_findings precursor opened 4-turn gate this turn plus capability jump with open weights at 54, answers directly
LEGITIMACY LENDS: capital 12, sentiment 27 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, Gigafactories in flight +0, capability rose 6.0 −1 = 18

## Emerging developments (tracked)

- `emergent_siting_blockade` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated local blockades halt construction and grid connection work at one of the two secured gigafactory sites for weeks amid drought rationing and data-centre opposition.
- `emergent_siting_freeze_wave` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated municipal moratoriums on new data-centre grid connections spread across drought-hit regions, with councils citing power rationing and water use, freezing two further AI factory candidate sites for the turn.
...
- Turn 2 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, safety_breakthrough, automated_decision_scandal
- Turn 3 (2 turn(s) ago): openweight_frontier_release, emergent_ot_insurance_pullback, emergent_foundry_supply_squeeze
- Turn 4 (1 turn(s) ago): capability_jump, bio_uplift_findings, safety_breakthrough
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.095}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.4}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.22}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.33}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.13}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.03}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "rsi_onset", "probability": 0.35}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Coordinated local blockades halt construction and grid connection work at one of the two secured gigafactory sites for weeks amid drought rationing and data-centre opposition.", "emergent": true, "id": "emergent_siting_blockade", "probability": 0.28}, {"description": "Coordinated municipal moratoriums on new data-centre grid connections spread across drought-hit regions, with councils citing power rationing and water use, freezing two further AI factory candidate sites for the turn.", "emergent": true, "id": "emergent_siting_freeze_wave", "probability": 0.3}]
```
