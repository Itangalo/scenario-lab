...
- characters 105-13634: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13677-13869: `{{metrics_json}}` from the run's live metric values
- characters 13962-15387: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15430-17599: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17655-18781: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Evaluation and Incident Clearinghouse | 2 |
| M5 | EU Displaced-Worker and Claimant Safety Net | 2 |
| M6 | EU Bio Detection and Medical Countermeasure Surge | 2 |
...
## Metrics
```json
{"ai_capability": 67.0, "openweight_capability": 58.0, "ai_safety": 33.0, "resilience": 39.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 15.0, "public_sentiment": 27.0}
```
