...
- characters 376-1801: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1844-4013: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4069-4600: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4663-31607: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31962-32240: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, safety_breakthrough, automated_decision_scandal
- Turn 3 (1 turn(s) ago): openweight_frontier_release, emergent_ot_insurance_pullback, emergent_foundry_supply_squeeze
