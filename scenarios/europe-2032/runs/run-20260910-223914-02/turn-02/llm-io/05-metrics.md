...
- characters 105-13169: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13212-13404: `{{metrics_json}}` from the run's live metric values
- characters 13497-14826: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14869-17346: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17402-18487: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 50.5, "ai_safety": 37.0, "resilience": 36.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 27.0, "public_sentiment": 30.0}
```
