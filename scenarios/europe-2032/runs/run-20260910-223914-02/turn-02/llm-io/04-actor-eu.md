...
- characters 7017-7489: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8961-11088: `{{previous_actions}}` from the actor's own response from the previous turn
