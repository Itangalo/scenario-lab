...
- characters 106-13227: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13270-13462: `{{metrics_json}}` from the run's live metric values
- characters 13555-15091: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15135-17331: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17387-17873: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, EU Evaluation and Incident Clearinghouse −2, priority −1 = −12
PROPOSAL BONUS: EU Evaluation and Incident Clearinghouse (cat 5, small) +3 — cyber_major_incident this turn plus autumn pre-positioning last turn, answers directly
LEGITIMACY LENDS: capital 25, sentiment 30 -> +2
