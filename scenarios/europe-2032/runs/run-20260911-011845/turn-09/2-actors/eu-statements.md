...
- `two_year_commitment` (commitment): Rebuild sovereign leverage so coercion cannot decide our future

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild sovereign leverage so coercion cannot decide our future
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The commitment's end directly changes the actor's obligation to uphold the prior statement, triggering a reassessment of strategic posture.
