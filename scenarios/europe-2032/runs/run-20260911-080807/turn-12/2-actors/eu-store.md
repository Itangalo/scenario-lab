...
| M14 | EU Sites and Services Protection Surge | 6 | small | 12 | 14 | own jurisdiction | resilience up, ai_safety up slightly via adopted controls, public_sentiment stabilised | 2 | running |
...
- **applied** `M14` — {"op": "add", "table": "measures", "fields": {"name": "EU Sites and Services Protection Surge", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly via adopted controls, public_sentiment stabilised"}, "grounds": "to answer sabotage wave, bio uplift precursor and collapsing trust"}
  - Grounds: to answer sabotage wave, bio uplift precursor and collapsing trust
