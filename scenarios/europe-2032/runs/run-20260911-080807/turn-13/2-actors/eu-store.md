...
| M13 | EU Displaced Entry-Level Transition Guarantee | 7 | small | 11 | 14 | own jurisdiction | public_sentiment up, eu_political_capital protected, resilience up slightly via social absorption | 2 | running |
| M14 | EU Sites and Services Protection Surge | 6 | small | 12 | 13 | own jurisdiction | resilience up, ai_safety up slightly via adopted controls, public_sentiment stabilised | 2 | finished |
| M15 | EU Trusted Public Benefit Deployment | 9 | small | 13 | 15 | own jurisdiction | public_sentiment up sharply, eu_political_capital up, resilience up slightly via trusted adoption | 2 | running |
...
- **applied** `M15` — {"op": "add", "table": "measures", "fields": {"name": "EU Trusted Public Benefit Deployment", "category": 9, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up sharply, eu_political_capital up, resilience up slightly via trusted adoption"}, "grounds": "to convert medical and adoption wins into trust while answering scandal"}
  - Grounds: to convert medical and adoption wins into trust while answering scandal
