...
| M9 | EU Hospital and Municipal Continuity Reinforcement | 6 | small | 8 | 10 | own jurisdiction | resilience up to stop cascade, ai_safety loss contained | 2 | running |
| M10 | EU Defensive Shield Scale-Up | 6 | small | 9 | 11 | own jurisdiction | resilience up substantially, ai_safety loss contained | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Defensive Shield Scale-Up", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up substantially, ai_safety loss contained"}, "grounds": "defensive breakthrough must be diffused before next cascade season"}
  - Grounds: defensive breakthrough must be diffused before next cascade season
