...
- characters 455-1600: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1644-3843: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6123-6595: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8716-10711: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU Bio-Shield and Blockade Continuity Regime | 6 | large | 4 | 6 | own jurisdiction | resilience up substantially, ai_safety up modestly via incident response | 3 | running |
