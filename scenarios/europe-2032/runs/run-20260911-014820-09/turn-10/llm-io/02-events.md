...
- characters 1609-3645: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3701-4132: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4195-31640: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31995-32750: `{{event_history}}` from the run's own event record
...
- Turn 7 (3 turn(s) ago): bio_uplift_findings, embodied_ai_deployment, member_state_defection
- Turn 8 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident
- Turn 9 (1 turn(s) ago): cyber_major_incident, knowledge_work_augmented, eu_frontier_access_denied
