...
- characters 1687-3723: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5331-5808: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9155-11524: `{{previous_actions}}` from the actor's own response from the previous turn
