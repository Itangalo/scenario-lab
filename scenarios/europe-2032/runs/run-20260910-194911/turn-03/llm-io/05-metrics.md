...
- characters 13443-14411: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14455-16092: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16148-16623: `{{notepad}}` from the Game Master's notepad, carried across turns
