...
- characters 106-13528: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13571-13762: `{{metrics_json}}` from the run's live metric values
- characters 13855-15668: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15712-17477: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17533-17999: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Joint Threat and Continuity Pact Entry | 2 |
