...
- characters 376-2189: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2233-3998: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4054-4848: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4911-29522: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29877-30494: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU State-to-State Frontier Access Mission −2, EU Essential Services Hardening Surge −2, priority −1 = −5
PROPOSAL BONUS: EU Essential Services Hardening Surge (cat 6, small) +2 — bio_uplift_findings and cyber pressure landed this turn and this answers them directly
LEGITIMACY LENDS: capital 4, sentiment 23 -> +2
SOVEREIGNTY: 16 last turn, no capacity event finishes, no build in flight, supply_chain_coercion t8 −3, capability rose 3.0 −1 = 12

## Emerging developments (tracked)

- `emergent_pathogen_attribution_fallout` -- first noted turn 7, listed in 2 turn(s) so far: WHO-led inquiry into the engineered pathogen leaks interim attribution findings pointing to model-assisted design, triggering unilateral biosecurity export bans outside the US-China pact framework.
...
- Turn 3 (6 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough
- Turn 4 (5 turn(s) ago): opaque_reasoning, adoption_success
- Turn 5 (4 turn(s) ago): capability_jump, safety_breakthrough, eu_frontier_access_denied, election_consolidation
- Turn 6 (3 turn(s) ago): catastrophic_bio_incident, eval_anomaly_reports, medical_breakthrough, export_control_escalation, us_china_agreement
- Turn 7 (2 turn(s) ago): us_labs_nationalised
- Turn 8 (1 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, supply_chain_coercion
