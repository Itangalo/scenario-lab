...
- characters 454-2267: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2311-4076: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6287-6788: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9490-11252: `{{previous_actions}}` from the actor's own response from the previous turn
