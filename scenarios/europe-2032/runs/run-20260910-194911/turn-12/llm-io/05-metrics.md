...
- characters 13412-13601: `{{metrics_json}}` from the run's live metric values
- characters 13694-14771: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14814-16468: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16524-17268: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Displaced Entry-Level Guarantee | 2 |
