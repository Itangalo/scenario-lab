...
- characters 105-13406: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13449-13640: `{{metrics_json}}` from the run's live metric values
- characters 13733-15358: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15401-17659: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17715-18516: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU State-to-State Frontier Access Mission | 2 |
| M9 | EU Essential Services Hardening Surge | 2 |
