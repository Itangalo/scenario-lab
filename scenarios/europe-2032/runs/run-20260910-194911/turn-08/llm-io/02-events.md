...
- characters 375-2000: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2043-4301: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4357-5158: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5221-29832: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30187-30707: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU Pandemic Continuity and Bio-Response Cell −2, EU State-to-State Frontier Access Mission −2, priority −1 = −5
PROPOSAL BONUS: EU State-to-State Frontier Access Mission (cat 8, small) +2 — us_labs_nationalised landed this turn and this answers it directly
LEGITIMACY LENDS: capital 6, sentiment 26 -> +2
SOVEREIGNTY: 14 last turn, InvestAI Gigafactories finishes t7 +4, no in-flight build bonus, us_labs_nationalised t7 −1, capability rose 2.5 −1 = 16

## Emerging developments (tracked)

- `emergent_pathogen_attribution_fallout` -- first noted turn 7, listed in 1 turn(s) so far: WHO-led inquiry into the engineered pathogen leaks interim attribution findings pointing to model-assisted design, triggering unilateral biosecurity export bans outside the US-China pact framework.
...
- Turn 3 (5 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough
- Turn 4 (4 turn(s) ago): opaque_reasoning, adoption_success
- Turn 5 (3 turn(s) ago): capability_jump, safety_breakthrough, eu_frontier_access_denied, election_consolidation
- Turn 6 (2 turn(s) ago): catastrophic_bio_incident, eval_anomaly_reports, medical_breakthrough, export_control_escalation, us_china_agreement
