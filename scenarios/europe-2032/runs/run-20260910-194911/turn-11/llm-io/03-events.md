...
- characters 377-1152: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1196-2919: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 2975-3409: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3472-29129: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29484-30392: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Breakthrough Patching and Care Continuity Scale-up −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: none — cyber and medical breakthroughs are positive shifts, not negative events from last three turns this answers
LEGITIMACY LENDS: capital 9, sentiment 18 -> +2
SOVEREIGNTY: 9 last turn, no capacity event, no category 4 finish, no build in flight +0, capability rose 3.0 −1 = 8
...
- Turn 3 (8 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough
- Turn 4 (7 turn(s) ago): opaque_reasoning, adoption_success
- Turn 5 (6 turn(s) ago): capability_jump, safety_breakthrough, eu_frontier_access_denied, election_consolidation
- Turn 6 (5 turn(s) ago): catastrophic_bio_incident, eval_anomaly_reports, medical_breakthrough, export_control_escalation, us_china_agreement
- Turn 7 (4 turn(s) ago): us_labs_nationalised
- Turn 8 (3 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, supply_chain_coercion
- Turn 9 (2 turn(s) ago): loss_of_control_incident, embodied_ai_deployment, joint_threat_response, emergent_pathogen_attribution_fallout
- Turn 10 (1 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, medical_breakthrough, openweight_frontier_release, knowledge_work_augmented
