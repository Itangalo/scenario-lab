...
- characters 455-1230: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1274-2997: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3437-3897: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7116-8971: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Breakthrough Patching and Care Continuity Scale-up | 6 | small | 10 | 12 | own jurisdiction | resilience up materially, public_sentiment up slightly via care delivery | 2 | running |
...
## New measure
**EU Breakthrough Patching and Care Continuity Scale-up**
Rolls the demonstrated automated patching and swarm detection across hospitals, grids and municipal services while securing licensed access to the new tailored therapies for EU clinics.
This and now because the cyber breakthrough offers the first cheap defensive gain in years and the medical breakthrough can still steady sentiment if delivered through EU channels despite dependence and open-weight leakage; a preparedness measure (category 6) fits the continuity commitment when capital is at 8 and sovereignty at 9.

## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Breakthrough Patching and Care Continuity Scale-up", "category": 6, "size": "small", "finish_turn": 12, "applies_to": "own jurisdiction", "targeted_effect": "resilience up materially, public_sentiment up slightly via care delivery"}, "grounds": "cyber breakthrough plus medical breakthrough amid low capital"}]}
```

## Priority
EU Breakthrough Patching and Care Continuity Scale-up, because with no measures in flight it is the only affordable move that converts an exogenous defensive shift into visible service continuity under the two-year commitment.

## In practice
We mandate ENISA and the joint cyber command liaison cell to push the proven automated patching and swarm-behaviour detection from the finished Shield into remaining hospitals, energy distribution and municipal IT, funded by reprogrammed Digital Europe resilience funds with no new vote.

We task HERA and the permanent allocation cell to negotiate licensed production and pooled procurement of the new therapies for EU clinics, using the biosurveillance pact sample-sharing channel to counter hoarding, while DG EMPL extends southern clinic overtime support to hold wards open until both land.
