...
- characters 107-12973: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13016-13207: `{{metrics_json}}` from the run's live metric values
- characters 13300-14075: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14119-15842: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 15898-16711: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 87.5, "openweight_capability": 80.5, "ai_safety": 9.0, "resilience": 48.0, "eu_ai_sovereignty": 7.0, "eu_political_capital": 7.0, "public_sentiment": 21.0}
```
