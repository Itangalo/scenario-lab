...
- characters 453-1562: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1605-3646: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6160-6661: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8985-10729: `{{previous_actions}}` from the actor's own response from the previous turn
