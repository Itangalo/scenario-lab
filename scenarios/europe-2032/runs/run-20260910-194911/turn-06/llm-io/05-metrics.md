...
- characters 105-13637: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13680-13871: `{{metrics_json}}` from the run's live metric values
- characters 13964-15073: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15116-17157: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17213-17639: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Pandemic Continuity and Bio-Response Cell | 2 |
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, Anomaly Triage and Certified Controls Rollout −2, European Public Results Drive −2, priority −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 5, sentiment 32 -> +2
SOVEREIGNTY: 16 last turn, no capacity event, no category 4 finish, in-flight +0, eu_frontier_access_denied t5 −2, capability rose 7.0 −1 = 13
...
## Metrics
```json
{"ai_capability": 73.0, "openweight_capability": 66.0, "ai_safety": 26.0, "resilience": 36.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 8.0, "public_sentiment": 27.0}
```
## Narrative
### Pandemic mode
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 election winner took office turn 6 - rationing as strategic asset"}]}
```
```
