...
- characters 1616-3782: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3838-4352: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4415-29391: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29746-30219: `{{event_history}}` from the run's own event record
...
- Turn 3 (4 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough
- Turn 4 (3 turn(s) ago): opaque_reasoning, adoption_success
- Turn 5 (2 turn(s) ago): capability_jump, safety_breakthrough, eu_frontier_access_denied, election_consolidation
- Turn 6 (1 turn(s) ago): catastrophic_bio_incident, eval_anomaly_reports, medical_breakthrough, export_control_escalation, us_china_agreement
