...
- characters 106-13584: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13627-13818: `{{metrics_json}}` from the run's live metric values
- characters 13911-15107: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15151-17317: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17373-18215: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 75.5, "openweight_capability": 69.0, "ai_safety": 24.0, "resilience": 35.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 8.0, "public_sentiment": 26.0}
```
