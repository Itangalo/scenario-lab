...
- characters 454-1652: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1696-3728: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6093-6553: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9979-11990: `{{previous_actions}}` from the actor's own response from the previous turn
...
- `two_year_commitment` (commitment): Hold essential services and livelihoods through AI shocks on EU-controlled resilience
...
|---|---|---|---|---|---|---|---|---|---|
| M12 | EU Displaced Entry-Level Guarantee | 7 | small | 12 | 14 | own jurisdiction | resilience up materially via transition capacity, public_sentiment up, eu_political_capital up slightly | 2 | running |
...
| M3 | EU Critical Systems Shield | 6 | large | 1 | 4 | own jurisdiction | resilience up materially, ai_safety up slightly via detection | 3 | finished |
| M4 | EU Evaluation and Incident Hub | 5 | small | 2 | 5 | own jurisdiction | ai_safety up materially, resilience up slightly via detection | 2 | finished |
| M5 | Anomaly Triage and Certified Controls Rollout | 5 | small | 3 | 6 | own jurisdiction | ai_safety up materially, resilience up slightly via certified controls | 2 | finished |
| M6 | European Public Results Drive | 9 | small | 4 | 7 | own jurisdiction | public_sentiment up materially, eu_political_capital up slightly, resilience up slightly via trusted adoption | 2 | finished |
| M7 | EU Pandemic Continuity and Bio-Response Cell | 6 | small | 6 | 8 | own jurisdiction | resilience up materially, ai_safety up slightly via misuse detection | 2 | finished |
| M8 | EU State-to-State Frontier Access Mission | 8 | small | 7 | 9 | US | eu_ai_sovereignty up slightly via assured access, resilience up slightly via restored keys | 2 | finished |
| M9 | EU Essential Services Hardening Surge | 6 | small | 8 | 9 | own jurisdiction | resilience up materially, ai_safety up slightly via detection | 2 | finished |
| M10 | EU Joint Threat and Continuity Pact Entry | 6 | small | 9 | 10 | coalition | resilience up materially, ai_safety up slightly via shared detection | 2 | finished |
| M11 | EU Breakthrough Patching and Care Continuity Scale-up | 6 | small | 10 | 12 | own jurisdiction | resilience up materially, public_sentiment up slightly via care delivery | 2 | finished |
...
## New measure
**EU Displaced Entry-Level Guarantee**
It funds wage-subsidised first jobs, rapid retraining and income bridging for graduates and clerical workers displaced in law, accountancy, software and customer operations, tied to the cyber-defence and care hardening rollout. Because labour displacement is now measurable and public sentiment at 21 leaves no room to hold services without holding livelihoods, and this is the core of the two-year commitment.

## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Displaced Entry-Level Guarantee", "category": 7, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up materially via transition capacity, public_sentiment up, eu_political_capital up slightly"}, "grounds": "to hold livelihoods through named displacement under the commitment"}]}
```

## Priority
EU Displaced Entry-Level Guarantee, because with hiring frozen and a decision-scandal discrediting automated administration, the commitment to hold livelihoods outranks patching continuity this turn.

## In practice
We task DG EMPL with ESF+ reprogramming and SURE-top-up bridging to pay employers taking displaced entry-level staff, paired with short reskilling vouchers for cyber-hygiene, care-support and municipal resilience roles where the joint cyber command and HERA cell already have secondments. EPSCO formation carries it, with no new headline fund to force a Council budget fight we would lose at capital 7.

We use the cyber-defence breakthrough and safety breakthrough as delivery, not new programmes: ENISA pushes automated patching and swarm-behaviour detection as certified controls into the small clinics and reverted utilities, and we cite the new interpretability result to impose human-oversight logging and ombudsman redress on the scandal-hit decision systems under the AI Act, conceding the Annex III gap and fixing enforcement visibly to make adoption politically possible again.
...
## New measure
None this turn.
We are at political capital 6 with one measure already running, sovereignty at 7 and sentiment at 14 — we cannot credibly start a new instrument until the Displaced Entry-Level Guarantee lands and the major cyber incident response restores minimal consent to act.

## Store changes
No changes.

## Priority
M12, because with graduate hiring frozen, embodied AI arriving from outside, and a major automated attack landing on brittle legitimacy, holding livelihoods and essential services is the only commitment we can still fund.

## In practice
We put the joint cyber command, ENISA and the CERT network on the major incident first: ward-by-ward patching and swarm detection already in clinics and reverted utilities become the triage line, with big hospitals and energy held as continuity islands and municipal services degraded rather than stopped. DG CNECT carries this under the Critical Systems Shield and Breakthrough Patching record, no new mandate asked.

We use the medical breakthrough and the adoption success as rationed delivery, not promises: HERA pooled procurement for licensed tailored batches where they reach ordinary care, DG EMPL paying M12 wage-subsidised first jobs and reskilling vouchers into cyber-hygiene and care-support roles where secondments already exist. EPSCO and HEALTH formations carry it from reprogrammed ESF+ funds, conceding export-control rationing and foreign-model dependence openly to avoid another conformity-assessment fig-leaf scandal.
