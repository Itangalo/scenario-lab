...
- characters 376-1574: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1618-3650: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3706-4498: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4561-30218: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30573-31661: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Displaced Entry-Level Guarantee −2, priority no effect (capital below 20, no cost) = −2
PROPOSAL BONUS: EU Displaced Entry-Level Guarantee (cat 7, small) +2 — labour_displacement fired this turn and this answers it directly
LEGITIMACY LENDS: capital 7, sentiment 21 -> +2
SOVEREIGNTY: 7 last turn, no capacity event, no category 4 finish, no build in flight +0, capability rose 1.5 −0 = 7

## Emerging developments (tracked)

- `emergent_shadow_medical_agents` -- first noted turn 11, listed in 2 turn(s) so far: Unlicensed open-weight medical agents combining near-frontier reasoning with tailored-therapy protocols spread through EU clinics and pharmacies, delivering treatments outside the licensed-batch system with real benefits and uncontrolled safety failures.
...
- Turn 3 (10 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough
- Turn 4 (9 turn(s) ago): opaque_reasoning, adoption_success
- Turn 5 (8 turn(s) ago): capability_jump, safety_breakthrough, eu_frontier_access_denied, election_consolidation
- Turn 6 (7 turn(s) ago): catastrophic_bio_incident, eval_anomaly_reports, medical_breakthrough, export_control_escalation, us_china_agreement
- Turn 7 (6 turn(s) ago): us_labs_nationalised
- Turn 8 (5 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, supply_chain_coercion
- Turn 9 (4 turn(s) ago): loss_of_control_incident, embodied_ai_deployment, joint_threat_response, emergent_pathogen_attribution_fallout
- Turn 10 (3 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, medical_breakthrough, openweight_frontier_release, knowledge_work_augmented
- Turn 11 (2 turn(s) ago): openweight_frontier_release
- Turn 12 (1 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, labour_displacement, automated_decision_scandal
