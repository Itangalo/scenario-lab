...
- characters 12997-13187: `{{metrics_json}}` from the run's live metric values
- characters 13280-14478: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14522-16554: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16610-17023: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 90.5, "openweight_capability": 86.5, "ai_safety": 12.0, "resilience": 50.0, "eu_ai_sovereignty": 5.0, "eu_political_capital": 2.0, "public_sentiment": 10.0}
```
...
## Notepad
PORTFOLIO CHARGE t13: EU Displaced Entry-Level Guarantee −2, priority no effect (capital below 20, no cost) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2, sentiment 10 -> +1 (capped, sentiment above capital, small lend under strain)
SOVEREIGNTY: 7 last turn, no capacity event? embodied_ai_deployment t13 −2 (largest, export_control_escalation also qualifies), no category 4 finish, no build in flight +0, capability rose 1.5 −0 = 5
