...
- characters 13781-14818: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14862-16633: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16689-17805: `{{notepad}}` from the Game Master's notepad, carried across turns
