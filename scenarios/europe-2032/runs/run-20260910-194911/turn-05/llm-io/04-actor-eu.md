...
- characters 1536-3307: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5196-5663: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7986-9957: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | European Public Results Drive | 9 | small | 4 | 7 | own jurisdiction | public_sentiment up materially, eu_political_capital up slightly, resilience up slightly via trusted adoption | 2 | running |
