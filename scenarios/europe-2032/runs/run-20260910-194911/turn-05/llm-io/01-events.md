...
- characters 377-1414: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1458-3229: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3285-4401: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4464-30720: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31075-31291: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, eval_anomaly_reports
- Turn 3 (2 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough
- Turn 4 (1 turn(s) ago): opaque_reasoning, adoption_success
