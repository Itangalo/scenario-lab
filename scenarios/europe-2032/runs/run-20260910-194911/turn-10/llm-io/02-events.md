...
- characters 375-1638: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1681-3756: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3812-4251: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4314-29971: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30326-31080: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Joint Threat and Continuity Pact Entry −2, priority −1 = −3
PROPOSAL BONUS: EU Joint Threat and Continuity Pact Entry (cat 6, small) +3 — loss-of-control incident and WHO attribution fallout landed this turn and this answers them directly
LEGITIMACY LENDS: capital 8, sentiment 18 -> +2
SOVEREIGNTY: 12 last turn, no category 4 finish, no build in flight +0, embodied_ai_deployment t9 −2, capability rose 3.0 −1 = 9
...
- Turn 3 (7 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, safety_breakthrough
- Turn 4 (6 turn(s) ago): opaque_reasoning, adoption_success
- Turn 5 (5 turn(s) ago): capability_jump, safety_breakthrough, eu_frontier_access_denied, election_consolidation
- Turn 6 (4 turn(s) ago): catastrophic_bio_incident, eval_anomaly_reports, medical_breakthrough, export_control_escalation, us_china_agreement
- Turn 7 (3 turn(s) ago): us_labs_nationalised
- Turn 8 (2 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, supply_chain_coercion
- Turn 9 (1 turn(s) ago): loss_of_control_incident, embodied_ai_deployment, joint_threat_response, emergent_pathogen_attribution_fallout
