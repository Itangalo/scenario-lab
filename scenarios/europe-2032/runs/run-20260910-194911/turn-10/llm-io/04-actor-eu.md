...
- characters 1759-3834: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5855-6315: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9188-11472: `{{previous_actions}}` from the actor's own response from the previous turn
