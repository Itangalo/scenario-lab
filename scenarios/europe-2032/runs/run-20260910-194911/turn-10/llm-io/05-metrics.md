...
- characters 106-13364: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13407-13597: `{{metrics_json}}` from the run's live metric values
- characters 13690-14953: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14996-17071: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17127-17566: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Breakthrough Patching and Care Continuity Scale-up | 2 |
...
## Metrics
```json
{"ai_capability": 84.5, "openweight_capability": 78.0, "ai_safety": 11.0, "resilience": 49.0, "eu_ai_sovereignty": 8.0, "eu_political_capital": 11.0, "public_sentiment": 22.0}
```
## Narrative
