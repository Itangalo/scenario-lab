...
- characters 376-1803: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1846-3860: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3916-4924: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4987-28064: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28419-28482: `{{event_history}}` from the run's own event record
