...
- characters 105-13055: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13098-13290: `{{metrics_json}}` from the run's live metric values
- characters 13383-14810: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14853-16867: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16923-17931: `{{notepad}}` from the Game Master's notepad, carried across turns
