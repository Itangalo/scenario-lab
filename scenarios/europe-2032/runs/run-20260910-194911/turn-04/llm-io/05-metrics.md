...
- characters 105-13492: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13535-13727: `{{metrics_json}}` from the run's live metric values
- characters 13820-14804: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14847-16638: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16694-17821: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Evaluation and Incident Hub | 2 |
| M5 | Anomaly Triage and Certified Controls Rollout | 2 |
| M6 | European Public Results Drive | 2 |
...
PORTFOLIO CHARGE t3: Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Evaluation and Incident Hub −2, Anomaly Triage and Certified Controls Rollout −2, priority −1 = −14
PROPOSAL BONUS: Anomaly Triage and Certified Controls Rollout (cat 5, small) +3 — eval anomaly reports and safety breakthrough both landed this turn and this answers both directly
LEGITIMACY LENDS: capital 20, sentiment 37 -> +2
SOVEREIGNTY: 20 last turn, no category 4 finish, ai_investment_collapse t3 −2, capability rose 3.0 −1 = 17

## Emerging developments (tracked)

- `emergent_grid_shedding_crisis` -- first noted turn 4, listed in 1 turn(s) so far: Prolonged walkouts and unpaid overtime cascade into an unplanned regional grid separation drill failure, forcing rolling load-shedding in the two previously breached states during winter peak.
- `emergent_insurance_repricing` -- first noted turn 4, listed in 1 turn(s) so far: A major European insurer reprices data-centre and AI-liability coverage after the investment freeze, sharply raising premiums for municipalities and hospitals running uncertified AI systems.
...
## Notepad
PORTFOLIO CHARGE t4: Gigafactories −3, Tech sovereignty package −3, EU Evaluation and Incident Hub −2, Anomaly Triage and Certified Controls Rollout −2, European Public Results Drive −2, priority −1 = −13
PROPOSAL BONUS: none — European Public Results Drive (cat 9, small) exploits adoption_success, a positive attribution, not a negative event from last three rounds
LEGITIMACY LENDS: capital 13, sentiment 36 -> +2
SOVEREIGNTY: 17 last turn, no capacity event, no category 4 finish, in-flight +0, capability rose 3.0 −1 = 16
