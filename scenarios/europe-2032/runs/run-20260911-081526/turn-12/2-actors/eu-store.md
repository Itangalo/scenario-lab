...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Containment and Continuity Lockdown", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly via quarantine and detection"}, "grounds": "simultaneous cyber, bio and loss-of-control incidents"}
  - Grounds: simultaneous cyber, bio and loss-of-control incidents
