...
| M12 | EU Municipal Continuity and Bio-Detection Surge | 6 | small | 11 | 14 | own jurisdiction | resilience up, ai_safety up slightly via containment and detection | 2 | running |
| M13 | EU Containment and Continuity Lockdown | 6 | small | 12 | 15 | own jurisdiction | resilience up, ai_safety up slightly via quarantine and detection | 2 | running |
| M14 | EU Clinical AI Liability and Offline Fallback Guarantee | 9 | small | 13 | 15 | own jurisdiction | public_sentiment up, resilience up slightly via restored diagnostics | 2 | running |
...
- **applied** `M14` — {"op": "add", "table": "measures", "fields": {"name": "EU Clinical AI Liability and Offline Fallback Guarantee", "category": 9, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, resilience up slightly via restored diagnostics"}, "grounds": "hospital federations freezing AI diagnostics until liability law"}
  - Grounds: hospital federations freezing AI diagnostics until liability law
