...
- characters 106-13011: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13054-13246: `{{metrics_json}}` from the run's live metric values
- characters 13362-16311: `{{world_state}}` from background/context.md, seeded as the opening world state
- characters 16367-17019: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_clinical_model_pause` -- first noted turn 1, listed in 1 turn(s) so far: Major European research hospitals pause use of US frontier models for clinical decision support after the June switch-off scare, publicly citing continuity risk and accelerating evaluation of open-weight alternatives.
- `emergent_bioscreening_publishing_pact` -- first noted turn 1, listed in 1 turn(s) so far: A major European scientific publisher and a university lab jointly disclose that reviewers caught AI-generated phage design details inserted into submitted manuscripts, triggering a cross-publisher screening pact debate.
