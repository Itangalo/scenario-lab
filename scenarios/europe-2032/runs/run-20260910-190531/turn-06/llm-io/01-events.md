...
- characters 376-2069: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2112-4255: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4311-4837: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4900-31423: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31778-32309: `{{event_history}}` from the run's own event record
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, loss_of_control_incident, eu_access_secured, adoption_success
- Turn 2 (4 turn(s) ago): bio_incident, loss_of_control_incident, cyber_defence_breakthrough, export_control_escalation
- Turn 3 (3 turn(s) ago): capability_jump, openweight_frontier_release, ai_investment_collapse
- Turn 4 (2 turn(s) ago): bio_uplift_findings, opaque_reasoning, labour_displacement
- Turn 5 (1 turn(s) ago): medical_breakthrough, embodied_ai_deployment, emergent_trust_freeze_backlash, election_consolidation
