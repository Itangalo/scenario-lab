...
- characters 454-2147: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2190-4333: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5797-6294: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8800-11041: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Trusted Deployment Compact | 9 | small | 5 | 7 | own jurisdiction | public_sentiment up, resilience up slightly via trusted adoption | 2 | running |
