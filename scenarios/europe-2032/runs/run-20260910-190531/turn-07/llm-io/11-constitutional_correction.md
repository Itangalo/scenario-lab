...
- characters 3454-3908: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 79.0, "openweight_capability": 71.0, "ai_safety": 2.0, "resilience": 37.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 7.0, "public_sentiment": 14.0}
```
