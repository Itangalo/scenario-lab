...
- characters 13517-13706: `{{metrics_json}}` from the run's live metric values
- characters 13799-15678: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15722-18368: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18424-19440: `{{notepad}}` from the Game Master's notepad, carried across turns
