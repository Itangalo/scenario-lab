...
- characters 375-1971: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2015-4205: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4261-4856: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4919-30042: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30397-31489: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Joint Threat Membership and Municipal Hardening −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: EU Joint Threat Membership and Municipal Hardening (cat 6, small) +3 — cyber_major_incident fired this turn and joint_threat_response invitation answers it directly
LEGITIMACY LENDS: capital 4, sentiment 4 -> +0, capped by sentiment [recomputed as capital 4 after charges/bonus/finish, sentiment 4, no lend]
SOVEREIGNTY: 16 last turn, no category 4 finish, no category 4 in flight +0, embodied_ai_deployment t10 −2, capability rose 4.0 −1 = 13
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, loss_of_control_incident, eu_access_secured, adoption_success
- Turn 2 (9 turn(s) ago): bio_incident, loss_of_control_incident, cyber_defence_breakthrough, export_control_escalation
- Turn 3 (8 turn(s) ago): capability_jump, openweight_frontier_release, ai_investment_collapse
- Turn 4 (7 turn(s) ago): bio_uplift_findings, opaque_reasoning, labour_displacement
- Turn 5 (6 turn(s) ago): medical_breakthrough, embodied_ai_deployment, emergent_trust_freeze_backlash, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, capability_jump, medical_breakthrough, labour_displacement
- Turn 7 (4 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, research_breakthrough, adoption_success
- Turn 8 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, us_labs_nationalised, eu_frontier_access_denied
- Turn 9 (2 turn(s) ago): openweight_frontier_release, us_china_agreement
- Turn 10 (1 turn(s) ago): cyber_major_incident, rsi_onset, labour_displacement, embodied_ai_deployment, joint_threat_response
