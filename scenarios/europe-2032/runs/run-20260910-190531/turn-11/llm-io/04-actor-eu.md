...
- characters 453-2049: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2093-4283: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6582-7063: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10162-12785: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Joint Threat Membership and Municipal Hardening | 6 | small | 10 | 12 | own jurisdiction and joint response coalition | resilience up substantially, ai_safety up slightly via shared attribution | 2 | running |
