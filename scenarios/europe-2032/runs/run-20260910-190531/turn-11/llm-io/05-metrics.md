...
- characters 107-13063: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13106-13295: `{{metrics_json}}` from the run's live metric values
- characters 13388-14984: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15028-17218: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17274-18452: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Joint Threat Membership and Municipal Hardening | 2 |
| M11 | EU Middle-Power Supply-Chain Coalition for Compute Access and Joint Evaluation | 2 |
...
## Metrics
```json
{"ai_capability": 89.5, "openweight_capability": 83.0, "ai_safety": 0.0, "resilience": 33.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 8.0, "public_sentiment": 7.0}
```
