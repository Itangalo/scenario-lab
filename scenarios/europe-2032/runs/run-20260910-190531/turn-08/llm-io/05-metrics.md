...
- characters 105-13000: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13043-13233: `{{metrics_json}}` from the run's live metric values
- characters 13326-14401: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14444-17655: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17711-18184: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Clinical Inference Repatriation | 2 |
| M9 | EU-US State-to-State Continuity Accord | 2 |
