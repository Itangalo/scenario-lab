...
- characters 374-1449: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1492-4703: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4759-5794: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5857-33547: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33902-34649: `{{event_history}}` from the run's own event record
...
- `emergent_gigafactory_backlash_sabotage` -- first noted turn 6, listed in 2 turn(s) so far: Coordinated sabotage and blockades halt construction and grid connection of EU gigafactory sites after protests over costs, jobs and US dependence turn disruptive.
- `emergent_siting_blockade_protests` -- first noted turn 6, listed in 2 turn(s) so far: Coordinated physical protests and blockades target grid connection works for the 4-5 reserved EU factory sites, delaying construction starts and forcing a public-order response.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, loss_of_control_incident, eu_access_secured, adoption_success
- Turn 2 (6 turn(s) ago): bio_incident, loss_of_control_incident, cyber_defence_breakthrough, export_control_escalation
- Turn 3 (5 turn(s) ago): capability_jump, openweight_frontier_release, ai_investment_collapse
- Turn 4 (4 turn(s) ago): bio_uplift_findings, opaque_reasoning, labour_displacement
- Turn 5 (3 turn(s) ago): medical_breakthrough, embodied_ai_deployment, emergent_trust_freeze_backlash, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, capability_jump, medical_breakthrough, labour_displacement
- Turn 7 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, research_breakthrough, adoption_success
