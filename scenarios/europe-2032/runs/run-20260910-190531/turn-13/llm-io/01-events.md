...
- characters 375-1594: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1638-3636: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3692-4645: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4708-29831: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30186-31607: `{{event_history}}` from the run's own event record
...
- `emergent_infrastructure_sabotage_wave` -- first noted turn 11, listed in 2 turn(s) so far: Coordinated physical sabotage campaign against data-centre power feeds and fibre spurs in multiple member states, forcing temporary shutdowns and emergency policing of infrastructure sites.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, loss_of_control_incident, eu_access_secured, adoption_success
- Turn 2 (11 turn(s) ago): bio_incident, loss_of_control_incident, cyber_defence_breakthrough, export_control_escalation
- Turn 3 (10 turn(s) ago): capability_jump, openweight_frontier_release, ai_investment_collapse
- Turn 4 (9 turn(s) ago): bio_uplift_findings, opaque_reasoning, labour_displacement
- Turn 5 (8 turn(s) ago): medical_breakthrough, embodied_ai_deployment, emergent_trust_freeze_backlash, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, capability_jump, medical_breakthrough, labour_displacement
- Turn 7 (6 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, research_breakthrough, adoption_success
- Turn 8 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, us_labs_nationalised, eu_frontier_access_denied
- Turn 9 (4 turn(s) ago): openweight_frontier_release, us_china_agreement
- Turn 10 (3 turn(s) ago): cyber_major_incident, rsi_onset, labour_displacement, embodied_ai_deployment, joint_threat_response
- Turn 11 (2 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, openweight_frontier_release, export_control_escalation, adoption_success, middle_power_coalition
- Turn 12 (1 turn(s) ago): eval_anomaly_reports, labour_displacement, knowledge_work_augmented, eu_frontier_access_denied, emergent_anti_ai_sabotage_wave
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.06}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.3}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.04}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.03}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.025}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.075}, {"description": "", "emergent": false, "id": "catastrophic_great_power_conflict", "probability": 0.085}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.26}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Coordinated physical sabotage campaign against data-centre power feeds and fibre spurs in multiple member states, forcing temporary shutdowns and emergency policing of infrastructure sites.", "emergent": true, "id": "emergent_infrastructure_sabotage_wave", "probability": 0.22}]
```
