...
- characters 375-1626: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1669-3846: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3902-4255: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4318-30016: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30371-31335: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M9 EU-US State-to-State Continuity Accord −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2, sentiment 10 -> +1, capped by sentiment
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, loss_of_control_incident, eu_access_secured, adoption_success
- Turn 2 (8 turn(s) ago): bio_incident, loss_of_control_incident, cyber_defence_breakthrough, export_control_escalation
- Turn 3 (7 turn(s) ago): capability_jump, openweight_frontier_release, ai_investment_collapse
- Turn 4 (6 turn(s) ago): bio_uplift_findings, opaque_reasoning, labour_displacement
- Turn 5 (5 turn(s) ago): medical_breakthrough, embodied_ai_deployment, emergent_trust_freeze_backlash, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, capability_jump, medical_breakthrough, labour_displacement
- Turn 7 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, research_breakthrough, adoption_success
- Turn 8 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, us_labs_nationalised, eu_frontier_access_denied
- Turn 9 (1 turn(s) ago): openweight_frontier_release, us_china_agreement
