...
- characters 453-1704: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1747-3924: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6409-6847: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9573-11161: `{{previous_actions}}` from the actor's own response from the previous turn
