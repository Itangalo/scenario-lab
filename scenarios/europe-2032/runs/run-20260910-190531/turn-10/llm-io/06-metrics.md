...
- characters 13405-13595: `{{metrics_json}}` from the run's live metric values
- characters 13688-14939: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14982-17159: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17215-17568: `{{notepad}}` from the Game Master's notepad, carried across turns
