...
- characters 454-1905: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1948-4033: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5483-5968: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8122-10128: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU Compute Continuity Bridge | 4 | small | 3 | 5 | own jurisdiction | eu_ai_sovereignty up slightly / prevents fall, eu_political_capital cost contained | 2 | running |
...
## New measure
**EU Compute Continuity Bridge**
Keeps Gigafactory site work and power hook-ups alive through the investment collapse with bridge public finance and repurposed EIB guarantees, so EU-controlled compute does not evaporate with private valuations. This now because the collapse directly threatens the sovereignty capacity our two-year absorb-and-control commitment depends on, while the capability jump plus near-frontier open release makes losing domestic controllable capacity this turn unrecoverable.
## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Compute Continuity Bridge", "category": 4, "size": "small", "finish_turn": 5, "applies_to": "own jurisdiction", "targeted_effect": "eu_ai_sovereignty up slightly / prevents fall, eu_political_capital cost contained"}, "grounds": "investment collapse evaporates private compute arrangements"}]}
```
## Priority
EU Bio-Response and Agent Containment Shield, not the new bridge, because live bio and agent containment with weeks-long deaths outranks financing over the next six months under our absorb-shocks commitment.
## In practice
We keep M4 as the operational centre: HERA/ECDC push sentinel sequencing and the 48-hour playbook with health-resilience co-financing to pull the two slipping large states along, while ENISA and the Cyber Solidarity SOCs roll swarm-behaviour detection and mandatory kill-switch/transaction-hold/replication-log duties through national market surveillance with AI Office escalation.

We use the bridge only to hold ground: EuroHPC JU and EIB reprogramme existing InvestAI envelopes to cover site reservation, grid connection fees and long-lead power equipment for the four to five Gigafactory sites, with accelerated-permitting zones under M2 kept moving in Council. We accept longer US licence lead times and pair volume licences with explicit EU-jurisdiction hosting terms, telling finance ministers this is loss-avoidance, not new spend, to fit our 33 capital.
...
A flexicurity-style bridge for displaced graduates and back-office workers — wage insurance, paid retraining placements, and hiring incentives tied to automating employers — to stop labour displacement becoming political collapse. This now because measurable graduate job losses plus hostile sentiment directly threaten the capital needed to hold our absorb-and-control commitment, and only a visible social cushion restores room to act.
## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Entry-Level Transition Guarantee", "category": 7, "size": "small", "finish_turn": 7, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, resilience up via social absorption, eu_political_capital stabilised"}, "grounds": "labour displacement and eroding public trust threaten governability"}]}
```
## Priority
EU Entry-Level Transition Guarantee, not the compute lines, because without arresting sentiment collapse at 28 and capital at 25 no sovereignty or shield measure can be funded or enforced over the next six months.
## In practice
We run the Guarantee through ESF+ and SURE-style loans via EPSCO, with DG EMPL and national PES: income bridge for 6 months plus funded reskilling vouchers in law, accountancy, software support and customer operations, co-paid by a transition levy on large deployers of agentic automation. We sell it to finance ministers as loss-avoidance for cohesion, not new largesse, and to unions and youth organisations as proof renting intelligence does not mean abandoning entrants.

We hold the rest on maintenance, not expansion: EuroHPC JU/EIB keep the Continuity Bridge paying only reservation and grid fees for the four-to-five Gigafactory sites while Council Legal Service unblocks permitting zones, and HERA/ECDC plus ENISA keep the finished shields drilling sequencing, 48-hour playbook and kill-switch enforcement. On opaque reasoning and bio uplift we issue AI Office guidance shifting procurement and incident reporting to black-box behavioural evaluations and mandatory bio-uplift disclosure, without opening a new build this turn.
