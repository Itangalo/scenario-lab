...
- characters 376-1827: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1870-3955: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4011-4535: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4598-30740: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31095-31414: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, loss_of_control_incident, eu_access_secured, adoption_success
- Turn 2 (2 turn(s) ago): bio_incident, loss_of_control_incident, cyber_defence_breakthrough, export_control_escalation
- Turn 3 (1 turn(s) ago): capability_jump, openweight_frontier_release, ai_investment_collapse
