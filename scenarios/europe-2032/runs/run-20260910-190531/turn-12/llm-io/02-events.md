...
- characters 374-1945: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1988-4162: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4218-5466: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5529-30652: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31007-32273: `{{event_history}}` from the run's own event record
...
- `emergent_infrastructure_sabotage_wave` -- first noted turn 11, listed in 1 turn(s) so far: Coordinated physical sabotage campaign against data-centre power feeds and fibre spurs in multiple member states, forcing temporary shutdowns and emergency policing of infrastructure sites.
- `emergent_anti_ai_sabotage_wave` -- first noted turn 11, listed in 1 turn(s) so far: Coordinated physical sabotage and arson against data-centre construction sites and robot depots spreads across several member states, forcing a temporary construction freeze.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, loss_of_control_incident, eu_access_secured, adoption_success
- Turn 2 (10 turn(s) ago): bio_incident, loss_of_control_incident, cyber_defence_breakthrough, export_control_escalation
- Turn 3 (9 turn(s) ago): capability_jump, openweight_frontier_release, ai_investment_collapse
- Turn 4 (8 turn(s) ago): bio_uplift_findings, opaque_reasoning, labour_displacement
- Turn 5 (7 turn(s) ago): medical_breakthrough, embodied_ai_deployment, emergent_trust_freeze_backlash, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, capability_jump, medical_breakthrough, labour_displacement
- Turn 7 (5 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, research_breakthrough, adoption_success
- Turn 8 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, us_labs_nationalised, eu_frontier_access_denied
- Turn 9 (3 turn(s) ago): openweight_frontier_release, us_china_agreement
- Turn 10 (2 turn(s) ago): cyber_major_incident, rsi_onset, labour_displacement, embodied_ai_deployment, joint_threat_response
- Turn 11 (1 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, openweight_frontier_release, export_control_escalation, adoption_success, middle_power_coalition
