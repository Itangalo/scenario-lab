...
- characters 106-13505: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13548-13737: `{{metrics_json}}` from the run's live metric values
- characters 13830-15401: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15444-17618: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17674-18660: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M12 | EU Protected Sites and Cutoff Continuity Operation | 2 |
...
## Metrics
```json
{"ai_capability": 91.0, "openweight_capability": 86.0, "ai_safety": 0.0, "resilience": 37.0, "eu_ai_sovereignty": 12.0, "eu_political_capital": 4.0, "public_sentiment": 2.0}
```
