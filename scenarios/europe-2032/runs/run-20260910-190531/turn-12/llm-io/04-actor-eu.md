...
- characters 452-2023: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2066-4240: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6145-6626: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9964-12095: `{{previous_actions}}` from the actor's own response from the previous turn
...
**emergent_anti_ai_sabotage_wave (emergent event):** Coordinated physical sabotage and arson against data-centre construction sites and robot depots spreads across several member states, forcing a temporary construction freeze.
...
- `two_year_commitment` (commitment): Hold the Union together through automation and embodied shock while rebuilding resilience under EU control
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Middle-Power Supply-Chain Coalition for Compute Access and Joint Evaluation | 8 | small | 11 | 13 | middle-power coalition and own jurisdiction | eu_ai_sovereignty up, eu_political_capital up via secured access | 2 | running |
...
| M4 | EU Bio-Response and Agent Containment Shield | 6 | large | 2 | 4 | own jurisdiction | resilience up substantially, ai_safety up moderately via containment learning | 3 | finished |
| M5 | EU Compute Continuity Bridge | 4 | small | 3 | 5 | own jurisdiction | eu_ai_sovereignty up slightly / prevents fall, eu_political_capital cost contained | 2 | finished |
| M6 | EU Entry-Level Transition Guarantee | 7 | small | 4 | 6 | own jurisdiction | public_sentiment up, resilience up via social absorption, eu_political_capital stabilised | 2 | finished |
| M7 | EU Trusted Deployment Compact | 9 | small | 5 | 7 | own jurisdiction | public_sentiment up, resilience up slightly via trusted adoption | 2 | finished |
| M8 | EU Clinical Inference Repatriation | 9 | small | 7 | 9 | own jurisdiction | public_sentiment up, resilience up slightly, eu_ai_sovereignty up slightly via anchored inference | 2 | finished |
| M9 | EU-US State-to-State Continuity Accord | 8 | small | 8 | 10 | US | resilience up, eu_ai_sovereignty fall prevented, eu_political_capital stabilised | 2 | finished |
| M10 | EU Joint Threat Membership and Municipal Hardening | 6 | small | 10 | 12 | own jurisdiction and joint response coalition | resilience up substantially, ai_safety up slightly via shared attribution | 2 | finished |
...
## New measure
**EU Middle-Power Supply-Chain Coalition for Compute Access and Joint Evaluation**
Joins the middle-power coordination framework to align export licences, bargain jointly for compute access, and pool evaluation capacity without ceding sovereignty.
Why this and why now: with sovereignty at 13, capital at 6 and export controls tightening again, this is the only offered window that secures access on survivable terms and rebuilds leverage, while the cyber-defence breakthrough and visible public-sector adoption success give us something to bring to the table.

## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Middle-Power Supply-Chain Coalition for Compute Access and Joint Evaluation", "category": 8, "size": "small", "finish_turn": 13, "applies_to": "middle-power coalition and own jurisdiction", "targeted_effect": "eu_ai_sovereignty up, eu_political_capital up via secured access"}, "grounds": "seizing coalition window amid export escalation"}]}
```

## Priority
EU Middle-Power Supply-Chain Coalition for Compute Access and Joint Evaluation, because with general US access unrestored and open weights at 81 unrecallable, only joint withholding power restores bargaining leverage and keeps the two-year commitment to hold together alive.

## In practice
We mandate the Commission via European Council conclusions and the Foreign Affairs Council (Trade) to sign the coalition MoU on export-licence alignment and joint compute bargaining, tasking DG TRADE, DG CNECT and the EU Anti-Coercion Instrument unit with a joint secretariat contribution, funded by redeployed Digital Europe funds — offering our ASML/lithography and EuroHPC evaluation slots as our share.

We carry M10 in parallel: ENISA and HERA liaison officers stay in the pooled cyber-bio command, transposing its new defensive tooling — automated patching and swarm detection — into rehearsed municipal and hospital playbooks, while we ring-fence the proven public-sector adoption wins (waiting-list falls) to defend against hostile data-centre politics and keep retraining linked to displaced juniors.
...
```
## New measure
**EU Protected Sites and Cutoff Continuity Operation**
Deploys coordinated site protection to restart frozen data-centre and depot construction while switching cut-off hospitals, ministries and firms to EU-hosted and coalition fallback inference.
Why this and why now: with access denied at short notice, coordinated arson freezing build, and capital at 8 and sentiment at 7, only visible protection plus keeping clinics running holds the two-year commitment to hold together alive.

## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Protected Sites and Cutoff Continuity Operation", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_political_capital stabilised, eu_ai_sovereignty fall prevented"}, "grounds": "answering sabotage freeze and US cutoff together"}]}
```

## Priority
EU Protected Sites and Cutoff Continuity Operation, because it and not the coalition answers this turn's twin shock of physical sabotage and model cutoff that would otherwise stop services and construction at once.

## In practice
We act through the Justice and Home Affairs Council and the Critical Entities Resilience Directive: Europol-coordinated national police protection for listed construction sites and robot depots, ENISA hardened temporary site networks, and accelerated permitting conditional on local benefit payments to defuse protest, funded by redeployed Internal Security and Digital Europe funds.

We carry M11 in parallel: DG TRADE and DG CNECT use the middle-power pact to route emergency inference and power equipment for cut-off hospitals via coalition evaluation slots and EuroHPC, while HERA and ENISA liaison officers in the pooled command transpose auto-patching and swarm detection into municipal playbooks, and public employment services link displaced juniors to protected-site and care-assistant queues.
