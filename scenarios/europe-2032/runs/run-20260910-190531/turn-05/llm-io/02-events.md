...
- characters 377-2297: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2341-4471: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4527-5294: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5357-32229: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32584-32988: `{{event_history}}` from the run's own event record
...
- `emergent_trust_freeze_backlash` -- first noted turn 4, listed in 1 turn(s) so far: Municipal utilities and mid-size manufacturers hit by AI-generated fraud and agent-driven intrusions suspend automation rollouts and sue vendors, freezing EU adoption pipeline for months.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, loss_of_control_incident, eu_access_secured, adoption_success
- Turn 2 (3 turn(s) ago): bio_incident, loss_of_control_incident, cyber_defence_breakthrough, export_control_escalation
- Turn 3 (2 turn(s) ago): capability_jump, openweight_frontier_release, ai_investment_collapse
- Turn 4 (1 turn(s) ago): bio_uplift_findings, opaque_reasoning, labour_displacement
