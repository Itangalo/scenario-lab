...
- characters 13790-15710: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15754-17884: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17940-18396: `{{notepad}}` from the Game Master's notepad, carried across turns
