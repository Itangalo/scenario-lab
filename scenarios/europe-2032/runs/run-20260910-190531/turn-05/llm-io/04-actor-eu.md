...
- characters 455-2375: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2419-4549: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6903-7388: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9733-11917: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Entry-Level Transition Guarantee | 7 | small | 4 | 6 | own jurisdiction | public_sentiment up, resilience up via social absorption, eu_political_capital stabilised | 2 | running |
