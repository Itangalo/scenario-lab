...
- characters 374-1693: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1737-3932: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3988-4543: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4606-31810: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32165-33055: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Clinical Inference Repatriation −2, EU-US State-to-State Continuity Accord −2, priority −1 not charged (capital below 20, no effect) = −4
PROPOSAL BONUS: EU-US State-to-State Continuity Accord (cat 8, small) +4 — answers nationalisation and access cut-off from this turn directly
LEGITIMACY LENDS: capital 1, sentiment 6 -> +1, capped by sentiment
SOVEREIGNTY: 21 last turn, no capacity build finishes, no capacity event in flight bonus, eu_frontier_access_denied t8 −3 (larger of two take-away events), capability rose 3.0 −1 = 17
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, loss_of_control_incident, eu_access_secured, adoption_success
- Turn 2 (7 turn(s) ago): bio_incident, loss_of_control_incident, cyber_defence_breakthrough, export_control_escalation
- Turn 3 (6 turn(s) ago): capability_jump, openweight_frontier_release, ai_investment_collapse
- Turn 4 (5 turn(s) ago): bio_uplift_findings, opaque_reasoning, labour_displacement
- Turn 5 (4 turn(s) ago): medical_breakthrough, embodied_ai_deployment, emergent_trust_freeze_backlash, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, capability_jump, medical_breakthrough, labour_displacement
- Turn 7 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, research_breakthrough, adoption_success
- Turn 8 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, safety_breakthrough, us_labs_nationalised, eu_frontier_access_denied
