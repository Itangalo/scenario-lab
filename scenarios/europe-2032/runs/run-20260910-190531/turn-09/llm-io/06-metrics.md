...
- characters 13416-13605: `{{metrics_json}}` from the run's live metric values
- characters 13698-15017: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15061-17256: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17312-17867: `{{notepad}}` from the Game Master's notepad, carried across turns
