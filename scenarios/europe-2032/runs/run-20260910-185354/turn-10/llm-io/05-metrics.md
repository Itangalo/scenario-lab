...
- characters 106-13525: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13568-13759: `{{metrics_json}}` from the run's live metric values
- characters 13852-15137: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15180-17276: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17332-18094: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Dock-Logistics Flexicurity Transition | 2 |
...
PORTFOLIO CHARGE t9: M9 EU Foundry Keep-Alive and Grid-Queue Pact −2, M10 EU Critical Services Restoration Pact −2, priority −1 = −5
PROPOSAL BONUS: M10 (cat 6, small) +4 — cyber_major_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 15, sentiment 34 -> +2
SOVEREIGNTY: 22 last turn, no finishing capacity, M9 in flight +0, embodied_ai_deployment t9 −2, capability rose 1.0 no penalty = 20

## Emerging developments (tracked)

- `emergent_port_strike_escalation` -- first noted turn 10, listed in 1 turn(s) so far: A coordinated dockworker and municipal workers strike wave spreads from port stoppages to sympathy strikes in logistics hubs, blocking delivery of backup power and cyber-response hardware to lagging towns for weeks.
