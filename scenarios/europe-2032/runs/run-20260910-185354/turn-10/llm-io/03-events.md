...
- characters 376-1661: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1704-3800: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3856-4277: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4340-31155: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31510-32169: `{{event_history}}` from the run's own event record
...
- Turn 5 (5 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise, member_state_defection, emergent_procurement_legal_freeze, election_alliance
- Turn 7 (3 turn(s) ago): capability_jump, ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, export_control_escalation, member_state_defection
- Turn 8 (2 turn(s) ago): research_breakthrough, taiwan_tension_rise
- Turn 9 (1 turn(s) ago): cyber_major_incident, opaque_reasoning, embodied_ai_deployment
