...
- characters 454-1739: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1782-3878: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7678-8127: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11039-13646: `{{previous_actions}}` from the actor's own response from the previous turn
