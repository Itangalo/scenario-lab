...
- characters 13304-14533: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14577-16442: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16498-16846: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Critical Services Restoration Pact | 2 |
...
## Metrics
```json
{"ai_capability": 65.5, "openweight_capability": 63.3, "ai_safety": 7.0, "resilience": 40.5, "eu_ai_sovereignty": 20.0, "eu_political_capital": 17.0, "public_sentiment": 26.0}
```
