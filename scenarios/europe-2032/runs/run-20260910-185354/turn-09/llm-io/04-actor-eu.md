...
- characters 1728-3593: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5899-6364: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9223-11386: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Foundry Keep-Alive and Grid-Queue Pact | 4 | small | 8 | 10 | own jurisdiction | eu_ai_sovereignty up slightly, eu_political_capital down slightly | 2 | running |
