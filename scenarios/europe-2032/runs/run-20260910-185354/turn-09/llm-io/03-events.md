...
- characters 1650-3515: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3571-3919: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3982-30641: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30996-31566: `{{event_history}}` from the run's own event record
...
- Turn 5 (4 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise, member_state_defection, emergent_procurement_legal_freeze, election_alliance
- Turn 7 (2 turn(s) ago): capability_jump, ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, export_control_escalation, member_state_defection
