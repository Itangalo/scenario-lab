...
- characters 377-2037: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2081-4388: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4444-5349: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5412-32227: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32582-33384: `{{event_history}}` from the run's own event record
...
- Turn 5 (6 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise, member_state_defection, emergent_procurement_legal_freeze, election_alliance
- Turn 7 (4 turn(s) ago): capability_jump, ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, export_control_escalation, member_state_defection
- Turn 8 (3 turn(s) ago): research_breakthrough, taiwan_tension_rise
- Turn 9 (2 turn(s) ago): cyber_major_incident, opaque_reasoning, embodied_ai_deployment
- Turn 10 (1 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, knowledge_work_augmented, embodied_ai_deployment, supply_chain_coercion
