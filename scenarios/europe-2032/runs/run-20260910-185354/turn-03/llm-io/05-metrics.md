...
- characters 106-13411: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13454-13646: `{{metrics_json}}` from the run's live metric values
- characters 13739-15211: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15255-16907: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16963-17433: `{{notepad}}` from the Game Master's notepad, carried across turns
