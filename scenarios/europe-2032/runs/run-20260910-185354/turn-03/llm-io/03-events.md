...
- characters 1893-3545: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3601-4402: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4465-28692: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29047-29131: `{{event_history}}` from the run's own event record
