...
- characters 1397-3534: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3590-4068: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4131-31384: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31739-32080: `{{event_history}}` from the run's own event record
...
- Turn 5 (2 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise, member_state_defection, emergent_procurement_legal_freeze, election_alliance
