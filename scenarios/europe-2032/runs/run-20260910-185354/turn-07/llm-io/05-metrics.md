...
- characters 106-13460: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13503-13695: `{{metrics_json}}` from the run's live metric values
- characters 13788-14764: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14808-16945: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17001-17479: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Edge Resilience and Bio-Detection Surge | 2 |
