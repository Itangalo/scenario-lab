...
- characters 13778-15162: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15206-17446: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17502-18390: `{{notepad}}` from the Game Master's notepad, carried across turns
