...
- characters 455-1839: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1883-4123: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6174-6651: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9004-11213: `{{previous_actions}}` from the actor's own response from the previous turn
