...
- characters 1632-3627: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3683-4224: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4287-29596: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29951-30923: `{{event_history}}` from the run's own event record
...
- Turn 5 (8 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise, member_state_defection, emergent_procurement_legal_freeze, election_alliance
- Turn 7 (6 turn(s) ago): capability_jump, ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, export_control_escalation, member_state_defection
- Turn 8 (5 turn(s) ago): research_breakthrough, taiwan_tension_rise
- Turn 9 (4 turn(s) ago): cyber_major_incident, opaque_reasoning, embodied_ai_deployment
- Turn 10 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, knowledge_work_augmented, embodied_ai_deployment, supply_chain_coercion
- Turn 11 (2 turn(s) ago): us_china_agreement
- Turn 12 (1 turn(s) ago): cyber_major_incident, embodied_ai_deployment, eu_frontier_access_denied, joint_threat_response
