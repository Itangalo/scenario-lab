...
- characters 107-13279: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13322-13513: `{{metrics_json}}` from the run's live metric values
- characters 13606-14817: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14861-16856: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16912-17809: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t12: M13 EU Essential Services Islanding and Joint Response Pact −2, priority −1 = −3
PROPOSAL BONUS: M13 (cat 6, small) +4 — cyber_major_incident and eu_frontier_access_denied this turn, answers both directly on hospitals/ministries/ports
LEGITIMACY LENDS: capital 13, sentiment 26 -> +2
SOVEREIGNTY: 22 last turn, no capacity event finish, no cat4 in flight +0, eu_frontier_access_denied t12 −2 (largest of two capacity-takeaway events this turn, embodied_ai_deployment also qualifies), capability rose 1.0 no penalty = 20

## Emerging developments (tracked)

- `emergent_robot_fleet_brick` -- first noted turn 13, listed in 1 turn(s) so far: A major foreign logistics-robot vendor pushes a mandatory over-the-air control-model update that briefly bricks or degrades palletising fleets in EU ports, exposing remote kill-switch dependence and triggering seizure / escrow demands.
...
## Metrics
```json
{"ai_capability": 69.0, "openweight_capability": 67.1, "ai_safety": 3.0, "resilience": 47.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 13.0, "public_sentiment": 8.0}
```
...
## Notepad
PORTFOLIO CHARGE t13: (none in flight) = -0 + priority M14 −1 = −1
PROPOSAL BONUS: EU Bio-Containment and Care Continuity Shield (cat 6, small) +4 — bio_incident and cyber_major_incident this turn, answers both directly on hospitals/care continuity
LEGITIMACY LENDS: capital 13, sentiment 8 -> none (capital higher)
SOVEREIGNTY: 20 last turn, no cat4 finish +0, no cat4 in flight +0, export_control_escalation t13 −2, capability rose 1.0 no penalty = 18
