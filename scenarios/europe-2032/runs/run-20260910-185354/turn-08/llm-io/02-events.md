...
- characters 1487-3801: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3857-4396: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4459-31118: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31473-31974: `{{event_history}}` from the run's own event record
...
- Turn 5 (3 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise, member_state_defection, emergent_procurement_legal_freeze, election_alliance
- Turn 7 (1 turn(s) ago): capability_jump, ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, export_control_escalation, member_state_defection
