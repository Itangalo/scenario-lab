...
- characters 376-1722: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1765-3692: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3748-4501: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4564-29873: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30228-31077: `{{event_history}}` from the run's own event record
...
- Turn 5 (7 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise, member_state_defection, emergent_procurement_legal_freeze, election_alliance
- Turn 7 (5 turn(s) ago): capability_jump, ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, export_control_escalation, member_state_defection
- Turn 8 (4 turn(s) ago): research_breakthrough, taiwan_tension_rise
- Turn 9 (3 turn(s) ago): cyber_major_incident, opaque_reasoning, embodied_ai_deployment
- Turn 10 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, knowledge_work_augmented, embodied_ai_deployment, supply_chain_coercion
- Turn 11 (1 turn(s) ago): us_china_agreement
