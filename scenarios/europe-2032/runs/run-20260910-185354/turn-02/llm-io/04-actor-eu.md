...
- characters 454-1938: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1981-3994: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4361-4838: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6300-8328: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M3 | EU Grid and Port Cyber Shield | 6 | large | 1 | 3 | own jurisdiction | resilience up strongly, ai_safety up slightly via detection | 3 | running |
