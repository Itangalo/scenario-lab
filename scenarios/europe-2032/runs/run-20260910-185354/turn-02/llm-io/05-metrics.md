...
- characters 13364-14848: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14891-16904: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16960-18058: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | European Public Services AI Dividend | 2 |
...
- `emergent_datacentre_pause` -- first noted turn 1, listed in 2 turn(s) so far: A major non-EU cloud provider announces emergency power-price surcharges and pauses new EU datacentre leases after grid-connection queues lengthen, sharpening the siting debate without any EU decision causing it.
