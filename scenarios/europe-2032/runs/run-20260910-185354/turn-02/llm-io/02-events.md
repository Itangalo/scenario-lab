...
- characters 376-1860: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1903-3916: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3972-5070: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5133-29360: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29715-29756: `{{event_history}}` from the run's own event record
