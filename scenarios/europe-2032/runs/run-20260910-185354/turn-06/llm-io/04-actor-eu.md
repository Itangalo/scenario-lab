...
- characters 1559-4134: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4202-4667: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7192-9577: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Defensive Stack Deployment | 6 | small | 5 | 7 | own jurisdiction | resilience up strongly, ai_safety up slightly, public_sentiment up slightly | 2 | running |
