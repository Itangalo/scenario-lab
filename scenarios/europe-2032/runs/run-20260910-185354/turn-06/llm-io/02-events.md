...
- characters 1481-4056: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4112-4987: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5050-31700: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32055-32396: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, Credible Enforcement Repair −2, EU Defensive Stack Deployment −2, priority −1 = −11
PROPOSAL BONUS: EU Defensive Stack Deployment (cat 6, small) +2 — answers welfare-trust erosion and precursor pressure from last turns, small and just proposed
LEGITIMACY LENDS: capital 10, sentiment 32 -> +2
SOVEREIGNTY: 16 last turn, no cat4 finishes, Gigafactories + Tech package in flight +0, member_state_defection t5 −2, capability rose 1.0 no penalty = 14

## Emerging developments (tracked)

- `emergent_grid_connection_revolt` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated municipal and regional court challenges temporarily halt data-centre grid connections for gigafactory siting, citing costs and the welfare-scoring scandal, delaying EU compute build-out without a formal EU decision.
...
- Turn 2 (4 turn(s) ago): adoption_success
- Turn 3 (3 turn(s) ago): automated_decision_scandal
- Turn 4 (2 turn(s) ago): export_control_escalation
- Turn 5 (1 turn(s) ago): cyber_defence_breakthrough, taiwan_tension_rise, member_state_defection, emergent_procurement_legal_freeze, election_alliance
