...
- `two_year_commitment` (commitment): Prevent the frontier from escaping political control

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Prevent the frontier from escaping political control
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the two-year period directly changes the temporal basis on which the original commitment was made, altering the cost and relevance of maintaining the prior statement.
