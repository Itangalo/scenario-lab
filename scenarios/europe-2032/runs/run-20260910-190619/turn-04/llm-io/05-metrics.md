...
- characters 13364-14534: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14577-16417: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16473-17414: `{{notepad}}` from the Game Master's notepad, carried across turns
