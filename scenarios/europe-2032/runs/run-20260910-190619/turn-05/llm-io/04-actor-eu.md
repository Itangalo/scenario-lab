...
- characters 454-1766: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1810-3776: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5652-6129: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8095-9387: `{{previous_actions}}` from the actor's own response from the previous turn
