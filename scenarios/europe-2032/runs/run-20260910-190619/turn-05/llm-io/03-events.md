...
- characters 376-1688: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1732-3698: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3754-4697: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4760-33245: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33600-33708: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Infrastructure Shield −3, M4 European Assurance Transfer Cell −2, priority M3 −1 = −12
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2, sentiment 40 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, Gigafactories in flight +0, capability rose 2.0 −1 = 18

## Emerging developments (tracked)

- `emergent_factory_site_blockade` -- first noted turn 4, listed in 1 turn(s) so far: A coordinated physical protest campaign blocks permitting hearings and grid-connection works at the two shortlisted gigafactory sites, delaying site preparation by months.
- `emergent_shield_supply_chain_leak` -- first noted turn 4, listed in 1 turn(s) so far: A subcontractor supporting stalled Shield upgrades is breached, leaking segmentation plans and shared telemetry credentials for several eastern and southern operators.
...
- Turn 4 (1 turn(s) ago): bio_uplift_findings
