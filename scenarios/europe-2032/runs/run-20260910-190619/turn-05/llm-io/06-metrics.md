...
- characters 13548-13739: `{{metrics_json}}` from the run's live metric values
- characters 13832-15144: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15188-17154: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17210-18153: `{{notepad}}` from the Game Master's notepad, carried across turns
