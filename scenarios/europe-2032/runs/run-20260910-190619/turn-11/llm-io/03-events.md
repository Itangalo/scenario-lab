...
- characters 377-1020: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1064-2848: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 2904-3425: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3488-29276: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29631-30338: `{{event_history}}` from the run's own event record
...
- Turn 4 (7 turn(s) ago): bio_uplift_findings
- Turn 5 (6 turn(s) ago): cyber_major_incident, supply_chain_coercion, election_alliance
- Turn 6 (5 turn(s) ago): bio_incident, knowledge_work_augmented
- Turn 7 (4 turn(s) ago): knowledge_work_augmented, us_china_agreement
- Turn 8 (3 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, member_state_defection
- Turn 9 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, cyber_defence_breakthrough, bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, export_control_escalation, emergent_grid_permit_freeze
- Turn 10 (1 turn(s) ago): member_state_defection
