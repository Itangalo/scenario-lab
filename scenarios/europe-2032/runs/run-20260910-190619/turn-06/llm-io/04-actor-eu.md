...
- characters 453-1930: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1973-4294: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5698-6174: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8141-9948: `{{previous_actions}}` from the actor's own response from the previous turn
