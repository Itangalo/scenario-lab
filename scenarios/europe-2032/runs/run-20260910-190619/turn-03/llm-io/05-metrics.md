...
- characters 13365-14627: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14671-16509: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16565-17074: `{{notepad}}` from the Game Master's notepad, carried across turns
