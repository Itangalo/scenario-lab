...
- characters 377-1639: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1683-3521: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3577-4647: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4710-28937: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29292-29354: `{{event_history}}` from the run's own event record
