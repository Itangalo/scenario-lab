...
- characters 13364-14525: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14568-16899: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16955-18077: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | European Assurance Transfer Cell | 2 |
...
- `emergent_research_integrity_pact` -- first noted turn 1, listed in 2 turn(s) so far: Major EU scientific publishers and universities jointly mandate disclosure and watermarking of AI-generated research content after phage-design controversy spills into journals.
- `emergent_bioscreening_pledge` -- first noted turn 1, listed in 2 turn(s) so far: Major European research hospitals publish a joint moratorium call on open release of genome language models after the phage results, prompting a funder-led screening pledge.
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 50.0, "ai_safety": 37.0, "resilience": 37.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 27.0, "public_sentiment": 41.0}
```
...
## Notepad
PORTFOLIO CHARGE t2: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Infrastructure Shield −3, M4 European Assurance Transfer Cell −2, priority −1 = −12
PROPOSAL BONUS: none — no external event in last three turns that this small category 5 measure answers; autumn reconnaissance traces predate window and are not in event record
