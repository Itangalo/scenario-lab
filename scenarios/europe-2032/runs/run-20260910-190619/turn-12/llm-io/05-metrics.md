...
- characters 13580-13770: `{{metrics_json}}` from the run's live metric values
- characters 13863-14878: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14921-17201: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17257-18022: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Emergency Restoration and Bio-Sentinel Surge | 2 |
