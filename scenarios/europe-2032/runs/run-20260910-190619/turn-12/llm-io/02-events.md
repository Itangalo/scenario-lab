...
- characters 375-1390: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1433-3713: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3769-4235: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4298-29492: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29847-30648: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, safety_breakthrough
- Turn 4 (8 turn(s) ago): bio_uplift_findings
- Turn 5 (7 turn(s) ago): cyber_major_incident, supply_chain_coercion, election_alliance
- Turn 6 (6 turn(s) ago): bio_incident, knowledge_work_augmented
- Turn 7 (5 turn(s) ago): knowledge_work_augmented, us_china_agreement
- Turn 8 (4 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, member_state_defection
- Turn 9 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, cyber_defence_breakthrough, bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, export_control_escalation, emergent_grid_permit_freeze
- Turn 10 (2 turn(s) ago): member_state_defection
- Turn 11 (1 turn(s) ago): capability_jump, ai_investment_collapse, eu_frontier_access_denied
