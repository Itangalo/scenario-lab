...
- characters 1749-3982: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4362-4824: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7322-9451: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | EU Loss-of-Control Containment Drill | 6 | small | 9 | 11 | own jurisdiction | resilience up moderately, ai_safety up slightly via containment learning | 2 | running |
