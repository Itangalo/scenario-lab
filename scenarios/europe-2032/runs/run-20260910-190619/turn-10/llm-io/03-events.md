...
- characters 1671-3904: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3960-4406: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4469-29404: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29759-30415: `{{event_history}}` from the run's own event record
...
- Turn 4 (6 turn(s) ago): bio_uplift_findings
- Turn 5 (5 turn(s) ago): cyber_major_incident, supply_chain_coercion, election_alliance
- Turn 6 (4 turn(s) ago): bio_incident, knowledge_work_augmented
- Turn 7 (3 turn(s) ago): knowledge_work_augmented, us_china_agreement
- Turn 8 (2 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, member_state_defection
- Turn 9 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, cyber_defence_breakthrough, bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, export_control_escalation, emergent_grid_permit_freeze
