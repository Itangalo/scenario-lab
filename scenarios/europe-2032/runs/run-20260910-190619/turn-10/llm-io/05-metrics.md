...
- characters 13677-14929: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14972-17205: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17261-17707: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Loss-of-Control Containment Drill | 2 |
...
PORTFOLIO CHARGE t9: M6 Municipal Shield Patch Surge −2, M7 EU Loss-of-Control Containment Drill −2, priority −1 = −5
PROPOSAL BONUS: EU Loss-of-Control Containment Drill (cat 6, small) +2 — loss_of_control_incident landed this turn severe and this answers it directly with drills
LEGITIMACY LENDS: capital 7, sentiment 22 -> +2
SOVEREIGNTY: 16 last turn, no finish, no cat4 in flight, export_control_escalation t9 −2, capability rose 1.0 −0 = 14
