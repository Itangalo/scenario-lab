...
- characters 377-1735: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1779-3691: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3747-4470: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4533-29727: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30082-30952: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M10 EU Emergency Restoration and Bio-Sentinel Surge −2, priority −1 uncharged as capital <20 = −2
PROPOSAL BONUS: EU Emergency Restoration and Bio-Sentinel Surge (cat 6, small) +3 — cyber_major_incident this turn and bio precursor window, answers directly
LEGITIMACY LENDS: capital 10, sentiment 11 -> +1
SOVEREIGNTY: 9 last turn, no capacity event, no cat4 finish or in flight, capability rose 1.0 = 9

## Emerging developments (tracked)

- `emergent_distress_buyout` -- first noted turn 12, listed in 1 turn(s) so far: Gulf and Asian sovereign funds bulk-buy distressed EU AI hosting assets and cancelled factory-site options at fire-sale prices, shifting ownership offshore without adding capacity.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, safety_breakthrough
- Turn 4 (9 turn(s) ago): bio_uplift_findings
- Turn 5 (8 turn(s) ago): cyber_major_incident, supply_chain_coercion, election_alliance
- Turn 6 (7 turn(s) ago): bio_incident, knowledge_work_augmented
- Turn 7 (6 turn(s) ago): knowledge_work_augmented, us_china_agreement
- Turn 8 (5 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, member_state_defection
- Turn 9 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, cyber_defence_breakthrough, bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, export_control_escalation, emergent_grid_permit_freeze
- Turn 10 (3 turn(s) ago): member_state_defection
- Turn 11 (2 turn(s) ago): capability_jump, ai_investment_collapse, eu_frontier_access_denied
- Turn 12 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings
