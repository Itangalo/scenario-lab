...
- characters 107-12987: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13030-13221: `{{metrics_json}}` from the run's live metric values
- characters 13314-14672: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14716-16628: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16684-17407: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M11 | EU Middle-Power Access and Supply Pact | 2 |
...
- `emergent_distress_buyout` -- first noted turn 12, listed in 2 turn(s) so far: Gulf and Asian sovereign funds bulk-buy distressed EU AI hosting assets and cancelled factory-site options at fire-sale prices, shifting ownership offshore without adding capacity.
