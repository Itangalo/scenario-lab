...
- characters 1568-4004: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8230-8729: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11051-12950: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M6 | Municipal Shield Patch Surge | 6 | small | 8 | 10 | own jurisdiction | resilience up moderately, ai_safety up slightly via incident learning | 2 | running |
