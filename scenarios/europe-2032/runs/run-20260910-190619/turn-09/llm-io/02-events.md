...
- characters 376-1446: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1490-3926: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3982-5069: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5132-30067: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30422-30854: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M5 EU Accord Verification Cell −2, M6 Municipal Shield Patch Surge −2, priority no effect — capital below 20 = −4
PROPOSAL BONUS: Municipal Shield Patch Surge (cat 6, small) +2 — cyber_major_incident landed this turn severe and this answers it directly with breakthrough tooling
LEGITIMACY LENDS: capital 7, sentiment 26 -> +2
SOVEREIGNTY: 18 last turn, no finish, no cat4 in flight, member_state_defection t8 −2, capability rose 1.0 −0 = 16

## Emerging developments (tracked)

- `emergent_grid_sabotage_wave` -- first noted turn 7, listed in 2 turn(s) so far: A coordinated winter wave of physical blockades and sabotage against grid interconnectors and data-centre substations in several member states, organized outside formal unions and amplified by viral footage of sealed hospital wards.
- `emergent_grid_permit_freeze` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated blockades and legal challenges stall grid upgrades for the reserved gigafactory sites through autumn, forcing the Commission to pay reservation fees with no construction start.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, safety_breakthrough
- Turn 4 (5 turn(s) ago): bio_uplift_findings
- Turn 5 (4 turn(s) ago): cyber_major_incident, supply_chain_coercion, election_alliance
- Turn 6 (3 turn(s) ago): bio_incident, knowledge_work_augmented
- Turn 7 (2 turn(s) ago): knowledge_work_augmented, us_china_agreement
- Turn 8 (1 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, member_state_defection
