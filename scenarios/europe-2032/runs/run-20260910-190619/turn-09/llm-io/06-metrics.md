...
- characters 13415-13606: `{{metrics_json}}` from the run's live metric values
- characters 13699-14769: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14813-17249: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17305-17767: `{{notepad}}` from the Game Master's notepad, carried across turns
