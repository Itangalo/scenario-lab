...
- characters 1979-4140: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6109-6608: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8424-10483: `{{previous_actions}}` from the actor's own response from the previous turn
