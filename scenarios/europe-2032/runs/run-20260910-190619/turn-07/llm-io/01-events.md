...
- characters 1901-4062: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4118-4478: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4541-30982: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31337-31599: `{{event_history}}` from the run's own event record
...
- Turn 4 (3 turn(s) ago): bio_uplift_findings
- Turn 5 (2 turn(s) ago): cyber_major_incident, supply_chain_coercion, election_alliance
- Turn 6 (1 turn(s) ago): bio_incident, knowledge_work_augmented
