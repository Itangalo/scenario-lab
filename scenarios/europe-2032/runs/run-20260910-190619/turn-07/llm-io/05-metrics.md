...
- characters 106-13274: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13317-13509: `{{metrics_json}}` from the run's live metric values
- characters 13602-15082: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15126-17287: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17343-18328: `{{notepad}}` from the Game Master's notepad, carried across turns
