...
- characters 107-12969: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13012-13204: `{{metrics_json}}` from the run's live metric values
- characters 13297-14479: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14523-16277: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16333-16791: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M14 | EU Major Cyber Incident Containment | 2 |
