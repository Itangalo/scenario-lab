...
- characters 378-1560: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1604-3358: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3414-4209: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4272-31008: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31363-32761: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Shielded Care Restoration −2, priority −1 = −3
PROPOSAL BONUS: EU Shielded Care Restoration (cat 6, small) none — knowledge_work_augmented removes displacement crisis and no recent negative-event bonus applies despite cutoff/scandal
LEGITIMACY LENDS: capital 18, sentiment 15 -> none, capital higher
SOVEREIGNTY: 14.0 last turn, EU Care Continuity Reserve finishes t12 +4, member_state_defection t12 −2, capability rose 1.0 −0 = 16.0

## Emerging developments (tracked)

- `emergent_permit_backlash_after_blackout` -- first noted turn 11, listed in 2 turn(s) so far: Municipal paper fallback after the back-office blackout hardens into street-level resistance to new data-centre and compute permits, with councils linking permits to proven restoration of local services.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (11 turn(s) ago): bio_incident, emergent_third_pole_demo
- Turn 3 (10 turn(s) ago): capability_jump, safety_breakthrough, taiwan_tension_rise, export_control_escalation, emergent_datacentre_backlash
- Turn 4 (9 turn(s) ago): knowledge_work_augmented, automated_decision_scandal
- Turn 5 (8 turn(s) ago): cyber_major_incident, taiwan_tension_rise, member_state_defection, election_retrenchment
- Turn 6 (7 turn(s) ago): knowledge_work_augmented, emergent_utility_telemetry_lockin
- Turn 7 (6 turn(s) ago): ai_investment_collapse, safety_breakthrough, labour_displacement, eu_frontier_access_denied, middle_power_coalition
- Turn 8 (5 turn(s) ago): cyber_major_incident, openweight_frontier_release, joint_threat_response, emergent_gigafactory_injunction_wave
- Turn 9 (4 turn(s) ago): cyber_major_incident
- Turn 10 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, medical_breakthrough, safety_breakthrough, export_control_escalation
- Turn 11 (2 turn(s) ago): medical_breakthrough, eu_frontier_access_denied
- Turn 12 (1 turn(s) ago): capability_jump, eval_anomaly_reports, knowledge_work_augmented, embodied_ai_deployment, member_state_defection, adoption_success, automated_decision_scandal, joint_threat_response
