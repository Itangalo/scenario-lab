...
- characters 376-1705: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1748-3722: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3778-4342: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4405-27820: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28175-28520: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (2 turn(s) ago): bio_incident, emergent_third_pole_demo
- Turn 3 (1 turn(s) ago): capability_jump, safety_breakthrough, taiwan_tension_rise, export_control_escalation, emergent_datacentre_backlash
