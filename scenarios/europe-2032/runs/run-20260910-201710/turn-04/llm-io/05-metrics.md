...
- characters 105-13430: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13473-13665: `{{metrics_json}}` from the run's live metric values
- characters 13758-15087: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15130-17104: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17160-18315: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU High-Risk Enforcement and Redress Sweep | 2 |
