...
- characters 378-1447: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1491-4000: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4056-4462: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4525-31261: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31616-32729: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M11 EU Trusted Cure Deployment −2, priority −1 = −3
PROPOSAL BONUS: none — cat9 Trusted Cure answers medical breakthrough (positive) and chronic low sentiment, not a negative event from last three turns
LEGITIMACY LENDS: capital 14, sentiment 16 -> +1
SOVEREIGNTY: 18.0 last turn, no cat4 finishes, no cat4 in flight +0, export_control_escalation t10 −2, capability rose 0.8 −0 = 16.0
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (9 turn(s) ago): bio_incident, emergent_third_pole_demo
- Turn 3 (8 turn(s) ago): capability_jump, safety_breakthrough, taiwan_tension_rise, export_control_escalation, emergent_datacentre_backlash
- Turn 4 (7 turn(s) ago): knowledge_work_augmented, automated_decision_scandal
- Turn 5 (6 turn(s) ago): cyber_major_incident, taiwan_tension_rise, member_state_defection, election_retrenchment
- Turn 6 (5 turn(s) ago): knowledge_work_augmented, emergent_utility_telemetry_lockin
- Turn 7 (4 turn(s) ago): ai_investment_collapse, safety_breakthrough, labour_displacement, eu_frontier_access_denied, middle_power_coalition
- Turn 8 (3 turn(s) ago): cyber_major_incident, openweight_frontier_release, joint_threat_response, emergent_gigafactory_injunction_wave
- Turn 9 (2 turn(s) ago): cyber_major_incident
- Turn 10 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, medical_breakthrough, safety_breakthrough, export_control_escalation
