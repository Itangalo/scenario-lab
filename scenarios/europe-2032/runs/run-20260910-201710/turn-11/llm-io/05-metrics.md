...
- characters 107-13305: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13348-13540: `{{metrics_json}}` from the run's live metric values
- characters 13633-14702: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14746-17255: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17311-18054: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Care Continuity Reserve | 2 |
