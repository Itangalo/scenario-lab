...
- characters 13676-14601: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14645-16863: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16919-17441: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | EU Middle-Power Compute and Access Pact | 2 |
