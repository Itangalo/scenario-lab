...
- characters 376-1301: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1345-3563: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3619-4141: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4204-30681: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31036-31661: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (5 turn(s) ago): bio_incident, emergent_third_pole_demo
- Turn 3 (4 turn(s) ago): capability_jump, safety_breakthrough, taiwan_tension_rise, export_control_escalation, emergent_datacentre_backlash
- Turn 4 (3 turn(s) ago): knowledge_work_augmented, automated_decision_scandal
- Turn 5 (2 turn(s) ago): cyber_major_incident, taiwan_tension_rise, member_state_defection, election_retrenchment
- Turn 6 (1 turn(s) ago): knowledge_work_augmented, emergent_utility_telemetry_lockin
