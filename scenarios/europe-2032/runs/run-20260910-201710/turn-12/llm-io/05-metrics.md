...
- characters 106-13318: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13361-13553: `{{metrics_json}}` from the run's live metric values
- characters 13646-14752: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14795-16704: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16760-17555: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Shielded Care Restoration | 2 |
