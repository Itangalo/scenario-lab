...
- characters 377-1483: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1526-3435: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3491-4286: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4349-31085: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31440-32629: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M12 EU Care Continuity Reserve −2, priority −1 = −3
PROPOSAL BONUS: EU Care Continuity Reserve (cat 4, small) +2 — eu_frontier_access_denied fired this turn and this answers it directly by pinning clinical loads to EU/pact capacity
LEGITIMACY LENDS: capital 18, sentiment 15 -> none, capital higher
SOVEREIGNTY: 16.0 last turn, no cat4 finishes, M12 proposed this turn +0, eu_frontier_access_denied t11 −2, capability rose 0.8 −0 = 14.0

## Emerging developments (tracked)

- `emergent_permit_backlash_after_blackout` -- first noted turn 11, listed in 1 turn(s) so far: Municipal paper fallback after the back-office blackout hardens into street-level resistance to new data-centre and compute permits, with councils linking permits to proven restoration of local services.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (10 turn(s) ago): bio_incident, emergent_third_pole_demo
- Turn 3 (9 turn(s) ago): capability_jump, safety_breakthrough, taiwan_tension_rise, export_control_escalation, emergent_datacentre_backlash
- Turn 4 (8 turn(s) ago): knowledge_work_augmented, automated_decision_scandal
- Turn 5 (7 turn(s) ago): cyber_major_incident, taiwan_tension_rise, member_state_defection, election_retrenchment
- Turn 6 (6 turn(s) ago): knowledge_work_augmented, emergent_utility_telemetry_lockin
- Turn 7 (5 turn(s) ago): ai_investment_collapse, safety_breakthrough, labour_displacement, eu_frontier_access_denied, middle_power_coalition
- Turn 8 (4 turn(s) ago): cyber_major_incident, openweight_frontier_release, joint_threat_response, emergent_gigafactory_injunction_wave
- Turn 9 (3 turn(s) ago): cyber_major_incident
- Turn 10 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, medical_breakthrough, safety_breakthrough, export_control_escalation
