...
- characters 106-13500: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13543-13735: `{{metrics_json}}` from the run's live metric values
- characters 13828-15095: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15139-17273: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17329-18427: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.5, "openweight_capability": 57.4, "ai_safety": 28.0, "resilience": 42.5, "eu_ai_sovereignty": 14.0, "eu_political_capital": 8.0, "public_sentiment": 26.0}
```
## Narrative
