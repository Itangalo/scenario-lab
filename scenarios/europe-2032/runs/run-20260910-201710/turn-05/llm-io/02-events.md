...
- characters 377-1644: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1688-3822: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3878-4976: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5039-29131: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29486-29910: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Assured Deployment Standard −2, EU High-Risk Enforcement and Redress Sweep −2, priority −1 = −11
PROPOSAL BONUS: none — new sweep answers this turn's scandal, not an event from the last three rounds, and with no displacement crisis the public feels no problem to spend against
...
- `emergent_utility_telemetry_lockin` -- first noted turn 4, listed in 1 turn(s) so far: Municipal utilities hit by scripted intrusions jointly procure a managed detection service from a non-EU frontier lab, locking operational telemetry outside EU jurisdiction.
- `emergent_municipal_utility_outage` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated contractor breach disclosures force several municipalities to take billing and grid-management portals offline for weeks, turning cyber-tooling advance into a visible public-service outage.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (3 turn(s) ago): bio_incident, emergent_third_pole_demo
- Turn 3 (2 turn(s) ago): capability_jump, safety_breakthrough, taiwan_tension_rise, export_control_escalation, emergent_datacentre_backlash
- Turn 4 (1 turn(s) ago): knowledge_work_augmented, automated_decision_scandal
...
```
[{"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.4}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.15}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.25}, {"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.36}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.08}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.06}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.12}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.16}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.05}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.15}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.15}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Municipal utilities hit by scripted intrusions jointly procure a managed detection service from a non-EU frontier lab, locking operational telemetry outside EU jurisdiction.", "emergent": true, "id": "emergent_utility_telemetry_lockin", "probability": 0.18}, {"description": "Coordinated contractor breach disclosures force several municipalities to take billing and grid-management portals offline for weeks, turning cyber-tooling advance into a visible public-service outage.", "emergent": true, "id": "emergent_municipal_utility_outage", "probability": 0.2}]
```
