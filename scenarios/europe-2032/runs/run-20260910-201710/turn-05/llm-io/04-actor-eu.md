...
- characters 455-1722: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1766-3900: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5845-6286: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8560-10616: `{{previous_actions}}` from the actor's own response from the previous turn
