...
- characters 455-2598: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2642-5179: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5729-6187: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8767-10808: `{{previous_actions}}` from the actor's own response from the previous turn
