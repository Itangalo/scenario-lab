...
- characters 106-13281: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13324-13516: `{{metrics_json}}` from the run's live metric values
- characters 13609-15752: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15796-18333: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18389-19115: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Displaced Work Transition Guarantee | 2 |
...
## Metrics
```json
{"ai_capability": 64.8, "openweight_capability": 62.0, "ai_safety": 28.0, "resilience": 48.5, "eu_ai_sovereignty": 18.0, "eu_political_capital": 30.0, "public_sentiment": 17.0}
```
