...
- characters 105-13459: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13502-13694: `{{metrics_json}}` from the run's live metric values
- characters 13787-15297: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15340-17670: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17726-18518: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Joint Cyber Shield Accession | 2 |
