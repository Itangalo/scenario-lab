...
- characters 1880-4142: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4198-5023: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5086-28501: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28856-29060: `{{event_history}}` from the run's own event record
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (1 turn(s) ago): bio_incident, emergent_third_pole_demo
