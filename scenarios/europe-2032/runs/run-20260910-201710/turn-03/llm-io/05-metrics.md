...
- characters 106-13412: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13455-13647: `{{metrics_json}}` from the run's live metric values
- characters 13740-15199: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15243-17505: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17561-18070: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Biological Detection and Response Surge | 3 |
| M5 | EU Assured Deployment Standard | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −2, EU Biological Detection and Response Surge −3, priority −1 = −12
PROPOSAL BONUS: EU Biological Detection and Response Surge (cat 6, large) +5 — real bio incident with casualties and weeks-long containment landed this turn and this answers it directly
LEGITIMACY LENDS: capital 35, sentiment 36 -> +2
...
## Metrics
```json
{"ai_capability": 57.5, "openweight_capability": 53.2, "ai_safety": 31.0, "resilience": 40.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 28.0, "public_sentiment": 32.0}
```
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Biological Detection and Response Surge −3, EU Assured Deployment Standard −2, priority −1 = −12
PROPOSAL BONUS: EU Assured Deployment Standard (cat 5, small) +3 — capability_jump in verifiable domains landed this turn and safety_breakthrough gives certifiable content this answers directly
LEGITIMACY LENDS: capital 28, sentiment 32 -> +2
SOVEREIGNTY: 20 last turn, no category 4 finish, Gigafactories in flight +0, export_control_escalation t3 −2, capability rose 1.5 no charge = 18
