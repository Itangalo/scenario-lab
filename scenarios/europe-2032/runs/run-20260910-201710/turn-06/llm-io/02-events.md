...
- characters 375-1582: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1625-4022: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4078-5004: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5067-30941: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31296-31835: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, priority −1 = −7
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 6, sentiment 26 -> +2
SOVEREIGNTY: 17 last turn, no capacity event finish, M1/M2 in flight +0, member_state_defection t5 −2, capability rose 2.0 −1 = 14

## Emerging developments (tracked)

- `emergent_utility_telemetry_lockin` -- first noted turn 4, listed in 2 turn(s) so far: Municipal utilities hit by scripted intrusions jointly procure a managed detection service from a non-EU frontier lab, locking operational telemetry outside EU jurisdiction.
- `emergent_municipal_utility_outage` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated contractor breach disclosures force several municipalities to take billing and grid-management portals offline for weeks, turning cyber-tooling advance into a visible public-service outage.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (4 turn(s) ago): bio_incident, emergent_third_pole_demo
- Turn 3 (3 turn(s) ago): capability_jump, safety_breakthrough, taiwan_tension_rise, export_control_escalation, emergent_datacentre_backlash
- Turn 4 (2 turn(s) ago): knowledge_work_augmented, automated_decision_scandal
- Turn 5 (1 turn(s) ago): cyber_major_incident, taiwan_tension_rise, member_state_defection, election_retrenchment
