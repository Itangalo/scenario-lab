...
- characters 453-1660: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1703-4100: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5461-5919: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8194-10045: `{{previous_actions}}` from the actor's own response from the previous turn
