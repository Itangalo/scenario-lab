...
- characters 1331-3482: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3538-4272: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4335-30218: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30573-31524: `{{event_history}}` from the run's own event record
...
- `emergent_siting_freeze` -- first noted turn 8, listed in 2 turn(s) so far: Municipal water courts grant injunctions that freeze gigafactory construction through the turn, turning paper capacity into a national siting crisis.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, bio_uplift_findings, eval_anomaly_reports, openweight_frontier_release, knowledge_work_augmented
- Turn 2 (8 turn(s) ago): bio_incident, emergent_third_pole_demo
- Turn 3 (7 turn(s) ago): capability_jump, safety_breakthrough, taiwan_tension_rise, export_control_escalation, emergent_datacentre_backlash
- Turn 4 (6 turn(s) ago): knowledge_work_augmented, automated_decision_scandal
- Turn 5 (5 turn(s) ago): cyber_major_incident, taiwan_tension_rise, member_state_defection, election_retrenchment
- Turn 6 (4 turn(s) ago): knowledge_work_augmented, emergent_utility_telemetry_lockin
- Turn 7 (3 turn(s) ago): ai_investment_collapse, safety_breakthrough, labour_displacement, eu_frontier_access_denied, middle_power_coalition
- Turn 8 (2 turn(s) ago): cyber_major_incident, openweight_frontier_release, joint_threat_response, emergent_gigafactory_injunction_wave
