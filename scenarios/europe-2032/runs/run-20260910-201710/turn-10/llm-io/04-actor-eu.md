...
- characters 1409-3560: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6178-6623: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9412-11708: `{{previous_actions}}` from the actor's own response from the previous turn
