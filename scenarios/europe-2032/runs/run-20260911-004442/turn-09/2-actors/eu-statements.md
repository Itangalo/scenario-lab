...
- `two_year_commitment` (commitment): Hold essential services, jobs and democratic control together through broadly superhuman AI

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold essential services, jobs and democratic control together through broadly superhuman AI
