...
| M9 | EU Loss-of-Control Containment and Continuity Protocol | 6 | small | 7 | 9 | own jurisdiction | resilience up moderately, ai_safety protected | 2 | finished |
| M10 | EU Displacement Bridge and Retraining Guarantee | 7 | small | 8 | 10 | own jurisdiction | resilience up, public_sentiment up, eu_political_capital protected | 2 | running |
| M11 | EU Seat at the Safety Floor and Defensive Research Pact | 8 | small | 9 | 11 | US, China and coalition partners | ai_safety up, ai_capability growth slowed indirectly, eu_ai_sovereignty protected | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Seat at the Safety Floor and Defensive Research Pact", "category": 8, "size": "small", "finish_turn": 11, "applies_to": "US, China and coalition partners", "targeted_effect": "ai_safety up, ai_capability growth slowed indirectly, eu_ai_sovereignty protected"}, "grounds": "to join US-China safety floor while it is still forming"}
  - Grounds: to join US-China safety floor while it is still forming
