...
| M9 | EU Loss-of-Control Containment and Continuity Protocol | 6 | small | 7 | 9 | own jurisdiction | resilience up moderately, ai_safety protected | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Loss-of-Control Containment and Continuity Protocol", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected"}, "grounds": "to contain unsanctioned agentic action and keep services running through RSI"}
  - Grounds: to contain unsanctioned agentic action and keep services running through RSI
