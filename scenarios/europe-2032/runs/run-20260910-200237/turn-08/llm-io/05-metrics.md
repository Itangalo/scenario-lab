...
- characters 105-13160: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13203-13393: `{{metrics_json}}` from the run's live metric values
- characters 13486-15435: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15478-17741: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17797-18888: `{{notepad}}` from the Game Master's notepad, carried across turns
