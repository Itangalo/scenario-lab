...
- characters 374-2323: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2366-4629: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4685-5776: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5839-30270: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30625-31270: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: InvestAI Gigafactories −3, EU Graduate Transition Guarantee −2 = −5 + priority void (capital below 20, no cost) = −5
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 4, sentiment 13 -> +1 (capped below sentiment, before event deductions)
SOVEREIGNTY: 20 last turn, no capacity build finishes t7 +0, Gigafactories in flight +0 (stalled, no ground broken), supply_chain_coercion t7 −2, capability rose 0.6 −0 = 18

## Emerging developments (tracked)

- `emergent_public_sector_walkout` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated walkouts by junior doctors and court clerks over AI triage and casework errors force several health ministries to suspend foreign-model contracts and tender for EU-hosted alternatives.
- `emergent_anti_ai_electoral_surge` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated anti-AI municipal movements field candidates in upcoming national and regional votes, turning permit freezes and graduate job losses into an organized electoral bloc calling for moratoria on data centres.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, cyber_major_incident, adoption_success
- Turn 3 (5 turn(s) ago): openweight_frontier_release
- Turn 4 (4 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports
- Turn 5 (3 turn(s) ago): cyber_major_incident, openweight_frontier_release, taiwan_tension_rise, member_state_defection, automated_decision_scandal, election_retrenchment
- Turn 6 (2 turn(s) ago): labour_displacement, taiwan_tension_rise, eu_frontier_access_denied, emergent_permitting_freeze
- Turn 7 (1 turn(s) ago): loss_of_control_incident, bio_uplift_findings, supply_chain_coercion, automated_decision_scandal
