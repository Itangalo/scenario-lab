...
- characters 375-2487: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2531-4549: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4605-5601: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5664-30095: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30450-31165: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: (none) = −0 + priority void (no priority named) = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 5 -> +1 (capped below sentiment, before event deductions)
SOVEREIGNTY: 18 last turn, no capacity build finishes t8 +0, no measure in flight +0, middle_power_coalition t8 +2, capability rose 0.5 −0 = 20

## Emerging developments (tracked)

- `emergent_public_sector_walkout` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated walkouts by junior doctors and court clerks over AI triage and casework errors force several health ministries to suspend foreign-model contracts and tender for EU-hosted alternatives.
- `emergent_anti_ai_electoral_surge` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated anti-AI municipal movements field candidates in upcoming national and regional votes, turning permit freezes and graduate job losses into an organized electoral bloc calling for moratoria on data centres.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, cyber_major_incident, adoption_success
- Turn 3 (6 turn(s) ago): openweight_frontier_release
- Turn 4 (5 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports
- Turn 5 (4 turn(s) ago): cyber_major_incident, openweight_frontier_release, taiwan_tension_rise, member_state_defection, automated_decision_scandal, election_retrenchment
- Turn 6 (3 turn(s) ago): labour_displacement, taiwan_tension_rise, eu_frontier_access_denied, emergent_permitting_freeze
- Turn 7 (2 turn(s) ago): loss_of_control_incident, bio_uplift_findings, supply_chain_coercion, automated_decision_scandal
- Turn 8 (1 turn(s) ago): bio_uplift_findings, middle_power_coalition
