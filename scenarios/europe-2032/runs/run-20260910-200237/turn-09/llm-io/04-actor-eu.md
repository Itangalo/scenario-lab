...
- characters 453-2565: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2609-4627: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5305-5788: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7814-9536: `{{previous_actions}}` from the actor's own response from the previous turn
