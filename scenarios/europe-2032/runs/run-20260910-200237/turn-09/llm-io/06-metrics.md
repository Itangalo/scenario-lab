...
- characters 106-12732: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12775-12965: `{{metrics_json}}` from the run's live metric values
- characters 13058-15170: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15214-17232: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17288-17659: `{{notepad}}` from the Game Master's notepad, carried across turns
