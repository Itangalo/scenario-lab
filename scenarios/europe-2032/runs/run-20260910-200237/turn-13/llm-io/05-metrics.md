...
- characters 13060-15133: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15177-16970: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17026-17360: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t13: (none) = −0 + priority void (no priority named) = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 2 -> +1 (capped below sentiment, after event deductions)
SOVEREIGNTY: 20 last turn, no capacity event, no capacity build in flight +0, capability rose 0.6 −0 = 20
