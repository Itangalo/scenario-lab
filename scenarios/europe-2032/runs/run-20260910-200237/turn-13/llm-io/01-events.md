...
- characters 375-2448: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2492-4285: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4341-4675: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4738-29075: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29430-30392: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: (none) = −0 + priority void (no priority named) = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 3 -> +1 (capped below sentiment, before event deductions)
...
- Turn 4 (9 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports
- Turn 5 (8 turn(s) ago): cyber_major_incident, openweight_frontier_release, taiwan_tension_rise, member_state_defection, automated_decision_scandal, election_retrenchment
- Turn 6 (7 turn(s) ago): labour_displacement, taiwan_tension_rise, eu_frontier_access_denied, emergent_permitting_freeze
- Turn 7 (6 turn(s) ago): loss_of_control_incident, bio_uplift_findings, supply_chain_coercion, automated_decision_scandal
- Turn 8 (5 turn(s) ago): bio_uplift_findings, middle_power_coalition
- Turn 9 (4 turn(s) ago): opaque_reasoning
- Turn 11 (2 turn(s) ago): cyber_major_incident, medical_breakthrough, openweight_frontier_release, emergent_service_walkouts
