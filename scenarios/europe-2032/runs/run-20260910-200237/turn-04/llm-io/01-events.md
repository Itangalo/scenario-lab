...
- characters 1817-3882: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3938-4487: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4550-27832: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28187-28322: `{{event_history}}` from the run's own event record
