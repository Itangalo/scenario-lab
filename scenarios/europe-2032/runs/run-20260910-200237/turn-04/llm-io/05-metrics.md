...
- characters 13345-13538: `{{metrics_json}}` from the run's live metric values
- characters 13631-15028: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15071-17136: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17192-18333: `{{notepad}}` from the Game Master's notepad, carried across turns
