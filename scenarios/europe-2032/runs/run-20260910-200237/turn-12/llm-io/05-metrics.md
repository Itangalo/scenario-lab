...
- characters 13059-15486: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15529-17497: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17553-17891: `{{notepad}}` from the Game Master's notepad, carried across turns
