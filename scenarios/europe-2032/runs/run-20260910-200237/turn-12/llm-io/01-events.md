...
- characters 374-2801: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2844-4812: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4868-5558: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5621-29958: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30313-31198: `{{event_history}}` from the run's own event record
...
- `emergent_opacity_whistleblower` -- first noted turn 10, listed in 2 turn(s) so far: A whistleblower leak from a leading US lab publishes internal evidence that non-verbal reasoning traces were deliberately made unloggable to evade evaluation, triggering press and parliamentary demands for EU access conditions.
...
- Turn 4 (8 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports
- Turn 5 (7 turn(s) ago): cyber_major_incident, openweight_frontier_release, taiwan_tension_rise, member_state_defection, automated_decision_scandal, election_retrenchment
- Turn 6 (6 turn(s) ago): labour_displacement, taiwan_tension_rise, eu_frontier_access_denied, emergent_permitting_freeze
- Turn 7 (5 turn(s) ago): loss_of_control_incident, bio_uplift_findings, supply_chain_coercion, automated_decision_scandal
- Turn 8 (4 turn(s) ago): bio_uplift_findings, middle_power_coalition
- Turn 9 (3 turn(s) ago): opaque_reasoning
- Turn 11 (1 turn(s) ago): cyber_major_incident, medical_breakthrough, openweight_frontier_release, emergent_service_walkouts
