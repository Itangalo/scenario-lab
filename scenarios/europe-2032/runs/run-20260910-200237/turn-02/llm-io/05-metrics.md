...
- characters 105-12922: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12965-13157: `{{metrics_json}}` from the run's live metric values
- characters 13250-14301: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14344-16230: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16286-17684: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Frontier Monitoring Cell | 2 |
...
- `emergent_screening_failure_demo` -- first noted turn 1, listed in 2 turn(s) so far: A peer-reviewed replication study demonstrates end-to-end AI-assisted design and ordering of a novel bacteriophage evading voluntary DNA synthesis screening, triggering emergency biosecurity talks among synthesis providers.
- `emergent_research_provenance_pact` -- first noted turn 1, listed in 2 turn(s) so far: Major European scientific publishers and universities jointly mandate provenance watermarking and AI-use disclosure for papers and theses after phage-design controversy, creating de facto publication standard.
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 49.5, "ai_safety": 30.0, "resilience": 37.0, "eu_ai_sovereignty": 22.0, "eu_political_capital": 38.0, "public_sentiment": 38.0}
```
...
## Notepad
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Shield Hardening −3, EU Frontier Monitoring Cell −2, priority −1 = −12
PROPOSAL BONUS: EU Frontier Monitoring Cell (cat 5, small) +3 — autumn swarm undetected for weeks and Christmas automated strike last turn, this answers detection gap directly
LEGITIMACY LENDS: capital 36, sentiment 39 -> +2
SOVEREIGNTY: 22 last turn, no capacity event, Gigafactories/Tech package in flight +0, capability rose 1.5 −0 = 22
