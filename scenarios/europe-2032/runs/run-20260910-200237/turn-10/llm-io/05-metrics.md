...
- characters 106-12734: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12777-12966: `{{metrics_json}}` from the run's live metric values
- characters 13059-15747: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15790-17395: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17451-18383: `{{notepad}}` from the Game Master's notepad, carried across turns
