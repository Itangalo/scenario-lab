...
- characters 374-3062: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3105-4710: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4766-5099: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5162-28896: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29251-30009: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: (none) = −0 + priority void (no priority named) = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 9 -> +1 (capped below sentiment, before event deductions)
...
- Turn 4 (6 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports
- Turn 5 (5 turn(s) ago): cyber_major_incident, openweight_frontier_release, taiwan_tension_rise, member_state_defection, automated_decision_scandal, election_retrenchment
- Turn 6 (4 turn(s) ago): labour_displacement, taiwan_tension_rise, eu_frontier_access_denied, emergent_permitting_freeze
- Turn 7 (3 turn(s) ago): loss_of_control_incident, bio_uplift_findings, supply_chain_coercion, automated_decision_scandal
- Turn 8 (2 turn(s) ago): bio_uplift_findings, middle_power_coalition
- Turn 9 (1 turn(s) ago): opaque_reasoning
