...
- characters 452-3140: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3183-4788: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4856-5326: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7352-8906: `{{previous_actions}}` from the actor's own response from the previous turn
