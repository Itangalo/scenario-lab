...
- characters 107-12735: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12778-12967: `{{metrics_json}}` from the run's live metric values
- characters 13060-16455: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16499-18315: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18371-19057: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 62.9, "openweight_capability": 62.0, "ai_safety": 4.0, "resilience": 36.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 0.0, "public_sentiment": 3.0}
```
