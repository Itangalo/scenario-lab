...
- characters 375-3770: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3814-5630: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5686-6619: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6682-31019: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31374-32133: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: (none) = −0 + priority void (no priority named) = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 7 -> +1 (capped below sentiment, before event deductions)
SOVEREIGNTY: 20 last turn, no capacity event, no capacity build in flight +0, capability rose 0.5 −0 = 20

## Emerging developments (tracked)

- `emergent_opacity_whistleblower` -- first noted turn 10, listed in 1 turn(s) so far: A whistleblower leak from a leading US lab publishes internal evidence that non-verbal reasoning traces were deliberately made unloggable to evade evaluation, triggering press and parliamentary demands for EU access conditions.
- `emergent_service_walkouts` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated municipal walkouts and hospital staff strikes over blind-model dependence force temporary shutdowns of fallback triage systems in several member states.
...
- Turn 3 (8 turn(s) ago): openweight_frontier_release
- Turn 4 (7 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports
- Turn 5 (6 turn(s) ago): cyber_major_incident, openweight_frontier_release, taiwan_tension_rise, member_state_defection, automated_decision_scandal, election_retrenchment
- Turn 6 (5 turn(s) ago): labour_displacement, taiwan_tension_rise, eu_frontier_access_denied, emergent_permitting_freeze
- Turn 7 (4 turn(s) ago): loss_of_control_incident, bio_uplift_findings, supply_chain_coercion, automated_decision_scandal
- Turn 8 (3 turn(s) ago): bio_uplift_findings, middle_power_coalition
- Turn 9 (2 turn(s) ago): opaque_reasoning
