...
- characters 375-1909: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1952-4261: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4317-5292: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5355-26676: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27031-27431: `{{event_history}}` from the run's own event record
...
- `emergent_permitting_freeze` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated municipal backlash halts data-centre and sensor-site permitting in several member states, with court injunctions citing fraud, energy costs and health-system strain.
- `emergent_misuse_liability_litigation` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated municipal lawsuits against distributors and AI deployers over fraud losses and hospital outages force courts to rule on liability for open-model misuse, creating an EU-wide precedent debate.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, cyber_major_incident, adoption_success
- Turn 3 (3 turn(s) ago): openweight_frontier_release
- Turn 4 (2 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports
- Turn 5 (1 turn(s) ago): cyber_major_incident, openweight_frontier_release, taiwan_tension_rise, member_state_defection, automated_decision_scandal, election_retrenchment
