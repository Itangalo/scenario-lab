...
- characters 453-1987: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2030-4339: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5610-6093: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8205-9859: `{{previous_actions}}` from the actor's own response from the previous turn
