...
- characters 106-12850: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12893-13084: `{{metrics_json}}` from the run's live metric values
- characters 13177-14674: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14718-16669: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16725-17876: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 60.8, "openweight_capability": 59.1, "ai_safety": 19.0, "resilience": 41.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 0.0, "public_sentiment": 5.0}
```
