...
- characters 1917-3868: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3924-4450: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4513-28944: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29299-29821: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, cyber_major_incident, adoption_success
- Turn 3 (4 turn(s) ago): openweight_frontier_release
- Turn 4 (3 turn(s) ago): cyber_major_incident, ai_investment_collapse, eval_anomaly_reports
- Turn 5 (2 turn(s) ago): cyber_major_incident, openweight_frontier_release, taiwan_tension_rise, member_state_defection, automated_decision_scandal, election_retrenchment
- Turn 6 (1 turn(s) ago): labour_displacement, taiwan_tension_rise, eu_frontier_access_denied, emergent_permitting_freeze
