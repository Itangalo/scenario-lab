...
- characters 2644-3143: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 56.5, "openweight_capability": 50.5, "ai_safety": 28.0, "resilience": 36.0, "eu_ai_sovereignty": 22.0, "eu_political_capital": 28.0, "public_sentiment": 36.0}
```
