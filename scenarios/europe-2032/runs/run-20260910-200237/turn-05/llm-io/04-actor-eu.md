...
- characters 2087-4281: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7877-8339: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10449-11844: `{{previous_actions}}` from the actor's own response from the previous turn
