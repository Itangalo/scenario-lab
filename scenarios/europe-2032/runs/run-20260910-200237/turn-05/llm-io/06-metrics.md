...
- characters 106-13264: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13307-13499: `{{metrics_json}}` from the run's live metric values
- characters 13592-15180: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15224-17418: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17474-18482: `{{notepad}}` from the Game Master's notepad, carried across turns
