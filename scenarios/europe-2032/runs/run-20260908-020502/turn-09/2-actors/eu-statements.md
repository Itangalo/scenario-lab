...
- `two_year_commitment` (commitment): Keep sovereign control over AI systems operating in or affecting the EU

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Keep sovereign control over AI systems operating in or affecting the EU
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The commitment's expiry directly changes the actor's obligation to uphold the original statement, triggering a necessary reassessment of its position.
