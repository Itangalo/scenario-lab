...
- characters 1974-3821: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6467-6907: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9232-11398: `{{previous_actions}}` from the actor's own response from the previous turn
