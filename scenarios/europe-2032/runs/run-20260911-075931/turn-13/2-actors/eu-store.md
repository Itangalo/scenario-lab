...
| M11 | EU Swarm-Defence and Auto-Patch Deployment Pact | 6 | small | 11 | 13 | own jurisdiction | resilience up moderately, ai_safety protected | 2 | finished |
| M12 | EU Visible Relief Scale-Up for Care and Administration | 9 | small | 12 | 14 | own jurisdiction | public_sentiment up, resilience up modestly, eu_political_capital protected | 2 | running |
| M13 | EU Wartime Continuity and Neutral Shelter Pact | 6 | small | 13 | 15 | own jurisdiction | resilience up moderately, eu_political_capital protected | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Wartime Continuity and Neutral Shelter Pact", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital protected"}, "grounds": "to hold services through war targeting Europe-adjacent infrastructure"}
  - Grounds: to hold services through war targeting Europe-adjacent infrastructure
