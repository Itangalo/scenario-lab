...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Swarm-Defence and Auto-Patch Deployment Pact", "category": 6, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected"}, "grounds": "to exploit defence breakthrough and joint response against loose agent"}
  - Grounds: to exploit defence breakthrough and joint response against loose agent
