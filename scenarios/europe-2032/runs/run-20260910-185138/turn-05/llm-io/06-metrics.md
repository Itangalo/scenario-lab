...
- characters 13882-15814: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15858-18388: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18444-19498: `{{notepad}}` from the Game Master's notepad, carried across turns
