...
- characters 2431-4961: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6220-6701: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8820-10425: `{{previous_actions}}` from the actor's own response from the previous turn
