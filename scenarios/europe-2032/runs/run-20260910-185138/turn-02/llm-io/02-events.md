...
- characters 376-1439: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1482-3435: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3491-4696: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4759-28041: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28396-28437: `{{event_history}}` from the run's own event record
