...
- characters 2060-4229: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4285-4794: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4857-29206: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29561-30080: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): export_control_escalation, emergent_synthesis_screening_pact
- Turn 3 (4 turn(s) ago): emergent_eval_leak_pressure
- Turn 4 (3 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, automated_decision_scandal
- Turn 5 (2 turn(s) ago): export_control_escalation, election_consolidation
- Turn 6 (1 turn(s) ago): ai_investment_collapse, labour_displacement, knowledge_work_augmented, emergent_disclosure_template_freeze, emergent_full_eval_dump
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.03}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.05}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.07}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.04}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.15}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.05}, {"description": "Coordinated graduate-led blockades of data-centre and gigafactory construction sites in several member states, forcing temporary work stoppages and a national debate on AI jobs versus infrastructure.", "emergent": true, "id": "emergent_site_blockades", "probability": 0.18}]
```
