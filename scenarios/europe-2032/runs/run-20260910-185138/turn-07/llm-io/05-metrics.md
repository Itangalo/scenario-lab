...
- characters 106-12909: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12952-13144: `{{metrics_json}}` from the run's live metric values
- characters 13237-14876: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14920-17089: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17145-18217: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Essential Services Continuity Reserve | 2 |
...
- `emergent_youth_site_blockades` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated graduate-led blockades of data-centre and gigafactory sites in three or more member states force a temporary construction halt and policing response.
- `emergent_site_blockades` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated graduate-led blockades of data-centre and gigafactory construction sites in several member states, forcing temporary work stoppages and a national debate on AI jobs versus infrastructure.
...
## Metrics
```json
{"ai_capability": 61.5, "openweight_capability": 58.8, "ai_safety": 20.0, "resilience": 39.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 6.0, "public_sentiment": 9.0}
```
...
## Notepad
PORTFOLIO CHARGE t7: M1 InvestAI Gigafactories −3, M6 EU Displaced Workers Transition Fund −2, M7 EU Essential Services Continuity Reserve −2, priority −1 = −8
PROPOSAL BONUS: EU Essential Services Continuity Reserve (cat 6, small) +3 — cyber_major_incident and eu_frontier_access_denied fired this turn and this answers both directly
LEGITIMACY LENDS: capital 6, sentiment 9 -> +1
SOVEREIGNTY: 21 last turn, no finish, M1 InvestAI Gigafactories in flight +0, eu_frontier_access_denied t7 −2, capability rose 1.0 −0 = 19
