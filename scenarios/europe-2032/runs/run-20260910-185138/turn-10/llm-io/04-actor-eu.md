...
- characters 2217-4727: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6128-6595: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9355-11706: `{{previous_actions}}` from the actor's own response from the previous turn
