...
- characters 2139-4649: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4705-5509: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5572-30524: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30879-31623: `{{event_history}}` from the run's own event record
...
- `emergent_side_deal_cascade` -- first noted turn 9, listed in 1 turn(s) so far: Two more capitals break cover to sign separate cut-price hosting deals for hospitals and municipalities, openly citing the first side deal and forcing the Commission to run parallel audited emergency connections.
...
- Turn 2 (8 turn(s) ago): export_control_escalation, emergent_synthesis_screening_pact
- Turn 3 (7 turn(s) ago): emergent_eval_leak_pressure
- Turn 4 (6 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, automated_decision_scandal
- Turn 5 (5 turn(s) ago): export_control_escalation, election_consolidation
- Turn 6 (4 turn(s) ago): ai_investment_collapse, labour_displacement, knowledge_work_augmented, emergent_disclosure_template_freeze, emergent_full_eval_dump
- Turn 7 (3 turn(s) ago): cyber_major_incident, eu_frontier_access_denied
- Turn 8 (2 turn(s) ago): member_state_defection, emergent_youth_site_blockades
- Turn 9 (1 turn(s) ago): medical_breakthrough, middle_power_coalition
