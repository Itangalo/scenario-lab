...
- characters 13601-15320: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15363-17873: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17929-18733: `{{notepad}}` from the Game Master's notepad, carried across turns
