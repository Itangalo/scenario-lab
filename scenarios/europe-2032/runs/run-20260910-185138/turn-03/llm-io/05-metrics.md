...
- characters 106-12976: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13019-13211: `{{metrics_json}}` from the run's live metric values
- characters 13304-14702: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14746-16821: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16877-17377: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Frontier Disclosure Mandate | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Cyber Shield −3, Joint Supply-Chain Leverage Pact −2, priority −1 = −12
PROPOSAL BONUS: Joint Supply-Chain Leverage Pact (cat 8, small) +2 — export_control_escalation landed this turn and this answers it directly
LEGITIMACY LENDS: capital 35, sentiment 37 -> +1
SOVEREIGNTY: 22 last turn, no capacity event finish, Gigafactories in flight +0, export_control_escalation t2 −2, capability rose 1.5 −0 = 20
