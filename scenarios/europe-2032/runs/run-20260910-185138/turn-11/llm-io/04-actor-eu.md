...
- characters 456-1786: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1830-4134: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4951-5433: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8569-11492: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Bio-Continuity Shield and Single-Line Enforcement | 6 | small | 10 | 12 | own jurisdiction | resilience up substantially, ai_safety up slightly, eu_political_capital up slightly if defections stop | 2 | running |
