...
- characters 107-12913: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12956-13148: `{{metrics_json}}` from the run's live metric values
- characters 13241-14571: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14615-16919: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16975-17514: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Bio-Continuity Shield and Single-Line Enforcement | 2 |
