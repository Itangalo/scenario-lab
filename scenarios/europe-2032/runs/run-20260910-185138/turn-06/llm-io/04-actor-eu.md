...
- characters 2384-4483: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6235-6698: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8818-10731: `{{previous_actions}}` from the actor's own response from the previous turn
