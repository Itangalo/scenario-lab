...
- characters 376-2183: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2226-4603: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4659-5160: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5223-28505: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28860-29042: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): export_control_escalation, emergent_synthesis_screening_pact
- Turn 3 (1 turn(s) ago): emergent_eval_leak_pressure
