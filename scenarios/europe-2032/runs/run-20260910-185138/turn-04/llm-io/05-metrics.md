...
- characters 13303-15110: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15153-17530: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17586-18767: `{{notepad}}` from the Game Master's notepad, carried across turns
