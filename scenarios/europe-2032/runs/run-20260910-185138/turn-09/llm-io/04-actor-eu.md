...
- characters 454-2068: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2112-3897: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4820-5283: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7830-9914: `{{previous_actions}}` from the actor's own response from the previous turn
