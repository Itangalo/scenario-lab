...
- characters 376-1990: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2034-3819: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3875-4656: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4719-29671: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30026-30699: `{{event_history}}` from the run's own event record
...
- Turn 2 (7 turn(s) ago): export_control_escalation, emergent_synthesis_screening_pact
- Turn 3 (6 turn(s) ago): emergent_eval_leak_pressure
- Turn 4 (5 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, automated_decision_scandal
- Turn 5 (4 turn(s) ago): export_control_escalation, election_consolidation
- Turn 6 (3 turn(s) ago): ai_investment_collapse, labour_displacement, knowledge_work_augmented, emergent_disclosure_template_freeze, emergent_full_eval_dump
- Turn 7 (2 turn(s) ago): cyber_major_incident, eu_frontier_access_denied
- Turn 8 (1 turn(s) ago): member_state_defection, emergent_youth_site_blockades
