...
- characters 377-1301: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1344-3575: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3631-4232: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4295-28435: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28790-29693: `{{event_history}}` from the run's own event record
...
- Turn 2 (10 turn(s) ago): export_control_escalation, emergent_synthesis_screening_pact
- Turn 3 (9 turn(s) ago): emergent_eval_leak_pressure
- Turn 4 (8 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, automated_decision_scandal
- Turn 5 (7 turn(s) ago): export_control_escalation, election_consolidation
- Turn 6 (6 turn(s) ago): ai_investment_collapse, labour_displacement, knowledge_work_augmented, emergent_disclosure_template_freeze, emergent_full_eval_dump
- Turn 7 (5 turn(s) ago): cyber_major_incident, eu_frontier_access_denied
- Turn 8 (4 turn(s) ago): member_state_defection, emergent_youth_site_blockades
- Turn 9 (3 turn(s) ago): medical_breakthrough, middle_power_coalition
- Turn 10 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, member_state_defection
- Turn 11 (1 turn(s) ago): bio_incident, middle_power_coalition
