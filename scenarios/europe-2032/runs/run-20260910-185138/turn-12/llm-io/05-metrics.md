...
- characters 106-13363: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13406-13598: `{{metrics_json}}` from the run's live metric values
- characters 13691-14615: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14658-16889: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16945-17887: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Middle-Power Bio-Containment and Compute Access Compact | 2 |
