...
- characters 107-13379: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13422-13614: `{{metrics_json}}` from the run's live metric values
- characters 13707-14913: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14957-16783: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16839-17430: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Bio-Lab Recovery and Municipal Response Staffing Surge | 2 |
| M13 | EU Accession Track to the US-China AI Risk Floor and Joint Verification Cell | 2 |
