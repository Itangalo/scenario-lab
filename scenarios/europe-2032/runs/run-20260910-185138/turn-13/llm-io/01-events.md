...
- characters 378-1584: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1628-3454: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3510-4442: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4505-29498: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29853-30757: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M11 EU Middle-Power Bio-Containment and Compute Access Compact −2, M12 EU Bio-Lab Recovery and Municipal Response Staffing Surge −2 = −4 [priority cost void under rule 10 as capital 12 <20]
PROPOSAL BONUS: EU Bio-Lab Recovery and Municipal Response Staffing Surge (cat 6, small) +2 — autumn designed-pathogen outbreak contained last turn, labs exhausted, this answers staffing gap directly
LEGITIMACY LENDS: capital 13, sentiment 12 -> none [capital higher]
SOVEREIGNTY: 21 last turn, no cat4 finish, no cat4 in flight +0, no capacity event, capability rose 0.7 −0 = 21

## Emerging developments (tracked)

- `emergent_genome_publication_moratorium_push` -- first noted turn 12, listed in 1 turn(s) so far: WHO-led inquiry into the autumn designed-pathogen outbreak names published genome-model methods as an enabling factor, triggering calls for binding pre-publication review that split journals and funders.
...
- Turn 2 (11 turn(s) ago): export_control_escalation, emergent_synthesis_screening_pact
- Turn 3 (10 turn(s) ago): emergent_eval_leak_pressure
- Turn 4 (9 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, automated_decision_scandal
- Turn 5 (8 turn(s) ago): export_control_escalation, election_consolidation
- Turn 6 (7 turn(s) ago): ai_investment_collapse, labour_displacement, knowledge_work_augmented, emergent_disclosure_template_freeze, emergent_full_eval_dump
- Turn 7 (6 turn(s) ago): cyber_major_incident, eu_frontier_access_denied
- Turn 8 (5 turn(s) ago): member_state_defection, emergent_youth_site_blockades
- Turn 9 (4 turn(s) ago): medical_breakthrough, middle_power_coalition
- Turn 10 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, member_state_defection
- Turn 11 (2 turn(s) ago): bio_incident, middle_power_coalition
