...
- characters 374-1813: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1856-3685: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3741-4824: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4887-29236: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29591-30184: `{{event_history}}` from the run's own event record
...
- Turn 2 (6 turn(s) ago): export_control_escalation, emergent_synthesis_screening_pact
- Turn 3 (5 turn(s) ago): emergent_eval_leak_pressure
- Turn 4 (4 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, automated_decision_scandal
- Turn 5 (3 turn(s) ago): export_control_escalation, election_consolidation
- Turn 6 (2 turn(s) ago): ai_investment_collapse, labour_displacement, knowledge_work_augmented, emergent_disclosure_template_freeze, emergent_full_eval_dump
- Turn 7 (1 turn(s) ago): cyber_major_incident, eu_frontier_access_denied
