...
- characters 105-13552: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13595-13785: `{{metrics_json}}` from the run's live metric values
- characters 13878-15317: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15360-17189: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17245-18081: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Youth Construction and Jobs Compact | 2 |
...
- `emergent_site_blockades` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated graduate-led blockades of data-centre and gigafactory construction sites in several member states, forcing temporary work stoppages and a national debate on AI jobs versus infrastructure.
