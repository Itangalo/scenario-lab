...
- `two_year_commitment` (commitment): Secure autonomous AI capability to defend European sovereignty and manage systemic risk without dependency

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure autonomous AI capability to defend European sovereignty and manage systemic risk without dependency
