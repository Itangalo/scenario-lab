...
- `two_year_commitment` (commitment): Secure foundational AI capacity under EU control while building resilience to systemic risk

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure foundational AI capacity under EU control while building resilience to systemic risk
