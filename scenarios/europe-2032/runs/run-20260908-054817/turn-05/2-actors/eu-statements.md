...
- `two_year_commitment` (commitment): Maintain sovereign access to AI systems capable of defending EU interests in a world where control is increasingly fragile

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Maintain sovereign access to AI systems capable of defending EU interests in a world where control is increasingly fragile
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the commitment period directly changes the actor's obligation to uphold the original statement, triggering a natural reassessment of its position.
