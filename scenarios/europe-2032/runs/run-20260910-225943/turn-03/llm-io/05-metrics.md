...
- characters 106-13160: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13203-13395: `{{metrics_json}}` from the run's live metric values
- characters 13488-14800: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14844-16682: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16738-17908: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 52.0, "ai_safety": 28.0, "resilience": 36.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 9.0, "public_sentiment": 37.0}
```
## Narrative
