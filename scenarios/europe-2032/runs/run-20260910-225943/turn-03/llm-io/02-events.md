...
- characters 377-1689: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1733-3571: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3627-4797: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4860-29087: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29442-29483: `{{event_history}}` from the run's own event record
