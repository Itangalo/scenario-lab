...
- characters 105-13642: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13685-13877: `{{metrics_json}}` from the run's live metric values
- characters 13970-15417: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15460-18018: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18074-18470: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Lithography Leverage and Joint Shield Accession | 2 |
...
## Metrics
```json
{"ai_capability": 60.0, "openweight_capability": 55.0, "ai_safety": 27.0, "resilience": 42.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 12.0, "public_sentiment": 32.0}
```
