...
- `two_year_commitment` (commitment): Hold essential services running on trusted AI through allied shelter and shared defence

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold essential services running on trusted AI through allied shelter and shared defence
