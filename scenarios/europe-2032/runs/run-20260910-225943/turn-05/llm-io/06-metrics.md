...
- characters 13497-14780: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14824-17134: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17190-18308: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | Municipal Continuity and Bio-Response Bridge | 2 |
...
- `emergent_foundry_side_deal` -- first noted turn 5, listed in 1 turn(s) so far: With chip shipments stopped by the Taiwan quarantine, a major Asian foundry offers the EU guaranteed emergency allocations in exchange for continued lithography servicing and a carve-out from US export rules.
- `emergent_quarantine_grey_market` -- first noted turn 5, listed in 1 turn(s) so far: Grey-market brokers route quarantined accelerators and grid-control spares via third countries at 5-10x prices, with counterfeit and trojaned lots entering EU supply chains.
