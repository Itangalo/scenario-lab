...
- characters 455-1738: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1782-4092: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6516-6956: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9134-11421: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU Lithography Leverage and Joint Shield Accession | 8 | small | 4 | 6 | coalition plus own jurisdiction | resilience up via joint telemetry and biosurveillance; eu_ai_sovereignty up modestly via supply-chain leverage | 2 | running |
