...
- characters 377-1660: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1704-4014: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4070-4599: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4662-32429: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32784-33034: `{{event_history}}` from the run's own event record
...
- Turn 3 (2 turn(s) ago): cyber_major_incident, openweight_frontier_release, knowledge_work_augmented, taiwan_tension_rise
- Turn 4 (1 turn(s) ago): taiwan_blockade, bio_uplift_findings, joint_threat_response
