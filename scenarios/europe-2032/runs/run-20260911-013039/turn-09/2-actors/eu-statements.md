...
- `two_year_commitment` (commitment): Deploy proven safety and defensive tooling to restore trustworthy services on EU-controlled capacity

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Deploy proven safety and defensive tooling to restore trustworthy services on EU-controlled capacity
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the timeframe for the original pledge, changing the cost of maintaining it and enabling a pivot to a new implementation under the same strategic objective.
