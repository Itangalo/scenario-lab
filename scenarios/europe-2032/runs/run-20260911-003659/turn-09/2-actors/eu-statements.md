...
- `two_year_commitment` (commitment): Restore trusted public services and livelihoods under EU control

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Restore trusted public services and livelihoods under EU control
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the timeframe for the original statement, changing the cost of maintaining it and triggering a necessary update.
