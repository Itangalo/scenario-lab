...
| M7 | Municipal Cyber Mutual-Aid Pact | 6 | small | 8 | 10 | own jurisdiction | resilience up, eu_political_capital up modestly via visible response | 2 | running |
| M8 | Joint Cyber Shield Accession | 8 | small | 9 | 11 | coalition of EU and states hit by same incident class | resilience up via pooled telemetry and response | 2 | running |
...
- **applied** `M8` — {"op": "add", "table": "measures", "fields": {"name": "Joint Cyber Shield Accession", "category": 8, "size": "small", "finish_turn": 11, "applies_to": "coalition of EU and states hit by same incident class", "targeted_effect": "resilience up via pooled telemetry and response"}, "grounds": "accepting joint threat response invitation while solo capacity stalled"}
  - Grounds: accepting joint threat response invitation while solo capacity stalled
