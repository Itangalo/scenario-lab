...
- `two_year_commitment` (commitment): Rebuild sovereign AI capacity and hardened resilience to restore the Union's ability to act

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild sovereign AI capacity and hardened resilience to restore the Union's ability to act
