...
- **applied** `M7` — {"op": "add", "table": "measures", "fields": {"name": "Municipal Cyber Mutual-Aid Pact", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_political_capital up modestly via visible response"}, "grounds": "answering major cyber incident with no capital for large build"}
  - Grounds: answering major cyber incident with no capital for large build
