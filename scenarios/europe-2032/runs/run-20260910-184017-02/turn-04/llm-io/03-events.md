...
- characters 1541-3523: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3579-4005: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4068-25274: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 25629-25867: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, bio_uplift_findings, safety_breakthrough
- Turn 2 (2 turn(s) ago): cyber_defence_breakthrough, us_china_agreement
- Turn 3 (1 turn(s) ago): emergent_ai_fraud_wave, emergent_lab_whistleblower_leak
