...
- characters 105-13337: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13380-13572: `{{metrics_json}}` from the run's live metric values
- characters 13665-14787: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14830-16812: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16868-17612: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Cyber-Bio Surge Response | 2 |
...
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M5 EU Trust Shield Against AI Fraud −2, priority −1 = −9
PROPOSAL BONUS: EU Trust Shield (cat 9, small) +3 — emergent_ai_fraud_wave landed this turn and this answers it directly
LEGITIMACY LENDS: capital 30, sentiment 40 -> +1
SOVEREIGNTY: 21 last turn, no capacity event, no finish this turn, in-flight partial +0, capability rose 2.0 −1 = 20
