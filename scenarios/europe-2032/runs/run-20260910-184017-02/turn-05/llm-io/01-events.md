...
- characters 1518-3694: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3750-4525: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4588-26471: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26826-27153: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M6 EU Cyber-Bio Surge Response −2, priority −1 = −9
PROPOSAL BONUS: EU Cyber-Bio Surge Response (cat 6, small) +4 — cyber_major_incident and bio_uplift_findings landed this turn and this answers them directly
LEGITIMACY LENDS: capital 31, sentiment 36 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, no finish this turn, in-flight partial +0, capability rose 2.0 −1 = 19

## Emerging developments (tracked)

- `emergent_anti_datacentre_backlash` -- first noted turn 4, listed in 1 turn(s) so far: A coordinated campaign physically targets data-centre construction and grid connections in two member states after fraud losses and power-bill blame merge, delaying permitted sites by months.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, bio_uplift_findings, safety_breakthrough
- Turn 2 (3 turn(s) ago): cyber_defence_breakthrough, us_china_agreement
- Turn 3 (2 turn(s) ago): emergent_ai_fraud_wave, emergent_lab_whistleblower_leak
- Turn 4 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, safety_breakthrough
