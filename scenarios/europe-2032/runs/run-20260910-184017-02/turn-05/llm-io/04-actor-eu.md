...
- characters 1596-3772: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6449-6891: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9134-11116: `{{previous_actions}}` from the actor's own response from the previous turn
