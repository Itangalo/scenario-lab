...
- characters 13676-14773: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14817-16993: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17049-17824: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.5, "openweight_capability": 57.3, "ai_safety": 39.0, "resilience": 46.5, "eu_ai_sovereignty": 19.0, "eu_political_capital": 36.0, "public_sentiment": 32.0}
```
