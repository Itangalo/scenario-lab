...
- characters 13379-14556: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14599-16740: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16796-17965: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Verification Bridge to the US-China Accord | 2 |
...
- `emergent_ai_fraud_wave` -- first noted turn 1, listed in 2 turn(s) so far: A coordinated campaign uses Kimi K3-derived voice and video clones for large-scale fraud against EU banks and public administrations in autumn 2026, causing tens of millions in losses and forcing emergency authentication changes.
- `emergent_lab_whistleblower_leak` -- first noted turn 1, listed in 2 turn(s) so far: A leading US lab researcher publicly leaks internal documents showing frontier safety testing was curtailed before the June access shutoff, triggering congressional hearings and press scrutiny on both sides of the Atlantic.
