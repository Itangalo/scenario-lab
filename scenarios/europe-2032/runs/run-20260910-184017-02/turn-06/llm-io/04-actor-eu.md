...
- characters 2235-4321: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6108-6549: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8935-10882: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Allied Shield Accession | 8 | small | 5 | 7 | coalition and US | resilience up substantially, ai_safety up modestly | 2 | running |
