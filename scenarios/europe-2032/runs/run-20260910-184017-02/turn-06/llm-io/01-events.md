...
- characters 2157-4243: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4299-5068: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5131-28760: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29115-29581: `{{event_history}}` from the run's own event record
...
- `emergent_anti_datacentre_backlash` -- first noted turn 4, listed in 2 turn(s) so far: A coordinated campaign physically targets data-centre construction and grid connections in two member states after fraud losses and power-bill blame merge, delaying permitted sites by months.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, bio_uplift_findings, safety_breakthrough
- Turn 2 (4 turn(s) ago): cyber_defence_breakthrough, us_china_agreement
- Turn 3 (3 turn(s) ago): emergent_ai_fraud_wave, emergent_lab_whistleblower_leak
- Turn 4 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, safety_breakthrough
- Turn 5 (1 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, eval_anomaly_reports, joint_threat_response, election_alliance
