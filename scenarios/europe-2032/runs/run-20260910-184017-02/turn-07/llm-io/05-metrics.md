...
- characters 13773-14699: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14743-16800: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16856-17385: `{{notepad}}` from the Game Master's notepad, carried across turns
...
Autumn 2029 delivered two completions wrapped in two shocks. The first gigafactory shell was declared grid-ready, transformers humming on guaranteed power, even as lawyers fought the second site's injunction court by court. Accession to the joint telemetry pact was signed in Washington, with localisation annexes intact and European analysts admitted to shared incident feeds.
...
## Notepad
PORTFOLIO CHARGE t7: M8 EU Chokepoint Bargain −2, M9 EU Containment Surge −2, priority −1 = −5
PROPOSAL BONUS: EU Containment Surge (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly, bio signal adds urgency
LEGITIMACY LENDS: capital 30, sentiment 31 -> +1
SOVEREIGNTY: 22 last turn, InvestAI Gigafactories finishes t7 +5, no in-flight bonus, export_control_escalation t7 −1, capability rose 1.0 no deduction = 26
