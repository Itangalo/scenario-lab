...
- characters 455-1193: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1237-3134: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3962-4403: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7110-9385: `{{previous_actions}}` from the actor's own response from the previous turn
