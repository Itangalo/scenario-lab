...
- characters 13779-14517: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14561-16458: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16514-17022: `{{notepad}}` from the Game Master's notepad, carried across turns
