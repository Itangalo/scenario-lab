...
- characters 106-12968: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13011-13203: `{{metrics_json}}` from the run's live metric values
- characters 13296-14176: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14219-16491: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16547-16990: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Municipal and Hospital Hard Shield | 2 |
| M12 | EU Breakthrough Shield Rollout | 2 |
...
PORTFOLIO CHARGE t9: EU Municipal and Hospital Hard Shield −2, priority −1 = −3
PROPOSAL BONUS: EU Municipal and Hospital Hard Shield (cat 6, small) +4 — capability_jump and openweight_frontier_release landed this turn driving second probing wave and this answers them directly
LEGITIMACY LENDS: capital 30, sentiment 26 -> none, capital higher
SOVEREIGNTY: 24 last turn, no capacity event, no category 4 in flight, capability rose 1.5 −0 = 24
...
## Metrics
```json
{"ai_capability": 67.0, "openweight_capability": 64.5, "ai_safety": 35.0, "resilience": 47.0, "eu_ai_sovereignty": 24.0, "eu_political_capital": 24.0, "public_sentiment": 30.0}
```
...
## Notepad
PORTFOLIO CHARGE t10: EU Municipal and Hospital Hard Shield −2, EU Breakthrough Shield Rollout −2, priority −1 = −5
PROPOSAL BONUS: none — new cat 6 measure answers positive breakthroughs, not a negative event from last three rounds
LEGITIMACY LENDS: capital 22, sentiment 30 -> +2
SOVEREIGNTY: 24 last turn, no capacity event, no category 4 in flight, capability rose 1.0 −0 = 24
