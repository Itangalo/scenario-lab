...
- characters 455-1335: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1378-3650: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4747-5169: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8183-10944: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Municipal and Hospital Hard Shield | 6 | small | 9 | 11 | own jurisdiction | resilience up substantially, ai_safety up modestly | 2 | running |
