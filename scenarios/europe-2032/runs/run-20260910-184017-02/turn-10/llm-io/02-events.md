...
- characters 377-1257: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1300-3572: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3628-4071: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4134-28625: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28980-29885: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, bio_uplift_findings, safety_breakthrough
- Turn 2 (8 turn(s) ago): cyber_defence_breakthrough, us_china_agreement
- Turn 3 (7 turn(s) ago): emergent_ai_fraud_wave, emergent_lab_whistleblower_leak
- Turn 4 (6 turn(s) ago): cyber_major_incident, bio_uplift_findings, safety_breakthrough
- Turn 5 (5 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, eval_anomaly_reports, joint_threat_response, election_alliance
- Turn 6 (4 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented, supply_chain_coercion, joint_threat_response
- Turn 7 (3 turn(s) ago): cyber_major_incident, ai_investment_collapse, bio_uplift_findings, export_control_escalation
- Turn 8 (2 turn(s) ago): research_breakthrough, openweight_frontier_release, supply_chain_coercion, member_state_defection
- Turn 9 (1 turn(s) ago): capability_jump, openweight_frontier_release
