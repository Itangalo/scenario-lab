...
- characters 13306-14079: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14122-16104: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16160-16553: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Black-Box Assurance Initiative | 2 |
...
PORTFOLIO CHARGE t11: EU Black-Box Assurance Initiative −2, priority −1 = −3
PROPOSAL BONUS: EU Black-Box Assurance Initiative (cat 5, small) +3 — opaque reasoning landed this turn breaking chain-of-thought oversight and this answers it directly
