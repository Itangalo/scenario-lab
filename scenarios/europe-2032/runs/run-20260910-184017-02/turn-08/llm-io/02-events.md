...
- characters 376-1535: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1578-3949: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4005-4454: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4517-28155: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28510-29220: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, bio_uplift_findings, safety_breakthrough
- Turn 2 (6 turn(s) ago): cyber_defence_breakthrough, us_china_agreement
- Turn 3 (5 turn(s) ago): emergent_ai_fraud_wave, emergent_lab_whistleblower_leak
- Turn 4 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, safety_breakthrough
- Turn 5 (3 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, eval_anomaly_reports, joint_threat_response, election_alliance
- Turn 6 (2 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented, supply_chain_coercion, joint_threat_response
- Turn 7 (1 turn(s) ago): cyber_major_incident, ai_investment_collapse, bio_uplift_findings, export_control_escalation
