...
- characters 13648-14807: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14850-17221: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17277-17726: `{{notepad}}` from the Game Master's notepad, carried across turns
