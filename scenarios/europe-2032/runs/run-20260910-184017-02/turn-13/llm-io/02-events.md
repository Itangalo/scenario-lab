...
- characters 378-1624: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1668-3367: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3423-3895: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3958-27034: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27389-28620: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Black-Box Assurance Initiative −2, EU Blockade Continuity and Restoration Corps −2, priority −1 = −5
PROPOSAL BONUS: EU Blockade Continuity and Restoration Corps (cat 6, small) +4 — cyber_major_incident and taiwan_blockade both landed this turn and this answers both directly
LEGITIMACY LENDS: capital 28, sentiment 30 -> +1
SOVEREIGNTY: 24 last turn, no capacity event, no category 4 in flight, taiwan_blockade t12 −3, capability rose 1.0 −0 = 21
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, bio_uplift_findings, safety_breakthrough
- Turn 2 (11 turn(s) ago): cyber_defence_breakthrough, us_china_agreement
- Turn 3 (10 turn(s) ago): emergent_ai_fraud_wave, emergent_lab_whistleblower_leak
- Turn 4 (9 turn(s) ago): cyber_major_incident, bio_uplift_findings, safety_breakthrough
- Turn 5 (8 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, eval_anomaly_reports, joint_threat_response, election_alliance
- Turn 6 (7 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented, supply_chain_coercion, joint_threat_response
- Turn 7 (6 turn(s) ago): cyber_major_incident, ai_investment_collapse, bio_uplift_findings, export_control_escalation
- Turn 8 (5 turn(s) ago): research_breakthrough, openweight_frontier_release, supply_chain_coercion, member_state_defection
- Turn 9 (4 turn(s) ago): capability_jump, openweight_frontier_release
- Turn 10 (3 turn(s) ago): cyber_defence_breakthrough, medical_breakthrough, safety_breakthrough
- Turn 11 (2 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, opaque_reasoning, taiwan_tension_rise
- Turn 12 (1 turn(s) ago): cyber_major_incident, taiwan_blockade, cyber_defence_breakthrough, adoption_success
