...
- characters 107-13348: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13391-13583: `{{metrics_json}}` from the run's live metric values
- characters 13676-14922: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14966-16665: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16721-17193: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Blockade Continuity and Restoration Corps | 2 |
| M15 | EU Certified Assurance Fast-Track | 2 |
...
## Notepad
PORTFOLIO CHARGE t13: EU Blockade Continuity and Restoration Corps −2, EU Certified Assurance Fast-Track −2, priority −1 = −5
PROPOSAL BONUS: none — EU Certified Assurance Fast-Track (cat 5, small) answers safety_breakthrough positive result, not a negative event from last three rounds
LEGITIMACY LENDS: capital 23, sentiment 32 -> +2
SOVEREIGNTY: 21 last turn, no capacity event finished, no category 4 in flight, export_control_escalation t13 −1, capability rose 1.0 −0 = 20
