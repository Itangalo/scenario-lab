...
- characters 13594-13786: `{{metrics_json}}` from the run's live metric values
- characters 13879-15382: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15426-17603: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17659-18287: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Trust Shield Against AI Fraud | 2 |
