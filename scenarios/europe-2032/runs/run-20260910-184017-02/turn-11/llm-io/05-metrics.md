...
- characters 107-13447: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13490-13682: `{{metrics_json}}` from the run's live metric values
- characters 13775-14442: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14486-16537: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16593-16973: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 68.0, "openweight_capability": 65.8, "ai_safety": 28.5, "resilience": 55.0, "eu_ai_sovereignty": 24.0, "eu_political_capital": 27.0, "public_sentiment": 31.0}
```
## Narrative
