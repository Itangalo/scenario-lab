...
- characters 13367-14956: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15000-17390: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17446-18007: `{{notepad}}` from the Game Master's notepad, carried across turns
