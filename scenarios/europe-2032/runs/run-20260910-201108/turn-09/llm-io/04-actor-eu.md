...
- characters 453-2042: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2086-4476: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6384-6812: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9699-11785: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M9 | EU Essential Inference Continuity and Infrastructure Guard | 6 | small | 8 | 10 | own jurisdiction | resilience up moderately, eu_ai_sovereignty up slightly via protected usable capacity | 2 | running |
