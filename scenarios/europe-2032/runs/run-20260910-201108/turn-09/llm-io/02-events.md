...
- characters 375-1964: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2008-4398: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4454-5292: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5355-34088: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34443-35392: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M8 EU Lithography Shield and Sovereign Inference Reserve −2, M9 EU Essential Inference Continuity and Infrastructure Guard −2, priority has no effect and no cost as capital below 20 = −4 total
PROPOSAL BONUS: none — M9 EU Essential Inference Continuity and Infrastructure Guard already in flight per rule 6 portfolio, no new measure started this turn
LEGITIMACY LENDS: capital 6, sentiment 10 -> +2
SOVEREIGNTY: 14 last turn, no cat4 finish, M8 in flight +1, supply_chain_coercion t8 −3 (largest capacity event), capability rose 8.0 −1 = 11

## Emerging developments (tracked)

- `emergent_datacentre_moratorium_push` -- first noted turn 7, listed in 2 turn(s) so far: Municipal bans on new data-centre grid connections spread to a national moratorium debate after walkouts and ransomware blame infrastructure strain.
...
- Turn 2 (7 turn(s) ago): bio_uplift_findings, member_state_defection, emergent_datacentre_siting_backlash
- Turn 3 (6 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise, export_control_escalation
- Turn 4 (5 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, automated_decision_scandal
- Turn 5 (4 turn(s) ago): eval_anomaly_reports, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, research_breakthrough, medical_breakthrough, export_control_escalation, us_labs_nationalised, emergent_critical_staff_walkout
- Turn 7 (2 turn(s) ago): medical_breakthrough, safety_breakthrough, taiwan_tension_rise, eu_frontier_access_denied, supply_chain_coercion
- Turn 8 (1 turn(s) ago): capability_jump, eval_anomaly_reports, rsi_onset, research_breakthrough, medical_breakthrough, supply_chain_coercion, emergent_infrastructure_sabotage_wave
