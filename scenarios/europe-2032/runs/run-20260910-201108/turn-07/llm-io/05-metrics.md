...
- characters 106-13567: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13610-13802: `{{metrics_json}}` from the run's live metric values
- characters 13895-15301: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15345-17813: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17869-18988: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Displaced Workers Transition Fund | 2 |
