...
- characters 1827-4295: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4351-4902: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4965-32060: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32415-33043: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): bio_uplift_findings, member_state_defection, emergent_datacentre_siting_backlash
- Turn 3 (4 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise, export_control_escalation
- Turn 4 (3 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, automated_decision_scandal
- Turn 5 (2 turn(s) ago): eval_anomaly_reports, election_consolidation
- Turn 6 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, research_breakthrough, medical_breakthrough, export_control_escalation, us_labs_nationalised, emergent_critical_staff_walkout
