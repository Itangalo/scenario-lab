...
- characters 373-1515: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1558-3276: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3332-4073: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4136-31702: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32057-33426: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M10 EU Wartime Inference Rationing and Repair Corps −2, priority has no effect and no cost as capital below 20 = −2 total
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: none — capital 14, sentiment 2, capital is higher
SOVEREIGNTY: 9 last turn, no category 4 finish, no in-flight bonus, supply_chain_coercion t11 −2 (largest capacity event), capability rose 3.0 −1 = 6

## Emerging developments (tracked)

- `emergent_neutral_escrow_corridor` -- first noted turn 10, listed in 2 turn(s) so far: Swiss-anchored custodians offer to host a neutral escrow of lithography spares, subsea repair capacity and pooled inference for hospitals, open to all belligerents on published humanitarian terms.
...
- Turn 2 (10 turn(s) ago): bio_uplift_findings, member_state_defection, emergent_datacentre_siting_backlash
- Turn 3 (9 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise, export_control_escalation
- Turn 4 (8 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, automated_decision_scandal
- Turn 5 (7 turn(s) ago): eval_anomaly_reports, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident, research_breakthrough, medical_breakthrough, export_control_escalation, us_labs_nationalised, emergent_critical_staff_walkout
- Turn 7 (5 turn(s) ago): medical_breakthrough, safety_breakthrough, taiwan_tension_rise, eu_frontier_access_denied, supply_chain_coercion
- Turn 8 (4 turn(s) ago): capability_jump, eval_anomaly_reports, rsi_onset, research_breakthrough, medical_breakthrough, supply_chain_coercion, emergent_infrastructure_sabotage_wave
- Turn 9 (3 turn(s) ago): catastrophic_great_power_conflict, cyber_defence_breakthrough, catastrophic_loss_of_control_incident, emergent_datacentre_moratorium_push
- Turn 10 (2 turn(s) ago): cyber_major_incident, capability_jump, labour_displacement, export_control_escalation, eu_frontier_access_denied, middle_power_coalition, emergent_wartime_connectivity_severance
- Turn 11 (1 turn(s) ago): supply_chain_coercion
