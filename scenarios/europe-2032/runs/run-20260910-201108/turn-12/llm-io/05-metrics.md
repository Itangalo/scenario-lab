...
- characters 106-13409: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13452-13640: `{{metrics_json}}` from the run's live metric values
- characters 13733-14875: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14918-16636: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16692-17110: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Humanitarian Clinical Access and Embodied-Work Continuity Bridge | 2 |
