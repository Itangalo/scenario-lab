...
- characters 373-1386: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1429-3685: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3741-4212: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4275-31841: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32196-33309: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): bio_uplift_findings, member_state_defection, emergent_datacentre_siting_backlash
- Turn 3 (7 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise, export_control_escalation
- Turn 4 (6 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, automated_decision_scandal
- Turn 5 (5 turn(s) ago): eval_anomaly_reports, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, research_breakthrough, medical_breakthrough, export_control_escalation, us_labs_nationalised, emergent_critical_staff_walkout
- Turn 7 (3 turn(s) ago): medical_breakthrough, safety_breakthrough, taiwan_tension_rise, eu_frontier_access_denied, supply_chain_coercion
- Turn 8 (2 turn(s) ago): capability_jump, eval_anomaly_reports, rsi_onset, research_breakthrough, medical_breakthrough, supply_chain_coercion, emergent_infrastructure_sabotage_wave
- Turn 9 (1 turn(s) ago): catastrophic_great_power_conflict, cyber_defence_breakthrough, catastrophic_loss_of_control_incident, emergent_datacentre_moratorium_push
