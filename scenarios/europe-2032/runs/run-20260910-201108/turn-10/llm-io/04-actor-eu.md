...
- characters 451-1464: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1507-3763: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6308-6744: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9481-10993: `{{previous_actions}}` from the actor's own response from the previous turn
