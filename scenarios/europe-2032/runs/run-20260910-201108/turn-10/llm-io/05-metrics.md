...
- characters 106-13574: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13617-13805: `{{metrics_json}}` from the run's live metric values
- characters 13898-14911: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14954-17210: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17266-18060: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Wartime Inference Rationing and Repair Corps | 2 |
...
**emergent_wartime_connectivity_severance (emergent event):** Wartime strikes and sabotage sever a major transatlantic cable bundle and a satellite relay, isolating EU cloud regions for days and forcing emergency rationing of inference to triage and payments only.
