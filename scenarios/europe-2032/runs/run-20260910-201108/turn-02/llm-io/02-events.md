...
- characters 376-1918: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1961-4087: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4143-5105: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5168-28245: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28600-28641: `{{event_history}}` from the run's own event record
