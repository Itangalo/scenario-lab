...
- characters 13406-14948: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14991-17117: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17173-17892: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_synthesis_screening_pact` -- first noted turn 1, listed in 2 turn(s) so far: Major DNA synthesis providers announce a voluntary cross-industry screening pact for AI-designed sequences after the phage results, ahead of any regulation.
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 50.5, "ai_safety": 30.0, "resilience": 36.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 25.0, "public_sentiment": 37.0}
```
