...
- characters 106-13132: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13175-13367: `{{metrics_json}}` from the run's live metric values
- characters 13460-15494: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15538-17855: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17911-18444: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 54.2, "ai_safety": 28.0, "resilience": 36.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 19.0, "public_sentiment": 35.0}
```
