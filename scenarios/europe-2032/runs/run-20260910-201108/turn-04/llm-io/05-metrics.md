...
- characters 105-13518: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13561-13753: `{{metrics_json}}` from the run's live metric values
- characters 13846-16222: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16265-18091: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18147-19303: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Synthesis Screening and Bio-Detection Bridge | 2 |
| M5 | EU Frontier Evaluation Access Taskforce | 2 |
| M6 | EU Public Services Continuity Corps | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Cyber Shield −3, EU Synthesis Screening and Bio-Detection Bridge −2, EU Frontier Evaluation Access Taskforce −2, priority −1 = −14
PROPOSAL BONUS: EU Frontier Evaluation Access Taskforce (cat 5, small) +2 — answers eval anomaly leak this turn and prior grid intrusions with open-weight tooling directly
LEGITIMACY LENDS: capital 17, sentiment 35 -> +2
SOVEREIGNTY: 18 last turn, no category 4 finish, in flight +0, export_control_escalation t3 −2, capability rose 3.0 −1 = 15

## Emerging developments (tracked)

- `emergent_critical_staff_walkout` -- first noted turn 4, listed in 1 turn(s) so far: A coordinated walkout by grid control-room engineers and hospital lab staff over AI-linked workload and safety liability halts segmentation retrofits and sentinel staffing for weeks.
- `emergent_offshore_synthesis_grey_market` -- first noted turn 4, listed in 1 turn(s) so far: Benchtop synthesis providers outside the EU begin advertising no-questions-asked oligo pools marketed to European buyers, exploiting pilot-only screening and idle sentinel staffing.
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Synthesis Screening and Bio-Detection Bridge −2, EU Frontier Evaluation Access Taskforce −2, EU Public Services Continuity Corps −2, priority −1 = −13
PROPOSAL BONUS: EU Public Services Continuity Corps (cat 6, small) +3 — cyber_major_incident landed this turn severe and this answers it directly
LEGITIMACY LENDS: capital 12, sentiment 24 -> +2
SOVEREIGNTY: 15 last turn, no capacity event, Gigafactories in flight +0, capability rose 6.0 −1 = 14
