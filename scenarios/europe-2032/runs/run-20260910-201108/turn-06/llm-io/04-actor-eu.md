...
- characters 454-2035: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2078-3872: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8308-8736: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11235-13371: `{{previous_actions}}` from the actor's own response from the previous turn
