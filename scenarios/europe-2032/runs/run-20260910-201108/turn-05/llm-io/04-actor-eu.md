...
- characters 455-1680: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1724-3773: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5227-5681: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7988-10157: `{{previous_actions}}` from the actor's own response from the previous turn
