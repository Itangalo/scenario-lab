...
- characters 106-13632: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13675-13867: `{{metrics_json}}` from the run's live metric values
- characters 13960-15185: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15229-17278: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17334-18445: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 70.2, "openweight_capability": 62.3, "ai_safety": 17.0, "resilience": 49.0, "eu_ai_sovereignty": 13.0, "eu_political_capital": 15.0, "public_sentiment": 22.0}
```
