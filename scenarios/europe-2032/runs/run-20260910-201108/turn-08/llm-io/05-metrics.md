...
- characters 105-13452: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13495-13686: `{{metrics_json}}` from the run's live metric values
- characters 13779-15094: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15137-16995: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17051-18003: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Lithography Shield and Sovereign Inference Reserve | 2 |
| M9 | EU Essential Inference Continuity and Infrastructure Guard | 2 |
...
## Metrics
```json
{"ai_capability": 83.7, "openweight_capability": 72.6, "ai_safety": 9.0, "resilience": 43.0, "eu_ai_sovereignty": 11.0, "eu_political_capital": 8.0, "public_sentiment": 10.0}
```
