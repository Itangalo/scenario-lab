...
- characters 453-1768: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1811-3669: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7321-7749: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10426-12429: `{{previous_actions}}` from the actor's own response from the previous turn
...
**emergent_infrastructure_sabotage_wave (emergent event):** Coordinated physical sabotage hits AI infrastructure in multiple member states, with substations feeding data-centre clusters and fibre links damaged in overnight attacks claimed by anti-AI groups.
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Lithography Shield and Sovereign Inference Reserve | 4 | small | 7 | 10 | own jurisdiction | eu_ai_sovereignty up moderately, resilience up slightly | 2 | running |
...
## New measure
**EU Lithography Shield and Sovereign Inference Reserve**
Keeps essential public workloads running on EU-anchored capacity after US frontier cut-off and ASML coercion, by ring-fencing lithography servicing and pooling sovereign inference.
This turn the cut-off and the coercion make dependence operational, not theoretical, so even with capital at 10 we must start the reserve that our two-year commitment to secure independent AI capacity under European control demands.

## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Lithography Shield and Sovereign Inference Reserve", "category": 4, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "eu_ai_sovereignty up moderately, resilience up slightly"}, "grounds": "frontier access denied and ASML coercion force sovereign fallback"}]}
```

## Priority
M7 EU Displaced Workers Transition Fund, because with sentiment at 14 and capital at 10 only visible payouts to hospitals, municipalities and walkout-hit regions keep any further sovereignty build politically survivable.

## In practice
We trigger the Anti-Coercion Instrument consultation on the ASML servicing ban via Trade and Competitiveness Councils, directing DG TRADE to prepare blocking and compensation cover while we negotiate servicing carve-outs for legacy tools with Washington, and we instruct HERA/ENISA to shift hospital and registry workloads cut off from US models onto Gigafactory first capacity and EuroHPC pools under emergency procurement.

We hold M7 as the delivery vehicle: EPSCO channels Transition Fund top-ups to small-town payroll and care staff hit by February ransomware and to grid/lab walkout overtime, paired with AI-liability clarification through social partners, to restart segmentation retrofits and bio-sentinels without opening a second front. No new law this semester beyond ACI process and emergency implementing acts; the Reserve is scoped small to fit capital.
...
```
## New measure
**EU Essential Inference Continuity and Infrastructure Guard**
Keeps cut-off hospitals and registries on pooled EU inference while guarding substations, fibre and Gigafactory sites against coordinated sabotage through exercised protection and repair.
This is category 6 Preparedness and resilience, small and immediate, because with RSI compounding, open weights at 69.5 and physical attacks now hitting the only sovereign capacity we have, continuity and physical guard outrank any new build this semester and directly serve our two-year commitment to secure independent AI capacity under European control.

## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Essential Inference Continuity and Infrastructure Guard", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_ai_sovereignty up slightly via protected usable capacity"}, "grounds": "cut-off plus sabotage wave threatens remaining sovereign inference"}]}
```

## Priority
M8 EU Lithography Shield and Sovereign Inference Reserve, because without ring-fenced servicing and pooled inference surviving the US cut-off and ASML coercion, the new guard has nothing to protect.

## In practice
We act through the Justice and Home Affairs Council and the Transport, Telecommunications and Energy Council on a Critical Entities Resilience legal base: ENISA and Europol coordinate member-state police and operators to harden substations and fibre serving EuroHPC and Gigafactory clusters, with mutual-aid repair stocks and exercised failover, funded by re-scoped emergency implementing acts.

We direct HERA, ENISA and EuroHPC JU to keep triage and registry workloads shifted from failed US calls onto pooled sovereign inference under clinical priority, while DG TRADE sustains Anti-Coercion consultation for legacy lithography carve-outs. No new large law this turn; with capital at 9 we pair the small guard with visible Transition Fund payouts already on the books to hold towns and care staff.
