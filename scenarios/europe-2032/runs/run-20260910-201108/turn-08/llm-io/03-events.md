...
- characters 375-1690: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1733-3591: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3647-4890: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4953-33215: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33570-34337: `{{event_history}}` from the run's own event record
...
- `emergent_infrastructure_sabotage_wave` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated physical sabotage hits AI infrastructure in multiple member states, with substations feeding data-centre clusters and fibre links damaged in overnight attacks claimed by anti-AI groups.
- `emergent_datacentre_moratorium_push` -- first noted turn 7, listed in 1 turn(s) so far: Municipal bans on new data-centre grid connections spread to a national moratorium debate after walkouts and ransomware blame infrastructure strain.
...
- Turn 2 (6 turn(s) ago): bio_uplift_findings, member_state_defection, emergent_datacentre_siting_backlash
- Turn 3 (5 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise, export_control_escalation
- Turn 4 (4 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, automated_decision_scandal
- Turn 5 (3 turn(s) ago): eval_anomaly_reports, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, research_breakthrough, medical_breakthrough, export_control_escalation, us_labs_nationalised, emergent_critical_staff_walkout
- Turn 7 (1 turn(s) ago): medical_breakthrough, safety_breakthrough, taiwan_tension_rise, eu_frontier_access_denied, supply_chain_coercion
