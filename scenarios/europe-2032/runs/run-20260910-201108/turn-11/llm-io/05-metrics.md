...
- characters 107-12967: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13010-13199: `{{metrics_json}}` from the run's live metric values
- characters 13292-14219: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14263-16582: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16638-17544: `{{notepad}}` from the Game Master's notepad, carried across turns
