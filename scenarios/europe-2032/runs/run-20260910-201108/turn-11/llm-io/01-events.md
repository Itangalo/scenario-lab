...
- characters 375-1302: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1346-3665: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3721-4627: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4690-32256: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32611-33930: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M10 EU Wartime Inference Rationing and Repair Corps −2, priority has no effect and no cost as capital below 20 = −2 total
PROPOSAL BONUS: EU Wartime Inference Rationing and Repair Corps (cat 6, small) +4 — severance, frontier cut-off and automated extortion wave hit this turn and this answers them directly
LEGITIMACY LENDS: none — capital 14, sentiment 2, capital is higher
SOVEREIGNTY: 8 last turn, M8 EU Lithography Shield and Sovereign Inference Reserve finishes t10 +4, eu_frontier_access_denied t10 −2 (largest capacity event), capability rose 3.3 −1 = 9

## Emerging developments (tracked)

- `emergent_neutral_escrow_corridor` -- first noted turn 10, listed in 1 turn(s) so far: Swiss-anchored custodians offer to host a neutral escrow of lithography spares, subsea repair capacity and pooled inference for hospitals, open to all belligerents on published humanitarian terms.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot
- Turn 2 (9 turn(s) ago): bio_uplift_findings, member_state_defection, emergent_datacentre_siting_backlash
- Turn 3 (8 turn(s) ago): eval_anomaly_reports, taiwan_tension_rise, export_control_escalation
- Turn 4 (7 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, automated_decision_scandal
- Turn 5 (6 turn(s) ago): eval_anomaly_reports, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, research_breakthrough, medical_breakthrough, export_control_escalation, us_labs_nationalised, emergent_critical_staff_walkout
- Turn 7 (4 turn(s) ago): medical_breakthrough, safety_breakthrough, taiwan_tension_rise, eu_frontier_access_denied, supply_chain_coercion
- Turn 8 (3 turn(s) ago): capability_jump, eval_anomaly_reports, rsi_onset, research_breakthrough, medical_breakthrough, supply_chain_coercion, emergent_infrastructure_sabotage_wave
- Turn 9 (2 turn(s) ago): catastrophic_great_power_conflict, cyber_defence_breakthrough, catastrophic_loss_of_control_incident, emergent_datacentre_moratorium_push
- Turn 10 (1 turn(s) ago): cyber_major_incident, capability_jump, labour_displacement, export_control_escalation, eu_frontier_access_denied, middle_power_coalition, emergent_wartime_connectivity_severance
