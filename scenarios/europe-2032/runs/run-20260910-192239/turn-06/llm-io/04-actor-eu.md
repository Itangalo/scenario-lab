...
- characters 453-1360: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1403-2954: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3022-3473: `{{statement_ledger}}` from the actor's live statement ledger
- characters 5508-7217: `{{previous_actions}}` from the actor's own response from the previous turn
