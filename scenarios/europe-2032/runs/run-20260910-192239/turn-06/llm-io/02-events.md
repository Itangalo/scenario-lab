...
- characters 375-1282: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1325-2876: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 2932-3848: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3911-25857: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26212-26571: `{{event_history}}` from the run's own event record
...
- Turn 2 (4 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, knowledge_work_augmented, member_state_defection
- Turn 3 (3 turn(s) ago): cyber_defence_breakthrough
- Turn 4 (2 turn(s) ago): member_state_defection
- Turn 5 (1 turn(s) ago): labour_displacement, eu_frontier_access_denied, election_alliance
