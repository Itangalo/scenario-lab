...
- characters 13265-13456: `{{metrics_json}}` from the run's live metric values
- characters 13549-14456: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14499-16050: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16106-16421: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "ALLIANCE"}, "grounds": "turn 5 elected coalition-minded president, takes office turn 6"}]}
```
```
