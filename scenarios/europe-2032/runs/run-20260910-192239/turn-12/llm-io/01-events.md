...
- characters 1991-3976: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4032-4748: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4811-30626: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30981-31822: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M7 EU Middle-Power Leverage Pact −2 = −2 (named priority M7 has no effect and no −1 cost as capital below 20)
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2, sentiment 17.0 -> +2 capped, net applied in capital total
SOVEREIGNTY: 15.0 last turn, no capacity event, no cat4 finish or in-flight, capability rose 0.5 no −1 = 15.0

## Emerging developments (tracked)

- `emergent_open_model_crime_wave` -- first noted turn 11, listed in 1 turn(s) so far: Small contractors using the new near-frontier open model automate phishing, invoice fraud and municipal ransomware at scale, producing a visible wave of AI-assisted crime blamed on openly available weights.
...
- Turn 2 (10 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, knowledge_work_augmented, member_state_defection
- Turn 3 (9 turn(s) ago): cyber_defence_breakthrough
- Turn 4 (8 turn(s) ago): member_state_defection
- Turn 5 (7 turn(s) ago): labour_displacement, eu_frontier_access_denied, election_alliance
- Turn 7 (5 turn(s) ago): labour_displacement, member_state_defection, adoption_success, emergent_anti_datacentre_blockades
- Turn 8 (4 turn(s) ago): capability_jump
- Turn 9 (3 turn(s) ago): opaque_reasoning, medical_breakthrough, eu_frontier_access_denied, automated_decision_scandal, emergent_allied_access_deal
- Turn 10 (2 turn(s) ago): openweight_frontier_release, safety_breakthrough, adoption_success, middle_power_coalition
- Turn 11 (1 turn(s) ago): safety_breakthrough
