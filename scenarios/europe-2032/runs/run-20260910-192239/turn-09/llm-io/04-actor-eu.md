...
- characters 454-1708: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1752-3453: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6457-6908: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8970-9943: `{{previous_actions}}` from the actor's own response from the previous turn
