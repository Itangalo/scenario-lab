...
- characters 376-1630: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1674-3375: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3431-4444: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4507-31019: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31374-31899: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M6 EU Trust Adoption Dividend −2, priority no effect no cost — capital 3 below 20 = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0 after charge and event, sentiment 18 -> +2 capped, net applied in capital total
SOVEREIGNTY: 16.0 last turn, no capacity event, no cat4 finish or in-flight, capability rose 4.0 −1 = 15.0

## Emerging developments (tracked)

- `emergent_graduate_strike_wave` -- first noted turn 8, listed in 1 turn(s) so far: Coordinated graduate-led strikes and occupations spread from frozen entry-level sectors to universities and retraining centres across several member states, directly targeting EU digital programmes as symbols of jobless automation.
- `emergent_allied_access_deal` -- first noted turn 8, listed in 1 turn(s) so far: Washington offers a signed tiered allied-access licence for frontier models to select EU public-sector and industrial users, restoring partial access but with US audit and data-sharing conditions.
...
- Turn 2 (7 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, knowledge_work_augmented, member_state_defection
- Turn 3 (6 turn(s) ago): cyber_defence_breakthrough
- Turn 4 (5 turn(s) ago): member_state_defection
- Turn 5 (4 turn(s) ago): labour_displacement, eu_frontier_access_denied, election_alliance
- Turn 7 (2 turn(s) ago): labour_displacement, member_state_defection, adoption_success, emergent_anti_datacentre_blockades
- Turn 8 (1 turn(s) ago): capability_jump
