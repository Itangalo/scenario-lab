...
- characters 106-13127: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13170-13361: `{{metrics_json}}` from the run's live metric values
- characters 13454-14708: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14752-16453: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16509-17242: `{{notepad}}` from the Game Master's notepad, carried across turns
