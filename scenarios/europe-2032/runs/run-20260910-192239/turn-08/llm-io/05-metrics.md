...
- characters 105-12803: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12846-13037: `{{metrics_json}}` from the run's live metric values
- characters 13130-14203: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14246-16237: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16293-17410: `{{notepad}}` from the Game Master's notepad, carried across turns
