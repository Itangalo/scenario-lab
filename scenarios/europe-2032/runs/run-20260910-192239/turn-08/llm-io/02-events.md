...
- characters 1491-3482: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3538-4021: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4084-29140: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29495-29978: `{{event_history}}` from the run's own event record
...
- Turn 2 (6 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, knowledge_work_augmented, member_state_defection
- Turn 3 (5 turn(s) ago): cyber_defence_breakthrough
- Turn 4 (4 turn(s) ago): member_state_defection
- Turn 5 (3 turn(s) ago): labour_displacement, eu_frontier_access_denied, election_alliance
- Turn 7 (1 turn(s) ago): labour_displacement, member_state_defection, adoption_success, emergent_anti_datacentre_blockades
