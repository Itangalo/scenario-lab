...
- characters 454-1549: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1592-3711: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5208-5643: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7705-9115: `{{previous_actions}}` from the actor's own response from the previous turn
