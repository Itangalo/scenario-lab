...
- characters 106-12810: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12853-13044: `{{metrics_json}}` from the run's live metric values
- characters 13137-14232: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14275-16394: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16450-16781: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 67.0, "openweight_capability": 65.0, "ai_safety": 21.0, "resilience": 39.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 4.0, "public_sentiment": 15.5}
```
