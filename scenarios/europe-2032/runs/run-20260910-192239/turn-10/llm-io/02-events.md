...
- characters 376-1471: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1514-3633: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3689-4374: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4437-30252: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30607-31281: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: (none) = 0, no priority = 0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 18 -> +2 capped, net applied in capital total but floored at 0
SOVEREIGNTY: 15.0 last turn, no cat4 finish or in-flight, eu_frontier_access_denied t9 −2, capability rose 0.7 no −1 = 13.0

## Emerging developments (tracked)

- `emergent_graduate_strike_wave` -- first noted turn 8, listed in 2 turn(s) so far: Coordinated graduate-led strikes and occupations spread from frozen entry-level sectors to universities and retraining centres across several member states, directly targeting EU digital programmes as symbols of jobless automation.
...
- Turn 2 (8 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, knowledge_work_augmented, member_state_defection
- Turn 3 (7 turn(s) ago): cyber_defence_breakthrough
- Turn 4 (6 turn(s) ago): member_state_defection
- Turn 5 (5 turn(s) ago): labour_displacement, eu_frontier_access_denied, election_alliance
- Turn 7 (3 turn(s) ago): labour_displacement, member_state_defection, adoption_success, emergent_anti_datacentre_blockades
- Turn 8 (2 turn(s) ago): capability_jump
- Turn 9 (1 turn(s) ago): opaque_reasoning, medical_breakthrough, eu_frontier_access_denied, automated_decision_scandal, emergent_allied_access_deal
