...
- characters 377-1287: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1331-3228: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3284-4277: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4340-28121: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28476-28743: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, priority −1 = −7
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 11, sentiment 35 -> +2 (capped below sentiment, after charges, finishes and event)
SOVEREIGNTY: 20 last turn, no capacity finish, Gigafactories in flight +0, member_state_defection t4 −2, capability rose 1.5 −0 = 18

## Emerging developments (tracked)

- `emergent_laggard_ransomware_sweep` -- first noted turn 4, listed in 1 turn(s) so far: A coordinated ransomware sweep hits several unsegmented municipal utilities and mid-size ports using open Mythos-derived tooling, forcing extended public defensive disconnects beyond the November near-misses.
- `emergent_local_permitting_revolt` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated municipal opposition blocks last-mile hardening sites and gigafactory permitting zones, with court injunctions pausing construction and grid upgrades through winter.
...
- Turn 2 (3 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, knowledge_work_augmented, member_state_defection
