...
- characters 2040-3937: `{{world_state}}` from background/context.md, seeded as the opening world state
- characters 3970-5679: `{{previous_actions}}` from the actor's own response from the previous turn
...
Rewrite it to read: Secure independent European AI capacity with allied access on European terms
