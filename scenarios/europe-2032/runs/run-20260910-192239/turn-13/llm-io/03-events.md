...
- characters 377-2573: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2617-4614: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4670-5332: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5395-29704: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30059-31000: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: (none in flight) = -0 + no priority = -0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2, sentiment 17.0 -> +2 capped, net applied in capital total
SOVEREIGNTY: 15.0 last turn, no cat4 finish or in-flight, export_control_escalation t12 −2, capability rose 0.5 no −1 = 13.0

## Emerging developments (tracked)

- `emergent_open_model_crime_wave` -- first noted turn 11, listed in 2 turn(s) so far: Small contractors using the new near-frontier open model automate phishing, invoice fraud and municipal ransomware at scale, producing a visible wave of AI-assisted crime blamed on openly available weights.
...
- Turn 2 (11 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, knowledge_work_augmented, member_state_defection
- Turn 3 (10 turn(s) ago): cyber_defence_breakthrough
- Turn 4 (9 turn(s) ago): member_state_defection
- Turn 5 (8 turn(s) ago): labour_displacement, eu_frontier_access_denied, election_alliance
- Turn 7 (6 turn(s) ago): labour_displacement, member_state_defection, adoption_success, emergent_anti_datacentre_blockades
- Turn 8 (5 turn(s) ago): capability_jump
- Turn 9 (4 turn(s) ago): opaque_reasoning, medical_breakthrough, eu_frontier_access_denied, automated_decision_scandal, emergent_allied_access_deal
- Turn 10 (3 turn(s) ago): openweight_frontier_release, safety_breakthrough, adoption_success, middle_power_coalition
- Turn 11 (2 turn(s) ago): safety_breakthrough
- Turn 12 (1 turn(s) ago): loss_of_control_incident, export_control_escalation, us_china_agreement
