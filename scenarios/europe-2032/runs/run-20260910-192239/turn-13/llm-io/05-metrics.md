...
- characters 107-12825: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12868-13059: `{{metrics_json}}` from the run's live metric values
- characters 13152-15348: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15392-17389: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17445-17776: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Lifeline Restoration and Scandal Redress | 2 |
...
## Notepad
PORTFOLIO CHARGE t13: EU Lifeline Restoration and Scandal Redress −2 = −2 + no priority = −2
PROPOSAL BONUS: EU Lifeline Restoration and Scandal Redress (cat 6, small) +3 — cyber_major_incident and automated_decision_scandal both fired this turn and this answers both directly
LEGITIMACY LENDS: capital 0, sentiment 5.0 -> +2 capped, net applied in capital total
SOVEREIGNTY: 13.0 last turn, no cat4 finish, no cat4 in flight, no capacity event, capability rose 0.0 no −1 = 13.0
