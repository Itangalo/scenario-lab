...
- characters 105-13307: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13350-13542: `{{metrics_json}}` from the run's live metric values
- characters 13635-14946: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14989-16748: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16804-17851: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Assurance Adoption Cell −2, Municipal Lifeline Close-Out −2, priority −1 = −11
PROPOSAL BONUS: none — Close-Out answers laggard gap from autumn intrusion but no negative event fired in last three rounds to pay bonus
