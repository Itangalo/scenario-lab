...
- characters 377-1832: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1876-4451: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4507-4931: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4994-30809: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31164-31957: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M7 EU Middle-Power Leverage Pact −2 = −2
PROPOSAL BONUS: EU Middle-Power Leverage Pact (cat 8, small) +3 — answers t9 frontier access withdrawal and trust collapse directly via coalition window
LEGITIMACY LENDS: capital 4, sentiment 15.5 -> +1 capped, net applied in capital total
SOVEREIGNTY: 13.0 last turn, no cat4 finish or in-flight, middle_power_coalition t10 +2, capability rose 0.5 no −1 = 15.0
...
- Turn 2 (9 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, knowledge_work_augmented, member_state_defection
- Turn 3 (8 turn(s) ago): cyber_defence_breakthrough
- Turn 4 (7 turn(s) ago): member_state_defection
- Turn 5 (6 turn(s) ago): labour_displacement, eu_frontier_access_denied, election_alliance
- Turn 7 (4 turn(s) ago): labour_displacement, member_state_defection, adoption_success, emergent_anti_datacentre_blockades
- Turn 8 (3 turn(s) ago): capability_jump
- Turn 9 (2 turn(s) ago): opaque_reasoning, medical_breakthrough, eu_frontier_access_denied, automated_decision_scandal, emergent_allied_access_deal
- Turn 10 (1 turn(s) ago): openweight_frontier_release, safety_breakthrough, adoption_success, middle_power_coalition
