...
- characters 107-12811: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12854-13045: `{{metrics_json}}` from the run's live metric values
- characters 13138-14593: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14637-17212: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17268-18023: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Middle-Power Leverage Pact | 2 |
