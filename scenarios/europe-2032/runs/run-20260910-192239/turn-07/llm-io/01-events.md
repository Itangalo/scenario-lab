...
- characters 1499-3782: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3838-4224: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4287-29343: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29698-30057: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, knowledge_work_augmented, member_state_defection
- Turn 3 (4 turn(s) ago): cyber_defence_breakthrough
- Turn 4 (3 turn(s) ago): member_state_defection
- Turn 5 (2 turn(s) ago): labour_displacement, eu_frontier_access_denied, election_alliance
