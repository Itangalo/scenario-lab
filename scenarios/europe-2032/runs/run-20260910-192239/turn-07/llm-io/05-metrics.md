...
- characters 106-13169: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13212-13403: `{{metrics_json}}` from the run's live metric values
- characters 13496-14575: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14619-16902: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16958-17344: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M6 | EU Trust Adoption Dividend | 2 |
...
## Metrics
```json
{"ai_capability": 61.8, "openweight_capability": 59.4, "ai_safety": 31.0, "resilience": 42.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 3.0, "public_sentiment": 20.0}
```
