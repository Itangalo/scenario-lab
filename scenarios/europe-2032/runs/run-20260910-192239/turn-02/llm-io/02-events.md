...
- characters 376-1520: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1563-3465: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3521-4627: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4690-27972: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28327-28368: `{{event_history}}` from the run's own event record
