...
- characters 4601-5073: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6545-8672: `{{previous_actions}}` from the actor's own response from the previous turn
