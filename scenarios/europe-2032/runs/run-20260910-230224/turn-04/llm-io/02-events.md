...
- characters 1463-3713: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3769-4177: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4240-26804: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27159-27425: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): taiwan_blockade, bio_uplift_findings
- Turn 3 (1 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, export_control_escalation, emergent_memory_substrate_squeeze, emergent_datacentre_pause
