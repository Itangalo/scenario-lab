...
- characters 454-1498: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1541-3791: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5768-6240: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8226-9736: `{{previous_actions}}` from the actor's own response from the previous turn
