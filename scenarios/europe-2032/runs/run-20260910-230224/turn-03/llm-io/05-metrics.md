...
- characters 106-13045: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13088-13280: `{{metrics_json}}` from the run's live metric values
- characters 13373-14750: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14794-16814: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16870-17395: `{{notepad}}` from the Game Master's notepad, carried across turns
