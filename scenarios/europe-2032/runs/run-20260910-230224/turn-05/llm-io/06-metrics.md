...
- characters 13744-14964: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15008-17236: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17292-17829: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Seat in Joint Response and Standards Pact | 2 |
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Seat in Joint Response and Standards Pact −2, priority −1 = −9
PROPOSAL BONUS: EU Seat in Joint Response and Standards Pact (cat 8, small) +4 — joint_threat_response and us_china_agreement landed this turn and this answers both directly
LEGITIMACY LENDS: capital 23, sentiment 28 -> +2
SOVEREIGNTY: 18 last turn, no category 4 finish, emergent_substrate_second_source t5 +1, capability rose 1.5 −0 = 19
