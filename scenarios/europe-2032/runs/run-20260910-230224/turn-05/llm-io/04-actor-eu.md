...
- characters 455-1675: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1719-3947: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7368-7840: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10021-12111: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU Incident Surge and Bio-Detection Deployment | 6 | small | 4 | 5 | own jurisdiction | resilience up, ai_safety up via safety breakthrough adoption and incident learning | 2 | finished |
