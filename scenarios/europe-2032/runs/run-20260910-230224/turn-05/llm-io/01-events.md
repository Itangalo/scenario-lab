...
- characters 377-1597: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1641-3869: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3925-4778: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4841-27405: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27760-28165: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): taiwan_blockade, bio_uplift_findings
- Turn 3 (2 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, export_control_escalation, emergent_memory_substrate_squeeze, emergent_datacentre_pause
- Turn 4 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, safety_breakthrough, taiwan_tension_rise
...
```
[{"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.5}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.15}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.35}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.25}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.045}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.08}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.13}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.15}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.14}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.15}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "A non-US foundry consortium announces a qualified second-source for advanced packaging substrates outside the licensing regime, easing one of the two fresh squeezes but at low initial yield.", "emergent": true, "id": "emergent_substrate_second_source", "probability": 0.12}]
```
