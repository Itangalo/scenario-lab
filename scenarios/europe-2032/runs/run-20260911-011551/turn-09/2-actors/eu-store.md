...
| M7 | Emergency Winter Load-Shedding Pact and Municipal Islanding Kits | 6 | small | 9 | 11 | own jurisdiction | resilience up moderately, eu_political_capital up slightly if blackouts contained | 2 | running |
...
- **applied** `M7` — {"op": "add", "table": "measures", "fields": {"name": "Emergency Winter Load-Shedding Pact and Municipal Islanding Kits", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital up slightly if blackouts contained"}, "grounds": "uncontrolled cross-border load-shedding demands immediate absorption"}
  - Grounds: uncontrolled cross-border load-shedding demands immediate absorption
