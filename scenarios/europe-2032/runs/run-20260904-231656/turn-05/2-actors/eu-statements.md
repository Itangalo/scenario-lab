...
- `two_year_commitment` (commitment): Maintain sovereign control over AI systems essential to critical functions and decision-making

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Maintain sovereign control over AI systems essential to critical functions and decision-making
