...
- characters 454-1784: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1827-4360: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5557-5999: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8320-10526: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Municipal and Hospital Cyber Backstop | 6 | small | 5 | 7 | own jurisdiction | resilience up moderately, eu_political_capital down slightly then up if it holds | 2 | running |
