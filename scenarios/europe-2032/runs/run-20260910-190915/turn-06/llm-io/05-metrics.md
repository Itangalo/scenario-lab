...
- characters 13767-15097: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15140-17673: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17729-18193: `{{notepad}}` from the Game Master's notepad, carried across turns
