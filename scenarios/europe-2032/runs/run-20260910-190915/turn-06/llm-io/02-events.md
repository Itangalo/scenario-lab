...
- characters 376-1706: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1749-4282: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4338-5149: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5212-31898: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32253-32619: `{{event_history}}` from the run's own event record
...
- `emergent_care_triage_backlash` -- first noted turn 4, listed in 2 turn(s) so far: Major European health insurers announce AI-assisted claims triage exclusions after the autumn hospital disruptions, triggering patient-group lawsuits and a cross-border dispute over liability for model-supported care delays.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, eval_anomaly_reports, openweight_frontier_release
- Turn 3 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented
- Turn 4 (2 turn(s) ago): cyber_major_incident
- Turn 5 (1 turn(s) ago): cyber_major_incident, emergent_cyber_insurance_retreat, election_retrenchment
