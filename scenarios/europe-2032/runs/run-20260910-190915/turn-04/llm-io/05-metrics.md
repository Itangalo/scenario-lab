...
- characters 13369-14693: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14736-16891: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16947-18040: `{{notepad}}` from the Game Master's notepad, carried across turns
