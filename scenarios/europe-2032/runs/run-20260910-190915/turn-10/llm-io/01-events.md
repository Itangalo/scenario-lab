...
- characters 375-1457: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1500-3380: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3436-4404: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4467-31797: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32152-32873: `{{event_history}}` from the run's own event record
...
- `emergent_care_staff_walkout` -- first noted turn 9, listed in 1 turn(s) so far: Coordinated staff walkouts and sick-outs in hospital systems still on paper triage and mandatory overtime force temporary ward closures in two member states.
- `emergent_clinical_staff_walkout` -- first noted turn 9, listed in 1 turn(s) so far: Hospital staff walkouts over paper-triage overload and unpaid overtime spread across several member states, forcing emergency staffing measures during containment.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, eval_anomaly_reports, openweight_frontier_release
- Turn 3 (7 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented
- Turn 4 (6 turn(s) ago): cyber_major_incident
- Turn 5 (5 turn(s) ago): cyber_major_incident, emergent_cyber_insurance_retreat, election_retrenchment
- Turn 6 (4 turn(s) ago): bio_incident, bio_uplift_findings, openweight_frontier_release
- Turn 7 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 8 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, taiwan_tension_rise, emergent_anti_infrastructure_backlash
- Turn 9 (1 turn(s) ago): capability_jump, eu_frontier_access_denied
