...
- characters 106-13356: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13399-13589: `{{metrics_json}}` from the run's live metric values
- characters 13682-14764: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14807-16687: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16743-17711: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Pandemic Triage and Joint Biosurveillance Surge | 2 |
...
PORTFOLIO CHARGE t9: EU Essential Continuity Stack −2, priority −1 = −3
PROPOSAL BONUS: EU Essential Continuity Stack (cat 9, small) +3 — eu_frontier_access_denied and capability_jump landed this turn and this answers cutoff replacement directly
LEGITIMACY LENDS: capital 30, sentiment 8 -> none, capital higher
SOVEREIGNTY: 27 last turn, no cat4 finishes, no cat4 in flight +0, eu_frontier_access_denied t9 −2, capability rose 1.7 −0 = 25

## Emerging developments (tracked)

- `emergent_care_staff_walkout` -- first noted turn 9, listed in 2 turn(s) so far: Coordinated staff walkouts and sick-outs in hospital systems still on paper triage and mandatory overtime force temporary ward closures in two member states.
- `emergent_clinical_staff_walkout` -- first noted turn 9, listed in 2 turn(s) so far: Hospital staff walkouts over paper-triage overload and unpaid overtime spread across several member states, forcing emergency staffing measures during containment.
...
## Metrics
```json
{"ai_capability": 66.0, "openweight_capability": 63.9, "ai_safety": 7.5, "resilience": 54.5, "eu_ai_sovereignty": 23.0, "eu_political_capital": 28.0, "public_sentiment": 2.0}
```
## Narrative
### Pandemic Mode
