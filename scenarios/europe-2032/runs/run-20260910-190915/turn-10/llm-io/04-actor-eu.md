...
- characters 453-1535: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1578-3458: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6874-7628: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10526-13504: `{{previous_actions}}` from the actor's own response from the previous turn
...
- `bio_containment_first` (position): Containment, cyber-restoration and site security remain preconditions, but restoring cut-off hospital, ministry and firm workloads onto EU-controlled systems now outranks new sovereign-build cash starts until essentials hold without foreign frontier access.
