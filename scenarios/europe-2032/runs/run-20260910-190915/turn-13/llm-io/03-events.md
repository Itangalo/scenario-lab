...
- characters 376-1775: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1819-4425: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4481-5715: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5778-29437: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29792-31029: `{{event_history}}` from the run's own event record
...
- `emergent_care_chain_contagion_strike` -- first noted turn 12, listed in 1 turn(s) so far: Coordinated walkouts by clinical support and municipal care staff spread beyond the five striking countries, forcing temporary closure of paper-based triage sites and prompting cross-border patient transfers.
- `emergent_support_staff_paralysis` -- first noted turn 12, listed in 1 turn(s) so far: Cross-border walkout of outsourced hospital IT and cleaning staff over infection risk and arrears closes triage-adjacent services in several crisis wards, distinct from the clinical staffing compact.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, eval_anomaly_reports, openweight_frontier_release
- Turn 3 (10 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented
- Turn 4 (9 turn(s) ago): cyber_major_incident
- Turn 5 (8 turn(s) ago): cyber_major_incident, emergent_cyber_insurance_retreat, election_retrenchment
- Turn 6 (7 turn(s) ago): bio_incident, bio_uplift_findings, openweight_frontier_release
- Turn 7 (6 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 8 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings, taiwan_tension_rise, emergent_anti_infrastructure_backlash
- Turn 9 (4 turn(s) ago): capability_jump, eu_frontier_access_denied
- Turn 10 (3 turn(s) ago): bio_uplift_findings, catastrophic_bio_incident, eval_anomaly_reports, research_breakthrough, eu_frontier_access_denied, joint_threat_response
- Turn 11 (2 turn(s) ago): capability_jump, bio_uplift_findings, medical_breakthrough, us_china_agreement, emergent_clinical_staff_walkout
- Turn 12 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, capability_jump, taiwan_blockade, ai_investment_collapse, eu_frontier_access_denied, supply_chain_coercion, member_state_defection
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.36}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.3}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.12}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.15}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.08}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.08}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.05}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.14}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Coordinated walkouts by clinical support and municipal care staff spread beyond the five striking countries, forcing temporary closure of paper-based triage sites and prompting cross-border patient transfers.", "emergent": true, "id": "emergent_care_chain_contagion_strike", "probability": 0.28}, {"description": "Cross-border walkout of outsourced hospital IT and cleaning staff over infection risk and arrears closes triage-adjacent services in several crisis wards, distinct from the clinical staffing compact.", "emergent": true, "id": "emergent_support_staff_paralysis", "probability": 0.24}]
```
