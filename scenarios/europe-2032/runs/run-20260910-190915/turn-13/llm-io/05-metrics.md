...
- characters 107-13460: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13503-13693: `{{metrics_json}}` from the run's live metric values
- characters 13786-15185: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15229-17835: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17891-18497: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Chip Chokepoint Hold and Continuity Procurement | 2 |
| M14 | EU Joint Defence Accession and Care Continuity Deployment | 2 |
...
## Notepad
PORTFOLIO CHARGE t13: EU Chip Chokepoint Hold and Continuity Procurement −2, EU Joint Defence Accession and Care Continuity Deployment −2, priority −1 = −5
PROPOSAL BONUS: EU Joint Defence Accession and Care Continuity Deployment (cat 6, small) +3 — ransomware sweep plus support/care walkouts landed this turn and last, and this answers them directly
LEGITIMACY LENDS: capital 12, sentiment 0 -> none, capital higher
SOVEREIGNTY: 20 last turn, no capacity event, no cat4 finishes, no cat4 in flight +0, capability rose 0.8 −0 = 20

## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M14", "fields": {"finish_turn": 14}, "grounds": "named priority"}]}
```
```
