...
- characters 13358-14276: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14319-16089: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16145-17214: `{{notepad}}` from the Game Master's notepad, carried across turns
