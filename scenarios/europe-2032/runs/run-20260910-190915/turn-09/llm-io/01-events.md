...
- characters 1449-3480: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3536-4016: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4079-30556: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30911-31563: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, eval_anomaly_reports, openweight_frontier_release
- Turn 3 (6 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented
- Turn 4 (5 turn(s) ago): cyber_major_incident
- Turn 5 (4 turn(s) ago): cyber_major_incident, emergent_cyber_insurance_retreat, election_retrenchment
- Turn 6 (3 turn(s) ago): bio_incident, bio_uplift_findings, openweight_frontier_release
- Turn 7 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 8 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, taiwan_tension_rise, emergent_anti_infrastructure_backlash
