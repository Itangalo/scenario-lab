...
- characters 13396-13587: `{{metrics_json}}` from the run's live metric values
- characters 13680-14709: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14753-16784: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16840-17849: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Essential Continuity Stack | 2 |
...
## Metrics
```json
{"ai_capability": 65.3, "openweight_capability": 62.5, "ai_safety": 9.5, "resilience": 55.5, "eu_ai_sovereignty": 25.0, "eu_political_capital": 27.0, "public_sentiment": 5.0}
```
