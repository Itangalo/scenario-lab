...
- characters 454-1483: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1527-3558: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4435-5223: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7926-10952: `{{previous_actions}}` from the actor's own response from the previous turn
