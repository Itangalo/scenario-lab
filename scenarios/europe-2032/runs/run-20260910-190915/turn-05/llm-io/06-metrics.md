...
- characters 13884-14962: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15006-16766: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16822-17551: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Municipal and Hospital Cyber Backstop | 2 |
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 57.5, "ai_safety": 24.5, "resilience": 43.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 29.0, "public_sentiment": 22.0}
```
