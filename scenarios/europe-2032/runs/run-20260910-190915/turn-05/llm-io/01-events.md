...
- characters 377-1455: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1499-3259: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3315-4333: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4396-32881: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33236-33498: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Evaluation Cell −2, EU Incident Surge and Bio-Detection Network −2, priority −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 25, sentiment 27 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, Gigafactories in flight +0, capability rose 2.0 −1 = 18

## Emerging developments (tracked)

- `emergent_care_triage_backlash` -- first noted turn 4, listed in 1 turn(s) so far: Major European health insurers announce AI-assisted claims triage exclusions after the autumn hospital disruptions, triggering patient-group lawsuits and a cross-border dispute over liability for model-supported care delays.
- `emergent_cyber_insurance_retreat` -- first noted turn 4, listed in 1 turn(s) so far: Private insurers across several member states temporarily withdraw or reprice cyber cover for hospitals and municipalities after the autumn sweep, forcing emergency state backstops for recovery costs.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, eval_anomaly_reports, openweight_frontier_release
- Turn 3 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented
