...
- characters 1577-3337: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4981-5439: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7573-8875: `{{previous_actions}}` from the actor's own response from the previous turn
