...
- characters 375-2210: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2253-4523: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4579-5003: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5066-30037: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30392-31422: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, eval_anomaly_reports, openweight_frontier_release
- Turn 3 (9 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented
- Turn 4 (8 turn(s) ago): cyber_major_incident
- Turn 5 (7 turn(s) ago): cyber_major_incident, emergent_cyber_insurance_retreat, election_retrenchment
- Turn 6 (6 turn(s) ago): bio_incident, bio_uplift_findings, openweight_frontier_release
- Turn 7 (5 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 8 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, taiwan_tension_rise, emergent_anti_infrastructure_backlash
- Turn 9 (3 turn(s) ago): capability_jump, eu_frontier_access_denied
- Turn 10 (2 turn(s) ago): bio_uplift_findings, catastrophic_bio_incident, eval_anomaly_reports, research_breakthrough, eu_frontier_access_denied, joint_threat_response
- Turn 11 (1 turn(s) ago): capability_jump, bio_uplift_findings, medical_breakthrough, us_china_agreement, emergent_clinical_staff_walkout
