...
- characters 106-13007: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13050-13240: `{{metrics_json}}` from the run's live metric values
- characters 13333-15168: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15211-17481: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17537-18589: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Clinical Retention and Emergency Staffing Compact | 2 |
...
## Metrics
```json
{"ai_capability": 67.8, "openweight_capability": 66.0, "ai_safety": 0.0, "resilience": 54.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 15.0, "public_sentiment": 0.0}
```
