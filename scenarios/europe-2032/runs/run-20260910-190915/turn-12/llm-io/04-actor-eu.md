...
- characters 453-2288: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2331-4601: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7971-8693: `{{statement_ledger}}` from the actor's live statement ledger
- characters 12176-14273: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M12 | EU Clinical Retention and Emergency Staffing Compact | 7 | small | 11 | 13 | own jurisdiction | resilience up moderately, public_sentiment up slightly, eu_political_capital up slightly if walkouts end | 2 | running |
