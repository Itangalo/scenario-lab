...
- characters 376-1286: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1329-3268: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3324-4110: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4173-30650: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31005-31529: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, eval_anomaly_reports, openweight_frontier_release
- Turn 3 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented
- Turn 4 (4 turn(s) ago): cyber_major_incident
- Turn 5 (3 turn(s) ago): cyber_major_incident, emergent_cyber_insurance_retreat, election_retrenchment
- Turn 6 (2 turn(s) ago): bio_incident, bio_uplift_findings, openweight_frontier_release
- Turn 7 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports
