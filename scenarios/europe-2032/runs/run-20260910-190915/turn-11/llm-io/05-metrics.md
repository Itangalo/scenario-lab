...
- characters 13698-14840: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14884-16991: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17047-17507: `{{notepad}}` from the Game Master's notepad, carried across turns
...
Brussels answered with cash for shifts. Overtime guarantees, backfill funds paid direct to hospitals, and mobile relief teams from the civil protection pool arrived within weeks. Unions paused further walkouts where money landed, wards reopened, but elsewhere local managers called the package late and conditional, and short sick-outs continued through December. Essentials held, degraded.
