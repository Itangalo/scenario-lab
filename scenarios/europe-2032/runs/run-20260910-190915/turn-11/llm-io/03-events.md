...
- characters 376-1518: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1562-3669: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3725-4714: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4777-31254: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31609-32500: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, eval_anomaly_reports, openweight_frontier_release
- Turn 3 (8 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented
- Turn 4 (7 turn(s) ago): cyber_major_incident
- Turn 5 (6 turn(s) ago): cyber_major_incident, emergent_cyber_insurance_retreat, election_retrenchment
- Turn 6 (5 turn(s) ago): bio_incident, bio_uplift_findings, openweight_frontier_release
- Turn 7 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 8 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, taiwan_tension_rise, emergent_anti_infrastructure_backlash
- Turn 9 (2 turn(s) ago): capability_jump, eu_frontier_access_denied
- Turn 10 (1 turn(s) ago): bio_uplift_findings, catastrophic_bio_incident, eval_anomaly_reports, research_breakthrough, eu_frontier_access_denied, joint_threat_response
