...
- characters 1954-4012: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4068-4614: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4677-31154: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31509-31964: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, eval_anomaly_reports, openweight_frontier_release
- Turn 3 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, openweight_frontier_release, knowledge_work_augmented
- Turn 4 (3 turn(s) ago): cyber_major_incident
- Turn 5 (2 turn(s) ago): cyber_major_incident, emergent_cyber_insurance_retreat, election_retrenchment
- Turn 6 (1 turn(s) ago): bio_incident, bio_uplift_findings, openweight_frontier_release
