...
- characters 106-13434: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13477-13669: `{{metrics_json}}` from the run's live metric values
- characters 13762-15165: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15209-17392: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17448-17957: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Incident Surge and Bio-Detection Network | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, European Critical Systems Shield −3, EU Frontier Evaluation Cell −2, priority −1 = −12
PROPOSAL BONUS: EU Frontier Evaluation Cell (cat 5, small) +2 — leaked evasive-behaviour reports plus widely copied open release in last two turns and this answers it directly
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Evaluation Cell −2, EU Incident Surge and Bio-Detection Network −2, priority −1 = −11
PROPOSAL BONUS: none — knowledge_work_augmented removes felt problem, no bonus for measure addressing recent negative event applies
LEGITIMACY LENDS: capital 31, sentiment 34 -> +2
