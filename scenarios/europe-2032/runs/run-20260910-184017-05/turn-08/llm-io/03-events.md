...
- characters 376-1296: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1339-3449: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3505-4428: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4491-28677: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29032-29640: `{{event_history}}` from the run's own event record
...
- `emergent_anti_ai_sabotage` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated physical protests block or damage gigafactory grid-connection works and a foreign-owned warehouse automation site, forcing construction delays and a policing response.
- `emergent_anti_ai_sabotage_sites` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated physical protests block or damage gigafactory grid-connection works and a foreign warehouse automation site, forcing construction delays and a policing response.
...
- Turn 2 (6 turn(s) ago): eval_anomaly_reports, safety_breakthrough, adoption_success
- Turn 3 (5 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 4 (4 turn(s) ago): cyber_major_incident
- Turn 5 (3 turn(s) ago): embodied_ai_deployment, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, us_china_agreement
- Turn 7 (1 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, automated_decision_scandal
