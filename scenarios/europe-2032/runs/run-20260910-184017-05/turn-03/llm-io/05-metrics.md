...
- characters 106-13457: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13500-13692: `{{metrics_json}}` from the run's live metric values
- characters 13785-15184: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15228-17627: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17683-18233: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU AI Assurance and Anomaly Triage Capacity | 2 |
| M5 | EU Biosecurity Detection and Response Uplift | 2 |
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Assurance and Anomaly Triage Capacity −2, EU Biosecurity Detection and Response Uplift −2, priority −1 = −11
PROPOSAL BONUS: EU Biosecurity Detection and Response Uplift (cat 6, small) +3 — bio_uplift signal landed this turn, categorically stronger precursor opening bio window and this answers it directly
LEGITIMACY LENDS: capital 30, sentiment 50 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, no finishing measure, in flight +0, capability rose 2.0 −1 = 18
