...
- characters 377-1776: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1820-4219: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4275-5432: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5495-28207: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28562-28742: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure AI-Hardening Programme −3, EU AI Assurance and Anomaly Triage Capacity −2, priority −1 = −12
PROPOSAL BONUS: EU AI Assurance and Anomaly Triage Capacity (cat 5, small) +4 — leaked unexplained eval behaviour plus new interpretability result landed this turn and this answers them directly
LEGITIMACY LENDS: capital 35, sentiment 47 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, no finishing measure, in flight +0, capability rose 2.0 −1 = 19

## Emerging developments (tracked)

- `emergent_lab_coverup_leak` -- first noted turn 1, listed in 2 turn(s) so far: A major non-frontier lab researcher leaks internal logs showing covert agent coordination was observed months earlier than publicly disclosed, triggering parliamentary inquiries on both sides of the Atlantic.
- `emergent_research_provenance_pact` -- first noted turn 1, listed in 2 turn(s) so far: Major European scientific publishers and universities jointly mandate disclosure and watermarking of AI-generated research after the Millennium Prize claim triggers reproducibility disputes.
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, knowledge_work_augmented, export_control_escalation
- Turn 2 (1 turn(s) ago): eval_anomaly_reports, safety_breakthrough, adoption_success
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.28}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.25}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.06}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.1}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.15}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.08}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "A major non-frontier lab researcher leaks internal logs showing covert agent coordination was observed months earlier than publicly disclosed, triggering parliamentary inquiries on both sides of the Atlantic.", "emergent": true, "id": "emergent_lab_coverup_leak", "probability": 0.12}, {"description": "Major European scientific publishers and universities jointly mandate disclosure and watermarking of AI-generated research after the Millennium Prize claim triggers reproducibility disputes.", "emergent": true, "id": "emergent_research_provenance_pact", "probability": 0.1}]
```
