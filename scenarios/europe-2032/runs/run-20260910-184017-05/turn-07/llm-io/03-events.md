...
- characters 377-1751: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1795-3983: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4039-4591: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4654-28237: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28592-29098: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): eval_anomaly_reports, safety_breakthrough, adoption_success
- Turn 3 (4 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 4 (3 turn(s) ago): cyber_major_incident
- Turn 5 (2 turn(s) ago): embodied_ai_deployment, election_consolidation
- Turn 6 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, us_china_agreement
