...
- characters 13686-15060: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15104-17292: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17348-18459: `{{notepad}}` from the Game Master's notepad, carried across turns
