...
- characters 376-2511: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2554-4681: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4737-5479: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5542-29987: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30342-31210: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Distressed Capacity Capture Facility −2, priority −0 (capital below 20, no effect, no cost) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 3, sentiment 14 -> +2 (capped by sentiment, after charge/finish/events)
SOVEREIGNTY: 12 last turn, no capacity event, Distressed Facility in flight +1, capability rose 1.0 no charge = 13

## Emerging developments (tracked)

- `emergent_clinical_pathway_suspension` -- first noted turn 10, listed in 2 turn(s) so far: A major European hospital group publicly suspends use of a US-planned therapy pathway after a dosing-log error, triggering cross-border patient transfers and an emergency EMA review of logged-workload clinical protocols.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, knowledge_work_augmented, export_control_escalation
- Turn 2 (10 turn(s) ago): eval_anomaly_reports, safety_breakthrough, adoption_success
- Turn 3 (9 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 4 (8 turn(s) ago): cyber_major_incident
- Turn 5 (7 turn(s) ago): embodied_ai_deployment, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, us_china_agreement
- Turn 7 (5 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, automated_decision_scandal
- Turn 8 (4 turn(s) ago): member_state_defection
- Turn 9 (3 turn(s) ago): medical_breakthrough
- Turn 10 (2 turn(s) ago): ai_investment_collapse, export_control_escalation
- Turn 11 (1 turn(s) ago): loss_of_control_incident, emergent_therapy_triage_scandal
