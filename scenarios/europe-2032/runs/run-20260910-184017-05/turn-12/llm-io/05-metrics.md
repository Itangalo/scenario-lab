...
- characters 106-13343: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13386-13577: `{{metrics_json}}` from the run's live metric values
- characters 13670-15805: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15848-17975: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18031-18422: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Logged-Workload Clinical Safety Reset | 2 |
