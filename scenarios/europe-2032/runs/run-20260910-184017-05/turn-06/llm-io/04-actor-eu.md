...
- characters 454-2085: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2128-4495: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8072-8527: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10673-13098: `{{previous_actions}}` from the actor's own response from the previous turn
