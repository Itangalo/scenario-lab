...
- characters 105-13405: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13448-13640: `{{metrics_json}}` from the run's live metric values
- characters 13733-15364: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15407-17774: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17830-18356: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU-US AI Access and Supply-Chain Bargain | 2 |
| M7 | EU Automated Attack Containment and Continuity Surge | 2 |
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 winner was consolidation, takes effect turn 6"}, {"op": "update", "table": "measures", "id": "M7", "fields": {"finish_turn": 8}, "grounds": "named priority"}]}
```
```
