...
- characters 105-13019: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13062-13254: `{{metrics_json}}` from the run's live metric values
- characters 13347-14680: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14723-17022: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17078-18313: `{{notepad}}` from the Game Master's notepad, carried across turns
