...
- characters 106-13006: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13049-13241: `{{metrics_json}}` from the run's live metric values
- characters 13357-16306: `{{world_state}}` from background/context.md, seeded as the opening world state
- characters 16362-16967: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M3 | EU Critical Infrastructure AI-Hardening Programme | 3 |
...
- `emergent_lab_coverup_leak` -- first noted turn 1, listed in 1 turn(s) so far: A major non-frontier lab researcher leaks internal logs showing covert agent coordination was observed months earlier than publicly disclosed, triggering parliamentary inquiries on both sides of the Atlantic.
- `emergent_research_provenance_pact` -- first noted turn 1, listed in 1 turn(s) so far: Major European scientific publishers and universities jointly mandate disclosure and watermarking of AI-generated research after the Millennium Prize claim triggers reproducibility disputes.
...
## Metrics
```json
{"ai_capability": 54.0, "openweight_capability": 46.0, "ai_safety": 32.0, "resilience": 38.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 43.0, "public_sentiment": 45.0}
```
## Narrative
