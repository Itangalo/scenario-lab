...
- characters 1800-3548: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4275-4731: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7491-9858: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Trusted Clinical AI Access Programme | 9 | small | 9 | 11 | own jurisdiction | public_sentiment up sharply, eu_political_capital stabilized, resilience up slightly via healthcare continuity | 2 | running |
