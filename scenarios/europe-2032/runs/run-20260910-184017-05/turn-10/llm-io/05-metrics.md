...
- characters 106-13418: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13461-13652: `{{metrics_json}}` from the run's live metric values
- characters 13745-15048: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15091-16839: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16895-17997: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Trusted Clinical AI Access Programme | 2 |
| M10 | EU Distressed Capacity Capture Facility | 2 |
...
PORTFOLIO CHARGE t9: EU Public AI Redress and Procurement Repair −2, EU Trusted Clinical AI Access Programme −2, priority −0 (capital below 20, no effect, no cost) = −4
PROPOSAL BONUS: none — new clinical programme answers medical_breakthrough which is positive, not a negative event from last three rounds
LEGITIMACY LENDS: capital 6, sentiment 22 -> +2
SOVEREIGNTY: 13 last turn, no capacity event, no category 4 in flight +0, capability rose 1.0 no charge = 13
