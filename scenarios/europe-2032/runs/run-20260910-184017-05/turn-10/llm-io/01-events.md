...
- characters 1722-3470: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3526-3989: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4052-28238: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28593-29297: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): eval_anomaly_reports, safety_breakthrough, adoption_success
- Turn 3 (7 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 4 (6 turn(s) ago): cyber_major_incident
- Turn 5 (5 turn(s) ago): embodied_ai_deployment, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, us_china_agreement
- Turn 7 (3 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, automated_decision_scandal
- Turn 8 (2 turn(s) ago): member_state_defection
- Turn 9 (1 turn(s) ago): medical_breakthrough
