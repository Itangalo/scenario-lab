...
- characters 377-2200: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2244-4438: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4494-5695: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5758-30203: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30558-31340: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Trusted Clinical AI Access Programme −2, EU Distressed Capacity Capture Facility −2, priority −0 (capital below 20, no effect, no cost) = −4
PROPOSAL BONUS: EU Distressed Capacity Capture Facility (cat 4, small) +2 — ai_investment_collapse and export tightening landed this turn and this answers them directly, small size limits gain
LEGITIMACY LENDS: capital 4, sentiment 22 -> +2
SOVEREIGNTY: 13 last turn, no capacity event finish, Distressed Facility in flight +1, export_control_escalation t10 −2, capability rose 0.8 no charge = 12

## Emerging developments (tracked)

- `emergent_therapy_triage_scandal` -- first noted turn 10, listed in 1 turn(s) so far: A US therapy-planning model error or quota-driven triage denial causes a high-profile patient death in an EU pilot ward, triggering cross-border media inquiry into reliance on tiered foreign weights.
- `emergent_clinical_pathway_suspension` -- first noted turn 10, listed in 1 turn(s) so far: A major European hospital group publicly suspends use of a US-planned therapy pathway after a dosing-log error, triggering cross-border patient transfers and an emergency EMA review of logged-workload clinical protocols.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, knowledge_work_augmented, export_control_escalation
- Turn 2 (9 turn(s) ago): eval_anomaly_reports, safety_breakthrough, adoption_success
- Turn 3 (8 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 4 (7 turn(s) ago): cyber_major_incident
- Turn 5 (6 turn(s) ago): embodied_ai_deployment, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, us_china_agreement
- Turn 7 (4 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, automated_decision_scandal
- Turn 8 (3 turn(s) ago): member_state_defection
- Turn 9 (2 turn(s) ago): medical_breakthrough
