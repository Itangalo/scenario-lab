...
- characters 107-13369: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13412-13603: `{{metrics_json}}` from the run's live metric values
- characters 13696-15519: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15563-17757: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17813-18726: `{{notepad}}` from the Game Master's notepad, carried across turns
