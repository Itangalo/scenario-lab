...
- characters 105-13063: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13106-13298: `{{metrics_json}}` from the run's live metric values
- characters 13391-14702: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14745-16848: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16904-18022: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 50.0, "ai_safety": 37.0, "resilience": 39.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 37.0, "public_sentiment": 47.0}
```
