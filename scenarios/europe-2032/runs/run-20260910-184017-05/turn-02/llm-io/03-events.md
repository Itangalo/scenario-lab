...
- characters 376-1687: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1730-3833: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3889-5007: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5070-27782: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28137-28231: `{{event_history}}` from the run's own event record
