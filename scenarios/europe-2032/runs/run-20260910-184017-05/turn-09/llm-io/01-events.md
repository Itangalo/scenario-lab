...
- characters 1504-3427: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3483-4573: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4636-28822: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29177-29834: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU-US AI Access and Supply-Chain Bargain −2, EU Public AI Redress and Procurement Repair −2, priority −0 (capital below 20, no effect, no cost) = −4
PROPOSAL BONUS: EU Public AI Redress and Procurement Repair (cat 9, small) +3 — benefits-eligibility scandal landed t7 and this answers it directly, small size limits gain
LEGITIMACY LENDS: capital 5, sentiment 22 -> +2
SOVEREIGNTY: 15 last turn, no category 4 finish, no category 4 in flight +0, member_state_defection t8 −2, capability rose 1.0 no charge = 13

## Emerging developments (tracked)

- `emergent_anti_ai_sabotage` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated physical protests block or damage gigafactory grid-connection works and a foreign-owned warehouse automation site, forcing construction delays and a policing response.
- `emergent_anti_ai_sabotage_sites` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated physical protests block or damage gigafactory grid-connection works and a foreign warehouse automation site, forcing construction delays and a policing response.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, knowledge_work_augmented, export_control_escalation
- Turn 2 (7 turn(s) ago): eval_anomaly_reports, safety_breakthrough, adoption_success
- Turn 3 (6 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 4 (5 turn(s) ago): cyber_major_incident
- Turn 5 (4 turn(s) ago): embodied_ai_deployment, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, us_china_agreement
- Turn 7 (2 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, automated_decision_scandal
- Turn 8 (1 turn(s) ago): member_state_defection
