...
- characters 1582-3505: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3974-4429: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6972-9060: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Public AI Redress and Procurement Repair | 9 | small | 8 | 10 | own jurisdiction | public_sentiment up, eu_political_capital stabilized, ai_safety up slightly via procurement enforcement | 2 | running |
