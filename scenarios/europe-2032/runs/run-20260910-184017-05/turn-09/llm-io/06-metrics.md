...
- characters 106-13419: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13462-13653: `{{metrics_json}}` from the run's live metric values
- characters 13746-14830: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14874-16797: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16853-17384: `{{notepad}}` from the Game Master's notepad, carried across turns
