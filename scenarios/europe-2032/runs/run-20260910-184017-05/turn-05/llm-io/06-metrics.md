...
- characters 13737-14839: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14883-17232: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17288-18352: `{{notepad}}` from the Game Master's notepad, carried across turns
