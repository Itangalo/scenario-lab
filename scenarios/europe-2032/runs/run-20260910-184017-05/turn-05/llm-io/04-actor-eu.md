...
- characters 1601-3950: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6035-6512: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8444-9869: `{{previous_actions}}` from the actor's own response from the previous turn
