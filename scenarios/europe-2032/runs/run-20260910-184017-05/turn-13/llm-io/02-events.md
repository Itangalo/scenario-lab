...
- characters 377-2796: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2840-4655: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4711-5181: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5244-29689: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30044-31020: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Logged-Workload Clinical Safety Reset −2, priority −0 (capital below 20, no effect, no cost) = −2
PROPOSAL BONUS: EU Logged-Workload Clinical Safety Reset (cat 1, small) +2 — emergent hospital-group suspension and Rotterdam death last turn, this answers directly
LEGITIMACY LENDS: capital 0, sentiment 12 -> +2
SOVEREIGNTY: 13 last turn, Distressed Capacity Capture Facility finishes t12 +4, no capacity event, capability rose 1.2 no charge = 17
...
- Turn 2 (11 turn(s) ago): eval_anomaly_reports, safety_breakthrough, adoption_success
- Turn 3 (10 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 4 (9 turn(s) ago): cyber_major_incident
- Turn 5 (8 turn(s) ago): embodied_ai_deployment, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, embodied_ai_deployment, us_china_agreement
- Turn 7 (6 turn(s) ago): cyber_defence_breakthrough, safety_breakthrough, automated_decision_scandal
- Turn 8 (5 turn(s) ago): member_state_defection
- Turn 9 (4 turn(s) ago): medical_breakthrough
- Turn 10 (3 turn(s) ago): ai_investment_collapse, export_control_escalation
- Turn 11 (2 turn(s) ago): loss_of_control_incident, emergent_therapy_triage_scandal
- Turn 12 (1 turn(s) ago): capability_jump, knowledge_work_augmented, emergent_clinical_pathway_suspension
