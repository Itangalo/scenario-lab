...
- characters 2167-4413: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4469-4969: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5032-26935: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27290-27680: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): taiwan_blockade, openweight_frontier_release, safety_breakthrough, member_state_defection
- Turn 3 (2 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, taiwan_tension_rise, export_control_escalation, emergent_grid_copycat_extortion
- Turn 4 (1 turn(s) ago): loss_of_control_incident, member_state_defection
