...
- characters 455-2201: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2245-4491: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5862-6302: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8549-10610: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Loss-of-Control Containment Network | 6 | small | 4 | 5 | own jurisdiction | resilience up, ai_safety up modestly | 2 | finished |
