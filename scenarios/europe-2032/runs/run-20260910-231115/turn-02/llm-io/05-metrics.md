...
- characters 13372-14603: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14646-17236: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17292-18326: `{{notepad}}` from the Game Master's notepad, carried across turns
