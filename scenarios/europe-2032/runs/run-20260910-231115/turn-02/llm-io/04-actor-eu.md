...
- characters 5738-6178: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7632-9723: `{{previous_actions}}` from the actor's own response from the previous turn
