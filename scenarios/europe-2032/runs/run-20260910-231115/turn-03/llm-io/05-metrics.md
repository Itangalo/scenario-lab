...
- characters 106-13092: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13135-13327: `{{metrics_json}}` from the run's live metric values
- characters 13420-14760: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14804-17103: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17159-17965: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Grid and Essential Services Shield | 2 |
| M5 | EU Supply-Chain Bargain Coalition | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Grid and Essential Services Shield −2, priority −1 = −12
PROPOSAL BONUS: none — no priced event in last three turns; autumn intrusions are background, new measure answers current-turn shocks not prior events
LEGITIMACY LENDS: capital 20, sentiment 32 -> +2
SOVEREIGNTY: 20 last turn, no capacity finish, Gigafactories in flight +0, member_state_defection t2 −2, capability rose 1.5 −0 = 18

## Emerging developments (tracked)

- `emergent_hyperscaler_pause_eu` -- first noted turn 2, listed in 2 turn(s) so far: A major US hyperscaler publicly pauses two planned EU data-centre expansions, citing permitting delays and grid-connection uncertainty around the AI factory siting process.
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Grid and Essential Services Shield −2, EU Supply-Chain Bargain Coalition −2, priority −1 = −14
PROPOSAL BONUS: EU Supply-Chain Bargain Coalition (cat 8, small) +3 — answers cross-strait blockade and breakaway from t2 plus export tightening and investment collapse this turn directly
LEGITIMACY LENDS: capital 29, sentiment 32 -> +2
SOVEREIGNTY: 18 last turn, no capacity event finish +0, Gigafactories in flight +0, export_control_escalation t3 −2, capability rose 1.0 −0 = 16
## Store changes
```json
{"store": []}
```
