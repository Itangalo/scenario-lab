...
- characters 13854-15597: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15640-18049: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18105-18703: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Loss-of-Control Containment Network | 2 |
...
## Metrics
```json
{"ai_capability": 57.5, "openweight_capability": 53.5, "ai_safety": 36.0, "resilience": 40.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 27.0, "public_sentiment": 26.0}
```
