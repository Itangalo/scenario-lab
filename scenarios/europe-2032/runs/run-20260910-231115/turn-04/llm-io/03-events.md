...
- characters 376-2119: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2162-4571: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4627-5520: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5583-27486: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27841-28156: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): taiwan_blockade, openweight_frontier_release, safety_breakthrough, member_state_defection
- Turn 3 (1 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, taiwan_tension_rise, export_control_escalation, emergent_grid_copycat_extortion
