...
- characters 1727-4138: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5526-5999: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8399-10477: `{{previous_actions}}` from the actor's own response from the previous turn
