...
- characters 1649-4060: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4116-4945: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5008-33435: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33790-34211: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Automating-Employer Transition Fund −2, EU Essential Services Cyber Surge −2, priority −1 = −11
PROPOSAL BONUS: EU Essential Services Cyber Surge (cat 6, small) +3 — cyber_major_incident landed this turn severe and this answers it directly
LEGITIMACY LENDS: capital 13, sentiment 28 -> +2
SOVEREIGNTY: 18 last turn, no capacity event finishes, no cat4 in flight bonus, export_control_escalation t4 −2, capability rose 7.0 −1 = 15

## Emerging developments (tracked)

- `emergent_municipal_hardening_standoff` -- first noted turn 4, listed in 1 turn(s) so far: Municipal water and grid operators hit by autumn intrusion drills publicly refuse ENISA hardening orders, triggering a court-backed standoff over EU access to local critical infrastructure.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, loss_of_control_incident, capability_jump
- Turn 2 (3 turn(s) ago): openweight_frontier_release, labour_displacement, export_control_escalation, adoption_success
- Turn 3 (2 turn(s) ago): safety_breakthrough, us_china_agreement
- Turn 4 (1 turn(s) ago): cyber_major_incident, rsi_onset, research_breakthrough, medical_breakthrough, taiwan_tension_rise, export_control_escalation
...
```
[{"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.55}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.28}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.15}, {"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.075}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.15}, {"description": "", "emergent": false, "id": "us_labs_nationalised", "probability": 0.12}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Municipal water and grid operators hit by autumn intrusion drills publicly refuse ENISA hardening orders, triggering a court-backed standoff over EU access to local critical infrastructure.", "emergent": true, "id": "emergent_municipal_hardening_standoff", "probability": 0.22}]
```
