...
- characters 106-13615: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13658-13850: `{{metrics_json}}` from the run's live metric values
- characters 13943-15171: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15215-17626: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17682-18511: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 75.0, "openweight_capability": 66.8, "ai_safety": 15.0, "resilience": 42.5, "eu_ai_sovereignty": 15.0, "eu_political_capital": 18.0, "public_sentiment": 27.0}
```
