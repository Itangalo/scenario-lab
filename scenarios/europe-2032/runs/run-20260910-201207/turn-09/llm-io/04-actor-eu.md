...
- characters 455-1874: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1918-3963: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5159-5604: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8760-11241: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M10 | EU Pandemic Continuity and Biosurveillance Surge | 6 | small | 8 | 10 | own jurisdiction and biosurveillance coalition | resilience up materially, ai_safety up slightly via deployed assurance | 2 | running |
