...
- characters 377-1796: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1840-3885: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3941-5086: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5149-32439: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32794-33583: `{{event_history}}` from the run's own event record
...
- `emergent_siting_backlash_blocks` -- first noted turn 7, listed in 2 turn(s) so far: Physical protests block accelerated compute-zone construction sites after outage maps and frozen graduate hiring fuse into anti-data-centre movement, delaying grid-hardened permits.
- `emergent_siting_blockade_freeze` -- first noted turn 7, listed in 2 turn(s) so far: A coordinated physical and legal blockade of EU accelerated compute zones by municipal coalitions and local courts halts grid-connection works for months, freezing Gigafactory build-out regardless of Brussels permits.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, loss_of_control_incident, capability_jump
- Turn 2 (7 turn(s) ago): openweight_frontier_release, labour_displacement, export_control_escalation, adoption_success
- Turn 3 (6 turn(s) ago): safety_breakthrough, us_china_agreement
- Turn 4 (5 turn(s) ago): cyber_major_incident, rsi_onset, research_breakthrough, medical_breakthrough, taiwan_tension_rise, export_control_escalation
- Turn 5 (4 turn(s) ago): cyber_major_incident, election_retrenchment
- Turn 6 (3 turn(s) ago): cyber_major_incident, opaque_reasoning, medical_breakthrough
- Turn 7 (2 turn(s) ago): cyber_major_incident, research_breakthrough, member_state_defection
- Turn 8 (1 turn(s) ago): bio_uplift_findings, catastrophic_bio_incident, safety_breakthrough, joint_threat_response
