...
- characters 13523-13715: `{{metrics_json}}` from the run's live metric values
- characters 13808-15227: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15271-17316: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17372-17906: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 87.2, "openweight_capability": 79.5, "ai_safety": 4.0, "resilience": 44.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 11.0, "public_sentiment": 12.0}
```
