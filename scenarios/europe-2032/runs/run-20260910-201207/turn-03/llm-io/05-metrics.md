...
- characters 106-13486: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13529-13721: `{{metrics_json}}` from the run's live metric values
- characters 13814-15540: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15584-17617: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17673-18237: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Bridge to the Washington-Beijing Safety Floor | 2 |
