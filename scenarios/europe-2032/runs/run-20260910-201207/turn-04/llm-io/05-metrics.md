...
- characters 105-13514: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13557-13749: `{{metrics_json}}` from the run's live metric values
- characters 13842-15924: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15967-18400: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18456-19290: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Automating-Employer Transition Fund | 2 |
| M6 | EU Essential Services Cyber Surge | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Automating-Employer Transition Fund −2, EU Bridge to the Washington-Beijing Safety Floor −2, priority −1 = −11
PROPOSAL BONUS: none — new Bridge (cat 8, small) answers US-China agreement but that is an opportunity not a negative shock from last three turns, no bonus
LEGITIMACY LENDS: capital 19, sentiment 33 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, Gigafactories/Tech sovereignty in flight +0, capability rose 2.0 −1 = 18
