...
- characters 105-13478: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13521-13711: `{{metrics_json}}` from the run's live metric values
- characters 13804-14942: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14985-17025: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17081-18263: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Essential Services Islanding and Access Pact | 2 |
| M9 | EU Licence Solidarity and Clinical Continuity Pact | 2 |
| M10 | EU Pandemic Continuity and Biosurveillance Surge | 2 |
...
## Metrics
```json
{"ai_capability": 81.9, "openweight_capability": 77.0, "ai_safety": 13.0, "resilience": 41.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 13.0, "public_sentiment": 10.0}
```
