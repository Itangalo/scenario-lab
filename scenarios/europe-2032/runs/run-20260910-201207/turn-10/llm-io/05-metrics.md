...
- characters 106-13665: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13708-13899: `{{metrics_json}}` from the run's live metric values
- characters 13992-16016: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16059-18290: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18346-19566: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Anti-Coercion Supply and Cure Access Shield | 2 |
| M12 | EU Pathogen Early-Warning and Care Continuity Net | 2 |
