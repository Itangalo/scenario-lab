...
- characters 376-2400: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2443-4674: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4730-5360: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5423-32713: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33068-33944: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, loss_of_control_incident, capability_jump
- Turn 2 (8 turn(s) ago): openweight_frontier_release, labour_displacement, export_control_escalation, adoption_success
- Turn 3 (7 turn(s) ago): safety_breakthrough, us_china_agreement
- Turn 4 (6 turn(s) ago): cyber_major_incident, rsi_onset, research_breakthrough, medical_breakthrough, taiwan_tension_rise, export_control_escalation
- Turn 5 (5 turn(s) ago): cyber_major_incident, election_retrenchment
- Turn 6 (4 turn(s) ago): cyber_major_incident, opaque_reasoning, medical_breakthrough
- Turn 7 (3 turn(s) ago): cyber_major_incident, research_breakthrough, member_state_defection
- Turn 8 (2 turn(s) ago): bio_uplift_findings, catastrophic_bio_incident, safety_breakthrough, joint_threat_response
- Turn 9 (1 turn(s) ago): capability_jump, medical_breakthrough, supply_chain_coercion
