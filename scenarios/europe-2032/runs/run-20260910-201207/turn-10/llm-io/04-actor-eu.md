...
- characters 454-2478: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2521-4752: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5982-6457: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9893-12571: `{{previous_actions}}` from the actor's own response from the previous turn
