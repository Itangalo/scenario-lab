...
- characters 454-1684: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1727-3806: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3874-4349: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8002-9291: `{{previous_actions}}` from the actor's own response from the previous turn
