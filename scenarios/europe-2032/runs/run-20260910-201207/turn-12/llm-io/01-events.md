...
- characters 376-1606: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1649-3728: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3784-4780: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4843-32133: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32488-33557: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Anti-Coercion Supply and Cure Access Shield −2, EU Pathogen Early-Warning and Care Continuity Net −2, priority −0 (capital below 20, no effect, no cost) = −4
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 13, sentiment 14 -> +2 (capped at sentiment)
SOVEREIGNTY: 16 last turn, no capacity event, no cat4 in flight +0, capability rose 1.2 −0 = 16

## Emerging developments (tracked)

- `emergent_alt_lithography_lifeline` -- first noted turn 10, listed in 2 turn(s) so far: Japanese equipment makers and a Taiwanese service consortium quietly offer the EU pooled maintenance and legacy-tool parts outside US jurisdiction, blunting the Dutch servicing cut without any EU decision.
- `emergent_endemic_downgrade` -- first noted turn 10, listed in 2 turn(s) so far: WHO declares the engineered pneumonia strain endemic and winds down emergency coordination, stripping Brussels of pooled-procurement authority just as triage queues persist.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, loss_of_control_incident, capability_jump
- Turn 2 (10 turn(s) ago): openweight_frontier_release, labour_displacement, export_control_escalation, adoption_success
- Turn 3 (9 turn(s) ago): safety_breakthrough, us_china_agreement
- Turn 4 (8 turn(s) ago): cyber_major_incident, rsi_onset, research_breakthrough, medical_breakthrough, taiwan_tension_rise, export_control_escalation
- Turn 5 (7 turn(s) ago): cyber_major_incident, election_retrenchment
- Turn 6 (6 turn(s) ago): cyber_major_incident, opaque_reasoning, medical_breakthrough
- Turn 7 (5 turn(s) ago): cyber_major_incident, research_breakthrough, member_state_defection
- Turn 8 (4 turn(s) ago): bio_uplift_findings, catastrophic_bio_incident, safety_breakthrough, joint_threat_response
- Turn 9 (3 turn(s) ago): capability_jump, medical_breakthrough, supply_chain_coercion
- Turn 10 (2 turn(s) ago): bio_uplift_findings, medical_breakthrough, adoption_success
- Turn 11 (1 turn(s) ago): openweight_frontier_release, knowledge_work_augmented, joint_threat_response
