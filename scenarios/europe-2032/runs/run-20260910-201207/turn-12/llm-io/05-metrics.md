...
- characters 13510-13701: `{{metrics_json}}` from the run's live metric values
- characters 13794-15024: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15067-17146: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17202-17608: `{{notepad}}` from the Game Master's notepad, carried across turns
