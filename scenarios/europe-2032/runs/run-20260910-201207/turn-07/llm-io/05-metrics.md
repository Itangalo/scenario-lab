...
- characters 13483-13674: `{{metrics_json}}` from the run's live metric values
- characters 13767-14996: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15040-17345: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17401-18519: `{{notepad}}` from the Game Master's notepad, carried across turns
