...
- characters 1623-3352: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3408-3758: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3821-31111: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31466-32536: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Pathogen Early-Warning and Care Continuity Net −2, priority −0 (capital below 20, no effect, no cost) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 16, sentiment 16 -> +0 (equal, no lend)
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, loss_of_control_incident, capability_jump
- Turn 2 (11 turn(s) ago): openweight_frontier_release, labour_displacement, export_control_escalation, adoption_success
- Turn 3 (10 turn(s) ago): safety_breakthrough, us_china_agreement
- Turn 4 (9 turn(s) ago): cyber_major_incident, rsi_onset, research_breakthrough, medical_breakthrough, taiwan_tension_rise, export_control_escalation
- Turn 5 (8 turn(s) ago): cyber_major_incident, election_retrenchment
- Turn 6 (7 turn(s) ago): cyber_major_incident, opaque_reasoning, medical_breakthrough
- Turn 7 (6 turn(s) ago): cyber_major_incident, research_breakthrough, member_state_defection
- Turn 8 (5 turn(s) ago): bio_uplift_findings, catastrophic_bio_incident, safety_breakthrough, joint_threat_response
- Turn 9 (4 turn(s) ago): capability_jump, medical_breakthrough, supply_chain_coercion
- Turn 10 (3 turn(s) ago): bio_uplift_findings, medical_breakthrough, adoption_success
- Turn 11 (2 turn(s) ago): openweight_frontier_release, knowledge_work_augmented, joint_threat_response
