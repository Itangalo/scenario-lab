...
- characters 106-13028: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13071-13263: `{{metrics_json}}` from the run's live metric values
- characters 13379-16328: `{{world_state}}` from background/context.md, seeded as the opening world state
- characters 16384-17080: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M3 | EU Critical Shield and Continuity Programme | 3 |
...
- `emergent_provenance_mandate_fight` -- first noted turn 1, listed in 1 turn(s) so far: A major European scientific publisher and two national research funders impose mandatory AI-provenance and disclosure rules for submitted papers after the Millennium Prize claim, triggering a high-profile dispute over verification of AI-assisted proofs.
- `emergent_bio_publishing_freeze` -- first noted turn 1, listed in 1 turn(s) so far: A major European scientific publisher or preprint server imposes mandatory AI-uplift screening and holds back several genome-model manuscripts after the phage demonstrations, triggering a public fight over censorship versus safety.
...
## Metrics
```json
{"ai_capability": 60.0, "openweight_capability": 46.0, "ai_safety": 24.0, "resilience": 37.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 39.0, "public_sentiment": 35.0}
```
...
## Notepad
PORTFOLIO CHARGE t1: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Shield and Continuity Programme −3, priority −1 = −10
PROPOSAL BONUS: EU Critical Shield (cat 6, large) +4 — cyber_test_shot precursor landed this turn with EU grids mapped and this answers it directly
LEGITIMACY LENDS: capital 39, sentiment 35 -> none (capital higher)
SOVEREIGNTY: 22 last turn, no capacity event, Gigafactories/Tech sovereignty in flight +0, capability rose 8 −1 = 21
