...
- characters 107-13029: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13072-13263: `{{metrics_json}}` from the run's live metric values
- characters 13356-14569: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14613-16793: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16849-17983: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 89.6, "openweight_capability": 84.0, "ai_safety": 0.0, "resilience": 49.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 15.0, "public_sentiment": 14.0}
```
