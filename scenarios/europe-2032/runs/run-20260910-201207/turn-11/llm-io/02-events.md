...
- characters 377-1590: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1634-3814: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3870-5004: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5067-32357: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32712-33676: `{{event_history}}` from the run's own event record
...
- `emergent_alt_lithography_lifeline` -- first noted turn 10, listed in 1 turn(s) so far: Japanese equipment makers and a Taiwanese service consortium quietly offer the EU pooled maintenance and legacy-tool parts outside US jurisdiction, blunting the Dutch servicing cut without any EU decision.
- `emergent_endemic_downgrade` -- first noted turn 10, listed in 1 turn(s) so far: WHO declares the engineered pneumonia strain endemic and winds down emergency coordination, stripping Brussels of pooled-procurement authority just as triage queues persist.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, loss_of_control_incident, capability_jump
- Turn 2 (9 turn(s) ago): openweight_frontier_release, labour_displacement, export_control_escalation, adoption_success
- Turn 3 (8 turn(s) ago): safety_breakthrough, us_china_agreement
- Turn 4 (7 turn(s) ago): cyber_major_incident, rsi_onset, research_breakthrough, medical_breakthrough, taiwan_tension_rise, export_control_escalation
- Turn 5 (6 turn(s) ago): cyber_major_incident, election_retrenchment
- Turn 6 (5 turn(s) ago): cyber_major_incident, opaque_reasoning, medical_breakthrough
- Turn 7 (4 turn(s) ago): cyber_major_incident, research_breakthrough, member_state_defection
- Turn 8 (3 turn(s) ago): bio_uplift_findings, catastrophic_bio_incident, safety_breakthrough, joint_threat_response
- Turn 9 (2 turn(s) ago): capability_jump, medical_breakthrough, supply_chain_coercion
- Turn 10 (1 turn(s) ago): bio_uplift_findings, medical_breakthrough, adoption_success
