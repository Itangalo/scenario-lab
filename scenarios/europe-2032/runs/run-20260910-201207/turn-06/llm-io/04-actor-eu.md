...
- characters 1887-4278: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5795-6240: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8810-11341: `{{previous_actions}}` from the actor's own response from the previous turn
