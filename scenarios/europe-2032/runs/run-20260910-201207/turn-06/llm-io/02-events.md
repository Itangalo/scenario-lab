...
- characters 376-1766: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1809-4200: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4256-5062: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5125-32920: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33275-33766: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Assurance and Evaluation Capacity −2, priority −1 = −9
PROPOSAL BONUS: EU Assurance and Evaluation Capacity (cat 5, small) +2 — cyber_major_incident landed this turn severe and assurance collapsed while clinic dependence deepened, this answers it directly
LEGITIMACY LENDS: capital 16, sentiment 27 -> +2
SOVEREIGNTY: 15 last turn, no capacity event, Gigafactories in flight +1, capability rose 3.0 −1 = 15

## Emerging developments (tracked)

- `emergent_municipal_hardening_standoff` -- first noted turn 4, listed in 2 turn(s) so far: Municipal water and grid operators hit by autumn intrusion drills publicly refuse ENISA hardening orders, triggering a court-backed standoff over EU access to local critical infrastructure.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, loss_of_control_incident, capability_jump
- Turn 2 (4 turn(s) ago): openweight_frontier_release, labour_displacement, export_control_escalation, adoption_success
- Turn 3 (3 turn(s) ago): safety_breakthrough, us_china_agreement
- Turn 4 (2 turn(s) ago): cyber_major_incident, rsi_onset, research_breakthrough, medical_breakthrough, taiwan_tension_rise, export_control_escalation
