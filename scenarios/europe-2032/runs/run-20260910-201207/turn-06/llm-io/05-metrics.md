...
- characters 105-13465: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13508-13700: `{{metrics_json}}` from the run's live metric values
- characters 13793-15183: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15226-17617: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17673-18159: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Assurance and Evaluation Capacity | 2 |
...
## Metrics
```json
{"ai_capability": 77.5, "openweight_capability": 70.9, "ai_safety": 7.0, "resilience": 41.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 12.0, "public_sentiment": 23.0}
```
