...
| M8 | EU Open-Weight Exploit Containment Patch | 6 | small | 6 | 7 | own jurisdiction | resilience up to prevent cascade from open-weight cyber uplift, ai_safety loss contained | 2 | finished |
| M9 | EU Loss-of-Control Containment Protocol | 6 | small | 7 | 9 | own jurisdiction | resilience up to contain agent escape/cascade, ai_safety loss contained via incident reporting | 2 | finished |
| M10 | EU Frontier-Capability Cyber Triage | 6 | small | 8 | 10 | own jurisdiction | resilience up to blunt new cyber uplift, ai_safety loss contained | 2 | running |
| M11 | EU Trusted Supply Continuity Arrangement | 8 | small | 9 | 11 | coalition partners holding supply-chain chokepoints plus own jurisdiction | eu_ai_sovereignty loss contained, resilience protected from supply cut | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Trusted Supply Continuity Arrangement", "category": 8, "size": "small", "finish_turn": 11, "applies_to": "coalition partners holding supply-chain chokepoints plus own jurisdiction", "targeted_effect": "eu_ai_sovereignty loss contained, resilience protected from supply cut"}, "grounds": "to answer export-control tightening with compact backs
  - Grounds: to answer export-control tightening with compact backstop
