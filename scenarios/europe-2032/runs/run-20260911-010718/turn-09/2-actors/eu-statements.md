...
- `two_year_commitment` (commitment): Keep essential services running and agent misuse contained while rebuilding a foothold of independent capacity

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Keep essential services running and agent misuse contained while rebuilding a foothold of independent capacity
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The commitment's duration ending directly changes the actor's obligation to uphold the original statement, triggering a natural review and revision.
