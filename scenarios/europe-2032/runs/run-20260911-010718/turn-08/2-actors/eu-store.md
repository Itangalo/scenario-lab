...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Frontier-Capability Cyber Triage", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up to blunt new cyber uplift, ai_safety loss contained"}, "grounds": "to answer verifiable-domain capability jump with low-capital triage"}
  - Grounds: to answer verifiable-domain capability jump with low-capital triage
