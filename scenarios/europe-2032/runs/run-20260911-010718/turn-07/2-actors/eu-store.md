...
| M8 | EU Open-Weight Exploit Containment Patch | 6 | small | 6 | 8 | own jurisdiction | resilience up to prevent cascade from open-weight cyber uplift, ai_safety loss contained | 2 | running |
| M9 | EU Loss-of-Control Containment Protocol | 6 | small | 7 | 9 | own jurisdiction | resilience up to contain agent escape/cascade, ai_safety loss contained via incident reporting | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Loss-of-Control Containment Protocol", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up to contain agent escape/cascade, ai_safety loss contained via incident reporting"}, "grounds": "to answer loss-of-control incident with low-capital enforceable plumbing"}
  - Grounds: to answer loss-of-control incident with low-capital enforceable plumbing
