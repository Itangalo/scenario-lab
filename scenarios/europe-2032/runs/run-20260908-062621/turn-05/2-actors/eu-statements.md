...
- `two_year_commitment` (commitment): Secure sovereign AI capacity to act independently while restoring public trust as the foundation of resilience and control

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign AI capacity to act independently while restoring public trust as the foundation of resilience and control
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the original pledge's timeframe, making its revision timely and necessary.
