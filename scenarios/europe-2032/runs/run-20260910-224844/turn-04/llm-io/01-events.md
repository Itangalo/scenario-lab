...
- characters 376-1908: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1951-4789: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4845-6068: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6131-31035: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31390-31613: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): eu_frontier_access_denied, automated_decision_scandal
- Turn 3 (1 turn(s) ago): export_control_escalation, eu_frontier_access_denied, supply_chain_coercion
