...
- characters 105-13653: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13696-13888: `{{metrics_json}}` from the run's live metric values
- characters 13981-15513: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15556-18394: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18450-18989: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 60.0, "openweight_capability": 55.5, "ai_safety": 26.0, "resilience": 40.0, "eu_ai_sovereignty": 13.0, "eu_political_capital": 16.0, "public_sentiment": 17.0}
```
## Narrative
### The sweep
