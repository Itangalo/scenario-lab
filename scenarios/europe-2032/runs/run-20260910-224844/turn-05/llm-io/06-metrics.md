...
- characters 13460-14267: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14311-16128: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16184-16579: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Automation Shock Absorber | 2 |
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Lithography Bargain Shield −2, EU Automation Shock Absorber −2 = −10 (priority cost waived, capital below 20)
PROPOSAL BONUS: EU Automation Shock Absorber (cat 7, small) +2 — embodied deployment landed this turn displacing logistics work and sentiment at 17, this answers it directly
LEGITIMACY LENDS: capital 10, sentiment 13 -> +2
SOVEREIGNTY: 13 last turn, no finish, Gigafactories in flight +0, embodied_ai_deployment t5 −2, capability rose 1.0 no charge = 11
