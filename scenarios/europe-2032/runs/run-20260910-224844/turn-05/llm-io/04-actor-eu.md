...
- characters 455-1262: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1306-3123: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5764-6236: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8395-9684: `{{previous_actions}}` from the actor's own response from the previous turn
