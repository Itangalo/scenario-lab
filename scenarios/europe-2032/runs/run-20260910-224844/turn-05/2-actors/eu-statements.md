...
- `two_year_commitment` (commitment): Rebuild public trust through resilient services and managed automation while securing allied and domestic AI capacity on EU terms

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild public trust through resilient services and managed automation while securing allied and domestic AI capacity on EU terms
