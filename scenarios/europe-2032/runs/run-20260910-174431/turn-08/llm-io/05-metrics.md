...
- characters 105-13260: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13303-13495: `{{metrics_json}}` from the run's live metric values
- characters 13588-14664: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14707-17265: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17321-18422: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Bio-Incident Containment and Care Continuity Operation | 2 |
