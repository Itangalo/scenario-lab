...
- characters 376-1452: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1495-4053: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4109-5210: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5273-27944: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28299-28830: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU Bio-Detection and Care Continuity Surge −2, priority −1 = −3
PROPOSAL BONUS: EU Bio-Detection and Care Continuity Surge (cat 6, small) +3 — bio_uplift_findings precursor this turn plus rationed clinical capacity and labour_displacement demand visible protection, answered directly
LEGITIMACY LENDS: capital 12, sentiment 26 -> +2
SOVEREIGNTY: 19 last turn, InvestAI Gigafactories finishes t7 +5, no cat4 in flight +0, no capacity event, capability rose 0.7 −0 = 24

## Emerging developments (tracked)

- `emergent_shadow_standardisation` -- first noted turn 7, listed in 1 turn(s) so far: Municipal utilities and hospital IT contractors quietly standardise on the same EU-hosted open-model stack, creating a single widely-shared dependency that no authority centrally monitors for vulnerabilities.
- `emergent_open_model_crimeware_kit` -- first noted turn 7, listed in 1 turn(s) so far: Criminal crews package the recent near-frontier open model into a ready-made ransomware and phishing toolkit, with EU municipalities and clinics running self-hosted older versions hit first.
...
- Turn 3 (5 turn(s) ago): openweight_frontier_release, automated_decision_scandal, emergent_cyber_insurance_retrenchment
- Turn 4 (4 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, export_control_escalation
- Turn 5 (3 turn(s) ago): eu_frontier_access_denied, supply_chain_coercion, adoption_success, election_consolidation
- Turn 6 (2 turn(s) ago): openweight_frontier_release, eu_frontier_access_denied
- Turn 7 (1 turn(s) ago): bio_uplift_findings, labour_displacement
