...
- characters 1552-3558: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3614-4670: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4733-27068: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27423-27464: `{{event_history}}` from the run's own event record
