...
- characters 377-1664: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1707-3733: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3789-4254: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4317-26779: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27134-27778: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Cut-Off Continuity and Open-Model Shield −2, priority −1 = −3
PROPOSAL BONUS: EU Cut-Off Continuity and Open-Model Shield (cat 6, small) +2 — answers bio-misuse and open-model phishing wave from last two turns, cut-off itself is this turn
LEGITIMACY LENDS: capital 20.0, sentiment 19.0 -> none, capital higher
SOVEREIGNTY: 17.5 last turn, no cat4 finishes, no cat4 in flight +0, eu_frontier_access_denied t9 −3, capability rose 0.7 −0 = 14.5
...
- Turn 3 (7 turn(s) ago): openweight_frontier_release, automated_decision_scandal, emergent_cyber_insurance_retrenchment
- Turn 4 (6 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, export_control_escalation
- Turn 5 (5 turn(s) ago): eu_frontier_access_denied, supply_chain_coercion, adoption_success, election_consolidation
- Turn 6 (4 turn(s) ago): openweight_frontier_release, eu_frontier_access_denied
- Turn 7 (3 turn(s) ago): bio_uplift_findings, labour_displacement
- Turn 8 (2 turn(s) ago): bio_incident
- Turn 9 (1 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied
