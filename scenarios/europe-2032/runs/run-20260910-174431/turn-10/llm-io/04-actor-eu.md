...
- characters 1785-3811: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5959-6395: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9348-11599: `{{previous_actions}}` from the actor's own response from the previous turn
