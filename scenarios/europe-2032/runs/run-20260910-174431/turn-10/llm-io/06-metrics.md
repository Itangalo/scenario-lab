...
- characters 13572-14859: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14902-16928: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16984-18049: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 63.1, "openweight_capability": 61.6, "ai_safety": 17.0, "resilience": 56.0, "eu_ai_sovereignty": 12.5, "eu_political_capital": 19.0, "public_sentiment": 14.0}
```
## Narrative
### The strait closes
