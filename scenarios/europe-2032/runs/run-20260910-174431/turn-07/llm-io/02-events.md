...
- characters 1406-3270: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3326-3705: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3768-26439: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26794-27258: `{{event_history}}` from the run's own event record
...
- Turn 3 (4 turn(s) ago): openweight_frontier_release, automated_decision_scandal, emergent_cyber_insurance_retrenchment
- Turn 4 (3 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, export_control_escalation
- Turn 5 (2 turn(s) ago): eu_frontier_access_denied, supply_chain_coercion, adoption_success, election_consolidation
- Turn 6 (1 turn(s) ago): openweight_frontier_release, eu_frontier_access_denied
