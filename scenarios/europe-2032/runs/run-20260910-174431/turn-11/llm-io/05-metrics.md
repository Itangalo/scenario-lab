...
- characters 107-12889: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12932-13124: `{{metrics_json}}` from the run's live metric values
- characters 13217-14766: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14810-17495: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17551-18636: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Upstream Leverage for Inclusion Pact | 2 |
| M12 | EU Agentic Loss-of-Control Containment Protocol | 2 |
