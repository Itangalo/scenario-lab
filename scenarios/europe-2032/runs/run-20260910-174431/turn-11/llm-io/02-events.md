...
- characters 93-285: `{{metrics_json}}` from the run's live metric values
- characters 378-1927: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1971-4656: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4712-5797: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5860-26098: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 26453-27215: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Upstream Leverage for Inclusion Pact −2, priority −1 = −3
PROPOSAL BONUS: EU Upstream Leverage for Inclusion Pact (cat 8, small) +3 — answers taiwan_blockade and us_china_agreement exclusion from last turn directly, small size caps upside
LEGITIMACY LENDS: capital 19.0, sentiment 14.0 -> none, capital higher
SOVEREIGNTY: 14.5 last turn, no cat4 finishes, no cat4 in flight +0, taiwan_blockade t10 −2 as emergent capacity denial, capability rose 0.5 −0 = 12.5

## Emerging developments (tracked)

- `emergent_open_triage_failure` -- first noted turn 10, listed in 1 turn(s) so far: Independent clinicians publish evidence that the certified EU-hosted open stack mis-triages a rare but severe presentation at scale, triggering liability suits and a cross-border debate over open-model clinical safety.
- `emergent_clinician_triage_boycott` -- first noted turn 10, listed in 1 turn(s) so far: Municipal clinic staff stage coordinated walkouts refusing to operate AI triage tools after phishing wave, forcing emergency staffing measures in several member states.
...
- Turn 3 (8 turn(s) ago): openweight_frontier_release, automated_decision_scandal, emergent_cyber_insurance_retrenchment
- Turn 4 (7 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, export_control_escalation
- Turn 5 (6 turn(s) ago): eu_frontier_access_denied, supply_chain_coercion, adoption_success, election_consolidation
- Turn 6 (5 turn(s) ago): openweight_frontier_release, eu_frontier_access_denied
- Turn 7 (4 turn(s) ago): bio_uplift_findings, labour_displacement
- Turn 8 (3 turn(s) ago): bio_incident
- Turn 9 (2 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied
- Turn 10 (1 turn(s) ago): taiwan_blockade, knowledge_work_augmented, us_china_agreement, automated_decision_scandal
