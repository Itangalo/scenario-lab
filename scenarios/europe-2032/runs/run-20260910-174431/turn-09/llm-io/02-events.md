...
- characters 377-1915: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1959-4220: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4276-5350: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5413-27272: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27627-28197: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Bio-Incident Containment and Care Continuity Operation −2, priority −1 = −3
PROPOSAL BONUS: EU Bio-Incident Containment and Care Continuity Operation (cat 6, small) +4 — bio_incident landed this turn severe with casualties and weeks containment, this answers it directly
LEGITIMACY LENDS: capital 13, sentiment 24 -> +2
SOVEREIGNTY: 17.5 last turn, no cat4 finishes, no cat4 in flight +0, no capacity event, capability rose 0.7 −0 = 17.5

## Emerging developments (tracked)

- `emergent_shadow_standardisation` -- first noted turn 7, listed in 2 turn(s) so far: Municipal utilities and hospital IT contractors quietly standardise on the same EU-hosted open-model stack, creating a single widely-shared dependency that no authority centrally monitors for vulnerabilities.
- `emergent_open_model_crimeware_kit` -- first noted turn 7, listed in 2 turn(s) so far: Criminal crews package the recent near-frontier open model into a ready-made ransomware and phishing toolkit, with EU municipalities and clinics running self-hosted older versions hit first.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot
- Turn 3 (6 turn(s) ago): openweight_frontier_release, automated_decision_scandal, emergent_cyber_insurance_retrenchment
- Turn 4 (5 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, export_control_escalation
- Turn 5 (4 turn(s) ago): eu_frontier_access_denied, supply_chain_coercion, adoption_success, election_consolidation
- Turn 6 (3 turn(s) ago): openweight_frontier_release, eu_frontier_access_denied
- Turn 7 (2 turn(s) ago): bio_uplift_findings, labour_displacement
- Turn 8 (1 turn(s) ago): bio_incident
