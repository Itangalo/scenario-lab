...
- characters 2037-4298: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5324-5772: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8528-10670: `{{previous_actions}}` from the actor's own response from the previous turn
