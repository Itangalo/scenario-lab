...
- characters 377-1434: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1478-3301: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3357-3808: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3871-24109: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 24464-25279: `{{event_history}}` from the run's own event record
...
- Turn 3 (10 turn(s) ago): openweight_frontier_release, automated_decision_scandal, emergent_cyber_insurance_retrenchment
- Turn 4 (9 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, export_control_escalation
- Turn 5 (8 turn(s) ago): eu_frontier_access_denied, supply_chain_coercion, adoption_success, election_consolidation
- Turn 6 (7 turn(s) ago): openweight_frontier_release, eu_frontier_access_denied
- Turn 7 (6 turn(s) ago): bio_uplift_findings, labour_displacement
- Turn 8 (5 turn(s) ago): bio_incident
- Turn 9 (4 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied
- Turn 10 (3 turn(s) ago): taiwan_blockade, knowledge_work_augmented, us_china_agreement, automated_decision_scandal
- Turn 11 (2 turn(s) ago): loss_of_control_incident
