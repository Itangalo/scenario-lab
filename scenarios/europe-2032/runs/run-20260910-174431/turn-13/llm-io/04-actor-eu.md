...
- characters 455-1512: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1556-3379: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3971-4513: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8192-9902: `{{previous_actions}}` from the actor's own response from the previous turn
...
- `two_year_commitment` (commitment): Hold leverage and stay inside the guardrails — trade upstream chokepoints for a seat in US-China risk controls while keeping essential services up without the frontier
...
|---|---|---|---|---|---|---|---|---|---|
| M13 | EU Redress Backlog Clearance for Automated Decisions | 7 | small | 12 | 14 | own jurisdiction | public_sentiment up slightly, eu_political_capital up slightly, resilience up slightly | 2 | running |
...
| M9 | EU Bio-Incident Containment and Care Continuity Operation | 6 | small | 8 | 9 | own jurisdiction | resilience up materially, public_sentiment up slightly, ai_safety up slightly via detection | 2 | finished |
| M10 | EU Cut-Off Continuity and Open-Model Shield | 6 | small | 9 | 10 | own jurisdiction | resilience up materially, public_sentiment up slightly, eu_ai_sovereignty up slightly | 2 | finished |
| M11 | EU Upstream Leverage for Inclusion Pact | 8 | small | 10 | 13 | US, China, coalition | eu_ai_sovereignty up slightly, ai_safety up slightly, resilience up slightly | 2 | finished |
| M12 | EU Agentic Loss-of-Control Containment Protocol | 6 | small | 11 | 12 | own jurisdiction | resilience up materially, ai_safety up slightly via detection | 2 | finished |
...
## New measure
**EU Redress Backlog Clearance for Automated Decisions**
Clears the months-long appeals backlog from AI-driven benefits and court-scheduling decisions via levy-funded case teams and binding review deadlines.
This now because confirmed systematic disadvantage with unheard appeals is driving hostility to 9 and paralysis to 13, and without visible redress no containment drill or leverage offer regains room to act.

## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Redress Backlog Clearance for Automated Decisions", "category": 7, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up slightly, eu_political_capital up slightly, resilience up slightly"}, "grounds": "ombudsman backlog fuels hostility and blocks action"}]}
```

## Priority
EU Redress Backlog Clearance for Automated Decisions, because with capital at 13 and sentiment at 9 restoring that appeals are heard outranks the stalled upstream leverage negotiation while M11 continues in the background.

## In practice
We act under the AI Act redress and Services of General Interest base via the AI Office and national ombudsmen: lithography-licence levy money already paying auditors is extended to temporary review chambers with 90-day decision deadlines for benefits and scheduling cases, with ENISA drills paused where they burden clinics.

We keep M11 alive at minimal cost in Trade/Foreign Affairs Council — pooled servicing offer held open while The Hague protects books — but spend our voice this turn on redress as enforcement that works, to stop the transition-is-over narrative from hardening into permanent left-behind.
...
```
## New measure
None this turn. We are waiting for the redress chambers to clear enough cases to lift sentiment and capital above paralysis before starting anything new.

## Store changes
No changes.

## Priority
M13 EU Redress Backlog Clearance for Automated Decisions, because with capital at 11 and sentiment at 10 hearing wrongful-cut appeals is the only action that can rebuild room to act while leverage stays stalled.

## In practice
We hold the line on redress as the Union's visible work this turn. Levy money continues through the AI Office and national ombudsmen into temporary review chambers with the 90-day target for benefits and court-scheduling cases, evening hearings kept where they eased hostility, payouts publicised where made. We accept the criticism on paused clinic drills and do not expand the pause further.

We keep the pooled servicing offer open in trade councils at minimal cost — acknowledged but unanswered in Washington and Beijing, The Hague books protected — and use ENISA mutual-aid reporting only to sustain the two states where the freeze drill held, without launching new obligations the budget and the publics cannot carry.
