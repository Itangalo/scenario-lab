...
- characters 107-13250: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13293-13484: `{{metrics_json}}` from the run's live metric values
- characters 13577-14634: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14678-16501: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16557-17008: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t13: EU Redress Backlog Clearance for Automated Decisions −2, priority −1 not charged — capital below 20 priority has no effect = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: none — capital 11.0 above sentiment 10.0
SOVEREIGNTY: 12.5 last turn, no capacity event, no cat4 in flight +0, capability rose 0.7 −0 = 12.5
