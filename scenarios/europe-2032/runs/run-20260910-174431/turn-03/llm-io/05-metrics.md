...
- characters 13319-14636: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14680-16343: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16399-16985: `{{notepad}}` from the Game Master's notepad, carried across turns
