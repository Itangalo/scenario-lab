...
- characters 1738-3401: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3457-4638: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4701-27036: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27391-27432: `{{event_history}}` from the run's own event record
