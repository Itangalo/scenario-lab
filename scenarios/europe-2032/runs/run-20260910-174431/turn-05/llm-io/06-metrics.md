...
- characters 106-13639: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13682-13874: `{{metrics_json}}` from the run's live metric values
- characters 13967-15794: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15838-18082: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18138-19045: `{{notepad}}` from the Game Master's notepad, carried across turns
