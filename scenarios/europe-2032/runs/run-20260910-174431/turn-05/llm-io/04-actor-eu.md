...
- characters 455-2282: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2326-4570: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6643-7104: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9407-11291: `{{previous_actions}}` from the actor's own response from the previous turn
