...
- characters 13707-15432: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15475-18249: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18305-19164: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Frontier Evaluation and Assurance Capacity | 2 |
| M5 | EU Systemic Cyber Cover Backstop | 2 |
| M6 | EU Defensive Breakthrough Rapid Adoption | 2 |
...
- `emergent_datacentre_siting_revolt` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated municipal bans on new data-centre grid connections spread across several member states after power-bill protests, forcing a temporary EU-level siting mediation.
...
## Metrics
```json
{"ai_capability": 57.5, "openweight_capability": 53.5, "ai_safety": 28.0, "resilience": 41.5, "eu_ai_sovereignty": 20.0, "eu_political_capital": 17.0, "public_sentiment": 34.0}
```
