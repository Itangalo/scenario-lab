...
- characters 453-1805: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1848-3937: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4005-4547: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8018-10054: `{{previous_actions}}` from the actor's own response from the previous turn
