...
- characters 106-13292: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13335-13525: `{{metrics_json}}` from the run's live metric values
- characters 13618-14970: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15013-17102: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17158-17620: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M13 | EU Redress Backlog Clearance for Automated Decisions | 2 |
