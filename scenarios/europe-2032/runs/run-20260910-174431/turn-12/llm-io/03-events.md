...
- characters 375-1727: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1770-3859: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3915-4977: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5040-25278: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 25633-26447: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Upstream Leverage for Inclusion Pact −2, EU Agentic Loss-of-Control Containment Protocol −2, priority −1 = −5
PROPOSAL BONUS: EU Agentic Loss-of-Control Containment Protocol (cat 6, small) +3 — loss_of_control_incident landed this turn and this answers it directly, small size caps upside
LEGITIMACY LENDS: capital 12, sentiment 14 -> +1
SOVEREIGNTY: 12.5 last turn, no capacity event, no cat4 in flight +0, capability rose 0.7 −0 = 12.5

## Emerging developments (tracked)

- `emergent_open_triage_failure` -- first noted turn 10, listed in 2 turn(s) so far: Independent clinicians publish evidence that the certified EU-hosted open stack mis-triages a rare but severe presentation at scale, triggering liability suits and a cross-border debate over open-model clinical safety.
- `emergent_clinician_triage_boycott` -- first noted turn 10, listed in 2 turn(s) so far: Municipal clinic staff stage coordinated walkouts refusing to operate AI triage tools after phishing wave, forcing emergency staffing measures in several member states.
...
- Turn 3 (9 turn(s) ago): openweight_frontier_release, automated_decision_scandal, emergent_cyber_insurance_retrenchment
- Turn 4 (8 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, export_control_escalation
- Turn 5 (7 turn(s) ago): eu_frontier_access_denied, supply_chain_coercion, adoption_success, election_consolidation
- Turn 6 (6 turn(s) ago): openweight_frontier_release, eu_frontier_access_denied
- Turn 7 (5 turn(s) ago): bio_uplift_findings, labour_displacement
- Turn 8 (4 turn(s) ago): bio_incident
- Turn 9 (3 turn(s) ago): eval_anomaly_reports, eu_frontier_access_denied
- Turn 10 (2 turn(s) ago): taiwan_blockade, knowledge_work_augmented, us_china_agreement, automated_decision_scandal
- Turn 11 (1 turn(s) ago): loss_of_control_incident
