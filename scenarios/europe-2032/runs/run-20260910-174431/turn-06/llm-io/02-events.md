...
- characters 376-1413: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1456-3835: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3891-4772: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4835-25127: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 25482-25865: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Continuity Stack for Cut-Off Public Services −2, priority −1 = −9
PROPOSAL BONUS: EU Continuity Stack for Cut-Off Public Services (cat 9, small) +4 — answers eu_frontier_access_denied this turn directly on hospitals/ministries, plus adoption_success showing European decision can earn trust
LEGITIMACY LENDS: capital 11, sentiment 30 -> +2
SOVEREIGNTY: 20 last turn, no cat4 finish, no in-flight bonus, eu_frontier_access_denied t5 −3 (larger than supply_chain_coercion t5), capability rose 1.5 −0 = 17

## Emerging developments (tracked)

- `emergent_datacentre_siting_revolt` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated municipal bans on new data-centre grid connections spread across several member states after power-bill protests, forcing a temporary EU-level siting mediation.
...
- Turn 3 (3 turn(s) ago): openweight_frontier_release, automated_decision_scandal, emergent_cyber_insurance_retrenchment
- Turn 4 (2 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, export_control_escalation
- Turn 5 (1 turn(s) ago): eu_frontier_access_denied, supply_chain_coercion, adoption_success, election_consolidation
