...
- characters 1534-3913: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4752-5200: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7691-10004: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Continuity Stack for Cut-Off Public Services | 9 | small | 5 | 7 | own jurisdiction | eu_ai_sovereignty up slightly, resilience up slightly, public_sentiment up | 2 | running |
