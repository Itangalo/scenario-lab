...
- `two_year_commitment` (commitment): Keep essential services running and trustworthy on the AI we already have

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Keep essential services running and trustworthy on the AI we already have
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The development directly ends the timeframe the commitment was based on, changing the actor's obligation to uphold it.
