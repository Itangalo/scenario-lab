...
| M12 | EU Essential Services Human-Gate Enforcement | 6 | small | 11 | 13 | own jurisdiction | resilience up, ai_safety up slightly via containment | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Essential Services Human-Gate Enforcement", "category": 6, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly via containment"}, "grounds": "no in-flight measures and need to lock in what worked during intrusion and rogue-agent shocks"}
  - Grounds: no in-flight measures and need to lock in what worked during intrusion and rogue-agent shocks
