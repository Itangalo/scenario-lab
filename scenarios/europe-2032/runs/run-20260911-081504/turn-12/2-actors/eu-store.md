...
| M12 | EU Essential Services Human-Gate Enforcement | 6 | small | 11 | 12 | own jurisdiction | resilience up, ai_safety up slightly via containment | 2 | finished |
| M13 | EU Local Resilience Repair Corps | 6 | small | 12 | 14 | own jurisdiction | resilience up, eu_political_capital up slightly via visible repair, public_sentiment up slightly | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Local Resilience Repair Corps", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_political_capital up slightly via visible repair, public_sentiment up slightly"}, "grounds": "gates held in large operators but failed in understaffed municipalities"}
  - Grounds: gates held in large operators but failed in understaffed municipalities
