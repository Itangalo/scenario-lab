...
- characters 454-1758: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1801-3657: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5816-6280: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8415-10627: `{{previous_actions}}` from the actor's own response from the previous turn
