...
- characters 376-1680: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1723-3579: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3635-4155: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4218-31162: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31517-31748: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, cyber_major_incident, adoption_success
- Turn 2 (2 turn(s) ago): safety_breakthrough, member_state_defection
- Turn 3 (1 turn(s) ago): eu_frontier_access_denied, emergent_eval_coverup_leak
