...
- characters 13563-13755: `{{metrics_json}}` from the run's live metric values
- characters 13848-15170: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15214-17956: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18012-18941: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Allied Shield and Access Pact | 2 |
| M9 | EU Automated Patching Surge | 2 |
