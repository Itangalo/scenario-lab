...
- characters 377-1699: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1743-4485: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4541-5470: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5533-32121: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32476-33033: `{{event_history}}` from the run's own event record
...
- `emergent_allied_access_limbo` -- first noted turn 6, listed in 1 turn(s) so far: The incoming US administration delays publication of allied access terms past inauguration amid interagency review, leaving EU ministries on interim commercial access with no published tiers for a full half-year.
...
- Turn 2 (5 turn(s) ago): safety_breakthrough, member_state_defection
- Turn 3 (4 turn(s) ago): eu_frontier_access_denied, emergent_eval_coverup_leak
- Turn 4 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning
- Turn 5 (2 turn(s) ago): joint_threat_response, emergent_clinician_backlash_suspension, emergent_compute_referendum_block, election_alliance
- Turn 6 (1 turn(s) ago): bio_incident, loss_of_control_incident, rsi_onset
