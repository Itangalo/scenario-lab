...
- characters 376-1346: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1389-3632: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3688-4679: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4742-27819: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28174-28255: `{{event_history}}` from the run's own event record
