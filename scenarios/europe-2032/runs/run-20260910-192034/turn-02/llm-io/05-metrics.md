...
- characters 13391-14361: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14404-16647: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16703-17694: `{{notepad}}` from the Game Master's notepad, carried across turns
