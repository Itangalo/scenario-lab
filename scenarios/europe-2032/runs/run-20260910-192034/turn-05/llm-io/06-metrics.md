...
- characters 13852-15890: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15934-18372: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18428-18942: `{{notepad}}` from the Game Master's notepad, carried across turns
