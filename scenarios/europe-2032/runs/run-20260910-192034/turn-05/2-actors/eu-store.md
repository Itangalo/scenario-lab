...
- **applied** `M7` — {"op": "add", "table": "measures", "fields": {"name": "EU Allied Shield and Access Pact", "category": 8, "size": "small", "finish_turn": 8, "applies_to": "coalition", "targeted_effect": "resilience up moderately, eu_ai_sovereignty up slightly"}, "grounds": "lock in joint threat response and allied access while rebuilding trust"}
  - Grounds: lock in joint threat response and allied access while rebuilding trust
