...
- characters 106-13294: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13337-13529: `{{metrics_json}}` from the run's live metric values
- characters 13622-14737: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14780-16442: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16498-17445: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Rogue AI Isolation and Continuity Regime | 2 |
