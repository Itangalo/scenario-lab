...
- characters 1613-3275: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5462-5922: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8753-10923: `{{previous_actions}}` from the actor's own response from the previous turn
