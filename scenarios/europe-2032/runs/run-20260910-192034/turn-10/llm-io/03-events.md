...
- characters 377-1492: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1535-3197: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3253-4200: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4263-33064: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33419-34214: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Joint Threat Pool Accession −2, priority −1 = −3
PROPOSAL BONUS: EU Joint Threat Pool Accession (cat 8, small) +2 — February sweep / spring disruption last 2 turns, pooled telemetry answers next sweep directly
LEGITIMACY LENDS: capital 18, sentiment 12 -> none, capital higher
SOVEREIGNTY: 13 last turn, no capacity event, no cat4 in flight +0, capability rose 3.0 −1 = 12

## Emerging developments (tracked)

- `emergent_ransom_boycott_crunch` -- first noted turn 9, listed in 1 turn(s) so far: Municipal ransomware payments coalesce into a coordinated payment boycott and insurance pullback, leaving smaller councils unable to buy cover and hardening refusal as policy.
- `emergent_municipal_staff_revolt` -- first noted turn 9, listed in 1 turn(s) so far: Municipal IT staff walkouts and local ransomware-payment bans spread after the spring sweep, leaving patching playbooks unstaffed in several regions through autumn.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, cyber_major_incident, adoption_success
- Turn 2 (8 turn(s) ago): safety_breakthrough, member_state_defection
- Turn 3 (7 turn(s) ago): eu_frontier_access_denied, emergent_eval_coverup_leak
- Turn 4 (6 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning
- Turn 5 (5 turn(s) ago): joint_threat_response, emergent_clinician_backlash_suspension, emergent_compute_referendum_block, election_alliance
- Turn 6 (4 turn(s) ago): bio_incident, loss_of_control_incident, rsi_onset
- Turn 7 (3 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, knowledge_work_augmented, taiwan_tension_rise
- Turn 8 (2 turn(s) ago): cyber_major_incident
- Turn 9 (1 turn(s) ago): taiwan_tension_rise, joint_threat_response
