...
| M11 | EU Joint Threat Pool Accession | 8 | small | 9 | 11 | coalition | resilience up moderately | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Joint Threat Pool Accession", "category": 8, "size": "small", "finish_turn": 11, "applies_to": "coalition", "targeted_effect": "resilience up moderately"}, "grounds": "take up joint threat response invitation now"}
  - Grounds: take up joint threat response invitation now
