...
- characters 1350-3163: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3219-3649: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3712-31467: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31822-32548: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Automated Patching Surge −2, EU Major Cyber Response Sprint −2, priority −1 = −5
PROPOSAL BONUS: EU Major Cyber Response Sprint (cat 6, small) +3 — cyber_major_incident this turn with public-service disruption, this answers absorption directly
...
- Turn 2 (7 turn(s) ago): safety_breakthrough, member_state_defection
- Turn 3 (6 turn(s) ago): eu_frontier_access_denied, emergent_eval_coverup_leak
- Turn 4 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning
- Turn 5 (4 turn(s) ago): joint_threat_response, emergent_clinician_backlash_suspension, emergent_compute_referendum_block, election_alliance
- Turn 6 (3 turn(s) ago): bio_incident, loss_of_control_incident, rsi_onset
- Turn 7 (2 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, knowledge_work_augmented, taiwan_tension_rise
