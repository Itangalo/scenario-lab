...
- characters 1428-3241: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4040-4535: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7250-8962: `{{previous_actions}}` from the actor's own response from the previous turn
