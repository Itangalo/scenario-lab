...
- characters 374-1160: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1204-3416: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3472-4342: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4405-31674: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32029-33302: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Trusted Essential Services Rebuild −2, priority −0 (capital below 20, priority has no effect and no cost) = −2
PROPOSAL BONUS: EU Trusted Essential Services Rebuild (cat 9, small) +2 — answers automated-decision scandal and access cutoff directly, leverages adoption success this turn
LEGITIMACY LENDS: capital 12, sentiment 10 -> none, capital higher
SOVEREIGNTY: 6 last turn, no capacity event finishes, no cat4 in flight +0, eu_frontier_access_denied t12 −3 (largest of four capacity events this turn), capability rose 3.0 −1 = 2

## Emerging developments (tracked)

- `emergent_patch_refusal_belt` -- first noted turn 12, listed in 1 turn(s) so far: Municipal utilities and hospital groups openly refuse to install centrally pushed AI patching agents after the autumn outages, creating a patch-refusal belt that leaves edge networks exposed.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, cyber_major_incident, adoption_success
- Turn 2 (11 turn(s) ago): safety_breakthrough, member_state_defection
- Turn 3 (10 turn(s) ago): eu_frontier_access_denied, emergent_eval_coverup_leak
- Turn 4 (9 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning
- Turn 5 (8 turn(s) ago): joint_threat_response, emergent_clinician_backlash_suspension, emergent_compute_referendum_block, election_alliance
- Turn 6 (7 turn(s) ago): bio_incident, loss_of_control_incident, rsi_onset
- Turn 7 (6 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, knowledge_work_augmented, taiwan_tension_rise
- Turn 8 (5 turn(s) ago): cyber_major_incident
- Turn 9 (4 turn(s) ago): taiwan_tension_rise, joint_threat_response
- Turn 10 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, catastrophic_loss_of_control_incident, member_state_defection, adoption_success
- Turn 11 (2 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release, embodied_ai_deployment, us_labs_nationalised
- Turn 12 (1 turn(s) ago): export_control_escalation, eu_frontier_access_denied, supply_chain_coercion, member_state_defection, adoption_success, automated_decision_scandal
