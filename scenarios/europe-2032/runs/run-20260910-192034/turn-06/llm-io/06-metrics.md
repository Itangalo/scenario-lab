...
- characters 13495-13687: `{{metrics_json}}` from the run's live metric values
- characters 13780-15442: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15485-17895: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17951-18752: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | EU Containment and Continuity Protocol | 2 |
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "ALLIANCE"}, "grounds": "turn 5 winner was alliance coalition, takes office turn 6"}, {"op": "update", "table": "measures", "id": "M8", "fields": {"finish_turn": 7}, "grounds": "named priority"}]}
```
```
