...
- characters 454-2116: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2159-4569: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5924-6391: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8791-11154: `{{previous_actions}}` from the actor's own response from the previous turn
