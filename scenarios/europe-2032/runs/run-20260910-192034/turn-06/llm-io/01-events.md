...
- characters 376-2038: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2081-4491: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4547-5014: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5077-31520: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31875-32356: `{{event_history}}` from the run's own event record
...
- Turn 2 (4 turn(s) ago): safety_breakthrough, member_state_defection
- Turn 3 (3 turn(s) ago): eu_frontier_access_denied, emergent_eval_coverup_leak
- Turn 4 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning
- Turn 5 (1 turn(s) ago): joint_threat_response, emergent_clinician_backlash_suspension, emergent_compute_referendum_block, election_alliance
