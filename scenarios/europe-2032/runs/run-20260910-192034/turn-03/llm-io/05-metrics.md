...
- characters 13778-15271: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15315-17212: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17268-17796: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Assurance Adoption Programme −2, EU Essential Services Continuity Switch −2, priority −1 = −11
PROPOSAL BONUS: EU Essential Services Continuity Switch (cat 6, small) +3 — eu_frontier_access_denied landed this turn degrading hospitals/ministries and this answers it directly
LEGITIMACY LENDS: capital 25, sentiment 34 -> +2
SOVEREIGNTY: 18 last turn, no cat4 finish, in flight +0, eu_frontier_access_denied t3 −3, capability rose 3.0 −1 = 14
