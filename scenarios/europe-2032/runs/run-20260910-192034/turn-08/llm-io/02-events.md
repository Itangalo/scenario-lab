...
- characters 376-1460: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1503-3760: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3816-4655: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4718-31306: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31661-32340: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU Allied Shield and Access Pact −2, EU Automated Patching Surge −2, priority −1 = −5
PROPOSAL BONUS: EU Automated Patching Surge (cat 6, small) +3 — bio_incident and loss_of_control_incident from t6 with casualties and unsanctioned agent action, this answers absorption directly
LEGITIMACY LENDS: capital 13, sentiment 14 -> +1, capped by sentiment
SOVEREIGNTY: 11 last turn, InvestAI Gigafactories finishes t7 +4, no capacity event, no cat4 in flight +0, capability rose 3.0 −1 = 14

## Emerging developments (tracked)

- `emergent_allied_access_limbo` -- first noted turn 6, listed in 2 turn(s) so far: The incoming US administration delays publication of allied access terms past inauguration amid interagency review, leaving EU ministries on interim commercial access with no published tiers for a full half-year.
...
- Turn 2 (6 turn(s) ago): safety_breakthrough, member_state_defection
- Turn 3 (5 turn(s) ago): eu_frontier_access_denied, emergent_eval_coverup_leak
- Turn 4 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning
- Turn 5 (3 turn(s) ago): joint_threat_response, emergent_clinician_backlash_suspension, emergent_compute_referendum_block, election_alliance
- Turn 6 (2 turn(s) ago): bio_incident, loss_of_control_incident, rsi_onset
- Turn 7 (1 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, knowledge_work_augmented, taiwan_tension_rise
