...
- characters 13392-13584: `{{metrics_json}}` from the run's live metric values
- characters 13677-14761: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14804-17061: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17117-17622: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Major Cyber Response Sprint | 2 |
