...
- characters 106-13338: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13381-13571: `{{metrics_json}}` from the run's live metric values
- characters 13664-14756: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14799-16656: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16712-17484: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Trusted Essential Services Rebuild | 2 |
