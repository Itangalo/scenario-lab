...
- characters 375-1467: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1510-3367: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3423-3882: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3945-31214: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31569-32668: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Breakthrough Patching Deployment −2, priority −1 = −3
PROPOSAL BONUS: EU Breakthrough Patching Deployment (cat 6, small) +3 — self-spreading agent still at large and open frontier release this turn, containment answers cascade directly
LEGITIMACY LENDS: capital 12, sentiment 10 -> none, capital higher
SOVEREIGNTY: 9 last turn, no capacity event finishes, no cat4 in flight +0, us_labs_nationalised t11 −2, capability rose 2.5 −1 = 6
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, cyber_major_incident, adoption_success
- Turn 2 (10 turn(s) ago): safety_breakthrough, member_state_defection
- Turn 3 (9 turn(s) ago): eu_frontier_access_denied, emergent_eval_coverup_leak
- Turn 4 (8 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, opaque_reasoning
- Turn 5 (7 turn(s) ago): joint_threat_response, emergent_clinician_backlash_suspension, emergent_compute_referendum_block, election_alliance
- Turn 6 (6 turn(s) ago): bio_incident, loss_of_control_incident, rsi_onset
- Turn 7 (5 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, knowledge_work_augmented, taiwan_tension_rise
- Turn 8 (4 turn(s) ago): cyber_major_incident
- Turn 9 (3 turn(s) ago): taiwan_tension_rise, joint_threat_response
- Turn 10 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, catastrophic_loss_of_control_incident, member_state_defection, adoption_success
- Turn 11 (1 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release, embodied_ai_deployment, us_labs_nationalised
