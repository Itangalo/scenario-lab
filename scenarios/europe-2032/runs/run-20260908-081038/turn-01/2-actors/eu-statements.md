...
- `two_year_commitment` (commitment): Secure independent AI capacity to act with credibility on safety and resilience

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure independent AI capacity to act with credibility on safety and resilience
