...
- characters 106-12974: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13017-13209: `{{metrics_json}}` from the run's live metric values
- characters 13302-14310: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14354-16136: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16192-16671: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | Public Service Continuity Backstop | 2 |
| M5 | EU Essential-Service AI Fallback | 2 |
...
PORTFOLIO CHARGE t2: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 Grid and Port Cyber Shield −3, M4 Public Service Continuity Backstop −2, priority −1 = −12
PROPOSAL BONUS: Public Service Continuity Backstop (cat 6, small) +2 — cyber_major_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 27, sentiment 35 -> +2
SOVEREIGNTY: 22 last turn, export_control_escalation t2 −2, Gigafactories in flight +0, capability rose 1.5 −0 = 20
...
## Notepad
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 Grid and Port Cyber Shield −3, M4 Public Service Continuity Backstop −2, M5 EU Essential-Service AI Fallback −2, priority −1 = −14
PROPOSAL BONUS: EU Essential-Service AI Fallback (cat 4, small) +4 — eu_frontier_access_denied landed this turn and this answers it directly, with investment collapse reinforcing need
LEGITIMACY LENDS: capital 19, sentiment 24 -> +2
SOVEREIGNTY: 20 last turn, no capacity event? no — eu_frontier_access_denied t3 −3, Gigafactories in flight +0, capability rose 1.0 −0 = 17
