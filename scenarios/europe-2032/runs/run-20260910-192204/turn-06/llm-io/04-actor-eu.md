...
- characters 454-2375: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2418-4447: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5984-6418: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8707-11135: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Trustworthy Adoption Dividend | 9 | small | 5 | 7 | own jurisdiction | public_sentiment up materially, eu_political_capital up, resilience up slightly | 2 | running |
