...
- characters 106-12832: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12875-13066: `{{metrics_json}}` from the run's live metric values
- characters 13159-14233: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14276-16412: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16468-16919: `{{notepad}}` from the Game Master's notepad, carried across turns
