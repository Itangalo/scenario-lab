...
- characters 376-1450: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1493-3629: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3685-4808: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4871-29905: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30260-31129: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Clinical Access and Trusted Cures Programme −2, priority −1 = −3
PROPOSAL BONUS: none — EU Clinical Access and Trusted Cures Programme (cat 9, small) answers medical_breakthrough, a positive breakthrough not a negative event in last three turns
LEGITIMACY LENDS: capital 14, sentiment 14 -> none, capital not lower
SOVEREIGNTY: 27 last turn, no cat4 finish, no cat4 in flight +0, no capacity event, capability rose 0.5 −0 = 27

## Emerging developments (tracked)

- `emergent_biosurge_site_backlash` -- first noted turn 10, listed in 2 turn(s) so far: Copycat blockades spread from gigafactory sites to wastewater sequencing hubs and medical stockpiles, with activists alleging bio-surveillance overreach and forcing temporary suspension of Bio Early-Warning installations.
- `emergent_biosurveillance_false_alarm` -- first noted turn 10, listed in 2 turn(s) so far: A contested wastewater sequencing hit from the new Bio Early-Warning Surge triggers a city-wide public health scare and temporary controls before confirmatory testing clears it, discrediting the surge while it is still procurement.
...
- Turn 2 (10 turn(s) ago): cyber_major_incident, export_control_escalation
- Turn 3 (9 turn(s) ago): cyber_major_incident, ai_investment_collapse, eu_frontier_access_denied
- Turn 4 (8 turn(s) ago): emergent_frontier_lab_stall
- Turn 5 (7 turn(s) ago): adoption_success, election_retrenchment
- Turn 6 (6 turn(s) ago): cyber_major_incident, labour_displacement, joint_threat_response, emergent_clinical_backlash_freeze
- Turn 7 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, member_state_defection
- Turn 8 (4 turn(s) ago): cyber_major_incident, embodied_ai_deployment, taiwan_tension_rise
- Turn 9 (3 turn(s) ago): bio_uplift_findings, joint_threat_response, emergent_site_blockade_wave
- Turn 11 (1 turn(s) ago): medical_breakthrough, openweight_frontier_release, knowledge_work_augmented
