...
- characters 13478-13670: `{{metrics_json}}` from the run's live metric values
- characters 13763-15095: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15139-17085: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17141-17850: `{{notepad}}` from the Game Master's notepad, carried across turns
