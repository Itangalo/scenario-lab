...
- characters 455-1787: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1831-3777: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4982-5433: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7544-8896: `{{previous_actions}}` from the actor's own response from the previous turn
