...
- characters 106-13259: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13302-13493: `{{metrics_json}}` from the run's live metric values
- characters 13586-15382: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15426-17390: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17446-17900: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Bio Early-Warning and Health Resilience Surge | 2 |
