...
- characters 454-2250: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2294-4258: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5516-5950: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8691-10761: `{{previous_actions}}` from the actor's own response from the previous turn
