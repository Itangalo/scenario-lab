...
- characters 376-2172: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2216-4180: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4236-5290: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5353-29784: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30139-30805: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: Entry-Worker Transition Backstop −2, Essential Services Municipal Containment Surge −2, priority −1 = −5
PROPOSAL BONUS: Essential Services Municipal Containment Surge (cat 6, small) +3 — cyber_major_incident landed this turn severe and this answers it directly
LEGITIMACY LENDS: capital 11, sentiment 12 -> +1
SOVEREIGNTY: 28 last turn, no cat4 finish, no cat4 in flight +0, embodied_ai_deployment t8 −1, capability rose 0.5 −0 = 27

## Emerging developments (tracked)

- `emergent_site_occupations` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated occupations and blockades of fenced gigafactory plots and planned data-centre sites by graduate and municipal groups, halting site works for weeks and forcing evictions covered as national news.
- `emergent_site_blockade_wave` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated physical blockades of fenced gigafactory plots and data-centre substations spread across three member states, forcing extended construction halts and private security withdrawals.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, adoption_success
- Turn 2 (7 turn(s) ago): cyber_major_incident, export_control_escalation
- Turn 3 (6 turn(s) ago): cyber_major_incident, ai_investment_collapse, eu_frontier_access_denied
- Turn 4 (5 turn(s) ago): emergent_frontier_lab_stall
- Turn 5 (4 turn(s) ago): adoption_success, election_retrenchment
- Turn 6 (3 turn(s) ago): cyber_major_incident, labour_displacement, joint_threat_response, emergent_clinical_backlash_freeze
- Turn 7 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, member_state_defection
- Turn 8 (1 turn(s) ago): cyber_major_incident, embodied_ai_deployment, taiwan_tension_rise
