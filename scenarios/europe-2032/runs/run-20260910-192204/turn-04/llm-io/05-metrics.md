...
- characters 13631-14908: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14951-16880: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16936-17852: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_clinical_backlash_freeze` -- first noted turn 4, listed in 1 turn(s) so far: Municipal hospital federations and sickness funds publish a joint procurement boycott of hallucination-prone fallback triage tools after a medication-form error, freezing EU-funded rollout for months.
