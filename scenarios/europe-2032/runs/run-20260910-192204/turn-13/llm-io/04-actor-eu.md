...
- characters 1931-4008: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5168-5627: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8777-10197: `{{previous_actions}}` from the actor's own response from the previous turn
