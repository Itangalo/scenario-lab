...
- characters 1853-3930: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3986-4292: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4355-29389: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29744-30722: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, adoption_success
- Turn 2 (11 turn(s) ago): cyber_major_incident, export_control_escalation
- Turn 3 (10 turn(s) ago): cyber_major_incident, ai_investment_collapse, eu_frontier_access_denied
- Turn 4 (9 turn(s) ago): emergent_frontier_lab_stall
- Turn 5 (8 turn(s) ago): adoption_success, election_retrenchment
- Turn 6 (7 turn(s) ago): cyber_major_incident, labour_displacement, joint_threat_response, emergent_clinical_backlash_freeze
- Turn 7 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident, member_state_defection
- Turn 8 (5 turn(s) ago): cyber_major_incident, embodied_ai_deployment, taiwan_tension_rise
- Turn 9 (4 turn(s) ago): bio_uplift_findings, joint_threat_response, emergent_site_blockade_wave
- Turn 11 (2 turn(s) ago): medical_breakthrough, openweight_frontier_release, knowledge_work_augmented
- Turn 12 (1 turn(s) ago): research_breakthrough, taiwan_tension_rise, emergent_biosurveillance_false_alarm
