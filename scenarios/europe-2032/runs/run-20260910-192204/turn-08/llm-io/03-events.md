...
- characters 376-2065: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2108-4679: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4735-5757: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5820-30251: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30606-31180: `{{event_history}}` from the run's own event record
...
- Turn 2 (6 turn(s) ago): cyber_major_incident, export_control_escalation
- Turn 3 (5 turn(s) ago): cyber_major_incident, ai_investment_collapse, eu_frontier_access_denied
- Turn 4 (4 turn(s) ago): emergent_frontier_lab_stall
- Turn 5 (3 turn(s) ago): adoption_success, election_retrenchment
- Turn 6 (2 turn(s) ago): cyber_major_incident, labour_displacement, joint_threat_response, emergent_clinical_backlash_freeze
- Turn 7 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, member_state_defection
