...
- characters 105-12873: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12916-13108: `{{metrics_json}}` from the run's live metric values
- characters 13201-14890: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14933-17504: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17560-18582: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | Essential Services Municipal Containment Surge | 2 |
