...
- characters 1558-3608: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3664-4144: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4207-28638: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28993-29470: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): cyber_major_incident, export_control_escalation
- Turn 3 (4 turn(s) ago): cyber_major_incident, ai_investment_collapse, eu_frontier_access_denied
- Turn 4 (3 turn(s) ago): emergent_frontier_lab_stall
- Turn 5 (2 turn(s) ago): adoption_success, election_retrenchment
- Turn 6 (1 turn(s) ago): cyber_major_incident, labour_displacement, joint_threat_response, emergent_clinical_backlash_freeze
