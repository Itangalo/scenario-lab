...
- characters 452-2226: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2269-4346: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4414-4873: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7620-9924: `{{previous_actions}}` from the actor's own response from the previous turn
