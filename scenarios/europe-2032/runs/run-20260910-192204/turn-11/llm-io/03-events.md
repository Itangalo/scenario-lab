...
- characters 376-1137: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1181-3250: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3306-4401: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4464-29498: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29853-30618: `{{event_history}}` from the run's own event record
...
- Turn 2 (9 turn(s) ago): cyber_major_incident, export_control_escalation
- Turn 3 (8 turn(s) ago): cyber_major_incident, ai_investment_collapse, eu_frontier_access_denied
- Turn 4 (7 turn(s) ago): emergent_frontier_lab_stall
- Turn 5 (6 turn(s) ago): adoption_success, election_retrenchment
- Turn 6 (5 turn(s) ago): cyber_major_incident, labour_displacement, joint_threat_response, emergent_clinical_backlash_freeze
- Turn 7 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, member_state_defection
- Turn 8 (3 turn(s) ago): cyber_major_incident, embodied_ai_deployment, taiwan_tension_rise
- Turn 9 (2 turn(s) ago): bio_uplift_findings, joint_threat_response, emergent_site_blockade_wave
