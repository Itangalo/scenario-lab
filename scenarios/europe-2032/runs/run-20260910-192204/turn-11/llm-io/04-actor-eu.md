...
- characters 454-1215: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1259-3328: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4649-5108: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8063-10147: `{{previous_actions}}` from the actor's own response from the previous turn
