...
| M12 | EU Trusted Care Deployment | 9 | small | 11 | 12 | own jurisdiction | public_sentiment up substantially, resilience up slightly via continuity of care | 2 | finished |
| M13 | EU Municipal Restoration Corps | 6 | small | 12 | 14 | own jurisdiction | resilience up substantially, public_sentiment up slightly via restored services | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Municipal Restoration Corps", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up substantially, public_sentiment up slightly via restored services"}, "grounds": "to answer the ongoing ransomware sweep and stop cascade"}
  - Grounds: to answer the ongoing ransomware sweep and stop cascade
