...
| M12 | EU Trusted Care Deployment | 9 | small | 11 | 13 | own jurisdiction | public_sentiment up substantially, resilience up slightly via continuity of care | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Trusted Care Deployment", "category": 9, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up substantially, resilience up slightly via continuity of care"}, "grounds": "to convert medical breakthrough into trusted EU-delivered benefit"}
  - Grounds: to convert medical breakthrough into trusted EU-delivered benefit
