...
| M9 | EU Strait Supply Continuity Buffer | 6 | small | 7 | 8 | own jurisdiction | resilience up, eu_political_capital protected from supply shock | 2 | finished |
| M10 | EU Loss-of-Control and Bio-Uplift Containment Protocol | 6 | small | 8 | 9 | own jurisdiction | resilience up, ai_safety up slightly via containment and detection | 2 | finished |
| M11 | EU Bio-Containment and Assurance Uptake Surge | 6 | small | 9 | 11 | own jurisdiction | resilience up, ai_safety up via incident containment and deployed assurance uptake | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio-Containment and Assurance Uptake Surge", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up via incident containment and deployed assurance uptake"}, "grounds": "to answer real bio incident and adopt safety breakthrough with exhausted capital"}
  - Grounds: to answer real bio incident and adopt safety breakthrough with exhausted capital
