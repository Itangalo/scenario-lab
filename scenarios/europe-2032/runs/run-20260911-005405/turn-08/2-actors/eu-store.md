...
| M10 | EU Loss-of-Control and Bio-Uplift Containment Protocol | 6 | small | 8 | 10 | own jurisdiction | resilience up, ai_safety up slightly via containment and detection | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Loss-of-Control and Bio-Uplift Containment Protocol", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly via containment and detection"}, "grounds": "to answer loss-of-control incident and 4-turn bio gate with cheap exercised protocol"}
  - Grounds: to answer loss-of-control incident and 4-turn bio gate with cheap exercised protocol
