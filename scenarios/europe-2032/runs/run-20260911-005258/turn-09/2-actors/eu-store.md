...
| M11 | EU Sovereign Fallback Stack | 4 | small | 9 | 12 | own jurisdiction | eu_ai_sovereignty up, resilience up slightly via continuity | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Sovereign Fallback Stack", "category": 4, "size": "small", "finish_turn": 12, "applies_to": "own jurisdiction", "targeted_effect": "eu_ai_sovereignty up, resilience up slightly via continuity"}, "grounds": "to answer frontier access denial with domestic fallback"}
  - Grounds: to answer frontier access denial with domestic fallback
