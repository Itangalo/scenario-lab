...
| M9 | EU Essential Services Continuity and Cyber Recovery Operation | 6 | small | 7 | 8 | own jurisdiction | resilience up moderately, eu_political_capital protected, public_sentiment protected | 2 | finished |
| M10 | EU Work Transition and Service Continuity Pact | 7 | small | 8 | 9 | own jurisdiction | public_sentiment up, eu_political_capital protected, resilience up modestly | 2 | finished |
| M11 | EU Bio-Cyber Survival Shield for Hospitals, Grids and Labs | 6 | small | 9 | 11 | own jurisdiction | resilience up moderately, ai_safety protected, public_sentiment protected | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio-Cyber Survival Shield for Hospitals, Grids and Labs", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected, public_sentiment protected"}, "grounds": "to absorb bio uplift and RSI-driven cyber wave into continuity doctrine"}
  - Grounds: to absorb bio uplift and RSI-driven cyber wave into continuity doctrine
