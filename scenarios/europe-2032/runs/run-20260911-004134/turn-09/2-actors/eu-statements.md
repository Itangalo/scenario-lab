...
- `two_year_commitment` (commitment): Survive runaway capability without losing essential services or governability

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Survive runaway capability without losing essential services or governability
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the timeframe for the original pledge, changing the actor's obligation and cost of maintaining it.
