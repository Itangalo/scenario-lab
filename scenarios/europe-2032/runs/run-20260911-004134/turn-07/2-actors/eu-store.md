...
| M9 | EU Essential Services Continuity and Cyber Recovery Operation | 6 | small | 7 | 9 | own jurisdiction | resilience up moderately, eu_political_capital protected, public_sentiment protected | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Essential Services Continuity and Cyber Recovery Operation", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, eu_political_capital protected, public_sentiment protected"}, "grounds": "to survive cut-off and major cyber incident without essential-service collaps
  - Grounds: to survive cut-off and major cyber incident without essential-service collapse
