...
| M10 | EU Work Transition and Service Continuity Pact | 7 | small | 8 | 10 | own jurisdiction | public_sentiment up, eu_political_capital protected, resilience up modestly | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Work Transition and Service Continuity Pact", "category": 7, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, eu_political_capital protected, resilience up modestly"}, "grounds": "to absorb labour displacement into recovery and hold consent for rationing"}
  - Grounds: to absorb labour displacement into recovery and hold consent for rationing
