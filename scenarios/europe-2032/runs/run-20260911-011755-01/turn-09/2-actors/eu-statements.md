...
- `two_year_commitment` (commitment): Rebuild trust through visible restoration before any new build

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild trust through visible restoration before any new build
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the timeframe for the original statement, changing the actor's obligation and enabling a shift in strategy.
