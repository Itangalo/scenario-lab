...
- `two_year_commitment` (commitment): Rebuild trust and hold together enough autonomous capacity to endure ungovernable AI

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild trust and hold together enough autonomous capacity to endure ungovernable AI
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the timeframe of the original statement, necessitating a new focus for the next phase.
