...
- characters 375-1439: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1483-3582: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3638-4470: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4533-28902: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29257-30354: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Continuity and Redress Deployment −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: EU Continuity and Redress Deployment (cat 9, small) +4 — eu_frontier_access_denied and automated_decision_scandal both fired this turn and this answers both directly
LEGITIMACY LENDS: capital 3, sentiment 6 -> +2
SOVEREIGNTY: 23 last turn, no capacity event? no — eu_frontier_access_denied t12 −2, no category 4 finish, no build in flight +0, capability rose 1.0 −0 = 21

## Emerging developments (tracked)

- `emergent_grid_permit_stall` -- first noted turn 12, listed in 1 turn(s) so far: Coordinated municipal refusals spread from data-centre and battery sites to a de facto winter moratorium on grid interconnector works, enforced by courts and guarded sites rather than by any EU decision.
...
- Turn 2 (11 turn(s) ago): capability_jump, bio_uplift_findings, member_state_defection
- Turn 3 (10 turn(s) ago): export_control_escalation, adoption_success
- Turn 4 (9 turn(s) ago): eval_anomaly_reports, middle_power_coalition
- Turn 5 (8 turn(s) ago): cyber_major_incident, bio_incident, bio_uplift_findings, election_alliance
- Turn 6 (7 turn(s) ago): cyber_major_incident, loss_of_control_incident
- Turn 7 (6 turn(s) ago): eval_anomaly_reports, labour_displacement, embodied_ai_deployment, adoption_success
- Turn 8 (5 turn(s) ago): opaque_reasoning, member_state_defection, emergent_siting_litigation_freeze
- Turn 9 (4 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release
- Turn 10 (3 turn(s) ago): capability_jump, cyber_defence_breakthrough, bio_uplift_findings, emergent_infrastructure_backlash_sabotage
- Turn 11 (2 turn(s) ago): emergent_permit_freeze_spillover
- Turn 12 (1 turn(s) ago): eval_anomaly_reports, safety_breakthrough, eu_frontier_access_denied, adoption_success, automated_decision_scandal
