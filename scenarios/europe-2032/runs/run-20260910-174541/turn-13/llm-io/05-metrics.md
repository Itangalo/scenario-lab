...
- characters 107-12923: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12966-13155: `{{metrics_json}}` from the run's live metric values
- characters 13248-14312: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14356-16455: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16511-17343: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_grid_permit_stall` -- first noted turn 12, listed in 2 turn(s) so far: Coordinated municipal refusals spread from data-centre and battery sites to a de facto winter moratorium on grid interconnector works, enforced by courts and guarded sites rather than by any EU decision.
...
## Notepad
PORTFOLIO CHARGE t13: M12 EU Continuity and Redress Deployment −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 0, sentiment 11 -> +1
SOVEREIGNTY: 21 last turn, no capacity event, no category 4 in flight +0, capability rose 1.0 −0 = 21
