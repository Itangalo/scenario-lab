...
- characters 376-2523: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2566-5014: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5070-5936: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5999-30212: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30567-31120: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU Loss-of-Control and Automated-Cyber Containment Protocol −2, EU Entry-Level AI Transition Fund −2, priority −1 not charged (capital below 20, no effect) = −4
PROPOSAL BONUS: EU Entry-Level AI Transition Fund (cat 7, small) +2 — labour_displacement landed this turn narrow entry-level losses and this answers it directly with adoption_success anchor
LEGITIMACY LENDS: capital 10, sentiment 20 -> +2
SOVEREIGNTY: 22 last turn, InvestAI Gigafactories finishes t7 +4, no capacity event in flight bonus, embodied_ai_deployment t7 −1, capability rose 1.0 −0 = 25

## Emerging developments (tracked)

- `emergent_siting_litigation_freeze` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated municipal lawsuits halt data-centre water permits in two more member states, freezing planned resilience and gigafactory power upgrades for months.
...
- Turn 2 (6 turn(s) ago): capability_jump, bio_uplift_findings, member_state_defection
- Turn 3 (5 turn(s) ago): export_control_escalation, adoption_success
- Turn 4 (4 turn(s) ago): eval_anomaly_reports, middle_power_coalition
- Turn 5 (3 turn(s) ago): cyber_major_incident, bio_incident, bio_uplift_findings, election_alliance
- Turn 6 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident
- Turn 7 (1 turn(s) ago): eval_anomaly_reports, labour_displacement, embodied_ai_deployment, adoption_success
