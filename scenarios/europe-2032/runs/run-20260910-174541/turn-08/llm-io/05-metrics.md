...
- characters 105-13400: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13443-13635: `{{metrics_json}}` from the run's live metric values
- characters 13728-15875: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15918-18366: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18422-19002: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Entry-Level AI Transition Fund | 2 |
| M9 | EU Black-Box Oversight and Deployment Check Programme | 2 |
