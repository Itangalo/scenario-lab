...
- characters 375-1466: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1510-3615: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3671-4242: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4305-27821: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28176-28831: `{{event_history}}` from the run's own event record
...
- Turn 2 (7 turn(s) ago): capability_jump, bio_uplift_findings, member_state_defection
- Turn 3 (6 turn(s) ago): export_control_escalation, adoption_success
- Turn 4 (5 turn(s) ago): eval_anomaly_reports, middle_power_coalition
- Turn 5 (4 turn(s) ago): cyber_major_incident, bio_incident, bio_uplift_findings, election_alliance
- Turn 6 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident
- Turn 7 (2 turn(s) ago): eval_anomaly_reports, labour_displacement, embodied_ai_deployment, adoption_success
- Turn 8 (1 turn(s) ago): opaque_reasoning, member_state_defection, emergent_siting_litigation_freeze
