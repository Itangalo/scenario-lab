...
- characters 1588-3693: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5274-5726: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8605-10636: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Black-Box Oversight and Deployment Check Programme | 5 | small | 8 | 11 | own jurisdiction | ai_safety up slightly, resilience up slightly via deployment safeguards | 2 | running |
