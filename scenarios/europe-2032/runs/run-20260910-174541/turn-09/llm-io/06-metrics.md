...
- characters 106-13420: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13463-13653: `{{metrics_json}}` from the run's live metric values
- characters 13746-14837: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14881-16986: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17042-18275: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Unsanctioned-Agent Containment and Essential-Service Continuity Order | 2 |
