...
- characters 13416-14590: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14633-16696: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16752-17673: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 66.5, "openweight_capability": 63.9, "ai_safety": 1.0, "resilience": 40.0, "eu_ai_sovereignty": 23.0, "eu_political_capital": 3.0, "public_sentiment": 9.0}
```
