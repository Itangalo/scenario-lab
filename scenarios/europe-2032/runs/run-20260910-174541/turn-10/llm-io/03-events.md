...
- characters 376-1550: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1593-3656: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3712-4952: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5015-29384: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29739-30496: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Black-Box Oversight and Deployment Check Programme −2, EU Unsanctioned-Agent Containment and Essential-Service Continuity Order −2, priority −1 not charged (capital below 20, no effect) = −4
PROPOSAL BONUS: EU Unsanctioned-Agent Containment and Essential-Service Continuity Order (cat 6, small) +2 — loss-of-control incident landed this turn and this answers it directly with containment
LEGITIMACY LENDS: capital 8, sentiment 12 -> +2
SOVEREIGNTY: 23 last turn, no capacity event, no category 4 finish, no build in flight +0, capability rose 1.0 −0 = 23

## Emerging developments (tracked)

- `emergent_permit_freeze_spillover` -- first noted turn 9, listed in 1 turn(s) so far: Coordinated municipal water and planning challenges spread from data-centres to grid-scale battery and substation upgrades, freezing several cross-border power interconnection works counted for resilience this winter.
- `emergent_infrastructure_backlash_sabotage` -- first noted turn 9, listed in 1 turn(s) so far: Coordinated physical protests and sabotage against power substations and data-centre construction sites spread across three member states, linking municipal water-permit freezes to a wider anti-AI infrastructure movement.
...
- Turn 2 (8 turn(s) ago): capability_jump, bio_uplift_findings, member_state_defection
- Turn 3 (7 turn(s) ago): export_control_escalation, adoption_success
- Turn 4 (6 turn(s) ago): eval_anomaly_reports, middle_power_coalition
- Turn 5 (5 turn(s) ago): cyber_major_incident, bio_incident, bio_uplift_findings, election_alliance
- Turn 6 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident
- Turn 7 (3 turn(s) ago): eval_anomaly_reports, labour_displacement, embodied_ai_deployment, adoption_success
- Turn 8 (2 turn(s) ago): opaque_reasoning, member_state_defection, emergent_siting_litigation_freeze
- Turn 9 (1 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release
