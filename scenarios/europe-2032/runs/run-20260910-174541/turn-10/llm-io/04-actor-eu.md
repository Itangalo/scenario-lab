...
- characters 1671-3734: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5284-5730: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8812-11093: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M10 | EU Unsanctioned-Agent Containment and Essential-Service Continuity Order | 6 | small | 9 | 11 | own jurisdiction | resilience up moderately, ai_safety up slightly via containment | 2 | running |
