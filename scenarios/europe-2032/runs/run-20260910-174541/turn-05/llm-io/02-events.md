...
- characters 376-1476: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1520-3788: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3844-5043: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5106-31363: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31718-31987: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): capability_jump, bio_uplift_findings, member_state_defection
- Turn 3 (2 turn(s) ago): export_control_escalation, adoption_success
- Turn 4 (1 turn(s) ago): eval_anomaly_reports, middle_power_coalition
