...
- characters 13951-15051: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15095-17363: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17419-18618: `{{notepad}}` from the Game Master's notepad, carried across turns
