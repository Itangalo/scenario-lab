...
- characters 16361-17006: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_genome_model_leak` -- first noted turn 1, listed in 1 turn(s) so far: A copy of a leading genome language model with phage-design capability is leaked outside voluntary screening channels and mirrored on foreign file-hosts, widening access to AI-assisted biological design.
- `emergent_biopublish_moratorium_fight` -- first noted turn 1, listed in 1 turn(s) so far: A major EU scientific publisher and a national research funder jointly impose a moratorium on publishing AI-designed pathogen methods after the phage results, triggering a high-profile fight over open science and pre-print servers.
...
PROPOSAL BONUS: EU Critical Systems Hardening and Detection Pact (cat 6, large) +3 — cyber_test_shot landed this turn with EU grid victims and this answers it directly
