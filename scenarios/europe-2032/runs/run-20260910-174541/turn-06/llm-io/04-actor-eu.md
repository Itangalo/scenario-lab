...
- characters 1693-3664: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4818-5270: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7583-9269: `{{previous_actions}}` from the actor's own response from the previous turn
