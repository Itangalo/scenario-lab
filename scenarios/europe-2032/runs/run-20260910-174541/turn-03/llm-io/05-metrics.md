...
- characters 13434-14925: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14969-17182: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17238-17777: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | European Public Benefit AI Deployment | 2 |
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 53.0, "ai_safety": 22.0, "resilience": 35.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 16.0, "public_sentiment": 34.0}
```
## Narrative
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Hardening and Detection Pact −3, EU Bio Detection and Triage Upgrade −2, European Public Benefit AI Deployment −2, priority −1 = −14
PROPOSAL BONUS: none — new European Public Benefit AI Deployment (cat 9, small) answers adoption_success positive window and low sentiment, not a negative event from last three rounds
LEGITIMACY LENDS: capital 14, sentiment 34 -> +2
SOVEREIGNTY: 18 last turn, no capacity event finish, in flight +0, export_control_escalation t3 −2, capability rose 2.0 −1 = 15
## Store changes
```json
{"store": []}
```
