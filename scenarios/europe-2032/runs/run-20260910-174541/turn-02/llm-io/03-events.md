...
- characters 376-1586: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1629-3711: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3767-4899: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4962-27674: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28029-28070: `{{event_history}}` from the run's own event record
