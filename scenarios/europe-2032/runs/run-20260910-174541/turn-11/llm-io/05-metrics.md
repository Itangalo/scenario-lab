...
- characters 107-13553: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13596-13785: `{{metrics_json}}` from the run's live metric values
- characters 13878-15385: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15429-17595: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17651-18288: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Essential-Site Protection and Bio-Cyber Shield | 2 |
