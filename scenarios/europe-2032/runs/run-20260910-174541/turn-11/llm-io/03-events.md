...
- characters 375-1882: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1926-4092: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4148-5128: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5191-29560: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29915-30808: `{{event_history}}` from the run's own event record
...
- `emergent_permit_freeze_spillover` -- first noted turn 9, listed in 2 turn(s) so far: Coordinated municipal water and planning challenges spread from data-centres to grid-scale battery and substation upgrades, freezing several cross-border power interconnection works counted for resilience this winter.
...
- Turn 2 (9 turn(s) ago): capability_jump, bio_uplift_findings, member_state_defection
- Turn 3 (8 turn(s) ago): export_control_escalation, adoption_success
- Turn 4 (7 turn(s) ago): eval_anomaly_reports, middle_power_coalition
- Turn 5 (6 turn(s) ago): cyber_major_incident, bio_incident, bio_uplift_findings, election_alliance
- Turn 6 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident
- Turn 7 (4 turn(s) ago): eval_anomaly_reports, labour_displacement, embodied_ai_deployment, adoption_success
- Turn 8 (3 turn(s) ago): opaque_reasoning, member_state_defection, emergent_siting_litigation_freeze
- Turn 9 (2 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release
- Turn 10 (1 turn(s) ago): capability_jump, cyber_defence_breakthrough, bio_uplift_findings, emergent_infrastructure_backlash_sabotage
