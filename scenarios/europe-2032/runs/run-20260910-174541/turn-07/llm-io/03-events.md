...
- characters 377-2429: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2473-5316: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5372-5830: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5893-30106: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30461-30904: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): capability_jump, bio_uplift_findings, member_state_defection
- Turn 3 (4 turn(s) ago): export_control_escalation, adoption_success
- Turn 4 (3 turn(s) ago): eval_anomaly_reports, middle_power_coalition
- Turn 5 (2 turn(s) ago): cyber_major_incident, bio_incident, bio_uplift_findings, election_alliance
- Turn 6 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident
