...
- characters 106-13353: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13396-13588: `{{metrics_json}}` from the run's live metric values
- characters 13681-15733: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15777-18620: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18676-19420: `{{notepad}}` from the Game Master's notepad, carried across turns
