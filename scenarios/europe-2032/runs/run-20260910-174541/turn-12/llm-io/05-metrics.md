...
- characters 106-13349: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13392-13582: `{{metrics_json}}` from the run's live metric values
- characters 13675-15429: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15472-17497: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17553-18235: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Continuity and Redress Deployment | 2 |
