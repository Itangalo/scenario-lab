...
- characters 375-2129: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2172-4197: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4253-4611: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4674-29043: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29398-30352: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Essential-Site Protection and Bio-Cyber Shield −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2, sentiment 10 -> +2
...
- Turn 2 (10 turn(s) ago): capability_jump, bio_uplift_findings, member_state_defection
- Turn 3 (9 turn(s) ago): export_control_escalation, adoption_success
- Turn 4 (8 turn(s) ago): eval_anomaly_reports, middle_power_coalition
- Turn 5 (7 turn(s) ago): cyber_major_incident, bio_incident, bio_uplift_findings, election_alliance
- Turn 6 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident
- Turn 7 (5 turn(s) ago): eval_anomaly_reports, labour_displacement, embodied_ai_deployment, adoption_success
- Turn 8 (4 turn(s) ago): opaque_reasoning, member_state_defection, emergent_siting_litigation_freeze
- Turn 9 (3 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release
- Turn 10 (2 turn(s) ago): capability_jump, cyber_defence_breakthrough, bio_uplift_findings, emergent_infrastructure_backlash_sabotage
- Turn 11 (1 turn(s) ago): emergent_permit_freeze_spillover
