...
- characters 1771-3618: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3674-4264: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4327-27716: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28071-28269: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): capability_jump, bio_uplift_findings, member_state_defection
- Turn 3 (1 turn(s) ago): export_control_escalation, adoption_success
