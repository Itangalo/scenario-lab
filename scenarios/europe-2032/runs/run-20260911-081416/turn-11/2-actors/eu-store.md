...
| M12 | EU Municipal Recovery and Continuity Corps | 6 | small | 11 | 13 | own jurisdiction | resilience up, eu_political_capital protected from service failure | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Municipal Recovery and Continuity Corps", "category": 6, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_political_capital protected from service failure"}, "grounds": "major automated cyber incident darkening public services requires immediate containment"}
  - Grounds: major automated cyber incident darkening public services requires immediate containment
