...
| M13 | EU Entry-Level Transition Guarantee | 7 | small | 12 | 15 | own jurisdiction | resilience up, eu_political_capital protected via trust repair | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Entry-Level Transition Guarantee", "category": 7, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_political_capital protected via trust repair"}, "grounds": "narrow but real AI entry-level displacement amid collapsed public trust"}
  - Grounds: narrow but real AI entry-level displacement amid collapsed public trust
