...
| M12 | EU Municipal Recovery and Continuity Corps | 6 | small | 11 | 12 | own jurisdiction | resilience up, eu_political_capital protected from service failure | 2 | finished |
| M13 | EU Entry-Level Transition Guarantee | 7 | small | 12 | 14 | own jurisdiction | resilience up, eu_political_capital protected via trust repair | 2 | running |
| M14 | EU Automated Attack Containment Surge | 6 | small | 13 | 15 | own jurisdiction | resilience up, eu_political_capital protected from service failure | 2 | running |
...
- **applied** `M14` — {"op": "add", "table": "measures", "fields": {"name": "EU Automated Attack Containment Surge", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_political_capital protected from service failure"}, "grounds": "large automated attack landing amid collapsed trust"}
  - Grounds: large automated attack landing amid collapsed trust
