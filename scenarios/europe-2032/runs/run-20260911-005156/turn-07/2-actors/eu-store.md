...
| M8 | EU Bio-Containment and Agent Loss-of-Control Emergency Regime | 6 | small | 7 | 9 | own jurisdiction | resilience up moderately, ai_safety protected from further fall, public_sentiment protected | 2 | running |
...
- **applied** `M8` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio-Containment and Agent Loss-of-Control Emergency Regime", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected from further fall, public_sentiment protected"}, "grounds": "bio incident and loss-of-control demand immediate containment"}
  - Grounds: bio incident and loss-of-control demand immediate containment
