...
| M8 | EU Bio-Containment and Agent Loss-of-Control Emergency Regime | 6 | small | 7 | 8 | own jurisdiction | resilience up moderately, ai_safety protected from further fall, public_sentiment protected | 2 | finished |
| M9 | EU Automation and Robotics Transition Shield | 7 | small | 8 | 10 | own jurisdiction | public_sentiment up, resilience up moderately, eu_political_capital protected | 2 | running |
| M10 | EU Agent Containment and Essential-Service Isolation Regime | 6 | small | 9 | 11 | own jurisdiction | resilience up, ai_safety protected from further fall, public_sentiment protected | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Agent Containment and Essential-Service Isolation Regime", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety protected from further fall, public_sentiment protected"}, "grounds": "loss-of-control incident plus RSI onset demands containment"}
  - Grounds: loss-of-control incident plus RSI onset demands containment
