...
- `two_year_commitment` (commitment): Survive autonomous AI without losing essential services or democratic control

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Survive autonomous AI without losing essential services or democratic control
