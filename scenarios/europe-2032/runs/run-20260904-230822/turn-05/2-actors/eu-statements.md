...
- `two_year_commitment` (commitment): Secure sovereign AI capacity to act independently in a fractured technological world

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign AI capacity to act independently in a fractured technological world
