...
- characters 13398-14817: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14860-17667: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17723-18803: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M3 | EU Essential Services Shield | 3 |
| M4 | EU–Middle Power Compute and Chokepoint Pact | 3 |
...
- `emergent_datacentre_permit_revolt` -- first noted turn 1, listed in 2 turn(s) so far: Municipal opposition to new hyperscale data-centre siting coalesces across several member states into coordinated permit blocks and grid-connection challenges, delaying at least one major build without any EU-level decision.
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 51.0, "ai_safety": 37.0, "resilience": 37.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 41.0, "public_sentiment": 29.0}
```
...
## Notepad
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Essential Services Shield −3, EU–Middle Power Compute and Chokepoint Pact −3, priority −1 = −13
PROPOSAL BONUS: EU–Middle Power Compute and Chokepoint Pact (cat 8, large) +5 — taiwan_blockade and export squeeze landed this turn severe and this answers them directly via joint leverage
LEGITIMACY LENDS: capital 41, sentiment 29 -> none (capital above sentiment)
SOVEREIGNTY: 20 last turn, no finish this turn, Gigafactories in flight +1, taiwan_blockade t2 −2, capability rose 3.0 −1 = 18
