...
- characters 374-2939: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2983-4794: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4850-5328: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5391-30608: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30963-32482: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_frontier_access_denied, supply_chain_coercion, member_state_defection
- Turn 2 (11 turn(s) ago): taiwan_blockade, eval_anomaly_reports, safety_breakthrough, export_control_escalation, middle_power_coalition
- Turn 3 (10 turn(s) ago): eval_anomaly_reports
- Turn 4 (9 turn(s) ago): cyber_defence_breakthrough, research_breakthrough, taiwan_tension_rise
- Turn 5 (8 turn(s) ago): cyber_major_incident, eval_anomaly_reports, export_control_escalation, election_consolidation
- Turn 6 (7 turn(s) ago): cyber_major_incident, bio_uplift_findings, capability_jump, medical_breakthrough, openweight_frontier_release, ai_investment_collapse, taiwan_tension_rise, export_control_escalation
- Turn 7 (6 turn(s) ago): capability_jump, export_control_escalation
- Turn 8 (5 turn(s) ago): loss_of_control_incident, bio_uplift_findings, rsi_onset, labour_displacement
- Turn 9 (4 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, catastrophic_loss_of_control_incident, export_control_escalation, us_labs_nationalised, joint_threat_response
- Turn 10 (3 turn(s) ago): cyber_major_incident, eu_frontier_access_denied
- Turn 11 (2 turn(s) ago): bio_uplift_findings, opaque_reasoning, catastrophic_loss_of_control_incident, taiwan_tension_rise, us_china_agreement, emergent_anti_ai_infrastructure_sabotage
- Turn 12 (1 turn(s) ago): labour_displacement, knowledge_work_augmented, embodied_ai_deployment, emergent_shadow_fork_fragmentation
