...
- characters 2052-4025: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4704-5191: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7846-10478: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Essential Continuity and Bio-Detection Patch | 6 | small | 6 | 8 | own jurisdiction | resilience up moderately, ai_safety up slightly via early detection | 2 | running |
