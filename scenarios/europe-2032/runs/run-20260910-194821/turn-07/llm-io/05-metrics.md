...
- characters 106-13491: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13534-13726: `{{metrics_json}}` from the run's live metric values
- characters 13819-15372: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15416-17389: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17445-18034: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Essential Continuity and Bio-Detection Patch | 2 |
