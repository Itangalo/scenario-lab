...
- characters 377-1930: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1974-3947: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4003-4592: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4655-31970: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32325-33077: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, EU Shield Recovery and Continuity Surge −2, EU Essential Continuity and Bio-Detection Patch −2, priority −1 = −8
PROPOSAL BONUS: EU Essential Continuity and Bio-Detection Patch (cat 6, small) +3 — cyber_major_incident landed this turn and bio_uplift_findings opened precursor, this answers both directly
LEGITIMACY LENDS: capital 21, sentiment 20 -> none (capital not below sentiment)
SOVEREIGNTY: 15 last turn, Tech sovereignty package finishes t6 +4, Gigafactories in flight +0, export_control_escalation t6 −3, capability rose 7.0 −1 = 15
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_frontier_access_denied, supply_chain_coercion, member_state_defection
- Turn 2 (5 turn(s) ago): taiwan_blockade, eval_anomaly_reports, safety_breakthrough, export_control_escalation, middle_power_coalition
- Turn 3 (4 turn(s) ago): eval_anomaly_reports
- Turn 4 (3 turn(s) ago): cyber_defence_breakthrough, research_breakthrough, taiwan_tension_rise
- Turn 5 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, export_control_escalation, election_consolidation
- Turn 6 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, capability_jump, medical_breakthrough, openweight_frontier_release, ai_investment_collapse, taiwan_tension_rise, export_control_escalation
