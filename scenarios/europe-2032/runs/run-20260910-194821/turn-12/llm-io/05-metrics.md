...
- characters 13446-13635: `{{metrics_json}}` from the run's live metric values
- characters 13728-16652: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16695-18628: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18684-19174: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 96.0, "openweight_capability": 91.2, "ai_safety": 0.0, "resilience": 64.0, "eu_ai_sovereignty": 3.0, "eu_political_capital": 8.0, "public_sentiment": 0.0}
```
## Narrative
