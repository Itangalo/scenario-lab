...
- characters 374-3298: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3341-5274: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5330-5820: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5883-31100: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31455-32840: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M11 EU Denied-Access Continuity Switch −2, M12 EU Accession to US-China AI Risk Floor −2, priority M11 −1 = −5
PROPOSAL BONUS: EU Accession to US-China AI Risk Floor (cat 8, small) +3 — us_china_agreement, opaque_reasoning and bio_uplift_findings landed this turn and this answers them directly
LEGITIMACY LENDS: capital 12, sentiment 0 -> none (capital not below sentiment)
SOVEREIGNTY: 7 last turn, no capacity event, no cat4 in flight +0, capability rose 2.5 −1 = 6
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_frontier_access_denied, supply_chain_coercion, member_state_defection
- Turn 2 (10 turn(s) ago): taiwan_blockade, eval_anomaly_reports, safety_breakthrough, export_control_escalation, middle_power_coalition
- Turn 3 (9 turn(s) ago): eval_anomaly_reports
- Turn 4 (8 turn(s) ago): cyber_defence_breakthrough, research_breakthrough, taiwan_tension_rise
- Turn 5 (7 turn(s) ago): cyber_major_incident, eval_anomaly_reports, export_control_escalation, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, bio_uplift_findings, capability_jump, medical_breakthrough, openweight_frontier_release, ai_investment_collapse, taiwan_tension_rise, export_control_escalation
- Turn 7 (5 turn(s) ago): capability_jump, export_control_escalation
- Turn 8 (4 turn(s) ago): loss_of_control_incident, bio_uplift_findings, rsi_onset, labour_displacement
- Turn 9 (3 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, catastrophic_loss_of_control_incident, export_control_escalation, us_labs_nationalised, joint_threat_response
- Turn 10 (2 turn(s) ago): cyber_major_incident, eu_frontier_access_denied
- Turn 11 (1 turn(s) ago): bio_uplift_findings, opaque_reasoning, catastrophic_loss_of_control_incident, taiwan_tension_rise, us_china_agreement, emergent_anti_ai_infrastructure_sabotage
