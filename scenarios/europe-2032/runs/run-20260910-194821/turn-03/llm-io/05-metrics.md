...
- characters 106-13475: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13518-13710: `{{metrics_json}}` from the run's live metric values
- characters 13803-15587: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15631-17980: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18036-18604: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 54.5, "ai_safety": 35.0, "resilience": 42.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 37.0, "public_sentiment": 28.0}
```
