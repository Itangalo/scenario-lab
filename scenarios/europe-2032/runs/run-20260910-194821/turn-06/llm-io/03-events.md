...
- characters 376-1697: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1740-3830: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3886-4991: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5054-31431: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31786-32330: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Shield Recovery and Continuity Surge −2, priority −1 = −9
PROPOSAL BONUS: EU Shield Recovery and Continuity Surge (cat 6, small) +4 — cyber_major_incident landed this turn on thin hospitals/municipalities and this answers it directly
LEGITIMACY LENDS: capital 30, sentiment 24 -> none (capital not below sentiment)
SOVEREIGNTY: 18 last turn, no capacity build finishing, Gigafactories in flight +0, export_control_escalation t5 −2, capability rose 3.0 −1 = 15

## Emerging developments (tracked)

- `emergent_allied_accelerator_batch` -- first noted turn 4, listed in 2 turn(s) so far: A non-US foundry consortium announces a qualified second-source accelerator batch available for allied pooled buyers, easing but not ending the Taiwan-driven shortage.
- `emergent_second_source_yield_relief` -- first noted turn 4, listed in 2 turn(s) so far: A non-US accelerator line in Japan or South Korea clears volume yield earlier than expected, easing prices for pooled EU orders without resolving leading-edge dependence on Taiwan.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_frontier_access_denied, supply_chain_coercion, member_state_defection
- Turn 2 (4 turn(s) ago): taiwan_blockade, eval_anomaly_reports, safety_breakthrough, export_control_escalation, middle_power_coalition
- Turn 3 (3 turn(s) ago): eval_anomaly_reports
- Turn 4 (2 turn(s) ago): cyber_defence_breakthrough, research_breakthrough, taiwan_tension_rise
- Turn 5 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, export_control_escalation, election_consolidation
