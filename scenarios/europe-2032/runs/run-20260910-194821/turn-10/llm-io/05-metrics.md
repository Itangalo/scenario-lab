...
- characters 106-13423: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13466-13656: `{{metrics_json}}` from the run's live metric values
- characters 13749-15939: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15982-18364: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18420-19277: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | EU Joint Cyber-Bio Lifeline Accession | 2 |
