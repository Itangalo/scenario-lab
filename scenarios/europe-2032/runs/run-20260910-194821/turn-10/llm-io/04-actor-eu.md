...
- characters 453-2643: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2686-5068: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6017-6527: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9561-12040: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Joint Cyber-Bio Lifeline Accession | 6 | small | 9 | 11 | coalition | resilience up substantially via joint response, ai_safety up slightly via telemetry | 2 | running |
