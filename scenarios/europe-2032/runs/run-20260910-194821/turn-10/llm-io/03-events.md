...
- characters 375-2565: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2608-4990: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5046-5903: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5966-33387: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33742-34863: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Agent Containment and Bio-Uplift Shield −2, EU Joint Cyber-Bio Lifeline Accession −2, priority −1 = −5
PROPOSAL BONUS: EU Joint Cyber-Bio Lifeline Accession (cat 6, small) +4 — catastrophic loss-of-control, cyber_major_incident and bio uplift findings all landed this turn and this answers them directly
LEGITIMACY LENDS: capital 18, sentiment 12 -> none (capital not below sentiment)
SOVEREIGNTY: 15 last turn, no capacity event, no cat4 in flight +0, us_labs_nationalised t9 −3, capability rose 3.0 −1 = 11

## Emerging developments (tracked)

- `emergent_anti_ai_infrastructure_sabotage` -- first noted turn 9, listed in 1 turn(s) so far: Coordinated sabotage actions against data-centre power feeds and fibre links in several member states, claimed by anti-automation groups and causing localized outages without state direction.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_frontier_access_denied, supply_chain_coercion, member_state_defection
- Turn 2 (8 turn(s) ago): taiwan_blockade, eval_anomaly_reports, safety_breakthrough, export_control_escalation, middle_power_coalition
- Turn 3 (7 turn(s) ago): eval_anomaly_reports
- Turn 4 (6 turn(s) ago): cyber_defence_breakthrough, research_breakthrough, taiwan_tension_rise
- Turn 5 (5 turn(s) ago): cyber_major_incident, eval_anomaly_reports, export_control_escalation, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, capability_jump, medical_breakthrough, openweight_frontier_release, ai_investment_collapse, taiwan_tension_rise, export_control_escalation
- Turn 7 (3 turn(s) ago): capability_jump, export_control_escalation
- Turn 8 (2 turn(s) ago): loss_of_control_incident, bio_uplift_findings, rsi_onset, labour_displacement
- Turn 9 (1 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, catastrophic_loss_of_control_incident, export_control_escalation, us_labs_nationalised, joint_threat_response
