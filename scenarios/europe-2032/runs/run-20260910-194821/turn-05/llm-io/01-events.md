...
- characters 377-2267: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2311-4182: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4238-5356: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5419-32249: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32604-33028: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Deception Eval and Interpretability Cell −2, EU Shield Patch-Scale Deployment −2, priority −1 = −11
PROPOSAL BONUS: EU Shield Patch-Scale Deployment (cat 6, small) +2 — answers credential-collection probes and thin hospital/municipal cover from last turns and Taiwan precursor raising risk
LEGITIMACY LENDS: capital 31, sentiment 31 -> none (capital not below sentiment)
SOVEREIGNTY: 18 last turn, no capacity event, Gigafactories in flight +1, capability rose 3.0 −1 = 18

## Emerging developments (tracked)

- `emergent_allied_accelerator_batch` -- first noted turn 4, listed in 1 turn(s) so far: A non-US foundry consortium announces a qualified second-source accelerator batch available for allied pooled buyers, easing but not ending the Taiwan-driven shortage.
- `emergent_second_source_yield_relief` -- first noted turn 4, listed in 1 turn(s) so far: A non-US accelerator line in Japan or South Korea clears volume yield earlier than expected, easing prices for pooled EU orders without resolving leading-edge dependence on Taiwan.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_frontier_access_denied, supply_chain_coercion, member_state_defection
- Turn 2 (3 turn(s) ago): taiwan_blockade, eval_anomaly_reports, safety_breakthrough, export_control_escalation, middle_power_coalition
- Turn 3 (2 turn(s) ago): eval_anomaly_reports
- Turn 4 (1 turn(s) ago): cyber_defence_breakthrough, research_breakthrough, taiwan_tension_rise
...
```
[{"description": "","emergent": false,"id": "election_consolidation","probability": 0.55},{"description": "","emergent": false,"id": "election_alliance","probability": 0.22},{"description": "","emergent": false,"id": "election_retrenchment","probability": 0.12},{"description": "","emergent": false,"id": "cyber_major_incident","probability": 0.19},{"description": "","emergent": false,"id": "bio_incident","probability": 0.01},{"description": "","emergent": false,"id": "loss_of_control_incident","probability": 0.14},{"description": "","emergent": false,"id": "capability_jump","probability": 0.3},{"description": "","emergent": false,"id": "taiwan_blockade","probability": 0.35},{"description": "","emergent": false,"id": "ai_investment_collapse","probability": 0.06},{"description": "","emergent": false,"id": "cyber_defence_breakthrough","probability": 0.08},{"description": "","emergent": false,"id": "bio_uplift_findings","probability": 0.16},{"description": "","emergent": false,"id": "eval_anomaly_reports","probability": 0.25},{"description": "","emergent": false,"id": "opaque_reasoning","probability": 0.15},{"description": "","emergent": false,"id": "research_breakthrough","probability": 0.05},{"description": "","emergent": false,"id": "medical_breakthrough","probability": 0.18},{"description": "","emergent": false,"id": "openweight_frontier_release","probability": 0.1},{"description": "","emergent": false,"id": "safety_breakthrough","probability": 0.1},{"description": "","emergent": false,"id": "labour_displacement","probability": 0.1},{"description": "","emergent": false,"id": "knowledge_work_augmented","probability": 0.05},{"description": "","emergent": false,"id": "embodied_ai_deployment","probability": 0.16},{"description": "","emergent": false,"id": "taiwan_tension_rise","probability": 0.1},{"description": "","emergent": false,"id": "export_control_escalation","probability": 0.15},{"description": "","emergent": false,"id": "us_china_agreement","probability": 0.06},{"description": "","emergent": false,"id": "eu_frontier_access_denied","probability": 0.1},{"description": "","emergent": false,"id": "supply_chain_coercion","probability": 0.04},{"description": "","emergent": false,"id": "member_state_defection","probability": 0.13},{"description": "","emergent": false,"id": "adoption_success","probability": 0.1},{"description": "","emergent": false,"id": "automated_decision_scandal","probability": 0.06},{"description": "","emergent": false,"id": "middle_power_coalition","probability": 0.1},{"description": "A non-US foundry consortium announces a qualified second-source accelerator batch available for allied pooled buyers, easing but not ending the Taiwan-driven shortage.","emergent": true,"id": "emergent_allied_accelerator_batch","probability": 0.18},{"description": "A non-US accelerator line in Japan or South Korea clears volume yield earlier than expected, easing prices for pooled EU orders without resolving leading-edge dependence on Taiwan.","emergent": true,"id": "emergent_second_source_yield_relief","probability": 0.14}]
```
