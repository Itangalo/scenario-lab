...
- characters 106-13585: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13628-13820: `{{metrics_json}}` from the run's live metric values
- characters 13913-15803: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15847-17718: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17774-18892: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M7 | EU Shield Recovery and Continuity Surge | 2 |
