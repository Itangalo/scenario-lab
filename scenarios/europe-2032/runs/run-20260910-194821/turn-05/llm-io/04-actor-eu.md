...
- characters 2389-4260: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6516-6971: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9280-11496: `{{previous_actions}}` from the actor's own response from the previous turn
