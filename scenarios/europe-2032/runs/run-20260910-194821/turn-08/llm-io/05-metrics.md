...
- characters 13401-13593: `{{metrics_json}}` from the run's live metric values
- characters 13686-15092: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15135-17104: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17160-17536: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Agent Containment and Bio-Uplift Shield | 2 |
