...
- characters 376-1782: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1825-3794: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3850-4226: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4289-32771: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33126-33947: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU Essential Continuity and Bio-Detection Patch −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 20, sentiment 17 -> none (capital not below sentiment)
SOVEREIGNTY: 15 last turn, InvestAI Gigafactories finishes t7 +4, no cat4 in flight +0, export_control_escalation t7 −2, capability rose 5.0 −1 = 16
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_frontier_access_denied, supply_chain_coercion, member_state_defection
- Turn 2 (6 turn(s) ago): taiwan_blockade, eval_anomaly_reports, safety_breakthrough, export_control_escalation, middle_power_coalition
- Turn 3 (5 turn(s) ago): eval_anomaly_reports
- Turn 4 (4 turn(s) ago): cyber_defence_breakthrough, research_breakthrough, taiwan_tension_rise
- Turn 5 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, export_control_escalation, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, capability_jump, medical_breakthrough, openweight_frontier_release, ai_investment_collapse, taiwan_tension_rise, export_control_escalation
- Turn 7 (1 turn(s) ago): capability_jump, export_control_escalation
