...
- characters 16369-16718: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_datacentre_permit_revolt` -- first noted turn 1, listed in 1 turn(s) so far: Municipal opposition to new hyperscale data-centre siting coalesces across several member states into coordinated permit blocks and grid-connection challenges, delaying at least one major build without any EU-level decision.
