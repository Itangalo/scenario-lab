...
- characters 107-13410: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13453-13642: `{{metrics_json}}` from the run's live metric values
- characters 13735-16026: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16070-17830: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17886-18389: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Denied-Access Continuity Switch | 2 |
| M12 | EU Accession to US-China AI Risk Floor | 2 |
