...
- characters 375-2666: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2710-4470: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4526-5354: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5417-32838: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33193-34390: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Joint Cyber-Bio Lifeline Accession −2, EU Denied-Access Continuity Switch −2, priority −1 = −5
PROPOSAL BONUS: EU Denied-Access Continuity Switch (cat 6, small) +4 — cyber_major_incident and eu_frontier_access_denied both landed this turn and this answers them directly
LEGITIMACY LENDS: capital 14, sentiment 8 -> none (capital not below sentiment)
SOVEREIGNTY: 11 last turn, no capacity event, no cat4 in flight +0, eu_frontier_access_denied t10 −3, capability rose 3.0 −1 = 7

## Emerging developments (tracked)

- `emergent_anti_ai_infrastructure_sabotage` -- first noted turn 9, listed in 2 turn(s) so far: Coordinated sabotage actions against data-centre power feeds and fibre links in several member states, claimed by anti-automation groups and causing localized outages without state direction.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_frontier_access_denied, supply_chain_coercion, member_state_defection
- Turn 2 (9 turn(s) ago): taiwan_blockade, eval_anomaly_reports, safety_breakthrough, export_control_escalation, middle_power_coalition
- Turn 3 (8 turn(s) ago): eval_anomaly_reports
- Turn 4 (7 turn(s) ago): cyber_defence_breakthrough, research_breakthrough, taiwan_tension_rise
- Turn 5 (6 turn(s) ago): cyber_major_incident, eval_anomaly_reports, export_control_escalation, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings, capability_jump, medical_breakthrough, openweight_frontier_release, ai_investment_collapse, taiwan_tension_rise, export_control_escalation
- Turn 7 (4 turn(s) ago): capability_jump, export_control_escalation
- Turn 8 (3 turn(s) ago): loss_of_control_incident, bio_uplift_findings, rsi_onset, labour_displacement
- Turn 9 (2 turn(s) ago): cyber_major_incident, capability_jump, bio_uplift_findings, catastrophic_loss_of_control_incident, export_control_escalation, us_labs_nationalised, joint_threat_response
- Turn 10 (1 turn(s) ago): cyber_major_incident, eu_frontier_access_denied
