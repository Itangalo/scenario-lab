...
- characters 454-2238: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2282-4420: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8069-8556: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11408-13315: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Agent Containment and Bio-Uplift Shield | 6 | small | 8 | 10 | own jurisdiction | resilience up moderately, ai_safety up slightly via containment and early bio detection | 2 | running |
