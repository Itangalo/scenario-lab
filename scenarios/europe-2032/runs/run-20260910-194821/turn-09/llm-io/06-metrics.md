...
- characters 106-13010: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13053-13244: `{{metrics_json}}` from the run's live metric values
- characters 13337-15121: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15165-17303: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17359-18121: `{{notepad}}` from the Game Master's notepad, carried across turns
