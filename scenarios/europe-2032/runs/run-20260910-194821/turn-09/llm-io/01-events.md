...
- characters 376-2160: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2204-4342: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4398-4835: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4898-33851: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34206-35131: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Agent Containment and Bio-Uplift Shield −2, priority −1 = −3
PROPOSAL BONUS: EU Agent Containment and Bio-Uplift Shield (cat 6, small) +3 — loss-of-control incident and bio uplift findings landed this turn and this answers both directly
LEGITIMACY LENDS: capital 18, sentiment 12 -> none (capital not below sentiment)
SOVEREIGNTY: 16 last turn, no capacity event, no cat4 in flight +0, capability rose 7.0 −1 = 15
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, openweight_frontier_release, eu_frontier_access_denied, supply_chain_coercion, member_state_defection
- Turn 2 (7 turn(s) ago): taiwan_blockade, eval_anomaly_reports, safety_breakthrough, export_control_escalation, middle_power_coalition
- Turn 3 (6 turn(s) ago): eval_anomaly_reports
- Turn 4 (5 turn(s) ago): cyber_defence_breakthrough, research_breakthrough, taiwan_tension_rise
- Turn 5 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, export_control_escalation, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, capability_jump, medical_breakthrough, openweight_frontier_release, ai_investment_collapse, taiwan_tension_rise, export_control_escalation
- Turn 7 (2 turn(s) ago): capability_jump, export_control_escalation
- Turn 8 (1 turn(s) ago): loss_of_control_incident, bio_uplift_findings, rsi_onset, labour_displacement
