...
- `two_year_commitment` (commitment): Hold essential services running and keep European leverage through the open-weight offensive surge

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Hold essential services running and keep European leverage through the open-weight offensive surge
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The development directly ends the timeframe the original commitment was bound to, changing the actor's obligation and cost of maintaining the prior statement.
