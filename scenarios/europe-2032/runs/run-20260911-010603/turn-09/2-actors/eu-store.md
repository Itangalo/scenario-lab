...
| M9 | EU Continuity and Automated Defence Switch | 6 | small | 7 | 9 | own jurisdiction | resilience up, eu_ai_sovereignty loss contained, ai_safety loss contained | 2 | finished |
| M10 | EU Chokepoint Retention and Servicing Shield | 8 | small | 8 | 10 | own jurisdiction plus coalition partners holding supply-chain chokepoints | eu_ai_sovereignty loss contained, resilience up slightly via secured supply | 2 | running |
| M11 | EU Verifiable-Domain Surge Containment | 6 | small | 9 | 11 | own jurisdiction | resilience up to prevent cascade from verifiable-domain jump, ai_safety loss contained | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Verifiable-Domain Surge Containment", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up to prevent cascade from verifiable-domain jump, ai_safety loss contained"}, "grounds": "to answer discontinuous uplift in code/cyber with open weights loose"}
  - Grounds: to answer discontinuous uplift in code/cyber with open weights loose
