...
- `two_year_commitment` (commitment): Secure the capacity to act independently before the window for agency closes.

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure the capacity to act independently before the window for agency closes.
