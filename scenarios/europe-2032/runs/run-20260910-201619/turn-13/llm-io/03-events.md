...
- characters 377-1980: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2024-3940: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3996-4530: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4593-30341: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30696-31777: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M10 EU Middle-Power Servicing and Evaluation Pact −2, M11 EU Automated Decision Redress and Logging Audit −2, priority −1 not charged (capital below 20, priority has no effect) = −4
PROPOSAL BONUS: none — M11 already in flight, no new measure started this turn
LEGITIMACY LENDS: capital 4, sentiment 22 -> +2 capped by other negatives, included in net (capital remains below sentiment)
SOVEREIGNTY: 32 last turn, no cat4 finish, no cat4 in flight +0, middle_power_coalition t12 +2, capability rose 0.7 no −1 = 34
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, bio_uplift_findings, eu_access_secured, emergent_shutdown_whistleblower
- Turn 2 (11 turn(s) ago): cyber_defence_breakthrough, export_control_escalation
- Turn 3 (10 turn(s) ago): openweight_frontier_release, emergent_publication_pause_push
- Turn 4 (9 turn(s) ago): openweight_frontier_release, taiwan_tension_rise
- Turn 5 (8 turn(s) ago): adoption_success, election_consolidation
- Turn 6 (7 turn(s) ago): taiwan_blockade, knowledge_work_augmented, export_control_escalation, member_state_defection
- Turn 8 (5 turn(s) ago): cyber_major_incident, openweight_frontier_release, export_control_escalation, member_state_defection, middle_power_coalition
- Turn 9 (4 turn(s) ago): cyber_major_incident
- Turn 10 (3 turn(s) ago): eval_anomaly_reports, supply_chain_coercion, joint_threat_response
- Turn 11 (2 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, research_breakthrough, adoption_success, middle_power_coalition
- Turn 12 (1 turn(s) ago): automated_decision_scandal, middle_power_coalition, emergent_solo_deal_signed
