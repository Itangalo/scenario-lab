...
- characters 105-13283: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13326-13518: `{{metrics_json}}` from the run's live metric values
- characters 13611-14924: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14967-17316: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17372-18444: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | EU Cyber Emergency Hardening and Mutual Aid Activation | 2 |
