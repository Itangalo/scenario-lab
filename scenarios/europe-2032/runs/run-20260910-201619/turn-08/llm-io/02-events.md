...
- characters 376-1689: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1732-4081: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4137-5209: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5272-29564: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29919-30461: `{{event_history}}` from the run's own event record
...
- `emergent_chip_grey_market_surge` -- first noted turn 7, listed in 1 turn(s) so far: Grey-market brokers in Southeast Asia offer blocked Taiwanese accelerators at 4-6x list via relabelled industrial PCs, drawing EU intermediaries and customs seizures into a public smuggling scandal.
- `emergent_asian_stopgap_offer` -- first noted turn 7, listed in 1 turn(s) so far: Seoul and Tokyo announce a joint emergency allocation of mature-node accelerators and spare parts for critical infrastructure, offered to the EU outside US licensing queues as a stopgap during the Taiwan quarantine.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, bio_uplift_findings, eu_access_secured, emergent_shutdown_whistleblower
- Turn 2 (6 turn(s) ago): cyber_defence_breakthrough, export_control_escalation
- Turn 3 (5 turn(s) ago): openweight_frontier_release, emergent_publication_pause_push
- Turn 4 (4 turn(s) ago): openweight_frontier_release, taiwan_tension_rise
- Turn 5 (3 turn(s) ago): adoption_success, election_consolidation
- Turn 6 (2 turn(s) ago): taiwan_blockade, knowledge_work_augmented, export_control_escalation, member_state_defection
