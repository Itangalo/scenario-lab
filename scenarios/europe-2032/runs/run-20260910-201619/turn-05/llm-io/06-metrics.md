...
- characters 13788-15780: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15824-18031: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18087-18870: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 59.5, "openweight_capability": 54.7, "ai_safety": 25.0, "resilience": 43.5, "eu_ai_sovereignty": 24.0, "eu_political_capital": 13.0, "public_sentiment": 41.0}
```
