...
- characters 455-2447: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2491-4698: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5892-6364: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8499-9554: `{{previous_actions}}` from the actor's own response from the previous turn
