...
- characters 377-2369: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2413-4620: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4676-5751: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5814-29595: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29950-30306: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Open Model Triage and Publication Norms −2, priority −1 = −12
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 14.0, sentiment 38.0 -> +2, capped below sentiment
SOVEREIGNTY: 22.0 last turn, no finishing cat4, no capacity event, Gigafactories in flight +1, capability rose 1.5 no −1 = 23.0

## Emerging developments (tracked)

- `emergent_publication_review_lawsuit` -- first noted turn 4, listed in 1 turn(s) so far: A coordinated legal challenge by European academic societies and a civil-liberties NGO seeks an injunction against the voluntary pre-publication review, arguing it is a de facto prior restraint without legislative basis.
- `emergent_us_agentic_publish_defection` -- first noted turn 4, listed in 1 turn(s) so far: A leading US laboratory openly publishes a full agentic-training recipe despite the European publication pause, triggering mass replication and a wave of copycat open-weight fine-tunes within weeks.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, bio_uplift_findings, eu_access_secured, emergent_shutdown_whistleblower
- Turn 2 (3 turn(s) ago): cyber_defence_breakthrough, export_control_escalation
- Turn 3 (2 turn(s) ago): openweight_frontier_release, emergent_publication_pause_push
- Turn 4 (1 turn(s) ago): openweight_frontier_release, taiwan_tension_rise
