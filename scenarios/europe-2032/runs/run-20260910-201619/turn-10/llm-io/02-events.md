...
- characters 377-1895: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1938-3624: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3680-4049: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4112-29007: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29362-30102: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, bio_uplift_findings, eu_access_secured, emergent_shutdown_whistleblower
- Turn 2 (8 turn(s) ago): cyber_defence_breakthrough, export_control_escalation
- Turn 3 (7 turn(s) ago): openweight_frontier_release, emergent_publication_pause_push
- Turn 4 (6 turn(s) ago): openweight_frontier_release, taiwan_tension_rise
- Turn 5 (5 turn(s) ago): adoption_success, election_consolidation
- Turn 6 (4 turn(s) ago): taiwan_blockade, knowledge_work_augmented, export_control_escalation, member_state_defection
- Turn 8 (2 turn(s) ago): cyber_major_incident, openweight_frontier_release, export_control_escalation, member_state_defection, middle_power_coalition
