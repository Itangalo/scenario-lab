...
- characters 455-1973: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2016-3702: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5251-5705: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8277-10233: `{{previous_actions}}` from the actor's own response from the previous turn
