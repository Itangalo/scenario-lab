...
- characters 13565-15083: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15126-16812: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16868-17563: `{{notepad}}` from the Game Master's notepad, carried across turns
