...
- characters 13610-15743: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15787-18030: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18086-18704: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 63.2, "openweight_capability": 61.2, "ai_safety": 17.0, "resilience": 37.0, "eu_ai_sovereignty": 34.0, "eu_political_capital": 16.0, "public_sentiment": 34.0}
```
