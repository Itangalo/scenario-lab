...
- characters 376-2185: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2228-4379: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4435-5031: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5094-28376: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28731-29012: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, bio_uplift_findings, eu_access_secured, emergent_shutdown_whistleblower
- Turn 2 (2 turn(s) ago): cyber_defence_breakthrough, export_control_escalation
- Turn 3 (1 turn(s) ago): openweight_frontier_release, emergent_publication_pause_push
