...
- characters 13643-15452: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15495-17646: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17702-18939: `{{notepad}}` from the Game Master's notepad, carried across turns
