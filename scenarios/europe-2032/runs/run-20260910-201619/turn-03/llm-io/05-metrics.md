...
- characters 106-12978: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13021-13213: `{{metrics_json}}` from the run's live metric values
- characters 13306-14855: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14899-17075: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17131-17661: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Automated Defence Rollout | 2 |
| M5 | EU Open Model Triage and Publication Norms | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Automated Defence Rollout −2, priority −1 = −12
PROPOSAL BONUS: EU Automated Defence Rollout (cat 6, small) +3 — autumn swarm intrusions compromised EU operators last turn and breakthrough closes that gap directly
LEGITIMACY LENDS: capital 40, sentiment 40 -> none, sentiment not above capital
SOVEREIGNTY: 24 last turn, no finishing cat4, in flight +0, export_control_escalation t2 −2, capability rose 1.5 no −1 = 22.0
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Automated Defence Rollout −2, EU Open Model Triage and Publication Norms −2, priority −1 = −14
PROPOSAL BONUS: EU Open Model Triage and Publication Norms (cat 5, small) +3 — openweight_frontier_release lands this turn unrecallable and this answers it directly with triage plus publication norms
LEGITIMACY LENDS: capital 29.0, sentiment 38.0 -> +1, capped below sentiment
SOVEREIGNTY: 22.0 last turn, no finishing cat4, no capacity event, in flight +0, capability rose 1.5 no −1 = 22.0
