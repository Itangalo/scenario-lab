...
- characters 456-2278: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2322-4136: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7371-7878: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10823-13950: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Joint Threat Telemetry Membership | 6 | small | 10 | 12 | own jurisdiction via invited joint command and pact partners | resilience up substantially, ai_safety up slightly via shared attribution | 2 | running |
