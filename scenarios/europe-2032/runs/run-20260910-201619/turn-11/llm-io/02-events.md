...
- characters 378-2200: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2244-4058: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4114-4844: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4907-29802: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30157-30992: `{{event_history}}` from the run's own event record
...
- `emergent_solo_deal_signed` -- first noted turn 10, listed in 1 turn(s) so far: The wavering capital holding the unsigned solo hyperscaler memorandum finally signs it as EU gigafactory funds expire, presenting it domestically as recovery pragmatism and fracturing the single bloc offer.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, bio_uplift_findings, eu_access_secured, emergent_shutdown_whistleblower
- Turn 2 (9 turn(s) ago): cyber_defence_breakthrough, export_control_escalation
- Turn 3 (8 turn(s) ago): openweight_frontier_release, emergent_publication_pause_push
- Turn 4 (7 turn(s) ago): openweight_frontier_release, taiwan_tension_rise
- Turn 5 (6 turn(s) ago): adoption_success, election_consolidation
- Turn 6 (5 turn(s) ago): taiwan_blockade, knowledge_work_augmented, export_control_escalation, member_state_defection
- Turn 8 (3 turn(s) ago): cyber_major_incident, openweight_frontier_release, export_control_escalation, member_state_defection, middle_power_coalition
- Turn 9 (2 turn(s) ago): cyber_major_incident
- Turn 10 (1 turn(s) ago): eval_anomaly_reports, supply_chain_coercion, joint_threat_response
