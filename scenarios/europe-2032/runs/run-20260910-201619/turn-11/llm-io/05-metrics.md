...
- characters 107-12883: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12926-13118: `{{metrics_json}}` from the run's live metric values
- characters 13211-15033: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15077-16891: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16947-17677: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Joint Threat Telemetry Membership | 2 |
