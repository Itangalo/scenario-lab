...
- characters 376-2788: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2831-4782: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4838-5612: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5675-27575: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27930-28353: `{{event_history}}` from the run's own event record
...
- `emergent_publication_review_lawsuit` -- first noted turn 4, listed in 2 turn(s) so far: A coordinated legal challenge by European academic societies and a civil-liberties NGO seeks an injunction against the voluntary pre-publication review, arguing it is a de facto prior restraint without legislative basis.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, bio_uplift_findings, eu_access_secured, emergent_shutdown_whistleblower
- Turn 2 (4 turn(s) ago): cyber_defence_breakthrough, export_control_escalation
- Turn 3 (3 turn(s) ago): openweight_frontier_release, emergent_publication_pause_push
- Turn 4 (2 turn(s) ago): openweight_frontier_release, taiwan_tension_rise
- Turn 5 (1 turn(s) ago): adoption_success, election_consolidation
