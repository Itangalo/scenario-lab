...
- characters 454-2866: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2909-4860: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6448-6904: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9209-11530: `{{previous_actions}}` from the actor's own response from the previous turn
