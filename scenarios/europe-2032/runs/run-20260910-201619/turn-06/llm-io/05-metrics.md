...
- characters 105-13327: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13370-13562: `{{metrics_json}}` from the run's live metric values
- characters 13655-16067: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16110-18061: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18117-18542: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | European Public Benefit AI Scale-up | 2 |
| M7 | EU Supply-Chain Bargain and Rationing Pact | 2 |
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, European Public Benefit AI Scale-up −2, priority −1 = −9
PROPOSAL BONUS: none — new Scale-up answers adoption_success (positive) not a negative shock from last three turns
LEGITIMACY LENDS: capital 11, sentiment 41 -> +2
SOVEREIGNTY: 23.0 last turn, no finishing cat4, no capacity event, Gigafactories in flight +1, capability rose 1.5 no −1 = 24.0
...
## Notepad
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, European Public Benefit AI Scale-up −2, EU Supply-Chain Bargain and Rationing Pact −2, priority −1 = −8
PROPOSAL BONUS: EU Supply-Chain Bargain (cat 8, small) +5 — taiwan_blockade + export controls + defection risk last/this turn and this answers directly
LEGITIMACY LENDS: capital 12, sentiment 38 -> +2
SOVEREIGNTY: 24.0 last turn, Tech sovereignty package finishes t6 +4, Gigafactories in flight +1, export_control_escalation t6 −2, capability rose 1.5 no −1 = 27.0
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}, "grounds": "turn 5 elected tiered-access president, takes office turn 6"}]}
```
```
