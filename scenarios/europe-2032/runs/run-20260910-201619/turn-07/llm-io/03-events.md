...
- characters 1574-3730: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3786-4302: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4365-28657: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29012-29554: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, bio_uplift_findings, eu_access_secured, emergent_shutdown_whistleblower
- Turn 2 (5 turn(s) ago): cyber_defence_breakthrough, export_control_escalation
- Turn 3 (4 turn(s) ago): openweight_frontier_release, emergent_publication_pause_push
- Turn 4 (3 turn(s) ago): openweight_frontier_release, taiwan_tension_rise
- Turn 5 (2 turn(s) ago): adoption_success, election_consolidation
- Turn 6 (1 turn(s) ago): taiwan_blockade, knowledge_work_augmented, export_control_escalation, member_state_defection
