...
- characters 106-13239: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13282-13474: `{{metrics_json}}` from the run's live metric values
- characters 13567-14720: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14764-16920: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16976-18115: `{{notepad}}` from the Game Master's notepad, carried across turns
