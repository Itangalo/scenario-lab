...
- characters 1716-3667: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5883-6346: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8551-10428: `{{previous_actions}}` from the actor's own response from the previous turn
