...
- characters 13727-14944: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14988-16939: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16995-18101: `{{notepad}}` from the Game Master's notepad, carried across turns
