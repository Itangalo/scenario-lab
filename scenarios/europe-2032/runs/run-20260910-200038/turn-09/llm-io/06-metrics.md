...
- characters 13487-13678: `{{metrics_json}}` from the run's live metric values
- characters 13771-14798: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14842-17216: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17272-17733: `{{notepad}}` from the Game Master's notepad, carried across turns
