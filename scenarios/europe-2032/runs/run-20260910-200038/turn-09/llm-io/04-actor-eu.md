...
- characters 454-1481: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1525-3899: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4271-4779: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7382-9924: `{{previous_actions}}` from the actor's own response from the previous turn
