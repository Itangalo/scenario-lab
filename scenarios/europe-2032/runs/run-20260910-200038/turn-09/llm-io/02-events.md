...
- characters 376-1403: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1447-3821: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3877-4690: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4753-33726: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34081-34789: `{{event_history}}` from the run's own event record
...
- Turn 2 (7 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release
- Turn 3 (6 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, emergent_safety_leak_press
- Turn 5 (4 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, eval_anomaly_reports, election_consolidation
- Turn 6 (3 turn(s) ago): rsi_onset, research_breakthrough, medical_breakthrough, emergent_municipal_moratoria_wave
- Turn 7 (2 turn(s) ago): cyber_defence_breakthrough
- Turn 8 (1 turn(s) ago): ai_investment_collapse, bio_uplift_findings, opaque_reasoning, medical_breakthrough, eu_frontier_access_denied, emergent_training_power_rationing
