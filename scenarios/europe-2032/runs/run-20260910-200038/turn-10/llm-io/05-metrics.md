...
- characters 106-13014: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13057-13248: `{{metrics_json}}` from the run's live metric values
- characters 13341-14313: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14356-16090: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16146-16883: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Site Shield and Repair Corps | 2 |
...
PORTFOLIO CHARGE t9: EU Site Shield and Repair Corps −2, priority −1 = −3
PROPOSAL BONUS: EU Site Shield and Repair Corps (cat 6, small) +3 — emergent sabotage halting transmission and cooling works this turn and this answers it directly
LEGITIMACY LENDS: capital 19, sentiment 25 -> +2
SOVEREIGNTY: 24 last turn, no category 4 finish, no category 4 in flight, emergent_grid_siting_sabotage t9 −2, capability rose 3.0 −1 = 21

## Emerging developments (tracked)

- `emergent_compute_logistics_siege` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated sabotage spreads from grid connections to water and logistics for compute sites, with simultaneous blockades of equipment convoys forcing extended guarded-escort operations.
...
**emergent_operating_grid_sabotage (emergent event):** Coordinated night-time sabotage spreads from construction sites to operating grid interconnectors and hospital backup power, forcing rolling guarded outages in two member states.
