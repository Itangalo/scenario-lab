...
- characters 105-13580: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13623-13815: `{{metrics_json}}` from the run's live metric values
- characters 13908-16960: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 17003-19348: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 19404-20562: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Frontier Evaluation Disclosure Act | 2 |
| M6 | Municipal Resilience Backstop | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Cyber Shield −3, EU Agent Containment and Recall Protocol −2, EU Frontier Evaluation Disclosure Act −2, priority −1 = −14
PROPOSAL BONUS: EU Frontier Evaluation Disclosure Act (cat 2, small) +3 — leaked withheld cyber-offensive evals landed this turn and this answers it directly
...
## Metrics
```json
{"ai_capability": 64.0, "openweight_capability": 57.5, "ai_safety": 26.0, "resilience": 42.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 23.0, "public_sentiment": 28.0}
```
