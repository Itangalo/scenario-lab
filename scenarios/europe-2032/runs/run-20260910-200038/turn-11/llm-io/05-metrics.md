...
- characters 107-13453: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13496-13687: `{{metrics_json}}` from the run's live metric values
- characters 13780-15356: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15400-17497: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17553-18416: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Hospital Power Guard and Auto-Patch Deployment | 2 |
| M13 | EU Automated Attack Containment and Essential Service Restoration | 2 |
...
PORTFOLIO CHARGE t10: EU Site Shield and Repair Corps −2, EU Hospital Power Guard and Auto-Patch Deployment −2, priority −1 = −5
PROPOSAL BONUS: EU Hospital Power Guard and Auto-Patch Deployment (cat 6, small) +3 — coordinated sabotage of operating interconnectors and hospital backup this turn and this answers it directly, aided by defensive tooling arrival
LEGITIMACY LENDS: capital 14, sentiment 29 -> +2
SOVEREIGNTY: 21 last turn, no category 4 finish, no category 4 in flight, emergent_operating_grid_sabotage t10 −2, capability rose 2.0 −1 = 18

## Emerging developments (tracked)

- `emergent_compute_logistics_siege` -- first noted turn 10, listed in 2 turn(s) so far: Coordinated sabotage spreads from grid connections to water and logistics for compute sites, with simultaneous blockades of equipment convoys forcing extended guarded-escort operations.
...
## Metrics
```json
{"ai_capability": 87.5, "openweight_capability": 83.2, "ai_safety": 0.0, "resilience": 57.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 21.0, "public_sentiment": 24.0}
```
...
## Notepad
PORTFOLIO CHARGE t11: EU Hospital Power Guard and Auto-Patch Deployment −2, EU Automated Attack Containment and Essential Service Restoration −2, priority −1 = −5
PROPOSAL BONUS: EU Automated Attack Containment and Essential Service Restoration (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 19, sentiment 29 -> +2
SOVEREIGNTY: 18 last turn, no capacity event, no category 4 finish, no category 4 in flight, capability rose 1.5 −0 = 18
