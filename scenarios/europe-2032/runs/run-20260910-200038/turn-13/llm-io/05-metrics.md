...
- characters 107-13425: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13468-13659: `{{metrics_json}}` from the run's live metric values
- characters 13752-14869: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14913-16978: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17034-17540: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Degraded Operations Continuity Pact | 2 |
| M15 | EU Wartime Joint Cyber-Bio Defence Accession | 2 |
...
PORTFOLIO CHARGE t12: EU Automated Attack Containment and Essential Service Restoration −2, EU Degraded Operations Continuity Pact −2, priority −1 = −5
PROPOSAL BONUS: EU Degraded Operations Continuity Pact (cat 6, small) +2 — answers autumn open-weight sweep and continued degraded operations directly
LEGITIMACY LENDS: capital 18, sentiment 25 -> +2
SOVEREIGNTY: 18 last turn, no capacity event, no category 4 finish, no category 4 in flight, export_control_escalation t12 −2, capability rose 1.5 −0 = 16
...
## Notepad
PORTFOLIO CHARGE t13: EU Degraded Operations Continuity Pact −2, EU Wartime Joint Cyber-Bio Defence Accession −2, priority −1 = −5
PROPOSAL BONUS: EU Wartime Joint Cyber-Bio Defence Accession (cat 8, small) +4 — answers catastrophic war plus concurrent automated attack and bio-uplift signal directly, severe and immediate
LEGITIMACY LENDS: capital 19, sentiment 18 -> none, capital higher
SOVEREIGNTY: 16 last turn, no category 4 finish, no category 4 in flight, catastrophic_great_power_conflict t13 −3, capability rose 1.5 −0 = 13
