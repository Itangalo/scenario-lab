...
- characters 377-1494: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1538-3603: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3659-4165: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4228-33201: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33556-34606: `{{event_history}}` from the run's own event record
...
- Turn 2 (11 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release
- Turn 3 (10 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, emergent_safety_leak_press
- Turn 5 (8 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, eval_anomaly_reports, election_consolidation
- Turn 6 (7 turn(s) ago): rsi_onset, research_breakthrough, medical_breakthrough, emergent_municipal_moratoria_wave
- Turn 7 (6 turn(s) ago): cyber_defence_breakthrough
- Turn 8 (5 turn(s) ago): ai_investment_collapse, bio_uplift_findings, opaque_reasoning, medical_breakthrough, eu_frontier_access_denied, emergent_training_power_rationing
- Turn 9 (4 turn(s) ago): emergent_grid_siting_sabotage
- Turn 10 (3 turn(s) ago): cyber_defence_breakthrough, medical_breakthrough, emergent_operating_grid_sabotage
- Turn 11 (2 turn(s) ago): cyber_major_incident
- Turn 12 (1 turn(s) ago): eval_anomaly_reports, openweight_frontier_release, taiwan_tension_rise, export_control_escalation
