...
- characters 13501-13692: `{{metrics_json}}` from the run's live metric values
- characters 13785-14818: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14861-16796: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16852-17353: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 89.0, "openweight_capability": 84.0, "ai_safety": 0.0, "resilience": 61.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 20.0, "public_sentiment": 25.0}
```
