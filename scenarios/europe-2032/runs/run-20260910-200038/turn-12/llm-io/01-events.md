...
- characters 376-1409: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1452-3387: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3443-4256: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4319-33292: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33647-34571: `{{event_history}}` from the run's own event record
...
- Turn 2 (10 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release
- Turn 3 (9 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, emergent_safety_leak_press
- Turn 5 (7 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, eval_anomaly_reports, election_consolidation
- Turn 6 (6 turn(s) ago): rsi_onset, research_breakthrough, medical_breakthrough, emergent_municipal_moratoria_wave
- Turn 7 (5 turn(s) ago): cyber_defence_breakthrough
- Turn 8 (4 turn(s) ago): ai_investment_collapse, bio_uplift_findings, opaque_reasoning, medical_breakthrough, eu_frontier_access_denied, emergent_training_power_rationing
- Turn 9 (3 turn(s) ago): emergent_grid_siting_sabotage
- Turn 10 (2 turn(s) ago): cyber_defence_breakthrough, medical_breakthrough, emergent_operating_grid_sabotage
- Turn 11 (1 turn(s) ago): cyber_major_incident
