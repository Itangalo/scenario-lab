...
- characters 376-1438: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1481-3874: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3930-5107: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5170-32265: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32620-32987: `{{event_history}}` from the run's own event record
...
- `emergent_municipal_moratoria_wave` -- first noted turn 4, listed in 2 turn(s) so far: A coordinated wave of municipal moratoria on new data-centre water and power connections spreads across several member states, freezing permitted gigafactory-adjacent sites for months pending local referenda.
- `emergent_shield_noncompliance_revolt` -- first noted turn 4, listed in 2 turn(s) so far: Municipal utilities in two member states publicly refuse to implement mandated segmentation proofs, citing costs and staffing, triggering infringement threats and a court challenge over isolation powers.
...
- Turn 2 (4 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release
- Turn 3 (3 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, emergent_safety_leak_press
- Turn 5 (1 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, eval_anomaly_reports, election_consolidation
