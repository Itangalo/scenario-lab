...
- characters 454-1516: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1559-3952: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6347-6807: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9124-11415: `{{previous_actions}}` from the actor's own response from the previous turn
