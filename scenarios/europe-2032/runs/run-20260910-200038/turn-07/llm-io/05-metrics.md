...
- characters 13662-14558: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14602-16915: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16971-18051: `{{notepad}}` from the Game Master's notepad, carried across turns
