...
- characters 377-1273: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1317-3630: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3686-4149: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4212-33431: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33786-34269: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release
- Turn 3 (4 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, emergent_safety_leak_press
- Turn 5 (2 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, eval_anomaly_reports, election_consolidation
- Turn 6 (1 turn(s) ago): rsi_onset, research_breakthrough, medical_breakthrough, emergent_municipal_moratoria_wave
