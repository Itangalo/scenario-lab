...
- characters 106-13123: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13166-13358: `{{metrics_json}}` from the run's live metric values
- characters 13451-15429: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15473-17458: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17514-18028: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Agent Containment and Recall Protocol | 2 |
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 54.0, "ai_safety": 28.0, "resilience": 35.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 16.0, "public_sentiment": 29.0}
```
