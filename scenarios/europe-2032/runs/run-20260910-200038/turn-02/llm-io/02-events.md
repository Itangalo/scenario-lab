...
- characters 1584-3434: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3490-4574: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4637-27714: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28069-28110: `{{event_history}}` from the run's own event record
