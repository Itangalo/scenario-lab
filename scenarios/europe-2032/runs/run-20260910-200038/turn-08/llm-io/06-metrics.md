...
- characters 105-13359: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13402-13594: `{{metrics_json}}` from the run's live metric values
- characters 13687-14852: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14895-16959: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17015-17765: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Essential Continuity Reserve | 2 |
