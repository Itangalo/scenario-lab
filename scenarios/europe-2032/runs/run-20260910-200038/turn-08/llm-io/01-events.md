...
- characters 376-1541: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1584-3648: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3704-4719: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4782-34001: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34356-34892: `{{event_history}}` from the run's own event record
...
- `emergent_grid_siting_sabotage` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated sabotage and blockades against transmission-operator backup lines and closed-loop cooling retrofits for gigafactory-adjacent sites halt construction for months, turning the siting freeze into a physical confrontation.
- `emergent_training_power_rationing` -- first noted turn 7, listed in 1 turn(s) so far: US grid operators impose rolling power rationing on data-centre clusters after self-improving training runs trigger regional brownouts, freezing new training starts for weeks.
...
- Turn 2 (6 turn(s) ago): loss_of_control_incident, eval_anomaly_reports, openweight_frontier_release
- Turn 3 (5 turn(s) ago): openweight_frontier_release, taiwan_tension_rise, emergent_safety_leak_press
- Turn 5 (3 turn(s) ago): cyber_major_incident, cyber_defence_breakthrough, eval_anomaly_reports, election_consolidation
- Turn 6 (2 turn(s) ago): rsi_onset, research_breakthrough, medical_breakthrough, emergent_municipal_moratoria_wave
- Turn 7 (1 turn(s) ago): cyber_defence_breakthrough
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.06}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "catastrophic_great_power_conflict", "probability": 0.11}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "us_labs_nationalised", "probability": 0.22}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "Coordinated sabotage and blockades against transmission-operator backup lines and closed-loop cooling retrofits for gigafactory-adjacent sites halt construction for months, turning the siting freeze into a physical confrontation.", "emergent": true, "id": "emergent_grid_siting_sabotage", "probability": 0.2}, {"description": "US grid operators impose rolling power rationing on data-centre clusters after self-improving training runs trigger regional brownouts, freezing new training starts for weeks.", "emergent": true, "id": "emergent_training_power_rationing", "probability": 0.18}]
```
