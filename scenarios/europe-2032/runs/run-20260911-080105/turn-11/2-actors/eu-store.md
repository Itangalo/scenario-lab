...
| M11 | EU Shield Patch Deployment Pact | 6 | small | 11 | 13 | own jurisdiction | resilience up moderately, ai_safety protected, eu_political_capital protected | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Shield Patch Deployment Pact", "category": 6, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected, eu_political_capital protected"}, "grounds": "to exploit defensive breakthrough against ongoing sweep"}
  - Grounds: to exploit defensive breakthrough against ongoing sweep
