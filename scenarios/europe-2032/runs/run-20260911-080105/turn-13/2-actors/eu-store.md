...
| M11 | EU Shield Patch Deployment Pact | 6 | small | 11 | 13 | own jurisdiction | resilience up moderately, ai_safety protected, eu_political_capital protected | 2 | finished |
| M12 | EU Bio-Uplift Containment and Agent Loss-of-Control Emergency Protocol | 6 | small | 13 | 15 | own jurisdiction | resilience up moderately, ai_safety protected from zero | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio-Uplift Containment and Agent Loss-of-Control Emergency Protocol", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected from zero"}, "grounds": "bio gate open and loss-of-control demonstrated while open weights unrecallable"}
  - Grounds: bio gate open and loss-of-control demonstrated while open weights unrecallable
