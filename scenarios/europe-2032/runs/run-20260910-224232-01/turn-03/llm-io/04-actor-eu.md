...
- characters 455-1751: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1795-3806: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4173-4645: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6278-8118: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M4 | Municipal Utility and Hospital Cyber Backstop | 6 | small | 2 | 4 | own jurisdiction | resilience up, prevent fall from maintenance cuts | 2 | running |
