...
- characters 106-13219: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13262-13454: `{{metrics_json}}` from the run's live metric values
- characters 13547-14843: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14887-16898: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16954-18071: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | Municipal Utility and Hospital Cyber Backstop | 2 |
| M5 | EU Public Services AI Scale-Up | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, Municipal Utility and Hospital Cyber Backstop −2, priority −1 = −12
PROPOSAL BONUS: Municipal Utility and Hospital Cyber Backstop (cat 6, small) +2 — autumn grid/port intrusions in t1 directly motivate it, plus this-turn copycat reuse and insurer repricing hitting same municipals/hospitals
...
- `emergent_insurer_market_exit` -- first noted turn 3, listed in 1 turn(s) so far: A major EU cyber-insurer announces full withdrawal from municipal utility and hospital cover after copycat intrusion losses, forcing emergency state underwriting and service cutbacks.
- `emergent_datacentre_siting_freeze` -- first noted turn 3, listed in 1 turn(s) so far: Coordinated municipal opposition and grid-operator objections freeze permitting for new AI data centre sites in several member states, delaying power connections by months.
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, Municipal Utility and Hospital Cyber Backstop −2, EU Public Services AI Scale-Up −2, priority −1 = −14
PROPOSAL BONUS: none — new EU Public Services AI Scale-Up (cat 9, small) answers adoption_success positive window, not a negative event from last three rounds
LEGITIMACY LENDS: capital 16, sentiment 37 -> +2
