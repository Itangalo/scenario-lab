...
- characters 1779-3542: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6486-6958: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9112-10933: `{{previous_actions}}` from the actor's own response from the previous turn
