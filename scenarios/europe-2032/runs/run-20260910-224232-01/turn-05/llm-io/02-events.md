...
- characters 1701-3464: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3520-3855: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3918-31466: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31821-32121: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): emergent_utility_insurance_crunch, emergent_swarm_toolkit_proliferation
- Turn 3 (2 turn(s) ago): adoption_success
- Turn 4 (1 turn(s) ago): automated_decision_scandal, emergent_insurer_market_exit, emergent_datacentre_siting_freeze
