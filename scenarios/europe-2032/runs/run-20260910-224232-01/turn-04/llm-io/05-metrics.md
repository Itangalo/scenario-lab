...
- characters 105-13664: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13707-13899: `{{metrics_json}}` from the run's live metric values
- characters 13992-15278: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15321-17157: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17213-17734: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 64.0, "openweight_capability": 57.6, "ai_safety": 26.0, "resilience": 44.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 9.0, "public_sentiment": 32.0}
```
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Public Services AI Scale-Up −2, priority −1 = −9
