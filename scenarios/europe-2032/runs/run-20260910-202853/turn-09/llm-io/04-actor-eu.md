...
- characters 2150-4563: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5632-6110: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9158-11273: `{{previous_actions}}` from the actor's own response from the previous turn
