...
- characters 106-13713: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13756-13947: `{{metrics_json}}` from the run's live metric values
- characters 14040-15692: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15736-18149: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18205-18687: `{{notepad}}` from the Game Master's notepad, carried across turns
