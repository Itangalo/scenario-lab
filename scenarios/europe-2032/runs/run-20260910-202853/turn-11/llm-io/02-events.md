...
- characters 377-1815: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1859-4003: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4059-5037: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5100-31849: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32204-33215: `{{event_history}}` from the run's own event record
...
- `emergent_port_wildcat_spread` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated wildcat shutdowns spread from Rotterdam and Lyon to two additional EU container ports after another teleoperated-machine injury, forcing a national-level port continuity emergency.
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, loss_of_control_incident
- Turn 2 (9 turn(s) ago): capability_jump, cyber_defence_breakthrough
- Turn 3 (8 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports
- Turn 4 (7 turn(s) ago): medical_breakthrough, embodied_ai_deployment
- Turn 5 (6 turn(s) ago): capability_jump, cyber_major_incident, joint_threat_response, opaque_reasoning, research_breakthrough, us_china_agreement, election_consolidation
- Turn 6 (5 turn(s) ago): taiwan_blockade, embodied_ai_deployment
- Turn 7 (4 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, openweight_frontier_release, taiwan_tension_rise
- Turn 8 (3 turn(s) ago): bio_uplift_findings, rsi_onset, medical_breakthrough, joint_threat_response
- Turn 9 (2 turn(s) ago): labour_displacement, joint_threat_response, emergent_port_robot_blockade
- Turn 10 (1 turn(s) ago): loss_of_control_incident, research_breakthrough, embodied_ai_deployment, export_control_escalation, member_state_defection
