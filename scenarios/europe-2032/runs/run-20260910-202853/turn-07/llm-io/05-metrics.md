...
- characters 106-13595: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13638-13828: `{{metrics_json}}` from the run's live metric values
- characters 13921-15425: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15469-17729: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17785-19064: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M9 | EU Rapid Defence and Open-Model Absorption Shield | 2 |
...
## Metrics
```json
{"ai_capability": 80.0, "openweight_capability": 73.0, "ai_safety": 0.0, "resilience": 47.5, "eu_ai_sovereignty": 19.0, "eu_political_capital": 13.0, "public_sentiment": 21.0}
```
