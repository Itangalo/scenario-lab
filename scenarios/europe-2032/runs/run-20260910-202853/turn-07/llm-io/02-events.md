...
- characters 1923-4183: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4239-4890: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4953-31825: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32180-32712: `{{event_history}}` from the run's own event record
...
- Turn 3 (4 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports
- Turn 4 (3 turn(s) ago): medical_breakthrough, embodied_ai_deployment
- Turn 5 (2 turn(s) ago): capability_jump, cyber_major_incident, joint_threat_response, opaque_reasoning, research_breakthrough, us_china_agreement, election_consolidation
- Turn 6 (1 turn(s) ago): taiwan_blockade, embodied_ai_deployment
