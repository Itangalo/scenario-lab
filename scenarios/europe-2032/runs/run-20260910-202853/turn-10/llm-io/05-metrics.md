...
- characters 106-13054: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13097-13288: `{{metrics_json}}` from the run's live metric values
- characters 13381-14369: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14412-16526: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16582-17362: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Dock-to-Job Transition and Port Continuity Deal | 2 |
| M12 | EU Loss-of-Control Containment and Critical Systems Isolation Protocol | 2 |
...
PORTFOLIO CHARGE t9: M11 EU Dock-to-Job Transition and Port Continuity Deal −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: EU Dock-to-Job Transition and Port Continuity Deal (cat 7, small) +3 — labour_displacement and emergent port blockade landed this turn and this answers both directly
LEGITIMACY LENDS: capital 18, sentiment 23 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, no cat4 in flight +0, capability rose 1.5 −1 = 18
