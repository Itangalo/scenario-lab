...
- characters 1485-3599: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7015-7507: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10946-13217: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Dock-to-Job Transition and Port Continuity Deal | 7 | small | 9 | 11 | own jurisdiction | public_sentiment up materially, resilience up slightly via continuity, eu_political_capital up slightly if blockades lift | 2 | running |
