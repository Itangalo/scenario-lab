...
- characters 13399-14811: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14854-17236: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17292-18066: `{{notepad}}` from the Game Master's notepad, carried across turns
