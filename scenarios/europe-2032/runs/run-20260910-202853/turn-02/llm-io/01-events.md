...
- characters 1831-4213: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4269-5043: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5106-28183: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28538-28605: `{{event_history}}` from the run's own event record
