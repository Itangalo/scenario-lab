...
- characters 13798-15424: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15468-17458: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17514-18679: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "pending"}, "grounds": "turn 5 election settles winner, administration not yet in office"}]}
```
```
