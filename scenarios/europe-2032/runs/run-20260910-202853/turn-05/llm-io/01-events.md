...
- characters 377-2003: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2047-4037: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4093-5258: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5321-34297: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34652-34946: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Agentic Deployment Safety Gate −2, M6 EU Clinical AI Adoption Trust Programme −2, priority −1 = −11
PROPOSAL BONUS: none — new Clinical Trust Programme answers this turn's medical advance, a positive opening not a negative shock, and does not directly answer embodied displacement
LEGITIMACY LENDS: capital 15, sentiment 28 -> +2
SOVEREIGNTY: 19 last turn, no capacity finish, Gigafactories in flight +0, embodied_ai_deployment t4 −2, capability rose 3.0 −1 = 16

## Emerging developments (tracked)

- `emergent_care_vs_compute_backlash` -- first noted turn 4, listed in 1 turn(s) so far: Municipal hospital outages trigger coordinated strikes by health and local-government unions blocking new data-centre grid connections until clinics are restored.
- `emergent_vendor_liability_suits` -- first noted turn 4, listed in 1 turn(s) so far: Municipal hospital associations and patient groups file coordinated liability suits against the vendor of the compromised enterprise component, seeking EU-wide collective redress and forcing disclosure of the quiet summer patch timeline.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, loss_of_control_incident
- Turn 2 (3 turn(s) ago): capability_jump, cyber_defence_breakthrough
- Turn 3 (2 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports
- Turn 4 (1 turn(s) ago): medical_breakthrough, embodied_ai_deployment
...
```
[{"description": "", "emergent": false, "id": "election_consolidation", "probability": 0.42}, {"description": "", "emergent": false, "id": "election_alliance", "probability": 0.14}, {"description": "", "emergent": false, "id": "election_retrenchment", "probability": 0.24}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.3}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "rsi_onset", "probability": 0.35}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "Municipal hospital outages trigger coordinated strikes by health and local-government unions blocking new data-centre grid connections until clinics are restored.", "emergent": true, "id": "emergent_care_vs_compute_backlash", "probability": 0.22}, {"description": "Municipal hospital associations and patient groups file coordinated liability suits against the vendor of the compromised enterprise component, seeking EU-wide collective redress and forcing disclosure of the quiet summer patch timeline.", "emergent": true, "id": "emergent_vendor_liability_suits", "probability": 0.14}]
```
