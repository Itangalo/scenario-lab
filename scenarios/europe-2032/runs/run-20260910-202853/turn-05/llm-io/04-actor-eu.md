...
- characters 455-2081: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2125-4115: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8880-9353: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11634-13676: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Clinical AI Adoption Trust Programme | 9 | small | 4 | 6 | own jurisdiction | public_sentiment up materially, resilience up slightly | 2 | running |
