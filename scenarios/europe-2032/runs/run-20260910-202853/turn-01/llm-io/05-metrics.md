...
- characters 16380-16725: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_bio_screening_norm` -- first noted turn 1, listed in 1 turn(s) so far: Major EU scientific publishers and universities jointly mandate disclosure and containment standards for AI-designed biological constructs after the phage demonstrations, creating a de facto screening norm ahead of regulation.
