...
- characters 377-1354: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1398-3796: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3852-4361: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4424-28474: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28829-30123: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M13 EU Wartime Continuity and Allied Shield Accession −2, M14 EU Port Continuity and Teleoperation Safety Compact −2, priority −1 = −5
PROPOSAL BONUS: EU Port Continuity and Teleoperation Safety Compact (cat 7, small) +2 — emergent port wildcat spread landed this turn and this answers it directly
LEGITIMACY LENDS: capital 15, sentiment 12 -> none (capital higher)
SOVEREIGNTY: 12 last turn, no cat4 finish, no cat4 in flight +0, us_labs_nationalised t12 −2, capability rose 1.5 −0 = 10
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, loss_of_control_incident
- Turn 2 (11 turn(s) ago): capability_jump, cyber_defence_breakthrough
- Turn 3 (10 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports
- Turn 4 (9 turn(s) ago): medical_breakthrough, embodied_ai_deployment
- Turn 5 (8 turn(s) ago): capability_jump, cyber_major_incident, joint_threat_response, opaque_reasoning, research_breakthrough, us_china_agreement, election_consolidation
- Turn 6 (7 turn(s) ago): taiwan_blockade, embodied_ai_deployment
- Turn 7 (6 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, openweight_frontier_release, taiwan_tension_rise
- Turn 8 (5 turn(s) ago): bio_uplift_findings, rsi_onset, medical_breakthrough, joint_threat_response
- Turn 9 (4 turn(s) ago): labour_displacement, joint_threat_response, emergent_port_robot_blockade
- Turn 10 (3 turn(s) ago): loss_of_control_incident, research_breakthrough, embodied_ai_deployment, export_control_escalation, member_state_defection
- Turn 11 (2 turn(s) ago): bio_uplift_findings, medical_breakthrough, catastrophic_great_power_conflict, joint_threat_response
- Turn 12 (1 turn(s) ago): cyber_defence_breakthrough, medical_breakthrough, loss_of_control_incident, us_labs_nationalised, emergent_port_wildcat_spread
