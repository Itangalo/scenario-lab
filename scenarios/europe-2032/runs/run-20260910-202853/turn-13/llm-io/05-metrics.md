...
- characters 107-13610: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13653-13844: `{{metrics_json}}` from the run's live metric values
- characters 13937-14914: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14958-17356: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17412-18264: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M15 | EU Rogue System Blackout Containment and Certified Defence Rollout | 2 |
...
- `emergent_port_militarization_backlash` -- first noted turn 13, listed in 1 turn(s) so far: Naval-operated medicine and fuel corridors are formalized into a permanent military logistics command after box traffic fails to restart, triggering coordinated dock blockades in solidarity ports outside the EU.
...
## Notepad
PORTFOLIO CHARGE t13: EU Rogue System Blackout Containment and Certified Defence Rollout −2, priority −1 = −3
PROPOSAL BONUS: EU Rogue System Blackout Containment and Certified Defence Rollout (cat 6, small) +4 — catastrophic_loss_of_control_incident landed this turn and this answers it directly, plus safety_breakthrough deployable
LEGITIMACY LENDS: capital 15, sentiment 12 -> none (capital higher)
SOVEREIGNTY: 10 last turn, no cat4 finish, no capacity event, M15 in flight +0 (cat6, not cat4), capability rose 2.0 −1 = 9
