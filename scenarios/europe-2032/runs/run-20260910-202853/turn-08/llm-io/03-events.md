...
- characters 375-1546: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1589-3751: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3807-4989: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5052-32376: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32731-33390: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: M8 EU Lithography-for-Access and Embodied Deployment Pact −2, M9 EU Rapid Defence and Open-Model Absorption Shield −2, priority −1 = −5
PROPOSAL BONUS: EU Rapid Defence and Open-Model Absorption Shield (cat 6, small) +4 — openweight frontier release and continued cyber pressure landed this turn and this answers both directly, plus defence breakthrough makes it cheap
LEGITIMACY LENDS: capital 11, sentiment 21 -> +2
SOVEREIGNTY: 16 last turn, M1 InvestAI Gigafactories finishes t7 +4, no capacity event, capability rose 2.8 −1 = 19

## Emerging developments (tracked)

- `emergent_shadow_logistics_fork` -- first noted turn 7, listed in 1 turn(s) so far: Port operators and municipal utilities begin quietly replacing metered US logistics control models with offline open-weight planners after quota cuts, creating an unlogged shadow fleet the AI Office cannot inspect.
- `emergent_port_robot_blockade` -- first noted turn 7, listed in 1 turn(s) so far: Port operators and unions coordinate wildcat blockades of teleoperated Chinese humanoid fleets in Rotterdam and Lyon after a logistics robot injures dockworkers, halting automated port throughput for days.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, loss_of_control_incident
- Turn 2 (6 turn(s) ago): capability_jump, cyber_defence_breakthrough
- Turn 3 (5 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports
- Turn 4 (4 turn(s) ago): medical_breakthrough, embodied_ai_deployment
- Turn 5 (3 turn(s) ago): capability_jump, cyber_major_incident, joint_threat_response, opaque_reasoning, research_breakthrough, us_china_agreement, election_consolidation
- Turn 6 (2 turn(s) ago): taiwan_blockade, embodied_ai_deployment
- Turn 7 (1 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, openweight_frontier_release, taiwan_tension_rise
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.095}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.12}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.05}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "rsi_onset", "probability": 0.35}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_loss_of_control_incident", "probability": 0.02}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.05}, {"description": "", "emergent": false, "id": "catastrophic_great_power_conflict", "probability": 0.045}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.21}, {"description": "", "emergent": false, "id": "us_labs_nationalised", "probability": 0.14}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.16}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Port operators and municipal utilities begin quietly replacing metered US logistics control models with offline open-weight planners after quota cuts, creating an unlogged shadow fleet the AI Office cannot inspect.", "emergent": true, "id": "emergent_shadow_logistics_fork", "probability": 0.24}, {"description": "Port operators and unions coordinate wildcat blockades of teleoperated Chinese humanoid fleets in Rotterdam and Lyon after a logistics robot injures dockworkers, halting automated port throughput for days.", "emergent": true, "id": "emergent_port_robot_blockade", "probability": 0.18}]
```
