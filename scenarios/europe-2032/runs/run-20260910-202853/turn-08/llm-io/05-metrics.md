...
- characters 105-13446: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13489-13680: `{{metrics_json}}` from the run's live metric values
- characters 13773-14944: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14987-17149: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17205-18387: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Lithography-for-Access and Embodied Deployment Pact | 2 |
| M10 | EU Joint Threat Accession and Bio-Sentinel Shield | 2 |
