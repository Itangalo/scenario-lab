...
- characters 1995-4310: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4366-5409: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5472-31054: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31409-32548: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, loss_of_control_incident
- Turn 2 (10 turn(s) ago): capability_jump, cyber_defence_breakthrough
- Turn 3 (9 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports
- Turn 4 (8 turn(s) ago): medical_breakthrough, embodied_ai_deployment
- Turn 5 (7 turn(s) ago): capability_jump, cyber_major_incident, joint_threat_response, opaque_reasoning, research_breakthrough, us_china_agreement, election_consolidation
- Turn 6 (6 turn(s) ago): taiwan_blockade, embodied_ai_deployment
- Turn 7 (5 turn(s) ago): ai_investment_collapse, cyber_defence_breakthrough, openweight_frontier_release, taiwan_tension_rise
- Turn 8 (4 turn(s) ago): bio_uplift_findings, rsi_onset, medical_breakthrough, joint_threat_response
- Turn 9 (3 turn(s) ago): labour_displacement, joint_threat_response, emergent_port_robot_blockade
- Turn 10 (2 turn(s) ago): loss_of_control_incident, research_breakthrough, embodied_ai_deployment, export_control_escalation, member_state_defection
- Turn 11 (1 turn(s) ago): bio_uplift_findings, medical_breakthrough, catastrophic_great_power_conflict, joint_threat_response
