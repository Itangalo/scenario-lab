...
- characters 13563-13754: `{{metrics_json}}` from the run's live metric values
- characters 13847-15423: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15466-17781: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17837-18565: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Wartime Continuity and Allied Shield Accession | 2 |
| M14 | EU Port Continuity and Teleoperation Safety Compact | 2 |
