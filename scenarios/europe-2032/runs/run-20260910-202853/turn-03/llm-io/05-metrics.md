...
- characters 106-13465: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13508-13700: `{{metrics_json}}` from the run's live metric values
- characters 13793-15464: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15508-17415: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17471-17968: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Incident Surge and Dependency Containment | 2 |
...
PORTFOLIO CHARGE t2: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Infrastructure Cyber Shield −3, M4 EU Agentic Deployment Safety Gate −2, priority −1 = −12
PROPOSAL BONUS: EU Agentic Deployment Safety Gate (cat 1, small) +3 — capability_jump plus rogue-agent loss-of-control last turn and this answers it directly
LEGITIMACY LENDS: capital 27, sentiment 39 -> +2
SOVEREIGNTY: 21 last turn, no capacity event, Gigafactories in flight +0, capability rose 6.0 −1 = 20
