...
- characters 105-13475: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13518-13710: `{{metrics_json}}` from the run's live metric values
- characters 13803-14836: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14879-16893: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16949-18055: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Agentic Deployment Safety Gate | 2 |
| M6 | EU Clinical AI Adoption Trust Programme | 2 |
...
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Agentic Deployment Safety Gate −2, M5 EU Incident Surge and Dependency Containment −2, priority −1 = −11
PROPOSAL BONUS: EU Incident Surge and Dependency Containment (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly
...
## Metrics
```json
{"ai_capability": 69.0, "openweight_capability": 60.8, "ai_safety": 11.0, "resilience": 44.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 17.0, "public_sentiment": 28.0}
```
