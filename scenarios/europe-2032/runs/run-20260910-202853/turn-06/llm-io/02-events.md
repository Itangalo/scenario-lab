...
- characters 375-1587: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1630-3813: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3869-5095: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5158-31581: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31936-32402: `{{event_history}}` from the run's own event record
...
- `emergent_care_vs_compute_backlash` -- first noted turn 4, listed in 2 turn(s) so far: Municipal hospital outages trigger coordinated strikes by health and local-government unions blocking new data-centre grid connections until clinics are restored.
- `emergent_vendor_liability_suits` -- first noted turn 4, listed in 2 turn(s) so far: Municipal hospital associations and patient groups file coordinated liability suits against the vendor of the compromised enterprise component, seeking EU-wide collective redress and forcing disclosure of the quiet summer patch timeline.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, loss_of_control_incident
- Turn 2 (4 turn(s) ago): capability_jump, cyber_defence_breakthrough
- Turn 3 (3 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports
- Turn 4 (2 turn(s) ago): medical_breakthrough, embodied_ai_deployment
- Turn 5 (1 turn(s) ago): capability_jump, cyber_major_incident, joint_threat_response, opaque_reasoning, research_breakthrough, us_china_agreement, election_consolidation
