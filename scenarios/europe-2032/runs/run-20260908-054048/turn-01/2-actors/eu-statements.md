...
- `two_year_commitment` (commitment): Secure the capacity to act independently in AI while containing the risk of catastrophic failure.

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure the capacity to act independently in AI while containing the risk of catastrophic failure.
