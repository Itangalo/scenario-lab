...
- `two_year_commitment` (commitment): Secure sovereign access to AI systems essential for public functions and build independent EU evaluation capacity

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign access to AI systems essential for public functions and build independent EU evaluation capacity
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The commitment's time-bound nature means its closure directly changes the actor's obligation to uphold the original statement.
