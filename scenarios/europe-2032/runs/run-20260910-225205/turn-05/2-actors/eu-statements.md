...
- `two_year_commitment` (commitment): Secure assured access and joint leverage so the Union cannot be cut off

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure assured access and joint leverage so the Union cannot be cut off
