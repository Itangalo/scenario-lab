...
- characters 1492-4120: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6058-6530: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8644-10148: `{{previous_actions}}` from the actor's own response from the previous turn
