...
- characters 106-13812: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13855-14047: `{{metrics_json}}` from the run's live metric values
- characters 14140-15133: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15177-17805: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17861-18614: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | European Access and Supply-Chain Coalition | 2 |
...
| M4 | Union External AI Deal Screen | 8 | small | 2 | 5 | own jurisdiction | eu_political_capital stabilise then up, eu_ai_sovereignty up by preventing fragmentation | 2 | finished |
| M5 | Emergency Containment and Continuity Surge | 6 | small | 3 | 5 | own jurisdiction | resilience up, damage contained | 2 | finished |
...
- `emergent_power_bill_backlash` -- first noted turn 5, listed in 1 turn(s) so far: Spiking household power bills blamed on AI data-centre demand trigger coordinated siting blockades and municipal referendums around the two stalled gigafactory sites, freezing grid-connection mediation through autumn.
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, European Access and Supply-Chain Coalition −2, priority −1 = −9
PROPOSAL BONUS: European Access and Supply-Chain Coalition (cat 8, small) +4 — member_state_defection this turn and tiered US rationing decided this turn directly answered
LEGITIMACY LENDS: capital 14, sentiment 32 -> +2
SOVEREIGNTY: 16 last turn, no cat4 finish, Gigafactories in flight +0, middle_power_coalition t5 +2 (largest capacity event, defection also fired), capability rose 2.0 −1 = 17
