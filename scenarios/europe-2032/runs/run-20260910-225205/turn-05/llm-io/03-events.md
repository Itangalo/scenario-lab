...
- characters 1414-4042: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4098-4512: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4575-33060: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33415-33650: `{{event_history}}` from the run's own event record
...
- Turn 3 (2 turn(s) ago): cyber_major_incident, emergent_grid_forensics_leak
- Turn 4 (1 turn(s) ago): capability_jump, knowledge_work_augmented
