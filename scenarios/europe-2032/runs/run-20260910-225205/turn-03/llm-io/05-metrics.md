...
- characters 106-13187: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13230-13422: `{{metrics_json}}` from the run's live metric values
- characters 13515-14721: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14765-16629: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16685-17487: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | Union External AI Deal Screen | 2 |
| M5 | Emergency Containment and Continuity Surge | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, Union External AI Deal Screen −2, priority −1 = −12
PROPOSAL BONUS: Union External AI Deal Screen (cat 8, small) +2 — member_state_defection fired this turn and this answers it directly
LEGITIMACY LENDS: capital 25, sentiment 34 -> +2
SOVEREIGNTY: 21 last turn, no finishing, Gigafactories in flight +0, member_state_defection t2 −2, capability rose 2.0 −1 = 18

## Emerging developments (tracked)

- `emergent_cyber_insurance_retreat` -- first noted turn 2, listed in 2 turn(s) so far: A major European insurer reprices cyber cover after the grid intrusions, quietly excluding losses from AI-probed OT compromises and forcing several grid operators and ports to self-insure critical downtime.
