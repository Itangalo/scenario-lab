...
- characters 13514-15307: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15350-17110: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17166-17690: `{{notepad}}` from the Game Master's notepad, carried across turns
