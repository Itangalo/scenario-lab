...
- characters 105-13130: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13173-13365: `{{metrics_json}}` from the run's live metric values
- characters 13458-14648: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14691-16783: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16839-17901: `{{notepad}}` from the Game Master's notepad, carried across turns
