...
- characters 4159-4631: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6103-8230: `{{previous_actions}}` from the actor's own response from the previous turn
