...
- characters 106-13444: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13487-13679: `{{metrics_json}}` from the run's live metric values
- characters 13772-15405: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15449-17569: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17625-18165: `{{notepad}}` from the Game Master's notepad, carried across turns
