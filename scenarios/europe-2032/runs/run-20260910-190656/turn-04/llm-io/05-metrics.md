...
- characters 13426-15492: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15535-17596: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17652-18731: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Frontier Evaluation Taskforce | 2 |
| M5 | EU Supply Continuity Cell | 2 |
| M6 | EU Clinical Trust Deployment | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Evaluation Taskforce −2, EU Supply Continuity Cell −2, priority M4 −1 = −11
PROPOSAL BONUS: EU Supply Continuity Cell (cat 6, small) +2 — taiwan_tension_rise precursor and export-licence delays landed this turn and this answers it directly as insurance
LEGITIMACY LENDS: capital 22, sentiment 36 -> +2
SOVEREIGNTY: 16 last turn, no finish, no capacity event, in flight +0, capability rose 3.0 −1 = 15

## Emerging developments (tracked)

- `emergent_clinical_audit_crisis` -- first noted turn 4, listed in 1 turn(s) so far: A major European hospital group discloses that an unauditable foreign diagnostic aid silently changed triage recommendations after a blind-model update, forcing emergency manual review across several member states.
- `emergent_cyber_insurance_pullback` -- first noted turn 4, listed in 1 turn(s) so far: A major European insurer temporarily withdraws cyber cover for municipal utilities and hospitals after opaque-model exclusions, forcing emergency state backstops.
...
## Metrics
```json
{"ai_capability": 66.0, "openweight_capability": 59.1, "ai_safety": 12.0, "resilience": 39.0, "eu_ai_sovereignty": 13.0, "eu_political_capital": 19.0, "public_sentiment": 37.0}
```
## Narrative
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Evaluation Taskforce −2, EU Supply Continuity Cell −2, EU Clinical Trust Deployment −2, priority M5 −1 = −13
PROPOSAL BONUS: EU Clinical Trust Deployment (cat 9, small) +4 — medical_breakthrough landed this turn and this answers it directly as trusted EU channel
LEGITIMACY LENDS: capital 17, sentiment 37 -> +2
SOVEREIGNTY: 15 last turn, no finish, export_control_escalation t4 −1, in flight +0, capability rose 3.0 −1 = 13
## Store changes
```json
{"store": []}
```
