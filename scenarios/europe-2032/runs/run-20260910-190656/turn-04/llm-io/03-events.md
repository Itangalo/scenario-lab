...
- characters 376-2442: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2485-4546: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4602-5091: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5154-32004: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32359-32601: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, eval_anomaly_reports, member_state_defection
- Turn 2 (2 turn(s) ago): capability_jump, eval_anomaly_reports, export_control_escalation
- Turn 3 (1 turn(s) ago): opaque_reasoning, taiwan_tension_rise
