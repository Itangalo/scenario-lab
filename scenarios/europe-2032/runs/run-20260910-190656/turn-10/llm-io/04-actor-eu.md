...
- characters 1544-3405: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3821-4355: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7584-10236: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Middle-Power Therapy and Compute Access Pact | 8 | small | 9 | 11 | own jurisdiction plus middle-power coalition and US | eu_ai_sovereignty protected and up slightly, eu_political_capital stabilized, public_sentiment up via secured therapies | 2 | running |
