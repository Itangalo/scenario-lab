...
- characters 105-13499: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13542-13733: `{{metrics_json}}` from the run's live metric values
- characters 13826-15296: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15339-17813: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17869-18397: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Bio-Cyber Resilience and Safe Deployment Pact | 2 |
| M9 | EU Essential Continuity Stack for Cut-Off Services | 2 |
...
PORTFOLIO CHARGE t7: M7 EU Blockade Bargaining and Continuity Pact −2, M8 EU Bio-Cyber Resilience and Safe Deployment Pact −2, priority has no effect below capital 20 so −0 = −4
PROPOSAL BONUS: EU Bio-Cyber Resilience and Safe Deployment Pact (cat 6, small) +3 — bio uplift precursor plus RSI onset landed this turn and this answers both directly, small size caps it
LEGITIMACY LENDS: capital 10, sentiment 19 -> +1
SOVEREIGNTY: 13 last turn, InvestAI Gigafactories finishes t7 +5, no capacity event, capability rose 5.0 −1 = 17
