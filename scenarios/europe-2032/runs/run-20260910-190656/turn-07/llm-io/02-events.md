...
- characters 1847-4250: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4306-4668: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4731-32024: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32379-32883: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, eval_anomaly_reports, member_state_defection
- Turn 2 (5 turn(s) ago): capability_jump, eval_anomaly_reports, export_control_escalation
- Turn 3 (4 turn(s) ago): opaque_reasoning, taiwan_tension_rise
- Turn 4 (3 turn(s) ago): medical_breakthrough, export_control_escalation
- Turn 5 (2 turn(s) ago): taiwan_blockade, export_control_escalation, election_retrenchment
- Turn 6 (1 turn(s) ago): eval_anomaly_reports, labour_displacement, automated_decision_scandal
