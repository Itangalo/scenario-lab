...
- characters 13710-15137: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15181-17584: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17640-18002: `{{notepad}}` from the Game Master's notepad, carried across turns
