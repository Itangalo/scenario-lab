...
- characters 107-13443: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13486-13677: `{{metrics_json}}` from the run's live metric values
- characters 13770-15131: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15175-17114: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17170-17676: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Certified Safe Care Deployment | 2 |
