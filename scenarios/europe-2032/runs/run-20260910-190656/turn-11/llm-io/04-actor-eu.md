...
- characters 455-1816: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1860-3799: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5656-6188: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9618-12165: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M11 | EU Certified Safe Care Deployment | 9 | small | 10 | 12 | own jurisdiction | ai_safety up moderately, public_sentiment up, resilience up modestly via trusted health deployment | 2 | running |
