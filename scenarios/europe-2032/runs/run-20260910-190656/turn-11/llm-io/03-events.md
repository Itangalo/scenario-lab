...
- characters 377-1738: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1782-3721: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3777-4283: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4346-32683: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33038-33903: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M10 EU Middle-Power Therapy and Compute Access Pact −2, M11 EU Certified Safe Care Deployment −2, priority has no effect below capital 20 so −0 = −4
PROPOSAL BONUS: none — new Cat 9 answers safety_breakthrough positive advance and long-running cut-off dependence, not a negative event from last three rounds
LEGITIMACY LENDS: capital 9, sentiment 18 -> +1 capped in totals
SOVEREIGNTY: 14 last turn, no cat4 finish, no cat4 in flight +0, no capacity event, capability rose 1.5 −1 = 13
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, eval_anomaly_reports, member_state_defection
- Turn 2 (9 turn(s) ago): capability_jump, eval_anomaly_reports, export_control_escalation
- Turn 3 (8 turn(s) ago): opaque_reasoning, taiwan_tension_rise
- Turn 4 (7 turn(s) ago): medical_breakthrough, export_control_escalation
- Turn 5 (6 turn(s) ago): taiwan_blockade, export_control_escalation, election_retrenchment
- Turn 6 (5 turn(s) ago): eval_anomaly_reports, labour_displacement, automated_decision_scandal
- Turn 7 (4 turn(s) ago): bio_uplift_findings, rsi_onset, safety_breakthrough, taiwan_tension_rise
- Turn 8 (3 turn(s) ago): bio_uplift_findings, capability_jump, openweight_frontier_release, ai_investment_collapse, eu_frontier_access_denied
