...
- characters 453-1571: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1615-3706: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4629-5165: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8124-10295: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Essential Continuity Stack for Cut-Off Services | 6 | small | 8 | 10 | own jurisdiction | resilience up moderately, eu_ai_sovereignty protected from falling further, public_sentiment stabilized | 2 | running |
