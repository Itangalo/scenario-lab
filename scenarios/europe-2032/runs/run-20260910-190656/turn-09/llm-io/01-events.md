...
- characters 375-1493: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1537-3628: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3684-4269: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4332-32669: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33024-33770: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, eval_anomaly_reports, member_state_defection
- Turn 2 (7 turn(s) ago): capability_jump, eval_anomaly_reports, export_control_escalation
- Turn 3 (6 turn(s) ago): opaque_reasoning, taiwan_tension_rise
- Turn 4 (5 turn(s) ago): medical_breakthrough, export_control_escalation
- Turn 5 (4 turn(s) ago): taiwan_blockade, export_control_escalation, election_retrenchment
- Turn 6 (3 turn(s) ago): eval_anomaly_reports, labour_displacement, automated_decision_scandal
- Turn 7 (2 turn(s) ago): bio_uplift_findings, rsi_onset, safety_breakthrough, taiwan_tension_rise
- Turn 8 (1 turn(s) ago): bio_uplift_findings, capability_jump, openweight_frontier_release, ai_investment_collapse, eu_frontier_access_denied
