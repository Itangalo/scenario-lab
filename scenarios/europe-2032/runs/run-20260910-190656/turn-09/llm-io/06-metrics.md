...
- characters 13766-14884: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14928-17019: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17075-17660: `{{notepad}}` from the Game Master's notepad, carried across turns
