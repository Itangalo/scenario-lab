...
- characters 105-13066: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13109-13301: `{{metrics_json}}` from the run's live metric values
- characters 13394-14728: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14771-17274: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17330-18380: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 60.0, "openweight_capability": 50.5, "ai_safety": 23.0, "resilience": 36.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 26.0, "public_sentiment": 34.0}
```
## Narrative
### The jump
