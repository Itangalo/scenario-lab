...
- characters 454-1788: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1831-4334: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5550-6010: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7483-9507: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M3 | EU Grid and Critical Systems Shield | 6 | large | 1 | 3 | own jurisdiction | resilience up substantially, ai_safety up slightly via detection | 3 | running |
