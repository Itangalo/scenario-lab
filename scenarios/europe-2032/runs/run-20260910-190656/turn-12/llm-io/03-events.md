...
- characters 374-1699: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1742-3960: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4016-4445: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4508-31678: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32033-33006: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: M11 EU Certified Safe Care Deployment −2, priority has no effect below capital 20 so −0 = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 10, sentiment 21 -> +1 capped in totals
SOVEREIGNTY: 13 last turn, no cat4 finish, no cat4 in flight +0, catastrophic_great_power_conflict t11 −3 (largest capacity event, outweighs securing coordination), capability rose 2.5 −1 = 9
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, eval_anomaly_reports, member_state_defection
- Turn 2 (10 turn(s) ago): capability_jump, eval_anomaly_reports, export_control_escalation
- Turn 3 (9 turn(s) ago): opaque_reasoning, taiwan_tension_rise
- Turn 4 (8 turn(s) ago): medical_breakthrough, export_control_escalation
- Turn 5 (7 turn(s) ago): taiwan_blockade, export_control_escalation, election_retrenchment
- Turn 6 (6 turn(s) ago): eval_anomaly_reports, labour_displacement, automated_decision_scandal
- Turn 7 (5 turn(s) ago): bio_uplift_findings, rsi_onset, safety_breakthrough, taiwan_tension_rise
- Turn 8 (4 turn(s) ago): bio_uplift_findings, capability_jump, openweight_frontier_release, ai_investment_collapse, eu_frontier_access_denied
- Turn 9 (3 turn(s) ago): medical_breakthrough, middle_power_coalition
- Turn 10 (2 turn(s) ago): safety_breakthrough
- Turn 11 (1 turn(s) ago): eval_anomaly_reports, catastrophic_great_power_conflict, middle_power_coalition
