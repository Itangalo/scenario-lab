...
- characters 106-13495: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13538-13730: `{{metrics_json}}` from the run's live metric values
- characters 13823-15015: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15059-17312: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17368-18471: `{{notepad}}` from the Game Master's notepad, carried across turns
