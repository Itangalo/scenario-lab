...
- characters 1691-3944: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5578-6038: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8329-10383: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Clinical Trust Deployment | 9 | small | 4 | 6 | own jurisdiction | public_sentiment up sharply, resilience up modestly via health system absorption | 2 | running |
