...
- characters 2079-4332: `{{world_state}}` from background/context.md, seeded as the opening world state
- characters 4365-7636: `{{previous_actions}}` from the actor's own response from the previous turn
...
Rewrite it to read: Hold the Union together through blockade and retrenchment by securing critical supply and keeping essential services running
