...
- characters 107-13025: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13068-13259: `{{metrics_json}}` from the run's live metric values
- characters 13352-15003: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15047-17143: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17199-17632: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M13 | EU Rogue Containment and Essential Continuity Protocol | 2 |
