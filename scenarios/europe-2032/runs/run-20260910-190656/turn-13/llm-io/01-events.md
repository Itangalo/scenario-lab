...
- characters 2072-4168: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4224-4657: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4720-31890: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32245-33269: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, eval_anomaly_reports, member_state_defection
- Turn 2 (11 turn(s) ago): capability_jump, eval_anomaly_reports, export_control_escalation
- Turn 3 (10 turn(s) ago): opaque_reasoning, taiwan_tension_rise
- Turn 4 (9 turn(s) ago): medical_breakthrough, export_control_escalation
- Turn 5 (8 turn(s) ago): taiwan_blockade, export_control_escalation, election_retrenchment
- Turn 6 (7 turn(s) ago): eval_anomaly_reports, labour_displacement, automated_decision_scandal
- Turn 7 (6 turn(s) ago): bio_uplift_findings, rsi_onset, safety_breakthrough, taiwan_tension_rise
- Turn 8 (5 turn(s) ago): bio_uplift_findings, capability_jump, openweight_frontier_release, ai_investment_collapse, eu_frontier_access_denied
- Turn 9 (4 turn(s) ago): medical_breakthrough, middle_power_coalition
- Turn 10 (3 turn(s) ago): safety_breakthrough
- Turn 11 (2 turn(s) ago): eval_anomaly_reports, catastrophic_great_power_conflict, middle_power_coalition
- Turn 12 (1 turn(s) ago): middle_power_coalition
