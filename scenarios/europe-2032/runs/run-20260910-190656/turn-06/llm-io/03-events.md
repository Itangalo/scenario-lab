...
- characters 376-1720: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1763-4088: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4144-5306: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5369-31130: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31485-31893: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Supply Continuity Cell −2, EU Clinical Trust Deployment −2, EU Blockade Bargaining and Continuity Pact −2, priority M5 −1 = −13
PROPOSAL BONUS: EU Blockade Bargaining and Continuity Pact (cat 8, small) +5 — taiwan_blockade and export_control_escalation landed this turn and this answers them directly as joint leverage and pooling
LEGITIMACY LENDS: capital 14, sentiment 31 -> +2
SOVEREIGNTY: 13 last turn, no finish, export_control_escalation t5 −2, in flight +0, capability rose 3.0 −1 = 10

## Emerging developments (tracked)

- `emergent_clinical_audit_crisis` -- first noted turn 4, listed in 2 turn(s) so far: A major European hospital group discloses that an unauditable foreign diagnostic aid silently changed triage recommendations after a blind-model update, forcing emergency manual review across several member states.
- `emergent_cyber_insurance_pullback` -- first noted turn 4, listed in 2 turn(s) so far: A major European insurer temporarily withdraws cyber cover for municipal utilities and hospitals after opaque-model exclusions, forcing emergency state backstops.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, eval_anomaly_reports, member_state_defection
- Turn 2 (4 turn(s) ago): capability_jump, eval_anomaly_reports, export_control_escalation
- Turn 3 (3 turn(s) ago): opaque_reasoning, taiwan_tension_rise
- Turn 4 (2 turn(s) ago): medical_breakthrough, export_control_escalation
- Turn 5 (1 turn(s) ago): taiwan_blockade, export_control_escalation, election_retrenchment
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.05}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.06}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "rsi_onset", "probability": 0.35}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.05}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.15}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.09}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "A major European hospital group discloses that an unauditable foreign diagnostic aid silently changed triage recommendations after a blind-model update, forcing emergency manual review across several member states.", "emergent": true, "id": "emergent_clinical_audit_crisis", "probability": 0.18}, {"description": "A major European insurer temporarily withdraws cyber cover for municipal utilities and hospitals after opaque-model exclusions, forcing emergency state backstops.", "emergent": true, "id": "emergent_cyber_insurance_pullback", "probability": 0.15}]
```
