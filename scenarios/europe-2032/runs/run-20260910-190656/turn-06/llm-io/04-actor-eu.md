...
- characters 454-1798: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1841-4166: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6382-6918: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9463-12734: `{{previous_actions}}` from the actor's own response from the previous turn
