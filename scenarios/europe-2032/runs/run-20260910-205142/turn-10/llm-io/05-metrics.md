...
- characters 106-13272: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13315-13507: `{{metrics_json}}` from the run's live metric values
- characters 13600-15451: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15494-17674: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17730-18589: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Displacement Transition Facility | 2 |
...
PORTFOLIO CHARGE t9: Essential Services Continuity Shield −2, priority −1 = −2 + 1 more for the priority = −3

PROPOSAL BONUS: Essential Services Continuity Shield (cat 6, small) +4 — frontier denial and fallback outage landed this turn and this answers them directly

LEGITIMACY LENDS: capital 24, sentiment 36 -> +2 (included in capital total, capped below sentiment)

SOVEREIGNTY: 22 last turn, no category 4 finish, no category 4 in flight, eu_frontier_access_denied t9 −2 (larger than export_control_escalation t9), capability rose 0.8 no charge = 20

## Emerging developments (tracked)

- `emergent_eu_open_medical_hosting_offer` -- first noted turn 10, listed in 1 turn(s) so far: A major non-US open-weight lab offers EU hospitals a clinically validated medical model for on-premise EU hosting, easing therapy procurement standoff without US licences.
...
## Notepad
PORTFOLIO CHARGE t10: EU Displacement Transition Facility −2, priority −1 = −2 + 1 more for the priority = −3

PROPOSAL BONUS: EU Displacement Transition Facility (cat 7, small) +3 — labour_displacement landed this turn and this answers it directly

LEGITIMACY LENDS: capital 24, sentiment 28 -> +1

SOVEREIGNTY: 20 last turn, no category 4 finish, no category 4 in flight, taiwan_blockade t10 −2, capability rose 0.6 no charge = 18
