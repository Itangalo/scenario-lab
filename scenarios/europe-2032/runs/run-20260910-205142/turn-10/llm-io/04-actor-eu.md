...
- characters 455-2306: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2349-4529: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5271-5772: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8698-11530: `{{previous_actions}}` from the actor's own response from the previous turn
