...
- characters 1775-3610: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5085-5636: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8333-10410: `{{previous_actions}}` from the actor's own response from the previous turn
