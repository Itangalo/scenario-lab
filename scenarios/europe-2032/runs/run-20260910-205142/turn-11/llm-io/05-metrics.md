...
- characters 107-13244: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13287-13479: `{{metrics_json}}` from the run's live metric values
- characters 13572-15330: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15374-17367: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17423-18159: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Sovereign Fallback Stack | 2 |
