...
- characters 454-1671: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1714-3896: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4488-4960: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7248-8621: `{{previous_actions}}` from the actor's own response from the previous turn
