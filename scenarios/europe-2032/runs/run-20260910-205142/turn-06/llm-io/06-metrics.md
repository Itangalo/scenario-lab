...
- characters 13746-14963: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15006-17188: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17244-17684: `{{notepad}}` from the Game Master's notepad, carried across turns
