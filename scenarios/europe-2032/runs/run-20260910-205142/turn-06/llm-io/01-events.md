...
- characters 376-1593: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1636-3818: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3874-4314: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4377-25616: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 25971-26434: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M6 EU Bio Shield Detection Upgrade −2, priority M6 −1 = −8 + 1 more for the priority = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 12, sentiment 44 -> +2 (capped below sentiment)
SOVEREIGNTY: 16 last turn, no category 4 finish, M1/M2 in flight +0, export_control_escalation t5 −2, capability rose 1.5 no charge = 14
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, taiwan_tension_rise, supply_chain_coercion
- Turn 2 (4 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, knowledge_work_augmented, member_state_defection, emergent_eu_biotech_breakthrough
- Turn 3 (3 turn(s) ago): member_state_defection
- Turn 4 (2 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 5 (1 turn(s) ago): knowledge_work_augmented, export_control_escalation, election_consolidation
