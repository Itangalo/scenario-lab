...
- characters 455-1523: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1567-3711: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5472-5908: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8194-10089: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Bio Shield Detection Upgrade | 6 | small | 4 | 6 | own jurisdiction | resilience up via biosecurity detection and response | 2 | running |
