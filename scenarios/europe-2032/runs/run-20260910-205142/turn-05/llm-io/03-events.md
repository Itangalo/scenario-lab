...
- characters 377-1445: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1489-3633: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3689-4241: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4304-26925: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27280-27641: `{{event_history}}` from the run's own event record
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, taiwan_tension_rise, supply_chain_coercion
- Turn 2 (3 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, knowledge_work_augmented, member_state_defection, emergent_eu_biotech_breakthrough
- Turn 3 (2 turn(s) ago): member_state_defection
- Turn 4 (1 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
