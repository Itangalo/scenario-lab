...
- characters 106-13273: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13316-13508: `{{metrics_json}}` from the run's live metric values
- characters 13601-14669: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14713-16857: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16913-17465: `{{notepad}}` from the Game Master's notepad, carried across turns
