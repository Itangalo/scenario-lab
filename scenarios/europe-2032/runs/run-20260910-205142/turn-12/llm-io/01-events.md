...
- characters 377-2268: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2311-4317: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4373-5127: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5190-28727: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29082-30035: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: EU Sovereign Fallback Stack −2, priority −1 = −2 + 1 more for the priority = −3

PROPOSAL BONUS: EU Sovereign Fallback Stack (cat 6, small) +3 — eu_frontier_access_denied landed this turn and this answers it directly

LEGITIMACY LENDS: capital 30, sentiment 25 -> none, capital higher

SOVEREIGNTY: 18 last turn, no category 4 finish, no category 4 in flight, eu_frontier_access_denied t11 −2, capability rose 0.7 no charge = 16

## Emerging developments (tracked)

- `emergent_eu_open_medical_hosting_offer` -- first noted turn 10, listed in 2 turn(s) so far: A major non-US open-weight lab offers EU hospitals a clinically validated medical model for on-premise EU hosting, easing therapy procurement standoff without US licences.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, taiwan_tension_rise, supply_chain_coercion
- Turn 2 (10 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, knowledge_work_augmented, member_state_defection, emergent_eu_biotech_breakthrough
- Turn 3 (9 turn(s) ago): member_state_defection
- Turn 4 (8 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 5 (7 turn(s) ago): knowledge_work_augmented, export_control_escalation, election_consolidation
- Turn 6 (6 turn(s) ago): knowledge_work_augmented
- Turn 7 (5 turn(s) ago): safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise
- Turn 8 (4 turn(s) ago): opaque_reasoning, automated_decision_scandal
- Turn 9 (3 turn(s) ago): medical_breakthrough, export_control_escalation, eu_frontier_access_denied, emergent_fallback_hosting_strain
- Turn 10 (2 turn(s) ago): taiwan_blockade, labour_displacement
- Turn 11 (1 turn(s) ago): taiwan_tension_rise, eu_frontier_access_denied
