...
- characters 105-13273: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13316-13508: `{{metrics_json}}` from the run's live metric values
- characters 13601-14660: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14703-16400: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16456-17301: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | Taiwan-Contingency Continuity Reserve | 2 |
| M9 | Deployment Accountability and Redress Audit | 2 |
...
PORTFOLIO CHARGE t7: M7 Allied Assurance and Supply Pact −2, M8 Taiwan-Contingency Continuity Reserve −2, priority M7 −1 = −4 + 1 more for the priority = −5

PROPOSAL BONUS: Taiwan-Contingency Continuity Reserve (cat 6, small) +2 — taiwan tension rise this turn opened three-turn supply risk and this answers it directly

LEGITIMACY LENDS: capital 22, sentiment 48 -> +2

SOVEREIGNTY: 18 last turn, InvestAI Gigafactories finishes t7 +4, no in-flight cat4, no capacity event, capability rose 0.7 no charge = 22

## Emerging developments (tracked)

- `emergent_fallback_hosting_strain` -- first noted turn 8, listed in 1 turn(s) so far: A major non-US cloud provider suffers a prolonged outage during Strait shipping disruption, forcing emergency rerouting of European health and telecom inference workloads and exposing fallback capacity limits.
...
## Notepad
PORTFOLIO CHARGE t8: M8 Taiwan-Contingency Continuity Reserve −2, M9 Deployment Accountability and Redress Audit −2, priority −1 = −4 + 1 more for the priority = −5

PROPOSAL BONUS: Deployment Accountability and Redress Audit (cat 1, small) +3 — automated_decision_scandal landed this turn and this answers it directly

LEGITIMACY LENDS: capital 16, sentiment 41 -> +2

SOVEREIGNTY: 22 last turn, no capacity event, no cat4 in flight, capability rose 0.8 no charge = 22
