...
- characters 376-1435: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1478-3175: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3231-3741: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3804-28153: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28508-29115: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, taiwan_tension_rise, supply_chain_coercion
- Turn 2 (6 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, knowledge_work_augmented, member_state_defection, emergent_eu_biotech_breakthrough
- Turn 3 (5 turn(s) ago): member_state_defection
- Turn 4 (4 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 5 (3 turn(s) ago): knowledge_work_augmented, export_control_escalation, election_consolidation
- Turn 6 (2 turn(s) ago): knowledge_work_augmented
- Turn 7 (1 turn(s) ago): safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise
