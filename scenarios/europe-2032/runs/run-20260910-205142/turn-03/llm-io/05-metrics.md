...
- characters 106-13307: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13350-13542: `{{metrics_json}}` from the run's live metric values
- characters 13635-15058: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15102-17357: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17413-17903: `{{notepad}}` from the Game Master's notepad, carried across turns
