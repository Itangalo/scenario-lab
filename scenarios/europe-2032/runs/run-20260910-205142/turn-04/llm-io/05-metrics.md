...
- characters 13371-13563: `{{metrics_json}}` from the run's live metric values
- characters 13656-14785: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14828-17539: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17595-18124: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Bio Shield Detection Upgrade | 2 |
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Clinical Validation Network −2, EU Common Hosting Terms −2, priority −1 = −11
PROPOSAL BONUS: EU Common Hosting Terms (cat 8, small) +2 — answers member_state_defection from t2 and renewed t3 side-deal pressure directly, small size limits value
LEGITIMACY LENDS: capital 14, sentiment 42 -> +2
SOVEREIGNTY: 18 last turn, no finish, Gigafactories/Tech sovereignty in flight stalled +0, member_state_defection t3 −2, capability rose 1.5 no charge = 16
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Clinical Validation Network −2, EU Bio Shield Detection Upgrade −2, priority −1 = −10 + 1 more for the priority = −11
PROPOSAL BONUS: EU Bio Shield Detection Upgrade (cat 6, small) +3 — bio_uplift_findings fired this turn opening 4-turn window and this answers it directly, small size limits value
LEGITIMACY LENDS: capital 16, sentiment 44 -> +2
SOVEREIGNTY: 16 last turn, no capacity event, Gigafactories/Tech sovereignty in flight +0, capability rose 1.5 no charge = 16
