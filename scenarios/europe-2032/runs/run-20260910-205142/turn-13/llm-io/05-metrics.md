...
- characters 107-13203: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13246-13438: `{{metrics_json}}` from the run's live metric values
- characters 13531-15521: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15565-17699: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17755-18223: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M14 | EU Hospital Inference Expansion | 2 |
...
## Notepad
PORTFOLIO CHARGE t13: EU Hospital Inference Expansion −2, priority −1 = −2 + 1 more for the priority = −3

PROPOSAL BONUS: none — EU Hospital Inference Expansion already in flight, no new measure answering last-three-turn shock

LEGITIMACY LENDS: capital 33, sentiment 29 -> none, capital higher

SOVEREIGNTY: 16 last turn, no capacity event, EU Hospital Inference Expansion in flight +1, capability rose 0.6 no charge = 17
