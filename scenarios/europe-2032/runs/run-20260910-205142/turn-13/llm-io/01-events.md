...
- characters 378-2368: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2412-4546: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4602-5070: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5133-28670: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29025-30088: `{{event_history}}` from the run's own event record
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, taiwan_tension_rise, supply_chain_coercion
- Turn 2 (11 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, knowledge_work_augmented, member_state_defection, emergent_eu_biotech_breakthrough
- Turn 3 (10 turn(s) ago): member_state_defection
- Turn 4 (9 turn(s) ago): bio_uplift_findings, knowledge_work_augmented
- Turn 5 (8 turn(s) ago): knowledge_work_augmented, export_control_escalation, election_consolidation
- Turn 6 (7 turn(s) ago): knowledge_work_augmented
- Turn 7 (6 turn(s) ago): safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise
- Turn 8 (5 turn(s) ago): opaque_reasoning, automated_decision_scandal
- Turn 9 (4 turn(s) ago): medical_breakthrough, export_control_escalation, eu_frontier_access_denied, emergent_fallback_hosting_strain
- Turn 10 (3 turn(s) ago): taiwan_blockade, labour_displacement
- Turn 11 (2 turn(s) ago): taiwan_tension_rise, eu_frontier_access_denied
- Turn 12 (1 turn(s) ago): medical_breakthrough, taiwan_tension_rise, emergent_eu_open_medical_hosting_offer
