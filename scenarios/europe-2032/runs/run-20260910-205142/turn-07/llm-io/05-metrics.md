...
- characters 13274-13466: `{{metrics_json}}` from the run's live metric values
- characters 13559-14642: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14686-16605: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16661-17159: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | Allied Assurance and Supply Pact | 2 |
...
PORTFOLIO CHARGE t6: M1 InvestAI Gigafactories −3, M7 Allied Assurance and Supply Pact −2, priority M1 −1 = −5 + 1 more for the priority = −6
PROPOSAL BONUS: Allied Assurance and Supply Pact (cat 8, small) +2 — export tightening last turn showed allied status did not assure supply and this answers it directly
LEGITIMACY LENDS: capital 18, sentiment 45 -> +2
SOVEREIGNTY: 14 last turn, Tech sovereignty package finishes t6 +4, M1 in flight +0, no capacity event, capability rose 1.5 no charge = 18
...
## Metrics
```json
{"ai_capability": 61.2, "openweight_capability": 59.0, "ai_safety": 27.0, "resilience": 41.5, "eu_ai_sovereignty": 22.0, "eu_political_capital": 24.0, "public_sentiment": 48.0}
```
## Narrative
### Holding the line
