...
| M10 | EU Rogue Agent Containment and Essential Services Shield | 6 | small | 10 | 12 | own jurisdiction with coalition partners | resilience up moderately, ai_safety protected, eu_political_capital protected | 2 | finished |
| M11 | EU Livelihood Continuity and Automation Transition Fund | 7 | small | 11 | 13 | own jurisdiction | resilience up moderately, public_sentiment up, eu_political_capital protected | 2 | finished |
| M12 | EU Chip Continuity and Allied Compute Fallback | 8 | small | 12 | 14 | own jurisdiction with coalition and supply-chain partners | resilience up modestly, eu_ai_sovereignty protected | 2 | running |
| M13 | EU Unsanctioned-Agent and Bio-Uplift Containment Shield | 6 | small | 13 | 15 | own jurisdiction with coalition partners | resilience up moderately, ai_safety protected | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Unsanctioned-Agent and Bio-Uplift Containment Shield", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction with coalition partners", "targeted_effect": "resilience up moderately, ai_safety protected"}, "grounds": "to contain loss-of-control and bio-uplift with breakthrough controls"}
  - Grounds: to contain loss-of-control and bio-uplift with breakthrough controls
