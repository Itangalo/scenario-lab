...
| M11 | EU Livelihood Continuity and Automation Transition Fund | 7 | small | 11 | 13 | own jurisdiction | resilience up moderately, public_sentiment up, eu_political_capital protected | 2 | running |
...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Chip Continuity and Allied Compute Fallback", "category": 8, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction with coalition and supply-chain partners", "targeted_effect": "resilience up modestly, eu_ai_sovereignty protected"}, "grounds": "to hedge Taiwan supply gate for essential services"}
  - Grounds: to hedge Taiwan supply gate for essential services
