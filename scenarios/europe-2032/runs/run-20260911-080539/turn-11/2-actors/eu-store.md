...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Livelihood Continuity and Automation Transition Fund", "category": 7, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, public_sentiment up, eu_political_capital protected"}, "grounds": "to deliver promised labour transition under superhuman diffusion"}
  - Grounds: to deliver promised labour transition under superhuman diffusion
