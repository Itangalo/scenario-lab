...
- `two_year_commitment` (commitment): Secure sovereign access to frontier AI systems for public mission-critical functions

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign access to frontier AI systems for public mission-critical functions
