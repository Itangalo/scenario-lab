...
- `two_year_commitment` (commitment): Secure independent AI capability to anchor European sovereignty and resilience

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure independent AI capability to anchor European sovereignty and resilience
