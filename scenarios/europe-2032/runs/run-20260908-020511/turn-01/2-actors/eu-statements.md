...
- `two_year_commitment` (commitment): Secure the autonomy to act in a world transformed by AI, without being left behind or broken by it.

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure the autonomy to act in a world transformed by AI, without being left behind or broken by it.
