...
- characters 377-1820: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1864-3983: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4039-5082: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5145-31040: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31395-32077: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, ai_investment_collapse, eval_anomaly_reports, taiwan_tension_rise
- Turn 2 (7 turn(s) ago): safety_breakthrough, knowledge_work_augmented, supply_chain_coercion
- Turn 3 (6 turn(s) ago): cyber_major_incident, bio_uplift_findings
- Turn 4 (5 turn(s) ago): cyber_major_incident, safety_breakthrough, eu_frontier_access_denied, member_state_defection, joint_threat_response
- Turn 5 (4 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, election_consolidation
- Turn 7 (2 turn(s) ago): openweight_frontier_release, automated_decision_scandal
- Turn 8 (1 turn(s) ago): taiwan_blockade, bio_uplift_findings, knowledge_work_augmented
