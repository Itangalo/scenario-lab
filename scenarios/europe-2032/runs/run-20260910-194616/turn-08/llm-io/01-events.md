...
- characters 376-1788: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1831-4230: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4286-5169: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5232-31845: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32200-32793: `{{event_history}}` from the run's own event record
...
- `emergent_tiered_access_codified` -- first noted turn 7, listed in 1 turn(s) so far: US tiered-access licensing rules are published, formally placing EU buyers in a restricted quota tier with case-by-case review, hardening the cut-off into standing policy.
- `emergent_insurer_return_pilot` -- first noted turn 7, listed in 1 turn(s) so far: Municipal insurers coordinate a limited return to cyber cover for EU-hosted health and grid workloads, conditional on segmentation audits, easing the freeze described this turn.
...
- Turn 2 (6 turn(s) ago): safety_breakthrough, knowledge_work_augmented, supply_chain_coercion
- Turn 3 (5 turn(s) ago): cyber_major_incident, bio_uplift_findings
- Turn 4 (4 turn(s) ago): cyber_major_incident, safety_breakthrough, eu_frontier_access_denied, member_state_defection, joint_threat_response
- Turn 5 (3 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, election_consolidation
- Turn 7 (1 turn(s) ago): openweight_frontier_release, automated_decision_scandal
