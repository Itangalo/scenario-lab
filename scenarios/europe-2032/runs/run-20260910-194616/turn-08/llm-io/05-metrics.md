...
- characters 13375-13567: `{{metrics_json}}` from the run's live metric values
- characters 13660-15072: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15115-17514: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17570-18453: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Supply-Chain Leverage and Continuity Pact | 2 |
...
PORTFOLIO CHARGE t7: EU Sovereign Essential Workloads Programme −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 19, sentiment 19 -> none, capital not lower
SOVEREIGNTY: 17 last turn, InvestAI Gigafactories finishes t7 +4, no capacity event, capability rose 1.0 −0 = 21

## Emerging developments (tracked)

- `emergent_tiered_access_codified` -- first noted turn 7, listed in 2 turn(s) so far: US tiered-access licensing rules are published, formally placing EU buyers in a restricted quota tier with case-by-case review, hardening the cut-off into standing policy.
- `emergent_insurer_return_pilot` -- first noted turn 7, listed in 2 turn(s) so far: Municipal insurers coordinate a limited return to cyber cover for EU-hosted health and grid workloads, conditional on segmentation audits, easing the freeze described this turn.
...
## Notepad
PORTFOLIO CHARGE t8: EU Supply-Chain Leverage and Continuity Pact −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: EU Supply-Chain Leverage and Continuity Pact (cat 8, small) +3 — taiwan blockade landed this turn and this answers it directly; knowledge-work gains block bonus for other claims
LEGITIMACY LENDS: capital 18, sentiment 22 -> +2
SOVEREIGNTY: 21 last turn, no cat4 finish, no cat4 in flight, taiwan_blockade t8 −2, capability rose 1.0 −0 = 19
