...
- characters 456-2123: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2167-4490: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6090-6585: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9890-12002: `{{previous_actions}}` from the actor's own response from the previous turn
...
- `two_year_commitment` (commitment): An independent Europe that can run essential AI without foreign permission and absorb AI-enabled shocks without collapse
...
| M4 | EU Lithography Leverage Compact | 8 | small | 2 | 5 | own jurisdiction + US + coalition (NL, JP) | eu_ai_sovereignty up slightly / prevent fall, eu_political_capital stabilise | 2 | finished |
| M5 | EU Active Incident Response and Essential Services Continuity Surge | 6 | large | 3 | 4 | own jurisdiction | resilience up substantially, ai_safety up slightly via incident learning | 3 | finished |
| M6 | EU Joint Continuity and Fallback Access Pact | 8 | small | 4 | 5 | coalition + own jurisdiction | resilience up, eu_ai_sovereignty stabilise, eu_political_capital stabilise | 2 | finished |
| M7 | EU Sovereign Essential Workloads Programme | 9 | small | 5 | 8 | own jurisdiction | resilience up, eu_ai_sovereignty stabilise, public_sentiment up slightly | 2 | finished |
| M8 | EU Supply-Chain Leverage and Continuity Pact | 8 | small | 8 | 10 | coalition + own jurisdiction | eu_ai_sovereignty stabilise, eu_political_capital stabilise, resilience up slightly | 2 | finished |
| M9 | EU Deployed Assurance Uptake | 5 | small | 9 | 11 | own jurisdiction | ai_safety up, resilience up slightly, public_sentiment up slightly | 2 | finished |
| M10 | EU Essential Services Restoration and Hardening Surge | 6 | small | 10 | 11 | own jurisdiction | resilience up, ai_safety up slightly | 2 | finished |
| M11 | EU Welfare AI Redress and Recertification Freeze | 3 | small | 11 | 12 | own jurisdiction | public_sentiment up, resilience up slightly, ai_safety up slightly | 2 | finished |
| M12 | EU Islanded Continuity and Cyber Containment Surge | 6 | small | 12 | 13 | own jurisdiction | resilience up, ai_safety up slightly | 2 | finished |
...
## New measure
**EU Islanded Continuity and Cyber Containment Surge**
It keeps hospitals, ministries and essential services running on EU-hosted islanded systems through the automated attack and access cut-off, with ENISA-led containment, clean-image rebuilds and manual fallback procedures.
Why this and why now: the large automated attack landing on top of frontier cut-off and a member-state side-deal means services must stay upright without foreign models, and with capital at 18 and sentiment at 18 only a small preparedness and resilience move using existing continuity structures can absorb the shock while the redress freeze lands.

## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Islanded Continuity and Cyber Containment Surge", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly"}, "grounds": "contain major automated attack under access denial"}]}
```

## Priority
M12 EU Islanded Continuity and Cyber Containment Surge, because the cyber sweep plus loss of frontier access outranks hardware and trust work and without containment neither restoration nor the independence commitment survives.

## In practice
We task ENISA and the AI Office with joint containment under the Cyber Solidarity Act and NIS2 base, with the Health and Home Affairs Councils owning rollout: priority clusters stay islanded on domestic capacity, compromised dependencies isolated, vetted logging replacements and clean-image rebuilds extended, and hospitals/ministries shifted to EU-hosted fallbacks with manual decision queues where automation is unsafe.

We keep the M11 redress and recertification freeze running in parallel but subordinate: no new compute push this turn, repair pools keep cannibalising to keep priority clusters alive, and we answer the member-state side-deal through the continuity pact table without new concessions. On the leaked eval anomaly and research breakthrough we order structured incident reporting only, starting no new build until containment holds.
...
```
## New measure
**EU Shopfloor Transition and Manual Continuity Fund**
It funds wage insurance, rapid retraining and employer transition contributions for picking/logistics/warehouse workers displaced by commercial robots, while ring-fencing repair, care and construction-site work as manual-continuity occupations with supported apprenticeships.
Why this and why now: with sentiment at 10, capital at 16 and robots now taking the automatable physical jobs from outside suppliers, a small labour-protection move (category 7) is the only affordable way to hold the independence-and-absorption commitment and stop displacement becoming collapse.

## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Shopfloor Transition and Manual Continuity Fund", "category": 7, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "public_sentiment up, resilience up slightly"}, "grounds": "answer embodied-robot displacement under cut-off with minimal capital"}]}
```

## Priority
M13 EU Shopfloor Transition and Manual Continuity Fund, because job loss plus hostility now outranks cyber-containment and hardware leverage as the binding constraint on any further action.

## In practice
We run this through EMPL and the EGF/ESF+ base with the Employment Council owning rollout: SURE-style wage bridges for displaced logistics workers, transition levies on deploying firms to fund retraining, and manual-continuity apprenticeship lines for repair/care/site work coordinated with the islanded permit/school pilots that still work.

We hold islanded continuity with existing ENISA structures without a new build, treat the tightening export controls as rationing to be absorbed by cannibalised domestic clusters, and answer the member-state hyperscaler side-deal and US model withdrawal by keeping essential workloads on EU-hosted fallbacks rather than chasing replacement access this turn.
