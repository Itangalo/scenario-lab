...
- characters 378-2045: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2089-4412: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4468-5425: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5488-32236: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32591-33682: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Islanded Continuity and Cyber Containment Surge −2, priority −1 = −3
PROPOSAL BONUS: EU Islanded Continuity and Cyber Containment Surge (cat 6, small) +4 — cyber_major_incident and eu_frontier_access_denied fired this turn and this answers both directly
LEGITIMACY LENDS: capital 18, sentiment 18 -> none, capital not below sentiment
SOVEREIGNTY: 16 last turn, no capacity event? No — eu_frontier_access_denied t12 −2 (largest of two takeaways, member_state_defection also qualifies), no category 4 build in flight +0, capability rose 1.0 −0 = 14

## Emerging developments (tracked)

- `emergent_insurance_exclusion_lockin` -- first noted turn 11, listed in 2 turn(s) so far: Insurers and municipal hospital federations formalise a brittle-systems exclusion pact, refusing automated coverage for AI-dependent clinical and administrative systems until domestic accelerators arrive, locking in paper fallbacks as the contractual norm.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, ai_investment_collapse, eval_anomaly_reports, taiwan_tension_rise
- Turn 2 (11 turn(s) ago): safety_breakthrough, knowledge_work_augmented, supply_chain_coercion
- Turn 3 (10 turn(s) ago): cyber_major_incident, bio_uplift_findings
- Turn 4 (9 turn(s) ago): cyber_major_incident, safety_breakthrough, eu_frontier_access_denied, member_state_defection, joint_threat_response
- Turn 5 (8 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, election_consolidation
- Turn 7 (6 turn(s) ago): openweight_frontier_release, automated_decision_scandal
- Turn 8 (5 turn(s) ago): taiwan_blockade, bio_uplift_findings, knowledge_work_augmented
- Turn 9 (4 turn(s) ago): safety_breakthrough, export_control_escalation
- Turn 10 (3 turn(s) ago): cyber_major_incident, knowledge_work_augmented
- Turn 11 (2 turn(s) ago): eval_anomaly_reports, automated_decision_scandal
- Turn 12 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, research_breakthrough, labour_displacement, eu_frontier_access_denied, member_state_defection, adoption_success
