...
- characters 107-13319: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13362-13554: `{{metrics_json}}` from the run's live metric values
- characters 13647-15314: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15358-17681: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17737-18308: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M13 | EU Shopfloor Transition and Manual Continuity Fund | 2 |
...
## Notepad
PORTFOLIO CHARGE t13: EU Shopfloor Transition and Manual Continuity Fund −2, priority −1 = −3

PROPOSAL BONUS: EU Shopfloor Transition and Manual Continuity Fund (cat 7, small) +2 — embodied displacement fires this turn and labour losses hardened last turn, this answers both directly but small and not yet delivering

LEGITIMACY LENDS: capital 16, sentiment 10 -> none, capital not below sentiment

SOVEREIGNTY: 14 last turn, no category 4 finish, no category 4 in flight +0, export_control_escalation t13 −2 (largest of two takeaways, embodied_ai_deployment also qualifies), capability rose 0.5 −0 = 12
## Store changes
```json
