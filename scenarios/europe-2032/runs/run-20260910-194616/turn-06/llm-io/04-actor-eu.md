...
- characters 454-1741: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1784-4063: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4131-4580: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7167-9600: `{{previous_actions}}` from the actor's own response from the previous turn
