...
- characters 376-1663: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1706-3985: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4041-5227: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5290-31300: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31655-32166: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Sovereign Essential Workloads Programme −2, priority −1 = −9
PROPOSAL BONUS: EU Sovereign Essential Workloads Programme (cat 9, small) +4 — eu_frontier_access_denied and cyber_major_incident both severe and this turn, this answers fallback and continued care directly
LEGITIMACY LENDS: capital 22, sentiment 20 -> none, capital higher
SOVEREIGNTY: 14 last turn, no capacity measure finishes t5, builds in flight +0, eu_frontier_access_denied t5 −2, capability rose 1.5 −0 = 12

## Emerging developments (tracked)

- `emergent_anti_datacentre_backlash` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated physical sabotage and blockades against data-centre construction and grid upgrade sites in two or more member states, driven by resentment over outages, fraud and power costs, delaying builds by months.
- `emergent_cyber_insurance_retreat` -- first noted turn 4, listed in 2 turn(s) so far: A major European insurer withdraws cyber cover for municipalities and hospitals after the autumn automated attacks, forcing emergency state backstops and freezing outsourcing of AI-enabled e-services.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, ai_investment_collapse, eval_anomaly_reports, taiwan_tension_rise
- Turn 2 (4 turn(s) ago): safety_breakthrough, knowledge_work_augmented, supply_chain_coercion
- Turn 3 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings
- Turn 4 (2 turn(s) ago): cyber_major_incident, safety_breakthrough, eu_frontier_access_denied, member_state_defection, joint_threat_response
- Turn 5 (1 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, election_consolidation
