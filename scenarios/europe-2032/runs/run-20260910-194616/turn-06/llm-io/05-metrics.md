...
- characters 13710-14997: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15040-17319: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17375-17931: `{{notepad}}` from the Game Master's notepad, carried across turns
