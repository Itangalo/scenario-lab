...
- characters 455-2472: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2515-4416: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6007-6456: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9413-11738: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Deployed Assurance Uptake | 5 | small | 9 | 11 | own jurisdiction | ai_safety up, resilience up slightly, public_sentiment up slightly | 2 | running |
