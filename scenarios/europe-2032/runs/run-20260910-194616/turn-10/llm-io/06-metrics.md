...
- characters 13457-13649: `{{metrics_json}}` from the run's live metric values
- characters 13742-15759: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15802-17703: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17759-18179: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Essential Services Restoration and Hardening Surge | 2 |
