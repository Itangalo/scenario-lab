...
- characters 377-2394: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2437-4338: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4394-4814: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4877-31625: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31980-32735: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): safety_breakthrough, knowledge_work_augmented, supply_chain_coercion
- Turn 3 (7 turn(s) ago): cyber_major_incident, bio_uplift_findings
- Turn 4 (6 turn(s) ago): cyber_major_incident, safety_breakthrough, eu_frontier_access_denied, member_state_defection, joint_threat_response
- Turn 5 (5 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, election_consolidation
- Turn 7 (3 turn(s) ago): openweight_frontier_release, automated_decision_scandal
- Turn 8 (2 turn(s) ago): taiwan_blockade, bio_uplift_findings, knowledge_work_augmented
