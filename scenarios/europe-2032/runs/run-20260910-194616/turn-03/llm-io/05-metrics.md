...
- characters 13797-16094: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16138-19082: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 19138-19687: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Active Incident Response and Essential Services Continuity Surge | 3 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Cyber Shield −3, EU Lithography Leverage Compact −2, priority −1 = −12
PROPOSAL BONUS: none — new Compact answers coercion over lithography, but broad productivity gains without job losses leave public unable to feel urgency, so no legitimacy bonus accrues
LEGITIMACY LENDS: capital 18, sentiment 42 -> +2
SOVEREIGNTY: 21 last turn, no capacity event finishes, Gigafactories in flight +0, supply_chain_coercion t2 −2, capability rose 2.0 −1 = 18
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 53.0, "ai_safety": 35.0, "resilience": 41.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 33.0, "public_sentiment": 35.0}
```
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Lithography Leverage Compact −2, EU Active Incident Response and Essential Services Continuity Surge −3, priority −1 = −12
PROPOSAL BONUS: EU Active Incident Response and Essential Services Continuity Surge (cat 6, large) +4 — cyber_major_incident landed this turn severe and public and this answers it directly, bio precursor watched
LEGITIMACY LENDS: capital 31, sentiment 35 -> +2
SOVEREIGNTY: 18 last turn, no capacity event, Gigafactories in flight +0, capability rose 2.0 −1 = 17

## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M5", "fields": {"finish_turn": 4}, "grounds": "named priority"}]}
```
```
