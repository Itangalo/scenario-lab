...
- characters 377-1362: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1406-3556: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3612-4889: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4952-32843: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33198-33611: `{{event_history}}` from the run's own event record
...
- `emergent_anti_datacentre_backlash` -- first noted turn 4, listed in 1 turn(s) so far: Coordinated physical sabotage and blockades against data-centre construction and grid upgrade sites in two or more member states, driven by resentment over outages, fraud and power costs, delaying builds by months.
- `emergent_cyber_insurance_retreat` -- first noted turn 4, listed in 1 turn(s) so far: A major European insurer withdraws cyber cover for municipalities and hospitals after the autumn automated attacks, forcing emergency state backstops and freezing outsourcing of AI-enabled e-services.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, ai_investment_collapse, eval_anomaly_reports, taiwan_tension_rise
- Turn 2 (3 turn(s) ago): safety_breakthrough, knowledge_work_augmented, supply_chain_coercion
- Turn 3 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings
- Turn 4 (1 turn(s) ago): cyber_major_incident, safety_breakthrough, eu_frontier_access_denied, member_state_defection, joint_threat_response
