...
- characters 106-13617: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13660-13852: `{{metrics_json}}` from the run's live metric values
- characters 13945-14930: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14974-17124: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17180-18457: `{{notepad}}` from the Game Master's notepad, carried across turns
