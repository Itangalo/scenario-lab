...
- characters 1484-3634: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5410-5870: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8276-10325: `{{previous_actions}}` from the actor's own response from the previous turn
