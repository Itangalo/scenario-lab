...
- characters 107-13482: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13525-13717: `{{metrics_json}}` from the run's live metric values
- characters 13810-15319: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15363-17028: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17084-17927: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M11 | EU Welfare AI Redress and Recertification Freeze | 2 |
...
PORTFOLIO CHARGE t10: EU Deployed Assurance Uptake −2, EU Essential Services Restoration and Hardening Surge −2, priority −1 = −5
PROPOSAL BONUS: none — knowledge_work_augmented removes felt displacement crisis, so bonus for answering recent negative event does not apply despite cyber_major_incident
