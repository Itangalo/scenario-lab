...
- characters 378-1887: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1931-3596: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3652-4109: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4172-30920: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31275-32105: `{{event_history}}` from the run's own event record
...
- Turn 2 (9 turn(s) ago): safety_breakthrough, knowledge_work_augmented, supply_chain_coercion
- Turn 3 (8 turn(s) ago): cyber_major_incident, bio_uplift_findings
- Turn 4 (7 turn(s) ago): cyber_major_incident, safety_breakthrough, eu_frontier_access_denied, member_state_defection, joint_threat_response
- Turn 5 (6 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, election_consolidation
- Turn 7 (4 turn(s) ago): openweight_frontier_release, automated_decision_scandal
- Turn 8 (3 turn(s) ago): taiwan_blockade, bio_uplift_findings, knowledge_work_augmented
- Turn 9 (2 turn(s) ago): safety_breakthrough, export_control_escalation
