...
- characters 456-1965: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2009-3674: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5602-6097: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9062-11713: `{{previous_actions}}` from the actor's own response from the previous turn
