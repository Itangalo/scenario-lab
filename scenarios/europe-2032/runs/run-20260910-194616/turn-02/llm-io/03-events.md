...
- characters 1709-4165: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4221-4997: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5060-28693: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29048-29156: `{{event_history}}` from the run's own event record
