...
- characters 377-1538: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1581-3338: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3394-4239: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4302-31050: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31405-32312: `{{event_history}}` from the run's own event record
...
- Turn 2 (10 turn(s) ago): safety_breakthrough, knowledge_work_augmented, supply_chain_coercion
- Turn 3 (9 turn(s) ago): cyber_major_incident, bio_uplift_findings
- Turn 4 (8 turn(s) ago): cyber_major_incident, safety_breakthrough, eu_frontier_access_denied, member_state_defection, joint_threat_response
- Turn 5 (7 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, election_consolidation
- Turn 7 (5 turn(s) ago): openweight_frontier_release, automated_decision_scandal
- Turn 8 (4 turn(s) ago): taiwan_blockade, bio_uplift_findings, knowledge_work_augmented
- Turn 9 (3 turn(s) ago): safety_breakthrough, export_control_escalation
- Turn 10 (2 turn(s) ago): cyber_major_incident, knowledge_work_augmented
- Turn 11 (1 turn(s) ago): eval_anomaly_reports, automated_decision_scandal
