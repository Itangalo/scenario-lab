...
- `two_year_commitment` (commitment): Secure a sovereign foundation for AI capability while containing the risk of uncontrolled escalation.

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure a sovereign foundation for AI capability while containing the risk of uncontrolled escalation.
