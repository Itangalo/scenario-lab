...
- characters 105-13497: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13540-13732: `{{metrics_json}}` from the run's live metric values
- characters 13825-15699: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15742-17995: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18051-18590: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Emergency Authentication Shield against Synthetic Fraud | 2 |
