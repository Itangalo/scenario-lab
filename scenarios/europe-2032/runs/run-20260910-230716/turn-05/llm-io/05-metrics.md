...
- characters 106-13578: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13621-13813: `{{metrics_json}}` from the run's live metric values
- characters 13906-15241: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15285-17740: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17796-18737: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_fraud_insurance_retreat` -- first noted turn 5, listed in 1 turn(s) so far: Insurers across several member states temporarily exclude AI-enabled fraud and system-outage losses from standard business policies after the voice-clone wave, forcing SMEs and municipalities to self-insure.
...
## Metrics
```json
{"ai_capability": 59.0, "openweight_capability": 55.8, "ai_safety": 24.0, "resilience": 47.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 14.0, "public_sentiment": 16.0}
```
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Emergency Authentication Shield against Synthetic Fraud −2, priority −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 15, sentiment 16 -> +2 (capped, then election shock −3 to 14)
