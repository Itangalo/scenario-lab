...
- characters 377-1712: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1756-4211: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4267-4875: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4938-27559: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27914-28329: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, knowledge_work_augmented, eu_frontier_access_denied, adoption_success
- Turn 3 (2 turn(s) ago): cyber_major_incident, knowledge_work_augmented, taiwan_tension_rise
- Turn 4 (1 turn(s) ago): export_control_escalation, eu_frontier_access_denied, emergent_synthetic_fraud_wave
