...
- characters 5988-6460: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7932-10059: `{{previous_actions}}` from the actor's own response from the previous turn
