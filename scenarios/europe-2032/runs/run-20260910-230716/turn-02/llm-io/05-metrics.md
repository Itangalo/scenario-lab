...
- characters 105-13035: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13078-13270: `{{metrics_json}}` from the run's live metric values
- characters 13363-14500: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14543-16572: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16628-17717: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Store changes
```json
{"store": [{"op": "update", "table": "measures", "id": "M3", "fields": {"finish_turn": 5}, "grounds": "named priority"}, {"op": "update", "table": "measures", "id": "M1", "fields": {"finish_turn": 7}, "grounds": "event ai_investment_collapse delayed private co-investment"}]}
```
```
