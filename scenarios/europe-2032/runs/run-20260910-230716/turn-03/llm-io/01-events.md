...
- characters 377-1987: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2031-4351: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4407-5597: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5660-28281: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28636-28847: `{{event_history}}` from the run's own event record
...
- `emergent_municipal_fraud_wave` -- first noted turn 2, listed in 1 turn(s) so far: Coordinated AI-generated fraud and extortion wave hits municipal services and hospitals already exposed by the autumn drills, using open-weight models for multilingual phishing and deepfake invoices, causing public losses but no infrastructure destruction.
- `emergent_synthetic_fraud_wave` -- first noted turn 2, listed in 1 turn(s) so far: Coordinated AI-generated voice and video fraud wave hits several EU banks and public administrations, causing hundreds of millions in losses and forcing emergency authentication changes.
...
- Turn 2 (1 turn(s) ago): cyber_major_incident, ai_investment_collapse, cyber_defence_breakthrough, knowledge_work_augmented, eu_frontier_access_denied, adoption_success
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.03}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.04}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.15}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.14}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.01}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.13}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Coordinated AI-generated fraud and extortion wave hits municipal services and hospitals already exposed by the autumn drills, using open-weight models for multilingual phishing and deepfake invoices, causing public losses but no infrastructure destruction.", "emergent": true, "id": "emergent_municipal_fraud_wave", "probability": 0.22}, {"description": "Coordinated AI-generated voice and video fraud wave hits several EU banks and public administrations, causing hundreds of millions in losses and forcing emergency authentication changes.", "emergent": true, "id": "emergent_synthetic_fraud_wave", "probability": 0.2}]
```
