...
- characters 13420-15030: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15074-17394: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17450-18640: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Critical Supply Buffer for Taiwan Shock | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, EU Essential Services Continuity Stack −2, priority −1 = −12
PROPOSAL BONUS: EU Essential Services Continuity Stack (cat 6, small) +3 — cutoff of frontier access plus large automated attack landed this turn and this answers both directly
LEGITIMACY LENDS: capital 28, sentiment 32 -> +2
SOVEREIGNTY: 22 last turn, no capacity event finishes, Gigafactories in flight +0, eu_frontier_access_denied t2 −3, capability rose 1.0 −0 = 19

## Emerging developments (tracked)

- `emergent_municipal_fraud_wave` -- first noted turn 2, listed in 2 turn(s) so far: Coordinated AI-generated fraud and extortion wave hits municipal services and hospitals already exposed by the autumn drills, using open-weight models for multilingual phishing and deepfake invoices, causing public losses but no infrastructure destruction.
- `emergent_synthetic_fraud_wave` -- first noted turn 2, listed in 2 turn(s) so far: Coordinated AI-generated voice and video fraud wave hits several EU banks and public administrations, causing hundreds of millions in losses and forcing emergency authentication changes.
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, EU Essential Services Continuity Stack −2, EU Critical Supply Buffer for Taiwan Shock −2, priority −1 = −14
PROPOSAL BONUS: EU Critical Supply Buffer for Taiwan Shock (cat 6, small) +2 — taiwan_tension_rise precursor opened this turn and this answers it directly, small and early
LEGITIMACY LENDS: capital 18, sentiment 32 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 19
