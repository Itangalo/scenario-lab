...
- characters 454-2053: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2096-4209: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4277-4717: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6626-7890: `{{previous_actions}}` from the actor's own response from the previous turn
