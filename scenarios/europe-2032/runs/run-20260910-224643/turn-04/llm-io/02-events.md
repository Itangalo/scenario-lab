...
- characters 376-1975: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2018-4131: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4187-4944: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5007-31951: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32306-32459: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU AI Evaluation and Safety Institute −3, EU Essential Services Cyber Shield −2, priority −1 = −12
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 9, sentiment 38 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, Gigafactories in flight +0, capability rose 3.0 −1 = 19

## Emerging developments (tracked)

- `emergent_inference_throttling` -- first noted turn 2, listed in 2 turn(s) so far: A major US hyperscaler quietly throttles inference capacity available to EU enterprise customers during peak demand, citing domestic load and new review requirements, forcing temporary service degradation in firms and public bodies built on its models.
...
- Turn 2 (2 turn(s) ago): openweight_frontier_release
- Turn 3 (1 turn(s) ago): emergent_energy_siting_backlash
