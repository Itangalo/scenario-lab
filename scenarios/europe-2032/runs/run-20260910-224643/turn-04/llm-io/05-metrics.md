...
- characters 105-13578: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13621-13813: `{{metrics_json}}` from the run's live metric values
- characters 13906-15505: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15548-17661: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17717-18099: `{{notepad}}` from the Game Master's notepad, carried across turns
