...
- characters 105-13173: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13216-13408: `{{metrics_json}}` from the run's live metric values
- characters 13501-14668: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14711-16966: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17022-18082: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Essential Services Cyber Shield | 2 |
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 50.0, "ai_safety": 30.0, "resilience": 37.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 26.0, "public_sentiment": 40.0}
```
