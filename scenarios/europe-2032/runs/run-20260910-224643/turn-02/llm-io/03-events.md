...
- characters 1586-3841: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3897-4312: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4375-27452: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27807-27848: `{{event_history}}` from the run's own event record
