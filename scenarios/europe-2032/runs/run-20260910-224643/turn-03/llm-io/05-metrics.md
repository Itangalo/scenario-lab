...
- characters 13502-15064: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15108-17152: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17208-18093: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 54.0, "ai_safety": 28.0, "resilience": 36.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 11.0, "public_sentiment": 38.0}
```
