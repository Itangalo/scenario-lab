...
- characters 377-2077: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2121-4055: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4111-4441: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- characters 32407-32560: `{{event_history}}` from the run's own event record
...
- Turn 3 (2 turn(s) ago): emergent_energy_siting_backlash
