...
| M7 | EU Municipal Cyber Restoration Surge | 6 | small | 8 | 10 | own jurisdiction | resilience up, eu_political_capital up modestly via visible response | 2 | running |
...
- **applied** `M7` — {"op": "add", "table": "measures", "fields": {"name": "EU Municipal Cyber Restoration Surge", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_political_capital up modestly via visible response"}, "grounds": "major automated attack requires immediate restoration response"}
  - Grounds: major automated attack requires immediate restoration response
