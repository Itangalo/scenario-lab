...
- `two_year_commitment` (commitment): Rebuild trust through resilient services and accountable public AI that visibly works

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild trust through resilient services and accountable public AI that visibly works
