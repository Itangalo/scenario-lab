...
- characters 13716-15146: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15189-17434: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17490-18282: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Frontier Anomaly Triage Cell | 2 |
...
- `emergent_hyperscaler_gigafactory_exit` -- first noted turn 3, listed in 2 turn(s) so far: The two absent hyperscaler partners formally withdraw from the EU gigafactory land-and-power deals, forcing a public search for replacement investors and a writedown of the build-out timeline.
...
## Notepad
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Frontier Anomaly Triage Cell −2, priority −1 = −9
PROPOSAL BONUS: none — EU Frontier Anomaly Triage Cell (cat 5, small) answers eval-anomaly precursor, but knowledge_work_augmented removes recent-negative-event bonus and precursor alone does not pay it
LEGITIMACY LENDS: capital 33, sentiment 36 -> +2
