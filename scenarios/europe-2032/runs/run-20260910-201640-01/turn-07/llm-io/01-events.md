...
- characters 377-1348: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1392-3713: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3769-4332: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4395-31008: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31363-31842: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, ai_investment_collapse
- Turn 2 (5 turn(s) ago): cyber_major_incident
- Turn 3 (4 turn(s) ago): bio_uplift_findings
- Turn 4 (3 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented
- Turn 5 (2 turn(s) ago): openweight_frontier_release, safety_breakthrough, election_consolidation
- Turn 6 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, cyber_defence_breakthrough, safety_breakthrough, eu_frontier_access_denied
