...
- characters 106-13509: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13552-13744: `{{metrics_json}}` from the run's live metric values
- characters 13837-14808: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14852-17173: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17229-18398: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Allied Access and Chokepoint Compact | 2 |
...
## Metrics
```json
{"ai_capability": 63.0, "openweight_capability": 60.2, "ai_safety": 35.0, "resilience": 50.0, "eu_ai_sovereignty": 26.0, "eu_political_capital": 27.0, "public_sentiment": 24.0}
```
