...
- characters 105-13372: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13415-13607: `{{metrics_json}}` from the run's live metric values
- characters 13700-15000: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15043-17054: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17110-18496: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Incident Containment and Recovery Surge | 2 |
...
## Notepad
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Incident Containment and Recovery Surge −2, priority −1 = −9
PROPOSAL BONUS: EU Incident Containment and Recovery Surge (cat 6, small) +3 — cyber_major_incident landed this turn and this answers it directly
LEGITIMACY LENDS: capital 40, sentiment 32 -> none, capital higher
