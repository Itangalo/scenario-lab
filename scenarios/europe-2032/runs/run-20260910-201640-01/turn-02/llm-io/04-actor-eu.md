...
- characters 454-1754: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1797-3808: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4358-4828: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6606-8802: `{{previous_actions}}` from the actor's own response from the previous turn
