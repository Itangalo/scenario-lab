...
- characters 1517-3684: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5865-6333: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8800-11477: `{{previous_actions}}` from the actor's own response from the previous turn
