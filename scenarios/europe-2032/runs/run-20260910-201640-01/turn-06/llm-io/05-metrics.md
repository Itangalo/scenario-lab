...
- characters 13776-14796: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14839-17006: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17062-17557: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | EU Essential Services Continuity and Sovereign Fallback | 2 |
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Allied Access and Chokepoint Compact −2, priority −1 = −9
PROPOSAL BONUS: EU Allied Access and Chokepoint Compact (cat 8, small) +2 — answers tiered-access threat signalled by US election and open-weight permanence, recent and direct but small and pre-inauguration
LEGITIMACY LENDS: capital 28, sentiment 37 -> +2
