...
- characters 1439-3606: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3662-4157: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4220-30230: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30585-30915: `{{event_history}}` from the run's own event record
...
- Turn 2 (4 turn(s) ago): cyber_major_incident
- Turn 3 (3 turn(s) ago): bio_uplift_findings
- Turn 4 (2 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented
- Turn 5 (1 turn(s) ago): openweight_frontier_release, safety_breakthrough, election_consolidation
