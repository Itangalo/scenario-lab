...
- characters 1513-3829: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3885-4691: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4754-32645: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33000-33231: `{{event_history}}` from the run's own event record
