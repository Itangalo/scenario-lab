...
- characters 13673-14765: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14809-17125: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17181-17664: `{{notepad}}` from the Game Master's notepad, carried across turns
