...
- characters 1591-3907: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5500-5970: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8208-10275: `{{previous_actions}}` from the actor's own response from the previous turn
