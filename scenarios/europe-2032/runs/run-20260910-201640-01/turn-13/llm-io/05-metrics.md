...
- characters 107-13530: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13573-13765: `{{metrics_json}}` from the run's live metric values
- characters 13858-15159: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15203-17235: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17291-17716: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M15 | EU Sovereign Fallback Activation | 2 |
...
PORTFOLIO CHARGE t12: EU Joint Shield Accession −2, EU Unrecallable-Capability Absorption −2, priority −1 = −5
PROPOSAL BONUS: EU Unrecallable-Capability Absorption (cat 6, small) +2 — openweight frontier-near release last turn answers unrecallable kits directly
...
## Metrics
```json
{"ai_capability": 70.0, "openweight_capability": 67.5, "ai_safety": 11.0, "resilience": 62.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 34.0, "public_sentiment": 10.0}
```
...
## Notepad
PORTFOLIO CHARGE t13: EU Sovereign Fallback Activation −2, priority −1 = −3
PROPOSAL BONUS: EU Sovereign Fallback Activation (cat 6, small) +4 — cyber_major_incident plus frontier cutoff plus blockade last/this turn answers directly
LEGITIMACY LENDS: capital 33, sentiment 16 -> none, capital higher
SOVEREIGNTY: 24 last turn, no cat4 finish, no cat4 in flight +0, eu_frontier_access_denied t13 −3, capability rose 1.5 −0 = 21
