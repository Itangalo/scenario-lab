...
- characters 13703-14660: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14704-16777: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16833-17611: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Bio Shield – Screening and Detection Surge | 2 |
...
- `emergent_hyperscaler_gigafactory_exit` -- first noted turn 3, listed in 1 turn(s) so far: The two absent hyperscaler partners formally withdraw from the EU gigafactory land-and-power deals, forcing a public search for replacement investors and a writedown of the build-out timeline.
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Bio Shield – Screening and Detection Surge −2, priority −1 = −9
PROPOSAL BONUS: EU Bio Shield – Screening and Detection Surge (cat 6, small) +3 — bio_uplift_findings precursor fired this turn and this answers it directly
LEGITIMACY LENDS: capital 39, sentiment 31 -> none, capital higher
