...
- characters 376-1170: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1213-3279: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3335-4439: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4502-30418: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30773-31360: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: EU Allied Access and Chokepoint Compact −2, EU Sovereign Assurance Stack −2, priority −1 = −5
PROPOSAL BONUS: EU Sovereign Assurance Stack (cat 5, small) +2 — opaque_reasoning and cyber_major_incident both firing this turn, answers loss of chain-of-thought oversight directly
LEGITIMACY LENDS: capital 27, sentiment 24 -> none, capital higher
SOVEREIGNTY: 21 last turn, InvestAI Gigafactories finishes t7 +5, no capacity event, no cat4 in flight +0, capability rose 1.0 −0 = 26

## Emerging developments (tracked)

- `emergent_insurance_retrenchment` -- first noted turn 7, listed in 1 turn(s) so far: Major European insurers jointly withdraw or reprice cyber-extortion coverage for public-sector operators after the H1 ransomware wave, forcing emergency state backstops for municipalities and clinics.
- `emergent_grassroots_continuity_standard` -- first noted turn 7, listed in 1 turn(s) so far: Municipal and clinical staff who ran the 72-hour manual drills publish open playbooks that spread to other sectors, creating a de facto EU continuity standard outside Brussels programs.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, ai_investment_collapse
- Turn 2 (6 turn(s) ago): cyber_major_incident
- Turn 3 (5 turn(s) ago): bio_uplift_findings
- Turn 4 (4 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented
- Turn 5 (3 turn(s) ago): openweight_frontier_release, safety_breakthrough, election_consolidation
- Turn 6 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, cyber_defence_breakthrough, safety_breakthrough, eu_frontier_access_denied
- Turn 7 (1 turn(s) ago): cyber_major_incident, opaque_reasoning, medical_breakthrough, safety_breakthrough
