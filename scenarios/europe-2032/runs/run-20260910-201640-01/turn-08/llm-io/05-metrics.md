...
- characters 105-13423: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13466-13658: `{{metrics_json}}` from the run's live metric values
- characters 13751-14545: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14588-16654: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16710-17814: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Sovereign Assurance Stack | 2 |
| M10 | EU Agent Containment and Continuity Protocol | 2 |
...
- `emergent_insurance_retrenchment` -- first noted turn 7, listed in 2 turn(s) so far: Major European insurers jointly withdraw or reprice cyber-extortion coverage for public-sector operators after the H1 ransomware wave, forcing emergency state backstops for municipalities and clinics.
- `emergent_grassroots_continuity_standard` -- first noted turn 7, listed in 2 turn(s) so far: Municipal and clinical staff who ran the 72-hour manual drills publish open playbooks that spread to other sectors, creating a de facto EU continuity standard outside Brussels programs.
...
## Notepad
PORTFOLIO CHARGE t8: EU Sovereign Assurance Stack −2, EU Agent Containment and Continuity Protocol −2, priority −1 = −5
PROPOSAL BONUS: EU Agent Containment and Continuity Protocol (cat 6, small) +2 — loss-of-control incident firing this turn, answers unsanctioned agentic action directly
LEGITIMACY LENDS: capital 30, sentiment 22 -> none, capital higher
SOVEREIGNTY: 26 last turn, M7 finishes t8 cat8 +0, no cat4 in flight +0, export_control_escalation t8 −2, capability rose 1.0 −0 = 24
## Store changes
```json
