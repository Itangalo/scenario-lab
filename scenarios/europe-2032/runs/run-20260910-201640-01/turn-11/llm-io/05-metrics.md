...
- characters 107-13325: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13368-13560: `{{metrics_json}}` from the run's live metric values
- characters 13653-14571: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14615-16882: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16938-17642: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Small-Operator Shield Surge | 2 |
| M13 | EU Joint Shield Accession | 2 |
...
PORTFOLIO CHARGE t10: EU Shielded Operations Upgrade −2, EU Small-Operator Shield Surge −2, priority −1 = −5
PROPOSAL BONUS: EU Small-Operator Shield Surge (cat 6, small) +3 — cyber_major_incident landed this turn severe and this answers two-tier gap directly
LEGITIMACY LENDS: capital 36, sentiment 20 -> none, capital higher
SOVEREIGNTY: 24 last turn, no capacity event, no cat4 in flight +0, capability rose 1.0 −0 = 24

## Emerging developments (tracked)

- `emergent_datacentre_backlash` -- first noted turn 10, listed in 2 turn(s) so far: Coordinated physical protests and grid-connection lawsuits stall several EU data-centre expansions, forcing a temporary moratorium debate in two member states.
...
## Metrics
```json
{"ai_capability": 67.5, "openweight_capability": 65.3, "ai_safety": 23.0, "resilience": 55.0, "eu_ai_sovereignty": 24.0, "eu_political_capital": 38.0, "public_sentiment": 17.0}
```
...
## Notepad
PORTFOLIO CHARGE t11: EU Small-Operator Shield Surge −2, EU Joint Shield Accession −2, priority −1 = −5
PROPOSAL BONUS: EU Joint Shield Accession (cat 8, small) +2 — cyber_major_incident, loss_of_control and bio signal in last turn and this answers pooled-detection gap directly
LEGITIMACY LENDS: capital 38, sentiment 17 -> none, capital higher
SOVEREIGNTY: 24 last turn, no capacity event, no cat4 in flight +0, capability rose 1.0 −0 = 24
