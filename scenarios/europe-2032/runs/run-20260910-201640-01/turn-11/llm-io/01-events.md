...
- characters 378-1296: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1340-3607: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3663-4367: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4430-31199: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31554-32438: `{{event_history}}` from the run's own event record
...
- Turn 2 (9 turn(s) ago): cyber_major_incident
- Turn 3 (8 turn(s) ago): bio_uplift_findings
- Turn 4 (7 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented
- Turn 5 (6 turn(s) ago): openweight_frontier_release, safety_breakthrough, election_consolidation
- Turn 6 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, cyber_defence_breakthrough, safety_breakthrough, eu_frontier_access_denied
- Turn 7 (4 turn(s) ago): cyber_major_incident, opaque_reasoning, medical_breakthrough, safety_breakthrough
- Turn 8 (3 turn(s) ago): loss_of_control_incident, research_breakthrough, export_control_escalation
- Turn 9 (2 turn(s) ago): capability_jump, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 10 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release
