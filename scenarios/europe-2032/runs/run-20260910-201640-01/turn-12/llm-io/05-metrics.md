...
- characters 106-13332: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13375-13567: `{{metrics_json}}` from the run's live metric values
- characters 13660-15110: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15153-17274: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17330-17771: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M14 | EU Unrecallable-Capability Absorption | 2 |
...
## Metrics
```json
{"ai_capability": 68.5, "openweight_capability": 66.0, "ai_safety": 21.0, "resilience": 58.0, "eu_ai_sovereignty": 24.0, "eu_political_capital": 33.0, "public_sentiment": 16.0}
```
