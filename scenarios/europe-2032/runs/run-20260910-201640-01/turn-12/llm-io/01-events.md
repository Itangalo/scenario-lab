...
- characters 377-1827: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1870-3991: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4047-4770: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4833-31602: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31957-32978: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, ai_investment_collapse
- Turn 2 (10 turn(s) ago): cyber_major_incident
- Turn 3 (9 turn(s) ago): bio_uplift_findings
- Turn 4 (8 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented
- Turn 5 (7 turn(s) ago): openweight_frontier_release, safety_breakthrough, election_consolidation
- Turn 6 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident, cyber_defence_breakthrough, safety_breakthrough, eu_frontier_access_denied
- Turn 7 (5 turn(s) ago): cyber_major_incident, opaque_reasoning, medical_breakthrough, safety_breakthrough
- Turn 8 (4 turn(s) ago): loss_of_control_incident, research_breakthrough, export_control_escalation
- Turn 9 (3 turn(s) ago): capability_jump, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 10 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, openweight_frontier_release
- Turn 11 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, bio_uplift_findings, adoption_success, joint_threat_response
