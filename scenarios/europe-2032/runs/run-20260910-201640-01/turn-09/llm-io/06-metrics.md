...
- characters 13804-14959: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15003-16981: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17037-17526: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 65.5, "openweight_capability": 63.0, "ai_safety": 27.0, "resilience": 52.0, "eu_ai_sovereignty": 24.0, "eu_political_capital": 36.0, "public_sentiment": 27.0}
```
