...
- characters 377-1532: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1576-3554: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3610-4705: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4768-30684: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31039-31727: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, ai_investment_collapse
- Turn 2 (7 turn(s) ago): cyber_major_incident
- Turn 3 (6 turn(s) ago): bio_uplift_findings
- Turn 4 (5 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented
- Turn 5 (4 turn(s) ago): openweight_frontier_release, safety_breakthrough, election_consolidation
- Turn 6 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, cyber_defence_breakthrough, safety_breakthrough, eu_frontier_access_denied
- Turn 7 (2 turn(s) ago): cyber_major_incident, opaque_reasoning, medical_breakthrough, safety_breakthrough
- Turn 8 (1 turn(s) ago): loss_of_control_incident, research_breakthrough, export_control_escalation
