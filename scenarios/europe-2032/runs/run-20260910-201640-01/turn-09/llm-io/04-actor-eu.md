...
- characters 455-1610: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1654-3632: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5453-5921: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8750-10954: `{{previous_actions}}` from the actor's own response from the previous turn
