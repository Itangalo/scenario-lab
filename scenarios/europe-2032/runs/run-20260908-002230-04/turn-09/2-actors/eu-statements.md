...
- `two_year_commitment` (commitment): Secure sovereign AI infrastructure and ensure its legitimacy

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign AI infrastructure and ensure its legitimacy
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the timeframe during which the original statement was valid, changing the cost and relevance of maintaining it.
