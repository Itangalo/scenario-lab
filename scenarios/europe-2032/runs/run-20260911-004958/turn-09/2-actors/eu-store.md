...
| M8 | EU Bio-Containment and Essential Service Shield | 6 | small | 7 | 8 | own jurisdiction | resilience up moderately, ai_safety protected, public_sentiment protected | 2 | finished |
| M9 | EU Supervised-Operations Continuity Regime | 6 | small | 8 | 9 | own jurisdiction | resilience up modestly, ai_safety protected, public_sentiment protected | 2 | finished |
| M10 | EU Cut-Off Fallback and Cyber Restoration Regime | 6 | small | 9 | 11 | own jurisdiction | resilience up modestly, public_sentiment protected, eu_political_capital protected | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Cut-Off Fallback and Cyber Restoration Regime", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up modestly, public_sentiment protected, eu_political_capital protected"}, "grounds": "frontier denial plus major cyber incident on unreadable models"}
  - Grounds: frontier denial plus major cyber incident on unreadable models
