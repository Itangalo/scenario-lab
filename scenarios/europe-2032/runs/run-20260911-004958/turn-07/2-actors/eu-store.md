...
| M8 | EU Bio-Containment and Essential Service Shield | 6 | small | 7 | 9 | own jurisdiction | resilience up moderately, ai_safety protected, public_sentiment protected | 2 | running |
...
- **applied** `M8` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio-Containment and Essential Service Shield", "category": 6, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, ai_safety protected, public_sentiment protected"}, "grounds": "bio incident plus uplift findings demand immediate response"}
  - Grounds: bio incident plus uplift findings demand immediate response
