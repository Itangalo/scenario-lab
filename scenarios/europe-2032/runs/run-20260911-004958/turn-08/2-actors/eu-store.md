...
| M9 | EU Supervised-Operations Continuity Regime | 6 | small | 8 | 10 | own jurisdiction | resilience up modestly, ai_safety protected, public_sentiment protected | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Supervised-Operations Continuity Regime", "category": 6, "size": "small", "finish_turn": 10, "applies_to": "own jurisdiction", "targeted_effect": "resilience up modestly, ai_safety protected, public_sentiment protected"}, "grounds": "opaque reasoning plus capability jump removes readable oversight"}
  - Grounds: opaque reasoning plus capability jump removes readable oversight
