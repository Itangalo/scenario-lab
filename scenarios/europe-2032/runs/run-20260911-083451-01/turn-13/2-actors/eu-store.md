...
| M9 | EU Hospital and Dispatch Staff Retention Pact | 7 | small | 11 | 13 | own jurisdiction | resilience up modestly, eu_political_capital up modestly if services hold | 2 | finished |
| M10 | EU Municipal Offline Continuity Corps | 6 | small | 13 | 15 | own jurisdiction | resilience up modestly, eu_political_capital up modestly if services hold | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU Municipal Offline Continuity Corps", "category": 6, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up modestly, eu_political_capital up modestly if services hold"}, "grounds": "to hold essential services through cutoff and attack with no headroom"}
  - Grounds: to hold essential services through cutoff and attack with no headroom
