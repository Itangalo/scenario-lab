...
- characters 453-1944: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1988-4056: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6822-7320: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9626-10933: `{{previous_actions}}` from the actor's own response from the previous turn
