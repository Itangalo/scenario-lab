...
- characters 106-13459: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13502-13692: `{{metrics_json}}` from the run's live metric values
- characters 13785-15276: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15320-17388: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17444-18165: `{{notepad}}` from the Game Master's notepad, carried across turns
