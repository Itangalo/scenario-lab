...
- characters 375-1866: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1910-3978: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4034-4755: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4818-32859: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33214-34047: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M6 EU Displacement and Embodied-AI Transition Shield −2, M7 EU Cutoff Continuity and Joint Threat Adhesion −2, priority M7 −1 = −5
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 1 -> none, sentiment not above capital
SOVEREIGNTY: 16 last turn, no category 4 finish, no in-flight bonus, eu_frontier_access_denied t8 −1, capability rose 3.0 −1 = 14

## Emerging developments (tracked)

- `emergent_eu_fallback_stack_diffusion` -- first noted turn 8, listed in 1 turn(s) so far: Municipal hospital federations publish an open fallback triage stack built on EU-pooled inference that other member states copy, easing cutoff pressure without US restoration.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release, automated_decision_scandal
- Turn 2 (7 turn(s) ago): taiwan_blockade, bio_uplift_findings, member_state_defection
- Turn 3 (6 turn(s) ago): cyber_major_incident
- Turn 4 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
- Turn 5 (4 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, supply_chain_coercion, member_state_defection, election_consolidation
- Turn 6 (3 turn(s) ago): rsi_onset, embodied_ai_deployment
- Turn 7 (2 turn(s) ago): export_control_escalation, us_china_agreement, eu_frontier_access_denied, adoption_success, joint_threat_response
- Turn 8 (1 turn(s) ago): eval_anomaly_reports, labour_displacement, eu_frontier_access_denied
