...
- characters 374-2055: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2099-4526: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4582-5394: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5457-31268: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31623-32835: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Cyber Restoration and Embodied-AI Containment Corps −2 = −2 + priority has no effect below 20, not charged
PROPOSAL BONUS: EU Cyber Restoration and Embodied-AI Containment Corps (cat 6, small) +3 — cyber_major_incident landed this turn and this answers restoration directly
LEGITIMACY LENDS: capital 3, sentiment 0 -> none, sentiment not above capital
SOVEREIGNTY: 5 last turn, no category 4 finish, no in-flight bonus, embodied_ai_deployment t12 −2, capability rose 1.5 (below 2, no −1) = 3

## Emerging developments (tracked)

- `emergent_infrastructure_sabotage_wave` -- first noted turn 11, listed in 2 turn(s) so far: A coordinated municipal blackout protest shuts down several planned data-centre and grid-upgrade sites across two member states for weeks, halting continuity works.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release, automated_decision_scandal
- Turn 2 (11 turn(s) ago): taiwan_blockade, bio_uplift_findings, member_state_defection
- Turn 3 (10 turn(s) ago): cyber_major_incident
- Turn 4 (9 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
- Turn 5 (8 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, supply_chain_coercion, member_state_defection, election_consolidation
- Turn 6 (7 turn(s) ago): rsi_onset, embodied_ai_deployment
- Turn 7 (6 turn(s) ago): export_control_escalation, us_china_agreement, eu_frontier_access_denied, adoption_success, joint_threat_response
- Turn 8 (5 turn(s) ago): eval_anomaly_reports, labour_displacement, eu_frontier_access_denied
- Turn 9 (4 turn(s) ago): loss_of_control_incident, bio_uplift_findings, eval_anomaly_reports, us_labs_nationalised
- Turn 10 (3 turn(s) ago): capability_jump, opaque_reasoning, member_state_defection
- Turn 11 (2 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, export_control_escalation
- Turn 12 (1 turn(s) ago): cyber_major_incident, embodied_ai_deployment
