...
- characters 107-13039: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13082-13270: `{{metrics_json}}` from the run's live metric values
- characters 13363-15044: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15088-17515: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17571-18087: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Neutrality Corridor and Middle-Power Supply Pact | 2 |
...
## Metrics
```json
{"ai_capability": 92.5, "openweight_capability": 88.9, "ai_safety": 0.0, "resilience": 48.0, "eu_ai_sovereignty": 1.0, "eu_political_capital": 4.0, "public_sentiment": 0.0}
```
