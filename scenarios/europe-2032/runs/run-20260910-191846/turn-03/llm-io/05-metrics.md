...
- characters 13378-15323: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15367-17554: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17610-18097: `{{notepad}}` from the Game Master's notepad, carried across turns
