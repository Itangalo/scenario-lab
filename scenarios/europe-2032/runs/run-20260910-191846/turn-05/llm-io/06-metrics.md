...
- characters 13344-15597: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15641-17806: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17862-18693: `{{notepad}}` from the Game Master's notepad, carried across turns
