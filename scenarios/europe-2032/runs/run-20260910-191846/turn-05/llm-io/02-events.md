...
- characters 377-2630: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2674-4839: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4895-5726: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5789-32619: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32974-33351: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, Municipal Care Continuity Corps −2, priority Municipal Care Continuity Corps −1 = −9
PROPOSAL BONUS: Municipal Care Continuity Corps (cat 6, small) +2 — cyber_major_incident and loss_of_control landed this turn and this answers periphery collapse directly
LEGITIMACY LENDS: capital 13, sentiment 20 -> +2
SOVEREIGNTY: 16 last turn, no capacity event, Gigafactories in flight +0, capability rose 3.0 −1 = 15

## Emerging developments (tracked)

- `emergent_liability_cascade` -- first noted turn 4, listed in 1 turn(s) so far: Municipal hospital federations and city councils hit by the autumn ransomware wave jointly sue a US frontier lab and an EU deployer for damages, creating a first cross-border AI liability case that courts cannot dismiss quickly.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release, automated_decision_scandal
- Turn 2 (3 turn(s) ago): taiwan_blockade, bio_uplift_findings, member_state_defection
- Turn 3 (2 turn(s) ago): cyber_major_incident
- Turn 4 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
