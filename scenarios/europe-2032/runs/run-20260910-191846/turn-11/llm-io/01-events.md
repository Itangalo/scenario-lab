...
- characters 374-1427: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1471-3493: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3549-4084: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4147-29958: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30313-31348: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: EU Essential Continuity and Agent Containment Pact −2 = −2 + priority has no effect below 20, not charged
PROPOSAL BONUS: EU Essential Continuity and Agent Containment Pact (cat 6, small) +3 — September agent actions, genome uplift finding and second US cutoff in last three turns, this answers them directly
LEGITIMACY LENDS: capital 4, sentiment 1 -> none, sentiment not above capital
SOVEREIGNTY: 11 last turn, no category 4 finish, no in-flight bonus, member_state_defection t10 −2, capability rose 4.5 −1 = 8
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release, automated_decision_scandal
- Turn 2 (9 turn(s) ago): taiwan_blockade, bio_uplift_findings, member_state_defection
- Turn 3 (8 turn(s) ago): cyber_major_incident
- Turn 4 (7 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
- Turn 5 (6 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, supply_chain_coercion, member_state_defection, election_consolidation
- Turn 6 (5 turn(s) ago): rsi_onset, embodied_ai_deployment
- Turn 7 (4 turn(s) ago): export_control_escalation, us_china_agreement, eu_frontier_access_denied, adoption_success, joint_threat_response
- Turn 8 (3 turn(s) ago): eval_anomaly_reports, labour_displacement, eu_frontier_access_denied
- Turn 9 (2 turn(s) ago): loss_of_control_incident, bio_uplift_findings, eval_anomaly_reports, us_labs_nationalised
- Turn 10 (1 turn(s) ago): capability_jump, opaque_reasoning, member_state_defection
