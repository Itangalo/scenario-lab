...
- characters 13012-13200: `{{metrics_json}}` from the run's live metric values
- characters 13293-14346: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14390-16412: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16468-17299: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Essential Continuity and Agent Containment Pact | 2 |
