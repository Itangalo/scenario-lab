...
- characters 452-1505: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1549-3571: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4842-5364: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7987-10316: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Essential Continuity and Agent Containment Pact | 6 | small | 10 | 12 | own jurisdiction | resilience up moderately, ai_safety up slightly | 2 | running |
