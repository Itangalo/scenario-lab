...
- characters 374-1704: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1747-3856: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3912-4423: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4486-31481: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31836-32574: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release, automated_decision_scandal
- Turn 2 (6 turn(s) ago): taiwan_blockade, bio_uplift_findings, member_state_defection
- Turn 3 (5 turn(s) ago): cyber_major_incident
- Turn 4 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
- Turn 5 (3 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, supply_chain_coercion, member_state_defection, election_consolidation
- Turn 6 (2 turn(s) ago): rsi_onset, embodied_ai_deployment
- Turn 7 (1 turn(s) ago): export_control_escalation, us_china_agreement, eu_frontier_access_denied, adoption_success, joint_threat_response
