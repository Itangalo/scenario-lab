...
- characters 13349-14679: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14722-16831: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16887-17703: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 80.5, "openweight_capability": 73.6, "ai_safety": 10.0, "resilience": 43.5, "eu_ai_sovereignty": 14.0, "eu_political_capital": 1.0, "public_sentiment": 1.0}
```
## Narrative
### Downgraded but lit
