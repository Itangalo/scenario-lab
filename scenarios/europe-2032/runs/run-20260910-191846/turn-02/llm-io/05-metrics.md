...
- characters 105-13049: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13092-13284: `{{metrics_json}}` from the run's live metric values
- characters 13377-14785: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14828-17323: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17379-18591: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_research_integrity_pact` -- first noted turn 1, listed in 2 turn(s) so far: Major European scientific publishers and research funders jointly mandate provenance watermarking and AI-use disclosure for papers and grants after phage-design controversy.
- `emergent_clinical_model_pullback` -- first noted turn 1, listed in 2 turn(s) so far: Major European research hospitals pause use of US frontier models for clinical decision support after the June switch-off scare, publicly citing continuity risk and accelerating EU-hosted alternatives.
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 51.0, "ai_safety": 30.0, "resilience": 36.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 20.0, "public_sentiment": 27.0}
```
...
## Notepad
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Chip Leverage Compact −2, priority −1 = −12
PROPOSAL BONUS: EU Chip Leverage Compact (cat 8, small) +4 — Taiwan blockade and member-state side-deal landed this turn and this answers both directly
LEGITIMACY LENDS: capital 18, sentiment 27 -> +2
SOVEREIGNTY: 21 last turn, no capacity event finish, Gigafactories in flight +0, taiwan_blockade t2 −3, capability rose 3.0 −1 = 17
