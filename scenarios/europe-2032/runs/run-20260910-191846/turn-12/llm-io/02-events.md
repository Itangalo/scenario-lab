...
- characters 373-1914: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1957-4157: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4213-4900: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4963-30774: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31129-32268: `{{event_history}}` from the run's own event record
...
- `emergent_infrastructure_sabotage_wave` -- first noted turn 11, listed in 1 turn(s) so far: A coordinated municipal blackout protest shuts down several planned data-centre and grid-upgrade sites across two member states for weeks, halting continuity works.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release, automated_decision_scandal
- Turn 2 (10 turn(s) ago): taiwan_blockade, bio_uplift_findings, member_state_defection
- Turn 3 (9 turn(s) ago): cyber_major_incident
- Turn 4 (8 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
- Turn 5 (7 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, supply_chain_coercion, member_state_defection, election_consolidation
- Turn 6 (6 turn(s) ago): rsi_onset, embodied_ai_deployment
- Turn 7 (5 turn(s) ago): export_control_escalation, us_china_agreement, eu_frontier_access_denied, adoption_success, joint_threat_response
- Turn 8 (4 turn(s) ago): eval_anomaly_reports, labour_displacement, eu_frontier_access_denied
- Turn 9 (3 turn(s) ago): loss_of_control_incident, bio_uplift_findings, eval_anomaly_reports, us_labs_nationalised
- Turn 10 (2 turn(s) ago): capability_jump, opaque_reasoning, member_state_defection
- Turn 11 (1 turn(s) ago): cyber_defence_breakthrough, eval_anomaly_reports, export_control_escalation
