...
- characters 13402-13590: `{{metrics_json}}` from the run's live metric values
- characters 13683-15224: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15267-17467: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17523-18210: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Cyber Restoration and Embodied-AI Containment Corps | 2 |
...
## Metrics
```json
{"ai_capability": 91.0, "openweight_capability": 86.8, "ai_safety": 0.0, "resilience": 50.0, "eu_ai_sovereignty": 3.0, "eu_political_capital": 3.0, "public_sentiment": 0.0}
```
