...
- characters 454-2971: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 3014-4883: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6574-7017: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8955-10108: `{{previous_actions}}` from the actor's own response from the previous turn
