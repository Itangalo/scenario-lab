...
- characters 106-13389: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13432-13622: `{{metrics_json}}` from the run's live metric values
- characters 13715-14784: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14828-17094: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17150-17730: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M6 | EU Displacement and Embodied-AI Transition Shield | 2 |
| M7 | EU Cutoff Continuity and Joint Threat Adhesion | 2 |
