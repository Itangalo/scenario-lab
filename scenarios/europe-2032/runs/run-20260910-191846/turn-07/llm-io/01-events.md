...
- characters 375-1444: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1488-3754: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3810-4390: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4453-32954: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33309-33907: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release, automated_decision_scandal
- Turn 2 (5 turn(s) ago): taiwan_blockade, bio_uplift_findings, member_state_defection
- Turn 3 (4 turn(s) ago): cyber_major_incident
- Turn 4 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
- Turn 5 (2 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, supply_chain_coercion, member_state_defection, election_consolidation
- Turn 6 (1 turn(s) ago): rsi_onset, embodied_ai_deployment
