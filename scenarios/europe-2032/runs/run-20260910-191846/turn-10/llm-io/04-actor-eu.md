...
- characters 452-1792: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1835-4021: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5236-5731: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8037-9750: `{{previous_actions}}` from the actor's own response from the previous turn
