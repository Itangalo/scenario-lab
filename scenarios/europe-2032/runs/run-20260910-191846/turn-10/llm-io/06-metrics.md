...
- characters 13011-13200: `{{metrics_json}}` from the run's live metric values
- characters 13293-14633: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14676-16862: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16918-17228: `{{notepad}}` from the Game Master's notepad, carried across turns
