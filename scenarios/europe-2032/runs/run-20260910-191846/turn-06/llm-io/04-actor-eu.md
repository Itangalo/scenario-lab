...
- characters 453-2878: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2921-5251: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6546-6998: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9082-10581: `{{previous_actions}}` from the actor's own response from the previous turn
