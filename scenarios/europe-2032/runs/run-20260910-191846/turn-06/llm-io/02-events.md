...
- characters 375-2800: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2843-5173: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5229-6044: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6107-32484: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32839-33377: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, Municipal Care Continuity Corps −2, priority M5 Municipal Care Continuity Corps −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 10 -> +2
SOVEREIGNTY: 15 last turn, no capacity event paid separately beyond largest, supply_chain_coercion t5 / member_state_defection t5 largest −2, Gigafactories in flight +0, capability rose 3.0 −1 = 12

## Emerging developments (tracked)

- `emergent_liability_cascade` -- first noted turn 4, listed in 2 turn(s) so far: Municipal hospital federations and city councils hit by the autumn ransomware wave jointly sue a US frontier lab and an EU deployer for damages, creating a first cross-border AI liability case that courts cannot dismiss quickly.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, eval_anomaly_reports, openweight_frontier_release, automated_decision_scandal
- Turn 2 (4 turn(s) ago): taiwan_blockade, bio_uplift_findings, member_state_defection
- Turn 3 (3 turn(s) ago): cyber_major_incident
- Turn 4 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports
- Turn 5 (1 turn(s) ago): cyber_major_incident, bio_uplift_findings, eval_anomaly_reports, supply_chain_coercion, member_state_defection, election_consolidation
