...
- characters 105-13562: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13605-13796: `{{metrics_json}}` from the run's live metric values
- characters 13889-16314: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16357-18687: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18743-19210: `{{notepad}}` from the Game Master's notepad, carried across turns
