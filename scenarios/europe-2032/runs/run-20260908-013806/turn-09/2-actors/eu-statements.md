...
- `two_year_commitment` (commitment): Sovereign runtime integrity and operational control over high-capability AI systems

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Sovereign runtime integrity and operational control over high-capability AI systems
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the two-year period directly ends the original commitment's timeframe, altering the actor's obligation and justifying a reframing of its sovereign AI focus.
