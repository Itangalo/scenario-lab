...
- characters 13707-14822: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14865-16755: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16811-17218: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t3: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Systems Shield −3, M4 EU Public Service AI Replication Fund −2, priority M3 −1 = −12
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 18, sentiment 42 -> +2
SOVEREIGNTY: 20 last turn, no capacity event, Gigafactories/Tech sovereignty in flight +0, capability rose 2.0 −1 = 19
...
## Metrics
```json
{"ai_capability": 60.0, "openweight_capability": 55.5, "ai_safety": 26.0, "resilience": 39.0, "eu_ai_sovereignty": 18.0, "eu_political_capital": 20.0, "public_sentiment": 40.0}
```
## Narrative
### Holding the line
