...
- characters 1828-4937: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4993-5969: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6032-31093: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31448-31998: `{{event_history}}` from the run's own event record
...
- `emergent_reinsurance_guarantee_fight` -- first noted turn 5, listed in 2 turn(s) so far: A second major European reinsurer announces exclusion of systemic cyber failure from public-sector coverage, forcing several member states to extend emergency guarantees into 2029 and triggering a court challenge over state-aid rules.
...
- Turn 3 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 4 (3 turn(s) ago): emergent_municipal_cyber_insurance_retreat
- Turn 5 (2 turn(s) ago): cyber_major_incident, capability_jump, knowledge_work_augmented, export_control_escalation, emergent_reinsurance_freeze_spillover, election_retrenchment
- Turn 6 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, bio_uplift_findings
