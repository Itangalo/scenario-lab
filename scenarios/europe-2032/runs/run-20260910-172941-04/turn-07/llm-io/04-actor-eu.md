...
- characters 1906-5015: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6655-7216: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9541-12598: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M6 | EU Agentic Containment and Bio-Response Backstop | 6 | small | 6 | 8 | own jurisdiction | resilience up, ai_safety up slightly via containment learning and detection | 2 | running |
