...
- characters 105-13343: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13386-13578: `{{metrics_json}}` from the run's live metric values
- characters 13671-14767: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14810-16789: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16845-17181: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t7: M6 EU Agentic Containment and Bio-Response Backstop −2, priority void (capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 17, sentiment 33 -> +2
SOVEREIGNTY: 14 last turn, M1 InvestAI Gigafactories finishes t7 +5, no capacity event, capability rose 0.8 −0 = 19
...
## Metrics
```json
{"ai_capability": 64.0, "openweight_capability": 61.8, "ai_safety": 20.0, "resilience": 45.5, "eu_ai_sovereignty": 17.0, "eu_political_capital": 24.0, "public_sentiment": 29.0}
```
## Narrative
