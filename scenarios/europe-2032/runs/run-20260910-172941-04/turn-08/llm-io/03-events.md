...
- characters 376-1472: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1515-3494: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3550-3886: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3949-29010: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29365-30029: `{{event_history}}` from the run's own event record
...
- Turn 3 (5 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 4 (4 turn(s) ago): emergent_municipal_cyber_insurance_retreat
- Turn 5 (3 turn(s) ago): cyber_major_incident, capability_jump, knowledge_work_augmented, export_control_escalation, emergent_reinsurance_freeze_spillover, election_retrenchment
- Turn 6 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, bio_uplift_findings
- Turn 7 (1 turn(s) ago): bio_uplift_findings, safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise
