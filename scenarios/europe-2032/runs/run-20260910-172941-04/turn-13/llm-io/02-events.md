...
- characters 378-1347: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1391-3448: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3504-4024: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4087-28586: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28941-30115: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M10 EU Trustworthy Care Rollout −2, M11 EU Clinical and Essential Services Continuity Reserve −2, priority ineffective (capital below 20, no cost) = −4
PROPOSAL BONUS: EU Clinical and Essential Services Continuity Reserve (cat 6, small) +2 — cyber_major_incident and cutoff both fired this turn and this answers both directly
LEGITIMACY LENDS: capital 15, sentiment 16 -> +2
SOVEREIGNTY: 17 last turn, no cat4 finish, no cat4 in flight, eu_frontier_access_denied t12 −3, capability rose 0.8 −0 = 14
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, openweight_frontier_release
- Turn 2 (11 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 3 (10 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 4 (9 turn(s) ago): emergent_municipal_cyber_insurance_retreat
- Turn 5 (8 turn(s) ago): cyber_major_incident, capability_jump, knowledge_work_augmented, export_control_escalation, emergent_reinsurance_freeze_spillover, election_retrenchment
- Turn 6 (7 turn(s) ago): cyber_major_incident, loss_of_control_incident, bio_uplift_findings
- Turn 7 (6 turn(s) ago): bio_uplift_findings, safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise
- Turn 8 (5 turn(s) ago): cyber_major_incident, taiwan_blockade, joint_threat_response, emergent_infrastructure_insurance_gap
- Turn 9 (4 turn(s) ago): cyber_major_incident, automated_decision_scandal
- Turn 10 (3 turn(s) ago): capability_jump, opaque_reasoning, safety_breakthrough, emergent_municipal_cyber_uninsurable
- Turn 11 (2 turn(s) ago): eval_anomaly_reports, medical_breakthrough, adoption_success, joint_threat_response
- Turn 12 (1 turn(s) ago): cyber_major_incident, eu_frontier_access_denied
