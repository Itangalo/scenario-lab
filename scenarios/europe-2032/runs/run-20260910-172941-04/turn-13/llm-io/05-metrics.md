...
- characters 13670-14639: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14683-16740: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16796-17622: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_care_reconnection_strike` -- first noted turn 13, listed in 1 turn(s) so far: Municipal hospital federations publish a joint refusal to reconnect foreign clinical assistants until liability for cutoff-period errors is assigned, freezing restoration queues.
...
## Notepad
PORTFOLIO CHARGE t13: M11 EU Clinical and Essential Services Continuity Reserve −2, priority ineffective (capital below 20, no cost) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: none — capital 17, sentiment 16, capital higher
SOVEREIGNTY: 14 last turn, no cat4 finish, no cat4 in flight +0, middle_power_coalition t13 +2, capability rose 0.8 −0 = 16
