...
- characters 106-13397: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13440-13632: `{{metrics_json}}` from the run's live metric values
- characters 13725-14985: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15028-17219: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17275-17680: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M11 | EU Clinical and Essential Services Continuity Reserve | 2 |
