...
- characters 1680-3871: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3927-4332: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4395-28894: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29249-30347: `{{event_history}}` from the run's own event record
...
- Turn 4 (8 turn(s) ago): emergent_municipal_cyber_insurance_retreat
- Turn 5 (7 turn(s) ago): cyber_major_incident, capability_jump, knowledge_work_augmented, export_control_escalation, emergent_reinsurance_freeze_spillover, election_retrenchment
- Turn 6 (6 turn(s) ago): cyber_major_incident, loss_of_control_incident, bio_uplift_findings
- Turn 7 (5 turn(s) ago): bio_uplift_findings, safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise
- Turn 8 (4 turn(s) ago): cyber_major_incident, taiwan_blockade, joint_threat_response, emergent_infrastructure_insurance_gap
- Turn 9 (3 turn(s) ago): cyber_major_incident, automated_decision_scandal
- Turn 10 (2 turn(s) ago): capability_jump, opaque_reasoning, safety_breakthrough, emergent_municipal_cyber_uninsurable
- Turn 11 (1 turn(s) ago): eval_anomaly_reports, medical_breakthrough, adoption_success, joint_threat_response
