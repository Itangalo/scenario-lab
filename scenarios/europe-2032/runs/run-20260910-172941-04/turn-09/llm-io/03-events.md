...
- characters 377-1071: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1115-3221: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3277-3753: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3816-28159: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28514-29304: `{{event_history}}` from the run's own event record
...
- Turn 3 (6 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 4 (5 turn(s) ago): emergent_municipal_cyber_insurance_retreat
- Turn 5 (4 turn(s) ago): cyber_major_incident, capability_jump, knowledge_work_augmented, export_control_escalation, emergent_reinsurance_freeze_spillover, election_retrenchment
- Turn 6 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, bio_uplift_findings
- Turn 7 (2 turn(s) ago): bio_uplift_findings, safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise
- Turn 8 (1 turn(s) ago): cyber_major_incident, taiwan_blockade, joint_threat_response, emergent_infrastructure_insurance_gap
