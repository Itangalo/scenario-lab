...
- characters 13324-14018: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14062-16168: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16224-17296: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | Joint Cyber Telemetry and Continuity Pact Entry | 2 |
...
PORTFOLIO CHARGE t8: M7 Joint Cyber Telemetry and Continuity Pact Entry −2, priority void (capital below 20) = −2
PROPOSAL BONUS: M7 Joint Cyber Telemetry and Continuity Pact Entry (cat 8, small) +3 — cyber_major_incident landed this turn and this answers it directly via invited joint response, plus insurance gap
LEGITIMACY LENDS: capital 21, sentiment 29 -> +2
SOVEREIGNTY: 19 last turn, no cat4 finish, no cat4 in flight, taiwan_blockade t8 −2, capability rose 0.9 −0 = 17
