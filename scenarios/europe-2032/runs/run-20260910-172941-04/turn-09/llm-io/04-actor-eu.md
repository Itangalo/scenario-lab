...
- characters 455-1149: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1193-3299: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4203-4764: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7309-9494: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | Joint Cyber Telemetry and Continuity Pact Entry | 8 | small | 8 | 10 | own jurisdiction plus joint cyber command coalition | resilience up, ai_safety up slightly via shared telemetry and learning | 2 | running |
