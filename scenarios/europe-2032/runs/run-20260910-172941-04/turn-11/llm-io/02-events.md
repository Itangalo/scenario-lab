...
- characters 378-1627: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1671-3967: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4023-4847: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4910-29409: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29764-30750: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, openweight_frontier_release
- Turn 2 (9 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 3 (8 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 4 (7 turn(s) ago): emergent_municipal_cyber_insurance_retreat
- Turn 5 (6 turn(s) ago): cyber_major_incident, capability_jump, knowledge_work_augmented, export_control_escalation, emergent_reinsurance_freeze_spillover, election_retrenchment
- Turn 6 (5 turn(s) ago): cyber_major_incident, loss_of_control_incident, bio_uplift_findings
- Turn 7 (4 turn(s) ago): bio_uplift_findings, safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise
- Turn 8 (3 turn(s) ago): cyber_major_incident, taiwan_blockade, joint_threat_response, emergent_infrastructure_insurance_gap
- Turn 9 (2 turn(s) ago): cyber_major_incident, automated_decision_scandal
- Turn 10 (1 turn(s) ago): capability_jump, opaque_reasoning, safety_breakthrough, emergent_municipal_cyber_uninsurable
