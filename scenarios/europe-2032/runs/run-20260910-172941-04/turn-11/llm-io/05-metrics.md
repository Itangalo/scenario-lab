...
- characters 13729-14978: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15022-17318: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17374-17890: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M10 | EU Trustworthy Care Rollout | 2 |
...
## Metrics
```json
{"ai_capability": 66.8, "openweight_capability": 65.0, "ai_safety": 15.0, "resilience": 43.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 18.0, "public_sentiment": 25.0}
```
