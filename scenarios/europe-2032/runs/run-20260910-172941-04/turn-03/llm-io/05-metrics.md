...
- characters 13363-14448: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14492-16432: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16488-16960: `{{notepad}}` from the Game Master's notepad, carried across turns
