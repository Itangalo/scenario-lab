...
- characters 377-1462: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1506-3446: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3502-4590: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4653-27365: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27720-27859: `{{event_history}}` from the run's own event record
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, openweight_frontier_release
- Turn 2 (1 turn(s) ago): knowledge_work_augmented, adoption_success
