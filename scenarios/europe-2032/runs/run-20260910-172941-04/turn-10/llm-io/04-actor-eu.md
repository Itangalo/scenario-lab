...
- characters 455-1321: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1364-3718: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5365-5846: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8604-11211: `{{previous_actions}}` from the actor's own response from the previous turn
...
- `two_year_commitment` (commitment): Rebuild sovereign AI capacity and democratic trust while hardening essentials against automated disruption
...
|---|---|---|---|---|---|---|---|---|---|
| M8 | EU Automated Decisions Redress and Certification | 2 | small | 9 | 11 | own jurisdiction | public_sentiment up, eu_political_capital up slightly, resilience up slightly via trusted systems | 2 | running |
...
| M4 | EU Public Service AI Replication Fund | 9 | small | 2 | 5 | own jurisdiction | public_sentiment up, eu_political_capital up slightly | 2 | finished |
| M5 | Municipal and Mid-Utility Continuity Guarantee | 6 | small | 5 | 7 | own jurisdiction | resilience up, eu_political_capital down slightly less via avoided outages | 2 | finished |
| M6 | EU Agentic Containment and Bio-Response Backstop | 6 | small | 6 | 8 | own jurisdiction | resilience up, ai_safety up slightly via containment learning and detection | 2 | finished |
