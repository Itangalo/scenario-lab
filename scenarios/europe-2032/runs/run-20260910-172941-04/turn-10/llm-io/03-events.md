...
- characters 377-1243: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1286-3640: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3696-4780: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4843-29186: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29541-30406: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M7 Joint Cyber Telemetry and Continuity Pact Entry −2, M8 EU Automated Decisions Redress and Certification −2, priority M7 −1 = −5
PROPOSAL BONUS: EU Automated Decisions Redress and Certification (cat 2, small) +2 — automated_decision_scandal fired this turn and this answers it directly as enforcement repair
...
- `emergent_municipal_cyber_uninsurable` -- first noted turn 9, listed in 1 turn(s) so far: Insurers extend the municipal freeze into a standing exclusion for model-enabled systemic cyber losses, forcing several cities to self-insure water and port OT and delaying restoration contracts.
- `emergent_ai_liability_insurance_retreat` -- first noted turn 9, listed in 1 turn(s) so far: Major insurers extend the infrastructure exclusion to cloud and AI-model outage liability, forcing EU hospitals and ports to self-insure automated operations through the turn.
...
- Can repeat: Yes
- Description: A significant research result, with AI doing what used to be the hard part – and in this world that happens wherever the answer can be checked: the natural sciences, computing and mathematics deliver repeatedly, while everything resistant to an automatic check does not move at all. Decide what the result is, how large, and where it was done, because the address matters as much as the finding.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, openweight_frontier_release
- Turn 2 (8 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 3 (7 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 4 (6 turn(s) ago): emergent_municipal_cyber_insurance_retreat
- Turn 5 (5 turn(s) ago): cyber_major_incident, capability_jump, knowledge_work_augmented, export_control_escalation, emergent_reinsurance_freeze_spillover, election_retrenchment
- Turn 6 (4 turn(s) ago): cyber_major_incident, loss_of_control_incident, bio_uplift_findings
- Turn 7 (3 turn(s) ago): bio_uplift_findings, safety_breakthrough, knowledge_work_augmented, taiwan_tension_rise
- Turn 8 (2 turn(s) ago): cyber_major_incident, taiwan_blockade, joint_threat_response, emergent_infrastructure_insurance_gap
- Turn 9 (1 turn(s) ago): cyber_major_incident, automated_decision_scandal
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.36}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.16}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.18}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.08}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.08}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.18}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.05}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.22}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.14}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "Insurers extend the municipal freeze into a standing exclusion for model-enabled systemic cyber losses, forcing several cities to self-insure water and port OT and delaying restoration contracts.", "emergent": true, "id": "emergent_municipal_cyber_uninsurable", "probability": 0.22}, {"description": "Major insurers extend the infrastructure exclusion to cloud and AI-model outage liability, forcing EU hospitals and ports to self-insure automated operations through the turn.", "emergent": true, "id": "emergent_ai_liability_insurance_retreat", "probability": 0.2}]
```
