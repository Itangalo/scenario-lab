...
- characters 1671-3490: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4330-4787: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6259-8275: `{{previous_actions}}` from the actor's own response from the previous turn
