...
- characters 1809-4174: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5812-6272: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8406-10890: `{{previous_actions}}` from the actor's own response from the previous turn
