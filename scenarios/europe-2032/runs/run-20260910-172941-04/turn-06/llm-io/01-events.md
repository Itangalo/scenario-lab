...
- characters 1731-4096: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4152-4986: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5049-29507: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29862-30318: `{{event_history}}` from the run's own event record
...
- `emergent_reinsurance_guarantee_fight` -- first noted turn 5, listed in 1 turn(s) so far: A second major European reinsurer announces exclusion of systemic cyber failure from public-sector coverage, forcing several member states to extend emergency guarantees into 2029 and triggering a court challenge over state-aid rules.
...
- Turn 2 (4 turn(s) ago): knowledge_work_augmented, adoption_success
- Turn 3 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 4 (2 turn(s) ago): emergent_municipal_cyber_insurance_retreat
- Turn 5 (1 turn(s) ago): cyber_major_incident, capability_jump, knowledge_work_augmented, export_control_escalation, emergent_reinsurance_freeze_spillover, election_retrenchment
