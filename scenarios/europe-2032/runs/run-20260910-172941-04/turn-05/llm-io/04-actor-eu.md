...
- characters 455-1326: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1370-3278: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6106-6563: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8510-10112: `{{previous_actions}}` from the actor's own response from the previous turn
