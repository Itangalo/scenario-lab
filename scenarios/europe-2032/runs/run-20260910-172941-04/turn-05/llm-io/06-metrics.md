...
- characters 106-13381: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13424-13616: `{{metrics_json}}` from the run's live metric values
- characters 13709-14580: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14624-16532: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16588-17324: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | Municipal and Mid-Utility Continuity Guarantee | 2 |
...
## Metrics
```json
{"ai_capability": 61.5, "openweight_capability": 57.8, "ai_safety": 19.0, "resilience": 37.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 17.0, "public_sentiment": 39.0}
```
## Narrative
### Winter of outages
