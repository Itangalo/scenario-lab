...
- characters 377-1248: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1292-3200: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3256-3628: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3691-29948: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30303-30580: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M4 EU Public Service AI Replication Fund −2, priority M4 −1 = −9
...
- Turn 3 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports
- Turn 4 (1 turn(s) ago): emergent_municipal_cyber_insurance_retreat
