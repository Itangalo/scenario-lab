...
- characters 1748-4225: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4281-4729: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4792-27869: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28224-28265: `{{event_history}}` from the run's own event record
