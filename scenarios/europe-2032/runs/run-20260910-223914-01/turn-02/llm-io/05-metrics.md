...
- characters 105-13152: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13195-13387: `{{metrics_json}}` from the run's live metric values
- characters 13480-14809: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14852-17329: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17385-18204: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 50.5, "ai_safety": 30.0, "resilience": 37.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 32.0, "public_sentiment": 34.0}
```
