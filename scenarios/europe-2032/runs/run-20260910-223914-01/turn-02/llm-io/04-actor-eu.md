...
- characters 4853-5325: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6797-8924: `{{previous_actions}}` from the actor's own response from the previous turn
