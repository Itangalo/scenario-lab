...
- characters 377-2724: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2768-5567: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5623-6146: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6209-35185: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35540-35813: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): cyber_major_incident
- Turn 3 (2 turn(s) ago): capability_jump, export_control_escalation
- Turn 4 (1 turn(s) ago): loss_of_control_incident, supply_chain_coercion, member_state_defection, adoption_success
