...
- characters 455-2802: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2846-5645: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 8561-9033: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11312-13169: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Trusted Public AI Scale-up | 9 | small | 4 | 7 | own jurisdiction | public_sentiment up, eu_political_capital up, resilience up modestly | 2 | running |
...
| M4 | EU Forensic Triage Cell | 5 | small | 2 | 5 | own jurisdiction | resilience up, ai_safety up modestly via attribution and detection | 2 | finished |
