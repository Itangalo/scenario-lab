...
- characters 13865-16212: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16256-19055: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 19111-20308: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_insurance_freeze` -- first noted turn 5, listed in 1 turn(s) so far: A major European insurers' consortium publishes pooled loss data from the ransomware and agent episodes and abruptly reprices AI-related operational risk, freezing cover for municipalities and hospitals without certified hardening.
- `emergent_gulf_compute_offer` -- first noted turn 5, listed in 1 turn(s) so far: A Gulf sovereign fund publicly offers dedicated AI compute financing for EU health and education workloads on EU soil, conditional on long-term power contracts, testing whether energy-constrained factory sites can be unblocked from outside.
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Supply-Chain Bargain Cell −2, EU Trusted Public AI Scale-up −2, priority −1 = −11
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 14, sentiment 24 -> +2
SOVEREIGNTY: 13 last turn, no capacity event? no — eu_frontier_access_denied t5 −2, Gigafactories in flight +0, capability rose 2.5 −1 = 10
