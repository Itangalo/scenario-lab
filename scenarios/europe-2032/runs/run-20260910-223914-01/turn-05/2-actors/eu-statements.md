...
- `two_year_commitment` (commitment): Endure decoupling and prevent bio-enabled harm with European-hosted capacity

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Endure decoupling and prevent bio-enabled harm with European-hosted capacity
