...
- characters 377-1965: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2009-4062: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4118-5054: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5117-28693: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29048-29136: `{{event_history}}` from the run's own event record
