...
- characters 106-13195: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13238-13430: `{{metrics_json}}` from the run's live metric values
- characters 13523-15111: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15155-17208: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17264-18200: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Forensic Triage Cell | 2 |
| M5 | EU Supply-Chain Bargain Cell | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Services Shield −3, EU Forensic Triage Cell −2, priority −1 = −12
PROPOSAL BONUS: EU Forensic Triage Cell (cat 5, small) +2 — cyber_major_incident landed this turn and this answers it directly via attribution and detection
LEGITIMACY LENDS: capital 32, sentiment 34 -> +0 applied in capital calc, none separate — capital below sentiment but dampened by heavy portfolio costs
SOVEREIGNTY: 21 last turn, no capacity event, Gigafactories in flight +0, capability rose 3.0 −1 = 20

## Emerging developments (tracked)

- `emergent_grid_insurance_crunch` -- first noted turn 2, listed in 2 turn(s) so far: Municipal utilities and grid operators hit by the autumn pre-positioning disclosures face a liability and insurance repricing shock, with cyber-insurance for energy and water operators sharply restricted and lawsuits alleging negligent monitoring.
...
## Metrics
```json
{"ai_capability": 64.0, "openweight_capability": 54.0, "ai_safety": 22.0, "resilience": 36.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 21.0, "public_sentiment": 28.0}
```
## Narrative
