...
- characters 13910-15580: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15623-17541: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17597-18144: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Trusted Public AI Scale-up | 2 |
...
## Metrics
```json
{"ai_capability": 67.0, "openweight_capability": 59.0, "ai_safety": 20.0, "resilience": 41.0, "eu_ai_sovereignty": 13.0, "eu_political_capital": 10.0, "public_sentiment": 24.0}
```
