...
- characters 2089-4007: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4063-4981: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5044-32592: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32947-33104: `{{event_history}}` from the run's own event record
...
- Turn 3 (1 turn(s) ago): capability_jump, export_control_escalation
