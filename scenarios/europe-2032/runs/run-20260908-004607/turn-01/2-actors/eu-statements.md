...
- `two_year_commitment` (commitment): Build sovereign capacity to act independently before the window closes

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Build sovereign capacity to act independently before the window closes
