...
- `two_year_commitment` (commitment): Absorb AI shocks through resilience and public trust so independent capacity can still be built

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Absorb AI shocks through resilience and public trust so independent capacity can still be built
