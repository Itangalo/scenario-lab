...
| M9 | EU Critical Services Restoration and Decision Redress Pact | 6 | small | 7 | 8 | own jurisdiction | resilience up, eu_political_capital protected, public_sentiment up slightly | 2 | finished |
| M10 | EU Industrial Automation Transition Shield | 7 | small | 8 | 10 | own jurisdiction | resilience up via social absorption, public_sentiment up, eu_political_capital protected | 2 | running |
| M11 | EU Bio Shield and Municipal Recovery Surge | 6 | small | 9 | 11 | own jurisdiction | resilience up, ai_safety up slightly via bio/cyber detection | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Bio Shield and Municipal Recovery Surge", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, ai_safety up slightly via bio/cyber detection"}, "grounds": "to contain bio-uplift and ransomware cascade before trust collapses"}
  - Grounds: to contain bio-uplift and ransomware cascade before trust collapses
