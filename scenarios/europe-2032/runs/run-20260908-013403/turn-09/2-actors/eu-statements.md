...
- `two_year_commitment` (commitment): Maintain sovereign control over AI systems essential to public order and state function

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Maintain sovereign control over AI systems essential to public order and state function
