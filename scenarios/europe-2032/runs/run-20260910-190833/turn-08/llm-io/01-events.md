...
- characters 1589-3822: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3878-4878: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4941-33242: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33597-34187: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: Containment-Grade Evaluation and Bio-Screening Upgrade −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2, sentiment 15 -> +2 capped by triple external shock losses
SOVEREIGNTY: 19 last turn, InvestAI Gigafactories finishes t7 +5, no in-flight cat4 bonus +0, taiwan_blockade t7 −2, capability rose 2.5 −1 = 21

## Emerging developments (tracked)

- `emergent_graduate_occupations` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated graduate-led occupations block several university administration buildings and a data-centre construction site, demanding hiring guarantees and AI displacement levies, forcing a national political response.
- `emergent_anti_datacentre_blockades` -- first noted turn 7, listed in 1 turn(s) so far: Coordinated graduate-led protests across several member states blockade data-centre construction sites and demand hiring guarantees, turning AI infrastructure into a physical contest.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, eu_access_secured
- Turn 2 (6 turn(s) ago): capability_jump, cyber_defence_breakthrough
- Turn 3 (5 turn(s) ago): cyber_major_incident, embodied_ai_deployment
- Turn 4 (4 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, opaque_reasoning
- Turn 5 (3 turn(s) ago): capability_jump, safety_breakthrough, election_alliance
- Turn 6 (2 turn(s) ago): rsi_onset, medical_breakthrough, labour_displacement, eu_frontier_access_denied, automated_decision_scandal
- Turn 7 (1 turn(s) ago): taiwan_blockade, ai_investment_collapse, bio_uplift_findings
