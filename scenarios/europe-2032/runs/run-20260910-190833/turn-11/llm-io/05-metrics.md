...
- characters 107-13400: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13443-13632: `{{metrics_json}}` from the run's live metric values
- characters 13725-15493: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15537-17420: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17476-17924: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | Seek Adherence to US-China Restraint Accord and Joint Bio-Cyber Defence Cell | 2 |
