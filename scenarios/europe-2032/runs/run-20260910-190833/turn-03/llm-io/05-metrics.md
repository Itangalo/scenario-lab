...
- characters 106-13135: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13178-13370: `{{metrics_json}}` from the run's live metric values
- characters 13463-14765: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14809-16760: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16816-17264: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t2: Gigafactories −3, Tech sovereignty package −3, Grid Shield and Essential Services Hardening −3, EU Frontier Evaluation Facility −2, priority −1 = −12
PROPOSAL BONUS: EU Frontier Evaluation Facility (cat 5, small) +3 — capability_jump landed this turn and this answers it directly
LEGITIMACY LENDS: capital 32, sentiment 40 -> +2
SOVEREIGNTY: 23 last turn, no capacity event, no finish, in flight +0, capability rose 6.0 −1 = 22
