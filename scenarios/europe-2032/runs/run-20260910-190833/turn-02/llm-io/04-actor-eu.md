...
- characters 1608-3791: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4430-4898: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6386-8428: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M3 | Grid Shield and Essential Services Hardening | 6 | large | 1 | 3 | own jurisdiction | resilience up substantially, ai_safety spillover via incident learning | 3 | running |
