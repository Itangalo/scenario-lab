...
- characters 13402-14513: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14556-16739: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16795-17922: `{{notepad}}` from the Game Master's notepad, carried across turns
