...
- characters 106-13329: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13372-13563: `{{metrics_json}}` from the run's live metric values
- characters 13656-15583: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15627-17671: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17727-18756: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 83.0, "openweight_capability": 74.3, "ai_safety": 10.0, "resilience": 39.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 2.0, "public_sentiment": 15.0}
```
