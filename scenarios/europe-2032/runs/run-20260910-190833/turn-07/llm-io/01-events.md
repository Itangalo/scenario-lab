...
- characters 376-2303: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2347-4391: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4447-4861: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4924-34537: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34892-35395: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): capability_jump, cyber_defence_breakthrough
- Turn 3 (4 turn(s) ago): cyber_major_incident, embodied_ai_deployment
- Turn 4 (3 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, opaque_reasoning
- Turn 5 (2 turn(s) ago): capability_jump, safety_breakthrough, election_alliance
- Turn 6 (1 turn(s) ago): rsi_onset, medical_breakthrough, labour_displacement, eu_frontier_access_denied, automated_decision_scandal
