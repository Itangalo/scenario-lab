...
- characters 453-1881: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1924-4065: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6910-7386: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9707-11792: `{{previous_actions}}` from the actor's own response from the previous turn
