...
- characters 374-1528: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1571-3648: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3704-4145: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4208-32509: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32864-33683: `{{event_history}}` from the run's own event record
...
- Turn 3 (7 turn(s) ago): cyber_major_incident, embodied_ai_deployment
- Turn 4 (6 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, opaque_reasoning
- Turn 5 (5 turn(s) ago): capability_jump, safety_breakthrough, election_alliance
- Turn 6 (4 turn(s) ago): rsi_onset, medical_breakthrough, labour_displacement, eu_frontier_access_denied, automated_decision_scandal
- Turn 7 (3 turn(s) ago): taiwan_blockade, ai_investment_collapse, bio_uplift_findings
- Turn 8 (2 turn(s) ago): medical_breakthrough, openweight_frontier_release, embodied_ai_deployment, export_control_escalation, adoption_success
- Turn 9 (1 turn(s) ago): automated_decision_scandal, emergent_graduate_occupations
