...
- characters 374-2002: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2045-4441: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4497-5010: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5073-31056: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31411-32475: `{{event_history}}` from the run's own event record
...
- Turn 2 (10 turn(s) ago): capability_jump, cyber_defence_breakthrough
- Turn 3 (9 turn(s) ago): cyber_major_incident, embodied_ai_deployment
- Turn 4 (8 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, opaque_reasoning
- Turn 5 (7 turn(s) ago): capability_jump, safety_breakthrough, election_alliance
- Turn 6 (6 turn(s) ago): rsi_onset, medical_breakthrough, labour_displacement, eu_frontier_access_denied, automated_decision_scandal
- Turn 7 (5 turn(s) ago): taiwan_blockade, ai_investment_collapse, bio_uplift_findings
- Turn 8 (4 turn(s) ago): medical_breakthrough, openweight_frontier_release, embodied_ai_deployment, export_control_escalation, adoption_success
- Turn 9 (3 turn(s) ago): automated_decision_scandal, emergent_graduate_occupations
- Turn 10 (2 turn(s) ago): loss_of_control_incident, bio_uplift_findings, knowledge_work_augmented, emergent_infrastructure_sabotage_wave
- Turn 11 (1 turn(s) ago): bio_incident, labour_displacement, us_china_agreement, member_state_defection
