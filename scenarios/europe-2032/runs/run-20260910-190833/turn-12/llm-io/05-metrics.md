...
- characters 13033-13222: `{{metrics_json}}` from the run's live metric values
- characters 13315-14943: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14986-17382: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17438-17951: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 92.5, "openweight_capability": 89.0, "ai_safety": 6.0, "resilience": 37.5, "eu_ai_sovereignty": 12.0, "eu_political_capital": 0.0, "public_sentiment": 4.0}
```
