...
- characters 1785-3971: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5480-5948: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8267-10332: `{{previous_actions}}` from the actor's own response from the previous turn
