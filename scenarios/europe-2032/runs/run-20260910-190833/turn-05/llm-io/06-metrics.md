...
- characters 13870-15156: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15200-17386: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17442-18682: `{{notepad}}` from the Game Master's notepad, carried across turns
