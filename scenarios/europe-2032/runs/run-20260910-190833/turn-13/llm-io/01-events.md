...
- characters 375-1308: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1352-3308: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3364-3814: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3877-29860: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30215-31378: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: Seek Adherence to US-China Restraint Accord and Joint Bio-Cyber Defence Cell −2, priority no effect under loss-of-control (capital below 20) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 1, sentiment 1 -> none, capital not below sentiment
SOVEREIGNTY: 15 last turn, no cat4 finish, no cat4 in flight +0, eu_frontier_access_denied t12 −3, capability rose 1.5 (halved above 85) no −1 = 12
...
- Turn 3 (10 turn(s) ago): cyber_major_incident, embodied_ai_deployment
- Turn 4 (9 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, opaque_reasoning
- Turn 5 (8 turn(s) ago): capability_jump, safety_breakthrough, election_alliance
- Turn 6 (7 turn(s) ago): rsi_onset, medical_breakthrough, labour_displacement, eu_frontier_access_denied, automated_decision_scandal
- Turn 7 (6 turn(s) ago): taiwan_blockade, ai_investment_collapse, bio_uplift_findings
- Turn 8 (5 turn(s) ago): medical_breakthrough, openweight_frontier_release, embodied_ai_deployment, export_control_escalation, adoption_success
- Turn 9 (4 turn(s) ago): automated_decision_scandal, emergent_graduate_occupations
- Turn 10 (3 turn(s) ago): loss_of_control_incident, bio_uplift_findings, knowledge_work_augmented, emergent_infrastructure_sabotage_wave
- Turn 11 (2 turn(s) ago): bio_incident, labour_displacement, us_china_agreement, member_state_defection
- Turn 12 (1 turn(s) ago): eval_anomaly_reports, research_breakthrough, eu_frontier_access_denied
