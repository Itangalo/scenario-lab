...
- characters 454-1597: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1641-3399: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5061-5537: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7919-10126: `{{previous_actions}}` from the actor's own response from the previous turn
