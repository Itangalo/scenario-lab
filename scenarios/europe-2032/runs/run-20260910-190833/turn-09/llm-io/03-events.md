...
- characters 376-1519: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1563-3321: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3377-4449: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4512-32813: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33168-33903: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, eu_access_secured
- Turn 2 (7 turn(s) ago): capability_jump, cyber_defence_breakthrough
- Turn 3 (6 turn(s) ago): cyber_major_incident, embodied_ai_deployment
- Turn 4 (5 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, opaque_reasoning
- Turn 5 (4 turn(s) ago): capability_jump, safety_breakthrough, election_alliance
- Turn 6 (3 turn(s) ago): rsi_onset, medical_breakthrough, labour_displacement, eu_frontier_access_denied, automated_decision_scandal
- Turn 7 (2 turn(s) ago): taiwan_blockade, ai_investment_collapse, bio_uplift_findings
- Turn 8 (1 turn(s) ago): medical_breakthrough, openweight_frontier_release, embodied_ai_deployment, export_control_escalation, adoption_success
