...
- `two_year_commitment` (commitment): Secure irreversibility: ensure the EU can never again be excluded from access to frontier AI capability.

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure irreversibility: ensure the EU can never again be excluded from access to frontier AI capability.
