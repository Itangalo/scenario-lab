...
- `two_year_commitment` (commitment): Sovereign capability at scale: ensure the EU can build, run, and control frontier AI systems independently by the end of 2032
