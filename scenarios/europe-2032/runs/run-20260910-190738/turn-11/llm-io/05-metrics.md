...
- characters 107-13445: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13488-13679: `{{metrics_json}}` from the run's live metric values
- characters 13772-15085: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15129-17266: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17322-18150: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M13 | EU Joint Cyber Shield Accession | 2 |
