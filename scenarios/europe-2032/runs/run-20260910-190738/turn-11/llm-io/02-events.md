...
- characters 377-1690: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1734-3871: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3927-4435: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4498-32386: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32741-33773: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, eval_anomaly_reports, emergent_clinical_reliance_review
- Turn 2 (9 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, eu_frontier_access_denied
- Turn 3 (8 turn(s) ago): loss_of_control_incident, ai_investment_collapse
- Turn 4 (7 turn(s) ago): openweight_frontier_release, export_control_escalation, adoption_success
- Turn 5 (6 turn(s) ago): capability_jump, bio_uplift_findings, embodied_ai_deployment, adoption_success, middle_power_coalition, election_retrenchment
- Turn 6 (5 turn(s) ago): cyber_defence_breakthrough, rsi_onset, adoption_success
- Turn 7 (4 turn(s) ago): loss_of_control_incident, taiwan_tension_rise, catastrophic_great_power_conflict, export_control_escalation, adoption_success
- Turn 8 (3 turn(s) ago): eval_anomaly_reports, openweight_frontier_release
- Turn 9 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, opaque_reasoning, embodied_ai_deployment
- Turn 10 (1 turn(s) ago): capability_jump, taiwan_tension_rise, adoption_success
