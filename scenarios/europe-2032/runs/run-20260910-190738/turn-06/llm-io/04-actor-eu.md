...
- characters 1947-4218: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5275-5749: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8118-10083: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M7 | EU Bio Detection and Response Surge | 6 | small | 5 | 7 | own jurisdiction | resilience up, ai_safety up slightly via detection | 2 | running |
