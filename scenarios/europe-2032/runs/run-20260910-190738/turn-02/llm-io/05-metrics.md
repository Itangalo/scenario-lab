...
- characters 13377-14412: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14455-16837: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16893-17607: `{{notepad}}` from the Game Master's notepad, carried across turns
