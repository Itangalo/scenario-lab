...
- characters 106-13455: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13498-13689: `{{metrics_json}}` from the run's live metric values
- characters 13782-15100: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15143-17486: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17542-18104: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M11 | EU Opaque-Embodied Shelter Extension | 2 |
| M12 | EU Attributed Benefit Retention Drive | 2 |
...
## Notepad
PORTFOLIO CHARGE t10: EU Open Frontier Shelter Hardening −2, EU Opaque-Embodied Shelter Extension −2, EU Attributed Benefit Retention Drive −2, priority −1 = −7
PROPOSAL BONUS: EU Attributed Benefit Retention Drive (cat 9, small) +2 — capability_jump landed this turn and this answers it directly by keeping services running through it
LEGITIMACY LENDS: capital 18, sentiment 13 -> none (capital not lower)
SOVEREIGNTY: 13 last turn, no capacity event, no category 4 in flight +0, capability rose 5.0 −1 = 12
