...
- characters 454-1772: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1815-4158: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5039-5557: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8589-11852: `{{previous_actions}}` from the actor's own response from the previous turn
