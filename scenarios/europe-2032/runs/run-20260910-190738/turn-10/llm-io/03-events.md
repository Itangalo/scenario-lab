...
- characters 376-1694: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1737-4080: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4136-5007: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5070-32958: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33313-34262: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: EU Wartime Essential Continuity Command −2, EU Open Frontier Shelter Hardening −2, EU Opaque-Embodied Shelter Extension −2, priority −1 = −7
PROPOSAL BONUS: EU Opaque-Embodied Shelter Extension (cat 6, small) +4 — cyber_major_incident, loss_of_control_incident, opaque_reasoning and embodied_ai_deployment all landed this turn and this answers them directly
LEGITIMACY LENDS: capital 20, sentiment 20 -> none (capital not lower)
SOVEREIGNTY: 16 last turn, no category 4 in flight +0, embodied_ai_deployment t9 −2, capability rose 2.5 −1 = 13

## Emerging developments (tracked)

- `emergent_war_targeting_eu_compute` -- first noted turn 8, listed in 2 turn(s) so far: US or Chinese strike planning publicly names EU-hosted compute and cable landings as dual-use targets, forcing emergency dispersal of workloads and a neutrality crisis for the Union.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, eval_anomaly_reports, emergent_clinical_reliance_review
- Turn 2 (8 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, eu_frontier_access_denied
- Turn 3 (7 turn(s) ago): loss_of_control_incident, ai_investment_collapse
- Turn 4 (6 turn(s) ago): openweight_frontier_release, export_control_escalation, adoption_success
- Turn 5 (5 turn(s) ago): capability_jump, bio_uplift_findings, embodied_ai_deployment, adoption_success, middle_power_coalition, election_retrenchment
- Turn 6 (4 turn(s) ago): cyber_defence_breakthrough, rsi_onset, adoption_success
- Turn 7 (3 turn(s) ago): loss_of_control_incident, taiwan_tension_rise, catastrophic_great_power_conflict, export_control_escalation, adoption_success
- Turn 8 (2 turn(s) ago): eval_anomaly_reports, openweight_frontier_release
- Turn 9 (1 turn(s) ago): cyber_major_incident, loss_of_control_incident, opaque_reasoning, embodied_ai_deployment
