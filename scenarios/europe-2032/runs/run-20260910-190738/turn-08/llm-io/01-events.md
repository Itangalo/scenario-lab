...
- characters 375-1606: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1649-3683: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3739-4290: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4353-31893: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32248-33006: `{{event_history}}` from the run's own event record
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, eval_anomaly_reports, emergent_clinical_reliance_review
- Turn 2 (6 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, eu_frontier_access_denied
- Turn 3 (5 turn(s) ago): loss_of_control_incident, ai_investment_collapse
- Turn 4 (4 turn(s) ago): openweight_frontier_release, export_control_escalation, adoption_success
- Turn 5 (3 turn(s) ago): capability_jump, bio_uplift_findings, embodied_ai_deployment, adoption_success, middle_power_coalition, election_retrenchment
- Turn 6 (2 turn(s) ago): cyber_defence_breakthrough, rsi_onset, adoption_success
- Turn 7 (1 turn(s) ago): loss_of_control_incident, taiwan_tension_rise, catastrophic_great_power_conflict, export_control_escalation, adoption_success
