...
- characters 105-13347: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13390-13581: `{{metrics_json}}` from the run's live metric values
- characters 13674-14905: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14948-16982: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17038-17898: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Wartime Essential Continuity Command | 2 |
| M10 | EU Open Frontier Shelter Hardening | 2 |
...
PORTFOLIO CHARGE t7: EU Automated Defence Deployment −2, EU Wartime Essential Continuity Command −2, priority void (capital 14 <20, no effect, no cost) = −4
PROPOSAL BONUS: EU Wartime Essential Continuity Command (cat 6, small) +5 — catastrophic_great_power_conflict landed this turn and loss_of_control_incident uncontained, this answers both directly
LEGITIMACY LENDS: capital 16, sentiment 22 -> +2
SOVEREIGNTY: 16 last turn, InvestAI Gigafactories finishes t7 +4, no in-flight build +0, export_control_escalation t7 −2, capability rose 2.0 −1 = 17
