...
- characters 106-13103: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13146-13338: `{{metrics_json}}` from the run's live metric values
- characters 13431-14409: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14453-16688: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16744-17520: `{{notepad}}` from the Game Master's notepad, carried across turns
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Shield −3, EU Care Continuity Stack −2, priority −1 = −12
PROPOSAL BONUS: EU Care Continuity Stack (cat 9, small) +3 — frontier access cutoff landed this turn and this answers it directly
LEGITIMACY LENDS: capital 37, sentiment 30 -> none, capital higher
SOVEREIGNTY: 21 last turn, no capacity event, no cat4 finish, in flight +0, eu_frontier_access_denied t2 −2, capability rose 3.0 −1 = 18

## Emerging developments (tracked)

- `emergent_attribution_row` -- first noted turn 2, listed in 2 turn(s) so far: Investigative reporting names a state sponsor behind the grid swarm with leaked forensic evidence, forcing governments to respond publicly despite unresolved attribution.
