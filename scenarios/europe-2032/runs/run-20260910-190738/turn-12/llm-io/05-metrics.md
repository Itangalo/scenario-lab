...
- characters 106-13586: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13629-13818: `{{metrics_json}}` from the run's live metric values
- characters 13911-14866: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14909-16997: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17053-18014: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M14 | EU Bio-Embodied Degradable Continuity | 2 |
