...
- characters 374-1329: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1372-3460: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3516-4477: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4540-32428: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32783-33970: `{{event_history}}` from the run's own event record
...
- `emergent_care_grid_work_to_rule` -- first noted turn 11, listed in 1 turn(s) so far: Municipal staff in several member states refuse to operate AI-assisted triage and grid-override systems after the spring outages, forcing extended manual-only operation in clinics and utilities.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, eval_anomaly_reports, emergent_clinical_reliance_review
- Turn 2 (10 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, eu_frontier_access_denied
- Turn 3 (9 turn(s) ago): loss_of_control_incident, ai_investment_collapse
- Turn 4 (8 turn(s) ago): openweight_frontier_release, export_control_escalation, adoption_success
- Turn 5 (7 turn(s) ago): capability_jump, bio_uplift_findings, embodied_ai_deployment, adoption_success, middle_power_coalition, election_retrenchment
- Turn 6 (6 turn(s) ago): cyber_defence_breakthrough, rsi_onset, adoption_success
- Turn 7 (5 turn(s) ago): loss_of_control_incident, taiwan_tension_rise, catastrophic_great_power_conflict, export_control_escalation, adoption_success
- Turn 8 (4 turn(s) ago): eval_anomaly_reports, openweight_frontier_release
- Turn 9 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, opaque_reasoning, embodied_ai_deployment
- Turn 10 (2 turn(s) ago): capability_jump, taiwan_tension_rise, adoption_success
- Turn 11 (1 turn(s) ago): cyber_major_incident, openweight_frontier_release, export_control_escalation, eu_frontier_access_denied, joint_threat_response
