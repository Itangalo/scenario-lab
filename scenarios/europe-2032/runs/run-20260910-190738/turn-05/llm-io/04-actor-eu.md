...
- characters 455-2427: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2471-4343: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7550-7994: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10210-12074: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Visible Benefit Scale-Up | 9 | small | 4 | 6 | own jurisdiction | public_sentiment up, resilience up slightly | 2 | running |
