...
- characters 106-13425: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13468-13660: `{{metrics_json}}` from the run's live metric values
- characters 13753-15725: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15769-17641: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17697-18839: `{{notepad}}` from the Game Master's notepad, carried across turns
