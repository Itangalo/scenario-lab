...
- characters 377-2349: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2393-4265: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4321-4843: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4906-31860: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32215-32587: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Loss-of-Control Containment Protocol −2, EU Visible Benefit Scale-Up −2, priority −1 = −11
PROPOSAL BONUS: EU Visible Benefit Scale-Up (cat 9, small) +2 — answers late-spring cutoff dependence humiliation and winter care pressure from last two turns, small and indirect
LEGITIMACY LENDS: capital 14, sentiment 24 -> +2
SOVEREIGNTY: 17 last turn, no cat4 finish, no in-flight bonus, export_control_escalation t4 −2, capability rose 3.0 −1 = 14
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, eval_anomaly_reports, emergent_clinical_reliance_review
- Turn 2 (3 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, eu_frontier_access_denied
- Turn 3 (2 turn(s) ago): loss_of_control_incident, ai_investment_collapse
- Turn 4 (1 turn(s) ago): openweight_frontier_release, export_control_escalation, adoption_success
