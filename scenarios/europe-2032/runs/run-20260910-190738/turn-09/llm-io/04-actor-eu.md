...
- characters 454-1595: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1639-3979: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6538-7012: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9856-12362: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M10 | EU Open Frontier Shelter Hardening | 6 | small | 8 | 11 | own jurisdiction | resilience up to absorb open-weight misuse and eval-anomaly surprise | 2 | running |
