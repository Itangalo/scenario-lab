...
- characters 2995-5335: `{{world_state}}` from background/context.md, seeded as the opening world state
- characters 5368-8631: `{{previous_actions}}` from the actor's own response from the previous turn
...
Rewrite it to read: Keep essential services and livelihoods standing through ungovernable AI, embodied deployment and war
