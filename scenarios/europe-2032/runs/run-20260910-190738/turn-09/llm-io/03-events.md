...
- characters 376-1517: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1561-3901: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3957-4765: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4828-33414: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33769-34603: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Wartime Essential Continuity Command −2, EU Open Frontier Shelter Hardening −2, priority void (capital 16 <20, no effect, no cost) = −4
PROPOSAL BONUS: EU Open Frontier Shelter Hardening (cat 6, small) +3 — openweight_frontier_release landed this turn and eval_anomaly_reports landed this turn and this answers both directly
LEGITIMACY LENDS: capital 18, sentiment 22 -> +2
SOVEREIGNTY: 17 last turn, no capacity event, no category 4 in flight +0, capability rose 2.0 −1 = 16

## Emerging developments (tracked)

- `emergent_war_targeting_eu_compute` -- first noted turn 8, listed in 1 turn(s) so far: US or Chinese strike planning publicly names EU-hosted compute and cable landings as dual-use targets, forcing emergency dispersal of workloads and a neutrality crisis for the Union.
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, eval_anomaly_reports, emergent_clinical_reliance_review
- Turn 2 (7 turn(s) ago): eval_anomaly_reports, knowledge_work_augmented, eu_frontier_access_denied
- Turn 3 (6 turn(s) ago): loss_of_control_incident, ai_investment_collapse
- Turn 4 (5 turn(s) ago): openweight_frontier_release, export_control_escalation, adoption_success
- Turn 5 (4 turn(s) ago): capability_jump, bio_uplift_findings, embodied_ai_deployment, adoption_success, middle_power_coalition, election_retrenchment
- Turn 6 (3 turn(s) ago): cyber_defence_breakthrough, rsi_onset, adoption_success
- Turn 7 (2 turn(s) ago): loss_of_control_incident, taiwan_tension_rise, catastrophic_great_power_conflict, export_control_escalation, adoption_success
- Turn 8 (1 turn(s) ago): eval_anomaly_reports, openweight_frontier_release
