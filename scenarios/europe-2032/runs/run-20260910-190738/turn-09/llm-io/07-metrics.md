...
- characters 13381-14522: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14566-16906: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16962-17770: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 82.5, "openweight_capability": 76.5, "ai_safety": 0.0, "resilience": 46.0, "eu_ai_sovereignty": 13.0, "eu_political_capital": 20.0, "public_sentiment": 10.0}
```
## Narrative
