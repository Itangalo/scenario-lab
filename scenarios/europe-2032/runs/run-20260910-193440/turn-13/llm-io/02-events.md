...
- characters 374-2277: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2321-4242: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4298-4750: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4813-31995: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32350-33615: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: M9 EU Borrowed-Competence Triage Continuity −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: none — duplicate proposal of measure already in flight, no new measure earned bonus this turn
LEGITIMACY LENDS: none — capital 5, sentiment 2, capital above sentiment
SOVEREIGNTY: 10 last turn, no category 4 finish, no in-flight category 4 bonus, embodied_ai_deployment t12 −2, capability rose 1.5 no −1 = 8
...
- Turn 2 (11 turn(s) ago): cyber_defence_breakthrough, emergent_health_data_forgery_wave
- Turn 3 (10 turn(s) ago): bio_uplift_findings, adoption_success
- Turn 4 (9 turn(s) ago): openweight_frontier_release
- Turn 5 (8 turn(s) ago): cyber_major_incident, eval_anomaly_reports, eu_frontier_access_denied, election_consolidation
- Turn 6 (7 turn(s) ago): eval_anomaly_reports, rsi_onset
- Turn 7 (6 turn(s) ago): capability_jump, bio_uplift_findings, emergent_siting_backlash
- Turn 8 (5 turn(s) ago): loss_of_control_incident, capability_jump, catastrophic_bio_incident, medical_breakthrough, labour_displacement, knowledge_work_augmented, adoption_success, joint_threat_response
- Turn 9 (4 turn(s) ago): cyber_major_incident, opaque_reasoning, safety_breakthrough, us_labs_nationalised, eu_frontier_access_denied, member_state_defection, automated_decision_scandal
- Turn 10 (3 turn(s) ago): eval_anomaly_reports, medical_breakthrough, export_control_escalation, middle_power_coalition
- Turn 11 (2 turn(s) ago): medical_breakthrough, safety_breakthrough, embodied_ai_deployment, taiwan_tension_rise, eu_frontier_access_denied
- Turn 12 (1 turn(s) ago): eval_anomaly_reports, medical_breakthrough, embodied_ai_deployment
