...
- characters 107-12959: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13002-13190: `{{metrics_json}}` from the run's live metric values
- characters 13283-15186: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15230-17151: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17207-17659: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t13: M9 EU Borrowed-Competence Triage Continuity −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: none — capital 0, sentiment 1, capital below sentiment but no rule term for sentiment lending in v14, and capital cannot be raised past floor dynamics
SOVEREIGNTY: 8 last turn, no category 4 finish, no in-flight category 4 bonus, ai_investment_collapse t13 −2, capability rose 1.5 no −1 = 6
## Store changes
```json
{"store": []}
```
