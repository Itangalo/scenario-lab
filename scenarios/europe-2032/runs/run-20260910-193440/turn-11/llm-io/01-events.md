...
- characters 376-2484: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2528-4945: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5001-6151: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6214-33396: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33751-34779: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: M8 EU Middle-Power Sufficiency and Access Coalition −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: none — M8 already in flight, no new measure entered portfolio this turn
LEGITIMACY LENDS: none — capital 4, sentiment 3, capital above sentiment
SOVEREIGNTY: 11 last turn, no category 4 finish, no in-flight category 4 bonus, middle_power_coalition t10 +2 (largest capacity event, also export_control_escalation t10 qualifies), capability rose 1.5 −1 = 12

## Emerging developments (tracked)

- `emergent_infrastructure_sabotage_wave` -- first noted turn 9, listed in 2 turn(s) so far: Coordinated physical attacks on power substations and a gigafactory construction site by anti-AI militants, halting work and forcing military guard of energy infrastructure through winter.
- `emergent_pandemic_data_sovereignty_fight` -- first noted turn 9, listed in 2 turn(s) so far: Cross-border triage data pooled during the pandemic is repurposed into a pan-European early-warning bio-model hosted outside EU jurisdiction, triggering a sovereignty fight over who controls the model and the samples behind it.
...
- Turn 2 (9 turn(s) ago): cyber_defence_breakthrough, emergent_health_data_forgery_wave
- Turn 3 (8 turn(s) ago): bio_uplift_findings, adoption_success
- Turn 4 (7 turn(s) ago): openweight_frontier_release
- Turn 5 (6 turn(s) ago): cyber_major_incident, eval_anomaly_reports, eu_frontier_access_denied, election_consolidation
- Turn 6 (5 turn(s) ago): eval_anomaly_reports, rsi_onset
- Turn 7 (4 turn(s) ago): capability_jump, bio_uplift_findings, emergent_siting_backlash
- Turn 8 (3 turn(s) ago): loss_of_control_incident, capability_jump, catastrophic_bio_incident, medical_breakthrough, labour_displacement, knowledge_work_augmented, adoption_success, joint_threat_response
- Turn 9 (2 turn(s) ago): cyber_major_incident, opaque_reasoning, safety_breakthrough, us_labs_nationalised, eu_frontier_access_denied, member_state_defection, automated_decision_scandal
- Turn 10 (1 turn(s) ago): eval_anomaly_reports, medical_breakthrough, export_control_escalation, middle_power_coalition
