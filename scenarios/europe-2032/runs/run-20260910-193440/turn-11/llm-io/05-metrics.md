...
- characters 13010-13200: `{{metrics_json}}` from the run's live metric values
- characters 13293-15401: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15445-17862: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17918-18425: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 88.0, "openweight_capability": 83.7, "ai_safety": 5.0, "resilience": 47.5, "eu_ai_sovereignty": 10.0, "eu_political_capital": 5.0, "public_sentiment": 2.0}
```
