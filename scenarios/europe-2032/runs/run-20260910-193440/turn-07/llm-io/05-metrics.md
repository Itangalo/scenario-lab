...
- characters 13672-15659: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15703-18508: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18564-19303: `{{notepad}}` from the Game Master's notepad, carried across turns
