...
- characters 106-13382: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13425-13614: `{{metrics_json}}` from the run's live metric values
- characters 13707-15735: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15778-17830: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17886-19047: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Middle-Power Sufficiency and Access Coalition | 2 |
