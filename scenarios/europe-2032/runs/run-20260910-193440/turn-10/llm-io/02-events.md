...
- characters 374-2402: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2445-4497: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4553-5714: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5777-32959: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33314-34220: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t9: M7 EU Bio-Crisis Continuity and Loss-of-Control Containment Activation −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: none — capital 4, sentiment 3, capital above sentiment
SOVEREIGNTY: 15 last turn, no category 4 finish, no in-flight category 4 bonus, us_labs_nationalised t9 −3 (largest capacity event, also eu_frontier_access_denied t9 and member_state_defection t9 qualify), capability rose 3.0 −1 = 11

## Emerging developments (tracked)

- `emergent_infrastructure_sabotage_wave` -- first noted turn 9, listed in 1 turn(s) so far: Coordinated physical attacks on power substations and a gigafactory construction site by anti-AI militants, halting work and forcing military guard of energy infrastructure through winter.
- `emergent_pandemic_data_sovereignty_fight` -- first noted turn 9, listed in 1 turn(s) so far: Cross-border triage data pooled during the pandemic is repurposed into a pan-European early-warning bio-model hosted outside EU jurisdiction, triggering a sovereignty fight over who controls the model and the samples behind it.
...
- Turn 2 (8 turn(s) ago): cyber_defence_breakthrough, emergent_health_data_forgery_wave
- Turn 3 (7 turn(s) ago): bio_uplift_findings, adoption_success
- Turn 4 (6 turn(s) ago): openweight_frontier_release
- Turn 5 (5 turn(s) ago): cyber_major_incident, eval_anomaly_reports, eu_frontier_access_denied, election_consolidation
- Turn 6 (4 turn(s) ago): eval_anomaly_reports, rsi_onset
- Turn 7 (3 turn(s) ago): capability_jump, bio_uplift_findings, emergent_siting_backlash
- Turn 8 (2 turn(s) ago): loss_of_control_incident, capability_jump, catastrophic_bio_incident, medical_breakthrough, labour_displacement, knowledge_work_augmented, adoption_success, joint_threat_response
- Turn 9 (1 turn(s) ago): cyber_major_incident, opaque_reasoning, safety_breakthrough, us_labs_nationalised, eu_frontier_access_denied, member_state_defection, automated_decision_scandal
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.09}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.02}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.025}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_great_power_conflict", "probability": 0.11}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.16}, {"description": "", "emergent": false, "id": "us_china_agreement", "probability": 0.22}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.26}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Coordinated physical attacks on power substations and a gigafactory construction site by anti-AI militants, halting work and forcing military guard of energy infrastructure through winter.", "emergent": true, "id": "emergent_infrastructure_sabotage_wave", "probability": 0.22}, {"description": "Cross-border triage data pooled during the pandemic is repurposed into a pan-European early-warning bio-model hosted outside EU jurisdiction, triggering a sovereignty fight over who controls the model and the samples behind it.", "emergent": true, "id": "emergent_pandemic_data_sovereignty_fight", "probability": 0.18}]
```
