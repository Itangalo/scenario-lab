...
- characters 452-2480: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2523-4575: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6377-7239: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9474-12044: `{{previous_actions}}` from the actor's own response from the previous turn
