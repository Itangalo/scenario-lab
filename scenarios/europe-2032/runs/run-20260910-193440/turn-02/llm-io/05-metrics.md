...
- characters 105-13076: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13119-13311: `{{metrics_json}}` from the run's live metric values
- characters 13404-14596: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14639-16255: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16311-16782: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 58.0, "openweight_capability": 50.5, "ai_safety": 30.0, "resilience": 36.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 37.0, "public_sentiment": 37.0}
```
...
## Notepad
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Cyber-Hardening Directive −3, EU Swarm-Defence Scale-Up −2, priority −1 = −12
PROPOSAL BONUS: EU Swarm-Defence Scale-Up (cat 6, small) +3 — autumn swarm demonstration from last turn and this turn's hospital forgery wave this answers directly
LEGITIMACY LENDS: capital 44, sentiment 40 -> none, capital higher
