...
- characters 376-1568: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1611-3227: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3283-4056: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4119-27196: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 27551-27592: `{{event_history}}` from the run's own event record
