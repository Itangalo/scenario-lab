...
- characters 13026-13216: `{{metrics_json}}` from the run's live metric values
- characters 13309-15260: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15304-17485: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17541-18710: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M7 | EU Bio-Crisis Continuity and Loss-of-Control Containment Activation | 2 |
