...
- characters 375-2326: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2370-4551: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4607-5133: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5196-34608: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34963-35682: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: EU Bio-Crisis Continuity and Loss-of-Control Containment Activation −2, priority −1 not charged (capital below 20, no effect) = −2
PROPOSAL BONUS: EU Bio-Crisis Continuity (cat 6, small) +3 — catastrophic bio outbreak plus unsanctioned agent incident this turn, answers directly but small and just proposed
LEGITIMACY LENDS: capital 10, sentiment 14 -> +1 (capped, sentiment above capital)
SOVEREIGNTY: 12 last turn, M1 InvestAI Gigafactories finishes t8 +4, no capacity event, capability rose 7.0 −1 = 15
...
- Turn 2 (7 turn(s) ago): cyber_defence_breakthrough, emergent_health_data_forgery_wave
- Turn 3 (6 turn(s) ago): bio_uplift_findings, adoption_success
- Turn 4 (5 turn(s) ago): openweight_frontier_release
- Turn 5 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, eu_frontier_access_denied, election_consolidation
- Turn 6 (3 turn(s) ago): eval_anomaly_reports, rsi_onset
- Turn 7 (2 turn(s) ago): capability_jump, bio_uplift_findings, emergent_siting_backlash
- Turn 8 (1 turn(s) ago): loss_of_control_incident, capability_jump, catastrophic_bio_incident, medical_breakthrough, labour_displacement, knowledge_work_augmented, adoption_success, joint_threat_response
