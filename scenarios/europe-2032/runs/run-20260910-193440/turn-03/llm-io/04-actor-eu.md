...
- characters 455-1965: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2009-3982: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4833-5302: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7216-9063: `{{previous_actions}}` from the actor's own response from the previous turn
