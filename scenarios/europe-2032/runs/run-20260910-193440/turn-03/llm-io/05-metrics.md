...
- characters 13768-15278: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15322-17295: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17351-18178: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_trial_retraction_freeze` -- first noted turn 3, listed in 1 turn(s) so far: A coordinated wave of retractions of AI-assisted clinical trials by major journals after forensic tools flag synthetic patient data, freezing new trial approvals across Europe for months.
...
## Metrics
```json
{"ai_capability": 61.0, "openweight_capability": 54.0, "ai_safety": 28.0, "resilience": 41.0, "eu_ai_sovereignty": 19.0, "eu_political_capital": 33.0, "public_sentiment": 35.0}
```
