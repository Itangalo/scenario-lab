...
- characters 455-2187: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2231-4697: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7010-7479: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9668-11821: `{{previous_actions}}` from the actor's own response from the previous turn
