...
- characters 13779-16178: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16221-18429: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18485-19465: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "CONSOLIDATION"}}, {"op": "update", "table": "measures", "id": "M1", "fields": {"finish_turn": 8}, "grounds": "named priority"}]}
```
```
