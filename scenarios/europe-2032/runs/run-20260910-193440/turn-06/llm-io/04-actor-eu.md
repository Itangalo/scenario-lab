...
- characters 454-2853: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2896-5104: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6119-6567: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8756-10317: `{{previous_actions}}` from the actor's own response from the previous turn
