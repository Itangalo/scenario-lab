...
- characters 376-2775: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2818-5026: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5082-5503: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5566-32661: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33016-33383: `{{event_history}}` from the run's own event record
...
- Turn 2 (4 turn(s) ago): cyber_defence_breakthrough, emergent_health_data_forgery_wave
- Turn 3 (3 turn(s) ago): bio_uplift_findings, adoption_success
- Turn 4 (2 turn(s) ago): openweight_frontier_release
- Turn 5 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, eu_frontier_access_denied, election_consolidation
