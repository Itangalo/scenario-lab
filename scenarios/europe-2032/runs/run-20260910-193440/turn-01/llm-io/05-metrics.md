...
- characters 106-13037: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13080-13272: `{{metrics_json}}` from the run's live metric values
- characters 13388-16337: `{{world_state}}` from background/context.md, seeded as the opening world state
- characters 16393-16693: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M3 | EU Critical Infrastructure Cyber-Hardening Directive | 3 |
...
- `emergent_health_data_forgery_wave` -- first noted turn 1, listed in 1 turn(s) so far: Major European research hospitals disclose coordinated fraud and data-poisoning campaigns using Mythos-class open models to fabricate clinical trial data and insurance claims.
...
## Metrics
```json
{"ai_capability": 55.0, "openweight_capability": 46.0, "ai_safety": 32.0, "resilience": 37.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 44.0, "public_sentiment": 40.0}
```
## Narrative
...
## Notepad
PORTFOLIO CHARGE t1: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Infrastructure Cyber-Hardening Directive −3, priority −1 = −10
PROPOSAL BONUS: EU Critical Infrastructure Cyber-Hardening Directive (cat 6, large) +4 — cyber_test_shot landed this turn and this answers it directly
LEGITIMACY LENDS: capital 44, sentiment 40 -> none, capital higher
