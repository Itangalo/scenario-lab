...
- characters 374-2401: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2444-4891: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4947-5427: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5490-32672: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 33027-34197: `{{event_history}}` from the run's own event record
...
- Turn 2 (10 turn(s) ago): cyber_defence_breakthrough, emergent_health_data_forgery_wave
- Turn 3 (9 turn(s) ago): bio_uplift_findings, adoption_success
- Turn 4 (8 turn(s) ago): openweight_frontier_release
- Turn 5 (7 turn(s) ago): cyber_major_incident, eval_anomaly_reports, eu_frontier_access_denied, election_consolidation
- Turn 6 (6 turn(s) ago): eval_anomaly_reports, rsi_onset
- Turn 7 (5 turn(s) ago): capability_jump, bio_uplift_findings, emergent_siting_backlash
- Turn 8 (4 turn(s) ago): loss_of_control_incident, capability_jump, catastrophic_bio_incident, medical_breakthrough, labour_displacement, knowledge_work_augmented, adoption_success, joint_threat_response
- Turn 9 (3 turn(s) ago): cyber_major_incident, opaque_reasoning, safety_breakthrough, us_labs_nationalised, eu_frontier_access_denied, member_state_defection, automated_decision_scandal
- Turn 10 (2 turn(s) ago): eval_anomaly_reports, medical_breakthrough, export_control_escalation, middle_power_coalition
- Turn 11 (1 turn(s) ago): medical_breakthrough, safety_breakthrough, embodied_ai_deployment, taiwan_tension_rise, eu_frontier_access_denied
