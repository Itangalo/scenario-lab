...
- characters 106-13463: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13506-13695: `{{metrics_json}}` from the run's live metric values
- characters 13788-15815: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15858-18305: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18361-18841: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | EU Borrowed-Competence Triage Continuity | 2 |
