...
- characters 375-2347: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2390-4532: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4588-5257: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5320-34539: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34894-35408: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t7: M1 InvestAI Gigafactories −3, M6 EU Model Evaluation and Release Brake −2, priority −1 = −6
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 9, sentiment 14 -> +1
SOVEREIGNTY: 13 last turn, no capacity event, M1 InvestAI Gigafactories in flight +0, capability rose 5.0 −1 = 12

## Emerging developments (tracked)

- `emergent_infrastructure_sabotage` -- first noted turn 6, listed in 2 turn(s) so far: Coordinated physical sabotage and blockades target planned gigafactory grid connections and data-centre sites in two member states, delaying construction and forcing a national debate on AI infrastructure siting.
...
- Turn 2 (6 turn(s) ago): cyber_defence_breakthrough, emergent_health_data_forgery_wave
- Turn 3 (5 turn(s) ago): bio_uplift_findings, adoption_success
- Turn 4 (4 turn(s) ago): openweight_frontier_release
- Turn 5 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, eu_frontier_access_denied, election_consolidation
- Turn 6 (2 turn(s) ago): eval_anomaly_reports, rsi_onset
- Turn 7 (1 turn(s) ago): capability_jump, bio_uplift_findings, emergent_siting_backlash
