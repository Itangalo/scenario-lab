...
- characters 13529-13720: `{{metrics_json}}` from the run's live metric values
- characters 13813-15785: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15828-17970: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18026-18357: `{{notepad}}` from the Game Master's notepad, carried across turns
