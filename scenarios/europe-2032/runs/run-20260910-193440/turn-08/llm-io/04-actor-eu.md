...
- characters 453-2425: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2468-4610: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7628-8076: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10116-11244: `{{previous_actions}}` from the actor's own response from the previous turn
