...
| M9 | EU Shopfloor and Care Transition Shield | 7 | small | 7 | 9 | own jurisdiction | resilience up modestly, public_sentiment protected/up, eu_political_capital protected | 2 | running |
...
- **applied** `M9` — {"op": "add", "table": "measures", "fields": {"name": "EU Shopfloor and Care Transition Shield", "category": 7, "size": "small", "finish_turn": 9, "applies_to": "own jurisdiction", "targeted_effect": "resilience up modestly, public_sentiment protected/up, eu_political_capital protected"}, "grounds": "to absorb embodied-AI displacement in logistics and care before backlash blocks essential services
  - Grounds: to absorb embodied-AI displacement in logistics and care before backlash blocks essential services
