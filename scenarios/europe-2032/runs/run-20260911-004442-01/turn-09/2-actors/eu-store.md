...
| M9 | EU Shopfloor and Care Transition Shield | 7 | small | 7 | 8 | own jurisdiction | resilience up modestly, public_sentiment protected/up, eu_political_capital protected | 2 | finished |
| M10 | EU State-to-State Continuity and Containment Accord | 8 | small | 8 | 9 | coalition and supply-chain partners plus US state counterpart, implemented in own jurisdiction | resilience up, ai_safety protected, eu_political_capital protected | 2 | finished |
| M11 | EU Essential Continuity and Social Absorption Pact | 6 | small | 9 | 11 | own jurisdiction | resilience up, public_sentiment protected/up, eu_political_capital protected | 2 | running |
...
- **applied** `M11` — {"op": "add", "table": "measures", "fields": {"name": "EU Essential Continuity and Social Absorption Pact", "category": 6, "size": "small", "finish_turn": 11, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, public_sentiment protected/up, eu_political_capital protected"}, "grounds": "to absorb unpreventable diffusion with continuity held under old commitment"}
  - Grounds: to absorb unpreventable diffusion with continuity held under old commitment
