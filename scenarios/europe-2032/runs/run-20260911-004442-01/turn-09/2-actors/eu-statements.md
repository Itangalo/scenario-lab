...
- `two_year_commitment` (commitment): Survive open superhuman diffusion while keeping essential services and social cohesion intact

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Survive open superhuman diffusion while keeping essential services and social cohesion intact
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The commitment's duration ending directly changes the actor's obligation to uphold the prior statement.
