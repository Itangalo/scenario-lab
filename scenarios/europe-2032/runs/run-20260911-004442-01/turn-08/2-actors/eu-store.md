...
| M10 | EU State-to-State Continuity and Containment Accord | 8 | small | 8 | 10 | coalition and supply-chain partners plus US state counterpart, implemented in own jurisdiction | resilience up, ai_safety protected, eu_political_capital protected | 2 | running |
...
- **applied** `M10` — {"op": "add", "table": "measures", "fields": {"name": "EU State-to-State Continuity and Containment Accord", "category": 8, "size": "small", "finish_turn": 10, "applies_to": "coalition and supply-chain partners plus US state counterpart, implemented in own jurisdiction", "targeted_effect": "resilience up, ai_safety protected, eu_political_capital protected"}, "grounds": "to replace company-leverag
  - Grounds: to replace company-leverage with state negotiation after US nationalisation while absorbing capability jump
