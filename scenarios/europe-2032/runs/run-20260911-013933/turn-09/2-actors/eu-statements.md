...
- `two_year_commitment` (commitment): Rebuild public trust and absorb AI displacement while keeping essential services running on controlled systems

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild public trust and absorb AI displacement while keeping essential services running on controlled systems
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the original mandate, necessitating a shift in focus from containment to rebuilding trust and managing displacement.
