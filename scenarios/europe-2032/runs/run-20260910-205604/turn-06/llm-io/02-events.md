...
- characters 1605-3754: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3810-4970: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5033-31719: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32074-32468: `{{event_history}}` from the run's own event record
...
- `emergent_datacentre_permitting_freeze` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated local referendums and court injunctions halt several gigafactory-linked data-centre builds over water and power use, freezing permitted capacity for months.
- `emergent_datacentre_permit_freeze` -- first noted turn 4, listed in 2 turn(s) so far: Coordinated municipal moratoriums on new data-centre water and power connections spread across several member states, freezing gigafactory site permitting for months.
...
- Turn 2 (4 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, openweight_frontier_release, automated_decision_scandal
- Turn 3 (3 turn(s) ago): openweight_frontier_release, export_control_escalation
- Turn 4 (2 turn(s) ago): bio_uplift_findings, supply_chain_coercion
- Turn 5 (1 turn(s) ago): embodied_ai_deployment, election_retrenchment
