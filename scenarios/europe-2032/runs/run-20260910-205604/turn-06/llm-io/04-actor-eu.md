...
- characters 1683-3832: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4550-5000: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7512-9956: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | EU Bio Detection and Response Surge | 6 | small | 4 | 7 | own jurisdiction | resilience up, ai_safety up slightly via detection | 2 | running |
