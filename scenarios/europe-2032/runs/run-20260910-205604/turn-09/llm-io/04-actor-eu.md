...
- characters 454-1440: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1484-3231: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5364-5814: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8370-9574: `{{previous_actions}}` from the actor's own response from the previous turn
