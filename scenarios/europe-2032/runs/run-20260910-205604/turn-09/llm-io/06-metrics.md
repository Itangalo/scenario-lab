...
- characters 13729-14715: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14759-16506: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16562-16914: `{{notepad}}` from the Game Master's notepad, carried across turns
