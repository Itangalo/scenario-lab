...
- characters 376-1362: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1406-3153: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3209-3854: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3917-31206: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31561-32226: `{{event_history}}` from the run's own event record
...
- Turn 2 (7 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, openweight_frontier_release, automated_decision_scandal
- Turn 3 (6 turn(s) ago): openweight_frontier_release, export_control_escalation
- Turn 4 (5 turn(s) ago): bio_uplift_findings, supply_chain_coercion
- Turn 5 (4 turn(s) ago): embodied_ai_deployment, election_retrenchment
- Turn 6 (3 turn(s) ago): eu_frontier_access_denied, emergent_datacentre_permitting_freeze
- Turn 7 (2 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment
- Turn 8 (1 turn(s) ago): eval_anomaly_reports, research_breakthrough, emergent_municipal_inference_ban_pact
