...
- characters 106-13265: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13308-13497: `{{metrics_json}}` from the run's live metric values
- characters 13590-14413: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14456-16557: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16613-17047: `{{notepad}}` from the Game Master's notepad, carried across turns
