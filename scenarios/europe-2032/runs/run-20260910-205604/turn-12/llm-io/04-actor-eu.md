...
- characters 452-1275: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1318-3419: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5915-6371: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9133-10703: `{{previous_actions}}` from the actor's own response from the previous turn
