...
- characters 374-1197: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1240-3341: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3397-4125: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4188-31736: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32091-33058: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: Municipal Night-Cover Mutual Aid −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2, sentiment 3 -> +2 capped by prior charges and internal-origin losses, net absorbed
SOVEREIGNTY: 11 last turn, no capacity event finish, no cat4 in flight +0, member_state_defection t11 −3 (largest, emergent stranded writeoff same turn absorbed), capability rose 0.8 −0 = 8

## Emerging developments (tracked)

- `emergent_municipal_kit_market` -- first noted turn 10, listed in 2 turn(s) so far: Shadow brokers begin renting turnkey open-weight ransomware kits tuned to EU municipal IT stacks, advertised openly with night-shift targeting and water-utility payloads.
...
- Turn 2 (10 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, openweight_frontier_release, automated_decision_scandal
- Turn 3 (9 turn(s) ago): openweight_frontier_release, export_control_escalation
- Turn 4 (8 turn(s) ago): bio_uplift_findings, supply_chain_coercion
- Turn 5 (7 turn(s) ago): embodied_ai_deployment, election_retrenchment
- Turn 6 (6 turn(s) ago): eu_frontier_access_denied, emergent_datacentre_permitting_freeze
- Turn 7 (5 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment
- Turn 8 (4 turn(s) ago): eval_anomaly_reports, research_breakthrough, emergent_municipal_inference_ban_pact
- Turn 9 (3 turn(s) ago): cyber_major_incident, ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, taiwan_tension_rise
- Turn 10 (2 turn(s) ago): cyber_major_incident, eu_frontier_access_denied
- Turn 11 (1 turn(s) ago): member_state_defection, emergent_stranded_gigafactory_writeoff
