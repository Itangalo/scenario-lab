...
- characters 106-12921: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 12964-13155: `{{metrics_json}}` from the run's live metric values
- characters 13248-14685: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14728-17308: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17364-18254: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | Municipal Night-Cover Mutual Aid | 2 |
