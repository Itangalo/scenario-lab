...
- characters 376-1813: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1856-4436: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4492-4772: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4835-31530: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31885-32685: `{{event_history}}` from the run's own event record
...
- Turn 2 (8 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, openweight_frontier_release, automated_decision_scandal
- Turn 3 (7 turn(s) ago): openweight_frontier_release, export_control_escalation
- Turn 4 (6 turn(s) ago): bio_uplift_findings, supply_chain_coercion
- Turn 5 (5 turn(s) ago): embodied_ai_deployment, election_retrenchment
- Turn 6 (4 turn(s) ago): eu_frontier_access_denied, emergent_datacentre_permitting_freeze
- Turn 7 (3 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment
- Turn 8 (2 turn(s) ago): eval_anomaly_reports, research_breakthrough, emergent_municipal_inference_ban_pact
- Turn 9 (1 turn(s) ago): cyber_major_incident, ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, taiwan_tension_rise
