...
- characters 454-1891: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1934-4514: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5463-5919: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8475-9811: `{{previous_actions}}` from the actor's own response from the previous turn
