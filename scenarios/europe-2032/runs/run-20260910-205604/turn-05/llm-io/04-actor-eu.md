...
- characters 1936-4063: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6159-6612: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8923-10960: `{{previous_actions}}` from the actor's own response from the previous turn
