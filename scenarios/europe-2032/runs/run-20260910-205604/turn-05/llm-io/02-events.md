...
- characters 1858-3985: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4041-5225: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5288-33773: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 34128-34450: `{{event_history}}` from the run's own event record
...
- Turn 2 (3 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, openweight_frontier_release, automated_decision_scandal
- Turn 3 (2 turn(s) ago): openweight_frontier_release, export_control_escalation
- Turn 4 (1 turn(s) ago): bio_uplift_findings, supply_chain_coercion
