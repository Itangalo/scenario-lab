...
- characters 13852-15289: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15333-17460: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17516-18700: `{{notepad}}` from the Game Master's notepad, carried across turns
