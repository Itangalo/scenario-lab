...
- characters 376-1569: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1613-3517: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3573-4621: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4684-32232: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32587-33463: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t10: Municipal Night-Cover Mutual Aid −2 = −2 + priority none = −2
PROPOSAL BONUS: Municipal Night-Cover Mutual Aid (cat 6, small) +3 — cyber_major_incident and frontier denial landed this turn and this answers small-service gap directly
LEGITIMACY LENDS: capital 0, sentiment 3 -> +2
SOVEREIGNTY: 14 last turn, no capacity event finish, no cat4 in flight +0, eu_frontier_access_denied t10 −3, capability rose 0.8 −0 = 11

## Emerging developments (tracked)

- `emergent_stranded_gigafactory_writeoff` -- first noted turn 10, listed in 1 turn(s) so far: Coordinated physical blockades and municipal court injunctions permanently strand the Lyon and Magdeburg gigafactory shells without power or fit-out, forcing the Commission to write them off as stranded assets this turn.
- `emergent_municipal_kit_market` -- first noted turn 10, listed in 1 turn(s) so far: Shadow brokers begin renting turnkey open-weight ransomware kits tuned to EU municipal IT stacks, advertised openly with night-shift targeting and water-utility payloads.
...
- Turn 2 (9 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, openweight_frontier_release, automated_decision_scandal
- Turn 3 (8 turn(s) ago): openweight_frontier_release, export_control_escalation
- Turn 4 (7 turn(s) ago): bio_uplift_findings, supply_chain_coercion
- Turn 5 (6 turn(s) ago): embodied_ai_deployment, election_retrenchment
- Turn 6 (5 turn(s) ago): eu_frontier_access_denied, emergent_datacentre_permitting_freeze
- Turn 7 (4 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment
- Turn 8 (3 turn(s) ago): eval_anomaly_reports, research_breakthrough, emergent_municipal_inference_ban_pact
- Turn 9 (2 turn(s) ago): cyber_major_incident, ai_investment_collapse, bio_uplift_findings, eval_anomaly_reports, taiwan_tension_rise
