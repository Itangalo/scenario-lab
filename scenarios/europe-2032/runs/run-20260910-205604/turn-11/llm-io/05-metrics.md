...
- characters 12965-13155: `{{metrics_json}}` from the run's live metric values
- characters 13248-14441: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14485-16389: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16445-17177: `{{notepad}}` from the Game Master's notepad, carried across turns
