...
- characters 375-1121: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1164-2811: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 2867-3922: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3985-31274: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31629-32185: `{{event_history}}` from the run's own event record
...
- Turn 2 (6 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, openweight_frontier_release, automated_decision_scandal
- Turn 3 (5 turn(s) ago): openweight_frontier_release, export_control_escalation
- Turn 4 (4 turn(s) ago): bio_uplift_findings, supply_chain_coercion
- Turn 5 (3 turn(s) ago): embodied_ai_deployment, election_retrenchment
- Turn 6 (2 turn(s) ago): eu_frontier_access_denied, emergent_datacentre_permitting_freeze
- Turn 7 (1 turn(s) ago): eval_anomaly_reports, embodied_ai_deployment
