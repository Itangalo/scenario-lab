...
- characters 13697-14443: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14486-16133: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16189-16925: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_anti_compute_sabotage` -- first noted turn 7, listed in 2 turn(s) so far: Coordinated physical blockades and sabotage of grid connections at frozen gigafactory sites and operating data centres, forcing extended outages and a policing response.
