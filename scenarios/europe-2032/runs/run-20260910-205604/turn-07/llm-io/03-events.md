...
- characters 377-1485: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1529-3647: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3703-4288: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4351-31640: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31995-32480: `{{event_history}}` from the run's own event record
...
- Turn 2 (5 turn(s) ago): cyber_defence_breakthrough, bio_uplift_findings, openweight_frontier_release, automated_decision_scandal
- Turn 3 (4 turn(s) ago): openweight_frontier_release, export_control_escalation
- Turn 4 (3 turn(s) ago): bio_uplift_findings, supply_chain_coercion
- Turn 5 (2 turn(s) ago): embodied_ai_deployment, election_retrenchment
- Turn 6 (1 turn(s) ago): eu_frontier_access_denied, emergent_datacentre_permitting_freeze
