...
- characters 13164-14115: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14159-16235: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16291-16708: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t13: no measures in flight, priority none = −0
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 2.0, sentiment 0.5 -> none, capital higher
SOVEREIGNTY: 5 last turn, no cat4 finish +0, no cat4 in flight +0, eu_frontier_access_denied t13 −2, capability rose 1.2 −0 = 3
## Store changes
```json
{"store": []}
```
