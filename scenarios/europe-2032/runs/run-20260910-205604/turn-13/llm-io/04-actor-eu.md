...
- characters 453-1404: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1448-3524: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5902-6358: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9120-10328: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M9 | Municipal Night-Cover Mutual Aid | 6 | small | 10 | 12 | own jurisdiction | resilience up modestly, public_sentiment up slightly, eu_political_capital up slightly via visible repair | 2 | finished |
...
## New measure
None this turn — with political capital at zero and no funded instrument in flight, any new measure cannot be staffed or enforced and would deepen the defection.

## Store changes
No changes.

## Priority
No priority named this turn, because there is no in-flight measure to push and naming a finished one would misdirect enforcement we do not have.

## In practice
We conserve what still functions on existing payroll and legal bases: ENISA coordination and the French-German-Dutch watch centres maintain night cover for clinics, water operators and small municipalities through the automated ransomware sweep, with restores and telemetry-sharing as the whole of response. No new hardening fund or mandate is announced.

We manage scarcity and dependence openly. The Taiwan blockade makes our upstream lithography and equipment position our only leverage, but we do not offer export action we cannot enforce; the US cutoff and the open-weight frontier release are noted as facts constraining hospitals and firms to slower European-hosted and relabelled open tools, and the member-state side deal is tolerated to keep wage advances flowing to Rotterdam, Antwerp and Lodz while cohesion holds.
...
```
## New measure
None this turn — with political capital at 2 and public sentiment at 3, any new funded instrument cannot be staffed or enforced and would deepen the defection.

We conserve what still functions on existing payroll and legal bases: the finished Shield, Bio Surge and Night-Cover mutual-aid networks sustain clinic restores and water-operator isolation through the automated ransomware sweep, while ministries fall back to slower European-hosted tools and the tolerated open-weight installs for triage paperwork. No new hardening fund, export retaliation, or compute build is announced because none can be paid for or held together.
...
## In practice
The Commission holds the line on essential services without opening a new file. ENISA and the French-German-Dutch watch centres extend night cover by roster, not by mandate, talking hospitals and registries through backups and telemetry-sharing by phone as the model-generated ransomware adapts. The Taiwan Strait blockade and the US cutoff are managed as scarcity facts: lithography leverage is held but not exercised, the capital's cut-price cloud side deal is tolerated to keep Rotterdam, Antwerp and Lodz wage advances flowing.

On cohesion, we do not spend against a productivity gain the public cannot feel as a crisis. The measured augmentation in law, accountancy and administration — more output per person, early cutters rehiring — is noted in communications but not campaigned on, while tailored-therapy access on foreign infrastructure and the middle-power coordination framework on licences and joint bargaining are kept alive at ministerial level without promises of hardware this turn.
