...
- characters 16339-16627: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_datacentre_backlash` -- first noted turn 1, listed in 1 turn(s) so far: Coordinated local protests and grid-connection lawsuits delay at least one hyperscale data centre project in Spain or Germany amid power-price and water-use grievances.
...
## Metrics
```json
{"ai_capability": 54.0, "openweight_capability": 46.0, "ai_safety": 32.0, "resilience": 37.0, "eu_ai_sovereignty": 21.0, "eu_political_capital": 43.0, "public_sentiment": 39.0}
```
