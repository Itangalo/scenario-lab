...
- characters 376-1295: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1338-3060: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3116-4070: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4133-28360: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28715-28756: `{{event_history}}` from the run's own event record
