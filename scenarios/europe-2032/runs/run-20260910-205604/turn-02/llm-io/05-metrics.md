...
- characters 13368-14287: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14330-16052: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16108-17062: `{{notepad}}` from the Game Master's notepad, carried across turns
...
- `emergent_datacentre_backlash` -- first noted turn 1, listed in 2 turn(s) so far: Coordinated local protests and grid-connection lawsuits delay at least one hyperscale data centre project in Spain or Germany amid power-price and water-use grievances.
