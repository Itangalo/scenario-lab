...
- characters 1370-3439: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4657-5097: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7164-8452: `{{previous_actions}}` from the actor's own response from the previous turn
