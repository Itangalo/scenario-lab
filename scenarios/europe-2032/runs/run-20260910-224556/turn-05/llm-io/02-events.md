...
- characters 1292-3361: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3417-3802: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3865-32143: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32498-32839: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU ASML Shield and Supply-Chain Coalition −2, priority −0 (capital below 20, no effect, no cost) = −8
...
- Turn 2 (3 turn(s) ago): emergent_siting_backlash
- Turn 3 (2 turn(s) ago): capability_jump, eval_anomaly_reports, knowledge_work_augmented, export_control_escalation, supply_chain_coercion
- Turn 4 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, opaque_reasoning, medical_breakthrough
