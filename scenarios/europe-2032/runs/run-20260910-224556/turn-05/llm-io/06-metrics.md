...
- characters 13836-14707: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14751-16820: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16876-17569: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M6 | EU Essential Services Hardening and Mutual Aid | 2 |
...
|---|---|---|---|---|---|---|---|---|---|
| M5 | EU ASML Shield and Supply-Chain Coalition | 8 | small | 3 | 5 | coalition | eu_ai_sovereignty up, eu_political_capital stabilize | 2 | finished |
...
- `emergent_siting_sabotage_wave` -- first noted turn 5, listed in 1 turn(s) so far: Coordinated physical blockades of gigafactory and data-centre construction sites in Spain and Sweden, fusing water-use litigation with anti-AI job-loss protest, halting works for weeks.
...
## Notepad
PORTFOLIO CHARGE t5: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Essential Services Hardening and Mutual Aid −2, priority −0 (capital below 20, no effect, no cost) = −8
PROPOSAL BONUS: EU Essential Services Hardening and Mutual Aid (cat 6, small) +2 — February-April ransomware wave landed within last three turns and this answers it directly
LEGITIMACY LENDS: capital 2, sentiment 24 -> +2
SOVEREIGNTY: 16 last turn, no capacity event, Gigafactories in flight +0, member_state_defection t5 −2, capability rose 3.0 −1 = 13
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "pending"}}]}
```
