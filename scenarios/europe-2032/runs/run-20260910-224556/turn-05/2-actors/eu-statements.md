...
- `two_year_commitment` (commitment): Rebuild independent, resilient AI capacity under European control

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild independent, resilient AI capacity under European control
