...
- characters 1523-3426: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3482-4252: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4315-27891: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28246-28338: `{{event_history}}` from the run's own event record
...
- `emergent_grid_toolkit_copycats` -- first noted turn 2, listed in 1 turn(s) so far: Forensic write-ups of the autumn grid intrusion circulate exploit tooling derived from the open model, triggering copycat probing of municipal utilities and ports by smaller actors.
...
- Turn 2 (1 turn(s) ago): emergent_siting_backlash
