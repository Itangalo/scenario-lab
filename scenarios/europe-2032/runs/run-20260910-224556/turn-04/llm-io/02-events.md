...
- characters 1618-4041: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4097-4996: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5059-32607: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32962-33194: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): emergent_siting_backlash
- Turn 3 (1 turn(s) ago): capability_jump, eval_anomaly_reports, knowledge_work_augmented, export_control_escalation, supply_chain_coercion
