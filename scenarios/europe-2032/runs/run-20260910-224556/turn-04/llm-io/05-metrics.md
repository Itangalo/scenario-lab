...
- characters 105-13638: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13681-13873: `{{metrics_json}}` from the run's live metric values
- characters 13966-15165: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15208-17631: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17687-18281: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 66.0, "openweight_capability": 58.0, "ai_safety": 17.0, "resilience": 39.0, "eu_ai_sovereignty": 16.0, "eu_political_capital": 11.0, "public_sentiment": 28.0}
```
