...
- characters 4230-4670: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6124-8215: `{{previous_actions}}` from the actor's own response from the previous turn
...
**emergent_siting_backlash (emergent event):** Coordinated local protests and permitting lawsuits stall at least one announced AI factory or data-centre zone site for months, driven by energy-cost and water-use concerns.
