...
- `two_year_commitment` (commitment): Survive cutoff and bio uplift on degraded capacity while rebuilding independent compute

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Survive cutoff and bio uplift on degraded capacity while rebuilding independent compute
