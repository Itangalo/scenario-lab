...
- `two_year_commitment` (commitment): Secure the capacity to act independently in an age of AI, or lose the right to shape our future.

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure the capacity to act independently in an age of AI, or lose the right to shape our future.
