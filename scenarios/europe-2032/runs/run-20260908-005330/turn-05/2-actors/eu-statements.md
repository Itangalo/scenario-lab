...
- `two_year_commitment` (commitment): Secure sovereign AI development and deployment to prevent strategic dependence and catastrophic risk

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign AI development and deployment to prevent strategic dependence and catastrophic risk
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The closure of the commitment period directly ends the original pledge's timeframe, changing the actor's obligation and triggering a necessary reassessment of its form.
