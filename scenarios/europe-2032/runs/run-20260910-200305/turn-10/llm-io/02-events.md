...
- characters 376-1669: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1712-3637: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3693-4041: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4104-30758: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31113-31923: `{{event_history}}` from the run's own event record
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 2 (8 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, member_state_defection, automated_decision_scandal, emergent_datacentre_blockade
- Turn 4 (6 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented, export_control_escalation, automated_decision_scandal
- Turn 5 (5 turn(s) ago): cyber_major_incident, bio_incident, ai_investment_collapse, safety_breakthrough, emergent_clinical_moratorium_suit, election_consolidation
- Turn 6 (4 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_welfare_scoring_court_ban
- Turn 8 (2 turn(s) ago): emergent_periphery_care_split
- Turn 9 (1 turn(s) ago): openweight_frontier_release, emergent_periphery_care_refusal
