...
- characters 1790-3715: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6256-6728: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9667-12286: `{{previous_actions}}` from the actor's own response from the previous turn
...
**emergent_periphery_mutual_aid_compact (emergent event):** Periphery hospital federations and municipal utilities formalize a mutual-aid compact to pool segmented compute and on-call technician teams across borders, operating outside Brussels command after repeated detachment shortfalls.
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | Locally Stationed Care Continuity Detachments | 9 | small | 9 | 11 | own jurisdiction | public_sentiment up moderately, resilience up slightly via staffed periphery reopening | 2 | running |
