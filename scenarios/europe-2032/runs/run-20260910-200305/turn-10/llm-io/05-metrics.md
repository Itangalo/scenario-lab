...
- characters 106-12999: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13042-13233: `{{metrics_json}}` from the run's live metric values
- characters 13326-14619: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14662-16587: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16643-17322: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M10 | Locally Stationed Care Continuity Detachments | 2 |
| M11 | Recognised Periphery Mutual-Aid Interoperability | 2 |
...
PORTFOLIO CHARGE t9: Locally Stationed Care Continuity Detachments −2, priority −1 = −3
PROPOSAL BONUS: none — Locally Stationed Detachments restates M10 already in flight, no new measure added this turn
...
- `emergent_detachment_backlash` -- first noted turn 10, listed in 1 turn(s) so far: Permanently stationed EU detachments running segmented clinical kits become a repeated physical target, with a coordinated intimidation and sabotage campaign forcing at least one site to withdraw temporarily.
