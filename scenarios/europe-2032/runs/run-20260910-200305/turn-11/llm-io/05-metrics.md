...
- characters 107-13361: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13404-13595: `{{metrics_json}}` from the run's live metric values
- characters 13688-14666: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14710-16824: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16880-17827: `{{notepad}}` from the Game Master's notepad, carried across turns
