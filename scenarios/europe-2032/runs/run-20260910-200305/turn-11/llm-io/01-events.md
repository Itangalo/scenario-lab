...
- characters 1399-3513: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3569-4516: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4579-31233: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31588-32566: `{{event_history}}` from the run's own event record
...
- Turn 1 (10 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 2 (9 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, member_state_defection, automated_decision_scandal, emergent_datacentre_blockade
- Turn 4 (7 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented, export_control_escalation, automated_decision_scandal
- Turn 5 (6 turn(s) ago): cyber_major_incident, bio_incident, ai_investment_collapse, safety_breakthrough, emergent_clinical_moratorium_suit, election_consolidation
- Turn 6 (5 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_welfare_scoring_court_ban
- Turn 8 (3 turn(s) ago): emergent_periphery_care_split
- Turn 9 (2 turn(s) ago): openweight_frontier_release, emergent_periphery_care_refusal
- Turn 10 (1 turn(s) ago): medical_breakthrough, knowledge_work_augmented, export_control_escalation, eu_frontier_access_denied, emergent_periphery_mutual_aid_compact
