...
- characters 377-2826: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2870-5086: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5142-6271: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 6334-34819: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 35174-35559: `{{event_history}}` from the run's own event record
...
- `emergent_clinical_moratorium_suit` -- first noted turn 4, listed in 1 turn(s) so far: A coalition of European hospital federations and medical associations sues to suspend AI triage fallbacks after dosage hallucinations, seeking a court-ordered moratorium on open-model clinical use until certified.
- `emergent_welfare_scoring_court_ban` -- first noted turn 4, listed in 1 turn(s) so far: The Court of Justice rules the welfare fraud-scoring system unlawful under EU fundamental rights and orders suspension, triggering compensation claims and a wider audit of similar public-sector models.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 2 (3 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, member_state_defection, automated_decision_scandal, emergent_datacentre_blockade
- Turn 4 (1 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented, export_control_escalation, automated_decision_scandal
