...
- characters 455-2904: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2948-5164: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7705-8159: `{{statement_ledger}}` from the actor's live statement ledger
- characters 10398-12351: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M6 | High-Risk Enforcement Audit | 1 | small | 4 | 6 | own jurisdiction | ai_safety up slightly, public_sentiment up slightly via restored trust | 2 | running |
