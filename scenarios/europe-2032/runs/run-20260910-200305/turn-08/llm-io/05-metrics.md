...
- characters 105-13320: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13363-13555: `{{metrics_json}}` from the run's live metric values
- characters 13648-16481: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16524-18022: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18078-18864: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M9 | Periphery Care Audit and Extension Pact | 2 |
...
PORTFOLIO CHARGE t7: Certified Care Continuity Corps −2, priority −1 = −3
PROPOSAL BONUS: Certified Care Continuity Corps (cat 9, small) +3 — wards partly closed and fraud-scoring ban collapsed legitimacy in last turns and this answers it directly
LEGITIMACY LENDS: capital 14, sentiment 15 -> +2 (applied after finishes and event terms, capped by sentiment)
SOVEREIGNTY: 13 last turn, InvestAI Gigafactories finishes t7 +4, no in-flight cat4 +0, no capacity event, capability rose 1.0 −0 = 17

## Emerging developments (tracked)

- `emergent_periphery_care_refusal` -- first noted turn 8, listed in 1 turn(s) so far: Periphery mayors and hospital directors jointly refuse to reopen EU triage tools without locally stationed certified teams, forcing a formal two-tier continuity regime.
...
## Metrics
```json
{"ai_capability": 64.0, "openweight_capability": 61.9, "ai_safety": 26.0, "resilience": 46.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 13.0, "public_sentiment": 15.0}
```
...
## Notepad
PORTFOLIO CHARGE t8: Periphery Care Audit and Extension Pact −2, priority −1 = −3
PROPOSAL BONUS: Periphery Care Audit and Extension Pact (cat 9, small) +2 — periphery coordinated refusal to rejoin triage this turn and this answers it directly
