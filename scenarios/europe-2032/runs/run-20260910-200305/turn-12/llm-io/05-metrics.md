...
- characters 106-13359: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13402-13593: `{{metrics_json}}` from the run's live metric values
- characters 13686-14921: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14964-17292: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17348-17712: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 68.0, "openweight_capability": 66.0, "ai_safety": 12.0, "resilience": 43.0, "eu_ai_sovereignty": 10.0, "eu_political_capital": 14.0, "public_sentiment": 9.0}
```
## Narrative
