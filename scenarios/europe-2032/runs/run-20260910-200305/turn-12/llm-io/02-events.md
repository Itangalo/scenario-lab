...
- characters 376-1611: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1654-3982: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4038-4733: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4796-31450: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31805-32899: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t11: Recognised Periphery Mutual-Aid Interoperability −2, priority −1 = −3
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 5, sentiment 17 -> +2
SOVEREIGNTY: 14 last turn, no cat4 finish +0, Recognised Periphery Mutual-Aid Interoperability in flight +0, embodied_ai_deployment t11 −2, capability rose 1.0 −0 = 12

## Emerging developments (tracked)

- `emergent_detachment_backlash` -- first noted turn 10, listed in 2 turn(s) so far: Permanently stationed EU detachments running segmented clinical kits become a repeated physical target, with a coordinated intimidation and sabotage campaign forcing at least one site to withdraw temporarily.
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 2 (10 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, member_state_defection, automated_decision_scandal, emergent_datacentre_blockade
- Turn 4 (8 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented, export_control_escalation, automated_decision_scandal
- Turn 5 (7 turn(s) ago): cyber_major_incident, bio_incident, ai_investment_collapse, safety_breakthrough, emergent_clinical_moratorium_suit, election_consolidation
- Turn 6 (6 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_welfare_scoring_court_ban
- Turn 8 (4 turn(s) ago): emergent_periphery_care_split
- Turn 9 (3 turn(s) ago): openweight_frontier_release, emergent_periphery_care_refusal
- Turn 10 (2 turn(s) ago): medical_breakthrough, knowledge_work_augmented, export_control_escalation, eu_frontier_access_denied, emergent_periphery_mutual_aid_compact
- Turn 11 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, labour_displacement, embodied_ai_deployment
