...
- characters 106-13422: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13465-13657: `{{metrics_json}}` from the run's live metric values
- characters 13750-15235: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15279-17952: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18008-18556: `{{notepad}}` from the Game Master's notepad, carried across turns
