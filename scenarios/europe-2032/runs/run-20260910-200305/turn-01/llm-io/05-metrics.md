...
- characters 16339-16992: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M3 | EU Swarm Defence Hardening | 2 |
...
- `emergent_datacentre_blockade` -- first noted turn 1, listed in 1 turn(s) so far: A coordinated physical protest movement blocks construction of two hyperscale data centre sites in Spain and Germany over water and power use, delaying commissioning by months and forcing a national permitting review.
- `emergent_biosecurity_publishing_freeze` -- first noted turn 1, listed in 1 turn(s) so far: A major European scientific publisher and university consortium imposes a coordinated disclosure moratorium on AI-designed pathogen methods after the phage results, prompting a fight over preprints and open science rules.
