...
- characters 375-2146: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2189-4924: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4980-5891: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5954-31152: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31507-32057: `{{event_history}}` from the run's own event record
...
- `emergent_welfare_scoring_court_ban` -- first noted turn 4, listed in 2 turn(s) so far: The Court of Justice rules the welfare fraud-scoring system unlawful under EU fundamental rights and orders suspension, triggering compensation claims and a wider audit of similar public-sector models.
...
- Turn 1 (5 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 2 (4 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, member_state_defection, automated_decision_scandal, emergent_datacentre_blockade
- Turn 4 (2 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented, export_control_escalation, automated_decision_scandal
- Turn 5 (1 turn(s) ago): cyber_major_incident, bio_incident, ai_investment_collapse, safety_breakthrough, emergent_clinical_moratorium_suit, election_consolidation
