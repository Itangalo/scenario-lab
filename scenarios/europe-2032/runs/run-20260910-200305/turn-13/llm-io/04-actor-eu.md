...
- characters 455-1574: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1618-3401: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5675-6147: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9495-11410: `{{previous_actions}}` from the actor's own response from the previous turn
