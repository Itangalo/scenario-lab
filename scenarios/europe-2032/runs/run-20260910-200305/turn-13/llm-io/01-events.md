...
- characters 377-1496: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1540-3323: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3379-3944: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4007-29155: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29510-30783: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t12: EU Observer Accession to US-China Safety Floor −2, priority −1 = −2 [priority void, capital below 20, no effect no cost]
PROPOSAL BONUS: EU Observer Accession (cat 8, small) +2 — export_control_escalation this turn and us_china_agreement window directly answered, small size caps gain
LEGITIMACY LENDS: capital 12, sentiment 9 -> none, capital higher
SOVEREIGNTY: 12 last turn, no cat4 finish +0, no cat4 in flight +0, export_control_escalation t12 −2 [largest of export_control_escalation, embodied_ai_deployment], capability rose 1.0 −0 = 10
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 2 (11 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, member_state_defection, automated_decision_scandal, emergent_datacentre_blockade
- Turn 4 (9 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented, export_control_escalation, automated_decision_scandal
- Turn 5 (8 turn(s) ago): cyber_major_incident, bio_incident, ai_investment_collapse, safety_breakthrough, emergent_clinical_moratorium_suit, election_consolidation
- Turn 6 (7 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_welfare_scoring_court_ban
- Turn 8 (5 turn(s) ago): emergent_periphery_care_split
- Turn 9 (4 turn(s) ago): openweight_frontier_release, emergent_periphery_care_refusal
- Turn 10 (3 turn(s) ago): medical_breakthrough, knowledge_work_augmented, export_control_escalation, eu_frontier_access_denied, emergent_periphery_mutual_aid_compact
- Turn 11 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, labour_displacement, embodied_ai_deployment
- Turn 12 (1 turn(s) ago): cyber_major_incident, capability_jump, eval_anomaly_reports, embodied_ai_deployment, taiwan_tension_rise, export_control_escalation, us_china_agreement
