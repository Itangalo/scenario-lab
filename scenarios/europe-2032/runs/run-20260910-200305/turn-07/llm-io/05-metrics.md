...
- characters 106-13544: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13587-13778: `{{metrics_json}}` from the run's live metric values
- characters 13871-15986: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 16030-18092: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18148-18622: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | Certified Care Continuity Corps | 2 |
