...
- characters 454-2569: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2613-4675: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4743-5249: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7471-9231: `{{previous_actions}}` from the actor's own response from the previous turn
