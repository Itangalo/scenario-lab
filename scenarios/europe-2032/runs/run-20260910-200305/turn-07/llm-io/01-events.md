...
- characters 376-2491: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2535-4597: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4653-5127: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5190-30991: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31346-32013: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t6: InvestAI Gigafactories −3, Municipal and Hospital Cyber Shield −3, EU Bio-Cyber Incident Containment Reserve −2, priority −1 = −9
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 5, sentiment 14 -> +2 (applied after finishes and event terms, capped by sentiment)
SOVEREIGNTY: 11 last turn, Tech sovereignty package finishes t6 +4, Gigafactories in flight +0, export_control_escalation t6 −2, capability rose 1.0 −0 = 13
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 2 (5 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, member_state_defection, automated_decision_scandal, emergent_datacentre_blockade
- Turn 4 (3 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented, export_control_escalation, automated_decision_scandal
- Turn 5 (2 turn(s) ago): cyber_major_incident, bio_incident, ai_investment_collapse, safety_breakthrough, emergent_clinical_moratorium_suit, election_consolidation
- Turn 6 (1 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_welfare_scoring_court_ban
