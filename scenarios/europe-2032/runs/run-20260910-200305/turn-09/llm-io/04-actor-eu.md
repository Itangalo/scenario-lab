...
- characters 1365-3104: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3767-4273: `{{statement_ledger}}` from the actor's live statement ledger
- characters 6861-8832: `{{previous_actions}}` from the actor's own response from the previous turn
