...
- characters 1287-3026: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3082-3763: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 3826-29627: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29982-30705: `{{event_history}}` from the run's own event record
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, cyber_defence_breakthrough, knowledge_work_augmented
- Turn 2 (7 turn(s) ago): cyber_major_incident, eu_frontier_access_denied, member_state_defection, automated_decision_scandal, emergent_datacentre_blockade
- Turn 4 (5 turn(s) ago): cyber_defence_breakthrough, knowledge_work_augmented, export_control_escalation, automated_decision_scandal
- Turn 5 (4 turn(s) ago): cyber_major_incident, bio_incident, ai_investment_collapse, safety_breakthrough, emergent_clinical_moratorium_suit, election_consolidation
- Turn 6 (3 turn(s) ago): openweight_frontier_release, export_control_escalation, emergent_welfare_scoring_court_ban
- Turn 8 (1 turn(s) ago): emergent_periphery_care_split
