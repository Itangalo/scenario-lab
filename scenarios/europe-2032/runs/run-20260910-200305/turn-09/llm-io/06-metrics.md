...
- characters 13675-14541: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14585-16324: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16380-16768: `{{notepad}}` from the Game Master's notepad, carried across turns
