...
| M13 | EU Joint Medical and Threat Response Accession | 6 | small | 12 | 14 | own jurisdiction plus coalition partners in joint command/pact | resilience up, public_sentiment up slightly if therapies delivered on EU terms | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Joint Medical and Threat Response Accession", "category": 6, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction plus coalition partners in joint command/pact", "targeted_effect": "resilience up, public_sentiment up slightly if therapies delivered on EU terms"}, "grounds": "to take protection offered and turn medical breakth
  - Grounds: to take protection offered and turn medical breakthrough into trusted domestic delivery
