...
- characters 2306-4490: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4546-5524: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5587-30491: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30846-31108: `{{event_history}}` from the run's own event record
...
- Turn 2 (2 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports, safety_breakthrough, knowledge_work_augmented
- Turn 3 (1 turn(s) ago): cyber_major_incident, emergent_grid_insurance_crunch
