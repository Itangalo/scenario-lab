...
- characters 13874-15761: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15804-17988: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 18044-18722: `{{notepad}}` from the Game Master's notepad, carried across turns
