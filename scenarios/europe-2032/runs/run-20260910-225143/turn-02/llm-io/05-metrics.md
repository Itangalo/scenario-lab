...
- characters 16849-17908: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 56.0, "openweight_capability": 50.0, "ai_safety": 37.0, "resilience": 36.0, "eu_ai_sovereignty": 20.0, "eu_political_capital": 29.0, "public_sentiment": 32.0}
```
