...
- characters 6837-7309: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8781-10908: `{{previous_actions}}` from the actor's own response from the previous turn
