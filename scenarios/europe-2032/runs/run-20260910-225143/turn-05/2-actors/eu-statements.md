...
- `two_year_commitment` (commitment): Rebuild trust and absorption capacity so the Union can act on AI again

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Rebuild trust and absorption capacity so the Union can act on AI again
