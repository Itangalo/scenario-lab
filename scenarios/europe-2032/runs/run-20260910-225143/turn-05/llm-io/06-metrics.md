...
- characters 13801-15040: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15084-16923: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16979-17441: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Notepad
PORTFOLIO CHARGE t5: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Services Shield −3, priority −1 = −10
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 3, sentiment 26 -> +2 [capped below sentiment after finishing bonus]
SOVEREIGNTY: 19 last turn, no capacity event, Gigafactories in flight +0, capability rose 1.5 −0 = 19
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "pending"}}]}
