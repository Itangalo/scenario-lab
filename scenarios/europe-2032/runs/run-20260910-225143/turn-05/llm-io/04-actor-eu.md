...
- characters 1738-3577: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4505-4977: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7110-8478: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | Municipal Shield Audit and Insurance Backstop | 6 | small | 3 | 5 | own jurisdiction | resilience up moderately by unblocking Shield rollout | 2 | finished |
