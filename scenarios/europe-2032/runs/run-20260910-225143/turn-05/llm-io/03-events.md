...
- characters 1660-3499: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3555-4017: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4080-28984: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 29339-29678: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: M1 InvestAI Gigafactories −3, M2 Tech sovereignty package −3, M3 EU Critical Services Shield −3, M5 Municipal Shield Audit and Insurance Backstop −2, priority −1 = −12
PROPOSAL BONUS: none — no new measure proposed this turn
LEGITIMACY LENDS: capital 8, sentiment 24 -> +2 [capped below sentiment after finishing bonus and event penalties]
...
- Turn 2 (3 turn(s) ago): cyber_major_incident, loss_of_control_incident, eval_anomaly_reports, safety_breakthrough, knowledge_work_augmented
- Turn 3 (2 turn(s) ago): cyber_major_incident, emergent_grid_insurance_crunch
- Turn 4 (1 turn(s) ago): capability_jump, emergent_gigafactory_siting_block
