...
- `two_year_commitment` (commitment): Secure sovereign AI capacity to anchor European autonomy in a world of distributed superintelligence

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign AI capacity to anchor European autonomy in a world of distributed superintelligence
