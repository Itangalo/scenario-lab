...
- **applied** `M12` — {"op": "add", "table": "measures", "fields": {"name": "EU Essential Services EU-Hosted Continuity Switch", "category": 6, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "resilience up, eu_ai_sovereignty up slightly via continuity"}, "grounds": "frontier access denied amid ransomware wave"}
  - Grounds: frontier access denied amid ransomware wave
