...
| M12 | EU Essential Services EU-Hosted Continuity Switch | 6 | small | 11 | 13 | own jurisdiction | resilience up, eu_ai_sovereignty up slightly via continuity | 2 | running |
| M13 | EU Deployed Assurance Fast-Track | 5 | small | 12 | 14 | own jurisdiction | ai_safety up, resilience up slightly via reduced misuse | 2 | running |
...
- **applied** `M13` — {"op": "add", "table": "measures", "fields": {"name": "EU Deployed Assurance Fast-Track", "category": 5, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "ai_safety up, resilience up slightly via reduced misuse"}, "grounds": "adopt deployable safety breakthrough during cutoff and cyber incident"}
  - Grounds: adopt deployable safety breakthrough during cutoff and cyber incident
