...
- characters 455-1896: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1939-3936: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 7455-7937: `{{statement_ledger}}` from the actor's live statement ledger
- characters 11006-13189: `{{previous_actions}}` from the actor's own response from the previous turn
...
**emergent_foreign_grid_software_lockin (emergent event):** Asian vendors bundle the open agent stack with subsidized power contracts for municipal utilities, locking in several EU cities to foreign-operated grid optimization software outside any EU procurement framework.
...
|---|---|---|---|---|---|---|---|---|---|
| M10 | EU Automated Defence Scale-Up | 6 | small | 9 | 11 | own jurisdiction | resilience up strongly, incident harm down | 2 | running |
