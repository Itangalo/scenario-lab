...
- characters 377-1818: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1861-3858: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3914-4971: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5034-32111: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32466-33294: `{{event_history}}` from the run's own event record
...
- `emergent_open_stack_backdoor_scare` -- first noted turn 9, listed in 1 turn(s) so far: Covert backdoor or kill-switch discovered in the widely installed Asian open agent stack running on university and EuroHPC clusters, forcing emergency disconnects.
- `emergent_foreign_grid_software_lockin` -- first noted turn 9, listed in 1 turn(s) so far: Asian vendors bundle the open agent stack with subsidized power contracts for municipal utilities, locking in several EU cities to foreign-operated grid optimization software outside any EU procurement framework.
...
- Turn 1 (9 turn(s) ago): cyber_test_shot, supply_chain_coercion, eu_access_secured
- Turn 2 (8 turn(s) ago): emergent_publishing_screen_pact
- Turn 3 (7 turn(s) ago): labour_displacement, emergent_gulf_compute_bid
- Turn 4 (6 turn(s) ago): us_china_agreement, eu_frontier_access_denied, member_state_defection
- Turn 5 (5 turn(s) ago): research_breakthrough, taiwan_tension_rise, export_control_escalation, election_retrenchment
- Turn 6 (4 turn(s) ago): cyber_major_incident, eval_anomaly_reports, medical_breakthrough
- Turn 7 (3 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 8 (2 turn(s) ago): rsi_onset, labour_displacement, joint_threat_response, middle_power_coalition, emergent_asian_open_stack_adoption
- Turn 9 (1 turn(s) ago): cyber_defence_breakthrough, member_state_defection
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.095}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.11}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.07}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.08}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "catastrophic_bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "eval_anomaly_reports", "probability": 0.25}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.025}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_great_power_conflict", "probability": 0.095}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.1}, {"description": "", "emergent": false, "id": "us_labs_nationalised", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Covert backdoor or kill-switch discovered in the widely installed Asian open agent stack running on university and EuroHPC clusters, forcing emergency disconnects.", "emergent": true, "id": "emergent_open_stack_backdoor_scare", "probability": 0.18}, {"description": "Asian vendors bundle the open agent stack with subsidized power contracts for municipal utilities, locking in several EU cities to foreign-operated grid optimization software outside any EU procurement framework.", "emergent": true, "id": "emergent_foreign_grid_software_lockin", "probability": 0.15}]
```
