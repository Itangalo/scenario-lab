...
- characters 106-13428: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13471-13663: `{{metrics_json}}` from the run's live metric values
- characters 13756-14907: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14951-17013: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17069-17922: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M4 | EU Supply-Chain Solidarity and Anti-Coercion Compact | 2 |
...
PORTFOLIO CHARGE t2: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Critical Systems Hardening and Mutual Aid Pact −2, EU Supply-Chain Solidarity and Anti-Coercion Compact −2, priority M3 −1 = −11
PROPOSAL BONUS: Anti-Coercion Compact (cat 8, small) +2 — supply coercion through Netherlands last turn and this answers it directly
...
- `emergent_hyperscaler_pause_eu_build` -- first noted turn 3, listed in 1 turn(s) so far: A major US hyperscaler unilaterally pauses its planned EU gigafactory co-investment for 12 months citing power-price uncertainty and US export-licence risk, freezing one of the two advancing sites without any EU decision causing it.
...
## Notepad
PORTFOLIO CHARGE t3: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Supply-Chain Solidarity and Anti-Coercion Compact −2, priority M4 −1 = −9
PROPOSAL BONUS: EU AI Work Transition Facility (cat 7, small) +2 — labour_displacement landed this turn and this answers it directly
