...
- characters 377-1528: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1572-3634: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3690-4182: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4245-27821: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 28176-28317: `{{event_history}}` from the run's own event record
...
- Turn 1 (2 turn(s) ago): cyber_test_shot, supply_chain_coercion, eu_access_secured
- Turn 2 (1 turn(s) ago): emergent_publishing_screen_pact
