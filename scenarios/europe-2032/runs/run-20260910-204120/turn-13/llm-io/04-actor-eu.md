...
- characters 1662-3867: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4571-5053: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8609-10770: `{{previous_actions}}` from the actor's own response from the previous turn
...
- `two_year_commitment` (commitment): Survive open diffusion by hardening what must not fail and rebuilding a controllable stack under EU control
...
|---|---|---|---|---|---|---|---|---|---|
| M13 | EU Certified Assurance Rollout for Deployed Systems | 5 | small | 12 | 14 | own jurisdiction | ai_safety up moderately, resilience up | 2 | running |
...
| M3 | EU Critical Systems Hardening and Mutual Aid Pact | 6 | small | 1 | 3 | own jurisdiction | resilience up moderately, ai_safety incident harm down | 2 | finished |
| M4 | EU Supply-Chain Solidarity and Anti-Coercion Compact | 8 | small | 2 | 5 | own jurisdiction plus coalition partners holding supply-chain chokepoints | eu_ai_sovereignty up, eu_political_capital stabilised by sharing coercion cost | 2 | finished |
| M5 | EU Continuity Stack and Evaluation Authority | 5 | small | 4 | 6 | own jurisdiction | eu_ai_sovereignty up, ai_safety up, resilience up | 2 | finished |
| M6 | EU Transition and Absorption Facility | 7 | small | 5 | 8 | own jurisdiction | resilience up, public_sentiment up, eu_political_capital stabilised | 2 | finished |
| M7 | EU Critical Services Cyber Shield Surge | 6 | small | 6 | 9 | own jurisdiction | resilience up, incident harm down | 2 | finished |
| M8 | EU Lithography and Supply-Chain Leverage Compact | 8 | small | 7 | 9 | own jurisdiction plus coalition partners holding supply-chain chokepoints | eu_ai_sovereignty up, eu_political_capital stabilised | 2 | finished |
| M9 | EU Joint Incident and Biosurveillance Accession | 6 | small | 8 | 10 | own jurisdiction plus joint threat response partners | resilience up, incident harm down | 2 | finished |
| M10 | EU Automated Defence Scale-Up | 6 | small | 9 | 11 | own jurisdiction | resilience up strongly, incident harm down | 2 | finished |
| M11 | EU Wartime Critical Systems Continuity Shield | 6 | small | 10 | 12 | own jurisdiction | resilience up strongly, incident harm down | 2 | finished |
| M12 | EU Wartime Pandemic Containment and Continuity Mobilisation | 6 | small | 11 | 13 | own jurisdiction | resilience up strongly, incident harm down | 2 | finished |
...
## New measure
**EU Certified Assurance Rollout for Deployed Systems**
Takes the new interpretability/control result and hard-wires it into hospitals, grids and public IT still running foreign agents — predict-before-observe checks and certified properties enforced via the evaluation authority. Category 5 Public technical capacity and research is why now: with safety at 6 and a breakthrough labs already want, this is the cheapest assurance gain available amid plague and war.

## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Certified Assurance Rollout for Deployed Systems", "category": 5, "size": "small", "finish_turn": 14, "applies_to": "own jurisdiction", "targeted_effect": "ai_safety up moderately, resilience up"}, "grounds": "adopt deployable safety breakthrough during investment collapse"}]}
```

## Priority
M12 EU Wartime Pandemic Containment and Continuity Mobilisation, because keeping crews, triage maps and absentee hosting alive through plague plus war outranks even a real safety gain when capital is at 17.

## In practice
We keep M12 as the operational core: HERA and the Emergency Response Coordination Centre run joint antiviral/reagent buying, rescEU releases, and military medics for power/water/telecom control rooms, with ECDC daily triage from pooled wastewater/hospital telemetry and empty backup halls hosting grid/hospital IT. Council Health and JHA formations extend the crisis derogation; we do not relitigate hyperscaler requisitions now but press voluntary modelling compute via the one willing capital.

Alongside it we start the assurance rollout through the Continuity Stack Evaluation Authority stood up under M5, with ENISA and Joint Research Centre vetting the breakthrough for certification on already-deployed clinical and grid agents, and freezing non-certified foreign-agent updates where engineers have access. We use the joint-threat-response invitation for biosurveillance sample-sharing and cyber telemetry to cover what we cannot build alone, funded by Digital Europe/EIB reprogramming, while accepting investment collapse means no new compute build this turn.
...
```
## New measure
**EU Entry-Level Displacement Backstop**
Pays wage-subsidised transition jobs, retraining stipends and hiring incentives in law, accountancy, software, customer operations and administration where AI has erased graduate hiring, run through national employment agencies with EU co-funding. Category 7 Labour and social protection is why now: with sentiment at 10 and entry-level work disappearing, quiet anger becomes open hostility unless displacement lands as adjustment rather than abandonment.
## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Entry-Level Displacement Backstop", "category": 7, "size": "small", "finish_turn": 15, "applies_to": "own jurisdiction", "targeted_effect": "resilience up moderately, public_sentiment up, eu_political_capital stabilised"}, "grounds": "answer measurable graduate job losses amid hostility"}]}
```
## Priority
M13 EU Certified Assurance Rollout for Deployed Systems, because the deployable interpretability gain is the only cheap safety and continuity win available while capital is at 17 and no build is possible.
## In practice
We keep the assurance rollout as the operational core: the Continuity Stack Evaluation Authority with ENISA and the Joint Research Centre finishes certifying the breakthrough on deployed clinical and grid agents, with predict-before-observe checks enforced in hospitals and grid control rooms and non-certified foreign-agent updates frozen where engineers can reach them, funded by Digital Europe reprogramming.

Alongside it we launch the displacement backstop via DG EMPL and national public employment services, using ESF+ and the Transition Facility residue for wage insurance, conversion apprenticeships and SME hiring bonuses for displaced graduates, decided in EPSCO to avoid a new fund fight. We sustain joint antiviral/reagent buying, military medics in control rooms, and biosurveillance and cyber-telemetry sharing to cover the investment freeze, while accepting no new sovereign compute this turn.
