...
- characters 378-1540: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1584-3789: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3845-5065: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5128-30637: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30992-32162: `{{event_history}}` from the run's own event record
...
- `emergent_plague_toolchain_attribution_leak` -- first noted turn 12, listed in 1 turn(s) so far: Independent forensic attribution of the engineered plague signature leaks, naming the lab toolchain and AI model family used to design it.
- `emergent_wartime_biocompute_denial` -- first noted turn 12, listed in 1 turn(s) so far: Wartime belligerents impose reciprocal AI-compute blockades on pharmaceutical and pathogen-modeling workloads, freezing cross-border access to sequencing and countermeasure design tools for months.
...
- Turn 1 (12 turn(s) ago): cyber_test_shot, supply_chain_coercion, eu_access_secured
- Turn 2 (11 turn(s) ago): emergent_publishing_screen_pact
- Turn 3 (10 turn(s) ago): labour_displacement, emergent_gulf_compute_bid
- Turn 4 (9 turn(s) ago): us_china_agreement, eu_frontier_access_denied, member_state_defection
- Turn 5 (8 turn(s) ago): research_breakthrough, taiwan_tension_rise, export_control_escalation, election_retrenchment
- Turn 6 (7 turn(s) ago): cyber_major_incident, eval_anomaly_reports, medical_breakthrough
- Turn 7 (6 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 8 (5 turn(s) ago): rsi_onset, labour_displacement, joint_threat_response, middle_power_coalition, emergent_asian_open_stack_adoption
- Turn 9 (4 turn(s) ago): cyber_defence_breakthrough, member_state_defection
- Turn 10 (3 turn(s) ago): research_breakthrough, embodied_ai_deployment, catastrophic_great_power_conflict, member_state_defection, emergent_foreign_grid_software_lockin
- Turn 11 (2 turn(s) ago): catastrophic_bio_incident
- Turn 12 (1 turn(s) ago): ai_investment_collapse, safety_breakthrough, taiwan_tension_rise, joint_threat_response
...
```
[{"description": "", "emergent": false, "id": "cyber_major_incident", "probability": 0.19}, {"description": "", "emergent": false, "id": "bio_incident", "probability": 0.01}, {"description": "", "emergent": false, "id": "loss_of_control_incident", "probability": 0.08}, {"description": "", "emergent": false, "id": "capability_jump", "probability": 0.1}, {"description": "", "emergent": false, "id": "taiwan_blockade", "probability": 0.12}, {"description": "", "emergent": false, "id": "ai_investment_collapse", "probability": 0.06}, {"description": "", "emergent": false, "id": "cyber_defence_breakthrough", "probability": 0.14}, {"description": "", "emergent": false, "id": "bio_uplift_findings", "probability": 0.21}, {"description": "", "emergent": false, "id": "opaque_reasoning", "probability": 0.15}, {"description": "", "emergent": false, "id": "research_breakthrough", "probability": 0.1}, {"description": "", "emergent": false, "id": "medical_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "openweight_frontier_release", "probability": 0.1}, {"description": "", "emergent": false, "id": "catastrophic_loss_of_control_incident", "probability": 0.02}, {"description": "", "emergent": false, "id": "safety_breakthrough", "probability": 0.18}, {"description": "", "emergent": false, "id": "labour_displacement", "probability": 0.16}, {"description": "", "emergent": false, "id": "knowledge_work_augmented", "probability": 0.05}, {"description": "", "emergent": false, "id": "embodied_ai_deployment", "probability": 0.16}, {"description": "", "emergent": false, "id": "taiwan_tension_rise", "probability": 0.05}, {"description": "", "emergent": false, "id": "export_control_escalation", "probability": 0.15}, {"description": "", "emergent": false, "id": "us_labs_nationalised", "probability": 0.06}, {"description": "", "emergent": false, "id": "eu_frontier_access_denied", "probability": 0.1}, {"description": "", "emergent": false, "id": "supply_chain_coercion", "probability": 0.04}, {"description": "", "emergent": false, "id": "member_state_defection", "probability": 0.09}, {"description": "", "emergent": false, "id": "adoption_success", "probability": 0.1}, {"description": "", "emergent": false, "id": "automated_decision_scandal", "probability": 0.06}, {"description": "", "emergent": false, "id": "joint_threat_response", "probability": 0.12}, {"description": "", "emergent": false, "id": "middle_power_coalition", "probability": 0.1}, {"description": "Independent forensic attribution of the engineered plague signature leaks, naming the lab toolchain and AI model family used to design it.", "emergent": true, "id": "emergent_plague_toolchain_attribution_leak", "probability": 0.18}, {"description": "Wartime belligerents impose reciprocal AI-compute blockades on pharmaceutical and pathogen-modeling workloads, freezing cross-border access to sequencing and countermeasure design tools for months.", "emergent": true, "id": "emergent_wartime_biocompute_denial", "probability": 0.14}]
```
