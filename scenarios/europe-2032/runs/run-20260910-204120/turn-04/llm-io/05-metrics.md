...
- characters 105-13095: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13138-13330: `{{metrics_json}}` from the run's live metric values
- characters 13423-14533: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14576-16462: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16518-17316: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M5 | EU Continuity Stack and Evaluation Authority | 2 |
...
## Metrics
```json
{"ai_capability": 63.5, "openweight_capability": 57.6, "ai_safety": 26.0, "resilience": 41.0, "eu_ai_sovereignty": 17.0, "eu_political_capital": 23.0, "public_sentiment": 25.0}
```
