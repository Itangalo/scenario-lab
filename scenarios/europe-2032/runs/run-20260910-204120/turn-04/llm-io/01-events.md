...
- characters 376-1486: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1529-3415: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3471-4269: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4332-31276: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31631-31845: `{{event_history}}` from the run's own event record
...
- Turn 1 (3 turn(s) ago): cyber_test_shot, supply_chain_coercion, eu_access_secured
- Turn 2 (2 turn(s) ago): emergent_publishing_screen_pact
- Turn 3 (1 turn(s) ago): labour_displacement, emergent_gulf_compute_bid
