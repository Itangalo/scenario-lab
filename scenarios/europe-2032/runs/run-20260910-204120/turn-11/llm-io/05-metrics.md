...
- characters 13726-14987: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15031-17220: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17276-17857: `{{notepad}}` from the Game Master's notepad, carried across turns
