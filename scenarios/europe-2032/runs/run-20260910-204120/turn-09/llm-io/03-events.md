...
- characters 377-1411: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1455-3528: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3584-4067: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4130-31207: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31562-32313: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t8: M7 Cyber Shield Surge −2, M8 Lithography Compact −2, M9 Biosurveillance Accession −2, priority M7 −1 = −7
PROPOSAL BONUS: EU Joint Incident and Biosurveillance Accession (cat 6, small) +3 — joint_threat_response fired this turn severe and this answers it directly
LEGITIMACY LENDS: capital 27, sentiment 22 -> none, capital higher
SOVEREIGNTY: 21 last turn, no category 4 finish, no category 4 in flight, middle_power_coalition t8 +2, capability rose 6.0 −1 = 22
...
- Turn 1 (8 turn(s) ago): cyber_test_shot, supply_chain_coercion, eu_access_secured
- Turn 2 (7 turn(s) ago): emergent_publishing_screen_pact
- Turn 3 (6 turn(s) ago): labour_displacement, emergent_gulf_compute_bid
- Turn 4 (5 turn(s) ago): us_china_agreement, eu_frontier_access_denied, member_state_defection
- Turn 5 (4 turn(s) ago): research_breakthrough, taiwan_tension_rise, export_control_escalation, election_retrenchment
- Turn 6 (3 turn(s) ago): cyber_major_incident, eval_anomaly_reports, medical_breakthrough
- Turn 7 (2 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 8 (1 turn(s) ago): rsi_onset, labour_displacement, joint_threat_response, middle_power_coalition, emergent_asian_open_stack_adoption
