...
- characters 13919-14953: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14997-17070: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17126-18206: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Metrics
```json
{"ai_capability": 79.1, "openweight_capability": 73.2, "ai_safety": 10.0, "resilience": 43.5, "eu_ai_sovereignty": 19.0, "eu_political_capital": 29.0, "public_sentiment": 19.0}
```
## Narrative
