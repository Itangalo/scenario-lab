...
- characters 1533-3606: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4288-4770: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7699-9537: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M9 | EU Joint Incident and Biosurveillance Accession | 6 | small | 8 | 10 | own jurisdiction plus joint threat response partners | resilience up, incident harm down | 2 | running |
