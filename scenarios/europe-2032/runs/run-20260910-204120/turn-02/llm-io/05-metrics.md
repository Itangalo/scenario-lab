...
- characters 105-13100: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13143-13335: `{{metrics_json}}` from the run's live metric values
- characters 13428-14326: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14369-16586: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 16642-17065: `{{notepad}}` from the Game Master's notepad, carried across turns
