...
- characters 13747-15427: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15470-17794: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17850-18941: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M12 | EU Wartime Pandemic Containment and Continuity Mobilisation | 2 |
...
## Metrics
```json
{"ai_capability": 85.3, "openweight_capability": 80.0, "ai_safety": 11.0, "resilience": 54.0, "eu_ai_sovereignty": 14.0, "eu_political_capital": 17.0, "public_sentiment": 10.0}
```
