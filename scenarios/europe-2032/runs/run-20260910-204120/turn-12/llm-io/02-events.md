...
- characters 375-2055: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2098-4422: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4478-5005: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5068-31171: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31526-32580: `{{event_history}}` from the run's own event record
...
- Turn 1 (11 turn(s) ago): cyber_test_shot, supply_chain_coercion, eu_access_secured
- Turn 2 (10 turn(s) ago): emergent_publishing_screen_pact
- Turn 3 (9 turn(s) ago): labour_displacement, emergent_gulf_compute_bid
- Turn 4 (8 turn(s) ago): us_china_agreement, eu_frontier_access_denied, member_state_defection
- Turn 5 (7 turn(s) ago): research_breakthrough, taiwan_tension_rise, export_control_escalation, election_retrenchment
- Turn 6 (6 turn(s) ago): cyber_major_incident, eval_anomaly_reports, medical_breakthrough
- Turn 7 (5 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, taiwan_tension_rise
- Turn 8 (4 turn(s) ago): rsi_onset, labour_displacement, joint_threat_response, middle_power_coalition, emergent_asian_open_stack_adoption
- Turn 9 (3 turn(s) ago): cyber_defence_breakthrough, member_state_defection
- Turn 10 (2 turn(s) ago): research_breakthrough, embodied_ai_deployment, catastrophic_great_power_conflict, member_state_defection, emergent_foreign_grid_software_lockin
- Turn 11 (1 turn(s) ago): catastrophic_bio_incident
