...
- characters 453-2133: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 2176-4500: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5920-6402: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9799-11870: `{{previous_actions}}` from the actor's own response from the previous turn
...
|---|---|---|---|---|---|---|---|---|---|
| M12 | EU Wartime Pandemic Containment and Continuity Mobilisation | 6 | small | 11 | 13 | own jurisdiction | resilience up strongly, incident harm down | 2 | running |
...
## New measure
**EU Wartime Pandemic Containment and Continuity Mobilisation**
Freezes non-essential activity to run pandemic triage through the continuity shield: EU-wide biosurveillance, medical stockpile release, hospital surge hosting, and keeping power, water and telecoms crewed through war plus plague. Category 6 Preparedness and resilience is why now: with AI-designed pathogen spreading amid US-China strikes, safety at 8 and capital at 18, only a survival mobilisation that uses what already landed holds.

## Store changes
```json
{"store": [{"op": "add", "table": "measures", "fields": {"name": "EU Wartime Pandemic Containment and Continuity Mobilisation", "category": 6, "size": "small", "finish_turn": 13, "applies_to": "own jurisdiction", "targeted_effect": "resilience up strongly, incident harm down"}, "grounds": "catastrophic AI-enabled bio outbreak during wartime demands immediate mobilisation"}]}
```

## Priority
M11 EU Wartime Critical Systems Continuity Shield, because keeping grid, hospitals and telecoms staffed and powered through pandemic absenteeism plus strikes is the precondition for any bio-response to function.

## In practice
We trigger the Emergency Response Coordination Centre and Health Emergency Preparedness and Response Authority under the Serious Cross-Border Threats Regulation and Civil Protection Mechanism, releasing rescEU stockpiles, activating joint procurement for antivirals, PPE and sequencing reagents, and ordering member states to staff critical-entity minimum crews with military medical support. ECDC runs pooled wastewater and hospital telemetry from M9 into daily triage.

We repurpose M11 islanding and backup hosting for absentee operation: ENISA, ENTSO-E and CERT-EU keep grid-control and hospital IT on backup halls, freeze municipal foreign-agent updates that could fail uncrewed, and use Digital Europe and EIB emergency reprogramming to pay overtime, fuel and spares. Defecting hyperscaler deals are requisitioned under crisis derogation for surge compute for pathogen modelling, not litigated now.
