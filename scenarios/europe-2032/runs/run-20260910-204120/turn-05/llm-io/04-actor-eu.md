...
- characters 1398-3549: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 6359-6848: `{{statement_ledger}}` from the actor's live statement ledger
- characters 9056-11171: `{{previous_actions}}` from the actor's own response from the previous turn
...
| M5 | EU Continuity Stack and Evaluation Authority | 5 | small | 4 | 7 | own jurisdiction | eu_ai_sovereignty up, ai_safety up, resilience up | 2 | running |
