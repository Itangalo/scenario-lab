...
- characters 1320-3471: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3527-4472: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4535-30577: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 30932-31242: `{{event_history}}` from the run's own event record
...
PORTFOLIO CHARGE t4: InvestAI Gigafactories −3, Tech sovereignty package −3, EU Supply-Chain Solidarity and Anti-Coercion Compact −2, EU Continuity Stack and Evaluation Authority −2, priority M4 −1 = −11
PROPOSAL BONUS: EU Continuity Stack and Evaluation Authority (cat 5, small) +4 — eu_frontier_access_denied landed this turn and this answers it directly, plus seeks inclusion in us_china_agreement
LEGITIMACY LENDS: capital 21, sentiment 25 -> +2
SOVEREIGNTY: 19 last turn, no capacity event, Gigafactories in flight +1, eu_frontier_access_denied t4 −2, capability rose 2.5 −1 = 17

## Emerging developments (tracked)

- `emergent_hyperscaler_pause_eu_build` -- first noted turn 3, listed in 2 turn(s) so far: A major US hyperscaler unilaterally pauses its planned EU gigafactory co-investment for 12 months citing power-price uncertainty and US export-licence risk, freezing one of the two advancing sites without any EU decision causing it.
...
- Turn 1 (4 turn(s) ago): cyber_test_shot, supply_chain_coercion, eu_access_secured
- Turn 2 (3 turn(s) ago): emergent_publishing_screen_pact
- Turn 3 (2 turn(s) ago): labour_displacement, emergent_gulf_compute_bid
- Turn 4 (1 turn(s) ago): us_china_agreement, eu_frontier_access_denied, member_state_defection
