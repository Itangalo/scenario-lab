...
- characters 13884-14783: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 14827-16978: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17034-17618: `{{notepad}}` from the Game Master's notepad, carried across turns
...
## Store changes
```json
{"store": [{"op": "update", "table": "standing", "id": "S1", "fields": {"posture": "pending"}}, {"op": "update", "table": "measures", "id": "M5", "fields": {"finish_turn": 6}, "grounds": "named priority"}]}
```
```
