...
- characters 376-1213: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1256-3209: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3265-4345: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4408-30893: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31248-31859: `{{event_history}}` from the run's own event record
...
- `emergent_asian_open_stack_adoption` -- first noted turn 6, listed in 2 turn(s) so far: Asian labs release a highly capable open agent stack that EuroHPC-hosted fallbacks rapidly adopt, deepening EU dependence on foreign open weights even as US access stays rationed.
- `emergent_asian_access_offer` -- first noted turn 6, listed in 2 turn(s) so far: Asian labs, gaining from US retrenchment, offer the EU cut-price frontier inference tied to data-centre and standards alignment, forcing a public choice between cheap access and sovereignty.
...
- Turn 1 (7 turn(s) ago): cyber_test_shot, supply_chain_coercion, eu_access_secured
- Turn 2 (6 turn(s) ago): emergent_publishing_screen_pact
- Turn 3 (5 turn(s) ago): labour_displacement, emergent_gulf_compute_bid
- Turn 4 (4 turn(s) ago): us_china_agreement, eu_frontier_access_denied, member_state_defection
- Turn 5 (3 turn(s) ago): research_breakthrough, taiwan_tension_rise, export_control_escalation, election_retrenchment
- Turn 6 (2 turn(s) ago): cyber_major_incident, eval_anomaly_reports, medical_breakthrough
- Turn 7 (1 turn(s) ago): taiwan_blockade, cyber_defence_breakthrough, taiwan_tension_rise
