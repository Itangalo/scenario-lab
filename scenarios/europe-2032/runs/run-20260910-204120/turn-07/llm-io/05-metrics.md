...
- characters 106-13431: `{{metric_rules}}` from metric-rules.md as it currently stands, including any variant patch
- characters 13474-13666: `{{metrics_json}}` from the run's live metric values
- characters 13759-14987: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15031-17228: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17284-18356: `{{notepad}}` from the Game Master's notepad, carried across turns
...
| M8 | EU Lithography and Supply-Chain Leverage Compact | 2 |
