...
- characters 377-1605: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1649-3846: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3902-4974: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 5037-30708: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 31063-31583: `{{event_history}}` from the run's own event record
...
- Turn 1 (6 turn(s) ago): cyber_test_shot, supply_chain_coercion, eu_access_secured
- Turn 2 (5 turn(s) ago): emergent_publishing_screen_pact
- Turn 3 (4 turn(s) ago): labour_displacement, emergent_gulf_compute_bid
- Turn 4 (3 turn(s) ago): us_china_agreement, eu_frontier_access_denied, member_state_defection
- Turn 5 (2 turn(s) ago): research_breakthrough, taiwan_tension_rise, export_control_escalation, election_retrenchment
- Turn 6 (1 turn(s) ago): cyber_major_incident, eval_anomaly_reports, medical_breakthrough
