...
- characters 454-1521: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1564-3489: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 4955-5437: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7817-10459: `{{previous_actions}}` from the actor's own response from the previous turn
