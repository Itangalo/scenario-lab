...
- `two_year_commitment` (commitment): Secure sovereign control over AI capability while proving resilience to its risks.

## Changes this turn

- **add** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Secure sovereign control over AI capability while proving resilience to its risks.
