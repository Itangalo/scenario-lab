...
- characters 454-1590: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1633-3755: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5502-5968: `{{statement_ledger}}` from the actor's live statement ledger
- characters 8223-10501: `{{previous_actions}}` from the actor's own response from the previous turn
