...
- characters 13547-13738: `{{metrics_json}}` from the run's live metric values
- characters 13831-14967: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 15010-17132: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 17188-17943: `{{notepad}}` from the Game Master's notepad, carried across turns
...
|---|---|---|
| M8 | EU Local Recovery Corps for Cyber Restoration and Displaced Junior Retraining | 2 |
...
|---|---|---|---|---|---|---|---|---|---|
| M7 | Emergency Winter Load-Shedding Pact and Municipal Islanding Kits | 6 | small | 9 | 10 | own jurisdiction | resilience up moderately, eu_political_capital up slightly if blackouts contained | 2 | finished |
...
- `emergent_winter_health_crisis` -- first noted turn 9, listed in 2 turn(s) so far: A prolonged winter anticyclone combined with forced compute curtailments triggers excess winter mortality and hospital strain across western Europe, independently of any cyber or bio attack.
...
## Metrics
```json
{"ai_capability": 67.0, "openweight_capability": 64.8, "ai_safety": 15.0, "resilience": 40.0, "eu_ai_sovereignty": 15.0, "eu_political_capital": 2.0, "public_sentiment": 0.0}
```
...
## Notepad
PORTFOLIO CHARGE t10: EU Local Recovery Corps for Cyber Restoration and Displaced Junior Retraining −2, priority −1 = −3
PROPOSAL BONUS: none — M8 in flight answers this turn's automated attack and junior losses, not an event from the last three rounds
LEGITIMACY LENDS: capital 2, sentiment 0 -> none, capital higher
SOVEREIGNTY: 17 last turn, no category 4 finishing or in flight, export_control_escalation t10 −2, capability rose 1.5 no charge = 15
