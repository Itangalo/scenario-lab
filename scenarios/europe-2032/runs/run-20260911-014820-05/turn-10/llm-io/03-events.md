...
- characters 376-1512: `{{historical_summary}}` from the run's rolling summary, written by the Game Master
- characters 1555-3677: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 3733-4488: `{{notepad}}` from the Game Master's notepad, carried across turns
- characters 4551-32017: `{{events_list}}` from events.md, parsed to id / condition / probability / description per event -- the prose sections of that file are NOT rendered
- characters 32372-33095: `{{event_history}}` from the run's own event record
...
- `emergent_winter_health_crisis` -- first noted turn 9, listed in 1 turn(s) so far: A prolonged winter anticyclone combined with forced compute curtailments triggers excess winter mortality and hospital strain across western Europe, independently of any cyber or bio attack.
...
- Turn 2 (8 turn(s) ago): cyber_major_incident, safety_breakthrough, eu_frontier_access_denied, adoption_success
- Turn 3 (7 turn(s) ago): ai_investment_collapse, eval_anomaly_reports, taiwan_tension_rise
- Turn 4 (6 turn(s) ago): supply_chain_coercion
- Turn 5 (5 turn(s) ago): middle_power_coalition, election_consolidation
- Turn 6 (4 turn(s) ago): cyber_major_incident, member_state_defection
- Turn 7 (3 turn(s) ago): research_breakthrough, openweight_frontier_release
- Turn 8 (2 turn(s) ago): bio_uplift_findings, eval_anomaly_reports, emergent_energy_price_shock
- Turn 9 (1 turn(s) ago): research_breakthrough, openweight_frontier_release, emergent_winter_blackout_cascade
