...
- characters 1801-3869: `{{world_state}}` from the Game Master's narrative from the previous turn
- characters 5240-5680: `{{statement_ledger}}` from the actor's live statement ledger
- characters 7598-8769: `{{previous_actions}}` from the actor's own response from the previous turn
