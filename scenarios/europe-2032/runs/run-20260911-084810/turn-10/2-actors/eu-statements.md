...
- **modify** `two_year_commitment` — applied
  ...
  - Reason: The expiration of the commitment period directly changes the actor's obligation to maintain the original statement, necessitating a new formulation.
