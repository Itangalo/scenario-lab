...
- `two_year_commitment` (commitment): Sovereign AI capacity as a foundation for strategic autonomy and collective security

## Changes this turn

- **modify** `two_year_commitment` — applied
  - Tier: commitment
  - Text: Sovereign AI capacity as a foundation for strategic autonomy and collective security
  - Trigger: the two-year commitment period closes this turn
  - Evidence quoted: the two-year commitment period closes this turn
  - Reason: The expiration of the two-year period directly ends the original commitment's timeframe, changing the actor's obligation and enabling a strategic reframing.
