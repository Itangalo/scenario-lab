...
Generated from `run-20260901-121414`. These documents exist because a scenario file that never reaches a prompt changes nothing, and nothing else in the pipeline will tell you which ones those are.
...
- [actor-turn-1](actor-turn-1.md) – `sign-off-capital-combined/actor-turn-1.md`
- [actor-turn-2](actor-turn-2.md) – `sign-off-capital-combined/actor-turn-2.md`
- [game-master-turn-2](game-master-turn-2.md) – `sign-off-capital-combined/game-master-turn-2.md`
- [events-turn-2](events-turn-2.md) – `sign-off-capital-combined/events-turn-2.md`
