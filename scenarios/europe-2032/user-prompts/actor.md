...
* Heading level 2: New measure — **at most one**. `None this turn.` is
  ...
  `Category:` (1-10), `Capital cost:` (low/medium/high), `Lead time:` (turns to
  full effect), `Targeted effect:` (which metrics, which direction, roughly how
  much), and `Applies to:` (your own jurisdiction, particular member states, the
  US, China, a coalition, the frontier developers directly). Measures you invent
  are welcome and get the category tag they most resemble, or `10. Other`.
...
You must open with your **Standing commitment**, restated or explicitly
abandoned. You may introduce **at most one new measure this turn**, however many
